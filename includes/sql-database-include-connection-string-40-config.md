...
### <a name="example-config-file-for-connection-string-security"></a>Пример файла конфигурации для обеспечения безопасности строки подключения
...
В этом примере большая часть строки подключения хранится в файле конфигурации с именем **ConsoleApplication1.exe.config**. Этот файл конфигурации также должен находиться в каталоге **bin\debug\**.
