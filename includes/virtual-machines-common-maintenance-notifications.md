...
4. Выберите и добавьте следующие столбцы:
   ...
   **Обслуживание** — показывает состояние обслуживания для виртуальной машины. Ниже приведены возможные значения.
      ...
      | Skipped| Инициирование обслуживания не прошло успешно. Вы не сможете использовать параметр самостоятельного обслуживания. ВМ будет перезагружен в Azure во время фазы запланированного обслуживания. | 
