...
> [!NOTE]
> Объекты [request](http://msdn.microsoft.com/library/windowsazure/jj554218.aspx) и [response](http://msdn.microsoft.com/library/windowsazure/dn303373.aspx), предоставленные функциям пользовательского API, реализуются [библиотекой Express.js](http://go.microsoft.com/fwlink/p/?LinkId=309046).
> 
> 
