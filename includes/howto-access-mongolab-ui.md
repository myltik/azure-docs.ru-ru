После подготовки базы данных MongoLab открывается доступ к веб-интерфейсу пользователя MongoLab для управления этой базой данных. Мы предлагаем удобный доступ единого входа (SSO) на портале управления Windows Azure.

Интерфейс MongoLab можно использовать для выполнения большинства задач базы данных: вставки и запроса документов, получения статистики базы данных и выполнения полезных команд базы данных. Чтобы узнать больше о пользовательском интерфейсе MongoLab, посетите [страницу поддержки](http://support.mongolab.com) и наш [блог](http://blog.mongolab.com).
