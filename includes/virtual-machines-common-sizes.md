...
|Standard\_DS5\_v2 |16|56|8|Локальный диск SSD: 112 ГБ |32|688| 51 200, 768 МБ в секунду | высокий |
...
|Standard\_DS14\_v2 |16|112|8|Локальный диск SSD: 224 ГБ |32|576| 51 200, 768 МБ в секунду | Очень высокая |
|Standard\_DS15\_v2 |20|140 ГБ|10|Локальный диск SSD: 280 ГБ |40| 720|64 000, 960 МБ в секунду | Очень высокая |
...
| Standard\_F16 | 16 | 32 ГБ | 8 | Временный (SSD): 256 ГБ | 32 | 32x500 | Очень высокая |
...
| Standard\_F16s | 16 | 32 | 8 | Локальный диск SSD: 64 ГБ | 32 | 192 | 51 200, 768 МБ в секунду | Очень высокая |
