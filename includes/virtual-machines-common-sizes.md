...
|Standard\_D5\_v2 |16|56 ГБ|8|Временный (SSD): 800 ГБ |32|32x500| Чрезвычайно высокая |
...
|Standard\_D14\_v2 |16|112 ГБ|8|Временный (SSD): 800 ГБ |32|32x500| Чрезвычайно высокая |
|Standard\_D15\_v2 |20|140 ГБ|8|Временный (SSD): 1 ТБ |40|40x500| Чрезвычайно высокая |
...
|Standard\_DS14 |16|112|8|Локальный диск SSD: 224 ГБ |32|576| 51 200, 512 МБ в секунду | Очень высокая |
...
|Standard\_DS5\_v2 |16|56|8|Локальный диск SSD: 112 ГБ |32|688| 51 200, 768 МБ в секунду | Чрезвычайно высокая |
...
|Standard\_DS14\_v2 |16|112|8|Локальный диск SSD: 224 ГБ |32|576| 51 200, 768 МБ в секунду | Чрезвычайно высокая |
|Standard\_DS15\_v2 |20|140 ГБ|8|Локальный диск SSD: 280 ГБ |40| 720|64 000, 960 МБ в секунду | Чрезвычайно высокая |
...
| Размер | Ядра ЦП | Память | Сетевые адаптеры (макс.) | Размер диска | Максимальное количество дисков данных (по 1023 ГБ каждый) | Максимальное количество операций ввода-вывода в секунду (500 на диск) | Максимальная пропускная способность сети |
|--------------|-----------|--------|------------|-------------------------|--------------------------|--------------------------|-------------|
| Standard\_F1 | 1 | 2 ГБ | 1 | Временный (SSD): 16 ГБ | 2 | 2x500 | Средняя |
| Standard\_F2 | 2 | 4 ГБ | 2 | Временный (SSD): 32 ГБ | 4\. | 4x500 | высокий |
| Standard\_F4 | 4\. | 8 ГБ | 4\. | Временный (SSD): 64 ГБ | 8 | 8x500 | высокий |
| Standard\_F8 | 8 | 16 ГБ | 8 | Временный (SSD): 128 ГБ | 16 | 16x500 | высокий |
| Standard\_F16 | 16 | 32 ГБ | 8 | Временный (SSD): 256 ГБ | 32 | 32x500 | Чрезвычайно высокая |



## Серия Fs*

| Размер | Ядра ЦП | Память | Сетевые адаптеры (макс.) | Размер диска | Максимальное количество дисков данных (по 1023 ГБ каждый) | Размер кэша (ГБ) | Максимальное количество дисковых операций ввода-вывода в секунду и пропускная способность | Максимальная пропускная способность сети |
|---------------|-----------|--------|------------|------------------------|-----------|-----------|----------------------------|------------|
| Standard\_F1s | 1 | 2 | 1 | Локальный диск SSD: 4 ГБ | 2 | 12 | 3200 48 МБ в секунду | Средняя |
| Standard\_F2s | 2 | 4\. | 2 | Локальный диск SSD: 8 ГБ | 4\. | 24 | 6400 96 МБ в секунду | высокий |
| Standard\_F4s | 4\. | 8 | 4\. | Локальный диск SSD: 16 ГБ | 8 | 48 | 12 800 192 МБ в секунду | высокий |
| Standard\_F8s | 8 | 16 | 8 | Локальный диск SSD: 32 ГБ | 16 | 96 | 25 600 384 МБ в секунду | высокий |
| Standard\_F16s | 16 | 32 | 8 | Локальный диск SSD: 64 ГБ | 32 | 192 | 51 200, 768 МБ в секунду | Чрезвычайно высокая |



*Максимальное количество операций ввода-вывода в секунду и пропускная способность для виртуальных машин серии Fs зависят от размера диска. Дополнительные сведения см. в статье [Хранилище Premium: хранилище высокой производительности для рабочих нагрузок виртуальных машин Azure](../articles/storage/storage-premium-storage.md).
...
| Размер | Ядра | Графический процессор | Память | Диск |
|------|-------|----------------|--------|-------------|
| Standard\_NV6 | 6 | 1 x NVIDIA M60 | 56 ГБ | SSD 380 ГБ |
| Standard\_NV12 | 12 | 2 x NVIDIA M60 | 112 ГБ | SSD 680 ГБ |
| Standard\_NV24 | 24 | 4 x NVIDIA M60 | 224 ГБ | SSD 1440 ГБ | 
...
| Размер | Ядра | Графический процессор | Память | Диск |
|------|-------|----------------|--------|-------------|
| Standard\_NC6 | 6 | 1 x NVIDIA K80 | 56 ГБ | SSD 380 ГБ |
| Standard\_NC12 | 12 | 2 x NVIDIA K80 | 112 ГБ | SSD 680 ГБ |
| Standard\_NC24 | 24 | 4 x NVIDIA K80 | 224 ГБ | SSD 1440 ГБ |
