...
4. На странице **Конфигурация виртуальной машины** укажите следующие сведения:
	...
	- — В поле **Новый пароль** введите [надежный пароль](http://msdn.microsoft.com/library/ms161962.aspx).
...
2. Введите "testlinuxvm.cloudapp.net" в поле **Имя узла** и "22" в поле **Порт**. ![Экран PuTTY][Image6]
