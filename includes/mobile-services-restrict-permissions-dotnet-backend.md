...
2. Примените следующий атрибут _AuthorizeLevel_ к классу **TodoItemController**.

		[AuthorizeLevel(AuthorizationLevel.User)]

	При этом только прошедший проверку пользователь сможет производить все операции с таблицей _TodoItem_. Можно также применить атрибут *AuthorizeLevel* на уровне метода.
