...
При создании веб-сайта Azure DNS-имя автоматически назначается веб-сайту. Это имя имеет форму **\<имя\_сайта\>.azurewebsites.net**. При добавлении веб-сайта в качестве конечной точки Azure Traffic Manager ваш веб-сайт становится доступным через домен **\<yourtrafficmanagerprofile\>. trafficmanager.net**.

> Когда веб-сайт настроен в качестве конечной точки Traffic Manager, будет использоваться адрес **. trafficmanager.net** при создании записей DNS.

> Записи CNAME можно использовать только с помощью Traffic Manager
