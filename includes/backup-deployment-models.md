...
> [!NOTE]
> С помощью хранилищ архивации невозможно защитить решения, развернутые с помощью Resource Manager. Тем не менее вы можете защитить серверы и виртуальные машины, развернутые с помощью классической модели, используя хранилище служб восстановления.  
> 
> 
