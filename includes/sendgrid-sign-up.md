...
6. Введите имя для идентификации своей службы **SendGrid** в параметрах настройки Azure или используйте значение по умолчанию **SendGrid** Имена должны иметь длину в диапазоне от 1 до 100 знаков и содержать только алфавитно-цифровые символы, дефисы, точки и подчеркивания. Имя должно быть уникальным в списке подписанных элементов хранилища Azure.
