...
4. В диалоговом окне **Выбор приложения и службы** укажите **SendGrid** и щелкните стрелку вправо.

5. В диалоговом окне **Персонализация приложения и службы** выберите план **SendGrid**, в котором вы хотите зарегистрироваться.
...
2. В диалоговом окне *Connection info* скопируйте **Пароль** и имя пользователя, чтобы применять их далее в этом руководстве.
