...
5. В диалоговом окне **Настроить надстройку** выберите план **SendGrid**, в котором планируется зарегистрироваться.

6. Введите имя для идентификации своей службы **SendGrid** в параметрах настройки Windows Azure или используйте значение по умолчанию **SendGrid** Имена должны иметь длину в диапазоне от 1 до 100 знаков и содержать только алфавитно-цифровые символы, дефисы, точки и подчеркивания. Имя должно быть уникальным в списке подписанных элементов хранилища Windows Azure.
...
9. На вкладке **Просмотреть приобретение** просмотрите сведения о плане и ценах, а также ознакомьтесь с условиями. Если вы согласны с данными условиями, щелкните флажок. После установки флажка для учетной записи SendGrid начнется процесс подготовки.
...
10. После подтверждения покупки вы будете перенаправлены на панель мониторинга надстроек и увидите сообщение **Приобретение SendGrid**.
	...
	Для изменения плана подписки или просмотра параметров контактов SendGrid выберите имя службы SendGrid, чтобы открыть панель мониторинга надстройки SendGrid. 
...
[Начало работы с SendGrid]: http://docs.sendgrid.com/documentation/get-started/
