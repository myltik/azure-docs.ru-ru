...
[На рисунке 2](#fig2) показан первый из этих вариантов, в котором Azure Active Directory обеспечивает все необходимые возможности.
...
<a id="fig4"></a>Рисунок 4. Azure Active Directory Access Control упрощает для приложений прием маркеров удостоверений, выпускаемых различными поставщиками.
