...
1.  Зарегистрируйте приложение с помощью Azure Active Directory, следуя инструкциям в разделе [Регистрация с помощью Azure Active Directory][Регистрация с помощью Azure Active Directory].

2.  На [портале управления Azure][портале управления Azure] вернитесь к расширению Azure Active Directory и щелкните активный каталог
