...
Прежде чем писать код для своего устройства, разверните предварительно настроенное решение для удаленного мониторинга и добавьте новое физическое устройство в решение.

### <a name="deploy-your-remote-monitoring-preconfigured-solution"></a>Развертывание предварительно настроенного решения для удаленного мониторинга
...
Вы добавили физическое устройство в предварительно настроенное решение для удаленного мониторинга и записали его строку подключения. В следующих разделах реализуется клиентское приложение, которое использует строку подключения устройства для подключения к решению.
