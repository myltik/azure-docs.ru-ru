...
Для работы с этим учебником требуется активная учетная запись Azure. Если ее нет, можно создать бесплатную пробную учетную запись всего за несколько минут. Дополнительные сведения см. в разделе [Бесплатная пробная версия Azure][lnk-free-trial].
...
Созданное устройство отправляет данные в экземпляр предварительно настроенного решения для [удаленного мониторинга][lnk-remote-monitoring]. Посетите страницу [Начало работы с Azure IoT Suite][lnk-getstarted] для подготовки предварительно настроенного решения удаленного мониторинга в вашей учетной записи Azure.

1. На странице https://www.azureiotsuite.com/ нажмите кнопку **+**, чтобы создать решение.

2. Щелкните **Выбрать** на панели **Удаленный мониторинг**, чтобы создать решение.

3. На странице **Создание решения "Удаленный мониторинг"** введите нужное имя в поле **Имя решения**, выберите значение для поля **Регион** и выберите нужную подписку Azure. Затем щелкните **Создать решение**.
...
После подготовки решения для удаленного мониторинга щелкните **Запустить**, чтобы открыть панель мониторинга решения в браузере.
