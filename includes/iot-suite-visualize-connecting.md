...
1. Выберите **FirmwareUpdate** и присвойте заданию имя **UpdatePhysicalChiller**. Задайте для параметра **Версия встроенного ПО** значение **2.0.0**, для параметра **URI встроенного ПО** значение **http://contoso.com/updates/firmware.bin** и нажмите кнопку **Применить**:
