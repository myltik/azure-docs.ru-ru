...
3.  Загрузите **[composer.phar][]** в корневой каталог проекта.
...
1.  Загрузите содержащий библиотеки архив .zip из [GitHub][]. Или же скопируйте репозиторий и клонируйте его на свой локальный компьютер. (Для последнего варианта требуется учетная запись GitHub и наличие установленного локально Git.)
...
Дополнительные сведения об установке клиентских библиотек PHP для Azure (включая сведения об установке как пакет PEAR) см. в разделе [Скачивание пакета SDK Azure для PHP][].
