...
Сведения о просмотре или копировании ключа учетной записи для службы хранилища Azure см. в [этой статье](../articles/storage/storage-create-storage-account.md#manage-your-storage-account).
...
> [!IMPORTANT]
> Теперь фабрика данных Azure поддерживает только **SAS службы**, а не SAS учетной записи. Сведения об этих двух типах и способах их создания см. в разделе [Типы подписанных URL-адресов](../articles/storage/storage-dotnet-shared-access-signature-part-1.md#types-of-shared-access-signatures). Обратите внимание: URL-адрес SAS, который можно создать на портале Azure или в обозревателе хранилищ, является учетной записью SAS, которая не поддерживается в фабрике данных.
> 
