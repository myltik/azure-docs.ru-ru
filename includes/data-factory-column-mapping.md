## <a name="column-mapping-with-translator-rules"></a>Сопоставление столбцов с помощью правил переводчика
...
## <a name="column-mapping-samples"></a>Примеры сопоставления столбцов
> [!NOTE]
