...
1. В меню **Запуск** щелкните элемент **Запуск приложения**.
2. Появится диалоговое окно **Выбор устройства**.
...
1. Выберите либо подключенное устройство, либо команду *Запуск эмулятора*.
2. При отображении приложения введите содержательный текст, например *Завершить работу с учебником*, и нажмите кнопку **Добавить**.
