...
В этой статье будет рассмотрено, как использовать [MongoLab] для создания базы данных MongoDB из [магазина Azure]. [MongoLab] является поставщиком MongoDB, позволяющим запускать и управлять базами данных MongoDB в центрах обработки данных Microsoft Azure и подключаться к ним из любого приложения.
