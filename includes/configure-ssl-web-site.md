...
6.	Щелкните **Увеличить масштаб**.
	
	![Вкладка "Масштаб"][scale]

7.	В разделе **Увеличение масштаба** выберите режим для плана служб приложений, нажав кнопку **Выбрать**.
...
8.	С использованием диалогового окна **загрузки сертификата** выберите файл сертификата .pfx, созданный ранее с помощью диспетчера IIS или OpenSSL. Укажите пароль, используемый для защиты файла .pfx (при наличии). Затем нажмите кнопку **Сохранить**, чтобы передать сертификат.
