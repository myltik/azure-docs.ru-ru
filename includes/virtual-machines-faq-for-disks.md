...
Да. Защита службой ASR в режиме репликации Azure — Azure не поддерживается для виртуальных машин с управляемыми дисками. Ее поддержку планируется реализовать в конце 2018 г. 
