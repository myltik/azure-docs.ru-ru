...
Управляемые диски устраняют ограничения, связанные с учетными записями хранения. Но для одной подписки по умолчанию существует ограничение в 2000 управляемых дисков. Вы можете обратиться в службу поддержки, чтобы увеличить это число.
...
Да. Защита службой ASR в режиме репликации Azure — Azure не поддерживается для виртуальных машин с управляемыми дисками. Ее поддержку планируется реализовать в конце первого квартала 2018 г. 
