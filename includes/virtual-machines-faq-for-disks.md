...
Да. Защита службой ASR в режиме репликации Azure — Azure не поддерживается для виртуальных машин с управляемыми дисками. Он будет поддерживаться в конец Q1 CY2018. 
