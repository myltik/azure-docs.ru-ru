...
9. Чтобы войти с другого компьютера, выполните следующую команду:
...
12. Щелкните **Добавить** в нижней части страницы. ![Endpoints][Image8]

13. Добавьте конечную точку с именем MySQL, протоколом **TCP** и портами **Общий** и **Частный** со значением "3306". Это позволит осуществлять удаленный доступ к MySQL. ![Конечные точки][Image9]
