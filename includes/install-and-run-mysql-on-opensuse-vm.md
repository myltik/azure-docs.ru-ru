...
11. После установки MySQL необходимо настроить конечную точку для удаленного доступа к MySQL. Войдите на [портал управления Windows Azure][AzurePreviewPortal]. На портале управления Windows Azure щелкните **Виртуальные машины** и выберите имя новой виртуальной машины, а затем щелкните **Конечные точки**.
...
14. Для удаленного подключения к MySQL на виртуальной машине OpenSUSE в Windows Azure выполните следующую команду на локальном компьютере:
