...
Просто изменим ваш метод *SendNotificationAsync* путем отправки одного уведомления шаблона.
...
Обратите внимание, что этот простой вызов будет доставлять правильно локализованную часть новостей на **все** ваши устройства, независимо от платформы, так как центр уведомлений создает и доставляет правильные собственные полезные данные на все устройств, подписанные на определенный тег.
