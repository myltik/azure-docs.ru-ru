...
### <a name="to-send-notifications-using-a-c-console-app"></a>Для отправки уведомлений с помощью консольного приложения C#
...
### <a name="sending-the-notification-with-mobile-services"></a>Отправка уведомления с помощью мобильных служб
