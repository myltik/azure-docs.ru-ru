...
В пошаговом руководстве [Пример отправки в облако виртуальных устройств] показано, как использовать [пакет SDK для шлюза IoT Azure][lnk-sdk] для отправки данных телеметрии, передаваемых с устройства в облако, с виртуальных устройств в центр Интернета вещей.
