...
В пошаговом руководстве [Пример отправки в облако виртуальных устройств] показано, как с помощью [пакета SDK для шлюза Центра Интернета вещей Azure][lnk-sdk] отправлять данные телеметрии, передаваемые с имитированных устройств в облако, в Центр Интернета вещей.
...
> [!NOTE]
> Модули не передают сообщения друг другу напрямую. Модули публикуют сообщения во внутренний брокер передачи сообщений, который передает их в другие модули с помощью механизма подписки, как показано на представленной ниже схеме. Дополнительные сведения см. [здесь][lnk-gw-getstarted].
> 
> 
...
<!-- Links -->
[Пример отправки в облако виртуальных устройств]: https://github.com/Azure/azure-iot-gateway-sdk/blob/master/samples/simulated_device_cloud_upload/README.md
