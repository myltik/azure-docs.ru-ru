...
1.	Создайте виртуальную сеть на [портале Azure](http://manage.windowsazure.com). Более подробную информацию можно найти в разделе [Задачи конфигурации виртуальной сети](../documentation/services/virtual-machines/).
