...
> [!NOTE]
> При определении размера и обрезки эскиза следует помнить, что на нем должен присутствовать сценарий поиска и положение для учета прав сторонних лиц согласно [требованиям отображения и использования API поиска](/useanddisplayrequirements.md).
