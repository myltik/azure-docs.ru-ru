...
Информацию об ограничениях конфигурации кэша Redis для Azure вы можете найти в разделе [Конфигурация сервера Redis по умолчанию](../articles/redis-cache/cache-configure.md#default-redis-server-configuration).
