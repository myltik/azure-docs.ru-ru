В этом разделе мы будем изменять модель нашей базы данных посредством добавления нового поля timestamp с именем **CompleteDate**. В этом поле будет записано последнее время, когда был завершен элемент todo. Entity Framework будет обновлять базу данных, на основании изменений нашей модели, используя инициализатор класса базы данных по умолчанию, выводимый из [DropCreateDatabaseIfModelChanges][DropCreateDatabaseIfModelChanges]
