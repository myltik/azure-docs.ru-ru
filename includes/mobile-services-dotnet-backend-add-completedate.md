...
5. Перестройте проект серверной службы .NET todolist и убедитесь в отсутствии ошибок построения. 

Далее вы обновите клиентское приложение для отображения новых данных **CompleteDate**.
