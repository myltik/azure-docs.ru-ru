...
1. Войдите на [портал управления Azure], щелкните **Мобильные службы**, выберите свою мобильную службу, а затем откройте вкладку **Панель мониторинга**.

	![Выбор мобильной службы](./media/mobile-services-enable-source-control/mobile-services-selection.png)
...
3. Укажите **Имя пользователя**, **Новый пароль**, подтвердите пароль, а затем нажмите кнопку «Проверить».
	...
	![Настройка учетных данных системы управления версиями](./media/mobile-services-enable-source-control/mobile-source-control-credentials.png)
