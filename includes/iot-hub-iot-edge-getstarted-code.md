...
В этой статье вы запустили простой шлюз IoT Edge, который записывает сообщения в файл журнала. Сведения о запуске примера, который будет отправлять сообщения в Центр Интернета вещей, см. в статье [Отправка сообщений с устройства в облако с помощью имитации устройства (Linux) с использованием Azure IoT Edge][lnk-gateway-simulated-linux] или [Отправка сообщений с устройства в облако с помощью имитации устройства (Windows) с использованием Azure IoT Edge][lnk-gateway-simulated-windows].
