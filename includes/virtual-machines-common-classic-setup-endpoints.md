...
Чтобы использовать командлет Azure PowerShell для настройки конечных точек, см. раздел [Add-AzureEndpoint](https://msdn.microsoft.com/library/azure/dn495300.aspx). При использовании Azure CLI в режиме управления службами пользуйтесь командой **azure vm endpoint create**.
