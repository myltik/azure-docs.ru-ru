...
5. Найдите дополнительные исправления, перечисленные в приведенной выше таблице (**4011841**), и добавьте каждое из них в корзину.
...
>
> Исправления необходимо скопировать в 3 отдельные папки. Обновление программного обеспечения устройства необходимо скопировать в папку _FirstOrderUpdate_. Все обновления, не нарушающие работу устройства, следует скопировать в папку _SecondOrderUpdate_, а обновления в режиме обслуживания — в папку _ThirdOrderUpdate_.
...
3. Чтобы установить исправление, в командной строке введите следующую команду:
    ...
    Ниже приведен пример выходных данных для установки обновлений первого типа.
...
7. Повторите шаги 3–5, чтобы установить обновления второго типа. Несколько обновлений можно установить, просто запустив командлет `Start-HcsHotfix cmdlet` и указав папку, где находятся обновления второго типа. Командлет выполнит все обновления, доступные в папке. Если обновление уже установлено, логика обновления обнаружит это и не установит его. После установки всех исправлений используйте командлет `Get-HcsSystem`. Необходимые версии:
