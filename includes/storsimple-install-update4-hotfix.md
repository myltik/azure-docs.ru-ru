...
>
> Исправления необходимо скопировать в 3 отдельные папки. Например, обновление программного обеспечения устройства необходимо скопировать в папку _FirstOrderUpdate_. Все обновления, не нарушающие работу устройства, следует скопировать в папку _SecondOrderUpdate_, а обновления в режиме обслуживания — в папку _ThirdOrderUpdate_.
...
7. Повторите шаги 3–5, чтобы установить обновления второго типа. **Для обновлений второго типа можно установить несколько обновлений, просто запустив командлет `Start-HcsHotfix cmdlet` и указав папку, где они находятся. Командлет выполнит все обновления, доступные в папке.** Если обновление уже установлено, логика обновления обнаружит это и не установит его. После установки всех исправлений используйте командлет `Get-HcsSystem`. Необходимые версии:
