...
-	Если используется копирование данных из локального в облачное хранилище или наоборот в формате ORC, а не копирование файлов ORC из источника в приемник в исходном виде, необходимо установить JRE (среду выполнения Java) на компьютере шлюза. 
