...
1. Войдите на [классический портал Azure][классический портал Azure] и в нижней части экрана нажмите кнопку **Создать**.
2. Выберите **Службы данных**, **Хранилище**, **Быстрое создание**, а затем укажите имя учетной записи хранения. Выберите нужный регион и нажмите кнопку **Создать учетную запись хранения**.
...
Для разных типов сред сборки можно явно получить последние выпущенные JAR-файлы из [центрального репозитория Maven][Maven Package] или из [точки распространения выпусков на GitHub](https://github.com/Azure/azure-event-hubs/releases).  
