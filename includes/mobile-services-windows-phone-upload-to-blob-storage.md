...
1. Откройте файл проекта MainPage.xaml.cs и добавьте следующие операторы **using**:
   
        using Microsoft.Phone.Tasks;
        using System.IO;
        using Microsoft.WindowsAzure.Storage.Auth;
        using Microsoft.WindowsAzure.Storage.Blob;
2. В файле проекта MainPage.xaml.cs обновите класс TodoItem, добавив следующие свойства:
...
3. В файле проекта MainPage.xaml.cs обновите класс MainPage. Добавьте следующий код для объявления [CameraCaptureTask] и объект потока, который будет ссылаться на записанное изображение:
...
4. В файле проекта MainPage.xaml.cs обновите класс MainPage. Добавьте следующий код, чтобы обновить конструктор для создания CameraCaptureTask и добавления обработчика события для события Completed:
...
5. В файле проекта MainPage.xaml.cs обновите класс MainPage. Добавьте следующий код, который отображает пользовательский интерфейс камеры, чтобы пользователь мог сохранять изображение при нажатии кнопки **Запись изображения**:
   
        private void ButtonCaptureImage_Click(object sender, RoutedEventArgs e)
        {
            cameraCaptureTask.Show();
        }
6. В файле проекта MainPage.xaml.cs обновите класс MainPage. Замените существующий метод `InsertTodoItem` следующим кодом:
...
6. Новый элемент отображается в представлении списка вместе с переданным изображением.
   ...
   > [!NOTE]
   > Изображение автоматически скачивается из службы хранилища больших двоичных объектов, когда свойство <code>imageUri</code> нового элемента привязано к элементу управления <strong>Изображение</strong>.
   > 
   > 
