...
* [Best Practices for Azure Functions](../articles/azure-functions/functions-best-practices.md) (Рекомендации по Функциям Azure)
...
* [Масштабирование функций Azure](../articles/azure-functions/functions-scale.md)  
...
* [Что такое служба приложений Azure?](../articles/app-service/app-service-value-prop-what-is.md)  
