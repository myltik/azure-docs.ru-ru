...
2.	На странице **Создание мобильной службы** выберите **Создать бесплатную базу данных SQL на 20 МБ**, выберите среду выполнения **.NET**, введите имя поддомена для новой мобильной службы в текстовом поле **URL-адрес**. Нажмите кнопку со стрелкой вправо, чтобы перейти к следующей странице.
