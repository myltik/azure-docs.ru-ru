В следующей таблице перечислены квоты и ограничения для концентраторов событий Azure. См. сведения о [ценах на концентраторы событий](https://azure.microsoft.com/pricing/details/event-hubs/).
...
| Число правил авторизации для каждого пространства имен |Пространство имен|Статическое |Последующие запросы на создание правила авторизации будут отклонены.|12 |
