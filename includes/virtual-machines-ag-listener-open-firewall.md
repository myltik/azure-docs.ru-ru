...
4. На странице **Протокол и порты** выберите **TCP** и введите **59999** в поле **Определенные локальные порты**. Нажмите кнопку **Далее**.
...
7. На странице **Имя** укажите имя правила, например **Порт пробы прослушивателя AlwaysOn**, в текстовом поле **Имя** и нажмите кнопку **Готово**.
