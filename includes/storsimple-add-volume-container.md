...
2. В нижней части страницы нажмите кнопку **Добавить**. В диалоговом окне **Создание контейнера томов** выполните указанные ниже действия.
  ...
  5. Введите **ключ шифрования облачного хранилища**, содержащий от 8 до 32 символов. Этот ключ используется устройством для доступа к зашифрованным данным. В поле **Подтвердить ключ шифрования облачного хранилища** снова введите ключ шифрования облачного хранилища, чтобы подтвердить его. Параметр шифрования нельзя изменить после создания контейнера томов. 
...
Контейнер томов будет сохранен и появится в списке на странице **Контейнер томов** в качестве нового контейнера.
