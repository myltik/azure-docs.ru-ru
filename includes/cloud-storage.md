...
&lt;*StorageAccount*&gt; — уникальный идентификатор, назначаемый при создании новой учетной записи хранения, а &lt;*Container*&gt; и &lt;*BlobName*&gt; — имя контейнера и имя большого двоичного объекта в этом контейнере соответственно.
