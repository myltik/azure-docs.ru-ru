...
В зависимости от способа и времени создания группы безопасности сети вы можете создать стандартные правила, которые разрешают доступ по протоколу RDP через TCP-порт 3389. Виртуальные машины Linux разрешают доступ по протоколу SSH через TCP-порт 22. Эти автоматические правила ACL будут созданы при следующих условиях.
...
При других условиях эти стандартные правила ACL не создаются. Вы не сможете подключиться к виртуальной машине, если не создадите соответствующие правила ACL. Чтобы подключиться к виртуальной машине, выполните следующие действия.
