...
**Последнее обновление документа**: 22 января 15:00 по тихоокеанскому времени.
...
> [!NOTE] 
> Все меры по устранению рисков, объявленные для Azure 3 января 2018 года, остаются действительными после недавнего [обновления рекомендаций](https://newsroom.intel.com/news/root-cause-of-reboot-issue-identified-updated-guidance-for-customers-and-partners/) корпорации Intel. Эти обновления не требуют дополнительных действий на виртуальных машинах клиентов.
>
> Мы будем продолжать обновлять эти рекомендации по мере получения обновлений микрокода от поставщиков оборудования. Проверяйте доступность обновленных рекомендаций.
>
