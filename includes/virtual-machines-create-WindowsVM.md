1. Войдите на [портал управления Azure](http://manage.windowsazure.com). Воспользуйтесь [бесплатной пробной версией](http://www.windowsazure.com/pricing/free-trial/), если у вас пока нет подписки.
...
6. На третьем экране можно настроить ресурсы сети, хранилища и доступности. Вот как это сделать. 
	...
	- Сведения о настройке конечных точек см. в разделе [Настройка конечных точек с виртуальной машиной](http://www.windowsazure.com/documentation/articles/virtual-machines-set-up-endpoints/).
