...
- [Как настроить виртуальную машину Linux при первой загрузке](../articles/virtual-machines/linux/tutorial-automate-vm-deployment.md)
