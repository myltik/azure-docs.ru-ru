...
| **routeTable** |Таблица маршрутизации подсети. |См. раздел [Определяемые пользователем маршруты](#Route-table). |
| **ipConfigurations** |Коллекция объектов конфигурации IP, используемых сетевыми картами, подключенными к подсети. |См. раздел [Определяемые пользователем маршруты](#Route-table). |
