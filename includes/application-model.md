...
-   [Определение и настройка размещенной службы][]
...
-   **Локальное хранилище**. Выделяет подкаталог на экземпляре роли, используемый вашим приложением. Более подробное описание см. в статье [Предлагаемые варианты хранения данных для платформы Azure][].
...
Подробнее о развертывании, обновлении и повторной настройке ролей см. в статье [Развертывание и обновление приложений Azure][].<a id="Ref" name="Ref"></a>
