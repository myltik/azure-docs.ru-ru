...
| Свойство | Описание |
|---|---|
|**Метод маршрутизации трафика**| возможные значения: *Performance* (производительный), *Weighted* (взвешенный) и *Priority* (приоритетный) | 
| **Настройка DNS** | полное доменное имя для профиля | 
