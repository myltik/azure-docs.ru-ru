...
Пошаговое руководство по созданию автомасштабируемого набора см. в статье [Автоматическое масштабирование машин в масштабируемом наборе виртуальных машин](virtual-machines-windows-ps-vmss-create.md).
