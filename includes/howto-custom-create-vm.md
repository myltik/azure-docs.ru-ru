...
11. Во вкладке **Облачная служба** выполните одно из следующих действий:
	...
	> [AZURE.NOTE]Дополнительную информацию о размещении виртуальных машин в той же облачной службе см. в разделе [Подключение к виртуальным машинам в облачной службе](http://www.windowsazure.com/manage/windows/how-to-guides/connect-to-a-cloud-service/).
