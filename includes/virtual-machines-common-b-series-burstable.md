...
| Размер          | Виртуальный процессор | Память, ГиБ | Локальный SSD: ГиБ | Базовая производительность ЦП виртуальной машины | Максимальная производительность ЦП виртуальной машины | Накопленных кредитов/час | Максимальное число накопленных кредитов |
|---------------|--------|-------------|----------------|--------------------------------|---------------------------|-----------------------|--------------------|
...
## <a name="q--a-about-this-preview"></a>Вопросы и ответы об этой предварительной версии

### <a name="q-how-can-i-participate-in-this-preview"></a>Вопрос. Как получить возможность использовать эту предварительную версию?
**Ответ.** Запросите квоту для серии B в одном из поддерживаемых регионов.  После утверждения квоты вы можете выполнить развертывание с помощью портала или API-интерфейсов, как обычно. Дополнительные сведения см. в статье [Запросы на увеличение квоты ядер Resource Manager](../articles/azure-supportability/resource-manager-core-quotas-request.md).
...
### <a name="q-is-there-a-discount-on-price-during-the-preview"></a>Вопрос. Доступны ли скидки на этапе предварительной версии?
**Ответ.** Да, стоимость предварительной версии можно узнать на [странице цен](http://aka.ms/vmsizes).
...
### <a name="q-which-regions-can-i-access-the-preview-from"></a>Вопрос. В каких регионах есть доступ к предварительной версии?
**Ответ.** Предварительная версия серии B будет доступна в следующих регионах:
- Западная часть США 2
- Восточная часть США
- Западная Европа
- Юго-восточная часть Азиатско-Тихоокеанского региона

После завершения этапа предварительной версии серия B станет доступна всех остальных регионах.
