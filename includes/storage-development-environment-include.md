...
Вы можете использовать клиентскую библиотеку службы хранилища Azure из любого приложения .NET, в том числе из облачной службы Azure, веб-приложения Azure, классического приложения или мобильного приложения. Для упрощения в этом руководстве мы будем использовать консольное приложение.
