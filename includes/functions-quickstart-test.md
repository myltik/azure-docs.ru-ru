...
1. На вкладке **Разработка** в окне **Код** убедитесь, что этот код ожидает HTTP-запрос со значением свойства *name*, передаваемым либо в тексте сообщения, либо в строке запроса. При выполнении функции это значение возвращается в сообщении с ответом. В примере ниже показана функция JavaScript.
