...
Для среды выполнения в следующей команде задано значение `NODE|8.1`. Чтобы просмотреть все поддерживаемые среды выполнения, выполните команду [az webapp list-runtimes](/cli/azure/webapp#list-runtimes). 
