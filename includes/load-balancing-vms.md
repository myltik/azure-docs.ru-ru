...
Дополнительную информацию см. в разделе [Диспетчер трафика][Диспетчер трафика].
...
Дополнительную информацию см. в разделе [Подсистема балансировки нагрузки Azure][Подсистема балансировки нагрузки Azure]. Указания по созданию набора балансировки нагрузки см. в разделе [Настройка комплекта балансировки нагрузки][Настройка комплекта балансировки нагрузки].
...
На следующем рисунке показан пример конечной точки с внутренней балансировкой нагрузки бля бизнес-приложения, которое является общим для трех виртуальных машин в виртуальной сети с подключением между организациями.

![балансировка нагрузки][2]

Дополнительную информацию см. в разделе [Внутренняя балансировка нагрузки][Внутренняя балансировка нагрузки]. Указания по созданию набора балансировки нагрузки см. в разделе [Настройка внутреннего набора с балансировкой нагрузки][Настройка внутреннего набора с балансировкой нагрузки].

<!-- LINKS -->

  [О методах балансировки нагрузки диспетчера трафика]: http://msdn.microsoft.com/ru-ru/library/azure/dn339010.aspx
  [балансировка нагрузки]: ./media/load-balancing-vms/TMSummary.png
  [Диспетчер трафика]: http://msdn.microsoft.com/ru-ru/library/azure/hh745750.aspx
  [1]: ./media/load-balancing-vms/LoadBalancing.png
  [Подсистема балансировки нагрузки Azure]: http://msdn.microsoft.com/ru-ru/library/azure/dn655058.aspx
  [Настройка комплекта балансировки нагрузки]: http://msdn.microsoft.com/ru-ru/library/azure/dn655055.aspx
  [2]: ./media/load-balancing-vms/LOBServers.png
  [Внутренняя балансировка нагрузки]: http://msdn.microsoft.com/ru-ru/library/azure/dn690121.aspx
  [Настройка внутреннего набора с балансировкой нагрузки]: http://msdn.microsoft.com/ru-ru/library/azure/dn690125.aspx
