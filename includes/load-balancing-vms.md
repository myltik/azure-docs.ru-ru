...
Дополнительные сведения см. в разделе [Сведения о методах балансировки нагрузки диспетчера трафика](http://msdn.microsoft.com/ru-ru/library/azure/dn339010.aspx).
...
Дополнительные сведения см. в разделе [Диспетчер трафика](http://msdn.microsoft.com/ru-ru/library/azure/hh745750.aspx).
...
Дополнительные сведения см. в разделе [Подсистема балансировки нагрузки Azure](http://msdn.microsoft.com/ru-ru/library/azure/dn655058.aspx). Указания по созданию набора балансировки нагрузки см. в разделе [Настройка комплекта балансировки нагрузки](http://msdn.microsoft.com/ru-ru/library/azure/dn655055.aspx).
...
Дополнительные сведения см. в разделе [Внутренняя балансировка нагрузки](http://msdn.microsoft.com/ru-ru/library/azure/dn690121.aspx). Указания по созданию набора балансировки нагрузки см. в разделе [Настройка внутреннего набора с балансировкой нагрузки](http://msdn.microsoft.com/ru-ru/library/azure/dn690125.aspx).
