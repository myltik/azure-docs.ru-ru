...
При создании приложения в Azure служба Azure предоставляет поддомен в домене cloudapp.net, чтобы пользователи могли получить доступ к приложению по такому URL-адресу, как [http://\<\*myapp][http://\<\*myapp]\*\>.cloudapp.net. Однако вы можете предоставить собственное доменное имя, например contoso.com.
