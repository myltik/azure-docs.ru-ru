...
> [!NOTE]
> Процедуры в этом задании применяются для облачных служб Azure. Сведения об учетных записях хранения см. в разделе [Настройка пользовательского доменного имени для учетной записи хранения Azure](../articles/storage/storage-custom-domain-name.md). Сведения о веб-сайтах см. в разделе [Настройка пользовательского доменного имени для веб-сайта Azure](../articles/app-service-web/web-sites-custom-domain-name.md).
> 
> 
...
4. Необходимо также указать псевдоним домена или дочернего домена для CNAME, такой как **www**, если вы хотите создать псевдоним для **www.customdomain.com**. Если вы хотите создать псевдоним для корневого домена, он может отображаться как символ "**@**" в средствах DNS вашего регистратора.
...
## Дальнейшие действия
* [Управление облачными службами](../articles/cloud-services/cloud-services-how-to-manage.md)
* [Сопоставление содержимого CDN с личным доменом][Сопоставление содержимого CDN с личным доменом]
