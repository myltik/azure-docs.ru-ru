## <a name="a-namecreate-clientacreate-a-client-connection"></a><a name="create-client"></a>Создание подключения клиента
...
## <a name="a-nametable-referenceawork-with-tables"></a><a name="table-reference"></a>Работа с таблицами
...
### <a name="a-namequeryingahow-to-query-a-table-reference"></a><a name="querying"></a>Практическое руководство. Запрос ссылки на таблицу
...
#### <a name="a-nametable-filterafiltering-data-on-the-server"></a><a name="table-filter"></a>Фильтрация данных на сервере
...
#### <a name="a-nametable-pagingapaging-through-data"></a><a name="table-paging"></a>Разбиение данных по страницам
