...
5. Укажите значения для следующих свойств сервера:
 ...
 - Пароль
 - подписка (только если у вас есть несколько подписок);
...
6.  Щелкните **Создать**. В области уведомлений вы увидите, что развертывание началось.
       ...
       ![новый логический сервер](./media/sql-database-create-new-server-portal/sql-database-create-new-server-portal-5.png)
