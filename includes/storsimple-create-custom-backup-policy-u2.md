...
6. В разделе **Определение расписания**:
    ...
    4. Выберите расписание хранения из раскрывающегося списка. Возможные периоды хранения зависят от периодичности резервного копирования. Например, для ежедневной политики резервного копирования период хранения можно указать в неделях, а для ежемесячной — в месяцах.
