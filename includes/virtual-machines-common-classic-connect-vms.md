...
1. Создайте облачную службу на [классическом портале Azure](http://manage.windowsazure.com). Щелкните **Создать > Вычисления > Облачная служба > Создать пользовательскую службу**. Создать облачную службу для развертывания также можно в момент создания первой виртуальной машины.
