...
4. В левом столбце разверните пункт **API и проверка подлинности**, щелкните **API-интерфейсы**, прокрутите список вниз и щелкните переключатель, чтобы включить службу **Google Cloud Messaging для Android**. На следующей странице щелкните **Включить API** и примите условия предоставления услуг.
