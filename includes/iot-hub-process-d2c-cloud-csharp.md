...
1. В текущем решении Visual Studio последовательно выберите **Файл**, **Добавить**, **Новый проект**, чтобы создать проект Visual C# Windows с помощью шаблона проекта **Консольное приложение**. Присвойте проекту имя **ProcessDeviceToCloudMessages**.
