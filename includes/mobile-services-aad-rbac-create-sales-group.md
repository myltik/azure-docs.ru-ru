...
1.  Перейдите на [портале управления Azure] в каталог, настроенный для проверки подлинности при завершении учебника [Начало работы с проверкой подлинности].
