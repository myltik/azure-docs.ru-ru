...
2. Нажмите кнопку **Создать**. В поле **Поиск по Marketplace** введите "виртуальная сеть". В результатах поиска найдите и щелкните **Виртуальная сеть**, чтобы открыть страницу **Виртуальная сеть**.
