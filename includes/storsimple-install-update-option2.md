...
7. Теперь можно [установить обновление 1.2 с помощью классического портала Azure](#install-update-12-via-the-azure-portal). Следуйте инструкциям, начиная с шага 3 описанной процедуры. После установки всех обновлений можно повторно включить отключенный сетевой интерфейс.
