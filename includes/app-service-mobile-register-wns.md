...
5. Перейдите в [Центр разработки для Windows](https://dev.windows.com/ru-RU/overview), войдите с помощью учетной записи Майкрософт, щелкните "Регистрация нового приложения" в области **Мои приложения**, а затем разверните **Службы** > **Push-уведомления**.
6. На странице **Push-уведомления** в разделе **Службы push-уведомлений Windows (WNS) и мобильные службы Microsoft Azure** щелкните **сайт служб Live** и запишите значение **ИД безопасности пакета** и *текущее* значение **секрета приложения**.
