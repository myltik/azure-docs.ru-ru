...
2. В метод Register после определения **ConfigOptions** добавьте следующий код:
	...
	Это запускает аутентификацию пользователя перед регистрацией для получения push-уведомлений. 

2. Щелкните проект правой кнопкой мыши, выберите пункт**Добавить**, затем выберите **Класс...**.

3. Назовите новый пустой класс  `PushRegistrationHandler`, затем щелкните **Добавить**.
