...
* **Компьютеры под управлением Windows с установленным и настроенным Azure PowerShell 0.8.7 или более поздней версии**. См. статью [Установка и настройка Azure PowerShell](../articles/powershell-install-configure.md). Скрипт выполняется в службе управления Azure.
