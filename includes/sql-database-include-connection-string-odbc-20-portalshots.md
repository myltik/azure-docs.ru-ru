...
6. Если вы планируете использовать библиотеку подключений ODBC, скопируйте строку с меткой **ODBC (включает Node.js)**.

	![Копирование строки подключения ODBC для базы данных][3-get-connection-string]
