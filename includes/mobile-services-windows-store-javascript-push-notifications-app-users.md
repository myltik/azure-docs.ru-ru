...
1. В Visual Studio откройте в обозревателе решений файл проекта push.register.js и закомментируйте или удалите вызов **addEventListener**. 
...
2. Переместите эту строку кода в функцию **login** до вызова **refreshTodoItems**. Функция **login** выглядит следующим образом.
