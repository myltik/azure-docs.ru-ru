...
1. В обозревателе решений Visual Studio откройте файл проекта app.xaml.cs и в обработчике событий **Application_Launching** закомментируйте или удалите вызов метода **AcquirePushChannel**. 
