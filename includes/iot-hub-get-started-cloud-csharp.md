...
3. В окне **Диспетчер пакетов NuGet** убедитесь, что флажок **Включить предварительные выпуски** установлен. Найдите **WindowsAzure.ServiceBus**, щелкните **Установить** и примите условия использования.
