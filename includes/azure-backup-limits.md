...
|---|---|
|Количество серверов и компьютеров, которые можно зарегистрировать для каждого хранилища|50 для Windows Server/Client/SCDPM <br/> 100 для виртуальных машин IaaS|
