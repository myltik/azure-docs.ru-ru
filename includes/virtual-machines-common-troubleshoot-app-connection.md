Проблемы с подключением к приложению, запущенном на виртуальной машине Azure, возникают в силу разных причин. Например, приложение не работает на ожидаемых портах и не прослушивает их или прослушивает заблокированный порт, или сетевые правила неправильно передают трафик приложению. В этой статье описываются методы поиска и устранения неисправностей.
