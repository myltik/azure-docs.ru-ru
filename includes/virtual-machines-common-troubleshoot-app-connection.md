...
- Повторно создайте конечную точку, правила брандмауэра и правила группы безопасности сети.
	- [Управление конечными точками облачных служб](../articles/cloud-services/cloud-services-enable-communication-role-instances.md)
	- [Управление группами безопасности сети](../articles/virtual-network/virtual-networks-create-nsg-arm-pportal.md)
...
- Для виртуальных машин, созданных с помощью классической модели развертывания, конфигурация конечной точки для виртуальной машины разрешает входящий трафик, в частности для протокола (TCP или UDP), а также общедоступных и частных номеров портов.
...
- Для виртуальных машин, созданных с помощью классической модели развертывания, списки управления доступом (ACL) для конечной точки не блокируют входящий трафик из Интернета.
	- Дополнительные сведения см. в разделе [Настройка конечных точек виртуальной машины](../articles/virtual-machines/virtual-machines-windows-classic-setup-endpoints.md).
