...
4. Введите **Y**, когда будет предложено подтвердить установку исправлений.
   ...
   > [!IMPORTANT]
   > В случае установки обновления 2.2 установите только двоичный файл, имя которого начинается с all-hcsmdssoftwareudpate. Не устанавливайте обновление агента Cis и MDS, имя которого начинается с all-cismdsagentupdatebundle. В противном случае произойдет сбой.
   > 
   > 
...
1. Когда установка обновления будет завершена, проверьте версии программного обеспечения системы. Тип:
   ...
   * `MdsAgentVersion: 30.0.4698.16`
     ...
     > 
     > 
2. Повторите шаги 3–5 для установки оставшихся обычных исправлений.
   
   * обновление KB3146621 для iSCSI;
   * обновление KB3103616 для WMI.
3. Этот шаг можно пропустить, если обновление выполняется с обновления 2. При обновлении с более ранней версии, чем обновление 2, также необходимо скачать:
