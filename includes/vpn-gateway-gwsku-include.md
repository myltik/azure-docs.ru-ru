...
| VpnGw1, VpnGw2, VpnGw3 |VPN-шлюзы на основе маршрутов с поддержкой до 30 туннелей* <br>P2S, BGP, режим "активный — активный", пользовательские политики IPsec и IKE, совместимость ExpressRoute с VPN |
|        |             |
