...
* Для приложения API .NET необходимо получать максимум сведений в сообщениях об ошибках. Для этого [отключите режим customErrors](../articles/app-service-web/web-sites-dotnet-troubleshoot-visual-studio.md#remoteview).
