...
Правила безопасности по умолчанию имеют те же свойства, что и правила безопасности. Они существуют для обеспечения базовых подключений между ресурсами, к которым применены группы безопасности сети. Вам следует знать, какие существуют [правила безопасности по умолчанию](../articles/virtual-network/virtual-networks-nsg.md#default-rules).
