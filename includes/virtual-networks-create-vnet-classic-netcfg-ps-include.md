...
6. В консоли Azure PowerShell воспользуйтесь командлетом **Set-AzureVnetConfig** для передачи файла конфигурации сети, выполнив указанную ниже команду. После выполнения команды вы увидите значение **Успешно** в разделе **OperationStatus**. Если это не так, проверьте XML-файл на наличие ошибок.
