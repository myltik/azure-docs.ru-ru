...
>[AZURE.NOTE] Пакет SDK для Android для мобильных служб обновлен до версии 2.0. Если ранее вы ознакомились с двумя указанными учебниками и в них не использовался обновленный пакет SDK, вам необходимо ознакомиться с этими учебниками повторно. Чтобы проверить, какую версию пакета SDK использует приложение, откройте его в Eclipse и проверьте содержимое папки **libs**. JAR-файлы мобильных служб должны быть обозначены версией 2.0 или более поздней.
