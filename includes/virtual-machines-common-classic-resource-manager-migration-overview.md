...
| Сеть |ExpressRoute со ссылками авторизации (см. часто задаваемые вопросы), шлюз приложения. | Удалите шлюз до начала миграции и повторно создайте его по ее завершении. |
