...
2. На вкладке **Веб-приложения** щелкните имя веб-приложения, выберите **Параметры**, а затем выберите **Личные домены и SSL**.
...
6. Щелкните флажок в правом нижнем углу для сохранения конфигурации доменного имени.
	...
	После завершения настройки личное имя домена будет указано в разделе **имен доменов** колонки **Личные домены и SSL** веб-приложения.
