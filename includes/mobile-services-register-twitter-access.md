...
2. Перейдите на веб-сайт <a href="http://go.microsoft.com/fwlink/p/?LinkId=268300" target="_blank">разработчиков Twitter</a>, войдите, используя данные учетной записи Twitter, перейдите к пункту **Мои приложения** и выберите свое приложение Twitter.
...
[Параметры приложения]: http://msdn.microsoft.com/library/windowsazure/b6bb7d2d-35ae-47eb-a03f-6ee393e170f7<!--HONumber=42-->
