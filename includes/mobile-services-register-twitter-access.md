...
1. Если это еще не сделано, выполните действия, описанные в разделе [Регистрация приложений для входа в Twitter с помощью мобильных служб](../../includes/mobile-services-how-to-register-twitter-authentication.md). 
