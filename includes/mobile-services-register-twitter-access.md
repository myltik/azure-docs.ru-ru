...
1. Если это еще не сделано, выполните действия, описанные в разделе [Регистрация приложений для входа в Twitter с помощью мобильных служб](../articles/mobile-services/mobile-services-how-to-register-twitter-authentication.md). 
...
2. Перейдите на веб-сайт [разработчиков Twitter](http://go.microsoft.com/fwlink/p/?LinkId=268300), войдите, используя данные учетной записи в этой сети, и выберите свое приложение для Twitter.
