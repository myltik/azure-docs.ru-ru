...
- [(Универсальное приложение для Windows (C#) | .NET)](../articles/mobile-services-dotnet-backend-windows-store-universal-get-started-data.md)
- [(Универсальное приложение для Windows (C#) | Javascript)](../articles/mobile-services-javascript-backend-windows-universal-dotnet-get-started-data.md)
- [(Магазин Windows (JavaScript) | Javascript)](../articles/mobile-services-windows-store-javascript-get-started-data.md)
