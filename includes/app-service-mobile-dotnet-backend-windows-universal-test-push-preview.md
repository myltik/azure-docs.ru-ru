...
1. Щелкните правой кнопкой мыши проект для Магазина Windows, выберите пункт **Назначить запускаемым проектом** и нажмите клавишу F5, чтобы запустить приложение Магазина Windows.
...
3. Запустите приложение Магазина Windows, введите текст в поле **Добавление пункта в список дел** и нажмите кнопку **Сохранить**.
