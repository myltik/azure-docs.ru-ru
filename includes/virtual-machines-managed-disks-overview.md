...
[Шифрование службы хранилища Azure](../articles/storage/common/storage-service-encryption.md) предоставляет возможность шифрования неактивных данных и защищает данные в соответствии с предложениями по безопасности и соответствию вашей организации. Шифрование службы хранилища включено по умолчанию для всех компонентов "Управляемые диски", моментальных снимков и образов во всех регионах, где доступны управляемые диски. Начиная с 10 июня 2017 года для всех новых управляемых дисков, моментальных снимков, образов и данных, записываемых на имеющиеся управляемые диски, автоматически выполняется шифрование неактивных данных с помощью ключей, управляемых корпорацией Майкрософт по умолчанию. Вы можете использовать собственный ключ для шифрования больших двоичных объектов и файлов Azure. Для шифрования таблиц и очередей всегда будут использоваться ключи, управляемые корпорацией Майкрософт.
Обратите внимание, что после включения шифрования службы хранилища будут шифроваться только новые данные, а все имеющиеся файлы в этой учетной записи хранения будут зашифрованы ретроспективно с помощью фонового процесса шифрования. Дополнительные сведения см. в статье [Часто задаваемые вопросы о дисках виртуальных машин Azure IaaS, а также об управляемых и неуправляемых дисках класса "Премиум"](../articles/virtual-machines/windows/faq-for-disks.md#managed-disks-and-storage-service-encryption).
