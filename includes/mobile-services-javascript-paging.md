...
1. В Visual Studio откройте проект, измененный после изучения учебника **Приступая к работе с данными**.

2. Нажмите клавишу **F5**, чтобы запустить приложение, затем введите текст в поле **Вставить TodoItem** и нажмите кнопку **Сохранить**.
