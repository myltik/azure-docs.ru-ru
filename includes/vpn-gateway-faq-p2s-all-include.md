...
### <a name="can-i-access-the-internet-when-i-am-connected-over-p2s-vpn"></a>Можно ли получить доступ к Интернету при VPN-подключении типа "точка — сеть"?

Да, вы можете получить доступ к Интернету, используя VPN-подключение типа "точка — сеть".
...
### <a name="i-already-have-an-azure-vpn-gateway-deployed-can-i-enabled-radius-andor-ikev2-vpn-on-it"></a>У меня уже развернут VPN-шлюз Azure. Можно ли включить на нем RADIUS и (или) IKEv2 для VPN?

Да, эти новые функции можно включить на уже развернутых шлюзах с помощью PowerShell и портала Azure.