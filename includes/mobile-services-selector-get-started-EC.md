...
- [(Универсальное приложение для Windows (C#) | .NET)](../articles/mobile-services-dotnet-backend-windows-store-dotnet-get-started.md)
- [(Универсальное приложение для Windows (C#) | Javascript)](../articles/mobile-services-javascript-backend-windows-store-dotnet-get-started.md)
- [(Универсальное приложение для Windows (JavaScript) | .NET)](../articles/mobile-services-dotnet-backend-windows-store-javascript-get-started.md)
- [(Универсальное приложение для Windows (JavaScript) | Javascript)](../articles/mobile-services-javascript-backend-windows-store-javascript-get-started.md)
