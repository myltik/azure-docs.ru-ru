...
2. В диалоговом окне *Connection info* вы увидите код приложения, ключ и секрет. Эти значения будут использоваться позже в этом учебнике, поэтому скопируйте их.
