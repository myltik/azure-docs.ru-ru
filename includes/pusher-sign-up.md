Первый шаг - создание учетной записи для использования с учебником. Можно использовать бесплатный план изолированной среды, он идеально подходит для этого учебника.
...
5. В диалоговом окне **Настроить надстройку** выберите **Pusher**, в котором планируется зарегистрироваться.

6. Введите имя для идентификации своей службы **Pusher** в параметрах настройки Azure или используйте значение **Pusher** по умолчанию. Имена должны иметь длину в диапазоне от 1 до 100 знаков и содержать только алфавитно-цифровые символы, дефисы, точки и подчеркивания. Имя должно быть уникальным в списке элементов Магазина Azure, на которые вы подписались.
...
Учетная запись Pusher была создана сразу же, вы увидите сообщение **Надстройка Pusher успешно приобретена**. Ваша учетная запись создана, и теперь вы готовы к использованию службы Pusher.
