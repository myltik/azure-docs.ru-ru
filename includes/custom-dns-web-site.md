...
> 
> [!NOTE]
> Записи A не могут использоваться для балансировки с помощью Traffic Manager. Дополнительные сведения см. в разделе [Управление трафиком веб-сайтов Azure с помощью Azure Traffic Manager][trafficmanager].
> 
> 
...
4. Необходимо также указать псевдоним домена или поддомена для CNAME. Например, выберите **www**, если вы хотите создать псевдоним для **www.customdomain.com**. Если вы хотите создать псевдоним для корневого домена, он может быть указан как символ **@** в инструментах DNS вашего регистратора.
