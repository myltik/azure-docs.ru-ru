...
1. Добавление поддержки Docker в веб-проект ASP.NET 5 приводит к добавлению в проект нескольких связанных с Docker файлов, включая файлы Docker-Compose, скрипты развертывания Windows PowerShell и файлы свойств Docker.
