``*.accesscontrol.windows.net``. Используется для управления доступом и идентификаторами. (Аутентификация на основе ACS будет считаться нерекомендуемой с декабря 2017 г.) <br/><br/>
