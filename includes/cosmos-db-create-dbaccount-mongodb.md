...
3. В области **Новая учетная запись** укажите желаемую конфигурацию учетной записи Azure Cosmos DB. 
    ...
    Заполните область **Новая учетная запись**, используя сведения в таблице.
 
    ![Снимок экрана новой области Azure Cosmos DB](./media/cosmos-db-create-dbaccount-mongodb/create-nosql-db-databases-json-tutorial-2.png)
