...
3. В подписках Azure для импорта нажмите **Загрузить файл подписки**, войдите в учетную запись Azure (если требуется), нажмите **Сохранить**, затем обозреватель запросит сохранить файл.
