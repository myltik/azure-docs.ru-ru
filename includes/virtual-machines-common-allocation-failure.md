...
> [!NOTE]
> Ошибки, перечисленные в каждом сценарии выделения, приведены в короткой форме. Для получения дополнительных сведений о строках ошибок используйте [поиск по строкам ошибок](#Error string lookup).
> 
> 
