1. Откройте файл проекта mainpage.xaml.cs и добавьте следующий фрагмент кода в класс MainPage:
   ...
   > [!NOTE]
   > Если используется поставщик удостоверений, отличный от Twitter, измените значение <strong>MobileServiceAuthenticationProvider</strong> выше на значение для вашего поставщика.</p> </div>
   > 
   > 
