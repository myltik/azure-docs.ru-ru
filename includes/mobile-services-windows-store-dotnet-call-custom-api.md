...
1. В Visual Studio откройте файл MainPage.xaml в проекте быстрого запуска, найдите элемент **Кнопка** с именем `ButtonRefresh` и замените его следующим кодом XAML: 
...
3. Найдите метод **RefreshTodoItems** в классе **MainPage** и убедитесь, что `запрос` определен с помощью следующего метода **Where**:
...
1. В Visual Studio нажмите клавишу **F5** для повторного построения проекта, после чего запустите приложение.
