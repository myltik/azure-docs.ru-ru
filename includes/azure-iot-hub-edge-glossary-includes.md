...
Azure IoT Edge обеспечивает развертывание основе облачных служб Azure и код для конкретного решения для локальных устройств. Устройства с IoT Edge могут собирать данные с других устройств для выполнения вычислений и аналитики перед отправкой данных в облако. Дополнительные сведения см. в статье [Edge Интернета вещей Azure](https://docs.microsoft.com/en-us/azure/iot-edge/).
...
## <a name="iot-edge-priority"></a>Приоритет IoT Edge
...
## <a name="iot-edge-target-condition"></a>Целевое условие IoT Edge
