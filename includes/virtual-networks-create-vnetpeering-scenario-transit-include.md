...
Примечание. Для простоты здесь предполагается, что все виртуальные сети находятся в одной подписке. Но указанные здесь сведения также применимы для сценариев с использованием нескольких подписок.

Ключевым свойством для включения транзитной маршрутизации является параметр "Разрешить перенаправленный трафик". Он делает возможным прием и отправку трафика с виртуального сетевого устройства и на него в пределах виртуальной сети, участвующей в пиринге.
