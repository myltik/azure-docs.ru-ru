...
Для подключения существующего диска требуется VHD-файл в учетной записи хранения. Для отправки VHD-файла в учетную запись хранения используйте командлет [Add-AzureVhd](http://go.microsoft.com/FWLink/p/?LinkID=391684). После создания и отправки VHD-файла можно подключить его к виртуальной машине. 
