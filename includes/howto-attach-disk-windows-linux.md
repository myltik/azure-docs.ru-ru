Дополнительные сведения о дисках в виртуальных машинах Azure см. в разделе [Сведения о дисках виртуальных машин Azure][].
...
2.  На панели команд нажмите **Присоединить** и выберите **Присоединить пустой диск**.
    ...
    ![Присоединить новый пустой диск][]
...
5.  Установите флажок, чтобы присоединить пустой диск данных.
    ...
    ![Пустой диск данных успешно подключен][]

## <span id="attachexisting"></span></a>Практическое руководство. Подключение существующего диска

Для подключения существующего диска требуется VHD-файл в учетной записи хранения. Для загрузки VHD-файла учетной записи хранения используйте командлет [Добавить AzureVhd][]. После создания и отправки VHD-файла можно подключить его к виртуальной машине.
...
2.  На панели команд нажмите кнопку **Присоединить**, а затем выберите **Присоединить диск**.
    ...
    ![Введите сведения о диске данных][]
