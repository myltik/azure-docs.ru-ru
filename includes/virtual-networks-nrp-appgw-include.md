...
| Свойство | Описание | 
|---|---|
|*Пул внутренних серверов* | Список IP-адресов внутренних серверов. Указанные IP-адреса должны относиться к подсети виртуальной сети либо представлять собой общедоступные, виртуальные либо частные IP-адреса. |
