## Шлюз приложений
Шлюз приложений обеспечивает управляемое Azure решение по балансировке нагрузки HTTP на основе технологии балансировки нагрузки на 7 уровне. Балансировка нагрузки приложения позволяет использовать правила маршрутизации для сетевого трафика в зависимости от HTTP. <BR>
