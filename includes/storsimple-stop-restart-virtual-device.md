#### <a name="to-stop-and-start-a-virtual-device"></a>Остановка и запуск виртуального устройства
...
#### <a name="to-restart-a-virtual-device"></a>Перезапуск виртуального устройства
