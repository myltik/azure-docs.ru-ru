...
2. Щелкните значок быстрого запуска ![Значок быстрого запуска](./media/storsimple-complete-minimum-device-setup/HCS_QuickStartIcon-include.png), чтобы перейти на страницу быстрого запуска устройства. Щелкните **Завершить настройку устройства**, чтобы запустить мастера **Настройка устройства**.
...
1. Щелкните значок галочки ![Значок флажка StorSimple](./media/storsimple-complete-minimum-device-setup/HCS_CheckIcon-include.png). Будет выполнен возврат на страницу устройства **Быстрый запуск**.
