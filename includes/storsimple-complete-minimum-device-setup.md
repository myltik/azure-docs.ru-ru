...
4. На странице **Сетевые интерфейсы** введите фиксированные IP-адреса для контроллеров 0 и 1. Если интерфейс DATA 0 настроен для IPv4, статические IP-адреса должны быть указаны в формате IPv4. Если указан префикс для IPv6, статические IP-адреса будут заполнены автоматически в этих полях.
...
Чтобы просмотреть видеоролик о том, как завершить минимальную настройку устройства, щелкните [здесь](http://azure.microsoft.com/documentation/videos/minimum-storsimple-device-setup/).
