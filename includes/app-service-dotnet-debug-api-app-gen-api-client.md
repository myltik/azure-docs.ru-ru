## <a name="generate-an-api-app-client"></a>Создание клиента приложения API
...
1. В Visual Studio откройте решение, которое содержит приложение API из статьи [Создание приложения API](../articles/app-service-api/app-service-dotnet-create-api-app.md) . 
...
## <a name="test-the-api-app-client"></a>Тестирование клиента приложения API
