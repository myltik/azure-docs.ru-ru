...
* **Для управляемых дисков Azure**: ограничение на количество управляемых дисков зависит от региона подписки. Нестрогое стандартное ограничение — 2000 на регион на подписку. Чтобы увеличить предельное значение ограничения, обратитесь в службу поддержки Azure.
