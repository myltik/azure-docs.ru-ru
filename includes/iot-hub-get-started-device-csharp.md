...
3. В окне **Диспетчер пакетов NuGet** убедитесь, что флажок **Включить предварительные выпуски** установлен. Найдите **Клиент устройств Microsoft Azure**, а затем щелкните **Установить** и примите условия использования.
