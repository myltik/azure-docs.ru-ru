...
- [(Магазин Windows (C#) | .NET)](../articles/mobile-services-dotnet-backend-windows-store-dotnet-get-started-users.md)
- [(Магазин Windows (C#) | JavaScript)](../articles/mobile-services-windows-store-dotnet-get-started-users.md)
- [(Магазин Windows (JavaScript) | Javascript)](../articles/mobile-services-windows-store-javascript-get-started-users.md)
