...
> 
> Страничные BLOB-объекты в хранилище класса Premium предназначены для использования только в качестве виртуальных жестких дисков. Корпорация Майкрософт не рекомендует хранить другие типы данных в страничных BLOB-объектах в хранилище класса Premium, так как стоимость хранения может значительно увеличиться. Используйте блочные BLOB-объекты для хранения данных, которые не находятся на виртуальных жестких дисках.
