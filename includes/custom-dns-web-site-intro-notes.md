> [AZURE.NOTE]**Эта статья содержит сведения о веб-приложениях**. Информацию об облачных службах см. в разделе <a href="/develop/net/common-tasks/custom-dns/">Настройка пользовательского доменного имени в Azure</a>.
>
