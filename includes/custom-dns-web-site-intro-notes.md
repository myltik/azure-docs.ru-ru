> [WACOM.NOTE] **В этой статье предоставляются сведения о веб-сайтах Azure**; сведения об облачных службах см. в разделе [Настройка пользовательского доменного имени в Azure][].
