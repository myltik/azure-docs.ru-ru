...
1. В Visual Studio 2012 Express для Windows Phone откройте файл MainPage.xaml из проекта быстрого запуска, найдите элемент **Кнопка** с именем `ButtonRefresh` и замените его следующим кодом XAML: 
