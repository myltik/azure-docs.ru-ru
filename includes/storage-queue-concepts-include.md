...
Следующий URL-адрес позволяет обратиться к одной из очередей на схеме: http://myaccount.queue.core.windows.net/imagesToDownload

**Учетная запись хранения.** Весь доступ к службе хранилища Azure осуществляется с помощью учетной записи хранения. Сведения о емкости учетной записи хранения см. на странице [Цели масштабируемости хранилища и производительности Azure](../articles/storage/storage-scalability-targets.md).
