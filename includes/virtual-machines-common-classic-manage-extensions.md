...
> [!NOTE]
> Кроме того, расширения могут использовать конфигурации, заданные с помощью JSON. При использовании расширений такого типа задействуется только элемент **SampleConfig**.
> 
> 
