...
| Определяемые пользователем таблицы маршрутизации |100 |200 |
| Определяемые пользователем маршруты для таблицы маршрутизации |100 |400 |
| Общедоступные IP-адреса (динамические) |(Базовый) 60 |обратитесь в службу поддержки |
...
| Конфигурации IP интерфейса, уровень "Базовый" | 10 | обратитесь в службу поддержки |
| Конфигурации IP интерфейса, уровень "Стандартный" | 10 | 600 |
| Серверный пул, уровень "Базовый" | 100, одна группа доступности | - |
| Серверный пул, уровень "Стандартный" | 1000, одна виртуальная сеть | обратитесь в службу поддержки |
