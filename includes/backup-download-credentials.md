...
Перед выполнением резервного копирования на локальный сервер (клиент Windows или Windows Server или Data Protection Manager server), в Azure, проверки подлинности сервера в хранилище служб восстановления. Используйте файл учетных данных хранилища для проверки подлинности сервера с помощью Azure. Учетные данные хранилища, аналогичны понятие «параметры публикации» файл, используемый в Azure PowerShell.
