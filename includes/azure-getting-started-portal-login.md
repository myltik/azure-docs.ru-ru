...
-->
## <a name="connect-to-the-azure-portal-with-a-subscription"></a>Подключение к порталу Azure с помощью подписки
Для подключения к порталу Azure вам нужна подписка.

### <a name="get-a-new-account"></a>Получение новой учетной записи
