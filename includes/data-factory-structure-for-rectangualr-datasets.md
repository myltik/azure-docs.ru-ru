...
2. **Для схемы на основе считываемых источников данных \(а именно большого двоичного объекта Azure\)** вы можете выбрать хранение данных без сохранения какой-либо схемы или информации о типах вместе с ними. Для таких типов источников данных раздел structure нужно добавлять в следующих двух случаях:
