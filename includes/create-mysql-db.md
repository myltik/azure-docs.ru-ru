#Создание базы данных MySQL в Windows Azure

В этом руководстве будет показано, как использовать [ClearDB] для создания базы данных MySQL из [магазина Windows Azure] и способы создания базы данных MySQL в качестве связанного ресурса при создании [веб-сайта Windows Azure][waws]. [ClearDB] является поставщиком отказоустойчивой базы данных, позволяющей запускать и управлять базами данных MySQL в центрах обработки данных Windows Azure и подключаться к ним из любого приложения.  

##Оглавление
* [Создание базы данных MySQL из магазина Windows Azure](#CreateFromStore)
* [Создание базы данных MySQL в качестве связанного ресурса для веб-сайта Windows Azure](#CreateForWebSite)

<div class="dev-callout"> 
<b>Примечание</b>. 
<p>При создании базы данных MySQL в рамках процесса создания веб-сайта можно создавать только бесплатные базы данных. Создание базы данных MySQL из магазина Windows Azure позволяет создать бесплатную базу данных или выбрать один из вариантов платной.</p> 
</div>

<h2><a id="CreateFromStore"></a>Создание базы данных MySQL из магазина Windows Azure</h2>

Для создание базы данных MySQL из [магазина Windows Azure] выполните следующие действия:

1. Войдите на [портал управления Windows Azure][portal].
...
6. После создания базой данных можно управлять на вкладке **НАДСТРОЙКИ** портала управления.
	...
	![Управление базой данных MySQL на портале Windows Azure](./media/create-mysql-db/manage-mysql-add-on.png)
...
<h2><a id="CreateForWebSite"></a>Создание базы данных MySQL в качестве связанного ресурса для веб-сайта Windows Azure</h2>

Для создания базы данных MySQL в качестве связанного ресурса при создании [веб-сайта Windows Azure][waws] выполните следующие действия:
...
[Магазин Windows Azure]: /ru-ru/store/overview/
