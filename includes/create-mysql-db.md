...
Вот как создать базу данных MySQL из [магазина Azure]:
...
3. Выберите **База данных ClearDB MySQL** и щелкните стрелку в нижней части окна.
...
Вот как создать базу данных MySQL в качестве связанного ресурса при создании [веб-сайта Azure][waws]:

1. Войдите на [портал управления Azure][portal].
2. Щелкните **+СОЗДАТЬ** в нижней части страницы и последовательно выберите **СРЕДА ВЫПОЛНЕНИЯ ПРИЛОЖЕНИЙ**, **ВЕБ-САЙТ** и **СОЗДАНИЕ С БАЗОЙ ДАННЫХ**.
...
4. Укажите **ИМЯ** базы данных, установите **ОБЛАСТЬ** для базы данных (ту же, что и для веб-сайта), примите условия использования ClearDB и нажмите кнопку с галочкой в нижней части окна.
...
7. Прокрутите вниз до раздела **Строки подключения** и нажмите **Показать строки подключения**. 
