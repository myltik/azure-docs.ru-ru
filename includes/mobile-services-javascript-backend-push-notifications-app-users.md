...
2. Щелкните вкладку **Push-уведомления**, выберите значение **Только прошедшие проверку пользователи** для параметра **Разрешения**, а затем нажмите кнопку **Изменить скрипт**.
...
4. Щелкните стрелку назад, затем вкладку **Данные**, **TodoItem**, **Скрипт** и выберите пункт **Вставка**. <!--HONumber=42-->
