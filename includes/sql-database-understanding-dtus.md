...
>[AZURE.NOTE]При переносе существующей базы данных SQL Server можно использовать средство стороннего поставщика [калькулятор DTU базы данных SQL Azure](http://dtucalculator.azurewebsites.net/), чтобы оценить уровень производительности и уровень служб, которые могут потребоваться вашей базе данных в базе данных SQL Azure.
