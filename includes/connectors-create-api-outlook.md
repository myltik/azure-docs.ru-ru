...
3. Выберите **Office 365 Outlook - On new email** (Office 365 Outlook — при получении нового сообщения).   
   Если вы ранее не создавали подключение к Outlook, вам будет предложено ввести учетные данные Outlook.com. Эти учетные данные будут использоваться для авторизации приложения логики, чтобы оно могло подключиться и получить доступ к данным вашей учетной записи Outlook.com. ![](./media/connectors-create-api-outlook/office365-outlook-1.png)
4. Укажите учетные данные для Outlook и войдите. ![](./media/connectors-create-api-outlook/office365-outlook-2.png)  
   Вот и все. Подключение к Outlook создано. Оно будет доступно для использования в других приложениях логики, которые вы создадите.
