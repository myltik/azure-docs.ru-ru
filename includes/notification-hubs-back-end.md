...
При использовании мобильных служб используйте учебники [Начало работы с push-уведомлениями](mobile-services-dotnet-backend-windows-store-dotnet-get-started-push.md). Если вы хотите использовать Java или PHP, см. раздел [Использование центров уведомлений из Java/PHP](notification-hubs-java-backend-how-to.md). Можно отправлять уведомления из любого серверного компонента с помощью [интерфейса REST центров уведомлений].
