<properties
   pageTitle="Установка обычных исправлений"
   description="Описание способов использования Windows PowerShell для StorSimple при установке обычных исправлений."
   services="storsimple"
...
1. Подключитесь к последовательной консоли устройства. Дополнительные сведения см. в разделе [Подключение через последовательную консоль](#to-connect-through-the-serial-console).
