...
## <a name="b-series-preview"></a>Серия B (предварительная версия)
...
> Эта предварительная версия будет ограничена следующими регионами:
