...
* На портале Azure найти виртуальную Машину, а затем нажмите кнопку **сброса удаленного доступа** на панели команд.
...
* Отключение или удаление виртуальной Машины на портале Azure.
...
Чтобы просмотреть журналы перезагрузки после перезагрузки произошла из-за планового обслуживания можно использовать портал Azure или Azure PowerShell. Для получения дополнительных сведений [просмотрите журналы перезагрузки виртуальной машины](https://azure.microsoft.com/blog/2015/04/01/viewing-vm-reboot-logs/).
