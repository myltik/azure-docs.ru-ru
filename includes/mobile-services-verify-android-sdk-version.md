...
2. В разделе **Сценарии Gradle** вкладки "Обозреватель проектов" откройте файл **radle.build (modeule: app)**. Убедитесь, что для **compileSdkVersion** и **buildToolsVersion** задана самая последняя установленная версия пакета SDK. Эти теги могут выглядеть следующим образом:
