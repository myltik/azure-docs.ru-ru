...
1. В Eclipse щелкните **Окно**, а затем - **Диспетчер SDK для Android**. Если вы не установили последнюю версию платформы SDK, щелкните ее для установки. Запишите номер версии.
...
3. В обозревателе пакетов Eclipse щелкните правой кнопкой мыши узел проекта, выберите **Свойства**, а затем в левом столбце выберите **Android**. Убедитесь, что для параметра **Цель сборки проекта** задана та же версия SDK, что и для **targetSdkVersion**.
