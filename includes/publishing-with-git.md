...
2. В колонке **Непрерывное развертывание** последовательно щелкните **Авторизация** и **Авторизовать**. Вы будете перенаправлены с портала Azure на сайт репозитория для выполнения авторизации.
