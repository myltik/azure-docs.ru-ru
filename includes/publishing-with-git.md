...
В этой статье описывается использование Git для выполнения публикации непосредственно с локального компьютера в веб-приложения (в Azure такой способ публикации называется **локальным репозиторием Git**). Вы также узнаете, как включить непрерывное развертывание с таких сайтов репозиториев, как BitBucket, CodePlex, Dropbox, GitHub или Mercurial. Сведения об использовании TFS для непрерывного развертывания см. в статье [Непрерывная доставка в Azure с помощью Visual Studio Team Services].
