...
1. Откройте файл проекта default.js, а затем в перезагрузке метода **app.OnActivated** замените последний вызов **refreshTodoItems** на следующий код: 
