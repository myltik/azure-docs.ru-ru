...
4. Чтобы создать приложение-функцию с этими параметрами в Azure, нажмите кнопку **Создать**. По окончании подготовки запомните или запишите **URL-адрес сайта**, который является адресом приложения-функции в Azure. 
