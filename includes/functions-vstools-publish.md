...
Чтобы создать приложение-функцию с этими параметрами в Azure, нажмите кнопку **Создать**. 

По окончании подготовки нажмите кнопку **Опубликовать**, чтобы развернуть код проекта в новом приложении-функции. 

![Локальная среда выполнения Azure](./media/functions-vstools-publish/functions-vstools-publish-profile.png)

Запомните или запишите **URL-адрес сайта**, который является адресом приложения-функции в Azure. 