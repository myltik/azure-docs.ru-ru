...
- [(Универсальное приложение для Windows (C#) | .NET)](../articles/mobile-services-dotnet-backend-windows-universal-dotnet-get-started-users.md)
- [(Универсальное приложение для Windows (C#) | Javascript)](../articles/mobile-services-javascript-backend-windows-universal-dotnet-get-started-users.md)
