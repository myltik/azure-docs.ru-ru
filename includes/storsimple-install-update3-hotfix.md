...
9. Повторите шаги 3–5, чтобы установить исправление для драйвера и встроенного ПО LSI (**KB3186859**). После установки исправления выполните командлет `Get-HcsSystem`. Должна отображаться приведенная ниже версия LSI.

	- `Lsisas2Version: 2.0.78.00`
	
10. Повторите шаги 3–5, чтобы установить обновление для Storport и Spaceport (**KB3121261**).


11. При обновлении программного обеспечения с обновлением 2 или более ранней версии также необходимо скачать:
