...
*    Теперь поддержка AMQP 1.0 доступна в шинах Azure Service Bus и Service Bus для Windows Server (Service Bus 1.1). Цены совпадают с ценами для существующих протоколов.
