...
| &nbsp; |[Merketo (бета-версия)](../articles/data-factory/connector-marketo.md) |✓ | |✓  |✓  |
...
> [!NOTE]
> Пометка *бета-версия* возле соединителя означает, что его можно опробовать и оставить отзыв, но нельзя использовать в рабочей среде.