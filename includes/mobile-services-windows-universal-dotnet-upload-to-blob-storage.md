...
3. В проекте приложения Windows Phone откройте файл MainPage.xaml и замените элемент **ButtonSave** указанным ниже кодом.
...
4. В общей папке DataModel откройте файл проекта TodoItem.cs и добавьте в класс TodoItem указанные ниже свойства.
...
3. Откройте общий файл проекта MainPage.cs и добавьте указанные ниже операторы **using**.
...
5. Добавьте в класс MainPage указанный ниже код.
...
3. Коснитесь окна предварительного просмотра, чтобы сделать снимок. Затем нажмите кнопку **Отправить**, чтобы вставить новый элемент и отправить изображение.
