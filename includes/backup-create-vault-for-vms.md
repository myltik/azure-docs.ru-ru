...
7. Успешное создание хранилища подтверждается сообщением. На странице **служб восстановления** оно будет иметь состояние **Активно**. Сразу после создания хранилища выберите соответствующее значение избыточности хранилища. См. дополнительные сведения о [настройке избыточности хранилища в хранилище службы архивации](../articles/backup/backup-configure-vault.md#azure-backup---storage-redundancy-options).
