...
14.	В разделе **Конечные точки** проверьте конечную точку, созданную автоматически, чтобы разрешить подключения Secure Shell (SSH) к виртуальной машине. (Конечные точки позволяют ресурсам в Интернете или других виртуальных сетях связываться с виртуальной машиной.) Вы можете добавить конечные точки сейчас или создать их позже. Инструкции по их созданию см. в разделе [Настройка конечных точек с виртуальной машиной](../articles/virtual-machines/virtual-machines-set-up-endpoints.md).
