...
1. В Visual Studio откройте файл default.html в вашем проекте быстрого запуска, найдите элемент **Кнопка** с именем `buttonRefresh` и добавьте следующий новый элемент сразу после него: 

		<button id="buttonCompleteAll" style="margin-left: 5px">Выполнить все</button>
