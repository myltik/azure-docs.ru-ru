1. На [портале управления Azure (предварительная версия)][AzurePreviewPortal] нажмите **Виртуальные машины**, а затем выберите только что созданную виртуальную машину (**testlinuxvm**).
