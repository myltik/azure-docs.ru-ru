...
Если вы не знаете, какое расположение нужно использовать, можно получить список доступных расположений. Получив список, найдите то расположение, которое вы хотите использовать. В этом примере будет использоваться **eastus**. Сохраните его в переменной и используйте ее. Так вы сможете изменить расположение в одном месте.
