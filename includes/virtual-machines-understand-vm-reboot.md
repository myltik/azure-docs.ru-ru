...
- [Как запланировать плановое обслуживание на виртуальных машинах Azure](../articles/virtual-machines/windows/planned-maintenance-schedule.md)
...
### Перезапуск, инициированный пользователем, и действия по завершению работы
...
### Центр безопасности Azure и Центр обновления Windows
