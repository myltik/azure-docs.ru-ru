...
1. Откройте файл проекта default.js и в переопределении метода **app.OnActivated** замените последний вызов метода **refreshTodoItems** следующим кодом: 
    ...
    Если вы используете поставщик удостоверений, отличный от Facebook, замените значение, передаваемое в метод <strong>login</strong> выше, одним из следующих: *microsoftaccount*, *twitter*, *google* или *windowsazureactivedirectory*.
