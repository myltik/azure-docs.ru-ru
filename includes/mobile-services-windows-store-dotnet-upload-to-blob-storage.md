...
1. Откройте файл MainPage.xaml и замените элемент **StackPanel** непосредственно после первого элемента **Задача** следующим кодом:
...
2. Замените элемент **StackPanel** в **DataTemplate** на следующий код:
