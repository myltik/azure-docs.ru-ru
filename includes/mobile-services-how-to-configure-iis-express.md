...
5. Откройте консоль брандмауэра Windows и создайте новое правило для порта, чтобы разрешить подключения к нему. Дополнительные сведения о создании нового правила для порта в брандмауэре Windows см. в разделе [Добавление нового правила для порта в брандмауэре Windows].
   ...
   > [!NOTE]
   > Если тестовый компьютер присоединен к домену, исключения брандмауэра могут регулироваться политикой домена. В этом случае необходимо связаться со своим администратором домена, чтобы получить исключение для порта на вашем компьютере.
   > 
   > 
   ...
   > [!NOTE]
   > После завершения локального тестирования службы вам следует удалить созданное правило брандмауэра Windows.
   > 
   > 
