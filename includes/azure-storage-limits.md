...
| Максимальная скорость входящих данных<sup>2</sup> на одну учетную запись хранения (регионы за пределами США) |5 Гбит/c для хранилищ GRS и ZRS<sup>3</sup>, 10 Гбит/c для хранилищ LRS |
| Максимальная скорость исходящих данных<sup>2</sup> на одну учетную запись хранения (регионы за пределами США) |10 Гбит/с для хранилищ RA-GRS, GRS и ZRS<sup>3</sup>, 15 Гбит/с для хранилищ LRS |
