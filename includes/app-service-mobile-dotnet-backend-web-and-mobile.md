...
1. В Visual Studio откройте проект **MultiChannelToDo.Web**. Измените файл `js/service/ToDoService.js`, добавив URL-адрес к только что опубликованному веб-API.
