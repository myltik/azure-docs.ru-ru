...
1. Если ваше приложение еще не зарегистрировано, перейдите на <a href="http://go.microsoft.com/fwlink/p/?LinkId=272456" target="_blank">портал подготовки iOS</a> в центре по разработке для Apple, выполните вход с использованием своего идентификатора Apple, щелкните **Идентификаторы**, а затем - **Идентификаторы приложений** и щелкните значок **+**, чтобы зарегистрировать новое приложение.
