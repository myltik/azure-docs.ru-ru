...
**ПРИМЕЧАНИЕ.** Во всем коде этого руководства предполагается, что приложение создается как проект облачной службы Azure, который использует строку подключения к хранилищу, сохраненную в конфигурации службы приложения Azure.
