...
5. В верхней области на панели инструментов щелкните значок **Уведомления** ![значок уведомлений](./media/cosmos-db-create-dbaccount-graph/notification-icon.png), чтобы отслеживать процесс развертывания.
