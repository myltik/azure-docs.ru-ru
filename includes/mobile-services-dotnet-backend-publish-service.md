...
2. Войдите, используя учетные данные учетной записи Azure, выберите службу в списке **Существующие мобильные службы** и нажмите кнопку **ОК**. Visual Studio скачает параметры публикации прямо из Azure.
