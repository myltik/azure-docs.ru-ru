...
Размер временного диска зависит от размера виртуальной машины. Дополнительные сведения см. в разделе [Размеры виртуальных машин Linux](../articles/virtual-machines/virtual-machines-linux-sizes.md) или [Размеры виртуальных машин Windows](../articles/virtual-machines/virtual-machines-windows-sizes.md).
