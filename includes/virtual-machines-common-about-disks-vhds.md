...
>[AZURE.WARNING] Мы советуем не хранить данные на временном диске. Он обеспечивает временное хранилище для приложений и процессов и предназначен только для хранения данных, таких как файлы подкачки. Сведения о переназначении этого диска для виртуальной машины Windows см. в статье [Изменение буквы диска для временного диска Windows](virtual-machines-windows-classic-change-drive-letter.md).
...
>[AZURE.NOTE] Дополнительные сведения о емкости виртуальных машин см. в статье [Размеры виртуальных машин](virtual-machines-linux-sizes.md).
