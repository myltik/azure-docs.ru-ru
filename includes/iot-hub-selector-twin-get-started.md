...
* cохранение метаданных устройства из серверной части;
...
* *теги* — метаданные устройства, доступные только в серверной части;
* *требуемые свойства* — объекты JSON, задаваемые только в серверной части и считываемые в приложении устройства;
* *сообщаемые свойства* — объекты JSON, задаваемые только в приложении устройства и считываемые в серверной части (теги и свойства не могут содержать массивы, но объекты могут быть вложенными).

![][img-twin]

Кроме того, из серверной части приложения можно запросить двойники устройств на основе всех вышеизложенных данных.
...
* запрос устройств из внутреннего приложения с использованием фильтров в созданных ранее тегах и свойствах.
