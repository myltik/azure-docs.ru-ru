<h2><a id="AdditionalServices"></a><span class="short-header">Использование дополнительных служб Twilio</span>Инструкция: использование дополнительных служб Twilio</h2>
Помимо примеров, перечисленных здесь, Twilio предлагает веб-интерфейсы API, с помощью которых вы можете использовать дополнительные функции Twilio из вашего приложения Windows Azure. Дополнительные сведения см. в [документации по интерфейсу API Twilio][twilio_api_documentation].
