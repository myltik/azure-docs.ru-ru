...
2. Чтобы запустить приложение в эмуляторе Android, вам нужно определить хотя бы одно виртуальное устройство на платформе Android (AVD). Для создания этих устройств и управления ими используйте диспетчер AVD.
