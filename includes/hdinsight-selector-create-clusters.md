...
- [Linux | Пакет SDK для .NET](hdinsight-hadoop-create-linux-clusters-dotnet-sdk.md)
- [Linux | Шаблоны ARM](hdinsight-hadoop-create-linux-clusters-arm-templates.md)
- [Windows | Обзор](hdinsight-provision-clusters.md)
- [Windows | Портал Azure](hdinsight-hadoop-create-windows-clusters-portal.md)
