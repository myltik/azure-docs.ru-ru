...
Без ограничений на максимальный размер запроса (для документов и вложений)|512 КБ 
аксимальный размер запроса (для хранимой процедуры, триггера и определяемой пользователем функции)|512 КБ
...
Максимальное количество объединений (JOIN) в запросе* |5 
