...
Для реализации этого сценария см. следующий раздел справки: <br/> [Разработка в базе данных SQL Azure: инструкции](http://msdn.microsoft.com/library/azure/ee621787.aspx).
...
Также можно ознакомиться с разделом<br/> [Безопасность в базе данных SQL Azure: рекомендации и ограничения](http://msdn.microsoft.com/library/azure/ff394108.aspx#authentication).
