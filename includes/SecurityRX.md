...
Полный список угроз, атак, уязвимостей и контрмер см. в документах [Памятка: механизм безопасности веб-приложения](http://msdn.microsoft.com/library/ff649461.aspx) и [Руководство по безопасности для приложений](http://msdn.microsoft.com/library/ff650760.aspx).
