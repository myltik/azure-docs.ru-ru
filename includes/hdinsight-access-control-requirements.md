...
* Ваша учетная запись Azure должна иметь права доступа по крайней мере **участника** к группе ресурсов Azure, которая будет использоваться при создании HDInsight (и к другим ресурсам Azure).
