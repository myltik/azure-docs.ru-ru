...
-------- | ------------- | -------------
Точек данных сеанса<sup>1</sup> в месяц | без ограничений | 
Других точек данных в месяц | 5 млн | 50 млн<sup>2</sup>
Скорость [трассировки или передачи](../articles/application-insights/app-insights-search-diagnostic-logs.md) данных журнала | 200 точек данных в секунду | 500 точек данных в секунду
...
Хранение [необработанных данных](../articles/application-insights/app-insights-diagnostic-search.md) | 7 дней
Хранение [объединенных данных](../articles/application-insights/app-insights-metrics-explorer.md) | 90 дней
Количество имен [свойств](../articles/application-insights/app-insights-api-custom-events-metrics.md#properties) | 100 |
Длина имени свойства | 100 | 
Длина значения свойства | 1000 | 
