...
2. В разделе **Основные параметры** окна мастера добавления тома выполните следующие действия.
   ...
   3. В раскрывающемся списке **Тип использования** выберите нужный тип для тома. Для архивных данных, доступ к которым осуществляется не так часто, выберите **Архивный том**. Для любых других типов данных выбирайте **Основной том**. (Многоуровневые тома раньше назывались основными.)
