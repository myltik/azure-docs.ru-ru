...
2.  В окне **Подключение к серверу** укажите полное имя сервера как *имя_сервера*. database.windows.net. В Azure имя сервера представляет собой автоматически формируемую строку, состоящую из буквенно-цифровых символов.
...
В Azure каждый логический сервер базы данных SQL представляет собой абстракцию, определяющую группирование баз данных. Физически любая база данных может находиться на любом компьютере в центре обработки данных. 
...
* [Справочник по Transact-SQL (база данных SQL)][Справочнике по Transact-SQL (база данных SQL)]
  ...
  [Справочнике по Transact-SQL (база данных SQL)]: http://msdn.microsoft.com/ru-ru/library/windowsazure/ee336281.aspx
