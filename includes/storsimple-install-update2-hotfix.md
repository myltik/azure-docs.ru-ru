...
8. Повторите шаги 3–5 для установки оставшихся обычных исправлений.
...
3. Отслеживайте ход установки с помощью команды `Get-HcsUpdateStatus`. Обновление завершается, когда `RunInProgress` изменится на `False`.
