...
<sup>3</sup>За исключением уровня Free, ограничения на планы веб-хостинга приводятся в расчете на одну группу ресурсов. С более подробной информацией о создании и управлении группами ресурсов можно ознакомиться в разделе [Применение групп ресурсов для управления ресурсами Azure][useresourcegroups].

<sup>4</sup>Выделенные экземпляры могут иметь малый, средний или крупный размер. Более подробная информация приводится в разделе [Цены на веб-сайты Azure][websitespricing]. Дополнительное количество экземпляров можно получить, отправив запрос технической поддержки.
