...
---|---|---|---|---|---
Количество [веб-приложений, мобильных приложений или приложений API](../services/app-service/) на один [план службы приложений](web-sites-web-hosting-plan-overview.md)<sup>1</sup>|10|100|Без ограничений<sup>2</sup>|Без ограничений<sup>2</sup>|Без ограничений<sup>2</sup>
Количество [приложений логики](../services/app-service/) на [один план службы приложений](web-sites-web-hosting-plan-overview.md)</a><sup>1</sup>|10|10|10|20 шт. на одно ядро|20 шт. на одно ядро 
[План обслуживания приложения](web-sites-web-hosting-plan-overview.md)|1 для каждого региона|10 шт. на одну группу ресурсов|10 шт. на одну группу ресурсов|10 шт. на одну группу ресурсов|10 шт. на одну группу ресурсов
...
[Масштабирование](web-sites-scale.md) (максимальное количество экземпляров)|1 общедоступный|1 общедоступный|3 выделенных<sup>3</sup>|10 выделенных<sup>3</sup>|50 выделенных<sup>3,4</sup>
...
Количество одновременных [подключений к отладчику](web-sites-dotnet-troubleshoot-visual-studio.md) для каждого приложения|1|1|1|5|5
[Поддомен azurewebsites.net с доступом по FTP/S и SSL](web-sites-configure-ssl-certificate.md)|X|X|X|X|X
Поддержка [личных доменов](web-sites-custom-domain-name.md)||X|X|X|X
[Поддержка SSL](web-sites-configure-ssl-certificate.md) для личных доменов|||Без ограничений|Без ограничений, включено 5 подключений SNI SSL и 1 подключение SSL на основе IP|Без ограничений, включено 5 подключений SNI SSL и 1 подключение SSL на основе IP
Интегрированная подсистема балансировки нагрузки||X|X|X|X
[Всегда включено](web-sites-configure.md)|||X|X|X
[Архивация по расписанию](web-sites-backup.md)||||Один раз в день|Каждые 5 минут<sup>8</sup>
[Автоматическое масштабирование](web-sites-scale.md)|||X|X|X
[Веб-задания](web-sites-create-web-jobs.md)<sup>9</sup>|X|X|X|X|X
Поддержка [планировщика Azure](../services/scheduler/)||X|X|X|X
[Мониторинг конечных точек](web-sites-monitor.md)|||X|X|X
[Промежуточные слоты (предварительная версия)](web-sites-staged-publishing.md)||||5|20
