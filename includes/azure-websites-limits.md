...
<tr>
   ...
   <td valign="middle"><p>Общедоступный</p></td>
   <td valign="middle"><p>Общедоступный</p></td>
   <td valign="middle"><p>Выделенный</p></td>
   <td valign="middle"><p>Выделенный</p></td>
</tr>
<tr>
   <td valign="middle"><p><a href="http://azure.microsoft.com/documentation/articles/web-sites-scale/">Масштабирование</a> (максимальное количество экземпляров)</p></td>
   <td valign="middle"><p>1 общедоступный</p></td>
   <td valign="middle"><p>1 общедоступный</p></td>
   <td valign="middle"><p>3 выделенных</p></td>
   <td valign="middle"><p>10 выделенных<sup>4</sup></p></td>
</tr>
<tr>
...
<tr>
   <td valign="middle"><p>Веб-сокеты<sup>8</sup></p></td>
   <td valign="middle"><p>5</p></td>
   <td valign="middle"><p>35</p></td>
   <td valign="middle"><p>350</p></td>
   <td valign="middle"><p>Без ограничений</p></td>
</tr><tr>
   <td valign="middle"><p>Количество одновременных <a href="http://azure.microsoft.com/documentation/articles/web-sites-dotnet-troubleshoot-visual-studio/">подключений к отладчику</a> для каждого приложения</p></td>
   ...
   <td valign="middle"><p></p></td>
   <td valign="middle"><p>X</p></td>
   <td valign="middle"><p>5 SSL-подключений на основе SNI и 1 SSL-подключение на основе IP</p></td>
</tr><tr>
   ...
   <td valign="middle"><p><a href="http://azure.microsoft.com/documentation/articles/web-sites-configure/">Всегда включено</a></p></td>
   <td valign="middle"><p></p></td>
   <td valign="middle"><p></p></td>
   <td valign="middle"><p>X</p></td>
   <td valign="middle"><p>X</p></td>
...
<tr>
   <td valign="middle"><p><a href="http://azure.microsoft.com/documentation/articles/web-sites-backup/">Резервные копии</a></p></td>
   <td valign="middle"><p></p></td>
   <td valign="middle"><p></p></td>
   <td valign="middle"><p></p></td>
   <td valign="middle"><p>X</p></td>
</tr><tr>
   <td valign="middle"><p><a href="http://azure.microsoft.com/documentation/articles/web-sites-scale/">Автоматическое масштабирование</a></p></td>
   <td valign="middle"><p></p></td>
   <td valign="middle"><p></p></td>
   <td valign="middle"><p>X</p></td>
   <td valign="middle"><p>X</p></td>
</tr><tr>
   <td valign="middle"><p><a href="http://azure.microsoft.com/documentation/articles/web-sites-create-web-jobs/">Веб-задания</a><sup>10</sup></p></td>
   <td valign="middle"><p>X</p></td>
   <td valign="middle"><p>X</p></td>
   <td valign="middle"><p>X</p></td>
   <td valign="middle"><p>X</p></td>
...
<tr>
   <td valign="middle"><p>Поддержка <a href="http://azure.microsoft.com/services/scheduler/">планировщика Azure</a></p></td>
   <td valign="middle"><p></p></td>
   <td valign="middle"><p>X</p></td>
   <td valign="middle"><p>X</p></td>
   <td valign="middle"><p>X</p></td>
</tr><tr>
   <td valign="middle"><p><a href="http://azure.microsoft.com/documentation/articles/web-sites-monitor/">Мониторинг конечных точек</a></p></td>
   <td valign="middle"><p></p></td>
   <td valign="middle"><p></p></td>
   <td valign="middle"><p>X</p></td>
   <td valign="middle"><p>X</p></td>
...
<sup>3</sup>За исключением уровня Free, ограничения на планы веб-хостинга приводятся в расчете на одну группу ресурсов. Подробнее о создании групп ресурсов и управлении ими см. в разделе [Обзор диспетчера ресурсов Azure](../articles/resource-group-overview.md).

<sup>4</sup>Выделенные экземпляры могут иметь малый, средний или крупный размер. Более подробная информация приводится в разделе [Цены на веб-сайты Azure](http://azure.microsoft.com/pricing/details/web-sites/). Дополнительное количество экземпляров можно получить, отправив запрос технической поддержки.

<sup>5</sup>Все веб-сайты совместно используют одни и те же ресурсы хранилища для содержимого сайтов. Поэтому ограничения, касающиеся системы хранения, определяются совокупными потребностями всех веб-сайтов, а не каждым из них в отдельности. Ограничения на систему хранения можно увеличить, отправив запрос технической поддержке.

<sup>6</sup>Для уровней Basic и Standard квота на использование ЦП и памяти не задается, но эти ресурсы ограничиваются физическими ресурсами на выделенных экземплярах (размером и количеством экземпляров).
...
<sup>9</sup>Для уровня Basic применяются [стандартные расценки на SSL](http://azure.microsoft.com/pricing/details/web-sites/#ssl-connections).
