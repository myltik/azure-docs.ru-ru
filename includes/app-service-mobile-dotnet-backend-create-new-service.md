...
8. В колонке **Новый сервер** ведите уникальное **имя сервера**, укажите имя входа и пароль, установите флажок **Разрешить службам Azure доступ к серверу** и нажмите кнопку **ОК**. Будет создана база данных.
