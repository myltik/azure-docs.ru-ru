...
Azure предоставляет отличные облачные решения на основе виртуальных машин&mdash;(эмуляции оборудования физического компьютера)&mdash;, обеспечивающие гибкое перемещение развертывания программного обеспечения и значительно большую эффективность консолидации ресурсов, чем в случае использования физического оборудования. За последние несколько лет во многом благодаря подходу [Docker](https://www.docker.com) к контейнерам и экосистеме контейнерная технология Linux значительно расширила спектр способов разработки распределенного программного обеспечения и управления им. Код приложения в контейнере изолирован от основной виртуальной машины Azure, так же как другие контейнеры в той же виртуальной машине, что обеспечивает больше возможностей для разработки и развертывания на уровне приложения, помимо гибкости, которую обеспечивают сами виртуальные машины Azure.

**Но это уже устаревшие новости.** А вот *свежие* свежиеs is that Azure offers you even more Docker goodness:
...
### <a name="is-this-too-good-to-be-true"></a>Звучит слишком хорошо, чтобы быть правдой?
...
С другой стороны помните, что контейнеры выполняются на узле контейнеров (в операционной системе), а в Azure это означает виртуальную машину Azure. Даже если вам уже нравится идея контейнеров, вам все еще требуется инфраструктура виртуальных машин для размещения контейнеров, но преимущество этого состоит в том, что для контейнеров не важно, в каких виртуальных машинах они работают (хотя для контейнера имеет значение среда выполнения — Linux или Windows, например).

## <a name="what-are-containers-good-for"></a>Для чего же контейнеры подходят лучше всего?
Они отлично подходят для многих целей, но мы советуем использовать их (что и делают [облачные службы Azure](https://azure.microsoft.com/services/cloud-services/) и [Azure Service Fabric](../articles/service-fabric/service-fabric-overview.md)) для создания ориентированных на микрослужбы распределенных приложений с одной службой, если приложение состоит из нескольких небольших составных частей, а не компонентов большего размера, которые сильнее связаны друг с другом.
...
Эти (и другие) функции крайне актуальны в развитых сферах деятельности, в которых профессиональным ИТ-организациям приходится корректировать ресурсы, в том числе чисто производственные мощности, согласно задачам, необходимым не только для поддержки бизнес-деятельности, но и для привлечения заказчиков и повышения их удовлетворенности. Малый бизнес, независимые поставщики программного обеспечения и стартапы — их требования мало отличаются, но они могут описываться по-разному.
