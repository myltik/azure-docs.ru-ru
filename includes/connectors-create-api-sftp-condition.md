...
- Щелкните **Выберите значение** слева.  
![Условие SFTP, изображение 2](./media/connectors-create-api-sftp/condition-2.png)  
- Выберите **Содержимое файла**, чтобы указать, что в условии нужно оценивать содержимое файла.  
![Условие SFTP, изображение 3](./media/connectors-create-api-sftp/condition-3.png)  
- Выберите *содержит* из списка операторов.  
![Условие SFTP, изображение 4](./media/connectors-create-api-sftp/condition-4.png)  
- Щелкните **Выберите значение** справа и введите *ExtractMeFirst*. В этом примере значение ExtractMeFirst ожидается в файле пользователей, имеющих доступ к папке SFTP. Оно указывает, что это файл архива, который следует извлечь.  
