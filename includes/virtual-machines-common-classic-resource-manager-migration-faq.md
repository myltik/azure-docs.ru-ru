...
## <a name="what-if-im-using-azure-site-recovery-or-azure-backup-today"></a>Что если я использую Azure Site Recovery или службу архивации Azure в настоящее время? 

Чтобы перенести виртуальную машину, для которой включена архивация, ознакомьтесь с разделом [Резервные копии классических виртуальных машин созданы в хранилище службы архивации. Теперь эти виртуальные машины нужно перевести из классического режима в режим Resource Manager. Как выполнить их архивацию в хранилище служб восстановления?](../articles/backup/backup-azure-backup-ibiza-faq.md)Резервные копии классических виртуальных машин созданы в хранилище службы архивации. Теперь эти виртуальные машины нужно перевести из классического режима в режим Resource Manager.  Как выполнить их резервное копирование в хранилище служб восстановления?
