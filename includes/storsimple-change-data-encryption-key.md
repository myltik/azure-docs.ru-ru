...
> [AZURE.NOTE]На классическом портале Azure в списке устройств не отображаются виртуальные устройства StorSimple, которые могут быть авторизованы для запуска изменения ключа.
