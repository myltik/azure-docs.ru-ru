...
* Учитывайте тот факт, что пользователи с ролью [Участник виртуальных машин](../articles/active-directory/role-based-access-built-in-roles.md#virtual-machine-contributor) не смогут изменять размер виртуальной машины (как это было возможно перед преобразованием). Причина в том, что виртуальные машины с управляемыми дисками требуют разрешения Microsoft.Compute/disks/write для дисков операционной системы.
