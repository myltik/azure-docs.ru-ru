...
3. Щелкните **Source archive file path** (Путь к исходному файлу архива).  
...
8. Введите *True* в элементе управления **Перезаписать?*, чтобы указать, что существующие файлы следует перезаписать, если их имена совпали с именами извлеченных файлов.  
