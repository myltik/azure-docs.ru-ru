<properties urlDisplayName="What is a Cloud Service" pageTitle="Что такое облачная служба &mdash; управление службами в Azure" metaKeywords="Azure cloud services intro, cloud services overview, cloud services basics" description="Введение в облачные службы Azure." metaCanonical="" services="cloud-services" documentationCenter="" title="Что такое облачная служба?" authors="ryanwi" solutions="" manager="timlt" editor="" />
...
-   **Компоненты облачной службы.** Для развертывания приложения в качестве облачной службы в Azure необходимы три компонента:
...
> -   **Пакет услуг.** Пакет службы с расширением CSPKG содержит код приложения и файл определения службы.
...
-   **Минимальный и подробный уровень мониторинга.** *Минимальный уровень мониторинга* настраивается для облачной службы по умолчанию и использует счетчики производительности операционных систем хостов для экземпляров ролей (виртуальные машины). *В рамках подробного мониторинга* для более тщательного анализа проблем обработки приложений отслеживаются дополнительные метрики в экземплярах ролей. Дополнительные сведения см. в разделе [Мониторинг облачных служб][Мониторинг облачных служб].

-   **Служба диагностики Azure:**служба диагностики Azure представляет собой API, который позволяет собирать данные диагностики от приложений, работающих в Azure. Чтобы включить подробный мониторинг, необходимо предварительно включить диагностику Azure. Дополнительную информацию см. в разделе [Включение системы диагностики в Azure][Включение системы диагностики в Azure].
...
-   **Соглашение об уровне обслуживания (SLA) Azure:** соглашение об уровне обслуживания вычислительных мощностей Azure гарантирует, что при развертывании двух и более экземпляров каждой роли доступ к облачной службе будет поддерживаться не менее 99,95 процентов времени. Кроме того, обнаружение и устранение неисправностей будут запускаться в 99,9 процентах случаев во время отсутствия активности экземпляра роли. Дополнительные сведения см. в разделе [Соглашения об уровне обслуживания][Соглашения об уровне обслуживания].
  ...
  [Мониторинг облачных служб]: http://azure.microsoft.com/ru-ru/manage/services/cloud-services/how-to-monitor-a-cloud-service/
  [Включение системы диагностики в Azure]: http://azure.microsoft.com/ru-ru/documentation/articles/cloud-services-dotnet-diagnostics/
  [Соглашения об уровне обслуживания]: http://azure.microsoft.com/ru-ru/support/legal/sla/
