---
title: "Связывание зависимых ресурсов в решениях Azure | Документация Майкрософт"
...
---
# <a name="link-related-resources-from-different-resource-groups"></a>Связывание взаимосвязанных ресурсов из различных групп ресурсов
...
## <a name="linking-in-templates"></a>Привязка с использованием шаблонов
...
## <a name="linking-with-rest-api"></a>Создание связей с помощью REST API
...
Дополнительные примеры, в том числе способы получения информации о связях, см. в разделе [Связанные ресурсы](https://docs.microsoft.com/rest/api/resources/resourcelinks).
