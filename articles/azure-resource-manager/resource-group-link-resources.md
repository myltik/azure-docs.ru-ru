---
title: "Привязка ресурсов в Azure Resource Manager | Документация Майкрософт"
...
---
# <a name="linking-resources-in-azure-resource-manager"></a>Привязка ресурсов в диспетчере ресурсов Azure
