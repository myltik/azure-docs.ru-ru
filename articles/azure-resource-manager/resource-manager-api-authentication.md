---
title: "Аутентификация Active Directory и Resource Manager | Документация Майкрософт"
...
---
# <a name="how-to-use-azure-active-directory-and-resource-manager-to-manage-a-customers-resources"></a>Управление ресурсами клиента с помощью Azure Active Directory и Resource Manager
