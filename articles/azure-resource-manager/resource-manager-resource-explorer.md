---
title: "Обозреватель ресурсов Azure | Документация Майкрософт"
...
---
# <a name="use-azure-resource-explorer-to-view-and-modify-resources"></a>Использование обозревателя ресурсов Azure для просмотра и изменения ресурсов
...
## <a name="view-resources"></a>Просмотр ресурсов
...
По мере освоения шаблонов Resource Manager вы начнете привыкать к текстовому содержимому. Значения в разделе **properties** ответа соответствуют значениям, которые можно указывать в разделе **properties** шаблона.
...
При изучении базы данных отображаются свойства для этой базы данных. На снимке экрана ниже видно, что `edition` базы данных имеет значение `Standard`, а `serviceLevelObjective` (или уровень базы данных) имеет значение `S1`.

![база данных sql](./media/resource-manager-resource-explorer/are-04-database-get.png)

## <a name="change-resources"></a>Изменение ресурсов
...
## <a name="performing-actions-on-resources"></a>Выполнение действий с ресурсами
...
## <a name="invoking-the-api-via-powershell"></a>Вызов API с помощью PowerShell
