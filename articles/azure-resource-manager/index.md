...
Узнайте, как использовать диспетчер ресурсов для развертывания, отслеживания и администрирования ресурсов решения в качестве группы. Руководства, справочники по API и другая документация, в которой показано, как настраивать группы ресурсов и создавать шаблоны для согласованного и воспроизводимого развертывания.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Информация об Azure Resource Manager</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Видеотека по Azure Resource Manager</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/azure/templates/">Формат шаблона</a></p>
                        <p><a href="/azure/resource-group-template-functions">Функции шаблонов</a></p>
                        <p><a href="/azure/azure-resource-manager/managed-application-createuidefinition-functions">Функции определения пользовательского интерфейса</a></p>
                        <p><a href="/azure/azure-resource-manager/managed-application-createuidefinition-elements">Элементы CreateUiDefinition</a></p>
                    </div>
                </div>
            </div>
        </div>
