...
Если вы вручную измените или добавите ресурсы в несколько развертываний, шаблон, полученный из журнала развертывания, не отразит текущее состояние группы ресурсов. В этом разделе показано, как экспортировать шаблон, который отражает текущее состояние группы ресурсов. Он должен использоваться как моментальный снимок группы ресурсов, который можно применить для повторного развертывания в той же группе ресурсов. Чтобы использовать экспортированный шаблон для других решений, его необходимо значительно изменить.
