...
Значение **ApiVersion**, **тип** и **свойства** различны для каждого типа ресурса. Чтобы определить значения для этих свойств, ознакомьтесь со [справочником по шаблонам](/azure/templates/).
