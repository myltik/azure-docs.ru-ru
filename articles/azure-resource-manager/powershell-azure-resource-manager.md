---
title: "Использование Azure PowerShell с Resource Manager | Документация Майкрософт"
...
## <a name="move-a-resource"></a>Перемещение ресурса
...
### <a name="download-template-from-deployment"></a>Скачивание шаблона из развертывания
...
* Подробный пример развертывания проекта см. в статье [Предсказуемые подготовка и развертывание микрослужб в Azure](../app-service-web/app-service-deploy-complex-application-predictably.md).
* Сведения об устранении неполадок развертывания, завершившегося сбоем, см. в статье [Просмотр операций развертывания с помощью Azure PowerShell](resource-manager-troubleshoot-deployments-powershell.md).
