---
title: "Блокировка ресурсов с помощью Resource Manager | Документация Майкрософт"
...
---
# <a name="lock-resources-with-azure-resource-manager"></a>Блокировка ресурсов с помощью диспетчера ресурсов Azure
