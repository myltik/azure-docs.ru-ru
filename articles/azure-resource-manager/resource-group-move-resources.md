...
Виртуальные машины, созданные из ресурсов Marketplace, невозможно переместить между подписками. Отзовите виртуальную машину в текущей подписке и разверните ее в новой подписке.
...
Если пользователь перемещает резервную копию виртуальной машины между подписками, шаги 1 и 2 будут теми же. На шаге 3 пользователь должен защитить виртуальную машину в новом хранилище в целевой подписке. Хранилище служб восстановления не поддерживает резервное копирование между подписками.
