...
Для каждой подписки и клиента Resource Manager ограничивает число запросов на чтение до 15 000 и запросов на запись — до 1200 в час. Если приложение или сценарий достигает этих предельных значений, то требуется регулировать запросы. В этом разделе показано, как определить, сколько осталось запросов до достижения ограничения, и как реагировать на достижение этого ограничения.
