...
Эта ошибка может появится в результате ошибок нескольких различных типов. Как правило, это синтаксические или структурные ошибки в шаблоне.
...
### <a name="solution-4---circular-dependency-detected"></a>Решение 4 — обнаружена циклическая зависимость
