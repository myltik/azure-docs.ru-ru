...
В [центре учетных записей Azure](https://account.windowsazure.com/subscriptions) можно просмотреть актуальные и загрузить прошлые счета.

Чтобы просмотреть или загрузить счет, выполните следующие действия.

1. Войдите в [центр учетных записей](https://account.windowsazure.com/subscriptions) с помощью учетной записи Майкрософт или рабочей (учебной) учетной записи.
...
- [Изменение кредитной карты, используемой для оплаты подписки Azure](billing-how-to-change-credit-card.md)
