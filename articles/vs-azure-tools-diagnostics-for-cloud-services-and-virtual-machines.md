---
title: Настройка системы диагностики для облачных служб и виртуальных машин Azure | Microsoft Docs
...
9. На каждой вкладке, которая содержит нужные диагностические данные, установите флажок **Включить передачу <тип журнала>**.
