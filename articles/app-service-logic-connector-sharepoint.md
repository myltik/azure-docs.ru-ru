...
Это действие отправляет новый документ в 'Shared Documents'. Входные данные - строго типизированный объект JSON со всеми полями столбцов библиотеки документов.
