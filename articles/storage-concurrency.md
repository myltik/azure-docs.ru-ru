...
- [Аренда BLOB-объекта](http://msdn.microsoft.com/library/azure/ee691972.aspx) 
...
- Приступая к работе с хранилищем для [больших двоичных объектов](http://azure.microsoft.com/documentation/articles/storage-dotnet-how-to-use-blobs/), [таблиц](http://azure.microsoft.com/documentation/articles/storage-dotnet-how-to-use-tables/) и [очередей](http://azure.microsoft.com/documentation/articles/storage-dotnet-how-to-use-queues/)
