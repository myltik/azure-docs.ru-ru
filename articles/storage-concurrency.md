...
Операция	|Возвращает значение ETag для контейнера|	Принимает дополнительные заголовки|
------------|-----------------------|------------------------------------|
Создание контейнера|	Да|	Нет|
Получение свойств контейнера|	Да|	Нет|
Получение метаданных контейнера|	Да|	Нет|
Задание метаданных контейнера|	Да|	Да|
Получение ACL контейнера|	Да|	Нет|
Задание ACL контейнера|	Да|	Да (*)|
Удаление контейнера|	Нет|	Да|
Аренда контейнера|	Да|	Да|
Вывод списка больших двоичных объектов|	Нет|	Нет  
...
Операция	|Возвращает значение ETag|	Принимает дополнительные заголовки|
-----------|-------------------|----------------------------|
Отправка большого двоичного объекта|	Да|	Да|
...
Получение метаданных большого двоичного объекта|	Да|	Да|
Задание метаданных большого двоичного объекта|	Да|	Да|
Аренда большого двоичного объекта (*)|	Да|	Да|
Создание моментального снимка большого двоичного объекта|	Да|	Да|
Копирование большого двоичного объекта|	Да|	Да (для исходного и целевого большого двоичного объекта)|
...
- [Аренда BLOB-объекта](http://msdn.microsoft.com/ru-ru/library/azure/ee691972.aspx) 
...
Операция	|Возвращает значения ETag	|Требуется заголовок запроса (If-Match)|
------------|-------------------|--------------------------------|
Запрос сущностей|	Да|	Нет|
Вставка сущности|	Да|	Нет|
Обновление сущности|	Да|	Да|
Слияние сущности|	Да|	Да|
Удаление сущности|	Нет|	Да|
Вставка или замена сущности|	Да|	Нет|
Вставка или слияние сущности|	Да|	Нет 

Обратите внимание на то, что при операциях **Вставка или замена сущности** и **Вставка или слияние сущности** *не* выполняются проверки на параллелизм, так как они не отправляют значение ETag в службу таблиц.  
...
- [REST API службы очередей](http://msdn.microsoft.com/ru-ru/library/azure/dd179363.aspx)
