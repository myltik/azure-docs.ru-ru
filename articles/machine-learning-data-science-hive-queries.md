...
Поля, используемые в этом запросе, - координаты GPS мест посадки и высадки с именами pickup\_longitude, pickup\_latitude, dropoff\_longitude и dropoff\_latitude. Вот как выглядят запросы для расчета прямого расстояния между координатами посадки и высадки:
