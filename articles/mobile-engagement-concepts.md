...
Дополнительные данные структурируются так же, как объекты JSON: они созданы из дерева пар "ключ-значение". Ключи ограничены 64 буквами ASCII [a — z, A —Z], цифрами [0–9] и символами подчеркивания [_], а общий размер дополнительных данных ограничен 1024 знаками (после кодировки в JSON пакетом SDK для Mobile Engagement).
