...
##<a name="install-storage-client"></a>Установите клиентское хранилище для приложений Windows Phone
...
+ [Отправить сообщение электронной почты с мобильных служб с помощью SendGrid]
  ...
  Узнайте, как добавить функциональные возможности электронной почты в мобильную службу, используя службу электронной почты SendGrid. В данном разделе описывается добавление сценариев на стороне сервера для отправки сообщений электронной почты с помощью SendGrid.
