...
В ходе выполнения этого учебника в [проект приложения GetStartedWithData](mobile-services-windows-phone-get-started-data.md) добавляются функциональные возможности для съемки фотографий и их передачи в Azure с помощью SAS, созданных мобильными службами.
...
+ Выполнение заданий учебника [Добавление мобильных служб в существующее приложение](mobile-services-windows-phone-get-started-data.md)  


##Установите клиентское хранилище для приложений Windows Phone
