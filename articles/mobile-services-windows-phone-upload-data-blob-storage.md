...
В ходе выполнения этого учебника в [проект приложения GetStartedWithData](mobile-services-windows-phone-get-started-data.md) добавляются функциональные возможности для съемки фотографий и их передачи в Azure с помощью SAS, созданных мобильными службами. Этот учебник поможет выполнить следующие базовые действия для обновления примера приложения TodoList, что позволит передавать изображения в службу хранилища BLOB-объектов:
...
+ Пройдите учебник [Добавление мобильных служб к существующему приложению](mobile-services-windows-phone-get-started-data.md)  
