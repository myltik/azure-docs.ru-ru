---
title: "10 задач, которые можно выполнить в виртуальной машине для обработки и анализа данных | Документация Майкрософт"
...
## <a name="6-share-code-with-your-team-using-github"></a>6. Совместное использование кода с коллегами с помощью Github
...
Давайте визуализируем в службе Power BI JSON-файл с данными о вулканах, который мы видели в приведенном выше примере о DocumentDB, чтобы провести визуальный анализ данных. Подробные указания см. в статье о [Power BI](../documentdb/documentdb-powerbi-visualize.md). Далее приведены основные шаги.
