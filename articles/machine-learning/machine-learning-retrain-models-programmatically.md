...
7. *Обновление обученной модели добавленной конечной точки* Чтобы завершить процесс, потребуется обновить обученную модель, указав конечную точку прогнозирования, которую мы создали на шаге 4 выше.

	(Во время добавления новой конечной точки с помощью портала Azure щелкните имя новой конечной точки, затем щелкните ссылку "Обновить ресурс", чтобы получить URL-адрес, необходимый для обновления модели конечной точки).
