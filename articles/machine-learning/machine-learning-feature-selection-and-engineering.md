...
После применения модуля [Filter-Based Feature Selection][filter-based-feature-selection] (Выбор признаков на основе фильтра) будут выбраны 50 из 256 признаков, так как большинство этих признаков коррелируют с целевой переменной **Col1** на основе метода оценки **Pearson Correlation** (Корреляция Пирсона).
