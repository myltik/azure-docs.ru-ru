...
Существует 4 типа правил.
Правило <strong>BlockList</strong> позволяет указать список элементов, которые не должны возвращаться в результатах рекомендаций.
...
Правило <strong>WhiteList</strong> позволяет указать список элементов, которые могут возвращаться как результаты рекомендаций (это правило противоположно BlockList).
