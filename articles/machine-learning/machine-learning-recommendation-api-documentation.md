...
| Категория элемента | Да | Любые алфавитно-цифровые знаки. <br> Максимальная длина: 255. | Категория, к которой принадлежит этот элемент (например, кулинарные книги, драма и пр.); может отсутствовать. |
| Описание | Нет, если только не присутствуют функции (но может отсутствовать). | Любые алфавитно-цифровые знаки <br> Максимальная длина: 4000. | Описание этого элемента. | 
| Список функций | Нет | Любые алфавитно-цифровые знаки. <br> Максимальная длина: 4000; максимальное количество функций: 20. | Разделенный запятыми список значений компонента типа «имя=функция», который может использоваться для улучшения рекомендаций модели. См. раздел [Дополнительные разделы](#2-advanced-topics). |
...
1) Запустить сборку рейтингов (если только оценка характеристик не является постоянной) и дождаться получения оценки характеристик. 
2) Получить рейтинги характеристик, вызвав API [Получение информации о характеристиках](#101-get-features-info-for-last-rank-build). 
3) Настроить сборку рекомендаций со следующими параметрами: 
 ...
 4) Запустите сборку рекомендаций с настроенными параметрами.
