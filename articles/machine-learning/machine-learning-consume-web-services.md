...
> [AZURE.TIP] Простой способ создания веб-приложения для доступа к прогнозной веб-службе описан в статье [Использование веб-службы машинного обучения Azure с шаблоном веб-приложения](machine-learning-consume-web-service-with-web-app-template.md).
