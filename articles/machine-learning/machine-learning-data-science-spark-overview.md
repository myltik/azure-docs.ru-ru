...
> [AZURE.NOTE] О том, как использовать Scala вместо Python для выполнения задач по полной обработке и анализу данных, см. в статье [Data Science using Scala with Spark on Azure](machine-learning-data-science-process-scala-walkthrough.md) (Обработка и анализ данных с помощью Scala и Spark в Azure).
