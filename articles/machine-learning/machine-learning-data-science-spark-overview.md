...
Записную книжку Jupyter можно запустить с портала Azure. Найдите кластер Spark на панели мониторинга и щелкните ее, чтобы войти на страницу управления кластером. Последовательно выберите **Панели мониторинга кластера** > **Записная книжка Jupyter** со значком для записной книжки Jupyter, связанной с кластером Spark.
