---
title: "Что такое машинное обучение в Azure? | Документация Майкрософт"
...
---
# <a name="introduction-to-machine-learning-in-the-cloud"></a>Введение в машинное обучение в облаке
...
## <a name="build-complete-machine-learning-solutions-in-the-cloud"></a>Создание полноценных решений машинного обучения в облаке
...
### <a name="operationalize-predictive-analytics-solutions-purchase-web-services-or-publish-your-own"></a>Ввод прогнозных решений в эксплуатацию: приобретение веб-служб или публикация собственной веб-службы
...
Вы можете изучить базовые принципы прогнозной аналитики и машинного обучения, используя [пошаговое руководство](machine-learning-create-experiment.md) и [создание сборок из образцов](machine-learning-sample-experiments.md).  
