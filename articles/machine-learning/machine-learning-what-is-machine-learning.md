...
Служба машинного обучения Azure — это особенно эффективная платформа прогнозирующей аналитики: вы можете работать с библиотекой готовых алгоритмов, создавать модели на подключенных к Интернету компьютерах, не покупая дополнительное оборудование или инфраструктуру, и быстро развертывать решение прогнозирования. Кроме того, в [Microsoft Azure Marketplace](https://datamarket.azure.com/browse?query=machine+learning) или [коллекции Cortana Intelligence](http://gallery.cortanaintelligence.com/) можно найти готовые примеры и решения.
