...
* [Коллекция аналитических данных Кортаны](machine-learning-gallery-how-to-use-contribute-publish.md) поможет вам начать работу со службой машинного обучения Azure и учиться у других членов сообщества. Изучайте эксперименты, созданные другими пользователями, задавайте вопросы, оставляйте комментарии об экспериментах или публикуйте собственные эксперименты. Вы также можете делиться ссылками на интересные эксперименты через социальные сети, такие как LinkedIn и Твиттер.  
	...
	![Попробуйте образцы прогностических экспериментов или представьте свои в коллекции аналитических данных Кортаны для Azure](./media/machine-learning-what-is-machine-learning/azure-machine-learning-gallery-resources.png)
