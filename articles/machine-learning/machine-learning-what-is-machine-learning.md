<properties
	...
	keywords="что такое машинное обучение, облачная технология, прогнозирование, что такое прогнозная аналитика, ввод в эксплуатацию"
...
Служба машинного обучения Azure — это особенно эффективная платформа прогнозирующей аналитики: вы можете работать с библиотекой готовых алгоритмов, создавать модели на подключенных к Интернету компьютерах, не покупая дополнительное оборудование или инфраструктуру, и быстро развертывать решение прогнозирования. Кроме того, можно найти готовые к использованию примеры и решения в [Microsoft Azure Marketplace](https://datamarket.azure.com/browse?query=machine+learning) или в [коллекции Cortana Analytics](http://gallery.azureml.net/) (ранее — коллекция машинного обучения Azure).
...
* В [коллекции Cortana Analytics](machine-learning-gallery-how-to-use-contribute-publish.md) можно попробовать аналитические решения, созданные другими пользователями, или представить собственные решения на основе служб Azure, включая машинное обучение, HDInsight (Hadoop), Stream Analytics, аналитику озера данных, а также хранилища больших данных Azure и службы управления данными. Задавайте сообществу вопросы и оставляйте комментарии об экспериментах, обменивайтесь ссылками на эксперименты через социальные сети, такие как LinkedIn и Twitter.  

	![Попробуйте прогностические эксперименты или представьте свои в коллекции Cortana Analytics](./media/machine-learning-what-is-machine-learning/machine-learning-cortana-analytics-gallery.png)
