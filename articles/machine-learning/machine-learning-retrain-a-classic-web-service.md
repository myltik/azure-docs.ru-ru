...
# Переобучение классической веб-службы
...
### Добавление конечной точки с помощью портала веб-служб Microsoft Azure
...
3. Щелкните **Добавить**.
4. Введите имя и описание новой конечной точки. Выберите уровень ведения журнала и укажите, включать ли образцы данных. Дополнительные сведения см. в статье [Включение функции ведения журналов для веб-служб машинного обучения](machine-learning-web-services-logging.md).

### Добавление конечной точки с помощью классического портала Azure
...
2.	В меню слева щелкните **Машинное обучение**.
3.	В поле "Имя" выберите рабочую область, а затем щелкните **Веб-службы**.
4.	В поле "Name" (Имя) щелкните "Census Model [predictive exp.]" (Модель ценза [прогнозный эксперимент]).
