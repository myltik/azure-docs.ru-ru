---
title: Переобучение классической веб-службы | Microsoft Docs
...
> [!NOTE]
> В этом пошаговом руководстве предполагается, что вы создали веб-службу, используя шаги, описанные в статье [Программное переобучение моделей машинного обучения](machine-learning-retrain-models-programmatically.md).
> 
> 
