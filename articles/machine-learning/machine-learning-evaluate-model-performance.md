...
Щелкните модуль [импорта данных][reader] и укажите для свойства *Источник данных* значение *URL-адрес веб-сайта через HTTP*, а для свойства *URL-адрес* — значение http://archive.ics.uci.edu/ml/machine-learning-databases/iris/iris.data.
