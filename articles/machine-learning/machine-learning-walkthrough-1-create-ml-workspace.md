---
title: Шаг 1. Создание рабочей области машинного обучения | Microsoft Docs
...
---
# Шаг 1. Создание рабочей области машинного обучения
...
2. На панели служб Azure выберите **МАШИННОЕ ОБУЧЕНИЕ**. ![Создание рабочей области][1]
...
Созданная рабочая область машинного обучения появится в списке на странице **Машинное обучение** классического портала Azure. Дополнительные сведения о создании рабочей области см. в статье [Создание рабочей области машинного обучения Azure](machine-learning-create-workspace.md).

> [!TIP]
> Чтобы сделать общими эксперименты, над которыми вы работаете, пригласите других пользователей в свою рабочую область. Это можно сделать в Студии машинного обучения на странице **ПАРАМЕТРЫ**. Для каждого пользователя необходима учетная запись Майкрософт или учетная запись организации.
> 
> 
