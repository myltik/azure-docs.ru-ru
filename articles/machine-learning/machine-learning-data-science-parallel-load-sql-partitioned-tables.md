...
В этом документе описывается создание секционированных таблиц для быстрого параллельного массового импорта данных в Базу данных SQL Server.

При загрузке и передаче массивов «больших данных» в базу данных SQL с помощью _секционированных таблиц и представлений_ можно оптимизировать импорт информации в эту базу, а также выполнение последующих запросов.
...
- Примечание. Это можно сделать с помощью команды [CREATE DATABASE](https://technet.microsoft.com/library/ms176061.aspx) при создании новой базы или команды [ALTER DATABASE](https://msdn.microsoft.com/library/bb522682.aspx), если база данных уже существует.
