...
При загрузке и передаче массивов «больших данных» в базу данных SQL с помощью _секционированных таблиц и представлений_ можно оптимизировать импорт информации в эту базу, а также выполнение последующих запросов. В этом документе описывается создание секционированных таблиц для быстрого параллельного массового импорта данных в базу данных SQL Server.
