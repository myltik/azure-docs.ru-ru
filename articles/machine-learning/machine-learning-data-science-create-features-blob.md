...
* Создали учетную запись хранилища больших двоичных объектов Azure и сохранили в ней свои данные. Инструкции по настройке учетной записи можно найти в статье [Создание учетной записи хранения в Azure](../hdinsight-get-started.md#storage).
...
3. Теперь вы можете считывать данные из большого двоичного объекта с помощью модуля [считывателя](https://msdn.microsoft.com/library/azure/4e1b0fe6-aded-4b3f-a36f-39b8862b9004/) Студии машинного обучения Azure (см. рисунок ниже).
