...
После [подписки](https://datamarket.azure.com/dataset/amla/recommendations) на службу рекомендаций для ее настройки следует использовать документацию по API в статье [Краткое руководство по API рекомендаций для машинного обучения](machine-learning-recommendation-api-quick-start-guide.md).

**Где найти документацию по API?** 

Документация по API содержится в статье [Краткое руководство по API рекомендаций для машинного обучения](machine-learning-recommendation-api-quick-start-guide.md).
