---
title: "Как выбрать параметры для оптимизации алгоритмов в машинном обучении Azure | Документация Майкрософт"
...
Модуль [секционирования и выборки][partition-and-sample] используется, чтобы в случайном порядке назначать свертки данным. Ниже приведен пример с конфигурацией модуля, где задано пять сверток и выбран параметр случайного присвоения номеров сверток экземплярам выборки.
