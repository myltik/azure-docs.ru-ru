...
Реконструирование и выбор характеристик являются частью процесса CAP, описанного в разделе [Что такое процесс аналитики Кортаны (CAP)](machine-learning-data-science-the-cortana-analytics-process.md). Проектирование и выбор признаков входят в этап **разработки признаков** процесса Cortana Analytics (CAP).
