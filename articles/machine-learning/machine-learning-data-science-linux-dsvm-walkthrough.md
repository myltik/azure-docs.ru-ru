---
title: "Обработка и анализ данных с использованием специально подготовленной виртуальной машины Linux | Документация Майкрософт"
...
---
# <a name="data-science-on-the-linux-data-science-virtual-machine"></a>Обработка и анализ данных с использованием специально подготовленной виртуальной машины Linux
...
Выберите вкладку **Authorization Tokens** (Маркеры авторизации) в верхнем меню и укажите значение в поле **Primary Authorization Token** (Основной маркер авторизации).![3](./media/machine-learning-data-science-linux-dsvm-walkthrough/workspace-token.png)
