...
* Дополнительные сведения о Службах машинного обучения Azure и Machine Learning Workbench см. в [кратком руководстве и инструкциях](../preview/index.yml) по использованию продукта. 
