...
Указания по установке программы AzCopy и дополнительные сведения о ее использовании с платформой Azure см. в разделе [Приступая к работе с программой командной строки AzCopy](../storage-use-azcopy.md).
