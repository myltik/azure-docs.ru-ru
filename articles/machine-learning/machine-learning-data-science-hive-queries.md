...
* загрузили данные в таблицы Hive в кластере Hadoop под управлением службы Azure HDInsight Если данные не загружены, необходимо предварительно загрузить их в таблицы Hive, воспользовавшись инструкциями из статьи [Создание данных и их загрузка в таблицы Hive](machine-learning-data-science-hive-tables.md).
