...
## <a name="discover"></a>Поиск
  Для поиска решений перейдите на сайт [коллекции](http://gallery.cortanaintelligence.com) и в верхней части главной страницы щелкните **Solutions**
 (Решения).

 На странице **[решений](https://gallery.cortanaintelligence.com/solutions)**
 отобразится список недавно добавленных решений.
Щелкните **See all** (Показать все), чтобы просмотреть все решения.
На открывшейся странице можно просмотреть все решения в коллекции. Здесь также можно воспользоваться фильтрами в левой части страницы или строкой поиска вверху, чтобы найти определенные решения.
