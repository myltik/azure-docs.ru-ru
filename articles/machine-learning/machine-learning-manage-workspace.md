...
- **Обзор использования** отображает данные службы хранилища Azure, которое использует рабочая область. Примечание. Мониторинг хранилища недоступен на протяжении использования общедоступной предварительной версии Машинного обучения Azure.
- **Сводка** предоставляет сведенную информацию о рабочей области и полезные ссылки.

> [AZURE.NOTE]Ссылка **ОТКРЫТЬ В СТУДИИ** позволяет открыть Студию машинного обучения, используя учетную запись Майкрософт, в которою вы вошли. Для учетной записи Майкрософт, использованной для входа на портал Azure для создания рабочей области, не предусмотрено автоматическое предоставление разрешений на открытие этой рабочей области. Чтобы открыть рабочую область, необходимо войти в учетную запись Майкрософт, определенную в качестве учетной записи владельца рабочей области, или получить приглашение присоединиться к рабочей области от владельца.
...
Чтобы обеспечить управление тем, у кого есть доступ к рабочей области в Студии машинного обучения, щелкните **ОТКРЫТЬ В СТУДИИ** (см. примечание о ссылке **ОТКРЫТЬ В СТУДИИ** выше). Рабочая область откроется в Студии машинного обучения. Здесь щелкните вкладку **ПАРАМЕТРЫ**, а затем — **ПОЛЬЗОВАТЕЛИ**. Вы можете щелкнуть **ПРИГЛАСИТЬ БОЛЬШЕ ПОЛЬЗОВАТЕЛЕЙ**, чтобы предоставить пользователям доступ к рабочей области, или выбрать пользователя и щелкнуть **УДАЛИТЬ**.
...
- В дополнение к конечной точке «По умолчанию» вы можете определить дополнительные конечные точки. Чтобы добавить конечную точку, щелкните **ДОБАВИТЬ КОНЕЧНУЮ ТОЧКУ** в нижней части страницы.
