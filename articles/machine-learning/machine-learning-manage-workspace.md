...
Чтобы управлять доступом к рабочей области в Студии машинного обучения, нажмите **Войти в Студию машинного обучения Microsoft Azure** на вкладке **ПАНЕЛЬ МОНИТОРИНГА** (см. примечание о команде **Войти в Студию машинного обучения**). Рабочая область откроется в Студии машинного обучения. Здесь щелкните вкладку **ПАРАМЕТРЫ**, а затем — **ПОЛЬЗОВАТЕЛИ**. Вы можете щелкнуть **ПРИГЛАСИТЬ БОЛЬШЕ ПОЛЬЗОВАТЕЛЕЙ**, чтобы предоставить пользователям доступ к рабочей области, или выбрать пользователя и щелкнуть **УДАЛИТЬ**.
