...
Описание каждого этапа см. в статье [Жизненный цикл процесса обработки и анализа данных группы](https://docs.microsoft.com/en-us/azure/machine-learning/team-data-science-process/lifecycle).

В этой статье приведены ссылки на шаблоны Microsoft Project и Excel, которые помогут вам при планировании этапов этого проекта и управлении ими. 
...
[Выполнение проектов по обработке и анализу данных](project-execution.md). Из этого документа вы узнаете, как с помощью командного процесса обработки и анализа данных выполнять проекты по обработке и анализу данных с соблюдением системного подхода, контролем версий и поддержкой совместной работы.
