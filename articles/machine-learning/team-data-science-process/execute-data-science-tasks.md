...
Такие продукты, как Azure Machine Learning Workbench, также предоставляют [расширенную подготовку данных](../preview/tutorial-bikeshare-dataprep.md) для повышения качества этих данных и их изучения, включая создание возможностей. Пользователь должен выбрать инструменты, библиотеки и пакеты, которые лучше всего подходят для выполнения его задач. 
