...
Чтобы получить доступ к головному узлу кластера в целях исследовательского анализа данных и сокращения их выборки, выполните процедуру, описанную в разделе [Доступ к головному узлу кластера Hadoop](customize-hadoop-cluster.md).
...
> [!IMPORTANT]
> Чтобы узнать больше о службе "Машинное обучение Azure", о доступе к ней и ее использовании, см. статью [Введение в машинное обучение в облаке Azure](../studio/what-is-machine-learning.md). Полезным ресурсом для экспериментов с машинным обучением Azure является [коллекция Cortana Intelligence](https://gallery.cortanaintelligence.com/). Коллекция охватывает спектр экспериментов и служит подробным введением в диапазон возможностей машинного обучения Azure.
> 
> 
