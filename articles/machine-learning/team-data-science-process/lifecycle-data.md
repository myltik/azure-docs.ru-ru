...
Процесс TDSP включает автоматизированное средство [IDEAR](https://github.com/Azure/Azure-TDSP-Utilities/blob/master/DataScienceUtilities/DataReport-Utils), которое позволяет визуализировать данные и подготавливать сводные отчеты. Мы рекомендуем приступить к интерактивному изучению исходных данных с помощью IDEAR до написания кода. И только потом создавать пользовательский код для просмотра и визуализации данных. Рекомендации по очистке данных см. в статье [Задачи по подготовке данных для расширенного машинного обучения](prepare-data.md).  
