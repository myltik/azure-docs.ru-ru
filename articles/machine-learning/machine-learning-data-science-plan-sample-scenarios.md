<properties
	...
	description="Выбор оптимальных сценариев использования процесса расширенной прогнозной аналитики в среде машинного обучения Azure"
...
В этой статье описаны различные источники образцов данных и типовые сценарии, в которых можно использовать процесс Cortana Analytics. В ней продемонстрированы некоторые варианты и последовательности операций обработки на основе характеристик данных, исходного расположения и целевых репозиториев в Azure.
...
>[AZURE.NOTE] **Для каждого из них вам понадобится:**

*   [создать учетную запись хранения;](../storage/storage-create-storage-account.md)
