...
4. Отправьте эту веб-службу на конкурс в виде заявки и просмотрите свой открытый результат на странице коллекции Cortana Intelligence. И отпразднуйте, если окажетесь в таблице лидеров!  
   После успешной отправки заявки можно перейти к скопированному начальному эксперименту, выполнить итерации и обновить прогнозирующий эксперимент, обновить веб-службу и отправить новую заявку.   
