---
title: 'Шаг 2: передача данных в эксперимент машинного обучения | Microsoft Docs'
...
6. В диалоговом окне **Отправка нового набора данных** нажмите кнопку **Обзор** и найдите созданный ранее файл **german.csv**.
