...
. Обратите внимание, что для входа потребуется ввести учетные данные кластера Hadoop. Или же вы можете [отправить задания Hive с использованием PowerShell](../hdinsight/hdinsight-submit-hadoop-jobs-programmatically.md#hive-powershell). 
