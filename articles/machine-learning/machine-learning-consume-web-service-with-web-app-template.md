...
3. Перейдите по ссылке [Веб-приложение службы ответов на запросы Azure ML](https://azure.microsoft.com/marketplace/partners/microsoft/azuremlaspnettemplateforrrs/) и нажмите кнопку **Создать веб-приложение**. Шаблон перенаправит вас на портал Microsoft Azure, где создается новое веб-приложение.
