...
3. Откройте [портал Azure](https://portal.azure.com), выполните **вход**, щелкните **Создать**, найдите и выберите **веб-приложение службы "запрос — ответ" Azure ML** и щелкните **Создать**.
