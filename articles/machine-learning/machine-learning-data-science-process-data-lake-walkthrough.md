---
title: "Пошаговое руководство по масштабируемому анализу данных в Azure Data Lake | Документация Майкрософт"
...
---
# <a name="scalable-data-science-in-azure-data-lake-an-end-to-end-walkthrough"></a>Полное пошаговое руководство по масштабируемому анализу данных в озере данных Azure
...
> AZURE.NOTE **Azure Data Lake Store** можно создать отдельно или вместе с **Azure Data Lake Analytics** в качестве хранилища по умолчанию. Указания по созданию каждого из этих ресурсов приведены по отдельности ниже, но учетную запись хранения Data Lake не требуется создавать отдельно.
> <br/>
> 
