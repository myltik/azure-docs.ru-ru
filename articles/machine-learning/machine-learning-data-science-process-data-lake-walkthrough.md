---
title: Пошаговое руководство по масштабируемому анализу данных в озере данных Azure | Microsoft Docs
...
> [!NOTE]
> Чтобы отправлять запросы озера данных Azure, вместо Visual Studio можно также использовать портал Azure. Указания о том, как сделать это с помощью Visual Studio и на портале, см. в разделе **Обработка данных с использованием U-SQL**.
> 
> 
