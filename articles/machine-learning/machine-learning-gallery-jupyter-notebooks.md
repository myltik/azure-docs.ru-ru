...
## <a name="discover"></a>Обнаружение
  Для поиска записных книжек в коллекции откройте страницу [Gallery](http://gallery.cortanaintelligence.com) (Коллекция) и в верхней части начальной страницы коллекции щелкните **Notebooks**
 (Записные книжки).

 На странице **[Jupyter Notebooks](https://gallery.cortanaintelligence.com/notebooks)**
 (Записные книжки Jupyter) отобразится список самых популярных записных книжек.
Щелкните **See all** (Показать все), чтобы просмотреть все записные книжки.
На открывшейся странице можно просмотреть все записные книжки в коллекции. Здесь также можно воспользоваться фильтрами в левой части страницы или строкой поиска вверху, чтобы найти определенные записные книжки.
