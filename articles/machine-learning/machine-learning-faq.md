...
**Можно ли развернуть прогнозный эксперимент как новую веб-службу (на основе ARM), если он уже развернут в виде классической веб-службы?**
...
Служба машинного обучения является мультитенантной, и фактические вычислительные ресурсы, используемые на сервере, различаются. Кроме того, они оптимизируются для повышения производительности и качества прогнозирования.
...
Экземпляр плана — это единица включенного объема, которую можно добавить в план выставления счетов. Изначально в уровень выставления счетов, который выбирается для плана, включен один экземпляр. Если вам требуется больший объем, можно добавить дополнительные экземпляры выбранного уровня выставления счетов в план.
