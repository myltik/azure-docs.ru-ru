...
Сведения о возможности ввода изображений можно узнать в справочнике по модулю [импорта изображений][image-reader].
...
После того как прогнозная модель была развернута, вы сможете контролировать ее через классический портал Azure. Каждая развернутая служба имеет свою собственную панель мониторинга, где вы сможете увидеть данные мониторинга для этой службы. Дополнительную информацию об управлении развернутыми веб-службами см. в статье [Управление рабочей областью машинного обучения Azure](machine-learning-manage-workspace.md).
