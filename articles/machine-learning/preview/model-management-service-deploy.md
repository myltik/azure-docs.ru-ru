...
>[!NOTE] 
>Вы также можете использовать одну команду для выполнения обоих действий. Используйте -h с командой service create, чтобы получить более подробные сведения.
...
Теперь, когда вы протестировали веб-службу в локальной среде, ее можно развернуть в кластере для крупномасштабного использования. Дополнительные сведения о настройке кластера для развертывания веб-службы см. в статье [Установка службы управления моделями](model-management-configuration.md). 
