...
---
# <a name="deploy-and-azure-machine-learning-model-to-an-azure-iot-edge-device"></a>Развертывание модели машинного обучения Azure на устройстве Azure IoT Edge
...
Для ввода модели в эксплуатацию необходимо выполнить инструкции из статьи [Развертывание модели машинного обучения в качестве веб-службы](https://docs.microsoft.com/en-us/azure/machine-learning/preview/model-management-service-deploy), чтобы создать образ Docker с вашей моделью.
