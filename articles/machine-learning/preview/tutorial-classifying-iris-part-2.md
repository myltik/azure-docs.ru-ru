...
9. В том же состоянии задания на панели "Задания" щелкните синий текст **iris_sklearn.py [1]** непосредственно над состоянием **Завершено** и временем начала. Откроется страница **Свойства запуска**. На ней отображается информация о свойствах запуска **выходных** файлов, **визуализации** и **журналы**, связанные с определенной процедурой выполнения. 
