...
| Имя поля | Тип | Описание | Содержит недостающие значения |
|------------|------|-------------|---------------|
...
| `SponsorName` | Строка | Имя основного автора, который предложил законопроект или резолюцию. | Да |
| `Type` | Строка | Тип должности основного автора: rep (представитель) или sen (сенатор). | Да |
| `State` | Строка | Штат основного автора. | Да |
| `District` | Целое число  | Номер округа основного автора, если в качестве должности указан представитель. | Да |
| `Party` | Строка | Партия основного автора. | Да |
| `Subjects` | Строка | Термины предметной области, совокупно добавленные в законопроект в Библиотеке Конгресса США. Эти термины указываются через запятую. Они записываются сотрудником Библиотеки Конгресса США и, как правило, отсутствуют при первой публикации сведений о законопроекте. Термины могут быть добавлены в любое время. Таким образом, к концу жизненного цикла законопроекта некоторые термины могут больше не относиться к нему. | Да |
