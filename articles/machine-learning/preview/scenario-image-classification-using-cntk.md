...
- Код был протестирован с использованием CNTK 2.0 и 2.1 и должен работать в более новых версиях без каких-либо (или только незначительных) изменений.
...
Наконец, предоставляется записная книжка `showResults.py`, в которой можно просмотреть тестовые изображения и визуализировать их оценки:
<p align="center">
...
Теперь обученную систему можно опубликовать как REST API. Развертывание объясняется в записной книжке `deploy.ipynb` и основывается на функциональности в Azure Machine Learning Workbench. См. раздел о правильном развертывании в статье [Часть 3. Классификация цветков ириса: развертывание модели](https://docs.microsoft.com/azure/machine-learning/preview/tutorial-classifying-iris-part-3).
