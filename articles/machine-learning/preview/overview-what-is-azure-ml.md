...
В Azure, помимо службы "Машинное обучение Microsoft Azure", есть много других возможностей для построения и развертывания моделей машинного обучения, а также управления ими. [Подробнее здесь.](overview-more-machine-learning.md)
