...
>[!NOTE]
>Если у вас нет локальной подсистемы Docker, вы все еще можете создать для развертывания кластер в Azure. Не забудьте удалить этот кластер после завершения работы с руководством, чтобы не оплачивать его использование.
