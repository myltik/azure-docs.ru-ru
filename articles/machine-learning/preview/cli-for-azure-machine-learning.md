---
title: Установка и использование интерфейса командной строки для важнейших задач службы "Машинное обучение Azure"
...
>[!NOTE]
>CLI, поставляемый со службой "Машинное обучение Azure", отличается от [Azure CLI](https://docs.microsoft.com/en-us/cli/azure/?view=azure-cli-latest), который используется для управления ресурсами Azure.
