...
В этом разделе мы создадим проект, используя образец проекта в качестве шаблона.
...
Теперь нужно скачать модель с повышенным уровнем, чтобы применить ее для создания веб-службы прогнозирования. 
