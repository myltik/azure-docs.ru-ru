...
- Установленное приложение Azure Machine Learning Workbench. Инструкции по установке см. в статье [Создание учетной записи для предварительной версии службы "Машинное обучение Azure" и установка Azure Machine Learning Workbench](quickstart-installation.md). 
