...
* Перейдите к каталогу **C:\\Program Files\\Microsoft\\MRO-for-RRE\\8.0\\R-3.2.2\\library\\RevoScaleR\\demoScripts**, в котором можно найти примеры использования библиотеки RevoScaleR в R, которая поддерживает анализ данных на корпоративном уровне.  
