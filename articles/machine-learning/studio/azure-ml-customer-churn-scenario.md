...
В этой статье содержатся сведения об эталонной реализации проекта анализа оттока клиентов, созданного в Машинном обучении Azure. Кроме того, здесь рассматриваются соответствующие универсальные модели для комплексного решения проблем оттока промышленных клиентов. Мы также измерения точности моделей, построенных с помощью машинного обучения и оценки направлениях для дальнейшей разработки.  
...
Все предприятия объединяет одно — необходимость минимизации особых усилий по удержанию клиентов. Таким образом, абсолютно естественным вариантом будет оценка каждого клиента на предмет склонности к оттоку и принятие соответствующих мер к самым важным из них. Лучшие клиенты могут быть наиболее выгодных из них. Например в более сложных сценариях во время выбора кандидатов для специальных dispensation работает функция роста прибыли. Однако эти соображения имеют только часть полного стратегии обработки обработка. Компании также должны принимать во внимание риск (и связанную рискоустойчивость), уровень и стоимость вмешательства и обоснованную сегментацию клиентов.  
...
Например, на рынке мобильных телефонов хорошо известным фактором оттока является выбор нового устройства. В результате популярных политикой является subsidize цены мобильный телефон для новых подписчиков и плату полную стоимость для существующих клиентов для обновления. Традиционно эта политика привело к клиентам «прыгающих» от одной службы в другую новую скидку. Это, в свою очередь, запрос поставщиков для уточнения своей стратегии.

Высокий уровень изменчивости в предложениях переносные-фактор быстро делает недействительными модели обработки, основанных на мобильном телефоне моделей. Кроме того мобильные телефоны не только телекоммуникационные устройства, они также присутствуют операторы перебора (попробуйте iPhone). Этих социальных сетей для прогнозирования выходят за рамки регулярного телекоммуникационных наборов данных.
