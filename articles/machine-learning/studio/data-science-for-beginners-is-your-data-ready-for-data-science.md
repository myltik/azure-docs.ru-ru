...
description: "Четыре критерия данных должны соответствовать должны быть готовы для обработки и анализа данных. В этом видео имеет конкретные примеры, помогающие с оценки данных."
...
Взгляните на мишень в правом верхнем углу. У нас есть тесной группирования вправо относительно bulls глаза. Конечно, это пример точных данных. Как ни странно, но на языке обработки и анализа данных попадания, изображенные на мишени в правом нижнем углу, также считаются точными.

Если для сопоставления в центр стрелки, вы увидите, что он очень близок к bulls глаза. Стрелки распределено замкнутый целевого объекта, поэтому вы считается неточным, но они выполняется по центру вокруг глаза bulls, поэтому выполняется считать точными.

Теперь взгляните на мишень в левом верхнем угле. Здесь мы видим, что все попадания находятся близко друг к другу, то есть плотно сгруппированы. Они точно, но они неверные, так как центр является способом off глаз bulls. И, конечно же, в левом нижнем углу показана мишень с попаданиями, которые не являются ни точными, ни меткими. Этому лучнику нужно больше тренироваться.
