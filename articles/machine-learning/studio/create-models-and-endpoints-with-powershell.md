...
К счастью, этой цели можно достичь, используя [API переобучения Машинного обучения Azure](retrain-models-programmatically.md) и автоматизировав задачу с помощью [PowerShell для Машинного обучения Microsoft Azure](powershell-module.md).
