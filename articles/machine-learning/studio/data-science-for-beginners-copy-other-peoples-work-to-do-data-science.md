...
> [!IMPORTANT]
> Был переименован коллекции аналитики Cortana **коллекции AI Azure**. В результате текст и изображения в запись разговора несколько отличаться от видео, который использует прежнее имя.
>
...
## <a name="find-examples-in-the-azure-ai-intelligence-gallery"></a>Примеры можно найти в коллекции Azure AI аналитики
