...
-	Количество весов на ядро равно: _1 + **KernelShape**[0] * **KernelShape**[1] * **KernelShape**[2] = 1 + 1 * 5 * 5 = 26. Или 26 * 50 = 1300_.
...
-	Так как **Sharing**[d] имеет значение False только для _d == 0_, количество ядер равно _**MapCount** * **NodeCount**[0] = 10 * 5 = 50_. 
