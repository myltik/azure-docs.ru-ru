...
В этом примере показано, как создать файлы, необходимые для пользовательского R-модуля, упаковать их в ZIP-файл и затем зарегистрировать модуль в рабочей области Машинного обучения. Пример ZIP-пакета и файлов можно загрузить [отсюда](http://go.microsoft.com/fwlink/?LinkID=524916&clcid=0x409).
...
\*\* Указывает, являются ли результаты модуля детерминированными и недетерминированными
...
Например, для вывода наборов данных Dataset1 и Dataset2 для портов вывода dataset, dataset1 и dataset2 слева направо, определите, соответственно, порты вывода в файле CustomAddRows.xml следующим образом:
