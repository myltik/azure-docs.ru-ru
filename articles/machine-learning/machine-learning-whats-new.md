...
* Веб-службы теперь управляются как ресурсы Azure, с помощью интерфейсов [Azure Resource Manager](../azure-portal/resource-group-overview.md) (ARM), что обеспечивает следующие усовершенствования:
* Добавлены новые [интерфейсы REST API](https://msdn.microsoft.com/library/azure/Dn950030.aspx) для развертывания веб-служб на основе ARM и управления ими.
* Доступен новый портал [веб-служб Машинного обучения Microsoft Azure](https://services.azureml.net/), который обеспечивает централизованное управление всеми аспектами веб-службы. I
* Добавлена новая модель развертывания веб-служб в нескольких регионах по подписке, в которой применяются интерфейсы API на основе ARM, использующие ARM RP для веб-служб.
* Добавлены новые [ценовые планы](https://azure.microsoft.com/pricing/details/machine-learning/) и возможности планирования управления, использующие новые функции ARM RP для выставления счетов.
