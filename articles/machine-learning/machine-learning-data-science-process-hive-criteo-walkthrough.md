<properties 
	pageTitle="Обработка аналитических данных и технология расширенного анализа данных на практике: использование кластеров HDInsight Hadoop с набором данных Criteo объемом 1 ТБ | Microsoft Azure" 
