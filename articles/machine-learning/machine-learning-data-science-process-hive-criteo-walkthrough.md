...
### <a name="a-namestep3a-step-3-build-train-and-score-the-model"></a><a name="step3"></a> Шаг 3. Создание, обучение и оценка модели
...
### <a name="a-namestep4a-step-4-evaluate-the-model"></a><a name="step4"></a> Шаг 4. Анализ модели
...
### <a name="a-namestep5a-step-5-publish-the-model-as-a-web-service"></a><a name="step5"></a> Шаг 5. Публикация модели в качестве веб-службы
