...
>[AZURE.NOTE] Этот этап решения применяется только для пакетной обработки.
...
>[AZURE.NOTE] Если необходимо очистить набор данных Power BI, запустите RealtimeDashboardApp с использованием параметра flushdata:
