...
В статье описываются эти поддерживаемые источники и приводятся сведения, необходимые для переноса данных из этих источников в эксперимент машинного обучения Azure.
