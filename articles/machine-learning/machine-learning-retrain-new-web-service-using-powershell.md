...
# Переобучение новой веб-службы с помощью командлетов управления PowerShell Машинного обучения
...
Вы уже настроили обучающий и прогнозный эксперименты, как показано в статье "Программное переобучение моделей машинного обучения". Дополнительные сведения о создании обучающих и прогнозных экспериментов см. в статье [Программное переобучение моделей машинного обучения](Retrain Machine Learning models programmatically.md).

Для этого процесса требуется установить командлеты Машинного обучения Azure. Сведения по установке командлетов Машинного обучения Azure см. по [этой ссылке](https://msdn.microsoft.com/library/azure/mt767952.aspx) на сайте MSDN.
...
### Получение определения веб-службы
...
### Экспорт определения веб-службы в формате JSON
...
### Обновление ссылки на большой двоичный объект ilearner в JSON

В ресурсах-контейнерах найдите элемент [trained model], обновите значение *uri* в узле *locationInfo*, заменив его универсальным кодом ресурса (URI) большого двоичного объекта ilearner. URI формируется в результате объединения параметров *BaseLocation* и *RelativeLocation* из выходных данных вызова переобучения BES.
...
### Импорт JSON в определение веб-службы
...
### Обновление веб-службы с помощью нового определения веб-службы
