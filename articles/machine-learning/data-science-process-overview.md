...
2. Определите **целевые показатели модели**, создавая и уточняя острые вопросы: релевантные, конкретные и однозначные. Обработка и анализ данных — это работа с именами и числами для получения ответов на такие вопросы. Дополнительные рекомендации ответов на острые вопросы см. в блоге [Обработка и анализ данных](https://blogs.technet.microsoft.com/machinelearning/2016/03/28/how-to-do-data-science/). Обработка и анализ данных наряду с машинным обучением обычно применяются, чтобы отвечать на вопросы следующих пяти типов.
