...
## <a name="a-idmlstudioainteract-with-r-language-in-machine-learning-studio"></a><a id="mlstudio"></a>Работа с языком R в Студии машинного обучения
...
## <a name="a-idscriptmoduleaget-data-in-and-out-of-the-execute-r-script-module"></a><a id="scriptmodule"></a>Добавление данных в модуль «Выполнение сценария R» и их извлечение оттуда
...
#### <a name="a-idloadingaload-the-dataset"></a><a id="loading"></a>Загрузка набора данных
...
## <a name="a-idfilteringadata-filtering-and-transformation"></a><a id="filtering"></a>Фильтрация и преобразование данных
...
## <a name="a-idtimeseriesatime-series-objects-and-correlation-analysis"></a><a id="timeseries"></a>Объекты временного ряда и корреляционный анализ
...
## <a name="a-idseasonalforecastingatime-series-example-seasonal-forecasting"></a><a id="seasonalforecasting"></a>Пример временных рядов: сезонное прогнозирование
...
## <a name="a-idappendixaaappendix-a-guide-to-rstudio"></a><a id="appendixa"></a>ПРИЛОЖЕНИЕ А. Руководство по RStudio
...
## <a name="a-idappendixbaappendix-b-further-reading"></a><a id="appendixb"></a>ПРИЛОЖЕНИЕ Б. Дополнительные материалы
