...
- Щелкните __+ СОЗДАТЬ__ в нижнем левом углу экрана и выберите **Набор данных**.
...
- Щелкните __+ СОЗДАТЬ__ в левом нижнем углу и выберите **Эксперимент**, а затем — **Пустой эксперимент**.
...
- Соедините порт вывода **набора данных csdairydata.csv** с крайним левым портом ввода (**Набор данных 1**) модуля [Выполнение сценария R][execute-r-script].
...
2.  Создайте ZIP-файл и скопируйте в него свой скрипт. В Windows щелкните правой кнопкой мыши файл и выберите __Отправить__, а затем — __Сжатая ZIP-папка__. Будет создан ZIP-файл, содержащий файл "simpleplot.R".
