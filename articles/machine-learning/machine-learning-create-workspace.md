...
> [AZURE.NOTE] * Когда создается рабочая область, администратор подписки Azure автоматически становится владельцем этой рабочей области. При этом доступ предоставляется только потому, что он является владельцем рабочей области.
