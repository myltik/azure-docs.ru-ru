...
Следующие **типы данных** распознаются студией машинного обучения:
...
Для передачи данных между модулями студия машинного обучения Microsoft Azure использует внутренний тип данных, который называется ***таблица данных***. Данные можно явно преобразовать в формат Data Table с использованием модуля [Преобразование в набор данных][convert-to-dataset].
