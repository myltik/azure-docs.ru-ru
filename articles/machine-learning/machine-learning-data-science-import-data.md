...
* заранее создать модуль набора данных в рабочем пространстве, отправив данные из **локального файла** на жестком диске;  
...
> [!NOTE]
> В студии машинного обучения Microsoft Azure есть множество примеров наборов данных, которые можно использовать для этой цели. Подробнее в статье [Использование образцов наборов данных в Студии машинного обучения Azure](machine-learning-use-sample-datasets.md).
> 
> 
...
Вы можете явно указать или изменить заголовки и типы данных для столбцов с помощью функции [Edit Metadata][edit-metadata] (Изменение метаданных).
