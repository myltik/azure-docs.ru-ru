---
title: Настройка SQL Server на виртуальной машине, как сервера IPython Notebook | Microsoft Docs
...
Для подключения дополнительных дисков с данными выполните действия, описанные в статье [Как подключить диск с данными к виртуальной машине Windows](../virtual-machines/virtual-machines-windows-classic-attach-disk.md), которая описывает следующие этапы.
...
1. В **обозревателе объектов SQL Server Management Studio** щелкните правой кнопкой мыши имя экземпляра SQL Server (имя виртуальной машины) и выберите **Свойства**.
   
   ![Свойства сервера][7]
2. На странице **Безопасность** в разделе **Проверка подлинности сервера** выберите **Режим проверки подлинности SQL Server и Windows** и нажмите кнопку **ОК**.
   
   ![Выберите режим проверки подлинности][8]
3. В диалоговом окне **SQL Server Management Studio** нажмите кнопку **OK**, согласившись с перезапуском SQL Server.
4. В **обозревателе объектов** щелкните сервер правой кнопкой мыши и выберите **Перезагрузить**. (Если выполняется агент SQL Server, его также нужно перезапустить).
   
   ![Перезагрузить][9]
5. В **диалоговом окне SQL Server Management Studio** нажмите кнопку **Да** для подтверждения перезапуска SQL Server.
