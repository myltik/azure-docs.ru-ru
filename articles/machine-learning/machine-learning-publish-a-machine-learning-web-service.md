---
title: Развертывание веб-службы машинного обучения | Microsoft Docs
...
> [!NOTE]
> Если ранее вы изменили конфигурацию исходной веб-службы, например ввели новое отображаемое имя или описание, эти сведения нужно будет ввести еще раз.
> 
> 
