...
- получить доступ к данным из одного из нескольких **источников данных в Интернете** во время запуска эксперимента с помощью модуля [Reader][reader]; 
...
> [AZURE.NOTE]В студии машинного обучения Microsoft Azure есть множество примеров наборов данных, которые можно использовать для этой цели. (см. статью [Использование примеров наборов данных в студии машинного обучения Microsoft Azure](machine-learning-use-sample-datasets.md)).
...
Студия машинного обучения Microsoft Azure для передачи данных между модулями использует внутренний тип данных, который называется ***Data Table***. Данные можно явно преобразовать в формат Data Table с использованием модуля [Преобразование в набор данных][convert-to-dataset].
