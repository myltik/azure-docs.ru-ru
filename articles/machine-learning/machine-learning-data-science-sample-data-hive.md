...
Если размер набора данных, который планируется проанализировать, слишком большой, обычно рекомендуется уменьшить выборку данных до размера, который останется репрезентативным и будет более управляемым. Это способствует пониманию данных, их исследованию и проектированию характеристик. Роль выборки данных в процессе и технологии расширенного анализа (ADAPT) Машинного обучения Azure заключается в возможности быстрого создания прототипов функций обработки данных и моделей машинного обучения.

В этой статье мы опишем, как уменьшить выборку данных в таблицах Azure HDInsight Hive с помощью запросов Hive. Мы охватим три распространенных метода выборки: универсальную случайную выборку, случайную выборку по группам и стратифицированную выборку.

Запросы Hive следует отправлять из консоли командной строки Hadoop на головном узле кластера Hadoop. Для этого войдите в головной узел кластера Hadoop, откройте окно командной строки Hadoop и отправьте оттуда запросы Hive. Для получения инструкций по отправке запросов Hive в консоли командной строки Hadoop см. статью [Как отправлять запросы Hive](machine-learning-data-science-process-hive-tables.md#submit).
