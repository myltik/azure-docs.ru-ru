...
Обратите внимание и на то, что мы устанавливаем для параметра веб-службы URL-адрес, используемый модулем **Импорт данных**. Это позволяет использовать такой параметр, чтобы указать отдельные наборы данных в целях обучения модели для каждого расположения. Существуют и другие способы для выполнения этой задачи, например с помощью SQL-запроса с параметром веб-службы для получения данных из Базы данных SQL Azure или простое использование модуля **входных данных веб-службы** для передачи набора данных в веб-службу.
