...
При написании приложения, которое вызывает окончательную веб-службу, может потребоваться указать другой входной запрос или целевую таблицу во время выполнения. Чтобы настроить эти входные и выходные данные, можно воспользоваться функцией Web Service Parameters (Параметры веб-службы). С ее помощью можно задать свойство *Источник данных* модуля *Импорт данных* и свойство Data destination (Назначение данных) модуля *Экспорт данных*.  Дополнительные сведения о параметрах веб-службы см. в публикации [AzureML Web Service Parameters](https://blogs.technet.microsoft.com/machinelearning/2014/11/25/azureml-web-service-parameters/) (Параметры веб-службы AzureML) блога, посвященного Cortana Intelligence и машинному обучению Azure.
