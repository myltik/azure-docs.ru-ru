---
title: Что такое Студия машинного обучения Azure | Microsoft Docs
...
### Коллекция
Щелкните вкладку **Коллекция**, чтобы перейти к коллекции Cortana Intelligence. Коллекция — это место, где разработчики и специалисты по данным могут обмениваться решениями, созданными с помощью компонентов Cortana Intelligence Suite.
