...
Щелкните вкладку **Коллекция**, чтобы перейти в коллекцию Cortana Intelligence. Коллекция — это место, где разработчики и специалисты по данным могут обмениваться решениями, созданными с помощью компонентов Cortana Intelligence Suite.

Дополнительные сведения о коллекции см. в статье [Поиск и совместное использование решений в коллекции Cortana Intelligence](machine-learning-gallery-how-to-use-contribute-publish.md).
