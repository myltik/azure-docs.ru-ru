...
Чтобы продемонстрировать, как это можно изменить, давайте возьмем для примера вопрос "Какой новостной репортаж представляет наибольший интерес для читателя?" Здесь запрашивается прогноз одного варианта из множества вариантов. Другими словами: "Это A, B, C или D?" И в этом случае будет использоваться алгоритм классификации.
