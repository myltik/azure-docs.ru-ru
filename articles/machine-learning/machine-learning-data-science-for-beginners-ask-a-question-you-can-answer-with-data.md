<properties
   pageTitle="Задайте вопрос, на который можно ответить с помощью данных. Обработка и анализ данных для начинающих| Microsoft Azure"
...
Добро пожаловать в третье видео из цикла "Обработка и анализ данных для начинающих".
