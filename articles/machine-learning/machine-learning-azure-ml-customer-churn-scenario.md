...
> Обратите внимание, что эти данные являются частными, поэтому общий доступ к модели и данным должен быть ограничен. Тем не менее в примере [Коллекция аналитических данных Кортаны](http://gallery.azureml.net/): [отток клиентов Telco](http://gallery.azureml.net/Experiment/31c19425ee874f628c847f7e2d93e383) приведен эксперимент, где для построения аналогичной модели используются общедоступные данные.
> 
> Для получения дополнительных сведений о реализация модели анализа оттока с помощью Cortana Analytics Suite мы рекомендуем просмотреть [этот видеоролик](https://info.microsoft.com/Webinar-Harness-Predictive-Customer-Churn-Model.html) с участием старшего руководителя программы Ви Хен Тока (Wee Hyong Tok).
> 
...
[2] Статья из Википедии. [Точность и прецизионность](http://en.wikipedia.org/wiki/Accuracy_and_precision)
...
[5] [Шаблон модели оттока клиентов Telco] (http://gallery.cortanaanalytics.com/Experiment/Telco-Customer-Churn-5) в коллекции Cortana Analytics
##Приложение
