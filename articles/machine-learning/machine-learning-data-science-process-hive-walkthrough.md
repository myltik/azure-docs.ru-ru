...
Пошаговое руководство, показывающее, как обработать более крупный (1 терабайт) набор данных для подобного сценария с помощью кластеров HDInsight Hadoop для обработки данных, см. в статье [Процесс и технология расширенной аналитики в действии — использование кластеров Azure HDInsight Hadoop для набора данных объемом 1 ТБ](machine-learning-data-science-process-hive-criteo-walkthrough.md).
