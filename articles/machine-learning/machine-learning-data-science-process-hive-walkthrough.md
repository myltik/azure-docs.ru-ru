---
title: "Процесс обработки и анализа данных группы на практике: использование кластеров Hadoop | Документация Майкрософт"
...
## <a name="a-namesetupaset-up-an-hdinsight-hadoop-cluster-for-advanced-analytics"></a><a name="setup"></a>Настройка кластера HDInsight Hadoop для расширенной аналитики
> [!NOTE]
...
## <a name="a-namegetdataaget-the-data-from-a-public-source"></a><a name="getdata"></a>Получение данных из общедоступного источника
> [!NOTE]
> Эту задачу обычно выполняет **администратор** .
> 
> 
...
## <a name="a-nameuploadaupload-the-data-to-the-default-container-of-azure-hdinsight-hadoop-cluster"></a><a name="upload"></a>Отправка данных в контейнер по умолчанию кластера Azure HDInsight Hadoop
> [!NOTE]
> Эту задачу обычно выполняет **администратор** .
> 
> 
...
## <a name="a-namedownload-hql-filesalog-into-the-head-node-of-hadoop-cluster-and-and-prepare-for-exploratory-data-analysis"></a><a name="#download-hql-files"></a>Вход в головной узел кластера Hadoop и подготовка к исследовательскому анализу данных
> [!NOTE]
> Эту задачу обычно выполняет **администратор** .
> 
> 
...
## <a name="a-namehive-db-tablesacreate-hive-database-and-tables-partitioned-by-month"></a><a name="#hive-db-tables"></a>Создание базы данных Hive и таблиц, секционированных по месяцам
> [!NOTE]
> Эту задачу обычно выполняет **администратор** .
> 
> 
...
## <a name="a-nameload-dataaload-data-to-hive-tables-by-partitions"></a><a name="#load-data"></a>Загрузка данных в таблицы Hive по разделам
> [!NOTE]
> Эту задачу обычно выполняет **администратор** .
> 
> 
...
### <a name="a-nameshow-dbashow-databases-in-the-hdinsight-hadoop-cluster"></a><a name="#show-db"></a>Отображение баз данных в кластере HDInsight Hadoop
...
### <a name="a-nameshow-tablesashow-the-hive-tables-in-the-nyctaxidb-database"></a><a name="#show-tables"></a>Отображение таблиц Hive в базе данных nyctaxidb
...
## <a name="a-nameexplore-hiveadata-exploration-and-feature-engineering-in-hive"></a><a name="#explore-hive"></a>Исследование данных и проектирование признаков в Hive
> [!NOTE]
...
## <a name="a-namedownsampleadown-sample-data-and-build-models-in-azure-machine-learning"></a><a name="#downsample"></a>Сокращение выборки и построение моделей в машинном обучении Azure
> [!NOTE]
> Обычно эту задачу выполняет **специалист по обработке и анализу данных** .
> 
> 
