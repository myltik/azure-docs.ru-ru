...
3. **Каким образом вы собираетесь перемещать данные?** Процедуры и ресурсы, доступные для приема и загрузки данных в различные среды хранения и обработки, описаны в следующих разделах:
