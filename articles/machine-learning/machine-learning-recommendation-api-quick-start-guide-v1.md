<properties 
	pageTitle="Краткое руководство по API рекомендаций для машинного обучения | Microsoft Azure" 
...
Версия: 1.0<br>. Последнюю версию можно загрузить [здесь](machine-learning-recommendation-api-quick-start-guide.md).
...
* Импортировать данные об использовании. Данные об использовании можно загрузить двумя способами:
	...
	* путем отправки событий сбора данных. Обычно вы загружаете файл с данными об использовании, чтобы создать исходную модель рекомендаций (программу начальной загрузки) и использовать ее, пока система не соберет достаточно данных с помощью формата сбора данных.
...
###Получение статусов сборок модели
