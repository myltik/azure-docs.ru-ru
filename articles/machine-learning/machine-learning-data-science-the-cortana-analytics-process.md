...
Действия данной процедуры пояснены схемами в статье [Схема обучения CAP](https://azure.microsoft.com/ru-RU/documentation/learning-paths/cortana-analytics-process/) и описаны ниже.
