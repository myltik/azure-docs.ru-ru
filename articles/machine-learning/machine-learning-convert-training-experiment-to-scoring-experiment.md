...
2. Модули, которые явно не нужны, удаляются. В нашем примере это модуль [Split Data][split] (Разделение данных), второй модуль [Оценка модели][score-model] и модуль [Анализ модели][evaluate-model].
