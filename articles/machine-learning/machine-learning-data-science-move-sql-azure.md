...
Процедуры перемещения данных в базу данных SQL Azure с фабрикой данных Azure (ADF) приведены в статье [Перенос данных из локального SQL Server в SQL Azure с фабрикой данных Azure](machine-learning-data-science-move-sql-azure-adf.md). В это статье показано, как переместить данные из базы данных локального сервера SQL Server в базу данных SQL Azure через хранилище BLOB-объектов Azure с помощью ADF.
