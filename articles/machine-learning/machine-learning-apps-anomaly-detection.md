...
|Средства обнаружения изменений уровня|Средство обнаружения однонаправленных изменений уровня|Определение восходящего изменения уровня согласно чувствительности набора|См. описание для средства обнаружения медленно развивающихся тенденций|pscore: число с плавающей точкой, которое используется как показатель аномалий в восходящем изменении уровня|
|Средство обнаружения двунаправленных изменений уровня|Обнаружение восходящих и нисходящих изменений уровня согласно чувствительности набора|См. описание для средства обнаружения медленно развивающихся тенденций|rpscore: число с плавающей точкой, которое используется как показатель аномалий в восходящем и нисходящем изменении уровня
