<properties 
	pageTitle="Приложение машинного обучения: Служба обнаружения аномалий | Azure " 
...
2. Увеличение динамического диапазона значений. Например, при мониторинге исключений, порожденных службой, каждое увеличение динамического диапазона значений свидетельствует о нестабильности состояния службы.
...
Эта служба предоставляет API-интерфейс REST по протоколу HTTPS, который можно использовать различными способами, в том числе в мобильном или веб-приложении, R, Python, Excel и т. д. Есть также [веб-приложение Azure](http://anomalydetection-aml.azurewebsites.net/), которое помогает запускать веб-службу обнаружения аномалий для анализа определенных данных и представить результаты в наглядной форме. 
...
<tr>
   <th align="left" valign="middle">Время</th>
   <th align="left" valign="middle">Данные</th>
   <th align="left" valign="middle">Tspike</th>
   <th align="left" valign="middle">Zspike</th>
   <th align="left" valign="middle">Значения martingale</th>
   <th align="left" valign="middle">Индикатор предупреждений</th>
   <th align="left" valign="middle">Значения martingale (2)</th>
   <th align="left" valign="middle">Индикатор предупреждений (2)</th>
   </tr>
<tr>
   <td valign="middle">21.09.2014, 11:05</td>
...
<tr>
<td valign="middle">21.09.2014, 11:10</td>
...
<tr>
<td valign="middle">21.09.2014, 11:15</td>
   <td valign="middle">0</td>
   <td valign="middle">0</td>
   <td valign="middle">0</td>
