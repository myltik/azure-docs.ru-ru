<properties 
	...
	description="Узнайте, как проверять, изменять и улучшать данные для приложения JavaScript Магазина Windows с помощью мобильных служб Microsoft Azure c серверной частью .NET." 
