...
- [Руководство по устранению неисправностей — SDK][Link 25], [Руководство по устранению неисправностей — Push][Link 23], [Документация SDK — iOS — как подготовить ваше приложение для push-уведомлений Apple][Link 5]
...
- [Документация по пользовательскому интерфейсу — рекламные кампании][Link 17]
...
- [Описание процедур — первая push-операция][Link 27], [Руководство по поиску и устранению неисправностей — push-уведомления][Link 23], [Сведения протокола HTTP](http://www.w3.org/Protocols/rfc2616/rfc2616-sec5.html)
- [Разработчик Apple — сведения о пользовательском интерфейсе "отказ от участия"](http://support.apple.com/kb/HT3576), [Разработчик Apple — сведения для разработчиков "отказ от участия"](https://developer.apple.com/notifications/), [Разработчик Apple — поиск и устранение неисправностей "отказ от участия"](https://developer.apple.com/library/ios/technotes/tn2265/), [Apple Developer — схема URL](https://developer.apple.com/library/ios/featuredarticles/iPhoneURLScheme_Reference/Introduction/Introduction.html) 
- [Разработчик Android — сведения о пользовательском интерфейсе "отказ от участия"](http://developer.android.com/about/versions/jelly-bean.html), [Разработчик Android — закономерности "отказ от участия"](http://developer.android.com/design/patterns/notifications.html), [Разработчик Android — средство уведомлений "отказ от участия"](http://developer.android.com/guide/topics/ui/notifiers/notifications.html), [Разработчик Android — предварительный просмотр "отказ от участия"](https://developer.android.com/preview/notifications.html), [Разработчик Android — справочные материалы "отказ от участия"](http://developer.android.com/reference/android/app/Notification.html), [Разработчик Android — схема фильтрации по намерению](http://developer.android.com/guide/components/intents-filters.html#DataTest), [Разработчик Android — справочное руководство фильтра по намерению](http://developer.android.com/reference/android/content/Intent.html#toUri)
...
- [Документация пользовательского интерфейса — рекламные кампании][Link 17], [Документация пользовательского интерфейса — параметры][Link 20], [Документация API — рекламные кампании][Link 4], [Документация API —push-уведомления][Link 4], [Документация API — устройство][Link 4]
...
- [Способы реализации рекламных кампаний — планирование кампаний][Link 3], [Документация пользовательского интерфейса — создание новой рекламной кампании с push-уведомлениями][Link 27]
