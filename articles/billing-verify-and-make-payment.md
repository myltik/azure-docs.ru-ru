...
# Как проверить метод оплаты и оплатить подписку Azure
...
2. В разделе **Щелкните подписку для просмотра информации и сведений об использовании** выберите подписку, для которой требуется проверить метод оплаты.
...
Если в качестве метода оплаты вы указали кредитную или платежную карту, оплата будет производиться автоматически. Чтобы в любой момент изменить карту, см. статью [Изменение кредитной карты, используемой для оплаты подписки Azure](billing-how-to-change-credit-card.md).
