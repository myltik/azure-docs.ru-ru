...
2. Определите переменные своей среды. Обратите внимание, что для создания виртуальной сети необходима группа ресурсов. 
