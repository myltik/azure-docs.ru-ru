...
>[!NOTE]
>Диски, созданные и управляемые в Azure, называются [управляемыми дисками](https://docs.microsoft.com/en-us/azure/virtual-machines/windows/managed-disks-overview).
