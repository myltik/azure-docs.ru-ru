...
В этой статье рассматриваются шаги, необходимые для отправки сертификата на виртуальную машину Windows в Azure Stack. Эти шаги можно выполнить либо из Пакета средств разработки Azure Stack, либо из внешнего клиента на базе Windows при подключении через VPN.
