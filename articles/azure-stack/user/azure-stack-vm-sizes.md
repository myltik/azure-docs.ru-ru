...
В этой статье перечислены размеры виртуальных машин, которые поддерживает инфраструктура Azure Stack. 


## <a name="general-purpose"></a>Универсальные

### <a name="basic-a"></a>Basic A
|Размер: размер и имя |vCPU     |Память | Максимальный размер временного диска | Максимальная пропускная способность дисков ОС, операций ввода-вывода в секунду | Максимальная пропускная способность временного хранилища, операций ввода-вывода в секунду | Максимальная пропускная способность дисков данных, операций ввода-вывода в секунду |
|-----------------|-----|---------|---------|-----|------|-----------|
|**A0\Basic_A0**  |1    |768 МБ   | 20 ГБ   |300  | 300  |1/1 x 300  |
|**A1\Basic_A1**  |1    |1,75 ГБ  | 40 ГБ   |300  | 300  |2/2 x 300  |
|**A2\Basic_A2**  |2    |3,5 ГБ   | 60 ГБ   |300  | 300  |4 / 4 x 300  |
|**A3\Basic_A3**  |4.    |7 ГБ     | 120 ГБ  |300  | 300  |8/8 x 300  |
|**A4\Basic_A4**  |8    |14 ГБ    | 240 ГБ  |300  | 300  |6/16 x 300 |
...
|Размер     |vCPU     |Память, ГиБ | Временное хранилище, Гиб  | Максимальная пропускная способность дисков ОС, операций ввода-вывода в секунду | Максимальная пропускная способность временного хранилища, операций ввода-вывода в секунду | Максимальное число дисков данных/пропускная способность: операций ввода-вывода в секунду | Максимальное количество сетевых адаптеров/ожидаемая пропускная способность сети (Мбит/с) |
|-----------------|----|----|-----|-----|------|-------------|---------|
|**Standard_DS1** |1   |3,5 |7    |1000 |4000  |4/4 x 2300   |2 / 500  |
...
|**Standard_D4_v2** |8   |28  |400  |500 |24 000 |32 / 32x500 |8 / 6000 |
|**Standard_D5_v2** |16  |56  |800  |500 |48000 |64 / 64x500 |8/6000–12 000 |

### <a name="dsv2-series"></a>Серия DSv2
|Размер     |vCPU     |Память, ГиБ | Временное хранилище, Гиб  | Максимальная пропускная способность дисков ОС, операций ввода-вывода в секунду | Максимальная пропускная способность временного хранилища, операций ввода-вывода в секунду | Максимальное число дисков данных/пропускная способность: операций ввода-вывода в секунду | Максимальное количество сетевых адаптеров/ожидаемая пропускная способность сети (Мбит/с) |
|--------------------|----|----|----|-----|------|-------------|---------|
|**Standard_DS1_v2** |1   |3,5 |7   |1000 |4000  |4/4 x 2300   |2 / 750  |
...
|**Standard_DS5_v2** |16  |56  |112 |1000 |64000 |64/64 x 2300 |8/6000–12 000 |
...
|**Standard_DS14**  |16 |112 |224 |1000    |64000 |64/64 x 2300 |8/6000–12 000 |
...
|**Standard_D14_v2** |16  |112 |800  |500 |48000  |64 / 64x500  |8/6000–12 000 |
...
|**Standard_DS12_v2** |4.   |28  |56   |1000 |16000  |16/16 x 2300  |2/3000 |
|**Standard_DS13_v2** |8   |56  |112  |1000 |32000  |32/32 x 2300  |4/6000 |
|**Standard_DS14_v2** |16  |112 |224  |1000 |64000  |64/64 x 2300  |8 / 12 000 |
