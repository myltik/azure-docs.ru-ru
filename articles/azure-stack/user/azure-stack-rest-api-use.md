...
Прикладной программный интерфейс Azure Stack (API) можно использовать для автоматизации таких операций, как синдикация позиций на рынке.
