...
В этой статье приведены примеры, в которых для создания запросов к Azure Stack используется служебная программа curl. С помощью этих примеров описан пошаговый процесс получения маркера для доступа к API Azure Stack. Большинство языков программирования предоставляет библиотеки OAuth 2.0, в которых реализованы надежные возможности управления маркерами и обработки таких задач, как обновление маркеров.
