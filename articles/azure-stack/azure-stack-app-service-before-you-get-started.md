...
Запустите скрипт в расположении пакета SDK Azure Stack и убедитесь, что работаете в PowerShell с правами azurestack\CloudAdmin:
...
Этот [пример шаблона развертывания Azure Resource Manager](https://aka.ms/appsvconmasdkfstemplate) для развертывания настроенного файлового сервера на одном узле можно использовать только при развертываниях пакета SDK Azure Stack. В рабочей группе будет файловый сервер с одним узлом.
...
Чтобы развернуть комплект разработки Azure Stack, можно использовать SQL Server Express 2014 с пакетом обновления 2 (SP2) или более поздней версии.
