...
4. Корневой сертификат Azure Stack извлекается из привилегированной конечной точки. Для пакета SDK для Azure Stack в рамках этого процесса создается самозаверяющий сертификат. Для интегрированных систем вам нужно предоставить подходящий сертификат.
