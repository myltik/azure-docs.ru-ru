...
3. **Создание предложения**
   ...
   а. [Войдите](azure-stack-connect-azure-stack.md) на портал с правами администратора облака и последовательно выберите элементы **Создать** > **Предложения и планы** > **Предложение**.
...
2. **Подготовка виртуальной машины**
   ...
   а. Войдите на пользовательский портал в качестве пользователя.
      - В интегрированной системе URL-адрес зависит от региона оператора и внешнего доменного имени. Он будет иметь формат https://portal.&lt;*регион*&gt;.&lt;*полное_доменное_имя*&gt;.
   - При работе с пакетом SDK для Azure Stack портал можно найти по адресу https://portal.local.azurestack.external.

   b.  На панели мониторинга последовательно выберите элементы **Создать** > **Вычисления** > **Windows Server 2016 Datacenter Eval** и щелкните **Создать**.
