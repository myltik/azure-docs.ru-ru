...
* Сетевой трафик из поставщика ресурсов в SQL использует порт 1433 и не может быть изменен.
...
>[!NOTE]
Отображение номеров SKU на портале может занять до часа. Вы не сможете создать базу данных, пока не будет полностью создан SKU.
...
3. Заполните форму информацией о подключении экземпляра SQL Server. Обязательно используйте полное имя домена или IPv4-адрес прослушивателя Always On. Предоставьте информацию для учетной записи, настроенной с правами системного администратора.
...
Создайте планы и предложения для предоставления пользователям баз данных SQL. Добавьте службу Microsoft.SqlAdapter в план и добавьте имеющуюся квоту или создайте новую. При создании квоты можно указать емкость, разрешенную пользователю.
