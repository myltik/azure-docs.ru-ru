...
> [!NOTE]
> Отправка данных о потреблении является обязательным пунктом для многоузловых систем Azure Stack, для которых применяется модель оплаты по мере использования. При этом она необязательна для пользователей, использующих модель на основе емкости (см. страницу о том, [как приобрести Azure Stack](https://azure.microsoft.com/overview/azure-stack/how-to-buy/ to learn more about pricing in Azure Stack)). Для пользователей комплекта разработки Azure Stack операторы могут передавать данные о потреблении и тестировать эту возможность. Тем не менее с них не взимается плата за использование. 
...
При использовании комплекта разработки Azure Stack плата за ресурсы не взимается, поэтому отображается цена 0,00 долл. Когда многоузловые ресурсы Azure Stack станут общедоступными, вы сможете увидеть фактическую стоимость для каждого из них.

## <a name="which-azure-stack-deployments-are-charged"></a>За какие ресурсы, развернутые в Azure Stack, взимается плата?

Ресурсы в рамках комплекта разработки Azure Stack являются бесплатными. В то время как за использование многоузловых систем Azure Stack, виртуальных машин рабочих нагрузок, служб хранения и служб приложений плата взимается.
...
При использовании многоузловых систем Azure Stack поддерживаются подписки по Соглашению Enterprise (EA) и подписки CSP. При использовании комплекта разработки Azure Stack передача данных об использовании поддерживается в подписках Enterprise Agreement (EA), подписке с оплатой по мере использования, CSP и MSDN.
