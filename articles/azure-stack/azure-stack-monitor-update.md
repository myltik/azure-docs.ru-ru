...
Привилегированную конечную точку можно использовать для мониторинга хода выполнения обновления Azure Stack или возобновления невыполненного обновления с последнего успешного шага. 
