...
В настоящее время мы рекомендуем отключить расшифровку SSL для всего трафика Azure Stack. В будущем будут представлены рекомендации о том, как включить шифрование SSL для Azure Stack.

## <a name="edge-firewall-scenario"></a>Использование граничного брандмауэра
При пограничном развертывании Azure Stack развертывается непосредственно за пограничным маршрутизатором или брандмауэром. В этих сценариях брандмауэр может располагаться над границей или выступать в роли пограничного устройства, если он поддерживает ECMP с маршрутизацией BGP или статической маршрутизацией.
...
![Пример пограничного брандмауэра Azure Stack](.\media\azure-stack-firewall\edge-firewall-scenario.png)
