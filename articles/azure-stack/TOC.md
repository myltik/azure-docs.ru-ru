...
# Развертывание подтверждения концепции Azure Stack
...
## [Управление учетными записями хранения](azure-stack-manage-storage-accounts.md)
...
## [Управление обновлениями в Azure Stack](azure-stack-updates.md)
# хранилище ключей;
...
## [Поставщик ресурсов веб-приложений — известные проблемы и устранение неполадок](azure-stack-webapps-troubleshoot-known-issues.md)
