...
Автономное развертывания не обязательно означает, что вы не сможете позднее подключить Azure Stack к Azure для реализации гибридных сценариев виртуальных машин. Это означает, что во время развертывания отсутствует подключение к Azure или что вы не хотите использовать Azure Active Directory в качестве хранилища идентификаторов. Но если вы хотите иметь возможность подключения к Azure после развертывания, независимо от того, где вы хотите хранить идентификаторы, выберите развертывание с подключением к Azure. 
