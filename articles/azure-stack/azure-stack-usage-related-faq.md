...
| **Среда выполнения приложений** |FAB6EB84-500B-4A09-A8CA-7358F8BBAEA5 |Base VM Size Hours |Виртуальные ядра, в минутах | Результат умножения количества виртуальных ядер на минуты работы виртуальной машины |
| |9CD92D4C-BAFD-4492-B278-BEDC2DE8232A |Windows VM Size Hours |Виртуальные ядра, в минутах | Результат умножения количества виртуальных ядер на минуты работы виртуальной машины |
