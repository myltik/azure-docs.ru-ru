...
3. **Симптом.** Операторы Azure Stack могут видеть следующую ошибку во время обновления: *Тип CheckHealth роли VirtualMachines вызвал исключение: \n\nПри проверке работоспособности виртуальной машины для <machineName>-ACS01 вызваны следующие ошибки.\nПроизошла ошибка при получении сведений о виртуальной машине из хостов. Сведения об исключении.\nGet-VM: Не удалось выполнить операцию на компьютере Node03. Служба WS-Management не может обработать запрос. Служба \nWMI или поставщик WMI вернул неизвестную ошибку: HRESULT 0x8004106c".*
    ...
    2. **Разрешение.** Обратитесь за помощью в службу поддержки пользователей Майкрософт.
<br><br>
4. **Признак.** Операторы Azure Stack могут увидеть следующую ошибку во время процесса обновления: *"Тип 'DefenderUpdate' роли 'URP' вызвал исключение: Ошибка при получении версии из \\SU1FileServer\SU1_Public\DefenderUpdates\x64\{название файла}.exe после 60 ошибок с помощью Copy-AzSDefenderFiles, C:\Program Files\WindowsPowerShell\Modules\Microsoft.AzureStack.Defender\Microsoft.AzureStack.Defender.psm1: строка 262"*
...
См. дополнительные сведения о [резервном копировании и восстановлении данных для Azure Stack с помощью службы резервного копирования инфраструктуры](C:\Git\MS\azure-docs-pr\articles\azure-stack\azure-stack-backup-infrastructure-backup.md).
