...
- Сертификат может быть групповым сертификатом, охватывающим все пространства имен в поле "Альтернативное имя субъекта" (SAN). Или можно использовать отдельные сертификаты, используя шаблоны для конечных точек, например для хранилища и Key Vault, где они необходимы. 
