...
1. Запустите файл appservice.exe от имени администратора (azurestack\CloudAdmin).
...
12. В поле **Select Platform Image** (Выбор образа платформы) выберите для развертывания образ виртуальной машины Windows Server 2016 из доступных в поставщике вычислительных ресурсов для облачной службы приложений. Нажмите кнопку **Далее**.
