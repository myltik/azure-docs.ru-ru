...
Регионы Azure Stack являются основным элементом масштаба и управления. Организация может иметь несколько регионов с ресурсами в каждом из них. В регионах также могут быть доступны различные предложения служб. В комплекте разработки Azure Stack поддерживается только один регион. Он по умолчанию называется *local*.
...
## <a name="in-development-build-of-azure-stack-development-kit"></a>Добавочная сборка комплекта разработки Azure Stack
Добавочные сборки позволяют первым пользователям оценить самую последнюю версию комплекта разработки Azure Stack. Это инкрементные сборки, основанные на последнем основном выпуске. Основные версии будут выпускаться каждые несколько месяцев, а добавочные сборки будут периодически выпускаться между основными выпусками.
