...
Служба трассировки событий Windows направляет данные телеметрии в защищенное облачное хранилище. Доступ к данным телеметрии предоставляется по принципу наименьшего приоритета. Только сотрудникам Майкрософт с соответствующими бизнес-задачами разрешен доступ к данным телеметрии. Корпорация Майкрософт не предоставляет личные данные клиентов третьим лицам, кроме как по усмотрению клиента или в ограниченных случаях, описанных в [заявлении о конфиденциальности корпорации Майкрософт](https://privacy.microsoft.com/PrivacyStatement). Общий доступ к бизнес-отчетам предоставляется изготовителям оборудования и партнерам. В этих отчетах содержится агрегированная, анонимизированная информация о телеметрии. Решения о предоставлении общего доступа к данным принимаются внутренней группой корпорации Майкрософт, включая решения о конфиденциальности и правах, а также заинтересованными лицами управления данными.
...
Мы понимаем, что конфиденциальность и безопасность информации клиентов важна.  Мы использовали продуманный и комплексный подход к конфиденциальности и защите данных клиентов с помощью Azure Stack. У ИТ-администраторов есть средства для настройки компонентов и параметров конфиденциальности в любое время. Наша приверженность прозрачности и доверию очевидна:
...
Не рекомендуется отключать телеметрию в организации, так как она предоставляет данные, которые можно применить для улучшения функциональности и стабильности продукта. Однако мы понимаем, что в некоторых сценариях это может быть необходимо. 
...
### <a name="asdk-set-telemetry-level-in-the-windows-registry"></a>ASDK: настройка уровня телеметрии в реестре Windows
...
- **Данные о совместимости** обеспечивают представление о том, какие поставщики ресурсов установлены в системе и виртуальной машине, и идентифицируют потенциальные проблемы совместимости.
...
### <a name="asdk-and-multinode-enable-or-disable-telemetry-after-deployment"></a>ASDK и несколько узлов: включение и отключение телеметрии после развертывания
