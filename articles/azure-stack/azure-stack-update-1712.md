...
- Новый пользовательский интерфейс при создании элементов из Marketplace
...
- Добавлен командлет Update-BMCCredential в привилегированную конечную точку для смены пароля контроллера BMC
