...
> [!NOTE]
>Подключение путем входа к национальной среде Azure, такой как Black Forest Azure, Fairfax Azure и Mooncake Azure, в настоящее время не поддерживается. Сведения о том, как подключиться к учетным записям хранения национальной среды Azure, см. в **этом разделе**.
