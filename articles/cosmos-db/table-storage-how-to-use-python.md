...
Из этого руководства вы узнаете, как реализовать стандартные сценарии хранилища таблиц Azure в Python с помощью [пакета SDK для таблиц Azure Cosmos DB для Python](https://github.com/Azure/azure-cosmosdb-python/tree/master/azure-cosmosdb-table). Здесь описаны такие сценарии, как создание и удаление таблицы, вставка и запрос сущностей.

Работая над сценариями в этом руководстве, вы можете использовать [справочные материалы по API-интерфейсу Python](https://azure.github.io/azure-cosmosdb-python/).
...
После создания учетной записи Azure Cosmos DB установите [пакет SDK для таблиц Azure Cosmos DB для Python](https://github.com/Azure/azure-cosmosdb-python/tree/master/azure-cosmosdb-table). Дополнительные сведения по установке пакета SDK см. в файле [README.rst](https://github.com/Azure/azure-cosmosdb-python/tree/master/azure-cosmosdb-table) в репозитории GitHub на странице пакета SDK для таблиц Python.

## <a name="create-a-table"></a>Создание таблицы

Для работы со службой таблиц Azure в Python необходимо импортировать модуль [TableService][py_TableService]. Так как вы работаете с сущностями таблиц, потребуется класс [Entity][py_Entity]. Добавьте следующий код в начало файла Python, чтобы импортировать модуль и класс:
...
* [Справочная документация по API Python](https://azure.github.io/azure-cosmosdb-python/)
* [Azure Cosmos DB Table API for Python: Release notes and resources](https://github.com/Azure/azure-cosmosdb-python/tree/master/azure-cosmosdb-table) (API таблицы Python для базы данных Azure Cosmos DB. Заметки о выпуске и ресурсы)
