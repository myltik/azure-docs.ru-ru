...
<tr><td>**Начало работы**</td><td>[Начало работы с пакетом SDK .NET для библиотеки BulkExecutor](bulk-executor-dot-net.md)</td></tr>

<tr><td>**Текущая поддерживаемая платформа**</td><td><ul><li>[Microsoft.Azure.DocumentDB](https://www.nuget.org/packages/Microsoft.Azure.DocumentDB/)(версия >= 1.21.1)</li><li>
[Newtonsoft.Json](https://www.nuget.org/packages/Newtonsoft.Json/)(версия >= 10.0.2)
</li></ul></td></tr>
</table></br>
