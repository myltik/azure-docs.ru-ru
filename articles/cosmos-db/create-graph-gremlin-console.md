---
title: "Руководство по Azure Cosmos DB. Создание, запрос и просмотр в консоли Gremlin | Документация Майкрософт"
