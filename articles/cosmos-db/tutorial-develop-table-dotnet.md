...
3. Вставьте значение строки подключения в файл app.config в качестве значения CosmosDBStorageConnectionString. 
...
| TableIndexingPolicy | Строка JSON соответствует спецификации политики индексации. Сведения о добавлении или удалении определенных столбцов из политики индексации см. в [этой статье](indexing-policies.md). |
