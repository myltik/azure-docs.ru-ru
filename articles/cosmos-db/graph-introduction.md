...
База данных Azure Cosmos DB также предоставляет библиотеку .NET с методами расширения Gremlin на основе [пакетов SDK базы данных Azure Cosmos DB](sql-api-sdk-dotnet.md) через NuGet. Эта библиотека предоставляет серверу Gremlin «в процессе», можно использовать для прямого подключения к секции данных.
