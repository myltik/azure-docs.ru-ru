...
3. Скопируйте значение **первичного ключа** с портала и добавьте его в качестве значения параметра ключа AuthKey в App.config, а затем сохраните изменения. 

    `"authkey": "FILLME"`

4. Сохраните файл appsettings.json. 
