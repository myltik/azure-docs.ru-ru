...
# Azure Cosmos DB. Создание веб-приложения API DocumentDB с использованием языка .NET и портала Azure
...
2. Теперь добавьте несколько документов в коллекцию, вставляя уникальные значения идентификатора в каждом документе и изменяя другие свойства по своему усмотрению. Новые документы могут иметь любую структуру, так как Azure Cosmos DB не устанавливает определенные схемы данных.
