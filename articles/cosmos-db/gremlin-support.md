...
В этой статье мы укажите краткое описание Gremlin и перечисление Gremlin функции и действия, которые поддерживаются Graph API.
...
| --- | --- | --- |
| Функции графа | Предоставляет механизм сохраняемости и ConcurrentAccess. Разработаны для поддержки транзакций. | Вычислительные методы могут применяться через соединитель Spark. |
...
| Шаг | ОПИСАНИЕ | Руководство по TinkerPop 3.2 | Заметки |
| --- | --- | --- | --- |
