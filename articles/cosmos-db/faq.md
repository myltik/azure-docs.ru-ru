...
Здесь не требуется вносить каких-либо изменений. Теперь ресурсы DocumentDB преобразованы в ресурсы Azure Cosmos DB. Это преобразование выполнено без перебоев.
