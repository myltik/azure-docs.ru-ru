---
title: "Удалено уровни производительности Azure Cosmos DB | Документы Microsoft"
description: "Дополнительные сведения о S1, S2 и S3 уровней производительности доступны в базе данных Azure Cosmos ранее."
services: cosmos-db
author: mimig1
manager: jhubbard
editor: monicar
...
> [!IMPORTANT] 
> Уровни производительности S1, S2 и S3, рассматриваемые в данной статье будут выведены из эксплуатации и больше не доступны для новых учетных записей Azure Cosmos DB.
>
...
Стандартная предложение Azure Cosmos DB предоставляет гибкую не предлагают уровни производительности S1, S2 и S3. Пропускная способность и емкость хранилища для уровней производительности S1, S2 и S3 предварительно заданы, не изменяются и не поддерживают эластичность. Теперь в Azure Cosmos DB доступна настройка пропускной способности и емкости хранилища, что обеспечивает гораздо большую гибкость и возможность масштабирования по мере изменения потребностей.
...
Другой вариант изменения уровней производительности ваших коллекций — воспользоваться пакетами SDK для Azure Cosmos DB. В этом разделе рассматривается только изменение коллекции производительности уровня с помощью [API .NET для SQL](sql-api-sdk-dotnet.md), но процесс аналогичен для наших других пакетов SDK.
