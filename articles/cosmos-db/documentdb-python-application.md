...
4. Вернитесь на портал Azure, перейдите на страницу **Ключи**, скопируйте значение **первичного** или **вторичного ключа** и вставьте его в файл **config.py** как значение для свойства **DOCUMENTDB\_KEY**.
...
13. После полной настройки среды сервера обновите страницу в браузере. Вы должны увидеть веб-приложение.
    ...
    ![Результаты публикации приложений Bottle, Flask и Django в службе приложений](./media/documentdb-python-application/python-published-app-services.png)
