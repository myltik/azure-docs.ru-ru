...
1. Можно создать несколько функций Azure и добавить в каждую из них триггеры Azure Cosmos DB, которые ожидают передачи данных из одного канала изменений данных корзины для покупок. Обратите внимание, если несколько функций прослушивают один канал изменений, для каждой функции требуется новая коллекция аренды.
