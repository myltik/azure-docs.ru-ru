...
1. Щелкните **Обозреватель данных** > **Новый граф**.
    ...
    ![Страница добавления графа в обозревателе данных на портале Azure](./media/create-graph-python/azure-cosmosdb-data-explorer-graph.png)
