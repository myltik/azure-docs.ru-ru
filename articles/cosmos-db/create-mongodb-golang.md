...
# Azure Cosmos DB. Создание консольного приложения API MongoDB с использованием языка Golang и портала Azure
...
### Запрос к документу или чтение документа
...
## Просмотр документа в обозревателе данных
