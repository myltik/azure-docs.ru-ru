...
Пора показать ваш проект миру! Расскажите нам о проекте, в котором используете Azure Cosmos DB (стек DocumentDB нового поколения), и мы поможем вам поделиться своими находками со всем миром. Чтобы отправить проект, напишите нам по адресу [askcosmosdb@microsoft.com](mailto:askcosmosdb@microsoft.com).
...
Файл REST API Swagger Azure Cosmos DB для API DocumentDB, который можно легко развернуть как приложение API.
...
* [**A Journey to Social** (Путь к социальным сетям)](https://medium.com/@Ealsur/a-journey-to-social-c47636bf25c9#.an669sx41)  -  *Матиас Куаранта (Matías Quaranta)* 
...
* [**Collecting logs in to Azure DocumentDB using fluent-plugin-documentdb** (Сбор журналов в Azure DocumentDB с помощью подключаемого модуля fluent-plugin-documentdb)](http://unofficialism.info/posts/collecting-logs-into-azure-documentdb-using-fluent-plugin-documentdb/)  -  *Йоичи Кавасаки (Yoichi Kawasaki)*
* [**DocumentDB revisited Part 1/2 – The theory** (Новый взгляд на DocumentDB часть 1 и 2. Теория)](https://peterintheazuresky.wordpress.com/2016/02/19/documentdb-revisited-part-12-the-theory/)  - *Питер Маннехалт (Peter Mannerhult)*
* [**What to love and hate about Azure’s DocumentDB** (Преимущества и недостатки Azure DocumentDB)](http://blog.falafel.com/4-what-to-love-and-hate-about-azures-documentdb/)  - *Джордж Сааде (George Saadeh)*
...
* [**Перспективы разработки для Azure DocumentDB — разработка клиентского класса (1 из 2) (на японском языке)**](http://beachside.hatenablog.com/entry/2015/10/01/202734) —  - *Ацуши Йокогама (Atsushi Yokohama)*
* [**Что нужно знать при использовании Azure DocumentDB (на японском языке)**](http://beachside.hatenablog.com/entry/2015/10/01/202734)  -  *Ацуши Йокогама (Atsushi Yokohama)*
...
*У вас есть запись в блоге, пример кода или интересный материал, которым вы хотите поделиться? [Сообщите нам об этом](mailto:askcosmosdb@microsoft.com)!*
...
| Подкаст Azure |Кейл Титер (Cale Teeter) |14 января 2016 г. |[Episode 110: Using DocumentDB & Search](http://azpodcast.azurewebsites.net/post/Episode-110-Using-DocumentDB-Search) (Эпизод 110: использование DocumentDB и поиска) |
...
| --- | --- |
| [![Microsoft Virtual Academy](./media/community/mva.png)](https://mva.microsoft.com/en-US/training-courses/azure-documentdb-planetscale-nosql-16847) |[**Microsoft Virtual Academy**](https://mva.microsoft.com/en-US/training-courses/azure-documentdb-planetscale-nosql-16847) предоставляет возможность обучения у специалистов, которые участвуют в создании Azure DocumentDB. |
