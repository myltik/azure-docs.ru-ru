...
С помощью API таблицы можно указать пропускную способность для таблиц в конфигурации appSettings для своего приложения.
...
Затем можно создать таблицу с помощью пакета SDK для хранилища таблиц Azure. Ключ секции неявно создается как значение `PartitionKey`. 
