...
* Аналогичным образом, когда вы подготавливаете пропускную способность выше `t*N`, Azure Cosmos DB разбивает одну или несколько секций для поддержки более высокой пропускной способности.
