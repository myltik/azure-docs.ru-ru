...
* Azure Cosmos DB распределяет пространство хэшей ключей секций равномерно по **N** физическим секциям. Таким образом, каждая физическая секция содержит значения ключа секции **1/N** (логические секции).
...
Контейнеры Azure Cosmos DB также можно настроить для совместного использования пропускной способности набором контейнеров, в котором каждый контейнер должен указать ключ секции и может увеличиваться до неограниченного размера.
