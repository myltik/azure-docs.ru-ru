...
* [Вторичный индекс между шаблон](#inter-partition-secondary-index-pattern) -хранение нескольких копий каждой сущности, используя различные **RowKey** значения в разные разделы или в отдельные таблицы, чтобы включить быстрые и эффективные операции поиска и сортировки альтернативный заказы с помощью различных **RowKey** значения.  
