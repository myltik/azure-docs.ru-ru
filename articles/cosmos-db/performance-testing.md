...
Самый быстрый способ приступить к работе — скомпилировать и запустить пример .NET, как описано в ниже. Вы также можете просмотреть исходный код и реализовывать аналогичные настройки в своих клиентских приложениях.
...
В этой статье мы рассмотрели способы тестирования производительности и масштабируемости с помощью консольного приложения .NET Cosmos DB. Дополнительные сведения см. в следующих руководствах.
