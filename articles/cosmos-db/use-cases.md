...
Проект Azure Cosmos DB запущен в 2011 г. как проект "Флоренция", чтобы помочь разработчикам устранить проблемы, характерные для крупномасштабных веб-приложений в корпорации Майкрософт. Так как эти проблемы свойственны не только приложениям Майкрософт, в 2015 г. была выпущена общедоступная версия Azure Cosmos DB в виде [Azure DocumentDB](https://azure.microsoft.com/blog/documentdb-moving-to-general-availability/) для внешних разработчиков Azure. Данная служба используется в Майкрософт повсеместно и является одной из самых быстро развивающихся служб, используемых внешними разработчиками Azure. 
...
![Эталонная архитектура каталога магазина на основе Azure Cosmos DB](./media/use-cases/product-catalog.png)
 ...
 Кроме того, данные, хранящиеся в Azure Cosmos DB, можно интегрировать с HDInsight, чтобы анализировать большие данные посредством заданий Pig, Hive или Map/Reduce. Дополнительные сведения о соединителе Hadoop для Azure Cosmos DB см. в статье [Выполнение задания Apache Hive, Pig или Hadoop с помощью DocumentDB и HDInsight](run-hadoop-with-hdinsight.md).
...
Служба Azure Cosmos DB часто используется с веб-приложениями и мобильными приложениями. Она особенно хорошо подходит для моделирования социального взаимодействия, интеграции со службами сторонних поставщиков, а также для создания разнообразных персонализированных возможностей. Пакеты SDK Cosmos DB можно использовать для создания многофункциональных приложений iOS и Android с помощью популярной [платформы Xamarin](mobile-apps-with-xamarin.md).  
