...
## Как работает веб-канал изменений в Azure Cosmos DB
...
### Распределенное выполнение ReadDocumentFeed
...
### Извлечение диапазонов ключей разделов для коллекции
...
### Выполнение добавочного ReadDocumentFeed
