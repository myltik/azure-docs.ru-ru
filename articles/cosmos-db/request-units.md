...
* Как задать количество единиц запроса для контейнера в Azure Cosmos DB?
* Как оценить приемлемое количество единиц запросов для моего приложения?
* Что произойдет, если превысить максимальное количество единиц запроса для контейнера в Azure Cosmos DB?
...
При оценке количества единиц запросов, которое нужно подготовить для контейнера Azure Cosmos DB, важно учитывать следующие рекомендации:
...
* **Шаблоны запросов**. Сложность запроса влияет на количество единиц запроса, потребляемых операцией. Количество предикатов и их характер, проекции, количество определяемых пользователем функций и размер исходных данных — все это влияет на плату за операции запроса.
...
2. Чтобы оценить требования к хранилищу данных, укажите общее количество элементов, которые вы планируете хранить (например, документы, таблицы или графы).
