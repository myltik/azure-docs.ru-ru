...
# <a name="azure-cosmosdb-develop-with-the-documentdb-api-in-net"></a>Azure Cosmos DB. Разработка с помощью API DocumentDB на .NET
...
3. В диалоговом окне **Новый проект** выберите **Шаблоны** / **Visual C#** / **Консольное приложение (.NET Framework)**, а затем укажите имя проекта и нажмите кнопку **ОК**.
   ![Снимок экрана: диалоговое окно «Новый проект»](./media/tutorial-develop-documentdb-dotnet/nosql-tutorial-new-project-2.png)
...
4. В **обозревателе решений** щелкните правой кнопкой мыши новое консольное приложение (оно находится в решении Visual Studio). Затем щелкните **Управление пакетами NuGet...**
    ...
    ![Снимок экрана: меню «Проект», вызванное щелчком правой кнопки мыши](./media/tutorial-develop-documentdb-dotnet/nosql-tutorial-manage-nuget-pacakges.png)
...
6. В результатах найдите **Microsoft.Azure.DocumentDB** и нажмите кнопку **Установить**.
   ...
   ![Снимок экрана: меню NuGet для поиска пакета SDK для клиента Azure Cosmos DB](./media/tutorial-develop-documentdb-dotnet/nosql-tutorial-manage-nuget-pacakges-2.png)
...
На остальных шагах в этом руководстве приведены фрагменты кода API DocumentDB, необходимые для создания и обновления ресурсов Azure Cosmos DB в проекте.
...
![Снимок экрана портала Azure в ходе работы с руководством по NoSQL при создании консольного приложения C#. Показана учетная запись Azure Cosmos DB со следующими выделенными элементами: кнопка "Ключи" в колонке учетной записи Azure Cosmos DB и значения универсального кода ресурса и первичного ключа в колонке "Ключи".](./media/tutorial-develop-documentdb-dotnet/nosql-tutorial-keys.png)
