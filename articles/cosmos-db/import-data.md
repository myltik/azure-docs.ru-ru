...
![Снимок экрана: параметры источника MongoDB — documentdb и mongodb](./media/import-data/mongodbsource.png)
...
![Снимок экрана: параметры источника экспорта MongoDB — documentdb и mongodb](./media/import-data/mongodbexportsource.png)
