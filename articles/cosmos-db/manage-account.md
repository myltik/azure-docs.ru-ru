...
На [портале Azure](https://portal.azure.com/) откройте страницу **Ключи** из меню ресурсов на странице **учетной записи Azure Cosmos DB**, чтобы получить возможность просмотра, копирования и повторного создания ключей доступа, используемых для доступа к вашей учетной записи Azure Cosmos DB.
...
На странице **Ключи** нажмите кнопку **Копировать** справа от того ключа, который требуется скопировать.
...
3. На странице **учетной записи Azure Cosmos DB** щелкните **Ключи**.
4. На странице **Ключи** нажмите кнопку "Повторно создать", а затем кнопку **ОК**, чтобы подтвердить создание ключа.
