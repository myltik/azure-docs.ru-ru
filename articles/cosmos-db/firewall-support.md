...
# Поддержка брандмауэра для Azure Cosmos DB
...
## Общие сведения о контроле доступа на основе IP-адресов
...
## Подключения из виртуальных машин
