...
* [**Гибкое масштабирование пропускной способности и хранилища по требованию по всему миру**](#horizontal-scale)
    * Легко масштабируйте пропускную способность по [секундным](../documentdb/documentdb-request-units.md) и [минутным](https://aka.ms/acdbrupm) периодам и изменяйте ее при необходимости. 
...
* [**Гарантированная доступность AlwaysOn**](#high-availability)
    ...
    * [Моделируйте сбой](../documentdb/documentdb-regional-failovers.md) одного или нескольких регионов с гарантированной нулевой потерей данных. 

* [**Лучший способ создания глобально распределенных приложений**](#consistency)
    * [Пять моделей согласованности](../documentdb/documentdb-consistency-levels.md) обеспечивают широкий спектр функций от строгой согласованности SQL до окончательной согласованности NoSQL. 
...
Глобальное распределение ресурсов в Cosmos DB [готово к использованию](../documentdb/documentdb-distribute-data-globally.md). Вы можете в любое время связать любое количество географических регионов с учетной записью базы данных несколькими щелчками или программным путем с помощью одного вызова API. 
...
![Многомодельная Azure Cosmos DB с различными API](./media/introduction/azure-cosmos-db-multimodel.png) 
...
Cosmos DB позволяет выбрать одну из [пяти точно определенных моделей согласованности](../documentdb/documentdb-consistency-levels.md) разного уровня. Вы можете выбрать строгую согласованность, согласованность с ограниченным устареванием, [согласованность уровня сеанса](http://dl.acm.org/citation.cfm?id=383631) и итоговую согласованность. 
