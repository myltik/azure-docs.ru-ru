...
Обзорные сведения об использовании групп ресурсов в Visual Studio см. в статье [Создание и развертывание проектов развертывания группы ресурсов Azure](vs-azure-tools-resource-groups-deployment-projects-create-deploy.md).
