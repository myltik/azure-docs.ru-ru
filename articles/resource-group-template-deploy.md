...
3. Как правило, при развертывании нового шаблона для размещения ресурсов создается группа ресурсов. Если у вас уже есть группа ресурсов для развертывания, то можно пропустить этот шаг и просто использовать ее.

     Чтобы создать группу ресурсов, укажите ее имя и расположение.
