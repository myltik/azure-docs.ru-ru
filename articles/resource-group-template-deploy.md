...
В этом разделе объясняется, как использовать шаблоны диспетчера ресурсов Azure для развертывания приложения в Azure. Здесь описаны способы развертывания приложения с помощью Azure PowerShell, интерфейса командной строки Azure, REST API и портала Azure.
...
С помощью Azure PowerShell или REST API можно задать полное обновление для группы ресурсов. В настоящее время Azure CLI не поддерживает полные развертывания. В рамках полного развертывания диспетчер ресурсов выполняет следующие задачи:
...
3. Если у вас нет существующей группы ресурсов, создайте ее с помощью команды **New-AzureRmResourceGroup**. Введите имя группы ресурсов и расположение, необходимое для решения. Появится сводка по новой группе ресурсов.
...
Обзорные сведения об использовании групп ресурсов в Visual Studio см. в статье [Создание и развертывание проектов развертывания групп ресурсов Azure с помощью Visual Studio](vs-azure-tools-resource-groups-deployment-projects-create-deploy.md).
...
Дополнительные сведения об использовании портала с диспетчером ресурсов Azure см. в статье [Управление ресурсами Azure с помощью портала Azure](azure-portal/resource-group-portal.md).
...
- Инструкции по развертыванию своего решения в различных средах см. в статье [Среды разработки и тестирования в Microsoft Azure](solution-dev-test-environments-preview-portal.md).
