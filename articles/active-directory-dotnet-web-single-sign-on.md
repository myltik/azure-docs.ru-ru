<properties linkid="" urlDisplayName="" pageTitle="" metaKeywords="" description="" metaCanonical="" services="" documentationCenter="" title="Единый вход с использованием .NET и Azure Active Directory" authors="" solutions="" manager="" editor="" />
...
В этом учебнике показано, как создать и настроить приложение для одного клиента, использующее возможности единого входа Azure Active Directory. Для Azure Active Directory можно также создавать приложения, поддерживающие несколько клиентов, как описано в учебнике [Разработка многопользовательских облачных приложений с помощью Azure Active Directory].
