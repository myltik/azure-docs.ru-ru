...
Для получения дополнительной информации см. раздел [Как создать и опубликовать продукт][].
...
Полный список политик API Management см. в разделе [Справочник по политикам][]. Дополнительную информацию об использовании и настройке политик см. в разделе [Политики API Management][]. Руководство по созданию продукта с ограничением скорости и политиками квот см. в разделе [Как создать и задать расширенные настройки политик][].
