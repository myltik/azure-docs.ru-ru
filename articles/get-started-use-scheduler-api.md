<properties linkid="get-started-with-scheduler-API" urlDisplayName="Приступая к работе с API-интерфейсом планировщика" pageTitle="Приступая к работе с API-интерфейсом планировщика | Azure" metaKeywords="планировщик" description="TBD" umbracoNaviHide="0" disqusComments="1" editor="mattshel" manager="carolz" titel="Get started with the Scheduler API" authors="" title="Приступая к работе с API-интерфейсом планировщика" />


# Приступая к работе с API-интерфейсом планировщика
