...
| [Встроенная роль участника Службы поиска](https://docs.microsoft.com/azure/active-directory/role-based-access-built-in-roles#search-service-contributor) | Аналог роли участника. |
...
+ [Начало работы с управлением доступом на основе ролей на портале Azure](../active-directory/role-based-access-control-what-is.md).