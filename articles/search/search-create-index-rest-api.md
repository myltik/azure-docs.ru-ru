---
title: "Создание индекса службы поиска Azure с помощью REST API | Документация Майкрософт"
...
## <a name="ii-define-your-azure-search-index-using-wellformed-json"></a>2. Определение индекса службы поиска Azure с помощью JSON-содержимого правильного формата
...
## <a name="iii-issue-the-http-request"></a>3. Отправка HTTP-запроса
