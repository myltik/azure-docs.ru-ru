...
Чтобы удостовериться в создании индекса и в загрузке документа, перейдите в панель мониторинга службы Поиска на [классическом портале Azure](https://portal.azure.com). Значение параметра "Использование" для индекса должно увеличиться на единицу, и в наличии должно быть 294 документа: по одному для каждого продукта из базы данных.
