---
title: Использование приложения Fiddler для оценки и тестирования интерфейсов REST API службы поиска Azure | Microsoft Docs
description: 'Приложение Fiddler позволяет проверить доступность службы '
;поиск: ''
azure";: ''
и: ''
опробовать: ''
