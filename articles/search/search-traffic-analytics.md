...
Большие двоичные объекты журналов содержат журналы трафика службы поиска. Каждый большой двоичный объект имеет один корневой объект под названием **records**, который содержит массив объектов журнала. Каждый большой двоичный объект содержит записи по всем операциям, которые выполнялась в течение одного часа.
...
[Power BI Desktop](https://powerbi.microsoft.com/ru-RU/desktop): анализируйте данные и создавайте собственные представления данных. См. стартовый запрос в следующем разделе:
