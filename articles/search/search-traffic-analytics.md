...
5. Щелкните insight-logs-operationlogs правой кнопкой мыши и выберите "Загрузить".
6. Будет открыт Редактор запросов. Теперь откройте Расширенный редактор, выбрав "Вид" -> "Расширенный редактор".
...
8. Нажмите кнопку "Готово" и выберите "Закрыть и применить" на вкладке "Главная".

9. Теперь данные готовы к использованию. Создайте несколько [визуализаций](https://powerbi.microsoft.com/ru-RU/documentation/powerbi-desktop-report-view/).
