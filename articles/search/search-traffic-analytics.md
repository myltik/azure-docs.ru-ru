...
Вы можете задать политику хранения данных в диапазоне от 1 до 365 дней. Если вы не хотите хранить данные определенное время, задайте значение (количество дней) 0.
