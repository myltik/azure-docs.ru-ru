...
| [Демонстрационный веб-сайт поиска работы в г. Нью-Йорк](https://github.com/Azure-Samples/search-dotnet-asp-net-mvc-jobs) | Содержит исходный код для работающего демонстрационного сайта Поиска Azure с данными о поиске работы в г. Нью-Йорк с использованием ASP.NET MVC. |
| [Демонстрационный сайт Художественной галереи Тейт](https://github.com/liamca/azure-search-tate-art-gallery/) | Содержит исходный код для демонстрационного сайта Поиска Azure с данными художественной галереи. В нем показаны типы данных коллекций и вложенные структуры данных, аспекты и фильтры, имена людей и эскизы.|
...
Полнофункциональные веб-приложения, использующие Поиск Azure для реализации возможностей поиска. 
