---
title: "Отправка данных в службу поиска Azure с помощью REST API | Документация Майкрософт"
...
## <a name="i-create-an-instance-of-the-searchindexclient-class"></a>1. Создание экземпляра класса SearchIndexClient
...
## <a name="ii-decide-which-indexing-action-to-use"></a>2. Выбор операций индексирования
...
## <a name="iii-construct-your-indexbatch"></a>3. Создание класса IndexBatch
...
## <a name="iv-import-data-to-the-index"></a>4. Импорт данных в индекс
