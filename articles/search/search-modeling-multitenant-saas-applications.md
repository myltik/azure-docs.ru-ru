---
title: Моделирование мультитенантности в Поиске Azure | Microsoft Docs
...
* Можно добавлять *секции* для увеличения хранилища службы поиска.
* Чтобы увеличить производительность запросов, которые может обработать служба поиска, в нее можно добавлять *реплики*.
