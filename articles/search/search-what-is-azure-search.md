...
Чтобы ознакомиться со сценариями и возможностями, посмотрите наши видеоролики. Ссылки на видеоматериалы см. на странице [Поиск Azure: учебники, видеодемонстрации и примеры](https://msdn.microsoft.com/library/azure/dn818681.aspx).
...
Индексов может быть несколько (ограничения для различных ценовых категорий см. в статье [Пределы и ограничения (поиск Azure)](https://msdn.microsoft.com/library/azure/dn798934.aspx)). Обратите внимание, что в настоящее время объединение индексов не поддерживается. В запросе поиска может указываться только один индекс.
