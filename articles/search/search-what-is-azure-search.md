...
2. Выполните действия в одном или нескольких из следующих руководств. 
  ...
  + [Руководство по созданию первого индекса службы поиска Azure на портале](search-get-started-portal.md) показывает встроенные функции индексации и создания прототипов портала.   
