...
Служба поиска Azure хранит данные в индексе, поиск по которому осуществляется с помощью полнотекстовых запросов. Схему этих индексов можно создать на классическом портале Azure или программным путем с помощью клиентской библиотеки или API REST. Определив схему, можно загрузить данные в службу поиска Azure, где они будут подвергнуты индексации.
