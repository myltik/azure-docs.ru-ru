...
## <a name="viewing-the-examples-in-this-article"></a>Просмотр примеров в этой статье
...
## <a name="proximity-search"></a>Поиск с учетом расположения
...
## <a name="term-boosting"></a>Повышение приоритета слов
...
## <a name="wildcard-search"></a>Поиск с использованием подстановочных знаков
