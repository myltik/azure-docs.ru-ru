---
title: Начало работы со службой поиска Azure | Microsoft Docs
...
> [!NOTE]
> Кроме того, вам понадобятся [подписка Azure](/pricing/free-trial/?WT.mc_id=A261C142F) и [служба поиска Azure](search-create-service-portal.md).
> 
> 
