...
> [AZURE.NOTE] Кроме того, вам понадобятся [подписка Azure](../../includes/free-trial-note.md) и [служба поиска Azure](search-create-service-portal.md).
...
7. Щелкните **Обозреватель запросов** и убедитесь, что данные загружаются в соответствии с требованиями обозревателя документов к отправке.
