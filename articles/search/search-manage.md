...
> [AZURE.NOTE] Поведение кэша может временно превышать предел. Например, при использовании общей службы вы можете увидеть количество документов, превышающее жесткий предел в 10000 документов. Такое преувеличение является временным и будет обнаружено при следующей проверке лимитов.
