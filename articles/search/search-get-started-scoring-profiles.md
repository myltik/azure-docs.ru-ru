---
title: Использование профилей повышения в поиске Azure | Microsoft Docs
...
[!INCLUDE [Для работы с данным руководством требуется учетная запись Azure.](../../includes/free-trial-note.md)]
...
6. Щелкните плитку **Ключи**, чтобы скопировать `api-key`.
