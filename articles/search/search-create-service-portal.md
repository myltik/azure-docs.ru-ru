...
В этой статье предполагается, что у вас уже есть подписка Azure и вы можете войти на портал Azure.
...
3. Выберите **Интернет + мобильные устройства**.
...
3. Службу можно масштабировать, добавив реплики или разделы.
   * Каждый уровень обслуживания имеет свои [ограничения](search-limits-quotas-capacity.md) на общее количество единиц поиска, разрешенных для одной службы (реплики * секции = общее количество единиц поиска).
