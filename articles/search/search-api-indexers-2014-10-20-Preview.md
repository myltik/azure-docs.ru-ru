...
Если база данных SQL поддерживает [функцию интегрированного отслеживания изменений SQL]http://technet.microsoft.com/library/cc280462(v=SQL.105).aspx), мы советуем использовать интегрированную политику отслеживания изменений SQL. Эта политика обеспечивает наиболее эффективное отслеживание изменений, а также позволяет Поиску Azure выявлять удаленные строки без необходимости добавлять в схему отдельный столбец обратимого удаления.
