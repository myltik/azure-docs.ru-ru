...
## <a name="iii-construct-your-http-request-and-request-body"></a>3. Создание HTTP-запроса и текста запроса
...
## <a name="iv-understand-your-http-response-code"></a>4. Анализ кода HTTP-ответа
#### <a name="200"></a>200
