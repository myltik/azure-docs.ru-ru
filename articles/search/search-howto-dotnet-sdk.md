...
Если вы уже используете старую версию пакета SDK для .NET для службы поиска Azure и хотите выполнить обновление до новой версии 1.0.1-preview, см. инструкции в [этой статье](search-dotnet-sdk-migration.md).
