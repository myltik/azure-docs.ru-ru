...
Ниже показаны снимки экрана с колонками службы поиска Azure на портале Azure, позволяющими пользователям настраивать определение схемы индекса. В этой колонке пользователи могут создавать любые поля и настраивать свойства анализатора для каждого из них.
