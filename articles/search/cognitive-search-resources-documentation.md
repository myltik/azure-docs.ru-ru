...
+ [Предварительная версия REST API](search-api-2017-11-11-preview.md)
  + [Создание набора квалификационных навыков (api-version=2017-11-11-Preview)](ref-create-skillset.md)
  + [Создание индексатора (api-version=2017-11-11-Preview)](ref-create-indexer.md)
