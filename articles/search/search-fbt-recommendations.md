...
- Создайте экземпляр HDInsight (включив удаленный рабочий стол) и подключитесь к компьютеру через приложение удаленного рабочего стола (доступно на классическом портале Azure).
