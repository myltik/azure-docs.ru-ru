---
title: Профили оценки (REST API службы Поиска Azure, версия 2015-02-28-Preview) | Microsoft Docs
...
> [!NOTE]
> В этой статье описываются профили оценки, доступные в версии [2015-02-28-Preview](search-api-2015-02-28-preview.md). Сейчас нет различий между версией `2015-02-28`, описанной на сайте [MSDN](http://msdn.microsoft.com/library/azure/mt183328.aspx), и версией `2015-02-28-Preview`, описанной в этой статье. Однако мы предлагаем этот документ, чтобы обеспечить полную документацию по API.
> 
> 
