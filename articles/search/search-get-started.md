...
1. Перейдите на [классический портал Azure](https://portal.azure.com) с помощью существующей подписки. Обратите внимание, что по URL-адресу производится переход на портал. Использование портала является обязательным. 
