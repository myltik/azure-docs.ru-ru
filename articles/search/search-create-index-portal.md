<properties
	pageTitle="Создание индекса службы ";Поиск Azure"; на портале Azure | Microsoft Azure"
...
# Создание индекса службы "Поиск Azure" на портале Azure

На портале Azure можно быстро создать прототип индекса в службе "Поиск Azure". На этом портале можно не только с легкостью проверить концепцию, но и просмотреть определения схемы и данные об использовании ресурсов для любого индекса, развернутого в службе.
