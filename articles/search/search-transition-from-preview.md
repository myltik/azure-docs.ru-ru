<properties 
	pageTitle="Переход c предварительной версии api-version=2014* на версию api-version=2015* | Microsoft Azure | Размещенная облачная служба поиска" 
...
Также мы запускаем следующую предварительную версию [2015-02-28-Предварительная](search-api-2015-02-28-preview.md), представляющую функции, разработка которых еще продолжается. Отзыв о предварительной версии API можно отправить через [форумы поиска Azure](https://social.msdn.microsoft.com/forums/azure/home?forum=azuresearch) или со [страницы обратной связи] (https://feedback.azure.com/forums/263029-azure-search /).
