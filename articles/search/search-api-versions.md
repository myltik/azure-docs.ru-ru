...
| [API REST службы](https://msdn.microsoft.com/library/azure/dn798935.aspx) |2016-09-01 |Общедоступная версия |
...
## <a name="sdk-version-roadmap"></a>Дорожная карта версий SDK
...
| 3.x |2016-09-01 |То же, что и в 2.0-preview, за вычетом поддержки индексатора больших двоичных объектов для файлов CSV и JSON |Ноябрь 2016 г. |
