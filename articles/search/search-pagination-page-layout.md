---
title: Как разбивать на страницы результаты в Поиске Azure | Microsoft Docs
...
> [!NOTE]
> Допустимый запрос содержит несколько элементов, например URL-адрес службы и путь, HTTP-команду, `api-version` и т. д. Для краткости в примерах указывается только синтаксис, касающийся разбивки на страницы. Подробную информацию о синтаксисе запроса см. в [API REST службы поиска Azure](http://msdn.microsoft.com/library/azure/dn798935.aspx).
> 
> 
