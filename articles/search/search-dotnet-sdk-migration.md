...
## Заключение
Если вам нужны дополнительные сведения об использовании пакета SDK для .NET для поиска Azure, см. наше недавно обновленное [пошаговое руководство](search-howto-dotnet-sdk.md).
