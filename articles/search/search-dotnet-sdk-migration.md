...
---
# <a name="upgrading-to-the-azure-search-net-sdk-version-20-preview"></a>Обновление до пакета SDK для .NET для Поиска Azure версии 2.0-preview
...
## <a name="whats-new-in-version-20-preview"></a>Новые возможности в версии 2.0-preview
...
## <a name="breaking-changes-in-version-20-preview"></a>Критические изменения в версии 2.0-preview
...
Будем рады вашим отзывам о пакете SDK. Если вы столкнулись с проблемами, то всегда можете обратиться за помощью на [форуме по Поиску Azure на сайте MSDN](https://social.msdn.microsoft.com/Forums/azure/en-US/home?forum=azuresearch). При обнаружении ошибки можно зарегистрировать проблему в [репозитории GitHub пакета SDK .NET для Azure](https://github.com/Azure/azure-sdk-for-net/issues). Добавьте в название вашей проблемы префикс "пакет SDK для поиска:".
...
##### <a name="important-note-for-web-applications"></a>Важное примечание для веб-приложений
