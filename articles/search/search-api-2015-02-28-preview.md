---
title: REST API службы Поиска Azure, версия 2015-02-28-Preview | Microsoft Docs
...
> [!NOTE]
> При вызове **Поиска** с помощью запроса GET зарезервированные символы в URL-адресе должны быть экранированы знаком процента (например, %23 вместо #).
> 
> 
...
> [!NOTE]
> При вызове **предложений** с помощью запроса GET зарезервированные символы в URL-адресе следует экранировать знаком процента (например, %23 вместо #).
> 
> 
