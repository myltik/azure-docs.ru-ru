...
> [AZURE.NOTE] Статистика по количеству документов и размеру хранилища собирается каждые несколько минут, а не в режиме реального времени. Поэтому статистика, возвращаемая этим API, может не отражать изменения, внесенные последними операциями индексирования.
