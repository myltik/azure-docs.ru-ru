<properties
   pageTitle="REST API службы Поиска Azure, версия 2015-02-28-Preview | Microsoft Azure | API Поиска Azure (предварительная версия)"
...
- Параметр запроса `moreLikeThis` в API [Поиск документов](#SearchDocs). Находит другие документы, связанные с другим указанным документом.
...
Дополнительную информацию см. в разделе [Добавление профилей оценки в индекс поиска (REST API службы поиска Azure)](search-api-scoring-profiles-2015-02-28-preview.md).
...
> [AZURE.NOTE] Даже несмотря на то, что размер запроса POST очень большой, выражения фильтров не могут иметь произвольную сложность. Дополнительные сведения об ограничениях сложности фильтров см. в разделе [Синтаксис выражений OData](https://msdn.microsoft.com/library/dn798921.aspx).
