<properties
   ...
   description="В предварительной версии REST API службы поиска Azure от 28 февраля 2015 г. реализованы экспериментальные функции, такие как синтаксис запросов Lucene и пользовательские анализаторы."
   services="search"
...
- [Синтаксис запросов Lucene](https://msdn.microsoft.com/library/mt589323.aspx) теперь можно использовать для запросов в службе поиска Azure. Чтобы использовать средство синтаксического анализа запросов Lucene, укажите `queryType` в операциях поиска.
- [Пользовательские анализаторы](https://msdn.microsoft.com/library/azure/mt605304.aspx) позволяют получить контроль над процессом преобразования текста в индексируемые и поддерживающие поиск токены
...
##API, рассматриваемые в этом документе
