...
[Процесс разработки для Поиска Azure]: search-workflow.md
[Создание первого решения для Поиска Azure]: search-create-first-solution.md
[Создание приложения для геопространственного поиска с помощью Поиска Azure]: search-create-geospatial.md
