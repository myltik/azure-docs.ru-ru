...
Если вы еще не [загрузили пример приложения с сайта Github](https://github.com/Azure-Samples/search-dotnet-management-api/), то следует это сделать перед выполнением данного шага руководства.
