<properties 
	pageTitle="Пример разработки решения в службе Поиск Azure: как компания WhatToPedia создала информационный портал в службе Microsoft Azure | Microsoft Azure" 
