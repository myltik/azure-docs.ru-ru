<properties
	pageTitle="Ограничения поиска Azure"
	description="Ограничения службы поиска Azure, используемые при планировании загрузки, а также ограничения запросов и ответов на них."
	services="search"
	documentationCenter=""
	authors="HeidiSteen"
	manager="mblythe"
