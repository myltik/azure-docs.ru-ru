...
2. См. предыдущие шаги выше в этой статье, в которых вы нашли URL-адрес службы и ключ API на [портале Azure](https://portal.azure.com), чтобы получить значения, которые вы теперь введете в файл **config.properties**.
