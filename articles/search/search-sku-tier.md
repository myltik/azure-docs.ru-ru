---
title: Выбор SKU или ценовой категории для службы поиска Azure | Microsoft Docs
description: 'Выполнять подготовку службы поиска Azure можно в рамках таких SKU: '
;бесплатный";,: ''
"\";базовый\";": ''
и: ''
"\";стандартный\";": ''
...
> [!NOTE]
> Если вы недооцените требования к емкости, вам понадобится подготовить новую службу на более высоком уровне, а затем перезагрузить индексы. Обновление SKU службы на месте не поддерживается.
> 
> 
