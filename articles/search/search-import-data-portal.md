...
description: "Использование мастера импорта данных поиска Azure на портале Azure для сканирования данных Azure из NoSQL DocumentDB, хранилища BLOB-объектов, хранилища таблиц, базы данных SQL и SQL Server на виртуальных машинах Azure."
services: search
documentationcenter: 
author: HeidiSteen
manager: jhubbard
...
Вы можете опробовать этот рабочий процесс, используя демонстрационные данные в DocumentDB. См. инструкции в статье [Начало работы со службой поиска Azure на портале](search-get-started-portal.md).
...
1. Войдите на [портал Azure](https://portal.azure.com) и откройте панель мониторинга службы. Щелкните **Больше служб** на панели переходов, чтобы найти существующие службы поиска в текущей подписке. 
