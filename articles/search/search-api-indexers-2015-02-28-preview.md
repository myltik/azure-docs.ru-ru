---
title: 'Операции с индексаторами (REST API службы поиска Azure: версия 2015-02-28-Preview) | Microsoft Docs'
description: 'Операции с индексаторами (API REST службы '
;поиск: ''
'azure";:': ''
версия: ''
2015-02-28-preview)": ''
