...
Обратите внимание, что в дополнение к подготовке, настройке и управлению вашей учетной записью базы данных на портале Azure вы также можете программно создавать учетные записи базы данных DocumentDB и управлять ими через [интерфейс API REST Azure DocumentDB][], а также через клиентские пакеты SDK.
