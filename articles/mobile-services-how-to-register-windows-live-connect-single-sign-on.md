<properties pageTitle="Регистрация для использования единого входа: мобильные службы Azure" description="Узнайте, как зарегистрироваться, чтобы использовать аутентификацию с помощью единого входа в приложении мобильных служб Azure." services="mobile-services" documentationCenter="" authors="ggailey777" manager="dwrede" editor=""/>
