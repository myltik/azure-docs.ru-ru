...
>[AZURE.NOTE] Из-за сложности динамической маршрутизации, используемой на виртуальном шлюзе Azure, существуют определенные ограничения по применению определяемых пользователем маршрутов с ExpressRoute.
>
