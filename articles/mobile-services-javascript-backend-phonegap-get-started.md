...
- Android: установите пакет [Android Developer Tools.][Android SDK]
...
2. На вкладке быстрого запуска нажмите кнопку **PhoneGap** в разделе **Выбор платформы**, а затем разверните пункт **Создание нового приложения PhoneGap**.
...
2.	Откройте и запустите проект, следуя приведенным ниже инструкциям для каждой платформы.
	...
	+ **Android**
		...
		3. В меню **Пуск** щелкните **Выполнить**, чтобы запустить проект в эмуляторе Android.
...
4. Вернитесь назад, и на портале управления щелкните вкладку <strong>Данные</strong> , а затем щелкните таблицу <strong>TodoItems</strong> .
