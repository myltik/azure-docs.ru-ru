...
- Не используйте виртуальную либо предоплаченную дебетовую или кредитную карту.
- В случае сбоя оплаты или активации попробуйте использовать альтернативную действительную кредитную карту, которая поддерживается системой.
- Убедитесь, что метод оплаты активен и банк не блокирует все интернет-транзакции в соответствии со своими политиками безопасности.
...
- Так как данные вашего профиля используются для составления платежных документов, при регистрации обязательно предоставлять точную информацию.
...
- Дважды проверьте каждое поле в профиле при регистрации или при [настройке профиля](https://account.windowsazure.com/Profile/), если вы уже создали учетную запись Azure.
- Так как данные профиля используются для составления платежных документов, указывайте точную информацию.
...
- MSDN:
  ...
  - Проверьте свой статус соответствия требованиям на своей [странице учетной записи MSDN](https://msdn.microsoft.com/subscriptions/manage/deult.aspx).
...
## Дальнейшие действия
Есть вопросы, связанные с оплатой или подпиской Microsoft Azure? См. сведения в статье [Вопросы и ответы о выставлении счетов и управлении подпиской](billing-subscription-faq.md#what-payment-options-do-i-have-in-purchasing-azure).
