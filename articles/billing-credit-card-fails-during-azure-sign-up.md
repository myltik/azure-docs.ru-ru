...
Если вы уже активировали подписку Azure в прошлом и из-за этого не можете активировать бесплатную пробную версию, вместо бесплатной пробной версии Azure воспользуйтесь другим доступным планом Azure. Ознакомиться с планами можно на странице [сведений о предложениях Microsoft Azure](http://azure.microsoft.com/support/legal/offer-details/).
