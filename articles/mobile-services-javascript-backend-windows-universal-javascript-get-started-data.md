...
<ol start="8">
<li><p>В обозревателе решений перейдите во вложенную папку <strong>services\mobileService\scripts</strong>, откройте файл скрипта service.js и обратите внимание на новую глобальную переменную, которая выглядит, как в следующем примере:</p> 
