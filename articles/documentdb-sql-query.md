<properties title="Формирование запросов с помощью DocumentDB SQL" pageTitle="Формирование запросов с помощью DocumentDB SQL | Azure" description="DocumentDB поддерживает формирование запросов с помощью языка, синтаксис которого подобен языку SQL, в отношении иерархических документов JSON, не требуя явной схемы или создания дополнительных индексов." metaKeywords="" services="documentdb"  documentationCenter="" solutions="data-management" authors="bradsev" manager="jhubbard" editor="cgronlun" videoId="" scriptId="" />
...
-   DocumentDB поддерживает только документы, строго соответствующие JSON. Это означает, что система типов и выражения могут обрабатывать только типы JSON. Подробнее см. в разделе [спецификация JSON] (http://www.json.org/).
...
О том, как настроить политику индексации для коллекции, см. в разделе [примеры DocumentDB] (http://code.msdn.microsoft.com/Azure-DocumentDB-NET-Code-6b3da8af\#content) на сайте MSDN. Давайте теперь перейдем к деталям языка SQL DocumentDB .
...
См. подробнее в разделе [примеры .NET для DocumentDB] (http://code.msdn.microsoft.com/Azure-DocumentDB-NET-Code-6b3da8af\#content), где приведены другие примеры запросов.
...
1.  [Введение в Azure DocumentDB][Введение в Azure DocumentDB]
...
4.  [Уровни согласованности DocumentDB][Уровни согласованности DocumentDB]
5.  Стандарт ANSI SQL 2011 - <http://www.iso.org/iso/iso_catalogue/catalogue_tc/catalogue_detail.htm?csnumber=53681>
6.  JSON <http://json.org/>
7.  Спецификация JavaScript ECMA-262 <http://www.ecma-international.org/publications/standards/Ecma-262.htm>
8.  LINQ <http://msdn.microsoft.com/ru-ru/library/bb308959.aspx>
9.  Технология оценки выражения для больших баз данных <http://dl.acm.org/citation.cfm?id=152611>
