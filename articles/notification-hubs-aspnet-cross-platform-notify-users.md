...
+  **[Общая информация о центрах уведомлений Azure][Шаблоны]**<br/>Здесь приведена более подробная информация о шаблонах.
