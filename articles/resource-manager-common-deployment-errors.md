...
Чтобы зарегистрировать поставщика, используйте командлет **Register-AzureRmResourceProvider** и укажите имя поставщика ресурсов, который необходимо зарегистрировать.
...
Чтобы зарегистрировать поставщика ресурсов, используйте команду `azure provider register` и укажите *пространство имен*, которое следует зарегистрировать.
...
Если при развертывании виртуальной машины возникнет ошибка с расширением пользовательского скрипта, см. статью [Troubleshooting Azure Windows VM extension failures](./virtual-machines/virtual-machines-windows-extensions-troubleshoot.md) (Устранение сбоев в расширениях виртуальных машин Windows в Azure) или [Troubleshooting Azure Linux VM extension failures](./virtual-machines/virtual-machines-linux-extensions-troubleshoot.md) (Устранение сбоев в расширениях виртуальных машин Linux в Azure).
...
- Сведения об аудите действий см. в статье [Аудит операций с помощью Resource Manager](./resource-group-audit.md).
