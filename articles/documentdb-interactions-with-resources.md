...
Наконец, чтобы выполнить хранимую процедуру в приведенном выше примере, необходимо выполнить команду POST с URI-ресурса хранимой процедуры (/dbs/_rid-db/colls/_rid-coll/sprocs/sproc1). Это продемонстрировано в следующем коде.  
...
##Ссылки
-   [Справочник по API REST Azure DocumentDB](https://msdn.microsoft.com/library/azure/dn781481.aspx) 
...
-	Теги сущностей [http://en.wikipedia.org/wiki/HTTP_ETag](http://en.wikipedia.org/wiki/HTTP_ETag)
-	[Запросы в DocumentDB](../documentdb-sql-query/)
-	[Справочник по языку SQL DocumentDB](https://msdn.microsoft.com/library/azure/dn782250.aspx)
-	[Программирование DocumentDB. Хранимые процедуры, триггеры и пользовательские функции](../documentdb-programming/)
