<properties 
	pageTitle="Управление учетными записями разработчика в службе управления API Azure" 
	description="Создание или приглашение разработчиков в службе управления API Azure" 
