...
В следующем видео представлены службы Azure Location Based Services.
...
Наши API-интерфейсы сейчас недоступны в указанных ниже странах. Проверьте текущий IP-адрес и убедитесь, что он не относится к одной из неподдерживаемых стран, указанных ниже.
