---
title: "Управление хранилищем ключей с помощью интерфейса командной строки | Документация Майкрософт"
...
>
> В этом руководстве используется последняя версия Azure CLI 2.0. Инструкции по использованию предыдущих версий Azure CLI (на основе node.js) приведены в [этом аналогичном руководстве](key-vault-manage-with-cli.md).
>
>
...
2. Слева щелкните **Azure Active Directory**, а затем выберите каталог, в котором вам необходимо зарегистрировать приложение. <br> <br> Примечание. Вам необходимо выбрать каталог, содержащий подписку Azure, используемую для создания хранилища ключей. Если вам не известно, какой это каталог, щелкните **Параметры**, найдите подписку, использованную для создания хранилища ключей, и запишите имя каталога, отображающегося в последнем столбце.
