...
| Разработчики и операторы |Разрешения на развертывание хранилища ключей, чтобы развертываемые ими виртуальные машины могли получать секреты из хранилища ключей |Нет |
