...
Хранилищем ключей можно управлять в службе автоматизации Azure с помощью [командлетов хранилища ключей Azure](https://msdn.microsoft.com/library/azure/dn868052.aspx), которые доступны в [коллекции PowerShell](https://azure.microsoft.com/blog/azps-1-0/). Этот модуль можно импортировать в службу автоматизации Azure, что позволит выполнять в этой службе задачи по управлению хранилищем ключей. Вы также можете связать эти командлеты в службе автоматизации Azure с командлетами для других служб Azure, чтобы автоматизировать сложные задачи в службах Azure и системах сторонних производителей.

С помощью командлетов хранилища ключей Azure можно выполнять, кроме прочего, следующие задачи: создание или импорт ключа, создание или обновление секрета, обновление атрибутов ключа, получение ключа или секрета, а также удаление ключа или секрета.
