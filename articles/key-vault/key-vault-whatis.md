...
Дополнительную информацию об использовании ключей и секретов с помощью хранилища ключей Azure см. в статье, посвященной [ключам, секретам и сертификатам](https://msdn.microsoft.com/library/azure/dn903623(v=azure.1).aspx).
