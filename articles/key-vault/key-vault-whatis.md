...
Разработчики также могут управлять ключами напрямую с помощью API. Дополнительную информацию см. в [руководстве разработчика для хранилища ключей](key-vault-developers-guide.md).
