...
Затем этот администратор будет предоставлять разработчикам URI для вызова ключей из приложения, а их администраторам безопасности — информацию журналов использования ключей. Учтите, что журнал использования сейчас доступен в режиме [предварительной версии](http://blogs.technet.com/b/kv/archive/2015/11/10/keyvault_2d00_logging_2d00_preview.aspx).
