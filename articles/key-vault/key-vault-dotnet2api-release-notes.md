...
Следующие примечания и инструкции предназначены для разработчиков, использующих библиотеки .NET и C# при работе с хранилищем ключей Azure. Обновленная версия 2.0 включает ряд таких изменений, как реализация поддержки сертификатов хранилища ключей. Чтобы вы могли воспользоваться новыми возможностями и улучшениями, необходимо программным образом выполнить перенос.
