...
- [Интеграция хранилища ключей с шифрованием дисков Azure для виртуальных машин IaaS под управлением Windows или Linux](../security/azure-security-disk-encryption.md): это решение шифрования дисков интегрировано с хранилищем ключей Azure, то есть позволяет управлять ключами и секретами дискового шифрования через подписку хранилища ключей. Шифрование выполняется для всех данных на дисках виртуальных машин в хранилище Azure.
