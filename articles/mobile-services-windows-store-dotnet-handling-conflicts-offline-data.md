...
>[AZURE.NOTE] Для поддержки синхронизации удаленных записей при синхронизации автономных данных необходимо включить поддержку [удаления с возможностью восстановления](mobile-services-using-soft-delete.md). В противном случае придется вручную удалять записи в локальном хранилище или вызвать функцию `IMobileServiceSyncTable::PurgeAsync()` для очистки хранилища.
