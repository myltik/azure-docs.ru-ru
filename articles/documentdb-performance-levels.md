...
> [AZURE.IMPORTANT] Уровни производительности будут доступны после выпуска Azure DocumentDB. Выпуск запланирован на апрель 2015 г.
...
- [Управление емкостью DocumentDB](http://azure.microsoft.com/documentation/articles/documentdb-manage/) 
- [Моделирование данных в DocumentDB](http://azure.microsoft.com/documentation/articles/documentdb-modeling-data/)
- [Секционирование данных в DocumentDB](http://azure.microsoft.com/documentation/articles/documentdb-partition-data/)
