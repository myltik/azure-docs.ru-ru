...
Чтобы повторно включить отмененную подписку, необходимо создать запрос в службу поддержки. Войдите на [портал Azure](https://portal.azure.com/), выберите **Справка+поддержка** > **Новый запрос в службу поддержки**.
