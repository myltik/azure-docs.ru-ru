...
В этой статье описано планирование обновления Базы данных SQL Azure с версии 11 до 12 ([в некоторых регионах доступна только предварительная версия](sql-database-v12-whats-new.md#V12AzureSqlDbPreviewGaTable)), а также необходимые подготовительные действия.
...
> [AZURE.NOTE]База данных, версия которой ниже 12, *продолжает обеспечивать* доступ к данным во время обновления до версии 12.
