...
>
> [Освободить пробной версии подписки](https://azure.microsoft.com/offers/ms-azr-0044p) недоступны для увеличения максимального или квоты. Если у вас есть [бесплатной пробной версии подписки](https://azure.microsoft.com/offers/ms-azr-0044p), можно выполнить обновление до [Оплата по мере использования](https://azure.microsoft.com/offers/ms-azr-0003p/) подписки. Дополнительные сведения см. в разделе [обновление бесплатная пробная версия на оплату по мере использования](billing/billing-upgrade-azure-subscription.md) и [бесплатной пробной версии подписки часто задаваемые вопросы о](https://azure.microsoft.com/free/free-account-faq).
>
...
Ограничения хранилища данных SQL см. [ограничения ресурсов хранилища данных SQL](sql-data-warehouse/sql-data-warehouse-service-capacity-limits.md).
