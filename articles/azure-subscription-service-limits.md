...
- Категория *Стандартный (S1 и S2)* предназначена для рабочих нагрузок в рабочей среде. Версия с увеличенной емкостью (*S2*) доступна по запросу (обратитесь в службу поддержки или по адресу azuresearch_contact@microsoft.com).
...
Дополнительные сведения о других ограничениях, включая размер документа, количество запросов с секунду, ключи, запросы и ответы, см. в статье [Ограничения поиска Azure](search/search-limits-quotas-capacity.md).
