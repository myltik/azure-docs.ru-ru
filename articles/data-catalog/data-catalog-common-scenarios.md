<properties
   ...
   description="Обзор распространенных сценариев каталога данных Azure: регистрация, пополнение, изучение, понимание и использование источников данных и удаление метаданных источников данных."
