...
Эта статья поможет вам начать внедрение **каталога данных Azure** в своей организации. Чтобы успешно внедрить **каталог данных Azure**, вам нужно сосредоточиться на трех ключевых моментах: разработать концепцию, определить основные варианты использования каталога в организации и выбрать пилотный проект.

## Общие сведения о каталоге данных Azure
Бытующие на рынке труда представления о том, как можно находить специализированную информацию о ресурсах данных, изменились. В настоящее время, когда в работе широко используются инструменты социальных сетей, таких как Yammer, пользователи рассчитывают быстро получать помощь и советы на самые разные темы. **Каталог данных Azure** помогает предприятиям и рабочим коллективам консолидировать сведения о корпоративных ресурсах данных в централизованном репозитории. Здесь потребители данных могут находить доступные источники данных и получать знания, которыми делятся профильные специалисты.
...
## Определение концепции проекта каталога данных
...
-	**Поставьте конкретные цели и определите сроки их достижения**. Эти ограничения гарантируют, что план внедрения имеет конкретные и достижимые результаты. Временная шкала помогает участникам проекта сохранять концентрацию и содержит контрольные точки для измерения успеха.
...
## Определение вариантов использования каталога данных в компании
...
Это лишь несколько примеров использования **каталога данных Azure**. Дополнительные сведения о сценариях каталога данных см. в статье [Типичные сценарии каталога данных Azure](data-catalog-common-scenarios.md).
...
## Выбор пилотного проекта каталога данных
...
-	Дополнительные сведения о регистрации источников данных см. в разделе [Регистрация источников данных](data-catalog-get-started.md#exercise-2-registering-data-sources).

-	Дополнительные сведения об обнаружении источников данных см. в разделе [Обнаружение зарегистрированных ресурсов данных](data-catalog-get-started.md#exercise-3-discovering-registered-data-assets).
...
> [AZURE.NOTE] Мы написали пример инструмента, использующего API **каталога данных Azure** для переноса книги Excel в каталог данных. Чтобы получить дополнительные сведения об API каталога данных и примере инструмента, [загрузите одноразовый пример кода книги](https://azure.microsoft.com/documentation/samples/data-catalog-dotnet-excel-register-data-assets/) и ознакомьтесь с документацией по [REST API каталога данных Azure](https://msdn.microsoft.com/library/azure/mt267593.aspx).
...
## Дополнительная информация о каталоге данных Azure
...
-	[Регистрация источников данных](data-catalog-get-started.md#exercise-2-registering-data-sources)
-	[Поиск источников данных](data-catalog-get-started.md#exercise-3-discovering-registered-data-assets)
