...
|__id|Строка|Идентификатор элемента (только для чтения). Этот идентификатор ресурса гарантированно является уникальным в каталоге. |__type|Строка|Тип ресурса (только для чтения).
