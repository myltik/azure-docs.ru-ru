...
Для всех объектов структурные метаданные включают сведения о расположении объекта, так что клиенты могут определять, кто обнаруживает данные. К другим структурным метаданным относятся имя, тип, имя атрибута или столбца и тип данных.
...
Как и добавление предварительного просмотра предоставляет ценный контекст для пользователей, которые ищут источники данных в **каталоге данных Azure**, включение профиля данных также может понимание обнаруженных данных источников.
