...
Добавление предварительного просмотра предоставляет ценный контекст для пользователей, которые ищут источники данных в **каталоге данных Azure**. Включение профиля данных также упрощает понимание обнаруженных источников данных.
