...
Регистрация и подключение к базе данных Oracle При подключении к источникам данных базы данных Oracle у пользователей должны быть установлены правильные драйверы Oracle, которые соответствуют разрядности (32-разрядной или 64-разрядной версии) используемого программного обеспечения.
...
Если при регистрации таблиц и представлений, содержащих столбцы больших двоичных объектов (BLOB-объектов) и типов данных, определяемых пользователем (UDT), вы включаете предварительный просмотр для ресурсов данных, эти столбцы не будут включены в область предварительного просмотра.
