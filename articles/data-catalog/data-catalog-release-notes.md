...
## Заметки о выпуске каталога данных Azure от 4 сентября 2015 г.

### Возможно, профиль данных отсутствует для некоторых зарегистрированных ресурсов

При регистрации источников данных с параметром профилирования данных, выбранным в средстве регистрации источника данных, сведения профиля не могут быть включены при регистрации таблиц и представлений Oracle с многобайтовыми символами в именах столбцов.

Эти ограничения вызваны известной проблемой в выпуске от 4 сентября и будут устранены в последующем обновлении каталога данных Azure.
