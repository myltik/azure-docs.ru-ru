<properties
   pageTitle="Заметки о выпуске каталога данных Azure"
	description="Заметки о выпуске для общедоступной предварительной версии каталога данных Azure от 28 августа 2015 г."
...
## Заметки о выпуске каталога данных Azure от 28 августа 2015 г.

### Профиль данных отсутствует для некоторых средств зарегистрированных данных

При регистрации источников данных с параметром профилирования данных, выбранным в средстве регистрации источника данных, сведения профиля не могут быть включены в следующих сценариях:

* таблицы базы данных SQL Azure;
* таблицы и представления SQL Server, где существует несколько объектов с одним именем в разных схемах;
* таблицы и представления SQL Server с именами столбцов больше 118 символов;
* таблицы и представления Oracle с именами столбцов больше 20 символов;
* таблицы и представления Oracle с пробелами или двухбайтовыми символами в именах столбцов.

Эти ограничения вызваны известной проблемой в выпуске 28 августа и будут устранены в последующем обновлении каталога данных Azure.
...
Подробнее: [Настройка проверки подлинности на основе форм в интрасети для устройств, которые не поддерживают WIA](https://technet.microsoft.com/library/dn727110.aspx).
