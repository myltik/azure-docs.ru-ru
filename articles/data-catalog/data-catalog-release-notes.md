...
Пользователям, получившим это сообщение, следует удалить существующее приложение «Каталог данных Azure» с помощью панели управления Windows и повторно запустить этот инструмент из портала **каталога данных Azure**.
...
Подробнее об этом см. в разделе [Включение или отключение предупреждений системы безопасности о ссылках и файлах с подозрительных веб-сайтов](https://support.office.com/ru-RU/article/Enable-or-disable-security-alerts-about-links-and-files-from-suspicious-websites-A1AC6AE9-5C4A-4EB3-B3F8-143336039BBE).
...
Подробнее: [Настройка политик проверки подлинности](https://technet.microsoft.com/ru-RU/library/dn486781.aspx).
