...
## Заметки о выпуске каталога данных Azure от 6 ноября 2015 г.

### Пользователи могут получать сообщения об ошибках при запуске средства регистрации источника данных

При запуске средства регистрации источника данных **Каталог данных Azure** из портала **каталога данных Azure** пользователи, ранее установившие предыдущую версию средства, могут получать следующее сообщение: "Запуск приложения невозможен. Обратитесь к поставщику приложения".

Пользователям, получившим это сообщение, следует удалить существующее приложение "Каталог данных Azure" с помощью панели управления Windows и повторно запустить средство из портала **каталога данных Azure**.
...
Дополнительную информацию см. в разделе [Настройка политик проверки подлинности](https://technet.microsoft.com/ru-RU/library/dn486781.aspx).
