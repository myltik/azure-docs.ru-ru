...
- Поддержка изменения подписки Azure, используемой **каталогом данных Azure**. Администраторы **каталога данных azure** могут выбрать другую подписку Azure для составления счетов на странице "Настройки" на портале **каталога данных Azure**.
