...
- Возможность закрепления и открепления ресурсов данных в портале **каталога данных Azure**. Пользователи могут закрепить ресурсы данных, чтобы более удобно находить и повторно использовать их в будущем.
- Изменен дизайн домашней страницы в портале **каталога данных Azure**. Новая начальная страница содержит сведения о текущей деятельности пользователей — включая недавно опубликованные ресурсы, прикрепленные ресурсы и сохраненные результаты поиска, а также сведения о действиях в каталоге в целом.
- Поддержка постоянных пользовательских параметров в портале **каталога данных Azure**. Параметры взаимодействия с пользователем, включая представление в виде сетки или мозаики, количество результатов на страницу, а также включение или отключение выделения, сохраняются между сеансами пользователей.
- **Каталог данных Azure** теперь доступен в двух новых регионах Azure. Клиенты могут выполнять подготовку **каталога данных Azure** в Северной Европе и Юго-Восточной Азии в дополнение к Востоку США, Западной части США, Западной Европе и Восточной Австралии. Подробнее см. в разделе [Регионы Azure](https://azure.microsoft.com/regions/).
