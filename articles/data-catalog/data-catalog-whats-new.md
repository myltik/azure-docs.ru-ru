...
- Поддержка определения и изменения схем уровня столбца для зарегистрированных вручную ресурсов данных. После ручного создания ресурса-контейнера данных с помощью портала **каталога данных Azure** пользователи могут добавлять определения столбцов в свойства ресурса-контейнера данных.
...
- Добавлена новая кнопка "Пользователь" и меню в верхней панели навигации. С помощью этого меню пользователь может отображать сведения об учетной записи, используемой для входа в **каталог данных Azure** и, при необходимости, для выхода из него. Кроме того, в этом меню отображается имя каталога, которое может пригодиться разработчикам, использующим REST API **каталога данных Azure**.
