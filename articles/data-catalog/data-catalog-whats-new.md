<properties
   ...
   description="Обзор новых возможностей каталога данных Azure."
...
- Объединенная конечная точка API REST для программного доступа к возможностям поиска и управления ресурсами для службы каталога **каталога данных Azure**. Существующие конечная точка API поиска и конечная точка API каталога устарели, и их поддержка будет прекращена 21 марта 2016 г. В семантике API никаких изменений не произошло; изменился только URI конечной точки. Дополнительные сведения см. в разделе [Справочник по API REST для каталога данных Azure](https://msdn.microsoft.com/library/azure/mt267595.aspx). Примеры API см. в разделе [Примеры каталога данных Azure для разработчиков](data-catalog-samples.md).
