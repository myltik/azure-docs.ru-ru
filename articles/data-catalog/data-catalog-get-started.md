...
Данная статья содержит исчерпывающие сведения о сценариях использования и возможностях **общедоступной предварительной версии каталога данных Azure**. Зарегистрировавшись для работы с предварительной версией, вы сможете создать каталог данных, зарегистрировать и найти источники данных, а также добавить к ним заметки.
