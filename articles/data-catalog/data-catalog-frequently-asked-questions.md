---
title: Часто задаваемые вопросы о каталоге данных Azure | Microsoft Docs
...
## <a name="q:-does-azure-data-catalog-work-with-this-other-data-source-i’m-interested-in?"></a>Вопрос. Поддерживает ли каталог данных Azure другие источники данных, которые меня интересуют?
...
## <a name="q:-my-question-isn’t-answered-here-–-what-should-i-do?"></a>Вопрос. Я не нашел ответа на свой вопрос. Что делать?
