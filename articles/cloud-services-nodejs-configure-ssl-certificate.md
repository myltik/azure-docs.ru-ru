...
> [AZURE.NOTE] Действия, описанные в данной статье, применимы только к приложениям узла, размещенным в качестве облачной службы Azure в веб-роли; информацию, применимую к веб-сайтам, см. в разделе [Настройка SSL-сертификата для веб-сайта Azure](../web-sites-configure-ssl-certificate/).
