...
* **Тип действия** позволяет отправить текстовое сообщение, сообщение электронной почты, вызвать веб-перехватчик или отправить данные в инструмент ITSM.
...
7. Определите список действий, указав для каждого из них следующие данные:
    ...
    b. **Тип действия.** Выберите SMS, электронную почту, веб-перехватчик или ITSM.

    c. **Подробные сведения.** В зависимости от выбранного типа действия укажите номер телефона, адрес электронной почты, универсальный код ресурса (URI) веб-перехватчика или сведения о подключении ITSM. Для действия ITSM дополнительно укажите **рабочий элемент** и заполните другие поля, требуемые инструментом ITSM. 
