---
title: "Потоковая передача журналов диагностики Azure в пространство имен концентраторов событий | Документация Майкрософт"
description: "Узнайте, как настроить потоковую передачу журналов диагностики Azure в пространство имен концентраторов событий."
author: johnkemnetz
manager: orenr
editor: 
...
* **Потоковая передача журналов в сторонние системы ведения журналов и системы телеметрии.** Через некоторое время потоковая передача в концентраторы событий будет использоваться для передачи журналов диагностики в сторонние решения SIEM и решения для анализа журналов.
