...
| MetricName созданного оповещения |\Физический диск(_общий объем ресурсов)\скорость записи на диск/с Точные имена метрик можно получить с помощью командлета `Get-MetricDefinitions`. |
