...
Журналы действий отличаются от [журналов диагностики](monitoring-overview-of-diagnostic-logs.md). Журналы действий предоставляют внешние данные об операциях с ресурсами. Журналы диагностики выдаются ресурсом и содержат данные о его работе.
...
* [Создание оповещения, активируемого событием журнала действий.](monitoring-activity-log-alerts.md)
