...
Журнал действий содержит несколько категорий данных. Подробные сведения о схемах этих категорий см. в [этой статье](monitoring-activity-log-schema.md). В частности, описаны такие возможности:
