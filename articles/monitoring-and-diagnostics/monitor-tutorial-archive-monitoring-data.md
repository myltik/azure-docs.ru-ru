...
В этом руководстве вы узнали, как настроить архивацию данных мониторинга из среды Azure (подписка, ресурс или гостевая ОС) в учетную запись хранения. Чтобы эффективнее использовать свои данные и получать аналитические сведения, попробуйте также отправить данные в Log Analytics.
