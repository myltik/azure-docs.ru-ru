...
[Монитор ExpressRoute](https://azure.microsoft.com/en-in/blog/monitoring-of-azure-expressroute-in-preview/) — функция NPM, которая отслеживает сквозную доступность и производительность каналов Azure ExpressRoute.
...
* [Azure Monitor](https://azure.microsoft.com/en-us/services/monitor/) поможет начать работу с метриками и предупреждениями базового мониторинга.
