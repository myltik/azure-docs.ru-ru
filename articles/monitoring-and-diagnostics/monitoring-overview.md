...
![Модель мониторинга и диагностики для невычислительных ресурсов](./media/monitoring-overview/Monitoring_Azure_Resources-compute_v4.png)

Рис. 1. Концептуальная модель мониторинга и диагностики для невычислительных ресурсов

<br/>

![Модель мониторинга и диагностики для вычислительных ресурсов](./media/monitoring-overview/Monitoring_Azure_Resources-non-compute_v4.png)
...
Можно использовать данные мониторинга для активации оповещений или даже целых процессов.
Примеры приведены ниже.
