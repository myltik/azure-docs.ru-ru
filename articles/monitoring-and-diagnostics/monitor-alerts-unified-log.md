...
> [!NOTE]
> В запросе необходимо использовать функцию Bin. Кроме того, если при использовании функции Bin для временного окна будут выданы неравные интервалы времени, служба оповещений будет вместо нее использовать функцию bin_at, чтобы гарантировать наличие фиксированной запятой.
