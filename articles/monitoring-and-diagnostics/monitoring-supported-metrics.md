...
|Метрика|Отображаемое имя метрики|Единица измерения|Тип статистической обработки|Описание|
|---|---|---|---|---|
|CustomerInsightsApiCalls|CustomerInsightsApiCalls|Count|Всего||
...
|notificationhub.devices|Устройства концентратора уведомлений|Count|Средняя|Количество устройств концентратора уведомлений|
|notificationhub.pushes|push-уведомления концентратора уведомлений|Count|Всего|Количество push-уведомлений в концентраторе уведомлений|
