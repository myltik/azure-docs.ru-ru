...
|ConnectionsOpened|Открытые подключения. (предварительная версия)|Count|Среднее|Открытые подключения для Microsoft.EventHub. (предварительная версия)|EntityName|
...
|Average_% Used Inodes|Average_% Used Inodes|Count|Среднее|Average_% Used Inodes|Computer, ObjectName, InstanceName, CounterPath, SourceSystem|
|Average_% Used Space|Average_% Used Space|Count|Среднее|Average_% Used Space|Computer, ObjectName, InstanceName, CounterPath, SourceSystem|
