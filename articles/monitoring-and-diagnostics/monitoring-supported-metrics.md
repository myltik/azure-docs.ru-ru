...
| d2c.telemetry.egress.success | Telemetry messages delivered | Count | Всего | Число всех успешных операций записи в конечную точку. |
| d2c.telemetry.egress.invalid | Invalid telemetry message delivery attempts | Count | Всего | Число сообщений, которые не были доставлены из-за несовместимости с конечной точкой. |
| d2c.telemetry.egress.dropped | Dropped telemetry messages | Count | Всего | Число сообщений, отброшенных из-за неработоспособности конечной точки. |
| d2c.telemetry.egress.fallback | Telemetry messages matching fallback condition | Count | Всего | Число сообщений, соответствующих резервному маршруту. |
| d2c.telemetry.egress.orphaned | Orphaned telemetry messages | Count | Всего | Число сообщений, не соответствующих какому-либо маршруту, включая резервный. |
| d2c.endpoints.latency.eventHubs | Message latency for Event Hub endpoints | Миллисекунды | Средняя | Средняя, минимальная и максимальная задержки в миллисекундах между поступлением сообщения в Центр Интернета вещей и его поступлением на конечную точку концентратора событий. |
| d2c.endpoints.latency.serviceBusQueues | Message latency for Service Bus Queue endpoints | Миллисекунды | Средняя | Средняя, минимальная и максимальная задержки в миллисекундах между поступлением сообщения в Центр Интернета вещей и его поступлением на конечную точку очереди служебной шины. |
| d2c.endpoints.latency.serviceBusTopics | Message latency for Service Bus Topic endpoints | Миллисекунды | Средняя | Средняя, минимальная и максимальная задержки в миллисекундах между поступлением сообщения в Центр Интернета вещей и его поступлением на конечную точку раздела служебной шины. |
...
## <a name="microsoftwebsites-including-azure-functions"></a>Microsoft.Web/sites (в т. ч. Функции Azure)
...
|AverageMemoryWorkingSet|средний размер рабочего набора памяти;|Байты|Всего|средний размер рабочего набора памяти;|
