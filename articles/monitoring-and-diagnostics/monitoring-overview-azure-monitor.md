...
- **Активированные оповещения и источники оповещений.** В этой таблице отображается общее количество оповещений, источников оповещений, а также количество выполненных оповещений за выбранный период времени. Она применяется для оповещений на основе метрик и журналов действий. *<Правка. Функция оповещений (предварительная версия) с унифицированным представлением также отображается для всех предупреждений: событий, метрик и журналов>*
...
> [!NOTE]
> Мы работаем над функцией оповещений в Microsoft Azure, и теперь унифицированное представление для отображения предупреждений доступно в режиме предварительной версии. См. дополнительные сведения об [оповещениях Azure (предварительная версия)](monitoring-overview-unified-alerts.md)

В стандартной версии функции оповещений Azure вы можете использовать данные мониторинга для активации оповещений или даже целых процессов. Примеры приведены ниже.
