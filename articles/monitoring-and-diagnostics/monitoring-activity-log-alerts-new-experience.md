---
title: Создание оповещений журнала действий и управление ими с помощью новой функции "Оповещения (предварительная версия)" в Azure Monitor | Документация Майкрософт
description: Эта статья содержит сведения о создании оповещений журнала действий на вкладке "Оповещения (предварительная версия)" в разделе Azure Monitor. В ней также подробно описан новый пользовательский интерфейс для этой функции.
...
---
# <a name="create-activity-log-alerts-using-the-new-alerts-preview-experience"></a>Создание оповещений журнала действий с помощью новой функции "Оповещения (предварительная версия)"
...
## <a name="whats-new-in-alerts-preview-for-activity-logs"></a>Новые возможности функции "Оповещения (предварительная версия)" для журналов действий

Функция [Оповещения Azure (предварительная версия)](monitoring-overview-unified-alerts.md) теперь предоставляет улучшенный пользовательский интерфейс для оповещений журнала действий. С [улучшенным пользовательским интерфейсом для оповещений](monitoring-overview-unified-alerts.md) теперь вы можете делать следующее:

- [Создавать](#create-an-alert-rule-for-an-activity-log) правила генерации оповещений журнала действий и [управлять](#view-and-manage-activity-log-alert-rules) ими в колонке **Монитор** > **Оповещения (предварительная версия)**. Узнайте больше о [журналах действий](monitoring-overview-activity-logs.md).
...
1. На портале Azure выберите **Монитор** > **Оповещения (предварительная версия)**.
2. Выберите **Новое правило генерации оповещений** в верхней части окна **Оповещения (предварительная версия)**.
...
1. На портале Azure выберите **Монитор** > **Оповещения (предварительная версия)** и щелкните **Manage rules** (Управление правилами) в верхнем левом углу окна.
