...
> [!NOTE]
> В этой статье объясняется, как создать оповещение метрики прежней версии. Azure Monitor теперь поддерживает новые улучшенные оповещения на основе метрик. Эти оповещения поддерживают мониторинг нескольких метрик и охватывают метрики размерностей. Дополнительные сведения об оповещениях на основе метрик практически в реальном времени см. [здесь](monitoring-near-real-time-metric-alerts.md).
>
>

В этой статье показано, как настроить оповещения метрик Azure с помощью портала Azure. 
...
3. Выберите команду **Добавить оповещение метрики** и заполните поля.
