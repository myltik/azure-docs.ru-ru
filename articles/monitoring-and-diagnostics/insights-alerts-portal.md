...
* **События журнала действий**. Оповещение может активироваться при *каждом* событии или только тогда, когда выполняются определенные события. Узнайте больше об [оповещениях журнала действий](monitoring-activity-log-alerts.md).
...
> [!NOTE]
> Azure Monitor теперь поддерживает оповещения на основе метрик практически в реальном времени (общедоступная предварительная версия). Эти оповещения используют группы действий. Дополнительные сведения об оповещениях на основе метрик практически в реальном времени см. [здесь](monitoring-near-real-time-metric-alerts.md).
>
>
