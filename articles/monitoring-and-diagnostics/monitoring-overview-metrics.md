...
* [REST API определений метрик Azure Monitor](https://docs.microsoft.com/en-us/rest/api/monitor/metricdefinitions) используется для доступа к списку метрик и любых измерений, которые доступны для службы.
* [REST API метрик Azure Monitor](https://docs.microsoft.com/en-us/rest/api/monitor/metrics) используется для сегментирования и фильтрации данных метрик, а также для доступа к ним.

> [!NOTE]
> В этой статье описывается работа с метриками с помощью [нового API для метрик](https://docs.microsoft.com/en-us/rest/api/monitor/) ресурсов Azure. Версия нового API метрик и определений метрик — 2017-05-01-preview. Для доступа к устаревшим метрикам и их определениям используйте API версии 2014-04-01.
>
>
