...
> [!NOTE]
> В этой статье описывается работа с метриками с помощью [нового API для метрик](https://docs.microsoft.com/rest/api/monitor/) ресурсов Azure. Версия нового API метрик и определений метрик — 2017-05-01-preview. Для доступа к устаревшим метрикам и их определениям используйте API версии 2014-04-01.
>
>
