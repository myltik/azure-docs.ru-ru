...
* Ограничьте доступ к учетным записям хранения или концентраторам событий, связанным с мониторингом, держа их в отдельной группе ресурсов, и [используйте область применения](../role-based-access-control/overview.md#basics-of-access-management-in-azure) ролей мониторинга, чтобы предоставить им доступ только к этой группе ресурсов.
