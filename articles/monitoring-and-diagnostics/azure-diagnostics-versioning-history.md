---
title: "Журнал версий системы диагностики Azure | Документация Майкрософт"
...
---
# <a name="microsoft-azure-diagnostics-version-history"></a>Журнал версий системы диагностики Microsoft Azure
...
## <a name="azure-sdk-28"></a>Пакет SDK для Azure 2.8
В пакет SDK для Azure 2.8 добавлена возможность отправлять данные диагностики в [Application Insights](../application-insights/app-insights-cloudservices.md). Это упрощает диагностирование проблем в приложении, а также на уровне системы и инфраструктуры.
