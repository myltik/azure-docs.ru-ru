---
title: "Просмотр журналов событий и действий (аудита)"
...
---
# <a name="view-events-and-activity-logs"></a>Просмотр журналов событий и действий
...
## <a name="browse-the-events-impacting-your-azure-subscription"></a>Просмотр событий, влияющих на подписку Azure
1. Войдите на [портал Azure](https://portal.azure.com/).
2. Нажмите кнопку **Обзор** и выберите **Журналы аудита**.  
...
2. Отсюда можно перейти к колонке сведения для просмотра описания события.
    ...
    Для событий с состоянием **Ошибка** эта страница обычно содержит разделы **Дополнительный статус** и **Свойства** с полезными для отладки данными.

## <a name="filter-to-specific-logs"></a>Фильтр для определенных журналов
...
## <a name="monitor-events-impacting-specific-resources"></a>Отслеживание событий, влияющих на определенные ресурсы
1. Нажмите кнопку **Обзор** для поиска интересующих вас ресурсов. Можно также просмотреть все журналы для всей **группы ресурсов**.
2. Прокрутите колонку ресурса вниз до плитки **События** .  
    ![Плитка "События"](./media/insights-debugging-with-events/Insights_EventsTile.png)
