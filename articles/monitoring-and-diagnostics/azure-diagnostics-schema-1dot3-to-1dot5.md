---
title: "Схема конфигурации системы диагностики Azure версий 1.3, 1.4 и 1.5 | Документация Майкрософт"
description: "Схемы версий 1.3, 1.4 и 1.5 для системы диагностики Azure поставляются в составе пакета SDK для Microsoft Azure."
services: multiple
