...
3. В верхней части колонки **Масштаб** на вкладке **Выполнения** находится журнал действий автомасштабирования для службы.
   ...
   > 
   > 
4. Можно вручную настроить число **экземпляров** на вкладке **Настройка**.
