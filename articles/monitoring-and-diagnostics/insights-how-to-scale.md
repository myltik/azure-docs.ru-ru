...
Масштабирование можно применять на портале, также можно использовать [REST API](https://msdn.microsoft.com/library/azure/dn931953.aspx) или [пакет SDK для .NET](http://www.nuget.org/packages/Microsoft.Azure.Management.Monitor) для изменения масштаба вручную или автоматически.
