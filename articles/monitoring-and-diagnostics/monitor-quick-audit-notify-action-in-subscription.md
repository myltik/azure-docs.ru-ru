---
title: "Аудит и получение уведомлений о важных действиях в подписке Azure | Документация Майкрософт"
...
6. В разделе **Действия** добавьте одно или несколько действий, указав **имя** для действия, а также **тип действия** (например, электронные письма или текстовые сообщения) и **сведения** для этого типа действий (например, URL-адрес веб-перехватчика, адрес электронной почты или номер для текстового сообщения).
...
> [!NOTE]
> Чтобы оповещения журнала действий стали полностью активными, может потребоваться около 10 минут. Новые события, произошедшие до полной активации оповещения журнала действий, не создают уведомления.
>
>
