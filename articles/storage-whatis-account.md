...
Подробную информацию о ценах на объем хранилища, репликацию и транзакции см. на странице [Цены на хранилище](http://www.windowsazure.com/ru-ru/pricing/details/#storage). Подробную информацию о ценах на исходящие данные см. на странице [Сведения о ценах - передача данных](http://www.windowsazure.com/ru-ru/pricing/details/data-transfers/).
...
- Дополнительную информацию о службе хранилища Azure см. в документации хранилища на следующих ресурсах: [azure.com](http://azure.microsoft.com/ru-ru/documentation/services/storage/) и [MSDN](http://msdn.microsoft.com/ru-ru/library/gg433040.aspx). 
