<properties urlDisplayName="About Azure Storage Accounts" pageTitle="Об учетных записях хранения Azure - Microsoft Azure" metaKeywords="" description="Узнайте о работе с учетными записями хранения Azure." metaCanonical="" services="storage" documentationCenter="" title="About Azure Storage Accounts" authors="tamram" solutions="" manager="adinah" />
