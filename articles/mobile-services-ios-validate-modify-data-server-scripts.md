<properties 
	pageTitle="Использование скриптов на сервере для проверки и изменения данных (iOS) | Центр разработчиков для мобильных устройств" 
	description="Узнайте, как проверять и изменять данные, отправленные с помощью серверных сценариев из приложения iOS." 
