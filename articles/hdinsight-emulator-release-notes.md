<properties linkid="hdinsight-emulator-release-notes" urlDisplayName="Заметки о выпуске: эмулятор HDInsight" pageTitle="Заметки о выпуске: эмулятор Microsoft HDInsight для Azure | Azure" metaKeywords="hdinsight, Azure hdinsight, hdinsight azure, приступая к работе с hdinsight, эмулятор, эмулятор hdinsight" description="Получите самые новые сведения о последних версиях эмулятора HDInsight." umbracoNaviHide="0" disqusComments="1" editor="cgronlun" manager="paulettm" services="hdinsight" title="Заметки о выпуске: эмулятор Microsoft HDInsight для Azure" authors="cgronlun" />
...
* Были добавлены скрипты для упрощения установки всех служб Apache Hadoop в режим автоматического или ручного запуска. По умолчанию, как и раньше, используется автоматический режим, но теперь можно изменить все службы с помощью скриптов set-onebox-manualstart.cmd или set-onebox-autostart.cmd, установленных в папку C:\Hadoop. 
...
* Эта версия содержит обновление для платформы данных Hortonworks Data Platform Developer Preview, которая соответствует Hortonworks Data Platform Preview в Azure HDInsight. 
...
* Дополнительные сведения о службе HDInsight см. по адресу http://www.windowsazure.com/ru-ru/manage/services/hdinsight.
...
## Версия 1.0.0.0, выпущенная 23.10.2012
...
* Каталог временных данных> 
	...
	hadoop.tmp.dir указывает на неправильное место: вместо C:\hadoop\hdfs он указывает на c:\hdfs. Эта ошибка будет исправлена в следующем обновлении битов HDP. 
