...
В этом руководстве показано, как реализовать типичные сценарии с использованием службы таблиц Windows Azure. Примеры написаны с помощью Node.jsAPI. Здесь описаны такие сценарии, как **создание и удаление таблицы, вставка и запрос сущностей в таблице**. Дополнительные сведения о таблицах см. в разделе [Дальнейшие действия][Дальнейшие действия].
...
-   [Практическое руководство. Извлечение сущности][Практическое руководство. Извлечение сущности]
...
**PartitionKey** и **RowKey** должны быть строковыми значениями. Дополнительную информацию см. в разделе [Общие сведения о модели данных службы таблиц][Общие сведения о модели данных службы таблиц].
...
Если операция успешна, `result` будет содержать [ETag][ETag] вставленной записи, а `response` — сведения об операции.
