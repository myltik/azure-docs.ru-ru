...
| location | Нет | Поддерживаемые географические расположения указанного ресурса. Сведения о том, как определить доступные расположения, см. в разделе [Поддерживаемые регионы](../resource-manager-supported-services/#supported-regions).
