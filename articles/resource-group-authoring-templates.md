...
- **parameters(parameterName)**.
    ...
    Возвращает значение параметра, которое указывается при выполнении развертывания.

- **variables(variableName)**.

    Возвращает определенную в шаблоне переменную.

- **concat(arg1,arg2,arg3,...)**.

    Объединяет несколько строковых значений. Эта функция может принимать любое количество аргументов.
...
- **resourceGroup()**
    ...
    Возвращает структурированный объект (с ИД, именем и свойствами расположения), представляющий текущую группу ресурсов.

- **resourceId([resourceGroupName], resourceType, resourceName1, [resourceName2]...)**.

    Возвращает уникальный идентификатор ресурса. Может использоваться для извлечения ресурса из другой группы ресурсов.
...
Теперь вам достаточно известно о выражениях и функциях для понимания разделов шаблона. Дополнительную информацию обо всех функциях шаблонов, в том числе параметрах и формате возвращаемых значений, см. в разделе [Функции шаблонов в диспетчере ресурсов Azure](./resource-group-template-functions.md).
...
| Имя элемента | Обязательно | Описание
| :----------------------: | :------: | :----------
| версия\_API | Да | Версия интерфейса API, которая поддерживает ресурс. Доступные версии и схемы для ресурсов см. в статье [Схемы диспетчера ресурсов Azure](https://github.com/Azure/azure-resource-manager-schemas).
...
Возможно, понадобится объединить два шаблона или использовать дочерний шаблон внутри родительского. Дополнительную информацию см. в статье [Использование связанных шаблонов в диспетчере ресурсов Azure](resource-group-linked-templates.md).

Инструкции по выполнению заданного количества циклов итерации при создании типа ресурса см. в статье [Создание нескольких экземпляров ресурса в диспетчере ресурсов Azure](resource-group-create-multiple.md).
