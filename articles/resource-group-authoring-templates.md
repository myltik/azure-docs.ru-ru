...
| ресурсов | Нет | Дочерние ресурсы, которые зависят от определяемого ресурса. Можно указать только те типы ресурсов, которые разрешены для использования в схеме родительского ресурса. Полное имя типа дочернего ресурса содержит тип родительского ресурса, например **Microsoft.Web/sites/extensions**.
