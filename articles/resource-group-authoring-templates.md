...
| Имя элемента | Обязательно | Описание
| :----------------------: | :------: | :----------
| версия\_API | Да | Версия интерфейса API, которая поддерживает ресурс. С доступными версиями и схемами для ресурсов можно ознакомиться в статье [Схемы диспетчера ресурсов Azure](https://github.com/Azure/azure-resource-manager-schemas).
