...
* [Приступая к работе с проверкой подлинности](partner-xamarin-mobile-services-android-get-started-users.md) <br/>Узнайте, как проверить подлинность пользователей приложения с разными типами учетных записей при помощи мобильных служб.
...
<!-- URLs. -->
[Приступая к работе с мобильными службами]: partner-xamarin-mobile-services-ios-get-started.md
[Добавление мобильных служб в существующее приложение]: partner-xamarin-mobile-services-android-get-started-data.md
