...
description: Примеры Azure CLI для службы "Сетка событий"
services: event-grid
author: tfitzmac
manager: timlt
...
| [Создание пользовательского раздела](scripts/event-grid-cli-create-custom-topic.md) | Создание управляемого диска из специализированного VHD в качестве диска ОС или из VHD данных в качестве диска данных.  |
| | |
