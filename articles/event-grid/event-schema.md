...
События отправляются в службу "Сетка событий Azure" в массиве, который может содержать несколько объектов событий. Если отправляется только одно событие, длина массива составляет 1. 
...
* См. дополнительные сведения о [схеме подписки службы "Сетка событий Azure"](subscription-creation-schema.md).
