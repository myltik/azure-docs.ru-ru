...
Примеры назначения ролей см. в статье [Управление доступом к ресурсам](resource-group-rbac.md).
...
- Сведения о развертывании созданных шаблонов см. в статье [Развертывание шаблонов](resource-group-template-deploy.md).
- Сведения об используемых в шаблоне функциях см. в статье [Функции шаблонов](./resource-group-template-functions.md).
