...
Вы добавите эту функцию в приложение, созданное при изучении учебника [Добавление мобильных служб к существующему приложению](mobile-services-dotnet-backend-windows-phone-get-started-data.md) . Для этого выполните следующие шаги:
