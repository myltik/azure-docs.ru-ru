...
Некоторые функции нельзя правильно протестировать с помощью упомянутых ранее средств. Например, функцию триггера очереди, которая выполняется при поступлении сообщения в [хранилище очередей Azure](../storage/storage-dotnet-how-to-use-queues.md). Всегда можно написать код, помещающий сообщение в очередь, пример которого указан в консольном проекте далее в этой статье. Однако существует другой подход, который можно использовать для непосредственного тестирования функций.  
