...
# <a name="tips-for-improving-the-performance-and-reliability-of-azure-functions"></a>Советы для улучшения производительности и надежности Функций Azure

##<a name="overview"></a>Обзор

В этой статье представлен набор рекомендаций, которые необходимо учитывать при реализации приложений-функций. Имейте в виду, что ваше приложение-функция — это приложение в службе приложений Azure. Поэтому к нему также применяются рекомендации службы приложений.
...
* [Шаблоны и методики оптимизации производительности HTTP](https://github.com/mspnp/performance-optimization/blob/master/ImproperInstantiation/docs/ImproperInstantiation.md)
