...
1. На портале Azure откройте страницу приложения-функции для приложения, созданного [ранее](functions-create-first-azure-function.md). Для этого выберите **Дополнительные службы > Приложения-функции**, а затем выберите приложение-функцию.
