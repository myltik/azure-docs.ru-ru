...
> - Используйте другой механизм для активации обработки большого двоичного объекта, например подписку сетки событий или сообщение очереди, содержащее имя большого двоичного объекта. С примерами входных привязок больших двоичных объектов вы можете ознакомитсья в [этой статье](functions-bindings-storage-blob.md#input---example).
