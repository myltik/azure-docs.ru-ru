...
Функции оркестратора при модульном тестировании даже более интересны, так как в них обычно гораздо больше бизнес-логики. В настоящее время функции оркестратора можно реализовать только на C#.
