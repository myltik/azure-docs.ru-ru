...
`"backendurl": "localhost/api/httptriggerC#1"` будет ссылаться на локальную функцию, активируемую HTTP, на маршруте `/api/httptriggerC#1`.
