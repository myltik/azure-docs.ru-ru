---
title: "Триггеры и привязки для службы хранилища Azure в Функциях Azure | Документация Майкрософт"
...
---
# <a name="azure-functions-triggers-and-bindings-for-azure-storage"></a>Триггеры и привязки для службы хранилища Azure в функциях Azure
...
## <a name="a-idstoragequeuetriggera-azure-storage-queue-trigger"></a><a id="storagequeuetrigger"></a> Триггер очереди службы хранилища Azure
#### <a name="functionjson-for-storage-queue-trigger"></a>Файл function.json для триггера очереди службы хранилища
...
#### <a name="queue-trigger-supported-types"></a>Поддерживаемые типы триггеров очереди
...
## <a name="a-idstoragequeueoutputa-azure-storage-queue-output-binding"></a><a id="storagequeueoutput"></a> Выходная привязка очереди службы хранилища Azure
#### <a name="functionjson-for-storage-queue-output-binding"></a>Файл function.json для выходной привязки очереди службы хранилища
Файл *function.json* определяет следующие свойства:
...
#### <a name="queue-output-binding-supported-types"></a>Поддерживаемые типы выходных привязок очереди
...
#### <a name="queue-output-binding-code-examples"></a>Пример кода выходной привязки очереди
...
## <a name="a-idstorageblobtriggera-azure-storage-blob-trigger"></a><a id="storageblobtrigger"></a> Триггер BLOB-объекта службы хранилища Azure
#### <a name="functionjson-for-storage-blob-trigger"></a>Файл function.json для триггера BLOB-объекта службы хранилища
Файл *function.json* определяет следующие свойства:
...
#### <a name="blob-trigger-supported-types"></a>Поддерживаемые типы триггеров больших двоичных объектов
...
#### <a name="blob-trigger-c-code-example"></a>Пример кода C# триггера большого двоичного объекта
...
#### <a name="blob-trigger-name-patterns"></a>Шаблоны имен триггеров больших двоичных объектов
...
Типы больших двоичных объектов, которые активируют функции, можно ограничить, указав шаблон с фиксированным значением расширения файла. Если задать для свойства `path` значение *samples/{имя}.png*, функция будет активирована только для больших двоичных объектов с расширением *PNG* в контейнере *samples*.
...
* функция, вызванная для большого двоичного объекта (*{имя_приложения-функции}*.Functions.*{имя_функции}*, например: functionsf74b96f7.Functions.CopyBlob);
* имя контейнера;
...
## <a name="a-idstorageblobbindingsa-azure-storage-blob-input-and-output-bindings"></a><a id="storageblobbindings"></a> Входные и выходные привязки для BLOB-объектов службы хранилища Azure
#### <a name="functionjson-for-a-storage-blob-input-or-output-binding"></a>Файл function.json для входной и выходной привязки для BLOB-объектов службы хранилища
Файл *function.json* определяет следующие свойства:
...
#### <a name="blob-input-and-output-supported-types"></a>Поддерживаемые типы входных и выходных привязок больших двоичных объектов
...
#### <a name="blob-output-c-code-example"></a>Пример кода C# с выходными данными большого двоичного объекта
...
## <a name="a-idstoragetablesbindingsa-azure-storage-tables-input-and-output-bindings"></a><a id="storagetablesbindings"></a> Входные и выходные привязки для таблиц службы хранилища Azure
#### <a name="functionjson-for-storage-tables"></a>Файл function.json для таблиц службы хранилища
...
#### <a name="storage-tables-input-and-output-supported-types"></a>Поддерживаемые типы входных и выходных таблиц службы хранилища
...
#### <a name="storage-tables-binding-scenarios"></a>Сценарии привязки таблиц службы хранилища
...
#### <a name="storage-tables-example-read-a-single-table-entity-in-c-or-node"></a>Пример таблиц службы хранилища: чтение одной сущности таблицы в коде C# или Node
...
#### <a name="storage-tables-example-read-multiple-table-entities-in-c"></a>Пример таблиц службы хранилища: чтение нескольких сущностей таблицы на языке C
...
#### <a name="storage-tables-example-create-table-entities-in-c"></a>Пример таблиц службы хранилища: создание сущностей таблицы на языке C
...
#### <a name="storage-tables-example-create-table-entities-in-f"></a>Пример таблиц службы хранилища: создание сущностей таблицы на языке F
...
#### <a name="storage-tables-example-create-a-table-entity-in-node"></a>Пример таблиц службы хранилища: создание сущности таблицы на платформе Node
