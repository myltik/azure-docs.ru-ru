...
Выполнение функций в Azure происходит с помощью приложения функций. Ниже описано, как можно создать приложение функций, а также функцию. Новое приложение-функцию создается с использованием конфигурации по умолчанию. Пример того, как можно явно создать приложение-функцию, см. в [этом руководстве по функциям Azure](functions-create-first-azure-function-azure-portal.md).
