...
---
# <a name="use-azure-functions-to-create-a-function-that-connects-to-other-azure-services"></a>Создание функции, которая подключается к другим службам Azure, с помощью службы функций Azure
