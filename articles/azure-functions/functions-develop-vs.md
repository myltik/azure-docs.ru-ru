...
2. В вашем проекте откройте файл local.settings.json и задать значение **AzureWebJobsStorage** ключа в строку подключения вы скопировали.
