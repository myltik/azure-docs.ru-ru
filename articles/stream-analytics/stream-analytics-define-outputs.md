<properties
	pageTitle="Результаты преобразования данных: параметры хранилища и анализа | Microsoft Azure"
	description="Узнайте больше о параметрах направления результатов преобразования данных Stream Analytics в хранилище данных. Также для анализа результатов используйте Power BI."
...
# Параметры направления результатов преобразования данных Stream Analytics в средства анализа и хранилище данных

Создавая задание Stream Analytics, необходимо учитывать, каким образом будут использоваться результаты преобразования данных. Каким образом вы будете просматривать результаты задания Stream Analytics? Какие средства вы будете использовать для отображения результатов анализа данных? Является ли обязательным параметр хранилища данных?
...
> [AZURE.NOTE]В настоящий момент создание и настройка выходных данных Power BI не поддерживаются на портале предварительной версии Azure.
