---
title: Использование параллелизации запросов в Azure Stream Analytics | Документация Майкрософт
...
Выходные данные PowerBI, SQL и хранилища данных SQL не поддерживают секционирование. Однако можно по-прежнему секционировать входные данные как описано в [этом разделе](#multi-step-query-with-a-grouping-key). 
