...
* Установите Visual Studio 2017, Visual Studio 2015, Visual Studio 2013 с обновлением 4. Поддерживаются выпуски Enterprise (Ultimate/Premium), Professional и Community. Выпуск Express не поддерживается. 
* Следуйте [инструкциям по установке](https://docs.microsoft.com/en-us/azure/stream-analytics/stream-analytics-tools-for-visual-studio-install), чтобы установить инструменты Stream Analytics для Visual Studio.
...
5.  В раскрывающемся списке пространства имен служебной шины выберите **TollData**.
...
1. Щелкните правой кнопкой мыши узел задания в узле **Задания Stream Analytics** в **обозревателе сервера**. В контекстном меню выберите **Export to New Stream Analytics Project** (Экспортировать в новый проект Stream Analytics).
   ...
   Созданный проект находится в **обозревателе решений**.
