...
6. Ключевой столбец секции — необязательный параметр для выходных данных концентратора событий. Столбец атрибутов данных, который используется в качестве ключа секции для выходных данных концентратора событий. 
