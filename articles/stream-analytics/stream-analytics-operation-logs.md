...
# Основные сведения о журналах операций Stream Analytics
...
## Поиск журналов операций на классическом портале Azure
...
На классическом портале Azure нажмите кнопку **Сведения** в нижней части окна, чтобы увидеть дополнительные сведения о выбранном событии.
...
На классическом портале Azure нажмите значок поиска и введите «failed». Это позволит получить все журналы с ошибками.
