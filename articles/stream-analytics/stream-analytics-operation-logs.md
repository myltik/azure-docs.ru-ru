...
## <a name="find-operation-logs-in-the-azure-portal"></a>Поиск журналов операций на портале Azure
...
1. На [классическом портале Azure](https://manage.windowsazure.com) щелкните **Службы управления**.
...
Откроется экран с событиями за последние семь дней для всех ресурсов в подписке.  Вы можете применить фильтр, чтобы просмотреть события определенного типа или за указанный временной интервал, выбрав команду **Фильтр** .
...
На портале Azure нажмите кнопку **Сведения** в нижней части окна, чтобы увидеть дополнительные сведения о выбранном событии. 
...
Здесь вы можете открыть экран **Сведения**, щелкнув событие.
...
На портале Azure нажмите значок поиска и введите "failed". Это позволит получить все журналы с ошибками. 
