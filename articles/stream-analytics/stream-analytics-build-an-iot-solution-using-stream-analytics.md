...
-   Скачать последний выпуск TollApp.zip с сайта [GitHub](https://github.com/streamanalytics/samples/releases)
...
Теперь вы можете увидеть все созданные ресурсы на портале управления Azure. Перейдите к <https://manage.windowsazure.com> и войдите с использованием своей учетной записи.
...
Однако если вас интересуют подробности реализации, вы можете найти исходный код приложения TollApp на сайт GitHub в разделе [samples/TollApp](https://github.com/streamanalytics/samples/tree/master/TollApp).
...
Введите "tolladmin" в качестве имени пользователя и "123toll!" в качестве пароля. Задайте "TollDataRefJoin" в качестве имени таблицы.
