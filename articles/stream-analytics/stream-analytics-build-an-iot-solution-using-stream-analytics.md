...
-   Необязательно: исходный код генератора событий TollApp из [GitHub](https://aka.ms/azure-stream-analytics-toll-source).
...
Обратите внимание, что если у вас есть доступ к нескольким подпискам, то вам будет предложено ввести имя подписки, которая будет использоваться для работы с заданиями учебника.
...
Однако если вас интересуют подробности реализации, то вы можете найти исходный код приложения TollApp на сайте GitHub в разделе [samples/TollApp](https://aka.ms/azure-stream-analytics-toll-source).
