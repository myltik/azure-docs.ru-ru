...
## <a name="configuring-streaming-units"></a>Настройка единиц потоковой передачи
...
## <a name="embarrassingly-parallel-job"></a>Задание с усложненным параллелизмом
...
### <a name="query-with-grouping-key"></a>Запрос с ключом группирования
...
### <a name="multi-step-query-with-grouping-key"></a>Многоэтапный запрос с ключом группирования
...
### <a name="mismatched-partition-count"></a>Несоответствие в числе разделов
...
### <a name="not-using-event-hubs-or-blobs-as-output"></a>Для выходных данных не используются концентраторы событий или BLOB-объекты
...
> [!NOTE]
> Этот образец запроса будет описан далее в этой статье.
> 
> 
...
### <a name="examples-of-scale"></a>Примеры масштабирования
...
> [!NOTE]
> При объединении двух потоков убедитесь, что потоки разделены с помощью ключа раздела для объединяемого столбца и количество разделов в обоих потоках одинаковое.
> 
> 

## <a name="configure-stream-analytics-job-partition"></a>Настройка раздела задания Stream Analytics
...
## <a name="stream-analytics-throughput-at-scale---raspberry-pi-scenario"></a>Масштабирование пропускной способности службы Stream Analytics — сценарий для компьютера Raspberry Pi
