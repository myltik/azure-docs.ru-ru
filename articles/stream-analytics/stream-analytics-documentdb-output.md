...
[Секционированные коллекции](../documentdb/documentdb-partition-data.md#single-partition-and-partitioned-collections) Cosmos DB являются рекомендуемым способом секционирования данных. 
