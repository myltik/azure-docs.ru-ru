...
1.  На портале управления Azure перейдите к расширению "Хранилище": ![рисунок1][graphic1]
...
###Концентраторы событий
1.  На портале управления Azure перейдите к расширению Service Bus: ![рисунок6][graphic6]
...
1.  На портале управления Azure перейдите к расширению "Базы данных SQL": ![рисунок14][graphic14]
...
5.  Введите свои имя пользователя и пароль и нажмите кнопку "Вход": ![рисунок18][graphic18]
...
11. Введите свои имя пользователя и пароль и нажмите кнопку "Вход": ![рисунок23][graphic23]
...
1.  На портале управления Azure перейдите к расширению Stream Analytics: ![рисунок26][graphic26]
