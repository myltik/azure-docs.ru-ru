---
title: Настройка конечных точек машинного обучения Azure в Stream Analytics | Microsoft Docs
...
## <a name="machine-learning-resources-that-needed-for-stream-analytics-jobs"></a>Ресурсы машинного обучения, необходимые для заданий Stream Analytics
