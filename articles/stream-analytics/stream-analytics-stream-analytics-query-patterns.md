...
**Описание**: определите типы свойств для входного потока. Например, вес автомобиля поступает по входному потоку как строка и должен быть преобразован в тип INT для выполнения операции SUM.
...
**Описание**: убедитесь, что в потоке отсутствует значение, соответствующее определенным условиям. Например, два автомобиля одной и той же марки подряд въезжают на платную дорогу в течение 90 секунд.
