...
**Описание**: подсчитайте число уникальных значений поля, отображаемое в потоке в окне времени. Например, сколько уникальных марок автомобилей проехали через пропускной пункт за окно в 2 секунды?
...
**Описание**: поиск нового автомобиля каждые 10 минут?

**Входные данные**

| Номерной знак | Убедитесь, | Время |
| --- | --- | --- |
