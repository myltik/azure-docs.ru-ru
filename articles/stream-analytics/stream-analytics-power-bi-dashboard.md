...
* Идентификатор организации Microsoft Power BI
...
4.  На этом шаге укажите идентификатор Ord для выходных данных задания Stream Analytics. При наличии учетной записи Power BI выберите **Авторизовать сейчас**. Если это не так, выберите **Зарегистрироваться сейчас**. [Вот хороший блог, в котором подробно описываются этапы регистрации в Power BI](http://blogs.technet.com/b/powerbisupport/archive/2015/02/06/power-bi-sign-up-walkthrough.aspx).
