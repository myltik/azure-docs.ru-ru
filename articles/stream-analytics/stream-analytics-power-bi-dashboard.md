...
> [AZURE.NOTE] В настоящий момент создание и настройка выходных данных Power BI не поддерживаются на портале Azure. Это можно сделать только на классическом портале Azure.
