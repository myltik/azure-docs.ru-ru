...
> [AZURE.NOTE]Вывод выходных данных в Power BI — это функция предварительной версии Azure Stream Analytics. В настоящий момент создание и настройка выходных данных Power BI не поддерживаются на портале Azure.
