---
title: Панель мониторинга Power BI в Stream Analytics | Microsoft Docs
...
> [!NOTE]
> Не следует напрямую создавать этот набор данных и таблицу в вашей учетной записи Power BI. Они будут автоматически созданы при запуске задания в Stream Analytics, когда задание начнет вносить выходные данные в Power BI. Если запрос задания не возвращает никаких результатов, набор данных и таблица не будут созданы.
> 
> 
