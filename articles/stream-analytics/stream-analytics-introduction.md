...
Ниже представлены примеры сценариев Stream Analytics.
...
На следующей схеме изображен конвейер Stream Analytics по принятию, анализу и отправке данных для предоставления или выполнения действий. 
