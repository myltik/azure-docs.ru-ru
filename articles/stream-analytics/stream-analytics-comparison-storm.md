<properties
	pageTitle="Платформы аналитики: сравнение Apache Storm и Stream Analytics | Microsoft Azure"
	description="Рекомендации по выбору облачной платформы аналитики: сравнение Apache Storm и Stream Analytics Возможности и отличия."
...
# Помощь в выборе платформы потоковой аналитики: сравнение Apache Storm и Azure Stream Analytics

Рекомендации по выбору облачной платформы аналитики: сравнение Apache Storm и Azure Stream Analytics Узнайте об основных преимуществах Stream Analytics по сравнению с Apache Storm, управляемой службой в Azure HDInsight, и выберите решение, максимально отвечающее вашим задачам.
...
## Сравнение Storm и Stream Analytics: общие характеристики ##
...
## Работа в каждой платформе аналитики ##
<table border="1" cellspacing="0" cellpadding="0">
    <tbody>
        <tr>
            <td width="174" valign="top">
