...
1.  Войдите на [классический портал Microsoft Azure](http://manage.windowsazure.com) или портал Azure.
2.  На классическом портале Azure **нажмите «Создать»** и последовательно выберите пункты **Службы данных**, **Stream Analytics** и **Быстрое создание**.

    ![Мастер быстрого создания](./media/stream-analytics-create-a-job/1-stream-analytics-create-a-job.png)

    На портале Azure нажмите «Создать», затем выберите «Данные+аналитика», а затем — Azure Stream Analytics.

    ![Создание задания на классическом портале Azure](./media/stream-analytics-create-a-job/4-stream-analytics-create-a-job.png)
...
3.  Укажите требуемую конфигурацию для задания Stream Analytics.
	...
	- С помощью поля **Регион** на классическом портале Azure или поля **Расположение** на портале Azure можно указать географическое расположение для запуска задания.
	- Если вы используете классический портал Azure, выберите или создайте учетную запись хранения в качестве **учетной записи хранения регионального мониторинга**. Она будет использоваться для хранения данных мониторинга для всех заданий Stream Analytics, выполняемых в этом регионе.
...
4.  Настроив параметры нового задания Stream Analytics, нажмите **Создать задание Stream Analytics**. Задание Stream Analytics будет создано в течение нескольких минут. Для контроля состояния можно отслеживать ход выполнения в концентраторе уведомлений.
    ...
    ![Создание задания на портале Azure](./media/stream-analytics-create-a-job/5-stream-analytics-create-a-job.png)
...
5.  Новое задание будет отображаться с состоянием **Создано**. Обратите внимание, что кнопка **Запуск** неактивна. Перед запуском задания необходимо настроить для него источник данных, запрос и выходные данные.
    ...
    ![Состояние задания на портале Azure](./media/stream-analytics-create-a-job/6-stream-analytics-create-a-job.png)
