...
> Обратите внимание, что мы не рекомендуем использовать 1 единицу потоковой передачи для производственных заданий. Обычно мы советуем использовать задания с 1 единицей потоковой передачи только для создания прототипов и тестирования.
...
Разделы концентратора событий должны быть разделены с помощью ключа группирования, чтобы вам не нужно было выполнять шаг по уменьшению. Дополнительная информация описана [здесь](https://docs.microsoft.com/en-us/azure/event-hubs/event-hubs-overview). 
