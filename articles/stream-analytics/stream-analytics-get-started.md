...
2.	В появившемся диалоговом окне укажите **время начала** сбора данных и **длительность** получения дополнительных данных.
3.	Нажмите кнопку "Проверить", чтобы запустить данные выборки из входных данных. Создание файла может занять пару минут. Когда процесс завершится, щелкните **Сведения**, а затем загрузите и сохраните созданный JSON-файл.
