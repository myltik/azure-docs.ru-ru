...
У поставщика телекоммуникационных услуг есть большой объем данных для входящих вызовов. Потребности компании относительно данных: 
* сокращение объема данных для упрощения управления ими, а также анализ информации по использованию клиентом услуг по времени и географическим регионам; 
* выявление мошенничества в отношении SIM-карт (когда один пользователь одновременно выполняет несколько вызовов из разных географических расположений) в режиме реального времени, чтобы с легкостью реагировать на угрозы путем уведомления клиентов или завершения работы службы.
