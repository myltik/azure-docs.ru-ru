...
У поставщика телекоммуникационных услуг есть большой объем данных для входящих вызовов. Потребности компании касательно данных: * сокращение объема данных для упрощения управления ими, а также анализ информации по использованию клиентом услуг по времени и географическим регионам; * выявление мошенничества в отношении SIM-карт (когда один пользователь одновременно выполняет несколько вызовов из разных географических расположений) в режиме реального времени, чтобы с легкостью реагировать на угрозы путем уведомления клиентов или завершения работы службы.
...
Чтобы просматривать события, связанные с мошенническими действиями, во время их записи в выходные данные в режиме реального времени, воспользуйтесь такими инструментами, как [обозреватель хранилищ Azure](https://azurestorageexplorer.codeplex.com/) или [обозреватель Azure](http://www.cerebrata.com/products/azure-explorer/introduction).

![Выявление мошенничества. Связанные с мошенническими действиями события, просмотренные в режиме реального времени](./media/stream-analytics-get-started/stream-ananlytics-view-real-time-fraudent-events.png)
