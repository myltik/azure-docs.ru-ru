...
На странице мониторинга содержатся ключевые метрики производительности, которые используются для мониторинга заданий и устранения возможных неполадок. Эти метрики можно просмотреть на вкладке «Монитор» текущего задания Stream Analytics. На странице «Монитор» метрики производительности отображаются с задержкой (не более одной минуты).
...
На диаграмме можно отобразить не более 6 метрик.
...
Состояние заданий Stream Analytics можно проверить в списке заданий на портале Azure. Вы увидите список заданий, щелкнув значок Stream Analytics на портале Azure.
...
На панели мониторинга отображаются сведения о том, где искать диагностические сведения — во входящих или исходящих данных либо в журнале операций. Щелкнув ссылку, вы перейдете в соответствующее расположение для просмотра диагностических сведений.
