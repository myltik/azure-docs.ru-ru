...
Интеграция портала предварительной версии Azure | Помимо постоянного присутствия на портале управления Azure, служба Stream Analytics теперь интегрирована в [портал предварительной версии Azure](https://azure.microsoft.com/overview/preview-portal/). Обратите внимание, что функции Stream Analytics на портале предварительной версии в настоящий момент являются подмножеством функций портала управления Azure без поддержки тестирования запросов в браузере, настройки выходных данных Power BI и перехода ко входным и выходным ресурсам в доступных вам подписках, а также создания новых.
