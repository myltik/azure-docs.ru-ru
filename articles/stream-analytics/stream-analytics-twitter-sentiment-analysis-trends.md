...
Инструменты аналитики для социальных сетей помогают организациям определить популярные темы, то есть темы и отношения с большим объемом записей в социальных сетях. Чтобы определить отношение к продукции, идеям и т. д., анализ тональности, также называемый «интеллектуальный анализ мнений», использует инструменты аналитики для социальных сетей. Хороший пример — анализ тенденций Twitter в режиме реального времени, поскольку модель подписки с использованием хэштегов позволяет прослушивать определенные ключевые слова и разрабатывать анализ тональности канала.
