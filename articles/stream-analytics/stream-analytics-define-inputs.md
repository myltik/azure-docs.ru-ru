...
| Свойство | Описание |
|------------------------------|--------------------------------------------------------------------|
| System.EventProcessedUtcTime | Дата и время обработки события службой Stream Analytics. |
| System.EventEnqueuedUtcTime | Дата и время получения события концентраторами событий. |
| System.PartitionId | Идентификатор раздела для входного адаптера (нумерация идет от нуля) |
...
| Свойство | Описание |
|--------------------------------|--------------------------------------------------------------------|
| System.BlobName | Имя входного большого двоичного объекта, от которого поступило событие. |
| System.EventProcessedUtcTime | Дата и время обработки события службой Stream Analytics. |
| System.BlobLastModifiedUtcTime | Дата и время последнего изменения большого двоичного объекта |
| System.PartitionId | Идентификатор раздела для входного адаптера (нумерация идет от нуля) |
