...
1. Скачайте [файл TelcoGenerator.zip](http://download.microsoft.com/download/8/B/D/8BD50991-8D54-4F59-AB83-3354B69C8A7E/TelcoGenerator.zip) и распакуйте его в каталог.
   ...
   > [!NOTE]
   > Windows может заблокировать загруженный ZIP-файл. Щелкните правой кнопкой мыши файл и выберите **Свойства**. Если появляется сообщение "Этот файл получен с другого компьютера и, возможно, был заблокирован с целью защиты компьютера", установите флажок **Разблокировать** и нажмите кнопку "Применить".
   >
   > 
