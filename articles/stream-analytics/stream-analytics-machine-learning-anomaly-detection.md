...
2. **Медленная положительная тенденция.** Линия тенденции вычисляется на основе значений в окне журнала, что позволяет просмотреть положительную тенденцию. Значение странности вычисляется как:  

   - slope, если наклон положительный;  
   - в противном случае 0. 

1. **Медленная отрицательная тенденция.** Линия тенденции вычисляется на основе значений в окне журнала, что позволяет просмотреть отрицательную тенденцию. Значение странности вычисляется как: 
...
вероятность [существует такое значение t, при котором M<sub>t</sub> > λ ] < 1/λ, где M<sub>t</sub> — значение мартингала на момент времени t, а λ — действительное значение. Например, если при получении предупреждения M<sub>t</sub> > 100, вероятность ложных срабатываний менее 1/100.  
