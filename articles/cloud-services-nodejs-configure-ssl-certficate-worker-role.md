<properties urlDisplayName="Enable SSL worker role" pageTitle="Настройка SSL для рабочей роли облачной службы (Node.js)" metaKeywords="Node.js Azure SSL, Node.js Azure, SSL worker role" description="" metaCanonical="" services="cloud-services" documentationCenter="nodejs" title="Настройка SSL для приложения Node.js в рабочей роли Azure" authors="larryfr" solutions="" manager="wpickett" editor="" />
...
безопасности данных, отправляемых через Интернет. В этой теме, посвященной общим
...
Чтобы создать простую службу Node.js "hello world" с помощью оболочки Azure PowerShell, выполните следующие действия.
...
2.  Обновите измененную конфигурацию в облаке, выполнив
    повторную публикацию службы. В командной строке Azure PowerShell перейдите в каталог службы и введите **Publish-AzureServiceProject**.
