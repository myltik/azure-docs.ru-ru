...
4.	*Необязательно:* измените ключевые слова для поиска. По умолчанию это приложение выполняет поиск по ключевым словам «Azure,Skype,XBox,Microsoft,Seattle». При необходимости можно настроить значения для twitter\_keywords в файле App.config.
