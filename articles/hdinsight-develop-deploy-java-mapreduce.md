...
## <a name="develop"></a>Использование Apache Maven при создании на языке Java программы MapReduce
...
3.  Используйте команду **mvn**, которая будет установлена вместе с Maven, для создания шаблона проекта.
    ...
    -   **src** — каталог, содержащий каталог **main\\java\\org\\apache\\hadoop\\examples**, в котором будет создаваться приложение.
...
4.  Извлечение результатов выполнения задания
...
## <span id="upload"></span></a>Передача данных и приложений в хранилище BLOB-объектов Azure
