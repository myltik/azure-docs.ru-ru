<properties pageTitle="Как использовать VMAccess для виртуальных машин Linux" description="Как использовать расширение VMAccess для сброса паролей, ключей SSH и конфигурации SSH в виртуальных машинах Linux" services="virtual-machines" documentationCenter="" authors="KBDAzure" manager="timlt" editor=""/>
...
[Расширения и компоненты виртуальных машин Azure]: http://msdn.microsoft.com/ru-ru/library/azure/dn606311.aspx
[Подключение к виртуальной машине Azure с помощью RDP или SSH]: http://msdn.microsoft.com/ru-ru/library/azure/dn535788.aspx
