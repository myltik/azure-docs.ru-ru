<properties pageTitle="Выполнение ресурсоемкого приложения Java на виртуальной машине - Azure" description="Узнайте, как создать виртуальную машину Azure для выполнения ресурсоемкого приложения Java, за работой которого может следить другое приложение Java." services="virtual-machines" documentationCenter="java" authors="rmcmurray" manager="wpickett" editor="mollybos"/>
