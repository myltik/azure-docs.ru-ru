<properties urlDisplayName="How to Make a Phone Call from Twilio in Java" pageTitle="Осуществление телефонных звонков из Twilio (Java) - Azure" metaKeywords="вызов Azure Twilio, веб-сайт вызова Twilio, Azure Twilio Java" description="Learn how to make a phone call from a web page using Twilio in a Java application on Azure." metaCanonical="" services="" documentationCenter="Java" title="How to Make a Phone Call Using Twilio in a Java Application on Azure" authors="MicrosoftHelp@twilio.com; robmcm" videoId="" scriptId="" solutions="" manager="twilio" editor="mollybos" />
...
2. Измените **startup.cmd**, чтобы распаковать TwilioCloud WAR.
...
Завершив подготовку к развертыванию в Azure, выполните повторную компиляцию для развертывания в облаке, далее выполните развертывание в Azure и запустите http://*имя_размещенного _приложения.cloudapp.net/TwilioCloud/callform.jsp в браузере (замените атрибут имя_размещенного _приложения на нужное значение).
