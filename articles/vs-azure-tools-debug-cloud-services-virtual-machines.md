...
1. Откройте пользовательский интерфейс эмулятора вычислений. Для этого в области уведомлений правой кнопкой мыши щелкните значок Azure и выберите пункт **Показать пользовательский интерфейс эмулятора вычислений**.
...
1. Откройте контекстное меню роли или экземпляра роли, к которому требуется присоединить отладчик, и нажмите кнопку **Присоединить отладчик**.
...
1. Откройте контекстное меню и выберите пункт **Включить отладку**. Когда появится просьба подтвердить включение отладки на виртуальной машине, нажмите кнопку **Да**.
...
1. Когда проект опубликуется, в обозревателе сервера в контекстном меню виртуальной машины щелкните **Присоединить отладчик**.
