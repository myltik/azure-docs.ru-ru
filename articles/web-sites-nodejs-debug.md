<properties linkid="dev-nodejs-how-to-debug-website" urlDisplayName="Отладка веб-сайтов (Node)" pageTitle="Отладка веб-сайтов Azure в Node.js" metaKeywords="отладка веб-сайта azure, отладка azure, устранение неполадок веб-сайт azure, устранение неполадок веб-сайт azure node" description="Узнайте, как выполнять отладку веб-сайта Azure в Node.js." metaCanonical="" services="web-sites" documentationCenter="Node.js" title="Отладка приложения Node.js на веб-сайтах Azure" authors="larryfr" solutions="" manager="paulettm" editor="mollybos" />





#Отладка приложения Node.js для веб-сайтов Azure

Azure предоставляет встроенные средства диагностики, которые помогают отлаживать приложения Node.js, размещенные на веб-сайтах Azure. В этой статье вы узнаете, как включить ведение журналов stdout и stderr, отображать сведения об ошибке в браузере, а также загружать и просматривать файлы журнала.
...
Если в среде разработки установлены средства командной строки Azure, чтобы перезапустить веб-сайт, можно воспользоваться следующей командой:
...
[Использование средств командной строки Azure]: https://www.windowsazure.com/ru-ru/develop/nodejs/how-to-guides/command-line-tools/
[Использование модулей Node.js с приложениями Azure]: https://www.windowsazure.com/ru-ru/develop/nodejs/common-tasks/working-with-node-modules/
[Установка версии Node.js в приложении Azure]: https://www.windowsazure.com/ru-ru/develop/nodejs/common-tasks/specifying-a-node-version/
