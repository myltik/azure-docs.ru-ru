...
> [AZURE.NOTE]Также можно расширить это решение. Например, если необходимо обновить только одну таблицу, достаточно будет просто отфильтровать таблицу #stats_ddl.
