<properties 
	pageTitle="Рекомендации по машинному обучению Azure — интеграция JavaScript" 
...
- itemDescription (строковый, обязательный) — описание элемента; 
- itemCategory (строковый, необязательный) — категория элемента;
...
* items (приобретено[]) — массив, содержащий запись по каждому приобретенному элементу.<br><br> Формат приобретения: 
...
* Функция обработки — функция, при помощи которой будут обработаны возвращенные рекомендации. Данные возвращаются в виде следующего массива: 
	...
	* name — имя элемента (если есть в каталоге); 
