...
1. Пройдите учебник [Хранение серверных сценариев в системе управления версиями](mobile-services-store-scripts-source-control.md). В нем приводятся указания по настройке системы управления версиями для мобильных служб и хранению серверных сценариев в репозитории Git.
