...
- В обозревателе сервера откройте контекстное меню для узла **Azure**, выберите **Управление подписками**, затем откройте вкладку **Сертификаты** и нажмите кнопку **Создать** или **Изменить**.

- При публикации облачной службы Azure с помощью **мастера публикации приложений Azure** выберите **<Manage>** в списке **Выбор подписки**, откройте вкладку «Сертификаты», а затем нажмите кнопку **Создать** или **Изменить**.
...
1. Чтобы передать файл сертификата на портал управления, сделайте вот что:
