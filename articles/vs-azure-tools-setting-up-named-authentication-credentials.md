...
* В **обозревателе сервера** откройте контекстное меню узла **Azure**, выберите **Управление подписками**, затем откройте вкладку **Сертификаты** и нажмите кнопку **Создать** или **Изменить**.
