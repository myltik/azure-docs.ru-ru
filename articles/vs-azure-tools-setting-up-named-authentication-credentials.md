...
## <a name="modify-or-export-authentication-credentials-in-visual-studio"></a>Изменение или экспорт учетных данных для проверки подлинности в Visual Studio
...
* В **обозревателе сервера** откройте контекстное меню узла **Azure**, выберите **Управление подписками и их фильтрация**, затем откройте вкладку **Сертификаты** и нажмите кнопку **Импорт**, **Создать** или **Изменить**.
* Во время публикации облачной службы Azure с помощью мастера **Опубликовать приложение Azure** выберите **Управление** из списка **Выбор подписки**, откройте вкладку "Сертификаты", а затем нажмите кнопку **Создать** или **Изменить**.
...
2. Нажмите кнопку **Скопировать полный путь**. Путь к сертификату (CER-файлу) будет скопирован в буфер обмена.

   > [!IMPORTANT]
   > Чтобы опубликовать приложение Azure из Visual Studio, следует передать этот сертификат на [классический портал Azure](http://go.microsoft.com/fwlink/?LinkID=213885).
   >
   >
3. Чтобы передать сертификат на [классический портал Azure](http://go.microsoft.com/fwlink/?LinkID=213885), сделайте следующее.

   1. Выберите ссылку «Портал Azure».

        Откроется [классический портал Azure](http://go.microsoft.com/fwlink/?LinkID=213885).
   2. Войдите на [классический портал Azure](http://go.microsoft.com/fwlink/?LinkID=213885)нажмите кнопку **Облачные службы**.
   3. Выберите интересующую вас облачную службу.

       Откроется страница этой службы.
   4. На вкладке **Сертификаты** нажмите кнопку **Передать**.
   5. Вставьте полный путь к CER-файлу, который вы только что создали, а затем введите выбранный вами пароль.
