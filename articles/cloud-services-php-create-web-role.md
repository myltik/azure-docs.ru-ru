...
Подробнее об этих моделях можно узнать в статье [Варианты размещения вычислительных сред, предоставляемые Azure](./cloud-services/cloud-services-choose-me.md).
