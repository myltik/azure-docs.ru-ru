...
##<a name="CreateProject"></a>Практическое руководство. Создание проекта облачной службы
...
##<a name="AddRole"></a>Практическое руководство. Добавление веб-ролей и рабочих ролей PHP
...
1. Создайте проект службы Azure и добавьте веб-роль PHP, как описано в разделах [Практическое руководство. Создание проекта облачных служб](#CreateProject) и [Практическое руководство. Добавление веб-ролей и рабочих ролей PHP](#AddRole) выше.
...
6. Опубликуйте приложение, как описано в разделе [Практическое руководство. Публикация приложения](#Publish) ниже.
...
1. Создайте проект службы Azure и добавьте рабочую роль PHP, как описано в разделах [Практическое руководство. Создание проекта облачных служб](#CreateProject) и [Практическое руководство. Добавление веб-ролей и рабочих ролей PHP](#AddRole) выше.
