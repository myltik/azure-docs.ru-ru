...
##Веб-задания##
На странице управления "Веб-задания" для веб-сайта можно создавать задачи, выполняемые непрерывно, по требованию или по расписанию. Дополнительную информацию см. в разделе [Использование функции заданий WebJob на веб-сайтах Microsoft Azure](http://www.windowsazure.com/ru-ru/documentation/articles/web-sites-create-web-jobs/).
