<properties
    pageTitle="Добавление соединителя Google-диска в PowerApps или приложения логики | Microsoft Azure"
...
Подключитесь к Google-диску, чтобы создавать файлы, получать строки и выполнять множество других действий. Соединитель Google-диска можно использовать из:
...
- Добавлять соединитель Google-диска в службу PowerApps Enterprise. После этого пользователи смогут использовать его в своих приложениях. 
