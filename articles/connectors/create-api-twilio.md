...
>[AZURE.NOTE] Эта версия статьи предназначена для приложений логики со схемой версии 2015-08-01-preview. Чтобы получить версию схемы 2014-12-01-preview, щелкните [Twilio](../app-service-logic/app-service-logic-connector-twilio.md).
...
Сведения о создании маркера доступа см. в статье [Twilio](https://www.twilio.com/docs/api/ip-messaging/guides/identity).
