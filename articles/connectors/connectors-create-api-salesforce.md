<properties
pageTitle="Добавление соединителя Salesforce в службу PowerApps Enterprise и приложения логики | Microsoft Azure"
description="Обзор соединителя Salesforce и параметров интерфейса API REST"
services=""    
documentationCenter=""     
authors="msftman"    
manager="erikre"    
...
Подключитесь к Salesforce, чтобы создавать объекты, получать их и выполнять многие другие действия. Соединитель Salesforce можно использовать из:
...
- Добавьте соединитель Salesforce в PowerApps Enterprise. После этого пользователи смогут использовать его в своих приложениях. 
...
При добавлении соединителя в приложения логики эти приложения необходимо авторизовать для подключения к Salesforce.

>[AZURE.INCLUDE [Шаги по созданию подключения к Salesforce](../../includes/connectors-create-api-salesforce.md)]
