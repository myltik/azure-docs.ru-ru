---
title: Сведения об использовании соединителя SFTP в приложениях логики | Microsoft Docs
...
> [!INCLUDE [Шаги по созданию подключения к SFTP](../../includes/connectors-create-api-sftp.md)]
> 
> 
...
> [!INCLUDE [Действия по созданию триггера SFTP](../../includes/connectors-create-api-sftp-trigger.md)]
> 
> 

## Добавление условия
> [!INCLUDE [Действия по добавлению условия](../../includes/connectors-create-api-sftp-condition.md)]
> 
> 
...
> [!INCLUDE [Действия по созданию действия SFTP](../../includes/connectors-create-api-sftp-action.md)]
> 
> 
