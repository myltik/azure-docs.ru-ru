<properties
    pageTitle="Добавление соединителя SFTP в приложения логики | Microsoft Azure"
    description="Обзор соединителя SFTP с параметрами API REST"
    services=""
    documentationCenter="" 
...
Подключитесь к SFTP-серверу, чтобы управлять своими файлами. На SFTP-сервере можно выполнять различные задачи, такие как отправка файлов, их удаление и многое другое. Соединитель SFTP можно использовать из таких компонентов, как:
...
При добавлении этого соединителя в приложения логики введите указанные ниже значения:
...
Ниже приведены пошаговые инструкции по созданию подключения.
