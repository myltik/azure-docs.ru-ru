<properties
pageTitle="Добавление соединителя Dynamic CRM Online в службу PowerApps Enterprise и приложения логики | Microsoft Azure"
description="Обзор соединителя CRM Online с параметрами интерфейса API REST"
services=""    
documentationCenter=""     
authors="msftman"    
manager="erikre"    
...
# Начало работы с соединителем CRM
Подключение к Dynamics CRM Online позволяет создавать записи, обновлять элементы и выполнять многие другие действия. Соединитель CRM можно использовать из следующих компонентов:
...
## Триггеры и действия
Соединитель CRM Online позволяет выполнять следующие действия. Триггеры отсутствуют.
...
При добавлении этого соединителя в приложения логики необходимо войти в Dynamics CRM Online. Выполните следующие действия, чтобы войти в CRM Online и выполнить настройку **подключения** в приложении логики.
...
6. Выберите **Вход в Dynamics CRM Online**. ![Настройка CRM Online][14]
