---
title: Добавление соединителя Dynamics CRM Online в приложения логики | Microsoft Docs
...
> [!INCLUDE [Шаги по созданию подключения к поставщику подключений Dynamics CRM Online](../../includes/connectors-create-api-crmonline.md)]
> 
> 
...
2. Выберите **Dynamics CRM Online - When a record is created** (Dynamics CRM Online — при создании записи). Если подключение уже существует, выберите организацию и сущность в раскрывающемся списке.
   ...
   > [!NOTE]
   > В этом примере приложение логики выполняется при создании записи. Чтобы увидеть результаты триггера, добавьте другое действие, которое отправляет сообщение электронной почты. Например, добавьте действие Office 365 *Отправить сообщение электронной почты* для отправки вам сообщения электронной почты после создания новой записи.
   > 
   > 
