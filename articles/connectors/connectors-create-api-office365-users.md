<properties
    pageTitle="Добавление соединителя Office 365 Пользователи в PowerApps Enterprise или приложения логики | Microsoft Azure"
...
Подключившись к Office 365 Пользователи, вы сможете получать профили, искать пользователей и выполнять многие другие действия. Соединитель Office 365 Пользователи можно использовать из таких компонентов, как:
...
- Добавьте соединитель Office 365 Пользователи в службу PowerApps Enterprise. После этого пользователи смогут использовать его в своих приложениях. 
