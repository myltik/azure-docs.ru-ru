...
[Создайте приложение логики](../logic-apps/logic-apps-create-a-logic-app.md) и узнайте, какие еще соединители доступны в Logic Apps, с помощью [списка интерфейсов API](apis-list.md).
