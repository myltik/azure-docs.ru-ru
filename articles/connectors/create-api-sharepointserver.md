<properties
pageTitle="Использование API SharePoint Server в приложениях логики | Microsoft Azure"
description="Начало использования API-интерфейса SharePoint Server службы приложений Azure в приложениях логики и приложениях PowerApps"
services=""	
documentationCenter="" 	
authors="msftman"	
manager="erikre"	
...
# Начало работы с API-интерфейсом SharePoint
...
>[AZURE.TIP] Это подключение можно использовать в других приложениях логики и высокопроизводительных приложениях.
...
| Имя| Тип данных|Обязательно|Местонахождение|Значение по умолчанию|Описание|
| ---|---|---|---|---|---|
|dataset|строка|Да|path|Нет|URL-адрес сайта SharePoint. Например http://contoso.sharepoint.com/sites/mysite|.
|id|строка|Да|path|Нет|Уникальный идентификатор файла|
