...
Чтобы использовать API, сначала нужно создать **подключение**, а затем указать данные для приведенных ниже свойств.

|Свойство| Обязательно|Описание|
| ---|---|---|
|токен|Да|Указание учетных данных Yammer|

Выполните следующие действия, чтобы войти в Yammer и настроить **подключение** Yammer в приложении логики.

1. Выберите **Повторение**.
2. Выберите **частоту** и введите **интервал**.
3. Выберите **Добавить действие**. ![Настройка Yammer][1]
4. В поле поиска введите "yammer" и дождитесь возвращения всех записей с "Yammer" в имени.
5. Выберите **Yammer — получить все сообщения**.
6. Выберите **Вход в Yammer**. ![Настройка Yammer][2]
7. Укажите учетные данные Yammer, чтобы войти и авторизовать приложение. ![Настройка Yammer][3]  
8. Вы будете перенаправлены на страницу входа своей организации. **Разрешите** Yammer взаимодействие с вашим приложением логики. ![Настройка Yammer][4] 
9. После входа вернитесь к своему приложению логики, чтобы завершить его, настроив параметры в разделе **Yammer — получить все сообщения** и добавив другие триггеры и действия, которые необходимы. ![Настройка Yammer][5]  
