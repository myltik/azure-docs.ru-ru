...
6. Выберите **Вход в Yammer**.
![Настройка Yammer][2]
7. Укажите учетные данные Yammer, чтобы войти и авторизовать приложение.
![Настройка Yammer][3]  
8. Вы будете перенаправлены на страницу входа своей организации. **Разрешите** Yammer взаимодействие с вашим приложением логики.
![Настройка Yammer][4] 
9. После входа вернитесь к своему приложению логики, чтобы завершить его, настроив параметры в разделе **Yammer — получить все сообщения** и добавив другие триггеры и действия, которые необходимы.
![Настройка Yammer][5]  
