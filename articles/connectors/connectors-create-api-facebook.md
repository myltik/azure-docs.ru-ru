...
Подключение к Facebook позволяет оставлять публикации в хронике, получать канал страниц и выполнять другие действия. Соединитель Facebook можно использовать из таких компонентов, как:
...
| триггеры; | Действия|
| --- | --- |
| <ul><li>При появлении новой публикации в хронике</li></ul> |<ul><li>Получение ленты из хроники</li><li>Публикация в хронике</li><li>При появлении новой публикации в хронике</li><li>Получение ленты страниц</li><li>Получение публикаций в хронике пользователя</li><li>Публикация на странице</li></ul>
...
Получает ленты из хроники вошедшего в систему пользователя. ```GET: /me/feed```
...
Получает сообщения из ленты указанной страницы. ```GET: /{pageId}/feed```
