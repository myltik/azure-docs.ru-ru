...
Подключитесь к Microsoft Translator, чтобы переводить тексты, определять языки и выполнять многие другие действия. Соединитель Microsoft Translator можно использовать из:
...
- Добавлять соединитель Microsoft Translator в PowerApps Enterprise. После этого пользователи смогут использовать его в своих приложениях. 
