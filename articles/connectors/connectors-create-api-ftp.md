...
Подключитесь к FTP-серверу для управления файлами, включая передачу файлов, удаление файлов и многое другое. API FTP можно использовать из:
...
Получает обновленный файл. ```GET: /datasets/default/triggers/onupdatedfile```
