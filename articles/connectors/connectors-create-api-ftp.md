<properties
    pageTitle="Добавление соединителя FTP в приложения логики | Microsoft Azure"
    description="Обзор соединителя FTP с параметрами API REST"
    services=""
    documentationCenter="" 
...
Подключитесь к FTP-серверу для управления файлами, включая передачу файлов, удаление файлов и многое другое. Соединитель FTP можно использовать из таких компонентов, как:
...
### Создание файла
Передает файл на FTP-сервер. ```POST: /datasets/default/files```

| Имя| Тип данных|Обязательно|Местонахождение|Значение по умолчанию|Описание|
| ---|---|---|---|---|---|
|folderPath|строка|Да|запрос|Нет |Путь к папке для отправки файла на FTP-сервер|
|name|строка|Да|запрос| Нет|Имя файла, создаваемого на FTP-сервере|
...
### Извлечение папки
Извлекает файл архива в папку на FTP-сервере (например, ZIP-файл). ```POST: /datasets/default/extractFolderV2```
...
Получает содержимое файла с FTP-сервера с помощью идентификатора. ```GET: /datasets/default/files/{id}/content```
...
Получает содержимое файла с FTP-сервера с помощью пути. ```GET: /datasets/default/GetFileContentByPath```
...
Получает метаданные файла с FTP-сервера с помощью идентификатора. ```GET: /datasets/default/files/{id}```
...
Получает метаданные файла с FTP-сервера с помощью пути. ```GET: /datasets/default/GetFileByPath```
...
Получение обновленного файла. ```GET: /datasets/default/triggers/onupdatedfile```

| Имя| Тип данных|Обязательно|Местонахождение|Значение по умолчанию|Описание|
| ---|---|---|---|---|---|
|folderId|string|Да|запрос|Нет |Идентификатор папки, в которой выполняется поиск обновленного файла|
