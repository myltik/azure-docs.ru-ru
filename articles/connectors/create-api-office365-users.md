...
5. По завершении открывается новое приложение AAD. Перейдите на вкладку **Настройка**: ![Приложение AAD Contoso][10]

6. В разделе **OAuth 2** укажите в поле **URL-адрес ответа** URL-адрес, полученный при добавлении нового API Office 365 Пользователи на портале Azure. Выберите **Добавить приложение**: ![Настройка приложения AAD Contoso][11]
