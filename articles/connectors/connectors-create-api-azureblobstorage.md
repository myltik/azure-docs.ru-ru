---
title: Добавление соединителя хранилища BLOB-объектов Azure в приложения логики | Microsoft Docs
...
> [!INCLUDE [Создание подключения к хранилищу BLOB-объектов Azure](../../includes/connectors-create-api-azureblobstorage.md)]
> 
> 
...
> [!TIP]
> [Storage Explorer](http://storageexplorer.com/) — это отличное средство для управления несколькими учетными записями хранения.
> 
> 
