<properties
pageTitle="Добавление соединителя OneDrive в службу PowerApps Enterprise и приложения логики | Microsoft Azure"
...
Подключитесь к OneDrive для управления файлами, включая передачу, получение, удаление файлов и многое другое. Соединитель OneDrive можно использовать из:
...
- Добавьте соединитель OneDrive в PowerApps Enterprise. После этого пользователи смогут использовать его в своих приложениях. 
...
## Триггеры и действия
Соединитель OneDrive предоставляет следующие триггеры и действия.
...
При добавлении соединителя в приложения логики эти приложения необходимо авторизовать для подключения к OneDrive.
