---
title: Добавление соединителя базы данных SQL Azure в приложения логики | Microsoft Docs
...
> [!INCLUDE [Создание подключения к SQL Azure](../../includes/connectors-create-api-sqlazure.md)]
> 
> 
