...
Подключитесь к Microsoft Translator, чтобы переводить тексты, определять языки и выполнять многие другие действия.

API Microsoft Translator можно использовать из PowerApps Enterprise и приложений логики.
...
При добавлении Microsoft Translator в PowerApps Enterprise нужно ввести значения **идентификатора клиента** и **секрета клиента** для приложения Microsoft Translator. Если у вас нет приложения Translator, создайте его, выполнив приведенные ниже действия.
...
2. Выберите **Зарегистрировать приложение**.
	...
	2. Укажите **имя** вашего приложения.
...
| ---|---|---|---|---|---|
|запрос|строка|Да|запрос|Нет |Текст, язык которого будет определен|
...
| Имя| Тип данных|Обязательно|Местонахождение|Значение по умолчанию|Описание|
| ---|---|---|---|---|---|
|запрос|строка|Да|запрос|Нет |Текст для перевода|
