<properties
	pageTitle="Список управляемых API | Служба приложений Microsoft Azure"
...
# Список API, управляемых корпорацией Майкрософт для создания приложений

Выберите значок API и узнайте, как внедрить его в приложение, вызывающее эти службы. Эти API можно использовать для создания приложений логики, высокопроизводительных приложений и высокопроизводительных приложений логики.
...
|Интерфейсы API||||
|-----------|-----------|-----------|-----------|
|[![Значок API][blobicon]<br/>**BLOB-объекты Azure**][azureblobdoc]|[![Значок API][bingsearchicon]<br/>**Поиск Bing**][bingsearchdoc]|[![Значок API][boxicon]<br/>**Box**][boxDoc]|[![Значок API][crmonlineicon]<br/>**CRM Online**][crmonlinedoc]|
...
|[![Значок API][sharepointicon]<br/>**SharePoint**<br/>**Server**][sharepointdoc]|[![Значок API][slackicon]<br/>**Slack**<br/>][slackdoc]|[![Значок API][smtpicon]<br/>**SMTP**][smtpdoc]|[![Значок API][sqlicon]<br/>**SQL Azure**][sqldoc]|
...
> [AZURE.NOTE] Эти API-интерфейсы работают с версией службы 2015-12-01-preview.

### API могут быть триггерами.
Некоторые API служат триггерами, уведомляющими приложение о возникновении определенных событий. Например, API FTP имеет триггер OnUpdatedFile. Вы можете создавать приложения логики и высокопроизводительные приложения, которые прослушивают этот триггер и предпринимают определенные действия, если триггер срабатывает.
...
[Новые возможности](../app-service-logic/app-service-logic-schema-2015-08-01.md) [Сборка приложения логики](../app-service-logic/app-service-logic-create-a-logic-app.md) [Начало работы с высокопроизводительными приложениями](../power-apps/powerapps-get-started-azure-portal.md)
...
[sharepointdoc]: ./create-api-sharepointserver.md "Подключается к локальному Microsoft SharePoint Server или SharePoint Online, чтобы управлять документами и перечислять элементы. Поддерживаются разные способы проверки подлинности, такие как учетные данные по умолчанию, OAuth 2.0, проверка подлинности Windows и проверка подлинности с помощью форм."
