...
> [!TIP]
> Здесь содержится [полный список](#az) всех доступных соединителей, которые можно использовать в приложениях логики. В [Swagger для соединителей](/connectors/) выводятся сведения для каждого соединителя.
