...
Подключитесь к OneDrive, чтобы управлять файлами. Вы можете выполнять различные действия, такие как отправка, обновление, получение и удаление файлов в OneDrive.

API OneDrive можно использовать из PowerApps Enterprise и приложений логики.

>[AZURE.NOTE] Эта версия статьи предназначена для приложений логики со схемой версии 2015-08-01-preview. Чтобы получить версию схемы 2014-12-01-preview, щелкните [API OneDrive](../app-service-logic/app-service-logic-connector-onedrive.md).
...
2. Введите **имя приложения** и примите условия соглашения:  
![Новое приложение OneDrive][6]
...
| ---|---|---|---|---|---|
|id|string|Да|path|Нет|Уникальный идентификатор файла в OneDrive|
...
| Имя| Тип данных|Обязательно|Местонахождение|Значение по умолчанию|Описание|
| ---|---|---|---|---|---|
|id|string|Да|path|Нет|Уникальный идентификатор файла, обновляемого в OneDrive|
...
### Создание файла
Отправляет файл в OneDrive. ```POST: /datasets/default/files```

| Имя| Тип данных|Обязательно|Местонахождение|Значение по умолчанию|Описание|
| ---|---|---|---|---|---|
|folderPath|string|Да|запрос|Нет|Путь к папке для отправки файла в OneDrive|
|name|string|Да|запрос|Нет|Имя файла, создаваемого в OneDrive|
...
### При создании файла
Запускает поток при создании файла в папке OneDrive. ```GET: /datasets/default/triggers/onnewfile```
...
Запускает поток при изменении файла в папке OneDrive. ```GET: /datasets/default/triggers/onupdatedfile```
