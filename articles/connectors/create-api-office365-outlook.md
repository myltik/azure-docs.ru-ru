...
Извлекает электронные сообщения из папки. 
```GET: /Mail```
...
Удаляет электронное сообщение по идентификатору. 
...
Помечает электронное сообщение как прочитанное.
...
### Ответ на сообщение 
Отвечает на электронное сообщение. 
...
Активирует поток при получении нового электронного сообщения. 
```GET: /Mail/OnNewEmail```
...
Отправка электронного сообщения с несколькими параметрами и ожидание ответа от получателя с одним из параметров. 
...
Отправка электронного сообщения с утверждением и ожидание ответа от получателя. 
...
Активируется при создании элемента календаря.
...
Активируется при изменении элемента календаря. 
