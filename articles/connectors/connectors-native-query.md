...
Сведения о начале работы с действием запроса в приложении логики см. в статье [Создание нового приложения логики, подключающего службы SaaS](../app-service-logic/app-service-logic-create-a-logic-app.md).
...
| Действие | Описание |
| --- | --- |
| Filter array |Оценивает условие для каждого элемента в массиве и возвращает результаты. |
