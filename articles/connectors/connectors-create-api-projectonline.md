...
| ---|---|---|---|---|---|
|siteUrl|строка|Да|запрос|Нет|Корневой URL-адрес сайта проектов (например, https://sampletenant.sharepoint.com/teams/sampleteam)|
...
| Имя| Тип данных|Обязательно|Местонахождение|Значение по умолчанию|Описание|
| ---|---|---|---|---|---|
|siteUrl|string|Да|запрос|Нет|Корневой URL-адрес сайта проектов (например, https://sampletenant.sharepoint.com/teams/sampleteam)|
...
| ---|---|---|---|---|---|
|siteUrl|строка|Да|запрос|Нет|Корневой URL-адрес сайта проектов (например, https://sampletenant.sharepoint.com/teams/sampleteam)|
|project\_id|строка|Да|path|Нет|Уникальный идентификатор проекта, в который добавляется задача|
