<properties 
	pageTitle="Авторизация пользователей с помощью сценариев (Xamarin.Android) - мобильные службы Azure" 
	description="Узнайте, как осуществить авторизацию пользователей с помощью сценариев в приложении мобильных служб Azure для Xamarin.Android." 
	authors="lindydonna" 
	manager="dwrede" 
	editor="" 
