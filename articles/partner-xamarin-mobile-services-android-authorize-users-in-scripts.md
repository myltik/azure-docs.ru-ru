<properties urlDisplayName="Authorize Users in Scripts (Xamarin.Android)" pageTitle="Авторизация пользователей с помощью скриптов (Xamarin.Android) - мобильные службы Azure" metaKeywords = операция авторизация пользователей Azure, авторизация скриптов Xamarin.Android, авторизация мобильных служб" description="Узнайте, как осуществить авторизацию пользователей с помощью сценариев в приложении мобильных служб Azure для Xamarin.Android." metaCanonical="" disqusComments="1" umbracoNaviHide="1" title="Use scripts to authorize users in Mobile Services" authors="donnam" manager="dwrede" />
