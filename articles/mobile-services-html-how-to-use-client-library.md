<properties urlDisplayName="HTML Client" pageTitle="Как использовать клиент HTML для мобильных служб Azure" metaKeywords="Azure Mobile Services, Mobile Service HTML client, HTML client" description="Узнайте, как использовать клиент HTML для мобильных служб Azure." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="How to use an HTML/JavaScript client for Azure Mobile Services" authors="glenga" solutions="" manager="dwrede" editor="" />
