...
* Идентификатор клиента для собственного приложения Azure AD.
* Универсальный код ресурса (URI) ответа для собственного приложения Azure AD.
