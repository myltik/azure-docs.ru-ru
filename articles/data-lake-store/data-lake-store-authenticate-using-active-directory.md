...
## <a name="step-2-get-client-id-client-secret-and-tenant-id"></a>Шаг 2. Получение идентификатора клиента, секрета клиента и кода клиента
...
* Инструкции о том, как получить идентификатор клиента и секрет клиента для приложения, см. в разделе [Получение идентификатора приложения и ключа проверки подлинности](../azure-resource-manager/resource-group-create-service-principal-portal.md#get-application-id-and-authentication-key).
