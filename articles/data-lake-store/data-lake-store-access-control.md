...
> [!NOTE]
> Для удаления файла разрешение на запись не требуется, если выполняются два предыдущих условия.
> 
> 
...
### <a name="a-child-file-or-folders-access-acl"></a>Список ACL для доступа для дочернего файла или папки
...
## <a name="common-questions-for-acls-in-data-lake-store"></a>Общие вопросы по спискам управления доступом в хранилище Data Lake Store
...
### <a name="who-is-set-as-the-owning-group-of-a-file-or-folder-at-creation"></a>Как назначается группа владельцев файла или папки при их создании?
