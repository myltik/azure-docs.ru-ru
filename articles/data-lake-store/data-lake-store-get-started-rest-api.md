---
title: Начало работы с хранилищем озера данных Azure с помощью интерфейсов REST API| Microsoft Docs
...
> [!NOTE]
> Подробные сведения о поддержке REST API для хранилища озера данных см. в [справочнике по REST API хранилища озера данных Azure](https://msdn.microsoft.com/library/mt693424.aspx).
> 
> 
...
1. В приложении перенаправьте пользователя на следующий URL-адрес.
   ...
   > [!NOTE]
   > \<REDIRECT-URI> должен быть закодирован для использования в URL-адресе. То есть для https://localhost используйте `https%3A%2F%2Flocalhost`.
   > 
   > 
