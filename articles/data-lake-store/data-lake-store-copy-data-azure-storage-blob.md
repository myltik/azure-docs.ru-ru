...
* AdlCopy не поддерживает копирование данных из источников, имеющих в совокупности более 1000 файлов и папок. Альтернативный подход — распределить файлы и папки в разных вложенных папках и использовать путь до этих вложенных папок в качестве источника.
