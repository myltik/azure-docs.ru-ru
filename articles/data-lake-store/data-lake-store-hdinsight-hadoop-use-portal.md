...
Узнайте, как с помощью портала предварительной версии Azure настроить кластер HDInsight (Hadoop, HBase или Storm) для работы с хранилищем озера данных Azure. Важные сведения, которые следует учитывать при работе с данным выпуском.
