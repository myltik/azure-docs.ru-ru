...
Можно подготовить кластер [Azure HDInsight](https://azure.microsoft.com/ru-RU/documentation/learning-paths/hdinsight-self-guided-hadoop-training/), который использует хранилище озера данных в качестве соответствующего требованиям HDFS хранилища. В этом выпуске для кластеров Hadoop и Storm в Windows и Linux можно использовать хранилище озера данных только в качестве дополнительного. В этих кластерах по-прежнему используется хранилище Azure (WASB) в качестве хранилища по умолчанию. Тем не менее для кластеров HBase в Windows и Linux можно использовать хранилище озера данных как хранилище по умолчанию, дополнительное хранилище или и то и другое.

Инструкции по подготовке кластера HDInsight с хранилищем озера данных см. в следующих разделах.

* [Подготовка кластера HDInsight и хранилища озера данных с помощью портала предварительной версии Azure](data-lake-store-hdinsight-hadoop-use-portal.md)
...
## Использование хранилища озера данных с Azure Data Factory

Можно использовать [фабрику данных Azure](https://azure.microsoft.com/ru-RU/services/data-factory/) для приема данных из таблиц Azure, Базы данных SQL Azure, хранилища данных SQL Azure, больших двоичных объектов хранилища Azure и локальных баз данных. Фабрика данных Azure является ведущим компонентом экосистемы Azure, ее можно использовать для координации приема данных из этих источников в хранилище озера данных Azure.
