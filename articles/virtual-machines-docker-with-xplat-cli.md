...
## <a id='How to use the Docker VM Extension with Azure'></a>Использование расширения Docker для виртуальных машин с Azure
