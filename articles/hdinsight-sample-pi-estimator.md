<properties linkid="manage-services-hdinsight-sample-pi-estimator" urlDisplayName="Примеры HDInsight" pageTitle="Пример оценки числа пи в HDInsight | Azure" metaKeywords="hdinsight, пример hdinsight, mapreduce" description="Узнайте, как выполнить простой пример MapReduce в HDInsight." umbracoNaviHide="0" disqusComments="1" editor="cgronlun" manager="paulettm" services="hdinsight" documentationCenter="" title="Пример оценки числа пи в HDInsight" authors="bradsev" />

# Пример оценки числа пи в HDInsight
 
В этом разделе показано, как выполнить простую программу MapReduce, которая оценивает значение математической константы пи, в Azure HDInsight с использованием Azure Powershell. 
...
Другие доступные примеры, которые помогут вам увеличить скорость при использовании HDInsight для выполнения заданий MapReduce, а также ссылки на инструкции по их выполнению см. в разделе [Выполнение примеров HDInsight][run-samples].
...
[run-samples]: /ru-ru/manage/services/hdinsight/howto-run-samples
