<properties urlDisplayName="Intro to Linux" pageTitle="Введение в Linux в Azure &mdash; учебник Azure" metaKeywords="Azure Linux vm, Linux vm" description="Узнайте о том, как использовать виртуальные машины Linux в Azure." metaCanonical="" services="virtual-machines" documentationCenter="Python" title="Введение в Linux в Azure" authors="szark" solutions="" manager="timlt" editor="" />
...
-   См. также: [Настройка программного RAID-массива в Linux][Настройка программного RAID-массива в Linux]
