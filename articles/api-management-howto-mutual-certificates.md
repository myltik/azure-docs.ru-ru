...
> Дополнительные сведения об управлении сертификатами с помощью API REST API Management см. в разделе [Объект сертификата API REST Azure API Management][].

## Содержание раздела

- [Предварительные требования][]
- [Добавление сертификата клиента][]
- [Удаление сертификата клиента][]
- [Настройка API для проверки подлинности прокси с помощью взаимного сертификата][]
