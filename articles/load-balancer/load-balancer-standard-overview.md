...
Load Balancer уровня "Стандартный" сейчас доступен во всех регионах общедоступного облака, за исключением западной части США.
...
- Перемещение подписки не поддерживается.
- Недоступно в западной части США.
