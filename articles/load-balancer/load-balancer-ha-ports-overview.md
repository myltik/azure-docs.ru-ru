...
- Симметрия потока для сценариев виртуальных сетевых устройств поддерживается только одним сетевым интерфейсом. См. описание и схему [виртуальных сетевых устройств](#nva). 
