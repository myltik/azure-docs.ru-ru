...
Общедоступный IP-адрес, назначенный виртуальной машине, предназначен для связи "один к одному" (а не "один ко многим") и реализован в виде NAT типа "один к одному" без отслеживания состояния.  Маскировка портов (PAT) не используется, и виртуальная машина может использовать все временные порты.
