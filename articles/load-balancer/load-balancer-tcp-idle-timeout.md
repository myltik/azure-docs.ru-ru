---
title: Настройка времени ожидания простоя TCP для балансировщика нагрузки | Microsoft Docs
...
> [!NOTE]
> Чтобы иметь возможность настраивать эти параметры, убедитесь, что вы установили последнюю версию пакета Azure PowerShell.
> 
> 
...
> [!NOTE]
> Допустимый диапазон времени ожидания — от 4 до 30 минут.
> 
> 
