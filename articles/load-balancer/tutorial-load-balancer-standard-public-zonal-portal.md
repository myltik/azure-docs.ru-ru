...
6. В окне PowerShell выполните следующие команды, чтобы установить сервер IIS, удалить файл default.htm и добавить новый файл default.htm с именем виртуальной машины.
   ...
   ```
8. Закройте сеанс RDP для *myVM1*.
9. Повторите шаги 1–8, чтобы установить IIS на виртуальную машину *myVM2*.
