...
Меткой домена для общедоступного IP-адреса, который балансировщик нагрузки будет использовать в этой модели развертывания, будет <имя облачной службы>.cloudapp.net. На представленной ниже схеме показан балансировщик нагрузки Azure в этой модели.
