...
Диспетчер ресурсов Azure (ARM) представляет собой новую платформу управления для служб в Azure. Теперь подсистемой балансировки нагрузки Azure можно управлять с помощью интерфейсов API и инструментов на основе диспетчера ресурсов Azure. Подробнее о диспетчере ресурсов Azure: [Использование групп ресурсов для управления ресурсами Azure](../azure-preview-portal-using-resource-groups.md).
...
[Дополнительные сведения о сетевых ресурсах](../resource-groups-networking)
