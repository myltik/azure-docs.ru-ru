...
Службы балансировки нагрузки в Microsoft Azure работают с клиентами всех типов (IaaS или PaaS) и все поддерживаемые операционные системы (Windows или любые поддерживаемые ОС на основе Linux).
...
1. На портале Azure щелкните **Виртуальные машины**, а затем выберите имя виртуальной машины в наборе балансировки нагрузки.
2.	Нажмите **Конечные точки**, а затем выберите **Добавить**.

4.	На странице **Добавление конечной точки к виртуальной машине** нажмите стрелку вправо.
...
9.	На странице **Добавление конечной точки на виртуальную машину** нажмите **Добавить конечную точку в существующий набор балансировки нагрузки**, выберите имя набора балансировки нагрузки и нажмите стрелку вправо.

10.	На странице **Ввод сведений о конечной точке** введите имя конечной точки и щелкните флажок. Для дополнительных виртуальных машин в наборе балансировки нагрузки повторите шаги 8–10.
...
## Настройка подсистемы балансировки нагрузки, доступной в Интернете, для облачных служб
...
Подсистема балансировки нагрузки объединяет информацию о конечной точке и информацию о зонде для создания URL-адреса в виде http://{DIP ВМ}:80/Probe.aspx, который можно использовать для запроса на проверку работоспособности службы.
...
В следующем примере мы добавим подсистему балансировки нагрузки с именем webfarm в конечную точку облачной службы mycloudservice (или mycloudservice.cloudapp.net) и на виртуальную машину с именем myVM. Подсистема балансировки нагрузки принимает трафик через порт 80 и распределяет сетевой трафик между виртуальными машинами через порт 8080 по протоколу HTTP.
