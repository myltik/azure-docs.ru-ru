...
## [Настройка подсистемы балансировки нагрузки для Интернета](load-balancer-get-started-internet-portal.md)
...
## [Azure CLI 2.0 (предварительная версия)](/cli/azure/network/lb)
