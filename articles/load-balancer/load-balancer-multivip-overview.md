<properties
   pageTitle="Несколько виртуальных IP-адресов для Azure Load Balancer | Microsoft Azure"
...
* DIP: виртуальная сетевая карта, связанная с виртуальной машиной (ресурс сетевой карты Azure).
