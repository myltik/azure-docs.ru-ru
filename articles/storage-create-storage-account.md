<properties urlDisplayName="How to create" pageTitle="Как создать учетную запись хранения | Azure" metaKeywords="" description="Узнайте, как создать учетную запись хранения на портале управления Azure." metaCanonical="" services="storage" documentationCenter="" title="Создание учетной записи хранения" solutions="" authors="tamram" manager="adinah" editor="cgronlun" />
...
Дополнительные сведения о емкости и пропускной способности учетной записи хранения см. в разделе [Целевые показатели масштабируемости и производительности хранилища Azure][Целевые показатели масштабируемости и производительности хранилища Azure].
...
-   Дополнительные сведения о хранилище Azure см. в документации хранилища на следующих ресурсах: [azure.com][azure.com] и [MSDN][MSDN].
