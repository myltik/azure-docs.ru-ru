...
**Аналитика использования** предоставляет быстрый снимок по количеству пользователей, сеансов и просмотров страниц:

![](./media/app-insights-sharepoint/06-usage.png)

Щелкните диаграмму «Просмотры страниц», чтобы получить более подробные данные:
