...
Проблемы с поддержкой ОС Windows | Убедитесь, что используется поддерживаемая операционная система. [Дополнительные сведения](concepts-assessment-calculation.md#azure-suitability-analysis)
