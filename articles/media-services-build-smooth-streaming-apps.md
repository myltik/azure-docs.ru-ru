...
-   Windows 8 (32-разрядная или 64-разрядная). Можно получить [оценку Windows 8 Enterprise][] из MSDN.
-   Visual Studio 2012 и Visual Studio Express 2012 для Windows 8, установленные под управлением Windows 8. Можно получить бесплатную пробную версию [здесь][].
-   [Клиентский пакет SDK для бесперебойной потоковой передачи Microsoft для Windows 8][]

Готовое решение для каждого урока можно загрузить из раздела образцов кода для разработчиков MSDN (коллекция кодов): [Урок 1][], [Урок 2][], [Урок 3][] и [Урок 4][].
...
![Пример приложения для магазина Windows с бесперебойной потоковой передачей][]

Дополнительные сведения о разработке приложений для магазина Windows см. в разделе [Разработка замечательных приложений для Windows 8][].
...
![Просмотр кода в Visual Studio для приложения для магазина Windows с бесперебойной потоковой передачей][]
...
-   [Создание приложения Windows 8 с бесперебойной потоковой передачей на JavaScript с расширенными возможностями][]
-   [Технический обзор бесперебойной потоковой передачи][]
  ...
  [оценку Windows 8 Enterprise]: http://msdn.microsoft.com/en-us/evalcenter/jj554510.aspx
  [здесь]: http://www.microsoft.com/visualstudio/11/en-us/downloads
  ...
  [Разработка замечательных приложений для Windows 8]: http://msdn.microsoft.com/en-us/windows/apps/br229512.aspx
