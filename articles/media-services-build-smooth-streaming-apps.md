...
-   Windows 8 (32-разрядная или 64-разрядная). Можно получить [оценку Windows 8 Enterprise][оценку Windows 8 Enterprise] из MSDN.
-   Visual Studio 2012 и Visual Studio Express 2012 для Windows 8, установленные под управлением Windows 8. Можно получить бесплатную пробную версию [здесь][здесь].
-   [Клиентский пакет SDK для бесперебойной потоковой передачи Microsoft для Windows 8][Клиентский пакет SDK для бесперебойной потоковой передачи Microsoft для Windows 8]

Готовое решение для каждого урока можно загрузить из раздела образцов кода для разработчиков MSDN (коллекция кодов): [Урок 1][Урок 1], [Урок 2][Урок 2], [Урок 3][Урок 3] и [Урок 4][Урок 4].

# Урок 1: Создание базового приложения магазина с бесперебойной потоковой передачей
...
![Пример приложения для магазина Windows с бесперебойной потоковой передачей][Пример приложения для магазина Windows с бесперебойной потоковой передачей]

Дополнительные сведения о разработке приложений для магазина Windows см. в разделе [Разработка замечательных приложений для Windows 8][Разработка замечательных приложений для Windows 8].
...
**Добавление ссылки на клиентский пакет SDK бесперебойной потоковой передачи**
...
2.  Введите или выберите следующие значения:
    ...
    | материалы по     | Выберите клиентский пакет SDK бесперебойной потоковой передачи Microsoft для Windows 8 и пакет среды выполнения Microsoft Visual C++ |
...
**Разработка интерфейса пользователя проигрывателя**
...
![Просмотр кода в Visual Studio для приложения для магазина Windows с бесперебойной потоковой передачей][Просмотр кода в Visual Studio для приложения для магазина Windows с бесперебойной потоковой передачей]
...
**Регистрация обработчика байтового потока бесперебойной потоковой передачи и передача набора свойств propertyset**
...
**Добавление обработчика событий уровня диспетчера адаптивных источников**
...
Вы выполнили занятие 2. На этом занятии в приложение был добавлен ползунок.
...
3.  В верхней части приложения можно выбрать URL-адрес бесперебойной потоковой передачи по умолчанию или ввести другой.
4.  Щелкните **Задать источник**.
5.  Язык по умолчанию — audio\_eng. Попробуйте переключаться между audio\_eng и audio\_es. Каждый раз при выборе нового потока необходимо нажать кнопку "Отправить".

Вы завершили занятие 3. На этом занятии были добавлены функциональные возможности для выбора потоков.
...
Вы завершили занятие 4. На этом занятии были добавлены функциональные возможности для выбора дорожек.

# Другие ресурсы:

-   [Создание приложения Windows 8 с бесперебойной потоковой передачей на JavaScript с расширенными возможностями][Создание приложения Windows 8 с бесперебойной потоковой передачей на JavaScript с расширенными возможностями]
-   [Технический обзор бесперебойной потоковой передачи][Технический обзор бесперебойной потоковой передачи]

  [заметках к выпуску]: http://www.iis.net/learn/media/smooth-streaming/smooth-streaming-client-sdk-for-windows-8-release-notes
  [платформу проигрывателя Windows 8]: http://playerframework.codeplex.com/
  [оценку Windows 8 Enterprise]: http://msdn.microsoft.com/ru-ru/evalcenter/jj554510.aspx
  [здесь]: http://www.microsoft.com/visualstudio/11/ru-ru/downloads
  ...
  [Урок 1]: http://code.msdn.microsoft.com/Smooth-Streaming-Client-0bb1471f " Простой проигрыватель мультимедиа Windows 8 с бесперебойной потоковой передачей"
  [Урок 2]: http://code.msdn.microsoft.com/A-simple-Windows-8-Smooth-ee98f63a " Простой проигрыватель мультимедиа Windows 8 с бесперебойной потоковой передачей с ползунком"
  [Урок 3]: http://code.msdn.microsoft.com/A-Windows-8-Smooth-883c3b44 " Проигрыватель мультимедиа Windows 8 с бесперебойной потоковой передачей с возможностью выбора потока"
  [Урок 4]: http://code.msdn.microsoft.com/A-Windows-8-Smooth-aa9e4907 "Проигрыватель мультимедиа Windows 8 с бесперебойной потоковой передачей и возможностью выбора дорожки"
  [Пример приложения для магазина Windows с бесперебойной потоковой передачей]: ./media/media-services-build-smooth-streaming-apps/SSClientWin8-1.png
  [Разработка замечательных приложений для Windows 8]: http://msdn.microsoft.com/ru-ru/windows/apps/br229512.aspx
  [Просмотр кода в Visual Studio для приложения для магазина Windows с бесперебойной потоковой передачей]: ./media/media-services-build-smooth-streaming-apps/SSClientWin8-2.png
  [Создание приложения Windows 8 с бесперебойной потоковой передачей на JavaScript с расширенными возможностями]: http://blogs.iis.net/cenkd/archive/2012/08/10/how-to-build-a-smooth-streaming-windows-8-javascript-application-with-advanced-features.aspx
  [Технический обзор бесперебойной потоковой передачи]: http://www.iis.net/learn/media/on-demand-smooth-streaming/smooth-streaming-technical-overview
