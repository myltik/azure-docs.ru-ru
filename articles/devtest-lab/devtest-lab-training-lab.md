...
4. **Контроль расходов**
    ...
    Если обучение проводится в течение нескольких дней и нужно остановить все виртуальные машины в определенное время, а затем автоматически перезапустить их на следующий день, для этого нужно задать в лаборатории политики автоматического завершения работы и запуска.
