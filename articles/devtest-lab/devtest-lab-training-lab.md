...
2. **Создание обучающих виртуальных машин за считаные минуты с помощью готовых образов Marketplace и пользовательских образов** 
   ...
   | Задача | Что вы узнаете |
   | --- | --- |
   | [Настройка образы Azure Marketplace](devtest-lab-configure-marketplace-images.md) |Как добавить образы Azure Marketplace в список разрешений, а также сделать доступными для выбора необходимые образы для обучения. |
