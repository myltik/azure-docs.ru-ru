...
После настройки виртуальной сети ее можно выбирать при создании виртуальной машины. Чтобы узнать, как создать виртуальную Машину и укажите виртуальную сеть, обратитесь к статье [добавить виртуальную Машину в лабораторию](devtest-lab-add-vm.md). 
