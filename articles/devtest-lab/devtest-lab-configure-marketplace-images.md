<properties
	pageTitle="Настройка параметров образов Azure Marketplace в Azure DevTest Labs | Microsoft Azure"
...
1. В колонке **Конфигурация** лаборатории выберите **Marketplace images** (Образы Marketplace).
