...
* [Azure AzCopy](../storage/common/storage-use-azcopy.md#blob-upload).
...
Сведения о том, как получить журналы, касающиеся артефактов со сбоями, см. в статье [Диагностика сбоев артефактов в лаборатории](devtest-lab-troubleshoot-artifact-failure.md).
