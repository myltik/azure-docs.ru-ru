---
title: Добавление владельцев и пользователей в Azure DevTest Labs | Microsoft Docs
...
6. В колонке **Пользователи** выберите **Добавить**.
...
1. Выполните вход на [портал Azure](http://go.microsoft.com/fwlink/p/?LinkID=525040).
2. Щелкните **Другие службы**, а затем в списке выберите **Подписки**.
