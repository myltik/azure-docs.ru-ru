<properties
	pageTitle="Сравнение пользовательских образов и формул в лаборатории для разработки и тестирования | Microsoft Azure"
	description="Узнайте о различиях между пользовательскими образами и формулами в качестве основы для создания виртуальных машин, чтобы выбрать наиболее подходящее средство для вашей среды."
...
# Сравнение пользовательских образов и формул в лаборатории для разработки и тестирования
...
## Преимущества и недостатки пользовательских образов
...
- Параметры, сохраненные в формуле, отображаются как значения по умолчанию, но их можно изменять при создании виртуальной машины. 
