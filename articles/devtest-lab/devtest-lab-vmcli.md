...
Если необходимо создать виртуальную машину с помощью формулы, воспользуйтесь параметром --formula команды [az lab vm create](https://docs.microsoft.com/cli/azure/lab/vm#create).
