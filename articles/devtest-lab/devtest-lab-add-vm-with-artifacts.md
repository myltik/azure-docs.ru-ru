...
> [AZURE.NOTE] Просмотрите видео к этой статье: [How to create VMs with artifacts in DevTest Labs](/documentation/videos/how-to-create-vms-with-artifacts-in-a-devtest-lab) (Как создавать виртуальные машины с артефактами в DevTest Labs).
...
1. В верхней части колонки **Добавить артефакты** щелкните ссылку с количеством артефактов, добавленных в виртуальную машину.
