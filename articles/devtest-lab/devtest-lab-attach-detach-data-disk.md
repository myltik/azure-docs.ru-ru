...
- Размер виртуальной машины определяет число дисков данных, которые можно к ней подключить. Дополнительную информацию см. в статье [Размеры виртуальных машин](https://docs.microsoft.com/en-us/azure/virtual-machines/windows/sizes).
