...
7. В колонке **Создание формулы** укажите перечисленные ниже значения.
    ...
    * **Артефакты** — щелкните, чтобы открыть колонку **Add artifacts** (Добавление артефактов), где можно выбрать и настроить артефакты, которые нужно добавить в базовый образ. Дополнительные сведения об артефактах см. в разделе [создать пользовательские артефакты для виртуальной машины Azure DevTest Labs](devtest-lab-artifact-author.md).
