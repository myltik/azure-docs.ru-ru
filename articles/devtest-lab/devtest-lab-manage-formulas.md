...
1. В колонке **Создание формулы** укажите перечисленные ниже значения.
	...
	- **Виртуальная сеть** — щелкните и выберите нужную виртуальную сеть.
	- **Подсеть** — щелкните и выберите нужную подсеть.
	...
	- **Артефакты** — щелкните, чтобы выбрать из списка и настроить артефакты, которые нужно добавить в базовый образ. Обратите внимание на то, что параметры артефактов, представляющие собой защищенные строки, не отображаются, так как формула не сохраняет значения защищенных строк.

    	![Создание формулы](./media/devtest-lab-manage-formulas/create-formula.png)

1. Щелкните **Создать**, чтобы создать формулу. Когда формула будет создана, она появится в колонке **Lab formulas** (Формулы лаборатории).
