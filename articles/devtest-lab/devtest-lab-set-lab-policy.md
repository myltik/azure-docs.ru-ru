...
1. Укажите значение **Да** или **Нет** для параметра отправки уведомления за 15 минут до времени автоматического завершения работы. Если вы выбрали **Да**, введите URL-адрес конечной точки веб-перехватчика для публикации уведомления или адрес электронной почты для его отправки. Дополнительные сведения об объектах webhook см. в статье [Создание функции Azure объекта webhook или API](../azure-functions/functions-create-a-web-hook-or-api-function.md). 
