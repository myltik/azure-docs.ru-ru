...
1. В колонке **Параметры** в разделе **VM Policies** (Политики виртуальных машин) выберите **Allowed VM Sizes** (Допустимые размеры виртуальной машины).
...
1. В колонке **Параметры** в разделе **VM Policies** (Политики виртуальных машин) выберите **Maximum VMs per user** (Максимальное количество виртуальных машин для каждого пользователя).
...
1. В колонке **Параметры** в разделе **VM Policies** (Политики виртуальных машин) выберите **Total VMs allowed** (Максимально допустимое количество виртуальных машин).
...
1. В колонке **Параметры** в разделе **VM Policies** (Политики виртуальных машин) выберите **Auto shutdown** (Автоматическое завершение работы).
...
1. В колонке **Параметры** в разделе **VM Policies** (Политики виртуальных машин) выберите **Автоматический запуск**.
