...
1. В колонке **Параметры** находится группа параметров с именем **VM Policies** (Политики виртуальных машин).
	...
	- [Maximum VMs per user](#set-maximum-vms-per-user) (Максимальное количество виртуальных машин для каждого пользователя). Укажите максимальное количество виртуальных машин, создаваемых для лаборатории, а также максимальное количество виртуальных машин, создаваемых пользователем.

	- [Total VMs allowed](#set-total-vms-allowed) (Максимально допустимое количество виртуальных машин). Укажите максимальное количество виртуальных машин, создаваемых для лаборатории, а также максимальное количество виртуальных машин, создаваемых пользователем.
