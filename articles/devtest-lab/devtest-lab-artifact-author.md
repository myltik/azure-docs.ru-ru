<properties 
	pageTitle="Создание пользовательских артефактов для виртуальной машины DevTest Lab | Microsoft Azure"
...
> [AZURE.NOTE] Щелкните следующую ссылку, чтобы просмотреть видео для этой статьи: [Как создавать настраиваемые артефакты](/documentation/videos/how-to-author-custom-artifacts).
