...
Когда вы решите, что объявление больше не нужно показывать пользователям лаборатории, вернитесь на страницу **объявления лаборатории** и установите для параметра **Включено** значение **Нет**.
