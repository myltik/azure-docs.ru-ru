<properties urlDisplayName="Blob Service" pageTitle="Как использовать хранилище больших двоичных объектов (Ruby) - Microsoft Azure" metaKeywords="Get started Azure blob, Azure unstructured data, Azure unstructured storage, Azure blob, Azure blob storage, Azure blob Ruby" description="Вы узнаете, как использовать службы BLOB-объектов Azure для передачи, загрузки, отображения и удаления содержимого BLOB-объектов. Примеры кода написаны на Ruby." metaCanonical="" services="storage" documentationCenter="Ruby" title="How to Use the Blob Service from Ruby" authors="tomfitz" solutions="" manager="wpickett" editor="" />
