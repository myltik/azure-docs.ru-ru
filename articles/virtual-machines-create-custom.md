...
*Настраиваемая* виртуальная машина — это виртуальная машина, созданная с помощью метода **Из коллекции**, что дает больший выбор настроек, чем метод **Быстрое создание**. К ним относятся:
