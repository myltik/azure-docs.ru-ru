---
title: Часто задаваемые вопросы о служебной шине | Microsoft Docs
...
[Пространство имен](../service-bus/service-bus-create-namespace-portal.md) предоставляет контейнер для адресации ресурсов служебной шины в вашем приложении. Необходимо создать пространство имен, чтобы использовать служебную шину. Это будет одним из первых шагов.
...
* [Рекомендации по изолированию приложений от простоев и аварий служебной шины][Рекомендации по изолированию приложений от простоев и аварий служебной шины]. В этой статье описываются оптимальные способы защиты очередей, разделов и конечных точек ретрансляции, а также использование активной и пассивной репликации для защиты центра обработки данных от простоев.
...
Подписанные URL-адреса представляют собой механизм аутентификации на базе алгоритма безопасного хэширования SHA-256 или URI. Дополнительные сведения о том, как создавать собственные подписи с использованием Node, PHP, Java и C\#, см. в статье о [Подписи коллективного доступа][Подписи коллективного доступа].
