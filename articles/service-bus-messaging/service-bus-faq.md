...
В статье [Исключения обмена сообщениями служебной шины][Exceptions overview] описываются некоторые исключения и рассматриваются действия по их устранению.
...
[Рекомендации по изолированию приложений от простоев и аварий служебной шины]: ../service-bus/service-bus-outages-disasters.md
[Pricing overview]: https://azure.microsoft.com/pricing/details/service-bus/
[обзоре]: ../service-bus/service-bus-quotas.md
[здесь]: ../service-bus/service-bus-powershell-how-to-provision.md#migrate-a-namespace-to-another-azure-subscription
[Exceptions overview]: ../service-bus/service-bus-messaging-exceptions.md
[Общие сведения об исключениях]: ../service-bus/service-bus-messaging-exceptions.md
[подписанных URL-адресах]: ../service-bus/service-bus-sas-overview.md
