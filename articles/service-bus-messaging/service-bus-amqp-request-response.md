---
title: "AMQP 1.0 в служебной шине: операции c запросами и ответами | Документация Майкрософт"
...
|properties|map|Нет|Сопоставляется с [BrokeredMessage.Properties](https://msdn.microsoft.com/library/azure/microsoft.servicebus.messaging.brokeredmessage.properties.aspx) в служебной шине.|  
