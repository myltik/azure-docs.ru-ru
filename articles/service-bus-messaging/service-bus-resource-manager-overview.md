---
title: "Создание ресурсов служебной шины Azure с помощью шаблонов | Документация Майкрософт"
...
Установите Azure PowerShell, следуя указаниям в разделе [Приступая к работе с командлетами Azure PowerShell](/powershell/azureps-cmdlets-docs).
...
Дополнительные сведения см. в разделе [Параметры](../azure-resource-manager/resource-group-template-deploy.md#parameters).
