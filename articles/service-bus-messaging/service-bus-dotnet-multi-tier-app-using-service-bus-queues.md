...
1. Установите пакет Azure SDK для .NET с [этой страницы](https://azure.microsoft.com/downloads/).
2. В столбце **.NET** щелкните ссылку, соответствующую используемой версии Visual Studio. На описанных в этом учебнике шагах используется Visual Studio 2015.
