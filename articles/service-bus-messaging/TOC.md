# Обзор
## [Что такое обмен сообщениями с помощью служебной шины?](service-bus-queues-topics-subscriptions.md)
...
### [Руководство разработчика для AMQP]
...
### [Использование AMQP с API .NET](service-bus-dotnet-advanced-message-queuing.md)
### [Использование AMQP с секционированными очередями и разделами](service-bus-partitioned-queues-and-topics-amqp-overview.md)
