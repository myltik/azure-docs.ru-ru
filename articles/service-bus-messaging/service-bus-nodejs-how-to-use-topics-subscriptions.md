...
3.  Выполнив команду **ls**, можно убедиться, что каталог **node\_modules** создан. Найдите в папке пакет **azure**, который содержит библиотеки, необходимые для доступа к разделам служебной шины.
