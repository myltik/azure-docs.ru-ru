...
Чтобы использовать служебную шину Azure, скачайте и используйте пакет Azure Ruby, который содержит набор библиотек, взаимодействующих со службами REST хранилища.
