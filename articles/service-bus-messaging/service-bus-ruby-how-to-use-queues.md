...
Чтобы начать использовать очереди служебной шины в Azure, необходимо сначала создать пространство имен службы. Пространство имен службы формирует контейнер областей для обращения к ресурсам служебной шины внутри вашего приложения. Так как классический портал Azure не создает пространство имен с подключением ACS, необходимо создать пространство имен через интерфейс командной строки.
