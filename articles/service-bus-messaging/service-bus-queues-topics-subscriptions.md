...
Сущности обмена сообщениями, образующие основные возможности обмена сообщениями через брокер в служебной шине, представлены очередями, разделами и подписками, правилами и действиями, а также концентраторами событий.
...
Используя предыдущий пример, вы можете создать подписку Dashboard для фильтрации сообщений, приходящих только из хранилища **Store1**.
...
- [Документация по концентраторам событий](https://azure.microsoft.com/documentation/services/event-hubs/)
- [Руководство разработчика по концентраторам событий](../event-hubs/event-hubs-programming-guide.md)
- [Фильтры разделов](https://github.com/Azure-Samples/azure-servicebus-messaging-samples/tree/master/TopicFilters)
