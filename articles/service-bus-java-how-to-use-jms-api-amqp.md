<properties urlDisplayName="Service Bus AMQP" pageTitle="Использование AMQP 1.0 с интерфейсом шины обслуживания API Java - Azure" metaKeywords="ava Сообщение AMQP, шина обслуживания AMQP, загрузить библиотеку AMQP JMS" description="Узнайте, как использовать службу сообщений Java (JMS) с Azure Service Bus и протоколом AMQP 1.0." metaCanonical="" services="service-bus" documentationCenter="Java" title="How to use the Java Message Service (JMS) API with Service Bus and AMQP 1.0" authors="sethm"  solutions="" writer="sethm" manager="timlt" editor="mattshel"  />
