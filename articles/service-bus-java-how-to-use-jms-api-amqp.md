...
## Приступая к работе с шиной обслуживания
...
|-------------|---------------------------------------------------------------------------------------------|
| [namespace] | Пространство имен Service Bus, полученное с портала управления Azure.                       |
| [username]  | Имя издателя Service Bus, полученное с портала управления Azure.                            |
| [password]  | Закодированный URL-адрес ключа издателя Service Bus, полученный с портала управления Azure. |
...
| [physical\_name] | Имя сущности Service Bus, которой приложение отправляет сообщения или от которого оно получает сообщения.                   |
