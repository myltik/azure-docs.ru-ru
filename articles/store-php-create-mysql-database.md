...
В этом учебнике объясняется, как создать базу данных MySQL на [портале Azure](https://portal.azure.com) (поставщик — [ClearDB](http://www.cleardb.com/)) и как подключиться к ней из веб-приложения PHP, запущенного в [службе приложений Azure](./app-service/app-service-value-prop-what-is.md).
...
>[AZURE.NOTE] Чтобы выполнить приведенные ниже инструкции, следует предварительно изучить учебник [Создание, настройка и развертывание веб-приложения PHP в Azure](./app-service-web/app-service-web-php-get-started.md).
