...
# <a name="what's-new-in-the-azure-toolkit-for-eclipse"></a>Новые возможности набора средств Azure для Eclipse
...
> [AZURE.NOTE] Также имеется набор средств Azure для интегрированной среды разработки IntelliJ. Дополнительные сведения см. в разделе [Набор средств Azure для IntelliJ].
...
* **Поддержка новых размеров D уровня "Стандартный" для облачных служб**, которые обеспечивают повышение производительности и увеличение объемов памяти. Дополнительные сведения см. в разделе [Размеры виртуальных машин и облачных служб в Azure].
...
[Веб-страница Zulu OpenJDK на сайте Azul Systems]: http://go.microsoft.com/fwlink/?LinkId=402457
