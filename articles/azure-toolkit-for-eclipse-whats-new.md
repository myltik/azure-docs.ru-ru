...
* **Сравнение функций наборов средств Eclipse и IntelliJ для Azure**. Набор средств Azure для Eclipse и [набор средств Azure для IntelliJ][] теперь поддерживают один и тот же набор функций.
