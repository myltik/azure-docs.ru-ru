...
* **Поддержка управления веб-приложениями в представлении обозревателя Azure**. Представление обозревателя Azure в наборе средств теперь поддерживает получение списков, запуск и остановку веб-приложений Azure.
...
* **Сравнение функций наборов средств Azure для Eclipse и IntelliJ**. Набор средств Azure для Eclipse и [набор средств Azure для IntelliJ] теперь поддерживают один и тот же набор функций.
...
* **Повышение производительности при публикации в облаке**. Загрузка сведений о подписке теперь выполняется гораздо быстрее при наличии нескольких подписок и нескольких учетных записей хранения.
