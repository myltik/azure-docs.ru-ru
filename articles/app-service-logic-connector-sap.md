...
Соединители можно использовать в приложениях логики для извлечения, обработки или отправки данных в рамках потока. 
Существуют сценарии, в которых необходимо работать с системой SAP, установленной локально за брандмауэром. Используя в потоке соединитель SAP, можно реализовать множество сценариев. Вот несколько примеров.  
...
Чтобы использовать соединитель SAP, вы должны создать экземпляр приложения API 'SAP Connector'. Это можно сделать следующим образом.
...
2. Щелкните ссылку 'Download and Configure'.
