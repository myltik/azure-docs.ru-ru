...
- Страница [Включение диагностики для виртуальных машин и облачных служб Azure](cloud-services-dotnet-diagnostics.md) на веб-сайте корпорации Майкрософт.
- Страницы [Кэш Redis для Azure](https://azure.microsoft.com/services/cache/), [Azure DocumentDB](https://azure.microsoft.com/services/documentdb/) и [HDInsight](https://azure.microsoft.com/services/hdinsight/) на веб-сайте корпорации Майкрософт.
- Страница [Использование очередей служебной шины](service-bus-dotnet-how-to-use-queues.md) на веб-сайте корпорации Майкрософт.
...
- Страницы [Получение уведомлений об оповещениях](insights-receive-alert-notifications.md) и [Мониторинг работоспособности службы](insights-service-health.md) на веб-сайте Майкрософт.
- Страница [Application Insights](app-insights-get-started.md) на веб-сайте корпорации Майкрософт.
