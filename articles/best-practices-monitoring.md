---
title: Руководство по мониторингу и диагностике | Microsoft Docs
...
#### <a name="_pulling-and-pushing-instrumentation-data_"></a>*Извлечение и отправка данных инструментирования*
...
#### <a name="_consolidating-instrumentation-data_"></a>*Консолидация данных инструментирования*
...
#### <a name="_log-rotation-and-data-retention_"></a>*Ротация журналов и удержание данных*
...
#### <a name="_down-sampling_"></a>*Понижающая выборка*
