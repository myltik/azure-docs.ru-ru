<properties 
	pageTitle="Отладка Hadoop в HDInsight: Сообщения об ошибках | Azure" 
...
- **Описание**. Недопустимое имя контейнера BLOB-объектов для внешней учетной записи хранения *yourContainerName*. Убедитесь, что имя начинается с буквы и содержит только строчные буквы, цифры и дефис.  
