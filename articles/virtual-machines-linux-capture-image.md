<properties pageTitle="Запись образа виртуальной машины под управлением Linux" description="Узнайте, как записать образ виртуальной машины (ВМ) Azure под управлением Linux." services="virtual-machines" documentationCenter="" authors="KBDAzure" manager="timlt" editor="tysonn"/>
...
8.	Все образы Linux должны быть  *deprovisioned* путем выполнения команды  `waagent` с параметром отзыва -`deprovision`. Щелкните **Я выполнил команду waagent-deprovision на виртуальной машине**, чтобы указать, что операционная система подготовлена к тому, чтобы стать образом.
