...
## Как перейти к колонкам «Приложение API» и «Шлюз» 
...
В этой статье было показано, как использовать портал Azure для выполнения задач управления приложением API.
