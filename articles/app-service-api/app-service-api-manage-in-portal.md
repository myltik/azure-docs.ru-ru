...
Колонку **Узел приложения API** можно использовать для всех задач, которые можно выполнять для любого веб-приложения. Дополнительные сведения см. в разделе [Управление веб-приложениями на портале](../app-service-web/web-sites-manage.md).
...
Колонку **Узел шлюза** можно использовать для всех задач, которые можно выполнять для любого веб-приложения. Дополнительные сведения см. в разделе [Управление веб-приложениями на портале](../app-service-web/web-sites-manage.md).
