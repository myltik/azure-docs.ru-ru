...
В этой статье было показано, как использовать портал Azure для выполнения задач управления приложениями API. Информацию о приложениях API, установленных из коллекции приложений API, см. в статье [Управление встроенными приложениями API и соединителями, а также их мониторинг](../app-service-logic/app-service-logic-monitor-your-connectors.md).
