...
## <a name="a-idauthconfiga-how-to-configure-service-principal-authentication-in-azure-app-service"></a><a id="authconfig"></a> Настройка проверки подлинности субъекта-службы в службе приложений Azure
...
## <a name="a-idtutorialstarta-continuing-the-net-api-apps-tutorial-series"></a><a id="tutorialstart"></a> Продолжение руководств по началу работы с .NET
