---
title: Проверка подлинности с использованием субъекта-службы для приложений API в службе приложений Azure | Microsoft Docs
...
7. В разделе **Режим управления** щелкните **Создать приложение AD**, если этот параметр еще не выбран.
