...
1. Выполните действия, описанные в учебнике [Защита приложения API](../app-service-api-dotnet-add-authentication.md), чтобы настроить приложение API с уровнем доступа **Общедоступный (с проверкой подлинности)**.
