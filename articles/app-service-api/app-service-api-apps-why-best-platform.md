...
[Служба приложений](../app-service/app-service-value-prop-what-is.md) — это полностью управляемая платформа для сценариев веб-сайтов, мобильных устройств и интеграции. Приложения API в службе приложений предоставляют возможности, которые упрощают создание, размещение и использование интерфейсов API в облачной и локальной среде. Используя приложения API, вы получите преимущества безопасности корпоративного класса, простого контроля доступа, возможности гибридного подключения, автоматического создания пакетов SDK и прозрачной интеграции с [приложениями логики](../app-service-logic/app-service-logic-what-are-logic-apps.md).
