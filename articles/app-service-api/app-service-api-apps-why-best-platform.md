...
Чтобы приступить к работе с приложениями API, ознакомьтесь с одним из учебников цикла [Приступая к работе с приложениями API](app-service-api-dotnet-get-started.md).
