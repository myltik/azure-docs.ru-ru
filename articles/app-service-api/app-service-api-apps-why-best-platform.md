...
- быстрое и простое развертывание, а также множество вариантов непрерывной доставки — сведения о вариантах развертывания, доступных для приложений API, см. в разделе [Развертывание веб-приложения в службе приложений Azure](../app-service-web/web-sites-deploy.md). 
...
- **Доступ к локальным данным.** Приложения API могут предоставлять API, использующие данные из собственного центра обработки данных с помощью [гибридных подключений](../integration-hybrid-connection-overview.md) и [VNET](../app-service-web/web-sites-integrate-with-vnet.md).
