...
* **Интеграция с Visual Studio.** Выделенные инструменты в Visual Studio упрощают работу по созданию, развертыванию, отладке приложений API и управлению ими. Дополнительную информацию см. в статье о [ выпуске пакета Azure SDK 2.8.1 для .NET](/blog/announcing-azure-sdk-2-8-1-for-net/).
