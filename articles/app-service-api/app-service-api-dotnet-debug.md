...
12. После загрузки пользовательского интерфейса Swagger щелкните команду **Get** в окне браузера, чтобы отобразить схему для объекта «Контакт», а затем щелкните **Попробовать**. Visual Studio остановит выполнение программы в соответствии с ранее назначенными точками останова, и вы сможете произвести отладку логики вашего контроллера.
