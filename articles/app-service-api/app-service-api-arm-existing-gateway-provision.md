...
Идентификатор существующего плана размещения службы приложений.
...
Обратите внимание: для параметра **kind** задано значение **apiApp**. Для портала Azure это служит уведомлением о том, что в данном веб-приложении размещается приложение API. Портал не будет отображать веб-приложение в колонке обзора веб-приложений. Приложение содержит расширение для установки пустого пакета приложения API по умолчанию. Между приложением API и размещением веб-приложения определяется связь. Раздел параметров приложения содержит значения, необходимые для размещения приложения API. Свойству **serverFarmId** присвоено значение, указанное в параметре **hostingPlanId**.
