<properties 
	pageTitle="Подготовка приложения API с помощью существующего шлюза" 
	description="Использование шаблона диспетчера ресурсов Azure для развертывания приложения API, использующего существующий шлюз и план службы приложений." 
...
Полный шаблон см. в статье [Приложение API с существующим шаблоном шлюза](https://github.com/tfitzmac/AppServiceTemplates/blob/master/existing-gateway-existing-plan-new-apiapp.json).
