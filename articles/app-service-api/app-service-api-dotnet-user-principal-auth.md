---
title: Проверка подлинности пользователей для приложений API в службе приложений Azure | Microsoft Docs
...
4. В разделе **Поставщики проверки подлинности** щелкните **Azure Active Directory**.
    ...
    ![Колонка "Проверка подлинности и авторизация" на портале Azure](./media/app-service-api-dotnet-user-principal-auth/authblade.png)
5. В колонке **Параметры Azure Active Directory** щелкните **Автоматическое**.
...
6. В разделе **Режим управления** нажмите кнопку **Создать приложение AD** (если она еще не нажата) и обратите внимание на значение, которое находится в поле **Создание приложения** — вы будете искать это приложение AAD на классическом портале Azure позднее.
...
3. Щелкните **Приложения > Приложения, принадлежащие моей компании**, а затем установите флажок.
...
[!INCLUDE [устранение неполадок](../../includes/app-service-api-auth-troubleshooting.md)]
