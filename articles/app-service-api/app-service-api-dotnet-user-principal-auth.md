...
Общие сведения о функциях проверки подлинности, которые используются в этом руководстве, см. в предыдущем руководстве этой серии — [Приступая к работе с приложениями API и ASP.NET в службе приложений Azure](app-service-api-dotnet-get-started.md).
...
15. В нижней части страницы щелкните **Управление манифестом > Загрузить манифест** и сохраните файл в расположении, в котором сможете его изменить.
