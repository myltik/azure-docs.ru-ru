...
В инструкциях этой статьи предполагается, что вы установили Azure CLI и знаете, как выполнять основные задачи. Чтобы ознакомиться с интерфейсом командной строки, см. статью [Установка и настройка консоли Azure CLI](../xplat-cli-install.md).
