...
2. Установка [Maven] на компьютере, на котором ведется разработка.
3. Установка [Git] на компьютере, на котором ведется разработка.
...
2. Перейдите в [онлайн-редактор Swagger]. В редакторе щелкните в меню **Файл -> Вставить JSON**.
...
5. В меню выберите **Создать сервер -> JAX RS**, чтобы создать серверный код на основе скаффолдинга, который позже будет изменен для добавления возможности реализации макетов.
