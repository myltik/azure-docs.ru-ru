---
title: Поддержка CORS в службе приложений | Microsoft Docs
...
3. В колонке **Параметры**, расположенной справа от колонки **Приложение API**, найдите раздел **API** и щелкните **CORS**.
...
2. В мастере **веб-публикации** на вкладке **Профиль** щелкните **Служба приложений Microsoft Azure**.
