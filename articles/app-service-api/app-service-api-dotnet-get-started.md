...
В этом разделе вы создадите приложение API в Azure с помощью инструментов Azure, интегрированных в мастер **Публикация веб-сайта** в Visual Studio. Затем вы развернете проект ToDoListDataAPI в новом приложении API и выполните вызов API, запустив пользовательский интерфейс Swagger в облаке.
...
1. Откройте [обозреватель ресурсов](https://resources.azure.com/).
