...
В этом разделе описываются процедуры создания нового пустого веб-приложения, установки и использования AngularJS и связывания простого внешнего интерфейса HTML с приложением API. Будет выполнено развертывание используемого веб-приложения в службу приложений Azure. Веб-приложение HTML установит связь с данными, полученными из приложения API, и будет отображать их, а также обеспечит пользователям простой пользовательский интерфейс для API контактов.
