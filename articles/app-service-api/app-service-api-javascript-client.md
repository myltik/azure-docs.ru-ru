...
1. Щелкните правой кнопкой мыши ранее созданное решение согласно шагам в статье [Cоздание приложения API](app-service-dotnet-create-api-app.md) и выберите **Добавить -> Новый проект**.
