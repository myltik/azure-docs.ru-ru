...
Параметр приложения **MS\_CrossDomainOrigins** подробно описан в записи блога [Обновления .NET мобильной службы Azure](https://azure.microsoft.com/blog/2014/07/28/azure-mobile-services-net-updates/), где можно найти более подробные сведения о параметре.
...
В этом разделе описываются процедуры создания нового пустого веб-приложения, установки и использования AngularJS и привязки к этому приложению API простого внешнего интерфейса HTML. Будет выполнено развертывание используемого веб-приложения в службу приложений Azure. Веб-приложение HTML установит связь с данными, полученными из приложения API, и будет отображать их, а также обеспечит пользователям простой пользовательский интерфейс для API контактов.
