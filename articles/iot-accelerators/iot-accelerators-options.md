...
ms.locfileid: "34725587"
---
# <a name="compare-azure-iot-options"></a>Сравнение вариантов Интернета вещей Azure

В статье [Azure и "Интернет вещей"](iot-accelerators-what-is-azure-iot.md) описывается распространенная архитектура решения Интернета вещей со следующими уровнями:
...
* **Акселераторы решений Azure IoT.** [What are the IoT solution accelerators?](iot-accelerators-what-are-solution-accelerators.md) (Что собой представляют акселераторы решений Интернета вещей).
