...
* [Predictive Maintenance solution accelerator overview](../iot-suite/iot-suite-predictive-overview.md) (Общие сведения об акселераторе решения для прогнозного обслуживания)
