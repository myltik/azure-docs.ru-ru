---
title: Создание субъекта-службы с помощью интерфейса командной строки Azure | Microsoft Docs
...
1. Войдите в свою учетную запись.
        ...
        azure login
2. Создайте субъект-службу для своего приложения. Укажите отображаемое имя, универсальный код ресурса (URI) на странице, описывающей приложение, коды URI, идентифицирующие приложение, а также пароль для его удостоверения. Эта команда создает приложение AD и субъект-службу.
...
2. Выполните вход как субъект-служба.
...
4. Войдите в свою учетную запись.
        ...
        azure config mode arm
        azure login
5. Создайте субъект-службу для своего приложения. Укажите отображаемое имя, универсальный код ресурса (URI) на странице, описывающей приложение, коды URI, идентифицирующие приложение, а также скопированные данные сертификата. Эта команда создает приложение AD и субъект-службу.
