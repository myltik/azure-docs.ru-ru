---
title: Политики в службе управления API Azure | Microsoft Docs
...
Выражения политики можно использовать в качестве значений атрибутов или текстовых значений в любой политике управления API, если в ней не указано иное. Некоторые политики, например [Управление потоками][Управление потоками] и [Задание переменной][Задание переменной], основаны на выражениях политики. Подробнее: [Расширенные политики][Расширенные политики] и [Выражения политики][Выражения политики].

## <a name="scopes"></a>Как настраивать политики
Политики можно настраивать глобально или на уровне [продукта][продукта], [API][API] или [операции][операции]. Для настройки политики перейдите в редактор политик на портале издателя.
