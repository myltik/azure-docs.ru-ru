...
Цвета, шрифты, размеры, отступы и другие элементы стиля страниц портала задаются правилами стиля. Чтобы изменить стили на **портале разработчиков**, откройте панель инструментов настройки в левой части окна, переместив указатель мыши на значок настройки, а затем выберите "Стили" на панели инструментов.
