...
## <a name="step2"> </a>Настройка API для проверки подлинности шлюза с помощью взаимного сертификата
...
[Настройка API для проверки подлинности шлюза с помощью взаимного сертификата]: #step2
