...
-	[Политики преобразования][]
	...
	-	[Маскировка URL-адресов в содержимом][] — перезаписывает (маскирует) ссылки в тексте ответа так, чтобы каждая из них они указывала на эквивалентную ссылку через шлюз.
