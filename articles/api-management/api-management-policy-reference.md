...
-	[Политики преобразования][] 
	...
	-	[Маскирование URL-адресов в содержимом][] — перезаписывает (маскирует) ссылки в тексте ответа и в заголовке папки так, чтобы они указывали на эквивалентную ссылку через шлюз.
