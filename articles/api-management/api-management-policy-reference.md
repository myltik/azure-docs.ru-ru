...
-	[Расширенные политики][]
	...
	-	[Повторить](https://msdn.microsoft.com/ru-RU/library/dn894085.aspx#Retry) — повторяет выполнение инструкций встраиваемой политики, если не выполнено условие и до тех пор пока оно не будет выполнено. Выполнение будет повторяться через определенные промежутки времени и до указанного количества повторных попыток.
	...
	-	[Трассировка](https://msdn.microsoft.com/ru-RU/library/dn894085.aspx#Trace) — добавляет строку в выходные данные [инспектора API](../api-management/api-management-howto-api-inspector.md).
...
-	[Политики кэширования][]
	...
	-	[Удалить значение из кэша](https://msdn.microsoft.com/ru-RU/library/dn894086.aspx#RemoveCacheByKey) — удаление элемента в кэше по ключу.
