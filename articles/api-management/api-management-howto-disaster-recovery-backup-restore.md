...
>
> Обратите внимание, что срок действия каждой резервной копии истекает через 30 дней. При попытке восстановления резервной копии по истечении 30 дней восстановление завершится сбоем и будет отображено сообщение `Cannot restore: backup expired`.
>
>
