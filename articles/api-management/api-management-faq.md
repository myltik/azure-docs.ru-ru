...
-	Вы можете отправить нам [запрос на функцию](https://feedback.azure.com/forums/248703-api-management).
...
-	Создайте собственную функцию архивации и восстановления с помощью [REST API службы управления API](https://msdn.microsoft.com/library/azure/dn776326.aspx), чтобы сохранять и восстанавливать нужные объекты из экземпляра службы.
...
-	Если вы хотите оставить сегмент версии default в URL-адресе службы API, вы можете задать для выбранных операций политику, использующую политику [Задание внутренней службы](https://msdn.microsoft.com/library/azure/dn894083.aspx#SetBackendService) для изменения пути запроса к внутренней службе.
...
Да, см. шаблоны быстрого запуска на странице [служба управления API Azure](http://aka.ms/apimtemplate).
