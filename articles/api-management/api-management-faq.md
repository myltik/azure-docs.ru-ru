...
Сведения о настройке этого сценария см. в статье [Использование служб федерации Active Directory в управлении API](https://phvbaars.wordpress.com/2016/02/06/using-adfs-in-api-management/).
