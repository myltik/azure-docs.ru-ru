...
|ИМЯ|ОПИСАНИЕ|Требуется|значение по умолчанию|  
|----------|-----------------|--------------|-------------|  
...
|ИМЯ|ОПИСАНИЕ|Требуется|значение по умолчанию|  
|----------|-----------------|--------------|-------------|  
|base-url|Новый базовый URL-адрес внутренней службы.|Нет |Н/Д|  
|backend-id|Идентификатор серверной части для перенаправления.|Нет |Н/Д|  
...
|SF имя прослушивателя|Применимо только для внутреннего — это служба Service Fabric и задается с помощью «идентификатор серверной». Надежные службы структуры дает возможность создания нескольких прослушивателей в службе. Этот атрибут используется для выбора конкретного прослушивателя, когда серверной надежной службы имеет более одного прослушивателя. Если этот атрибут не указан, API управления будет пытаться использовать прослушиватель без имени. Прослушиватель без имени является типичным для надежных служб, которые имеют только один прослушиватель. |Нет |Н/Д|  
