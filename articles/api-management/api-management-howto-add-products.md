...
> Если экземпляр службы управления API еще не создан, см. раздел [Создание экземпляра службы управления API][Создание экземпляра службы управления API] в руководстве [Начинаем работу со службой управления API][Начинаем работу со службой управления API].
> 
> 
...
> Дополнительные сведения см. в разделе [Как создать и использовать группы для управления учетными записями разработчиков в службе управления Azure API][Как создать и использовать группы для управления учетными записями разработчиков в службе управления Azure API].
> 
> 
