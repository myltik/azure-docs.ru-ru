...
В этом учебнике мы создадим бесплатную пробную версию продукта API, которая позволит разработчикам вызывать API до 10 раз в минуту и до 200 раз в неделю. Затем вы опубликуете API и протестируете политику ограничения скорости.
...
**Заголовки ответа** и **Содержимое ответа** указывают оставшийся интервал, после которого повторные попытки будут успешными.
