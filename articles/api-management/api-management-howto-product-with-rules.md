...
В этом учебнике мы создадим бесплатную пробную версию продукта API (Free Trial), которая позволит разработчикам вызывать API до 10 раз в минуту и до 200 раз в неделю. Затем вы опубликуете API и протестируете политику ограничения скорости.
...
Чтобы разрешить для учетных записей разработчика многократную подписку на новый продукт, установите флажок **Разрешить несколько одновременных подписок**. В этом разделе не используется несколько одновременных подписок, поэтому не устанавливайте этот флажок.
...
Щелкните **Продукты** в меню **Управление API** слева и щелкните **Free Trial** для настройки продукта.
...
Ограничения скорости и квоты настраиваются в редакторе политик. Щелкните **Продукты** в меню **Управление API** слева и выберите **Free Trial** из раскрывающегося списка **Диапазон политик продукта**.
...
Теперь API добавлены, политики настроены и готовы к использованию разработчиками. Прежде чем продукт смогут использовать разработчики, его нужно опубликовать. Щелкните **Продукты** в меню **Управление API** слева и щелкните **Free Trial** для настройки продукта.
...
Установите флажок в поле рядом с **Free Trial** и щелкните **Подписать**.
