...
+ Возможность подключения к виртуальной сети доступна на уровнях **Премиум** и **Разработчик**. Переключитесь на один из этих уровней, как описано в статье об [обновлении и масштабировании](upgrade-and-scale.md#upgrade-and-scale).
...
| * / 6381 - 6383 |Входящий и исходящий |TCP |Зависимость для кэша Redis |VIRTUAL_NETWORK — VIRTUAL_NETWORK |Внешний и внутренний |
