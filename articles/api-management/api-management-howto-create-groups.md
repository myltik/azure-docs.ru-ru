...
Для связывания группы с продуктом щелкните **Продукты** в расположенном слева меню **Управление API**, а затем щелкните имя требуемого продукта.
...
* После добавления в группу разработчик может просматривать связанные с данной группой продукты и подписываться на них. Дополнительные сведения см. в разделе [Как создавать и публиковать продукт в службе управления Azure API][Как создавать и публиковать продукт в службе управления Azure API],
* Помимо создания групп и управления ими на портале издателя, это можно делать с помощью сущности [Group](https://msdn.microsoft.com/library/azure/dn776329.aspx) REST API интерфейса API управления.
...
[Как создавать и публиковать продукт в службе управления Azure API]: api-management-howto-add-products.md
