...
* Другие способы защиты внутренней службы см. в разделе [Взаимная аутентификация на основе сертификатов](api-management-howto-mutual-certificates.md) и [Подключение через VPN или ExpressRoute](api-management-howto-setup-vpn.md).
