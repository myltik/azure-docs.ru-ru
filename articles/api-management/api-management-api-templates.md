...
##  <a name="a-nameapilista-api-list"></a><a name="APIList"></a>Список API  
...
##  <a name="a-nameproducta-operation"></a><a name="Product"></a> Операция  
...
##  <a name="a-namecodesamplesa-code-samples"></a><a name="CodeSamples"></a> Примеры кода  
