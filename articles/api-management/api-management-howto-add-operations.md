<properties 
	pageTitle="Добавление операций в API в Azure API Management" 
...
![Добавление операции][api-management-add-operation]
...
![Кэширование][api-management-caching-tab]
...
>Дополнительные сведения о кэшировании и политиках кэширования см. в разделе [Кэширование результатов операции в Azure API Management][].
