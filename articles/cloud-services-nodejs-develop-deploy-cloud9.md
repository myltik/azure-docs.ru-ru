...
<div class="dev-callout">
<strong>Примечание.</strong>
<p>Хотя действий, приведенных в этом разделе, достаточно для приложения Hello World, для приложений, использующих внешние модули, может потребоваться выбрать нужную версию Node.js в среде отладки. Для этого выберите пункт **Настройка...** в раскрывающемся списке для отладки, а затем выберите конкретную версию Node.js. Например, могут возникнуть ошибки проверки подлинности при использовании модуля azure, если не выбрана версия Node.js 0.6.x.</p>
</div>
...
7.  Запись развертывания будет отображать состояние процесса развертывания. После завершения развертывания оно будет отображаться **Активное**
    ...
    <div class="dev-callout">
	<strong>Примечание.</strong>
	<b>Проектам развертывания через Cloud 9 IDE присваивается идентификатор GUID в качестве имени развертывания в Azure.</b>
    </div>
