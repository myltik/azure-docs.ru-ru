<properties pageTitle="Оптимизация производительности MySQL в виртуальных машинах Azure Linux" description="Узнайте, как оптимизировать MySQL в виртуальной машине Azure под управлением Linux." services="virtual-machines" documentationCenter="" authors="NingKuang" manager="timlt" editor="tysonn"/>
...
[http://Azure.Microsoft.com/ru-ru/Documentation/articles/Virtual-Machines-Linux-Configure-RAID/](http://azure.microsoft.com/ru-ru/documentation/articles/virtual-machines-linux-configure-RAID/)
...
-	Сокращение времени отклика при вводе-выводе.  
...
Чтобы получить информацию о способе сравнения производительности после оптимизации, см. [Приложение Г](AppendixD).
...
|-----------|-----------|-----------
|**innodb_buffer_pool_size**	|Нет	|7G
