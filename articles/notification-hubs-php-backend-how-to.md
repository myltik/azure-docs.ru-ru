...
-   использование [Учебника по началу работы][Учебника по началу работы] с выбранной мобильной платформой, реализация серверной части на PHP.
...
Весь доступный код находится в [Примере оболочки PHP REST][Примере оболочки PHP REST].
...
Кроме того, при желании вы можете использовать код из [Примера оболочки PHP REST][Примере оболочки PHP REST] и перейти напрямую в раздел [Завершение работы с учебником][Завершение работы с учебником].

Подробные сведения о реализации полноценной оболочки REST можно найти в [MSDN][MSDN]. В этом разделе описывается реализация основных действий на PHP, необходимых для доступа к конечным точкам REST концентраторов уведомлений.
...
-   Загрузить полный [Образец оболочки PHP REST][Примере оболочки PHP REST], содержащий весь указанный выше код.
