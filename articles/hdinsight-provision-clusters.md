...
## <span id="configuration"></span></a>Настройки конфигурации
...
[Azure Virtual Networ][Azure Virtual Networ] позволяет создать безопасную и стабильную сеть, в которой будут находиться все ресурсы, необходимые для успешного функционирования вашего решения. Виртуальная сеть позволит вам:
...
4.  На странице **Настройка кластера** введите или выберите следующие значения:
    ...
    <p>Доступны следующие регионы: <strong>Восточная Азия</strong>, <strong>Юго-Восточная Азия</strong>, <strong>Северная Европа</strong>, <strong>Западная Европа</strong>, <strong>Восточные штаты США</strong>, <strong>Западные штаты США</strong>, <strong>Северные штаты США</strong>, <strong>Южные и центральные штаты США</strong><br />При создании виртуальной сети Azure вы можете выбрать сеть, чтобы настроить кластеры HDInsight для ее использования.</p>
...
-   [Документация по пакету Azure HDInsight SDK][Документация по пакету Azure HDInsight SDK]
  ...
  [Azure Virtual Networ]: http://azure.microsoft.com/ru-ru/documentation/services/virtual-network/
