...
ms.locfileid: "34361188"
---
# <a name="compare-managed-and-devtest-labs-in-azure-lab-services"></a>Сравнение управляемых лабораторий и лабораторий Azure DevTest Labs в Службах лабораторий Azure
...
## <a name="devtest-labs"></a>Лаборатории для разработки и тестирования
...
## <a name="managed-labs-vs-devtest-labs"></a>Управляемые лаборатории и Лаборатории для разработки и тестирования
В следующей таблице приведены два типа лабораторий, которые поддерживаются Службами лабораторий Azure: 

| Функции | Управляемые лаборатории. | Лаборатории для разработки и тестирования |
| -------- | ----------------  | ---------- |
