<properties 
	pageTitle="" 
	description="Использование мобильных служб в проектах Cordova" 
...
1. В проекте Cordova предварительной версии Visual Studio 2015 откройте файл Config.xml и на вкладке **Подключаемые модули** включите подключаемый модуль **Мобильные службы Azure**.<br/> ![][1]

2. В файле index.html удалите строки, которые ссылаются на **MobileServices.Web 1.2.2.min.js**.<br/>
