<properties title="Search Service: workflow for developers" pageTitle="Служба поиска: рабочий процесс для разработчиков" description="Служба поиска: рабочий процесс для разработчиков" metaKeywords="" services="" solutions="" documentationCenter="" authors="Heidist" manager="mblythe" videoId="" scriptId="" />
...
Мы предполагаем, что служба уже подготовлена вами. Если вы еще не сделали этого, см. инструкции в разделе [Начало работы со службой Поиска Azure ](../search-get-started/).
...
Индексы создаются кодом приложения. Отсутствуют встроенные средства или редакторы, помогающие определить индекс в пользовательском интерфейсе. Примеры, демонстрирующие различные способы создания индекса, включают [Создание первого поиска решения с помощью поиска Azure](../search-create-first-solution/), где схема задается в файле Program.cs и разделе [Начало работы с оценки профилей в поиске Azure](../search-get-started-scoring-profiles), задающим индекс в отдельном файле схемы JSON. Дополнительные сведения о создании индекса см. в разделе [Создание индекса (API Поиска Azure)](http://msdn.microsoft.com/ru-ru/library/dn798941.aspx) в MSDN.
...
Дополнительные сведения о создании индексов или документов см. в разделе [Rest API поиска Azure](http://msdn.microsoft.com/ru-ru/library/dn798935.aspx).
