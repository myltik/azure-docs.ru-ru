...
## <a id='How to use the Docker VM Extension with Azure'>Использование расширения Docker для виртуальных машин с Azure</a>
