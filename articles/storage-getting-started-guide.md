...
Если вы хотите больше узнать о службе хранилище Azure, прежде чем углубляться в код, см. раздел [Дальнейшие действия][].
...
3. В диалоговом окне **Новый проект** нажмите кнопку **Установленные** > **Шаблоны** > **Visual C#** > **Облако** > **Быстрй запуск** > **Службы данных**.
...
Запустите пример приложения с помощью [эмулятора службы хранилища Azure](https://msdn.microsoft.com/library/azure/hh403989.aspx), который устанавливается как часть пакета Azure SDK:
