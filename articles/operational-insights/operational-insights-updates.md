...
Для использования системных обновлений в службе Microsoft Azure Operational Insights необходимо установить решение. Дополнительные сведения об установке решений см. в разделе [Использование коллекции решений для добавления или удаления решений](operational-insights-add-solution.md). После установки можно просмотреть обновления, пропущенные на отслеживаемых серверах, с помощью плитки **Оценка системных обновлений** на странице **Обзор** в службе Operational Insights.
