...
- Общие сведения об контроле доступа на основе ролей см. в статье [Контроль доступа на основе ролей на портале Microsoft Azure](role-based-access-control-configure.md).
