<properties 
   ...
   description="Заметки о выпуске пакета SDK для Azure для .NET" 
...
# Заметки о выпуске пакета SDK для Azure для .NET

В этом документе содержатся заметки о выпуске пакета SDK для Azure для .NET 2.5.1. 

##Заметки о выпуске пакета SDK для Azure для .NET 2.5.1

Далее приведены новые функции и обновления в пакете SDK для Azure для .NET 2.5.1.
...
- Новые функции и сценарии, относящиеся к **инструментам HDInsight** в Visual Studio и включенные в этот выпуск. 
	...
	Дополнительные сведения см. в разделе [Начало работы с инструментами HDInsight Hadoop для Visual Studio](hdinsight-hadoop-visual-studio-tools-get-started.md).
