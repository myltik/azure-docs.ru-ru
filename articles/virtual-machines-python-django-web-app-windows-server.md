<properties pageTitle="Веб-приложение Python на Django - учебник по Azure" description="В этом учебнике описывается размещение веб-сайта, созданного на основе Django, в Azure с помощью виртуальной машины Windows Server 2012 R2 Datacenter." services="virtual-machines" documentationCenter="python" authors="huguesv" manager="wpickett" editor=""/>
...
1. Следуйте приведенным [здесь][portal-vm] указаниям, чтобы создать виртуальную машину дистрибутива  *Windows Server 2012 R2 Datacenter*.
...
1. В случае установки версии Python 2.7 [выполните эти инструкции, чтобы установить pip вручную](https://pip.pypa.io/en/latest/installing.html) (в версии Python 3.4 уже установлен pip).
