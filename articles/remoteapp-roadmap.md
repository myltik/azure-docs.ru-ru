<properties 
    pageTitle="Новые возможности RemoteApp" 
    description="Сведения о новых функциональных возможностях RemoteApp" 
    services="remoteapp" 
    solutions="" 
	documentationCenter="" 
    authors="lizap" 
...
# Новые возможности RemoteApp

Мы постоянно улучшаем и совершенствуем платформу RemoteApp с учетом ваших мнений и пожеланий. Вот ориентировочные сроки реализации поддержки различных функций и возможностей.

|Функция|Июль-сентябрь 2014 г.|Октябрь-декабрь 2014 г.|Январь-март 2015 г.|Апрель-июнь 2015 г.|
|-----------|-------|-------|-------|-------|
|Отправка бизнес-приложений в облачные и гибридные коллекции|X| | | |
|Поддержка Windows Phone| |X| | |
|Панель мониторинга показателей использования| |X| | | 	
|Подготовка к работе большого количества пользователей с помощью CSV-файла | |X| | |
