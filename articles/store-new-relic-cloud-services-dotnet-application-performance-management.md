...
##Использование New Relic с Azure

Чтобы получить дополнительную информацию об использовании New Relic совместно с Azure, см. [веб-сайт документации по New Relic](https://docs.newrelic.com/docs/agents/net-agent/azure-installation), в частности такие статьи:

* [New Relic for .NET](https://docs.newrelic.com/docs/agents/net-agent/getting-started/new-relic-net) (New Relic для .NET)
* [Instrument a .NET Worker Role on Azure Cloud service](https://docs.newrelic.com/docs/agents/net-agent/azure-installation/instrument-net-worker-role-azure-cloud-service) (Инструментирование рабочей роли .NET в облачной службе Azure)
* [New Relic for the Microsoft Azure Cloud platform](https://docs.newrelic.com/docs/agents/net-agent/azure-installation/azure-cloud-services) (New Relic для облачной платформы Microsoft Azure)
* [New Relic for the Microsoft Azure App Services](https://docs.newrelic.com/docs/agents/net-agent/azure-installation/azure-portal) (New Relic для службы приложений Microsoft Azure)
* [New Relic/Azure troubleshooting](https://docs.newrelic.com/docs/agents/net-agent/azure-troubleshooting) (Устранение неполадок при работе с New Relic и Azure)
