<properties 
	pageTitle="Мониторинг учетной записи служб мультимедиа - Azure" 
...
##<a id="configuringstorage"></a>Практическое руководство. Мониторинг использования хранилища BLOB-объектов (необязательно)
...
<!-- Images -->
[панель мониторинга]: ./media/media-services-monitor-services-account/media-services-dashboard.png
