...
3.  Вручную выполните команду **ls** или **dir** и убедитесь, что папка **node_modules** создана. В этой папке найдите пакет **azure**, который содержит библиотеки для доступа к концентратору уведомлений.
