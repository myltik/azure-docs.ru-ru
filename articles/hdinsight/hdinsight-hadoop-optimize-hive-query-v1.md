---
title: Оптимизируйте запросы Hive для более быстрого выполнения в HDInsight | Microsoft Docs
...
> 
> В этом документе также содержатся сведения об использовании Azure PowerShell. Представленные фрагменты кода основаны на командах, использующих пакет управления службами Azure (ASM) для работы с HDInsight, и являются **устаревшими**. Эти команды будут удалены с 1 января 2017 г.
> 
> Версию этого документа, в которой используется портал Azure, а также фрагменты кода PowerShell, использующие Azure Resource Manager (ARM), см. в разделе [Оптимизация запросов Hive для Hadoop в HDInsight](hdinsight-hadoop-optimize-hive-query.md).
> 
> 
