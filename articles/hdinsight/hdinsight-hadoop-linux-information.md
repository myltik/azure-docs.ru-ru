...
Сведения о разработке собственных действий скриптов см. в разделе [Разработка действий скриптов с помощью HDInsight](hdinsight-hadoop-script-actions-linux.md).
