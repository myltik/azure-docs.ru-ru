...
![Топология присоединенного к домену кластера HDInsight](./media/apache-domain-joined-configure/hdinsight-domain-joined-topology.png)
...
3. Создайте виртуальную сеть HDInsight в режиме управления ресурсами Azure.
4. Установите пиринг между двумя виртуальными сетями.
...
7. Скопируйте пароль и щелкните **Завершить**. Далее в этом руководстве вы используете этого глобального администратора, чтобы создать кластер HDInsight.
...
1. Получите SSL-сертификат, подписанный заверителем подписи для вашего домена. Если вам необходимо использовать самозаверяющий сертификат, обратитесь с просьбой по поводу исключения по адресу hdipreview@microsoft.com.
