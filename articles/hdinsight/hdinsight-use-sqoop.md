...
Пример PowerShell в этом разделе выполняет следующие действия:
...
3. Создайте сервер базы данных SQL Azure, базу данных SQL Azure и две таблицы. 
...
4. Создайте кластер HDInsight.

	Для проверки кластера можно использовать портал Azure или Azure PowerShell.

5. Выполните предварительную обработку исходного файла данных.
...
6. Экспортируйте файл данных в базу данных SQL Azure.
...
7. Экспортируйте таблицу Hive в базу данных SQL Azure.

8. Импортируете таблицу mobiledata в кластер HDInsight.
