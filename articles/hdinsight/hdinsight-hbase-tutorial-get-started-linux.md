...
4. Получите одну строку
    ...
    Дополнительные сведения о схеме таблицы HBase см. в документе [Introduction to HBase Schema Design] (Общие сведения о проектировании схемы HBase)[hbase-schema]. Сведения о других командах HBase см. в [справочнике по Apache HBase][hbase-quick-start].
