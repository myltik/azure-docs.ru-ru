---
title: Руководство по HBase. Приступая к работе с кластерами HBase под управлением Linux в Hadoop | Microsoft Docs
...
4. Запустите следующий сценарий HiveQL. Запрос Hive запрашивает данные в таблице HBase:
