...
> [AZURE.NOTE] 
Самый простой способ проверить номер версии заключается в том, чтобы найти запись **Эмулятор Microsoft HDInsight для Azure** (для версии 1.0.0.0 или более поздней версии) или **Microsoft HDInsight Developer Preview** (для версий младше 1.0.0.0) в окне «Установка и удаление программ».
