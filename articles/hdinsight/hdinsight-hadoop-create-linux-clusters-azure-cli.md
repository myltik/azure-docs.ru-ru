---
title: Создание кластеров Hadoop, HBase и Storm на базе Linux в HDInsight с помощью кроссплатформенного Azure CLI | Microsoft Docs
...
5. Извлеките ключ для доступа к учетной записи хранения.
   ...
   * Замените **storagename** на имя учетной записи хранения.
     ...
     Из полученных данных сохраните значение **key** для параметра **key1**.
6. Создание кластера HDInsight.
   ...
   * Замените **admin** и **httppassword** на имя пользователя и пароль, которые хотите использовать для доступа к кластеру по протоколу HTTPS.
   * Замените **sshuser** и **sshuserpassword** на имя пользователя и пароль, которые хотите использовать для доступа к кластеру по протоколу SSH.
