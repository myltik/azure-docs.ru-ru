...
Power BI позволяет визуально представлять данные в виде отчетов или панелей мониторинга. С помощью API REST Power BI вы можете легко использовать в Power BI данные из топологии в кластере Apache Storm в HDInsight.
...
1. Следуйте указаниям в [кратком руководстве по Power BI](https://msdn.microsoft.com/library/dn931989.aspx) для регистрации в Power BI.

2. Создайте регистрацию приложения, выполнив инструкции в статье [Регистрация приложения](https://msdn.microsoft.com/library/dn877542.aspx). Она будет использоваться при доступе к API REST Power BI.
...
1. Откройте пример в Visual Studio. В **обозревателе решений** откройте файл **App.config**, а затем найдите элемент **<OAuth .../>**. Введите значения для следующих свойств этого элемента:
