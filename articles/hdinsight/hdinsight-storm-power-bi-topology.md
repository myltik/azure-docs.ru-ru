...
6. В области **Поля** разверните элемент **IISLOGS**. Установите флажок напротив **URISTEM**. Немедленно будет создан отчет, в котором перечислены все ресурсы URI (/foo, /bar и т. д.), сохраненные в базе данных.
