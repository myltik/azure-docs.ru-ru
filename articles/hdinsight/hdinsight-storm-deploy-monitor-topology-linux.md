...
Пользовательский интерфейс Storm предоставляет веб-интерфейс для работы с запущенными топологиями и включен в состав кластера HDInsight. Чтобы открыть веб-интерфейс Storm, перейдите в веб-браузере по адресу __https://CLUSTERNAME.azurehdinsight.net/stormui__, где __CLUSTERNAME\_\_ — это имя вашего кластера.
