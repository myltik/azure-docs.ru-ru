---
title: Развертывание топологий Apache Storm в HDInsight на основе Linux и управление ими | Microsoft Docs
...
### Использование команд Storm и SSH
...
### Программным образом
Вы можете программно развернуть топологию в Storm в HDInsight, обмениваясь данными со службой Nimbus, размещенной в кластере. На странице [https://github.com/Azure-Samples/hdinsight-java-deploy-storm-topology](https://github.com/Azure-Samples/hdinsight-java-deploy-storm-topology) приведен пример приложения Java, в котором показано, как развернуть и запустить топологию с помощью службы Nimbus.
...
Пользовательский интерфейс Storm предоставляет веб-интерфейс для работы с запущенными топологиями и включен в состав кластера HDInsight. Чтобы открыть веб-интерфейс Storm, перейдите в веб-браузере по адресу **https://CLUSTERNAME.azurehdinsight.net/stormui**, где *_CLUSTERNAME\*\_ — это имя вашего кластера.
...
* **Из сеанса SSH**. Для этого в сеансе SSH используйте команду `headnode -f`.
