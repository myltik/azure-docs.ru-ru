...
## <a name="a-idwhyawhy-use-pig"></a><a id="why"></a>Почему именно Pig?
...
## <a name="a-idjobaabout-the-sample-job"></a><a id="job"></a>Сведения о примере приложения
...
## <a name="a-idrunarun-the-pig-latin-job"></a><a id="run"></a>Запуск задания Pig Latin
