---
title: "Мониторинг и управление кластерами HDInsight с помощью веб-интерфейса Apache Ambari | Документация Майкрософт"
...
## <a name="ssh-proxy"></a>Прокси-сервер SSH
> [!NOTE]
...
> [!WARNING]
> Не изменяйте пароль модуля наблюдения Ambari (hdinsightwatchdog) в кластере HDInsight под управлением Linux. Это не позволит выполнять действия скрипта или операции масштабирования в кластере.
> 
> 
...
### <a name="a-idserviceaservices"></a><a id="service"></a>Службы
