---
title: Использование Hive с Hadoop для анализа журнала веб-сайта| Microsoft Docs
...
3. На открывшейся веб-странице выберите вкладку **Коллекция для начала работы**, а затем в категории **Решения с примером данных** щелкните пример **Анализ журнала веб-сайта**.
