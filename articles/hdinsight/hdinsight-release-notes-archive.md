...
description: "Архивные заметки о выпуске и версии компонентов Hadoop для Azure HDInsight."
services: hdinsight
documentationcenter: 
editor: cgronlun
manager: jhubbard
