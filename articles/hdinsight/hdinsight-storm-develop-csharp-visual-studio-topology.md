...
4. После создания проекта у вас должны быть следующие файлы:
   ...
   * **Bolt.cs**— пример сита, которое подсчитывает числа, созданные воронкой.
     ...
     В рамках создания проекта с NuGet скачиваются актуальные версии [пакетов SCP.NET](https://www.nuget.org/packages/Microsoft.SCP.Net.SDK/).
...
> [!WARNING]
> Локальное тестирование работает только для базовых топологий на C#. Не следует использовать локальное тестирование для гибридных топологий или топологий, использующих несколько потоков.
