...
> [AZURE.NOTE] Ключ `2.2.4.9-1` в пути соответствует версии платформы данных Hortonworks для кластера HDInsight, которое может измениться при обновлении HDInsight.
...
> [AZURE.NOTE] Ключ `2.2.4.9-1` в пути может меняться при обновлении кластера HDInsight.
