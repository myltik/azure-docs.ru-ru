---
title: "Выполнение примеров Hadoop MapReduce в HDInsight на основе Linux | Документация Майкрософт"
...
* **Подписка на Azure**. Узнайте, как [получить бесплатную пробную версию Azure](https://azure.microsoft.com/documentation/videos/get-azure-free-trial-for-testing-hadoop-in-hdinsight/).
