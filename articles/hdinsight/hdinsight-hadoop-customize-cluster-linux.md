...
Кроме того, у проектов Apache есть соответствующие сайты по-адресу [Apache.org](https://apache.org), например для [Hadoop](http://hadoop.apache.org/) и [Spark](http://spark.apache.org/).
