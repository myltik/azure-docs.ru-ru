...
> [AZURE.NOTE]Для доступа к файлам журнала через Ambari требуется туннель SSH, так как веб-сайты отдельных служб не отображаются для всех пользователей в Интернете. Сведения об использовании SSL-туннеля см. в одной из следующих статей:
>
...
- [Установка и настройка CLI Azure](../xplat-cli.md)
