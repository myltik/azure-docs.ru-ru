...
2. Создайте новую записную книжку. На панели заголовка щелкните элемент **Notebook** и в раскрывающемся списке выберите пункт **Create New Note** (Создать новую заметку).
...
1. В записной книжке Zeppelin выполните абзац с фрагментом кода. Нажмите клавиши **SHIFT+ВВОД** или кнопку **Play** (Воспроизвести) в правом верхнем углу.
...
2. Запустите проект **Sender** и нажмите клавишу **ВВОД** в окне консоли, чтобы запустить отправку сообщений в концентратор событий.
