...
Примечание. В скобках указано количество узлов каждого типа.
...
Примечание. Головной узел для типа кластера Storm называется Nimbus. Рабочая роль называется "регионом" в кластерах типа HBase и "контролером" в кластерах типа Storm.
