---
title: "Создание кластеров Hadoop, HBase, Storm или Spark на платформе Linux в HDInsight | Документация Майкрософт"
...
---
# <a name="create-linux-based-hadoop-clusters-in-hdinsight"></a>Создание кластеров Hadoop под управлением Linux в HDInsight
...
* Только южная Бразилия и западная Япония (здесь нет размеров v2):
  ...
  | Граничный узел — размеры виртуальной машины по умолчанию | | | | |Windows: D12; Linux: D4 |
  | Граничный узел — рекомендуемые размеры виртуальной машины | | | | |Windows: D12, D13, D14; Linux: D4, D12, D13, D14 |
...
Если для решения нужны технологии, распределенные по нескольким типам кластера HDInsight, нужно создать виртуальную сеть Azure, а в ней — необходимые типы кластера. Благодаря такой конфигурации кластеры и любой развернутый в них код могут взаимодействовать друг с другом напрямую.
...
Подробные сведения о дополнительных хранилищах см. в статье [Использование хранилища BLOB-объектов Azure с HDInsight](hdinsight-hadoop-use-blob-storage.md).
