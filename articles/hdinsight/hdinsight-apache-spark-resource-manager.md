---
title: Использование диспетчера ресурсов для выделения ресурсов для кластера Apache Spark в HDInsight | Microsoft Docs
...
---
# Управление ресурсами кластера Apache Spark в HDInsight на платформе Linux
