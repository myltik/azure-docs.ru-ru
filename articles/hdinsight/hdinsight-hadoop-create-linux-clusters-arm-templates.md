---
title: "Создание кластеров HDInsight (Hadoop) с помощью шаблонов | Документация Майкрософт"
...
## <a name="appendix-resource-manager-template"></a>Приложение: шаблон Resource Manager
