...
>
> В настоящее время (по состоянию на 25 августа 2015 г.) вы можете выполнять подготовку к работе только для одного кластера HDInsight под управлением Linux в виртуальной сети Azure.
