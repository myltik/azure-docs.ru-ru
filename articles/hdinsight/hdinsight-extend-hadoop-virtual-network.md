...
>
> Если у вас есть ресурсы в сети v1 и вам необходимо сделать соединение HDInsight доступным для этих ресурсов через виртуальную сеть, см. информацию о подключении виртуальной сети v2 к виртуальной сети v1 в статье [Подключение классических виртуальных сетей к новым виртуальным сетям](../virtual-network/virtual-networks-arm-asm-s2s.md). После установления подключения можно создать кластер HDInsight в виртуальной сети v2.
