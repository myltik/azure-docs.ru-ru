---
title: Расширение возможностей HDInsight с помощью виртуальной сети Azure | Microsoft Docs
...
1. Используйте следующую команду, чтобы создать новую группу безопасности сети с именем `hdisecure`. Замените **RESOURCEGROUPNAME** и **LOCATION** на имя группы ресурсов, которая содержит виртуальную сеть Azure, и расположение (регион), в котором была создана группа.
...
3. После создания правила используйте следующую команду для применения группы безопасности сети к подсети. Замените значение **RESOURCEGROUPNAME** именем группы ресурсов, содержащей виртуальную сеть Azure. Замените **VNETNAME** и **SUBNETNAME** именами виртуальной сети Azure и подсети, которая будет использоваться при установке HDInsight.
...
> [!NOTE]
> Дополнительные сведения об использовании Ambari в HDInsight см. в разделе [Мониторинг кластеров Hadoop в HDInsight с помощью API Ambari](hdinsight-monitor-use-ambari-api.md).
> 
> 
