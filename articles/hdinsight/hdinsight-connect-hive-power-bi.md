...
![Отчет карты HDInsight Power BI](./media/hdinsight-connect-power-bi/hdinsight-power-bi-visualization.png)

Эти сведения также относятся к новому типу кластера [интерактивных запросов](./hdinsight-hadoop-use-interactive-hive.md).

## <a name="prerequisites"></a>Предварительные требования
Чтобы выполнить действия, указанные в этой статье, вам потребуется:

* **Кластер HDInsight.** Это может быть кластер HDInsight с Hive или новый кластер интерактивных запросов. Сведения о создании кластеров см. в [этом разделе](hdinsight-hadoop-linux-tutorial-get-started.md#create-cluster).
...
Дополнительные сведения см. в разделе [Создание источника данных Hive ODBC](hdinsight-connect-excel-hive-odbc-driver.md#create-hive-odbc-data-source).
...
2. Перейдите на вкладку **Главная**, на ленте **Внешние данные** щелкните **Получить данные**, а затем выберите **Дополнительно**.
    ...
    ![Открытие данных HDInsight Power BI](./media/hdinsight-connect-power-bi/hdinsight-power-bi-open-odbc.png)
...
1. В области "Визуализации" выберите **Карта**.  Это значок глобуса.
    ...
    ![Настройка отчета HDInsight Power BI](./media/hdinsight-connect-power-bi/hdinsight-power-bi-customize.png)
