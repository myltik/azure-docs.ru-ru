---
title: Что такое R в HDInsight? Основные сведения об R Server в HDInsight (предварительная версия) | Microsoft Docs
