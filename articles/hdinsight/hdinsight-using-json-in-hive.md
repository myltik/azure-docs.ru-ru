...
* написание собственной определяемой пользователем функции с использованием Python или других языков. Сведения о выполнении кода Python в Hive приведены в [этой статье][hdinsight-python].
