...
<tr><td>Имя пользователя</td><td>Введите имя пользователя кластера HDInsight. Это имя пользователя, созданное во время подготовки кластера. При использовании параметра быстрого создания именем пользователя по умолчанию является <strong>admin</strong>.</td></tr>
<tr><td>Пароль</td><td>Введите пароль пользователя кластера HDInsight.</td></tr>
</table>Существует несколько важных параметров, о которых следует помнить при выборе пункта **Расширенные параметры**.
