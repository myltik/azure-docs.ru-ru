...
# Запуск программы оценки числа пи MapReduce в кластере Hadoop в HDInsight

Кластеры HDInsight снабжены JAR-файлом с несколькими примерами MarReduce. В этой статье показано, как запустить пример оценки числа пи с помощью Azure PowerShell. Пример оценки числа пи оценивает значение математической константы пи.
