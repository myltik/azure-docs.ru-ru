...
---
# <a name="what-are-the-different-hadoop-components-and-versions-available-with-hdinsight"></a>Что представляют собой различные компоненты и версии Hadoop, доступные в HDInsight?

Узнайте об уровнях обслуживания, предлагаемых для кластеров Azure HDInsight, а также о включенных в них компонентах и версиях экосистемы Hadoop. Каждая версия HDInsight является облачной реализацией версии платформы данных HortonWorks Data Platform (HDP).
...
Azure HDInsight поддерживает несколько версий кластера Hadoop, которые могут быть развернуты в любое время. Каждая из версий создает конкретную версию платформы HortonWorks Data Platform (HDP) и набор компонентов, содержащихся в этой версии. Версии компонентов, связанные с версиями кластера HDInsight, приведены в следующей таблице. Обратите внимание, что в настоящее время Azure HDInsight по умолчанию использует версию кластера 3.5 на основе HDP 2.5 (с 17.02.2017).
...
| Компонент | HDInsight 3.5 (по умолчанию) | HDInsight 3.4 | HDInsight 3.3 | HDInsight 3.2 | HDInsight 3.1 | HDInsight 3.0 |

| --- | --- | --- | --- | --- | --- | --- | | Hortonworks Data Platform |2.5 |2.4 |2.3 |2.2 |2.1.7 |2.0 | | Apache Hadoop и YARN |2.7.3 |2.7.1 |2.7.1 |2.6.0 |2.4.0 |2.2.0 | | Apache Tez |0.7.0 |0.7.0 |0.7.0 |0.5.2 |0.4.0 | | | Apache Pig |0.16.0 |0.15.0 |0.15.0 |0.14.0 |0.12.1 |0.12.0 | | Apache Hive и HCatalog |1.2.1.2.5 |1.2.1 |1.2.1 |0.14.0 |0.13.1 |0.12.0 | | Apache HBase |1.1.2 |1.1.2 |1.1.1 |0.98.4 |0.98.0 | | | Apache Sqoop |1.4.6 |1.4.6 |1.4.6 |1.4.5 |1.4.4 |1.4.4 | | Apache Oozie |4.2.0 |4.2.0 |4.2.0 |4.1.0 |4.0.0 |4.0.0 | | Apache Zookeeper |3.4.6 |3.4.6 |3.4.6 |3.4.6 |3.4.5 |3.4.5 | | Apache Storm |1.0.1 |0.10.0 |0.10.0 |0.9.3 |0.9.1 | | | Apache Mahout |0.9.0 и выше |0.9.0 и выше |0.9.0 и выше |0.9.0 |0.9.0 | | | Apache Phoenix |4.7.0 |4.4.0 |4.4.0 |4.2.0 |4.0.0.2.1.7.0-2162 | | | Apache Spark |1.6.2 и 2.0 (только Linux) |1.6.0 (только Linux) |1.5.2 (только Linux или экспериментальная сборка) |1.3.1 (только Windows) | | |
