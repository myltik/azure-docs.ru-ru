...
| Компонент | HDInsight версии 3.5 (по умолчанию) | HDInsight версия 3.4 | HDInsight версия 3.3 | HDInsight версия 3.2 | HDInsight версия 3.1 | HDInsight версия 3,0 |
| --- | --- | --- | --- | --- | --- | --- |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| HDI 3.6 (предварительная версия) |HDP 2.6 |Ubuntu 16 |Да |28.02.2017 |Да | | |
...
##<a name="hdi-36-preview-with-apache-spark-21"></a>HDI 3.6 (предварительная версия) с Apache Spark 2.1
Предварительная версия HDI 3.6 выпущена 28.02.2017. Она доступна в предварительной версии для Apache Spark 2.1. Дополнительные сведения см. в записи блога [Announcing preview of Azure HDInsight 3.6 with Apache Spark 2.1](https://azure.microsoft.com/en-us/blog/announcing-preview-of-azure-hdinsight-3-6-with-apache-spark-2-1/) (Анонс выпуска предварительной версии Azure HDInsight 3.6 с Apache Spark 2.1).
