...
1. Перейдите на [Бюро транспортной статистики при администрации по исследованиям и инновационным технологиям][rita-website].
...
4. В командной строке `1>` введите следующее:
    ...
    Если вводится инструкция `GO` , то оцениваются предыдущие инструкции. Будет создана новая таблица **delays**с кластеризованным индексом (требуется для базы данных SQL).
