...
6. Экспортирование файла данных в базу данных SQL Azure.
   ...
   > * **Azure HDInsight**: в разделе [кластеров создать Hadoop в HDInsight с использованием пользовательских параметров](../hdinsight-hadoop-provision-linux-clusters.md) сведения о создании кластера в виртуальной сети.
