...
* **[Кластеры, присоединенные к домену (предварительная версия)](../domain-joined/apache-domain-joined-introduction.md)** — с помощью кластеров, присоединенных к домену Active Directory, можно контролировать доступ к данным и управлять ими.
...
* [Руководство по Hadoop. Начало работы с Hadoop в HDInsight на платформе Linuxt](apache-hadoop-linux-tutorial-get-started.md). Краткое руководство по подготовке кластеров HDInsight Hadoop и выполнению примеров запросов Hive.
* [Начало работы. Создание кластера Apache Spark в HDInsight на платформе Linux и выполнение интерактивных запросов с помощью SQL Spark](../spark/apache-spark-jupyter-spark-sql.md). Краткое руководство по созданию кластера Spark и выполнению интерактивных запросов Spark SQL.
* [Приступая к работе с R Server в HDInsight (предварительная версия)](../r-server/r-server-get-started.md). Начало работы с использованием R Server в HDInsight Premium.
