...
>
> Если вы используете кластер HDInsight на платформе Windows, вы можете использовать [консоль запросов](../hadoop/apache-hadoop-use-hive-query-console.md) в браузере или [удаленный рабочий стол](../hadoop/apache-hadoop-use-hive-remote-desktop.md) для выполнения запросов Hive.
...
* [Использование пользовательских функций Python с Hive и Pig в Azure HDInsight](../hadoop/python-udf-hdinsight.md)
