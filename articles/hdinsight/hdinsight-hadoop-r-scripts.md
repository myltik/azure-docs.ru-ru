...
> [AZURE.NOTE]Действия, описанные в этом документе, требуют наличия кластера HDInsight на основе Windows. Сведения об использовании R с кластером под управлением Linux см. в разделе [Установка и использование R в кластерах HDInsight Hadoop (Linux)](hdinsight-hadoop-r-scripts-linux.md).
...
1. При подготовке кластера HDInsight на портале предварительной версии щелкните **Необязательная конфигурация**, а затем щелкните **Действия скрипта**.
...
## Установка R с помощью пакета .NET SDK
...
**Создание приложения .NET в Visual Studio**
