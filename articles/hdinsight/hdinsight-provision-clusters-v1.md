...
>
> В этом документе также содержатся сведения об использовании Azure PowerShell, Azure CLI и пакета SDK для .NET для HDInsight. Представленные фрагменты кода основаны на командах, использующих пакет управления службами Azure (ASM) для работы с HDInsight, и являются __устаревшими__. Эти команды будут удалены с 1 января 2017 г.
>
