---
title: Создание приложений Spark Scala с помощью средств HDInsight в наборе средств Azure для IntelliJ | Microsoft Docs
...
1. Запустите интегрированную среду разработки IntelliJ и откройте Azure Explorer. В меню **Вид** интегрированной среды разработки щелкните **Окна инструментов** и выберите **Azure Explorer**.
...
1. В **Azure Explorer** разверните **HDInsight**, затем — имя кластера Spark, после чего щелкните **Jobs** (Задания).
