...
10. Вставьте в функцию **Main()** следующий код.
	...
	Это все переменные, которые необходимо задать для программы. Узнать имя подписки Azure можно на [портале предварительной версии Azure][azure-management-portal].
