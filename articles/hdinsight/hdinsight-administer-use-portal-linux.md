...
2. На портале:
   ...
   * В меню слева щелкните **Кластеры HDInsight**, чтобы просмотреть список существующих кластеров:
       ...
       Если кнопка **Кластеры HDInsight** не отображается, в нижней части списка щелкните **Другие службы** и в разделе **Аналитика** щелкните **Кластеры HDInsight**.
...
1. Войдите на портал [https://portal.azure.com](https://portal.azure.com).
2. В меню слева щелкните **Кластеры HDInsight** , чтобы просмотреть список существующих кластеров. Если вы не видите **кластеры HDInsight**, сначала щелкните **Больше служб**.
