...
1. Начните подготовку кластера с помощью действий, описанных в статье [Подготовка кластеров HDInsight под управлением Linux](hdinsight-provision-linux-clusters.md#portal), но не завершайте ее.
...
2. В колонке **Необязательная конфигурация** выберите **Действия сценария** и введите следующие сведения:
	...
	* __ПАРАМЕТРЫ__: для сценария нужен пароль администратора кластера в качестве параметра. Заключите пароль в одинарные кавычки.
