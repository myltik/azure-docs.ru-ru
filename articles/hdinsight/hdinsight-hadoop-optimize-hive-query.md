---
title: "Оптимизация запросов Hive для более быстрого выполнения в HDInsight | Документация Майкрософт"
...
---
# <a name="optimize-hive-queries-for-hadoop-in-hdinsight"></a>Оптимизация запросов Hive для Hadoop в HDInsight
...
* Во время подготовки можно указать количество рабочих узлов при помощи портала Azure, Azure PowerShell или кросс-платформенного интерфейса командной строки.  Дополнительные сведения см. в статье [Создание кластеров Hadoop под управлением Windows в HDInsight](hdinsight-provision-clusters.md). На следующем экране показана рабочая конфигурация узла на портале Azure.
  
    ![scaleout_1][image-hdi-optimize-hive-scaleout_1]
* Во время выполнения можно масштабировать кластер без необходимости его повторного создания. Такой способ показан ниже.
