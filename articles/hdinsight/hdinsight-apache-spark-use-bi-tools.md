---
title: Использование средств бизнес-аналитики с Apache Spark в HDInsight | Microsoft Docs
...
---
# Использование инструментов бизнес-аналитики с кластером Apache Spark в HDInsight на платформе Linux
...
2. Вы можете теперь завершить работу записной книжки для освобождения ресурсов. Для этого в записной книжке в меню **Файл** выберите пункт **Закрыть и остановить**. Это завершит работу записной книжки и закроет ее.
