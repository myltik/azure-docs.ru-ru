...
1. Запустите обозреватель хранилищ Azure. Если вы запускаете обозреватель хранилищ в первый раз, вам будет предложено ввести ___\_имя учетной записи хранения__ и __ключ учетной записи хранения__. Если вы уже запускали его раньше, нажмите кнопку __Добавить__, чтобы добавить новые имя и ключ учетной записи хранения.
...
Дополнительные сведения см. в [документации по фабрике данных Azure](http://azure.microsoft.com/documentation/services/data-factory/).
...
Дополнительные сведения об установке пакетов SDK для Azure см. в разделе [Загрузки Azure](http://azure.microsoft.com/downloads/)
