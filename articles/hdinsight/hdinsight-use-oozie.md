---
title: Использование Hadoop Oozie в HDInsight | Microsoft Docs
...
> [!NOTE]
> Информацию о поддерживаемых версиях Oozie в кластерах HDInsight см. в статье [Новые возможности в версиях кластеров Hadoop, предоставляемых в HDInsight][hdinsight-versions].
> 
> 
...
* **Рабочая станция с Azure PowerShell.**.
    ...
    Для выполнения сценариев Windows PowerShell необходимо использовать права администратора и задать политику выполнения *RemoteSigned*. Дополнительные сведения см. в статье [Выполнение сценариев Windows PowerShell][powershell-script].
...
<tr><td>${nameNode}</td><td>Задает URL-адрес узла имен заданий Hadoop. Используйте стандартный адрес файловой системы, например <i>wasbs://&lt;имя_контейнера>@&lt;имя_учетной_записи_хранения>.blob.core.windows.net</i>.</td></tr>
...
5. Копирование файла рабочего процесса Oozie и файла сценария HiveQL в файловую систему по умолчанию.
   ...
   * Скопируйте сценарий HiveQL (useoozie.hql) в службу хранилища Azure (wasbs:///tutorials/useoozie/useoozie.hql).
