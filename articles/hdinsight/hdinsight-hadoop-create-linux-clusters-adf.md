...
- [Azure PowerShell](../xplat-cli-install.md) или [Azure CLI](hdinsight-administer-use-powershell.md#install-azure-powershell-10-and-greater). 
...
Ресурс *hdinsight-hive-on-demand* содержит четыре ресурса:
...
4. Щелкните **Условия**, а затем нажмите кнопку **Создать**.
...
[Azure Resource Manager](../resource-group-overview.md) используется для развертывания, контроля и мониторинга решения в виде группы. При удалении группы ресурсов будут удалены все компоненты внутри нее.
