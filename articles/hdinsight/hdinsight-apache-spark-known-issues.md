...
##Ошибка при загрузке записных книжек размером свыше 2 МБ

**Симптом**

При загрузке записных книжек, размер которых превышает 2 МБ, может возникнуть ошибка **`Error loading notebook`**.
