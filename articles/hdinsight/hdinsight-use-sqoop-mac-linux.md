...
> [AZURE.IMPORTANT] Если вы используете кластер HDInsight и базу данных SQL, созданную по инструкциям в разделе [Создание кластера и базы данных SQL](hdinsight-use-sqoop.md), не выполняйте действия, описанные в этом разделе, так как, выполняя эти инструкции, вы уже создали базу данных и таблицу.
...
3. Используя SSH подключение к HDInsight, выполните следующую команду, чтобы проверить, видна ли баз данных SQL в Sqoop:
