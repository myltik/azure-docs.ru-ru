...
3. Введите следующие значения.
	...
	- **Тип кластера** — HBase
	- **Операционная система кластера** — сейчас кластер HBase HDInsight доступен только на ОС Windows.
	...
	- **Необязательная конфигурация** — выберите версию кластера, настройте виртуальную сеть Azure, метахранилище Hive или Oozie, действие сценария и добавьте учетные записи хранения.
