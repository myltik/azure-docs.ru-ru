---
title: "Руководство по HBase. Приступая к работе с HBase в Hadoop | Документация Майкрософт"
...
Узнайте, как создавать кластеры HBase на HDInsight, создавать таблицы HBase и запрашивать таблицы с помощью Apache Hive. Общие сведения об HBase см. в статье об [HBase в HDInsight][hdinsight-hbase-overview].
...
> [!NOTE]
> HBase (версия 0.98.0) на HDInsight под управлением Windows доступна только для использования с кластерами HDInsight версии 3.1 (на основе Apache Hadoop и YARN версии 2.4.0). Подробные сведения о версиях ПО см. в статье [Что представляют собой различные компоненты Hadoop, доступные в HDInsight?][hdinsight-versions].
> 
> 
...
1. Выполните вход на [портал Azure][azure-management-portal].
...
1. Используйте RDP для подключения к кластеру HBase на HDInsight. Для получения инструкций см. статью [Управление кластерами Hadoop в HDInsight с помощью портала Azure][hdinsight-manage-portal].
...
6. Получите одну строку
    ...
    Дополнительные сведения о схеме таблицы HBase см. в документе [Introduction to HBase Schema Design][hbase-schema] (Общие сведения о проектировании схемы HBase). Сведения о других командах HBase см. в [справочнике по Apache HBase][hbase-quick-start].
...
* [Обзор HBase в HDInsight][hdinsight-hbase-overview].
