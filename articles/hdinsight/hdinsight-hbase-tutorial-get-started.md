...
> [!NOTE]
> HBase (версия 0.98.0) на HDInsight под управлением Windows доступна только для использования с кластерами HDInsight версии 3.1 (на основе Apache Hadoop и YARN версии 2.4.0). Сведения о версиях см. в статье [Что представляют собой различные компоненты Hadoop, доступные в HDInsight?][hdinsight-versions]
> 
> 
