...
1. Выполните вход на [портал предварительной версии Azure][azure-management-portal].
2. Щелкните **Создать** в верхнем левом углу и последовательно выберите **Данные и аналитика**, **HDInsight**.
3. Введите следующие значения.
	...
	- **Группа ресурсов** — добавьте группу ресурсов Azure или выберите существующую. Дополнительную информацию см. в разделе [Обзор диспетчера ресурсов Azure](resource-group-overview.md).
