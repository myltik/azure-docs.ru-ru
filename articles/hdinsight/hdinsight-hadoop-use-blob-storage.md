...
После создания учетной записи хранения используйте следующую команду для получения ключей учетной записи хранения:
...
Если у вас уже [установлен и настроен Azure PowerShell][powershell-install], можно выполнить следующие действия в командной строке Azure PowerShell для создания учетной записи хранения и контейнера:
