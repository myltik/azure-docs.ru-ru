---
title: "Запрос данных из HDFS-совместимых BLOB-хранилищ | Документация Майкрософт"
...
---
# <a name="use-hdfscompatible-azure-blob-storage-with-hadoop-in-hdinsight"></a>Использование хранилища BLOB-объектов Azure с HDInsight
...
Сведения о создании кластера HDInsight см. в статьях о [начале работы с HDInsight][hdinsight-get-started] или о [создании кластеров HDInsight][hdinsight-creation].
...
![Кластеры Hadoop используют API-Интерфейс HDFS для доступа и хранения структурированных и неструктурированных данных в хранилище BLOB-объектов.](./media/hdinsight-hadoop-use-blob-storage/HDI.WASB.Arch.png "HDInsight Storage Architecture")
...
> [!NOTE]
> В версиях HDInsight до версии 3.0 вместо префикса `asv://` использовался префикс `wasb://`. `asv://` не следует использовать с кластерами HDInsight версии 3.0 и выше, так как это приведет к ошибке.
> 
> 
...
Помимо этой учетной записи хранения в процессе создания или после создания кластера можно добавить дополнительные учетные записи хранения из той же или других подписок Azure. Инструкции по добавлению дополнительных учетных записей хранения см. в статье о [создании кластеров HDInsight][hdinsight-creation].
