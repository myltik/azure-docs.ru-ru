---
title: 'Учебник по Apache Storm: начало работы со Storm под управлением Linux в HDInsight | Microsoft Docs'
...
2. Запустите пример топологии, используя следующую команду:
   ...
   > [!NOTE]
   > При обновлении HDinsight до более новых версий Storm часть имени файла `0.10.0.2.4.2.4-5` может измениться.
   > 
   > 
...
1. Откройте веб-браузер и перейдите по адресу https://CLUSTERNAME.azurehdinsight.net/stormui, где **CLUSTERNAME** — это имя вашего кластера. Откроется пользовательский интерфейс Storm.
