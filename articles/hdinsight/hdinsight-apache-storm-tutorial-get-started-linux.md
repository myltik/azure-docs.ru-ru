...
> [AZURE.NOTE]С помощью действий, описанных в данной статье, можно создать кластер HDInsight под управлением Linux. Действия по созданию Storm под управлением Windows в кластере HDInsight см. в статье [Учебник по Apache Storm: начало работы с примерами Storm Starter для анализа больших данных в HDInsight](hdinsight-apache-storm-tutorial-get-started.md)
...
2. Последовательно выберите элементы **СОЗДАТЬ**, __Анализ данных__ и __HDInsight__.
	...
	![Создание нового кластера на портале предварительной версии Azure](./media/hdinsight-apache-storm-tutorial-get-started-linux/new-cluster.png)
...
8. Выберите пункт __Необязательная конфигурация__. В этой колонке можно выбрать версию кластера, а также настроить другие необязательные параметры, включая присоединение к __виртуальной сети__ или настройку __пользовательского метахранилища__ для хранения данных Hive и Oozie.
...
2. Запустите пример топологии, используя следующую команду:
	...
	> [AZURE.NOTE]При обновлении HDinsight на более новые версии Storm часть имени файла `0.9.3.2.2.4.9-1` может измениться.
