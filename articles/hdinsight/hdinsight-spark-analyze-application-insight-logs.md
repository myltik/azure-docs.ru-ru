...
Сведения о добавлении дополнительного хранилища в имеющийся кластер HDInsight см. статье [Добавление дополнительных учетных записей хранения в HDInsight](hdinsight-hadoop-add-storage.md).
