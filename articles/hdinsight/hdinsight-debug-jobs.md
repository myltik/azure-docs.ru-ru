...
- **Устранение**. Укажите допустимый URL-адрес большого двоичного объекта. Этот URL-адрес ДОЛЖЕН быть записан полностью, включая префикс *http://* и окончание *.com*. Полный URL-адрес обычно находится на вкладке хранилища на портале manage.windowsazure.com.
