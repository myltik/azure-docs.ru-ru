...
* [Analyze Application Insights telemetry logs with Spark on HDInsight](hdinsight-spark-analyze-application-insight-logs.md) (Анализ журналов телеметрии Application Insights с помощью Spark в HDInsight)
