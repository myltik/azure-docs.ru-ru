...
![Spark: единая платформа](./media/hdinsight-apache-spark-overview/hdinsight-spark-overview.png)
...
![Сравнительная характеристика традиционной модели MapReduce и Spark](./media/hdinsight-apache-spark-overview/mapreduce-vs-spark.png)
...
![Архитектура кластера Spark](./media/hdinsight-apache-spark-overview/spark-architecture.png)
...
[Ознакомьтесь с руководством по прогнозированию температуры в зданиях с помощью данных системы кондиционирования](hdinsight-apache-spark-ipython-notebook-machine-learning.md)
