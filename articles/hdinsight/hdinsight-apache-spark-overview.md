...
| Функция | Описание |
|-------------------------------------|-------------------|
| Простота подготовки | Подготовка нового кластера Spark в HDInsight с помощью классического портала Azure, Azure PowerShell или пакета SDK .NET HDInsight занимает всего несколько минут. См. раздел [Подготовка кластера Spark в HDInsight](hdinsight-apache-spark-provision-clusters.md). |
