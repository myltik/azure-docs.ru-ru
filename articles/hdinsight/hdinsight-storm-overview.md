...
> [AZURE.NOTE]Кластеры Storm также можно подготавливать к работе с помощью [Azure CLI](../xplat-cli.md) или [Azure PowerShell](../powershell-install-configure.md).
...
Примеры чистых топологий Java и Trident см. в каталоге **%storm\_home%\\contrib\\storm-starter** в своем кластере Storm в HDInsight.
