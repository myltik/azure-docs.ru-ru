...
Дополнительные сведения о средствах HDInsight для Visual Studio см. в статье [Приступая к работе с инструментами Hadoop в Visual Studio для HDInsight для выполнения запроса Hive](../HDInsight/hdinsight-hadoop-visual-studio-tools-get-started.md).
...
Примеры storm-starter расположены в каталоге __ /usr/hdp/current/storm-client/contrib/storm-starter__ в кластерах под управлением Linux и в каталоге **%storm_home%\contrib\storm-starter** в кластерах под управлением Windows.
