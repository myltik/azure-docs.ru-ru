...
Примеры storm-starter расположены в каталоге \_\_ /usr/hdp/current/storm-client/contrib/storm-starter\_\_ в кластерах под управлением Linux и каталоге **%storm\_home%\\contrib\\storm-starter** в кластерах под управлением Windows.
