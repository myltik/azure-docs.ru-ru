---
title: "Использование Hadoop Hive в консоли запросов в HDInsight | Документация Майкрософт"
...
## <a name="a-idruna-run-hive-queries-using-the-query-console"></a><a id="run"></a> Выполнение запросов Hive с помощью консоли запросов
