...
## Автоматизированное создание кластера
...
## Создание кластера с помощью портала Azure
...
## Включение нескольких параллельных подключений пользователей
...
### Шаг 1. Вход на граничный узел с помощью созданного пользователя SSH
...
### Шаг 2. Добавление дополнительных пользователей Linux на граничный узел
...
### Шаг 3. Использование версии RStudio Community с помощью созданного пользователя
...
## Доступ к данным в Hive и Parquet
...
## Установка дополнительных пакетов R на граничный узел
...
## Ввод в эксплуатацию для Microsoft R Server
...
### Кластер R Server в виртуальной сети
...
### Кластер RServer не настроен в виртуальной сети
...
## Как масштабировать вычислительные узлы системы ввода в эксплуатацию Microsoft R Server на рабочих узлах HDInsight?
...
### Настройка вычислительных узлов на каждом из рабочих узлов, выведенных из эксплуатации
...
### Добавление сведений о вычислительных узлах на веб-узел
