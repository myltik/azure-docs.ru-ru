...
> [!NOTE]
> Информация, приведенная в этой статье, относится только к кластерам HDInsight под управлением Linux. Сведения о работе с кластерами под управлением Windows см. в статье [Установка и использование Giraph в HDInsight](hdinsight-hadoop-giraph-install.md).
> 
> 

## <a name="a-namewhatisawhat-is-giraph"></a><a name="whatis"></a>Что такое Giraph
...
## <a name="a-nameinstallainstall-giraph-using-script-actions"></a><a name="install"></a>Установка Giraph с помощью действий сценария
...
## <a name="a-nameusegiraphahow-do-i-use-giraph-in-hdinsight"></a><a name="usegiraph"></a>Как использовать Giraph в HDInsight
...
6. После завершения задания результаты будут храниться в двух выходных файлах в каталоге **wasbs:///example/out/shotestpaths**. Созданные файлы будут начинаться с **part-m-** и заканчиваться числом, указывающим номер файла (первый, второй и т. д.). Для просмотра выходных данных используйте следующую команду:
