...
> [!IMPORTANT]
> В Kafka нет сведений о базовом оборудовании (стойке) в центре обработки данных Azure. Чтобы обеспечить правильное распределение секций в базовом оборудовании, см. руководство по [настройке высокого уровня доступности данных (Kafka)](apache-kafka-high-availability.md).
