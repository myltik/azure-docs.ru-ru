...
2. Когда ядро будет готово, вставьте указанный ниже код в пустую ячейку и нажмите клавиши **SHIFT+ВВОД**, чтобы выполнить код. Выходные данные должны содержать имя таблицы `hivesampletable`, доступной в кластере по умолчанию.
