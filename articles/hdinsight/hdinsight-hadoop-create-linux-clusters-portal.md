...
3. Введите:
    ...
    - **Имя кластера**: это имя должно быть глобально уникальным.
    - **Тип кластера**: если вы не знаете, что выбрать, выберите **Hadoop**.
    - **Операционная система кластера**: выберите **Linux**.
