---
title: "Создание кластеров Azure HDInsight (Hadoop) с помощью веб-браузера | Документация Майкрософт"
...
3. В колонке **HDInsight** щелкните **Custom (size, settings, apps)** (Пользовательские (параметры, приложения, размер)), **Основы** и введите следующие сведения.
    ...
    ![Создание кластера на портале Azure](./media/hdinsight-hadoop-create-linux-cluster-portal/HDI.CreateCluster.basics.png "Создание кластера на портале Azure")
...
4. В колонке **Хранилище** укажите нужное хранилище по умолчанию: служба хранилища Azure (WASB) или Data Lake Store. Дополнительные сведения см. в таблице ниже.
    ...
    ![Создание кластера на портале Azure](./media/hdinsight-hadoop-create-linux-cluster-portal/HDI.CreateCluster.storage.png "Создание кластера на портале Azure")
...
6. Щелкните **Размер кластера**, чтобы отобразить сведения об узлах, которые будут созданы для этого кластера. Задайте количество рабочих узлов, необходимых для кластера. Оценочная стоимость кластера отобразится в колонке.
    ...
    ![Колонка "Ценовые категории узлов"](./media/hdinsight-hadoop-create-linux-cluster-portal/HDI.CreateCluster.nodes.png "Указание количества узлов кластера")
...
7. Щелкните **Дополнительные параметры**, чтобы настроить другие необязательные параметры, например присоединение к **виртуальной сети** или настройку кластера для установки пользовательских компонентов с помощью **действий сценария**. Дополнительные сведения см. в таблице ниже.
    ...
    ![Колонка "Ценовые категории узлов"](./media/hdinsight-hadoop-create-linux-cluster-portal/HDI.CreateCluster.advanced.png "Указание количества узлов кластера")
...
8. Проверьте сведения, введенные ранее в колонке **Сводка** и нажмите кнопку **Создать**.
    ...
    ![Колонка "Ценовые категории узлов"](./media/hdinsight-hadoop-create-linux-cluster-portal/HDI.CreateCluster.summary.png "Указание количества узлов кластера")
...
12. После завершения процесса создания щелкните элемент кластера на начальной панели, чтобы открыть колонку кластера. В колонке кластера содержатся следующие сведения.
    ...
    ![Колонка "Кластер"](./media/hdinsight-hadoop-create-linux-cluster-portal/HDI.CreateCluster.completed.png "Свойства кластера")
