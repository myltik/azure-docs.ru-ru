...
* Примеры файлов взяты из статьи [https://github.com/Blackmist/hdinsight-azure-storage-sas](https://github.com/Blackmist/hdinsight-azure-storage-sas). Этот репозиторий содержит следующее:
...
В настоящее время хранимые политики создаются программным способом. Примеры кода для создания хранимой политики и SAS на C# и Python см. на странице [https://github.com/Blackmist/hdinsight-azure-storage-sas](https://github.com/Blackmist/hdinsight-azure-storage-sas).
...
2. В командной строке выполните следующую команду для проверки подлинности в подписке Azure:

        Login-AzureRmAccount
    
    При появлении запроса войдите в систему, используя учетную запись своей подписки Azure.
    
    Если ваше имя входа связано с несколькими подписками Azure, выберите нужную подписку с помощью командлета `Select-AzureRmSubscription`.
