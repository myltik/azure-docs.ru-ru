...
![Потоковая обработка с помощью HDInsight и потоковой передачи Spark](./media/hdinsight-spark-streaming-overview/hdinsight-spark-streaming.png)
...
![Пример потока DStream с событиями температуры ](./media/hdinsight-spark-streaming-overview/hdinsight-spark-streaming-example.png)
...
![Пример начального окна с событиями температуры](./media/hdinsight-spark-streaming-overview/hdinsight-spark-streaming-window-01.png)

![Пример окна с событиями температуры после изменения слайда](./media/hdinsight-spark-streaming-overview/hdinsight-spark-streaming-window-02.png)
...
![Пример окна с событиями температуры после изменения слайда](./media/hdinsight-spark-streaming-overview/hdinsight-spark-streaming-livy.png)
...
* [Удаленная отправка заданий Spark в кластер Azure HDInsight с помощью Apache Spark REST API](hdinsight-apache-spark-livy-rest-interface.md)
