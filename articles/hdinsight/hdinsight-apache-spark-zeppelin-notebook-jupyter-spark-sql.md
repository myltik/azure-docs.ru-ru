...
3. Введите имя в поле **Имя кластера**, выберите значение **Spark** для параметра **Тип кластера** и в раскрывающемся меню **Операционная система кластера** выберите **Центр обработки данных Windows Server 2012 R2**. Рядом с именем кластера (если оно доступно) отобразится зеленый флажок.
