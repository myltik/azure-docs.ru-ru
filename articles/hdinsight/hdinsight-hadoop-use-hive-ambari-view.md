...
Вы увидите направленный ациклический граф (DAG), который используется Tez для этого запроса, если он существует. Чтобы просмотреть DAG для ранее выполненных запросов, используйте __представление Tez__.
...
2. Нажмите кнопку __Сохранить как__ в нижней части окна редактора. Назовите этот запрос __Errorlogs__ и нажмите __ОК__. Обратите внимание, что имя листа изменилось на __Errorlogs__.
...
* имя ресурса — myudfs;
* путь к ресурсу — wasb:///myudfs.jar;
