...
4. Откроется страница, аналогичная следующей:
	...
	> [AZURE.NOTE] Обратите внимание на URL-адрес для этой страницы. URL-адрес должен быть похож на \_\_http://hn1-CLUSTERNAME.randomcharacters.cx.internal.cloudapp.net:8088/cluster__. Этот адрес использует полное внутреннее доменное имя узла (FQDN), и он недоступен без использования туннеля SSH.
