...
HDInsight предоставляет Spark как тип кластера первого класса для кластеров на основе Windows. Это означает, что теперь можно создать кластер Spark без изменения кластера Hadoop. С помощью типа кластера Spark вы получаете кластер HDInsight версии 3.2 с версией Spark 1.3.1. Для установки различных версий Spark можно использовать действие сценария. В HDInsight есть пример действия сценария.

**Связанные статьи** — [Установка Spark в кластерах HDInsight под управлением Linux](hdinsight-hadoop-spark-install-linux.md). — [Создание кластеров Hadoop в HDInsight](hdinsight-provision-clusters.md). Общие сведения о создании кластеров HDInsight. — [Приступая к работе с Apache Spark в HDInsight](hdinsight-apache-spark-zeppelin-notebook-jupyter-spark-sql.md). Создание кластера типа Spark в ОС Windows. — [Настройка кластера HDInsight с помощью действия сценария][hdinsight-cluster-customize]. Общие сведения о настройке кластеров HDInsight с помощью действия сценария. — [Разработка скриптов действия сценария для HDInsight](hdinsight-hadoop-script-actions.md).
...
- При использовании сценария с создаваемым кластером **HDInsight 3.2** устанавливается **Spark 1.2.0**.
- При использовании сценария с создаваемым кластером **HDInsight 3.1** устанавливается **Spark 1.0.2**.
...
- [Приступая к работе с Apache Spark в HDInsight](hdinsight-apache-spark-zeppelin-notebook-jupyter-spark-sql.md). Приступая к работе со Spark в HDInsight
