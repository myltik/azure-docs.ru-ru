...
Этот учебник по Hadoop поможет вам быстро приступить к работе с Azure HDInsight в Linux. В нем рассказывается о том, как подготовить кластер Hadoop в Linux и отправить запрос Hive для получения полезной информации из неструктурированных данных.
