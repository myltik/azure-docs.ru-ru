...
> ```set hive.execution.engine=tez;```
> 
> Эти характеристики можно настроить для определенных запросов, поместив их в начале кода вашего запроса. Также можно задействовать эти характеристики по умолчанию для кластера, установив значения конфигурации при создании кластера. За более подробной информацией обращайтесь к разделу [Распределение кластеров HDInsight](hdinsight-hadoop-provision-linux-clusters.md).
> 
> 
