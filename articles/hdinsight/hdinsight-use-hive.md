...
* [Use a Java User Defined Function with Hive](hdinsight-hadoop-hive-java-udf.md) (Использование определяемых пользователем функций Java с помощью Hive)
...
Следующие операторы HiveQL позволяют создать столбцы из данных с разделителями, хранящихся в каталоге **wasb:///example/data**.
