...
2. В колонке __Размер кластера__ укажите количество дисков в поле __Disks per worker node__ (Число дисков на рабочий узел).
