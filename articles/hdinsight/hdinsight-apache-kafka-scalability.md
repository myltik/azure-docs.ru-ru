...
2. В разделе __Размер кластера__ укажите число дисков в поле __Число дисков на рабочий узел__.
    ...
    ![Изображение раздела "Размер кластера" с выделенным полем "Число дисков на рабочий узел"](./media/hdinsight-apache-kafka-scalability/set-managed-disks-portal.png)
