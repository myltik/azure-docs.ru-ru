...
> 
> В этом документе также содержатся сведения об использовании пакета SDK .NET для HDInsight. Представленные фрагменты кода основаны на командах, использующих пакет управления службами Azure (ASM) для работы с HDInsight, и являются **устаревшими**. Эти команды будут удалены с 1 января 2017 г.
> 
...
> [!NOTE]
> При создании сертификата, обязательно запомните использованное понятное имя, так как оно будет использоваться позднее.
> 
> 
...
2. Нажмите клавишу **ВВОД** для завершения работы приложения.
