---
title: Указатель статей о HDInsight для классического портала Azure | Microsoft Docs
...
> [!IMPORTANT]
> Эта страница указателя документации предназначена для клиентов, у которых уже есть развернутые решения на текущем классическом портале Azure.
> 
