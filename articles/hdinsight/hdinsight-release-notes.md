...
| Высокий уровень доступности содержимого Jupyter | Предоставлена возможность сохранять и загружать содержимое записной книжки Jupyter как в учетную запись хранения, связанную с кластером, так и из нее. Дополнительные сведения см. в статье [Ядра, доступные для использования с записными книжками Jupyter с кластерами HDInsight Spark на платформе Linux в HDInsight (предварительная версия)](hdinsight-apache-spark-jupyter-notebook-kernels.md).| Записные книжки | Spark в Linux| Недоступно
| Удаление hiveContext в записных книжках Jupter | Используйте магическую команду `%%sql` вместо `%%hive`. SqlContext является эквивалентом hiveContext. Дополнительные сведения см. в статье [Ядра, доступные для использования с записными книжками Jupyter с кластерами HDInsight Spark на платформе Linux в HDInsight (предварительная версия)](hdinsight-apache-spark-jupyter-notebook-kernels.md).| Записные книжки | Кластеры Spark в Linux| Недоступно
