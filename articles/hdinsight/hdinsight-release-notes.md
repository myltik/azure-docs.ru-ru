...
## Заметки о выпуске R Server в HDinsight от 30.08.2016
...
- R Server 8.0.5 — это, главным образом, выпуск для исправления ошибок. Дополнительные сведения см. в статье [R Server Release Notes](https://msdn.microsoft.com/microsoft-r/notes/r-server-notes) (Заметки о выпуске R Server).
