...
### Драйверы
Драйвер Java Database Connnectivity (JDBC) для SQL Server используется внутри HDInsight и не используется для внешних операций. Если вы хотите использовать Open Database Connectivity (ODBC) для подключения к HDInsight, используйте драйвер Microsoft Hive ODBC. Дополнительную информацию см. в разделе [Подключение Excel к HDInsight с помощью драйвера Microsoft Hive ODBC](../../articles/hdinsight/hdinsight-connect-excel-hive-odbc-driver.md).
