...
2. На левой панели щелкните **Обзор**, а затем **Кластеры HDInsight**.
...
7. Выберите вкладку **Конфигурации**.
8. Щелкните **Hive** в меню слева.
9. Выберите вкладку **Дополнительно**.
10. Прокрутите вниз и разверните раздел **Расширенный сайт Hive**.
...
См. [Создание кластеров под управлением Linux в HDInsight с помощью пакета SDK для .NET](hdinsight-hadoop-create-linux-clusters-dotnet-sdk#use-bootstrap).
