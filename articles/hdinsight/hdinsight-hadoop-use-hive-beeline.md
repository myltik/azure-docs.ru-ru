...
3. Чтобы сохранить файл, нажмите клавиши __CTRL__ + __X__, введите __Y__ и нажмите клавишу __ВВОД__.
...
Если компонент Beeline установлен на клиенте вне кластера, к нему можно подключиться с помощью следующей команды. Замените __CLUSTERNAME__ именем кластера HDInsight. Замените __PASSWORD__ паролем администратора (имени для входа по протоколу HTTP).
