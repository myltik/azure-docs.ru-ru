...
## <a name="a-idbeelineause-the-beeline-command"></a><a id="beeline"></a>Использование команды Beeline
...
## <a name="a-idfilearun-a-hiveql-file"></a><a id="file"></a>Запуск файла HiveQL.
...
## <a name="a-idsummaryaa-idnextstepsanext-steps"></a><a id="summary"></a><a id="nextsteps"></a>Дальнейшие действия
