---
title: Использование действия сценария для установки Solr в кластере Hadoop | Microsoft Docs
...
* [Установка Solr в кластерах HDInsight](hdinsight-hadoop-solr-install.md). Установка Solr в кластер HDInsight на портале Azure
