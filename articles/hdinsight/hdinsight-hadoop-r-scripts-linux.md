---
title: Установка R в HDInsight на основе Linux | Microsoft Docs
...
2. В колонке **Необязательная конфигурация** выберите **Действия сценария** и введите следующие сведения:
   ...
   * **УНИВЕРСАЛЬНЫЙ КОД РЕСУРСА (URI) СКРИПТА**: https://hdiconfigactions.blob.core.windows.net/linuxrconfigactionv01/r-installer-v01.sh.
