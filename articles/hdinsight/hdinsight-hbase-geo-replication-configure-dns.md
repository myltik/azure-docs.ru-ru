---
title: Настройка DNS между двумя виртуальными сетями Azure | Microsoft Docs
...
5. В рамках сеанса RDP нажмите кнопку Windows в левом нижнем углу, чтобы открыть начальный экран.
6. Щелкните плитку **Диспетчер серверов**.
7. Щелкните **Добавить роли и компоненты**.
8. Нажмите кнопку **Далее**.
9. Выберите **Role-based or feature-based installation** (Установка на основе ролей или функций), а затем нажмите **Next**.
10. Выберите виртуальную машину DNS (она должна быть уже выделена), а затем нажмите кнопку **Далее**.
11. Установите флажок **DNS-сервер**.
12. Нажмите **Добавить компоненты**, а затем **Продолжить**.
13. Нажмите кнопку **Далее** три раза, а затем нажмите **Установить**.
