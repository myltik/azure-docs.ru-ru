...
Чтобы использовать пользовательский интерфейс Yarn, в консоли запросов HDInsight щелкните **Пользовательский интерфейс Hadoop**. См. раздел [Открытие консоли запросов HDInsight](#open-hdinsight-query-console).
