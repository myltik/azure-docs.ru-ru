...
4. Дважды щелкните кластер в списке, чтобы просмотреть подробные сведения о нем.
	...
	**Меню и основная информация**:
	...
	- **Панель мониторинга**, **панель мониторинга кластера** и **URL-адрес: это все способы доступа к панели мониторинга кластера, являющейся веб-интерфейсом Ambari для кластеров на основе Linux. 
	**Secure Shell**: отображает инструкции для подключения к кластеру с помощью соединения SSH (Secure Shell).
