...
## <a name="a-namebestpracticescriptingabest-practices-for-script-development"></a><a name="bestPracticeScripting"></a>Рекомендации по разработке сценариев
...
### <a name="a-namebps1atarget-the-hadoop-version"></a><a name="bPS1"></a>Выбор целевой версии Hadoop
...
### <a name="a-namebps10a-target-the-os-version"></a><a name="bps10"></a> Выбор версии ОС
...
### <a name="a-namebps2aprovide-stable-links-to-script-resources"></a><a name="bPS2"></a>Предоставление стабильных ссылок на ресурсы сценария
...
### <a name="a-namebps4ause-pre-compiled-resources"></a><a name="bPS4"></a>Использование предварительно скомпилированных ресурсов
...
### <a name="a-namebps3aensure-that-the-cluster-customization-script-is-idempotent"></a><a name="bPS3"></a>Обеспечение идемпотентности сценария настройки кластера
...
### <a name="a-namebps5aensure-high-availability-of-the-cluster-architecture"></a><a name="bPS5"></a>Обеспечение высокого уровня доступности кластера
...
### <a name="a-namebps6aconfigure-the-custom-components-to-use-azure-blob-storage"></a><a name="bPS6"></a>Настройка пользовательских компонентов для использования хранилища больших двоичных объектов Azure
...
### <a name="a-namebps8a-save-files-as-ascii-with-lf-line-endings"></a><a name="bps8"></a> Сохранение файлов в формате ASCII с использованием LF в качестве символа завершения строки
...
## <a name="a-namecommonusageacommon-usage-patterns"></a><a name="commonusage"></a>Общие варианты использования
...
## <a name="a-namerunscriptactionahow-to-run-a-script-action"></a><a name="runScriptAction"></a>Как запустить действие сценария
...
## <a name="a-namesamplescriptsacustom-script-samples"></a><a name="sampleScripts"></a>Примеры пользовательских сценариев
...
## <a name="a-nameseealsoanext-steps"></a><a name="seeAlso"></a>Дальнейшие действия
