...
#### <a name="hortonworks-repository"></a>Репозиторий Hortonworks

Решение HDInsight основано на платформе данных Hortonworks Data Platform. Чтобы обеспечить совместимость проекта с версиями Storm и Hadoop в HDInsight 3.5, в следующем разделе выполняется настройка проекта для использования компонентов Hortonworks.
