---
title: Выполнение учебных задач Hadoop в Azure HDInsight | Microsoft Docs
...
> [!NOTE]
> Шаги, описанные в этом учебнике, можно применять только к кластерам HDInsight под управлением Windows. Пример потоковой передачи для HDInsight под управлением Linux см. в статье [Разработка программ потоковой передачи Python для HDInsight](hdinsight-hadoop-streaming-python.md).
> 
> 
