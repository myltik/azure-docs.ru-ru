...
HDInsight предоставляет конфигурации кластера для Hadoop, HBase или Storm. Вы также можете <a href="http://azure.microsoft.com/documentation/articles/hdinsight-hadoop-customize-cluster/" target="_blank">настроить кластеры с помощью действий сценария</a>.
