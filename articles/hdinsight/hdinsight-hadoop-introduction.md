...
**Развертывание** | Портал управления Azure, интерфейс командной строки Azure, Azure PowerShell | Портал управления Azure, интерфейс командной строки Azure, Azure PowerShell, пакет SDK для .NET для HDInsight
