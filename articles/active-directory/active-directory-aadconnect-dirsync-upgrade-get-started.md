...
8. На странице "Приступить к настройке" снимите флажок "Запустить синхронизацию сразу после завершения настройки".
