<properties 
    pageTitle="Руководство. Интеграция Azure Active Directory с Zscaler ZSCloud | Microsoft Azure" description="Узнайте, как использовать Zscaler ZSCloud вместе с Azure Active Directory для реализации единого входа, автоматической подготовки пользователей и выполнения других задач." 
...
4.  Для загрузки сертификата на странице **Настройка единого входа в ZScaler ZSCloud** нажмите кнопку **Загрузить сертификат** и сохраните файл сертификата на своем компьютере.
...
9.  На странице диалогового окна **Настройка параметров единого входа в SAML** выполните следующие действия и нажмите кнопку **Готово**.
    ...
    3.  Чтобы передать загруженный сертификат, щелкните **ZScaler pem**.
