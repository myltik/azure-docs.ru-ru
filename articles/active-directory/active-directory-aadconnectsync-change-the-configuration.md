...
Дополнительные сведения о [декларативной подготовке](active-directory-aadconnectsync-understanding-declarative-provisioning.md) и параметрах, доступных в правилах синхронизации.
