---
title: Руководство по интеграции Azure Active Directory с Litmos | Microsoft Docs
...
3. Войдите на сайт Litmos вашей компании (например, *https://azureapptest.litmos.com/account/Login*) с правами администратора.
...
13. В меню в верхней части экрана выберите пункт **Атрибуты**, чтобы открыть диалоговое окно **Атрибуты токена SAML**.
