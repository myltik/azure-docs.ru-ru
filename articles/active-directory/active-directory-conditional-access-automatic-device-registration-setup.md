...
> [!NOTE]
> Присоединенные к домену компьютеры Windows 10 автоматически регистрируются в Azure AD, только если задан объект групповой политики развертывания.
> 
> 
...
> [!NOTE]
> Групповая политика для управления развертыванием также активирует регистрацию присоединенных к домену компьютеров Windows 8.1. Эту политику можно использовать для регистрации присоединенных к домену компьютеров Windows 8.1. Или при наличии разных версий Windows, включая Windows 7 или Windows Server, все компьютеры не на базе Windows 10 и Windows Server 2016 можно зарегистрировать с помощью пакета установщика Windows.
> 
> 
