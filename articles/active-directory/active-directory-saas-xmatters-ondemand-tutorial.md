...
1.  На странице интеграции с приложением **xMatters OnDemand** классического портала Azure щелкните **Настройка единого входа**, чтобы открыть соответствующее диалоговое окно.
...
3.  На странице **Настройка URL-адреса приложения** выполните следующие действия.
	...
	а. В текстовом поле **xMatters OnDemand Sign In URL** (URL-адрес входа в xMatters OnDemand) введите URL-адрес в следующем формате: `https://<tenant-name>.XMattersOnDemandapp.com`.
...
7.  На странице **Настройка SAML** сделайте следующее:
    ...
    2.  На странице диалогового окна **Configure single sign-on at xMatters OnDemand** (Настройка единого входа в xMatters OnDemand) классического портала Azure скопируйте значение поля **Идентификатор поставщика удостоверений** и вставьте его в текстовое поле **Идентификатор поставщика удостоверений**.
    3.  На странице диалогового окна **Configure single sign-on at xMatters OnDemand** (Настройка единого входа в xMatters OnDemand) классического портала Azure скопируйте значение поля **URL-адрес службы единого входа** и вставьте его в текстовое поле **URL-адрес для единого входа**.
    4.  На странице диалогового окна **Configure single sign-on at xMatters OnDemand** (Настройка единого входа в xMatters OnDemand) классического портала Azure скопируйте значение поля **URL-адрес службы единого выхода** и вставьте его в текстовое поле **Single Logout URL** (URL-адрес для единого выхода).
