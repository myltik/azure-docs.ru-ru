...
1. На портале управления Azure в области навигации слева щелкните **Active Directory**. <br><br>![Настройка единого входа][1]<br>
...
1. На странице интеграции с приложением **DocuSign** портала Azure AD щелкните **Настройка единого входа**, чтобы открыть диалоговое окно «Настройка единого входа». <br><br>![Настройка единого входа][7]<br>
...
8. В разделе **Настройка SAML 2.0** выполните следующие действия: <br><br>![Настройка единого входа][13]<br>
    ...
    а. На странице **Настройка единого входа в DocuSign** портала Azure скопируйте значение поля «URL-адрес издателя» и вставьте его в текстовое поле **URL-адрес конечной точки поставщика удостоверений**.
...
9. На портале Azure AD выберите **подтверждение конфигурации единого входа** и нажмите кнопку **Далее**. <br><br>![Приложения][14]<br>
...
1. На странице **интеграции приложений DocuSign** **портала управления Azure** нажмите **Настроить подготовку учетных записей пользователей**, чтобы открыть диалоговое окно «Настройка подготовки учетных записей пользователей». <br><br>![Настройка подготовки учетных записей][30]<br>
...
В качестве первого шага проверки можно проверить состояние подготовки, щелкнув «Панель мониторинга» в разделе D на странице интеграции приложения DocuSign портала управления Azure. <br><br>![Назначение пользователей][42]<br>
