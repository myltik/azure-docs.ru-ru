...
-   **Администратор** может назначать группам людей совместно используемые имена для входа и пароли, используя функцию обновления учетных данных при [назначении групп приложениям](#assign-an-application-to-a-group-directly).

Ниже представлены сведения о том, как включить [единый вход по паролю](https://docs.microsoft.com/azure/active-directory/active-directory-appssoaccess-whatis#how-does-single-sign-on-with-azure-active-directory-work) для приложения, которое уже находится в [коллекции приложений Azure AD](https://docs.microsoft.com/azure/active-directory/active-directory-appssoaccess-whatis#get-started-with-the-azure-ad-application-gallery).

## <a name="overview-of-steps-required"></a>Обзор необходимых действий
Чтобы настроить единый вход для приложения из коллекции Azure AD, сделайте следующее:

-   [Добавьте приложение из коллекции Azure AD](#add-an-application-from-the-azure-ad-gallery).

-   [Настройте приложение для единого входа на основе пароля](#configure-the-application-for-password-single-sign-on).

-   [Назначьте приложение для пользователя или группы](#assign-the-application-to-a-user-or-a-group).
...
7.  Выберите приложение, для которого необходимо настроить единый вход.
...
11. Наведите в списке указатель мыши на **группу**, чтобы отобразить **флажок**. Чтобы добавить пользователя в список **Выбрано**, установите флажок рядом с фотографией или логотипом профиля этой группы.
