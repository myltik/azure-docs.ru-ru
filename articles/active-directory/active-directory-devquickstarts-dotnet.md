...
Теперь, когда приложение зарегистрировано в Azure AD, можно установить библиотеку ADAL и написать код для работы с удостоверением. Чтобы библиотека ADAL имела возможность взаимодействовать с Azure AD, необходимо предоставить ей некоторые регистрационные сведения  приложения. Начните с добавления библиотеки ADAL в проект DirectorySearcher с помощью консоли диспетчера пакетов.
