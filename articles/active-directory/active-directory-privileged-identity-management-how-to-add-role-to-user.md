---
title: Как добавить или удалить роль пользователя | Microsoft Docs
...
> [!NOTE]
> Если приложение PIM еще не включено на портале Azure, см. статью [Приступая к работе с Azure AD PIM](active-directory-privileged-identity-management-getting-started.md).
> 
> 
