...
- Не поддерживается свойство **домашней страницы**, также известное как **URL-адрес входа**. Без домашней страницы эти приложения не будут отображаться на панели Office MyApps.
...
## Ограничения для рабочих и учебных учетных записей
...
##### Условный доступ на основе устройств, встроенные и мобильные приложения и Microsoft Graph
...
##### Встроенная проверка подлинности Windows для федеративных клиентов
