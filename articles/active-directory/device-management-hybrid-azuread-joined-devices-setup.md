...
- Устройства с обновлением Windows 10 от ноября 2015 г. автоматически присоединяются к Azure AD **только** в том случае, если задан объект групповой политики развертывания.
