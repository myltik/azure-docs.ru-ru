...
6. Щелкните на вкладке **Конфигурация поставщика удостоверений** и выполните следующие действия. <br><br> ![Настройка SAML](./media/active-directory-saas-citrix-gotomeeting-tutorial/IC6892321.png "Настройка SAML")
     ...
     6\.2. На диалоговой странице **Настройка единого входа в Citrix GoToMeeting** портала Azure скопируйте значение поля **URL-адрес страницы входа** и вставьте его в текстовое поле **URL-адрес страницы входа**.

     6\.3. На диалоговой странице **Настройка единого входа в Citrix GoToMeeting** портала Azure скопируйте значение поля **URL-адрес страницы выхода** и вставьте его в текстовое поле **URL-адрес страницы выхода**.

     6\.4. На диалоговой странице **Настройка единого входа в Citrix GoToMeeting** портала Azure скопируйте значение поля **Идентификатор сущности** и вставьте его в текстовое поле **Идентификатор сущности поставщика удостоверений**.

     6\.5. Для передачи загруженного сертификата нажмите кнопку **Отправить**.

     6\.6. Щелкните **Сохранить**.

6.  На портале Azure AD выберите подтверждение конфигурации единого входа и нажмите кнопку **Далее**.
...
1.  На странице интеграции приложения **Citrix GoToMeeting** портала управления Azure нажмите **Настроить подготовку учетных записей пользователей**, чтобы открыть диалоговое окно **Настроить подготовку учетных записей пользователей**.
...
В качестве первого шага проверки можно проверить состояние подготовки, щелкнув «Панель мониторинга» в разделе D на странице интеграции приложения **Citrix GoToMeeting** портала управления Azure.
