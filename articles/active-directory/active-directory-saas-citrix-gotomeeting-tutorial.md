<properties pageTitle="Учебник. Интеграция Azure Active Directory с Citrix GoToMeeting | Microsoft Azure" description="Узнайте, как использовать Citrix GoToMeeting вместе с Azure Active Directory для реализации единого входа, автоматической подготовки пользователей и выполнения других задач." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
...
1.  На странице интеграции с приложением **Citrix GoToMeeting** нажмите **Настройка единого входа**, чтобы открыть диалоговое окно **Настройка единого входа**.
    ...
    ![Включить единый вход](./media/active-directory-saas-citrix-gotomeeting-tutorial/IC768997.png "Включить единый вход")
...
3.  На странице **Настройка единого входа в Citrix GoToMeeting** нажмите кнопку **Загрузить сертификат**, а затем сохраните файл сертификата на свой компьютер.

    ![Настройка единого входа](./media/active-directory-saas-citrix-gotomeeting-tutorial/IC768999.png "Настройка единого входа")

4.  В другом окне браузер войдите в клиент Citrix GoToMeeting в качестве администратора.

5.  Откройте страницу [Настройка единого входа SAML 2.0](https://login.citrixonline.com/saml/settings.html) и выполните следующие действия.

    ![Настройка SAML](./media/active-directory-saas-citrix-gotomeeting-tutorial/IC689232.png "Настройка SAML")

    1.  Установите переключатель **Настроить вручную**.
    2.  На диалоговой странице **Настройка единого входа в Citrix GoToMeeting** портала Azure скопируйте значение поля **URL-адрес страницы выхода** и вставьте его в текстовое поле **URL-адрес страницы выхода**.
    3.  На диалоговой странице **Настройка единого входа в Citrix GoToMeeting** портала Azure скопируйте значение поля **URL-адрес страницы входа** и вставьте его в текстовое поле **URL-адрес страницы входа**.
    ...
    5.  Нажмите кнопку **Заменить сертификат** и передайте свой **файл сертификата в кодировке Base-64**.
...
1.  На странице интеграции приложений **Citrix GoToMeeting** портала управления Azure нажмите **Настроить подготовку учетных записей пользователей**, чтобы открыть диалоговое окно **Настроить подготовку учетных записей пользователей**.
...
2.  На странице **Имя администратора Citrix GoToMeeting** введите имя учетной записи Citrix GoToMeeting, располагающей правами администратора в отношении клиента Citrix GoToMeeting, и нажмите кнопку **Далее**.
...
2.  На странице интеграции приложения **Citrix GoToMeeting** нажмите **Назначить пользователей**.
