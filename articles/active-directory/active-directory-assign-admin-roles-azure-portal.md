...
- **Администратор приложений:** пользователи с этой ролью могут создавать и администрировать все приложения, управлять назначением лицензий, отслеживать работоспособность служб и управлять запросами к службам.

- **Разработчик приложений:** пользователи с этой ролью могут создавать приложения. Эта роль позволяет пользователям создавать приложения, даже если для параметра **UsersPermissionToCreateLOBAppsEnabled** (позволяющий создавать приложения всем пользователям) задано значение false.

- **Администратор прокси-службы приложения:** пользователи с этой ролью имеют разрешения на управление всеми аспектами прокси-службы приложения в Azure AD.
...
- **Администратор службы Skype для бизнеса.** У пользователей с этой ролью есть глобальные разрешения в Microsoft Skype для бизнеса при наличии этой службы. Дополнительные сведения см. в разделе "Роли администраторов в Office 365". Ранее эта роль называлась "Администратор службы Lync".
...
- **Чтение данных безопасности:** доступ только для чтения к ряду функций безопасности центра защиты идентификации, управления привилегированными пользователями, журналов аудита, отслеживания работоспособности служб Office 365 и Центра безопасности и соответствия требованиям Office 365.

* **Администратор службы**: управляет запросами на обслуживание и отслеживает работоспособность службы. Эта роль предоставляет все разрешения роли читателя данных безопасности (например, может также просматривать журналы аудита).
...
| Может | Не может |
| --- | --- |
| <p>Создавать приложения </p><p>Управлять собственными приложениями </p>|<p>Сброс паролей пользователей </p><p>Создание представлений пользователя и управление ими</p><p>Создание, изменение, удаление пользователей и групп, а также управление пользовательскими лицензиями</p><p>Управление доменами</p><p>Управление информацией о компании </p><p>Делегирование административных ролей другим пользователям</p><p>Использование синхронизации каталогов</p><p>Просматривать отчеты журналов аудита</p>|

###<a name="application-developer"></a>Разработчик приложений

| Может | Не может |
| --- | --- |
|<p>Просматривать сведения о каталоге </p><p>Создавать и администрировать все приложения </p><p>Назначать лицензии и получать доступ к приложениям </p><p>Управлять запросами в службу поддержки Office и отслеживать работоспособность служб</p><p>Выполнение операций выставления счетов и приобретения продуктов Office</p><p>Просматривать отчеты журналов аудита</p>|<p>Сброс паролей пользователей </p><p>Создание представлений пользователя и управление ими </p><p>Создавать, изменять и удалять пользователей и группы</p><p>Управление доменами </p><p>Управление информацией о компании</p><p>Делегирование административных ролей другим пользователям </p><p>Использование синхронизации каталогов</p>|
