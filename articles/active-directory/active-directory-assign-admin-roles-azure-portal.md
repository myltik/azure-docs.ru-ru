...
С помощью Azure Active Directory (Azure AD) можно назначить несколько администраторов, которые будут выполнять различные функции. Администраторы имеют доступ к различным возможностям портала Azure, а в зависимости от их роли, можно создать или изменение пользователей, назначить административные роли другим пользователям, сброс паролей пользователей, управление лицензиями на пользователей и Управление доменами, кроме всего прочего. Пользователь, которому назначена роль администратора будет иметь те же разрешения во всех облачных служб, на которые подписана ваша организация, независимо от того, является ли назначение роли на портале Office 365 или на портале Azure или с помощью модуля Azure AD для Windows PowerShell.
