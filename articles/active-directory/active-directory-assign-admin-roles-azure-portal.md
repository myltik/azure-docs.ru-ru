...
* **Администратор Information Protection.** Пользователи с этой ролью могут работать с системой Azure Information Protection на портале Azure. Они могут настраивать метки для политики Azure Information Protection, управлять шаблонами защиты и активировать защиту.
...
В | Может
-------- | ---------
Azure Information Protection | * Настраивать глобальные политики, политики в области и метки<br>* Настраивать и обновлять шаблоны защиты, а также управлять ими<br>* Активировать защиту 
Управление привилегированными пользователями (PIM) | * Осуществлять доступ к данным с правами на чтение<br>* Осуществлять доступ к данным без прав на управление членством в роли или параметрами ролей Azure AD
