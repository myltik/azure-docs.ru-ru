...
# Как выбрать нужный тип приложения при добавлении приложения
...
## Поддерживаемые типы приложений в Azure AD
...
## Функции и возможности, поддерживаемые приведенными выше типами приложений
...
## Как выбрать режим единого входа

Ниже приведены поддерживаемые режимы **единого входа** для приложений Azure AD.

-   **Единый вход Azure AD отключен**. Выберите **этот режим**, если вы еще не готовы к интеграции этого приложения с единым входом в Azure AD или просто его тестируете.
...
## Как настроить режим подготовки для приложения
