...
6. Щелкните роль, которую необходимо активировать.
7. Щелкните **Активировать**. Отобразится колонка **Запрос активации роли**.
8. В текстовом поле введите основание для запроса активации.
