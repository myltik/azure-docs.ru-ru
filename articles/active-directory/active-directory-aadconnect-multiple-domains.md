...
Предположим, что в локальной системе службы AD FS настроены с именем службы федерации fs.contoso100.com.
