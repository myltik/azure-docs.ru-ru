...
1.  На странице интеграции с приложением **SAP HANA Cloud Platform** портала Azure AD нажмите кнопку **Настроить единый вход**, чтобы открыть диалоговое окно **Настройка единого входа**.
...
3.  В другом окне веб-браузера войдите в пульт управления SAP HANA Cloud Platform по адресу https://account.\<узел среды>.ondemand.com/cockpit (например, **https://account.hanatrial.ondemand.com/cockpit*).
...
6.  На странице **Настройка URL-адреса приложения** портала Azure Active Directory выполните следующие действия, а затем нажмите кнопку **Далее**.
    ...
    2.  Откройте скачанный файл метаданных SAP HANA Cloud Platform, а затем найдите тег **ns3:AssertionConsumerService**.
...
10. Откройте вкладку **Общие** и нажмите кнопку **Обзор**, чтобы отправить скачанный файл метаданных.
    ...
    >[AZURE.NOTE]После отправки файла метаданных значения полей **URL-адрес единого входа**, **URL-адрес единого выхода** и **Сертификат подписи** заполнятся автоматически.
...
13. На портале Azure в диалоговом окне **Настройка единого входа на SAP HANA Cloud Platform** выберите подтверждение настройки единого входа и нажмите кнопку **Завершить**.
