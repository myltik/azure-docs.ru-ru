<properties pageTitle="Руководство. Интеграция Azure Active Directory с SumoLogic | Microsoft Azure" description="Узнайте, как использовать SumoLogic вместе с Azure Active Directory для реализации единого входа, автоматической подготовки пользователей и выполнения других задач." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi" />
#Учебник. Интеграция Azure Active Directory с SumoLogic
>[AZURE.TIP]Чтобы оставить отзыв, нажмите [здесь](http://go.microsoft.com/fwlink/?LinkId=525318).
...
После завершения этого руководства пользователи Azure AD, назначенные в SumoLogic, будут иметь возможность единого входа в приложение на веб-сайте SumoLogic компании (вход, инициированный поставщиком услуг) или с помощью инструкций из статьи [Общие сведения о панели доступа](https://msdn.microsoft.com/library/dn308586).
...
1.  На странице интеграции с приложением **SumoLogic** портала Azure AD щелкните кнопку **Настроить единый вход**, чтобы открыть диалоговое окно **Настройка единого входа**.
...
3.  На странице **Настроить URL-адрес приложения** в текстовом поле **URL-адрес для входа в SumoLogic** введите свой URL-адрес, используя следующий шаблон "*https://\<имя-клиента>.SumoLogic.com*", а затем нажмите кнопку **Далее**.

    ![Настройка URL-адреса aoo](./media/active-directory-saas-sumologic-tutorial/IC778554.png "Настройка URL-адреса aoo")

4.  Для загрузки сертификата на странице **Настройка единого входа в SumoLogic** нажмите кнопку **Загрузить сертификат** и сохраните файл сертификата на своем компьютере.
...
6.  Выберите пункты **Управление > Безопасность**.
...
9.  В диалоговом окне **Настройка SAML 2.0** выполните следующие действия:
    ...
    3.  На странице **Настройка единого входа в SumoLogic** портала Azure скопируйте значение поля **URL-адрес издателя** и вставьте его в текстовое поле **Издатель**.
    4.  На странице **Настройка единого входа в SumoLogic** портала Azure скопируйте значение поля **URL-адрес запроса проверки подлинности** и вставьте его в текстовое поле **URL-адрес запроса проверки подлинности**.
    ...
    6.  Откройте сертификат в кодировке Base-64 в блокноте, скопируйте его содержимое в буфер обмена и вставьте весь сертификат текстовое поле **Сертификат X.509**.
    7.  В качестве **Атрибута электронной почты ** выберите параметр **Использовать субъекта SAML**.
    8.  Выберите пункт **Конфигурация роли инициируется SP**.
    9.  В текстовом поле **Путь входа** введите **Azure**.
    10. Щелкните **Сохранить**.

10. На портале Azure в диалоговом окне **Настройка единого входа в SumoLogic** выберите подтверждение настройки единого входа и нажмите **Готово**.
...
1.  Войдите в клиента **SumoLogic**.

2.  Выберите пункты **Управление > Пользователи**.
...
4.  В диалоговом окне **Новый пользователь** выполните следующие действия:
    ...
    2.  Выберите роль.
    3.  Для параметра **Состояния** выберите значение **Активно**.
...
2.  На странице интеграции приложений **SumoLogic** нажмите кнопку **Назначить пользователей**.

    ![Назначить пользователей](./media/active-directory-saas-sumologic-tutorial/IC778564.png "Назначить пользователей")
