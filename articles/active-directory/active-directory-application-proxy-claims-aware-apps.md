...
1. Опубликуйте приложение в соответствии с инструкциями, описанными в статье [Публикация приложений с помощью прокси приложения](manage-apps/application-proxy-publish-azure-portal.md).
...
* [Включение единого входа](manage-apps/application-proxy-single-sign-on.md) для приложений, не поддерживающих утверждения.
