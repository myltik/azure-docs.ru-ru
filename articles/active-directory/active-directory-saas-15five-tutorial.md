<properties pageTitle="Руководство. Интеграция Azure Active Directory с 15Five | Microsoft Azure" description="Узнайте, как использовать 15Five вместе с Azure Active Directory для реализации единого входа, автоматической подготовки пользователей и выполнения других задач." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi" />
#Руководство. Интеграция Azure Active Directory с 15Five
>[AZURE.TIP]Чтобы оставить отзыв, нажмите [здесь](http://go.microsoft.com/fwlink/?LinkId=528017).
...
4.  В разделе «Добавить новых пользователей» выполните следующие действия.
    ...
    1.  Заполните текстовые поля **Имя**, **Фамилия**, **Должность** и **Адрес электронной почты** данными действующей учетной записи Azure Active Directory, которую вы хотите подготовить.
...
2.  На странице интеграции с приложением **15Five** нажмите **Назначить пользователей**.
