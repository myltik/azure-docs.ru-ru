---
title: Руководство. Интеграция Azure Active Directory с 15Five | Microsoft Docs
...
> [!NOTE]
> Вы можете использовать любые другие средства создания учетной записи пользователя 15Five или API, предоставляемые 15Five для подготовки учетных записей пользователя AAD.
> 
> 
