...
Установка агента Microsoft Identity Health на серверах AD FS или контроллерах домена оказывает минимальное влияние с точки зрения использования ЦП, потребления памяти, пропускной способности сети и хранилища.
