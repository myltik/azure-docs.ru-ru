...
>[AZURE.NOTE]В случае если агент не может связаться с Azure, данные сохраняются локально, занимая при этом не более 10 % общей системной памяти. Как только 10-процентный порог от объема общей физической памяти будет достигнут и при этом агенту не удасться передать данные в службу, сведения о новых транзакциях ADFS будут записаны поверх "кэшированных" на основании принципа давности обслуживания.
