...
>[AZURE.NOTE]Если агенту не удается установить соединение с Azure, он будет сохранять данные локально. Если данные не будут загружены в службу до того, как будет превышен порог в 10 % от общего объема физической памяти, новые транзакции ADFS начнут перезаписывать «кэшированные» транзакции начиная с самых ранних.
