...
|**Командная строка**: все параметры командной строки |sync |X | |
|**Кортана**: включение или отключение |X |X | |
...
|**Устройства**: общие принтеры, к которым подключен компьютер |X | X |Прочие |
