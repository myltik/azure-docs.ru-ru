...
* Вы можете включить автоматический вход пользователей в Tidemark (единый вход) с их учетными записями Azure AD.
...
## <a name="add-tidemark-from-the-gallery"></a>Добавление Tidemark из коллекции
...
3. В диалоговом окне на странице **Настройка параметров приложения** выполните следующие действия.
  ...
  * В текстовом поле "URL-адрес входа" введите URL-адрес, используемый пользователями для входа в приложение Tidemark, по следующей схеме: **https://contoso.tidemark.com/login** или **https://contoso.tidemark.net/login**.
4. На странице **Настройка единого входа в Tidemark** выполните следующие действия.
...
### <a name="create-a-tidemark-test-user"></a>Создание тестового пользователя Tidemark
...
Цель этого раздела — предоставить пользователю Britta Simon доступ к Tidemark, чтобы этот пользователь мог использовать единый вход Azure.
