...
- **Администратор службы**: управляет запросами на обслуживание и отслеживает работоспособность службы.
    > [AZURE.NOTE] 
    > Чтобы назначить роль администратора службы пользователю, глобальный администратор должен сначала назначить права администратора пользователю в службе, например Exchange Online, а затем назначить пользователю роль администратора службы в портале управления Azure.
