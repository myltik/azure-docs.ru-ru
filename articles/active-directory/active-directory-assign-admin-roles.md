...
- **Администратор службы**: управляет запросами на обслуживание и отслеживает работоспособность службы.
    > [AZURE.NOTE]Чтобы присвоить пользователю роль администратора службы, глобальный администратор наделяет его правами администратора в такой службе, как Exchange Online, и затем присваивает ему роль администратора службы на портале управления Azure.
