...
Если вы первый пользователь, для использования в вашем каталоге Azure AD Privileged Identity Management и перейдите к роли каталога Azure AD, а затем перейдите к роли каталога Azure AD, [мастер защиты](active-directory-privileged-identity-management-security-wizard.md) поможет выполнить первоначального Назначение пользователей. После этого вы автоматически станете первым **администратором безопасности** и **администратором привилегированных ролей** каталога.
