...
1. [Служба проверяет параметры конфигурации приложения.](#the-service-checks-the-configuration-settings-for-the-app)
...
#### <a name="1-the-service-checks-the-configuration-settings-for-the-app"></a>1. Служба проверяет параметры конфигурации приложения
