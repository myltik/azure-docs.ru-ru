---
title: Приступая к работе с Azure AD для Cordova | Microsoft Docs
...
#### Windows 10
   ...
   **Примечание**. Во время первого запуска, возможно, потребуется выполнить вход для предоставления системе лицензии разработчика. Дополнительные сведения представлены в разделе [Лицензия разработчика](https://msdn.microsoft.com/library/windows/apps/hh974578.aspx).
