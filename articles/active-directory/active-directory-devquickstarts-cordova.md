...
- Выберите клиента, в котором нужно зарегистрировать приложение.
...
- Следуйте инструкциям на экране, а затем создайте новое "Собственное клиентское приложение".
    ...
    -	"URI перенаправления" — это URI, который используется для возврата маркеров приложению. Укажите `http://MyDirectorySearcherApp`.
...
## *2. Клонирование репозиториев, необходимых для данного руководства*
...
##### Чтобы создать и запустить версию приложения для планшетов/ПК под управлением Windows, требуется:
...
##### Чтобы собрать и запустить приложение для Windows Phone 8.1, необходимо:
...
##### Чтобы построить и запустить приложение на устройстве под управлением Android, необходимо:
...
##### Чтобы построить и запустить приложение для iOS, необходимо:
...
Завершенный образец (без ваших настроек) вы можете загрузить отсюда. Теперь вы можете приступить к более сложным сценариям (и более содержательным). Вы можете попробовать:
