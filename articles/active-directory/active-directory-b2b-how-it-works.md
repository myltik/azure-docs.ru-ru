---
title: "Предварительная версия службы совместной работы Azure AD B2B | Документация Майкрософт"
...
---
# <a name="azure-ad-b2b-collaboration-preview-how-it-works"></a>Предварительная версия службы совместной работы Azure AD B2B: как это работает
...
## <a name="directory-operations"></a>Операции с каталогами
