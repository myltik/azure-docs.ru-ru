...
1.  На странице интеграции с приложением **ThousandEyes** портала Azure AD нажмите кнопку **Настроить единый вход**, чтобы открыть диалоговое окно **Настройка единого входа**.
...
9.  В разделе **Настройка единого входа** сделайте следующее:
    ...
    5.  Напротив пункта **Сертификат поставщика удостоверений** нажмите кнопку **Выбрать файл**, а затем отправьте сертификат, скачанный с портала Microsoft Azure.
