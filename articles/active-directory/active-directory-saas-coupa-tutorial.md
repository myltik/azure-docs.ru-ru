...
После завершения этого руководства пользователи Azure AD, назначенные Coupa, будут иметь возможность единого входа в приложение с помощью инструкций из статьи [Общие сведения о панели доступа](https://msdn.microsoft.com/library/dn308586).
...
4.  В другом окне веб-браузера войдите на портал Azure Active Directory.

5.  На странице интеграции с приложением **Coupa** нажмите **Настройка единого входа**, чтобы открыть диалоговое окно **Настройка единого входа**.
...
7.  На странице **Настройка URL-адреса приложения** выполните следующие действия.
    ...
    1.  В текстовом поле **URL-адрес входа** введите URL-адрес, используемый пользователями для входа в приложение Coupa (например, *http://company.Coupa.com*”)).
...
10. В разделе **Вход с использованием учетных данных Coupa** выполните следующие действия.
    ...
    2.  Чтобы передать скачанный файл метаданных Azure Active, нажмите кнопку **Обзор**.
...
2.  На странице интеграции с приложением **Coupa** нажмите **Назначить пользователей**.
