...
> [AZURE.IMPORTANT] Следующая смена ключей подписывания запланирована на 15 августа 2016 года, и она **не** повлияет на приложения Azure AD, добавленные из коллекции (включая пользовательские), локальные приложения, опубликованные через прокси-сервер приложений, приложения в клиентах Azure AD B2C, а также на приложения, интегрированные с ACS или ADFS.
...
7. Вернитесь на вкладку **Обозреватель серверов** и посмотрите значения в таблице **IssuingAuthorityKeys** и **Клиенты**. Как можно заметить, в них автоматически добавлены соответствующие сведения из документа метаданных федерации.
