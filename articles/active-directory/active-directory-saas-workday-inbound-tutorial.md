...
Сведения о том, как настроить хранение данных журналов событий Windows, см. в разделе [Settings for event logs](https://technet.microsoft.com/en-us/library/cc952132.aspx) (Параметры журналов событий). Общие сведения о журнале событий Windows см. в [этой статье](https://msdn.microsoft.com/en-us/library/windows/desktop/aa385772.aspx).
