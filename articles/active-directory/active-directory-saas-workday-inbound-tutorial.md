...
## <a name="configure-user-import-in-azure-ad"></a>Настройка импорта пользователей в Azure AD
...
2. На странице **Параметры и учетные данные администратора** выполните приведенные ниже действия, после чего нажмите кнопку **Далее**. 
  ...
  1. В текстовом поле **Имя пользователя администратора Workday** введите имя пользователя, созданного в разделе "Создание пользователя системы интеграции".
  2. В текстовом поле **Пароль администратора Workday** введите пароль пользователя, созданного в разделе "Создание пользователя системы интеграции".
