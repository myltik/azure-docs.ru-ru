...
## <a name="gdpr-information"></a>Сведения о GDPR
...
Дополнительные сведения об истории применения GDPR в корпорации Майкрософт приведены в [условиях предоставления услуг](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=31).

Обратите внимание, что решение для подготовки Workday для Active Directory требует, чтобы агент синхронизации был установлен на сервере, присоединенном к домену. Этот агент создает журналы **в журнале событий Windows**, который может содержать личные сведения.
