<properties
	...
	description="На этой странице приведены комплексные таблицы, в которых сравниваются различные инструменты интеграции каталогов, доступные для использования."
