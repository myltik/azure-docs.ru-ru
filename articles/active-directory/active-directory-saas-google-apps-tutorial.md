...
#<a name="tutorial:-how-to-integrate-google-apps-with-azure-active-directory"></a>Учебник. Интеграция Google Apps с Azure Active Directory
...
4. На странице **Настройка единого входа в Google Apps** нажмите кнопку **Скачать сертификат**, а затем сохраните файл сертификата на локальном компьютере.
...
7. На странице **Security** (Безопасность) выберите **Set up single sign-on (SSO)** (Настроить единый вход).
