...
* подписка Learningpool с поддержкой единого входа.
...
**Чтобы включить интеграцию с приложением Learningpool, выполните следующее.**
...
5. В диалоговом окне **Что необходимо сделать?** щелкните **Добавить приложение из коллекции**.
   ...
   ![Добавление приложения из коллекции](./media/active-directory-saas-learningpool-tutorial/IC749322.png "Добавление приложения из коллекции")
...
![Атрибуты маркера SAML](./media/active-directory-saas-learningpool-tutorial/IC795074.png "Атрибуты маркера SAML")
...
**Чтобы назначить пользователей Learningpool, выполните следующее.**

1. На классическом портале Azure создайте тестовую учетную запись.
2. На странице интеграции с приложением **Learningpool** щелкните **Назначить пользователей**.
   
   ![Назначение пользователей](./media/active-directory-saas-learningpool-tutorial/IC795081.png "Назначение пользователей")
