...
*Обратите внимание, что формат URI перенаправления описан ниже. Вы можете использовать любой URI перенаправления, если не хотите поддерживать брокера: в этом случае он будет выглядеть, как показано выше*
