...
# Назначенное приложение не отображается на панели доступа
...
## Проблемы, связанные с настройкой приложения
...
### Проверка вхождения пользователя в группу, которой назначена лицензия
