...
Обратите внимание, что в документе ниже предполагается, что вы знаете, как [подготовить приложения на устаревшем портале для Azure Active Directory](develop/active-directory-how-to-integrate.md), а также что вы интегрировали приложение с [пакетом Android SDK для Microsoft Identity](https://github.com/AzureAD/azure-activedirectory-library-for-android).
...
## <a name="enabling-cross-app-sso-using-adal"></a>Включение единого входа для нескольких приложений с помощью ADAL
...
Этот URI перенаправления должен быть указан при регистрации приложения на [классическом портале Azure](https://manage.windowsazure.com/). Дополнительные сведения о регистрации приложения Azure AD см. в статье, посвященной [интеграции с Azure Active Directory](develop/active-directory-how-to-integrate.md).
