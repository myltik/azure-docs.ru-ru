...
3. В разделе **Домены и URL-адреса приложения Panorama9** выполните следующие действия.
    ...
    а. В текстовом поле **URL-адрес для входа** введите URL-адрес в формате `https://dashboard.panorama9.com/saml/access/3262`.
...
8. В разделе **Параметры** выполните следующие действия.
   ...
   ![Параметры](./media/active-directory-saas-panorama9-tutorial/ic790025.png "Параметры")
    ...
    а. В текстовое поле **Identity provider URL** (URL-адрес поставщика удостоверений) вставьте значение **URL-адрес службы единого входа**, скопированное на портале Azure.
