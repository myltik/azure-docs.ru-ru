...
6.  На панели инструментов вверху щелкните **Управление**, а затем **Расширения**.
...
2.  На странице интеграции с приложением **Panorama9** нажмите **Назначить пользователей**.
