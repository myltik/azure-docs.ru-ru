...
* подписка Panorama9 с поддержкой единого входа (SSO).
...
## <a name="enable-the-application-integration-for-panorama9"></a>Включение интеграции приложений для Panorama9
