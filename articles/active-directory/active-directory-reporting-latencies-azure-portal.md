...
| :-- | --- | --- | :-- |
| Журналы аудита | 30 минут  | 1 час  |В некоторых случаях отображение данных о действиях аудита может занять до двух часов.|
| Вход в систему | 15 минут  | 2 ч |В некоторых случаях отображение данных о действиях входа может занять до 24 часов. Сюда входят данные о действиях входа в систему, поступающие от приложений Office прежних версий. |
...
| Отчет | Минимальная | Среднее | Максимальная |
| :-- | --- | --- | --- |
