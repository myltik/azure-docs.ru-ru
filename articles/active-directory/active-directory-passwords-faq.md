...
## Регистрация данных для сброса паролей
 ...
 > **Ответ.** Нет, пока это невозможно, но мы думаем об этом.
...
## Сброс паролей
 ...
 > **Ответ.** Контрольный вопрос должен содержать от 3 до 200 символов.

 - **Вопрос. Какова допустимая длина ответов на контрольные вопросы?**
 
 > **Ответ.** Ответы должны содержать от 3 до 40 символов.
...
## Обратная запись паролей
 ...
 > **Ответ.** В разделе «Как работает обратная запись паролей» подробно описано, что происходит при включении обратной записи паролей и как данные перемещаются через систему обратно в локальную среду. Подраздел «Модель безопасности обратной записи паролей» в разделе «Как работает обратная запись паролей» содержит информацию о том, как достигается высокий уровень безопасности этой службы.
 ...
 > **Ответ.** Да, служба обратной записи паролей надежно защищена. Дополнительные сведения о четырех уровнях безопасности, реализованных в службе обратной записи паролей, см. в разделе «Как работает обратная запись паролей» в подразделе «Модель безопасности обратной записи паролей».
