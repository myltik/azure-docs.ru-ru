...
Предназначение этого отчета — определить инфицированные устройства пользователей, которые теперь являются частью ботнета (также называемого армией зомби). Мы сопоставляем IP-адреса, с которых вошли пользователи, с IP-адресами, с которых подключались к серверам ботнета.
