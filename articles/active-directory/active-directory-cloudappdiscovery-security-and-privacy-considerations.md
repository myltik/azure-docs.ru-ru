...
> [AZURE.NOTE] Указанные выше данные HTTP собираются для всех незашифрованных подключений.
...
> [AZURE.NOTE] Дополнительные сведения см. в статье [Начало работы с Cloud App Discovery](http://social.technet.microsoft.com/wiki/contents/articles/30962.getting-started-with-cloud-app-discovery.aspx).
