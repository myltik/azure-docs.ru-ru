<properties pageTitle="Учебник. Интеграция Azure Active Directory с Thirdlight | Microsoft Azure" description="Узнайте, как использовать Thirdlight вместе с Azure Active Directory для реализации единого входа, автоматической подготовки пользователей и выполнения других задач." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi" />
#Учебник. Интеграция Azure Active Directory с Thirdlight
>[AZURE.TIP]Чтобы оставить отзыв, нажмите [здесь](http://go.microsoft.com/fwlink/?LinkId=529835).
...
1.  На странице интеграции с приложением **Thirdlight** портала Azure AD щелкните **Настройка единого входа**, чтобы открыть диалоговое окно **Настройка единого входа**.
...
4.  Щелкните кнопку **Добавить пользователя**.
...
2.  На странице интеграции с приложением **Thirdlight** щелкните кнопку **Назначить пользователей**.
