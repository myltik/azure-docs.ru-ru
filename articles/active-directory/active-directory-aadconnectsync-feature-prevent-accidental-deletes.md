...
![Здравствуйте. Служба синхронизации удостоверений обнаружила, что число удалений превысило пороговое значение для fabrikam.com. Всего 1234 объекта было отправлено на удаление в этом сеансе запуска синхронизации удостоверений. Это равно пороговому значению в 500 объектов или превышает его. Нам необходимо получить от вас подтверждение, что эти удаления следует обработать, прежде чем мы продолжим. Ознакомьтесь с информацией о предотвращении случайных удалений, чтобы больше узнать об ошибке, приведенной в этом письме.](./media/active-directory-aadconnectsync-feature-prevent-accidental-deletes/email.png)
