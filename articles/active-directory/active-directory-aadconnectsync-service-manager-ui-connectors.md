...
**Импорт**. При открытии объекта пространства соединителя в верхней части будут находиться несколько вкладок. На вкладке **Импорт** отображаются данные, добавленные после импорта.  
...
![Synchronization Service Manager](./media/active-directory-aadconnectsync-service-manager-ui/preview1.png) Вы можете проверить объект и узнать, какое правило применено к конкретному потоку атрибутов.  
...
**Атрибуты**. На вкладке "Атрибуты" можно просмотреть значения и узнать, какой соединитель их передал.  
![Synchronization Service Manager](./media/active-directory-aadconnectsync-service-manager-ui/mvattributes.png)  
**Соединители**. На вкладке "Соединители" отображаются все пространства соединителя, имеющие представление объекта.  
