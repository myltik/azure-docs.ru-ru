...
8. Для настройки единого входа в приложение выполните следующие действия:
    ...
    г) Чтобы включить параметры SAML, нажмите кнопку **Изменить**.
    ...
    g. В текстовом поле **Идентификатор сущности** введите URL-адрес в формате `http://saml.marketo.com/sp`.
...
9. Чтобы включить единый вход для пользователей, выполните следующие действия.
    ...
    г) Установите флажок **Требовать единый вход** и **сохраните** параметры.
