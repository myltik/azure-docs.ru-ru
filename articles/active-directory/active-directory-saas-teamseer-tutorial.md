...
8.  Щелкните **Настроить сведения о поставщике SAML**.
    ...
    ![Настройка SAML](./media/active-directory-saas-teamseer-tutorial/IC789636.png "Настройка SAML")

9.  В разделе сведений о поставщике SAML выполните следующие действия:

    ![Настройка SAML](./media/active-directory-saas-teamseer-tutorial/IC789637.png "Настройка SAML")
...
10. Чтобы завершить настройку поставщика SAML, выполните следующие действия:
    ...
    ![Настройка SAML](./media/active-directory-saas-teamseer-tutorial/IC789638.png "Настройка SAML")
