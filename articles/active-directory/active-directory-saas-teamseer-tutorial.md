...
1.  На странице интеграции с приложением **TeamSeer** классического портала Azure щелкните **Настройка единого входа**, чтобы открыть соответствующее диалоговое окно.
...
9.  В разделе сведений о поставщике SAML выполните следующие действия:
    ...
    1.  На странице диалогового окна **Configure single sign-on at TeamSeer** (Настройка единого входа в TeamSeer) классического портала Azure скопируйте значение поля **URL-адрес службы единого входа** и вставьте его в текстовое поле **URL-адрес**.
