...
## <a name="enable-the-application-integration-for-teamseer"></a>Включение интеграции приложений для TeamSeer
В этом разделе показано, как включить интеграцию приложений для TeamSeer.

**Чтобы включить интеграцию приложений для TeamSeer, выполните следующее.**
...
1. На странице интеграции с приложением **TeamSeer** на классическом портале Azure щелкните **Настройка единого входа**, чтобы открыть диалоговое окно **Настройка единого входа**.
...
**Чтобы назначить пользователей TeamSeer, выполните следующее.**
