...
1.  На странице интеграции с приложением **Veracode** классического портала Azure AD щелкните **Настройка единого входа**, чтобы открыть соответствующее диалоговое окно.
...
8.  В разделе **Параметры SAML для организации** выполните следующие действия.
    ...
    1.  На странице **Configure single sign-on at Veracode** (Настройка единого входа в Veracode) классического портала Azure скопируйте значение поля **URL-адрес издателя** и вставьте его в текстовое поле **Издатель**.
