...
1.  На странице интеграции с приложением **Veracode** портала Azure AD щелкните **Настройка единого входа**, чтобы открыть диалоговое окно **Настройка единого входа**.
...
8.  В разделе **Параметры SAML для организации** выполните следующие действия:
    ...
    1.  На странице **Настройка единого входа в Veracode** портала Azure скопируйте значение поля **URL-адрес издателя** и вставьте его в текстовое поле **Издатель**.
...
12. Чтобы добавить требуемые сопоставления атрибутов, выполните следующие действия:
