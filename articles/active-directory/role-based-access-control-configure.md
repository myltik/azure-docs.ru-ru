...
3. Щелкните значок **Пользователи** в правом верхнем углу в колонке группы ресурсов.
...
Унаследованные назначения нельзя удалить из дочерних областей. Необходимо удалить назначение роли из родительской области.
