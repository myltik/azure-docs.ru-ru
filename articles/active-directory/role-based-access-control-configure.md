---
title: "Управление доступом на основе ролей на классическом портале Azure | Документация Майкрософт"
...
1. Используйте флажки в колонке "Управление доступом", чтобы выбрать одно или несколько назначений ролей.
2. Щелкните **Удалить**.  
3. Появится всплывающее окно с предложением подтвердить действие. Выберите **Да**, чтобы удалить назначения ролей.
