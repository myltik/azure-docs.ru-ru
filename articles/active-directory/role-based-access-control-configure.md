...
# Использование назначений ролей для управления доступом к ресурсам Azure Active Directory
...
3. Выберите **Пользователи** в правом верхнем углу колонки группы ресурсов. 
![Пользователи — значок](./media/role-based-access-control-configure/users_icon.png)
...
![Добавить — значок](./media/role-based-access-control-configure/add_icon.png)  
...
![Удалить — значок](./media/role-based-access-control-configure/remove_icon.png)
