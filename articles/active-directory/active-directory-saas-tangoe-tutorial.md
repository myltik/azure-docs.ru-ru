---
title: Учебник. Интеграция Azure Active Directory с Tangoe Command Premium Mobile | Microsoft Docs
...
1. На странице **Настройка единого входа в Tangoe Command Premium Mobile** выполните следующие действия:
...
2. Для настройки единого входа для своего приложения обратитесь в службу поддержки клиентов Tangoe и предоставьте следующие сведения:
...
1. На классическом портале выберите подтверждение конфигурации единого входа и нажмите кнопку **Далее**.
