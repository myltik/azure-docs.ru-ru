...
11. На классическом портале Azure в диалоговом окне **Configure single sign-on at ZScaler Two** (Настройка единого входа в ZScaler Two) подтвердите конфигурацию единого входа и нажмите кнопку **Завершить**.
