---
title: Руководство. Интеграция Azure Active Directory с Facebook at Work | Microsoft Docs
...
---
# <a name="tutorial:-azure-active-directory-integration-with-facebook-at-work"></a>Руководство. Интеграция Azure Active Directory с Facebook at Work
...
## <a name="adding-facebook-at-work-from-the-gallery"></a>Добавление Facebook at Work из коллекции
...
## <a name="automatically-provisioning-users-to-facebook-at-work"></a>Автоматическая подготовка пользователей для Facebook at Work
...
## <a name="assigning-users-to-facebook-at-work"></a>Назначение пользователям доступа в Facebook at Work
