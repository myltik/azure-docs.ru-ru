...
Защита привилегированного доступа — исключительно важный первый шаг для защиты корпоративных ресурсов в современных организациях. Безопасность большинства или всех корпоративных ресурсов в организации зависит от неприкосновенности привилегированных учетных записей, которые используются для администрирования и управления ИТ-системами. Злоумышленники в Интернете обычно используют эти учетные записи для доступа к данным и системам организации.

Для защиты административного доступа от преднамеренного воздействия извне требуется изолировать эти административные учетные записи и системы от рисков. Многие пользователи начинают получать привилегированный доступ через облачные службы. Это могут быть глобальные администраторы Office 365, администраторы подписок Azure и пользователи, имеющие административный доступ на виртуальных машинах или в приложениях SaaS.
...
Чтобы снизить риски для системы безопасности, необходимо пересмотреть роли и модель делегирования, включив административные роли облачной службы и сделав ключевым принципом удобство администрирования. Эта модель должна использовать возможности JIT (предоставление привилегий только на время).
