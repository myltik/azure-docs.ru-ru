...
С помощью расширений каталогов можно расширить схему в Azure AD с настраиваемыми атрибутами, добавленными в вашей организации, или другими атрибутами в Active Directory. Чтобы использовать эту функцию, на странице **Дополнительные функции** выберите **Синхронизация атрибутов расширения каталога**. Отобразится эта страница, на которой вы сможете выбрать дополнительные атрибуты.
