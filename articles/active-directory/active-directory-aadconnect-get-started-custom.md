...
На этой странице щелкните **Настройка**, чтобы запустить установку с настраиваемыми параметрами.
...
Если вы получаете сообщение об ошибке и испытываете проблемы с подключением, см. статью [Устранение неполадок подключения](active-directory-aadconnect-troubleshoot-connectivity.md).
