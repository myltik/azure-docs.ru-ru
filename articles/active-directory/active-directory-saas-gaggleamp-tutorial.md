...
3. В диалоговом окне на странице **Настройка параметров приложения** выполните следующие действия.
    ...
    > [AZURE.NOTE]Если вам нужен [URL единого входа](mailto:sales@gaggleamp.com) для приложения, обратитесь в **отдел продаж GaggleAMP** .

    b. Нажмите кнопку **Далее**.


1. На странице **Настройка единого входа в GaggleAMP** выполните следующие действия.
    ...
    b. Нажмите кнопку **Далее**.
2. В другом экземпляре браузера перейдите на страницу единого входа SAML, созданную для вас группой поддержки Gaggle (например, *https://accounts.gaggleamp.com/saml_configurations/oXH8sQcP79dOzgFPqrMTyw/edit*).
3. На странице **Единый вход SAML** выполните следующие действия.  
