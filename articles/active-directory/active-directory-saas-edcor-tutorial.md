...
3. В разделе **Домены и URL-адреса приложения Edcor** выполните следующие действия:
    ...
    ![Сведения о домене и URL-адресах единого входа для приложения Edcor](./media/active-directory-saas-edcor-tutorial/tutorial_edcor_url1.png)
...
6. В разделе **Настройка Edcor** щелкните **Настроить Edcor**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес выхода и идентификатор сущности SAM** из раздела **Краткий справочник**.
    ...
    ![Настройка Edcor](./media/active-directory-saas-edcor-tutorial/tutorial_edcor_configure.png) 
...
2. В списке приложений выберите **Edcor**.
    ...
    ![Ссылка на Edcor в списке приложений](./media/active-directory-saas-edcor-tutorial/tutorial_edcor_app.png)  
