...
1.  На странице интеграции с приложением **Panopto** портала Azure AD нажмите кнопку **Настроить единый вход**, чтобы открыть диалоговое окно **Настройка единого входа**.
...
8.  В разделе сведений поставщика SAML выполните следующие действия:
    ...
    4.  На странице диалогового окна **Настройка единого входа в Panopto** портала Azure скопируйте значение поля **URL-адрес издателя** и вставьте его в текстовое поле **Издатель**.
    5.  На странице диалогового окна **Настройка единого входа в Panopto** портала Azure скопируйте значение поля **URL-адрес единого входа SAML** и вставьте его в текстовое поле **URL-адрес страницы возврата**.
    ...
    8.  Нажмите кнопку **Сохранить**. ![Сохранить](./media/active-directory-saas-panopto-tutorial/IC777673.png "Сохранить")
...
2.  На странице интеграции с приложением **Panopto** нажмите кнопку **Назначить пользователей**.
