...
- **Сведения о пользователе** — какой идентификатор использует пользователь для входа в устройство? Как пользователь входит на устройство? Входит ли он в группу безопасности, для которой разрешена синхронизация? 
