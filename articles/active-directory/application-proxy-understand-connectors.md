...
Существует множество причин для создания групп соединителей, включая следующие:

* высокий уровень доступности;
* меньшая задержка для клиентов с приложениями в нескольких регионах;
* упорядоченные ресурсы, которыми проще управлять.

Чтобы узнать больше о преимуществах групп соединителей, ознакомьтесь с разделом [Публикация приложений в отдельных сетях и расположениях с помощью групп соединителей](active-directory-application-proxy-connectors-azure-portal.md).
