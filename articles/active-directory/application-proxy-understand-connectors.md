...
|8|32|270|1190|
|16|64|245|1200*|
\* Для этого компьютера было установлено ограничение в 200 подключений. Для всех остальных компьютеров мы использовали предельное число подключений по умолчанию — 200.
 
>[!NOTE]
>Предел в конфигурации по умолчанию составляет 200 (для 2, 4 и 8 ядер).  При тестировании с 16 ядрами предельное число было изменено на 800. В максимальном показателе TPS между компьютерами с 4, 8 и 16 ядрами нет существенных различий. Основное различие между ними — в ожидаемой задержке.  
