<properties pageTitle="Руководство. Интеграция Azure Active Directory с консолью администрирования Mimecast | Microsoft Azure" description="Узнайте, как использовать консоль администрирования Mimecast с Azure Active Directory для включения единого входа, автоматической подготовки пользователей и выполнения других задач." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi" />
#Руководство. Интеграция Azure Active Directory с консолью администрирования Mimecast
>[AZURE.TIP]Чтобы оставить отзыв, нажмите [здесь](http://go.microsoft.com/fwlink/?LinkId=529833).
...
После завершения этого руководства пользователи Azure AD, которые были назначены консоли администрирования Mimecast, будут иметь возможность единого входа в приложение консоли администрирования Mimecast на веб-сайте компании (вход, инициированный поставщиком услуг) или с помощью инструкций из статьи [Общие сведения о панели доступа](https://msdn.microsoft.com/library/dn308586).
...
1.  На странице интеграции с приложением **консоли администрирования Mimecast** портала Azure AD нажмите кнопку **Настроить единый вход**, чтобы открыть диалоговое окно **Настройка единого входа**.
...
4.  На странице **Настройка единого входа в консоль администрирования Mimecast** нажмите кнопку **Загрузить сертификат**, а затем сохраните файл сертификата на локальном компьютере.
...
9.  В разделе **Профиль проверки подлинности** выполните следующие действия.
    ...
    4.  На странице **Настройка единого входа в консоль администрирования Mimecast** портала Azure скопируйте значение поля **URL-адрес издателя** и вставьте его в текстовое поле **URL-адрес издателя**.
    5.  На странице **Настройка единого входа в консоль администрирования Mimecast** портала Azure скопируйте значение поля **URL-адрес удаленного входа в систему** и вставьте его в текстовое поле **URL-адрес входа в систему**.
    6.  На странице **Настройка единого входа в консоль администрирования Mimecast** портала Azure скопируйте значение поля **URL-адрес удаленного входа в систему** и вставьте его в текстовое поле **URL-адрес выхода из системы**.  
...
2.  На странице интеграции приложений **консоли администрирования Mimecast** нажмите **Назначить пользователей**.
