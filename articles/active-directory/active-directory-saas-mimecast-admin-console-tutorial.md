...
9.  В разделе **Профиль проверки подлинности** сделайте следующее:
    ...
    4.  На странице диалогового окна **Настройка единого входа в консоль администрирования Mimecast** портала Azure скопируйте значение поля **URL-адрес издателя** и вставьте его в текстовое поле **URL-адрес издателя**.
    5.  На странице диалогового окна **Настройка единого входа в консоль администрирования Mimecast** портала Azure скопируйте значение поля **URL-адрес удаленного входа** и вставьте его в текстовое поле **URL-адрес входа**.
    6.  На странице диалогового окна **Настройка единого входа в консоль администрирования Mimecast** портала Azure скопируйте значение поля **URL-адрес удаленного входа** и вставьте его в текстовое поле **URL-адрес выхода**.  
...
2.  На странице интеграции приложений **консоли администрирования Mimecast** нажмите кнопку **Назначить пользователей**.
