...
Функция "Условия использования Azure AD" — это простой способ, которым организации могут предоставлять сведения своим пользователям.  Таким образом, пользователи видят соответствующие заявления об отказе для юридических требований и требований к соответствию.

Для условий использования Azure AD используется формат PDF.   Это может быть любое содержимое, например имеющаяся контрактная документация, позволяющее собрать пользовательские соглашения во время входа пользователя.  Вы можете использовать условия использования для приложений, групп пользователей или при наличии нескольких экземпляров условий использования для разных целей.
...
Возникают сложности с получением согласия на условия использования от сотрудников или гостей перед предоставлением доступа? Нужна помощь, чтобы выяснить, кто принял и не принял условия использования вашей компании?  Функция "Условия использования Azure AD" — это простой способ, которым организации могут предоставлять сведения своим пользователям.  Таким образом, пользователи видят соответствующие заявления об отказе для юридических требований и требований к соответствию.
...
Охватываемым пользователям необходимо выйти и снова выполнить вход для удовлетворения требований новой политики, если:
...
О. Условия использования активируются, когда пользователь выполняет вход в систему.
...
О. Пользователь не сможет получить доступ к приложению. Чтобы получить доступ, ему необходимо повторно выполнить вход и принять условия.
