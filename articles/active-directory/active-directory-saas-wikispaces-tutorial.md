...
1.  На странице интеграции с приложением **Wikispaces** портала Azure AD щелкните **Настройка единого входа**, чтобы открыть диалоговое окно **Настройка единого входа**.
...
4.  В разделе **Пригласить пользователей** выполните следующие действия.
    ...
    ![Пригласить пользователей](./media/active-directory-saas-wikispaces-tutorial/IC787208.png "Пригласить пользователей")
