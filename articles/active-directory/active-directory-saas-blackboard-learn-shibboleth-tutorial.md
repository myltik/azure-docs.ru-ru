...
3. В диалоговом окне на странице **Настройка параметров приложения** выполните следующие действия.
    ...
    а. В текстовом поле **URL-адрес для входа** введите URL-адрес, используемый для входа в приложение Blackboard Learn — Shibboleth, в формате **https://\<ваш_сервер_blackoardlearn\>.blackboardlearn.com/Shibboleth.sso/Login**.
   
    b. В текстовом поле **Идентификатор** введите URL-адрес в следующем формате: **https://\<ваш_сервер_blackoardlearn\>.blackboardlearn.com/Shibboleth.sso/Login**.
...
### <a name="creating-an-blackboard-learn---shibboleth-test-user"></a>Создание тестового пользователя Blackboard Learn — Shibboleth
