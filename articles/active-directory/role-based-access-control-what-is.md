...
[Классический подписки Администраторы и соадминистраторы](../billing/billing-add-change-azure-subscription-administrator.md) имеют полный доступ к подписке Azure. Они могут управлять ресурсами с помощью [портал Azure](https://portal.azure.com), API диспетчера ресурсов Azure и классической модели развертывания API-интерфейсов. В модели RBAC классическим администраторам назначается роль владельца в области подписки.

Модель RBAC Azure поддерживается только порталом Azure и новыми API-интерфейсами Azure Resource Manager. Нельзя использовать пользователей и приложений, которым назначены роли RBAC Azure классической модели развертывания API-интерфейсов.
