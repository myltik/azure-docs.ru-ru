---
title: "Управление доступом и разрешениями с помощью ролей в Azure RBAC | Документация Майкрософт"
...
---
# <a name="get-started-with-access-management-in-the-azure-portal"></a>Начало работы с управлением доступом на портале Azure
...
Классические администраторы и соадминистраторы подписки имеют полный доступ к подписке Azure. Они могут управлять ресурсами с помощью [портала Azure](https://portal.azure.com) и интерфейсов API Azure Resource Manager или [классического портала Azure](https://manage.windowsazure.com) и классической модели развертывания Azure. В модели RBAC классическим администраторам назначается роль владельца в области подписки.

Модель RBAC Azure поддерживается только порталом Azure и новыми API-интерфейсами Azure Resource Manager. Пользователи и приложения, которым назначены роли RBAC, не могут использовать классический портал управления и классическую модель развертывания Azure.
