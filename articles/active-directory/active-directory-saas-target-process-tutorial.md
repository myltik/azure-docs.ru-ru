...
1. На странице **Настройка единого входа в TargetProcess** выполните следующие действия.
    ...
    b. Нажмите кнопку **Далее**.
2. Войдите в приложение TargetProcess с правами администратора.
3. В верхнем меню щелкните **Настройка**.
...
6. В диалоговом окне "Параметры единого входа" выполните следующие действия.
...
### <a name="creating-a-targetprocess-test-user"></a>Создание тестового пользователя TargetProcess
