---
title: Руководство по интеграции Azure Active Directory с Namely | Microsoft Docs
...
2. В диалоговом окне **Add New Person** (Добавление пользователя) выполните следующие действия.
