---
title: Руководство. Интеграция Azure Active Directory с QuickHelp | Microsoft Docs
...
7. В меню **Администратор QuickHelp** щелкните **Параметры**.
...
10. На классическом портале Azure подтвердите конфигурацию единого входа и нажмите кнопку **Далее**.
