...
3. В разделе **Домены и URL-адреса приложения Ariba** выполните следующие действия.
    ...
    а. В текстовом поле **URL-адрес для входа** введите URL-адрес в следующем формате: `https://<subdomain>.sourcing.ariba.com` или `https://<subdomain>.supplier.ariba.com`.
