...
## <a name="enable-the-application-integration-for-talentlms"></a>Включение интеграции приложений для TalentLMS
В этом разделе показано, как включить интеграцию приложений для TalentLMS.

**Чтобы включить интеграцию приложений для TalentLMS, выполните следующее.**
...
1. На странице интеграции с приложением **TalentLMS** на классическом портале Azure щелкните **Настройка единого входа**, чтобы открыть диалоговое окно **Настройка единого входа**.
...
8. В разделе "Единый вход" выполните следующие действия:
  ...
  6. Укажите следующие сведения. 
    * В поле **TargetedID** (Целевой идентификатор) введите **http://schemas.xmlsoap.org/ws/2005/05/identity/claims/name**.
    * В текстовом поле **First Name** (Имя) введите **http://schemas.xmlsoap.org/ws/2005/05/identity/claims/givenname**.
    * В текстовом поле **Last Name** (Фамилия) введите **http://schemas.xmlsoap.org/ws/2005/05/identity/claims/surname**.
    * В текстовом поле **Email** (Электронная почта) введите **http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress**.
...
**Чтобы назначить пользователей TalentLMS, выполните следующее.**
