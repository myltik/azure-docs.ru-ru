...
Чтобы предоставить пользователям доступ к опубликованному приложению, необходимо назначить их по отдельности или в группах. (Не забудьте предоставить доступ и себе.) Для этого требуется, чтобы у каждого пользователя была лицензия на поддержку Azure Basic или более высокого уровня. Дополнительные сведения см. в статье [Azure AD и приложения: назначение пользователей для приложения](active-directory-applications-guiding-developers-assigning-users.md) . 
