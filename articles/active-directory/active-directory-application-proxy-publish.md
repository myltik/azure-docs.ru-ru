...
Если вы впервые используете прокси приложения Azure AD, перед публикацией приложений проверьте соединитель, опубликовав веб-сайт из частной сети.
...
Чтобы предоставить пользователям доступ к опубликованному приложению, необходимо назначить их по отдельности или в группах. Таким образом они смогут использовать приложения, требующие предварительной проверки подлинности. Для доступа к приложениям, не требующим предварительной проверки подлинности, пользователей по-прежнему необходимо назначить для приложения, чтобы оно отображалось в их списке приложений.
