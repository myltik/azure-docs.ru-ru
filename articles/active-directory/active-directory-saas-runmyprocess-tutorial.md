...
1.  На странице интеграции с приложением **RunMyProcess** портала Azure AD нажмите кнопку **Настроить единый вход**, чтобы открыть диалоговое окно **Настройка единого входа **.
...
8.  В разделе **Метод проверки подлинности** сделайте следующее:
    ...
    2.  На странице диалогового окна **Настройка единого входа в RunMyProcess** портала Azure скопируйте значение поля **URL-адрес единого входа SAML** и вставьте его в текстовое поле **Перенаправление единого входа**.
    3.  На странице диалогового окна **Настройка единого входа в RunMyProcess** портала Azure скопируйте значение поля **URL-адрес службы единого выхода** и вставьте его в текстовое поле **Перенаправление для выхода**.
...
2.  На странице интеграции с приложением **RunMyProcess ** нажмите кнопку **Назначить пользователей**.
