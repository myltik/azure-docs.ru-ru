...
Из этого документа вы узнаете, к чему нужно быть готовым при использовании некоторых ролей на портале Azure. Существуют три основных роли, которые охватывают все типы ресурсов: роль владельца, роль участника и роль читателя
