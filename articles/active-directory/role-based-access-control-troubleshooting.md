...
Из этого документа вы узнаете, какие ситуации возможны при использовании некоторых ролей на портале Azure. Следующие три ресурса охватывают все типы ресурсов:
