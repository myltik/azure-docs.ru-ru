...
1. На [классическом портале Azure](https://manage.windowsazure.com) щелкните имя виртуальной сети и вкладку **Настройка**, чтобы [изменить конфигурацию IP-адресов DNS-серверов для виртуальной сети](../virtual-network/virtual-networks-manage-dns-in-vnet.md) для использования статических IP-адресов, назначенных репликам контроллеров домена вместо IP-адресов локальных DNS-серверов.
