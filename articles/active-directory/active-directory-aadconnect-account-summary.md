<properties
	pageTitle="Дополнительные сведения об учетных данных и разрешениях Azure AD Connect | Microsoft Azure"
...
Разрешения SQL Server|Для учетной записи службы синхронизации Azure AD Connect требуются права владельца базы данных в SQL. Они задаются во время установки Azure AD Connect, а внесение изменений не поддерживается.
...
------------- | ------------- |------------- |
Учетная запись Azure AD для синхронизации|Выделенная роль синхронизации каталогов|Непрерывная синхронизация (учетная запись агента управления AD)
