...
В следующей таблице перечислены собираемые при быстрой установке учетные данные. В ней также объясняется, для чего эти учетные данные используются.
...
<br> <br> В следующей таблице перечислены собираемые при быстрой установке учетные данные. В ней также объясняется, для чего эти учетные данные используются.
...
<br> <br> В следующей таблице приведены разрешения, необходимые для определенных сценариев.
...
<br> <br> В следующей таблице приведены учетные записи, которые создаются средством Azure AD Connect.
