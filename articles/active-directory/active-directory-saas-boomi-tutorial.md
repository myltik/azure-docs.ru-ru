...
3. В разделе **Домены и URL-адреса приложения Boomi** выполните следующие действия:
    ...
    a. В текстовом поле **Идентификатор** введите URL-адрес в следующем формате: `https://platform.boomi.com/`

    Б. В текстовом поле **URL-адрес ответа** введите URL-адрес в следующем формате: `https://platform.boomi.com/sso/<accountname>/saml`.
