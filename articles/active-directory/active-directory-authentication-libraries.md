...
|платформа|Имя пакета|Клиентская/серверная библиотека|Скачивание|Исходный код|Документация и примеры|
|---|---|---|---|---|---|
...
|Node.js|ПО промежуточного слоя для аутентификации Passport в Microsoft Azure Active Directory для Node.js|Клиент|[Azure Active Directory Passport для Node.js (npm)](https://www.npmjs.com/package/passport-azure-ad)|[Azure Active Directory для Node.js (Github)](https://github.com/AzureAD/passport-azure-ad)||
