...
> [!NOTE]
> Если элемент **Балансировщики нагрузки** не отображается в меню, щелкните **Обзор** в левом нижнем углу портала и прокрутите список до пункта **Балансировщики нагрузки**. Щелкните желтую звездочку, чтобы добавить его в меню. Затем щелкните значок балансировщика нагрузки, чтобы открыть панель и начать настройку балансировщика нагрузки.
> 
> 
