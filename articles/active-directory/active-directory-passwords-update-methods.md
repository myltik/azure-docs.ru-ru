.<properties
	pageTitle="Практическое руководство. Способы сброса паролей Azure AD | Microsoft Azure"
...
* [**Как пройти регистрацию для сброса пароля**](active-directory-passwords-update-your-own-password.md)
