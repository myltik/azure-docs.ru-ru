...
- На этапе общедоступной предварительной версии для использования управления лицензиями групп для клиента требуется платная или пробная подписка Azure AD уровня "Базовый" или "Премиум". Кроме того, каждому пользователю, наследующему лицензии групп, должна быть назначена лицензия на платный выпуск Azure AD.
