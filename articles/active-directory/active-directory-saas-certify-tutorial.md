...
7. В области результатов выберите **Certify** и нажмите кнопку **Завершить**, чтобы добавить приложение. <br><br>
...
В этом разделе описано, как включить единый вход Azure AD на портале Azure AD и настроить единый вход в приложение Certify.



**Чтобы настроить единый вход Azure AD в Certify, сделайте следующее:**

1. На портале Azure AD на странице интеграции с приложением **Certify** щелкните **Настроить единый вход**, чтобы открыть диалоговое окно **Настройка единого входа**. <br><br> ![Настройка единого входа][6] <br>
...
1. На **портале управления Azure** в области навигации слева щелкните **Active Directory**. <br><br>![Создание тестового пользователя Azure AD](./media/active-directory-saas-certify-tutorial/create_aaduser_09.png) <br>
