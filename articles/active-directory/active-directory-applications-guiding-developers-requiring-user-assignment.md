---
title: "Azure AD и приложения: требование назначения пользователей | Документация Майкрософт"
...
---
# <a name="azure-ad-and-applications-requiring-user-assignment"></a>Azure AD и приложения: требование назначения пользователей
