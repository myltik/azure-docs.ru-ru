---
title: Учебник. Интеграция Azure Active Directory с Optimizely | Microsoft Docs
...
1. Он получит приглашение по электронной почте. Электронный адрес будет использоваться для входа в Optimizely.
