...
Хотя [личные домены](active-directory-application-proxy-custom-domains.md) не являются обязательными для других приложений, они являются необходимым условием для создания приложений с подстановочным знаком. Для создания личных доменов необходимо:
...
1. Следуйте указаниям по [настройке URL-адреса домашней страницы](application-proxy-office365-app-launcher.md).
...
- **Личные домены**: [Работа с пользовательскими доменами в прокси приложения Azure AD](active-directory-application-proxy-custom-domains.md).
