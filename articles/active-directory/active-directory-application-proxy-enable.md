...
<p>- Укажите учетные данные глобального администратора Azure AD. Ваш клиент глобального администратора может отличаться от учетных данных Microsoft Azure.
<p>- Убедитесь, что администратор, который регистрирует соединитель, находится в том каталоге, где включены службы прокси приложения. Например, если домен клиента — contoso.com, у администратора должен быть псевдоним admin@contoso.com или другой псевдоним в этом домене.
