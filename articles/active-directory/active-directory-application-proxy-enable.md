...
<p>- Если зарегистрировать соединитель не удается, см. раздел «Устранение неполадок прокси приложения».
