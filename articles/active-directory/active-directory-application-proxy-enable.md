---
title: "Включение прокси приложения Azure AD | Документация Майкрософт"
...
## <a name="step-2-install-and-register-the-connector"></a>Шаг 2. Установка и регистрация соединителя
