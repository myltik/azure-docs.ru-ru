...
>[Примечание.] Обязательно запишите ответы на все вопросы и убедитесь, что они логически обоснованы. Доступные варианты, их недостатки и преимущества см. в разделе [Определение требований по реагированию на инциденты](active-directory-hybrid-identity-design-considerations-incident-response-requirements.md). Ответив на эти вопросы, вы сможете выбрать тот вариант, который лучше всего подходит для вашего бизнеса.
