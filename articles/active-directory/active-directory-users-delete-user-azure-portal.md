---
title: "Удаление пользователя из каталога в предварительной версии Azure Active Directory | Документация Майкрософт"
...
---
# <a name="delete-a-user-from-a-directory-in-azure-active-directory-preview"></a>Удаление пользователя из каталога в предварительной версии Azure Active Directory
В этой статье объясняется, как удалить пользователя из каталога в предварительной версии Azure Active Directory (Azure AD). [Что есть в предварительной версии?](active-directory-preview-explainer.md) Сведения о добавлении новых пользователей в организации см. в статье [Добавление новых пользователей в предварительную версию Azure Active Directory](active-directory-users-create-azure-portal.md).
...
* [Удаление пользователя из каталога в предварительной версии Azure Active Directory](active-directory-users-profile-azure-portal.md)
