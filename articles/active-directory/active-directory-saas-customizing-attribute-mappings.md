...
Чтобы изменить существующее сопоставление атрибута, выберите сопоставление и нажмите кнопку **Изменить**. Отобразится диалоговое окно, в котором можно изменить сопоставление выбранного атрибута.
