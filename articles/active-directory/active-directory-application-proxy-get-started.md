...
1. Пользователь, который обращается к приложению через прокси приложения, будет перенаправлен на страницу входа в Azure AD для проверки подлинности.
