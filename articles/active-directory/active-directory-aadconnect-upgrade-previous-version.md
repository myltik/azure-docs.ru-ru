---
title: 'Azure AD Connect: обновление до последней версии | Microsoft Docs'
description: 'Описывает различные способны обновления Azure Active Direcotry Connect до последней версии, включая обновление '
на: ''
месте": ''
и: ''
обновление: ''
