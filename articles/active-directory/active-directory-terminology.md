<properties
	pageTitle="Терминология Azure AD | Microsoft Azure"
	description="Термины и определения, связанные с Azure Active Directory."
...
Подключение Azure Active Directory | Приложение, которое предоставляет одностороннюю синхронизацию объектов каталога из локальной службы Active Directory компании в Azure Active Directory.
...
Синхронизация каталогов | Используется для синхронизации локальных объектов каталогов (пользователей, групп, контактов) в облако, чтобы сократить объем работы администраторов. Синхронизация каталогов также называется синхронизацией каталогов на портале Azure и классическом портале Azure. После настройки синхронизации каталогов администраторы, используя локальную среду Active Directory, могут подготовить к работе объекты каталога для экземпляра Azure AD.
