...
Синхронизация каталогов | Используется для синхронизации локальных объектов каталогов (пользователей, групп, контактов) в облако, чтобы сократить объем работы администраторов. Синхронизация каталогов также называется синхронизацией каталогов на портале Azure AD и классическом портале Azure. После настройки синхронизации каталогов администраторы, используя локальную среду Active Directory, могут подготовить к работе объекты каталога для экземпляра Azure AD.
