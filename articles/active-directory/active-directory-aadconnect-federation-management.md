...
|[Добавление нового сервера AD FS](#addadfsserver) | Развертывание фермы AD FS с использованием дополнительного сервера AD FS|
|[Добавление нового прокси-сервера веб-приложения AD FS](#addwapserver) | Развертывание фермы AD FS с использованием дополнительного WAP-сервера|
|[Добавление нового федеративного домена](#addfeddomain)| Добавление федеративного домена|
...
Выберите в списке доступных задач пункт **Восстановление доверия AAD и AD FS**.
...
### Добавление нового сервера AD FS<a name=addadfsserver></a>
...
### Добавление нового прокси-сервера веб-приложения AD FS<a name=addwapserver></a>
...
### Добавление нового федеративного домена<a name=addfeddomain></a>
...
=> issue(Type = “http://schemas.microsoft.com/ws/2008/06/identity/claims/issuerid“, Value = regexreplace(john@sub.contoso.com, “.+@(?<домен>.+)“, “http://${домен}/adfs/services/trust/“));
