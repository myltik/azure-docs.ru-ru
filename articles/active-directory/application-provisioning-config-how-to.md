...
# Как настроить подготовку пользователей для приложения из коллекции Azure AD
...
## Настройка приложения для подготовки вручную
...
## Настройка приложения для автоматической подготовки
