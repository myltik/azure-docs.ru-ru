...
Цель этого раздела — показать, как настроить и проверить единый вход Azure AD в Aravo с использованием тестового пользователя Britta Simon.
...
В этом разделе описано, как включить единый вход Azure AD на классическом портале и настроить его в приложении Aravo.

**Чтобы настроить единый вход Azure AD в Aravo, сделайте следующее:**
...
2. На странице **How would you like users to sign on to Aravo** (Как пользователи должны входить в Aravo?) выберите **Единый вход Azure AD** и нажмите кнопку **Далее**.
