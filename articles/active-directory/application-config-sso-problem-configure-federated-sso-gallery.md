...
-   Кроме того, вы можете обратиться в группу разработчиков Azure AD по адресу <aadapprequest@microsoft.com> или оставить комментарий в учебнике, чтобы запросить обновление поддерживаемых шаблонов для приложения.
