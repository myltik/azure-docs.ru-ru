...
6. Чтобы настроить единый вход на стороне **Dow Jones Factiva**, отправьте скачанный **XML-файл метаданных** в [службу поддержки Dow Jones Factiva](https://www.dowjones.com/contact/). Специалисты службы поддержки настроят подключение единого входа SAML на обеих сторонах подключения.
