...
>[AZURE.NOTE]Если пользователи наблюдают ошибку **Достигнут предел регистрации устройств** (код ошибки: **0x801C000E - DSREG\_E\_DEVICE\_REGISTRATION\_QUOTA\_EXCCEEDED**), необходимо изменить максимальное число устройств, допустимое для пользователя. В разделе **Пользователи могут присоединять устройства к Azure AD** выберите **Добавить** и задайте допустимое число устройств для пользователя.
