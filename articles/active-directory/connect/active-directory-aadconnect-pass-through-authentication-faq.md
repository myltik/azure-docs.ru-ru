...
Рекомендуется устанавливать агенты аутентификации как можно ближе к контроллерам домена, чтобы сократить задержку входа.
...
- Цель установки агентов аутентификации на контроллерах домена (или как можно ближе к ним) состоит в сокращении задержки входа.
- Обязательно добавьте серверы, на которых установлены агенты аутентификации, в леса Active Directory, в которых находятся пользователи, пароли которых необходимо проверять.
