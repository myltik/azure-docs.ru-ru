---
title: Сквозная аутентификация Azure AD Connect и соответствие GDPR | Документация Майкрософт
...
---
# <a name="azure-active-directory-pass-through-authentication-gdpr-compliance"></a>Краткое руководство по сквозной аутентификации Azure Active Directory и соответствию GDPR
...
Соответствие GDPR для сквозной аутентификации можно обеспечить двумя способами:
...
>[!IMPORTANT]
>Не удаляйте файл **PersistedState.xml** из этой папки. Он нужен для хранения состояния предыдущей установки Azure AD Connect и используется при установке обновлений. В нем никогда не хранятся личные данные о пользователях, и его не следует удалять.
...
Сохраните скрипт в файл с расширением .PS1. Выполняйте его по мере необходимости.
