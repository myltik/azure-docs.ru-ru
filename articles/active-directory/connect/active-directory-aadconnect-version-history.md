...
Состояние: выпуск для выбранных клиентов. Этот выпуск сейчас распространяется среди небольшой случайной выборки клиентов AAD Connect, у которых включено автоматическое обновление. Мы будем расширять эту группу клиентов в течение ближайших недель, пока все наши клиенты с включенным автоматическим обновлением не получат эту версию. После этого мы опубликуем сборку для общедоступного скачивания по ссылке выше.
>[!NOTE]
