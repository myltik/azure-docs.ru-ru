...
Состояние: выпуск для выбранных клиентов. Этот выпуск в настоящее время распространяется среди небольшой случайной выборки клиентов AADConnect, у которых включено автоматическое обновление. Мы будем расширять эту группу клиентов в течение ближайших недель, пока все наши клиенты с включенным автоматическим обновлением не получат эту версию. После этого мы опубликуем сборку для общедоступной загрузки по ссылке выше. Мы планируем реализовать это к середине марта 2018 года.
>[!NOTE]
...
* Устранены ошибки с временным окном выполнения фоновых задач для страницы фильтрации разделов.
...
* Изменен установщик. Теперь ему не нужно разрешение сопоставления безопасности для чистой установки Azure AD Connect.
