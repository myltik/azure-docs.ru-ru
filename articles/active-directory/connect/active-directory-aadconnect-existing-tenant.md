---
title: "Azure AD Connect: если имеется существующий клиент | Документация Майкрософт"
...
Можно управлять одними пользователями в локальной среде, а другими — в облаке. Распространенный сценарий для этой конфигурации — организация, состоящая из офисных работников и работников физического труда. Офисные работники используют локальную учетную запись AD, а работники физического труда — нет. Будет удобно управлять одними пользователями в локальной среде, а другими — в Azure AD.
