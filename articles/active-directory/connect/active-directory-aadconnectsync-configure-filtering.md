...
В следующих примерах значение приоритета начинается с 500. Это значение обеспечивает вычисление этих правил после применения стандартных правил (чем ниже приоритет, тем выше числовое значение).
