...
![Страница "Фильтрация домена и подразделения"](./media/active-directory-aadconnect-get-started-custom/domainoufiltering.png) На этой странице мастера настраивается фильтрация по доменам и подразделениям. Дополнительные сведения см. в разделах [Фильтрация по доменам](active-directory-aadconnectsync-configure-filtering.md#domain-based-filtering) и [Фильтрация по подразделениям](active-directory-aadconnectsync-configure-filtering.md#organizational-unitbased-filtering). При использовании фильтрации по подразделениям новые подразделения, добавляемые позже, синхронизируются по умолчанию. Если требуется, чтобы новые подразделения не синхронизировались, такое поведение можно настроить после того, как мастер завершит работу с [фильтрацией по подразделениям](active-directory-aadconnectsync-configure-filtering.md#organizational-unitbased-filtering).
