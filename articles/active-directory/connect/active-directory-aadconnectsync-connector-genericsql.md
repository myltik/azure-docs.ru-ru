...
| Функция | Поддержка |
| --- | --- |
| Подключенный источник данных |Все 64-разрядные драйверы ODBC поддерживают этот соединитель. Соединитель протестирован со следующими решениями:  <li>Microsoft SQL Server и SQL Azure</li><li>IBM DB2 10.x</li><li>IBM DB2 9.x</li><li>Oracle 10 и 11g</li><li>MySQL 5.x</li> |
...
Чтобы импортировать многозначных атрибутов объекта, вы должны предоставить имя таблицы или представления в **имя многозначных таблицы и представления** и условия соответствующих соединения в **условии Join** с родительской таблицы . Если существует более одной таблицы, допускающее в источнике данных, можно использовать объединения в одном представлении.

>[!IMPORTANT]
Агент управления универсального SQL можно работать только с одной таблицей несколькими значениями. Не следует помещать в несколько имен таблицы имя Многозначный таблицы и представления. Это ограничение универсального SQL.
