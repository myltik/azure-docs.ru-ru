...
Имя участника-пользователя (UPN) имеет формат username@domain.. Например, для пользователя домена Active Directory contoso.com по имени Джон (John) именем участника-пользователя может быть 'john@contoso.com'.. Имя участника-пользователя основано на спецификации RFC 822. Несмотря на то, что имя участника-пользователя и адрес электронной почты имеют одинаковый формат, значение имени участника-пользователя может совпадать или не совпадать с адресом электронной почты пользователя.
