...
---
# <a name="deloying-active-directory-federation-services-in-azure"></a>Развертывание служб федерации Active Directory в Azure
...
* **Назначение IP-адресов**. Выберите вариант "Динамический".
