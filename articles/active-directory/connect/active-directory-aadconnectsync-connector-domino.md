...
| Схема |<li>Пользователь (перемещаемый пользователь, контакт (лица без сертификата))</li><li>Группа</li><li>Ресурс (ресурс, комната, собрание по сети)</li><li>База данных для приема писем</li><li>Динамическое обнаружение атрибутов для поддерживаемых объектов</li><li>Поддержка до 250 пользовательских заверителей с организацией и подразделениями</li> |
...
| Объект. | Создание | Блокировка изменений | Delete |
| --- | --- | --- | --- |
