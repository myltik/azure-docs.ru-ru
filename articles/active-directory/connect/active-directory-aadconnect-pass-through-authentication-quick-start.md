...
2. Добавьте одно [пользовательское доменное имя](../active-directory-domains-add-azure-portal.md) (или несколько) в клиент Azure AD. Пользователи выполняют вход с помощью одного из этих доменных имен.
