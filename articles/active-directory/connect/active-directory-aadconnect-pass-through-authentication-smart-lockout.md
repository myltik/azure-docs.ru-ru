...
>[!NOTE]
>Функция смарт-блокировки предоставляется бесплатно. Она _включена_ по умолчанию для всех пользователей. При этом изменение порогового значения блокировки и периода блокировки с помощью API Graph Azure AD — это функция Azure AD Premium P2.
