...
>[!NOTE]
>Хотя сама функция смарт-блокировки бесплатна, изменение порогового значения блокировки и периода блокировки с помощью API Graph Azure AD — это функция Azure AD Premium P2. Для использования этой функции вы также должны быть глобальным администратором клиента.
