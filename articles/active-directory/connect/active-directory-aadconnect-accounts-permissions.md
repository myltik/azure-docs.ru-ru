...
Также поддерживается использование [автономной управляемой учетной записи службы](https://technet.microsoft.com/library/dd548356.aspx). Тем не менее, поскольку они могут использоваться только на локальном компьютере, не имеет смысла использовать их вместо учетной записи виртуальной службы по умолчанию.
