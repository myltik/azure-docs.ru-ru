...
| --- | --- | --- | --- |
| Н/Д |Пользователь, запускающий мастер установки |Администратор локального сервера |<li>Создание локальной учетной записи, которая используется в качестве [учетной записи службы модуля синхронизации](#azure-ad-connect-sync-service-account). |
