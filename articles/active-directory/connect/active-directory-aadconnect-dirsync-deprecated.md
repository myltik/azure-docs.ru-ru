...
Нет. Дата прекращения обмена данными между этими продуктами и Azure AD будет объявлена позднее. Как только они станут известны, соответствующие сведения будут опубликованы в этом разделе.
