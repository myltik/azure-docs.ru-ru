<properties
    pageTitle="Учебник. Как интегрировать NetSuite с Azure Active Directory | Microsoft Azure"
...
> [AZURE.NOTE] По умолчанию подготовленные пользователи будут добавлены в дочерний корневой раздел среды NetSuite.
