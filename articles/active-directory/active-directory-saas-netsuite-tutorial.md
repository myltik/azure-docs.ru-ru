---
title: Учебник. Как интегрировать NetSuite с Azure Active Directory | Microsoft Docs
...
---
# <a name="tutorial:-how-to-integrate-netsuite-with-azure-active-directory"></a>Учебник. Как интегрировать NetSuite с Azure Active Directory
...
## <a name="step-1:-add-netsuite-to-your-directory"></a>Шаг 1. Добавление NetSuite в каталог
...
6. В **поле поиска** введите **NetSuite**. Выберите **NetSuite** из списка результатов и нажмите кнопку **Завершить**, чтобы добавить приложение.
...
2. Откроется диалоговое окно, и вы увидите экран с вопросом "Как пользователи должны входить в NetSuite?". Выберите **Единый вход Azure AD**, а затем нажмите кнопку **Далее**.
   ...
   > 
   > 
3. На странице **Настроить параметры приложения** введите в поле **URL-адрес ответа** URL-адрес клиента NetSuite в одном из следующих форматов:
...
10. В Azure AD установите флажок подтверждения настройки единого входа, чтобы активировать сертификат, который вы загрузили в NetSuite. Нажмите кнопку **Далее**.
...
## <a name="step-4:-assign-users-to-netsuite"></a>Шаг 4. Назначение пользователей NetSuite
