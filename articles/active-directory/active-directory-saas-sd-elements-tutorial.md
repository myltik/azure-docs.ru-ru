---
title: Учебник. Интеграция Azure Active Directory с SD Elements | Microsoft Docs
...
8. В меню в верхней части экрана выберите пункт **Атрибуты**, чтобы открыть диалоговое окно **Атрибуты токена SAML**.
