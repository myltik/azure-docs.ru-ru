---
title: 'Руководство. Интеграция Azure Active Directory с приложением '
;люди";: ''
'|': ''
microsoft: ''
azure": ''
description: 'Сведения о настройке единого входа Azure Active Directory в приложение '
;люди";.": ''
...
---
# Руководство. Интеграция Azure Active Directory с приложением "Люди"
...
## Добавление приложения "Люди" из коллекции
...
1. На классическом портале Azure на странице интеграции с приложением **Люди** щелкните **Настроить единый вход**, чтобы открыть диалоговое окно **Настройка единого входа**.
...
3. На странице диалогового окна **Настройка параметров приложения** выполните действия, указанные ниже, а затем нажмите кнопку **Далее**.
   
    ![Настройка единого входа](./media/active-directory-saas-people-tutorial/tutorial_people_04.png)
   
    а. В текстовом поле **URL-адрес входа** введите URL-адрес, который используется пользователями для входа в приложение "Люди" по следующему шаблону: **https://<company name>.peoplehr.com/**.
   
    b. Если URL-адрес клиента неизвестен, обратитесь в службу поддержки приложения "Люди" по адресу [customerservices@peoplehr.com](mailto:customerservices@peoplehr.com), чтобы получить его.
   
    c. В текстовом поле **Идентификатор** введите URL-адрес клиента.
   
    г) В текстовом поле **URL-адрес ответа** введите URL-адрес по следующему шаблону: **https://itgs.peoplehr.net/Pages/Saml/ConsumeAzureAD.aspx**".
...
5. Чтобы настроить для приложения единый вход, нужно войти в клиент приложения "Люди" с правами администратора.
    ...
    а. В меню слева выберите **Параметры**.
    ...
    c. Чтобы отправить скачанный файл метаданных, в разделе **Отправить файл метаданных SAML для единого входа** нажмите кнопку **Обзор**.
...
### Создание тестового пользователя приложения "Люди"
...
Цель этого раздела — проверить конфигурацию единого входа Azure AD с помощью панели доступа. Щелкнув элемент "Люди" на панели доступа, вы автоматически войдете в приложение "Люди".
