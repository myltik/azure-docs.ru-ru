...
- Если планируется использовать функцию **синхронизации паролей**, сервер должен работать под управлением Windows Server 2008 R2 с пакетом обновления 1 (SP1) или более поздней версии.
...
- Если для подключения к Интернету используется исходящий прокси-сервер, в файл **C:\\Windows\\Microsoft.NET\\Framework64\\v4.0.30319\\Config\\machine.config** необходимо добавить следующий параметр, чтобы мастер установки и функция синхронизации Azure AD могли подключиться к Интернету и Azure AD.
