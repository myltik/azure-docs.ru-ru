...
На новом портале Azure доступны оптимизированные средства управления корпоративными приложениями. Некоторые вы уже использовали на классическом портале Azure. Новые средства позволяют более эффективно и просто управлять приложениями.

Ниже представлены новые возможности Azure AD, доступные на портале Azure.

- Новые и улучшенные возможности для работы с коллекцией приложений, в том числе упрощенная модель создания приложений и поддержка всех типов приложений, используемых на классическом портале. 
- Новые возможности быстрого запуска, которые позволяют максимально быстро выполнять пилотное развертывание нового приложения. 
- Возможность быстро настраивать политики самообслуживания. 
- Существенные улучшения прокси приложения и конфигурации единого входа, а также возможность использования собственные приложения, что позволяет выполнять на портале самые разные операции. Ниже все эти возможности описаны подробнее.

## <a name="the-new-and-improved-application-gallery"></a>Обновленная и усовершенствованная коллекция приложений

С помощью нового удобного интерфейса вы можете легко добавлять свои любимые приложения. Речь идет обо всех приложениях из нашей огромной коллекции, расширяемых в облако пользовательских приложениях, а также новых приложениях, которые вы разрабатываете.  Чтобы начать работу в этом интерфейсе, нажмите кнопку **Добавить** в обзоре **корпоративных приложений** или колонке **Все приложения**.
...
Надеемся, вам понравились обновленные функции предварительной версии. Поделитесь своими впечатлениями с нами! Вы можете опубликовать свои отзывы и предложения в разделе, посвященном **порталу администрирования** на нашем [форуме для обратной связи](https://feedback.azure.com/forums/169401-azure-active-directory/category/162510-admin-portal).  Мы работаем над новыми интересными возможностями и хотим учитывать ваши отзывы.
