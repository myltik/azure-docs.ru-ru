...
7. В диалоговом окне на странице **Настройка параметров приложения** выполните следующие действия.
    ...
    а. В текстовом поле "URL-адрес для входа" введите URL-адрес, используемый пользователями для входа в приложение Lessonly, в таком формате: **https://имя_компании.Lesson.ly/signin**. Значение **companyname** в ссылке необходимо заменить фактическим именем.


1. На странице **Настройка единого входа в Lesson.ly** сделайте следующее:
...
2. Чтобы получить помощь по настройке единого входа для приложения, обратитесь к группе поддержки Lesson.ly, отправив письмо на электронный адрес dev@lessonly.com. Прикрепите к сообщению скачанный сертификат и укажите URL-адреса метаданных (идентификатор сущности, URL-адрес единого входа и URL-адрес выхода), чтобы специалисты Lesson.ly смогли настроить единый вход со своей стороны.
...
> [!NOTE]
> Если вам нужно вручную создать пользователя, необходимо обратиться в службу поддержки Lesson.ly.
> 
> 
