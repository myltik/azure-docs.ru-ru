...
9. На странице диалогового окна **Единый вход** сделайте следующее:
    ...
    г) В текстовое поле **URL-адрес страницы входа** вставьте значение **URL-адреса службы единого входа SAML**, скопированное на портале Azure.
    ...
    g. Нажмите кнопку **Сохранить изменения**.
