...
## <a name="enable-the-application-integration-for-syncplicity"></a>Включение интеграции приложений для Syncplicity
В этом разделе рассматривается включение интеграции приложений для Syncplicity.

**Чтобы включить интеграцию приложений для Syncplicity, выполните следующее.**
...
1. На странице интеграции с приложением **Syncplicity** на классическом портале Azure щелкните **Настройка единого входа**, чтобы открыть диалоговое окно **Настройка единого входа**.
...
**Чтобы назначить пользователей Syncplicity, выполните следующее.**
