...
Расширение является обязательным для пользователей, которые используют единый вход на основе пароля. После установки пользователи могут также включить дополнительные функции, выполнив вход в расширение с помощью элемента **Sign in to get started** (Войдите, чтобы начать работу). 

- Пользователи могут входить в приложения напрямую, используя **URL-адрес для входа** в приложение. Когда пользователь переходит по URL-адресу для входа в приложение, расширение определяет это и позволяет войти в приложение из расширения.
- Пользователи также могут запусткать свои приложения с панели доступа с помощью функции **быстрого поиска** в расширении. 
- В разделе **Недавно использованные** также отображаются три приложения, запущенные последними.
