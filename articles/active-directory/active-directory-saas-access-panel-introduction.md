...
- Самостоятельное управление группами. В частности, можно создавать группы безопасности и управлять ими, а также запрашивать членство в группах безопасности в Azure AD. Дополнительные сведения см. в разделах [Самостоятельное управление группами пользователей в Azure AD](https://msdn.microsoft.com/library/azure/dn641267.aspx) и [Управление группами](https://msdn.microsoft.com/library/azure/dn641268.aspx).
...
После проверки подлинности пользователи смогут взаимодействовать с приложениями, интегрированными в каталог администратором. Чтобы узнать, как интегрировать приложения в Azure AD, см. статью [Возможности доступа к приложениям и единый вход в Azure Active Directory](active-directory-appssoaccess-whatis.md).
...
Это приложения, добавленные администратором в раздел Active Directory на портале управления Azure, с режимом единого входа «\*Единый вход по паролю\*». <br> Все пользователи в каталоге будут видеть все приложения, настроенные в этом режиме.
