...
5. Чтобы настроить единый вход для приложения, ознакомьтесь с руководством по интеграции единого входа Soonr Workplace, либо обратитесь к партнерам по интеграции для получения дополнительных сведений.
