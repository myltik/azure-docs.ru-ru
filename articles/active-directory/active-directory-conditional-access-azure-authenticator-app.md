...
---
title: Azure Authenticator для Android | Microsoft Docs
...
7. Коснитесь **ОК** на следующем экране. Не изменяйте имя сертификата. Появится сообщение «Присоединение к рабочей области». Приложение Azure Authenticator выполняет попытку подключить устройство к рабочей области. На следующем экране должно появиться сообщение о присоединении к рабочей области.
...
7. В строках **Кому** и **Тема** укажите информацию, полученную от службы поддержки Майкрософт.
