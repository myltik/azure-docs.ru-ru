...
Возможна ситуация, при которой Azure Active Directory обнаружит ложное срабатывание, вызываемое IP-адресами, фактически принадлежащими вашей организации, для таких [типов событий риска](active-directory-reporting-risk-events.md#risk-event-types): *Невозможно переместиться в нетипичные расположения* и *Входы с IP-адресов с подозрительными действиями*. 
