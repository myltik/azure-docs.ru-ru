...
* Полный список ресурсов для разработчиков, в том числе сведения о поддержке в Azure AD протоколов и потоков предоставления авторизации OAuth2, см. в [руководстве разработчика по Azure AD][AAD-Developers-Guide].
* Дополнительные сведения о процессе интеграции приложений см. в статье [Интеграция с Azure Active Directory][ACOM-How-To-Integrate].
