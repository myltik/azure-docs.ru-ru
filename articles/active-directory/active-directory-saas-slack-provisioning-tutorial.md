...
В результате все групповые объекты, назначенные в Slack в разделе **Пользователи и группы**, полностью синхронизируются из Azure AD в Slack. В разделе **Сведения о синхронизации** можно отслеживать ход выполнения и переходить по ссылкам для просмотра отчетов по подготовке, в которых зафиксированы все действия, выполняемые в приложении Slack службой подготовки.
