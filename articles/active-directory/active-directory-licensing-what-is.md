...
> [AZURE.IMPORTANT] Подписки Azure AD Premium и Basic, а также Enterprise Mobility Suite ограничены подготовленными для них каталогами и клиентами. Подписки нельзя разделять между каталогами или использовать их для предоставления прав пользователям в других каталогах. Подписки можно перемещать между каталогами, но для этого нужно отправить запрос в службу поддержки или отменить подписку и повторно купить ее, если она приобретена напрямую.
