...
Цель данного учебника — продемонстрировать, как настроить единый вход между Azure Active Directory и New Relic.
...
По завершении работы с этим руководством пользователи Azure Active Directory, которые были назначены в New Relic, смогут выполнять единый вход с помощью панели доступа AAD.
