...
Самый простой вариант — использовать MFA Azure для пользователей, активирующих привилегированную роль. Для этого сначала убедитесь, что эти пользователи лицензированы (при необходимости) и что они зарегистрированы для MFA Azure. Дополнительные сведения о том, как это сделать, см. в статье [Приступая к работе с Azure Multi-Factor Authentication в облаке](../multi-factor-authentication/multi-factor-authentication-get-started-cloud.md). Рекомендуется, но не обязательно, настроить принудительную MFA в Azure AD для этих пользователей при входе. Это вызвано тем, что многофакторная проверка подлинности будет производиться самой системой управления привилегированными пользователями Azure AD.
