...
> [AZURE.NOTE] Различные представления данных см. в разделе [Возможности Azure Active Directory](https://www.microsoft.com/server-cloud/products/azure-active-directory/Features.aspx).
...
| Free Edition| Basic Edition| Premium Edition| Только приложения Office 365 |
| :-: | :-: | :-: | :-: |
| 10 приложений на пользователя [1] <br> (предварительно интегрированные приложения SaaS и интегрированные разработчиками приложения)| 10 приложений на пользователя [1] <br>(уровень "Бесплатный" и прокси-приложения) | Без ограничений [2] <br> (уровни "Бесплатный", "Базовый" и шаблоны самостоятельной интеграции приложений)| 10 приложений на пользователя [1] <br> (предварительно интегрированные приложения SaaS и интегрированные разработчиками приложения)|
