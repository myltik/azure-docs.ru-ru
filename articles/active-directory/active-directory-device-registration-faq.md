...
**Ответ.** В данный момент нет возможности просмотреть все зарегистрированные устройства на портале Azure. Для поиска всех устройств можно использовать Azure PowerShell. Дополнительные сведения см. в описании командлета [Get-MsolDevice](https://docs.microsoft.com/powershell/msonline/v1/get-msoldevice).
