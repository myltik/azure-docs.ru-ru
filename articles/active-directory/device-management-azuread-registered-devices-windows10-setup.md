---
title: "Как настроить устройства, зарегистрированные в Azure Active Directory | Документация Майкрософт"
...
---
# <a name="how-to-configure-azure-active-directory-registered-windows-10-devices"></a>Как настроить устройства Windows 10, зарегистрированные в Azure Active Directory
