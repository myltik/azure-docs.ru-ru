...
1.  На странице интеграции с приложением **Cisco Webex** портала Azure AD нажмите **Настройка единого входа**. Вы увидите диалоговое окно **Настройка единого входа**.
...
8.  В разделе "Настройка федеративного единого входа в Интернете" выполните следующие действия.
    ...
    9.  На странице **Настройка единого входа в Cisco Webex** портала Azure скопируйте значение поля **URL-адрес удаленного выхода** и вставьте его в текстовое поле **URL-адрес выхода для клиентской службы единого входа**.
