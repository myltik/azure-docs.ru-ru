...
3. Выберите **Start local trace** (Запустить локальную трассировку).
   ...
   ![Запуск записи сетевых данных](./media/application-proxy-working-with-proxy-servers/start-local-trace.png)

3. Запустите службу соединителя прокси приложения Azure AD.
4. Остановите запись сетевых данных.

   ![Остановка записи сетевых данных](./media/application-proxy-working-with-proxy-servers/stop-trace.png)
