...
* **Требовать многофакторную проверку подлинности, если не на работе**. Если выбран этот вариант, пользователю с доверенным IP-адресом не нужно проходить многофакторную проверку подлинности. Диапазоны доверенных IP-адресов можно настроить на странице параметров многофакторной проверки подлинности или с помощью настройки диапазонов общедоступных IP-адресов на вкладке "Настройка" каталога.
