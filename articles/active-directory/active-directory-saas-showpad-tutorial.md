...
6. В поле поиска введите **Showpad**.
	...
	![Создание тестового пользователя Azure AD](./media/active-directory-saas-showpad-tutorial/tutorial_showpad_01.png)
...
3. **[Создание тестового пользователя Showpad](#creating-a-showpad-test-user)** нужно для того, чтобы в Showpad также существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
1. На классическом портале Azure на странице интеграции с приложением **Showpad** щелкните **Настроить единый вход**, чтобы открыть диалоговое окно **Настройка единого входа**.
...
3. На странице диалогового окна **Настройка параметров приложения** выполните описанные ниже действия и нажмите кнопку **Далее**.

	![Настройка единого входа](./media/active-directory-saas-showpad-tutorial/tutorial_showpad_04.png)


    а. В текстовом поле **URL-адрес входа** введите URL-адрес, по которому пользователи входят в приложение Showpad, в следующем формате: `https://<company name>.showpad.biz/login`.
...
7. Откройте параметр **Единый вход** и нажмите кнопку **Включить**.
 
	![Настройка единого входа на стороне приложения](./media/active-directory-saas-showpad-tutorial/tutorial_showpad_002.png)

8. В диалоговом окне **Добавление службы SAML 2.0** выполните следующие действия.
	...
	c. Скопируйте содержимое загруженного XML-файла с метаданными и вставьте его в текстовое поле **Метаданные XML**.
...
1. На классическом портале Azure щелкните **Приложения** в верхнем меню.
