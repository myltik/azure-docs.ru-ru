---
title: Руководство. Интеграция Azure Active Directory с Showpad | Microsoft Docs
...
1. На странице **Настройка единого входа в приложение Showpad** выполните описанные ниже действия и нажмите кнопку **Далее**.
