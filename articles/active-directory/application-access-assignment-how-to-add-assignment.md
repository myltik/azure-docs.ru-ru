...
Для включения самостоятельного доступа к приложениям для приложения сделайте следующее:
...
9.  Чтобы выбрать группу, в которую необходимо добавить пользователей, запрашивающих доступ к этому приложению, щелкните селектор рядом с меткой **К какой группе следует добавить назначенных пользователей?** и выберите группу.
...
11. **(Необязательно.) В приложениях, использующих единый вход по паролю,** при необходимости можно разрешить утверждающим лицам указывать пароли, которые отправляются приложению для утвержденных пользователей, установите переключатель **Разрешить утверждающим лицам задавать пароли пользователей для этого приложения?** в состояние **Да**.
