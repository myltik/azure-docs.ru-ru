<properties
    pageTitle="Учебник. Интеграция Azure Active Directory с @Task| Microsoft Azure"
...
4. **[Создание тестового пользователя @Tasktest](#creating-a-halogen-software-test-user)** требуется для создания в @Taskthat пользователя Britta Simon, связанного с представлением этого же пользователя в Azure AD.
