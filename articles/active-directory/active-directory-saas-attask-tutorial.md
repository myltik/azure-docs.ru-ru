...
Для настройки интеграции с Azure AD с @Task, необходимо следующее:
...
Для настройки и проверки Azure AD единого входа с @Task, необходимо выполнить следующие стандартные блоки:
...
**Чтобы настроить Azure AD единого входа с @Task, выполните следующие действия:**
...
**Чтобы создать пользователя с именем Саймон Britta @Task, выполните следующие действия:**
...
Цель этого раздела — позволить пользователю Britta Simon использовать единый вход Azure, предоставив ему доступ к @Task.

![Назначение пользователя][200] 

**Для назначения Саймон Britta для @Task, выполните следующие действия:**
