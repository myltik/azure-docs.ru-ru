...
В этом разделе можно настроить и проверить единый вход Azure AD в eTouches с использованием тестового пользователя Britta Simon.

Чтобы единый вход работал, в Azure AD необходимо указать, какой пользователь в eTouches соответствует пользователю в Azure AD. Иными словами, необходимо установить связь между пользователем Azure AD и соответствующим пользователем в eTouches.
...
2. В диалоговом окне **Атрибуты токена SAML** для каждой строки в таблице ниже выполните следующие действия:
 ...
 1. Щелкните **Добавить атрибут пользователя**, чтобы открыть диалоговое окно **Добавить атрибут пользователя**.
  ...
  4. Нажмите **Завершено**.    
3. На классическом портале Azure на странице интеграции с приложением **eTouches** щелкните **Настройка единого входа**, чтобы открыть диалоговое окно **Настройка единого входа**.
   
    ![Настройка единого входа][6] 
4. На странице **Как пользователи должны входить в eTouches** выберите **Единый вход Azure AD** и нажмите кнопку **Далее**.
...
5. В диалоговом окне на странице **Настройка параметров приложения** выполните следующие действия.
  ...
  1. В текстовом поле **URL-адрес для входа** введите URL-адрес, используемый для входа в приложение eTouches, в следующем формате: **https://www.eiseverywhere.com/saml/accounts/?sso&accountid=\<ИД_учетной записи\>**.
...
6. На странице **Configure single sign-on at eTouches** (Настройка единого входа в eTouches) выполните следующие действия:
  ...
  1. Нажмите **Скачать метаданные** и сохраните файл на свой компьютер.
  2. Нажмите кнопку **Далее**.
7. Чтобы настроить единый вход для приложения eTouches, выполните следующие действия:  
  1. Войдите в приложение **eTouches** с правами администратора. 
  2. Перейдите к настройке **SAML**.
  3. В разделе **Общие настройки** вставьте содержимое метаданных федерации Azure AD в текстовое поле.
  4. Нажмите кнопку **Save & Stay** (Сохранить и остаться).
  5. В разделе метаданных SAML нажмите кнопку **Update Metadata** (Обновить метаданные). 
  6. Откроется страница и будет выполнен единый вход. Если единый вход работает, можно настроить имя пользователя.
  7. В поле **Имя пользователя** выберите **emailaddress**, как показано на изображении ниже. 
  8. Скопируйте значение **SSO URL / ACS** (URL-адрес единого входа и ACS) и вставьте его в текстовое поле "URL-адрес для входа" мастера настройки приложения Azure AD.
...
5. На странице диалогового окна **Тип учетной записи пользователя** выполните следующие действия.
 ...
 ![Создание тестового пользователя Azure AD](./media/active-directory-saas-etouches-tutorial/create_aaduser_05.png) 
  1. В поле «Тип пользователя» выберите значение «Новый пользователь в вашей организации».
  2. В текстовом поле **Имя пользователя** введите **BrittaSimon**.
  3. Нажмите кнопку **Далее**.
6. На странице диалогового окна **Профиль пользователя** выполните следующие действия.

 ![Создание тестового пользователя Azure AD](./media/active-directory-saas-etouches-tutorial/create_aaduser_06.png)  
