---
title: Руководство. Интеграция Azure Active Directory с eTouches | Microsoft Docs
...
1. На классическом портале Azure на странице интеграции с приложением **eTouches** щелкните **Настроить единый вход**, чтобы открыть диалоговое окно **Настройка единого входа**.
   
    ![Настройка единого входа][6]
2. На странице **How would you like users to sign on to eTouches** (Как пользователи должны входить в eTouches) выберите **Единый вход Azure AD** и нажмите кнопку **Далее**.
