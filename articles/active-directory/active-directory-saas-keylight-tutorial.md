...
3. В диалоговом окне на странице **Настройка параметров приложения** выполните следующие действия.
    ...
    а. В текстовом поле "URL-адрес входа" введите URL-адрес, используемый пользователями для входа в приложение Keylight, по следующей схеме: **"https://\<название организации\>.keylightgrc.com/Login.aspx?saml=1"**.
...
5. На диалоговой странице **Изменение параметров SAML** выполните следующие действия:

	![Настройка единого входа](./media/active-directory-saas-keylight-tutorial/405.png)

    а. Задайте параметру **Проверка подлинности SAML** значение **Активно**.
    ...
    ж. Задайте параметру **Автоматическая подготовка пользователей** значение **Активно**.

    h. Задайте параметру **Тип учетной записи для автоматической подготовки** значение **С полным доступом**.

    i. Задайте параметру **Роль безопасности для автоматической подготовки** значение **Права обычного пользователя с SAML**.
   
    j. Задайте параметру **Конфигурация безопасности для автоматической подготовки** значение **Конфигурация обычного пользователя**.
   
    k. В текстовое поле "Атрибут электронной почты" введите значение \*\***http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress**.

    l. В текстовое поле **Атрибут имени** введите значение \*\***http://schemas.xmlsoap.org/ws/2005/05/identity/claims/givenname**.
...
В этом разделе никакие действия с вашей стороны не требуются. Новый пользователь, если он еще не существует, создается при доступе к Keylight. [Настройка единого входа в Azure AD](#configuring-azure-ad-single-single-sign-on).
