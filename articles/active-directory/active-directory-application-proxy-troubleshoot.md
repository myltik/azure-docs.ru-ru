<properties
	pageTitle="Устранение неполадок прокси-сервера приложений"
...
![Снимок экрана: свойства соединителя прокси-сервера приложений Microsoft AAD][connectorproperties.png]
...
- При необходимости доступны более подробные журналы, если включить журналы аналитики и отладки, а также журнал сеансов соединителя прокси-сервера приложений, как показано на следующем рисунке:

[Снимок экрана: журнал сеансов соединителя прокси-сервера приложений][sessionlog.png]
...
| Веб-сайт не может отобразить страницу. | Пользователь может получить эту ошибку при попытке доступа к опубликованному вами приложению, если оно является приложением OWA. Это может быть вызвано одной из следующих причин. | Соответствующие шаги по уменьшению риска. |
