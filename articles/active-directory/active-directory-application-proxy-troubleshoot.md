...
| --- | --- | --- |
| К этому корпоративному приложению нет доступа. Вы не авторизованы для доступа к этому приложению. Ошибка авторизации. Не забудьте назначить пользователю доступ к этому приложению. |Возможно, вы не назначили пользователя для этого приложения. |Перейдите на вкладку **Приложение** и в разделе **Пользователи и группы** назначьте этого пользователя или группу пользователей для этого приложения. |
...
## <a name="connector-troubleshooting"></a>Устранение неполадок соединителя
