...
Если вы изменили путь для включения содержимого, на которое указывает ссылка, но при этом вы хотите перенаправлять пользователей на внутреннюю ссылку пути, см. инструкции в записи блога [Настройка правильной ссылки на приложения Application Proxy на панели доступа Azure AD и в средстве запуска приложений Office 365](https://blogs.technet.microsoft.com/applicationproxyblog/2016/04/06/setting-the-right-link-for-application-proxy-applications-in-the-azure-ad-access-panel-and-office-365-app-launcher/).
...
Если во время работы мастера установки соединителя регистрация завершилась сбоем, вы можете выяснить причину, просмотрев журнал событий в разделе Applications and Services Logs\\Microsoft\\AadApplicationProxy\\Connector\\Admin или запустив следующую команду Windows PowerShell:
