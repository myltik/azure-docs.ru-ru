...
Для работы единого входа в Azure AD необходимо знать, какой пользователь в Workrite соответствует пользователю в Azure AD. Иными словами, необходимо установить связь между пользователем Azure AD и соответствующим пользователем в Workrite.  
...
### <a name="creating-a-workrite-test-user"></a>Создание тестового пользователя Workrite
...
4. В диалоговом окне **Создание пользователя** сделайте следующее:
    ...
    а. Заполните поля **Email** (Адрес электронной почты), **First Name** (Имя) и **Surname** (Фамилия) данными действительного пользователя Azure AD, которого необходимо подготовить.
