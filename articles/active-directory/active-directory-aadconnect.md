...
| Решение | Сценарий |
| ----- | ----- |
| Перед началом работы: [оборудование и необходимые компоненты](active-directory-aadconnect-prerequisites.md) | <li>Действия, которые нужно выполнить до установки Azure AD Connect.</li> |
