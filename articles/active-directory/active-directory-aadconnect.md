...
- При развертывании служб федерации Active Directory серверы, на которых будут установлены службы AD FS, должны работать под управлением Windows Server 2012 R2 или более поздней версии.
