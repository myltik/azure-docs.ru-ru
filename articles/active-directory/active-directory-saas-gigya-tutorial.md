...
6. В разделе **Настройка Gigya** щелкните **Настроить Gigya**, чтобы открыть окно **Настройка единого входа**. Скопируйте **идентификатор сущности SAML и URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.
...
9. В разделе **Вход SAML** выполните следующие действия.
    ...
    г) В текстовое поле **Формат идентификатора имени** вставьте значение **формата идентификатора имени**, скопированное на портале Azure.
