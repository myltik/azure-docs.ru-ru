...
После включения MSI для ресурса Azure, [например виртуальной машины Azure](msi-qs-configure-portal-windows-vm.md) или [масштабируемого набора виртуальных машин Azure](msi-qs-configure-portal-windows-vmss.md), сделайте следующее:
...
- Чтобы включить MSI для виртуальной машины Azure, см. инструкции в статье о [настройке управляемого удостоверения службы (MSI) на виртуальной машине Azure с помощью портала Azure](msi-qs-configure-portal-windows-vm.md).
