<properties
	pageTitle="Управление именами личных доменов в предварительной версии Azure Active Directory | Microsoft Azure"
...
# Управление именами личных доменов в предварительной версии Azure Active Directory
...
4. В колонке ***имя\_каталога* — Доменные имена** выберите доменное имя, которое требуется сделать основным.

5.  В колонке ***доменное\_имя*** (т. е. в отобразившейся колонке с новым доменным именем в заголовке) щелкните **Сделать основным**. При появлении запроса подтвердите свой выбор.
