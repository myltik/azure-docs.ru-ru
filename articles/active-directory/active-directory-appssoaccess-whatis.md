...
*	Azure AD поддерживает автоматическую подготовку и ее отзыв для всех приложений на вкладке "Избранные" в [коллекции приложений Azure Active Directory](http://azure.microsoft.com/marketplace/active-directory/all/).
...
*	**Запрашивание интеграции приложения**. Вы можете запросить поддержку для необходимого приложения на [форуме с отзывами об Azure AD](http://feedback.azure.com/forums/169401-azure-active-directory).
...
Панель доступа на сайте https://myapps.microsoft.com представляет собой веб-портал, который позволяет конечным пользователям с учетной записью организации в Azure Active Directory просматривать и запускать облачные приложения, к которым им предоставил доступ администратор Azure AD. Кроме того, если вы — конечный пользователь [Azure Active Directory Premium](http://azure.microsoft.com/pricing/details/active-directory/), то вы можете использовать возможности панели доступа для самостоятельного управления группами.
