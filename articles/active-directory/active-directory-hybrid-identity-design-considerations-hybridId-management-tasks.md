...
# Планирование жизненного цикла гибридной идентификации 
...
## Определение задач управления гибридной идентификацией
...
![](./media/hybrid-id-design-considerations/Directory_synchronization.png) Для правильного проектирования и синхронизации системы гибридной идентификации ответьте на следующие вопросы: • Какие решения синхронизации доступны для решения для гибридной идентификации? • Какие возможности единого входа доступны? • Каковы доступные варианты федерации удостоверений между B2B и B2C?

## Дальнейшие действия
[Определение стратегии принятия управления гибридной идентификацией](active-directory-hybrid-identity-design-considerations-lifecycle-adoption-strategy.md)
