<properties
    pageTitle="Справочник по API отчета о действиях при входе Azure Active Directory | Microsoft Azure"
...
> [AZURE.NOTE] При использовании Graph Explorer каждый знак в полях фильтра нужно указывать в требуемом регистре.
