...
19. Выполните следующие действия на этой странице.
    ...
    а. В текстовом поле **Путь** введите **/**.

    b. В текстовое поле **IDP URL** (URL-адрес IDP) введите значение **URL-адреса службы единого входа SAML**, скопированное с портала Azure.
