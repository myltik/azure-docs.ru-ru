...
В Azure Active Directory (Azure AD), каждый клиент является полностью независимым ресурсом: логически независимым от других клиентов, которыми вы управляете однорангового узла. Между клиентами нет связи типа "родительский объект — дочерний объект". Такая независимость клиентов подразумевает и независимость ресурсов, административную независимость и независимость синхронизации.
