---
title: Руководство. Интеграция Azure Active Directory с Jostle | Microsoft Docs
...
1. На странице **Configure single sign-on at Jostle** (Настройка единого входа в Jostle) нажмите кнопку **Скачать метаданные**, а затем сохраните файл метаданных на свой компьютер.
