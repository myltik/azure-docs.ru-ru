...
1. Выберите свой каталог и щелкните **Настройка**. ![Снимок экрана настройки прокси приложения: щелкните "Управление группами соединителей"](./media/active-directory-application-proxy-connectors/app_proxy_connectors_creategroup.png)
