...
1.  На странице интеграции с приложением **EmpCenter** классического портала Azure нажмите **Настройка единого входа**, чтобы открыть диалоговое окно **Настройка единого входа**.
