---
title: Учебник. Интеграция Azure Active Directory с EmpCenter | Microsoft Docs
...
5. Отправьте скачанный файл метаданных в службу поддержки EmpCenter.
   ...
   > [!NOTE]
   > Настройка единого входа должна выполняться службой поддержки EmpCenter. Как только единый вход для вашей подписки будет включен, вы получите уведомление.
   > 
   > 
