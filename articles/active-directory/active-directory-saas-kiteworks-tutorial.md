---
title: Руководство по интеграции Azure Active Directory с Kiteworks | Microsoft Docs
...
4. В разделе **Authentication and Authorization** (Аутентификация и авторизация) щелкните **SSO Setup** (Настройка единого входа).
