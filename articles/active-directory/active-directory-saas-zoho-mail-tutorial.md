...
1.  На странице интеграции с приложением **Zoho Mail** классического портала Azure AD щелкните **Настройка единого входа**, чтобы открыть соответствующее диалоговое окно.
...
3.  На странице **Настройка URL-адреса приложения** выполните следующие действия.
	...
	а. В текстовом поле **Zoho Mail Sign On URL** (URL-адрес входа в Zoho) введите URL-адрес в следующем формате: `http://<company name>.ZohoMail.com`.
...
8.  В разделе **Информация о проверке подлинности SAML** сделайте следующее:
    ...
    1.  На странице диалогового окна **Configure single sign-on at Zoho Mail** (Настройка единого входа в Zoho Mail) классического портала Azure скопируйте значение поля **URL-адрес удаленного входа** и вставьте его в текстовое поле **URL-адрес входа**.
    2.  На странице диалогового окна **Configure single sign-on at Zoho Mail** (Настройка единого входа в Zoho Mail) классического портала Azure скопируйте значение поля **URL-адрес удаленного выхода** и вставьте его в текстовое поле **URL-адрес выхода**.
    3.  На странице диалогового окна **Configure single sign-on at Zoho Mail** (Настройка единого входа в Zoho Mail) классического портала Azure скопируйте значение поля **Change Password URL** (URL-адрес изменения пароля) и вставьте его в текстовое поле **Change Password URL** (URL-адрес изменения пароля).
