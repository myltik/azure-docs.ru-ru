...
3.  На странице **Настройка URL-адреса приложения** в текстовом поле **URL-адрес для входа в Zoho Mail** введите свой URL-адрес, используя следующий шаблон **http://company.ZohoMail.com*", а затем нажмите кнопку **Далее**.
...
3.  Выберите **Сведения о пользователе > Добавить пользователя**.
