<properties
    pageTitle="Управление подготовкой пользователей для корпоративных приложений в предварительной версии Azure Active Directory | Microsoft Azure"
...
#Управление подготовкой учетных записей пользователей для корпоративных приложений на новом портале Azure (предварительная версия)
...
Если нажать кнопку **Проверить подключение**, можно проверить определенные учетные данные. В ходе этой проверки осуществляется попытка подключения Azure AD к приложению для подготовки приложения.
