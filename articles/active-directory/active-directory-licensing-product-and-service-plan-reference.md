---
title: "Справочник по продуктам и планам службы в Azure Active Directory | Документация Майкрософт"
description: "Справочник по продуктам и планам службы"
...
---
# <a name="reference-for-products-and-service-plans-in-azure-active-directory"></a>Справочник по продуктам и планам службы в Azure Active Directory

В этой статье содержатся справочные сведения, которые могут оказаться полезными при управлении лицензиями для Microsoft Online Services.

## <a name="product-names-and-identifiers-used-in-azure-ad"></a>Названия продуктов и идентификаторы, используемые в Azure AD

При управлении лицензиями на порталах [Azure](https://portal.azure.com/#blade/Microsoft_AAD_IAM/LicensesMenuBlade/Products) или Office вы увидите понятные названия продуктов, например *Office 365 Enterprise E3* (Office 365 корпоративный E3). Однако при использовании командлетов PowerShell версии 1.0 тот же продукт определяется с помощью менее понятного имени *ENTERPRISEPACK*. При использовании PowerShell версии 2.0 или Microsoft Graph он идентифицируется с помощью значения GUID: *6fd2c87f-b296-42f0-b197-1e91e994b900*. То же самое касается планов службы, включенных в продукт.

В таблице ниже представлен список наиболее часто используемых продуктов Microsoft Online Services, а также значения их различных идентификаторов.

- **Название продукта**. Эти значения отображаются на порталах управления.
- **Идентификатор строки**. Используется командлетами PowerShell версии 1.0 при выполнении операций с лицензиями.
- **Идентификатор GUID**. Этот идентификатор используется в Azure AD Graph и Microsoft Graph.
- **Включенные планы службы**. Список планов службы, предусмотренных для продукта, и соответствующие идентификаторы строки и GUID.

>[!NOTE]
>Эти сведения достоверные по состоянию на 11 октября 2017 года. В таблице приведены наиболее часто используемые продукты.

| Название продукта | Идентификатор строки | Идентификатор GUID| Включенные планы службы |
| --- | --- | --- |--- |
...
| Имя плана службы | Идентификатор GUID |
| --- | --- |
