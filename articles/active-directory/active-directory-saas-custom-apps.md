...
Клиенты, у которых есть лицензия [Azure Active Directory Premium](active-directory-editions.md), также получают приведенные ниже дополнительные возможности:
