...
Федеративная проверка подлинности с помощью сертификата клиента не поддерживается.
...
3. Сохраните изменения в **центре сертификации**:
...
Чтобы отзыв оставался в силе, для свойства **Дата вступления в силу** списка отзыва сертификатов необходимо задать дату, которая будет позже значения, заданного в поле **StsRefreshTokenValidFrom**, а также убедиться, что данный сертификат есть в списке отзыва сертификатов.
