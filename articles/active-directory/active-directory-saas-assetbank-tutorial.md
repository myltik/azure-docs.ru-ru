---
title: Руководство. Интеграция Azure Active Directory с Asset Bank | Microsoft Docs
...
2. В диалоговом окне на странице **Настройка параметров приложения** выполните следующие действия.
    ...
    а. В текстовом поле "URL-адрес входа" введите URL-адрес, используемый пользователями для входа в приложение Asset Bank, по следующему шаблону: **"https://<название\_организации>.assetbank-server.com"**.
