...
## <a name="add-asset-bank-from-the-gallery"></a>Добавление Asset Bank из коллекции
...
2. В диалоговом окне на странице **Настройка параметров приложения** выполните следующие действия.
    ...
    1. В текстовом поле "URL-адрес входа" введите URL-адрес, используемый пользователями для входа в приложение Asset Bank, по следующему шаблону: **https://\<название_организации\>.assetbank-server.com**
...
### <a name="create-a-asset-bank-test-user"></a>Создание тестового пользователя Asset Bank
...
Цель этого раздела — предоставить пользователю Britta Simon доступ к Asset Bank, чтобы этот пользователь мог использовать единый вход Azure.
