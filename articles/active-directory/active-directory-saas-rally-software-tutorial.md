...
1.  На странице интеграции с приложением **Rally Software** классического портала Azure щелкните **Настройка единого входа**, чтобы открыть диалоговое окно **Настройка единого входа**.
...
6.  На панели инструментов вверху щелкните **Настройка**, затем выберите **Подписка**.
    ...
    ![Подписки](./media/active-directory-saas-rally-software-tutorial/IC769531.png "Подписки")
...
8.  На диалоговой странице **Подписка** выполните указанные ниже действия, после чего нажмите кнопку **Сохранить и закрыть**:
    ...
    2.  На диалоговой странице **Настройка единого входа в Rally Software** классического портала Azure скопируйте значение поля **Идентификатор поставщика удостоверений** и вставьте его в текстовое поле **Identity Provider URL** (URL-адрес поставщика удостоверений).
    3.  На странице **Настройка единого входа в Rally Software** классического портала Azure скопируйте значение поля **URL-адрес удаленного выхода**.
