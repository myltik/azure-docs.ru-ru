<properties
	pageTitle="Самостоятельный доступ к приложениям и делегированное управление приложениями с помощью Azure Active Directory | Microsoft Azure"
...
#Самостоятельный доступ к приложениям и делегированное управление приложениями с помощью Azure Active Directory
...
Самостоятельный доступ к приложению — это функция платформы [Azure Active Directory Premium](http://azure.microsoft.com/trial/get-started-active-directory/), дающая администраторам каталогов следующие возможности:
...
Сейчас эту возможность поддерживают все предварительно интегрированные и настраиваемые приложения в [коллекции приложений Azure Active Directory](http://azure.microsoft.com/marketplace/active-directory/all/), которые позволяют выполнять федеративный единый вход или единый вход на основе пароля, в частности Salesforce, Dropbox, Google Apps и многие другие. В этой статье описывается, как:
...
**3.** Нажмите кнопку **Добавить** и выберите или добавьте приложение, используя параметр «Коллекция».
...
##Управление делегированным доступом к приложениям
...
###Настройка учетных данных единого входа на основе пароля (если применимо)
