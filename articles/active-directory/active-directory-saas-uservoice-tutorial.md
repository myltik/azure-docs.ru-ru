...
1.  На странице интеграции с приложением **UserVoice** классического портала Azure AD щелкните **Настройка единого входа**, чтобы открыть соответствующее диалоговое окно.
...
8.  На странице **Изменение проверки подлинности пользователя** выполните следующие действия.
    ...
    2.  На странице **Configure single sign-on at UserVoice** (Настройка единого входа в UserVoice) классического портала Azure скопируйте значение поля **URL-адрес удаленного входа** и вставьте его в текстовое поле **SSO Remote Sign-In** (URL-адрес удаленного входа для единого входа).
    3.  На странице **Configure single sign-on at UserVoice** (Настройка единого входа в UserVoice) классического портала Azure скопируйте значение поля **URL-адрес удаленного выхода** и вставьте его в текстовое поле **SSO Remote Sign-Out** (URL-адрес удаленного выхода для единого входа).
