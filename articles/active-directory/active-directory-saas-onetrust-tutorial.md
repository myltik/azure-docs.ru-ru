...
4. В поле поиска введите **OneTrust Privacy Management Software**, выберите **OneTrust Privacy Management Software** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.
    ...
    ![OneTrust Privacy Management Software в списке результатов](./media/active-directory-saas-onetrust-tutorial/tutorial_onetrust_addfromgallery.png)
...
3. Если вы хотите настроить приложение в режиме, инициируемом **поставщиком удостоверений**, то в разделе **Домены и URL-адреса приложения OneTrust Privacy Management Software** сделайте следующее.
    ...
    ![Сведения о домене и URL-адресах единого входа для приложения OneTrust Privacy Management Software](./media/active-directory-saas-onetrust-tutorial/tutorial_onetrust_url.png)
...
4. Установите флажок **Показать дополнительные параметры URL-адресов**, и выполните следующее действие, если хотите настроить приложение для работы в режиме, инициируемом **поставщиком услуг**:
    ...
    ![Сведения о домене и URL-адресах единого входа для приложения OneTrust Privacy Management Software](./media/active-directory-saas-onetrust-tutorial/tutorial_onetrust_url1.png)
...
2. Из списка приложений выберите **OneTrust Privacy Management Software**.
    ...
    ![Ссылка на OneTrust Privacy Management Software в списке "Приложения"](./media/active-directory-saas-onetrust-tutorial/tutorial_onetrust_app.png)  
