<properties pageTitle="Учебник. Интеграция Azure Active Directory с Thoughtworks Mingle | Microsoft Azure" description="Узнайте, как использовать Thoughtworks Mingle вместе с Azure Active Directory для реализации единого входа, автоматической подготовки пользователей и выполнения других задач." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi" />
#Учебник. Интеграция Azure Active Directory с Thoughtworks Mingle
>[AZURE.TIP]Чтобы оставить отзыв, нажмите [здесь](http://go.microsoft.com/fwlink/?LinkId=528082).
...
1.  На странице интеграции с приложением **Thoughtworks Mingle** портала Azure AD нажмите кнопку **Настроить единый вход**, чтобы открыть диалоговое окно **Настройка единого входа**.
...
7.  В разделе **Конфигурация единого входа** выполните следующие действия:
    ...
    1.  Чтобы передать файл метаданных, нажмите кнопку **Выбрать файл**.
...
4.  Нажмите кнопку **Новый пользователь**.
...
5.  На странице диалогового окна **Новый пользователь** выполните следующие действия:
    ...
    2.  В качестве **Типа пользователя** выберите **С полным доступом**.
    3.  Щелкните кнопку **Создать этот профиль**.
