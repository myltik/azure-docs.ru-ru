<properties 
    pageTitle="Azure AD Connect Health: история версий" 
...
Команда Azure Active Directory регулярно добавляет в Azure AD Connect Health новые функции и возможности. 

Эта статья поможет вам проследить историю выпущенных версий.
