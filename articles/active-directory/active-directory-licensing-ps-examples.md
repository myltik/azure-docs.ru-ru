...
С помощью командлета [Get-MsolGroup](https://docs.microsoft.com/powershell/msonline/v1/get-msolgroup) можно извлечь объект группы и проверить свойство *Licenses*: в нем перечислены все лицензии продуктов, назначенные группе.
```
...
Этот сценарий выполняет данные функции в отношении каждого пользователя в клиенте, используя идентификатор SKU в качестве входных данных:
```
