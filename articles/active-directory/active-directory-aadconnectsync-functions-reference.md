...
**Пример.** `RemoveDuplicates([proxyAddresses])` Возвращает очищенный атрибут proxyAddress (удалены все повторяющиеся значения).
...
**Описание.** Функция StringFromSid преобразует массив байтов или массив байтов с несколькими значениями и идентификатором безопасности в строку или строки с несколькими значениями.
