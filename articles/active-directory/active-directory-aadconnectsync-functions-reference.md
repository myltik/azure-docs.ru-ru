...
**Описание.** Функция StringFromSid преобразует массив байтов или массив байтов с несколькими значениями и идентификатором безопасности в строку или строку с несколькими значениями.
