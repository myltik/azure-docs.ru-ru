...
1.  Устройства можно зарегистрировать, когда выполняется присоединение к домену Azure AD. Ознакомьтесь с дополнительными сведениями о присоединении к Azure AD, а также с параметрами, необходимыми для пользователей при присоединении к домену Azure AD.

2.  Устройства можно зарегистрировать при добавлении пользователями рабочих или учебных учетных записей Windows на личные устройства или при подключении мобильных устройств к рабочим ресурсам, требующим регистрации. Для этого необходимо включить регистрацию устройств в Azure AD на портале Azure. 

3.  Устройства можно зарегистрировать с помощью автоматической регистрации устройств для традиционных компьютеров, присоединенных к домену. Для этого сначала необходимо настроить Azure AD Connect, а затем выполнить автоматическую регистрацию устройств.
