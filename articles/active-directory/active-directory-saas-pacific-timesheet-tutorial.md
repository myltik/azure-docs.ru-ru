...
6. В разделе **Настройка Pacific Timesheet** выберите **Настроить Pacific Timesheet** и откройте окно **Настройки единого входа**. Скопируйте **идентификатор сущности SAML и URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.
