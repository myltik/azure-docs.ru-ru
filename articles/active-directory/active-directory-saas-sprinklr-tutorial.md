---
title: Учебник. Интеграция Azure Active Directory с Sprinklr | Microsoft Docs
...
5. В диалоговом окне **Изменение пользователя** сделайте следующее:
   ...
   > [!IMPORTANT]
   > Необходимо установить флажок **Пароль отключен**, чтобы дать пользователю возможность входить через поставщик удостоверений.
   > 
   > 
