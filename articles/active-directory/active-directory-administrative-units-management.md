...
> [AZURE.IMPORTANT]Создавать и использовать административные единицы можно только в том случае, если активна подписка Azure Active Directory Premium. Дополнительные сведения см. в разделе [Приступая к работе с Azure AD Premium](active-directory-get-started-premium.md).
