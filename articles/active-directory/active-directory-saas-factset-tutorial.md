...
3. В разделе **Домены и URL-адреса приложения FactSet** выполните следующие действия.
    ...
    ![Сведения о домене и URL-адресах единого входа для приложения FactSet](./media/active-directory-saas-factset-tutorial/tutorial_factset_url.png)
...
2. Из списка приложений выберите **FactSet**.
    ...
    ![Ссылка на FactSet в списке "Приложения"](./media/active-directory-saas-factset-tutorial/tutorial_factset_app.png)  
