...
После завершения этого руководства пользователи Azure AD, назначенные Kintone, будут иметь возможность единого входа в приложение на веб-сайте компании Kintone (вход, инициированный поставщиком услуг) или с помощью инструкций из статьи [Общие сведения о панели доступа](https://msdn.microsoft.com/library/dn308586).
...
1.  На странице интеграции с приложением **Kintone** портала Azure AD нажмите **Настройка единого входа**, чтобы открыть диалоговое окно **Настройка единого входа**.
...
5.  В другом окне веб-браузера войдите на веб-сайт компании **Kintone** в качестве администратора.
...
8.  В разделе **Системное администрирование > Безопасность** нажмите **Вход**.

    ![Вход](./media/active-directory-saas-kintone-tutorial/IC785881.png "Вход")

9.  Нажмите **Включить проверку подлинности SAML**.
...
10. В разделе «Проверка подлинности SAML» выполните следующие действия.
    ...
    1.  На странице **Настройка единого входа в Kintone** портала Azure скопируйте значение поля **URL-адрес удаленного входа** и вставьте его в текстовое поле **URL-адрес входа**.
    2.  На странице **Настройка единого входа в Kintone** портала Azure скопируйте значение поля **URL-адрес удаленного выхода** и вставьте его в текстовое поле **URL-адрес выхода**.
...
1.  Выполните вход на веб-сайт компании **Kintone** в качестве администратора.
...
4.  В разделе **Администрирование пользователей** нажмите **Отделы и пользователи**.
...
6.  В разделе **Новый пользователь** выполните следующие действия.

    ![Новые пользователи](./media/active-directory-saas-kintone-tutorial/IC785890.png "Новые пользователи")

    1.  Введите значения **Отображаемое имя**, **Имя входа**, **Новый пароль**, **Подтверждение пароля**, **Адрес электронной почты** и другие сведения действующей учетной записи AAD, которую вы хотите подготовить, в соответствующих текстовых полях.
...
2.  На странице интеграции с приложением **Kintone** нажмите **Назначить пользователей**.
