...
1. На странице **Настройка единого входа в RedVector** нажмите кнопку **Скачать сертификат** и сохраните файл сертификата на компьютере. Также скопируйте URL-адрес службы единого входа. Эти сведения нужно предоставить группе поддержки RedVector, чтобы настроить единый вход.
   
    ![Настройка единого входа](./media/active-directory-saas-redvector-tutorial/tutorial_redvector_08.png)
2. Чтобы настроить единый вход для своего приложения, обратитесь в группу поддержки RedVector по адресу <mailto:sso@redvector.com>. Они помогут выбрать правильный канал для настройки единого входа. В сообщении электронной почты укажите следующие данные. 
