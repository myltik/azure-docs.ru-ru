...
1. В браузере [Tor Browser](https://www.torproject.org/projects/torbrowser.html.en) перейдите по адресу [https://myapps.microsoft.com](https://myapps.microsoft.com).   
...
* [многофакторная проверка подлинности](../multi-factor-authentication/multi-factor-authentication.md) Azure AD;
