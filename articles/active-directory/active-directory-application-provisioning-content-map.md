...
# Проблемы при настройке и подготовке пользователей для приложения



<a id="i-want-to-know-when-provisioning-will-finish" class="xliff"></a>

## Я хочу знать, когда подготовка будет завершена
...
## Возникли проблемы при настройке и подготовке пользователей для приложения
  Приведенные ниже документы помогут устранить некоторые из наиболее распространенных проблем в этой категории.
