...
3.  На странице **Настройка URL-адреса приложения** выполните следующие действия.
	...
	а. В текстовом поле **Zendesk Sign In URL** (URL-адрес входа в Zendesk) введите URL-адрес в следующем формате: `https://<tenant-name>.zendesk.com`.

	b. Нажмите кнопку **Далее**.



4.  На странице **Configure single sign-on at Zendesk** (Настройка единого входа в Zendesk) нажмите кнопку **Скачать сертификат**, а затем сохраните файл сертификата локально на компьютере.
...
8.  На странице **Безопасность** щелкните вкладку **Admin & Agents** (Администраторы и агенты).
