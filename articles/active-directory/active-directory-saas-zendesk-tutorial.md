...
1.  На странице интеграции с приложением **Zendesk** портала Azure AD нажмите кнопку **Настроить единый вход**, чтобы открыть диалоговое окно **Настройка единого входа**.
...
3.  На странице **Настройка URL-адреса приложения** в текстовом поле **URL-адрес для входа в Zendesk** введите свой URL-адрес, используя следующий шаблон *https://\<имя-клиента>.zendesk.com*, а затем нажмите кнопку **Далее**.
...
4.  На странице **Настройка единого входа в Zendesk** нажмите кнопку **Загрузить сертификат**, а затем сохраните файл сертификата локально в папке **c:\\zendesk.cer**.
