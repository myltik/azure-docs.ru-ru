...
![круговая диаграмма](media/active-directory-b2b-what-is-azure-ad-b2b/adding-b2b-users-admin.png)
...
Администраторы могут создавать политики условного доступа, например многофакторной проверки подлинности, а затем применять их на уровне клиента, приложения или отдельных пользователей для защиты корпоративных приложений и данных.
...
С помощью [интерфейсов API приглашения в Azure AD B2B](https://developer.microsoft.com/graph/docs/api-reference/v1.0/resources/invitation) организация может настроить собственные процедуры регистрации, в том числе создать портал для самостоятельной регистрации, образец кода для которого мы предоставили в Github: <https://github.com/Azure/active-directory-dotnet-graphapi-b2bportal-web>
