...
3. В разделе **Домен и URL-адреса приложения CloudPassage** выполните следующие действия.
    ...
    а. В текстовом поле **URL-адрес для входа** введите URL-адрес в следующем формате: `https://portal.cloudpassage.com/saml/init/accountid`
...
12. В разделе **Параметры единого входа** сделайте следующее: 
    ...
    г) Вставьте **URL-адрес выхода** в текстовое поле **Целевая страница выхода**.
