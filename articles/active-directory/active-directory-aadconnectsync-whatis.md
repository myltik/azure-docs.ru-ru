...
| **Функции и сценарии** |
| [Предотвращение случайного удаления](active-directory-aadconnectsync-feature-prevent-accidental-deletes.md) | Описание функции *предотвращения случайных удалений* и рекомендаций по ее настройке. |
