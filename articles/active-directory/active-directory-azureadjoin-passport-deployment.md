...
- **Инфраструктура PKI**. Для поддержки использования сертификатов пользователей службой Microsoft Passport for Work необходима инфраструктура PKI. Если у вас отсутствует инфраструктура PKI или вы не хотите использовать ее для сертификатов пользователей, выполните указанные ниже действия.
