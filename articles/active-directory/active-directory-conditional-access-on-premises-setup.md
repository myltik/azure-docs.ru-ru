...
5.  В разделе **Развертывание и управление** повторите шаги 1–3, чтобы интегрировать Azure Active Directory в локальный каталог.
  1.    Добавьте домены.
  2.    Установите и запустите Azure AD Connect. Для установки Azure AD Connect выполните следующие инструкции: [Выборочная установка Azure AD Connect](./aad-connect/active-directory-aadconnect-get-started-custom.md).
