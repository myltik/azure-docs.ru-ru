...
5.	В разделе **Развертывание и управление** повторите шаги 1–3, чтобы интегрировать Azure Active Directory в локальный каталог.
  ...
  >[AZURE.NOTE] Настройте федерацию с AD FS, как описано в документе по указанной выше ссылке.[AZURE.NOTE] Функции предварительного просмотра настраивать не нужно.
