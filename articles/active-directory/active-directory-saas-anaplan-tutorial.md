...
1. На странице **Настройка единого входа в Anaplan** выполните следующие действия и нажмите кнопку **Далее**.
...
### <a name="creating-a-anaplan-test-user"></a>Создание тестового пользователя Anaplan
