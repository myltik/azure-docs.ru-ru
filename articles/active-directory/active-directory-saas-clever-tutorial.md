...
3. В разделе **Домены и URL-адреса приложения Clever** сделайте следующее:
    ...
    b. В текстовом поле **Идентификатор** введите URL-адрес в следующем формате: `https://clever.com/<companyname>`
...
6. В разделе **Атрибуты пользователя** диалогового окна **Единый вход** настройте атрибут токена SAML, как показано на рисунке выше, и выполните следующие действия:
    ...
    г) Оставьте пустым текстовое поле **Пространство имен**.
...
8. Для создания URL-адреса **метаданных** выполните следующие действия.
    ...
    d. Теперь перейдите на страницу свойств **Clever** и скопируйте **идентификатор приложения** с помощью кнопки **Копировать**, а затем вставьте его в Блокнот.
...
9. В другом окне веб-браузера войдите на корпоративный веб-сайт Clever в качестве администратора.

10. На панели инструментов выберите **Мгновенный вход**.

    ![Мгновенный вход](./media/active-directory-saas-clever-tutorial/ic798984.png "Мгновенный вход")

11. На странице **Мгновенный вход** выполните следующие действия.
      ...
      c. Введите **URL-адрес метаданных** в текстовое поле **Metadata URL** (URL-адрес метаданных).
