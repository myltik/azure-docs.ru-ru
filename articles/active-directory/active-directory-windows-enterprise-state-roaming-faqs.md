...
- Отключите перемещение IE в разделе приложений.
...
- Синхронизация избранного IE не поддерживается в предыдущих версиях Windows 10. Вам может потребоваться июльский накопительный пакет обновления для Windows 10 (сборки 10586.494 или более поздней версии), чтобы синхронизация избранного IE заработала.
...
- Если компьютер присоединен к домену с автоматической регистрацией на устройствах Azure AD, могут возникать сбои синхронизации, если компьютер находится в удаленном расположении длительное время и невозможно выполнить проверку подлинности домена. Чтобы устранить эту проблему, подключите компьютер к корпоративной сети, чтобы возобновить синхронизацию.
