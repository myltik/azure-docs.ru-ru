...
Чтобы обнаружить проверку подлинности Windows в проект MVC, мастер ищет элемент `authentication` в файле **web.config**.
...
Дополнительные сведения см. в статье [Сценарии проверки подлинности для Azure AD](http://msdn.microsoft.com/library/azure/dn499820.aspx).
