...
> [!IMPORTANT]
> Вскоре мы прекратим использовать этот метод для контроля времени существования маркеров.  Пока мы работаем над новым решением, этот метод и дальше будет работать, но когда он будет объявлен устаревшим, созданные с его помощью политики времени существования маркеров перестанут работать. 
>
>
