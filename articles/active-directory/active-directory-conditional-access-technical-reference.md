...
Некоторые группы можно освободить от подчинения правилу с помощью параметра **Исключить**. Все члены этих групп будет исключены, даже если они входят в какую-либо включенную группу.
