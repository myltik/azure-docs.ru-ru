...
Для получения идентификатора объекта для субъекта-службы Azure AD воспользуйтесь командой Get-AzureRmADServicePrincipal -SearchString <service name in quotes>.
