<properties 
    pageTitle="Руководство. Интеграция Azure Active Directory с AppDynamics | Microsoft Azure" 
...
1.  На портале Azure AD на странице интеграции с приложением **AppDynamics** щелкните **Настройка единого входа**. Откроется диалоговое окно **Настройка единого входа**.
...
3.  На странице **Настройка URL-адреса приложения** введите в текстовое поле **URL-адрес входа в AppDynamics** URL-адрес, используемый для входа в AppDynamics (например, **https://companyname.saas.appdynamics.com*")), и нажмите кнопку **Далее**.
...
8.  В разделе **Authentication Provider** (Поставщик проверки подлинности) выполните следующие действия.
    ...
    2.  На портале Azure на диалоговой странице **Настройка единого входа в AppDynamics** скопируйте значение поля **URL-адрес удаленного входа** и вставьте его в текстовое поле **URL-адрес входа**.
    3.  На портале Azure на диалоговой странице **Настройка единого входа в AppDynamics** скопируйте значение поля **URL-адрес удаленного выхода** и вставьте его в текстовое поле **URL-адрес выхода**.
...
3.  В разделе **Create User** (Создание пользователя) выполните следующие действия.
...
2.  На странице интеграции с приложением **AppDynamics** щелкните **Назначить пользователей**.
