...
3. Чтобы настроить приложение в режиме, инициированном **поставщиком удостоверений**, в разделе **Grovo Domain and URLs** (Домен и URL-адреса приложения Grovo) выполните следующие действия:
    ...
    а. В текстовом поле **Идентификатор** введите URL-адрес в следующем формате: `https://<subdomain>.grovo.com/sso/saml2/metadata`
...
4.  Установите флажок **Показать дополнительные параметры URL-адресов** и выполните следующие действия:  
    ...
    а. В текстовое поле **Состояние ретранслятора** введите URL-адрес в следующем формате: `https://<subdomain>.grovo.com`.
...
13. Во всплывающем окне **SP Initiated SAML 2.0** (SAML 2.0, инициируемый поставщиком услуг) выполните следующие действия:
    ...
    а. В текстовое поле **Идентификатор сущности** вставьте значение **идентификатора сущности SAML**, скопированное на портале Azure.

    b. В текстовое поле **Single sign on service endpoint** (Конечная точка службы единого входа) вставьте значение **URL-адреса службы единого входа SAML**, скопированное на портале Azure.
