...
5. Следуйте инструкциям на экране, а затем создайте новое веб-приложение и (или) веб-API.
  ...
  * **URI перенаправления** — расположение, в которое Azure AD будет возвращать маркеры. Для нашего примера значением по умолчанию будет `https://localhost:44326/`.
...
8. Предоставьте разрешения для приложения в клиенте. Перейдите к разделу **Параметры** > **Свойства** > **Необходимые разрешения**, а затем нажмите кнопку **Предоставить разрешения** на панели сверху. Нажмите кнопку **Да** для подтверждения.
