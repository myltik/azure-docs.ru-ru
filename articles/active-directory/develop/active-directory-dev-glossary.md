...
[Руководство разработчика по Azure AD][AAD-Dev-Guide] охватывает все темы, связанные с разработкой Azure AD, в том числе обзор[интеграции приложений][AAD-How-To-Integrate], а также основы [аутентификации Azure AD и поддерживаемые сценарии аутентификации][AAD-Auth-Scenarios].
