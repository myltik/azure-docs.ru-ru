...
5. Следуйте инструкциям на экране, а затем создайте **веб-приложение и (или) веб-API**.
  ...
  * В поле **AppID URI** (URI идентификатора приложения) введите идентификатор конкретного клиента. Например, введите `https://contoso.onmicrosoft.com/TodoListService`.
