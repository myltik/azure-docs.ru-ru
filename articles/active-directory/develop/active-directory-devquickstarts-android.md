...
7. Для URI идентификатора приложения введите `https://<your_tenant_name>/TodoListService`. Замените `<your_tenant_name>` именем вашего клиента Azure AD. Для завершения регистрации нажмите кнопку **ОК**.
