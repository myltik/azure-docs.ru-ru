...
Вы успешно настроили веб-приложение Java, чтобы при запуске в эмуляторе вычислений Azure (на http://localhost:8080/) оно выступало в роли проверяющей стороны в пространстве имен ACS. Теперь необходимо создать правила, которые будет использовать ACS при обработке утверждений для проверяющей стороны.
