...
| Имя роли | Описание |
| --------- | ----------- |
| [Участник службы управления API](#api-management-service-contributor) | Может управлять компонентами Application Insights |
...
| [Владелец](#owner) | Владельцы могут управлять всем, включая доступ. |
...
| [Участник классической сети](#classic-network-contributor) | Может управлять виртуальными машинами, но не виртуальными сетями и учетными записями хранения, к которым они подключены |
...
Операторы службы автоматизации могут запускать, останавливать, приостанавливать и возобновлять задания
...
### Участник
Участники могут управлять всем, кроме доступа
