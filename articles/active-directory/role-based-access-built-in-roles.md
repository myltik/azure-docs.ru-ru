...
| [Роль оператора службы управления API](#api-management-service-operator-role) | Может управлять службами управления API |
| [Роль читателя данных службы управления API](#api-management-service-reader-role) | Может управлять службами управления API |
...
| [Участник резервного копирования](#backup-contributor) | Может управлять всеми операциями управления резервным копированием, за исключением создания хранилища служб восстановления и предоставления доступа другим пользователям. |
| [Оператор резервного копирования](#backup-operator) | Может управлять всеми операциями управления резервным копированием, за исключением создания хранилища, удаления резервных копий и предоставления доступа другим пользователям |
| [Читатель резервных копий](#backup-reader) | Может отслеживать управление резервным копированием в хранилище служб восстановления |
...
| [Участник фабрики данных](#data-factory-contributor) | Создание фабрик данных и дочерних ресурсов внутри их, а также управление ими. |
...
| [Участник Site Recovery](#site-recovery-contributor) | Может управлять всеми операциями управления Site Recovery, за исключением создания хранилища служб восстановления и назначения прав доступа другим пользователям. |
| [Оператор Site Recovery](#site-recovery-operator) | Может выполнять отработку отказа и восстановление размещения, но не может выполнять другие действия управления Site Recovery или назначать доступ другим пользователям. |
| [Читатель Site Recovery](#site-recovery-reader) | Может отслеживать состояние Site Recovery в хранилище служб восстановления и отправлять запросы в службу поддержки. |
...
| [Участник учетной записи хранения](#storage-account-contributor) | Может управлять учетными записями хранения, но не имеет к ним доступа. |
...
| [Support Request Contributor](#support-request-contributor) (Участник с правом создавать запросы на поддержку) | Может создавать запросы в службу поддержки на уровне подписки и управлять ими. |
...
| Microsoft.Management/managementGroups/read | Перечисляет группы управления для пользователя, прошедшего аутентификацию. |
| Microsoft.Support/* | Создание запросов в службу поддержки и управление ими |
...
| Microsoft.DocumentDB/databaseAccounts/readonlykeys/action | Получение данных с панели ключей, доступных только для чтения |
| Microsoft.Insights/MetricDefinitions/read | Чтение определений метрик |
| Microsoft.Insights/Metrics/read | Чтение метрик учетной записи |
| Microsoft.Resources/subscriptions/resourceGroups/read | Чтение группы ресурсов |
| Microsoft.Support/* | Создание запросов в службу поддержки и управление ими |
...
| Microsoft.Insights/alertRules/* | Создание правил оповещения Insights и управление ими |
| Microsoft.Network/virtualNetworks/subnets/joinViaServiceEndpoint/action | Присоединяет к подсети ресурс, например учетную запись хранения или базу данных SQL. |
| Microsoft.ResourceHealth/availabilityStatuses/read | Получение данных о работоспособности ресурсов |
| Microsoft.Resources/deployments/* | Создание развертываний группы ресурсов и управление ими |
| Microsoft.Resources/subscriptions/resourceGroups/read | Чтение группы ресурсов |
