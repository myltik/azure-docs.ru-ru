...
Дополнительную документацию по PowerShell Azure Active Directory см. в разделе [Azure Active Directory Cmdlets](https://docs.microsoft.com/powershell/azuread/) (Командлеты Azure Active Directory).
