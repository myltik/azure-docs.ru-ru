<properties
	pageTitle="Изменения модели приложений Azure AD версии 2.0 | Microsoft Azure"
...
Вместе с тем конечная точка версии 2.0 по-прежнему доступна только в предварительной версии. Это означает, что необходимо соблюдать осторожность при выпуске рабочих приложений, которые зависят от нее, и быть готовым к изменениям при выходе обновлений. Только когда появится общедоступная версия конечной точки версии 2.0, мы сможем рекомендовать разработчикам внедрять соответствующие зависимости.

И наконец, мы бы хотели выразить вам благодарность за то, что вы опробовали на практике эту предварительную версию. Аналитические сведения и опыт первых исследователей имели неоценимое значение, и мы надеемся, что вы продолжите делиться своим мнением и идеями.
