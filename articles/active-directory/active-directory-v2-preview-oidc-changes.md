---
title: Изменения в конечной точке Azure AD версии 2.0 | Microsoft Docs
...
> [!IMPORTANT]
> **Задание. Убедитесь, что работа приложения не зависит от значения `profile_info`.**
> 
> 
...
> [!IMPORTANT]
> **Задание. Убедитесь, что работа приложения не зависит от значения `id_token_expires_in`.**
> 
> 
