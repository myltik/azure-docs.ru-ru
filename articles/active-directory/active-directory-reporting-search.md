<properties
	pageTitle="Поиск отчетов Azure Active Directory"
...
Отчет | Включено
--------------------------------------------------- | --------
Операции входа из неизвестных источников | Нет
Операции входа после нескольких сбоев | Нет
Операции входа из нескольких географических регионов | Нет
Операции входа с IP-адресов с подозрительными действиями | Нет
Операции входа с возможно инфицированных устройств | Нет
