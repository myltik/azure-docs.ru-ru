...
1. В разделе **Добавление источника аутентификации** выполните следующие действия: <br><br>![Единый вход в Azure AD][14] <br>
...
4. Чтобы открыть диалоговое окно **Добавление пользователя**, нажмите кнопку **Добавить пользователя** на панели инструментов внизу. <br><br> ![Создание тестового пользователя Azure AD](./media/active-directory-saas-silkroad-life-suite-tutorial/create_aaduser_04.png) <br>
