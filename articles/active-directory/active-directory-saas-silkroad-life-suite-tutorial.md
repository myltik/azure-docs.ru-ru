---
title: Руководство по интеграции Azure Active Directory с решением SilkRoad Life Suite | Microsoft Docs
...
7. В приложении **SilkRoad** щелкните **Authentication Sources** (Источники аутентификации).
...
10. В разделе **Authentication Sources** (Источники аутентификации) нажмите кнопку **Edit** (Изменить).
