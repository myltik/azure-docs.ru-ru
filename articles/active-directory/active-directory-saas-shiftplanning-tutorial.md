...
1.  На странице интеграции с приложением **ShiftPlanning** портала Azure AD нажмите кнопку **Настроить единый вход**, чтобы открыть диалоговое окно **Настройка единого входа **.
...
8.  В разделе **Единый вход** сделайте следующее:
    ...
    3.  На странице диалогового окна **Настройка единого входа в ShiftPlanning** портала Azure скопируйте значение поля **URL-адрес удаленного входа** и вставьте его в текстовое поле **URL-адрес издателя SAML**.
    4.  На странице диалогового окна **Настройка единого входа в ShiftPlanning** портала Azure скопируйте значение поля **URL-адрес удаленного выхода** и вставьте его в текстовое поле **URL-адрес удаленного выхода**.
...
2.  На странице интеграции с приложением **ShiftPlanning ** нажмите кнопку **Назначить пользователей**.
