...
Обратите внимание на следующие возможности и ограничения Graph Explorer. Возможность автозаполнения для ресурса. Чтобы опробовать эту возможность, нажмите кнопку **Использовать демонстрационную компанию** и щелкните в текстовом поле запроса (где отображается URL-адрес компании). В раскрывающемся списке можно выбрать набор ресурсов.
