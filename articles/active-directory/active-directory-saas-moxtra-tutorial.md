...
7. В разделе **Настройка Moxtra** щелкните **Настроить Moxtra**, чтобы открыть окно **Настройка единого входа**. Скопируйте **идентификатор сущности SAML и URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.
...
3. На странице **Добавление пользователя** выполните следующие действия.
    ...
    г) В текстовом поле **Подразделение** введите **Dev**.
