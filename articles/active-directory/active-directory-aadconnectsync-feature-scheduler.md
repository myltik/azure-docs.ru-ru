...
Все эти параметры можно изменить с помощью командлета `Set-ADSyncScheduler`. Параметр IsStagingModeEnabled можно задать только в мастере установки.
...
**Цикл синхронизации изменений**. Цикл синхронизации изменений включает следующие этапы:
