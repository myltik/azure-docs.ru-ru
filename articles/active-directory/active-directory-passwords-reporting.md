...
> [!IMPORTANT]
> Сейчас с помощью API отчетов и событий Azure AD вы можете получить до *75 000 отдельных событий* типа [SsprActivityEvent](https://msdn.microsoft.com/library/azure/mt126081.aspx#BKMK_SsprActivityEvent) и [SsprRegistrationActivityEvent](https://msdn.microsoft.com/library/azure/mt126081.aspx#BKMK_SsprRegistrationActivityEvent). API-Интерфейс диапазонов за последние 30 дней.
> 
...
Для доступа к этим данным необходимо создать небольшое приложение или сценарий получения этих данных с наших серверов. Дополнительные сведения см. в статье [Приступая к работе с API отчетов Azure Active Directory](active-directory-reporting-api-getting-started.md).
