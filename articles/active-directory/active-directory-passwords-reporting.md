...
---
# Параметры отчетов для управления паролями Azure AD
...
## Как просмотреть отчеты об управлении паролями на портале Azure
...
### Описание столбцов отчета на портале Azure
...
### Описание значений отчета на портале Azure
...
### Описание столбцов отчета на классическом портале Azure
...
### Описание значений отчета на классическом портале Azure
