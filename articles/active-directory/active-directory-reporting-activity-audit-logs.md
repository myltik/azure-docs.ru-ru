...
Если выбрать **тип действия** **Группа**, то станет доступным дополнительный параметр фильтра, который позволяет фильтровать данные по приведенным ниже **источникам действий**.
