...
- Если во время установки, перед завершением работы мастера установки, вы сняли флажок **Запустить процесс синхронизации…**, то повторный запуск мастера установки не позволит включить планировщик.
