...
- Различные методы [обновления предыдущей версии до последней версии](active-directory-aadconnect-upgrade-previous-version.md) Azure AD Connect.
...
- Обновление предыдущих версий не работает, если установка не была выполнена в папку по умолчанию **C:\\Program Files**.
