...
Необходимые разрешения | Разрешения, необходимые для установки обновления, см. в разделе [Учетные записи и разрешения](./connect/active-directory-aadconnect-accounts-permissions.md#upgrade).
...
* Разрешите [фильтрацию доменов и подразделений](connect/active-directory-aadconnect-get-started-custom.md#domain-and-ou-filtering) в мастере установки. Это также позволяет подключиться к лесам, в которых доступны не все домены.
...
* установка [со стандартными параметрами](connect/active-directory-aadconnect-get-started-express.md);
* возможность [настроить ADFS](connect/active-directory-aadconnect-get-started-custom.md#configuring-federation-with-ad-fs);
* возможность [обновления из DirSync](connect/active-directory-aadconnect-dirsync-upgrade-get-started.md);
