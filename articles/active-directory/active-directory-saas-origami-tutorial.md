...
3. В диалоговом окне на странице **Настройка параметров приложения** выполните следующие действия.
    ...
    а. В текстовом поле **URL-адрес входа** введите URL-адрес, используемый пользователями для входа в приложение Origami, по следующей схеме: **https://live.origamirisk.com/origami/account/login?account=\<название_организации\>**.
...
1. На странице диалогового окна "Настройка единого входа" сделайте следующее.
    ...
    b. На классическом портале Azure скопируйте значение поля **URL-адрес единого входа SAML**, а затем вставьте его в текстовое поле**Identity Provider's Sign-in Page URL** (URL-адрес страницы входа поставщика удостоверений).

    c. На классическом портале Azure скопируйте значение поля **URL-адрес службы единого выхода**, а затем вставьте его в текстовое поле **Identity Provider's Sign-out Page URL** (URL-адрес страницы выхода поставщика удостоверений).

    d. Нажмите кнопку **Обзор**, чтобы отправить файл метаданных, скачанный с классического портала Azure.
...
6.  На странице диалогового окна **Профиль пользователя** выполните следующие действия. ![Создание тестового пользователя Azure AD](./media/active-directory-saas-origami-tutorial/create_aaduser_06.png) 
...
5. В диалоговом окне добавления нового пользователя выполните следующие действия.
    ...
    d. В текстовом поле **Имя** введите **Britta**.
