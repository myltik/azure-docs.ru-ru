...
6.  Последовательно щелкните **АДМИНИСТРАТОР > Параметры группы > Безопасность**.
...
7.  В разделе **Безопасность** выполните следующие действия.
    ...
    2.  Установите флажок **Включить автоматическую подготовку**.
...
8.  После этого выполните следующие действия.
    ...
    1.  Нажмите кнопку **Выбрать файл** и отправьте скачанный сертификат.
...
2.  Последовательно выберите пункты **АДМИНИСТРАТОР > Управление пользователями > Добавить пользователя**.
    ...
    >[AZURE.IMPORTANT]Вкладка **Добавить пользователя** доступна, только если на вкладке **Безопасность** снят флажок **Включить автоматическую подготовку**.
...
3.  В разделе **Добавить пользователя** выполните следующие действия.
    ...
    1.  Введите в текстовые поля **Имя пользователя BlueJeans**, **Адрес электронной почты**, **Идентификатор собрания BlueJeans** , **Секретный код модератора**, **Полное имя** и **Компания** соответствующие данные действующей учетной записи AAD, которую вы хотите подготовить.
