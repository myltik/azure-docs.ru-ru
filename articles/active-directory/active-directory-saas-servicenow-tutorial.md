...
9. Существует два способа настройки **ServiceNow**: автоматически и вручную.

10. Чтобы настроить **ServiceNow** автоматически, выполните следующие действия:
...
11. Чтобы настроить **ServiceNow** вручную, выполните следующие действия:

12. Войдите в приложение ServiceNow в качестве администратора.

13. В левой области навигации найдите раздел **Multi-Provider SSO** (Единый вход с помощью нескольких поставщиков) с помощью панели поиска, затем щелкните **Properties** (Свойства).
...
14. В диалоговом окне **Multiple Provider SSO Properties** (Свойства единого входа для нескольких поставщиков) выполните следующие действия.
