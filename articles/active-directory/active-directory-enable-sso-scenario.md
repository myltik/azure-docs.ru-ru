...
- *КТО* — это *идентификация*, т. е. управление пользователя и группами.

- *ЧТО* — это *управление доступом* к защищенным ресурсам.

Оба компонента вместе называются *Identity and Access Management (IAM)*. Это система, для которой компания [Gartner](http://www.gartner.com/it-glossary/identity-and-access-management-iam) разработала следующее определение: "* дисциплина безопасности, благодаря которой нужные пользователи получают доступ к нужным ресурсам в нужное время и по нужным причинам *".
