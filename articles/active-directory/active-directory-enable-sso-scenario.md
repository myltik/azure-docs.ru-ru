...
Оба компонента вместе называются *Identity and Access Management (IAM)*. Это система, для которой компания [Gartner](http://www.gartner.com/it-glossary/identity-and-access-management-iam) разработала следующее определение: "*дисциплина безопасности, предоставляющая нужным пользователям доступ к нужным ресурсам в нужное время и по нужным причинам*".
