...
> ### <a name="verification-step"></a>Проверка
> Когда вы добавите пользовательский домен, не забудьте установить для него состояние **Проверено** на вкладке **Доменные имена** портала Azure AD.
...
[Страница продукта Azure Active Directory](https://azure.microsoft.com/services/active-directory/)
