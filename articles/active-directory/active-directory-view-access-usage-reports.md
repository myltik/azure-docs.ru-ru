...
|	Отчет |	Описание |
|	------												|	-----																						|
|	Операции входа из неизвестных источников |	Может указывать на попытку входа без трассировки. |
|	Операции входа после нескольких сбоев |	Может указывать на успешную атаку методом подбора. |
|	Операции входа из нескольких географических регионов |	Может указывать на то, что несколько пользователей входят с помощью одной учетной записи. |
|	Операции входа с IP-адресов с подозрительными действиями |	Может указывать на успешный вход после продолжительных попыток вторжения. |
|	Операции входа с возможно инфицированных устройств |	Может указывать на попытку входа с потенциально инфицированных устройств. |
|	Нестандартные действия при входе |	Может указывать на аномальные события при входе пользователей. |
|	Пользователи с аномальными событиями при входе |	Указывает пользователей, учетные записи которых могли быть скомпрометированы. |
...
![Операции входа из неизвестных источников](./media/active-directory-view-access-usage-reports/signInsFromUnknownSources.PNG)]
...
![Операции входа после нескольких сбоев](./media/active-directory-view-access-usage-reports/signInsAfterMultipleFailures.PNG)]
...
![Операции входа из нескольких географических регионов](./media/active-directory-view-access-usage-reports/signInsFromMultipleGeographies.PNG)]
...
![Операции входа с IP-адресов с подозрительными действиями](./media/active-directory-view-access-usage-reports/signInsFromIPAddressesWithSuspiciousActivity.PNG)]
...
![Операции входа с возможно инфицированных устройств](./media/active-directory-view-access-usage-reports/signInsFromPossiblyInfectedDevices.PNG)]
...
![Пользователи с аномальными событиями при входе](./media/active-directory-view-access-usage-reports/usersWithAnomalousSignInActivity.PNG)]
