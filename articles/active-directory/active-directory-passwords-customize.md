...
- [**настройка оформления службы управления паролями**](#password-managment-look-and-feel);
- [**настройка поведения службы управления паролями пользователей**](#password-management-behavior);
- [**настройка уведомлений службы управления паролями**](#password-management-notifications).
...
<table>
            ...
            <tr>
              ...
              <td>
                ...
                <ul>
                  <li class="unordered">
												Можно определить не более 20 вопросов.<br><br></li>
                  <li class="unordered">
                  ...
                  <li class="unordered">
												Определение различных вопросов для разных языков пока не поддерживается, но планируется в будущем.<br><br></li>
                </ul>
                <p>
                  <strong>Портал регистрации:</strong>
                </p>
            ...
            <tr>
              <td>
                <p>Запрашивать регистрацию у пользователей при входе в панель доступа?</p>
                <p>
                  
                </p>
              </td>
              <td>
                <p>Определяет, требуется ли пользователю регистрировать контактные данные для сброса пароля при повторном входе в панель доступа.</p>
                <p>
            ...
            <tr>
              <td>
                <p>Записывать пароли в локальный каталог</p>
              </td>
              <td>
                ...
                <p>Эта функция полезна, если необходимо временно отключить службу из-за сбоя.</p>
              </td>
              <td>
                <p>
