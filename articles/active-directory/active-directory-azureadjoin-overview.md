<properties 
	...
	description="Содержит подробные сведения о том, как устройства Widows 10 могут использовать присоединение к Azure AD для регистрации в Azure Active Directory." 
