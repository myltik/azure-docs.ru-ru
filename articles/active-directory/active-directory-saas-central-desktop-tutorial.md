<properties pageTitle="Учебник. Интеграция Azure Active Directory с Central Desktop | Microsoft Azure" description="Узнайте, как использовать Central Desktop вместе с Azure Active Directory для реализации единого входа, автоматической подготовки пользователей и выполнения других задач." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>

<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi"/>

#Учебник. Интеграция Azure Active Directory с Central Desktop
>[AZURE.TIP]Чтобы оставить отзыв, нажмите [здесь](http://go.microsoft.com/fwlink/?LinkId=522411).
...
1.  На странице интеграции с приложением **Central Desktop** портала Azure AD нажмите кнопку **Настроить единый вход**, чтобы открыть диалоговое окно **Настройка единого входа**.
...
4.  Для загрузки сертификата на странице **Настройка единого входа в Central Desktop** нажмите кнопку **Загрузить сертификат** и сохраните файл сертификата на своем компьютере.
...
6.  Последовательно выберите пункты **Параметры** > **Дополнительно** > **Единый вход**.
...
10. На портале Azure AD подтвердите конфигурацию единого входа, а затем нажмите кнопку **Завершить**, чтобы закрыть диалоговое окно **Настройка единого входа**.
...
4.  В текстовом поле **Адреса электронной почты новых участников** введите учетную запись AAD, которую вы хотите подготовить, и нажмите кнопку **Далее**.
