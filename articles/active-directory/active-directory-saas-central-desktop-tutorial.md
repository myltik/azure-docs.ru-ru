...
7.  На странице **Параметры единого входа** выполните следующие действия.
    ...
    1.  Установите флажок **Разрешить единый вход SAML v2**.
    2.  На странице **Настройка единого входа в Central Desktop** на портале Azure скопируйте значение поля **URL-адрес издателя** и вставьте его в текстовое поле **URL-адрес единого входа**.
    3.  На странице **Настройка единого входа в Central Desktop** на портале Azure скопируйте значение поля **URL-адрес удаленного входа** и вставьте его в текстовое поле **URL-адрес единого входа**.
    4.  На странице **Настройка единого входа в Central Desktop** на портале Azure скопируйте значение поля **URL-адрес службы единого выхода** и вставьте его в текстовое поле **URL-адрес единого выхода**.
...
8.  В разделе **Метод проверки подписей в сообщениях** выполните следующие действия.
    ...
    4.  Установите флажок **Отображать ссылку на страницу входа SAMLv2**.
