...
14. В разделе **Параметры единого входа SAML** сделайте следующее:
    ...
    2.  На странице диалогового окна **Configure single sign-on at Work.com** (Настройка единого входа в Work.com) классического портала Azure скопируйте значение поля **URL-адрес издателя** и вставьте его в текстовое поле **Издатель**.
...
5.  В поле **Тип удостоверения SAML** выберите значение **Проверочное утверждение содержит идентификатор федерации из объекта User**.
    ...
    7.  На странице диалогового окна **Configure single sign-on at Work.com** (Настройка единого входа в Work.com) классического портала Azure скопируйте значение поля **URL-адрес удаленного входа** и вставьте его в текстовое поле **Identity Provider Login URL** (URL-адрес входа поставщика удостоверений).
    8.  На странице диалогового окна **Configure single sign-on at Work.com** (Настройка единого входа в Work.com) классического портала Azure скопируйте значение поля **URL-адрес удаленного выхода** и вставьте его в текстовое поле **Identity Provider Logout URL** (URL-адрес выхода поставщика удостоверений).
    9.  В поле **Связывание запросов, инициированных поставщиком услуг** выберите значение **HTTP Post**.
    10. Щелкните **Сохранить**.

15. В левой области навигации классического портала Work.com щелкните **Управление доменами**, чтобы развернуть соответствующий раздел, и щелкните **Мой домен**, чтобы открыть страницу **Мой домен**.
