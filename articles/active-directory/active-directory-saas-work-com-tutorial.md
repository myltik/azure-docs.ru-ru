...
5. В разделе "Изменить пользователя" выполните следующие действия.
   ...
   1. Введите значения атрибутов **Фамилия**, **Псевдоним**, **Электронный адрес**, **Имя пользователя** и **Псевдоним** данными действующей учетной записи Azure Active Directory, которую нужно подготовить.
   2. Выберите значения параметров **Роль**, **Лицензия пользователя** и **Профиль**.
...
> [!NOTE]
> Вы можете использовать любые другие средства создания учетной записи пользователя Work.com или API, предоставляемые Work.com, для подготовки учетных записей пользователей AAD.
> 
> 
