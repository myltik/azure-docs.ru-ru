<properties 
    pageTitle="Учебник. Интеграция Azure Active Directory с TOPdesk — Secure | Microsoft Azure" description="Узнайте, как использовать TOPdesk — Secure с Azure Active Directory для реализации единого входа, автоматической подготовки к работе и многого другого." 
...
3.  В диалоговом окне **Создание оператора** сделайте следующее:
