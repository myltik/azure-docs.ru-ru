...
Эту задачу можно выполнить с помощью портала учетных записей Office 365, портала учетных записей Windows Intune или портала Azure в зависимости от того, на какие службы подписана ваша организация. Дополнительную информацию об использовании порталов для управления Azure Active Directory см. в разделе [Управление каталогом Azure AD](active-directory-administer.md).
...
> [AZURE.NOTE] Вы можете настроить правило динамического членства для групп безопасности или групп Office 365. Сейчас членство во вложенных группах не поддерживается для назначения приложений на основе групп. В рамках динамического членства в группах нужно, чтобы лицензия Azure AD Premium была назначена:
