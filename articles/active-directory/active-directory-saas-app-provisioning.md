...
* Все приложения в разделе **Популярные приложения** поддерживают автоматическую подготовку. Дополнительные приложения приведены в [списке руководств по приложениям для подготовки пользователей](active-directory-saas-tutorial-list.md).
