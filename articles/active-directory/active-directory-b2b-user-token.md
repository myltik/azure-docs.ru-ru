---
title: "Основные сведения о токенах пользователей в службе совместной работы Azure Active Directory B2B | Документация Майкрософт"
...
# <a name="understand-user-tokens-in-azure-active-directory-b2b-collaboration"></a>Основные сведения о токенах пользователей в службе совместной работы Azure Active Directory B2B

Если вам интересно знать, как выглядит токен для пользователя службы совместной работы B2B, то ниже приведены сведения о токене носителя и содержимое токена для гостевого пользователя AAD и гостевого пользователя MSA в клиенте ресурса (для tenantid:04dcc6ab-388a-4559-b527-fbec656300ea). Чтобы просмотреть содержимое токена JWT, воспользуйтесь сайтом [https://jwt.io](https://jwt.io/) или [http://calebb.net](http://calebb.net/).

## <a name="azure-ad-guest-user-token"></a>Токен гостевого пользователя Azure AD
```
...
## <a name="microsoft-account-guest"></a>Гостевой пользователь учетной записи Майкрософт
```
