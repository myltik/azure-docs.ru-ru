---
title: Приступая к работе с Azure AD для Android | Microsoft Docs
...
## <a name="step-1:-download-and-run-the-node.js-rest-api-todo-sample-server"></a>Этап 1. Загрузка и запуск образца службы, реализующей интерфейс REST API приложения To Do List для Node.js
