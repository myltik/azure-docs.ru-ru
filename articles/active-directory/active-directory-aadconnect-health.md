...
|Вы должны быть глобальным администратором каталога Azure AD|По умолчанию глобальные администраторы имеют доступ к информации, предоставляемой Azure AD Connect Health. Вы не сможете создать экземпляр службы Azure AD Connect Health, если у вас нет прав глобального администратора каталога Azure AD. Убедитесь, что вы являетесь глобальным администратором. Дополнительные сведения см. в статье [Управление каталогом Azure AD](active-directory-administer.md).</br></br>**Важно.** Учетная запись, используемая при установке агентов, должна быть учетной записью организации и не может быть учетной записью Майкрософт. Дополнительные сведения см. в статье [Подписка организации на Azure](sign-up-organization.md).|
|Для аналитики использования должен быть включен аудит AD FS| Чтобы применять аналитику по использованию для AD FS, необходимо убедиться, что включен аудит AD FS. </br></br>См. статью [Включение аудита AD FS.](active-directory-aadconnect-health-operations.md#enable-auditing-for-ad-fs)
