...
## <a name="enable-the-application-integration-for-itrp"></a>Включение интеграции приложений для ITRP
В этом разделе показано, как включить интеграцию приложений для ITRP.

**Чтобы включить интеграцию приложений для ITRP, выполните следующее.**
...
**Чтобы назначить пользователей ITRP, выполните следующее.**

1. На портале Azure AD создайте тестовую учетную запись.

2. На странице интеграции с приложением **ITRP** щелкните **Назначить пользователей**.
