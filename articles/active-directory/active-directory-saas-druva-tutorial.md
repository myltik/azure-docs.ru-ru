...
12. В диалоговом окне «Параметры единого входа» выполните следующие действия.
    ...
    ![Single Sign-On Settings](./media/active-directory-saas-druva-tutorial/ic795092.png "Single Sign-On Settings") (Параметры единого входа)
    
    а. В текстовое поле **ID Provider Login URL** (URL-адрес входа поставщика удостоверений) вставьте значение **Single Sign-On Service URL** (URL-адрес службы единого входа), скопированное на портале Azure.
...
14. В диалоговом окне **Токен проверки подлинности единого входа** выполните следующие действия.
    ...
    а. Нажмите кнопку **Копировать**, затем вставьте скопированное значение в текстовое поле **Значение** в разделе **Добавление атрибута** на портале Azure.
