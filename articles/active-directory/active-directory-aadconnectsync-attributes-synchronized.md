---
title: "Синхронизация Azure AD Connect: атрибуты, синхронизируемые с Azure Active Directory | Документация Майкрософт"
