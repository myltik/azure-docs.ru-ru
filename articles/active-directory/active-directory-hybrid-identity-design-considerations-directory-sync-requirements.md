...
Теперь когда у вас есть представление о требованиях к синхронизации для вашей организации, необходимо оценить приложения, использующие эти службы каталогов. Эта оценка важна для определения технических требований для интеграции этих приложений в облако. Дайте ответы на следующие вопросы:
