---
title: Руководство. Интеграция Azure Active Directory с Asana | Microsoft Docs
...
1. На странице **Настройка единого входа в Asana** нажмите кнопку **Загрузить сертификат** и сохраните файл сертификата на своем компьютере. Кроме того, скопируйте значение URL-адреса единого входа SAML.
...
3. В другом окне браузера войдите в приложение Asana. Чтобы настроить единый вход в Asana, перейдите к параметрам рабочей области, щелкнув имя рабочей области в правом верхнем углу экрана. Щелкните элемент **<имя\_рабочей\_области> Settings** (Параметры <имя\_рабочей\_области>).
