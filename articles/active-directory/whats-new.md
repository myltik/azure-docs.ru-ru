...
**Предоставление доступа через браузер для Intune Managed Browser** 
...
**Новые утвержденные клиентские приложения для условного доступа на основе приложения Azure AD**
...
**Поддержка условий использования для нескольких языков**
...
**Состояние обратной записи паролей клиента в реальном времени**
...
**Условный доступ на основе приложений Azure AD** 
...
**Управление устройствами Azure AD на портале Azure**
...
**Поддержка macOS в качестве платформы устройства для условного доступа Azure AD** 
...
**Восстановление или окончательное удаление удаленных пользователей**
...
**Возможность выбора между элементами управления в политике условного доступа** 
...
**Агрегирование событий риска в реальном времени**
...
**Неподдерживаемые отчеты Azure AD**
...
**Новые возможности многофакторной проверки подлинности**
...
**Представление условий использования**
...
**Улучшение управления привилегированными пользователями**
...
**Предоставление проверок доступа**
...
**Скрытие сторонних приложений от средства запуска "Мои приложения" и Office 365**
...
**Исправления для Microsoft Identity Manager**
