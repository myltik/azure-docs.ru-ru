---
title: "Новые возможности Azure Active Directory | Документация Майкрософт"
description: "Используйте эти заметки о выпуске, чтобы всегда знать о **последних выпусках**, **известных проблемах**, **исправлениях**, **устаревших функциональных возможностях** и **планах по изменениям** в Azure Active Directory."
...
Мы постоянно улучшаем Azure Active Directory для вас. Чтобы вы оставались в курсе последних разработок, в этой статье предоставлены такие сведения:
