---
title: "Справочник по маркерам в Azure AD | Документация Майкрософт"
...
Для проверки маркера id_token или access_token приложение должно проверить подпись маркера и содержащиеся в нем утверждения.
