...
Продлите срок действия сертификата, используя инструкции из [этой статьи](active-directory-aadconnect-o365-certs.md).
...
- Найти ответы членов сообщества на технические вопросы, а также задать собственные вопросы можно [здесь](https://social.msdn.microsoft.com/Forums/azure/ru-RU/newthread?category=windowsazureplatform&forum=WindowsAzureAD&prof=required).
