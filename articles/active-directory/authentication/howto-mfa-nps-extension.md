...
3. Создайте политику условного доступа или [измените состояние пользователя](../../multi-factor-authentication/multi-factor-authentication-get-started-user-states.md), чтобы требовать двухфакторную проверку подлинности для тестовой учетной записи. 
...
- См. дополнительные сведения об интеграции [шлюза удаленных рабочих столов](../../multi-factor-authentication/nps-extension-remote-desktop-gateway.md) и [VPN-серверов](../../multi-factor-authentication/nps-extension-vpn.md) с помощью расширения NPS.
