...
- **Устройства, соответствующие требованиям.** Политики условного доступа можно настроить на основе устройств. Цель политики условного доступа на основе устройств — предоставить доступ к настроенным ресурсам только с доверенных устройств. Требование устройства, соответствующего требованиям — это один из способов определения доверенного устройства. Подробные сведения см. в статье [Настройка политик условного доступа на основе устройств для Azure Active Directory](active-directory-conditional-access-policy-connected-applications.md).

- **Устройство, присоединенное к домену.** Требование устройства, присоединенного к домену — это еще один способ настройки политики условного доступа на основе устройств. Это требование относится к настольным компьютерам, ноутбукам и корпоративным планшетам, присоединенным к локальному каталогу Active Directory. Подробные сведения см. в статье [Настройка политик условного доступа на основе устройств для Azure Active Directory](active-directory-conditional-access-policy-connected-applications.md).
