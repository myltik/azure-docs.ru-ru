...
Платформа устройства характеризуется операционной системой, установленной на устройстве (Android, iOS, Windows Phone, Windows). Вы можете указать платформы устройств, которые включены в политику, а также платформы, которые исключены из нее.  
