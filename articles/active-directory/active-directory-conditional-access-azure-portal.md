...
Полный список клиентских приложений, используемых в политике условного доступа, см. в статье [Техническая информация об условном доступе в Azure Active Directory](active-directory-conditional-access-technical-reference.md#client-apps-conditions).
