...
# Проблемы при добавлении или настройке приложений



<a id="i-dont-know-how-to-configure-single-sign-on-to-an-application" class="xliff"></a>

## Я не знаю, как настроить единый вход в приложение
...
## Возникла проблема при добавлении приложения
  Приведенные ниже документы помогут устранить некоторые из наиболее распространенных проблем в этой категории.
...
## Возникла проблема при настройке единого входа в приложение
  Приведенные ниже документы помогут устранить некоторые из наиболее распространенных проблем в этой категории.
