...
* Используйте клиент Windows 10 (1709 или более новой версии), присоединенный к домену Azure AD.
...
* Настройте и разверните параметр, чтобы включить отображение ссылки сброса пароля с помощью одного из следующих способов:
   * [профиль конфигурации устройств Intune](active-directory-passwords-login.md#configure-reset-password-link-using-intune);
   * [раздел реестра](active-directory-passwords-login.md#configure-reset-password-link-using-the-registry).
...
1. Войдите на устройство, присоединенное к домену Azure AD, используя учетные данные администратора.
...
Инструкции по использованию этой функции пользователи могут найти в статье [Я не помню свой пароль Azure AD](active-directory-passwords-update-your-own-password.md#reset-password-at-login).
...
[CreateProfile]: ./media/active-directory-passwords-login/create-profile.png "Создание профиля конфигурации устройства Intune для отображения ссылки "Сброс пароля" на экране входа в Windows 10"
[Assignment]: ./media/active-directory-passwords-login/profile-assignment.png "Назначение политики конфигурации устройства Intune группе устройств с Windows 10"
[LoginScreen]: ./media/active-directory-passwords-login/logon-reset-password.png "Ссылка "Сброс пароля" на экране входа в Windows 10"
