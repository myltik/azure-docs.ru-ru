...
## <a name="enable-the-application-integration-for-bime"></a>Включение интеграции приложений для Bime
В этом разделе показано, как включить интеграцию приложений для Bime.

**Чтобы включить интеграцию приложений для Bime, сделайте следующее:**
...
Чтобы настроить единый вход для Bime, необходимо извлечь значение отпечатка из сертификата. Если вы не знакомы с этой процедурой, просмотрите видео [Как извлечь значение отпечатка из сертификата](http://youtu.be/YKQF266SAxI).
...
**Чтобы назначить пользователей Bime, сделайте следующее:**
