...
1.  На портале Azure AD на странице интеграции с приложением **Adaptive Suite** нажмите кнопку **Настроить единый вход**. Откроется диалоговое окно **Настройка единого входа**.
...
3.  На странице **Настройка параметров приложения** введите в текстовое поле **URL-адрес ответа** URL-адрес в формате **https://login.adaptiveinsights.com:443/samlsso/RlJFRVRSSUFMMTI3MTE=*" и нажмите кнопку **Далее**.

    >[AZURE.NOTE]Этот адрес можно узнать на странице **Параметры единого входа SAML** клиента Adaptive Suite.
...
8.  На странице **SAML SSO Settings** (Параметры единого входа SAML) выполните следующие действия.
    ...
    2.  На портале Azure на диалоговой странице **Настройка единого входа в Adaptive Suite** скопируйте значение поля **Идентификатор сущности** и вставьте его в текстовое поле **Идентификатор сущности поставщика удостоверений**.
    3.  На портале Azure на диалоговой странице **Настройка единого входа в Adaptive Suite** скопируйте значение поля **URL-адрес единого входа SAML** и вставьте его в текстовое поле **URL-адрес единого входа поставщика удостоверений**.
    4.  На портале Azure на диалоговой странице **Настройка единого входа в Adaptive Suite** скопируйте значение поля **URL-адрес единого входа SAML** и вставьте его в текстовое поле **Настраиваемый URL-адрес выхода**.
...
2.  На странице интеграции с приложением **Adaptive Suite** щелкните **Назначить пользователей**.
