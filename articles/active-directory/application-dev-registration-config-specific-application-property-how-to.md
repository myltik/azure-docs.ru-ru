...
| URI перенаправления   | Для собственных приложений сюда перенаправляют пользователя после успешной авторизации. Azure AD проверяет, совпадает ли предоставленный приложением URI перенаправления в запросе OAuth 2.0 с одним из зарегистрированных значений на портале.                                                            |
