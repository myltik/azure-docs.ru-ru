...
В таблице ниже описано, какие сценарии поддерживаются для каких версий наших возможностей синхронизации.  Как правило, настоятельно рекомендуется установить новейшую версию [Azure AD Connect](connect/active-directory-aadconnect.md#install-azure-ad-connect) , если требуется использовать обратную запись паролей.
