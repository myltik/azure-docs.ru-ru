...
9. Если операция установки пароля прошла успешно, пользователь уведомляется о том, что его пароль изменен и он может продолжать работу. Если пароль пользователя синхронизирован с Azure AD с помощью синхронизации паролей, есть вероятность того, что локальная политика паролей является менее строгой, чем облачная. В этом случае мы применяем локальную политику, используя синхронизацию хэша паролей. Благодаря этому ваша локальная политика применяется в облаке независимо от того, обеспечиваете ли вы единый вход с помощью синхронизации паролей или федерации.
