---
title: 'Дополнительные сведения: управление паролями Azure AD| Microsoft Docs'
...
Обратная запись паролей — это компонент [Azure Active Directory Connect](active-directory-aadconnect.md), который может быть включен и использован текущими подписчиками Azure Active Directory Premium. Дополнительные сведения см. в статье [Выпуски Azure Active Directory](active-directory-editions.md).
