...
3. Условный доступ к приложениям Office 365 с использованием Microsoft Intune: ИТ-администраторы могут для защиты корпоративных ресурсов создавать политики условного доступа с устройств, разрешая при этом информационным работникам обращаться к службам с совместимых устройств. Дополнительные сведения см. в разделе [Политики условного доступа к Office 365 с устройств](active-directory-conditional-access-device-policies.md).
