...
Для соблюдения требований законов о защите конфиденциальности данных наши интерфейсы API не включают пользовательские сообщения в текст сообщений с приглашением, если у приглашающего пользователя нет адреса электронной почты в ресурсной организации (также называемой приглашающим клиентом) или если приглашение отправляется субъектом-службой приложения. Если вам важно использовать именно этот сценарий, то вы можете подавить интерфейс API, отправляющий сообщение с приглашением, и отправить его через любой другой механизм отправки электронной почты. Обязательно проконсультируйтесь к юристом своей организации, чтобы убедиться, что отправляемые таким образом сообщения не нарушают требования законов о защите конфиденциальности данных.
