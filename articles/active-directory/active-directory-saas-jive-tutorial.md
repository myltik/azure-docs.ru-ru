---
title: Руководство. Интеграция Azure Active Directory с Jive | Microsoft Docs
...
7. В области результатов выберите **Jive** и нажмите кнопку **Завершить**, чтобы добавить приложение.
...
3. **[Создание тестового пользователя Jive](#creating-a-jive-test-user)** требуется для создания пользователя Britta Simon в Jive, связанного с представлением этого же пользователя в Azure AD.
4. **[Настройка подготовки пользователя](#configuring-user-provisioning)** необходима, чтобы показать, как включить подготовку учетных записей пользователей Active Directory для Jive.
...
1. На классическом портале на странице интеграции с приложением **Jive** щелкните **Настроить единый вход**, чтобы открыть диалоговое окно **Настройка единого входа**.
   
    ![Настройка единого входа][6]
2. На странице **How would you like users to sign on to Jive** (Как пользователи должны входить в Jive?) выберите **Единый вход Azure AD** и нажмите кнопку **Далее**.
...
3. В диалоговом окне на странице **Настройка параметров приложения** выполните следующие действия.
    ...
    а. В текстовом поле **URL-адрес входа** введите URL-адрес, при помощи которого пользователи входят в приложение Jive, в следующем формате: **https://\<имя\_клиента>.jivecustom.com**.
...
9. На портале Azure AD выберите подтверждение конфигурации единого входа и нажмите кнопку **Далее**. ![Единый вход в Azure AD][10]
10. На странице **Подтверждение единого входа** нажмите кнопку **Завершить**. ![Единый вход в Azure AD][11]
...
6. На странице диалогового окна **Профиль пользователя** выполните следующие действия. ![Создание тестового пользователя Azure AD](./media/active-directory-saas-jive-tutorial/create_aaduser_06.png)
...
### Создание тестового пользователя приложения Jive
...
2. На странице **Введите учетные данные Jive, чтобы включить автоматическую подготовку учетных записей пользователей** укажите следующие параметры конфигурации.
   ...
   3. В текстовом поле **URL-адрес клиента Jive** введите URL-адрес клиента Jive.
      ...
      > [!NOTE]
      > URL-адрес клиента Jive — это URL-адрес, используемый вашей организацией для входа в Jive. Как правило, этот URL-адрес имеет следующий формат: **www.<организация>.jive.com**.
      > 
      > 
