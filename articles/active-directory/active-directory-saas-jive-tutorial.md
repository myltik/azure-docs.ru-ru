<properties pageTitle="Руководство. Интеграция Azure Active Directory с Jive | Microsoft Azure" description="Узнайте, как использовать Jive вместе с Azure Active Directory для реализации единого входа, автоматической подготовки пользователей и выполнения других задач." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi" />
#Руководство. Интеграция Azure Active Directory с Jive
>[AZURE.TIP]Чтобы оставить отзыв, нажмите [здесь](http://go.microsoft.com/fwlink/?LinkId=330042). Дополнительные сведения по этому разделу см. в статье [Рекомендации по управлению улучшениями для доступа приложений к Azure Active Directory](http://go.microsoft.com/fwlink/?LinkId=329963).
...
1.  На странице интеграции приложений **Jive** портала управления Azure нажмите **Настроить подготовку учетных записей пользователей**, чтобы открыть диалоговое окно **Настроить подготовку учетных записей пользователей**.
...
2.  На странице **Введите учетные данные Jive, чтобы включить автоматическую подготовку учетных записей пользователей**, укажите следующие параметры конфигурации.
    ...
    4.  Нажмите **проверить**д ля проверки конфигурации.
