...
Следующие приложения поддерживают политику на основе устройства, заданную для целевой службы:

| Приложение | Целевая служба | Платформа |
| :--                                     | :--            | :--      |
| "Почта", "Календарь" и "Люди" | Exchange | Windows 10, Windows Mobile 10 |
| Универсальные приложения Office: Word, Excel, PowerPoint | SharePoint | Windows 10, Windows Mobile 10 |
| Outlook 2016 | Exchange | Windows 10, Windows Mobile 10, Windows 8.1, Windows 7 |
|Outlook 2013 (требуется включение современной проверки подлинности) | Exchange | Windows 8.1, Windows 7 |


Следующие приложения не поддерживают политику на основе устройства, заданную для целевой службы:

| Приложение | Целевая служба | Платформа |
| :--                                     | :--            | :--      |
| OneDrive для бизнеса с использованием клиента синхронизации Next Generation Sync Client (NGSC) (личный сайт и сайт группы) | SharePoint | Windows 10, Windows Mobile 10 |
| Приложение "Мои приложения" | Любой | iOS, Android |
...
### Вариант 1: разрешить Exchange ActiveSync и разрешить устаревшие приложения только в интрасети.
