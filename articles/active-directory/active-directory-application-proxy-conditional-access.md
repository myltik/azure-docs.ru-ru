...
## <a name="configure-per-application-multi-factor-authentication"></a>Настройка многофакторной проверки подлинности для каждого приложения
...
5. Укажите пользователей и группы, к которым применяются правила. Нажмите кнопку **Добавить группу**, чтобы выбрать одну или несколько групп, к которым применяется правило доступа. В этом диалоговом окне можно также удалить выбранные группы.  Выбранные правила доступа для групп применяются только к тем пользователям, которые входят в одну из указанных групп безопасности.  
   ...
   * Чтобы явно исключить группы безопасности из правила, установите флажок **Исключение** и укажите одну или несколько групп. Пользователям, входящим в группу из списка исключений, не нужно выполнять многофакторную идентификацию.  
   * Если для пользователя настроена индивидуальная многофакторная идентификация, этот параметр будет более приоритетным, чем правила многофакторной идентификации приложения. Такому пользователю необходимо выполнить многофакторную идентификацию, даже если он исключен из правил многофакторной идентификации приложения. Узнайте больше о [многофакторной проверке подлинности и пользовательских параметрах](../multi-factor-authentication/multi-factor-authentication.md).
