...
# Определение стратегии выбора жизненного цикла гибридной идентификации 
...
## Управление доступом и подготовка 
...
>[AZURE.NOTE]Дополнительная информация приведена в статье «Настройка Azure AD для управления самостоятельным доступом к приложениям»
...
>[AZURE.NOTE]Дополнительные сведения см. в статье [Интеграция локальных удостоверений с Azure Active Directory](active-directory-aadconnect.md).
