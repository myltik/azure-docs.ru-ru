...
Каждый сценарий, рассматриваемый в этом документе, содержит подраздел, где описываются соответствующие требования по подготовке. Более подробные сведения о подготовке приложения в Azure AD, а также различиях между однотенантным или мультитенантным приложениями см. в разделе [Добавление, обновление и удаление приложения](https://msdn.microsoft.com/library/azure/dn132599.aspx). Продолжим рассмотрение типичных сценариев работы приложений в Azure AD.
...
1. Пользователь входит в систему Azure AD в веб-приложении (см. раздел "Из веб-браузера в веб-приложение" выше).
