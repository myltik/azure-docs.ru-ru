...
- **Администратор Skype для бизнеса** имеет административный доступ к Skype для бизнеса через Центр администрирования Skype для бизнеса и может выполнить практически любую задачу в Skype для бизнеса онлайн.
...
Из PIM [эти роли можно назначать пользователям на временной основе](active-directory-privileged-identity-management-how-to-add-role-to-user.md), чтобы те могли [активировать роли при необходимости](active-directory-privileged-identity-management-how-to-activate-role.md).
