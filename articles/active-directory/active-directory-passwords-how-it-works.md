...
7. В разделе "Разрешения" установите флажки "Сброс пароля", "Изменить пароль", Write lockoutTime (Запись в lockoutTime) и Write pwdLastSet (Запись в pwdLastSet).
