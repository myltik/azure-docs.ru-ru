...
Если запрос регистрации отключен, пользователи могут вручную зарегистрировать свои контактные данные. Они могут открыть страницу [http://aka.ms/ssprsetup](http://aka.ms/ssprsetup) или перейти по ссылке **Регистрация для сброса пароля** на вкладке **Профиль** на панели доступа.
