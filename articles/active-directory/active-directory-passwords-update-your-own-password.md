...
## <a name="unlock-my-account"></a>Разблокировка учетной записи
...
2. Введите **идентификатор пользователя** рабочей или учебной учетной записи и докажите, что вы не робот: введите текст для проверки CAPTCHA и нажмите кнопку **Далее**
   ...
   > [!NOTE]
   > Если администратор не включил эту функцию, появится ссылка "Обратитесь к своему администратору", чтобы он оказал вам помощь по электронной почте или самостоятельно сбросил пароль на веб-портале.
   >
