...
11. В разделе Поставщики удостоверений SAML" выполните следующие действия.
    ...
    3.  Щелкните **Сертификат открытого ключа поставщика удостоверений**, а затем нажмите кнопку**Создать**.
        ![Создание](./media/active-directory-saas-workday-tutorial/IC782928.png "Создание")
    4.  Щелкните**Создать открытый ключ x509**.
        ![Создание](./media/active-directory-saas-workday-tutorial/IC782929.png "Создание")
    5.  В разделе **Просмотреть открытый ключ x509** выполните следующие действия.
    ...
    6.  Выполните следующие действия.
        ![Настройка единого входа](./media/active-directory-saas-workday-tutorial/IC792131.png "Настройка единого входа")
