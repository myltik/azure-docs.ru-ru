...
3. В разделе **Домены и URL-адреса приложения IriusRisk** выполните следующие действия.
    ...
    ![Сведения о домене и URL-адресах единого входа приложения IriusRisk](./media/active-directory-saas-iriusrisk-tutorial/tutorial_iriusrisk_url.png)
...
2. Из списка приложений выберите **IriusRisk**.
    ...
    ![Ссылка на IriusRisk в списке "Приложения"](./media/active-directory-saas-iriusrisk-tutorial/tutorial_iriusrisk_app.png)  
