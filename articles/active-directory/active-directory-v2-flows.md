---
title: Типы конечной точки версии 2.0 | Microsoft Docs
...
### <a name="daemons/server-side-apps"></a>Управляющие программы и серверные приложения
...
В этом потоке приложение получает маркеры, взаимодействуя непосредственно с конечной точкой `/token`.

![Изображение управляющей программы Swimlanes](../media/active-directory-v2-flows/convergence_scenarios_daemon.png)

Чтобы создать управляющую программу, изучите документацию по учетным данным клиентов в нашем разделе [Приступая к работе](active-directory-appmodel-v2-overview.md#getting-started) или ознакомьтесь с [этим примером приложения .NET](https://github.com/Azure-Samples/active-directory-dotnet-daemon-v2).
...
### <a name="chained-web-apis-(on-behalf-of)"></a>Связанные веб-API
