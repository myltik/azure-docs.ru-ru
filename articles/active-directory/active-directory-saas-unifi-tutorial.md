...
11. В разделе **Add Identity Provider** (Добавление поставщика удостоверений) выполните следующие действия.   
    ...
    b. В текстовое поле **Provider URL** (URL-адрес поставщика) вставьте значение **URL-адреса службы единого входа SAML**, скопированное на портале Azure.
    ...
    г) Установите флажок **Is Default Provider** (Является поставщиком по умолчанию).
