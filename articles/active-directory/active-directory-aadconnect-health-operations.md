...
Чтобы разрешить пользователю доступ на уровне *каталога* в Azure AD Connect Health, откройте главную колонку в Azure AD Connect Health.<br>
[//]: # (RBAC\_MainBladeSS)
...
>[AZURE.NOTE]
- доступ ко всем операциям, однако их учетные записи не отображаются в указанном выше списке.
