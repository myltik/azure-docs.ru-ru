...
3. В разделе **Домены и URL-адреса приложения eKincare** выполните следующие действия:
    ...
    а. В текстовом поле **Идентификатор** введите URL-адрес в следующем формате: `https://<instancename>.ekincare.com/`
...
8. Чтобы настроить единый вход на стороне **eKincare**, отправьте в [службу поддержки eKincare](mailto:tech@ekincare.com) скачанный **XML-файл метаданных**. Специалисты службы поддержки правильно настроят подключение единого входа SAML на обеих сторонах подключения.
