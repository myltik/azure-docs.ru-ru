...
4. **[Создание тестового пользователя приложения Fuse](#creating-a-fuse-test-user)** требуется для создания пользователя Britta Simon в Fuse, связанного с соответствующим представлением в Azure AD.
