...
В этой среде все локальные леса обрабатываются как отдельные сущности. Ни один пользователь не может присутствовать в каком-либо другом лесу. У каждого леса есть своя организация Exchange. Синхронизация GALSync между лесами отсутствует. Такая топология может возникать в результате слияний и поглощений, а также в организации, в которой все подразделения функционируют изолированно друг от друга. В Azure AD эти леса будут находиться в одной организации и отображаться в едином глобальном списке адресов. На этом рисунке каждый объект в каждом лесу представлен в метавселенной в единственном экземпляре с объединением в целевом каталоге Azure AD.
