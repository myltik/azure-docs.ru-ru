...
3. [Назначьте и проверьте необходимые лицензии.](active-directory-passwords-licensing.md)
...
5. На основе вашей политики заполните минимальный набор [данных проверки подлинности](active-directory-passwords-data.md).
6. Отправьте пользователям инструкции по регистрации и сбросу пароля с помощью SSPR.
    > [!NOTE]
