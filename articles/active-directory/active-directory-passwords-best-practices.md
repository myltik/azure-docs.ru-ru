...
5. Со временем просматривайте ход регистрации пользовательских данных. Для этого нужно перейти на вкладку "Отчеты" и ознакомиться с отчетом [**Действие регистрации сброса пароля**](active-directory-passwords-get-insights.md#view-password-reset-registration-activity).
