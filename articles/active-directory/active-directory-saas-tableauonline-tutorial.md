---
title: Руководство. Интеграция Azure Active Directory с Tableau Online | Microsoft Docs
...
1. На странице **Configure single sign-on at Tableau Online** (Настройка единого входа в Tableau Online) нажмите кнопку **Скачать метаданные**, а затем сохраните файл метаданных на свой компьютер.
...
4. В другом окне браузера войдите в приложение Tableau Online. Перейдите к вкладке **Параметры**, а затем щелкните **Проверка подлинности**.
   
    ![Настройка единого входа](./media/active-directory-saas-tableauonline-tutorial/tutorial_tableauonline_09.png)
5. В разделе **Типы проверки подлинности** установите флажок **Single sign-on with SAML** (Единый вход с помощью SAML), чтобы включить SAML.
