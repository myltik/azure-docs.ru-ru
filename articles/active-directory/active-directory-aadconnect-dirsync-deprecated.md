...
**Вопрос. Перестанет ли DirSync или Azure AD Sync работать 13 апреля 2017 года?** Нет. Дата прекращения обмена данными между этими средствами и Azure AD будет объявлена позднее. Как только они станут известны, соответствующие сведения будут опубликованы в этом разделе.
