---
title: Учебник. Интеграция Azure Active Directory с Amazon Web Service (AWS) | Microsoft Docs
...
3. **[Создание тестового пользователя Amazon Web Service (AWS)](#creating-a-halogen-software-test-user)** требуется для создания соответствующего пользователя Britta Simon в Amazon Web Service (AWS), связанного с ее представлением в Azure AD.
