...
Чтобы выполнить код, используйте инструкции [библиотек PowerShell для Azure AD версии 1.0](https://docs.microsoft.com/en-us/powershell/azure/active-directory/install-msonlinev1?view=azureadps-1.0). Перед выполнением сценария запустите командлет `connect-msolservice`, чтобы войти в клиент.
