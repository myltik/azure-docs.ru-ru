...
---
# <a name="high-availability-crossgeographic-ad-fs-deployment-in-azure-with-azure-traffic-manager"></a>Развертывание AD FS высокого уровня доступности в нескольких регионах Azure с помощью диспетчера трафика Azure
...
## <a name="test-the-routing-and-ad-fs-signin"></a>Проверьте работу маршрутизации и входа в AD FS
...
### <a name="ad-fs-signin-test"></a>Проверка входа в AD FS
