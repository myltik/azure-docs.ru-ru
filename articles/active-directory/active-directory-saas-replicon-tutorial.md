<properties pageTitle="Учебник. Интеграция Azure Active Directory с Replicon | Microsoft Azure" description="Узнайте, как использовать Replicon с Azure Active Directory для реализации единого входа, автоматической подготовки к работе и многого другого." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi" />
#Учебник. Интеграция Azure Active Directory с Replicon
>[AZURE.TIP]Чтобы оставить отзыв, щелкните [здесь](http://go.microsoft.com/fwlink/?LinkId=525008).
...
После завершения этого руководства пользователи Azure AD, назначенные в Replicon, будут иметь возможность единого входа в приложение на сайте Replicon компании (вход, инициированный поставщиком услуг) или с помощью инструкций из статьи [Общие сведения о панели доступа](https://msdn.microsoft.com/library/dn308586).
...
1.  На странице интеграции с приложением **Replicon** портала Azure AD щелкните **Настройка единого входа**, чтобы открыть диалоговое окно **Настройка единого входа**.
...
4.  На странице **Настройка единого входа в Replicon** нажмите кнопку **Загрузить метаданные**, чтобы скачать их, а затем сохраните файл данных на свой компьютер.
...
4.  В разделе **Профиль пользователя** выполните следующие действия:
    ...
    5.  Щелкните **Сохранить профиль пользователя**.
