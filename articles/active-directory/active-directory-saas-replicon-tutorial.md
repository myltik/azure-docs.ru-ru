...
4.  В разделе **Профиль пользователя** сделайте следующее:
    ...
    1.  В текстовом поле **Имя для входа** введите адрес электронной почты пользователя Azure AD, которого необходимо подготовить.
    2.  Для параметра **Тип проверки подлинности** выберите значение **Единый вход**.
