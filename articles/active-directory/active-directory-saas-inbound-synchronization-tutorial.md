<properties pageTitle="Руководство. Настройка Workday для входящей синхронизации | Microsoft Azure" description="Узнайте, как использовать входящую синхронизацию вместе с Azure Active Directory для реализации единого входа, автоматической подготовки пользователей и выполнения других задач." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
...
>[AZURE.TIP]Чтобы оставить отзыв, нажмите [здесь](http://go.microsoft.com/fwlink/?LinkId=330042).
...
1.  В области **Рабочее место Workbench** введите в поле поиска значение **создать пользователя** и нажмите ссылку **Создать пользователя системы интеграции**.     
...
1.  Введите "изменить группу безопасности" в поле поиска, а затем нажмите ссылку **Изменить группу безопасности**.     
...
2.  На странице **Параметры и учетные данные администратора** выполните следующие действия, а затем нажмите кнопку "Далее":
...
3.  На странице **Проверить соединение**нажмите **Начать тест**, чтобы подтвердить подключение, а затем нажмите кнопку **Далее**.
