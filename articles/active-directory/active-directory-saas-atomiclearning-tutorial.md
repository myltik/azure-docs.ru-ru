<properties
	pageTitle="Руководство. Интеграция Azure Active Directory с Atomic Learning | Microsoft Azure"
...
4. **[Создание тестового пользователя Atomic Learning](#creating-an-atomic-learning-test-user)** требуется для создания в Atomic Learning пользователя Britta Simon, связанного с представлением этого же пользователя в Azure AD.
...
5. На странице **Настройка единого входа в Atomic Learning** нажмите кнопку **Скачать метаданные**, а затем сохраните файл метаданных на свой компьютер.

	![Настройка единого входа](./media/active-directory-saas-atomiclearning-tutorial/tutorial_atomiclearning_08.png)

6. Чтобы настроить единый вход для своего приложения, обратитесь в службу поддержки Atomic Learning. Они помогут выбрать правильный канал для настройки единого входа. Обратите внимание, что необходимо будет отправить по электронной почте сообщение, прикрепив к нему скачанный файл метаданных <cs@atomiclearning.com>.
