...
## Общие сведения об отчетах об управлении паролями
...
## Как просмотреть отчеты об управлении паролями
...
### Прямая ссылка на колонку "Журналы аудита"
...
### Роли каталога с доступом на чтение отчетов
...
## Типы действий по самостоятельному управлению паролями
...
### Тип действия: Self serve password reset flow activity progress (Ход выполнения процесса самостоятельного сброса пароля)
...
## Как получить события об управлении паролями из API отчетов и событий Azure AD
...
### Как начать работу с API отчетов
...
### Ограничения на извлечение данных с API отчетов
...
## Как быстро скачать события регистрации сброса паролей с помощью PowerShell
...
## Как просмотреть отчеты об управлении паролями на классическом портале
...
## Просмотр действий по регистрации сброса паролей на классическом портале
...
## Просмотр действий сброса паролей на классическом портале
