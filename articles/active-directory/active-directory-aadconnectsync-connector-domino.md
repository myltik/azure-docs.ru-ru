---
title: Соединитель Lotus Domino | Microsoft Docs
...
| Функция | Поддержка |
| --- | --- |
| Подключенный источник данных |Сервер:  <li>Lotus Domino 8.5.x</li><li>Lotus Domino 9.x</li>Клиент:<li>Lotus Notes 9.x</li> |
