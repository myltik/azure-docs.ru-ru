---
title: 'Служба синхронизации Azure AD Connect: общие сведения о конфигурации по умолчанию | Microsoft Docs'
...
Дополнительные сведения о модели конфигурации см. в статье [Знакомство с декларативной подготовкой](active-directory-aadconnectsync-understanding-declarative-provisioning.md).
...
* Дополнительные сведения о принципах работы стандартной конфигурации см. в статье [Синхронизация Azure AD Connect: общее представление о пользователях и контактах](active-directory-aadconnectsync-understanding-users-and-contacts.md).
