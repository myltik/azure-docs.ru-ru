...
1.  Инструкция **@outputSchema** определяетс формат данных, которые будут возвращены в Pig. В данном случае это **data bag**, являющийся типом данных Pig. Корзина содержит следующие поля, все они имеют тип "Массив строк" (строки):
