<properties title="Создание облачного развертывания RemoteApp" pageTitle="Создание облачного развертывания RemoteApp" description="Узнайте, как создавать развертывания RemoteApp, предназначенные для сохранения данных в облачной среде Azure." metaKeywords="" services="" solutions="" documentationCenter="" authors="elizapo" manager="kathyw" />
...
-   Хотите предоставить пользователям специализированные приложения или LOB-программы? Создайте новый [настраиваемый образ шаблона][настраиваемый образ шаблона] и используйте его при развертывании облака.
...
5.  Выберите шаблон для этой службы.
    ...
    **Подсказка.** Подписка на RemoteApp поставляется с образом шаблона, содержащим программы Office 2013, одни из которых опубликованы (например, Word), а другие готовы к публикации. Также можно создать новый [настраиваемый образ шаблона][настраиваемый образ шаблона] и использовать его при развертывании облака.
...
Итак, облачное развертывание RemoteApp успешно создано и развернуто. Далее пользователи должны загрузить и установить клиент удаленного рабочего стола. URL-адрес для клиента можно найти на странице быстрого запуска RemoteApp. Затем пользователи должны войти в клиент и вызвать опубликованные программы RemoteApp.

  [http://azure.microsoft.com/ru-ru/services/remoteapp/]: http://azure.microsoft.com/ru-ru/services/remoteapp/
  [настраиваемый образ шаблона]: http://azure.microsoft.com/ru-ru/documentation/articles/remoteapp-create-custom-image/
