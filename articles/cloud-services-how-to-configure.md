...
2. В разделе **Мониторинг** задайте уровень мониторинга (от минимального до подробного) и настройте диагностические строки подключения, которые необходимы для подробного мониторинга. Инструкции см. в разделе [Мониторинг облачных служб](how-to-monitor-a-cloud-service.md).
