...
- **Рабочая станция с Azure PowerShell.**. См. раздел "Предварительные требования" статьи [Использование Azure PowerShell с диспетчером ресурсов Azure](powershell-azure-resource-manager.md#prerequisites).
