...
3. Введите или выберите следующие значения:
   ...
   * **Data Lake Store**: щелкните *Настроить обязательные параметры*. Следуйте инструкциям для создания новой учетной записи хранения озера данных или выберите существующую. Каждая учетная запись Data Lake Analytics включает зависимую учетную запись Data Lake Store. Учетная запись аналитики озера данных и зависимая учетная запись хранения озера данных должны находиться в одном центре обработки данных Azure.
...
В этом руководстве описано, как выполнять обработку журналов поиска.  Журнал поиска может содержаться в хранилище Data Lake Store или в хранилище BLOB-объектов Azure.
