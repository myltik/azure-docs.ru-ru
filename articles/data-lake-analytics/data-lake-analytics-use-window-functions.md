---
title: Использование оконных функций U-SQL для заданий в службе аналитики озера данных Azure | Microsoft Docs
...
> [!NOTE]
> Инструкции по использованию запроса и проверке выходных данных см. в статье [Начало работы с языком U-SQL для заданий в службе аналитики озера данных Azure](data-lake-analytics-u-sql-get-started.md).
> 
> 
