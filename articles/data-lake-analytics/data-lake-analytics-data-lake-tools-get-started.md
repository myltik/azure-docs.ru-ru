...
4. Скопируйте следующий скрипт в файл **Script.usql**:
    ...
    - **Разверните столбцы ***
        ...
        Щелкните справа от *, вы увидите синюю линию подчеркивания под *. Наведите указатель мыши на синюю линию подчеркивания и нажмите кнопку со стрелкой вниз. 
	![Инструменты озера данных Visual Studio *](./media/data-lake-analytics-data-lake-tools-get-started/data-lake-analytics-data-lake-tools-expand-asterisk.png)
