...
4. Скопируйте следующий скрипт в файл **Script.usql**:
    ...
    - **Развертывание столбцов ***
        ...
        Щелкните справа от *. Под * вы увидите синюю линию подчеркивания. Наведите указатель мыши на синюю линию подчеркивания и нажмите кнопку со стрелкой вниз. ![Средства озера данных для Visual Studio. Развертывание столбца *](./media/data-lake-analytics-data-lake-tools-get-started/data-lake-analytics-data-lake-tools-expand-asterisk.png)
