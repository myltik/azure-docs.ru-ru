...
4. Скопируйте следующий скрипт в файл **Script.usql**:
    ...
    - **Разверните столбцы ***
        ...
        Щелкните справа от *, вы увидите синюю линию подчеркивания под *. Наведите указатель мыши на синюю линию подчеркивания и нажмите кнопку со стрелкой вниз. ![Инструменты озера данных Visual Studio *](./media/data-lake-analytics-data-lake-tools-get-started/data-lake-analytics-data-lake-tools-expand-asterisk.png)
...
6. В **обозревателе решений** щелкните правой кнопкой мыши **Script.usql** и выберите команду **Отправить сценарий**. Кроме того, вы можете нажать кнопку **Отправить** на панели Script.usql. См. предыдущий снимок экрана. Щелкните стрелку вниз рядом с кнопкой «Отправить», чтобы отправить с использованием расширенных параметров.
...
Следующий сценарий PowerShell подготавливает учетную запись аналитики озера данных Azure и источник данных, поэтому вы можете сразу перейти к разделу [Разработка скриптов U-SQL](data-lake-analytics-data-lake-tools-get-started.md#develop-u-sql-scripts).
