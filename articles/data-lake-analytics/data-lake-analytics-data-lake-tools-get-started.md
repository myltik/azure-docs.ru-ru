...
Следующий сценарий PowerShell подготавливает учетную запись аналитики озера данных Azure и источник данных, поэтому вы можете сразу перейти к разделу [Разработка сценариев U-SQL](data-lake-analytics-data-lake-tools-get-started.md#develop-u-sql-scripts).
