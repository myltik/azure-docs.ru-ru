...
6. В **обозревателе решений** щелкните правой кнопкой мыши **Script.usql** и выберите команду **Build Script** (Создать сценарий). Проверьте результат на панели вывода.
7. В **обозревателе решений** щелкните правой кнопкой мыши **Script.usql** и выберите команду **Submit Script** (Отправить сценарий). Либо можно нажать кнопку **Отправить** на панели Script.usql. См. предыдущий снимок экрана. Щелкните стрелку вниз рядом с кнопкой «Отправить», чтобы отправить с использованием расширенных параметров.
...
9. Чтобы увидеть текущее состояние задания, нажмите кнопку «Обновить». Если задание завершилось успешно, будут показаны **График задания**, **Операции с метаданными**, **Журнал состояний**, **Диагностика**.
