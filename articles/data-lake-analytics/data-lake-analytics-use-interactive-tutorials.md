---
title: "Узнайте о Data Lake Analytics и U-SQL с помощью интерактивных руководств на портале Azure | Документация Майкрософт"
...
* **Учетная запись Data Lake Analytics**.  [Начало работы с аналитическим модулем озера данных Azure при помощи портала Azure](data-lake-analytics-get-started-portal.md).
...
7. Введите или выберите следующие значения:
...
9. Щелкните **Создать**. Откроется начальная панель портала. На домашнюю страницу добавляется новый элемент с меткой «Развертывание аналитики озера данных Azure». Для создания учетной записи Data Lake Analytics может потребоваться некоторое время. После создания учетной записи она открывается в новой колонке.
...
6. Щелкните **1 Введение** , а затем следуйте инструкциям.
