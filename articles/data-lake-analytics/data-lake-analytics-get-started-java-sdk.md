...
* **Включите свою подписку Azure** для общедоступной предварительной версии аналитики озера данных. См. [инструкции](data-lake-analytics-get-started-portal.md#signup).
