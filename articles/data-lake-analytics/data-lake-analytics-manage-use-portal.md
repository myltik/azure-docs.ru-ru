---
title: Управление аналитикой озера данных Azure с помощью портала Azure | Microsoft Docs
...
Удаление учетной записи аналитики не приведет к удалению зависимой учетной записи хранения озера данных . Инструкции по удалению учетных записей хранения озера данных см. в разделе [Удаление учетной записи хранения озера данных](../data-lake-store/data-lake-store-get-started-portal.md#delete-azure-data-lake-store-account).
