...
Как администратор, вы можете добавить поиск в существующую подписку Azure с помощью нового [портала предварительной версии Azure][]. Добавлять новые возможности в подписку могут только администраторы. При настройке службы можно выбрать один из двух уровней ценообразования.
...
Когда вы будете готовы к подписке, см. раздел [Настройка поиска на портале предварительной версии Azure][].
...
Версия API не отображается в страницах портала, так что вы не можете предоставить эту информацию. Информацию о текущей и предыдущих версиях Api см. в разделе [API REST Поиска Azure][].
...
Используя API службы Поиска, вы можете получить количество документов и индексов. Существуют жесткие ограничения, связанные с этими количествами на основе уровня ценообразования. Дополнительные сведения см. в разделе [Пределы и ограничения][]
...
Чтобы помочь при планировании работы, вы можете проверить хранилище (с использованием раздела [Получение статистики индексов][]), чтобы посмотреть, какой объем на самом деле используется.
...
<!--Anchors--> <!--Image references--> <!--Link references-->
  ...
  [Пределы и ограничения]: http://msdn.microsoft.com/en-us/library/dn798934.aspx
  ...
  [Получение статистики индексов]: http://msdn.microsoft.com/en-us/library/dn798942.aspx
  [Подсчет документов]: http://msdn.microsoft.com/en-us/library/dn798924.aspx
