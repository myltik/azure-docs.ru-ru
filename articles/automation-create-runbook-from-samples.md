...
2.  [Импортировать модуль Runbook из Коллекции Runbook][Импортировать модуль Runbook из Коллекции Runbook]
...
## <a name="automationaccount"></a>Создание службы автоматизации Azure
...
## <a name="importrunbook"></a>Импортировать модули Runbook из Коллекции Runbook
...
## <a name="publishrunbook"></a>Опубликовать модуль Runbook
...
## <a name="startrunbook"></a>Запустить модуль Runbook
...
-   [Azure Automation: Authenticating to Azure using Azure Active Directory][Azure Automation: Authenticating to Azure using Azure Active Directory] (Служба автоматизации Azure: аутентификация в Azure с помощью Azure Active Directory)
  ...
  [Импортировать модуль Runbook из Коллекции Runbook]: #importrunbook
