...
**Сводка:** сведения о Поиске Azure — полностью управляемой службе поиска в Azure для поддержки расширенных возможностей поиска в веб-приложениях и мобильных приложениях. Поиск — это стиль по умолчанию для взаимодействия с данными в Интернете. Его использование все чаще ожидается во всех ситуациях приложений.
