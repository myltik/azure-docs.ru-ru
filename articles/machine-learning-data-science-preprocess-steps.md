<properties 
	pageTitle="Предварительная обработка и очистка данных | Azure" 
...
========================================
Необработанные данные зачастую искажены, ненадежны, и в них могут быть пропущены значения. Использование таких данных при моделировании может приводить к неверным результатам. Предварительная обработка и очистка данных - это важный шаг перед использованием набора данных для машинного обучения. В этой статье рассматриваются разные действия по предварительной обработке данных, которые вы можете выполнить перед использованием данных в рамках машинного обучения Azure. 

----------------

1. **Для чего нужна предварительная обработка и очистка данных**
	...
	- Неполные данные: данные не содержат атрибутов или в них пропущены значения.
	- Искаженные данные: данные содержат ошибочные записи или выбросы.
	- Несогласованные данные: данные содержат вызывающие конфликт записи или расхождения. 
		
	Наличие данных о качестве - это необходимое условие для работы моделей прогнозирования качества. Чтобы избежать появления ситуации "мусор на входе, мусор на выходе" и повысить качество данных и, как следствие, качество модели, необходимо провести мониторинг работоспособности данных и таким образом как можно раньше обнаружить проблемы и решить, какие нужны действия по предварительной обработке и очистке данных.

2. **Какие есть стандартные методы мониторинга работоспособности данных** 
...
3. **Каковы главные задачи предварительной обработки данных**
	...
	- Уплотнение данных:  выполнение выборки данных или атрибутов для упрощения обработки данных.
...
4. **Как обрабатывать пропущенные значения**
	...
	- Фиктивная подстановка: замена пропущенных значений фиктивными, например, значения _unknown_ категориальным или значения 0 числовыми.
...
5. **Как нормализовать данные**
	...
	- Нормализация по методу минимакса: линейное преобразование данных в диапазоне, скажем, от 0 до 1.  Минимальное и максимальное масштабируемые значения соответствуют 0 и 1 соответственно.
	...
	- Десятичное масштабирование: масштабирование данных путем удаления десятичной запятой значения атрибута.  

6. **Как дискретизировать данные**  
...
7. **Как сократить объем данных**  
	...
	- Выборка записей: создайте выборку записей данных и в общем наборе данных выберите только репрезентативное подмножество. 
	- Выборка атрибутов: выберите в данных только важные атрибуты.  
...
>_Интеллектуальный анализ данных: концепции и методы. Издание третье, Morgan Kaufmann Publishers, 2011. Цзявей Хан (Jiawei Han), Мишлин Кэмбер (Micheline Kamber) и Цзянь Пей (Jian Pei)
<!--HONumber=49-->