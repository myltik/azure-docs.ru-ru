...
- Спецификации высокопроизводительных VPN-шлюзов и маршрутизируещих VPN-шлюзов одинаковы, если не указано иное. Например, проверенные VPN-устройства, совместимые с маршрутизируещими VPN-шлюзами Azure, также совместимы с высокопроизводительными VPN-шлюзами Azure.
...
| Полная безопасность пересылки (PFS) | Нет | Да (группы DH 1, 2, 5, 14, 24) | | Обнаружение неиспользуемых одноранговых узлов | Не поддерживается | Поддерживается |
