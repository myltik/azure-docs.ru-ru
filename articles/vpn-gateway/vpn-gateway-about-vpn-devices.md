---
title: 'О VPN-устройствах для подключений VPN-шлюзов типа '
;сеть: ''
—: ''
сеть";: ''
в: ''
...
microsoft: ''
azure": ''
description: 'В этой статье рассматриваются VPN-устройства и параметры IPsec для подключения VPN-шлюза типа '
сеть";.: ''
статья: ''
содержит: ''
ссылки: ''
