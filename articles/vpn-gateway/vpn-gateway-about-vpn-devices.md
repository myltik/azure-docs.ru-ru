...
## <a name="IPSec"></a>Параметры IPsec
> [!NOTE]
...
| --- | --- | --- |
| Версия IKE |IKEv1 |IKEv2 |
| Алгоритм хэширования |SHA1(SHA128), SHA2(SHA256) |SHA1(SHA128), SHA2(SHA256) |
...
| Предложения для шифрования и аутентификации IPsec SA (в порядке предпочтения) |1. ESP-AES256 2. ESP-AES128 3. ESP-3DES 4. Недоступно |См. раздел "Предложения по сопоставлению безопасности IPsec для шлюзов типа RouteBased" (ниже) |
