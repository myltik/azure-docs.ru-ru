<properties 
   pageTitle="Настройка принудительного туннелирования для VPN-шлюзов с помощью PowerShell | Microsoft Azure"
   description="При наличии виртуальной сети, развернутой по классической модели и имеющей межорганизационный VPN-шлюз, можно перенаправлять или ";принудительно направлять"; весь интернет-трафик обратно в локальное расположение."
