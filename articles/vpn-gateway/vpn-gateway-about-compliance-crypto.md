...
VPN-шлюзы Azure теперь поддерживают настраиваемые политики IPsec/IKE, задаваемые для отдельных подключений. Вы можете выбрать определенное сочетание алгоритмов шифрования IPsec и IKE с требуемой надежностью ключа для подключения S2S или подключения между виртуальными сетями, как показано в примере ниже:

![ipsec-ike-policy](./media/vpn-gateway-about-compliance-crypto/ipsecikepolicy.png)

Можно создать политику IPsec/IKE и применить ее к существующему или новому подключению. Соответствующая процедура описана ниже.
