...
* Для поддержки шифрования IPsec с целостностью AES-GCM и IPsec с SHA-256, SHA-384, SHA-512 необходима коллекция ASA версии 9.x. Такая поддержка необходима на более новых устройствах ASA.

    > [!NOTE]
    > Модели ASA 5505, 5510, 5520, 5540, 5550 и 5580 не поддерживаются. По спецификации VPN-устройства проверьте алгоритмы, которые поддерживаются моделями VPN-устройства и версиями встроенного ПО.
