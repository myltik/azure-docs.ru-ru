---
title: "Планирование и проектирование VPN-шлюза | Документация Майкрософт"
...
### <a name="a-namecompareacross-premises-connectivity-options"></a><a name="compare"></a>Возможности распределенного подключения
...
### <a name="a-namegwrequireagateway-requirements-by-vpn-type-and-sku"></a><a name="gwrequire"></a>Требования к шлюзу в зависимости от типа VPN и SKU
...
#### <a name="aggregate-throughput-by-sku-and-vpn-type"></a>Суммарная пропускная способность в зависимости от SKU и типа VPN
...
### <a name="a-namewfaworkflow"></a><a name="wf"></a>Рабочий процесс
...
### <a name="a-nametopologiesaconnection-topologies"></a><a name="topologies"></a>Топологии подключений
...
### <a name="a-namedesignbasicsadesign-basics"></a><a name="designbasics"></a>Основы проектирования
...
#### <a name="a-namesubnetsaabout-subnets"></a><a name="subnets"></a>О подсетях
...
#### <a name="a-namelocalaabout-local-network-gateways"></a><a name="local"></a>О локальных сетевых шлюзах
...
#### <a name="a-namegwtypeaabout-gateway-types"></a><a name="gwtype"></a>О типах шлюзов
...
#### <a name="a-nameconnectiontypeaabout-connection-types"></a><a name="connectiontype"></a>О типах подключений
...
#### <a name="a-namevpntypeaabout-vpn-types"></a><a name="vpntype"></a>О типах VPN
...
### <a name="a-namedevicesavpn-devices-for-site-to-site-connections"></a><a name="devices"></a>VPN-устройства для подключений типа "сеть — сеть"
...
### <a name="a-nameforcedtunnelaconsider-forced-tunnel-routing"></a><a name="forcedtunnel"></a>Вариант маршрутизации с принудительным туннелированием
