---
title: Планирование и проектирование VPN-шлюза| Microsoft Docs
...
### <a name="<a-name="compare"></a>cross-premises-connectivity-options"></a><a name="compare"></a>Возможности распределенного подключения
...
### <a name="<a-name="gwrequire"></a>gateway-requirements-by-vpn-type-and-sku"></a><a name="gwrequire"></a>Требования к шлюзу в зависимости от типа VPN и SKU
[!INCLUDE [vpn-gateway-gwsku](../../includes/vpn-gateway-gwsku-include.md)]

Дополнительные сведения о номерах SKU шлюзов см. в разделе [Параметры VPN-шлюзов](vpn-gateway-about-vpn-gateway-settings.md#gwsku).

[!INCLUDE [vpn-gateway-table-requirements](../../includes/vpn-gateway-table-requirements-include.md)]

<br>
В следующей таблице приведены типы шлюзов с приблизительной суммарной пропускной способностью. Приблизительная суммарная пропускная способность может быть решающим фактором при проектировании.
Цены на шлюзы зависят от артикулов. Сведения о ценах см. в разделе [Стоимость VPN-шлюзов](https://azure.microsoft.com/pricing/details/vpn-gateway/). Эта таблица относится к классической модели развертывания и модели диспетчера ресурсов.

[!INCLUDE [vpn-gateway-table-gwtype-aggtput](../../includes/vpn-gateway-table-gwtype-aggtput-include.md)]

### <a name="<a-name="wf"></a>workflow"></a><a name="wf"></a>Рабочий процесс
...
### <a name="<a-name="topologies"></a>connection-topologies"></a><a name="topologies"></a>Топологии подключений
Начните с просмотра схем в статье о [Основные сведения о VPN-шлюзах Azure](vpn-gateway-about-vpngateways.md) . В этой статье содержатся базовые схемы, а также описаны модели развертывания для каждой топологии (с использованием Resource Manager или классическая модель) и средства развертывания, которыми можно воспользоваться для развертывания конфигурации.   

### <a name="<a-name="designbasics"></a>design-basics"></a><a name="designbasics"></a>Основы проектирования
В следующих разделах представлены основные сведения о VPN-шлюзе. Кроме того, ознакомьтесь с [ограничениями сетевых служб](../azure-subscription-service-limits.md#networking-limits).

#### <a name="<a-name="subnets"></a>about-subnets"></a><a name="subnets"></a>О подсетях
...
#### <a name="<a-name="local"></a>about-local-network-gateways"></a><a name="local"></a>О локальных сетевых шлюзах
...
#### <a name="<a-name="gwtype"></a>about-gateway-types"></a><a name="gwtype"></a>О типах шлюзов
...
#### <a name="<a-name="connectiontype"></a>about-connection-types"></a><a name="connectiontype"></a>О типах подключений
...
#### <a name="<a-name="vpntype"></a>about-vpn-types"></a><a name="vpntype"></a>О типах VPN
...
### <a name="<a-name="devices"></a>vpn-devices-for-site-to-site-connections"></a><a name="devices"></a>VPN-устройства для подключений типа "сеть — сеть"
...
### <a name="<a-name="forcedtunnel"></a>consider-forced-tunnel-routing"></a><a name="forcedtunnel"></a>Вариант маршрутизации с принудительным туннелированием
...
![Подключение с принудительным туннелированием](./media/vpn-gateway-plan-design/forced-tunnel.png "forced tunneling")
