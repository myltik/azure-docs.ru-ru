...
>[AZURE.IMPORTANT] В настоящее время объявления маршрута по умолчанию (0.0.0.0/0) к VPN-шлюзам Azure блокируются. Мы дополнительно сообщим о включении этой функции.
