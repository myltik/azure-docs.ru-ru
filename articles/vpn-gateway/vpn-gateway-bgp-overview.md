---
title: Особенности использования BGP с VPN-шлюзами Azure | Microsoft Docs
...
> [!IMPORTANT]
> В настоящее время объявления маршрута по умолчанию (0.0.0.0/0) к VPN-шлюзам Azure блокируются. Мы дополнительно сообщим о включении этой функции.
> 
> 
