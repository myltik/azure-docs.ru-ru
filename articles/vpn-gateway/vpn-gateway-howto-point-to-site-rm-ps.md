---
title: 'Настройка подключения шлюза типа '
точка—: ''
сеть": ''
к: ''
виртуальной: ''
...
## <a name="<a-name="declare"></a>part-1---log-in-and-set-variables"></a><a name="declare"></a>Часть 1. Вход и настройка переменных
...
## <a name="part-2---configure-a-vnet"></a>Часть 2. Настройка виртуальной сети
...
## <a name="part-3---add-trusted-certificates"></a>Часть 3. Добавление доверенных сертификатов
...
## <a name="part-4---create-the-vpn-gateway"></a>Часть 4. Создание VPN-шлюза
...
## <a name="part-5---download-the-vpn-client-configuration-package"></a>Часть 5. Скачивание пакета конфигурации VPN-клиента
...
4. На клиентском компьютере перейдите в раздел **Параметры сети** и щелкните **VPN**. Вы увидите подключение в списке. Оно будет содержать имя виртуальной сети, подключение к которой будет установлено, и выглядеть примерно так: 
    ...
    ![VPN-клиент](./media/vpn-gateway-howto-point-to-site-rm-ps/vpn.png "VPN client")

## <a name="<a-name="cc"></a>part-6---generate-the-client-certificate"></a><a name="cc"></a>Часть 6. Создание сертификата клиента
...
## <a name="part-7---install-the-client-certificate"></a>Часть 7. Установка сертификата клиента
...
## <a name="part-8---connect-to-azure"></a>Часть 8. Подключение к Azure
...
## <a name="part-9---verify-your-connection"></a>Часть 9. Проверка подключения
...
## <a name="to-add-or-remove-a-trusted-root-certificate"></a>Добавление и удаление доверенного корневого сертификата
...
1. Создайте корневой сертификат и подготовьте его к добавлению в Azure. Экспортируйте открытый ключ как CER-файл X.509 в кодировке Base-64 и откройте его в текстовом редакторе. Затем скопируйте только раздел, указанный ниже. 
    ...
    ![на основе сертификата.](./media/vpn-gateway-howto-point-to-site-rm-ps/copycert.png "certificate")
...
## <a name="to-manage-the-list-of-revoked-client-certificates"></a>Управление списком отозванных сертификатов клиента
