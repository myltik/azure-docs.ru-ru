...
* В настоящее время виртуальные сети, содержащие шлюзы ExpressRoute, не поддерживают перенос. Поэтому сосуществование со шлюзами ExpressRoute в одной и той же виртуальной сети не поддерживается.
...
Изучив сведения о поддержке при переносе VPN-шлюза, ознакомьтесь со статьей [Перенос ресурсов IaaS из классической модели в модель Azure Resource Manager с помощью Azure PowerShell](../virtual-machines/virtual-machines-windows-ps-migration-classic-resource-manager.md), чтобы приступить к работе.
