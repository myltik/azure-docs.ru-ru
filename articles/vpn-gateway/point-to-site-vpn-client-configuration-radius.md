...
### <a name="workflow"></a>Рабочий процесс
  ...
  3. Получите конфигурацию VPN-клиента для выбранного варианта аутентификации и используйте ее для настройки VPN-клиента на устройстве Windows. Это позволит установить подключение типа "точка — сеть" к виртуальным сетям Azure.
...
### <a name="usernamefiles"></a>Создание файлов конфигурации VPN-клиента
...
* Папка с именем GenericDevice. Эта папка содержит общие сведения для создания конфигурации VPN-клиента. Не используйте эту папку.
* Если при создании шлюза виртуальной сети настроен протокол IKEv2, отобразится папка с именем Mac, которая содержит файл с именем mobileconfig. Этот файл используется для настройки клиентов Mac.

Можно извлечь уже созданные файлы конфигурации клиента. Командлет Get-AzureRmVpnClientConfiguration возвращает URL-адрес (ссылку), по которому вы можете скачать файл VpnClientConfiguration.zip. Если изменить конфигурацию VPN-подключения типа "точка — сеть", например изменить тип VPN-протокола или аутентификации, конфигурация не обновится автоматически. Необходимо выполнить командлет New-AzureRmVpnClientConfiguration для повторного создания конфигурации.
...
### <a name="certfiles"></a>Создание файлов конфигурации VPN-клиента
...
* WindowsAmd64 и WindowsX86. Эти папки содержат пакеты установщика Windows 64- и 32-разрядной версий. 
* Папка с именем GenericDevice. Эта папка содержит общие сведения для создания конфигурации VPN-клиента.
...
### <a name="certmaccli"></a>Настройка VPN-клиента MAC
...
## <a name="otherauth"></a>Другие типы аутентификации или протоколы
