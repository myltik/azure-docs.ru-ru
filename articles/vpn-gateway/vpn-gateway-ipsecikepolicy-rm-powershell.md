...
Последняя команда отображает текущую политику IPsec/IKE, настроенную для подключения (если оно есть). Следующий пример выходных данных предназначен для подключения:
