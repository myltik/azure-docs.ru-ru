...
При выполнении командлетов PowerShell можно воспользоваться приведенными ниже примерами настроек.
...
Имя виртуальной сети: RMVNet. <br> Группа ресурсов: RG1. <br> Пространства IP-адресов виртуальной сети: 192.168.0.0/16. <br> Подсеть 1: 192.168.1.0/24. <br> Подсеть шлюза: 192.168.0.0/26. <br> Расположение: восточная часть США. <br> Имя общедоступного IP-адреса шлюза: gwpip.<br> Локальный сетевой шлюз: ClassicVNetLocal. <br> Имя шлюза виртуальной сети: RMGateway. <br> Конфигурация IP-адресации шлюза: gwipconfig.
