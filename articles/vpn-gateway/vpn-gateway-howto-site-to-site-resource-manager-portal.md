...
* **Диапазон адресов:** 10.11.0.0/16 и 10.12.0.0/16 (необязательно для этой задачи).
* **Подписка:** подписка, которая будет использоваться.
* **Группа ресурсов:** TestRG1
* **Расположение:** восточная часть США.
* **Подсеть:** FrontEnd — 10.11.0.0/24, BackEnd — 10.12.0.0/24 (необязательно для этой задачи).
* **Имя подсети шлюза:** GatewaySubnet (автоматически заполняется на портале).
* **Диапазон адресов подсети шлюза:** 10.11.255.0/27.
