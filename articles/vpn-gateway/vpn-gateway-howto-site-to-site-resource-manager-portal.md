...
## <a name="how-to-reset-a-vpn-gateway"></a>Как сбросить VPN-шлюз
...
## <a name="how-to-change-a-gateway-sku-resize-a-gateway"></a>Как изменить SKU шлюза (изменение размера шлюза)
