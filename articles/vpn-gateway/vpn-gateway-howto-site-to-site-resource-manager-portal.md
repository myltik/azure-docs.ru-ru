...
microsoft: ''
azure": ''
description: 'Узнайте, как создать виртуальную сеть с помощью модели развертывания Resource Manager, а затем подключить ее к локальной сети с помощью подключения типа '
через: ''
vpn-шлюз.": ''
