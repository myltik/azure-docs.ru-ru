---
title: "Создание виртуальной сети с VPN-подключением типа &quot;сеть — сеть&quot; при помощи Azure Resource Manager и портала Azure | Документация Майкрософт"
...
---
# <a name="create-a-vnet-with-a-sitetosite-connection-using-the-azure-portal"></a>Создание виртуальной сети с подключением типа "сеть — сеть" с помощью портала Azure
...
## <a name="a-namecreateconnectiona8-create-a-sitetosite-vpn-connection"></a><a name="CreateConnection"></a>8. Создание VPN-подключения типа "сеть — сеть"
