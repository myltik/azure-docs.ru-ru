...
### <a name="what-is-the-gatewaysubnet-and-why-is-it-needed"></a>Что такое подсеть шлюза (GatewaySubnet) и зачем она нужна?
...
Да, этот трафик проходит через магистраль Azure. Он не проходит через Интернет.
