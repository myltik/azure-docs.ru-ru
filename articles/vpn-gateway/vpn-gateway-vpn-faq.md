...
Да, это поддерживается. Дополнительные сведения см. в статье [Настройка подключения существующих одновременно VPN типа ExpressRoute и «сеть — сеть»](../expressroute/expressroute-coexist.md).
...
- [Вопросы по виртуальным сетям](../virtual-network/virtual-networks-faq.md)

- [Вопросы и ответы по ExpressRoute](../expressroute/expressroute-faqs.md)
