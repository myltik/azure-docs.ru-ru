...
### <a name="where-can-i-find-configuration-settings-for-vpn-devices"></a>Где можно найти параметры конфигурации для VPN-устройств?

См. дополнительные сведения о [проверенных VPN-устройствах](vpn-gateway-about-vpn-devices.md#devicetable). Ссылки на инструкции по настройке устройств будут предоставляться по мере возможности. Актуальные сведения о конфигурации всегда лучше проверять у производителей устройств.
