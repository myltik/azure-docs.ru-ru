...
10. В нижней части колонки **Новое VPN-подключение** нажмите кнопку **ОК**, чтобы приступить к созданию шлюза виртуальной сети. Создание VPN-шлюза может занять до 45 минут.
...
### <a name="part-2-install-an-exported-client-certificate"></a>Часть 2. Установка экспортированного сертификата клиента
