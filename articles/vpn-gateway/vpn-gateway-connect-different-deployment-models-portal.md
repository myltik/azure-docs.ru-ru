...
Имя виртуальной сети: ClassicVNet. <br> Расположение: западная часть США. <br> Адресное пространство виртуальной сети: 10.0.0.0/8. <br> Подсеть-1: 10.0.0.0/11. <br> Подсеть шлюза: 10.32.0.0/29. <br> Имя локальной сети: RMVNetLocal. <br>

**Параметры виртуальной сети Resource Manager**

Имя виртуальной сети: RMVNet. <br> Группа ресурсов: RG1. <br> Пространства IP-адресов виртуальной сети: 192.168.1.0/16. <br> Subnet-1: 192.168.1.0/24. <br> Подсеть шлюза: 192.168.0.0/26. <br> Расположение: восточная часть США. <br> Имя шлюза виртуальной сети: RMGateway. <br> Общедоступное IP-имя шлюза: gwpip. <br> Тип шлюза: VPN. <br> Тип VPN: на основе маршрутов. <br> Шлюз локальной сети: ClassicVNetLocal. <br>
