...
2. На странице **Обзор** в разделе **VPN-подключения** щелкните значок **шлюза**, чтобы создать шлюз.
...
1. На странице **Новое VPN-подключение** установите флажок **Немедленно создать шлюз** и щелкните **Дополнительная настройка шлюза**, чтобы открыть страницу **Настройка шлюза**. 
...
2. Щелкните **Подсеть — Настройка обязательных параметров**, чтобы открыть страницу **Добавление подсети**. Вы увидите, что в поле **Имя** уже задано обязательное значение **GatewaySubnet**.
...
4. На странице **Настройка шлюза** отображается значение **Размер**, которое относится к номеру SKU шлюза. Выберите номер SKU для своего VPN-шлюза.
5. Убедитесь, что параметр **Тип маршрутизации** имеет значение **Динамическая**, и нажмите кнопку **ОК** для возврата к странице **VPN-подключения**.
6. На странице **VPN-подключения** нажмите кнопку **ОК**, чтобы создать VPN-шлюз. Создание VPN-шлюза может занять до 45 минут.
...
2. Щелкните **VPN-подключения**, чтобы открыть страницу "VPN-подключения". На странице "VPN-подключения" можно увидеть общедоступный IP-адрес. Это общедоступный IP-адрес, назначенный вашему шлюзу виртуальной сети. 
...
4. Скопировав IP-адрес шлюза, закройте страницу.
