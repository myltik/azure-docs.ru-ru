---
title: "Подключение типа \"точка — сеть\" между компьютером и виртуальной сетью Azure с использованием портала Azure и собственной аутентификации Azure на основе сертификата | Документация Майкрософт"
