...
# Настройка VPN-шлюза на классическом портале Azure
...
Данная статья относится к классической модели развертывания и классическому порталу Azure (но не к порталу Azure). На данный момент настройку VPN-шлюза для классической модели развертывания с использованием портала следует выполнять на классическом портале Azure.
...
1. На странице **Сети** классического портала Azure убедитесь в том, что в столбце состояния виртуальной сети отображается значение **Создана**.
