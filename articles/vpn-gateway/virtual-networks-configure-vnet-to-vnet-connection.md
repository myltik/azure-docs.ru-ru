...
**Установите флажок** в правом нижнем углу страницы, после чего начнется создание виртуальной сети. По завершении на классическом портале Azure на странице *Сети* в поле *Состояние* появится значение *Создано*.
...
5. Теперь вы укажете каждой виртуальной сети друг на друга как на локальную сеть. На классическом портале Azure перейдите на страницу **Панель мониторинга** сети VNet1. В разделе **Подключение типа «сеть-сеть»** выберите ** Подключиться к локальной сети**, а затем в качестве локальной сети выберите **VNET2**.
