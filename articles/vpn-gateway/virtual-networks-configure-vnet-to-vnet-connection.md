...
## Часто задаваемые вопросы о подключении между виртуальными сетями
...
**На странице «Сведения о виртуальной сети»** укажите следующую информацию. Дополнительную информацию о параметрах на этой странице см. на [странице сведений о виртуальной сети](https://msdn.microsoft.com/library/azure/09926218-92ab-4f43-aa99-83ab4d355555#BKMK_VNetDetails).
...
**На странице «Адресное пространство виртуальной сети»** укажите диапазон адресов, который вы хотите использовать для виртуальной сети. Это динамические IP-адреса (DIP), которые будут назначаться виртуальным машинам и другим экземплярам ролей, развертываемым в этой виртуальной сети. Существует довольно много правил, касающихся адресного пространства виртуальной сети, поэтому вы захотите взглянуть на страницу [Адресное пространство виртуальной сети](https://msdn.microsoft.com/library/azure/09926218-92ab-4f43-aa99-83ab4d355555#BKMK_VNET_ADDRESS) для получения дополнительной информации. Особенно важно выбрать диапазон, который не пересекается с другими диапазонами, используемыми в локальной сети. Необходимо согласование с сетевым администратором, которому может потребоваться выделить диапазон IP-адресов из адресного пространства локальной сети, чтобы использовать его для виртуальной сети.
  ...
  **Введите следующую информацию**, а затем щелкните значок галочки в нижнем правом углу, чтобы настроить сеть.
...
**Щелкните значок галочки** в нижнем правом углу страницы, после чего начнется создание виртуальной сети. По завершении на странице *Сети* портала управления в поле *Состояние* появится значение *Создано*.
...
- **VNet2**: адресное пространство — 10.2.0.0/16;
...
Если вы хотите добавить виртуальные машины в свою виртуальную сеть, см. раздел [Создание настраиваемой виртуальной машины](../virtual-machines/virtual-machines-create-custom.md).
...
Дополнительную информацию о схеме конфигурации см. в разделе [Схема конфигурации виртуальной сети Azure](https://msdn.microsoft.com/library/azure/jj157100.aspx).
