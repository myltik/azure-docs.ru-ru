...
Данная статья поможет вам создать виртуальные сети и подключить их с помощью классической модели развертывания (которую также называют управлением службами). Если вы хотите подключить виртуальные сети, созданные с помощью модели развертывания диспетчера ресурсов, обратитесь к разделу [Настройка подключения между виртуальными сетями, входящими в одну и ту же подписку, с помощью диспетчера ресурсов Azure и PowerShell](vpn-gateway-vnet-vnet-rm-ps.md).
