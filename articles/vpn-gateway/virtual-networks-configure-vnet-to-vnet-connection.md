---
title: "Подключение виртуальной сети Azure к другой виртуальной сети (классическая модель) | Документация Майкрософт"
...
### <a name="vnet-to-vnet-considerations-for-classic-vnets"></a>Рекомендации по работе с подключением типа "виртуальная сеть — виртуальная сеть" для классических виртуальных сетей
...
### <a name="add-the-local-network-site-vnet2local"></a>Добавление сайта локальной сети VNet2Local
...
## <a name="step-6---edit-the-local-network"></a>Шаг 6. Изменение локальной сети
