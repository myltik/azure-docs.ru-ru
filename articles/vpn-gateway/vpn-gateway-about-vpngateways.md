...
>[!NOTE]
>Аутентификация RADIUS и IKEv2 при подключениях типа "точка — сеть" сейчас используется в режиме в предварительной версии.
>
