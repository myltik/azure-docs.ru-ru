...
Если вы хотите настроить VPN-шлюз, см. раздел [Настройки VPN-шлюза](vpn-gateway-configure-vpn-gateway-mp.md).

Если вы хотите изменить тип VPN-шлюза, см. раздел [Изменение типа маршрутизации VPN-шлюза виртуальной сети](vpn-gateway-configure-vpn-gateway-mp.md).
