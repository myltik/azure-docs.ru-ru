...
[AZURE.INCLUDE [vpn-gateway-gwsku-include](../../includes/vpn-gateway-gwsku-include.md)] Виртуальные частные сети PolicyBased можно создавать только для шлюзов, использующих SKU "Базовый".
