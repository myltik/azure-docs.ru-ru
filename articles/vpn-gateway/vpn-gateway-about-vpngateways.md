...
description: "Из этой статьи вы узнаете, что собой представляет VPN-шлюз и как установить VPN-подключение к виртуальным сетям Azure через Интернет. Сюда также включены схемы основных конфигураций подключения."
