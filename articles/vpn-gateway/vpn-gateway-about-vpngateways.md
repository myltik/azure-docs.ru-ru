...
## <a name="a-namediagramsaconnection-topology-diagrams"></a><a name="diagrams"></a>Схемы топологий подключения
...
### <a name="site-to-site-and-multi-site-connections"></a>Подключения типа "сеть — сеть" и многосайтовые подключения
#### <a name="a-names2sasite-to-site"></a><a name="S2S"></a>Подключение типа "сеть — сеть"
...
#### <a name="a-namemultiamulti-site"></a><a name="Multi"></a>Многосайтовые подключения
...
### <a name="a-namev2vavnet-to-vnet-connections"></a><a name="V2V"></a>Подключения типа "виртуальная сеть — виртуальная сеть"
...
### <a name="a-namecoexistingasite-to-site-and-expressroute-coexisting-connections"></a><a name="coexisting"></a>Параллельные подключения "сеть — сеть" и ExpressRoute
