<properties
   pageTitle="Настройка подключения между виртуальными сетями, входящими в одну и ту же подписку, с помощью диспетчера ресурсов Azure и PowerShell | Microsoft Azure"
