...
Приведенные ниже инструкции продолжают действия, описанные выше. Необходимо выполнить [шаг 1](#Step1) и [шаг 2](#Step2), чтобы создать и настроить сеть TestVNet1 и VPN-шлюз для нее. Если вы планируете подключать только виртуальные сети в рамках разных подписок, шаги 3 и 4 из предыдущего упражнения можно пропустить и перейти сразу к шагу 5.
...
5. Проверка подключения
	...
	Выполнив эти действия, проверьте подключение с помощью методов, описанных в разделе [Проверка подключения между виртуальными сетями](#Verify).
