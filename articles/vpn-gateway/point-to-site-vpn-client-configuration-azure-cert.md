...
description: "Создание и установка файлов конфигурации VPN-клиента Windows и Mac OS X для использования аутентификации на основе сертификата."
...
## <a name="installmac"></a>Настройка VPN-клиента на компьютерах Mac (OS X)
