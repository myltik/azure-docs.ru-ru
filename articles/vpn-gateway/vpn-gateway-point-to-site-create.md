<properties
   pageTitle="Настройка VPN-подключения типа «точка-сеть» | Microsoft Azure"
...
Дополнительную информацию о виртуальных сетях между несколькими организациями см. в разделе [Сведения о безопасной виртуальной сети между несколькими организациями](http://go.microsoft.com/fwlink/p/?LinkID=532884).
...
В виртуальную сеть можно добавлять виртуальные машины. Соответствующие указания см. в статье [Как создать настраиваемую виртуальную машину](../virtual-machines/virtual-machines-create-custom.md).
