...
В этой статье рассматривается создание виртуальной сети с подключением "точка — сеть" в **классической модели развертывания** с помощью **классического портала**. Сейчас для классической модели развертывания нельзя создать законченную конфигурацию с помощью портала Azure. Некоторые действия можно выполнить на портале Azure, но PowerShell по-прежнему требуется, чтобы скачать конфигурацию клиента VPN.
