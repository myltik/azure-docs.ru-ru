<properties urlDisplayName="Using Offline Data" pageTitle="С помощью автономных данных в мобильных службах (Xamarin Android) | Центр разработчиков мобильных устройств" metaKeywords ="" description="Learn how to use Azure Mobile Services to cache and sync offline data in your Xamarin Android application" metaCanonical="" disqusComments="1" umbracoNaviHide="1" documentationCenter="Mobile" title="Using offline data in Mobile Services" authors="donnam" editor="wesmc" manager="dwrede"/>
