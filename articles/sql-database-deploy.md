<properties 
	pageTitle="Развертывание базы данных SQL: Azure" 
	description="Узнайте, как развернуть базу данных SQL Server в Azure. Для передачи примера базы данных вы будете использовать мастер развертывания базы данных в Базе данных SQL." 
...
**Примечание.** Подробные указания о подготовке локальной базы данных к миграции в Azure см. в руководстве по переносу базы данных SQL. Кроме того, рекомендуется загрузить учебный набор Azure. Он включает в себя лабораторную работу, демонстрирующую альтернативный способ переноса локальной базы данных.
...
[Приступая к администрированию базы данных SQL]: /manage/services/sql-databases/getting-started-w-sql-databases/  
