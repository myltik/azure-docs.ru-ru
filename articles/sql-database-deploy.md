<properties linkid="manage-services-how-to-deploy-a-sqldb" urlDisplayName="Развертывание" pageTitle="Развертывание базы данных SQL в Azure" metaKeywords="" description="Узнайте, как развернуть базу данных SQL Server в Azure. Вы воспользуетесь мастером развертывания базы данных в базе данных SQL, чтобы отправить образец базы данных." metaCanonical="" services="sql-database" documentationCenter="" title="Развертывание базы данных в Azure" authors=""  solutions="" writer="" manager="" editor=""  />
...
Скрипты для создания этой базы данных можно найти в разделе [Приступая к администрированию базы данных SQL][]. В рамках данного руководства вам предстоит запустить эти скрипты в среде Management Studio, чтобы создать локальную версию базы данных school.
...
10. Щелкните элемент **Подключить**. После выполнения этого шага вы завершаете настройку подключения и возвращаетесь в мастер.
