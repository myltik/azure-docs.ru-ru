...
# <span id="howtodeploySQLdb"></span></a>Развертывание базы данных в Azure

Существует несколько различных способов для перемещения локальной базы данных SQL Server в Azure. В этой задаче для отправки образца базы данных вы будете использовать мастер развертывания базы данных в базе данных SQL.
...
-   [Практическое руководство. Создание базы данных school на локальном сервере][Практическое руководство. Создание базы данных school на локальном сервере]
-   [Практическое руководство. Развертывание в базе данных SQL][Практическое руководство. Развертывание в базе данных SQL]
-   [Практическое руководство. Проверка развертывания базы данных][Практическое руководство. Проверка развертывания базы данных]

## <span id="schooldb"></span></a>Практическое руководство. Создание базы данных "school" на локальном сервере
...
## <span id="deploydb"></span></a>Практическое руководство. Развертывание в базе данных SQL

1.  В среде Management Studio подключитесь к локальному экземпляру SQL Server с базой данных, которую требуется перенести.

2.  Щелкните правой клавишей мыши по только что созданной базе данных school, наведите указатель на пункт **Задачи** и выберите команду **Развертывание базы данных в SQL Azure**.

3.  В поле "Параметры развертывания" введите имя базы данных, например *school*.
...
11. Нажмите кнопку **Далее**, а затем **Готово** для запуска мастера.

## <span id="verify"></span></a>Практическое руководство. Проверка развертывания базы данных
...
3.  Щелкните правой клавишей мыши по базе данных school и выберите пункт **Создать запрос**.
