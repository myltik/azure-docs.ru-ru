<properties linkid="web-site-with-webmatrix" urlDisplayName="Веб-сайт с WebMatrix" pageTitle="Веб-сайт Node.js с WebMatrix - учебный курс Azure" metaKeywords="" description="Учебный курс, посвященный использованию WebMatrix для разработки и развертывания приложения Node.js на веб-сайте Azure." metaCanonical="" services="web-sites" documentationCenter="Node.js" title="Построение и развертывание веб-сайта Node.js в Azure с помощью WebMatrix" authors="" solutions="" manager="" editor="" />
...
<p>Чтобы пройти этот учебный курс, потребуется учетная запись Azure с включенной возможностью веб-сайтов Azure.</p>
...
4. По завершении создания веб-сайта в WebMatrix откроется интегрированная среда разработки WebMatrix.
...
3. Щелкните ссылку, чтобы открыть веб-сайт в браузере.
	...
	![Экспресс-сайт][webmatrix-node-express-site]
...
4. После завершения публикации щелкните ссылку, возвращенную по завершении процесса публикации, для просмотра обновленного сайта.
...
При возникновении проблем с приложением после его развертывания в Azure сведения о диагностике проблемы можно найти в разделе [Отладка приложения Node.js на веб-сайтах Azure](http://www.windowsazure.com/ru-ru/develop/nodejs/how-to-guides/Debug-Website/).
...
[Publishing an Azure Web site using Git]: /ru-ru/develop/nodejs/common-tasks/publishing-with-git/
