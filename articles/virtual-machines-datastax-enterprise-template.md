...
### Этап 1-б. Загрузка файлов шаблонов с помощью интерфейса командной строки Azure
...
При запуске команды **New-AzureResourceGroupDeployment** значения параметров извлекаются из JSON-файла и начинается выполнение шаблона на их основе. Определение и использование нескольких файлов параметров в разных средах (например, тестовая среда, рабочая среда и т. д.) способствует повторному использованию шаблона и упрощает сложные решения для нескольких сред.
...
На этой схеме представлены связи между всеми файлами, скачанными из репозитория GitHub для этого развертывания:
