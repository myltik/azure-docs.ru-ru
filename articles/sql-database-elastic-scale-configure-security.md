<properties title="Elastic Scale Security Configurations" pageTitle="Конфигурации безопасности гибкого масштабирования" description="Защита служб слияния и разбиения с помощью эластичного масштабирования для базы данных SQL Azure" metaKeywords="Elastic Scale Security Configurations, Azure SQL Database sharding, elastic scale " services="sql-database" documentationCenter="" manager="jhubbard" authors="sidneyh@microsoft.com"/>
...
* Получение WDK из [Windows 8.1: Загрузка наборов и инструментов](http://msdn.microsoft.com/windows/hardware/gg454513#drivers)
