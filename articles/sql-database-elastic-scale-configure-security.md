<properties 
	...
	description="Защита служб объединения и разбиения с помощью эластичного масштабирования для базы данных SQL Azure" 
...
## <a name="tools"></a>Инструменты для создания сертификатов
...
1.    [Отключение проверки подлинности на основе сертификата клиента][]
...
5.    [Создание PFX-файлов для сертификатов клиентов][]
...
## <a name="turn-off-client-cert"></a>Отключение проверки подлинности на основе сертификата клиента
...
## <a name="create-self-signed-ca"></a>Создание центра самозаверяющей сертификации
...
## <a name="upload-ca-cert"></a>Передайте сертификат ЦС в облачную службу
...
## <a name="issue-client-certs"></a>Выдача сертификатов клиентов
...
## <a name="create-pfx-files"></a>Создание PFX-файлов для сертификатов клиентов
...
## <a name="configure-allowed-client"></a>Настройте разрешенные клиенты в файле конфигурации службы
...
## <a name="configure-client-revocation"></a>Настройте проверку отзыва сертификата клиента
...
## <a name="create-pfx-files-encryption"></a>Создайте PFX-файл для самозаверяющих сертификатов шифрования
...
## <a name="export-encryption-from-store"></a>Экспортируйте сертификат шифрования из хранилища сертификатов
...
## <a name="upload-encryption-cert"></a> Отправьте сертификат шифрования в облачную службу

Отправьте сертификат с существующим или созданным .PFX-файлом с помощью пары ключей SSL.

* Введите пароль, защищающий данные закрытого ключа

## <a name="update-encryption-in-csft"></a>Обновите сертификат шифрования в файле конфигурации службы
...
## Стандартные операции с сертификатами
...
[Отключение проверки подлинности на основе сертификата клиента]: #turn-off-client-cert
...
[Создание PFX-файлов для сертификатов клиентов]:#create-pfx-files
