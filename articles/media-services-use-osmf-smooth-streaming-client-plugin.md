...
В настоящем документе предполагается, что читатель имеет общие знания о работе с OSMF и подключаемыми модулями OSMF. Дополнительные сведения об OSMF см. в документации на [официальном сайте OSMF][официальном сайте OSMF].
...
Дополнительные сведения о статической и динамической загрузке см. на официальной [странице подключаемого модуля OSMF][странице подключаемого модуля OSMF].
...
Дополнительные сведения об общей процедуре разработки для OSMF см. на официальной [странице разработки OSMF][странице разработки OSMF].
