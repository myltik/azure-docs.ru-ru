---
title: "Коллекция образов Azure для государственных организаций | Документация Майкрософт"
...
## <a name="images---azure-resource-manager"></a>Образы — Azure Resource Manager
| Издатель | Имя образа |
| --- | --- |
| Esri |ArcGIS 10.4.1 for Server |
| Barracuda Networks, Inc. |Barracuda NextGen Control Center (BYOL) |
| Barracuda Networks, Inc. |Брандмауэр Barracuda NextGen серии F (BYOL) |
| Microsoft |BizTalk Server 2016 CTP-версии 2 |
| Microsoft |{BYOL} SQL Server 2012 SP3 Enterprise на Windows Server 2012 R2 |
| Microsoft |{BYOL} SQL Server 2012 SP3 Standard на Windows Server 2012 R2 |
| Microsoft |{BYOL} SQL Server 2014 SP1 Enterprise на Windows Server 2012 R2 |
| Microsoft |{BYOL} SQL Server 2014 SP1 Standard на Windows Server 2012 R2 |
| Microsoft |{BYOL} SQL Server 2016 RTM Enterprise на Windows Server 2012 R2 |
| Microsoft |{BYOL} SQL Server 2016 RTM Standard на Windows Server 2012 R2 |
| OpenLogic |Версия 6.7 на основе CentOS |
| OpenLogic |Версия 6.8 на основе CentOS |
| OpenLogic |Версия 7.2 на основе CentOS |
| CoreOS |CoreOS Linux (стабильная версия) |
| F5 Networks |F5 BIG-IP ADC+SEC BEST — BYOL |
| F5 Networks |F5 BIG-IP ADC BETTER — BYOL |
| F5 Networks |F5 BIG-IP ADC GOOD (LTM) — BYOL |
| Bitnami |Moodle |
| Citrix |NetScaler VPX с использованием собственной лицензии |
| SUSE |openSUSE Leap 42.1 |
| Red Hat |Red Hat Enterprise Linux 6.8 |
| Red Hat |Red Hat Enterprise Linux 7.2 |
| Microsoft |SQL Server 2012 SP3 Enterprise на Windows Server 2012 R2 |
| Microsoft |SQL Server 2012 SP3 Standard на Windows Server 2012 R2 |
| Microsoft |SQL Server 2014 SP1 Enterprise на базе Windows Server 2012 R2 |
| Microsoft |SQL Server 2014 SP1 Standard на Windows Server 2012 R2 |
| Microsoft |SQL Server 2016 RTM Enterprise на Windows Server 2012 R2 |
| Microsoft |SQL Server 2016 RTM Standard на Windows Server 2012 R2 |
| SUSE |SLES 11 SP4 или более поздней версии |
| SUSE |SLES 12 SP1 |
| Microsoft |Центр обработки данных Windows Server 2012 R2; |
| Barracuda Networks, Inc. |Barracuda Web Application Firewall (WAF) — BYOL |
| Microsoft |Windows Server 2008 R2 с пакетом обновления 1 |
| Microsoft |Windows Server 2012 Datacenter |
| Microsoft |Центр обработки данных Windows Server 2012 R2; |

## <a name="images---classic-resource-provider"></a>Образы — классический поставщик ресурсов.
...
| Barracuda Networks, Inc. |Брандмауэр Barracuda NextGen серии F 7.0.0-672 |Брандмауэр Barracuda NextGen серии F (https://www.barracuda.com/products/nextgenfirewall-f) — это мощный и удобный инструмент для защиты сети и управления ею. Так как это средство безопасности под управлением Linux... |Linux |80 ГБ |
| Barracuda Networks, Inc. |Брандмауэр веб-приложения Barracuda 8.0.101101 |Брандмауэр веб-приложения Barracuda Web Application Firewall (https://www.barracuda.com/products/webapplicationfirewall) — это мощное и удобное устройство для защиты веб-сайта от атак, защиты данных… |Linux |50 ГБ |
...
| Microsoft Open Technologies, Inc. |Oracle WebLogic Server 11g Standard Edition на Windows Server 2008 R2 |Oracle WebLogic Server http://www.oracle.com/weblogicserver 11g Standard Edition (10.3.6) — это ведущий сервер приложений Java для предприятий всех размеров, предоставляющий разработчикам средства... |Windows |128 ГБ |
| Microsoft Open Technologies, Inc. |Oracle WebLogic Server 11g Enterprise Edition на Windows Server 2008 R2 |Oracle WebLogic Server 11g Enterprise Edition (10.3.6) — это ведущий сервер приложений Java для современных центров обработки данных. Он использует все преимущества новейших... |Windows |128 ГБ |
...
| Microsoft Open Technologies, Inc. |JDK 8 на Windows Server 2012 R2 |Платформа Java http://www.oracle.com/java,  стандартный выпуск 8 (обновление 25) обеспечивает разработку безопасных, переносимых и высокопроизводительных приложений, а также предлагает в своем составе комплект разработчика Java (JDK), Java... |Windows |128 ГБ |
...
| Microsoft Open Technologies, Inc. |JDK 6 в Windows Server 2012 |Платформа Java http://www.oracle.com/java, Standard Edition 6 (обновление 85) обеспечивает разработку безопасных, переносимых и высокопроизводительных приложений, а также предлагает в своем составе комплект разработчика Java (JDK), Java... |Windows |128 ГБ |
...
## <a name="quick-start-templates"></a>Шаблоны быстрого запуска
### <a name="step-1"></a>Шаг 1
Перейдите в репозиторий GitHub шаблонов быстрого запуска Azure и выберите из списка шаблонов решений ниже.

| Шаблон быстрого запуска |
| --- |
| <a href="https://github.com/Azure/azure-quickstart-templates/tree/master/ethereum-consortium-blockchain-network"> Сеть блочной цепи Ethereum Consortium </a> |
...
На странице обозревателя откроется колонка развертывания шаблона на портале Azure для государственных учреждений. В колонке "Параметры" заполните необходимые поля и нажмите кнопку "ОК".

### <a name="step-4"></a>Шаг 4.
Примите юридические условия и установите флажок "Закрепить на панели мониторинга", а затем нажмите кнопку "Создать".

> [!NOTE]
> Для продолжения потребуется действительная учетная запись Azure государственных организаций. Чтобы испытать все возможности Azure для государственных организаций в своей организации, зарегистрируйтесь для использования [пробной версии Azure для государственных организаций](https://azuregov.microsoft.com/trial/azuregovtrial).
> 
> 

### <a name="step-5"></a>Шаг 5
Колонки закроются, и вы вернетесь к панели мониторинга на портале, на которой показано развертывание образа. Операция займет несколько минут. После запуска решение виртуальной машины отобразится на панели мониторинга. Если на шаге 4 не был установлен флажок "Закрепить на панели мониторинга", то найти виртуальную машину можно будет в разделе "Ресурсы".

> [!NOTE]
> Шаблоны решений корпорации Майкрософт и сторонних поставщиков служат только отправной точкой. Вы полностью отвечаете за разработку и реализацию приложений и (или) подписок, выполняющихся в Microsoft Azure и Azure для государственных организаций, а также за управление ими в соответствии с применимыми законами, нормами и контрактным обязательствам.  Эти шаблоны предоставляются "КАК ЕСТЬ", без каких-либо гарантий (явных, подразумеваемых или предусмотренных законом). Корпорация Майкрософт явно отказывается от всех гарантий пригодности для продажи или соответствия конкретной цели, а также от гарантий ненарушения авторского права.
> 
> 

## <a name="next-steps"></a>Дальнейшие действия
Приведенные ниже ресурсы предлагают дополнительную информацию о развертывании из коллекции образов или создании собственных виртуальных жестких дисков.  См. [Руководство разработчика Azure Government](documentation-government-developer-guide.md), в котором содержится информация о программных различиях в конечных точках при работе с Azure Government.

### <a name="other-resources"></a>Другие ресурсы:
* [Развертывание виртуальной машиныWindows](../virtual-machines/virtual-machines-windows-hero-tutorial.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)
* [Вопросы и ответы по виртуальным машинам](../virtual-machines/virtual-machines-windows-faq.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)
* [Запись образа виртуальной машины Linux](../virtual-machines/virtual-machines-linux-classic-capture-image.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
