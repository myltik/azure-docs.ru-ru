...
Дополнительные сведения см. в <a href=https://azure.microsoft.com/ru-RU/documentation/services/virtual-machines/windows/>общедоступной документации по виртуальным машинам Azure </a>.
