...
### <a name="<a-name="overview"></a>encryption-at-rest"></a><a name="Overview"></a>Шифрование при хранении
...
### <a name="<a-name="overview"></a>storage-service-encryption"></a><a name="Overview"></a>Шифрование службы хранения
...
### <a name="<a-name="overview"></a>azure-disk-encryption"></a><a name="Overview"></a>Шифрование дисков Azure
...
### <a name="<a-name="overview"></a>client-side-encryption"></a><a name="Overview"></a>Шифрование на стороне клиента
...
### <a name="<a-name="overview"></a>encryption-in-transit"></a><a name="Overview"></a>Шифрование при передаче
...
### <a name="<a-name="overview"></a>best-practices-for-encryption"></a><a name="Overview"></a>Рекомендации по шифрованию
...
### <a name="<a-name="overview"></a>best-practices-for-managing-secrets"></a><a name="Overview"></a>Рекомендации по управлению секретами
...
### <a name="<a-name="overview"></a>environment-isolation"></a><a name="Overview"></a>Изоляция среды
...
#### <a name="<a-name="overview"></a>per-customer-isolation"></a><a name="Overview"></a>Изоляция среды клиента
