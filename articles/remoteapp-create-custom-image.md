<properties title="How to create a custom template image for RemoteApp" pageTitle="Создание пользовательского образа шаблона для службы RemoteApp" description="Узнайте, как создать настраиваемый образ шаблона для удаленного приложения RemoteApp Этот шаблон можно использовать для гибридного или облачного развертывания." metaKeywords="" services="" solutions="" documentationCenter="" authors="elizapo" manager="kathyw" />
