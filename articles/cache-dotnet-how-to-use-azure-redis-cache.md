...
информацией по использованию кэша Azure Redis обратитесь к разделу [Дальнейшие действия][Дальнейшие действия].

## Оглавление

-   [Что такое кэш Azure Redis][Что такое кэш Azure Redis]
-   [Начало работы с кэшем Azure Redis][Начало работы с кэшем Azure Redis]
...
-   [Работа с кэшами][Работа с кэшами]
    ...
    -   [Указание срока действия объекта в кэше][Указание срока действия объекта в кэше]
    -   [Сохранение состояния сеанса ASP.NET в кэше][Сохранение состояния сеанса ASP.NET в кэше]
...
Это руководство содержит обзор начала работы с кэшем Azure Redis. За дополнительной детальной информацией о компонентах, которые не вошли в это руководство, обратитесь к разделу [Обзор кэша Azure Redis][Обзор кэша Azure Redis].
...
> За дополнительной информацией обратитесь к разделу [Использование групп ресурсов для управления ресурсами Azure][Использование групп ресурсов для управления ресурсами Azure].
...
![Кэш создан][Кэш создан]

После создания кэша он доступен в лезвии **Обзор**.

![Лезвие "Обзор"][Лезвие "Обзор"]
...
> За дополнительной информацией обратитесь к странице [StackExchange.Redis][StackExchange.Redis] на github и документации клиента кэша [StackExchange.Redis][2].
...
![Пакет NuGet StackExchange.Redis][Пакет NuGet StackExchange.Redis]
...
> За дополнительной информацией по вариантам расширенных настроек соединения обратитесь к раз делу [Модель конфигурации StackExchange.Redis][Модель конфигурации StackExchange.Redis].
...
![Пакет Redis NuGet для состояний сеансов][Пакет Redis NuGet для состояний сеансов]
...
За дополнительной информацией о настройках и использовании поставщика состояний сеансов Redis обратитесь к разделу [Поставщик состояний сеансов Azure Redis][Поставщик состояний сеансов Azure Redis].
