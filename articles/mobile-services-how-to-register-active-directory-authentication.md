...
11. В списке **Разрешенные клиенты** нужно добавить домен каталога, в котором зарегистрировано приложение (например, contoso.onmicrosoft.com). Имя домена по умолчанию можно найти, щелкнув вкладку **Домены** в Active Directory.

    ![][11]
 
    Добавьте имя домена в список **Разрешенные клиенты**, а затем нажмите кнопку **Сохранить**.    
