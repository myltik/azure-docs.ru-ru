...
Прочтите и выполните подробные инструкции о развертывании шаблона из учебника [Развертывание ресурсов Azure с использованием библиотек .NET и шаблона](./arm-template-deployment/#step-4-create-the-credentials-that-are-used-to-authenticate-requests).
