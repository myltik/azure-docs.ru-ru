<properties 
	pageTitle="Как управлять учетными записями хранения - Microsoft Azure" 
	description="Вы узнаете, как управлять учетными записями хранения с помощью Портала управления в Azure." 
	services="storage" 
	documentationCenter="" 
	authors="tamram" 
	manager="adinah" 
...
> [AZURE.WARNING] Восстановить содержимое удаленной учетной записи хранения невозможно. Убедитесь, что вы создали резервные копии нужных данных, прежде чем удалять учетную запись.
> 
