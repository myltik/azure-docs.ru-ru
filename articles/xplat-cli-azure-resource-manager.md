...
>[AZURE.NOTE] При желании сохраните данные JSON в файл, используя символ &gt; для перенаправления выходных данных в файл. Например:
>
