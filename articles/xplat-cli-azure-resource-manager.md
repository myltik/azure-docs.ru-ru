...
Выполнять развертывание в этой группе ресурсов *testRG* вы будете позже при запуске виртуальной машины Ubuntu с помощью шаблона. Создав группу ресурсов, вы можете добавить в нее такие ресурсы, как виртуальные машины и сети или хранилища.
...
* доменное имя виртуальной машины (`dnsLabelPrefix`).
...
2. Чтобы просмотреть отдельный ресурс в группе, например виртуальную машину *MyUbuntuVM*, используйте такую команду.
...
* Дополнительные сведения о работе с Azure Resource Manager на портале Azure см. в статье [Управление ресурсами Azure через портал](./azure-portal/resource-group-portal.md).
