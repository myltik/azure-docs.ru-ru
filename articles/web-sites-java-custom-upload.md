...
](../web-sites-java-get-started). Этот учебник предназначен для сценариев, в которых не требуется пользовательский интерфейс настройки Azure или коллекция приложений Azure.  
