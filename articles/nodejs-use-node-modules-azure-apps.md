<properties pageTitle="Работа с модулями Node.js" description="Узнайте, как работать с модулями Node.js при использовании веб-сайтов или облачных служб Azure." services="" documentationCenter="nodejs" authors="rmcmurray" manager="wpickett" editor=""/>
