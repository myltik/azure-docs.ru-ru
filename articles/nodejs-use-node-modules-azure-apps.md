...
> [AZURE.NOTE]
Если при развертывании приложения на веб-сайте Azure ваш файл <b>package.json</b> ссылается на собственный модуль, вы увидите ошибку, аналогичную той, что возникает при публикации приложения с помощью Git:
...
> [AZURE.NOTE]
Если при развертывании приложения на веб-сайте Azure ваш файл <b>npm-shrinkwrap.json</b> ссылается на собственный модуль, вы увидите ошибку, аналогичную той, что возникает при публикации приложения с помощью Git:
