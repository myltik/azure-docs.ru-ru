...
#Дисковое шифрование Azure для виртуальных машин IaaS под управлением Windows и Linux (предварительная версия)

> [AZURE.NOTE]Сведения в этом документе относятся к предварительной версии дискового шифрования Azure.
...
- Сведения об установке и настройке хранилища ключей Azure для использования дискового шифрования Azure см. в разделе **Подключение и настройка хранилища ключей Azure для дискового шифрования Azure** приложения к этой статье.

- Сведения об установке и настройке приложения Azure AD в Azure Active Directory для использования дискового шифрования Azure см. в разделе **Настройка приложения Azure AD в Azure Active Directory** приложения к этой статье.

- Сведения об установке и настройке политики доступа к хранилищу ключей для приложения Azure AD см. в разделе **Настройка политики доступа к хранилищу ключей для приложения Azure AD** приложения к этой статье.
...
3\. Если вы изменяете файл *azure\_crypt\_key.sh* в Windows, а затем копируете его в Linux, не забудьте выполнить команду *dos2unix /usr/local/sbin/azure\_crypt\_key.sh*. 4. Выполните команду *update-initramfs -u -k all*, чтобы обновился параметр initramfs и вступил в силу keyscript.
