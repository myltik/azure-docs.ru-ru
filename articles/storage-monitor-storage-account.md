<properties linkid="manage-services-how-to-monitor-a-storage-account" urlDisplayName="Мониторинг" pageTitle="Мониторинг учетной записи хранения | Microsoft Azure" metaKeywords="мониторинг учетной записи хранения Azure, портал управления учетными записями хранения, панель мониторинга учетных записей хранения, таблица метрик хранилища, диаграмма метрик хранилища" description="Узнайте, как контролировать учетную запись хранения в Azure с помощью портала управления." metaCanonical="" services="storage" documentationCenter="" title="Мониторинг учетной записи хранения" authors="tamram" solutions="" manager="mbaldwin" editor="cgronlun" />





<h1><a id="createstorageaccount"></a>Мониторинг учетной записи хранения</h1>
...
* [Практическое руководство. Настройка ведения журналов](#configurelogging)
...
Метрики в учетной записи хранения хранятся в четырех таблицах с именами $MetricsTransactionsBlob, $MetricsTransactionsTable, $MetricsTransactionsQueue и $MetricsCapacityBlob. Дополнительные сведения см. в статье [О метриках аналитики хранилища](http://msdn.microsoft.com/ru-ru/library/windowsazure/hh343258.aspx).
...
<h2><a id="configurelogging"></a>Практическое руководство. Настройка ведения журналов</h2>
...
Журналы диагностики сохраняются в контейнере BLOB-объектов с именем $logs в вашей учетной записи хранения. Дополнительные сведения о доступе к контейнеру $logs см. в статье [О ведении журнала службы аналитики хранилища](http://msdn.microsoft.com/ru-ru/library/windowsazure/hh343262.aspx).
