...
|:---------------------|:-----|:-------|:------------|
|**id**|string|[a-zA-Z0-9\_.]|Идентификатор этого пакета. Должен быть уникальным в пределах пространства имен и может содержать только буквы, цифры, "\_" и ".". Должен начинаться с буквы или цифры.|
