...
10. В раскрывающемся списке **Приложения** выберите пункт "Приложение Contoso B2C", а в списке **URL-адрес ответа и URI перенаправления** — `https://localhost:44321/`. Нажмите кнопку **Запустить**. Откроется новая вкладка браузера, и вы сможете оценить процесс изменения профиля пользователя в своем приложении.
