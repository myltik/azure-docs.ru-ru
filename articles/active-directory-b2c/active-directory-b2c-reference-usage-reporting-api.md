...
Azure Active Directory B2C (Azure AD B2C) предоставляет аутентификацию на основе имени для входа и Многофакторной идентификации Azure. Аутентификация предоставляется для конечных пользователей всего семейства приложений у поставщиков удостоверений. Зная количество пользователей, зарегистрированных в клиенте, какие поставщики использовались для регистрации и сколько типов аутентификации используется, можно ответить на следующие вопросы:
...
* Сколько успешных операций аутентификации с помощью Многофакторной идентификации было выполнено за последний месяц?
