...
Перечисленные ниже типы приложений пока что не поддерживаются в Azure AD B2C. Описание поддерживаемых типов приложений можно найти в статье [Предварительная версия Azure Active Directory B2C: типы приложений](active-directory-b2c-apps.md).
...
В кратких руководствах для iOS и Android описано использование библиотек с открытым исходным кодом, протестированных на совместимость с Azure AD B2C. В разделе [Приступая к работе](active-directory-b2c-overview.md#getting-started) приведены все имеющиеся краткие руководства.
