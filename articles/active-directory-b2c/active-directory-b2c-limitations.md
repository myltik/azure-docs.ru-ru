...
Некоторые возможности и функции Azure Active Directory (Azure AD) B2C еще не поддерживаются в предварительной версии. Многие из этих ограничений будут сняты до того, как служба Azure AD B2C станет общедоступной. Эти ограничения следует учитывать, если вы создаете приложения для работы с клиентами в предварительной версии Azure AD B2C.

[AZURE.INCLUDE [active-directory-b2c-preview-note](../../includes/active-directory-b2c-preview-note.md)]

## Проблемы при создании клиентов Azure AD B2C

При возникновении проблем во время [создания клиента Azure AD B2C](active-directory-b2c-get-started) обратитесь к разделу [Создание клиента Azure AD или Azure AD B2C — проблемы и способы их устранения](active-directory-b2c-support-create-directory.md).
