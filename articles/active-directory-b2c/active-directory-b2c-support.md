<properties
	pageTitle="Azure Active Directory B2C: поддержка | Microsoft Azure"
...
2. Переключитесь с вашего клиента B2C на другой клиент, с которым сопоставлена подписка Azure. Это может быть клиент вашего сотрудника или клиент по умолчанию, который был создан, когда вы зарегистрировались для получения подписки Azure. Дополнительные сведения см. в статье [Связь между подписками Azure и Azure Active Directory](active-directory-how-subscriptions-associated-directory.md#how-an-azure-subscription-is-related-to-azure-ad).
