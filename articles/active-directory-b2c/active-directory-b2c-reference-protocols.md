...
Если вы готовы рассмотреть несколько примеров запросов, приступите к одному из учебников ниже. Каждый из них соответствует определенному сценарию аутентификации. Если вам требуется помощь при определении подходящего процесса, ознакомьтесь с [типами приложений, которые можно создать с помощью Azure AD B2C](active-directory-b2c-apps).
