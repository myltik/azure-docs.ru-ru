...
> [AZURE.NOTE]
Сейчас страницы входа в локальную учетную запись, подтверждающие сообщения электронной почты, и страницы самостоятельного сброса пароля можно настроить только с помощью [фирменной символики компании](../active-directory/active-directory-add-company-branding.md). Описанные в данной статье механизмы недоступны для этих целей.
...
- Не копируйте стандартный шаблон Azure AD B2C и не пытайтесь изменить его. Лучше создать содержимое HTML5 с нуля, используя стандартный шаблон в качестве образца.
