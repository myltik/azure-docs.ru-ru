---
title: "Azure Active Directory B2C: настройка пользовательского интерфейса | Документация Майкрософт"
...
2. Затем разместите это содержимое в конечной точке HTTPS (CORS-доступ должен быть включен). Обратите внимание, что при настройке CORS необходимо будет включить методы запроса GET и OPTIONS.
...
### <a name="the-most-basic-html-content-for-testing"></a>Самое простое содержимое HTML для тестирования
...
## <a name="the-core-ui-elements-in-each-type-of-page"></a>Основные элементы пользовательского интерфейса для каждого типа страницы
...
### <a name="azure-ad-b2c-content-inserted-into-the-identity-provider-selection-page"></a>Содержимое Azure AD B2C, вставленное на страницу выбора поставщика удостоверений
...
### <a name="azure-ad-b2c-content-inserted-into-the-local-account-sign-up-page"></a>Содержимое Azure AD B2C, вставленное на страницу регистрации локальной учетной записи
...
### <a name="azure-ad-b2c-content-inserted-into-the-social-account-sign-up-page"></a>Содержимое Azure AD B2C, вставленное на страницу регистрации учетной записи в социальной сети
...
### <a name="azure-ad-b2c-content-inserted-into-the-unified-sign-up-or-sign-in-page"></a>Содержимое Azure AD B2C, вставленное на единую страницу регистрации и входа
...
### <a name="azure-ad-b2c-content-inserted-into-the-multi-factor-authentication-page"></a>Содержимое Azure AD B2C, вставленное на страницу многофакторной проверки подлинности
...
### <a name="azure-ad-b2c-content-inserted-into-the-error-page"></a>Содержимое Azure AD B2C, вставленное на страницу с ошибкой
```HTML
