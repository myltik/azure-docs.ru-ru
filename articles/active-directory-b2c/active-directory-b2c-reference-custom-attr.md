<properties
	pageTitle="Azure Active Directory B2C: настраиваемые атрибуты | Microsoft Azure"
...
#  Azure Active Directory B2C: использование настраиваемых атрибутов для сбора данных о потребителях
