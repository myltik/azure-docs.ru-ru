---
title: Тестовый выпуск одностраничного приложения с включенным Azure AD B2C
description: Краткое руководство по применению образца одностраничного приложения Azure Active Directory B2C для проверки подлинности и регистрации пользователей.
...
---
# <a name="quickstart-test-drive-an-azure-ad-b2c-enabled-single-page-app"></a>Краткое руководство по тестовому выпуску одностраничного приложения с включенным Azure AD B2C
