---
title: "Azure Active Directory B2C: получение токена с помощью приложения iOS | Документация Майкрософт"
...
* Наведите указатель мыши на строку кода типа ОС для инструмента создания пакета и щелкните знак \+.
* Переименуйте новую строку на "Типы URL-адреса".
* Щелкните стрелку слева от "Типы URL-адреса".
* Переименуйте значение в элементе 0 на "Схемы URL-адреса".
* Измените значение элемента 0 под "Схемы URL-адреса" и установите значение для вашей уникальной схемы приложения.  Оно должно соответствовать схеме в redirectURL при создании объекта OIDAuthorizationRequest.
* В этом примере мы использовали схему com.onmicrosoft.fabrikamb2c.exampleapp.
