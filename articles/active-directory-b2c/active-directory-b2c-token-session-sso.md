<properties
	pageTitle="Предварительная версия Azure Active Directory B2C: конфигурация маркера, сеанса и единого входа | Microsoft Azure"
...
# Предварительная версия Azure Active Directory B2C: конфигурация маркера, сеанса и единого входа

[AZURE.INCLUDE [active-directory-b2c-preview-note](../../includes/active-directory-b2c-preview-note.md)]

Эта возможность обеспечивает более точный, осуществляемый [для каждой политики](active-directory-b2c-reference-policies.md) контроль указанных далее параметров.
