...
## <a name="register-a-service-application-in-your-tenant"></a>Регистрация приложения службы в клиенте
Теперь, когда у вас есть клиент B2C, необходимо создать приложение-службу с помощью командлетов Azure AD PowerShell.
