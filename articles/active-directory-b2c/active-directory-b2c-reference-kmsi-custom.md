---
title: "Azure Active Directory B2C: функция \"Оставаться в системе\" | Документация Майкрософт"
description: "Статья, в которой показано, как настроить функцию \"Оставаться в системе\"."
