...
7. Если веб-приложение будет вызывать некоторые веб-API, защищенные с помощью Azure AD B2C, сделайте следующее:
   1. Создайте **секрет приложения**, перейдя в колонку **Ключи** и щелкнув **Создать ключ**.
   2. Щелкните **Доступ через API**, затем **Добавить** и выберите ваше веб-API и области (разрешения).
...
7. Щелкните приложение, которое вы только что создали, и скопируйте глобальный уникальный **идентификатор клиента приложения**. Позже он вам потребуется в коде.
8. Если собственное приложение будет вызывать веб-API, защищенные с помощью Azure AD B2C, сделайте следующее:
   1. Создайте **секрет приложения**, перейдя в колонку **Ключи** и щелкнув **Создать ключ**.
   2. Щелкните **Доступ через API**, затем **Добавить** и выберите ваше веб-API и области (разрешения).
...
## <a name="build-an-application"></a>Создание приложения
