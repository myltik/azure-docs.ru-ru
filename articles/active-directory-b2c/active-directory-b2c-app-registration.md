...
Если колонка функций B2C закреплена на начальной панели, то она отобразится сразу же после того, как вы войдете на [портал предварительной версии Azure](https://portal.azure.com/) в качестве глобального администратора клиента B2C.

Кроме того, можно получить прямой доступ к колонке функций B2C, перейдя по адресу [https://portal.azure.com/{клиент}.onmicrosoft.com/?Microsoft\_AAD\_B2CAdmin=true#blade/Microsoft\_AAD\_B2CAdmin/TenantManagementBlade/id/{клиент}.onmicrosoft.com](https://portal.azure.com/{tenant}.onmicrosoft.com/?Microsoft_AAD_B2CAdmin=true#blade/Microsoft_AAD_B2CAdmin/TenantManagementBlade/id/{tenant}.onmicrosoft.com) (слово **{клиент}** необходимо заменить именем, которое использовалось при создании клиента, например contosob2c) и выполнив вход как глобальный администратор клиента B2C. Можно создать закладку для этой ссылки для дальнейшего использования (см. примечание ниже).
...
Войдите на [портал Azure](https://manage.windowsazure.com/) в качестве администратора подписок (воспользуйтесь той рабочей или учебной учетной записью либо учетной записью Майкрософт, которую вы указали при регистрации в Azure). Перейдите к расширению Active Directory слева и щелкните свой клиент B2C. На вкладке **Быстрый запуск** (первая открывшаяся вкладка) щелкните **Управление настройками B2C** в разделе **Администрирование**. Откроется колонка функций B2C в новом окне или на вкладке браузера.
