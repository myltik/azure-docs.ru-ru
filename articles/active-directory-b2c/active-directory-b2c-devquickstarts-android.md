...
В следующем коде мы добавим маркер доступа в запрос.
...
Вот и все! Теперь у вас есть файл `ToDoActivity.java`, который можно скомпилировать. На этом этапе должен компилироваться и весь проект.
...
Готовый пример можно [скачать в виде ZIP-файла](https://github.com/AzureADQuickStarts/B2C-NativeClient-Android/archive/complete.zip) или клонировать с GitHub.
