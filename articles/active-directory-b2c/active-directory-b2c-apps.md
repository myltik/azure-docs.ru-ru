...
## Основы
Каждое приложение, использующее Azure AD B2C, потребуется зарегистрировать для использования вашего [каталога B2C](active-directory-b2c-get-started.md) на [портале Azure](https://portal.azure.com/). В процессе регистрации для приложения будет собрано и назначено несколько значений:
