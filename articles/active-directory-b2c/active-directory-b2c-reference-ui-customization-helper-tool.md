...
- Использовать кнопку **Выполнить** для политики на [портале Azure](https://portal.azure.com/).
...
2. Последовательно выберите пункты **+ Создать** -> **Данные + хранилище** -> **Учетная запись хранения**. Для создания учетной записи хранения больших двоичных объектов Azure требуется подписка Azure. Бесплатную пробную версию можно загрузить [здесь](https://azure.microsoft.com/pricing/free-trial/).
