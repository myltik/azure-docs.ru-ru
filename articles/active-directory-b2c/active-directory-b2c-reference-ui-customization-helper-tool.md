...
3. Укажите **имя** учетной записи (например, contoso) и выберите соответствующие значения для **ценовой категории**, **группы ресурсов** и **подписки**. Убедитесь, что флажок **Закрепить на начальной панели** установлен. Щелкните **Создать**.
