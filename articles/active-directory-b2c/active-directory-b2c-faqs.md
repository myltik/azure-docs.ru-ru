...
Ознакомьтесь с [этой статьей](../active-directory/active-directory-b2b-compare-external-identities.md), чтобы получить дополнительные сведения о применении соответствующих функций в ваших сценариях, в которых используются внешние удостоверения.
...
В настоящее время нет. Мы планируем добавить эту функцию в будущем. Обратите внимание также на то, что "проверка" домена на вкладке **Домены** клиента на классическом портале Azure не позволяет этого сделать.
