...
description: "Часто задаваемые вопросы (FAQ) о Azure Active Directory B2C"
...
Подпись электронной почты содержит имя клиента Azure AD B2C, указанный при создании клиента Azure AD B2C. Это имя можно изменить, выполнив приведенные ниже инструкции.

1. Войдите в [портал Azure](https://portal.azure.com/) роли глобального администратора.
...
1. Теперь войдите в [портал Azure](https://portal.azure.com/) администратора подписки. (Используйте ту же рабочую или учебную учетную запись либо учетную запись Майкрософт, которая использовалась для регистрации в Azure.)
1. Ключ клиента Azure AD B2C, вы хотите удалить.
...
5. Нажмите кнопку **регистрации приложения**.
6. Выберите приложение под названием **b2c расширения приложения**. Нажмите кнопку **удаление** и нажмите кнопку **Да** при появлении запроса.
7. Щелкните **Обзор**.
8. Нажмите кнопку **каталог удаления**. Для завершения процесса следуйте инструкциям на экране.
