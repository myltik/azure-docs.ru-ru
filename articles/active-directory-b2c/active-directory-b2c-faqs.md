...
Используйте [функцию фирменной символики](../active-directory/active-directory-add-company-branding.md), чтобы настроить содержимое проверочных писем. Поле "От:" можно изменить, обратившись в службу поддержки.
...
В настоящее время нет. Мы планируем добавить эту функцию в будущем. Также учтите, что вы не сможете проверить домен на вкладке **Домены** клиента на классическом портале Azure.
...
См. статью [Azure Active Directory B2C: File Support Requests](active-directory-b2c-support.md) (Azure Active Directory B2C: регистрация запросов в службу поддержки).

## Дополнительные сведения

См. также действующие [ограничения для текущей версии службы](active-directory-b2c-limitations.md).
