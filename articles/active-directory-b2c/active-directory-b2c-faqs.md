...
Используйте [функцию фирменной символики](../active-directory/active-directory-add-company-branding.md) для настройки содержимого проверочных писем. Поле "От:" можно изменить, обратившись в службу поддержки.
...
См. [Регистрация запросов на поддержку для Azure Active Directory B2C](active-directory-b2c-support.md).
