...
| p | обязательно | Содержит политику для выполнения. Это имя политики, созданной в вашем клиенте B2C. Оно должно начинаться с b2c\_1\_. Дополнительные сведения о политиках см. [здесь](active-directory-b2c-reference-policies.md). |
