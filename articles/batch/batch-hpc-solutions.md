<properties
   ...
   description="В этой статье описаны сценарии пакетных и высокопроизводительных вычислений (вычисления HPC и ";большие вычисления";) и варианты решений в Azure."
...
* [Хранилище озера данных](https://azure.microsoft.com/services/data-lake-store/) предоставляет гипермасштабируемую распределенную файловую систему Apache Hadoop для облака, особенно полезную для пакетной и интерактивной аналитики в реальном времени.
...
* [Машинное обучение](https://azure.microsoft.com/documentation/services/machine-learning/) помогает создавать, тестировать решения прогнозной аналитики, а также работать с ними и управлять ими в полностью управляемой службе.
...
* Технические указания по созданию решений см. в статье [Большие вычисления в Azure: технические ресурсы для пакетных и высокопроизводительных вычислений (HPC)](big-compute-resources.md).
