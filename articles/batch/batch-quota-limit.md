...
Если при использовании более ранней версии API пакетной службы для создания учетной записи пакетной службы, в которой для режима выделения пула задана **подписка пользователя**, квоты применяются по-другому. В этом режиме, который больше не рекомендуется, виртуальные машины пакетной службы и другие ресурсы создаются непосредственно в подписке пользователя при создании пула. Квота на ядра пакетной службы Azure не применяется к учетной записи, созданной в этом режиме. Вместо этого применяются региональные квоты на вычислительные ядра и другие ресурсы в подписке. Вы можете подробнее узнать об этих квотах в статье [Лимиты, квоты и ограничения подписки и обслуживания Azure](../azure-subscription-service-limits.md).
