...
* [Клиент Node.js](https://github.com/shwetams/azure-batchclient-sample-nodejs/blob/master/storehbaseclient.js)
* [Скрипты оболочки для задач подготовки](https://github.com/shwetams/azure-batchclient-sample-nodejs/blob/master/startup_prereq.sh)
* [Преобразователь Python CSV в JSON](https://github.com/shwetams/azure-batchclient-sample-nodejs/blob/master/processcsv.py)
