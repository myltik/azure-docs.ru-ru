---
title: "Документация по пакетной службе Azure. Руководства и справочник по API | Документация Майкрософт"
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>См. дополнительные сведения о пакетной службе</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Видеотека по пакетной службе Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Начало работы с пакетной службой</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Начало работы с пакетной службой с использованием .NET</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Начало работы с пакетной службой с использованием Node.js</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/cli/azure/batch">Интерфейс командной строки Azure</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/azure/batch/batch-diagnostics">Журналы диагностики пакетной службы</a></p>
                        <p><a href="/azure/batch/batch-analytics">Пакетная аналитика</a></p>
                        <p><a href="/azure/batch/batch-compute-node-environment-variables">Переменные среды вычислительного узла пакетной службы Azure</a></p>
                    </div>
                </div>
            </div>
        </div>
