...
### [Выбор размера виртуальной машины для вычислительных узлов](batch-pool-vm-sizes.md)
...
### [Использование виртуальных машин для ресурсоемких вычислений](batch-pool-compute-intensive-sizes.md)
### [Использование вычислительных узлов Linux](batch-linux-nodes.md)
### [Использование виртуальных машин с низким приоритетом](batch-low-pri-vms.md)
