---
title: Узлы Linux в пулах пакетной службы Azure | Microsoft Docs
...
> [!NOTE]
> [Application packages](batch-application-packages.md) сейчас не поддерживаются на вычислительных узлах Linux.
> 
> 
