...
> [!IMPORTANT]
> Сейчас низкоприоритетные виртуальные машины для рабочих нагрузок, выполняющихся в пакетной службе. 
>
>
...
-   Низкоприоритетные виртуальные машины имеют отдельную квоту на ядра, которая отличается от квоты выделенных виртуальных машин. 
