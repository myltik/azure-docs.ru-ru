...
---
# <a name="manage-azure-batch-accounts-and-quotas-with-batch-management-net"></a>Управление квотами и учетными записями пакетной службы Azure с помощью библиотеки .NET для управления пакетной службой
