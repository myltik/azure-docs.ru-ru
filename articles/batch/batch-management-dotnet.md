---
title: Управление учетными записями с помощью библиотеки .NET для управления пакетной службой | Microsoft Docs
...
> [!TIP]
> Если **API управления службами Microsoft Azure** не отображается в разделе *разрешения для других приложений*, нажмите кнопку **Добавление приложения**, выберите **API управления службами Microsoft Azure** и щелкните кнопку с флажком. Затем делегируйте разрешения, как описано выше.
> 
> 
