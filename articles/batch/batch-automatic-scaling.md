...
При автоматическом масштабировании пакетная служба Azure может динамически добавлять или удалять вычислительные узлы в пуле в зависимости от определенных вами параметров. Это позволяет автоматически настраивать объем вычислительных ресурсов, используемых приложением, потенциально экономя время и деньги.
...
- [Включение автоматического масштабирования в пуле][rest_enableautoscale] — для этого запроса REST API в URI передается идентификатор существующего пула, а в тексте запроса — формула автоматического масштабирования.
