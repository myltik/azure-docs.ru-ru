...
>[AZURE.TIP] Для хранения журналов и других выходных данных заданий и задач также можно использовать библиотеку [Azure Batch File Conventions](batch-task-output.md).
