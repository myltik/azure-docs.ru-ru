...
* Если в указанной виртуальной сети есть связанные группы безопасности сети, необходимо включить входящий трафик. Для пула Linux должны быть включены порты 29876, 29877 и 22. Для пула Windows необходимо включить порт 3389.
