...
### <a name="multiinstance-task"></a>Задачи с несколькими экземплярами
...
* **Пересоздать образ узла** ([REST][rest_reboot] | [.NET][net_reboot]).
