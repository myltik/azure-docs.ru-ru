...
## <a name="pool-network-configuration"></a>Конфигурация сети пула
...
### <a name="vnets-for-pools-provisioned-in-the-batch-service"></a>Виртуальные сети для пулов, подготовленных в пакетной службе
...
### <a name="vnets-for-pools-provisioned-in-a-user-subscription"></a>Виртуальные сети для пулов, подготовленных в пользовательской подписке
