...
В следующих разделах вы узнаете о каждом из ресурсов, перечисленных в схеме рабочего процесса, а также о многих других возможностях пакетной службы, которые вы сможете использовать в сценариях распределенных вычислений.
...
Для всех решений, использующих пакетную службу, требуются такие ресурсы, как учетные записи, вычислительные узлы, пулы, задания и задачи. Другие, например расписания заданий и пакеты приложений, являются полезными дополнительными функциями.
