...
Служба рендеринга пакетной службы Azure предлагает возможности рендеринга в масштабах облака с оплатой по мере использования. Служба рендеринга пакетной службы обрабатывает планирование заданий и их постановку в очередь, управление сбоями и повторными попытками, а также автоматическое масштабирование заданий рендеринга. Она поддерживает [Autodesk Maya](https://www.autodesk.com/products/maya/overview), [3ds Max](https://www.autodesk.com/products/3ds-max/overview), [Arnold](https://www.autodesk.com/products/arnold/overview) и [V-Ray](https://www.chaosgroup.com/vray/maya). Подключаемый модуль пакетной службы для Maya 2017 упрощает запуск задания рендеринга в Azure непосредственно с рабочего стола.
...
- Autodesk Maya;
- Autodesk 3ds Max;
- Autodesk Arnold для Maya;
- Autodesk Arnold для 3ds Max;
- Chaos Group V-Ray для Maya;
- Chaos Group V-Ray для 3ds Max.
...
- [подключаемый модуль пакетной службы для Maya](https://docs.microsoft.com/en-us/azure/batch/batch-rendering-service#use-the-batch-plug-in-for-maya-to-submit-a-render-job);
- классическое приложение [Batch Labs](https://github.com/Azure/BatchLabs);
...
- классическое приложение [Batch Labs](https://github.com/Azure/BatchLabs) (руководство по использованию шаблонов 3ds Max Batch Labs см. в репозитории с [данными Batch Labs](https://github.com/Azure/BatchLabs-data/tree/master/ncj/3dsmax));
- [интерфейс командной строки шаблонов пакетной службы](batch-cli-templates.md).
...
Кроме того, можно использовать [пакет SDK пакетной службы для Python](https://docs.microsoft.com/en-us/azure/batch/batch-python-tutorial), чтобы интегрировать службу рендеринга с имеющимся конвейером.
