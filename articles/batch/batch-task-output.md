---
title: Сохранение выходных данных заданий и задач в пакетной службе Azure | Microsoft Docs
...
> [!TIP]
> [Исходный код][github_file_conventions] библиотеки соглашений об именовании файлов для пакетной службы Azure доступен на сайте GitHub в репозитории пакетов SDK Microsoft Azure для .NET.
> 
> 
