...
Этот компонент появился в [REST API пакетной службы][api_rest] версии 2015-12-01.2.2 и соответствующей библиотеке [.NET для пакетной службы][api_net] версии 3.1.0. Мы рекомендуем всегда использовать при работе с пакетной службой последнюю версию API.
