...
После настройки новой версии на всех *новых* узлах, присоединенных к пулу, будет развернута версия 2.76b. Чтобы установить версию 2.76b на все узлы, *уже* имеющиеся в пуле, перезагрузите их (или пересоздайте для них образ). Обратите внимание: после перезагрузки на узлах будут оставаться файлы предыдущих развертываний пакета.
