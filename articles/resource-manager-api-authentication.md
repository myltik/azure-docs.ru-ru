...
| client\_id | Идентификатор клиента приложения
| resource | Идентификатор с кодировкой URL ресурса, для которого запрашивается маркер доступа. В данном случае используется следующий идентификатор API Graph Azure AD: **https://graph.windows.net/** | client\_secret или client\_assertion\_type и client\_assertion | Если приложение использует пароль, используйте client\_secret. Если приложение использует сертификат, используйте client\_assertion.
