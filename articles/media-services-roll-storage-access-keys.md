...
#Практическое руководство. Обновление служб мультимедиа после оборота ключей доступа к хранилищу
...
## Шаг 1. Создание дополнительно ключа доступа к хранилищу

Начните с повторного создания дополнительно ключа хранилища. По умолчанию дополнительный ключ не используется службами мультимедиа.  Сведения об обороте ключей хранилища см. в разделе [Практическое руководство. Просмотр, копирование и повторное создание ключей доступа к хранилищу](storage/storage-create-storage-account.md#view-copy-and-regenerate-storage-access-keys).
...
Создайте основной ключ доступа к хранилищу. Сведения об обороте ключей хранилища см. в разделе [Практическое руководство. Просмотр, копирование и повторное создание ключей доступа к хранилищу](storage/storage-create-storage-account.md#view-copy-and-regenerate-storage-access-keys).

##Шаг 6. Обновление служб мультимедиа для использования нового основного ключа хранилища
	
Используйте ту же процедуру, что описана на [шаге 2](media-services-roll-storage-access-keys.md#step2), только в этот раз синхронизируйте новый основной ключ доступа к хранилищу с учетной записью служб мультимедиа.
