<properties pageTitle="Управление доступом на основе ролей с интерфейса кросс-платформенной командной строки Azure" metaKeywords ="Диспетчер ресурсов, кросс-платформенный интерфейс командной строки Azure, командная строка Azure, командная строка azure, azure cli, RBAC" description="Managing role-based access control with cross-platform command-line interface" metaCanonical="" services="" documentationCenter="" title="Managing Role-Based Access Control with Cross-Platform Command-Line Interface" authors="guayan" solutions="" manager="terrylan" editor="mollybos" />
