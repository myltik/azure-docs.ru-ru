<properties urlDisplayName="Service Bus AMQP Overview" pageTitle="Обзор AMQP в служебной шине - Azure " metaKeywords="" description="Learn about using the Advanced Message Queuing Protocol (AMQP) 1.0 in Azure." metaCanonical="" services="service-bus" documentationCenter=".NET" title="" authors="sethm" solutions="" manager="timlt" editor="mattshel" />
