...
Для этих типов ресурсов необходимо знать, какую версию вы используете, так как поддерживаемые ими операции будут различаться. Если вы готовы выполнить перенос ресурсов из классической модели развертывания в развертывание с помощью Resource Manager, см. раздел [Поддерживаемый платформой перенос ресурсов IaaS из классической модели в модель Azure Resource Manager](./virtual-machines/virtual-machines-windows-migration-classic-resource-manager.md).

Чтобы понять, какая модель использовалась для развертывания ресурсов, рассмотрим обе модели.
...
Если вы готовы выполнить перенос ресурсов из классической модели развертывания в развертывание с помощью Resource Manager, см. раздел [Поддерживаемый платформой перенос ресурсов IaaS из классической модели в модель Azure Resource Manager](./virtual-machines/virtual-machines-windows-migration-classic-resource-manager.md).

Дополнительные сведения о процессе перехода вычислительных, сетевых ресурсов и ресурсов хранения см. в статье [Поставщики вычислительных, сетевых ресурсов и ресурсов хранения в диспетчере ресурсов Azure](./virtual-machines/virtual-machines-windows-compare-deployment-models.md).
