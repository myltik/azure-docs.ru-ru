...
- Они создаются с помощью одного из следующих методов:
  ...
  - Для версий Azure PowerShell, выпущенных до предварительной версии 1.0, команды выполняются в режиме **AzureResourceManager**.

            PS C:\> Switch-AzureMode -Name AzureResourceManager

  - Для предварительной версии Azure PowerShell 1.0 используйте версию команд для диспетчера ресурсов. Эти команды имеют вид *{команда}-AzureRm*, как показано ниже.
...
- Они создаются с помощью одного из следующих методов:
  ...
  - Для версий Azure PowerShell, выпущенных до предварительной версии 1.0, команды выполняются в режиме **AzureServiceManagement** (который является режимом по умолчанию, поэтому если вы специально не переключились на AzureResourceManager, то работаете в режиме AzureServiceManagement).

            PS C:\> Switch-AzureMode -Name AzureServiceManagement

  - Для предварительной версии Azure PowerShell 1.0 используйте версию команд для управления ресурсами. Эти команды **не** имеют вид *{команда}-AzureRm*, как показано ниже.
