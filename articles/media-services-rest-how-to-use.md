...
<tr><td>client-request-id</td><td>Строка</td><td>Определяемое вызывающим объектом значение, по которому можно идентифицировать данный запрос. Если это значение указано, оно будет включено в ответное сообщении в качестве способа сопоставления запроса. <br/><br/>
<b>Важно!</b><br/>
...
<table border="1">
<tr><th>Заголовок</th><th>Тип</th><th>Значение</th></tr>
<tr><td>request-id</td><td>Строка</td><td>Уникальный идентификатор текущей операции, создаваемый службой.</td></tr>
<tr><td>client-request-id</td><td>Строка</td><td>Идентификатор, указанный вызывающим объектом в исходном запросе, если он имеется.</td></tr>
