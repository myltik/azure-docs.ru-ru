<properties 
	pageTitle="Выполнение сценариев Python в Машинном обучении Azure | Azure" 
	description="Описываются принципы проектирования, лежащие в основе текущей поддержки Python в Машинном обучении Azure, а также основные сценарии использования, возможности и ограничения." 
...
![рисунок 1](./media/machine-learning-execute-python-scripts/figure1a.png)

![рисунок 2](./media/machine-learning-execute-python-scripts/figure1b.png)
...
В этом разделе мы рассмотрим некоторые из основных вариантов использования модуля [Выполнение сценария Python][execute-python-script]. Как упоминалось ранее, любые входные данные, вводимые в модуль Python, представляются в качестве кадров данных Pandas. Дополнительную информацию о библиотеке Pandas и о том, как ее можно использовать для эффективного управления данными, см. в книге В. Маккини (W. McKinney) *Python для анализа данных* (Севастополь, Калифорния: O'Reilly, 2012 г.). Эта функция должна возвратить один кадр данных Pandas, упакованный в [последовательности](https://docs.python.org/2/c-api/sequence.html) Python, такой как кортеж, список или массив NumPy. Затем первый элемент из этой последовательности возвращается в первый выходной порт модуля. Схема этого процесса показана на рис. 2.

![image3](./media/machine-learning-execute-python-scripts/figure2.png) Рис. 2. Сопоставление входных портов с параметрами и возвращаемого значения с входным портом
...
При публикации в качестве веб-службы вызывается любой модуль [Выполнение сценария Python][execute-python-script] в эксперименте по оценке. Например, на рис. 3 показан эксперимент по оценке, содержащий код для оценки одного выражения Python.

![image4](./media/machine-learning-execute-python-scripts/figure3a.png)

![рисунок 5](./media/machine-learning-execute-python-scripts/figure3b.png)
...
## Импорт существующих модулей Python
