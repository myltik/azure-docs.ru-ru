...
Выполните следующие действия, чтобы воспользоваться преимуществами повышенной пропускной способности для учетной записи DocumentDB S1. Практически без дополнительных затрат можно увеличить пропускную способность учетной записи S1 от 250 [единиц запросов в секунду](documentdb-request-units.md) до 400 единиц запросов в секунду и выше!
