---
title: Политики индексирования DocumentDB | Microsoft Docs
...
> [!NOTE]
> DocumentDB поддерживает автоматическое индексирование Points, Polygons (закрытая предварительная версия) и LineStrings (закрытая предварительная версия). Чтобы получить доступ к предварительной версии, свяжитесь с нами по электронному адресу askdocdb@microsoft.com, или через службу поддержки Azure.
> 
> 
