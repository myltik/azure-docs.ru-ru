...
**Как индексировать данные в Azure Cosmos DB для каждой модели данных**

|   |API DocumentDB&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;API таблиц&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;API Graph&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;      API MongoDB|
|---|-----------------|--------------|-------------|---------------|
|Параметры индексирования|Используйте значение по умолчанию и индексируйте все данные. <br><br> Или [создайте пользовательские политики индексации](#CustomizingIndexingPolicy).|
|Режимы индексирования|[Consistent, Lazy или None](#indexing-modes).|
...
![Как работает индексирование — преобразование индексов Azure Cosmos DB в сети](media/documentdb-indexing-policies/index-transformations.png)
