...
Хотя многие клиенты с удовольствием позволяют DocumentDB автоматически регулировать [все аспекты индексирования](documentdb-indexing.md), DocumentDB также поддерживает задание пользовательской **политики индексирования** для коллекций во время их создания. Политики индексирования DocumentDB обладают большей гибкостью и возможностями, чем дополнительные индексы, предлагаемые в других платформах базы данных индексации, так как они позволяют разработать и настроить форму индекса без ущерба гибкости схемы. Чтобы узнать, как индексация работает в DocumentDB, необходимо понять, почему управляя политикой индексирования, можно найти точный компромисс между дополнительными затратами на хранение индекса, пропускной способностью записи и запросов и согласованностью запросов.
