...
## <a id="quick-create-documentdb-account"></a>Задача: создание учетной записи DocumentDB с одним регионом
...
### <a id="create-single-documentdb-account-cli-arm"></a> Создание учетной записи DocumentDB с одним регионом с помощью Azure CLI 1.0 без шаблонов Resource Manager
...
### <a id="create-single-documentdb-account-cli-arm"></a> Создание учетной записи DocumentDB с одним регионом с помощью Azure CLI 1.0 с шаблонами Resource Manager
...
## <a id="quick-create-documentdb-with-mongodb-api-account"></a>Задача: создание базы данных DocumentDB с одним регионом. API для учетной записи MongoDB
...
## <a id="create-multi-documentdb-account"></a>Задача: создание учетной записи DocumentDB с несколькими регионами
...
### <a id="create-multi-documentdb-account-cli"></a> Создание учетной записи DocumentDB с несколькими регионами с помощью Azure CLI 1.0 без шаблонов Resource Manager
Создайте учетную запись DocumentDB в новой или существующей группе ресурсов, введя следующую команду в командной строке:
...
### <a id="create-multi-documentdb-account-cli-arm"></a> Создание учетной записи DocumentDB с несколькими регионами с помощью Azure CLI 1.0 с шаблонами Resource Manager
Инструкции в этом разделе позволяют создать учетную запись DocumentDB с помощью шаблона Azure Resource Manager и файла необязательных параметров, каждый из которых является JSON-файлом. Использование шаблона позволяет точно описать, что вы хотите, и повторить все без ошибок.
