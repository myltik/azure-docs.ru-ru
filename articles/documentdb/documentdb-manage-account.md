...
Узнайте, как настроить глобальную согласованность данных и управлять несколькими регионами, чтобы обеспечить глобальную доступность данных. Кроме того узнайте, как работать с ключами и как удалить учетную запись на портале Azure.
