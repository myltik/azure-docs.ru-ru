...
3.      В колонке **Согласованность по умолчанию** выберите уровень согласованности, который необходимо использовать по умолчанию для учетной записи DocumentDB.
...
1.      На [портале предварительной версии Azure](https://portal.azure.com/) перейдите в учетную запись DocumentDB, которую необходимо удалить. 
