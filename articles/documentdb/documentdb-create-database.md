---
title: Как создать базу данных в DocumentDB | Microsoft Docs
...
1. В колонке **DocumentDB (NoSQL)** выберите учетную запись, в которую следует добавить базу данных NoSQL DocumentDB. При отсутствии учетных записей необходимо [создать учетную запись DocumentDB](documentdb-create-account.md).
2. В колонке **Учетная запись DocumentDB** щелкните **Добавить базу данных**.
...
3. В колонке **Добавление базы данных** введите идентификатор новой базы данных. После проверки имени в поле **идентификатора** отображается зеленая галочка. Нажмите кнопку **ОК**.
...
4. Теперь новая база данных появится в разделе **Базы данных** колонки **Учетная запись DocumentDB**.
