...
**Секционирование по хэшу:** ![Диаграмма, на которой показано, как хэш-секционирование равномерно распределяет запросы по секциям](media/documentdb-sharding/partition-hash.png "Секционирование по хэшу")
...
**Согласованное хэширование с помощью HashPartitionResolver:** ![Диаграмма, на которой показано, как HashPartitionResolver создает хэш-кольцо](media/documentdb-sharding/HashPartitionResolver.JPG "Согласованное хэширование")
...
![Диаграмма, на которой показано, как секционирование по диапазону равномерно распределяет запросы по секциям](media/documentdb-sharding/partition-range.png "Секционирование по диапазону")
