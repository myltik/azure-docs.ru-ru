...
Azure DocumentDB поддерживает коллекции, которые можно масштабировать до [больших объемов хранилища и пропускной способности](documentdb-partition-data.md). Однако существуют варианты использования, когда полезно иметь более точный контроль над поведением секционирования. Для уменьшения объема кода, необходимого для задач секционирования, мы добавили в пакеты SDK для Java, .NET и Node.js функции, которые упрощают создание приложений, масштабируемых по нескольким коллекциям.
...
##Ссылки
* [Секционирование данных с помощью DocumentDB](documentdb-partition-data.md)
