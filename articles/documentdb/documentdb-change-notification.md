...
---
# <a name="notifications-for-new-or-changed-azure-cosmos-db-resources-using-logic-apps"></a>Уведомления о новых или измененных ресурсах Azure Cosmos DB с использованием приложений логики
...
Azure Cosmos DB является репозиторием для документов HL7 FHIR. Предположим, что база данных Azure Cosmos DB вместе с API и приложением логики образует сервер HL7 FHIR.  Медицинское учреждение хранит данные о пациентах в базе данных Azure Cosmos DB "Пациенты". В этой базе данных имеется несколько коллекций — "Клинические исследования", "Идентификация" и т. д. Сведения о пациентах входят в коллекцию "Идентификация".  Существует коллекция с именем "Пациент".
...
Код для этого действия был создан с помощью шаблона для приложения логики и SendGrid в [репозитории GitHub 101-logic-app-sendgrid](https://github.com/Azure/azure-quickstart-templates/tree/master/101-logic-app-sendgrid).
