...
#<a name="modeling-data-in-documentdb#"></a>Моделирование данных в DocumentDB#
Хотя базы данных без схем, такие как Azure DocumentDB, существенно упрощают внесение изменений в модель данных, вам все равно следует уделить время анализу ситуации с данными. 
...
> [AZURE.TIP] Документы в DocumentDB имеют максимальный размер. Дополнительные сведения об этом можно найти в статье [Ограничения DocumentDB](documentdb-limits.md).
...
##<a name="<a-id="refer"></a>referencing-data##"></a><a id="Refer"></a>Использование ссылок на данные##
...
###<a name="how-do-i-model-many:many-relationships?"></a>Как моделировать связи "многие ко многим"
...
##<a name="<a-id="wrapup"></a>hybrid-data-models##"></a><a id="WrapUp"></a>Гибридные модели данных##
...
Дополнительные сведения об Azure DocumentDB можно найти на странице [документации](https://azure.microsoft.com/documentation/services/documentdb/) по службе. 

Дополнительные сведения о настройке индексов в Azure DocumentDB можно найти в статье о [политиках индексации](documentdb-indexing-policies.md).
