---
title: "Моделирование данных в Azure Cosmos DB | Документация Майкрософт"
description: "Узнайте, как моделировать данные для Azure Cosmos DB, многомодельной глобально распределенной базы данных."
...
---
# <a name="modeling-data-in-azure-cosmos-db"></a>Моделирование данных в Azure Cosmos DB
...
Дополнительные сведения об Azure Cosmos DB см. на странице [документации](https://azure.microsoft.com/documentation/services/documentdb/) по этой службе. 

Дополнительные сведения о настройке индексов в Azure Cosmos DB см. в статье [Политики индексации DocumentDB](documentdb-indexing-policies.md).
