...
Согласно описанному выше подходу, мы выполнили **денормализацию** записи человека, куда была **внедрена** такая информация, как сведения о контактах и адреса, получив отдельный документ JSON. Кроме того, отсутствие привязки к фиксированной схеме повышает гибкость работы, например, мы можем использовать сведения о контактах в самых разных формах.
...
Если эта таблица JOIN всего лишь соединяет два элемента данных, почему бы просто не отказаться от нее? Давайте рассмотрим следующее.
