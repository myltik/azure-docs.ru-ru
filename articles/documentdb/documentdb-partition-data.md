...
После прочтения этой статьи о масштабировании данных вы сможете ответить на следующие вопросы:
 ...
 - Что такое хэш и секционирование по диапазонам?
...
В этой статье описаны некоторые понятия, связанные с сегментированием. Если вы готовы написать код для секционирования данных с помощью пакетов SDK для DocumentDB, загляните в раздел [Секционирование данных с помощью пакета SDK для DocumentDB](documentdb-sharding.md).
...
> [AZURE.TIP] Секционирование по хэшу следует использовать, когда присутствует слишком много сущностей для перечисления (например, пользователей или устройств), а частота запросов у всех этих сущностей довольно однородна.
...
Маршрутизация запросов создания документов является тривиальной задачей для хэш-секционирования и секционирования по диапазонам. Документ создается в разделе из хэша или значения диапазона, соответствующего ключу раздела.
...
## Добавление и удаление секций для масштабирования данных
