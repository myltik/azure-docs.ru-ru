...
Вы можете создать любое количество коллекций в соответствии с требованиями масштабируемости к хранилищу и пропускной способности, предъявляемыми вашими приложениями. Коллекции можно создать на [портале Azure](https://portal.azure.com/) или с помощью любого [пакета SDK для DocumentDB](https://msdn.microsoft.com/library/azure/dn781482.aspx).
