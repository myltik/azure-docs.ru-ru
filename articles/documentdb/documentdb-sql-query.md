<properties 
	pageTitle="SQL-запросы в базе данных DocumentDB — запросы SQL | Microsoft Azure" 
	description="Узнайте, как DocumentDB поддерживает SQL-запросов к иерархическим документам JSON для автоматического индексирования. Изучите среду базы данных SQL-запросов, которая действительно не зависит от схемы." 
...
## Дополнительные понятия запросов SQL
### Итерация
...
![Архитектура поддержки запросов LINQ при использовании DocumentDB][1]
