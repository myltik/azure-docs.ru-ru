...
1. Если это еще не сделано, включите репозиторий git для веб-сайта Azure. Указания о том, как это сделать, см. [здесь](../web-sites-publish-source-control-git.md#step4).
