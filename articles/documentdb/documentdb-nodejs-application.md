...
2. Откройте файл **layout.jade **, расположенный в папке **views**, и замените его содержимое следующим:
	...
	Этот код дает команду обработчику **Jade** отобразить HTML для нашего приложения, а также создает **блок** с именем **content**, в который можно поместить макет страниц с содержимым. Сохраните и закройте файл **layout.jade**.
