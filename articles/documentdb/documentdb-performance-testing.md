...
Если вам нужны параметры конфигурации на стороне клиента для повышения производительности DocumentDB, см. [рекомендации по оптимизации производительности DocumentDB](documentdb-performance-tips.md).

## Запуск приложения для тестирования производительности
...
* [Performance tips for DocumentDB](documentdb-performance-tips.md) (Рекомендации по оптимизации производительности DocumentDB)
