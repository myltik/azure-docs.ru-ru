...
> [AZURE.NOTE]Изменилось название пакета NuGet при переходе от предварительной версии к общедоступной. Имя изменилось с **Microsoft.Azure.Documents.Client** на **Microsoft.Azure.DocumentDB**. <br/>
...
Корпорация Майкрософт сообщит о выбытии пакета SDK из эксплуатации минимум за **12 месяцев**, чтобы обеспечить удобный переход на новую (поддерживаемую) версию.

Новые функции, возможности и оптимизации добавляются только в текущую версию пакета SDK, поэтому рекомендуется постоянно и как можно раньше обновлять пакет SDK до последней версии.

Любые запросы к DocumentDB с помощью выведенного из эксплуатации SDK будут отклоняться службой.

> [AZURE.WARNING]Все версии пакета SDK для Azure DocumentDB для .NET версии ниже **1.0.0** будут удалены **29 февраля 2016 г.**
 
<br/>
 
| Version (версия) | Дата выпуска | Дата вывода 
| ---	  | ---	         | ---
| [1\.5.1](#1.5.1) | 23 ноября 2015 г. |---| [1\.5.0](#1.5.0) | 5 октября 2015 г. |---| [1\.4.1](#1.4.1) | 25 августа 2015 г. |---| [1\.4.0](#1.4.0) | 13 августа 2015 г. |---| [1\.3.0](#1.3.0) | 5 августа 2015 г. |---| [1\.2.0](#1.2.0) | 6 июля 2015 г. |---| [1\.1.0](#1.1.0) | 30 апреля 2015 г. |---| [1\.0.0](#1.0.0) | 8 апреля 2015 г. |---| [0\.9.3 (предварительная версия)](#0.9.x-preview) | 12 марта 2015 г. | 29 февраля 2016 г. | [0\.9.2 (предварительная версия)](#0.9.x-preview) | январь 2015 г. | 29 февраля 2016 г. | [0\.9.1 (предварительная версия)](#0.9.x-preview) | 13 октября 2014 г. | 29 февраля 2016 г. | [0\.9.0 (предварительная версия)](#0.9.x-preview) | 21 августа 2014 г. | 29 февраля 2016 г.
