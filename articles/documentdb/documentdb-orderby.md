<properties 
	pageTitle="Сортировка данных DocumentDB с помощью Order By | Microsoft Azure" 
...
- Политики динамической индексации: поддержка изменения политики индексации после создания коллекции и на классическом портале Azure
