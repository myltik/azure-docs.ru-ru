...
1. На панели быстрых переходов портала Azure щелкните **Учетные записи DocumentDB**. Если элемент **Учетные записи DocumentDB** не отображается, нажмите кнопку **Обзор**, а затем щелкните **Учетные записи DocumentDB**.
...
2. В колонке **Документ** введите или вставьте содержимое документа JSON, который нужно создать. Затем нажмите кнопку **Сохранить**, чтобы зафиксировать документ в базе данных и коллекции, которые указаны в колонке **Проводник документов**.
...
2. Чтобы начать отправку, нажмите кнопку **Отправить документ**.
...
2. Нажмите кнопку "Обзор", чтобы открыть окно проводника, выберите один или несколько документов JSON для отправки и нажмите кнопку **Открыть**.
