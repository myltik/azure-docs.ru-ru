...
## <a name="a-idenableglobaldistributionaenabling-turn-key-global-distribution"></a><a id="EnableGlobalDistribution"></a>Включение готового к использованию глобального распространения
...
### <a name="a-idregionalpresenceaubiquitous-regional-presence"></a><a id="RegionalPresence"></a>Повсеместное географическое присутствие 
...
### <a name="a-idunlimitedregionsperaccountaassociating-an-unlimited-number-of-regions-with-your-documentdb-database-account"></a><a id="UnlimitedRegionsPerAccount"></a>Связывание неограниченного количества регионов с учетной записью базы данных DocumentDB
...
### <a name="a-idpolicybasedgeofencingapolicy-based-geo-fencing"></a><a id="PolicyBasedGeoFencing"></a>Определение геозон на основе политик
...
### <a name="a-iddynamicallyaddregionsadynamically-add-and-remove-regions"></a><a id="DynamicallyAddRegions"></a>Динамическое добавление и удаление регионов
...
### <a name="a-idfailoverprioritiesafailover-priorities"></a><a id="FailoverPriorities"></a>Приоритеты отработки отказа
...
### <a name="a-idofflineregionsadynamically-taking-a-region-offline"></a><a id="OfflineRegions"></a>Динамическое отключение региона от сети
...
### <a name="a-idconsistencylevelsamultiple-well-defined-consistency-models-for-globally-replicated-databases"></a><a id="ConsistencyLevels"></a>Несколько четко определенных моделей согласованности для глобально реплицируемых баз данных
...
### <a name="a-idtunableconsistencyatunable-consistency-for-globally-replicated-databases"></a><a id="TunableConsistency"></a>Настраиваемая согласованность для глобально реплицируемых баз данных
...
### <a name="a-iddynamicallyconfigurablereadwriteregionsadynamically-configurable-read-and-write-regions"></a><a id="DynamicallyConfigurableReadWriteRegions"></a>Динамически настраиваемые регионы чтения и записи
DocumentDB позволяет настраивать регионы, связанные с базой данных, как регионы для чтения, записи или чтения и записи. 

### <a name="a-idelasticallyscalethroughputaelastically-scaling-throughput-across-azure-regions"></a><a id="ElasticallyScaleThroughput"></a>Эластичное масштабирование пропускной способности в регионах Azure
...
### <a name="a-idgeolocalreadsandwritesageo-local-reads-and-writes"></a><a id="GeoLocalReadsAndWrites"></a>Локальные операции чтения и записи
...
### <a name="a-idmanualfailoveramanually-initiate-regional-failover"></a><a id="ManualFailover"></a>Запуск региональной отработки отказа вручную
...
### <a name="a-idautomaticfailoveraautomatic-failover"></a><a id="AutomaticFailover"></a>Автоматическая отработка отказа
...
### <a name="a-idgranularfailoveradesigned-for-different-failover-granularities"></a><a id="GranularFailover"></a>Выбор степени детализации отработки отказа
...
### <a name="a-idmultihomingapisamulti-homing-apis"></a><a id="MultiHomingAPIs"></a>Интерфейсы API множественной адресации
...
### <a name="a-idtransparentschemamigrationatransparent-and-consistent-database-schema-and-index-migration"></a><a id="TransparentSchemaMigration"></a>Прозрачный и согласованный перенос схемы и индекса базы данных 
...
### <a name="a-idcomprehensiveslasacomprehensive-slas-beyond-just-high-availability"></a><a id="ComprehensiveSLAs"></a>Исчерпывающие соглашения об уровне обслуживания (не только высокий уровень доступности)
...
## <a name="a-idlatencyguaranteesalatency-guarantees"></a><a id="LatencyGuarantees"></a>Гарантии относительно задержки
...
### <a name="a-idlatencyandconsistencyalatencys-relationship-with-consistency"></a><a id="LatencyAndConsistency"></a>Взаимосвязь задержки и согласованности 
...
### <a name="a-idlatencyandavailabilityalatencys-relationship-with-availability"></a><a id="LatencyAndAvailability"></a>Взаимосвязь задержки и доступности 
...
### <a name="a-idlatencyandthroughputalatencys-relationship-with-throughput"></a><a id="LatencyAndThroughput"></a>Взаимосвязь задержки и пропускной способности
...
## <a name="a-idconsistencyguaranteesaconsistency-guarantees"></a><a id="ConsistencyGuarantees"></a>Гарантии согласованности
...
### <a name="a-idconsistencyandavailabilityaconsistencys-relationship-with-availability"></a><a id="ConsistencyAndAvailability"></a>Взаимосвязь согласованности и доступности
...
### <a name="a-idconsistencyandavailabilityaconsistencys-relationship-with-latency"></a><a id="ConsistencyAndAvailability"></a>Взаимосвязь согласованности и задержки
...
### <a name="a-idconsistencyandthroughputaconsistencys-relationship-with-throughput"></a><a id="ConsistencyAndThroughput"></a>Взаимосвязь согласованности и пропускной способности
...
## <a name="a-idthroughputguaranteesathroughput-guarantees"></a><a id="ThroughputGuarantees"></a>Гарантии пропускной способности 
...
### <a name="a-idthroughputandconsistencyathroughputs-relationship-with-consistency"></a><a id="ThroughputAndConsistency"></a>Взаимосвязь пропускной способности и согласованности 
То же, что и [взаимосвязь согласованности и пропускной способности](#ConsistencyAndThroughput).

### <a name="a-idthroughputandavailabilityathroughputs-relationship-with-availability"></a><a id="ThroughputAndAvailability"></a>Взаимосвязь пропускной способности и доступности
...
## <a name="a-idavailabilityguaranteesaavailability-guarantees"></a><a id="AvailabilityGuarantees"></a>Гарантии доступности
...
### <a name="a-idavailabilityandconsistencyaavailabilitys-relationship-with-consistency-latency-and-throughput"></a><a id="AvailabilityAndConsistency"></a>Взаимосвязь доступности с согласованностью, задержкой и пропускной способностью
...
## <a name="a-idreferencesareferences"></a><a id="References"></a>Справочные материалы
