...
- При успешном выполнении хранимая процедура будет иметь состояние *Хранимая процедура успешно сохранена и выполнена*, а возвращенные результаты отобразятся на панели *Результаты*.
