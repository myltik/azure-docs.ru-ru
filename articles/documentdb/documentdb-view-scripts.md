...
В этой статье приведены общие сведения об обозревателе скриптов [Microsoft Azure DocumentDB](http://azure.microsoft.com/services/documentdb/), средстве портала Azure, которое позволяет просматривать артефакты программирования на стороне сервера DocumentDB, включая хранимые процедуры, триггеры и определяемые пользователем функции. Подробнее о программировании на стороне сервера DocumentDB см. [здесь](documentdb-programming.md).
