...
Azure DocumentDB — это полностью управляемая служба баз данных NoSQL, созданная для быстрой и прогнозируемой работы, высокой доступности, автоматического масштабирования, глобального распространения данных и простоты разработки. Благодаря гибкой модели данных, согласованности и небольшой продолжительности задержек, а также широким возможностям запросов она прекрасно подходит для веб-приложений, мобильных приложений, игр, приложений IoT и многих других программ, которым требуется эффективное масштабирование.
...
-	[Что такое DocumentDB и каково ее значение для современных приложений?](#what-is-azure-documentdb)
...
DocumentDB — это служба базы данных NoSQL без схемы, предназначенная для современных мобильных приложений, веб-приложений, игр и приложений IoT. Благодаря службе DocumentDB 99 % операций чтения обрабатываются менее 10 миллисекунд, а 99 % операций записи — менее 15 миллисекунд. Кроме того, она обеспечивает гибкость схемы и возможность легко масштабировать базу данных по требованию. Она не подразумевает и не требует указания каких-либо схем для документов JSON. По умолчанию она автоматически индексирует все документы в базе данных и не ожидает и не требует наличия какой-либо схемы или создания вторичных индексов. DocumentDB позволяет выполнять сложные нерегламентированные запросы, используя язык SQL, поддерживает хорошо определенные уровни согласованности и интеграцию языка JavaScript, обработку транзакций для нескольких документов, используя известную модель программирования хранимых процедур, триггеров и определяемых пользователем функций.

Будучи базой данных JSON, DocumentDB изначально поддерживает JSON-документы, позволяя упростить итерацию схемы приложения и обеспечивая поддержку приложений, которым требуются модель данных "ключ — значение", модель данных документа или табличных данных. DocumentDB использует повсеместно распространенные форматы JSON и JavaScript, устраняя несоответствие между объектами, которые определяются приложением, и схемой базы данных. Глубокая интеграция JavaScript также позволяет разработчикам эффективно выполнять логику приложения непосредственно в ядре СУБД при транзакции базы данных.
...
-	**Репликация между несколькими регионами**. DocumentDB прозрачно реплицирует данные во все регионы, связанные с учетной записью DocumentDB. Это позволяет разрабатывать приложения, которым требуется глобальный доступ к данным, при этом обеспечивая компромиссы между согласованностью, доступностью и производительностью с соответствующими гарантиями. DocumentDB обеспечивает прозрачную отработку отказа между регионами с помощью API-интерфейсов многосетевого подключения, а также возможность гибко масштабировать пропускную способность и размер хранилища по всему миру. Дополнительные сведения см. в статье [Глобальное распространение данных с помощью DocumentDB](documentdb-distribute-data-globally.md).
...
Вы можете использовать DocumentDB для хранения гибких наборов данных, которые требуют запросы на извлечение и обработку транзакций. Сценарии приложений могут включать пользовательские данные для интерактивных веб-приложений и мобильных приложений и игр, а также для хранения, получения и обработки данных JSON для устройств IoT. База данных может хранить любое количество документов JSON, так как DocumentDB хорошо подходит для приложений, которые масштабируются в Интернете.
...
## Дальнейшие действия
Если у вас уже есть учетная запись Azure, вы можете приступить к работе с DocumentDB на [портале Azure](https://portal.azure.com/#gallery/Microsoft.DocumentDB), [создав учетную запись базы данных DocumentDB](documentdb-create-account.md).
...
- Если у вас есть подписка на MSDN, вам доступны [кредиты Azure на 150 долларов в месяц](https://azure.microsoft.com/pricing/member-offers/msdn-benefits-details/), которые также можно потратить на любые службы Azure.
