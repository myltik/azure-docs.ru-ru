...
2. Укажите требуемое количество операций создания, чтения и удаления документа (в секунду).

	![Ввод требований к пропускной способности в калькуляторе единиц запросов][3]

3. Нажмите кнопку "Вычислить" и ознакомьтесь с результатами.

	![Результаты калькулятора единиц запросов][4]

>[AZURE.NOTE]Если размеры и количество индексированных свойств разных типов документов существенно отличаются, загрузите в средство образцы *типов* стандартных документов и проведите вычисления.
