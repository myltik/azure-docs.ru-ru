...
7. Выберите **режим секционирования** коллекции: **Одна секция** или **Секционированный**. Для одного раздела зарезервировано хранилище объемом 10 ГБ и предусмотрена пропускная способность от 400 до 10 000 единиц запроса в секунду. Секционированную коллекцию можно масштабировать, получив в результате объем хранилища до 250 ГБ (в нескольких разделах) и пропускную способность от 10 100 до 250 000 единиц запроса в секунду. Сведения о том, как запросить увеличение выделяемых по умолчанию ресурсов после создания коллекции, см. в разделе [Запрос увеличения ограничений учетной записи DocumentDB](documentdb-increase-limits.md).
...
9. При создании секционированной коллекции выберите для нее **ключ секции**. Для создания высокопроизводительной коллекции важно выбрать правильный ключ раздела. Дополнительные сведения о выборе ключа секции см. в статье [Секционирование и масштабирование в Azure DocumentDB](documentdb-partition-data.md).
