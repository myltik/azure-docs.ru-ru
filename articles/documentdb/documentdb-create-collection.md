...
5. Выберите **режим секционирования коллекции**: **Одна секция** или **Секционированный**.
    ...
    **Секционированную коллекцию** можно масштабировать, получив в результате неограниченный объем хранилища (в нескольких секциях) и пропускную способность от 10 100 ЕЗ/с. Дополнительные сведения о секционированных коллекциях см. в разделе [Односекционные и секционированные коллекции](documentdb-partition-data.md#single-partition-and-partitioned-collections).

    По умолчанию для новой коллекции с одной секцией устанавливается пропускная способность 1000 ЕЗ/с и хранилище емкостью 10 ГБ. Для секционированной коллекции устанавливается пропускная способность 10100 ЕЗ/с без верхнего ограничения на емкость или пропускную способность.
