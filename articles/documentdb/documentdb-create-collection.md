...
7. Выберите одну из указанных ниже **Политик индексации**.
	...
	- **Диапазон**. Эта политика лучше всего подходит при использовании запросов предложения ORDER BY, диапазонов и сравнения на равенство и для чисел и для строк. Эта политика использует больший объем хранилища для служебных данных при индексации, чем политики **По умолчанию** и **Хэш**.
