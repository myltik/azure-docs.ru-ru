...
1.  На [портале Azure](https://portal.azure.com/) на навигационной панели щелкните **Учетные записи DocumentDB**, а затем в колонке **Учетные записи DocumentDB** выберите учетную запись, в которую необходимо добавить коллекцию.
    ...
    Если **учетные записи DocumentDB** не отображаются на навигационной панели, нажмите кнопку **Другие службы**, а затем **Учетные записи DocumentDB**. При отсутствии учетных записей необходимо [создать учетную запись DocumentDB](documentdb-create-account.md).
