...
1.  На [портале Azure](https://portal.azure.com/) на навигационной панели щелкните **DocumentDB (NoSQL)**, а затем в колонке **DocumentDB (NoSQL)** выберите учетную запись, в которую необходимо добавить коллекцию.
    ...
    Если **учетные записи DocumentDB** не отображаются на навигационной панели, то нажмите кнопку **Другие службы**, а затем выберите **DocumentDB (NoSQL)**. При отсутствии учетных записей необходимо [создать учетную запись DocumentDB](documentdb-create-account.md).
