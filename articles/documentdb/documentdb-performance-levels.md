...
|----------------|-------|----------|-------|-------|----|
|Производительность по определенным пользователем показателям|Пользователь задает пропускную способность в 100 ЕЗ/с|Без ограничений|Без ограничений|V2|API 2015-12-16 и более поздней версии|
