...
5. В колонке **Учетная запись DocumentDB** прокрутите вниз до пункта **Базы данных** и выберите базу данных, содержащую нужную коллекцию. 
6. В недавно открытой колонке **Базы данных** прокрутите вниз до пункта **Коллекции** и выберите нужную коллекцию.
7. И, наконец, в вашей колонке **Коллекции** найдите и щелкните плитку **Ценовая категория** в пункте **Использование**.
