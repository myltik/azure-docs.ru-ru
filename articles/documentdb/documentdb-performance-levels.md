...
3. В группе связанных элементов **Базы данных** выберите базу данных, которую нужно изменить, а затем в колонке **База данных** выберите коллекцию, которую нужно изменить. Учетные записи со стандартной пропускной способностью имеют ценовую категорию S1, S2 или S3.
...
5. В колонке **Параметры** щелкните **Ценовая категория**, чтобы отобразить оценку ежемесячных затрат для каждого плана в колонке **Выбор ценовой категории**. Чтобы изменить пользовательскую пропускную способность, щелкните **Стандартная** и нажмите кнопку **Выбрать** чтобы сохранить изменения.
...
6. В колонке **Параметры** значение **Ценовая категория** изменилось на **Стандартная** и появилось поле **Пропускная способность (единицы запросов в секунду)** со значением 400 (единиц запросов в секунду) по умолчанию. Вы можете задать пропускную способность от 400 до 10 000 [единиц запроса](documentdb-request-units.md) в секунду. **Сводка по ценам** в нижней части страницы автоматически обновляется, показывая оценку ежемесячных расходов. Нажмите кнопку **ОК**, чтобы сохранить изменения.
