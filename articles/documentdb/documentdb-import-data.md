...
Указав имена коллекций, выберите нужную ценовую категорию коллекций (S1, S2 или S3). Для наилучшей производительности выберите S3. Дополнительные сведения об уровнях производительности см. в разделе [Уровни производительности в DocumentDB](documentdb-performance-levels.md).
...
> [AZURE.NOTE] Если не указать политику индексации, будет применена политика по умолчанию. Дополнительные сведения о политиках индексации см. в статье [Политики индексации DocumentDB](documentdb-indexing-policies.md).
