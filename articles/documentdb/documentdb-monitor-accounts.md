...
Метрики можно просмотреть в колонке учетной записи или в новой колонке метрик.

## <a name="view-performance-metrics-on-the-metrics-blade"></a>Просмотр метрик производительности в колонке "Метрики"
1. В новом окне откройте [портал Azure](https://portal.azure.com/) и щелкните **Больше служб** > **DocumentDB (NoSQL)**, а затем щелкните имя учетной записи DocumentDB, для которой требуется просмотреть метрики производительности.
