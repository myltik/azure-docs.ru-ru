<properties 
	...
	description="Это руководство по ASP.NET MVC поможет вам создать веб-приложение MVC с помощью DocumentDB. Вы сможете сохранить JSON и получить доступ к данным из приложения «Список дел», размещенного на веб-сайтах Azure." 
