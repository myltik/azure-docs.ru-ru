...
#<a name="_Toc395809351"></a>Разработка веб-приложения ASP.NET MVC с использованием DocumentDB
...
## <a name="_Toc395637760"></a>Предварительные требования для прохождения этого учебника по базам данных
...
### <a name="_Toc395637770"></a>Список незавершенных элементов в веб-приложении
...
2. Все уже должно быть настроено в соответствии с вашими учетными данными. На самом деле сайт уже создан в Azure и находится по **Конечному URL-адресу**, вам просто нужно нажать кнопку **Опубликовать**.
    ...
    ![Снимок экрана: диалоговое окно "Публикация веб-сайта" в Visual Studio](./media/documentdb-dotnet-application/image29.png)
