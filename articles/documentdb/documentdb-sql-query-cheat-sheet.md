...
**Памятка по SQL-запросам DocumentDB** помогает быстро создавать запросы для данных DocumentDB, так как в удобном для печати справочном листе в формате PDF отображаются общие запросы, ключевые слова, встроенные функции и операторы.
