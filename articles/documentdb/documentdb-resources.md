...
_ts| Генерируемое системой | Метка времени последнего обновления ресурса. 
_self| Генерируемое системой| Уникальный адресуемый URI ресурса. 
id| Устанавливаемое пользователем| Определяемое пользователем уникальное имя ресурса. Если пользователь не укажет идентификатор, идентификатор будет создан системой.
