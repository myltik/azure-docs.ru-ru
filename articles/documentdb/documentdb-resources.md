...
[Создавать учетные записи базы данных DocumentDB и управлять ими](documentdb-create-account.md) можно с помощью классического портала Azure на сайте [http://portal.azure.com/](http://portal.azure.com/). Создание и управление учетной записью базы данных требует наличия административного доступа и может быть выполнено только для вашей подписки Azure.
