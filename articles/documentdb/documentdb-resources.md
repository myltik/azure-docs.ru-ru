...
Вы можете вставлять, заменять, удалять, читать, перечислять и запрашивать произвольные документы JSON в коллекции. DocumentDB не требует указывать схему и не требует создавать вторичные индексы для поддержки запросов к документам в коллекции. Максимальный размер документа составляет 2 МБ.   
