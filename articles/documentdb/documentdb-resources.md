...
![Иерархическая модель ресурсов DocumentDB][1]  
**Иерархическая модель ресурсов.**
...
|-------------------|----------- |
/dbs |Канал баз данных в учетной записи
|/dbs/{_rid-db} |База данных, идентификатор которой имеет значение {_rid-db} 
|/dbs/{_rid-db}/colls/ |Поток коллекций в базе данных 
|/dbs/{_rid-db}/colls/{_rid-coll} |Коллекция, идентификатор которой имеет значение {_rid-coll} 
|/dbs/{_rid-db}/colls/{_rid-coll}/docs |Канал документов в коллекции
|/dbs/{_rid-db}/colls/{_rid-coll}/docs/{_rid-doc} |Документ, идентификатор которого имеет значение {_rid-doc} 
|/dbs/{_rid-db}/users/ |Канал пользователей в базе данных 
|/dbs/{_rid-db}/users/{_rid-user} |Пользователь, идентификатор которого имеет значение {_rid-user} 
|/dbs/{_rid-db}/users/{_rid-user}/permissions |Канал разрешений для пользователя 
|/dbs/{_rid-db}/users/{_rid-user}/permissions/{_rid-permission} |Разрешение, идентификатор которого имеет значение {_rid-permission}
