<properties 
	pageTitle="Модель ресурсов и концепции DocumentDB | Microsoft Azure" 
...
Как показано на следующей схеме, **модель ресурсов** DocumentDB состоит из набора ресурсов в учетной записи, каждый из которых адресуется логическим постоянным URI. Набор ресурсов в этой статье называется **каналом**.
...
![][1] **Иерархическая модель ресурсов в учетной записи базы данных**
...
![][2] **База данных представляет собой логический контейнер пользователей и коллекций**
...
![][3] **Стратегии сегментирования и моделирования пользователей**
