...
Как показано на следующей схеме, **иерархическая модель ресурсов** DocumentDB состоит из набора ресурсов в учетной записи, каждый из которых адресуется логическим постоянным URI. Набор ресурсов в этой статье называется **каналом**.
