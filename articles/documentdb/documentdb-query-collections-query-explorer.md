...
В этой статье приведены общие сведения об обозревателе запросов [Microsoft Azure DocumentDB](https://azure.microsoft.com/services/documentdb/), который представляет собой средство портала Microsoft Azure и предназначен для создания, изменения и выполнения запросов к коллекции DocumentDB.
