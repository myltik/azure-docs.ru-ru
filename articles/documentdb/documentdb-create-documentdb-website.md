---
title: Развертывание DocumentDB и веб-приложений службы приложений Azure с помощью шаблона диспетчера ресурсов Azure | Microsoft Docs
...
## <a name="<a-id="createdb"></a>step-1:-download-the-template-files"></a><a id="CreateDB"></a>Шаг 1. Загрузка файлов шаблонов
