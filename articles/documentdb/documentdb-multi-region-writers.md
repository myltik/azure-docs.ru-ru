...
---
# <a name="multi-master-globally-replicated-database-architectures-with-documentdb"></a>Архитектуры с несколькими глобально реплицированными базами данных master с использованием DocumentDB
...
## <a id="Architecture"></a>Конфигурация учетной записи DocumentDB
