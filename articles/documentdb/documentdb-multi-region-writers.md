...
Если вы хотите узнать больше о секционировании и ключах секций, ознакомьтесь со статьей [Секционирование и масштабирование в базе данных Azure Cosmos DB](documentdb-partition-data.md).
...
![Архитектура с несколькими базами данных master на основе Azure Cosmos DB](./media/documentdb-multi-region-writers/documentdb-multi-master.png)
...
* Дополнительные сведения о поддержке глобального распределения в Azure Cosmos DB см. в [этой статье](documentdb-distribute-data-globally.md).
* Узнайте об [автоматической и ручной отработках отказа в Azure Cosmos DB](documentdb-regional-failovers.md).
* Дополнительные сведения о глобальной согласованности в Azure Cosmos DB см. в [этой статье](documentdb-consistency-levels.md).
* Сведения о разработке с использованием нескольких регионов с помощью API DocumentDB см. в статье [Как настроить глобальное распределение Azure Cosmos DB с помощью API DocumentDB](../cosmos-db/tutorial-global-distribution-documentdb.md).
* Сведения о разработке с использованием нескольких регионов с помощью API MongoDB см. в статье [Как настроить глобальное распределение Azure Cosmos DB с помощью API MongoDB](../cosmos-db/tutorial-global-distribution-MongoDB.md).
* Сведения о разработке с использованием нескольких регионов с помощью API таблицы см. в статье [Как настроить глобальное распределение Azure Cosmos DB с помощью API таблицы](../cosmos-db/tutorial-global-distribution-table.md).
