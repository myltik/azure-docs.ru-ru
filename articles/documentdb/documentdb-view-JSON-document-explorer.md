...
2. В верхней части колонки **Учетные записи DocumentDB** щелкните **Проводник документов**.
    ...
    В колонке **Проводник документов** раскрывающиеся списки **Базы данных** и **Коллекции** заполняются заранее в зависимости от контекста, в котором запускается обозреватель запросов.
