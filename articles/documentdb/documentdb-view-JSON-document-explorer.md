...
В этой статье приведены общие сведения об обозревателе документов [Microsoft Azure DocumentDB](https://azure.microsoft.com/services/documentdb/), средстве портала Azure для просмотра, изменения, создания и отправки документов JSON с помощью DocumentDB.
