...
Чтобы начать работу с DocumentDB, можно создать [учетную запись](http://azure.microsoft.com/pricing/free-trial/) и следовать [схеме обучения](https://azure.microsoft.com/documentation/learning-paths/documentdb/), чтобы узнать о DocumentDB и находить нужную информацию.
