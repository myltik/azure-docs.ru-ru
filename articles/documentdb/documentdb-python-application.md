...
- Добавьте следующий код в файл **views.py**. Он служит для настройки формы, чтения базы данных, коллекции и документа. Не удаляйте код из файла **views.py**. Просто переместите его в конец.
