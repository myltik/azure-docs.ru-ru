...
В настоящее время DocumentDB не соответствует положениям HIPAA, однако в будущем Azure планирует это изменить. Дополнительные сведения о корпорации Майкрософт и HIPAA см. в статье [HIPAA и HITECH](https://www.microsoft.com/ru-RU/TrustCenter/Compliance/HIPAA).
...
Пользователей и разрешения можно создавать с помощью одного из [пакетов SDK DocumentDB](https://msdn.microsoft.com/library/azure/dn781482.aspx) или [интерфейсов API REST](https://msdn.microsoft.com/library/azure/dn781481.aspx).
