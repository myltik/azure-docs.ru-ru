...
Вы можете создавать базы данных на [портале Azure]() в соответствии с инструкциями в статье [Создание базы данных для DocumentDB на портале Azure](documentdb-create-database.md), используя один из [пакетов SDK для DocumentDB](documentdb-sdk-dotnet.md) или [интерфейсы REST API](https://msdn.microsoft.com/library/azure/dn781481.aspx).  
