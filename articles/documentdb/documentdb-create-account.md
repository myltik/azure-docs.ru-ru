...
Для применения Microsoft Azure DocumentDB необходимо создать учетную запись базы данных DocumentDB с помощью портала Azure.
...
- Портал, как описано в разделе [Создание базы данных DocumentDB с помощью портала Azure](documentdb-create-database.md).
