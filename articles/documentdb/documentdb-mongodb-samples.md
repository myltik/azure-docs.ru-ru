...
description: "Руководство, в котором создается оперативная база данных с помощью API DocumentDB для MongoDB."
...
* [Создание](documentdb-create-mongodb-account.md) приложения API для MongoDB в Azure Cosmos DB.
