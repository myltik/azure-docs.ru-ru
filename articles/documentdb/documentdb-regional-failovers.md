---
title: "Региональная отработка отказа в Azure Cosmos DB | Документация Майкрософт"
description: "Сведения о принципах работы ручной и автоматической отработки отказа в Azure Cosmos DB."
services: cosmosdb
documentationcenter: 
author: arramac
manager: jhubbard
...
![Глобально распределенное развертывание приложений с помощью Azure Cosmos DB](./media/documentdb-regional-failovers/app-deployment.png)
...
![Сбои региона чтения в Azure Cosmos DB](./media/documentdb-regional-failovers/read-region-failures.png)
...
![Приоритеты при отработке отказа для Azure Cosmos DB](./media/documentdb-regional-failovers/failover-priorities.png)
...
![Сбои региона записи в Azure Cosmos DB](./media/documentdb-regional-failovers/write-region-failures.png)
...
![Ручная отработка отказа в Azure Cosmos DB](./media/documentdb-regional-failovers/manual-failovers.png)
...
* Дополнительные сведения о поддержке глобального распространения в Cosmos DB см. [здесь](documentdb-distribute-data-globally.md).
* Дополнительные сведения о глобальной согласованности в Cosmos DB см. в [этой статье](documentdb-consistency-levels.md).
