...
* Как работает автоматическая отработка отказа в DocumentDB и что происходит, когда в центре обработки данных возникает неполадка?
...
В редких случаях регионального сбоя или сбоя в центре обработки данных Azure DocumentDB автоматически инициирует отработку отказа для всех учетных записей DocumentDB, находящихся в пострадавшем регионе. 
