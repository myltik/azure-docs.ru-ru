...
[Веб-задания][Веб-задания] — это функция веб-сайтов Azure, которая позволяет запускать программу или скрипт в том же контексте, что и веб-сайт. Цель пакета SDK веб-заданий — упростить задачу написания кода, который используется в качестве веб-задания, работает с очередями, большими двоичными объектами и таблицами хранилища Azure, а также очередями служебной шины.
