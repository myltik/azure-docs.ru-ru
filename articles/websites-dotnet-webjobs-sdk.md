...
* Вы можете просматривать журналы в панели мониторинга, связанные с конкретным веб-заданием (журналы приложения, записанные с помощью Console.Out, Console.Error, Trace, etc.) или с вызовом определенной функции, которая создает их (журналы, записанные с помощью объекта `TextWriter`, который пакет SDK передает функции в качестве параметра). 

* Дополнительные сведения см. в разделах [Вызов функции вручную](websites-dotnet-webjobs-sdk-storage-queues-how-to.md#manual) и [Запись журналов](websites-dotnet-webjobs-sdk-storage-queues-how-to.md#logs) 
