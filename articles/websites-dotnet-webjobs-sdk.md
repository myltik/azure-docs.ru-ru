...
[Задания WebJob](/ru-ru/documentation/articles/web-sites-create-web-jobs/) - это функция веб-сайтов Azure, которая позволяет запускать программу или сценарий в том же контексте, что и веб-сайт. Цель пакета SDK для заданий WebJob - упростить задачу написания кода, который используется в качестве задания WebJob, работает с очередями, большими двоичными объектами и таблицами службы хранилища Azure, а также очередями Service Bus.
