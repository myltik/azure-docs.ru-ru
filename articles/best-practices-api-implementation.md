...
- На странице [Уведомление пользователей посредством центров уведомлений](notification-hubs-aspnet-backend-windows-dotnet-notify-users.md) на веб-сайте Майкрософт демонстрируется порядок использования центра уведомления Azure для отправки асинхронных ответов клиентским приложениям.
