...
### <a name="documenting-the-rest-operations-for-a-web-api"></a>Документирование операции REST для веб-API
...
* На странице [Методы маршрутизации трафика диспетчером трафика](traffic-manager/traffic-manager-routing-methods.md) веб-сайта Майкрософт представлены сводные сведения о том, как с помощью диспетчера трафика Azure можно балансировать нагрузку запросов в нескольких экземплярах веб-сайта, на котором размещен веб-API.
