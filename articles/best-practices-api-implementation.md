...
- На странице [Управление API](http://azure.microsoft.com/services/api-management/) на веб-сайте Майкрософт описывается порядок публикации продукта, который предоставляет управляемый и безопасный доступ к веб-API.
...
- На странице [О методах балансировки нагрузки диспетчера трафика](https://msdn.microsoft.com/library/azure/dn339010.aspx) на веб-сайте Майкрософт представлены сводные сведения о том, как диспетчер трафика Azure можно использовать для балансировки нагрузки запросов в нескольких экземплярах веб-сайта, на котором размещен веб-API.
