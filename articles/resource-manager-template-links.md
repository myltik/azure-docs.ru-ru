---
title: Шаблон диспетчера ресурсов для связывания ресурсов | Microsoft Docs
...
| Имя | Значение |
| --- | --- |
| targetId |Строка.<br />Обязательное значение.<br />**{идентификатор ресурса}**<br /><br />Идентификатор целевого ресурса для связывания. |
