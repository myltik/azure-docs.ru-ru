<properties linkid="develop-ruby-how-to-twilio-sms-voice-service" urlDisplayName="Служба Twilio Voice/SMS" pageTitle="Использование Twilio для поддержки голосовых вызовов и SMS (Ruby) - Azure" metaKeywords="Azure Ruby Twilio, телефонные звонки Azure, телефонные звонки Azure, Azure twilio, Azure SMS, Azure SMS, голосовые вызовы Azure, текстовые сообщения Azure, текстовые сообщения Azure" description="Как осуществлять телефонные вызовы и отправлять SMS-сообщения с использованием службы Azure Twilio API. Примеры кода, написанного на Ruby." metaCanonical="" services="" documentationCenter="Ruby" title="Использования Twilio для поддержки голосовых возможностей и SMS в PHP" authors="" solutions="" manager="" editor="" />
...
Если открыть страницу `http://yourdomain.cloudapp.net/make_call` в браузере, вы активируете вызов Twilio API для осуществления звонка. Первые два параметра в `client.account.calls.create` говорят сами за себя: номер, `с которого осуществляется вызов` и номер, `на который осуществляется вызов`. 
