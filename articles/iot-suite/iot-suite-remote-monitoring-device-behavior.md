...
В статье [Общие сведения о схеме модели устройства](iot-suite-remote-monitoring-device-schema.md) описана схема, определяющая модель имитированного устройства. В ней описаны два типа файлов JavaScript, реализующих поведение имитированного устройства:
...
Раздел [Simulation](iot-suite-remote-monitoring-device-schema.md#simulation) схемы модели устройства определяет внутреннее состояние имитированного устройства:
...
Раздел [CloudToDeviceMethods](iot-suite-remote-monitoring-device-schema.md#cloudtodevicemethods) схемы модели устройства определяет методы, на которые отвечает имитированное устройство.
...
Есть две глобальные функции, которые можно использовать для реализации поведения метода:
...
В статье о [создании имитированного устройства](iot-suite-remote-monitoring-test.md) описано, как локально запустить службу моделирования устройств. Локальный запуск службы упрощает отладку имитированного устройства перед его развертыванием в облако.
...
Вы узнали, как определить поведение имитированного устройства. Далее мы рекомендуем ознакомиться с [созданием имитированного устройства](iot-suite-remote-monitoring-test.md).
