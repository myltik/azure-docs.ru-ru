...
Компонент машинного обучения использует модель на основе данных, собранных с настоящих двигателей самолета. Вы можете перейти к рабочей области машинного обучения, используя плитку на странице [azureiotsuite.com][lnk-azureiotsuite] подготовленного решения, находящегося в состоянии **Готово**.
