...
Синие блоки представляют службы Azure, подготовленные в регионе, выбранном во время подготовки предварительно настроенного решения. Список регионов, в которых можно развернуть предварительно настроенное решение, отображается на [странице подготовки][lnk-azureiotsuite].
...
Компонент машинного обучения использует модель на основе данных, собранных с настоящих двигателей самолета. Вы можете перейти к рабочей области машинного обучения, используя элемент на странице [azureiotsuite.com][lnk-azureiotsuite] подготовленного решения, находящегося в состоянии **Готово**.
