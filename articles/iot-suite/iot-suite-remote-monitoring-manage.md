...
Для расширенного управления и настройки устройств в решении удаленного мониторинга используются компоненты Центра Интернета вещей, такие как [задания](../iot-hub/iot-hub-devguide-jobs.md) и [прямые методы](../iot-hub/iot-hub-devguide-direct-methods.md). Чтобы узнать, как разработчик устройств реализует методы на физическом устройстве, см. статью о [настройке акселератора решения для удаленного мониторинга](iot-suite-remote-monitoring-customize.md).
...
Сведения о подготовке *физического* устройства см. в статье о [подключении устройства к акселератору решения для удаленного мониторинга](iot-suite-connecting-devices-node.md).
...
* [Подключение устройства к акселератору решения для удаленного мониторинга](iot-suite-connecting-devices-node.md).
