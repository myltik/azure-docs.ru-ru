...
В этом руководстве показано, как использовать микрослужбу моделирования устройств с предварительно настроенным решением удаленного мониторинга. Чтобы продемонстрировать возможности симулятора устройств, здесь рассматривается два сценария с приложением Интернета вещей компании Contoso.
