---
title: 'Пример решения IoT Azure MyDriving: сборка | Microsoft Docs'
...
* *Проект VINLookupApplication не загружается*. Убедитесь, что [пакет SDK Azure для Visual Studio 2015](https://go.microsoft.com/fwlink/?linkid=518003&clcid=0x409) установлен.
...
| [Центр Azure IoT](https://azure.microsoft.com/pricing/details/iot-hub/) <br/>Двунаправленное подключение данных к устройствам. |8000 сообщений плюс 0,5 КБ данных на сообщение — бесплатно. |0 долл. США |
