...
В решении "Подключенная фабрика" агрегируются и отображаются данные с серверов OPC UA, подключенных к решению. В решении можно просматривать и отправлять команды на серверы OPC UA. Дополнительные сведения об OPC UA см. в статье с [часто задаваемыми вопросами о решении "Подключенная фабрика"](iot-suite-faq-cf.md).
...
Дополнительные сведения о сопоставлении и агрегировании данных в соответствии с конкретными требованиями см. в статье о [настройке акселератора решения "Подключенная фабрика"](iot-suite-connected-factory-configure.md).
