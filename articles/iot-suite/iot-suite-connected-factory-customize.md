...
description: "Сведения о том, как настроить поведение предварительно настроенного решения \"Подключенная фабрика\"."
services: 
suite: iot-suite
documentationcenter: 
author: dominicbetts
...
Дополнительные сведения о сопоставлении и агрегировании данных в соответствии с конкретными требованиями см. в разделе [Configure the Connected factory preconfigured solution](iot-suite-connected-factory-configure.md) (Настройка предварительно настроенного решения "Подключенная фабрика").
