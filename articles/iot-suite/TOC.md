...
## [Общие сведения о предварительно настроенных решениях](iot-suite-what-are-preconfigured-solutions.md)
...
### Основные понятия
#### [Архитектура решений удаленного мониторинга](iot-suite-remote-monitoring-sample-walkthrough.md)
