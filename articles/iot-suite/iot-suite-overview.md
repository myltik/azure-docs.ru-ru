...
Пакет IoT Suite содержит предварительно настроенные решения, которые позволяют быстро приступить к работе и изучить наиболее распространенные сценарии, связанные с Интернетом вещей, например *Удаленный мониторинг* и *Диагностическое обслуживание*. Вы можете развернуть эти решения в своей подписке Azure, а затем запустить готовый к использованию комплексный сценарий IoT.
