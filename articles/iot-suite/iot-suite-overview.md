...
Пакет IoT Suite содержит предварительно настроенные решения, которые позволяют быстро приступить к работе и изучить наиболее распространенные сценарии IoT. Вы можете развернуть решения в своей подписке Azure, а затем запустить готовое к использованию комплексное решение IoT.

## Дальнейшие действия

Теперь, когда вы ознакомились с возможностями IoT Suite и его основными компонентами, вы можете:

- Узнать больше о предварительно настроенных решениях пакета IoT Suite в статье [Что такое предварительно настроенные решения IoT Azure?][lnk-what-are-preconfig].

- Приступить к работе с помощью одного из предварительно настроенных решений в статье [Начало работы с решениями IoT с предварительно заданными параметрами][lnk-preconfig-start].

- Узнать больше о службе центра IoT Azure в [документации по центру IoT][lnk-iot-hub].
