...
1. Перейдите на [портал управления Azure][lnk-classic-portal].
...
1. Перейдите на [портал управления Azure][lnk-classic-portal] и выберите пункт **Параметры** в списке служб слева.
