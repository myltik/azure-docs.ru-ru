...
1. Нажмите кнопку **Schedule** (Запланировать), а затем выберите **Firmware update** (Обновление микропрограммы). Введите **имя задания**, **версию встроенного ПО** и **URI встроенного ПО** в соответствующих полях. Нажмите кнопку **Apply** (Применить), чтобы запланировать задание для выполнения сейчас:
