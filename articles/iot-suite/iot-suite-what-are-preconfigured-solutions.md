...
- данные **задания отправки сведений об устройстве**, чтобы обновить данные устройства в базе данных DocumentDB;
...
## <a name="device-identity-registry-device-twin-and-documentdb"></a>Реестр удостоверений устройств, двойник устройства и DocumentDB
...
Это решение использует двойники устройств для управления метаданными устройств. Решение также использует базу данных DocumentDB для хранения собственных дополнительных данных об устройствах, например команд, поддерживаемых каждым из устройств, и журнала команд.
