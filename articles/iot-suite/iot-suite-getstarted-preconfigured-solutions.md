...
Когда устройство впервые подключается к решению, оно отправляет tve свои метаданные. Если вы измените метаданные устройства через панель мониторинга решения, решение отправит новые значения метаданных на устройство, а также сохранит их в своей базе данных DocumentDB. Дополнительные сведения см. в статье [Реестр удостоверений устройств и DocumentDB][lnk-devicemetadata].
