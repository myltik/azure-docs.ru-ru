...
На странице **Rules & Actions** (Правила и действия) в решении показан список текущих правил:
...
| Источник           | Группа устройств **Chiller**              |
| Поле триггера    | Давление                              |
| Оператор триггера | Больше                          |
| Значение триггера    | 150                                   |
| Уровень серьезности   | Предупреждение                               |
| Текст уведомления | Давление устройства Chiller превышает 150 фунтов на квадратный дюйм |

Чтобы сохранить новое правило, нажмите кнопку **Применить**.

Сведения о том, активировано ли правило, можно посмотреть на странице **Rules & Actions** (Правила и действия) или на странице **Панель мониторинга**.
