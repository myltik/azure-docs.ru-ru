...
На странице **Rules and Actions** (Правила и действия) в решении показан список текущих правил:
...
| Источник           | Группа устройств **Chillers**             |
...
Сведения о том, активировано ли правило, можно посмотреть на странице **Rules and Actions** (Правила и действия) или на странице **Панель мониторинга**.
