...
* Подготовка нового устройства. Это действие задает уникальный идентификатор устройства и создает ключ проверки подлинности. Сведения об устройстве записываются в реестр удостоверений центра IoT и базу данных Cosmos DB определенного решения.
