...
Предварительно настроенное решение *диагностического обслуживания* является одним из [предварительно настроенных решений][lnk_preconfigured_solutions], выпущенных как часть [пакета Microsoft Azure IoT Suite][lnk_iot_suite]. Это решение интегрирует сбор данных телеметрии устройства в режиме реального времени и прогнозную модель, созданные с помощью [машинного обучения Azure][lnk_machine_learning].
...
Дополнительные сведения о том, как центр Интернета вещей Azure реализует сценарии диагностического обслуживания, см. в разделе [Capture value from the Internet of Things] (Захват значения из Интернета вещей) [lnk_capture_value].
