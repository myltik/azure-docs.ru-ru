...
3. Щелкните **Import** (Импорт) в главном меню. Затем щелкните ссылку **Click here** (Щелкните здесь), чтобы выполнить импорт с URL-адреса рядом со значком земного шара и логотипом mbed.
...
1. Щелкните **Compile** (Скомпилировать), чтобы выполнить сборку программы. Вы можете проигнорировать все предупреждения. Однако если при сборке возникают ошибки, исправьте их, прежде чем продолжить.
