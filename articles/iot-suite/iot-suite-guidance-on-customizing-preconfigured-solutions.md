...
Решение удаленного мониторинга включает в себя два задания [Stream Analytics Azure](https://azure.microsoft.com/services/stream-analytics/) для реализации логики телеметрии и оповещений, отображаемой на панели мониторинга.
