...
# Полная безопасность в Интернете вещей
...
Azure IoT Suite содержит уникальные компоненты, благодаря которым подготовка и подключение устройств IoT и хранение данных на них становятся простыми, прозрачными и, самое главное, безопасными процедурами. В этом документе мы рассмотрим средства безопасности, предоставляемые Azure IoT Suite, а также опишем стратегии развертывания, которые обеспечивают безопасность, конфиденциальность и соответствие требованиям.
...
[Центр Azure IoT](../iot-hub/iot-hub-what-is-iot-hub.md) в рамках [IoT Suite](iot-suite-what-is-azure-iot.md) — это полностью управляемая служба, которая обеспечивает надежный и безопасный двусторонний обмен данными между устройствами IoT и службами Azure, например [машинное обучение Azure](../machine-learning/machine-learning-what-is-machine-learning.md) и [Azure Stream Analytics](../stream-analytics/stream-analytics-introduction.md), с помощью учетных данных для безопасного доступа к каждому устройству и управления доступом.
...
![Набор Azure IoT Suite](media/securing-iot-ground-up/securing-iot-ground-up-fig2.png)
...
Все ключи, используемые в инфраструктуре IoT, хранятся в защищенном облачном хранилище с возможностью продления, в случае если ключи должны быть повторно подготовлены. Данные могут храниться в [DocumentDB](../documentdb/documentdb-introduction.md) или [базах данных SQL](../sql-database/sql-database-faq.md), что включает возможность определения требуемого уровня безопасности. Кроме того, в Azure предусмотрены функции мониторинга и аудита всех операций доступа к данным, которые оповещают о попытках вторжения и несанкционированного доступа.
...
- [**Центр Azure IoT**](https://azure.microsoft.com/services/iot-hub/) — шлюз, который обеспечивает подключение между облаком и "вещами". Вы можете изменять количество подключений к центру до миллионов, по-прежнему обрабатывая большие объемы данных с помощью функции проверки подлинности для каждого устройства, помогающей защитить решение.
- [**Azure DocumentDB**](https://azure.microsoft.com/services/documentdb/) — служба масштабируемых и полностью индексированных баз данных для частично структурированных данных, которая управляет метаданными для подготавливаемых устройств: атрибутами, конфигурацией и параметрами безопасности. DocumentDB обеспечивает высокую производительность и пропускную способность при обработке, схемонезависимое индексирование данных, а также полнофункциональный интерфейс SQL-запросов.
