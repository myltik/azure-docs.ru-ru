...
Все ключи, используемые в инфраструктуре IoT, хранятся в защищенном облачном хранилище с возможностью продления, в случае если ключи должны быть повторно подготовлены. Данные могут храниться в [DocumentDB](../documentdb/documentdb-introduction.md) или [базах данных SQL](../sql-database/sql-database-faq.md), что позволяет определять требуемый уровень безопасности. Кроме того, в Azure предусмотрены функции мониторинга и аудита всех операций доступа к данным, которые оповещают о попытках вторжения и несанкционированного доступа.
