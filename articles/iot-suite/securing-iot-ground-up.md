...
[Центр Azure IoT](../iot-hub/iot-hub-what-is-iot-hub.md) в рамках [IoT Suite](iot-suite-what-is-azure-iot.md) — это полностью управляемая служба, которая обеспечивает надежный и безопасный двусторонний обмен данными между устройствами IoT и службами Azure, включая [машинное обучение Azure](../machine-learning/studio/what-is-machine-learning.md) и [Azure Stream Analytics](../stream-analytics/stream-analytics-introduction.md), с помощью учетных данных для безопасного доступа к каждому устройству и управления доступом.
