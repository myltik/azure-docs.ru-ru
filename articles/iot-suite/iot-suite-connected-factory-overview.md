---
title: "Обзор подключенной фабрики Azure IoT Suite | Документация Майкрософт"
...
1. По умолчанию на портале решения отображается *панель мониторинга*. Вы можете перейти к другим областям портала решения, используя меню в левой части портала.
...
* Загрузить веб-страницу в новом окне браузера, чтобы отобразить справочные сведения.
* Вызвать метод на основе унифицированной архитектуры OPC на устройстве, чтобы устранить причину возникновения оповещения.
...
2. Для дальнейшего анализа общей эффективности оборудования для любого уровня в иерархии данных щелкните процентный показатель общей эффективности оборудования, доступности, производительности или качества. Отобразится контекстная панель с визуализациями Time Series Insights, на которых можно просмотреть данные за последний час, последние 24 часа и за последние 7 дней.
...
2. Для дальнейшего анализа числа единиц в час или расхода энергии для любого уровня в иерархии данных щелкните любой из этих показателей на панели **Key Performance Indicators** (Ключевые показатели эффективности). Отобразится контекстная панель с визуализациями Time Series Insights, на которых можно просмотреть данные за последний час, последние 24 часа и за последние 7 дней.
...
В следующих разделах приведены некоторые дополнительные возможности предварительно настроенного решения для подключенной фабрики, не описанные в предыдущем сценарии.
...
3. Выберите нужный фильтр. При необходимости в поля фильтра можно ввести произвольный текст.
...
3. Выберите **Опубликовать**.
    ...
    ![Узел публикации подключенной фабрики][cf-img-publish-node]
