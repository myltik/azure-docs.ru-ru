...
>[!div class="checklist"]
> * [Локальное развертывание предварительно настроенного решения удаленного мониторинга](../iot-accelerators/iot-accelerators-remote-monitoring-deploy-local.md).
...
![Сообщение "Alive and Well" в приложении Postman](media/iot-suite-microservices-example/postman-alive-well.png)
...
![Успешно созданный образ Docker](media/iot-suite-microservices-example/successful-docker-image.png)
...
![Образ Docker в центре Docker](media/iot-suite-microservices-example/docker-image-in-docker-hub.png)
...
![Сообщение "New Edits Made Here" в приложении Postman](media/iot-suite-microservices-example/new-postman-message.png)
...
Далее можно попытаться [настроить микрослужбу моделирования устройств в решении удаленного мониторинга](iot-suite-remote-monitoring-test.md).
