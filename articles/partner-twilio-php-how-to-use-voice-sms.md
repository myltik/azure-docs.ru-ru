...
1. Загрузите библиотеку Twilio для PHP с сайта Github ([https://github.com/twilio/twilio-php][twilio_php]) а добавьте каталог **Службы** для вашего приложения.
...
Следующая страница PHP создает ответ TwiML, позволяющий произнести сообщение **Hello World** при получении звонка.
