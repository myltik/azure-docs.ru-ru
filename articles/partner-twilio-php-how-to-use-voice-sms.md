...
Ниже приведен список команд Twilio. Узнайте больше о других командах и возможностях посредством [документации по языку разметки Twilio] [http://www.twilio.com/docs/api/twiml].
...
<h2><a id="howto_make_call"></a>Руководство: осуществление исходящего вызова</h2>
...
<h2><a id="howto_send_sms"></a>Руководство: отправка SMS-сообщения</h2>
...
<h2><a id="howto_provide_twiml_responses"></a>Руководство: предоставление ответов TwiML с собственного веб-сайта</h2>
...
<h2><a id="AdditionalServices"></a>Руководство: использование дополнительных служб Twilio</h2>
