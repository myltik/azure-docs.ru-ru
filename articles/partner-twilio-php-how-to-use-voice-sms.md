...
- **Примечание**. Рекомендации по устранению ошибок, связанных с проверкой SSL-сертификата, см. в статье [http://readthedocs.org/docs/twilio-php/en/latest/usage/rest.html][ssl_validation] 
