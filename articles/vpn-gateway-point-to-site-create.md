...
В виртуальную сеть можно добавлять виртуальные машины. Соответствующие инструкции см. в статье [Как создать настраиваемую виртуальную машину](virtual-machines-create-custom.md).
