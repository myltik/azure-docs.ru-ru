...
2.  В меню слева выберите **Все службы**. В поле поиска введите **интеграция** для фильтрации. В списке результатов выберите **Учетные записи интеграции**.

    > [!TIP]
    > Если раздел **Все службы** не отображается, разверните меню. В верхней области свернутого меню выберите **Показать меню**.

    ![Раздел "Все службы", фильтрация по параметру "интеграция", выбран параметр "Учетные записи интеграции"](./media/logic-apps-enterprise-integration-as2/overview-1.png)
