...
2.  В меню слева выберите **Больше служб**. В поле поиска введите **интеграция** для фильтрации. В списке результатов выберите **Учетные записи интеграции**.
    ...
    ![Дополнительные службы, выполните фильтрацию по "интеграция" и выберите "Учетные записи интеграции"](./media/logic-apps-enterprise-integration-as2/overview-1.png)
