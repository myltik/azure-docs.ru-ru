...
* Разделяет обмен на наборы транзакций или сохраняет весь обмен:
  * Разделение обмена на наборы транзакций — блокировка наборов транзакций при ошибке: разделяет обмен на наборы транзакции и анализирует каждый из них. 
  ...
  * Разделение обмена на наборы транзакций — блокировка обмена при ошибке: разделяет обмен на наборы транзакции и анализирует каждый из них. 
