...
3. Укажите сведения об учетной записи интеграции. 
   ...
   | Расположение | Yes | Запад США | Регион для хранения сведений вашей учетной записи интеграции. Выберите то же расположение, что и для приложения логики, или создайте приложение логики в том же расположении, что и учетную запись интеграции. В нашем примере: | 
