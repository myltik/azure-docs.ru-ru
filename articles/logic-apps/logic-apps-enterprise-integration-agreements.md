...
Созданное соглашение можно использовать на портале Azure, чтобы создавать [приложения логики](logic-apps-what-are-logic-apps.md "узнайте о приложениях логики") с функциями "бизнес — бизнес".
