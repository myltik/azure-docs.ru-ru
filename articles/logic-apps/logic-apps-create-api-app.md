...
Интерфейсы API можно разместить в [службе приложений Azure](../app-service/app-service-web-overview.md). Это служба PaaS (платформа как услуга), предоставляющая удобный способ размещения API с высоким уровнем масштабирования.
