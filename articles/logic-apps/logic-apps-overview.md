...
* **Визуальное создание рабочих процессов с помощью простых средств**
  ...
  Создавайте приложения логики от начала и до конца в конструкторе Logic Apps на портале Azure через браузер или в Visual Studio. Запускайте рабочие процессы с помощью триггера и добавляйте любое количество действий из [коллекции коннекторов](../connectors/apis-list.md).
