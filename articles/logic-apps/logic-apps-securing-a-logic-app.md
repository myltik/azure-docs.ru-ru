...
Все вызовы из приложений логики поступают из определенного набора IP-адресов для каждого региона.  Можно добавить дополнительные фильтры, чтобы принимать запросы только из указанных IP-адресов.  Список этих IP-адресов можно найти [в этой статье](logic-apps-limits-and-config.md#configuration).
