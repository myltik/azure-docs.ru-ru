...
На схеме ниже показано, как пользователи подключаются к URL-адресу, указанному для диспетчера трафика (__http://myATMURL.trafficmanager.net__), который абстрагирует действительные URL-адреса сайта (__http://app1URL.cloudapp.net__ и \_\_http://app2URL.cloudapp.net__). В зависимости от настроенных критериев маршрутизации пользователи будут направляться на соответствующий фактический сайт согласно настройкам политики. Политика предусматривает циклический перебор, учет производительности или отработку отказа. Согласно целям этой статьи мы уделим основное внимание отработке отказа.
