...
_Ограниченный режим приложения для записи транзакций_
...
_Развертывание в одном регионе_
...
_Повторное развертывание в дополнительном регионе Azure_
...
###Шаблон "активный-пассивный" (полная реплика)
