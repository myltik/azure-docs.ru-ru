...
1. Повторите операцию, которая может вызвать временный сбой.
1. Если произойдет сбой, будет вызвана политика повтора.
1. При сбое всех попыток произойдет исключение.
