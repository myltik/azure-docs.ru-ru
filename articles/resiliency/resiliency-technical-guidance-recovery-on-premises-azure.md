---
title: Техническое руководство по обеспечению устойчивости. Восстановление из локальной среды в Azure | Microsoft Docs
...
* **Сеть**. Виртуальная частная сеть позволяет безопасно расширить локальную сеть в облако.
...
* **Хранение**: StorSimple расширяет файловую систему в службу хранилища Azure. Служба архивации Azure позволяет архивировать файлы и базы данных SQL в службу хранилища Azure.
* **Репликация базы данных**. Группы доступности для SQL Server версии 2014 или более поздней позволяют реализовывать высокую доступность и аварийное восстановление локальных данных.
