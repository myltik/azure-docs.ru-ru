...
Подведем итог ключевых моментов, описанных в этой статье (а также в связанных статьях об [обеспечении высокого уровня доступности](./resiliency-high-availability-azure-applications.md) и [аварийном восстановлении](./resiliency-disaster-recovery-azure-applications.md) для приложений Azure). Эту сводку вы можете использовать в качестве контрольного списка элементов, которые следует учитывать при планировании стратегии обеспечения доступности и аварийного восстановления. Эти рекомендации пригодились клиентам, которые хотят создать эффективное решение.
