...
- Задания: Они аналогичны событиям, за исключением того, что они основываются на продолжительности действия. Например, задания могут сообщать техническую информацию о том, сколько времени занимает загрузка содержимого или вызов веб-службы. Они также могут показывать, сколько времени затрачивает пользователь на заполнение формы, создание учетной записи или покупку. Задание представляет собой длительность выполнения задачи, например, длительность выполнения задачи скачивания или время, на протяжении которого баннер отображается на экране. (Значение заданий зависит от того, как пакет SDK интегрирован в приложение.) Обычно задания связаны с фоновыми задачами, которые выполняются за пределами области сеанса (т. е. без действий пользователя).
- Техническая информация. Техническая информация об устройствах пользователей приложения, которую можно отслеживать, например информация о языковом стандарте, поставщике, сети, устройстве, встроенном программном обеспечении, размерах экранов устройств пользователей, а также об используемой версии приложения и версии пакета SDK, используемого в приложении.
- Ошибки: Информация о технических ошибках внутри приложения, которые не приводят к его сбою. Ошибка представляет собой проблему мгновенного характера, например сбой сети или неправильное выполнение операции. (Значение событий зависит от того, как пакет SDK интегрирован в приложение.) Ошибки могут возникать во время сеанса или выполнения задания, а также происходить автономно.
