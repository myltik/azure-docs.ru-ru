...
Эта статья содержит указания по автоматизации типичных задач для развертывания виртуальных машин Azure и управления ими с помощью шаблонов диспетчера ресурсов Azure и интерфейса командной строки Azure, а также ссылки на дополнительную документацию по автоматизации для виртуальных машин.
...
### Шаг 1. Обновление интерфейса командной строки Azure до версии 0.9.0

Введите `azure --version`, чтобы просмотреть, установлена ли версия 0.9.0.

	azure --version
    0.9.0 (node: 0.10.25)

Если у вас установлена другая версия, необходимо [установить эту версию интерфейса командной строки Azure](xplat-cli-install.md) или обновить его с помощью одного из встроенных установщиков или пакетного менеджера **NPM**, введя команду `npm update -g azure-cli`.
...
> [AZURE.NOTE]Если у вас нет рабочей учетной записи, появится сообщение об ошибке, указывающее, что вам необходима учетная запись другого типа. Чтобы создать такую учетную запись из текущей учетной записи Azure, см. раздел о [подключении к учетной записи Azure](xplat-cli-connect.md).
...
### Шаг 3. Переключение в режим группы ресурсов в интерфейсе командной строки Azure
...
## Общая задача. Быстрое создание виртуальной машины в Azure
...
## Общая задача. Развертывание виртуальной машины в Azure из шаблона
...
Чтобы присоединить новый диск, выполните следующую команду:
