...
<ol>
<li>Создайте образ с поддержкой Hyper-V: воспользуйтесь диспетчером Hyper-V, чтобы создать виртуальный жесткий диск с поддержкой Hyper-V. Дополнительные сведения см. на странице <a href="http://technet.microsoft.com/ru-ru/library/cc742509">Создание виртуальных жестких дисков</a>.</li>
