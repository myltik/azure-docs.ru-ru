...
**Примечание**. Для выполнения передачи права владения необходимо быть администратором учетной записи. Чтобы подтвердить, кто является администратором учетной записи подписки, выполните следующие действия.

1. Войдите на [портал Azure](https://portal.azure.com).
2. В главном меню выберите пункт **Подписка**.
3. Выберите подписку, которую требуется проверить, а затем выберите **Параметры**. ![Параметры](./media/billing-subscription-transfer/settings.png)
4. Выберите **Свойства**. Администратор учетной записи подписки отобразится в поле **АДМИНИСТРАТОР УЧЕТНОЙ ЗАПИСИ**. ![checkaa](./media/billing-subscription-transfer/checkaa.png)

## Как передать подписку Azure
