---
title: Передача подписки Azure| Microsoft Docs
...
* **Если я принимаю управление счетами подписки от другой организации, сохранится ли у этой организации доступ к моим ресурсам?**
  ...
  * Ключи доступа для служб, таких как служба хранилища. Дополнительные сведения см. в статье [Просмотр, копирование и повторное создание ключей доступа к хранилищу](storage/storage-create-storage-account.md#view-copy-and-regenerate-storage-access-keys).
