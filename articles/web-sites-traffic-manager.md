...
Дополнительные сведения о балансировке нагрузки в Azure Traffic Manager см. в разделе [Описание методов балансировки нагрузки в Traffic Manager][Описание методов балансировки нагрузки в Traffic Manager].
...
-   Имена пользовательских доменов будут работать должным образом, но помимо добавления их к веб-сайтам необходимо также настроить сопоставление DNS таким образом, чтобы оно указывало на URL-адрес Traffic Manager. Информацию о настройке пользовательского домена для веб-сайта Azure см. в разделе [Настройка пользовательского имени домена для веб-сайта Azure][Настройка пользовательского имени домена для веб-сайта Azure].

-   В профиль Traffic Manager можно добавить только веб-сайты, работающие в стандартном режиме.

## Дальнейшие действия

Общие и технические сведения об Azure Traffic Manager см. в разделе [Обзор Traffic Manager][Обзор Traffic Manager].

Сведения о настройке Azure Traffic Manager, включая применение этого компонента для веб-сайтов Azure, см. в разделе [Задачи настройки Traffic Manager][Задачи настройки Traffic Manager].

Дополнительные сведения о балансировке нагрузки в Azure Traffic Manager см. в разделе [Описание методов балансировки нагрузки в Traffic Manager][Описание методов балансировки нагрузки в Traffic Manager].

Дополнительные сведения об использовании Traffic Manager совместно с веб-сайтами Azure см. в статьях [Использование Windows Azure Traffic Manager c WAWS][Использование Windows Azure Traffic Manager c WAWS] и [Azure Traffic Manager теперь можно интегрировать с веб-сайтами Azure][Azure Traffic Manager теперь можно интегрировать с веб-сайтами Azure].

  [Описание методов балансировки нагрузки в Traffic Manager]: http://msdn.microsoft.com/ru-ru/library/windowsazure/dn339010.aspx
  [Настройка пользовательского имени домена для веб-сайта Azure]: https://www.windowsazure.com/ru-ru/documentation/articles/web-sites-custom-domain-name/
  [Обзор Traffic Manager]: http://msdn.microsoft.com/ru-ru/library/windowsazure/hh744833.aspx
  [Задачи настройки Traffic Manager]: http://msdn.microsoft.com/ru-ru/library/windowsazure/hh744830.aspx
  [Использование Windows Azure Traffic Manager c WAWS]: http://blogs.msdn.com/b/waws/archive/2014/03/18/using-windows-azure-traffic-manager-with-waws.aspx
  [Azure Traffic Manager теперь можно интегрировать с веб-сайтами Azure]: http://azure.microsoft.com/blog/2014/03/27/azure-traffic-manager-can-now-integrate-with-azure-web-sites/
