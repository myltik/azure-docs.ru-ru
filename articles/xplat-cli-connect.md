...
[AZURE.INCLUDE [learn-about-deployment-models](../includes/learn-about-deployment-models-include.md)]В этой статье описывается процесс создания и администрирования ресурсов с помощью модели развертывания, которая использует менеджер ресурсов, а также классической модели.
