...
## Для интерактивной проверки подлинности с помощью веб-портала используйте azure login.
...
## Использование azure login с именем пользователя и паролем учетной записи организации
...
* **Режим диспетчера ресурсов azure** — для работы с ресурсами Azure в модели развертывания диспетчера ресурсов. Чтобы установить этот режим, выполните командлет `azure config mode arm`.

* **Режим управления службами Azure** — для работы с ресурсами Azure в классической модели развертывания. Чтобы установить этот режим, выполните командлет `azure config mode asm`.
...
* Инструкции по работе с командами Azure CLI см. в статьях [Команды Azure CLI в режиме диспетчера ресурсов Azure](./virtual-machines/azure-cli-arm-commands.md) и [Команды Azure CLI в режиме управления службами Azure](virtual-machines-command-line-tools.md).
