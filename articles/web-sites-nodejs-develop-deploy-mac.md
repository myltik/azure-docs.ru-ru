<properties urlDisplayName="Website" pageTitle="Создание веб-сайта Node.js на Mac - учебные курсы Azure" metaKeywords="Создание веб-сайта Node в Azure, развертывание веб-сайта Node Azure, веб-сайт Node.js, веб-сайт Node" description="Узнайте, как выполнить сборку и развертывание веб-сайта Node.js в Azure. Пример кода написан на языке Java." metaCanonical="" services="web-sites" documentationCenter="nodejs" title="Build and deploy a Node.js website to Azure" authors="larryfr" solutions="" manager="wpickett" editor="" />
...
7.  Чтобы включить публикацию в Git, необходимо указать имя пользователя и пароль. Если вы уже включили публикации для веб-сайта Azure, имя пользователя и пароль запрашиваться не будут. Вместо этого будет создан репозиторий Git с использованием ранее указанных имени пользователя и пароля. Запишите имя пользователя и пароль, так как они будут использоваться для публикации через Git всех создаваемых вами веб-сайтов Azure.
...
В этом разделе будет создан файл **server.js**, содержащий пример вывода сообщения "hello world" из [nodejs.org]. В отличие от исходного примера, в этот код был добавлен process.env.PORT в качестве прослушиваемого порта при выполнении на веб-сайте Azure.
...
4. Откройте браузер и перейдите к адресу "http://localhost:1337". Появится веб-страница c сообщением "Hello World", как показано на следующем снимке экрана.

    ![A browser displaying the 'Hello World' message.][helloworld-localhost]

##Публикация приложения

1. В командной строке смените каталог на **helloworld** и введите следующие команды для инициализации локального репозитория Git. 
...
5. Просмотрите свой сайт с помощью кнопки **Обзор** на странице веб-сайта Azure на портале управления.

##Публикация изменений в приложении

1. Откройте файл **server.js** в текстовом редакторе и измените "Hello World\n" на "Hello Azure\n". Сохраните файл.
2. В командной строке смените каталог на **helloworld** и выполните следующие команды:
...
3. Перейдите к своему сайту с помощью кнопки **Обзор** и обратите внимание на то, что обновления были применены.
...
Хотя приведенные в этой статье действия позволяют использовать портал Azure для создания веб-сайта, можно также использовать [программы командой строки Azure для Mac и Linux], которые позволяют выполнить те же самые действия.
...
При возникновении проблем с приложением после его развертывания в Windows Azure сведения о диагностике проблемы можно найти в разделе [Отладка приложения Node.js для веб-сайтов Windows Azure](/ru-ru/documentation/articles/web-sites-nodejs-debug/).
