...
#### Запустить, остановить, перезапустить, приостановить, продолжить и удалить
<table border="1">
<tr>
...
####Масштаб, конфигурация обновления и архивация
<table border="1">
<tr>
        <th colspan="15">Операция</th>
</tr>
