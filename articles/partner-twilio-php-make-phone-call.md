...
Следующим шагом является [развертывание приложения в веб-приложениях Azure с Git](app-service-web/app-service-web-get-started-php.md) (хотя не все сведения в статье по ссылке применимы). 
