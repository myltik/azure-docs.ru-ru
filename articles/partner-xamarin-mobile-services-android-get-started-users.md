...
2. Добавьте в класс **TodoActivity** следующий метод: 
    ...
    > [AZURE.NOTE] Если используется поставщик удостоверений, отличный от Майкрософт, измените значение, передаваемое в метод **login** выше, на одно из следующих: _Facebook_, _Google_, _Twitter_ или _WindowsAzureActiveDirectory_.
