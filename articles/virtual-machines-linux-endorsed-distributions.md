<properties pageTitle="Рекомендованные дистрибутивы Linux в Azure" description="Сведения о рекомендованных дистрибутивах Linux в Azure, включая рекомендации по Ubuntu, OpenLogic и SUSE." services="virtual-machines" documentationCenter="" authors="szarkos" manager="timlt" editor="tysonn"/>
