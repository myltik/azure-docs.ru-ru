...
Как вы видите, команда Pig позволяет интерактивно выполнять операции MapReduce с помощью Pig Latin, а также выполнять операторы, хранимые в пакетном файле.
