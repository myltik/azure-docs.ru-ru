...
* Установочные файлы пакета HPC 2012 R2, доступные бесплатно. Последняя версия пакета — HPC 2012 R2 с пакетом обновлений 1. [Загрузите](http://go.microsoft.com/fwlink/p/?linkid=328024) полный пакета установки и скопируйте файлы на компьютер головного узла или в сетевую папку. Выберите установочные файлы на языке установленной системы Windows Server.
...
Используйте [портал управления Azure](https://manage.windowsazure.com) для выполнения следующих действий с подпиской Azure. Они необходимы для развертывания узлов Azure из локального головного узла.
...
### <a>Загрузка сертификата управления по умолчанию</a>
...
1. На компьютере головного узла войдите на [портал Azure](https://manage.windowsazure.com).
...
### <a>Создание облачной службы Azure</a>
...
1. На панели команд портала нажмите кнопку **Создать**.
...
### <a>Создайте учетную запись хранения Azure</a>
...
3. На странице **Укажите новые узлы** выберите созданный ранее шаблон узла Azure \(который по умолчанию называется **шаблоном узла Azure по умолчанию**\). Затем укажите узлы **2** **мелких** узла и нажмите кнопку **Далее**.
	...
	Сведения о доступных размерах виртуальных машин см. в разделе [Размеры виртуальных машин и облачных служб в Azure](https://msdn.microsoft.com/library/azure/dn197896.aspx).
...
4. Чтобы убедиться, что экземпляры ролей выполняются, на [портале](https://manage.windowsazure.com) нажмите **Облачные службы**, затем выберите имя вашей облачной службы и нажмите **Экземпляры**.
...
* [Большие вычисления Azure: HPC и Пакетная служба](http://azure.microsoft.com/solutions/big-compute/)
* [Большие вычисления Azure: HPC и Техническая документация по пакетной службе](http://msdn.microsoft.com/library/azure/dn482128.aspx)
