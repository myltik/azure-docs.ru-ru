...
-   [Как приступить к работе с пакетом SDK для служб BizTalk Azure][Как приступить к работе с пакетом SDK для служб BizTalk Azure]
  ...
  [REST API-интерфейсов службы BizTalk]: http://msdn.microsoft.com/ru-ru/library/windowsazure/dn232347.aspx
  [Операции, отслеживаемые с помощью служб управления Azure]: #bizops
  [Отслеживание сообщений]: http://msdn.microsoft.com/library/windowsazure/hh949805.aspx
