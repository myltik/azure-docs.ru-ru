...
Вы можете осуществлять потоковую передачу набора MP4-файлов с адаптивной скоростью, создавая указатель потоковой передачи OnDemand и формируя URL-адрес потоковой передачи. В разделе о [кодировании ресурса](../media-services-encode-asset) показано кодирование данных в набор MP4-файлов с адаптивной скоростью. Перед созданием указателя следует настроить политику доставки ресурсво, как описано в [этом](../media-services-dotnet-configure-asset-delivery-policy) разделе. 
