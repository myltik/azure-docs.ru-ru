...
Дополнительную информацию см. в статье [Использование сторонних динамических кодировщиков со службами мультимедиа Azure](https://msdn.microsoft.com/ru-ru/library/azure/dn783464.aspx).

## Управление каналами, программами и ресурсами

Дополнительную информацию см. в разделе [Потоковая трансляция](https://msdn.microsoft.com/ru-ru/library/azure/dn783466.aspx).
