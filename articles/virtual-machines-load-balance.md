<properties 
	...
	description="В этой статье описываются два разных типа балансировки нагрузки, которые поддерживаются в Azure: Балансировка нагрузки для облачных служб и диспетчера трафика Azure для клиентского трафика." 
...
Дополнительные сведения см. в статье [О методах балансировки нагрузки диспетчера трафика](http://msdn.microsoft.com/library/azure/dn339010.aspx).
...
Дополнительные сведения см. в статье [Диспетчер трафика](http://msdn.microsoft.com/library/azure/hh745750.aspx).
...
Дополнительные сведения см. в статье [Подсистема балансировки нагрузки Azure](http://msdn.microsoft.com/library/azure/dn655058.aspx). Инструкции по созданию комплекта с балансировкой нагрузки см. в статье [Настройка комплекта балансировки нагрузки](http://msdn.microsoft.com/library/azure/dn655055.aspx).
...
Дополнительные сведения см. в статье [Внутренняя балансировка нагрузки](http://msdn.microsoft.com/library/azure/dn690121.aspx). Инструкции по созданию набора с балансировкой нагрузки см. в статье [Настройка внутреннего набора с балансировкой нагрузки](http://msdn.microsoft.com/library/azure/dn690125.aspx).
