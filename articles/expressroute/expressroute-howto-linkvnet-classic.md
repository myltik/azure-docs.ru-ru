---
title: Связывание виртуальной сети с каналом ExpressRoute с помощью классической модели развертывания и PowerShell | Microsoft Docs
...
#### <a name="updating-authorizations"></a>Изменение разрешений
...
#### <a name="redeeming-link-authorizations"></a>Активация разрешений на связь
