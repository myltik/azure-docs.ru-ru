...
|-----------------------|--------------------|----------------|---------------|
| **[Aryaka Networks](http://www.aryaka.com/)** | Поддерживаются | Не поддерживается | Амстердам, Кремниевая долина, Сингапур, Вашингтон, округ Колумбия |
...
| **[Equinix](http://www.equinix.com/partners/microsoft-azure/)** | Скоро | Не поддерживается | Чикаго, Вашингтон (округ Колумбия) |
