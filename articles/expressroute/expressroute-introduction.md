---
title: Введение в ExpressRoute | Microsoft Docs
...
## <a name="<a-name="howtoconnect"></a>how-can-i-connect-my-network-to-microsoft-using-expressroute?"></a><a name="howtoconnect"></a>Как подключить свою сеть к облаку Майкрософт с помощью ExpressRoute?
