...
### <a name="co-located-at-a-cloud-exchange"></a>Совместное размещение в Cloud Exchange
...
### <a name="point-to-point-ethernet-connections"></a>Подключения Ethernet типа "точка — точка"
...
### <a name="any-to-any-ipvpn-networks"></a>Сети типа "любой к любому" (IPVPN)
