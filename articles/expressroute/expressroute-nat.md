...
Длина префиксов IP-адресов для NAT, объявляемых с помощью этого пиринга, не ограничивается. Вам нужно отслеживать пул NAT и следить за тем, чтобы не остаться без сеансов NAT.
