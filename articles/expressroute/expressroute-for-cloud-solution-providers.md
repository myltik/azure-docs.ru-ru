...
### <a name="connectthrough-model"></a>Подключение через посредника
...
### <a name="connectto-model"></a>Прямое подключение
...
### <a name="userdefined-routing-udr"></a>Определяемые пользователем маршруты
