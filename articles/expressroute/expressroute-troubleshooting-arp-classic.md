...
# <a name="expressroute-troubleshooting-guide:-getting-arp-tables-in-the-classic-deployment-model"></a>Руководство по устранению неполадок ExpressRoute. Получение таблиц ARP в классической модели развертывания
...
### <a name="arp-table-when-it's-on-premises-or-when-the-connectivity-provider-side-has-problems"></a>Таблица ARP, когда она находится в локальной среде или когда на стороне поставщика услуг подключения возникли проблемы
...
>[AZURE.NOTE] В случае возникновения подобной проблемы отправьте запрос на поддержку своему поставщику услуг подключения, чтобы устранить ее.
