...
По умолчанию квоты и ограничения применяются к каждому каналу ExpressRoute. Актуальные сведения о квотах см. в разделе [Подписка Azure, границы, квоты и ограничения службы](../articles/azure-subscription-service-limits.md).
