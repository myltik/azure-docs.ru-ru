...
|---|---|---|---|
| **Максимальное число поддерживаемых префиксов на пиринг** |4000 по умолчанию, 10 000 с ExpressRoute Premium|200|200|
...
|**IP-адреса интерфейса маршрутизации**|RFC1918 и общедоступные IP-адреса|Общедоступные IP-адреса, зарегистрированные для клиентов в реестрах маршрутизации.| Общедоступные IP-адреса, зарегистрированные для клиентов в реестрах маршрутизации.|
