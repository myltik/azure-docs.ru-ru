<properties
   pageTitle="Настройка маршрутизации для канала ExpressRoute с помощью портала Azure | Microsoft Azure"
...
6. Когда изменения настройки будут подтверждены, вы увидите примерно такой результат.
