...
- Настройте подключение ExpressRoute.
	...
	- См. статьи о [создании канала ExpressRoute с помощью классической модели развертывания](expressroute-howto-circuit-classic.md) или [создании и изменении канала ExpressRoute с помощью Azure Resource Manager](expressroute-howto-circuit-arm.md).
	- См. статьи о [настройке маршрутизации для канала классической модели развертывания](expressroute-howto-routing-classic.md) или [для модели развертывания Resource Manager](expressroute-howto-routing-arm.md).
	- См. статьи о [связывании классической виртуальной сети](expressroute-howto-linkvnet-classic.md) или [виртуальной сети Resource Manager с каналом ExpressRoute](expressroute-howto-linkvnet-arm.md).
