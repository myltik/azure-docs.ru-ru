...
# <a name="router-configuration-samples-to-setup-and-manage-routing"></a>Примеры конфигурации маршрутизатора для настройки и управления маршрутизацией
...
#### <a name="dot1q-interface-definition"></a>Определение интерфейса Dot1Q
...
#### <a name="qinq-interface-definition"></a>Определение интерфейса QinQ
