<properties
   pageTitle="Настройка маршрутизации для канала ExpressRoute при классической модели развертывания с помощью PowerShell | Microsoft Azure"
...
# Создание и изменение маршрутизации для канала ExpressRoute с помощью PowerShell
