...
- Вам потребуется активный канал ExpressRoute. Прежде чем переходить к описанным ниже действиям, выполните инструкции по [созданию канала ExpressRoute](expressroute-howto-circuit-classic.md) и его включению на стороне поставщика услуг подключения. Для выполнения описанных ниже командлетов канал ExpressRoute должен быть подготовлен и включен.

>[AZURE.IMPORTANT]Эти инструкции применяются только к каналам от поставщиков, предлагающих услуги подключения второго уровня. Если вы работаете с поставщиком, предлагающим услуги третьего уровня (обычно IPVPN), ваш поставщик услуг подключения выполнит настройку и управление конфигурацией самостоятельно. В этом случае создавать пиринги и управлять ими вы не сможете.
...
4. **Настройка пиринга Microsoft для канала**
	...
	- **ASN клиента:** для объявления префиксов, зарегистрированных с номером AS для пиринга, можно указать номер AS, с которым они зарегистрированы. **Это необязательно.**
