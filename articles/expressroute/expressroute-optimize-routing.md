...
>[AZURE.IMPORTANT] Хотя представленные здесь примеры предназначены для пиринга Майкрософт и общедоступного пиринга, их можно использовать и для частного пиринга. Кроме того, атрибут AS PATH можно использовать в отдельном канале ExpressRoute. Он влияет на выбор основного и дополнительного путей.
