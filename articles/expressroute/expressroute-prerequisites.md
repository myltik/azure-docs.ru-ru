...
# Предварительные требования к подключению Azure ExpressRoute  

Для подключения к облачным службам Майкрософт через ExpressRoute необходимо удовлетворить следующие предварительные требования.

## Предварительные требования к подключению

- Наличие действительной и активной учетной записи Microsoft Azure.
...
- Вы можете создать подключение к Azure, даже если ваш поставщик сетевых услуг не указан в списке поддерживаемых расположений.
	- Обратитесь к своему поставщику сетевых услуг, чтобы узнать, находится ли он в одном из поддерживаемых расположений Exchange.
...
- Подключение к инфраструктуре поставщика услуг. Вы должны выполнить условия по крайней мере одного из следующих пунктов.
	- Вы являетесь пользователем VPN поставщика сетевых услуг, и у вас есть по меньшей мере один локальный сайт, который подключен к инфраструктуре VPN этого поставщика. Свяжитесь с поставщиком сетевых услуг, чтобы узнать, соответствует ли ваше VPN-подключение требованиям для ExpressRoute.
