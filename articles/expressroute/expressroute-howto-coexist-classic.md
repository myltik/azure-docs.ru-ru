---
title: 'Настройка сосуществующих подключений VPN типа ExpressRoute и '
сеть-сеть": ''
'|': ''
microsoft: ''
azure": ''
description: 'В этой статье описывается настройка параллельных подключений ExpressRoute и VPN типа '
для: ''
классической: ''
модели: ''
развертывания.": ''
