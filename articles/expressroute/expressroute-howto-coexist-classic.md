...
5. На этом этапе вы будете иметь виртуальную сеть без шлюзов. Для создания шлюзов и установки подключений вы можете перейти к **шагу 3**, описанному в этом разделе учебника, — [Создание виртуальной сети с ExpressRoute и подключением типа «сеть — сеть»](#create-a-new-virtual-network-with-both-expressroute-and-site-to-site-connectivity).

## Дальнейшие действия

Дополнительные сведения об ExpressRoute см. в разделе [Часто задаваемые вопросы об ExpressRoute](expressroute-faqs.md).
