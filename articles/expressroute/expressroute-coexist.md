<properties
   pageTitle="Настройка сосуществующих подключений ExpressRoute и VPN типа «сеть-сеть»"
...
5. На этом этапе вы будете иметь виртуальную сеть без шлюзов. Вы можете выполнить **этап 3**, описанный в данной статье, [Создание новой виртуальной сети и подключений](#create-a-new-virtual-network-and-connections-that-coexist), чтобы создать новые шлюзы и установить подключения.
