...
6. **Создайте конфигурацию маршрутизации.**
	...
	Пошаговые инструкции см. на странице [Настройка маршрутизации канала ExpressRoute (создание и изменение пиринга каналов)](expressroute-howto-routing-classic.md).
