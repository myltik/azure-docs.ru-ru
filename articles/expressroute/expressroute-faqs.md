...
4. Выполните действия, перечисленные в рабочих процессах ниже, чтобы настроить подключение [рабочих процессов ExpressRoute для подготовки каналов и состояний каналов](expressroute-workflows.md).
...
Обратитесь к странице [URL-адреса и диапазоны IP-адресов Office 365](http://aka.ms/o365endpoints) для получения актуального списка служб, поддерживаемых в ExpressRoute.
