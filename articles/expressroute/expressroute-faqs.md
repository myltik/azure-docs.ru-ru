...
### <a name="onep2plink"></a>Если у меня отсутствует совместное размещение в Cloud Exchange, а поставщик услуг предлагает подключение "точка-точка", мне нужно заказать два физических подключения между моей локальной сетью и Майкрософт? 
...
Мы не принимаем частные префиксы (RFC1918) в сеансе BGP общедоступного пиринга.
