...
4. Выполните действия, перечисленные в рабочих процессах ниже, чтобы настроить [рабочие процессы подключения ExpressRoute для подготовки каналов и состояний каналов](expressroute-workflows.md).
