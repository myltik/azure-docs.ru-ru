...
Вы можете выбрать регионального поставщика и получить подключения Ethernet к одному из поддерживаемых расположений поставщиков Exchange. Затем вы можете взаимодействовать с Майкрософт в этом расположении EXP. Проверьте, есть ли ваш поставщик сетевых услуг в расположениях Exchange, в последнем разделе на странице [Партнеры и расположения ExpressRoute](expressroute-locations.md). Затем можно заказать канал ExpressRoute через поставщика Exchange, чтобы подключиться к Azure.
...
Мы не устанавливаем ограничения на объем передачи данных. Сведения о пропускной способности см. в разделе [Стоимость услуг](http://azure.microsoft.com/pricing/details/expressroute/).
...
При подключении через NSP настройка избыточных связей выполняется NSP от вашего имени. Если ваше оборудование уже размещено в EXP, необходимо настроить две связи LAN с облачной платформой обмена EXP. При подключении к EXP посредством одной связи WAN из частного центра обработки данных необходимо прервать связь WAN на вашем маршрутизаторе в EXP, а затем настроить две связи LAN с облачной платформой обмена EXP.
...
Дополнительные сведения см. в разделе [Совместное использование канала ExpressRoute несколькими подписками](expressroute-share-circuit.md).
...
Да. Можно связать одну виртуальную сеть с несколькими каналами ExpressRoute, но не более чем с 4. Они должны быть заказаны из четырех разных мест.
...
Да. Мы принимаем до 4000 префиксов маршрутов для частного пиринга и общедоступного пиринга. Это значение можно увеличить до 10 000 маршрутов, если включить функцию ExpressRoute Premium.
