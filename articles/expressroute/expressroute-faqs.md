...
Мы не устанавливаем ограничения на объем передачи данных. Сведения о пропускной способности см. в разделе [Цены на услуги](http://azure.microsoft.com/pricing/details/expressroute/).
...
При подключении через партнера, предлагающего услуги третьего уровня, настройка избыточных связей выполняется этим партнером от вашего имени. Однако если ваше оборудование уже размещено у поставщика облачных служб Exchange, необходимо настроить две связи локальной сети с облачной платформой Exchange. При подключении к поставщику облачных служб посредством одной связи глобальной сети из частного центра обработки данных необходимо прервать связь глобальной сети на вашем маршрутизаторе, а затем настроить две связи локальной сети с облачной платформой Exchange.
...
|--------------|----------------------------------------|-----------------------------------------------|
| 50 Мбит/с | 10 | Не поддерживается |
| 100 Мбит/с | 10 | 20 |
| 200 Мбит/с | 10 | 25 |
| 500 Мбит/с | 10 | 40 |
| 1 Гбит/с | 10 | 50 |
...
4. Выполните действия, перечисленные в рабочих процессах ниже, чтобы настроить подключение. [Процедуры ExpressRoute для подготовки каналов и состояний каналов](expressroute-workflows.md)

### Могут ли мои существующие каналы ExpressRoute поддерживать подключение к службам Office 365?
Да. Ваши существующие каналы ExpressRoute можно настроить для поддержки подключения к службам Office 365. Убедитесь в наличии достаточной мощности для подключения к службам Office 365. Сведения раздела [Планирование сети и оптимизация производительности для Office 365](http://aka.ms/tune/) помогут вам спланировать потребности подключения. Также ознакомьтесь с разделом [Создание и изменение канала ExpressRoute](expressroute-howto-circuit-classic.md).
