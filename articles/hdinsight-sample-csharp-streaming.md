<properties 
	pageTitle="Пример счетчика слов на C# для потоковой передачи в HDInsight | Azure" 
	description="Показано, как создавать программы MapReduce на C# с использованием интерфейса потоковой передачи Hadoop и как выполнять программы в Azure HDInsight с использованием командлетов Azure PowerShell." 
	editor="cgronlun" 
	manager="paulettm" 
	services="hdinsight" 
	documentationCenter="" 
