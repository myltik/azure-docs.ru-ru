<properties 
	pageTitle="Реконструирование и выбор признаков в Студии машинного обучения Azure | Azure" 
