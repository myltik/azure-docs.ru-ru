...
- Убедитесь в том, что запрос содержит заголовок **Accept-Encoding**, а значение этого заголовка содержит **gzip**, **defalte** или **bzip2**.
...
- Проверьте, включено ли сжатие.
- Убедитесь в том, что в списке **Типы файлов** содержится разделенный запятыми список типов MIME.
- Убедитесь в том, что тип MIME для сжимаемого содержимого включен в список сжимаемых форматов.
