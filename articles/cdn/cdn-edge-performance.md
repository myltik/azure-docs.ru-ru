...
> [AZURE.NOTE] Анализ производительности Edge — это функция подписки на CDN уровня «Премиум». Сравнение возможностей CDN уровней «Стандартный» и «Премиум» см. в статье [Обзор Azure CDN](cdn-overview.md).
>
