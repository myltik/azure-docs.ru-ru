...
1. На [портале Azure](http://portal.azure.com) перейдите к профилю сети CDN, содержащему конечную точку, которую необходимо предварительно загрузить. Откроется колонка профиля.
...
4. Введите полный путь к каждому активу, который нужно загрузить (например */pictures/kitten.png*) в текстовое поле **Путь**.
