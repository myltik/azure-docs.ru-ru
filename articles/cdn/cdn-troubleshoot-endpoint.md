---
title: Устранение неполадок с конечными точками Azure CDN, которые возвращают состояние 404 | Microsoft Docs
...
> [!NOTE]
> В конечных точках **Azure CDN от Akamai** запрещено использовать полный диапазон портов TCP для источников. Список запрещенных портов источников см. в статье [Azure CDN from Akamai Allowed Origin Ports](https://msdn.microsoft.com/library/mt757337.aspx) (Разрешенные порты источников Azure CDN от Akamai).
> 
> 
