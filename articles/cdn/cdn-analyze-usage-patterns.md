---
title: Анализ вариантов использования CDN Azure | Microsoft Docs
description: 'Вы можете просмотреть способы использования CDN, опираясь на следующие отчеты: '
;пропускная: ''
способность";,: ''
"\";переданные": ''
данные";,: ''
...
2. Наведите указатель на вкладку **Аналитика**, а затем — на всплывающее окно **Core Reports** (Базовые отчеты). Щелкните нужный отчет в меню.
...
Формула: (TCP_ HIT/(TCP_ HIT+TCP\_MISS))*100
