...
Сведения о вопросах, относящиеся к настройке этого типа ограничения, см. в разделе [Вопросы](cdn-restrict-access-by-country.md#considerations)в конце этой главы.
