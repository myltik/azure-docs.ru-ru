...
Полный список возможностей, которые поддерживает каждый продукт Azure CDN, см. в статье [Azure CDN product features](cdn-features.md) (Характеристики продукта Azure CDN).
