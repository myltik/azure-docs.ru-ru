...
Если вы являетесь действующим клиентом CDN, то сможете управлять своими конечными точками CDN с помощью [портала управления Microsoft Azure](https://portal.azure.com).
...
- [Пользовательские источники контента](cdn-map-content-to-custom-domain.md)
...
- [Статистика в режиме реального времени](cdn-read-time-stats.md)
