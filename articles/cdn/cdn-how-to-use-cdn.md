...
1. Создание профиля CDN с конечными точками, указывающими на ваш источник
	...
	>[AZURE.NOTE]По умолчанию в одной подписке Azure можно создать не более четырех профилей CDN. Каждый профиль CDN может содержать максимум десять конечных точек CDN.
	>
