...
5.  Выберите значение для параметра **Ценовая категория** или используйте значение по умолчанию. Для дополнительных сведений о ценовых категориях см. [цены на хранилища Azure](../../pricing/details/storage).

6.  Выберите или создайте **группу ресурсов**. Дополнительные сведения о группах ресурсов см. в статье [Общие сведения о диспетчере ресурсов Azure](resource-group-overview/#resource-groups).
...
-   Можно сделать контейнер закрытым, а не общедоступным. Дополнительные сведения см. в статье [Управление анонимным доступом на чтение к контейнерам и большим двоичным объектам](../storage-manage-access-to-resources/).
