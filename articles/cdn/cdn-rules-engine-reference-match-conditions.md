...
- Используйте параметр **Без учета регистра**, чтобы определить, выполняется ли для сравнения регистр.
- Значение, указанное для этого условия соответствия, будет сравниваться со значением относительного пути точного запроса, выполненного клиентом.
...
Адрес электронной почты Ivan | *     | Для соответствия этому шаблону строка запроса запрошенного URL-адреса должна содержать параметр адреса электронной почты, который начинается с "Ivan".
