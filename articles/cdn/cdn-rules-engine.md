...
Обработчик правил позволяет настраивать способ обработки HTTP-запросов, например блокировка доставки определенных типов содержимого, определение политики кэширования и изменение заголовков HTTP. В этом учебнике демонстрируется создание правила, которое изменяет поведение кэширования ресурсов CDN.
...
* [Статистика в реальном времени в сети CDN Microsoft Azure](cdn-real-time-stats.md)
