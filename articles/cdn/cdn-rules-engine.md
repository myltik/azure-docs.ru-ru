...
Обработчик правил позволяет настроить способ обработки HTTP-запросов, например блокировку доставки определенных типов содержимого, определение политики кэширования и изменение заголовков HTTP. В этом учебнике демонстрируется создание правила, которое изменяет поведение кэширования ресурсов CDN.
