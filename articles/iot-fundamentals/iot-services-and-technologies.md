...
- Платформа как услуга (PaaS). Создавайте приложения с помощью [Azure IoT Suite](https://www.azureiotsuite.com/), коллекции предварительно настроенных решений корпоративного уровня, которые позволяют ускорить разработку пользовательских решений Интернета вещей.
...
![Самый полный портфель технологий и решений в отрасли][img-paas-saas-technologies-solutions]

## <a name="solutions"></a>Решения

Приступите к работе с предложениями Azure IoT Suite и SaaS. Чтобы создать полностью настраиваемое решение, выберите одно из предварительно настроенных решений, которое содержит наиболее распространенные сценарии, связанные с Интернетом вещей, например удаленный мониторинг, диагностическое обслуживание и подключенная фабрика. Или же воспользуйтесь Azure IoT Central, полностью управляемым комплексным решением, позволяющим реализовать сложные сценарии Интернета вещей без опыта работы с облачными технологиями.

### <a name="azure-iot-suite-paas"></a>Azure IoT Suite (PaaS)

Azure IoT Suite представляет собой коллекцию настраиваемых решений PaaS корпоративного уровня, которые обеспечивают высокий уровень управления решением Интернета вещей. Если ваша компания внедряет Интернет вещей для подключенных операций или имеет особые требования к настройке подключенных продуктов, Azure IoT Suite предоставит необходимый контроль. 

Примерами компаний, которые могут воспользоваться преимуществами Azure IoT Suite, являются организации с большим количеством устройств или моделей устройств, а также производители, которым нужны решения для подключенной фабрики. Создавая настраиваемые решения, соответствующие сложным требованиям, IoT Suite предоставляет следующее:
...
### <a name="compare-azure-iot-suite-and-azure-iot-central"></a>Сравнение Azure IoT Suite и Azure IoT Central

Для реализации стандартной [архитектуры решения Интернета вещей](/azure/iot-fundamentals/iot-introduction#iot-solution-architecture) Центр Интернета вещей Azure предлагает несколько вариантов ([Azure IoT Suite](/azure/iot-suite) и [Azure IoT Central](https://www.microsoft.com/internet-of-things/iot-central-saas-solutions)), каждый из которых подходит для различных наборов требований клиента:

[Центр Интернета вещей Azure](https://azure.microsoft.com/services/iot-hub/) — это базовая платформа Azure PaaS, которую используют IoT Central и Azure IoT Suite. Центр Интернета вещей обеспечивает надежную и безопасную двунаправленную связь между миллионами устройств Интернета вещей и облачным устройством. Он помогает решить трудности реализации Интернета вещей, такие как:
...
Выбор продукта Интернета вещей Azure является важной частью планирования решения Интернета вещей. Центр Интернета вещей — это отдельная служба Azure, которая сама по себе не предоставляет комплексное решение Интернета вещей. Центр Интернета вещей можно использовать в качестве отправной точки для любого решения Интернета вещей. Для его применения вам не требуется Azure IoT Suite или Azure IoT Central. Azure IoT Suite и Azure IoT Central используют Центр Интернета вещей наряду с другими службами Azure. В следующей таблице перечислены основные различия между Azure IoT Suite и Azure IoT Central, которые помогут выбрать оптимальный вариант в соответствии с вашими требованиями:
