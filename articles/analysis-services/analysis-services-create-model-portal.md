...
Функция конструктора веб-приложений (предварительная версия) Azure Analysis Services на портале Azure позволяет легко и быстро создавать табличные модели и запрашивать данные модели прямо в браузере. 

Помните, что конструктор веб-приложений находится на этапе **предварительной версии**. В него постоянно добавляются новые функции, но на этапе предварительной версии функциональные возможности ограничены. Для разработки и тестирования более сложных моделей лучше использовать Visual Studio (SSDT) и SQL Server Management Studio (SSMS).
