...
1. В [Power BI Desktop](https://powerbi.microsoft.com/desktop/) выберите **Получить данные** > **Azure** > **База данных Microsoft Azure Analysis Services**.
...
> [!NOTE]
> В некоторых организациях для развертывания обновлений Office 365 используется отложенный канал. Это значит, что обновления версии задерживаются на период до четырех месяцев от текущей версии. Для Excel 2016 (версии 1609.7369.2115 и ниже) или Excel 2013 можно создать ODC-файл подключения и вручную обновить поставщик MSOLAP.7 для подключения к серверу. Чтобы узнать больше, изучите раздел [Создание файла подключения к данным Office (ODC-файла)](analysis-services-odc.md).
> 
> 
