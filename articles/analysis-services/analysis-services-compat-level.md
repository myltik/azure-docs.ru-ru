...
Последним является уровень совместимости 1400 (предварительная версия). Этот уровень совпадает с уровнем SQL Server 2017 Analysis Services. Ниже перечислены основные функции уровня совместимости 1400.
...
> [!IMPORTANT]
> Уровень совместимости 1400 находится на этапе предварительной версии. Возможности некоторых функций могут быть ограничены. Рекомендуется не использовать табличные модели с уровнем 1400 в рабочих средах. 
