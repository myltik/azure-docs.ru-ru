...
##Дальнейшие действия
Дополнительную информацию о веб-формах ASP.NET см. в разделе [Знакомьтесь с веб-формами ASP.NET](http://www.asp.net/web-forms) на веб-сайте ASP.NET и в разделе [Microsoft Azure: учебники и руководства](http://azure.microsoft.com/ru-ru/documentation/services/web-sites/#net).
