...
* Преимущества снижения расходов: платите только за используемые услуги. Может быть экономичным вариантом внешнего архива и архива резервных копий. Дополнительную информацию см. в статьях [Калькулятор цен Azure](http://go.microsoft.com/fwlink/?LinkId=277060 "Pricing Calculator") и [Цены Azure].(http://go.microsoft.com/fwlink/?LinkId=277059 "Pricing article") .

Дополнительную информацию см. в статье [Резервное копирование и восстановление SQL Server с помощью службы хранилищ BLOB-объектов Azure](http://go.microsoft.com/fwlink/?LinkId=271617).
...
Полное руководство по созданию учетной записи хранения и выполнению простого восстановления см. в статье [Учебник. Резервное копирование и восстановление SQL Server с помощью службы хранилищ BLOB-объектов Windows Azure](http://go.microsoft.com/fwlink/?LinkId=271615) 
...
Дополнительную информацию о службе хранилище больших двоичных объектов Azure см. в статье [Использование службы хранилища BLOB-объектов Azure].(http://www.windowsazure.com/ru-ru/develop/net/how-to-guides/blob-storage/)
...
Дополнительную информацию о страничных BLOB-объектах см. в статье [Основные сведения о блочных больших двоичных объектах и страничных больших двоичных объектах](http://msdn.microsoft.com/ru-ru/library/windowsazure/ee691964.aspx)
...
* Учетные данные: сведения, необходимые для подключения к службе хранилища BLOB-объектов Azure и проверки подлинности, хранятся в виде учетных данных.  Чтобы разрешить SQL Server записывать резервные копии как BLOB-объекты Azure или выполнять восстановление из BLOB-объектов, необходимо создать учетные данные SQL Server. В учетных данных хранятся имя учетной записи хранения и ключ доступа к учетной записи хранения.  После создания эти учетные данные необходимо указывать в параметре WITH CREDENTIAL инструкций BACKUP и RESTORE. Дополнительную информацию о том, как просматривать, копировать и повторно создавать ключи доступа к учетной записи хранения см. в статье [Ключи доступа к учетной записи хранения](http://msdn.microsoft.com/ru-ru/library/windowsazure/hh531566.aspx).
Пошаговые указания для создания учетных данных SQL Server см. в статье [Getting Started with Azure Storage Service for SQL Server Backup and Restore] (Начало работы со службой хранилища Azure для резервного копирования и восстановления SQL Server)(http://go.microsoft.com/fwlink/?LinkId=271615).

## Резервные копии и восстановление базы данных SQL Server с помощью больших двоичных объектов Azure - основные понятия и задачи

**Основные понятия, вопросы и примеры кода:**

[Резервное копирование и восстановление SQL Server с помощью службы хранилищ больших двоичных объектов Azure](http://go.microsoft.com/fwlink/?LinkId=271617)

**Учебник по началу работы:**

[Getting Started with SQL Server Backup and Restore to Azure Blob Storage Service] (Начало работы со службой хранилища Azure для резервного копирования и восстановления SQL Server)(http://go.microsoft.com/fwlink/?LinkID=271615 "Tutorial")
