...
Дополнительную информацию о страничных BLOB-объектах см. в разделе [Информация о блочных и страничных BLOB-объектах](http://msdn.microsoft.com/ru-ru/library/windowsazure/ee691964.aspx).
