...
---
# <a name="overview-of-reporting-apis-for-enterprise-customers-preview"></a>Обзор интерфейсов API отчетов для корпоративных клиентов (предварительная версия)
...
* **Создание или получение ключа API**. Войдите на корпоративный портал и следуйте инструкциям в статье справки, посвященной интерфейсам API отчетов. В первом разделе этой статьи справки описывается, как создать или получить ключ API для определенной регистрации.
