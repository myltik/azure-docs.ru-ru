...
* **Как перенести данные и службы из подписки Azure в новую подписку?**
  ...
  Если не удается передать права собственности на подписку, можно перенести ресурсы вручную. Ознакомьтесь со статьей [Move resources to new resource group or subscription](../azure-resource-manager/resource-group-move-resources.md) (Перемещение ресурсов в новую группу ресурсов или подписку).
