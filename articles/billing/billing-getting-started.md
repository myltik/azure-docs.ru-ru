...
При регистрации в Azure можно сделать несколько вещей, которые помогут вам лучше понять свои затраты. На [портале Azure](https://portal.azure.com/#blade/Microsoft_Azure_Billing/SubscriptionsBlade) при выборе подписки представлены ваши текущие детализация затрат и график расходов. Вы также можете [скачать прошлые счета и файлы сведений об использовании](billing-download-azure-invoice-daily-usage-date.md) для большинства типов предложений. Если требуется сгруппировать затраты для ресурсов, используемых для разных проектов или команд, воспользуйтесь [маркировкой ресурсов тегами](../azure-resource-manager/resource-group-using-tags.md). Если вы предпочитаете использовать систему отчетности, применяемую в вашей организации, то ознакомьтесь с [интерфейсами API выставления счетов](billing-usage-rate-card-overview.md). 
...
Если ваша подписка предоставлена на условиях соглашения поставщика облачных решений (CSP) или спонсорского предложения Azure, то многие функции, описываемые в этой статье, вам недоступны. Для вас доступен другой набор инструментов, который можно использовать для управления затратами. Ознакомьтесь с разделом [Дополнительные ресурсы для клиентов с соглашением Enterprise (EA), поставщиков облачных решений (CSP) и участников спонсорского предложения Azure](#other-offers).

Если вы используете подписку на условиях соглашения Enterprise (EA), на портале Azure для вас доступна возможность просмотра затрат в общедоступной предварительной версии. Есть [несколько аспектов, которые необходимо знать](#EA), так как ряд функций, описанных в этой статье, не относится к вам.   
...
Чтобы просмотреть, являетесь ли вы администратором учетной записи, перейдите на [страницу "Подписки" на портале Azure](https://portal.azure.com/#blade/Microsoft_Azure_Billing/SubscriptionsBlade) и просмотрите список подписок, к которым у вас есть доступ. Просмотрите столбец **Моя роль**. Если в нем отображается роль *Администратор учетной записи*, то у вас есть необходимый доступ. Если отображается другая роль, например *Владелец*, то у вас нет всех прав доступа.
...
### <a name="tags"></a> Группирование данных о выставлении счетов путем добавления тегов к ресурсам 
...
3. Детализация затрат и график расходов отобразятся на всплывающей странице. Эта функция может не поддерживаться для вашего предложения (в верхней части экрана отобразится соответствующее предупреждение). Данные будут заполнены в течение 24 часов после добавления службы.  
...
#### <a name="view-costs-for-all-your-subscriptions-in-the-billing-page"></a>Просмотр затрат для всех подписок на странице "Выставление счетов"

Если вы управляете несколькими подписками в качестве администратора учетной записи, то на странице [Выставление счетов](https://portal.azure.com/#blade/Microsoft_Azure_Billing/BillingBlade) можно увидеть общую сумму счета и разбивку затрат по всем подпискам. Сейчас объединенные представления EA отсутствуют на странице выставления счетов на портале Azure.  
