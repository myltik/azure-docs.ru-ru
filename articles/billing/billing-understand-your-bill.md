---
title: "Интерпретация счета | Документация Майкрософт"
...
Чтобы расшифровать счет Azure, просмотрите счет со сводными сведениями о расходах и отдельный файл с подробными данными о ежедневном использовании. В этой статье объясняются термины, встречающиеся в счете и файле с данными о ежедневном использования. Дополнительные сведения см. в статье [Скачивание счета на оплату и данных о ежедневном использовании в Azure](../billing-download-azure-invoice-daily-usage-date.md). Если вы используете бесплатную пробную подписку, можно получить данные об использовании ежедневно, но без счета.
...
Счет — это сводные сведения о ваших расходах. Он доступен для скачивания в формате PDF на [портале Azure](https://portal.azure.com). Дополнительные сведения см. в статье [Скачивание счета на оплату и данных о ежедневном использовании в Azure](../billing-download-azure-invoice-daily-usage-date.md). 
...
| Получатель счета |Адрес для оплаты подписки Microsoft Azure. Обновить адрес для выставления счетов, связанный с кредитной картой, можно на странице подписки в [центре управления учетной записью Azure](https://account.windowsazure.com/subscriptions). |
