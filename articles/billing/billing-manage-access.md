...
Предоставление согласия позволяет администратору служб, соадминистратору, владельцу, участнику, читателю и читателю счетов в подписке скачивать счета в формате PDF на портале Azure. Однако счета, созданные до декабря 2016 года, сейчас доступны только администратору учетной записи.
