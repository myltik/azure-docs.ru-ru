...
### <a name="a-namestep2astep-2-change-the-directory-associated-with-the-azure-subscription"></a><a name="Step2"></a>Шаг 2. Изменение каталога, связанного с подпиской Azure
