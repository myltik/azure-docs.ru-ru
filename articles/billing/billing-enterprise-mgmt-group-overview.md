...
Диспетчер ресурсов позволяет создавать настраиваемые политики для управления ресурсами. С помощью групп управления можно присваивать политику на любом уровне иерархии и ресурсам в этих политиках.  [Подробнее](https://go.microsoft.com/fwlink/?linkid=858942)
