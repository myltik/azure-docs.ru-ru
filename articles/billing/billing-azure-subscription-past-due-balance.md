...
Если вы являетесь администратором учетной записи для подписки Azure и не осуществили оплату вовремя, то вы получите по электронной почте уведомление о задолженности или увидите предупреждение в [центре управления учетной записью Azure](https://account.windowsazure.com) или на [портале Azure](https://portal.azure.com).
