...
Дополнительные сведения см. в разделе [Visual Studio Online](http://go.microsoft.com/fwlink/?LinkId=253861). Дополнительные советы по использованию Git в Visual Studio Online см. в статье [Совместный доступ к коду в Git](http://www.visualstudio.com/get-started/share-your-code-in-git-vs.aspx), а сведения об использовании для публикации в Azure репозитория Git, не управляемого Visual Studio, см. в статье [Публикация на веб-сайтах Azure с помощью Git](app-service-web/web-sites-publish-source-control.md).
