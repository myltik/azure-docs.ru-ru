...
**Рисунок 1.** Простой кластер Elasticsearch, включающий в себя два первичных узла и два набора реплик
...
**Рис. 2.** Кластер Elasticsearch с различными типами узлов
...
**Рис. 3.** Экземпляры клиентского приложения, подключающиеся к кластеру Elasticsearch через балансировщик нагрузки Azure
...
**Рис. 4** Рекомендуемая отправная точка для создания кластера Elasticsearch в Azure
...
**Рис. 5.** Доступ клиентского приложения к нескольким кластерам через узел Tribe
...
**Рис. 6.** Кластер с тремя узлами, тремя сегментами и репликами
...
**Рис. 7.** Конфигурация разработки с несколькими узлами Elasticsearch, работающими на одном компьютере
