...
- [Делегирование администрирования](role-based-access-control-configure.md) ресурсам в разных средах посредством назначения пользователям и группам Microsoft Azure AD определенных ролей с привилегиями на выполнение определенного набора операций с ресурсами Azure.
