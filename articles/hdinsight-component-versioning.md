...
Дополнительные заметки о выпусках последних версий HDInsight см. в разделе [Заметки о выпуске HDInsight](http://azure.microsoft.com/documentation/articles/hdinsight-release-notes/).
...
> [AZURE.NOTE] Кластеры HDInsight 2.1 и 3.0 работают на под управлением гостевой ОС Azure [Family 4](http://msdn.microsoft.com/library/azure/ee924680.aspx#explanation), которая использует 64-разрядную версию Windows Server 2012 R2 и поддерживает .NET Framework 4.0, 4.5. и 4.5.1. 
