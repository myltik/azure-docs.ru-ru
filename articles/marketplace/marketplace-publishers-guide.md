...
|**Образ на основе Docker**    |   Образы контейнеров должны быть основаны на формате образа Docker и извлечены из Реестра контейнеров Azure.      |  транзакция:       |
