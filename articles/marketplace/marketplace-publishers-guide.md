...
>[!IMPORTANT]
<<<<<<< HEAD Привлекать клиентов лучше всего с помощью предложений "Бесплатная пробная версия" и "Транзакция". Значение "Свяжитесь со мной" — это получаемые контактные данные потенциального клиента. Поэтому при выборе предложения этого типа убедитесь, что для потенциальных клиентов настроено назначение и все готово к развертыванию сведений о них. ======= "Свяжитесь со мной" не является рекомендуемым типом предложения. Его следует использовать только в ситуациях, когда невозможно установить пробный период. Привлекать клиентов лучше всего с помощью предложений "Бесплатная пробная версия" и "Транзакция". При наличии любого типа пробной версии наш процесс адаптации поможет вам выбрать один из этих вариантов, в зависимости от вашего сценария.
