...
>[AZURE.WARNING]IP-адреса в Azure по умолчанию являются динамическими. Чтобы IP-адрес не изменился, стоит использовать [зарезервированный IP-адрес](..\virtual-network\virtual-networks-reserved-public-ip.md).
