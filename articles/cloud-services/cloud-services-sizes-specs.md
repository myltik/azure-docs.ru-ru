...
Подробные сведения и рекомендации по использованию этих размеров см. в разделе [Виртуальные машины серии A (для ресурсоемких вычислений) и серии H](../virtual-machines/windows/a8-a9-a10-a11-specs.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
...
Чтобы получить список размеров, можно использовать PowerShell или REST API. Интерфейс REST API описан [здесь](https://msdn.microsoft.com/library/azure/dn469422.aspx). Ниже представлена команда PowerShell, которая позволяет перечислить все доступные размеры для облачной службы.
...
* Дополнительные сведения о таких рабочих нагрузках, как высокопроизводительные вычисление, см. в разделе [Виртуальные машины серии A (для ресурсоемких вычислений) и серии H](../virtual-machines/windows/a8-a9-a10-a11-specs.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
