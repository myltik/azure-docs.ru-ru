...
4. В поле **Конфигурации** нажмите кнопку **Обзор** и отправьте файл конфигурации службы (с расширением .cscfg).
...
2. Выберите облачную службу и нажмите кнопку **Удалить**. Чтобы выбрать службу, не открывая панель мониторинга, щелкните в любом месте вне поля с ее именем.
