...
| Недоступно | [3004375][3004375] | Обновление для улучшения аудита командной строки Windows<p/>**Примечание.** Это обновление устанавливается, но раздел реестра, в котором оно активируется, отключен. | 4\.17, 3.24, 2.36 | Недоступно |
