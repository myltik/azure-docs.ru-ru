...
> [!NOTE]
> API управления службами заменяется на новый API управления ресурсами (в настоящее время доступен в предварительной версии).  Дополнительные сведения об использовании новых API управления ресурсами из Python см. в [документации по управлению ресурсами Azure](http://azure-sdk-for-python.readthedocs.org/).
> 
> 
...
API управления службами обеспечивает программный доступ к большинству функциональных возможностей управления службами, доступных на [классическом портале Azure][management-portal]. Пакет Azure SDK для Python позволяет управлять облачными службами и учетными записями хранения.
