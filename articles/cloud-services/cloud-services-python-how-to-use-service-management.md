...
Дополнительные сведения о сертификатах Azure см. в разделе [Управление сертификатами в Windows Azure](http://msdn.microsoft.com/ru-ru/library/windowsazure/gg981929.aspx). Полное описание параметров OpenSSL см. в документации по адресу [http://www.openssl.org/docs/apps/openssl.html](http://www.openssl.org/docs/apps/openssl.html).
...
Эта команда создаст `.cer`-файл и установит этот сертификат в **личное** хранилище сертификатов. Дополнительные сведения содержатся в разделе [Создание и передача сертификата управления для Azure](http://msdn.microsoft.com/ru-ru/library/windowsazure/gg551722.aspx)
...
Дополнительные сведения о записи образа виртуальной машины Linux см. в разделе [Запись образа виртуальной машины Linux.](../virtual-machines-linux-capture-image.md)

Дополнительные сведения о записи образа виртуальной машины Windows см. в разделе [Запись образа виртуальной машины Windows.](../virtual-machines-capture-image-windows-server.md)
