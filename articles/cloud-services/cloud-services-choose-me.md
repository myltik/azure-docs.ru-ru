...
Дополнительный контроль также усложняет использование. Если вам не требуются возможности дополнительного контроля, как правило, гораздо быстрее и проще запустить и выполнить веб-приложение в службе приложений, чем в облачных службах.
