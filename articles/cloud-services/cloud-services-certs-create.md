...
>[AZURE.NOTE] Если вы хотите использовать сертификат, указав IP-адрес, а не домен, задайте этот IP-адрес в параметре -DnsName.
...
### Linux
В [этой](../virtual-machines/virtual-machines-linux-mac-create-ssh-keys.md) статье рассматривается создание сертификатов с использованием SSH.
