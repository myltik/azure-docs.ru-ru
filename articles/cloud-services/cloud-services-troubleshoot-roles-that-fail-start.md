...
2. Во время развертывания решения с помощью Visual Studio щелкните "Настроить подключения к удаленному рабочему столу...". Дополнительные сведения о настройке подключения к удаленному рабочему столу см. в статье [Использование удаленного рабочего стола с ролями Azure](https://msdn.microsoft.com/library/gg443832.aspx).
