---
title: Настройка гибридного кластера HPC с помощью пакета Microsoft HPC | Microsoft Docs
...
* Создание учетной записи хранения Azure
  ...
  > [!NOTE]
  > Также запишите идентификатор подписки Azure, которая понадобится позже. Найдите это на классическом портале, щелкнув **Настройки** > **Подписки**.
  > 
  > 
