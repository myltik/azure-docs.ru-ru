...
# Установка гибридного вычислительного кластера с помощью пакета Microsoft HPC
...
* Установочные файлы пакета HPC 2012 R2, доступные бесплатно. [Скачайте](http://go.microsoft.com/fwlink/p/?linkid=328024) последнюю версию и скопируйте файлы на компьютер головного узла или в сетевое расположение. Выберите установочные файлы на языке установленной системы Windows Server.
...
Используйте [портал Azure](https://manage.windowsazure.com) для выполнения следующих действий с подпиской Azure. Они необходимы для развертывания узлов Azure из локального головного узла.
...
4. Чтобы убедиться, что экземпляры ролей больше не выполняются в Azure, в [портале](https://manage.windowsazure.com) нажмите **Облачные службы**, затем выберите имя вашей облачной службы и нажмите **Экземпляры**. В рабочей среде будут отсутствовать развернутые экземпляры.
