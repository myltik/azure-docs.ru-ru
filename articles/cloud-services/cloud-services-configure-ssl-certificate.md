...
> [!NOTE]
> Процедуры в этом задании применяются для облачных служб Azure. Информацию о процедурах для служб приложений см. в [данной](../app-service/app-service-web-tutorial-custom-ssl.md) статье.
> 
> 
