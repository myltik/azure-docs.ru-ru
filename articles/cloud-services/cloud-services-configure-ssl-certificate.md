...
> [AZURE.NOTE] Процедуры в этом задании применяются для облачных служб Azure. Информацию о процедурах для служб приложений см. в [данной](../app-service-web/web-sites-configure-ssl-certificate.md) статье.
