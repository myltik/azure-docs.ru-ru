...
> [AZURE.NOTE] Если вы используете средство Azure для Microsoft Visual Studio, то определить локальный ресурс хранилища можно на страницах **Свойства** для роли.
...
- [Настройка облачной службы для Azure](cloud-services-model-and-package.md)
