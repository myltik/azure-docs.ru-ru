---
title: Непрерывная доставка в Azure с помощью Visual Studio Team Services | Microsoft Docs
...
2. В мастере введите имя учетной записи Visual Studio Team Services в соответствующем поле и щелкните ссылку **Авторизовать сейчас**. Может появиться запрос на вход в систему.
    ...
    ![][11]
3. Во всплывающем диалоговом окне **Запрос подключения** нажмите кнопку **Принять**, чтобы предоставить Azure полномочия для настройки командного проекта в VS Team Services.
