---
title: Общие задачи управления облачными службами | Microsoft Docs
...
1. На [портале Azure][портале Azure] выберите облачную службу, которую требуется обновить. Откроется колонка экземпляра облачной службы.
...
1. На [портале Azure][портале Azure] выберите облачную службу, которую требуется удалить. Откроется колонка экземпляра облачной службы.
