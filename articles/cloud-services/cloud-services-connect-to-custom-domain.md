...
Создать виртуальную сеть в Azure можно с помощью классического портала Azure или Powershell. В этом учебнике используется Powershell. Информацию о создании виртуальной сети с помощью классического портала Azure см. в разделе [Создание виртуальной сети](../create-virtual-network.md).
