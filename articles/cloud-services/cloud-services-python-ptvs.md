---
title: Использование веб-ролей и рабочих ролей Python с помощью средств Python для Visual Studio | Microsoft Docs
...
* [Инструменты Python для Visual Studio][](PTVS.md).
* [Инструменты пакета Azure SDK для VS 2013][Инструменты пакета Azure SDK для VS 2013] или [инструменты пакета Azure SDK для VS 2015][].
...
* [Очереди служебной шины][Очереди служебной шины]
* [Разделы служебной шины][Разделы служебной шины]
