...
2.  Когда вы нажимаете **Подключить**, веб-браузер предлагает сохранить 
    RDP-файл. Откройте этот файл. (Например, при использовании Internet Explorer щелкните **Открыть**).
...
4.  Нажмите **Подключить**, и появится запрос безопасности на ввод учетных данных для доступа к экземпляру.
    Введите пароль, созданный в
    [Действии 1][Действие 1. Настройка службы для доступа к удаленному рабочему столу с использованием Azure PowerShell], затем нажмите кнопку **ОК**.
