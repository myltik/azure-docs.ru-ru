...
4.  Нажмите **Подключить**, и появится запрос безопасности на ввод учетных данных для доступа к экземпляру.5.   Введите пароль, созданный в [Действии 1]\[Действие 1. Настройте службу для доступа к удаленному рабочему столу с использованием Azure PowerShell], затем нажмите кнопку **ОК**.
