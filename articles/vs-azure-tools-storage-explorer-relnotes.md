...
Эта статья содержит заметки о выпуске обозревателя службы хранилища Azure 0.9.5 (предварительная версия), а также заметки о выпусках предыдущих версий.
...
## <a name="version-094--093"></a>Версия 0.9.4/0.9.3
21.01.2018
...
## <a name="version-091--090-preview"></a>Версия 0.9.1 или 0.9.0 (предварительная версия)
20.10.2017
### <a name="new"></a>Создать
* Поддержка предварительной версии для Azure Cosmos DB:
    * [электронная документация](./cosmos-db/storage-explorer.md);
