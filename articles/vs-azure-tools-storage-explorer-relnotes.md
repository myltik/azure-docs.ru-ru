...
* У некоторых пользователей в версии 0.9.0 уведомление об обновлении не работало. Эта проблема была устранена. Если у вас возникла эта ошибка, то вы можете вручную скачать последнюю версию обозревателя хранилищ [отсюда](https://azure.microsoft.com/en-us/features/storage-explorer/).
