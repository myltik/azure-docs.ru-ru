...
Эта статья содержит заметки о выпуске обозревателя службы хранилища Azure 0.8.16 (предварительная версия), а также заметки о выпуске для предыдущих версий.
