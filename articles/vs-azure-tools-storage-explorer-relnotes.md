...
Эта статья содержит заметки о выпуске обозревателя службы хранилища Azure 0.8.15 (предварительная версия), а также заметки о выпуске для предыдущих версий.
...
## <a name="version-0815-preview"></a>Версия 0.8.15 (предварительная версия)
13.07.2017

### <a name="download-azure-storage-explorer-0815-preview"></a>Скачивание обозревателя службы хранилища Azure 0.8.15 (предварительная версия)
- [Обозреватель службы хранилища Azure 0.8.15 (предварительная версия) для Windows](https://go.microsoft.com/fwlink/?LinkId=708343)
- [Обозреватель служб хранилища Azure 0.8.15 (предварительная версия) для Mac](https://go.microsoft.com/fwlink/?LinkId=708342)
- [Обозреватель служб хранилища Azure 0.8.15 (предварительная версия) для Linux](https://go.microsoft.com/fwlink/?LinkId=722418)

### <a name="new"></a>Создать

* Повышена производительность передачи и скачивания больших двоичных объектов.
* Улучшен процесс обработки конфликтующих файлов для передачи и скачивания больших двоичных объектов.
* Оптимизировано отображение ошибок в журнале действий во время передачи и скачивания больших двоичных объектов.
* Увеличен максимальный размер большого двоичного объекта для передачи и скачивания (8 ТБ для страничных BLOB-объектов и около 4,7 ТБ для блочных BLOB-объектов).

### <a name="known-issues"></a>Известные проблемы

* После нажатия кнопки "Отмена" задача завершается через некоторое время. Это [ограничение библиотеки узлов службы хранилища Azure](https://github.com/Azure/azure-storage-node/issues/317).
