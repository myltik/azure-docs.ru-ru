...
Эта статья содержит заметки о выпуске обозревателя службы хранилища Azure 0.9.2 (предварительная версия), а также заметки о выпуске для предыдущих версий.
...
- [Обозреватель службы хранилища Azure 0.9.2 (предварительная версия) для Windows](https://go.microsoft.com/fwlink/?LinkId=708343)
- [Обозреватель службы хранилища Azure 0.9.2 (предварительная версия) для Mac](https://go.microsoft.com/fwlink/?LinkId=708342)
- [Обозреватель службы хранилища Azure 0.9.2 (предварительная версия) для Linux](https://go.microsoft.com/fwlink/?LinkId=722418)
...
* Поддержка предварительной версии для Azure Cosmos DB:
    * [электронная документация](./cosmos-db/tutorial-documentdb-and-mongodb-in-storage-explorer.md);
...
20.10.2017
### <a name="download-azure-storage-explorer-091-preview"></a>Скачивание обозревателя службы хранилища Azure 0.9.1 (предварительная версия)
* [Скачивание обозревателя службы хранилища Azure 0.9.1 (предварительная версия) для Windows](https://go.microsoft.com/fwlink/?LinkId=809306)
* [Скачивание обозревателя службы хранилища Azure 0.9.1 (предварительная версия) для Mac](https://go.microsoft.com/fwlink/?LinkId=809307)
* [Скачивание обозревателя службы хранилища Azure 0.9.1 (предварительная версия) для Linux](https://go.microsoft.com/fwlink/?LinkId=809308)
