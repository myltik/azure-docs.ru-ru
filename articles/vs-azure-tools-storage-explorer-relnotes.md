...
Эта статья содержит заметки о выпуске обозревателя службы хранилища Azure 0.9.4 (предварительная версия), а также заметки о выпусках предыдущих версий.
...
- [Обозреватель службы хранилища Azure 0.9.4 (предварительная версия) для Windows](https://go.microsoft.com/fwlink/?LinkId=708343)
- [Обозреватель службы хранилища Azure 0.9.4 (предварительная версия) для Mac](https://go.microsoft.com/fwlink/?LinkId=708342)
- [Обозреватель службы хранилища Azure 0.9.4 (предварительная версия) для Linux](https://go.microsoft.com/fwlink/?LinkId=722418)
