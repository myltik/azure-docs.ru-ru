...
Эта статья содержит заметки о выпуске обозревателя службы хранилища Azure 0.9.0 (предварительная версия), а также заметки о выпуске для предыдущих версий.
...
- [Обозреватель службы хранилища Azure 0.9.1 (предварительная версия) для Windows](https://go.microsoft.com/fwlink/?LinkId=708343).
- [Обозреватель служб хранилища Azure 0.9.1 (предварительная версия) для Mac](https://go.microsoft.com/fwlink/?LinkId=708342).
- [Обозреватель служб хранилища Azure 0.9.1 (предварительная версия) для Linux](https://go.microsoft.com/fwlink/?LinkId=722418).
...
* [Скачивание обозревателя службы хранилища Azure 0.8.16 (предварительная версия) для Windows](https://go.microsoft.com/fwlink/?LinkId=809306)
* [Скачивание обозревателя службы хранилища Azure 0.8.16 (предварительная версия) для Mac](https://go.microsoft.com/fwlink/?LinkId=809307)
* [Скачивание обозревателя службы хранилища Azure 0.8.16 (предварительная версия) для Linux](https://go.microsoft.com/fwlink/?LinkId=809308)
