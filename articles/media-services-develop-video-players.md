<properties 
	...
	description="В разделе также приведены ссылки на платформы проигрывателей и подключаемые модули, которые можно использовать для разработки собственных клиентских приложений, способных использовать потоковое мультимедиа из служб мультимедиа." 
	authors="Juliako" 
	manager="dwrede" 
	editor="" 
...
Дополнительные сведения см. в разделе [Azure Media Player](aka.ms/ampdocs).
...
- [Платформа медиапроигрывателя для iOS](https://github.com/Azure/azure-media-player-framework) 
