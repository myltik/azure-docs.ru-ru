...
3. Теперь создайте класс **Notifications** в том же пакете, где создан класс **MainActivity**.
...
4. В приведенном выше коде замените заполнители `<hub name>` и `<connection string with listen access>` именем концентратора уведомлений и строкой подключения для *DefaultListenSharedAccessSignature*, полученными ранее.
...
<!-- URLs.-->
[приступая к работе]: /ru-ru/documentation/articles/notification-hubs-android-get-started/
