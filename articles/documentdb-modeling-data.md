...
> [AZURE.TIP] Документы в DocumentDB имеют максимальный размер. Дополнительные сведения об этом см. в разделе [Ограничения DocumentDB](../documentdb-limits).
...
Дополнительные сведения о Azure DocumentDB см. в [документации по службе]( ../../services/documentdb/) . 

Дополнительные сведения о настройке индексов в Azure DocumentDB см. в статье о [политиках индексирования](../documentdb-indexing-policies).

Чтобы понять, как сегментировать данные по нескольким разделам, ознакомьтесь со статьей [Секционирование данных в DocumentDB](../documentdb-partition-data). 
