...
> [WACOM.NOTE] Если вы новичок в Hadoop и данных большого размера, полезно будет познакомиться подробнее с терминами [Apache Hadoop][Apache Hadoop], [MapReduce][MapReduce], [HDFS][HDFS] и [Hive][Hive].
...
-   [Выполнение задания Hive][Выполнение задания Hive]
