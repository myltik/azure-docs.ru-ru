<properties 
	...
	description="Сведения об использовании разбиения по страницам для управления объемом дata returned to your Windows Store JavaScript app from Mobile Services." 
