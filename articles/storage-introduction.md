<properties urlDisplayName="Introduction to Azure Storage" pageTitle="Вводная информация о хранилище &mdash; Microsoft Azure" metaKeywords="Get started  Azure storage introduction  Azure storage overview  Azure blob   Azure unstructured data   Azure unstructured storage   Azure blob   Azure blob storage  Azure queue   Azure asynchronous processing   Azure queue   Azure queue storage Azure table   Azure nosql   Azure large structured data store   Azure table   Azure table storage  Azure file storage  Azure file  Azure file share  Azure " description="Общая информация по хранилищам Microsoft Azure" metaCanonical="" disqusComments="1" umbracoNaviHide="1" services="storage" documentationCenter="" title="Введение в хранилище Microsoft Azure" authors="tamram" manager="adinah" editor="cgronlun" />
...
Хранилища Blob-объектов, табличные хранилища и хранилища очередей в включены в каждую учетную запись хранения, а хранилище файлов доступно по запросу через [страницу предварительной версии Azure][страницу предварительной версии Azure].

Учетная запись хранения — это уникальное пространство имен, предоставляющее доступ к хранилищу Azure. Каждая учетная запись хранения может содержать до 500 ТБ объединенных данных BLOB-объектов, таблиц, очередей и файлов. Подробные сведения о емкости учетной записи хранения см. на странице [Целевые показатели масштабируемости и производительности хранилища Azure][Целевые показатели масштабируемости и производительности хранилища Azure].

На снимке ниже показано взаимодействие между ресурсами хранилища Azure:

![Ресурсы хранилища Azure][Ресурсы хранилища Azure]

Прежде чем создавать учетную запись хранения, необходимо оформить подписку Azure, которая представляет собой план, дающий доступ к различным службам Azure. В рамках одной подписки можно создать до 100 учетных записей хранения с уникальными именами. Для получения более подробной информации см. раздел [Сведения о ценах на хранилище][Сведения о ценах на хранилище].

Приступая к работе с Azure, можно использовать [бесплатную пробную версию][бесплатную пробную версию]. Как только вы решите приобрести план, можете выбрать из множества [вариантов приобретения][вариантов приобретения]. Если вы являетесь [подписчиком MSDN][подписчиком MSDN], то получаете бесплатно ежемесячные кредиты, которые можно использовать для служб Azure, включая хранилище Azure.
...
При использовании очень больших наборов данных, когда данные просто нереально отправить или загрузить в хранилище BLOB-объектов по сети, можно передать жесткий диск в Майкрософт для импорта или экспорта данных непосредственно в центре обработки данных с помощью [службы импорта и экспорта Azure][службы импорта и экспорта Azure]. Можно также копировать данные BLOB-объекта внутри вашей учетной записи хранения или между разными учетными записями хранения.
...
Если требуется разрешить пользователям управляемый доступ к ресурсам хранилища, то можно создать [подпись общего доступа][подпись общего доступа]. Подпись общего доступа — это маркер, который можно добавить к URL-адресу, что разрешает делегированный доступ к контейнеру, BLOB-объекту, таблице или очереди. Любой пользователь, обладающий маркером, может получить доступ к ресурсу, на который указывает маркер, с определяемыми им разрешениями на период времени, в течение которого он действителен. Обратите внимание, что хранилище файлов Azure в настоящее время не поддерживает подписи общего доступа.
...
-   [Хранилище Azure — документация][Хранилище Azure — документация]
...
-   [Использование табличного хранилища из .NET][Использование табличного хранилища из .NET]
-   [Использование хранилища очередей из .NET][Использование хранилища очередей из .NET]

### Для разработчиков Java/Android

-   [Использование хранилища BLOB-объектов из Java/Android][Использование хранилища BLOB-объектов из Java/Android]
-   [Использование табличного хранилища из Java/Android][Использование табличного хранилища из Java/Android]
-   [Использование хранилища очередей из Java/Android][Использование хранилища очередей из Java/Android]

### Для разработчиков Node.js

-   [Использование хранилища BLOB-объектов из Node.js][Использование хранилища BLOB-объектов из Node.js]
-   [Использование табличного хранилища из Node.js][Использование табличного хранилища из Node.js]
-   [Использование хранилища очередей из Node.js][Использование хранилища очередей из Node.js]

### Для разработчиков PHP

-   [Использование хранилища BLOB-объектов из PHP][Использование хранилища BLOB-объектов из PHP]
-   [Использование табличного хранилища из PHP][Использование табличного хранилища из PHP]
-   [Использование хранилища очередей из PHP][Использование хранилища очередей из PHP]

### Для разработчиков Ruby

-   [Использование хранилища BLOB-объектов из Ruby][Использование хранилища BLOB-объектов из Ruby]
-   [Использование табличного хранилища из Ruby][Использование табличного хранилища из Ruby]
-   [Использование хранилища очередей из Ruby][Использование хранилища очередей из Ruby]

### Для разработчиков Python

-   [Использование хранилища BLOB-объектов из Python][Использование хранилища BLOB-объектов из Python]
...
-   [Использование хранилища очередей из Python][Использование хранилища очередей из Python]
  ...
  [страницу предварительной версии Azure]: /ru-ru/services/preview/
  ...
  [бесплатную пробную версию]: /ru-ru/pricing/free-trial/
  [вариантов приобретения]: /ru-ru/pricing/purchase-options/
  [подписчиком MSDN]: /ru-ru/pricing/member-offers/msdn-benefits-details/
  ...
  [1]: /ru-ru/pricing/details/storage/
  [Сведения о ценах на передачу данных]: /ru-ru/pricing/details/data-transfers/
  [калькулятор цен на хранилище Azure]: /ru-ru/pricing/calculator/?scenario=data-management
