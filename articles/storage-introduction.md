...
Подробные сведения о ценах на объем хранилища, репликацию и транзакции см. на странице [Сведения о ценах на хранилище][Сведения о ценах на хранилище]. Подробные сведения о ценах на исходящие данные см. на странице [Сведения о ценах на передачу данных][Сведения о ценах на передачу данных]. Используйте [калькулятор цен на хранилище Azure][калькулятор цен на хранилище Azure] для оценки затрат.
...
-   [Использование хранилища очередей из Python][Использование хранилища очередей из Python]
  ...
  [Сведения о ценах на хранилище]: /ru-ru/pricing/details/storage/
