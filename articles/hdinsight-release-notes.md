...
<tr>
<td>Исправление ошибки: случайное зависание в консоли запросов HDInsight</td>
...
* [Install and use Spark 1.0 on HDInsight clusters][hdinsight-install-spark] (Установка и использование Spark 1.0 на кластерах HDInsight)
* [Install and use R on HDInsight Hadoop clusters][hdinsight-r-scripts] (Установка и использование R на кластерах HDInsight Hadoop)
...
Эти проблемы с совместимостью решены в последней версии SDK и Azure PowerShell. Мы советуем обновить HDInsight SDK до версии 1.3.1.6 или до более поздней версии, а набор инструментов Azure PowerShell до версии 0.8.8 или более поздней версии. Вы можете получить доступ к последней версии пакета SDK для HDInsight из [NuGet](https://www.nuget.org/packages/Microsoft.WindowsAzure.Management.HDInsight/) и набора инструментов Azure PowerShell, используя [установщик веб-платформы Microsoft](http://go.microsoft.com/?linkid=9811175&clcid=0x409).
...
* С выходом этого выпуска HDInsight v1.6 (HDP1.1, Hadoop 1.0.3) и HDInsight v2.1 (HDP1.3, Hadoop 1.2) удаляются с портала управления Azure. Вы можете по-прежнему создавать кластеры Hadoop для этих версий, используя командлеты HDInsight PowerShell ([New-AzureHDInsightCluster](http://msdn.microsoft.com/ru-ru/library/dn593744.aspx)) или используя [пакет SDK для HDInsight](http://msdn.microsoft.com/ru-ru/library/azure/dn469975.aspx). См. страницу [Версии компонентов НDInsight](http://azure.microsoft.com/ru-ru/documentation/articles/hdinsight-component-versioning/) для получения дополнительной информации.
...
* Кластер HDInsight версии 3.1 использует пакет Hadoop, основанный на [платформе данных Нortonworks Data Platform 2.1.7][hdp-2-1-7]. С 7.11.2014 этот кластер Hadoop создается по умолчанию при использовании портала Azure HDInsight. Кластеры HDInsight 3.1, созданные до 7.11.2014, работают на [платформе данных Hortonworks Data Platform 2.1.1][hdp-2-1-1] 
