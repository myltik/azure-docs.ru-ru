...
<ol start="6">
<li><p>Перейдите в папку проекта <code>\services\mobileServices\scripts</code> скопируйте созданный файл скрипта &lt;<em>your_service_name</em>&gt;.push.register.js в общую папку <code>\js</code> , а затем удалите этот файл из проектов приложений Windows и Windows Phone.</p></li> 
