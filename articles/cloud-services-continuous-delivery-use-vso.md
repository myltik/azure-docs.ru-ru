...
# Непрерывная доставка в Azure с использованием Visual Studio Online
  ...
  Вы можете настроить командные проекты Visual Studio Online для автоматического построения облачных служб или веб-сайтов Azure.  (Дополнительные сведения о настройке непрерывное построение и развертывание с помощью системы *on-premises* Team Foundation Server, в разделе [непрерывная доставка для облачных служб в Azure](cloud-services-dotnet-continuous-delivery.md).)
...
Чтобы создать веб-сайт, выберите шаблон проекта "Веб-приложение ASP.NET" и затем выберите MVC. См. раздел [Начало работы с веб-сайтами Azure и ASP.NET](web-sites-dotnet-get-started.md).
...
<tr><td>Среда развертывания Azure</td><td>Имя веб-сайта или облачной службы</td></tr>
</table>
<br/>
...
Дополнительную информацию см. в разделе [Visual Studio Online](http://go.microsoft.com/fwlink/?LinkId=253861). При работе с Git см. разделы [Общий доступ к коду в репозитории Git](http://www.visualstudio.com/get-started/share-your-code-in-git-vs.aspx) и [Публикация на веб-сайтах Azure с использованием репозитория Git](web-sites-publish-source-control.md).
