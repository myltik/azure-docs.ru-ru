...
<b>Примечание.</b> 
    <p>Процедуры в этом задании применяются к учетным записям хранения Azure. Сведения об облачных службах см. в статье <a href = "/en-us/develop/net/common-tasks/custom-dns/">Настройка пользовательского имени домена для облачной службы Azure</a>, о веб-сайтах &mdash; в статье <a href="/en-us/develop/net/common-tasks/custom-dns-web-site/">Настройка пользовательского имени домена для веб-сайта Azure</a>.</p> 
</div>
...
-   [Регистрация пользовательского домена для используемой учетной записи хранения][]
...
Если пользовательский домен поддерживает приложение, не допускающее простоя, то следует использовать процедуру, описанную в разделе [Регистрация пользовательского домена для учетной записи хранения с помощью промежуточного поддомена asverify][]
...
-   [Сопоставление содержимого CDN с пользовательским доменом][]
  ...
  [Настройка пользовательского имени домена для облачной службы Azure]: /en-us/develop/net/common-tasks/custom-dns/
  [Настройка пользовательского имени домена для веб-сайта Azure]: /en-us/develop/net/common-tasks/custom-dns-web-site/
