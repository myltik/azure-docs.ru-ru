...
В отличие от [очередей и разделов служебной шины](../service-bus/service-bus-messaging-overview.md), концентраторы событий предназначены для обработки потока обмена сообщениями в нужном масштабе. Концентраторы событий отличаются от разделов служебной шины, например, более высокой пропускной способностью и сценариями обработки событий. В результате этого концентраторы событий не реализуют некоторые возможности обмена сообщениями, которые доступны для [разделов](../service-bus/service-bus-fundamentals-hybrid-solutions.md#topics). Если такие возможности вам необходимы, разделы остаются оптимальным вариантом.
