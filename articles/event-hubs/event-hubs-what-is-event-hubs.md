---
title: Что такое концентраторы событий Azure? | Microsoft Docs
...
* Начало работы с помощью [учебника по концентраторам событий][учебника по концентраторам событий].
* Завершенный [пример приложения, использующего концентраторы событий][пример приложения, использующего концентраторы событий]
