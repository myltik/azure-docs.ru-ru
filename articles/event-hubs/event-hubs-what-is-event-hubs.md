...
- [**Токены SAS**](event-hubs-features.md#sas-tokens) используются для идентификации и проверки подлинности издателя событий.
...
- [**Единицы пропускной способности**](event-hubs-features.md#capacity) — это предварительно приобретенные единицы емкости. Одна секция имеет максимальный масштаб в размере одной единицы пропускной способности.
