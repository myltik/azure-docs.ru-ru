...
Библиотеки управления концентраторов событий могут динамически подготавливать пространства имен и сущности концентраторов событий. Это динамическая природа позволяет сложных развертываний и сценариев обмена сообщениями, чтобы программными средствами можно определить, какие объекты для подготовки к работе. В настоящее время эти библиотеки доступны для .NET.
