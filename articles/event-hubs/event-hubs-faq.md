...
Концентраторы событий Azure доступны во всех поддерживаемых регионах Azure. Список см. на странице [регионов Azure][].  
...
* [Обзор концентраторов событий][Event Hubs overview].
...
[регионов Azure]: https://azure.microsoft.com/regions/
