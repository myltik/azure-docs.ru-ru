...
Функция [записи концентраторов событий](event-hubs-capture-overview.md) позволяет автоматически записывать данные потоковой передачи в концентраторы событий и архивировать их в выбранной учетной записи хранения BLOB-объектов. Эту функцию можно включить на портале Azure и указать минимальный размер записываемых данных и интервал времени для записи. С помощью записи концентраторов событий можно указать собственную учетную запись хранения BLOB-объектов Azure и контейнер, используемый для хранения собранных данных. Зафиксированные данные записываются в формате Apache Avro.
