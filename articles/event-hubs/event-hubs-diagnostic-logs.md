...
* **OperationalLogs**: записывает в журнал события, связанные с операциями концентратора событий, в частности, тип операции, включая создание концентратора событий, используемые ресурсы, а также с состояние операции.
