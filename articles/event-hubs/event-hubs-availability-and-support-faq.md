<properties 
    pageTitle="Концентраторы событий: часто задаваемые вопросы | Microsoft Azure"
...
## <a name="can-i-use-a-single-amqp-connection-to-send-and-receive-from-event-hubs-and-service-bus-queues/topics?"></a>Можно ли использовать одно AMQP-подключение для отправки и получения из концентраторов событий, а также из очередей и разделов служебной шины?
