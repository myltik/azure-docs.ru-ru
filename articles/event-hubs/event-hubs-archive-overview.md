---
title: Архив концентраторов событий Azure | Microsoft Docs
...
Настроенный архив концентраторов событий создает файлы в учетной записи хранения Azure и контейнере, указанных в настроенном окне времени. Эти файлы можно просмотреть в любом средстве, например в [обозревателе хранилищ Azure][обозревателе хранилищ Azure]. Чтобы выполнить определенные действия с этими файлами, их можно скачать локально.

Файлы, созданные архивом концентраторов событий, имеют следующую схему Avro.

![][3]

Файлы Avro можно легко просмотреть с помощью [средств Avro][средств Avro] \(JAR-файл) из Apache. После того как вы скачали этот JAR-файл, чтобы просмотреть схему определенного файла Avro, выполните следующую команду:
...
Apache Avro предоставило руководства по началу работы для платформ [Java][Java] и [Python][Python]. Дополнительные сведения см. в статье [Getting Started with Event Hubs Archive](event-hubs-archive-python.md) (Начало работы с архивом концентраторов событий).
