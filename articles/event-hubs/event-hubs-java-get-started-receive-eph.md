...
1. Войдите на [классический портал Azure][Azure classic portal] и в нижней части экрана нажмите кнопку **Создать**.
