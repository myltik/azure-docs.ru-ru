...
3. Заполните поля в колонке учетной записи хранения и нажмите кнопку **Создать**.
   ...
   ![][1]
4. Получив сообщение об **успешном выполнении развертывания**, щелкните новую учетную запись хранения, затем в колонке **Основные компоненты** щелкните **BLOB-объекты**. В верхней части открывшейся колонки **Служба BLOB-объектов** щелкните **+ Container** (+ Контейнер). Присвойте контейнеру имя **archive**, затем закройте колонку **Служба BLOB-объектов**.
...
* [Архив концентраторов событий Azure][Azure Event Hubs Archive]
...
[Об учетных записях хранения Azure]: https://azure.microsoft.com/en-us/documentation/articles/storage-create-storage-account/
