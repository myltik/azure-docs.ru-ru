---
title: Пошаговое руководство. Архив концентраторов событий Azure | Microsoft Docs
...
* [Azure Event Hubs Archive][Azure Event Hubs Archive] \(Архив концентраторов событий Azure)
...
* [Event Hubs overview][Event Hubs overview] \(Общие сведения о концентраторах событий Azure)
