...
### [🔧 Типичные сценарии интеграции со службами Azure](event-hubs-common-integrations.md)
...
## Разработка
### [🔧 Обработка ошибок и повторные попытки](event-hubs-handling-errors-retry.md)
### [🔧 Управление производительностью и масштабом](event-hubs-performance-scale.md)
