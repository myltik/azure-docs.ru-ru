...
Архиву потребуется идентификатор ресурса учетной записи хранения для включения архивации в нужную службу хранилища Azure.
...
Контейнер больших двоичных объектов, в который следует архивировать данные событий.
