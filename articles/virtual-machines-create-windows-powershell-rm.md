...
Затем вам необходимо переключить режим Azure PowerShell на режим диспетчера ресурсов. Выполните следующую команду.
...
[Создание виртуальной машины Windows с помощью PowerShell и диспетчера служб Azure](virtual-machines-create-windows-powershell-sm.md)
