...
- **Быстрая сборка веб- и мобильных приложений**. Быстро выполняйте сборку, развертывайте веб- и мобильные приложения для сотрудников или клиентов с помощью одного внутреннего сервера и управляйте этими приложениями. Используйте языки, которые знаете: .NET, Java, NodeJS, PHP или Python. Ускорьте разработку, используя обширную коллекцию API, соединителей и логики, доступную в Azure Marketplace.

- **Подключение к любой службе и разблокировка данных**. Подключите веб- или мобильное приложение к корпоративным системам или SaaS за минуты с помощью встроенных соединителей. Более 50 соединителей для корпоративных систем на выбор: SAP, Siebel и Oracle - для популярных корпоративных служб SaaS, таких как Salesforce и Office 365 и популярных интернет-служб, таких как Facebook, Twitter и Dropbox.
...
- **Непревзойденная продуктивность разработки**. Служба оптимизирована для DevOps с поддержкой непрерывной интеграции для Visual Studio Online и Github, чтобы вы могли сосредоточиться на усовершенствовании приложений, не беспокоясь об инфраструктуре. Развертывайте обновления приложений со встроенными возможностями промежуточного хранения, откатов и тестировании в рабочей среде.
...
- [**Веб-приложения**](app-service-web-overview.md). Быстро создавайте и развертывайте критически важные веб-приложения с возможностью масштабирования по мере роста бизнеса.
- [**Мобильные приложения**](app-service-mobile-value-prop-preview.md). Взаимодействуйте с сотрудниками, партнерами и клиентами на любых устройствах, в любое время.
- [**Приложения API**](app-service-api-apps-why-best-platform.md). Легко выполняйте сборку и используйте облачные API, а также участвуйте в экономике API.
- [**Приложения логики**](app-service-logic-what-are-logic-apps.md). Автоматизируйте доступ и использование данных в облаках без написания кода.
...
[Создайте новое бесплатное веб-приложение](http://go.microsoft.com/fwlink/?LinkId=523751) прямо сейчас. Никаких кредитных карт и обязательств, никаких проблем.
