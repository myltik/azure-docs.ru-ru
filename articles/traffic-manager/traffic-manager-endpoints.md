...
>[AZURE.NOTE] Нельзя добавлять внешние расположения или профили диспетчера трафика в качестве конечных точек с помощью портала управления. Необходимо использовать REST API [Создание определения](http://go.microsoft.com/fwlink/p/?LinkId=400772) или Windows PowerShell [Add-AzureTrafficManagerEndpoint](http://go.microsoft.com/fwlink/p/?LinkId=400774).
