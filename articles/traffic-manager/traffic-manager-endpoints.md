---
title: Управление конечными точками в диспетчере трафика Azure | Microsoft Docs
...
> [!NOTE]
> На классическом портале Azure нельзя удалять внешние расположения или профили диспетчера трафика как конечные точки. Необходимо использовать Windows PowerShell. Подробнее см. в описании командлета [Remove-AzureTrafficManagerEndpoint](https://msdn.microsoft.com/library/dn690251.aspx).
> 
> 
