...
5. **Выберите метод маршрутизации трафика.** Выберите метод маршрутизации трафика в разделе **Политика маршрутизации трафика**. Дополнительную информацию о методах маршрутизации трафика см. в статье [О методах маршрутизации трафика в диспетчере трафика](traffic-manager-load-balancing-methods.md).
