...
В следующей таблице описывается поведение мониторинга дочернего и родительского профилей вложенного профиля и параметра minChildEndpoints. Дополнительную информацию см. в разделе [Обзор диспетчера трафика](traffic-manager-overview.md).
...
3. На портале управления в разделе **Параметры мониторинга** в поле **Относительный путь и имя файла** укажите путь и имя файла.
