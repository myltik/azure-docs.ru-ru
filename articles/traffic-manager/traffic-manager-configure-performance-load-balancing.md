...
5. В области **Настройки метода балансировки нагрузки**, убедитесь в том, что в качестве метода балансировки нагрузки выбран вариант **Производительность*. Если это не так, выберите пункт **Производительность** в раскрывающемся списке.
