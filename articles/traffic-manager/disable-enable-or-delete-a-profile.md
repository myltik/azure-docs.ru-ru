...
1. Измените запись ресурса DNS на DNS-сервере Интернета, чтобы использовать тип записи CNAME, который сопоставляет доменное имя вашей компании с доменным именем вашего профиля диспетчера трафика. Дополнительную информацию см. в статье [Направление интернет-домена компании на домен диспетчера трафика](../point-a-company-internet-domain-to-a-traffic-manager-domain.md).
