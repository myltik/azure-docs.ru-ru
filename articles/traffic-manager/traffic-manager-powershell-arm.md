...
В контексте поддержки диспетчера трафика в Azure Resource Manager и в классической модели развертывания используется различная терминология. В следующей таблице показаны различия между терминами, используемыми в модели Resource Manager и классической модели.
