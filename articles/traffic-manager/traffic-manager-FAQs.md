...
Нет, сейчас диспетчер трафика учитывает только исходный IP-адрес полученного DNS-запроса. В большинстве случаев это IP-адрес сопоставителя DNS, выполняющего запросы для маршрутизации по производительности или географической маршрутизации.  
...
### <a name="is-it-guaranteed-that-traffic-manager-will-correctly-determine-the-exact-geographic-location-of-the-user-in-every-case"></a>Есть ли гарантия, что диспетчер трафика правильно определит точное географическое расположение пользователя во всех случаях?
