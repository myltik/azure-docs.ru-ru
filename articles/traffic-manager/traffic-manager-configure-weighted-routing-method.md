...
4. В разделе **Параметры** щелкните **Конфигурация** и в колонке **Конфигурация** сделайте следующее.
    1. В области **Настройки метода маршрутизации трафика** убедитесь, что в качестве метода маршрутизации трафика выбран вариант **Отработка отказа**. В противном случае выберите пункт **Отработка отказа** в раскрывающемся списке.
