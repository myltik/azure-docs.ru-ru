...
5. В колонке **Добавление конечной точки** введите значения следующих параметров.
    ...
    4. Для параметра **Целевой ресурс** в раскрывающемся списке выберите соответствующий целевой ресурс, чтобы отобразить список ресурсов в одной подписке в колонке **Ресурсы**. В появившейся колонке **Ресурсы** выберите службу, которую нужно добавить в качестве первой конечной точки.
