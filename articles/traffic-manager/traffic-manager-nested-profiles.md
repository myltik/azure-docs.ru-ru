...
|---|---|---|
|"Отключено". Дочерний профиль был отключен пользователем.|Остановлена|Состояние родительской конечной точки — «Остановлено», а не «Отключено». Состояние «Отключено» указывает, что вы отключили конечную точку в родительском профиле.|
...
|"Неактивно". Все конечные точки дочернего профиля находятся в состоянии "Отключено" или "Остановлено", либо в этом профиле нет конечных точек.|Остановлена||
