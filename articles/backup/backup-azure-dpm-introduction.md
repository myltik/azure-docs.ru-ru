...
1. Войдите на [портале Azure](https://portal.azure.com/).
2. Откройте в хранилище служб восстановления, где вы хотите зарегистрировать компьютер DPM.
...
1. Откройте в хранилище служб восстановления, где вы хотите зарегистрировать компьютер DPM.
...
3. На странице параметров под надписью **Агент службы архивации Windows Azure** щелкните **Скачать**.
   ...
   После загрузки агента запустите MARSAgentInstaller.exe для запуска установки агента резервного копирования Azure. Выберите папку установки и временную папку для агента. Указанное расположение кэша должно иметь свободное место, равное по крайней мере 5 % размера резервной копии данных.
