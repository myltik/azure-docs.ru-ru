...
[Диспетчер System Center DPM](https://docs.microsoft.com/en-us/system-center/dpm/dpm-overview) выполняет резервное копирование файлов и данных приложений. Дополнительные сведения о поддерживаемых рабочих нагрузках см. [здесь](https://docs.microsoft.com/en-us/system-center/dpm/dpm-protection-matrix). Данные, резервное копирование которых выполнено в DPM, можно хранить на магнитной ленте или диске либо сохранить как резервную копию в Azure с помощью службы Microsoft Azure Backup. DPM взаимодействует со службой архивации Azure по описанной ниже схеме.
...
3. **ПИН-код безопасности.** Если вы включили [параметры безопасности](https://docs.microsoft.com/en-us/azure/backup/backup-azure-security-feature) хранилища, для выполнения важных операций резервного копирования потребуется ПИН-код безопасности. Многофакторная проверка подлинности повышает уровень безопасности. 
...
2. Откройте хранилище служб восстановления, в котором необходимо зарегистрировать виртуальную машину DPM.
...
1. Откройте хранилище служб восстановления, в котором необходимо зарегистрировать виртуальную машину DPM.
...
3. На странице параметров под надписью **Агент службы архивации Windows Azure** щелкните **Скачать**.
   ...
   После скачивания агента дважды щелкните файл MARSAgentInstaller.exe, чтобы начать установку агента службы архивации Azure. Выберите папку установки и временную папку для агента. Указанное расположение кэша должно иметь свободное место, равное по крайней мере 5 % размера резервной копии данных.
