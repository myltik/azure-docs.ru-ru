...
4. В поле **Область** выберите географический регион для хранилища архивации. Обратите внимание, что хранилище должно быть в том же регионе, что и виртуальные машины, которые необходимо защитить. При наличии виртуальных машин в разных регионах создайте хранилище в каждом из них. Указывать учетные записи хранения для данных резервного копирования не требуется: хранилище и служба архивации Azure сделают это автоматически.
    > [AZURE.NOTE] Резервное копирование виртуальной машины средствами службы архивации Azure поддерживается лишь в отдельных регионах. Ознакомьтесь со списком [регионов](http://azure.microsoft.com/regions/#services). Регион, в котором данная функция в настоящее время не поддерживается, не отображается в раскрывающемся списке во время создания хранилища.
...
Файл установки агента нужно скачать и запустить на каждом сервере DPM, содержащем данные, резервную копию которых требуется создать. Агенты хранятся в **центре загрузки Azure**, и используют свой процесс установки. При запуске программы установки, агент устанавливается, а сервер DPM регистрируется в хранилище. Обратите внимание на следующее.
...
10. Щелкните "Создать парольную фразу", а затем — "Копировать в буфер обмена". Появится сообщение о том, что парольная фраза скопирована в буфер обмена. На этом этапе рекомендуем вам открыть Блокнот, вставить туда парольную фразу из буфера и сохранить файл, а затем распечатать его и положить в надежное место. Нажмите кнопку "Зарегистрировать", чтобы зарегистрировать сервер DPM в хранилище службы архивации.

    > [AZURE.TIP] Во время ввода параметров шифрования не забудьте скопировать парольную фразу в буфер обмена.
11. Щелкните **Зарегистрировать**.
