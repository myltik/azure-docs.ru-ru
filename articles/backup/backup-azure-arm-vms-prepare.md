...
В этой статье приведены шаги по подготовке среды к резервному копированию виртуальной машины, развернутой с помощью Azure Resource Manager. Шаги процедур выполняются на портале Azure. Данные резервной копии виртуальной машины хранятся в хранилище служб восстановления. Хранилище содержит данные резервного копирования для виртуальных машин, развернутых с помощью классической модели и с помощью Resource Manager.
...
* Создайте хранилище служб восстановления (или укажите существующее) *в том же регионе, где находится виртуальная машина*.
...
* Резервное копирование и восстановление виртуальных машин с помощью неуправляемых дисков в учетных записях хранения с применением правил сети не поддерживается. 
