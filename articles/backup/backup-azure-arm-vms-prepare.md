...
Теперь, когда есть подключение к сети, вы можете создать резервную копию виртуальной машины. См. раздел [Архивация виртуальных машин Azure Resource Manager (ARM)](backup-azure-arm-vms.md).
