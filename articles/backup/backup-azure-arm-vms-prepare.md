...
* Резервное копирование и восстановление виртуальных машин с помощью неуправляемых дисков в учетных записях хранения с применением правил сети сейчас не поддерживается. При настройке резервного копирования убедитесь, что настройки брандмауэров и виртуальных сетей учетной записи хранения разрешают доступ из всех сетей.
