...
> [!WARNING]
> Теги службы хранилища доступны только в определенных регионах и находятся на этапе предварительной версии. Список регионов см. в разделе [тегов службы для хранилища](../virtual-network/security-overview.md#service-tags).
