        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Начало резервного копирования сервера VMware с помощью сервера резервного копирования Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/recoveryservices">Справочник по REST API служб восстановления</a></p>
                    </div>
                </div>
            </div>
        </div>
