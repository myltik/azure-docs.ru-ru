...
Переведите существующую службу автоматизации или набор инструментов на модель развертывания Resource Manager, чтобы сохранить их работоспособность после обновления хранилища. Можно найти в книгах командлеты PowerShell для [модели развертывания диспетчера ресурсов](backup-client-automation.md).
