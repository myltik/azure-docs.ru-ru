...
Переведите существующую службу автоматизации или набор инструментов на модель развертывания Resource Manager, чтобы сохранить их работоспособность после обновления хранилища. Обратитесь к справочникам по командлетам PowerShell для [модели развертывания с помощью диспетчера служб](backup-client-automation-classic.md) и [модели развертывания с помощью Resource Manager](backup-client-automation.md).
