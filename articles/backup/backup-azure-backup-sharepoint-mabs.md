...
Прежде чем продолжить, убедитесь, что у вас [установлен и подготовлен сервер резервного копирования Azure](backup-azure-microsoft-azure-backup.md) для защиты рабочих нагрузок.
