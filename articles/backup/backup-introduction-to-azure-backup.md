...
description: "С помощью службы архивации и служб восстановления Azure можно создавать резервные копии и восстанавливать данные и приложения на серверах Windows, компьютерах Windows, серверах System Center DPM и виртуальных машинах Azure."
services: backup
documentationcenter: 
author: markgalioto
manager: carmonm
...
Процесс резервного копирования виртуальных машин, запущенных на управляемых дисках, такой же, как и для виртуальных машин Resource Manager. Это можно сделать непосредственно в представлении виртуальной машины или в представлении хранилища служб восстановления. Резервное копирование виртуальных машин, запущенных на управляемых дисках, осуществляется с помощью точек восстановления, созданных на основе управляемых дисков. Сейчас служба архивации Azure не поддерживает резервное копирование запущенных на управляемых дисках виртуальных машин, зашифрованных с помощью шифрования дисков Azure (ADE).

### <a name="restore-managed-disk-vms"></a>Восстановление виртуальных машин, запущенных на управляемых дисках
Служба архивации Azure позволяет восстанавливать виртуальные машины с управляемыми дисками или управляемыми дисками восстановления в учетную запись хранения Resource Manager. Диски, созданные в процессе восстановления, управляются службой Azure, но учетная запись хранения, созданная в рамках этого процесса, не отличается от любой другой учетной записи хранения Resource Manager и должна управляться клиентом.
...
* Сервер приложений. Сервер приложений может быть физическим компьютером или виртуальной машиной под управлением Windows Server с рабочими нагрузками, содержащими данные, для которых требуется резервное копирование. Типичные рабочие нагрузки: Microsoft SQL Server, Microsoft Exchange Server, Microsoft SharePoint Server, Microsoft Dynamics и роль файлового сервера в Windows Server. Для резервного копирования этих рабочих нагрузок требуется System Center Data Protection Manager (DPM) или сервер резервного копирования Azure.
* Персональный компьютер или ноутбук под управлением операционной системы Windows.
...
Служба архивации Azure и Azure Site Recovery схожи в том, что используются для резервного копирования и восстановления данных, но их основные назначения различны.
