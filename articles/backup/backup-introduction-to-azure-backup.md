...
| Служба архивации виртуальных машин Azure IaaS | <li>Собственные технологии резервного копирования для Windows и Linux.<li>Установка агентов не требуется.<li>Поддерживается резервное копирование на уровне структуры. Для этого не требуется инфраструктура.<li>Используется хранилище службы архивации Azure. | <li>Задания резервного копирования, а также восстановления дисков ограничены до одного в день.<li>Резервное копирование в локальной среде не поддерживается. | Виртуальные машины,<br>отдельные диски |
