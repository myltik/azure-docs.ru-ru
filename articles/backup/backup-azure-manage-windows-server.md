---
title: Управление хранилищами и серверами служб восстановления Azure | Microsoft Docs
...
3. Выберите в списке имя хранилища, которое нужно просмотреть, чтобы открыть колонку панели мониторинга хранилища служб восстановления.
