...
1. [Установите последнюю версию агента виртуальной машины Azure](https://acom-swtest-2.azurewebsites.net/documentation/articles/virtual-machines-linux-update-agent/).
...
Если расширение резервного копирования по-прежнему не удастся обновить или загрузить, попробуйте принудительно перезагрузить расширение VMSnapshot, установив это расширение. Расширение будет перезагружено при следующей попытке резервного копирования.
