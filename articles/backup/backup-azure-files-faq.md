...
### <a name="why-cant-i-protect-file-shares-connected-to-a-sync-group-in-azure-file-sync-br"></a>Почему я не могу защитить файловые ресурсы, подключенные к группе синхронизации в службе "Синхронизация файлов Azure"? <br/>
Функция защиты файловых ресурсов Azure, подключенных к группам синхронизации, доступна в режиме ограниченной предварительной версии. Отправьте электронное сообщение по адресу [AskAzureBackupTeam@microsoft.com](email:askazurebackupteam@microsoft.com), указав идентификатор подписки, в рамках которой нужно получить доступ. 
