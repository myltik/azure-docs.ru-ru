...
Независимо от того, отправляются архивные данные в Azure или сохраняются в локальной среде, Сервер резервного копирования Azure должен быть зарегистрирован в хранилище.
