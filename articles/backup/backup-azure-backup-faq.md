...
Да. Начиная с сентября 2016 года можно создать 25 резервных хранилищ на подписку. Можно создать не более 25 хранилищ служб восстановления на каждый поддерживаемый регион службы архивации Azure на подписку. Если вам нужно больше хранилищ, создайте дополнительную подписку.
...
Да, хранилища службы архивации по-прежнему поддерживаются. Хранилища службы архивации можно создать на [классическом портале](https://manage.windowsazure.com). Хранилища служб восстановления можно создать на [портале Azure](https://portal.azure.com). Мы настоятельно рекомендуем создать хранилище служб восстановления, так как все новые улучшения будут доступны только в этом решении.
