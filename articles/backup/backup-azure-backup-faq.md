...
**ВОПРОС 5. Данные архивации для виртуальной машины Azure шифруются?** <br/> ОТВЕТ 5. Служба архивации Azure работает в соответствии с параметрами шифрования, заданными в виртуальной машине Azure для резервных копий. Если ваша виртуальная машина зашифрована с помощью службы шифрования дисков Azure, служба архивации Azure обеспечивает безопасность данных именно с помощью этого шифрования.  
