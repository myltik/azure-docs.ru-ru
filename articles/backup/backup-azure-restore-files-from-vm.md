...
5. Запустите исполняемый файл или сценарий на компьютере, на который вы хотите восстановить файлы. Это нужно делать от имени администратора. Если скрипт выполняется на компьютере с ограниченным доступом, убедитесь в наличии доступа к следующим ресурсам:
