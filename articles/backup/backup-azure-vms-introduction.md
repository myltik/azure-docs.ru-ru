...
- Не планируйте одновременный запуск резервного копирования более четырех классических виртуальных машин из одной облачной службы. Если необходимо настроить резервное копирование большего количества виртуальных машин из одной облачной службы, рекомендуем запускать такие задания с промежутком в один час.
- Не планируйте одновременное резервное копирование более 40 виртуальных машин, развернутых в Resource Manager.
