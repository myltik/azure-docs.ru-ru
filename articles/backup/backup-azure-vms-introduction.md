...
## Рекомендации
Ниже приведены рекомендации, которые следует учитывать при настройке архивации виртуальных машин.

- Не планируйте одновременную архивацию более 4 классических виртуальных машин из одной облачной службы. Если необходимо настроить архивацию большего количества виртуальных машин из одной облачной службы, рекомендуем задать расписание архивации с разницей в один час. 
- Не планируйте архивацию более 40 виртуальных машин Resource Manager одновременно.
- Планируйте архивацию на периоды низкой нагрузки виртуальных машин. Таким образом служба архивации получает достаточное количество операций ввода-вывода в секунду для передачи данных из учетной записи хранения клиента в хранилище архивации. 
- Виртуальные машины, предусмотренные политикой, должны быть распределены из разных учетных записей хранения. Если в одной учетной записи хранения хранится более 20 дисков из виртуальных машин, рекомендуется задать для этих виртуальных машин разные расписания архивации, чтобы получить необходимое число операций ввода-вывода в секунду во время этапа передачи резервной копии.
- Не рекомендуется восстанавливать виртуальную машину, которую запущено в хранилище класса Premium, в ту же учетную запись хранения, так как эта операция может повлиять на операцию архивации и уменьшит количество доступных операций ввода-вывода в секунду. 
- Рекомендуется хранить виртуальные машины Premium в разных учетных записях хранения класса Premium, чтобы получить высокую производительность во время архивации. 
