...
- Время ожидания в очереди. Так как служба архивации обрабатывает резервные копии от нескольких пользователей, резервное копирование может начаться не сразу. В часы пиковой нагрузки время ожидания может достигать 8 часов из-за количества обрабатываемых резервных копий. Но даже при ежедневном резервном копировании общее время резервного копирования виртуальной машины не будет превышать 24 часов.
