...
Служба архивации Azure создает полные резервные копии VSS виртуальных машин Windows. Узнайте больше о [полной резервной копии VSS](http://blogs.technet.com/b/filecab/archive/2008/05/21/what-is-the-difference-between-vss-full-backup-and-vss-copy-backup-in-windows-server-2008.aspx). Чтобы включить копирующую архивацию VSS, для виртуальной машины необходимо задать приведенный ниже ключ реестра.
