...
6. Отобразится сообщение об успешном создании хранилища, а на странице служб восстановления хранилище будет иметь активное состояние. Сразу после создания хранилища убедитесь, что выбрано соответствующее значение избыточности хранилища. Узнайте больше о [настройке избыточности хранилища в хранилище службы архивации](backup-configure-vault.md#azure-backup---storage-redundancy-options). ![Список хранилищ службы архивации](./media/backup-azure-vms-introduction/backup_vaultslist.png)
