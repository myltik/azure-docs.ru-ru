...
Служба архивации Azure по установленному расписанию запускает задание резервного копирования. При этом модуль резервного копирования создает снимок текущего состояния. В случае виртуальных машин Windows создание моментального снимка координируется со службой теневого копирования томов (VSS), что позволяет создать согласованный моментальный снимок дисков виртуальной машины без остановки ее работы. Для виртуальных машин Linux клиенты могут написать собственные пользовательские сценарии, которые будут вызываться при создании моментального снимка виртуальной машины и обеспечивать согласованность, как описано далее в этой статье. 
...
Служба архивации Azure предоставляет платформу, обеспечивающую клиентам возможность гибкого управления рабочим процессом архивации и средой, выполняя предварительный и последующий сценарии в процессе архивации виртуальных машин, которые обеспечивают согласованность приложений. Предварительный сценарий будет вызываться до создания моментального снимка виртуальной машины, а последующий сценарий — после его создания. Для получения дополнительных сведений прочитайте раздел [Application Consistent backup of Azure Linux VMs (Preview)](https://docs.microsoft.com/azure/backup/backup-azure-linux-app-consistent) (Архивация виртуальных машин Linux в Azure с согласованием приложений (предварительная версия)). 
> [!NOTE]
> Служба архивации Azure вызывает только написанные и управляемые клиентом предварительный и последующий сценарии, которые должны обеспечить согласованность приложений. Служба архивации Azure пометит точку восстановления как согласованную по приложениям, если будут успешно выполнены предварительный и последующий сценарии. 
>
