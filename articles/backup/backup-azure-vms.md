...
6. Для просмотра списка заданий **Настройки защиты** из меню "Хранилища" щелкните **Задания** и выберите **Настроить защиту** для фильтра **Операция**.
...
## Устранение ошибок
Если во время архивации виртуальной машины возникнут проблемы, см. [Руководство по устранению неполадок виртуальной машины](backup-azure-vms-troubleshoot.md).
