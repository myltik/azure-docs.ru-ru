...
Есть несколько моментов, которые необходимо уладить до выполнения резервного копирования виртуальной машины Azure. Выполните [необходимые требования](backup-azure-vms-prepare.md) (если вы еще этого не сделали), чтобы подготовить среду к резервному копированию виртуальных машин.

Если вам нужна информация о [планировании инфраструктуры резервного копирования виртуальных машин в Azure](backup-azure-vms-introduction.md) или о [виртуальных машинах Azure](https://azure.microsoft.com/documentation/services/virtual-machines/), перейдите по соответствующим ссылкам.
...
3. В нижней части страницы щелкните **ОБНАРУЖИТЬ**. ![кнопка обнаружения](./media/backup-azure-vms/discover-button-only.png)
