...
Есть несколько моментов, которые необходимо уладить до выполнения резервного копирования виртуальной машины Azure. Если вы еще этого не сделали, выполните [необходимые требования](backup-azure-vms-prepare.md) для подготовки среды к архивации виртуальных машин.
...
1. Перейдите на [классический портал](http://manage.windowsazure.com/).
...
3. Из списка хранилищ архивации выберите хранилище для архивации виртуальной машины.
    ...
    Если это новое хранилище, на портале откроется страница **Быстрый запуск**.
...
5. Выберите **диапазон хранения**, который нужно связать с резервными копиями.
    ...
    - **Политика хранения при еженедельной архивации**. Архивы, создаваемые каждое воскресенье, хранятся в течение 104 недель.
    - **Политика хранения при ежемесячной архивации**. Архивы, создаваемые в последнее воскресенье каждого месяца, хранятся в течение 120 месяцев.
    - **Политика хранения при ежегодной архивации**. Архивы, создаваемые каждое первое воскресенье января, хранятся в течение 99 лет.
...
6. Для просмотра списка заданий **Настройки защиты** в меню "Хранилища" щелкните **Задания** и выберите **Настроить защиту** для фильтра **Операция**.
...
1. В нижней части страницы **Защищенные элементы** щелкните **Создать службу архивации**.
...
После обеспечения защиты число виртуальных машин также увеличивается на странице сводки **Панели мониторинга**. На странице **Панель мониторинга** также отображается количество *успешных*, *завершившихся неудачно* и *выполняющихся* заданий за последние 24 часа. На странице **Задания** используйте меню **Состояние**, **Операция**, **Из** и **В** для фильтрации заданий.
