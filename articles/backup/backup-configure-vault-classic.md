---
title: "Архивация сервера или клиента Windows в Azure с использованием классической модели развертывания | Документация Майкрософт"
...
---
# <a name="back-up-a-windows-server-or-client-to-azure-using-the-classic-deployment-model"></a>Архивация сервера или клиентского компьютера Windows в Azure с использованием классической модели развертывания
...
## <a name="step-1-create-a-backup-vault"></a>Шаг 1. Создание хранилища архивации
...
### <a name="to-create-a-backup-vault"></a>Создание хранилища службы архивации
1. Войдите на [классический портал Azure](https://manage.windowsazure.com/).
2. Щелкните **Создать** > **Службы данных** > **Службы восстановления** > **Хранилище архивации** и **Быстрое создание**.
...
6. Выберите параметр избыточности хранилища, выполнив описанные ниже действия.
   
   > [!IMPORTANT]
   > Наилучшее время для определения параметров избыточности хранилища — сразу после его создания и перед регистрацией в нем компьютеров. После регистрации элемента в хранилище параметр избыточности хранилища блокируется и впоследствии не может быть изменен.
   > 
   > 
    ...
    **Выбор параметров избыточности хранилища:**
    ...
    d. На панели навигации слева щелкните **Службы восстановления**, чтобы вернуться к списку ресурсов служб восстановления.

## <a name="step-2-download-the-vault-credential-file"></a>Шаг 2. Скачивание файла учетных данных хранилища
...
Ознакомьтесь с дополнительными сведениями об [использовании учетных данных хранилища для прохождения аутентификации в службе архивации](backup-introduction-to-azure-backup.md#what-is-the-vault-credential-file).
...
## <a name="step-3-download-install-and-register-the-backup-agent"></a>Шаг 3. Скачивание, установка и регистрация агента службы архивации
