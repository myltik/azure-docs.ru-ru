...
1. Откройте агент Microsoft Azure Backup. Он открывается автоматически, если вы оставили установленным флажок **Запустить агент служб восстановления Microsoft Azure** при закрытии мастера регистрации сервера. Его можно найти, выполнив поиск строки **Microsoft Azure Backup** на компьютере.
...
* [Резервное копирование рабочих нагрузок с использованием Microsoft Azure Backup Server](backup-azure-microsoft-azure-backup.md)
