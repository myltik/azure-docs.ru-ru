...
В январе 2017 года корпорация Майкрософт выпустила обновление предварительной версии для агента служб восстановления Microsoft Azure. Наряду с исправлениями ошибок это обновление реализует функцию мгновенного восстановления, которая позволяет подключить доступный для записи моментальный снимок точки восстановления в качестве тома восстановления. Вы сможете изучить этот том восстановления и выборочно восстановить файлы из него, то есть скопировать их на локальный компьютер.

> [!NOTE]
> Если вы хотите использовать мгновенное восстановление для восстановления данных, необходимо использовать [обновление службы архивации Azure за январь 2017 года](https://support.microsoft.com/en-us/help/3216528?preview). Кроме того, архивные данные должны быть защищены в хранилищах в местонахождениях, перечисленных в статье технической поддержки. В описании [обновления службы архивации Azure за январь 2017 года](https://support.microsoft.com/en-us/help/3216528?preview) вы найдете актуальный список регионов, поддерживающих мгновенное восстановление. В настоящее время мгновенное восстановление доступно **не во всех** регионах.
>
