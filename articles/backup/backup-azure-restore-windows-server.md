---
title: Восстановление данных на сервере Windows Server или клиентском компьютере Windows из Azure с помощью модели развертывания Resource Manager | Microsoft Docs
