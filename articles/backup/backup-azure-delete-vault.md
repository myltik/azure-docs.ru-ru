---
title: " Удаление резервного хранилища в Azure | Документация Майкрософт "
...
Удаление хранилища служб восстановления выполняется в одно действие *при условии, что в хранилище нет ресурсов*. Прежде чем удалить хранилище служб восстановления, необходимо удалить все ресурсы в нем. Попытка удалить хранилище, содержащее ресурсы, завершится ошибкой, как показано на следующем рисунке.
...
4. Прежде чем удалить элемент из хранилища, обеспечивающего защиту виртуальной машины, нужно остановить задание архивации элемента и удалить данные точки восстановления. Для каждого элемента в хранилище выполните следующие действия.
    ...
    После завершения задания отобразится сообщение о том, что процесс архивации остановлен и архивные данные элемента удалены.
