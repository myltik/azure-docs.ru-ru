...
Если у вас возникли проблемы при выполнении задач, описанных в этой статье, изучите статью по [устранению неполадок](backup-azure-vms-troubleshoot.md).
