...
Выполните следующие действия, чтобы настроить задание архивации в колонке управления виртуальной машиной на портале Azure. Следующие шаги применяются только к виртуальным машинам на портале Azure.
