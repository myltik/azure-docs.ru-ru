...
2. Последовательно выберите пункты **Создать** -> **Службы данных** -> **Службы восстановления** -> **Хранилище службы архивации** и **Быстрое создание**.

  ![Создать хранилище][1]

3. В поле **Имя** укажите понятное имя для идентификации хранилища службы архивации. Это имя должно быть уникальным для каждой подписки.

4. В поле **Регион** выберите географический регион хранилища службы архивации. Выбор определяет географическое расположение, куда отправляются ваши резервные данные. Выбирая географическое расположение, которое находится недалеко от вашего местоположения, можно уменьшить задержки сети при резервном копировании в Azure.
