...
1. Восстановление дисков из резервного хранилища с помощью [PowerShell службы архивации Azure](https://azure.microsoft.com/en-in/documentation/articles/backup-azure-vms-automation/#restore-an-azure-vm)
...
2. Создайте конфигурацию виртуальной машины, необходимой для балансировщика нагрузки, нескольких сетевых адаптеров или зарезервированных IP-адресов с помощью командлетов PowerShell и используйте ее для создания виртуальной машины с желаемой конфигурацией.
	- Создайте виртуальную машину в облачной службе с [внутренним балансировщиком нагрузки](https://azure.microsoft.com/ru-RU/documentation/articles/load-balancer-internal-getstarted/).
	...
	- Создайте виртуальную машину с [несколькими сетевыми адаптерами](https://azure.microsoft.com/en-in/documentation/articles/virtual-networks-multiple-nics).
	- Создайте виртуальную машину с [несколькими зарезервированными IP-адресами](https://azure.microsoft.com/en-in/documentation/articles/virtual-networks-reserved-public-ip/).
