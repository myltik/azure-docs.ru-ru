<properties
    pageTitle="Управление хранилищами и серверами службы архивации Azure с помощью классической модели развертывания | Microsoft Azure"
...
[AZURE.INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-classic-include.md)] Модель развертывания диспетчера ресурсов.
