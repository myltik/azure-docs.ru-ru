---
title: "Использование управления доступом на основе ролей Azure для управления резервными копиями | Документация Майкрософт"
...
# <a name="use-role-based-access-control-for-backup-management"></a>Использование управления доступом на основе ролей для управления резервными копиями
