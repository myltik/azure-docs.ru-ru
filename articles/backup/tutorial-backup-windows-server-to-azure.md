...
6. На странице **Задайте расписание архивации** укажите время или неделю, когда нужно активировать архивацию файлов и папок. Расписание архивации состояния системы настраивается автоматически. 

    ![Download Agent for Windows Server or Windows Client](./media/tutorial-backup-windows-server-to-azure/mars-schedule-backup.png)
 


7.  На странице **выбора политики хранения** выберите политику хранения для резервной копии файлов и папок. Для срока хранения резервных копий состояния системы автоматически задается значение 60 дней.
...
2.  На странице **Подтверждение** проверьте параметры, которые мастер **мгновенной архивации** будет использовать для архивации данных на сервере. Затем нажмите кнопку **Архивировать**.
