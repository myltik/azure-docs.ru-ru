...
![Обобщенное представление процесса резервного копирования виртуальной машины.](./media/backup-azure-vms-first-look/BackupAzureVM.png)


1. Создание подписки Azure или вход в нее.
2. Создание хранилища службы архивации или определение существующего хранилища службы архивации *в том же регионе, в котором расположена виртуальная машина*.
3. Обнаружение и регистрация виртуальных машин в подписке с помощью портала Azure.
4. Установка агента VM на виртуальной машине (если используется виртуальная машина из коллекции Azure, агент VM может быть уже установлен).
5. Создание политики для защиты виртуальных машин.
6. Выполнение резервного копирования.
...
5. В разделе **Настройка защиты** выберите существующую политику или создайте новую, чтобы защитить указанные виртуальные машины.
