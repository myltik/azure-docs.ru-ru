...
В этом руководстве описана процедура резервного копирования виртуальной машины (ВМ) в Azure. Для успешного выполнения заданий этого руководства необходимо предварительно:
