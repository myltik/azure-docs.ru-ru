...
2. На экране **Выбор типа группы защиты** мастера **Создание новой группы защиты** выберите **Серверы** и нажмите кнопку **Далее**.
...
4. На экране **Выбор метода защиты данных** введите имя *группы защиты* и выберите желаемый *метод защиты*. Нажмите кнопку **Далее**.
...
5. На экране **Выбор краткосрочных целей** выберите желаемый *диапазон хранения* и укажите время создания резервных копий.
...
9. На экране **Указание данных для оперативной защиты** выберите ферму SharePoint, которую нужно защитить, и нажмите кнопку **Далее**.

    ![DPM SharePoint Protection1](./media/backup-azure-backup-sharepoint/select-online-protection1.png)

10. На экране **Укажите расписание архивации в сети** выберите желаемое расписание и нажмите кнопку **Далее**.
...
11. В зависимости от выбранного расписания архивации на экране **Укажите политику хранения в сети** выберите политику хранения для ежедневных, еженедельных, ежемесячных и ежегодных точек резервного копирования.
...
5. Можно просмотреть разные точки восстановления и выбрать базу данных или элементы для восстановления. Выберите **дату и время восстановления**, а затем выберите **базу данных, ферму SharePoint, точку восстановления и элемент**.
...
8. Выберите желаемый **процесс восстановления**.
    ...
    - Если с момента создания точки восстановления ферма SharePoint изменилась, выберите **Восстановить с помощью фермы восстановления**.
...
4. Щелкните объект SharePoint на вкладке **Восстановление** DPM, чтобы получить структуру базы данных содержимого. Щелкните правой кнопкой мыши и выберите параметр **Восстановить**.
