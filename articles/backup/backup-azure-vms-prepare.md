...
7. Успешное создание хранилища подтверждается сообщением. На странице **служб восстановления** будет указано состояние хранилища **Активно**. Сразу после создания хранилища выберите соответствующее значение избыточности хранилища. Ознакомьтесь с дополнительными сведениями о [настройке избыточности хранилища в хранилище службы архивации](backup-configure-vault.md#create-a-recovery-services-vault).
