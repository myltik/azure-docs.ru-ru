...
2. На портале Azure последовательно щелкните **Создать** > **Гибридная интеграция** > **Резервное копирование**. При нажатии кнопки **Резервное копирование** выполняется автоматический переход на классический портал (см. после примечания).
