...
| Архивация | Произошла внутренняя ошибка архивации. Повторите операцию через несколько минут. Если проблема будет повторяться, обратитесь в службу поддержки Майкрософт | Проверьте, возникает ли временная проблема при доступе к хранилищу виртуальной машины. Проверьте [состояние Azure](https://azure.microsoft.com/ru-RU/status/), чтобы определить, имеются ли в настоящее время проблемы, связанные с вычислительными, сетевыми ресурсами или ресурсами хранилища в регионе. Повторите попытку, чтобы проверить, что проблема архивации устранена. |
| Архивация | Не удалось выполнить операцию, так как виртуальная машина больше не существует. | Нельзя выполнять архивацию, так как виртуальная машина, настроенная для архивации, была удалена. Остановите следующие операции архивации, перейдя к представлению "Архивируемый элемент" (выберите "Параметры" > "Архивные элементы" > имя элемента) и щелкнув "Остановить архивацию". Можно сохранить данные, выбрав параметр "Сохранить данные архивации". Позднее можно возобновить защиту этой виртуальной машины, щелкнув "Возобновить архивацию".|
