...
| Зарегистрировать | Произошла внутренняя ошибка службы архивации Microsoft Azure. Подождите несколько минут и снова запустите операцию. Если проблема будет повторяться, обратитесь в службу поддержки Майкрософт. | Эта ошибка может возникнуть из-за следующей неподдерживаемой конфигурации: <ul><li>локально избыточное хранилище класса Premium</ul>. Виртуальные машины хранилища класса Premium можно архивировать с использованием хранилища служб восстановления. [Дополнительные сведения](backup-introduction-to-azure-backup.md/#back-up-and-restore-premium-storage-vms) |
