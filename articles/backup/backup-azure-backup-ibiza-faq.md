...
В этой статье описывается хранилище служб восстановления. Она дополняет статью [Служба архивации Azure: часто задаваемые вопросы](backup-azure-backup-faq), содержащую полный набор вопросов и ответов о службе архивации Azure.
...
## Хранилища служб восстановления работают на основе модели развертывания Resource Manager. Поддерживаются ли еще хранилища службы архивации для классической модели развертывания? <br/>
