---
title: "Подготовка среды к архивации рабочих нагрузок с помощью Сервера резервного копирования Azure | Документация Майкрософт"
description: "Подготовка среды к использованию сервера резервного копирования Azure для защиты или резервного копирования рабочих нагрузок."
services: backup
documentationcenter: 
author: PVRK
manager: shivamg
...
5. В открывшемся разделе "Приступая к работе" будет автоматически выбран экран целей архивации.
...
7. В открывшейся колонке **Подготовка инфраструктуры** щелкните ссылки **Скачать**, чтобы установить сервер резервного копирования Azure и скачать учетные данные хранилища. Эти учетные данные используются для регистрации сервера службы архивации Azure в хранилище служб восстановления. В результате откроется страница Центра загрузки, где можно скачать программный пакет.
