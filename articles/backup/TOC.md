...
## Резервное копирование рабочих нагрузок приложений
...
### [Хранилище служб восстановления — вопросы и ответы](backup-azure-backup-ibiza-faq.md)
...
### [Резервное копирование виртуальных машин Azure в хранилище резервных копий](backup-azure-vms.md)
### [Резервное копирование виртуальных машин Azure в хранилище служб восстановления](backup-azure-arm-vms.md)
### [Резервное копирование и восстановление зашифрованных виртуальных машин](backup-azure-vms-encryption.md)
...
## Резервное копирование виртуальных машин под управлением Windows
