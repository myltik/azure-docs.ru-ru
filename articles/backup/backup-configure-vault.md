...
1. В колонке **Параметры**, которая автоматически откроется с панелью мониторинга хранилища, щелкните **Инфраструктура резервного копирования**.
2. В колонке "Инфраструктура резервного копирования" щелкните **Конфигурация архивации**, чтобы просмотреть **тип репликации хранилища**.
...
## <a name="step-2-download-files"></a>Шаг 2. Скачивание файлов
> [!NOTE]
...
4. В меню "Где выполняется рабочая нагрузка?" выберите **Локально**.
5. В меню "Что вы хотите резервировать?" выберите **Файлы и папки** и нажмите кнопку **ОК**.

#### <a name="download-the-recovery-services-agent"></a>Скачивание агента служб восстановления
1. В колонке **Подготовка инфраструктуры** щелкните **Скачать агент для Windows Server или Windows Client**.
...
1. В колонке "Подготовка инфраструктуры" щелкните **Скачать > Сохранить**.

    ![Download Agent for Windows Server or Windows Client](./media/backup-configure-vault/prepare-infrastructure-download.png)

## <a name="step-3-install-and-register-the-agent"></a>Шаг 3. Установка и регистрация агента
...
### <a name="confirm-the-installation"></a>Подтверждение установки
...
2. В главном меню щелкните **Обзор**, а затем в списке ресурсов введите **Службы восстановления**. Как только вы начнете вводить, список отфильтруется соответствующим образом. Щелкните **Хранилища служб восстановления**.
    ...
    После этого отобразится список хранилищ служб восстановления.
3. Выберите имя хранилища, которое вы создали.
...
4. Нажмите кнопку **Параметры** в верхней части страницы.
5. Щелкните **Инфраструктура резервного копирования > Рабочие серверы**.
...
## <a name="step-4-complete-the-initial-backup"></a>Шаг 4. Выполните начальную архивацию
