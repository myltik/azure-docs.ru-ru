...
В этой статье приведены инструкции по подготовке к использованию службы архивации Azure с Windows Servers. Чтобы создать резервную копию Windows Server или клиента Windows Client в Azure, вам потребуется учетная запись Azure. Если ее нет, можно создать бесплатную пробную учетную запись всего за несколько минут. Дополнительные сведения см. в разделе [Бесплатная пробная версия Azure](https://azure.microsoft.com/pricing/free-trial/).
