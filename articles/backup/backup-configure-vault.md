...
Политика архивации — это расписание, которое определяет частоту и время создания точек восстановления, а также срок хранения каждой резервной копии. Используйте агент службы архивации Microsoft Azure для создания политики архивации файлов и папок.
...
1. В агенте службы архивации Microsoft Azure щелкните **Изменить свойства**.
