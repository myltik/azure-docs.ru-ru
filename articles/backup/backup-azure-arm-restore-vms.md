...
> [!NOTE]
> Шаблоны будут добавляться к восстановленным дискам для точек восстановления, созданных после 1 марта 2017 года. Они применимы к виртуальным машинам с неуправляемыми дисками. Поддержка виртуальных машин с управляемыми дисками будет реализована в будущих выпусках. 
>
>
