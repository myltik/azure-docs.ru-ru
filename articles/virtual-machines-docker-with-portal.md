...
Нажмите и скопируйте имя домена виртуальной машины и в командной строке клиентского компьютера введите `docker --tls -H tcp://`*dockerextension*`.cloudapp.net:4243 info` (замените  *dockerextension* на имя дочернего домена виртуальной машины). 
...
Вы готовы перейти к [руководству пользователя Docker] и использовать виртуальную машину Docker. Для быстрого и многократного создания виртуальных машин Docker в Azure см. раздел [Использование расширения виртуальных машин Docker в межплатформенном интерфейсе Azure (xplat-cli)]
...
[Ссылка 3 на другой раздел документации на сайте azure.microsoft.com]: ../storage-whatis-account/
