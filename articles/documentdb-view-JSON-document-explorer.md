...
##<a id="Launch"></a>Запуск и навигация обозревателя документов##
...
5. Обозреватель документов также поддерживает фильтрацию загруженного в настоящий момент времени набора документов по их свойству идентификатора.  Достаточно просто ввести в поле фильтра.
	...
	> [AZURE.ВАЖНО] Функциональные возможности фильтрации обозревателя документов обеспечивают только фильтрацию загруженного в ***настоящее время*** набора документов и не выполняет запросы к выбранной в данный момент коллекции.
...
##<a id="Create"></a>Просмотр, создание и изменения документов с помощью обозревателя документов##
