...
**Группе контейнеров** выделяется как минимум один виртуальный процессор и 1 ГБ памяти. Отдельным **контейнерам** может предоставляться менее одного виртуального процессора и 1 ГБ памяти. В пределах группы контейнеров можно настроить распределение ресурсов для нескольких контейнеров с учетом ограничений, установленных на уровне группы контейнеров. Например, два контейнера, на каждый из которых выделено 0,5 виртуальных процессора, находятся в группе контейнеров, на которую выделен один виртуальный процессор.
