---
title: "Создание многоконтейнерной группы при помощи службы \"Экземпляры контейнеров Azure\" | Документация Azure"
description: "Создание многоконтейнерной группы и ее развертывание в службе \"Экземпляры контейнеров Azure\" из реестра контейнеров Azure"
