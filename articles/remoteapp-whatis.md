...
Ниже представлены дополнительные сведения о RemoteApp, но если мы уже убедили вас, [попробуйте прямо сейчас](http://azure.microsoft.com/services/remoteapp/).

У вас есть вопросы по Azure RemoteApp? Читайте раздел [Вопросы и ответы](http://azure.microsoft.com/documentation/articles/remoteapp-faq/).
...
[Облачная коллекция RemoteApp](http://azure.microsoft.com/documentation/articles/remoteapp-create-cloud-deployment/) позволяет автономно размещать приложения в облаке. Облачная коллекция существует только в облаке Azure и не подключается к локальной сети.
...
- [Создание настраиваемого образа шаблона для RemoteApp](http://azure.microsoft.com/documentation/articles/remoteapp-create-custom-image/)
...
- [Как работает лицензирование в RemoteApp?](http://azure.microsoft.com/documentation/articles/remoteapp-licensing/)
- [Рекомендации по настройке и использованию Azure RemoteApp](http://azure.microsoft.com/documentation/articles/remoteapp-bestpractices/)
- [Azure RemoteApp: вопросы и ответы](http://azure.microsoft.com/documentation/articles/remoteapp-faq/)
