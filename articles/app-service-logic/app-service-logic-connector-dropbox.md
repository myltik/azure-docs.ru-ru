<properties
	pageTitle="Использование соединителя Dropbox в приложении логики в службе приложений Azure"
	description="начало работы с соединителем Dropbox в приложении логики в службе приложений"
...
Соединитель Dropbox можно использовать как действие в приложении логики. Он поддерживает данные в форматах JSON и XML. В соединителе Chatter доступны следующие триггеры и действия.
