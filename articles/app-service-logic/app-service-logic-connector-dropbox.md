...
2.	Соединитель Dropbox будет указан в коллекции: ![][4]
3.	Выберите соединитель Dropbox, чтобы автоматически добавить его в конструктор. Выберите **Авторизовать**, введите свои учетные данные, а затем выберите **Разрешить**: ![][5] ![][6] ![][7]

Теперь можно использовать соединитель Dropbox в потоке. Можно использовать действие Dropbox «Передать файл» для передачи файла в учетную запись Dropbox: ![][8] ![][9]
