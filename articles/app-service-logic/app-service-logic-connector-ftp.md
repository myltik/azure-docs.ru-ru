...
Щелкните триггер «Доступный файл (Прочтите и удалите)»
...
Если нажать кнопку с многоточием (...), отобразятся дополнительные входные параметры.
...
Предоставьте входные параметры и щелкните значок галочки, чтобы завершить входную конфигурацию.

![Основные входные параметры триггера FTP][9]

Обратите внимание, что настроенный триггер FTP отображает как настроенные входные параметры, так и выходные параметры.
...
Для параметра «Путь к файлу» установлено
