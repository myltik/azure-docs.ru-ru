---
title: Использование соединителя FTP в приложениях логики | Microsoft Docs
...
> [!NOTE]
> Эта версия статьи предназначена для приложений логики со схемой версии 2014-12-01-preview. Чтобы узнать версию схемы 2015-08-01-preview, щелкните [API FTP](../connectors/connectors-create-api-ftp.md).
> 
> 
