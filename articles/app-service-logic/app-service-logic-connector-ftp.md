...
- В открывшейся колонке соединителя FTP укажите следующие данные.
...
Укажите входные параметры и щелкните значок флажка, чтобы завершить конфигурацию входных данных.
