...
### Добавление триггера
1. При создании или изменении приложения логики выберите соединитель SQL, созданный в качестве триггера. Будет выведен список доступных триггеров: **Опрос данных (JSON)** и **Опрос данных (XML)**. ![][5]

2. Выберите триггер **Опрос данных (JSON)**, укажите частоту и щелкните ✓. ![][6]
