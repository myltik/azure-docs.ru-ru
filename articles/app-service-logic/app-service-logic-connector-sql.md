...
--- | --- | ---
Выражение WHERE | <ul><li>Операторы: AND, OR, =, <>, <, < =, >, > = и LIKE</li><li>Несколько вложенных условий можно объединить при помощи «(« и «)»</li><li>Строковые литералы, дата и время (заключается в одинарные кавычки), числа (должны содержать только цифры)</li><li>Должно быть строго в виде двоичного выражения, например ((операнд оператор операнд) AND/OR (операнд оператор операнд))**</li></ul> | <ul><li>Операторы: Between, IN</li><li>Все встроенные функции, такие как ADD(), MAX(), NOW(), POWER() и т. д.</li><li>Математические операторы, такие как *, -, +, и т. д.</li><li>Объединение строк с помощью +.</li><li>Все соединения</li><li>IS NULL и IS NOT Null</li><li>Любые числа с нецифровыми символами, например шестнадцатеричные числа</li></ul>Поля (в запросе Select) | <ul><li>Допустимые имена столбцов, разделенные запятыми. Префиксы имен таблиц не допускаются (этот соединитель работает не более чем с одной таблицей одновременно).</li><li>Имена можно экранировать при помощи квадратных скобок «[» и «]»</li></ul> | <ul><li>Ключевые слова, например TOP, DISTINCT и т. д.</li><li>Псевдонимы, например Street + City + Zip AS Address</li><li>Все встроенные функции, такие как ADD(), MAX(), NOW(), POWER() и т. д.</li><li>Математические операторы, такие как *, -, + и т. д.</li><li>Объединение строк с помощью +</li></ul>
