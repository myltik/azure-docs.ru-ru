...
|Имя|Ограничение|Примечания|
|----|----|----|
|Элементы ForEach|10 000|При необходимости можно использовать [действие запроса](../connectors/connectors-native-query.md) для фильтрации больших массивов|
...
|Число последовательностей в регионе на подписку|1000||
