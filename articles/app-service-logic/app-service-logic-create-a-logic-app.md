...
2. После его загрузки нажмите кнопку **Авторизовать**, войдите в свою учетную запись Twitter и щелкните **Авторизовать приложение**.
	...
	> [AZURE.NOTE]После нажатия кнопки **Авторизовать** для подключения к службам SaaS, например Twitter, используется стандарт OAUTH. Дополнительные сведения о безопасности стандарта OAUTH см. [здесь](app-service-logic-oauth-security.md).
