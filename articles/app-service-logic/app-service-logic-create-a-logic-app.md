...
3. Выберите «Параметры пакета» и введите данные из своего приложения Twitter. Чтобы настроить бесплатное приложение, выполните следующие действия.
...
9. Теперь повторите эти действия для [Dropbox](https://portal.azure.com/#create/microsoft_com.DropboxConnector.0.2.2).
...
2. В верхней части щелкните **Повторение**.
...
2. После его загрузки нажмите кнопку **Авторизовать**, войдите в свою учетную запись Twitter и щелкните **Авторизовать приложение**.
	...
	> [AZURE.NOTE]При нажатии кнопки **Авторизовать** для подключения к службам SaaS, таким как Twitter, используются средства защиты OAUTH. Дополнительные сведения об OAUTH см. в статье [Средства защиты OAUTH](app-service-logic-oauth-security.md).
