<properties
	...
	description="Узнайте, как создать базовое приложение логики службы приложений"
...
3.  Выберите **частоту** и **интервал** повторения (например, один раз каждый час), затем щелкните зеленый флажок.
...
1. В области справа щелкните пункт **Соединитель Twitter**.
