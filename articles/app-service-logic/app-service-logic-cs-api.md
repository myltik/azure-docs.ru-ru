...
- **Выражение C#** — выражение, которое будет оцениваться. Необходимо включить инструкцию `return`, чтобы получить содержимое. 
...
- **Библиотеки** — необязательный массив DLL-файлов для включения в компиляцию скрипта. Массив использует следующую структуру и работает лучше всего вместе с соединителем хранилища больших двоичных объектов с DLL-файлом в качестве выходных данных.
