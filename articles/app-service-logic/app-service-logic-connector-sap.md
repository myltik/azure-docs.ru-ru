...
Перейдите в только что созданное приложение API, последовательно выбрав "Обзор -> Приложения API -> <Имя созданного приложения API>". Далее произойдет следующее. Настройка не завершена, так как гибридное подключение еще не установлено.  
![][2]
...
Дополнительная информация об [интеграции с локальным сервером SAP](app-service-logic-integrate-with-an-on-premise-sap-server.md).
...
При создании или изменении приложения логики выберите приложение API соединителя SAP, созданное выше. Появится список всех возможных действий, из которого можно выбрать нужное действие.  
![][5]

После выбора действия появится список входных параметров для этого действия. Предоставьте соответствующие значения и щелкните значок галочки.  
![][6]

Шаг или действие будет отображаться в приложении логики как настроенное. Будут отображаться результаты выполнения операции, которые можно использовать в качестве входных данных в следующем шаге.  
![][7]
