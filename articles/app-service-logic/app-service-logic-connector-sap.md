...
Перейдите в только что созданное приложение API, последовательно выбрав "Обзор -> Приложения API -> <Имя созданного приложения API>". Далее произойдет следующее. Настройка не завершена, так как гибридное подключение еще не установлено. ![][2]
