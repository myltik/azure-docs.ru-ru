...
Для подключения к *любой* конечной точке SAP соединителю SAP требуется гибридное соединение. Чтобы установить гибридное подключение, выполните следующие действия.
