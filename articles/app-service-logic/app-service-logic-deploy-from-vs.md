...
5. Состояние развертывания будет отображаться в окне **Вывод** \(возможно, потребуется выбрать пункт **Подготовка Azure**\). ![Выходные данные](./media/app-service-logic-deploy-from-vs/output.png)
