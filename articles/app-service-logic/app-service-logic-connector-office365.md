...
7.	Вы будете перенаправлены на страницу входа в Office 365, где можете пройти проверку подлинности с помощью учетных данных своей учетной записи Office 365. ![][6] ![][7]
...
10.	Измените частоту триггера на «Минуты» и нажмите ✓. ![][9]
...
14.	Укажите сведения о событии и нажмите ✓. ![][12]
...
17.	Нажмите знак плюса (+) рядом с полем «Адрес электронной почты» и выберите значение выходного поля «От» из триггера. ![][14]

18. Нажмите ✓. После этого настройка действия будет завершена. ![][15]
...
24.	Нажмите знак плюса (+) рядом с полем «От», выберите значение из идентификатора входного сообщения в триггере и нажмите ✓. ![][17]
