---
title: Использование соединителя Office 365 в приложениях логики | Microsoft Docs
...
5. Для подключения к Office 365 требуется авторизация приложения логики, чтобы оно имело доступ к вашей учетной записи. Нажмите кнопку «Авторизовать», чтобы предоставить учетные данные для входа в Office 365. ![][5]
6. Вы будете перенаправлены на страницу входа в Office 365, где можете пройти аутентификацию с помощью учетных данных своей учетной записи Office 365. ![][6] ![][7]
7. После выполнения авторизации отображаются триггеры Office 365. ![][8]
8. Выберите триггер «Новое сообщение электронной почты», и появятся входные параметры.
9. Измените частоту триггера на «Минуты» и щелкните ✓. ![][9]
10. Триггер «Новое сообщение» Office 365 теперь настроен, и вы можете видеть, что отображаются также и выходные параметры. ![][10]
11. В разделе «Последние использовавшиеся» коллекции выберите «Соединитель Office 365», и будет добавлено новое действие «Office 365».
12. Выберите «Отправить событие» в списке действий; появятся входные параметры действия «Отправить событие». ![][11]
13. Укажите сведения о событии и нажмите ✓. ![][12]
14. В разделе «Последние использовавшиеся» коллекции выберите «Соединитель Office 365», и будет добавлено новое действие «Office 365».
15. Выберите «Добавить контакт» в списке действий, и появятся входные параметры действия «Добавить контакт». ![][13]
16. Щелкните «+» рядом с полем «Адрес электронной почты» и выберите значение выходного поля «От» из триггера. ![][14]
17. Щелкните ✓. После этого настройка действия будет завершена. ![][15]
18. В разделе «Последние использовавшиеся» коллекции выберите «Соединитель Office 365», и будет добавлено новое действие «Office 365».
19. Выберите «Отправить сообщение электронной почты» в списке действий. Появятся входные параметры действия «Отправить сообщение электронной почты». ![][19]
20. Предоставьте сведения, необходимые для отправки сообщения электронной почты. Вы можете создать сообщение, введя примерно следующее. Настроив действие «Отправить сообщение», нажмите ✓.
    
     Body - @concat('You got a new sales enquiry from',triggers().output.body.From)
    
    ![][20]
21. В разделе «Последние использовавшиеся» коллекции выберите «Соединитель Office 365», и будет добавлено новое действие «Office 365».
22. Выберите «Ответить» в списке действий. Появятся входные параметры действия «Ответить». ![][16]
23. Нажмите знак плюса (+) рядом с полем «От», выберите значение из идентификатора входного сообщения в триггере и нажмите ✓. ![][17]
24. Нажмите кнопку «ОК» на экране редактора приложения логики, а затем нажмите кнопку «Создать». Создание займет приблизительно 30 секунд.
25. Отправьте сообщение электронной почты в учетную запись, которую вы настроили в триггере, и вы должны увидеть сообщение электронной почты в своей личной учетной записи, событие календаря и контакт в вашей почтовой учетной записи Office. Кроме того, вы должны получить ответ с подтверждением, что на ваш запрос на продажу будет вскоре отвечено.
