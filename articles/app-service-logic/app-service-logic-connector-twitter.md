...
4. Щелкните "Параметры пакета" и вставьте ключ потребителя из приложения Twitter в поле clientId. Вставьте секрет клиента из приложения Twitter в поле clientSecret: ![][10]
