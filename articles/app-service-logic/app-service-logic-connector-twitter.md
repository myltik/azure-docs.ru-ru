...
>[AZURE.NOTE] Эта версия статьи предназначена для приложений логики со схемой версии 2014-12-01-preview. Чтобы узнать версию схемы 2015-08-01-preview, щелкните [API Twitter](../connectors/connectors-create-api-twitter.md).
...
> [AZURE.NOTE] Если вы хотите усилить защиту API Twitter, используя URL-адрес перенаправления, воспользуйтесь [защитой OAUTH](app-service-logic-oauth-security.md).
