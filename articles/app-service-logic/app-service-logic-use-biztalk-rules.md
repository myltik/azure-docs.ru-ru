---
title: Узнайте о приложении API правил BizTalk в приложениях логики и научитесь его создавать | Microsoft Docs
...
## Словарь
*Словарь* — это набор определений, состоящий из понятных имен для вычислительных объектов, используемых в условиях и действиях правил. Словарные определения облегчают чтение, понимание и совместное использование правил пользователями в конкретной бизнес-сфере.
...
5. В новой открывшейся колонке введите следующие сведения.
   1. Имя — дайте имя вашему приложению API правил.
   2. План службы приложений: выберите или создайте новый план службы приложений.
   3. Ценовая категория — выберите ценовую категорию для этого приложения.
   4. Группа ресурсов — выберите или создайте группу ресурсов, в которой должно находиться это приложение.
   5. Подписка: выберите нужную подписку.
   6. Расположение — укажите географическое расположение, где планируется развернуть это приложение.
6. Нажмите кнопку *Создать*. В течение нескольких минут ваше приложение API правил BizTalk будет создано.
...
2\. Выберите «Словарные определения». Отобразится экран создания словаря.  

1. Выберите «Добавить», чтобы приступить к добавлению новых словарных определений. 
...
Для создания сложных условных операторов можно использовать поле «Условие» (IF). Далее приводится список поддерживаемых ключевых слов.  
