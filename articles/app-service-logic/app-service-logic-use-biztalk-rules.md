...
При нажатии кнопки «Массовое добавление» открывается новая колонка. Сначала нужно выбрать схему, для которой требуется создать несколько определений. При нажатии этого свойства открывается новая колонка, в которой пользователь может выбрать схему в списке уже отправленных схем или отправить новую схему. Теперь разблокируется свойство XPATHS. При нажатии этого свойства откроется просмотр схемы, где можно выбрать несколько узлов.
