...
Правила BizTalk поддерживают явное прямое построение цепочки. Это означает, что если пользователям требуется повторно оценить правила в ответ на определенные действия, они могут вызвать это с помощью определенных ключевых слов. Далее приведены поддерживаемые ключевые слова.  
