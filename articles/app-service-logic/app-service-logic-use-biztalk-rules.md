...
2\. Выберите «Словарные определения». Отобразится экран создания словаря. 3. Выберите «Добавить», чтобы приступить к добавлению новых словарных определений. В настоящее время поддерживается два типа определений словаря — литеральное и XML.
