---
title: Циклы, области действия и индивидуальная обработка приложений логики | Microsoft Docs
...
> [!NOTE]
> Эта версия статьи предназначена для приложений логики со схемой версии 2016-04-01-preview и более поздних версий. Основные понятия такие же, как в более ранних схемах, но области действий доступны только для этой и более ранних версий схемы.
> 
> 
