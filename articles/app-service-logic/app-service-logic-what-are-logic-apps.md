...
| [Форум о приложениях логики](https://social.msdn.microsoft.com/Forums/home?forum=azurelogicapps) |
...
Как уже упоминалось, с приложениями логики можно автоматизировать бизнес-процессы. Вот несколько примеров:
