...
- **[Соединители.][connectors]** Приложениям логики требуется доступ к данным и службам. Соединитель — это особый вид приложения API. Он создается специально для помощи при подключении к данным и работе с ними. Список доступных в настоящее время соединителей см. в разделе [Использование соединителей][connectors].
