<properties
   ...
   description="Использование соединителя HDInsight в службе приложений Azure"
...
2. Выполните поиск по запросу "Соединитель HDInsight", выберите его, а затем нажмите **Создать**.
...
2. в колонке "Безопасность" щелкните **ЗАГРУЗИТЬ СЕРТИФИКАТ**.
3. Найдите и выберите файл сертификата в следующей колонке.
4. Выбрав сертификат, нажмите кнопку **ОК**.

После успешной загрузки сертификата отобразятся сведения о сертификате: ![][3]

> [AZURE.NOTE]Если вы хотите изменить сертификат, загрузите другой сертификат — он заменит уже существующий.
...
2. Выберите приложение API соединителя HDInsight, созданное из коллекции. Доступны следующие действия: ![][5]

3. Выберите действие "Создать кластер", задайте все необходимые параметры кластера и нажмите ✓: ![][6]

4. Действие будет показано в приложении логики как настроенное. Будут показаны результаты действия, которые можно будет использовать как входные данные в последующих действиях: ![][7]

5. Выберите тот же соединитель HDInsight из коллекции в качестве действия. Выберите действие "Ожидать создания кластера", укажите необходимые параметры и нажмите ✓: ![][8]

6. Выберите тот же соединитель HDInsight из коллекции в качестве действия. Выберите действие "Отправить задание Hive", укажите все необходимые параметры и нажмите ✓: ![][9]

7. Выберите тот же соединитель HDInsight из коллекции в качестве действия. Выберите действие "Ожидать завершения задания", укажите необходимые параметры и нажмите ✓: ![][10]

8. Выберите тот же соединитель HDInsight из коллекции в качестве действия. Выберите действие "Удалить кластер", укажите все необходимые параметры и нажмите ✓: ![][11]
