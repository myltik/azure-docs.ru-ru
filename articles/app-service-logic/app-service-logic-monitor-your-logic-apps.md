...
Если вам нужны дополнительные сведения, например **идентификатор корреляции** выполнения (который может использоваться для REST API), нажмите кнопку **Сведения о выполнении**. Эти подробности включают в себя сведения обо всех шагах, состоянии, а также входных и выходных данных выполнения.
