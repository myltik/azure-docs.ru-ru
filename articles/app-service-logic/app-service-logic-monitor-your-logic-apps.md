...
>[AZURE.NOTE] Все сведения о времени выполнения и события шифруются в службе Logic Apps. Они расшифровываются только по запросу представления пользователем. Доступ к этим событиям можно также контролировать с помощью управления доступом на основе ролей Azure (RBAC).
