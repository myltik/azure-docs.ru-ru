...
Сведения об установке локального шлюза данных можно найти [в этой статье](app-service-logic-gateway-install.md). Шлюз нужно установить на локальном компьютере, прежде чем можно будет продолжить процедуру.
...
1. Введите информацию, которая нужна для связывания шлюза с учетной записью, в том числе выберите соответствующее значение **Installation Name** (Имя установки).
...
1. Выберите **шлюз** для подключения и введите прочую необходимую информацию.
