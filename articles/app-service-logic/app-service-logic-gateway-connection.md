---
title: Подключение приложений логики к локальному шлюзу данных | Microsoft Docs
...
> [!WARNING]
> Сейчас есть следующее ограничение: локальная установка шлюза будет завершена только при использовании учетной записи, зарегистрированной с помощью Power BI. Поэтому для успешного завершения установки вам нужно зарегистрировать любую учетную запись с помощью бесплатной версии Power BI.
> 
> 
...
2. Установите флажок **Connect via on-premises data gateway** (Подключиться через локальный шлюз данных).
