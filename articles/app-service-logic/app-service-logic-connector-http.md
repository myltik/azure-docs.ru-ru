...
2. Выполните поиск по запросу «HTTP», выберите прослушиватель HTTP и нажмите кнопку **Создать**.
...
7.	Чтобы получить полный универсальный код ресурса (URI), дважды щелкните прослушиватель HTTP, чтобы просмотреть его параметры конфигурации, и скопируйте URL-адрес «узла» вашего приложения API. ![][6]
8.	Теперь вы можете использовать данные, полученные в HTTP-запросе, в других действиях в потоке следующим образом. ![][7] ![][8]
