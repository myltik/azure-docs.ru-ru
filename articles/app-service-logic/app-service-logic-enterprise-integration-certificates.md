...
8. Выберите элемент **Сертификаты**. После обновления страницы вы увидите только что добавленный сертификат. ![](./media/app-service-logic-enterprise-integration-certificates/certificate-4.png)

### Закрытый сертификат
Закрытые сертификаты также можно передать в учетную запись интеграции, выполнив следующие действия.

1. [Передайте закрытый ключ в хранилище ключей.](../key-vault/key-vault-get-started.md "Сведения о хранилище ключей")

	> [AZURE.TIP] Службу приложений логики необходимо авторизовать для выполнения операций в хранилище ключей. Субъекту службы приложений логики можно предоставить доступ с помощью этой команды PowerShell: `Set-AzureRmKeyVaultAccessPolicy -VaultName 'TestcertKeyVault' -ServicePrincipalName '7cd684f4-8a78-49b0-91ec-6a35d38739ba' -PermissionsToKeys decrypt, sign, get, list`
...
7. В течение одной минуты появится уведомление о том, что передача сертификата завершена.
8. Выберите элемент **Сертификаты**. Вы увидите только что добавленный сертификат: ![](./media/app-service-logic-enterprise-integration-certificates/privatecertificate-2.png)
