...
С помощью соединителя SAP вы можете подключать веб-приложения, мобильные приложения и приложения логики службы приложений Azure к вашему существующему серверу SAP. Это позволяет вызывать RFC, BAPI, tRFC, а также отправлять IDoc на сервер SAP, даже если он находится за локальным брандмауэром.
