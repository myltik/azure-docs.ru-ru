...
После создания соединителя SAP его можно использовать в рабочем процессе приложения логики. Создайте новое приложение логики, последовательно выбрав **Новое** > **Приложения логики** > **Создать**. Введите метаданные для приложения логики, включая группу ресурсов.
