...
2. Рядом с полем **Повторить** нажмите кнопку `...` и выберите **Основной текст**. После этого входные данные:
