...
5. После нажатия кнопки "Авторизовать" открывается диалоговое окно проверки подлинности SharePoint. Введите данные для входа в учетную запись SharePoint, в которой вы хотите выполнять операции.  
![][4]

6. Предоставьте приложениям логики доступ к своей учетной записи для выполнения операций от вашего имени.  
![][5]

7. Если соединитель SharePoint настроен как триггер, тогда отображаются триггеры. В противном случае отображается список действий, в котором можно выбрать соответствующую операцию для выполнения.  
![][6]
  
**Относительный URL-адрес, настроенный для библиотеки документов**  
![][7]
