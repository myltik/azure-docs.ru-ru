---
title: "Диагностика сбоев приложений логики | Документация Майкрософт"
...
> [!NOTE]
> Также они помогут вам понять, как функция приложений логики [обрабатывает разные типы содержимого](app-service-logic-content-type.md) , если вы не понимаете некоторое содержимое.
> 
> 
