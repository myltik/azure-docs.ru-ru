...
# Приступая к работе с соединителем баз данных Oracle: добавление его в приложение логики
...
3. Триггер будет отображаться в приложении логики как настроенный. Будут отображены результаты триггера, которые можно использовать в качестве входных данных в следующих действиях: <br/> ![][7]
