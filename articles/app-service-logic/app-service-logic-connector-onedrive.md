...
>[AZURE.NOTE] Эта версия статьи предназначена для приложений логики со схемой версии 2014-12-01-preview. Чтобы узнать версию схемы 2015-08-01-preview, щелкните [API OneDrive](../connectors/create-api-onedrive.md).
...
3.	Настройте соединитель OneDrive следующим образом.
	...
	![][1]**Имя** — введите имя соединителя OneDrive. **План службы приложений** — выберите или создайте план службы приложений. **Ценовая категория** — выберите ценовую категорию для соединителя. **Группа ресурсов** — выберите или создайте группу ресурсов, где должен находиться соединитель. **Подписка** — выберите подписку, в которой необходимо создать соединитель. **Расположение** — выберите географическое расположение, где нужно развернуть соединитель.
