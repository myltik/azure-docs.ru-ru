...
3.	Настройте соединитель OneDrive следующим образом.
	...
	![][1]**Имя** — введите имя соединителя OneDrive. **План обслуживания приложения** — выберите или создайте план службы приложений. **Ценовая категория** — выберите ценовую категорию для соединителя. **Группа ресурсов** — выберите или создайте группу ресурсов, где должен находиться соединитель. **Подписка** — выберите подписку, в которой необходимо создать соединитель. **Расположение** — выберите географическое расположение, где нужно развернуть соединитель.
