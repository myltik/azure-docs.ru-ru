---
title: Использование соединителя DB2 в службе приложений Microsoft Azure | Microsoft Docs
...
> [!TIP]
> Действие соединителя DB2 « *Post to EntitySet* » возвращает значение столбца идентификатора, а *API Insert* возвращает количество затронутых строк.
> 
> 
