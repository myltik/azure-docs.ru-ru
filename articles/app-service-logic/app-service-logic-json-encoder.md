...
Кодировщик JSON BizTalk можно использовать как действие. У него нет никаких триггеров.
...
- Щелкните ->
	...
	![Список действий][4]
- Кодировщик JSON BizTalk поддерживает только одно действие. Выберите *Xml в JSON*
...
Вы также можете просматривать статистику производительности и управлять безопасностью соединителя. См. раздел [Отслеживание соединителя и приложений API и управление ими ](../app-service-api/app-service-api-manage-in-portal.md).
