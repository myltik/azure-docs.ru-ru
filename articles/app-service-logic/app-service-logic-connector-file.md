---
title: Использование соединителя File в приложениях логики | Microsoft Docs
...
5. Каждое из них демонстрирует определенные свойства. На следующем изображении представлен список свойств для триггера и действия для получения файла. ![][6]
