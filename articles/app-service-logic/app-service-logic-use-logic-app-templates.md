...
Эти шаблоны демонстрируют способ использования некоторых соединителей, доступных в Marketplace, а также позволяют узнать о различных шаблонах, которые могут быть созданы с помощью приложений логики. Можно использовать их как есть или изменить их в соответствии с необходимым сценарием. Чтобы начать использовать шаблон приложения логики, откройте Marketplace, введите "Шаблон приложения логики" в поле поиска и выберите один из шаблонов из проверенного списка или выберите "Триггеры и действия" при создании нового приложения логики и выберите шаблон из набора в конструкторе.
