...
1.	Создайте новое приложение логики и выберите ту же группу ресурсов, в которую входит соединитель служебной шины Azure:
<br/>
![][2]
...
5.	Теперь соединитель служебной шины Azure можно использовать в рабочем процессе. Можно использовать сообщение, извлеченное из триггера служебной шины Azure («Доступно сообщение»), в других действиях в потоке:
<br/>
![][5]
<br/>
![][6]

Можно также использовать действие «Отправить сообщение» служебной шины Azure:
<br/>
![][7]
<br/>
![][8]
