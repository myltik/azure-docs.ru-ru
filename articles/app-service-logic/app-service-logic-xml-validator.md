...
Соединитель для проверки XML BizTalk помогает приложению проверить XML-данные на соответствие предопределенным схемам XML. Пользователи могут применять существующие схемы или создать новые на основе экземпляра неструктурированного файла, экземпляра JSON или существующих соединителей.
