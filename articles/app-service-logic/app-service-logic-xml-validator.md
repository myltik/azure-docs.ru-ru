...
Используйте соединитель средства проверки XML BizTalk в приложении для проверки данных XML на соответствие предопределенным схемам XML. Пользователи могут применять существующие схемы или создавать новые на основе экземпляра неструктурированного файла, экземпляра JSON или существующих соединителей.
