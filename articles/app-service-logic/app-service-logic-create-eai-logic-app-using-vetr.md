...
2. Задайте для параметра **Отправлять ответ автоматически?** значение False. Настройте действие триггера, задав для параметра _Метод HTTP_ значение _POST_, а для параметра _Относительный URL-адрес_ — значение _/OneWayPipeline_. ![Триггер HTTP][2]
