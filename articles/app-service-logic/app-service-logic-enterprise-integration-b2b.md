...
[Обзор учетных записей интеграции](app-service-logic-enterprise-integration-accounts.md)
...
1. Создайте приложение логики и [свяжите его с учетной записью интеграции](app-service-logic-enterprise-integration-accounts.md).  
...
[Обзор Пакета интеграции Enterprise](app-service-logic-enterprise-integration-overview.md)  
