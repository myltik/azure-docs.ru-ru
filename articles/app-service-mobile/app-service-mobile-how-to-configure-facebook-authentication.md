...
7. На панели навигации слева щелкните **Параметры**. В поле **Секрет приложения** щелкните **Показать**, при запросе укажите пароль, а затем запишите значения полей **Идентификатор приложения** и **Секрет приложения**. Вы используете их позже, чтобы настроить свое приложение в Azure.
   ...
   > 
   > 
8. Учетная запись Facebook, которая использовалась для регистрации приложения, является администратором приложения. На этом этапе только администраторы могут входить в приложение. Чтобы проверить подлинность других учетных записей Facebook, щелкните **App Review** (Обзор приложения) и включите параметр **Make <your-app-name> public** (Сделать приложение общедоступным). Так вы активируете общий доступ с использованием аутентификации Facebook.
