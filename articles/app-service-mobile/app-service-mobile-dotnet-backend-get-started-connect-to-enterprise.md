...
В этом учебнике вы подключите мобильное приложение к корпоративному решению SaaS. Вы обновите приложение, работа с которым описана в учебнике [Проверка подлинности приложения с помощью единого входа библиотеки проверки подлинности Azure Active Directory], что позволит вам создавать документ Microsoft Word в SharePoint Online при каждом добавлении нового элемента TodoItem.

Для работы с данным учебником требуется следующее:

* Пакет Visual Studio 2013, работающий в среде Windows 8.1.
* Активная подписка на [SharePoint Online]
* Ознакомление с учебником [Проверка подлинности приложения с помощью единого входа библиотеки проверки подлинности Active Directory]. Необходимо использовать клиент, предоставленный подпиской на SharePoint.
