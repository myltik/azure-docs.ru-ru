<properties
	...
	keywords="служба приложений azure, служба приложений, мобильное приложение, серверная часть мобильного приложения, saas, azure saas, корпоративное мобильное приложение"
	documentationCenter=""
...
В этом учебнике вы подключите мобильное приложение к корпоративному решению SaaS. Вы обновите приложение, настроенное в соответствии с инструкциями в статье [Проверка подлинности приложения с помощью единого входа библиотеки проверки подлинности Azure Active Directory]. Это позволит вам создавать документ Microsoft Word в SharePoint Online при каждом добавлении нового элемента TodoItem.

Для работы с данным учебником требуется следующее:

* Пакет Visual Studio 2013, работающий в среде Windows 8.1.
* Активная подписка на [SharePoint Online]
* Ознакомление с руководством [Проверка подлинности приложения с помощью единого входа библиотеки проверки подлинности Active Directory]. Необходимо использовать клиент, предоставленный подпиской на SharePoint.
...
1. В разделе **Active Directory** на [классическом портале Azure] выберите свой клиент. Перейдите к веб-приложению, созданному для службы приложений.
...
3. На [портале Azure](https://portal.azure.com/) в серверной части мобильного приложения щелкните **Все параметры** > **Параметры приложения**, прокрутите список вниз и щелкните **Параметры приложения**. Здесь можно ввести пару "ключ - значение", которая позволит ссылаться на необходимые учетные данные.
...
[Проверка подлинности приложения с помощью единого входа библиотеки проверки подлинности Active Directory]: app-service-mobile-ios-aad-sso.md
[Проверка подлинности приложения с помощью единого входа библиотеки проверки подлинности Azure Active Directory]: app-service-mobile-ios-aad-sso.md
