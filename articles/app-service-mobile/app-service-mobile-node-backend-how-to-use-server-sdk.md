...
6. Вам может потребоваться обновить каталог npm перед созданием первого приложения на Node.js. В этом случае вам будет предложено нажать кнопку **Обновить**.
...
- драйвер **mssql** для доступа к хранилищу данных SQL Express во время разработки;
- драйвер **mssql** для доступа к хранилищу данных SQL Azure во время работы.
...
### <a name="howto-use-sqlazure"></a>Использование SQL Azure в качестве рабочего хранилища данных
