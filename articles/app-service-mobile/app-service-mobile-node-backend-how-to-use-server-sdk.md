...
2. Выполните инструкции из раздела [Включение репозитория для приложения службы приложений](../app-service-web/web-sites-deploy-local-git.md#Step3), чтобы включить репозиторий Git для веб-узла серверной части. Запишите имя пользователя и пароль для развертывания.
