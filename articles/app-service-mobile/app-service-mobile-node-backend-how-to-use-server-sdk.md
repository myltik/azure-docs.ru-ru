...
> [AZURE.NOTE]Сейчас доступна предварительная версия этого пакета SDK. Поэтому мы не рекомендуем использовать этот пакет SDK в рабочей среде. В примерах в этом документе используется пакет [azure-mobile-apps] версии v2.0.0-beta2.
