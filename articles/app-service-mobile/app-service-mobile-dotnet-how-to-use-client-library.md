...
#### <a name="a-nameclient-livesdkasingle-sign-on-using-microsoft-account-with-the-live-sdk"></a><a name="client-livesdk"></a>Единый вход с использованием учетной записи Майкрософт и пакета Live SDK
