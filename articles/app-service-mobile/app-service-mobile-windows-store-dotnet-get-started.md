---
title: Создание приложения универсальной платформы Windows (UWP) для использования в мобильных приложениях | Microsoft Docs
...
4. В приложении в поле **Вставить TodoItem** введите содержательный текст, например *Работа с руководством*, и нажмите кнопку **Сохранить**.
