---
title: Добавление аутентификации в приложение универсальной платформы Windows (UWP) | Microsoft Docs
...
2. Закомментируйте или удалите вызов метода **ButtonRefresh\_Click** (или метода **InitLocalStoreAsync**) в существующем переопределении метода **OnNavigatedTo**. Это позволяет предотвратить загрузку данных до того, как пользователь прошел проверку подлинности. Затем добавьте кнопку **Вход** в приложение, которое запускает проверку подлинности.
