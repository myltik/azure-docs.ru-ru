...
* [Добавление в приложение проверки подлинности](app-service-mobile-xamarin-ios-get-started-users.md) <br/>Узнайте, как выполнять проверку подлинности пользователей приложения с помощью поставщика удостоверений.
