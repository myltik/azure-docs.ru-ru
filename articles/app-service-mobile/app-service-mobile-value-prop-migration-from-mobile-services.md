...
В *службе приложений Azure* серверный код *мобильного приложения* выполняется в том же контейнере, в котором выполняется код веб-приложения и приложения API. Поэтому вы можете воспользоваться всеми функциями в этом контейнере, в том числе некоторыми из тех, которые в настоящее время отсутствуют в мобильных службах.
