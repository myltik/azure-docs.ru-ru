...
2. Щелкните **Параметры**, **Проверка подлинности пользователя** и **Учетная запись Майкрософт**. Скопируйте значение из поля **URL-адрес перенаправления**. Оно понадобится при настройке нового приложения для учетной записи Майкрософт.
