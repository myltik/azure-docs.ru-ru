...
> [AZURE.NOTE]Если используется шлюз службы приложений, пропустите этот раздел и перейдите к своему шлюзу на портале. Последовательно выберите пункты **Параметры**, **Идентификация**, а затем **Twitter**. Вставьте полученные ранее значения и нажмите кнопку **Сохранить**.
