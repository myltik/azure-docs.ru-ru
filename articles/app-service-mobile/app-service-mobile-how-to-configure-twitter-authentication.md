...
5. Откройте вкладку **Параметры**, установите флажок **Разрешить использовать это приложение для входа в Twitter**, затем нажмите **Обновить параметры**.
6. Откройте вкладку **Ключи и токены доступа**. Запишите значения полей **Пользовательский ключ (ключ API)** и **Пользовательский секрет (секрет API)**.
