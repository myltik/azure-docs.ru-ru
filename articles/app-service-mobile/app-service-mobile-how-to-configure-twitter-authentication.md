...
2. Щелкните **Параметры**, **Проверка подлинности мобильного приложения** и **Twitter**. Скопируйте **URL-адрес обратного вызова**. Он будет использован для настройки приложения Twitter.
