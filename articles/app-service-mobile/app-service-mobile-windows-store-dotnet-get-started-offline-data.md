...
3. SQLite — это собственная библиотека, для которой требуется выбрать архитектуру платформы, например **x86**, **x64** или **ARM**. Параметр **Любой процессор** не поддерживается. В обозревателе решений щелкните элемент "Решение" в верхней части, а затем выберите в раскрывающемся списке для архитектуры процессора один из поддерживаемых параметров, которые требуется протестировать.

    >[AZURE.NOTE] Если вы используете Visual Studio 2015, щелкните правой кнопкой мыши решение и выберите **Свойства**, чтобы открыть диспетчер конфигурации для установки платформы Windows и проектов Windows Phone.

    ![][13]


4. В обозревателе решений щелкните правой кнопкой мыши **Ссылки** для проектов, выполняемых на платформе Windows 8.1 и Windows Phone 8.1. Убедитесь в наличии ссылки на SQLite, расположенный в разделе **Расширения**.

    >[AZURE.NOTE] Если вы используете Visual Studio 2015, щелкните правой кнопкой мыши узел **Ссылки** узел для проектов, выполняемых на платформе Windows 8.1 и Windows Phone 8.1. Затем щелкните **Добавить ссылку**, чтобы открыть диспетчер ссылок.
