...
## <a name="a-namemobile-app-versionacreating-a-second-application-instance"></a><a name="mobile-app-version"></a>Создание второго экземпляра приложения
...
## <a name="a-nameauthenticationaauthentication-considerations"></a><a name="authentication"></a>Рекомендации по проверке подлинности
...
## <a name="a-nameupdating-clientsaupdating-clients"></a><a name="updating-clients"></a>Обновление клиентов
