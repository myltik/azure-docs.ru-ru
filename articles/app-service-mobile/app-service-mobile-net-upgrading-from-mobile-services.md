...
>[AZURE.TIP]Перед обновлением рекомендуется [выполнить миграцию](app-service-mobile-migrating-from-mobile-services.md). Таким образом, к обеим версиям приложения будет применен один тарифный план службы, и дополнительные затраты будут исключены.
...
Компоненты проверки подлинности мобильных служб перемещены в функцию проверки подлинности и авторизации службы приложений. Сведения о включении этой функции для сайта см. в статье [Добавление проверки подлинности в мобильное приложение](app-service-mobile-ios-get-started-users.md).
