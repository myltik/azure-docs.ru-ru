...
> [!NOTE]
> Если вы хотите узнать больше о новом пакете SDK сервера .NET и о том, как добавить или удалить компоненты из приложения, см. раздел [Как использовать пакет SDK для сервера .NET].
> 
> 
