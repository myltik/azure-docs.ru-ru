...
* **Непрерывное развертывание.** Службу приложений можно интегрировать с распространенными системами управления версиями (SCM), чтобы автоматически развертывать новую версию серверной части путем принудительной отправки в ветвь системы SCM.
