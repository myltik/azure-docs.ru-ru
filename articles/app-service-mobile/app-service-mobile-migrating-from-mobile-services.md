...
---
# <a name="a-namearticle-topamigrate-your-existing-azure-mobile-service-to-azure-app-service"></a><a name="article-top"></a>Перенос существующей мобильной службы Azure в службу приложений Azure
...
## <a name="a-namewhat-does-migration-doawhat-does-migration-do-to-your-site"></a><a name="what-does-migration-do"></a>Что происходит с сайтом во время переноса
...
## <a name="a-namewhy-migrateawhy-you-should-migrate-your-site"></a><a name="why-migrate"></a>Зачем переносить сайт
...
## <a name="a-namebefore-you-beginabefore-you-begin"></a><a name="before-you-begin"></a>Перед началом работы
Перед выполнением основных операций на сайте необходимо создать резервную копию мобильной службы и базы данных SQL.

## <a name="a-namemigrating-siteamigrating-your-sites"></a><a name="migrating-site"></a>Перенос сайтов
...
## <a name="a-namefinalizing-migrationafinalizing-the-migration"></a><a name="finalizing-migration"></a>Завершение переноса
...
### <a name="a-nameupdate-app-service-tieraselect-an-appropriate-app-service-pricing-tier"></a><a name="update-app-service-tier"></a>Выбор соответствующей ценовой категории службы приложений
...
### <a name="a-namereview-migration-scheduler-jobsareview-the-migrated-scheduler-jobs"></a><a name="review-migration-scheduler-jobs"></a>Просмотр перенесенных заданий планировщика
...
### <a name="a-nameconfigure-corsaconfigure-cors-if-needed"></a><a name="configure-cors"></a>Настройка CORS при необходимости
...
### <a name="a-namedownload-publish-profileadownload-a-new-publishing-profile"></a><a name="download-publish-profile"></a>Загрузка нового профиля публикации
...
## <a name="a-nameworking-with-your-siteaworking-with-your-site-post-migration"></a><a name="working-with-your-site"></a>Работа с сайтом после переноса
...
### <a name="a-namepublishing-your-siteadownloading-and-publishing-your-migrated-site"></a><a name="publishing-your-site"></a>Загрузка и публикация перенесенного сайта
...
### <a name="a-nameappsettingsaapplication-settings"></a><a name="appsettings"></a>Параметры приложения
...
### <a name="a-nameauthenticationaauthentication"></a><a name="authentication"></a>Проверка подлинности
...
### <a name="a-nameeasytablesadata"></a><a name="easytables"></a>Данные
...
### <a name="a-nameon-demand-jobsascheduler-jobs"></a><a name="on-demand-jobs"></a>Задания планировщика
...
### <a name="a-namenotification-hubsanotification-hubs"></a><a name="notification-hubs"></a>Центры уведомлений
...
### <a name="a-namelegacy-pushalegacy-push-settings"></a><a name="legacy-push"></a>Параметры отправки push-уведомлений устаревшего типа
...
### <a name="a-nameapp-settingsaother-app-settings"></a><a name="app-settings"></a>Другие параметры приложения
...
### <a name="a-namecliequivalentsacommand-line-equivalents"></a><a name="cliequivalents"></a>Эквиваленты командной строки
...
### <a name="a-namediagnosticsadiagnostics-and-logging"></a><a name="diagnostics"></a>Диагностика и ведение журналов
...
## <a name="a-nameknown-issuesaknown-issues"></a><a name="known-issues"></a>Известные проблемы
...
### <a name="a-nameupgrading-your-siteaupgrading-your-mobile-services-site-to-azure-mobile-apps-sdk"></a><a name="upgrading-your-site"></a>Обновление сайта мобильных служб до пакета SDK для мобильных приложений Azure
...
[Регион Azure]: https://azure.microsoft.com/en-us/regions/
