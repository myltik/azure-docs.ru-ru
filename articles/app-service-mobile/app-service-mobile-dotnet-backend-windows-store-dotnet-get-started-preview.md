<properties
	pageTitle="Создание универсального приложения среды выполнения Windows 8.1 в мобильных приложениях Azure"
...
В этом разделе вы скачаете проект шаблона универсального приложения Windows, который настроен для подключения к серверной части мобильного приложения Azure.
...
5. В приложении введите содержательный текст, например *Работа с учебником*, в поле **Вставить в TodoItem**, затем щелкните **Сохранить**.

	![](./media/app-service-mobile-dotnet-backend-windows-store-dotnet-get-started-preview/mobile-quickstart-startup.png)

	Отправится запрос POST к серверной части новой мобильной службы, размещенной в Azure.
...
[Просмотреть все]: https://portal.azure.com/
