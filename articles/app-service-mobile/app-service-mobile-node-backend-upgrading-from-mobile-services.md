...
## <a name="a-nameoverviewabasic-upgrade-overview"></a><a name="overview"></a>Общие сведения об обновлении
...
## <a name="a-nameinstall-npm-packagea-install-the-pre-requisites"></a><a name="install-npm-package"></a> Установка необходимых компонентов
...
## <a name="a-nameobtain-ams-scriptsa-obtain-your-azure-mobile-services-scripts"></a><a name="obtain-ams-scripts"></a> Получение скриптов мобильных служб Azure
...
## <a name="a-namescaffold-appa-scaffold-the-new-azure-mobile-apps-backend"></a><a name="scaffold-app"></a> Формирование шаблонов серверной части новых мобильных приложений Azure
...
## <a name="a-namedeploy-ama-appa-deploy-your-azure-mobile-apps-backend"></a><a name="deploy-ama-app"></a> Развертывание серверной части мобильных приложений Azure
...
## <a name="a-nameupdating-clientsaupdate-mobile-clients"></a><a name="updating-clients"></a>Обновление мобильных клиентов
