...
Вы можете выполнить дальнейшую настройку пакета SDK для мобильных приложений, передав [объект конфигурации](http://azure.github.io/azure-mobile-apps-node/global.html#configuration) инициализатору или [создав файл с именем azureMobile.js](app-service-mobile-node-backend-how-to-use-server-sdk.md#howto-config-localdev) в корне проекта.
