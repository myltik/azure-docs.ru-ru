...
2. В колонке **Параметры** мобильного приложения в разделе **Мобильные приложения** последовательно выберите **Начало работы** > **Xamarin.Forms**. На **шаге 3** выберите **Создание нового приложения** и нажмите **Загрузить**.
