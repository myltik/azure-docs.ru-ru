...
Часто требуется ограничить данные, возвращаемые определенному аутентифицированному пользователю. Для такого секционирования данных в таблицу добавляется столбец userIdе, а при вставке данных сохраняется идентификатор безопасности пользователя.
