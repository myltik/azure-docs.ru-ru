...
1. В Visual Studio в меню «Сервис» последовательно выберите **Диспетчер пакетов NuGet** > **Консоль диспетчера пакетов**, укажите Nuget.org в качестве **источника пакетов** и выполните в окне консоли следующую команду:
...
3. Создав **HttpConfiguration** (*config*), добавьте указанный ниже код в метод **Startup.ConfigureMobileApp**.
