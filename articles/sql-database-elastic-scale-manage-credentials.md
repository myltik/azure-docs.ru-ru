<properties title="Managing Elastic Scale Credentials" pageTitle="Управление учетными данными эластичного масштабирования" description="Как установить уровень прав учетных данных (от администратора до доступа только для чтения) для приложений эластичного масштабирования." metaKeywords="Azure SQL Database, elastic scale, about user credentials in elastic scale" services="sql-database" documentationCenter="" manager="jhubbard" authors="sidneyh@microsoft.com"/>
