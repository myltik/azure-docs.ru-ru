...
3. После входа в Azure вы можете создать веб-сайт Azure для локального сайта.  Выберите уникальное имя и центр обработки данных, где планируется создать сайт: 
...
2. Добавьте пакет SendGrid NuGet в проект WebMatrix. Во-первых, нажмите кнопку NuGet.
    ...
    Найдите SendGrid и установите его.

    ![Install SendGrid][installsendgrid]

    После завершения установки пакета обратите внимание, что сборки SendGrid были добавлены в папку bin.
...
7. В диалоговом окне **Просмотр публикации** убедитесь, что отмечены оба файла, а затем нажмите кнопку "Продолжить".
