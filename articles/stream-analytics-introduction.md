<properties title="Introduction to Azure Stream Analytics" pageTitle="Введение в Stream Analytics | Azure" description="Понимание анализа потоков Azure" metaKeywords="" services="stream analytics" solutions="" documentationCenter="" authors="jgao" videoId="" scriptId="" manager="paulettm" editor="cgronlun"/>
