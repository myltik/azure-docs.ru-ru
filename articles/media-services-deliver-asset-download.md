<properties 
	pageTitle="Доставка мультимедийных файлов - Azure" 
	description="Узнайте о вариантах доставки мультимедийных активов, переданных в службы мультимедиа в Azure. Примеры кода написаны на языке C# и используют пакет SDK служб мультимедиа для .NET." 
...
#Практическое руководство. Доставка ресурса путем скачивания
