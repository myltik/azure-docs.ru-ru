---
title: "Набор средств Azure для IntelliJ | Документация Майкрософт"
...
## <a name="use-the-azure-toolkit-for-intellij"></a>Использование набора средств Azure для IntelliJ
