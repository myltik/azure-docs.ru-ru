...
По умолчанию служба таблиц реализует проверки оптимистичного параллелизм на уровне отдельных сущностей для операций **Insert**, **Merge** и **Delete** несмотря на то, что клиент может принудительно заставить службу таблиц обойти эти проверки. Дополнительную информацию о том, каким образом служба таблиц осуществляет управление параллелизмом, см. в статье [Управление параллелизмом в хранилище Microsoft Azure](../storage-concurrency/) на веб-сайте Microsoft Azure.  
...
Дополнительные сведения об использовании маркеров SAS со службой таблиц см. в статье [Подписи общего доступа. Часть 1: Общие сведения о модели SAS](../storage-dotnet-shared-access-signature-part-1/).  
