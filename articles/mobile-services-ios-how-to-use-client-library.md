<properties urlDisplayName="iOS Client Library" pageTitle="Использование клиентской библиотеки iOS - мобильные службы Azure" metaKeywords="Azure Mobile Services, Mobile Service iOS client library, iOS client library" description="Узнайте, как использовать клиентскую библиотеку iOS для мобильных служб Azure." metaCanonical="" services="" documentationCenter="Mobile" title="How to use the iOS client library for Mobile Services" authors="krisragh" solutions="" manager="dwrede" editor="" />
