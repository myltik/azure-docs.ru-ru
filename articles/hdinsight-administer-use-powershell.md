<properties linkid="manage-services-hdinsight-administer-hdinsight-using-powershell" urlDisplayName="Администрирование HDInsight" pageTitle="Администрирование HDInsight с использованием PowerShell | Azure" metaKeywords="hdinsight, администрирование hdinsight, администрирование azure hdinsight" description="Узнайте, как выполнять задачи администрирования для кластеров HDInsight с использованием PowerShell." services="hdinsight" umbracoNaviHide="0" disqusComments="1" editor="cgronlun" manager="paulettm" title="Администрирование HDInsight с использованием PowerShell" authors="bradsev" />

# Администрирование HDInsight с использованием PowerShell

Azure PowerShell — это полнофункциональная среда сценариев, которую можно использовать для контроля и автоматизации развертывания и управления вашей рабочей нагрузкой в Azure. В этой статье вы узнаете, как управлять кластерами HDInsight с помощью локальной консоли Azure PowerShell, используя Windows PowerShell. Список командлетов HDInsight PowerShell см. в [Справочнике по командлетам HDInsight][hdinsight-powershell-reference].
...
Сведения о создании учетной записи хранения Azure с помощью портала управления см. в разделе [Создание учетной записи хранения](/ru-ru/manage/services/storage/how-to-create-a-storage-account/).
...
Подробную информацию о получении сведений с использованием портала управления см. в разделе *Практическое руководство. Просмотр, копирование и повторное создание ключей доступа к хранилищу* статьи [Управление учетными записями хранилища](/ru-ru/manage/services/storage/how-to-manage-a-storage-account/).
...
В примере <i>hdiv2</i> — это имя кластера HDInsight.

>[WACOM.NOTE] Предоставляя или отменяя доступ, вы переопределяете имя пользователя и пароль кластера.

Это можно сделать также с помощью портала управления Azure. См. раздел [Администрирование кластеров HDInsight с использованием портала управления][hdinsight-admin-portal].
...
Сведения о префиксе WASB см. в разделе [Использование хранилища BLOB-объектов Azure для HDInsight][hdinsight-
storage].
...
Дополнительные сведения о разработке и выполнении заданий MapReduce см. в разделе [Использование MapReduce с HDInsight][hdinsight-mapreduce].
...
Дополнительные сведения об использовании Hive см. в разделе [Использование Hive с HDInsight][hdinsight-hive].


##<a id="upload"></a>Отправка данных в хранилище BLOB-объектов
...
[hdinsight-submit-jobs]: /ru-ru/documentation/articles/hdinsight-submit-hadoop-jobs-programmatically/

[hdinsight-admin-portal]: /ru-ru/documentation/articles/hdinsight-administer-use-management-portal/
[hdinsight-admin-cli]: /ru-ru/documentation/articles/hdinsight-administer-use-command-line/
