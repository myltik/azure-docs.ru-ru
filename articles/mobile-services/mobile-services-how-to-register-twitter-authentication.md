...
1. Перейдите на веб-сайт [разработчиков Twitter](http://go.microsoft.com/fwlink/p/?LinkId=268300), войдите, используя данные учетной записи Twitter, и щелкните **Create new app** (Создать приложение).
...
7. Щелкните вкладку **Параметры**, прокрутите страницу вниз и убедитесь, что установлен флажок **Разрешить использовать это приложение для входа в Twitter**. Затем нажмите кнопку **Обновить параметры**.
