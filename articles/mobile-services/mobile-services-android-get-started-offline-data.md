...
3. Просмотрите содержимое таблицы *TodoItem* в Azure. Убедитесь, что новые элементы _не_ были синхронизированы с сервером.
   ...
   - Для серверной части .NET просмотрите содержимое таблицы либо с помощью средства SQL, например *SQL Server Management Studio*, либо с помощью клиента REST, например *Fiddler* или *Postman*.
