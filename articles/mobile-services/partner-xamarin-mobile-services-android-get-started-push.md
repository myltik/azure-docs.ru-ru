...
У вас в проекте уже должны быть установлены компоненты [Xamarin.Android] и [мобильные службы Azure] после завершения учебника [Приступая к работе с мобильными службами].
