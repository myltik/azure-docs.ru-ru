...
<ol start="4"> <li><p>На портале управления перейдите на вкладку <strong>Данные</strong>, затем щелкните таблицу <strong>TodoItem</strong>. После этого можно просматривать данные, добавленные в таблицу приложением.<p></li></ol></p>
