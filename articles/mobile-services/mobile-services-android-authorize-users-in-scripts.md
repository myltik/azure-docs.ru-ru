...
5. Повторите шаги 3 и 4, чтобы заменить существующую операцию **Read** такой функцией:
...
1. В Android Studio откройте проект, измененный после изучения учебника [Приступая к работе с проверкой подлинности].
...
3. В приложении введите текст в поле **Вставка TodoItem** и нажмите **Сохранить**.
