---
title: Использование автономных данных в мобильных службах (Xamarin для iOS) | Microsoft Docs
...
3. Чтобы обеспечить синхронизацию данных при обновлении, измените метод `QSTodoListViewController.RefreshAsync()`. Добавьте вызов `SyncAsync()` перед вызовом `RefreshDataAsync()`:
