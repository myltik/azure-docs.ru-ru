---
title: Приступая к работе с данными в Android (серверная часть JavaScript) | Microsoft Docs
...
[!INCLUDE [Проверка пакета SDK](../../includes/mobile-services-verify-android-sdk-version.md)]
