...
- **Серверная мобильная служба .NET**. <br/>Выполните инструкции в учебнике [Приступая к работе с мобильными службами], чтобы создать и загрузить новую серверную мобильную службу .NET с [портала управления Azure].
...
1. Перейдите к своей мобильной службе на [портале управления Azure].
