<properties 
	pageTitle="Использование автономных данных в мобильных службах (Windows Store) | Центр разработчиков для мобильных устройств" 
...
<p>В этом учебнике показано, как добавить поддержку автономных функций в универсальное приложение для Магазина Windows с помощью мобильных служб Azure. Автономный режим позволяет взаимодействовать с локальной базой данных, когда для приложения действует автономный сценарий. Когда приложение находится в сети с серверной базой данных, можно синхронизировать локальные изменения с помощью автономных функций. 
</p>
