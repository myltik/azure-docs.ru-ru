...
3. После запуска приложения в одном из указанных выше мобильных эмуляторов введите какой-либо текст в текстовое поле, а затем нажмите кнопку **Добавить**.
...
[Приступая к работе с push-уведомлениями]: /develop/mobile/tutorials/mobile-services-html-get-started-push
