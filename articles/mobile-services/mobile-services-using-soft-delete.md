...
Для таблиц, созданных с помощью JavaScript или серверной части .NET, можно включить удаление с возможностью восстановления. Если используется обратимое удаление, в базу данных добавляется новый столбец *__deleted* типа [SQL bit]. Если функция удаления с возможностью восстановления включена, операция удаления физически не удаляет строки из базы данных, а устанавливает для удаленного столбца значение TRUE.
...
2. На странице данных щелкните для выбора нужной таблицы. На панели команд нажмите кнопку **Включить удаление с возможностью восстановления**. Если в таблице уже включена эта функция, кнопка будет недоступна, но на вкладке **Обзор** или **Столбцы** таблицы будет виден столбец *__deleted*.
