---
title: Регистрация для проверки подлинности Azure Active Directory | Microsoft Docs
...
6. После добавления приложения щелкните вкладку **Настройка** и скопируйте **идентификатор клиента** приложения.
   ...
   > [!NOTE]
   > Для мобильной службы, которая использует серверную часть .NET, также измените **URL-адрес ответа** в разделе **Единый вход** на URL-адрес мобильной службы с добавлением пути *signin-aad*. Например, `https://todolist.azure-mobile.net/signin-aad`
   > 
   > 
