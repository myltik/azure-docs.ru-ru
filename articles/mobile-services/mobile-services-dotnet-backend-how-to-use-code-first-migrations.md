...
13. (Необязательно). На [портале управления Azure] выберите свою мобильную службу, откройте вкладку **Настройка** и щелкните **База данных SQL**. При этом откроется страница базы данных SQL для базы данных вашей мобильной службы.
