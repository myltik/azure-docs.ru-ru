...
13. (Необязательно). На [классическом портале Azure] выберите свою мобильную службу, откройте вкладку **Настройка** и щелкните **База данных SQL**. При этом откроется страница базы данных SQL для базы данных вашей мобильной службы.
