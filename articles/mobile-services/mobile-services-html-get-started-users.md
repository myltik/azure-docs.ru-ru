---
title: Добавление проверки подлинности в приложение HTML/JavaScript | Microsoft Docs
...
> [!NOTE]
> Так как вход выполняется во всплывающем окне, необходимо вызвать метод **login** по событию нажатия кнопки. В противном случае многие браузеры отключают окно входа.
> 
> 
...
2. В файле page.js найдите строку кода, расположенную в конце файла, которая вызывает функцию refreshTodoItems, и замените ее на следующий код:
   ...
   > [!IMPORTANT]
   > В приложении PhoneGap также необходимо добавить в проект следующие модули:
   > 
