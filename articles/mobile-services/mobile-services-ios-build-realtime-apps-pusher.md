...
9. Наконец, в разделе **Параметры построения** найдите параметр **Другие флаги компоновщика** и добавьте флаг **-all\_load**.
...
11. Замените заполнитель `**your_app_key**` на значение app\_key, ранее скопированное из диалогового окна "Сведения о подключении".
...
##<a name="install-scripts"></a>Установка серверных скриптов
