...
## Дальнейшие действия
Теперь, когда вы закончили изучение краткого руководства, узнайте, как работать с [клиентом мобильных служб для HTML/JavaScript](mobile-services-html-how-to-use-client-library.md).
