<properties
	pageTitle="Использование мобильных служб для отправки изображений в хранилище BLOB-объектов (Windows Phone) | Microsoft Azure"
...
>[AZURE.NOTE]Этот учебник поддерживает только приложения Windows Phone 8 и Windows Phone 8.1 Silverlight, но не приложения Магазина Windows Phone 8.1 или универсальные приложения Windows 8.1.
