---
title: Приступая к работе с мобильными службами для универсальных приложений Windows | Microsoft Docs
