...
1. В обозревателе решений Visual Studio откройте файл App.xaml.cs. Измените инициализацию **MobileServiceClient** на недопустимый адрес, заменив значение **azure-mobile.net** для URL-адреса значением **azure-mobile.xxx**. Затем сохраните файл.
...
1. В обозревателе решений Visual Studio откройте файл App.xaml.cs. Измените инициализацию **MobileServiceClient** снова на допустимый адрес, заменив значение **azure-mobile.xxx** для URL-адреса значением **azure-mobile.net**. Затем сохраните файл.
