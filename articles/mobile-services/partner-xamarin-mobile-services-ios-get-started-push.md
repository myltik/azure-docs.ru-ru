---
title: Добавление push-уведомлений в приложение мобильных служб (Xamarin.iOS) — мобильные службы
...
> Аналогичные сведения для мобильных приложений см. в статье [Добавление push-уведомлений в приложение Xamarin.iOS](../app-service-mobile/app-service-mobile-xamarin-ios-get-started-push.md).
> 
> 
...
> [!IMPORTANT]
> В соответствии с требованиями APNS необходимо развернуть и протестировать push-уведомления на устройстве iOS (iPhone или iPad), а не в эмуляторе.
> 
> 
