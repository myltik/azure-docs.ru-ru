---
title: Использование мобильных служб для передачи изображений в хранилище BLOB-объектов (Android) | Microsoft Docs
...
2. Добавьте следующий код, чтобы запустить приложение камеры Android. Теперь вы можете снимать. Если фотография вам нравится, нажмите кнопку **Сохранить**, после чего она будет сохранена в созданном вами файле.
