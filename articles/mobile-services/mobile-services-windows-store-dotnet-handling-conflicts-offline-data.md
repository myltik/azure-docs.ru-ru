<properties 
	pageTitle="Обработка конфликтов с автономными данными в мобильных службах (Магазин Windows) | Центр мобильных разработок" 
	description="Узнайте, как использовать возможности мобильных служб Azure для обработки конфликтов при синхронизации автономных данных в приложении магазина Windows." 
