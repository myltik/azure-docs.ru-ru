---
title: Администрирование мобильной службы из командной строки | Microsoft Docs
...
> [!NOTE]
> Команды CLI, связанные со "списком" и "скриптом", работают только с сервером JavaScript.
> 
> 
