...
Дополнительную информацию о ACS см. в разделе [Дальнейшие действия](#next_steps) .
...
7. Нажмите кнопку **OK**, чтобы закрыть диалоговое окно **Свойства MyACSHelloWorld**.
...
## <a name="run_application"></a>Запуск приложения
