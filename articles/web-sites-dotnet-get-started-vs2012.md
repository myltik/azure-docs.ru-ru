...
2.  [Создание веб-сайта в Azure][Создание веб-сайта в Azure]
3.  [Создание приложения ASP.NET MVC 4][Создание приложения ASP.NET MVC 4]
...
1.  На [портале управления Azure][портале управления Azure] щелкните элемент **Веб-сайты** и нажмите кнопку **Создать**.

 ![Новый веб-сайт][Новый веб-сайт]
...
4.  Щелкните стрелку **Создать веб-сайт**.
    ...
    ![Страница "Веб-сайты" на портале управления, веб-сайт создан][Страница "Веб-сайты" на портале управления, веб-сайт создан]
...
1.  Если подписка Azure еще не добавлена в Visual Studio, выполните следующие действия. После добавления существующей подписки в раскрывающемся списке в разделе **Импорт с веб-сайта Azure** появится и ваш веб-сайт.
    ...
    ![добавление подписки Azure][добавление подписки Azure]
    ...
    ![скачивание PUBLISHSETTINGS-файла][скачивание PUBLISHSETTINGS-файла]
...
![Веб-сайты Azure в обозревателе сервера][Веб-сайты Azure в обозревателе сервера]

![Конфигурация веб-сайта в Visual Studio.][Конфигурация веб-сайта в Visual Studio.]
...
![Вкладка "Панель мониторинга" портала управления][Вкладка "Панель мониторинга" портала управления]

Параметры сайта можно изменить на вкладке **Настройка**. Дополнительные сведения см. в статье [Как управлять веб-сайтами][Как управлять веб-сайтами].
...
![Вкладка "Масштаб" портала управления][Вкладка "Масштаб" портала управления]

Дополнительные сведения см. в статье [Как масштабировать веб-сайт][Как масштабировать веб-сайт]. (Добавление ресурсов сервера для масштабирования веб-сайта не является бесплатным.)
...
![Журналы в Visual Studio][Журналы в Visual Studio]

Дополнительные сведения см. в статье [Устранение неполадок веб-сайтов Azure в Visual Studio][Устранение неполадок веб-сайтов Azure в Visual Studio].
