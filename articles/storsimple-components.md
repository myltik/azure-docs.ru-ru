...
> [AZURE.NOTE] Сведения о развертывании StorSimple, опубликованные на веб-сайте Microsoft Azure, применяются только к устройствам серии StorSimple 8000. Дополнительные сведения об устройстве серии 7000 см. по ссылке [Справка StorSimple](http://onlinehelp.storsimple.com/).

## Устройство StorSimple

Устройство Microsoft Azure StorSimple - это локальный гибридный массив хранилища, который обеспечивает первичному хранилищу и iSCSI доступ к данным, расположенным в другом месте. Оно управляет взаимодействием с облачным хранилищем и обеспечивает безопасность и конфиденциальность всех данных, хранящихся в решении Microsoft Azure StorSimple.
