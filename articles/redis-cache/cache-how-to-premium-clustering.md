...
Чтобы изменить размер кластера для работающего кэша уровня "Премиум" с включенной кластеризацией, в**меню ресурсов** щелкните **(ПРЕДВАРИТЕЛЬНАЯ ВЕРСИЯ) Размер кластера Redis**.
