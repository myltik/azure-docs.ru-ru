...
## Добавление или удаление сегментов работающего кэша категории «Премиум»

Чтобы добавить или удалить сегменты работающего кэша категории «Премиум» с включенной кластеризацией, в колонке **Параметры** щелкните **(PREVIEW) Redis Cluster Size** (Размер кластера Redis (предварительная версия)).
