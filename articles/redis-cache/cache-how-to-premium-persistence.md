...
Для создания кэша и настройки сохраняемости войдите на [портал предварительной версии Azure](https://portal.azure.com), щелкните **Создать** -> **Данные + хранилище** > **Кэш Redis**.
