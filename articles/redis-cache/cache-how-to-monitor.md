...
Чтобы просмотреть метрики кэша, [перейдите](cache-configure.md) к своему экземпляру кэша на [портале Azure](https://portal.azure.com). Метрики экземпляров кэша Redis для Azure доступны в колонке **Метрики Redis**.
