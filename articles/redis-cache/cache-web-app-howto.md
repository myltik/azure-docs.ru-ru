...
2. Прочтите условия в колонке **Приобрести**, а затем нажмите кнопку **Приобрести**.
3. Чтобы начать подготовку ресурсов к работе, нажмите кнопку **Создать** в колонке **Настраиваемое развертывание**.
