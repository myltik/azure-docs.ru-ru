...
>[AZURE.NOTE]В настоящее время уровень Premium кэша Redis для Azure находится в состоянии предварительной версии. В течение периода предварительной версии функции уровня Premium можно настроить только в процессе создания кэша. Дополнительные сведения об использовании функций кэша уровня Premium см. в статьях [Настройка сохраняемости для уровня Premium кэша Redis для Azure](cache-how-to-premium-persistence.md), [Настройка кластеризации для уровня Premium кэша Redis для Azure](cache-how-to-premium-clustering.md) и [Настройка поддержки виртуальной сети для уровня Premium кэша Redis для Azure](cache-how-to-premium-vnet.md).
...
В разделе **Теги** вы можете упорядочить ваши ресурсы. Дополнительные сведения см. в статье [Использование тегов для организации ресурсов в Azure](../resource-group-using-tags.md).
