...
При возникновении во время работы кэша любого из условий, таких как интенсивное использование памяти, высокая загрузка пропускной способности сети или сервера, в колонке **Кэш Redis** отображается предупреждение.
...
>[AZURE.IMPORTANT] Функция импорта и экспорта доступна только для кэшей категории "Премиум". Дополнительные сведения и инструкции см. в статье [Импорт и экспорт данных в кэше Redis для Azure](cache-how-to-import-export-data.md).
...
>[AZURE.IMPORTANT] Функция перезагрузки доступна только для кэшей уровня "Премиум". Дополнительные сведения и инструкции см. в разделе [Администрирование кэша Redis для Azure — Перезагрузка](cache-administration.md#reboot).

### Планирование обновлений

Колонка **Schedule updates** (Планирование обновлений) позволяет указать период обслуживания для обновлений сервера кэша Redis.
...
>[AZURE.IMPORTANT] Функция планирования обновлений доступна только для кэшей категории "Премиум". Дополнительные сведения и инструкции см. в разделе [Администрирование кэша Redis для Azure — Планирование обновлений](cache-administration.md#schedule-updates).
