---
title: Импорт и экспорт данных в кэше Redis для Azure | Microsoft Docs
description: 'Вы можете узнать, как импортировать данные в хранилище BLOB-объектов и экспортировать их оттуда с использованием экземпляров кэша Redis для Azure категории '
;премиум";": ''
