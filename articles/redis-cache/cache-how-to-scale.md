...
>    -    Из ценовой категории кэша **Премиум** нельзя перейти к ценовой категории **Стандартный** или **Базовый**.
>    -    Понизить категорию кэша с уровня **Стандартный** до уровня **Базовый** нельзя.
...
>-	Увеличить категорию кэша с уровня **Базовый** сразу до уровня **Премиум** нельзя. Необходимо сначала перейти с уровня **Базовый** на уровень **Стандарт**, а затем с уровня **Стандарт** на уровень **Премиум**.
...
-	Кэш **Стандартный** и **Премиум** остается доступным во время операции масштабирования.
...
-	Перейти с более высокой ценовой категории на более низкую нельзя.
    ...
    -    Понизить категорию кэша с уровня **Стандартный** до уровня **Базовый** нельзя.
-	Вы можете выполнить масштабирование кэша с уровня **Базовый** до уровня **Стандартный**, но вам не удастся одновременно с этим изменить размер кэша. Если требуется изменить размер, можно выполнить последующую операцию масштабирования до нужного размера.
-	Увеличить категорию кэша с уровня **Базовый** сразу до уровня **Премиум** нельзя. Необходимо перейти с уровня **Базовый** на уровень **Стандарт**, а затем с уровня **Стандарт** на уровень **Премиум**.
-	Вам не удастся выполнить масштабирование с большего размера до размера **C0 (250 МБ)**.
