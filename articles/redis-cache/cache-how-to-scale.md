...
>[AZURE.NOTE]Функция масштабирования кэша Redis для Azure предоставляется в предварительной версии. В период действия предварительной версии нельзя масштабировать кэш до уровня "Премиум" или с уровня "Премиум" до другого уровня, но можно изменять ценовую категорию в кэше уровня "Премиум" и [размер кластера](cache-how-to-premium-clustering.md#cluster-size) в кэше уровня "Премиум" с включенной кластеризацией.

Кэш Redis для Azure предлагает разные варианты кэша, которые обеспечивают гибкость в выборе размера и функций кэша. Если требования вашего приложения изменятся после создания кэша, вы можете изменить размер кэша с помощью колонки **Изменение ценовой категории** на [портале Azure](https://portal.azure.com).
...
Кроме того, вы можете щелкнуть **Стандартный уровень** или **Базовый уровень** в колонке **Кэш Redis**.
...
-	Если при создании вашего кэша категории **Премиум** была включена кластеризация, вы можете [изменить размер кластера](cache-how-to-premium-clustering.md#cluster-size).
...
Вы не можете выполнить масштабирование кэша из категории **Стандартный** до категории **Базовый**.
