...
Имя кэша|Объем кэша|Get/с (простые вызовы GET значений в 1 КБ)|Пропускная способность (Мбит/с)
---|---|---|---
C0|250 МБ|610|5
C1|1 GB|12 200|100
C2|2,5 ГБ|24 300|200
C3|6 ГБ|48 875|400
C4|13 ГБ|61 350|500
C5|26 ГБ|112 275|1000
C6|53 ГБ|153 219|1000 +
...
-	При наличии кэша Standard команды Redis можно выполнять с помощью [консоли Redis](cache-configure.md#redis-console). Это — защищенный способ выполнения команд Redis на портале предварительной версии.
