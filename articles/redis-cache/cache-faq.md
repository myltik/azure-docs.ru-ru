...
-	Можно опубликовать вопрос на [форуме MSDN по кэшу Azure](https://social.msdn.microsoft.com/forums/azure/home?forum=azurecache) и обсудить его с командой разработчиков кэша Azure и другими участниками сообщества.
-	Можно [отправить нам внешний отзыв о кэше Azure](mailto:azurecache@microsoft.com) по электронной почте.
...
'<-- Loc Comment: Broken link: [StackExchange.Redis timeout exceptions](Устранение проблем на стороне клиента](cache-how-to-troubleshoot.md#stackexchangeredis-timeout-exceptions). "(Устранение проблем на стороне клиента]" следует удалить. -->'
