...
Вы можете использовать любые команды, перечисленные на странице [Команды Redis](http://redis.io/commands#). Для выполнения этих команд можно использовать следующие инструменты.
