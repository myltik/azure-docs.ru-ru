...
|----------------------|--------|----------------------------|--------------------------------|
| **Размеры кэша уровня Стандартный** | &nbsp; | **(Мбит/с)** | **Запросов в секунду** |
| C0 | 250 МБ | 5 | 600 |
| C1 | 1 GB | 100 | 12 200 |
...
Дополнительные сведения о начале работы с кэшем Redis для Azure см. в разделах [Использование кэша Redis для Azure](cache-dotnet-how-to-use-azure-redis-cache.md) и [Документация по кэшу Redis для Azure](https://azure.microsoft.com/documentation/services/redis-cache/).
