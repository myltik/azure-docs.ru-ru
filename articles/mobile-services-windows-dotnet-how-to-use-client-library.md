...
<properties urlDisplayName=".NET Client Library" pageTitle="Работа с клиентской библиотекой мобильных служб .NET " metaKeywords="мобильных служб Azure, клиент мобильных служб .NET, клиент .NET" description="Узнайте, как использовать клиент .NET для мобильных служб Azure." metaCanonical="" services="" documentationCenter="Mobile" title="How to use a .NET client for Azure Mobile Services" authors="glenga" solutions="" manager="dwrede" editor="" />
