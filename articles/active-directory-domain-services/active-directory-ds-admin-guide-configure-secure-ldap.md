...
1. **Надежный издатель**. Сертификат должен быть выдан центром сертификации, являющимся доверенным для компьютеров, подключающихся к управляемому домену по защищенному протоколу LDAP. Этот центр может быть общедоступного центра сертификации (ЦС) или ЦС предприятия, доверенным для этих компьютеров.
...
* Получите сертификат от общего ЦС и ЦС предприятия.
...
Если ваша организация получает сертификаты у общедоступного ЦС, сертификат безопасности LDAP, общедоступный центр сертификации. При развертывании ЦС предприятия, получите безопасный LDAP сертификат из центра сертификации предприятия.
