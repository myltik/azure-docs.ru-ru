...
* Включить доменные службы Azure AD можно в классической виртуальной сети Azure. Однако поддержка классических виртуальных сетей скоро будет прекращена. Мы рекомендуем использовать виртуальные сети диспетчера ресурсов для созданных управляемых доменов.
* Доменные службы Azure AD можно включить в виртуальных сетях, созданных с помощью Azure Resource Manager.
