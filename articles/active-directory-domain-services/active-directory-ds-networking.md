---
title: Доменные службы Azure AD. Рекомендации по сетям | Microsoft Docs
...
> [!NOTE]
> **Развертывайте доменные службы Azure AD в отдельную выделенную подсеть в виртуальной сети Azure. Не применяйте NSG к выделенной подсети. Не включайте доменные службы Azure AD в подсети шлюза виртуальной сети.**
> 
> 
