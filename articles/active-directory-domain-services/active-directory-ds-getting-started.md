...
# Приступая к работе с доменными службами Azure AD
...
6. Создайте группу с именем **AAD DC Administrators**.
    ...
    > [AZURE.WARNING] Чтобы обеспечить доступ, в доменных службах Azure AD необходимо создать группу с таким же именем.
