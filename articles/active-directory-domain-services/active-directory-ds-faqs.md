<properties
	pageTitle="Доменные службы Azure Active Directory: часто задаваемые вопросы | Microsoft Azure"
...
#### Являются ли доменные службы Azure AD платной службой?
В течение периода общедоступной предварительной версии эта служба доступна по специальной сниженной цене. Выставление счетов по полной стоимости начнется после выпуска общедоступной версии службы. Дополнительные сведения см. на [странице с расценками](https://azure.microsoft.com/pricing/details/active-directory-ds/).
...
В настоящее время мы не можем сообщить о сроках перехода службы в состояние общедоступной версии.
