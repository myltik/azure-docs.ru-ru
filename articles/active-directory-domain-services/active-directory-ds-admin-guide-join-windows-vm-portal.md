...
6. На странице **Параметры** мастера выберите виртуальную сеть, в которой развернут управляемый домен доменных служб Azure AD. Выберите подсеть, отличную от той, где развернут управляемый домен. Для других параметров оставьте значения по умолчанию и нажмите кнопку **ОК**.
    ...
    > Выберите либо виртуальную сеть, в которой развернут управляемый домен, либо виртуальную сеть, которая подключена к ней с использованием пиринговой связи между виртуальными сетями. Если вы выберете изолированную виртуальную сеть, то не сможете присоединить виртуальную машину к управляемому домену.
...
* Попробуйте использовать учетную запись пользователя, которая относится к группе "Администраторы AAD контроллера домена".
