...
|:---| --- | --- |
| Устройство управляется | с помощью Azure AD | с помощью управляемого домена доменных служб Azure AD |
...
| Аутентификация | Протоколы на основе OAuth или OpenID Connect | Протоколы Kerberos, NTLM |
