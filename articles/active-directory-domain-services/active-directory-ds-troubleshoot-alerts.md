...
| AADDS500 | *Управляемый домен последний раз синхронизировался с Azure AD {0}. Возможно, пользователям не удастся выполнить вход на управляемый домен или членства в группах могут быть не синхронизированы с Azure AD.* | [Синхронизация не выполнена спустя некоторое время](#aadds500-synchronization-has-not-completed-in-a-while) |
| AADDS501 | *Последняя резервная копия управляемого домена создана XX.* | [Резервная копия не создана спустя некоторое время](#aadds501-a-backup-has-not-been-taken-in-a-while) |
...
*Управляемый домен последний раз синхронизировался с Azure AD {0}. Возможно, пользователям не удастся выполнить вход на управляемый домен или членства в группах могут быть не синхронизированы с Azure AD.*
...
*Последняя резервная копия управляемого домена создана XX.*
