...
- **Доступно в различных регионах Azure:** список регионов Azure, в которых доступны доменные службы Azure AD, см. на странице [поддерживаемые регионы Azure](active-directory-ds-regions.md).
