...
* Убедитесь, что сертификат защищенного протокола LDAP не выдан промежуточным центром сертификации, который не считается надежным по умолчанию на новой виртуальной машине под управлением Windows.
