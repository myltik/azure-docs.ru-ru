...
# Приступая к работе
## [Создание административной группы](active-directory-ds-getting-started.md)
...
## [Обновление параметров DNS](active-directory-ds-getting-started-dns.md)
...
## [Синхронизация с локальным каталогом](active-directory-ds-synchronization.md)
