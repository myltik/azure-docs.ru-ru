<properties 
	pageTitle="Обзор сегментирования" 
	description="Описание причин сегментирования: масштабирование ресурсов базы данных для повышения доступности или производительности." 
...
Независимо от используемой модели сегментирования специальная структура данных, известная как **сопоставление сегментов**, служит в качестве подстановочной таблицы, ставящей в соответствие значения ключей сегментирования и базы данных, давая возможность приложению выполнять маршрутизацию запросов к базе данных. Это называется **маршрутизацией, зависящей от данных**, и представляет собой основной ресурс, необходимый для предоставления приложению возможности использовать уровень сегментированных данных. [API клиентов эластичного масштабирования](http://go.microsoft.com/?linkid=9862592) предоставляют большой набор функциональных возможностей, необходимых для [управления сопоставлениями сегментов](http://go.microsoft.com/?linkid=9862595) и обеспечения эффективности и простоты использования [возможностей маршрутизации на основе данных](http://go.microsoft.com/?linkid=9862596) в приложении. 
