<properties 
	...
	description="Основные концепции о пакете Azure и использование службы пакета в простом сценарии" 
	services="batch" 
...
Общую информацию и сценарии для Пакетной службы Azure см. в разделе [Технический обзор пакетной службы Azure](http://azure.microsoft.com/documentation/articles/batch-technical-overview/).
...
>[WACOM.NOTE] Для работы с этим учебником требуется учетная запись Azure. Вы можете создать бесплатную пробную учетную запись всего за несколько минут. Дополнительные сведения см. в разделе [Бесплатная пробная версия Azure](http://azure.microsoft.com/pricing/free-trial/). 
>
...
Для создания учетной записи Пакетной службы можно использовать портал управления. После создания учетной записи вам будет предоставлен ключ. Дополнительную информацию см. в разделе [Технический обзор Пакетной службы Azure](http://azure.microsoft.com/documentation/articles/batch-technical-overview/).  
...
Дополнительную информацию о службе хранилища Azure см. в разделе [Использование службы хранилища больших двоичных объектов Azure в .NET](http://azure.microsoft.com/develop/net/how-to-guides/blob-storage/).  
