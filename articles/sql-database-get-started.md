<properties urlDisplayName="How to create and provision" pageTitle="Приступая к работе с базами данных SQL &mdash; Azure" metaKeywords="" description="Начните создавать базы данных SQL и управлять ими в Azure." metaCanonical="" services="sql-database" documentationCenter="" title="Приступая к работе с базой данных SQL Azure" authors="loclar"  solutions="" writer="" manager="jeffreyg" editor="tysonn"  />
...
1.  На следующей странице выберите базу данных **School**, а затем выберите **Person**. Нажмите кнопку **Готово** При появлении запроса данных входа, введите их и нажмите кнопку **ОК**.
