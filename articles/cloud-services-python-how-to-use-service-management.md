...
Дополнительные сведения о сертификатах Azure см. в разделе [Управление сертификатами в Windows Azure][Управление сертификатами в Windows Azure]. Полное описание параметров OpenSSL см. в документации по адресу [][]<http://www.openssl.org/docs/apps/openssl.html></a>
