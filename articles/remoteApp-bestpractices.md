<properties title="Azure RemoteApp best practices" pageTitle="Рекомендации по Azure RemoteApp" description="Советы и рекомендации по настройке и использовании удаленных приложений RemoteApp." metaKeywords="" services="" solutions="" documentationCenter="" authors="elizapo"  />
