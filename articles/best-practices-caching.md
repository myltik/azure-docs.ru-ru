...
Для получения дополнительных сведений посетите страницу [Поставщик состояний сеансов ASP.NET для кэша Redis для Azure](redis-cache/cache-asp.net-session-state-provider.md) на веб-сайте Майкрософт.
...
Страница [Документация по кэшу Redis для Azure](http://azure.microsoft.com/documentation/services/cache/) на веб-сайте Майкрософт содержит дополнительные сведения о том, как писать клиентские приложения, которые могут использовать кэш Redis для Azure. Дополнительные сведения можно найти на странице [Основное использование](https://github.com/StackExchange/StackExchange.Redis/blob/master/Docs/Basics.md) веб-сайта StackExchange.Redis, а на странице [Конвейеры и мультиплексоры](https://github.com/StackExchange/StackExchange.Redis/blob/master/Docs/PipelinesMultiplexers.md) на том же веб-сайте содержатся дополнительные сведения об асинхронных операциях и конвейеризации с Redis при использовании библиотеки StackExchange. Варианты использования кэша Redis, представленные далее в этом руководстве, показывают примеры более совершенных методов, которые можно применять для данных, хранящихся в кэше Redis.
...
- Страница [Документации по кэшу Redis для Azure](http://azure.microsoft.com/documentation/services/cache/) на веб-сайте Майкрософт.
...
- Страница [Краткая информация о кэше Redis для Azure](http://azure.microsoft.com/blog/2014/06/04/lap-around-azure-redis-cache-preview/) в блоге Azure.
