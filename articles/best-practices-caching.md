---
title: "Руководство по кэшированию | Документация Майкрософт"
...
---
# <a name="caching-guidance"></a>Руководство по кэшированию
...
* более низкая скорость доступа к кэшу, так как данные больше не располагаются локально для каждого экземпляра приложения;
...
> В процессе подготовки к завершению использования рекомендуется перейти на кэш Redis для Azure. Дополнительные сведения см. на странице [Какое предложение и размер кэша Redis мне следует использовать?](redis-cache/cache-faq.md#what-redis-cache-offering-and-size-should-i-use) на веб-сайте Майкрософт.
> 
> 
...
### <a name="using-the-azure-redis-cache"></a>Использование кэша Redis для Azure
...
[AZURE.NOTE] Обратите внимание, что при реализации кэша Redis таким образом вы несете ответственность за мониторинг, управление и обеспечение безопасности службы.
...
Дополнительные сведения см. на странице [Transactions in Redis](https://github.com/StackExchange/StackExchange.Redis/blob/master/Docs/Transactions.md) (Транзакции в Redis) на веб-сайте StackExchange.Redis.
...
> *Совет*. Можно вручную удалить объект из кэша с помощью команды DEL, которая доступна в библиотеке StackExchange как метод `IDatabase.KeyDeleteAsync`.
> 
> 
