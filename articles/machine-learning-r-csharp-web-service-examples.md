<properties title="Sample Web Services Built with R on Azure ML and Published to Marketplace" pageTitle="Примеры веб-служб, построенных с помощью языка R в Azure ML и опубликованных в Магазине | Azure" description="Примеры веб-служб, построенных с помощью языка R в Azure ML и опубликованных в Магазине" metaKeywords="" services="machine-learning" solutions="" documentationCenter="" authors="jaymathe" manager="paulettm" editor="cgronlun" videoId="" scriptId="" />
...
* [Бинарный классификатор](http://azure.microsoft.com/ru-ru/documentation/articles/machine-learning-r-csharp-binary-classifier/)
* [Кластерная модель](http://azure.microsoft.com/ru-ru/documentation/articles/machine-learning-r-csharp-cluster-model/)
* [Многомерная линейная регрессия](http://azure.microsoft.com/ru-ru/documentation/articles/machine-learning-r-csharp-multivariate-linear-regression/)
* [Прогнозирование на основе метода экспоненциального сглаживания](http://azure.microsoft.com/ru-ru/documentation/articles/machine-learning-r-csharp-forecasting-exponential-smoothing/)
* [Прогнозирование ETS+STL](http://azure.microsoft.com/ru-ru/documentation/articles/machine-learning-r-csharp-retail-demand-forecasting/)
* [Прогнозирование на основе метода авторегрессионного интегрированного скользящего среднего](http://azure.microsoft.com/ru-ru/documentation/articles/machine-learning-r-csharp-arima/)
* [Анализ выживаемости](http://azure.microsoft.com/ru-ru/documentation/articles/machine-learning-r-csharp-survival-analysis/)
...
* [Анализ мнений на основе словаря](http://azure.microsoft.com/ru-ru/documentation/articles/machine-learning-r-csharp-lexicon-based-sentiment-analysis/)
...
* [Тест на разницу в пропорциях](http://azure.microsoft.com/ru-ru/documentation/articles/machine-learning-r-csharp-difference-in-two-proportions/)
* [Набор нормального распределения](http://azure.microsoft.com/ru-ru/documentation/articles/machine-learning-r-csharp-normal-distribution/)
* [Набор биномиального распределения](http://azure.microsoft.com/ru-ru/documentation/articles/machine-learning-r-csharp-binomial-distribution/)
