...
-   [У различных поставщиков дистрибутивов, работающих с Linux в Azure][]
-   или из [Репозитория Github открытого исходного кода для агента Azure Linux][]
