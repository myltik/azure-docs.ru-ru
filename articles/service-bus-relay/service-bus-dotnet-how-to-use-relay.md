---
title: Использование службы ретранслятора служебной шины (.NET) | Microsoft Docs
...
---
# <a name="how-to-use-the-azure-service-bus-relay-service"></a>Использование службы ретранслятора служебной шины Azure
...
## <a name="use-service-bus-to-expose-and-consume-a-soap-web-service-with-tcp"></a>Использование служебной шины для предоставления и получения веб-службы SOAP с TCP
...
### <a name="configure-a-service-host-in-the-app.config-file"></a>Настройка узла службы в файле App.config
...
#### <a name="configure-a-client-in-the-app.config-file"></a>Настройка клиента в файле App.config
