---
title: "Обзор ретранслятора служебной шины | Документация Майкрософт"
...
![Обзор ретранслятора WCF](./media/service-bus-relay-overview/sb-relay-01.png)
...
* [Как использовать службу ретранслятора WCF служебной шины](service-bus-dotnet-how-to-use-relay.md)
