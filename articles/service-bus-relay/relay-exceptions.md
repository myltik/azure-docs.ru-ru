---
title: "Исключения ретранслятора Azure и способы их устранения | Документация Майкрософт"
description: "Список исключений ретранслятора и предлагаемые действия."
