---
title: "Руководство по использованию ретранслятора WCF служебной шины | Документация Майкрософт"
...
---
# <a name="service-bus-wcf-relay-tutorial"></a>Руководство по использованию ретранслятора WCF служебной шины
