...
<!-- Anchors.  URLs. -->
  ...
  [<span class="icon">Воспроизведение видео</span>]: http://channel9.msdn.com/Series/Windows-Azure-Mobile-Services/Windows-Store-app-Getting-Started-with-Authentication-in-Windows-Azure-Mobile-Services
