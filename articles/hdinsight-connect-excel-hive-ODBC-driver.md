...
Можно также подключить данные, связанные с кластером HDInsight, и другими источниками данных, включая другие кластеры Hadoop (не HDInsight) из Excel с использованием надстройки Microsoft Power Query для Excel. Сведения об установке и использовании Power Query см. в разделе [Подключение Excel к HDInsight с использованием Power Query][]
...
1.  [Установка драйвера Microsoft Hive ODBC][]
2.  [Создание источника данных Hive ODBC][]
3.  [Импорт данных в Excel из кластера HDInsight][]
4.  [Дальнейшие действия][]

## <span id="InstallHiveODBCDriver"></span></a>Установка драйвера Microsoft Hive ODBC

Загрузите и установите драйвер Microsoft Hive ODBC из [Центра загрузок][].
