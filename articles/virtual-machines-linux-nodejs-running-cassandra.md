...
<tr><td>УЧЕТНАЯ ЗАПИСЬ ХРАНЕНИЯ </td><td>	Используйте значение по умолчанию.	</td><td>Используйте учетную запись хранения по умолчанию  или заранее созданную учетную запись хранения в определенном регионе</td></tr>
