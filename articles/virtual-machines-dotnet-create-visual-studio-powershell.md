<properties urlDisplayName="Create a virtual machine for a website" pageTitle="Создание виртуальной машины для веб-проекта с помощью Visual Studio" metaKeywords="Visual Studio, ASP.NET, web project, virtual machine" description="Создание виртуальной машины для веб-сайта" metaCanonical="" services="" documentationCenter="" title="Создание виртуальной машины для веб-сайта с помощью Visual Studio" authors="ghogen" solutions="" manager="douge" editor="" />
...
1.  (Дополнительно.) В **обозревателе сервера** разверните узел **Виртуальные машины**, выберите узел для созданной виртуальной машины, а затем выберите **Подключение к удаленному рабочему столу**, чтобы подключиться к виртуальной машине.

# Дальнейшие действия

Если требуется настроить созданные скрипты публикации, более подробные сведения см. [здесь][здесь].
  ...
  [здесь]: http://msdn.microsoft.com/library/dn642480.aspx
