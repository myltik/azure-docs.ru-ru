---
title: Интеграция Cloud Cruiser и API выставления счетов Microsoft Azure | Microsoft Docs
...
### <a name="cloud-cruiser’s-interface-to-azure-ratecard-api"></a>Интерфейс Cloud Cruiser для API RateCard Azure
