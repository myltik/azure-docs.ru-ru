...
- В [рекомендуемых ресурсах по веб-заданиям Azure](websites-webjobs-resources.md) перечислены многие полезные ресурсы, файлы для скачивания и примеры для веб-заданий.
...
- Использование задачи запуска для установки службы Windows, которая выполняет одну или несколько фоновых задач. Чтобы эта служба выполнялась в фоновом режиме, необходимо для свойства **taskType** задать значение **background**. Дополнительную информацию см. в статье [Выполнение задач запуска в Azure](cloud-services-startup-tasks.md).
...
Чтобы решить, когда следует использовать виртуальные машины, см. статью [Сравнение служб приложений, облачных служб и виртуальных машин Azure](choose-web-site-cloud-service-vm.md). Дополнительную информацию о параметрах [виртуальных машин см. раздел «Размеры виртуальных машин и облачных служб для Azure»](http://msdn.microsoft.com/library/azure/dn197896.aspx). Дополнительную информацию об операционных системах и готовых образах, доступных для виртуальных машин, см. в [коллекции виртуальных машин Azure](http://azure.microsoft.com/gallery/virtual-machines/).
...
- [Виртуальные машины в Azure](http://azure.microsoft.com/services/virtual-machines/)
...
- В дополнение к методам класса **RoleEntryPoint** можно использовать задачи запуска. Задачи запуска следует использовать для инициализации любых параметров, которые необходимо изменить в балансировщике нагрузки Azure, так как эти задачи будут выполнены прежде, чем роль получит какие-либо запросы. Дополнительную информацию см. в статье [Выполнение задач запуска в Azure](cloud-services-startup-tasks.md).
