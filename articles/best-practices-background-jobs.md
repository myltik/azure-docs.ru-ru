...
- Если требуется, чтобы задание реагировало на управляемый событиями триггер, оно должно быть настроено как **Выполнять постоянно**. Сценарий или программа хранится в папке site/wwwroot/app_data/jobs/continuous.
- Если требуется, чтобы задание реагировало на управляемый расписанием триггер, оно должно быть настроено как **Выполнять по расписанию**. Сценарий или программа хранится в папке site/wwwroot/app_data/jobs/triggered.
