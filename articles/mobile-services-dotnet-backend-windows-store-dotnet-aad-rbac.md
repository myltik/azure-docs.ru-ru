...
<div class="dev-center-tutorial-selector sublanding">
    <a href="/ru-ru/documentation/articles/mobile-services-dotnet-backend-windows-store-dotnet-aad-rbac/" title="Магазин Windows C#" class="current">Магазин Windows C#</a>
</div>

<div class="dev-center-tutorial-subselector">
    <a href="/ru-ru/documentation/articles/mobile-services-dotnet-backend-windows-store-dotnet-aad-rbac/" title="Сервер .NET" class="current">Сервер .NET</a> | 
    <a href="/ru-ru/documentation/articles/mobile-services-javascript-backend-windows-store-dotnet-aad-rbac/" title="Сервер JavaScript">Сервер JavaScript</a>
</div>
...
3.  [Создание пользовательского атрибута авторизации][Создание пользовательского атрибута авторизации]
...
6.  В начало файла AuthorizeAadRole.cs добавьте следующие операторы `using`.
...
10. В файле AuthorizeAadRole.cs обновите метод `OnAuthorization` в классе `AuthorizeAadRole` с помощью следующего кода. Этот код использует [клиентскую библиотеку Graph][клиентской библиотеки Graph] для поиска группы Active Directory, соответствующей роли. Затем он проверяет членство пользователя в этой группе для его авторизации.
...
11. Сохраните изменения в файле AuthorizeAadRole.cs.
...
2.  В файле TodoItemController.cs добавьте оператор `using` для пространства имен служебной программы, который содержит пользовательский атрибут авторизации.
...
<!-- URLs. -->
  ...
  [Магазин Windows C#]: /ru-ru/documentation/articles/mobile-services-dotnet-backend-windows-store-dotnet-aad-rbac/ "Магазин Windows C#"
  [Сервер .NET]: /ru-ru/documentation/articles/mobile-services-dotnet-backend-windows-store-dotnet-aad-rbac/ "Сервер .NET"
  [Сервер JavaScript]: /ru-ru/documentation/articles/mobile-services-javascript-backend-windows-store-dotnet-aad-rbac/ "Сервер JavaScript"
  [клиентской библиотеки Graph]: http://go.microsoft.com/fwlink/?LinkId=510536
