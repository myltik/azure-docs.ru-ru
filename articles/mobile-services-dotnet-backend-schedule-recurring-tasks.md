...
- [(Любая | .NET)](mobile-services-dotnet-backend-schedule-recurring-tasks.md)
- [(Любая | Javascript)](mobile-services-schedule-recurring-tasks.md)
...
1. [Регистрация для доступа к Twitter и сохранения учетных данных]
2. [Скачивание и установка библиотеки LINQ to Twitter]
...
##<a name="install-linq2twitter"></a>Скачивание и установка библиотеки LINQ to Twitter
...
2. Замените содержимое файла SampleJob.cs на код, приведенный ниже:
	...
	В приведенном выше коде необходимо заменить строки _todolistService_ и _todolistContext_ на пространство имен и DbContext скачанного проекта, т. е. <em>mobile&#95;service&#95;name</em>Service и <em>mobile&#95;service&#95;name</em>Context соответственно.  
...
[Скачивание и установка библиотеки LINQ to Twitter]: #install-linq2twitter
...
[Регистрация приложений для входа в Twitter с помощью мобильных служб]: mobile-services-how-to-register-twitter-authentication.md
