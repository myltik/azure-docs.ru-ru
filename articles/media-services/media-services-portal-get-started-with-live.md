<properties
	pageTitle="Использование классического портала Azure для создания каналов, получающих динамические потоки данных с несколькими скоростями от локальных кодировщиков | Microsoft Azure"
...
# Использование классического портала Azure для создания каналов, получающих динамические потоки данных с несколькими скоростями от локальных кодировщиков

[AZURE.INCLUDE [media-services-selector-manage-channels](../../includes/media-services-selector-manage-channels.md)]


В этом руководстве подробно описываются все этапы создания простого приложения служб мультимедиа для потоковой трансляции, которое реализует канал, принимающий динамический мультискоростной поток данных от локального кодировщика. Более подробные сведения о работе с каналами и связанными с ними компонентами см. в разделе [Работа с каналами, принимающими динамические мультискоростные потоки от локальных кодировщиков](media-services-live-streaming-with-onprem-encoders.md).

В этом руководстве описано выполнение перечисленных ниже задач с помощью классического портала Azure.
...
## Настройка конечной точки потоковой передачи с помощью классического портала Azure
...
На классическом портале Azure выберите страницу **КАНАЛЫ**. Нажмите кнопку **СОЗДАТЬ**. На странице **Создание нового динамического канала** введите имя канала.
...
Дополнительные сведения об URL-адресах приема см. в разделе [Передача мультискоростного динамического потока данных каналу с использованием локальных кодировщиков](media-services-live-streaming-with-onprem-encoders.md).
...
Подробные сведения о настройке Wirecast и запуске потоковой передачи данных на вход см. в разделе [Настройка Wirecast](https://azure.microsoft.com/blog/2014/09/18/azure-media-services-rtmp-support-and-live-encoders/).

>[AZURE.NOTE] Если вы по какой-то причине остановили кодировщик, а затем его потребовалось перезапустить, сначала выполните сброс канала с помощью команды **СБРОС** на классическом портале Azure.
...
- [Приступая к работе с динамической потоковой передачей с помощью классического портала Azure](https://azure.microsoft.com/blog/getting-started-with-live-streaming-using-the-azure-management-portal/)
