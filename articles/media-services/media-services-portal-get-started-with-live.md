...
- [Приступая к работе с динамической потоковой передачей с помощью классического портала Azure](http://azure.microsoft.com/blog/getting-started-with-live-streaming-using-the-azure-management-portal/)
