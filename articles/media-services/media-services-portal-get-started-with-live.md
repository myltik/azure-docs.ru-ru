...
Чтобы изменить число зарезервированных единиц потоковой передачи, выполните перечисленные ниже действия.
...
На этой странице ****можно найти все ресурсы, созданные для ваших программ.
...
Технология динамической упаковки обеспечить упаковку динамического потока данных с использованием указанного протокола.
