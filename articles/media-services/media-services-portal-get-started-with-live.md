...
Дополнительные сведения об URL-адресах приема см. в разделе [Передача мультискоростного динамического потока данных каналу с использованием локальных кодировщиков](media-services-manage-channels-overview.md).
