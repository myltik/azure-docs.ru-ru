...
Дополнительные сведения о вариантах доставки активов см. в разделе [Доставка активов с помощью пакета SDK служб мультимедиа для .NET](media-services-deliver-streaming-content.md).
