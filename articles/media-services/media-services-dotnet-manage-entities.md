...
См. статью [Настройка среды](media-services-set-up-computer.md).
...
Предупреждение. Получение ссылки на задание может потребоваться при запуске длительного задания кодирования, когда необходимо проверять состояние задания в программном потоке. В таких случаях при возвращении метода из потока требуется получить обновленную ссылку на задание.
