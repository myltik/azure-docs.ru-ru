...
# Телеметрия служб мультимедиа Azure
...
### Схема вывода данных телеметрии хранилища таблиц
...
RowKey|{число секунд до полуночи}_{случайное значение}|01688_00199<br/><br/>Ключ строки начинается с числа секунд до полуночи, чтобы сделать возможным выполнение запросов получения N первых элементов в секции. Дополнительные сведения см. в [этой статье](../storage/storage-table-design-guide.md#log-tail-pattern). 
...
### Как использовать данные метрик?
...
### Как узнать среднее использование пропускной способности?
...
### Как определить количество единиц потоковой передачи?
...
### Как найти среднее число запросов в секунду?
...
### Как определить работоспособность канала?
...
### Как выявить перекрытия меток времени?
...
### Как найти сведения о сбоях запросов потоковой передачи и их причинах?
...
### Как использовать данные с помощью внешних инструментов?
...
### Как управлять хранением данных?
