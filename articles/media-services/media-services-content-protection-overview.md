---
title: "Общие сведения о защите содержимого | Документация Майкрософт"
...
> [!NOTE]
> Для использования динамического шифрования вам потребуется получить по крайней мере одну единицу потоковой передачи по запросу для конечной точки потоковой передачи, из которой планируется передавать зашифрованное содержимое. Дополнительные сведения см. в статье [Масштабирование служб мультимедиа](media-services-portal-manage-streaming-endpoints.md).
> 
> 
