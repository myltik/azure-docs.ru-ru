...
**CommonEncryptionProtected** — используйте этот параметр, если вы хотите зашифровать содержимое с помощью стандартного шифрования либо передать уже зашифрованное содержимое. PlayReady и Widewine шифруются согласно спецификации общего шифрования (CENC) и поддерживаются AMS.
