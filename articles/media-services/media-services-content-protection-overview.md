...
Параметр **EnvelopeEncryptionProtected** позволяет защитить потоковую передачу HTTP (HLS), зашифрованную с помощью AES, или же добавить уже защищенную передачу. Обратите внимание, что при передаче HLS уже с шифрованием AES, он должен был зашифрован с помощью Transform Manager.
