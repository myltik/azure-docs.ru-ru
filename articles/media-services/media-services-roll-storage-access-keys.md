...
## <a name="a-idstep2astep-2--update-media-services-to-use-the-new-secondary-storage-key"></a><a id="step2"></a>Шаг 2. Обновление служб мультимедиа для использования нового дополнительного ключа к хранилищу данных
...
Создайте основной ключ доступа к хранилищу. Информацию о последовательной смене ключей к хранилищу данных см. в [статье о просмотре, копировании и повторном создании ключей доступа к хранилищу](../storage/storage-create-storage-account.md#view-and-copy-storage-access-keys).
