<properties 
    pageTitle="Обновление служб мультимедиа после оборота ключей доступа к хранилищу | Microsoft Azure" 
...
Создайте основной ключ доступа к хранилищу. Информацию о последовательной смене ключей к хранилищу данных см. в [статье о просмотре, копировании и повторном создании ключей доступа к хранилищу](../storage-create-storage-account.md#view-copy-and-regenerate-storage-access-keys).
