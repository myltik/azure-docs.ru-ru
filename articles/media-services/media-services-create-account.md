...
Кроме того, можно просмотреть код, который использует пакет SDK для служб мультимедиа Azure для выполнения следующих задач: добавление, кодирование и публикация видеоматериалов. Щелкнуть одну из ссылок в разделе **Написание кода**, вы можете скопировать код и вставить его в приложение.
