...
##Обзор
**Конструктор рабочих процессов** — это классическое приложение Windows, которое используется для разработки и создания настраиваемых рабочих процессов шифрования с помощью **расширенного рабочего процесса кодировщика мультимедиа**.
