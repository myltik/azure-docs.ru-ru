...
---
#  <a name="use-azure-media-standard-to-auto-generate-a-bitrate-ladder"></a>Использование Azure Media Encoder Standard для автоматического создания таблицы скоростей и разрешений
