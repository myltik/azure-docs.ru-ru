...
## Выполнение этой задачи с использованием других технологий  

На этой странице представлен обзор масштабирования обработки мультимедиа и показано, как это сделать с помощью классического портала Azure. Эту задачу также можно выполнить с использованием других технологий.
