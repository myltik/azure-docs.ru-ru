<properties
	pageTitle="Обнаружение движения с помощью медиа-аналитики Azure | Microsoft Azure"
...
>[AZURE.NOTE]В последнем выпуске формат выходного JSON-файла изменен. Для некоторых клиентов это может быть критическое изменение.
...
регионы|Область в видео, где необходимо отслеживать движение. <br/><br/> id представляет область. В этой версии существует только один идентификатор — 0. <br/> type представляет фигуру, ограничивающую область, в которой необходимо отслеживать движение. Сейчас поддерживаются прямоугольник и многоугольник.<br/> Если используется прямоугольник, то размеры области выражаются в значениях координат X, Y, ширины и высоты. Координаты X и Y представляют верхние левые координаты X и Y области по нормализованной шкале от 0,0 до 1,0. Ширина и высота представляют размер области по нормализованной шкале от 0,0 до 1,0. В текущей версии значения координат X, Y, ширины и высоты всегда фиксированы в позициях 0,0 и 1,1. <br/>Если используется многоугольник, то размеры области выражаются в точках. <br/>
