...
Задание обнаружения движения возвращает в выходной ресурс-контейнер JSON-файл, описывающий оповещения о движении и их категории на видео. Файл будет содержать сведения о времени и длительности движения, обнаруженного на видео.
