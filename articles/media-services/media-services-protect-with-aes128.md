<properties
	pageTitle="Использование динамического шифрования AES-128 и службы доставки ключей"
...
1. [Создание указателя OnDemand](media-services-protect-with-aes128.md#create_locator) для получения URL-адреса для потоковой передачи.

В этом разделе также показано, [как клиентское приложение может запрашивать ключ у службы доставки ключей](media-services-protect-with-aes128.md#client_request).
