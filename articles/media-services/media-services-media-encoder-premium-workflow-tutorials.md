...
description: 'Этот документ содержит пошаговые инструкции, показывающие, как выполнять расширенные задачи с рабочим процессом кодировщика мультимедиа ценовой категории '
;премиум";,: ''
а: ''
также: ''
как: ''
...
* [Расширенная схема кодирования файла MXF в файл MP4 с несколькими скоростями](media-services-media-encoder-premium-workflow-tutorials.md#MXF_to__multibitrate_MP4)
  ...
  * [Соглашения об именовании файлов](vMXF_to__multibitrate_MP4_file_naming.md)
