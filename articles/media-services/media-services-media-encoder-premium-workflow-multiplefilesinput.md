---
title: Использование нескольких входных файлов и свойств компонентов в кодировщике Premium | Microsoft Docs
description: 'В этой статье описано, как с помощью свойства setRuntimeProperties можно использовать несколько входных файлов в обработчике мультимедиа '
расширенный: ''
рабочий: ''
процесс: ''
обработчика: ''
...
### <a name="step-by-step-workflow-creation-that-overlays-a-logo-on-top-of-the-video"></a>Пошаговая инструкция по созданию рабочего процесса, в котором логотип накладывается поверх видео
