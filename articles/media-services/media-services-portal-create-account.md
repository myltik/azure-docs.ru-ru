---
title: " Создание учетной записи служб мультимедиа Azure с помощью портала Azure | Документация Майкрософтs"
...
4. Нажмите кнопку **Создать** в нижней части формы.
    ...
    ![Параметры служб мультимедиа](./media/media-services-create-account/media-services-settings.png)
...
3. Нажмите кнопку копирования, чтобы скопировать значения.
    ...
    ![Ключи служб мультимедиа](./media/media-services-create-account/media-services-keys.png)
