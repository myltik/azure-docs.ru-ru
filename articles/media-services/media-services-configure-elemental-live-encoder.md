...
3. Щелкните **Create Channel** (Создать канал). ![Elemental](./media/media-services-elemental-live-encoder/media-services-elemental12.png)
...
4. После создания выходных данных щелкните **Add Stream** (Добавить поток). Теперь можно настроить параметры выхода.
...
1. Вставьте этот адрес в поле **Primary Destination** (Основное назначение) Elemental. Все остальные параметры можно оставить без изменений.
