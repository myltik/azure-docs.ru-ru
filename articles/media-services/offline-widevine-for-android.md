...
В то же время в [документации по службам мультимедиа Azure в шаблоне лицензии Widevine](https://docs.microsoft.com/en-us/azure/media-services/media-services-widevine-license-template-overview) свойство security_level объекта content_key_specs может иметь пять различных значений (требования к надежности клиента для воспроизведения):
