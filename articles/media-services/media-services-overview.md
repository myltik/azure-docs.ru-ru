...
## <a id="live_scenarios"></a>Трансляция мероприятий с помощью динамической потоковой передачи и служб мультимедиа Azure
...
Дополнительные сведения можно найти в разделе [Working with Channels that are Enabled to Perform Live Encoding with Azure Media Services](media-services-manage-live-encoder-enabled-channels.md) (Работа с каналами, выполняющими кодирование в реальном времени с помощью служб мультимедиа Azure).

<a id="supported-media-processors" class="xliff"></a>

## Поддерживаемые обработчики мультимедиа
...
|Индексатор мультимедийных данных версии 2|Предварительный просмотр|Все, кроме регионов "Китай" и "Федеральное правительство США"|
