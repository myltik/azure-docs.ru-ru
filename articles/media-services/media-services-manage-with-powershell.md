...
Чтобы обновить первичный или вторичный ключ доступа служб мультимедиа, используйте командлет [New-AzureMediaServicesKey](https://msdn.microsoft.com/library/azure/dn495215.aspx). 
Необходимо указать имя учетной записи и ключ, который следует создать повторно (первичный или вторичный). 
