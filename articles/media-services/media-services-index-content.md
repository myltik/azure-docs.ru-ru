...
В этой статье показано, как создавать задания для **индексирования ресурса-контейнера** и **индексирования нескольких файлов**.
...
<!-- __ -->
### <a name="a-idoutputfilesaoutput-files"></a><a id="output_files"></a>Выходные файлы
...
### <a name="a-idpreseta-task-preset-for-azure-media-indexer"></a><a id="preset"></a> Предустановка задачи для индексатора мультимедийных данных Azure
...
### <a name="a-iderrorcodesaerror-codes"></a><a id="error_codes"></a>Коды ошибок
...
## <a name="a-idsupportedlanguagesasupported-languages"></a><a id="supported_languages"></a>Поддерживаемые языки
