...
| **Рабочий процесс Media Encoder Premium** |РАСШИРЕННЫЙ КОДИРОВЩИК |Плата за выполнение задач кодирования взимается на основе размера выходного ресурса-контейнера в гигабайтах по тарифу, указанному [здесь][1] в столбце "Расширенный кодировщик". |
