...
В этой статье описывается создание Функций Azure, использующих службы мультимедиа. Функция Azure, определенная в этом разделе, отслеживает контейнер учетной записи хранения **input** на наличие новых MP4-файлов. После попадания файла в контейнер хранилища триггер большого двоичного объекта выполнит функцию. **Обзор функций Azure** см. в разделах статьи [Общие сведения о Функциях Azure](../azure-functions/functions-overview.md).
