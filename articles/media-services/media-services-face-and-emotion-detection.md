...
В этой статье приводятся подробные сведения о **детектор лицевой стороны Azure Media** и показано, как использовать пакет SDK служб мультимедиа для .NET.
...
* Некоторые лица могут не обнаруживаться из-за технической проблемы; Например, очень большой углы лицевой стороны (head позы) и больших перекрытия. Лучшие результаты определяются для лиц в анфас или практически в анфас.
...
2. Создание задания с задачу обнаружения лиц на основе файла конфигурации, содержащий следующий набор параметров json: 
