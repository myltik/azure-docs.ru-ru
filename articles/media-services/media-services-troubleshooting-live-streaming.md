...
###Проблема: необходимо просмотреть журналы кодировщика. 

- **Потенциальная проблема**: не удается найти журналы, которые могут помочь в отладке.

	**Действия по устранению неполадок**: обычно журналы Wirecast можно найти в папке C:\\Users\\{имя\_пользователя}\\AppData\\Roaming\\Wirecast\\.
