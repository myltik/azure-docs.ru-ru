...
1. В [портале Azure](https://manage.windowsazure.com/) последовательно выберите **Создать**, **Служба мультимедиа**, **Быстрое создание**.
...
1. В [портале Azure](https://manage.windowsazure.com/) щелкните элемент **Службы мультимедиа**. Затем щелкните имя службы мультимедиа.
...
1. В [портале Azure](http://go.microsoft.com/fwlink/?LinkID=256666&clcid=0x409) щелкните **Службы мультимедиа**, а затем щелкните имя учетной записи служб мультимедиа.
...
В этом разделе описаны шаги, которые можно предпринять для кодирования содержимого с помощью кодировщика мультимедиа Azure на портале Azure.
...
При публикации ресурсов в портале Azure создаются указатели, а также предоставляется URL-адрес OnDemand (если ресурс содержит ISM-файл) или URL-адрес SAS.
