...
5. Выберите одну из **конфигураций кодирования**.
	...
	**Другие** конфигурации описаны ниже.
	...
	+ **Кодирование с системой защиты содержимого PlayReady**. Эта предустановка позволяет получить кодированный актив с защитой содержимого PlayReady.  
...
При использовании портала управления Azure для публикации ресурсов создаются указатели, а также предоставляется URL-адрес на основе OnDemand (если ресурс содержит файл .ISM) или URL-адрес SAS.
