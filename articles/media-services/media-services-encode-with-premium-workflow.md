...
Службы мультимедиа Azure корпорации Майкрософт представляют общедоступную предварительную версию обработчика мультимедиа **Media Encoder Premium Workflow**. Данный обработчик предоставляет расширенные возможности кодирования для рабочих процессов уровня premium по требованию.
