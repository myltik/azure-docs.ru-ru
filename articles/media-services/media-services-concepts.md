...
Службы мультимедиа также обеспечивают доставку лицензий PlayReady и незащищенных ключей AES авторизованным клиентам. Чтобы настроить политики авторизации и проверки подлинности для лицензий и ключей, можно использовать классический портал Azure, API REST или пакет SDK служб мультимедиа для .NET.
