...
## <a name="a-idassetsaassets-and-storage"></a><a id="assets"></a>Ресурсы-контейнеры и хранилища
...
### <a name="a-idlocatorsalocators"></a><a id="locators"></a>Указатели
...
## <a name="a-idencodingaencoding"></a><a id="encoding"></a>Кодирование
...
### <a name="a-iddynamicpackagingadynamic-packaging"></a><a id="dynamic_packaging"></a>Динамическая упаковка
