...
2. Получите URL-адрес приема канала.
...
1. Создайте ресурс.
2. Чтобы реализовать динамическое шифрование ресурса во время воспроизведения, выполните перечисленные ниже действия.
3. Создайте ключ содержимого.
...
6. Создайте программу и укажите в ней, что нужно использовать созданный вами ресурс.
7. Опубликуйте ресурс, связанный с программой, создав указатель OnDemand.
...
3. Чтобы остановить потоковую передачу и архивацию содержимого мероприятия, завершите работу программы.
4. Удалите программу (и при необходимости ресурс).
...
4. Создание ресурса (файла), который будет использоваться для хранения содержимого. Также необходимо настроить политики передачи ресурсов, как показано в этом примере.
...
2. Добавьте в свое консольное приложение пакет SDK служб мультимедиа для .NET с помощью пакета NuGet служб мультимедиа.
