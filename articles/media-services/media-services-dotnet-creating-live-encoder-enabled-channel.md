...
[Работа с каналами, выполняющими динамическое преобразование односкоростного потока в мультискоростной](media-services-manage-live-encoder-enabled-channels.md) 
