<properties 
	pageTitle="Создание ContentKey с помощью REST | Microsoft Azure" 
...
При доставке ресурсов-контейнеров клиентам можно [настроить динамическое шифрование таких ресурсов](media-services-rest-configure-asset-delivery-policy.md), используя один из двух следующих типов шифрования: **DynamicEnvelopeEncryption** или **DynamicCommonEncryption**.
