<properties
	pageTitle="Использование Azure Media Video Thumbnail для формирования сводных данных видео | Microsoft Azure"
...
#Использование Azure Media Video Thumbnail для формирования сводных данных видео
##Обзор
...
В этом разделе приводятся сведения об **Azure Media Video Thumbnail** и демонстрируется использование этого обработчика с пакетом SDK служб мультимедиа для .NET.
...
||||
---|---|---|---|---
Продолжительность видео|видео < 3 мин|3 мин < видео < 15 мин|15 мин < видео < 30 мин| 30 мин < видео
Продолжительность эскиза|15 с (2–3 сцены)| 30 с (3–5 сцен)|60 с (5–10 сцен)|90 с (10–15 сцен)
...
1. Создать задание с задачей создания эскиза видео на основе файла конфигурации, содержащего следующую предустановку JSON.
