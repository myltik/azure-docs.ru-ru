<properties 
	pageTitle="Шифрование содержимого с шифрованием хранилища, используя API REST AMS" 
...
#Шифрование содержимого с шифрованием хранилища, используя API REST AMS
...
##Общие сведения о шифровании хранилища 
...
Одно из значений, которые необходимо задать при создания ключа содержимого — это тип. Для шифрования хранилища используется значение "1".
