<properties 
	pageTitle="Вставка рекламы на стороне клиента | Microsoft Azure" 
...
Сведения о поддержке субтитров и рекламы в динамических потоковых видео см. в разделе [Поддерживаемые стандарты субтитров и рекламы](media-services-live-streaming-with-onprem-encoders.md#cc_and_ads).

>[AZURE.NOTE] Мультимедиапроигрыватель Azure на данный момент не поддерживает рекламу.
