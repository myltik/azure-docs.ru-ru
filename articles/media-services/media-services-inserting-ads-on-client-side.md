...
Сведения о поддержке субтитров и рекламы в динамических потоковых видео см. в разделе [Поддерживаемые стандарты субтитров и рекламы](media-services-manage-channels-overview.md#cc_and_ads).
