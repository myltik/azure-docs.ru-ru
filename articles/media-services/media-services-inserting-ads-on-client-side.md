...
##<a name="<a-id="insert_ads_into_media"></a>inserting-ads-into-your-media"></a><a id="insert_ads_into_media"></a>Вставка рекламы в мультимедиа
...
**<IFrameResource>** описывает ресурс HTML, который может быть отображен в IFrame. **<HTMLResource>** описывает фрагмент HTML-кода, который может быть вставлен в веб-страницу. **<TrackingEvents>** указывают события отслеживания и универсальный код ресурса (URI), который должен запрашиваться при возникновении события. В этом образце отслеживаются события acceptInvitation (принятие приглашения) и collapse (сворачивание). Дополнительные сведения об элементе **<NonLinearAds>** и его дочерних элементах см. в разделе IAB.NET/VAST. Обратите внимание, что элемент **<TrackingEvents>** находится внутри элемента ** <NonLinearAds>**, а не элемента **<NonLinear>**.
...
Дополнительные сведения об элементе <**TrackingEvents**> и его дочерних элементах см. в документе http://iab.org/VMAP.pdf
