...
# Настройка политик защиты содержимого с помощью портала Azure
...
## Начало настройки защиты содержимого
...
## Политика авторизации ключей и лицензий

Службы AMS поддерживают несколько способов аутентификации пользователей, запрашивающих ключи или лицензии. Чтобы получить ключ (лицензию) содержимого, клиент должен соответствовать заданной для этого ключа (лицензии) политике авторизации. Для политики авторизации ключа содержимого можно задать одно или несколько ограничений авторизации: **открытая** авторизация или с ограничением **по маркеру**.
...
## Шаблон прав PlayReady

Подробные сведения о шаблоне прав PlayReady см. в разделе [Обзор шаблонов лицензий PlayReady служб мультимедиа](media-services-playready-license-template-overview.md).
...
## Шаблон прав Widevine

Подробные сведения о шаблоне прав Widevine см. в разделе [Общие сведения о шаблоне лицензии Widevine](media-services-widevine-license-template-overview.md).
...
Подробное описание параметра "Дополнительно" в настройках Widevine см. в [этом разделе](media-services-widevine-license-template-overview.md).

![Защита содержимого](./media/media-services-portal-content-protection/media-services-content-protection005.png)

## Настройка FairPlay

Чтобы включить шифрование FairPlay, необходимо предоставить сертификат приложения и секретный ключ приложения (ASK), используя параметр настройки FairPlay. Подробные сведения о настройке и требованиях FairPlay см. в [этом разделе](media-services-protect-hls-with-fairplay.md).

![Защита содержимого](./media/media-services-portal-content-protection/media-services-content-protection006.png)

## Применение динамического шифрования к ресурсу-контейнеру
...
### Выбор ресурса-контейнера для шифрования
...
### Шифрование с помощью AES или DRM

При нажатии кнопки **Зашифровать** представляется на выбор два варианта: **AES** и **DRM**.
