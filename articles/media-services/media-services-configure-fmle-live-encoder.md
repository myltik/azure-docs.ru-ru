---
title: Настройка кодировщика FMLE для отправки односкоростного обновляющегося потока | Microsoft Docs
...
1. Щелкните **Создать канал**. ![FMLE](./media/media-services-fmle-live-encoder/media-services-fmle2.png)
...
> [!IMPORTANT]
> Перед нажатием кнопки **Подключиться** **обязательно** убедитесь в том, что канал находится в состоянии готовности. Кроме того, не оставляйте канал в состоянии готовности без входного потока более 15 минут.
> 
> 
