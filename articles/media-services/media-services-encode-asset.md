...
- [Кодировщик мультимедиа Azure](media-services-encode-asset.md#azure-media-encoder)
...
Для получения помощи от команды **служб мультимедиа** создайте [запрос в службу поддержки](https://ms.portal.azure.com/#blade/Microsoft_Azure_Support/HelpAndSupportBlade).
