...
В этой статье показано, как скопировать BLOB-объектов из учетной записи хранилища в новый актив служб мультимедиа Azure (AMS) с помощью [расширения SDK .NET служб мультимедиа Azure](https://github.com/Azure/azure-sdk-for-media-services-extensions/).

Методы расширений, работают с:
...
Статьи показано два образца кода.
...
Две учетные записи служб мультимедиа. См. в статье [Создание учетной записи Media Services](media-services-portal-create-account.md).
...
2. Добавить раздел appSettings в файле .config и обновите значения на основе учетных записей служб мультимедиа, целевой учетной записью хранения и идентификатор исходной активов.  
...
### <a name="copy-blobs-from-some-storage-account-into-a-new-asset-in-an-ams-account"></a>Копировать BLOB-объектов из учетной записи хранения в новый ресурс в учетной записи AMS
