...
Чтобы настроить учетную запись служб мультимедиа, перейдите на классический портал Azure. Дополнительные сведения см. в разделе [Создание учетной записи служб мультимедиа](media-services-create-account.md). Создав учетную запись на классическом портале, вы сможете приступить к настройке компьютера для разработки с использованием служб мультимедиа.
