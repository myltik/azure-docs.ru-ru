...
2. Создав проект, найдите кнопку **Поток** и щелкните значок шестеренки рядом с ним для доступа к меню настройки потока.

	![tricaster](./media/media-services-tricaster-live-encoder/media-services-tricaster3.png)
3. Открыв меню, нажмите кнопку **Создать** под заголовком «Подключение». При появлении запроса для типа подключения установите **Adobe Flash**.

	![tricaster](./media/media-services-tricaster-live-encoder/media-services-tricaster4.png)

4. Нажмите кнопку **ОК**.

5. Профиль FMLE теперь можно импортировать, щелкнув стрелку раскрывающегося списка под **Профилем потоковой передачи** и выбрав **Обзор**.

	![tricaster](./media/media-services-tricaster-live-encoder/media-services-tricaster5.png)

6. Перейдите в каталог, в котором был сохранен настроенный профиль FMLE.
7. Выберите его и нажмите **ОК**.
...
7. Вставьте этот адрес в поле **Расположение** в разделе **Flash Server** в проекте Tricaster. Также назначьте имя потока в поле **Идентификатор потока**.

	Если в профиль FMLE была добавлена информация о потоке, ее также можно импортировать в этот раздел, щелкнув **Импорт параметров**, перейдя к сохраненному профилю FMLE и нажав **ОК**. Соответствующие поля Flash Server должны заполниться информацией от FMLE.

	![tricaster](./media/media-services-tricaster-live-encoder/media-services-tricaster7.png)

9. По завершении нажмите **ОК** в нижней части окна. Когда входные видео и звук для Tricaster будут готовы, начните потоковую передачу в AMS, нажав кнопку **Поток**.

	![tricaster](./media/media-services-tricaster-live-encoder/media-services-tricaster11.png)

>[AZURE.IMPORTANT]Перед нажатием кнопки **Поток** **необходимо** убедиться, что канал находится в состоянии готовности. Кроме того, не оставляйте канал в состоянии готовности без входного потока более 15 минут.
