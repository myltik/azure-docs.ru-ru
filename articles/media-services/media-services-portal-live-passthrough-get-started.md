...
---
# <a name="how-to-perform-live-streaming-with-onpremise-encoders-using-the-azure-portal"></a>Потоковая трансляция с помощью локальных кодировщиков c использованием портала Azure
...
## <a name="create-and-start-passthrough-channels-and-events"></a>Создание и запуск сквозных каналов и событий
