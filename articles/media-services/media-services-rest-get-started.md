...
Корневой универсальный код ресурса (URI) для передачи и скачивания файлов ресурса-контейнера — https://yourstorageaccount.blob.core.windows.net/ , где имя_учетной_записи_хранения — это имя, использованное при настройке учетной записи служб мультимедиа.
