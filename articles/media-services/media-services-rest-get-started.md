...
2. Подключение к универсальному коду ресурса служб мультимедиа. 
	...
	> 
	> Кроме того, вы можете получить ответ 200 HTTP/1.1, содержащий описание метаданных API ODATA.3. Последующие вызовы API будут отправляться на новый URL-адрес. 
