.<properties 
	pageTitle="Начало работы с доставкой содержимого по запросу с помощью REST | Microsoft Azure" 
...
>[AZURE.NOTE] Теперь в этом руководстве будет использоваться новый универсальный код ресурса.
