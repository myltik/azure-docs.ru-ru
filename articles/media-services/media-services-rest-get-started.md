...
Ниже показано, как создать задание, содержащее одну задачу кодирования. Эта задача указывает на необходимость перекодирования мезонинного файла в набор MP4-файлов с адаптивной скоростью с помощью **стандартного кодировщика служб мультимедиа**. В данном разделе также показано, как отслеживать ход выполнения задания. После завершения задания можно будет создавать указатели, которые необходимы для получения доступа к ресурсам.
