...
>2. Если возвращается результат HTTP с кодом ошибки 412 (Необходимое условие не выполнено) с сообщением *Кодирование в реальном времени не поддерживается в этом регионе. Для EncodingType необходимо задать значение «Нет»*, ваш центр обработки данных не поддерживает кодирование в реальном времени.
...
---|---|---|---|---|---
3500|1280|720|30|Высокий|Video\_1280x720\_30fps\_3500kbps
2200|960|540|30|Главная|Video\_960x540\_30fps\_2200kbps
1350|704|396|30|Главная|Video\_704x396\_30fps\_1350kbps
850|512|288|30|Главная|Video\_512x288\_30fps\_850kbps
550|384|216|30|Главная|Video\_384x216\_30fps\_550kbps
350|340|192|30|Базовый|Video\_340x192\_30fps\_350kbps
200|340|192|30|Базовый|Video\_340x192\_30fps\_200kbps
...
**Примечание**. Перед созданием канала необходимо отправить изображение баннера с учетом следующих ограничений в качестве выделенного ресурс-контейнера (в этом ресурс-контейнере не должно быть никаких других файлов).
