<properties
	pageTitle="Приступая к работе с доставкой видео по запросу (VOD) с помощью пакета SDK для .NET"
...
# Приступая к работе с доставкой видео по запросу (VOD) с помощью пакета SDK для .NET
...
1. На [портале](https://manage.windowsazure.com/) щелкните элемент **Службы мультимедиа**. Затем щелкните имя службы мультимедиа.
...
5. Замените существующие операторы **using** в начале файла Program.cs на следующий код.
...
Дополнительные сведения о создании приложений для видео по запросу см. в статье [Создание приложений для видео по запросу](media-services-video-on-demand-workflow.md)
