---
title: Общие сведения о динамической упаковке | Microsoft Docs
...
1. [Проверьте предварительно закодированные файлы](media-services-static-packaging.md#validating-adaptive-bitrate-mp4s-encoded-with-external-encoders).
2. [Выполните потоковую передачу содержимого](media-services-deliver-content-overview.md).
