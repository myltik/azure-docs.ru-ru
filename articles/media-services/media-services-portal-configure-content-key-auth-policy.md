...
Вы можете нажать кнопку **импорта XML-файла политики** и выбрать другой XML-файл, который соответствует XML-схеме, определенной [здесь](media-services-playready-license-template-overview.md).
