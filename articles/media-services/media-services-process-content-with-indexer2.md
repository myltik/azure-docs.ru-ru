...
В этой статье показано, как создать задания индексирования с **предварительной версии 2 индексатора мультимедиа Azure**.
...
> 
> При индексировании содержимого обязательно используйте файлы мультимедиа, содержащие отчетливую речь (без фоновой музыки, шума, эффектов или шипения микрофона). Некоторые примеры подходящего содержимого: записанные собраний, лекции или презентации. Для индексирования, как правило, не подходит такое содержимое, как фильмы, телепередачи, любые материалы со смешанными аудио- и звуковыми эффектами, записи плохого качества с фоновым шумом (шипением).
> 
> 

В этой статье приводятся подробные сведения о **предварительной версии 2 индексатора мультимедиа Azure** и показано, как использовать пакет SDK служб мультимедиа для .NET
...
2. Создание задания с задачи индексирования на основе файла конфигурации, содержащий следующий набор параметров json:
