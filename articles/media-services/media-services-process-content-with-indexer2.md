...
При создании задачи индексирования с помощью \*\*индексатора мультимедийных данных Azure 2 \(предварительная версия\)\*\* необходимо указать предустановку конфигурации.

Следующий код JSON задает доступные параметры.
