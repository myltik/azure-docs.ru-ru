.<properties 
	pageTitle="Использование хранилища очередей Azure для наблюдения за уведомлениями о заданиях служб мультимедиа с использованием .NET | Microsoft Azure" 
...
Службы мультимедиа Microsoft Azure позволяют доставлять уведомления в [хранилище очередей Azure](../storage-dotnet-how-to-use-queues.md#what-is) при обработке заданий мультимедиа. В этой статье показано, как получить эти уведомления из хранилища очередей.
...
1. Создает очередь, которая получает уведомления о задании кодирования.
