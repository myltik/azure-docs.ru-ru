...
В целях автоматизации для проверки подлинности клиентского кода можно использовать также службу [Azure Active Directory](https://azure.microsoft.com/documentation/services/active-directory/).
