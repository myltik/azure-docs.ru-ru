...
<!-- URLs. -->
[Начало работы с проверкой подлинности]: app-service-mobile-dotnet-backend-ios-get-started-push-preview.md
[Начало работы с push-уведомлениями]: app-service-mobile-dotnet-backend-ios-get-started-push-preview.md
