...
Импорт параметров |Используйте этот параметр используется при импорте данных конфигурации из DirSync службы синхронизации Azure AD.|
...
Описание дополнительных параметров конфигурации, например для изменения конфигурации по умолчанию, использования редактора правил синхронизации и декларативной подготовки см. в разделе [Управление Azure AD Connect](active-directory-aadconnect-manage.md)
