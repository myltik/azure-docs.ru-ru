...
Пример использования раздела выходных данных связанного шаблона для возврата дисков данных виртуальной машины см. в разделе, посвященном [созданию нескольких дисков данных для виртуальной машины](./resource-group-create-multiple/#creating-multiple-data-disks-for-a-virtual-machine).
