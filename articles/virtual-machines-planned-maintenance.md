...
В противоположность этому, виртуальные машины с одним экземпляром являются изолированными и не входя в группу доступности. Сами по себе виртуальные машины в конфигурации с одним экземпляром не соответствуют соглашению об уровне обслуживания (SLA), для которого требуется не менее двух виртуальных машин, развернутых в рамках одной группы доступности. Дополнительную информацию о соглашении об уровне обслуживания см. в разделе "Облачные службы, виртуальные машины и виртуальная сеть" статьи [Соглашения об уровне обслуживания](http://azure.microsoft.com/support/legal/sla/).
