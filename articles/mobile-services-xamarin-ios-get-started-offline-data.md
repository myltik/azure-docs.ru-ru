...
<!-- URLs. -->
  ...
  [Azure Mobile Services SDK версия 1.3.0-alpha3 (или позднее)]: http://www.nuget.org/packages/WindowsAzure.MobileServices/1.3.0-alpha3
  [Azure Mobile Services SQLite Store версия 1.0.0-alpha2 (или позднее)]: http://www.nuget.org/packages/WindowsAzure.MobileServices.SQLiteStore/1.0.0-alpha2
