...
Дополнительные сведения о TwiML см. на странице [][4]<http://www.twilio.com/docs/api/twiml></a>. Дополнительные сведения о команде \<Say\> и других командах Twilio см. на странице [][5]<http://www.twilio.com/docs/api/twiml/say></a>.
