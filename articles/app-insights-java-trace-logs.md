...
Log4J версии 1.2|[Пакет SDK с аппендером Log4J версии 1.2](http://dl.msopentech.com/applicationinsights/javabin/log4j1_2Appender.zip)|applicationinsights-logging-log4j1\_2 
...
![На портале Application Insights откройте колонку "Поиск по журналу диагностики"](./media/app-insights-java-get-started/10-diagnostics.png)
