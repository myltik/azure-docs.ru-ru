...
-   [Visual Studio 2013 Express для Windows][Visual Studio 2013 Express для Windows]
...
Дополнительные сведения о б универсальных приложениях Windows см. в разделе [Поддержка нескольких клиентов из одной мобильной службы][Поддержка нескольких клиентов из одной мобильной службы].
  ...
  [Краткое руководство: Добавление мобильной службы (серверная часть JavaScript)]: http://msdn.microsoft.com/ru-ru/library/windows/apps/xaml/dn263180.aspx
