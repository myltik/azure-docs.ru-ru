<properties 
	pageTitle="Панель мониторинга, монитор и масштаб в службах BizTalk | Azure" 
	description="Сведения об элементах управления и мониторинге производительности на вкладках портала управления для служб BizTalk: "Панель мониторинга", "Мониторинг", "Масштаб", "Настройка" и "Гибридные подключения" MABS, WABS" 
...
Чтобы использовать гибридные подключения в мобильных службах Azure, см. раздел [Мобильные службы Azure и гибридные подключения](http://azure.microsoft.com/documentation/articles/mobile-services-dotnet-backend-hybrid-connections-get-started).
