<properties urlDisplayName="Manage Availability of VMs" pageTitle="Управление доступностью виртуальных машин - Azure" metaKeywords="" description="Описывается, как использовать несколько виртуальных машин для обеспечения высокой доступности приложения Azure. " metaCanonical="" services="virtual-machines" documentationCenter="" title="" authors="kenazk" solutions="" manager="timlt" editor="tysonn" />
...
* [объедините подсистемы балансировки нагрузки с группами доступности;] 
...
>[WACOM.NOTE] Указания см. в статье [Настройка группы доступности для виртуальных машин][].
