...
2. Перейдите на вкладку **Панель мониторинга**.
...
> [!NOTE]
> Ограничение справедливого распределения неприменимо к заданиям Runbook, выполняемым в гибридных рабочих ролях Runbook.
> 
> 
