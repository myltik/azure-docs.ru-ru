...
Вы можете компилировать конфигурацию DSC, показанную выше, с помощью PowerShell. При помощи приведенной ниже команды PowerShell в опрашивающий сервер Azure Automation DSC добавляются две конфигурации узла: **CredentialSample.MyVM1** и **CredentialSample.MyVM2**.
