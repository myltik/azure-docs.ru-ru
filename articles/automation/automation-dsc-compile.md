---
title: Компилирование конфигураций в Azure Automation DSC | Microsoft Docs
...
> [!NOTE]
> Вы можете использовать **ConfigurationData**, когда выполняете компилирование на платформе Azure Automation DSC с помощью Azure PowerShell. На портале Azure этот параметр использовать нельзя.
> 
> 
