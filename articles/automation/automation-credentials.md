---
title: Ресурсы-контейнеры учетных данных в службе автоматизации Azure | Microsoft Docs
...
4. В раскрывающемся списке **Тип учетных данных** выберите **Учетные данные Windows PowerShell**.
