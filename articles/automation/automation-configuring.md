...
2. На портале предварительной версии Azure последовательно выберите **Создать** > **Управление** > **Учетная запись автоматизации**.

3. В колонке **Добавление учетной записи службы автоматизации** настройте параметры учетной записи.

>[AZURE.NOTE] Если учетная запись службы автоматизации создается на портале предварительной версии Azure, учетная запись и все связанные с ней ресурсы не переносятся на классический портал управления.
...
| Группа ресурсов | Группы ресурсов упрощают просмотр связанных ресурсов Azure и управление ими. На портале предварительной версии Azure для учетной записи службы автоматизации можно выбрать существующую группу ресурсов или создать новую, тогда как на портале управления Azure все учетные записи службы автоматизации помещаются в группу ресурсов по умолчанию. |
...
>[AZURE.NOTE] Если учетная запись службы автоматизации, созданная с помощью классического портала управления, [перемещается в другую группу ресурсов](../resource-group-move-resources.md) с помощью на портала предварительной версии Azure, такая учетная запись больше не будет доступна на классическом портале Azure, так как учетные записи диспетчера ресурсов Azure не поддерживаются на классическом портале управления.
