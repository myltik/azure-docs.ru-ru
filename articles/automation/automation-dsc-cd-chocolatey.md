...
-   Установите модуль, необходимый на рабочей станции, следующим образом:
    -   Установите [Windows Management Framework версии 5](http://aka.ms/wmf5latest) (не требуется для Windows 10).
