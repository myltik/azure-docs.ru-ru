---
title: Гибридные рабочие роли Runbook в службе автоматизации Azure | Microsoft Docs
...
> [!NOTE]
> Гибридные рабочие роли Runbook в настоящее время не поддерживают [конфигурации DSC](automation-dsc-overview.md).
> 
> 
...
> [!NOTE]
> Гибридная рабочая роль Runbook версии 7.2.11136.0 сейчас поддерживает обмен данными через прокси-сервер только с помощью скриптов PowerShell.  Поддержка скриптов рабочего процесса PowerShell будет добавлена в следующем выпуске.  
> 
> 
