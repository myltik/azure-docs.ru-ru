...
Установите агент на локальный компьютер согласно инструкциям в статье [Прямое подключение компьютеров к Operational Insights](../operational-insights/operational-insights-direct-agent.md). Выполните эту процедуру на нескольких компьютерах, чтобы добавить в среду несколько компонентов Worker.
...
2. Щелкните плитку **Гибридные рабочие роли** и выберите группу.
