---
title: Настройка учетной записи пользователя Azure AD | Microsoft Docs
...
6. Для параметра **Создать учетную запись запуска от имени в Azure** выберите значение **Нет** и нажмите кнопку **Создать**.
...
## Дальнейшие действия
* Сведения о разных типах модулей Runbook и действиях по созданию собственных модулей Runbook см. в статье [Типы модулей Runbook в службе автоматизации Azure](automation-runbook-types.md).
