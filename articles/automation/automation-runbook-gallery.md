<properties 
	pageTitle="Коллекции модулей Runbook и других модулей для службы автоматизации Azure"
...
3. Нажмите кнопку **Коллекция PowerShell**, чтобы открыть коллекцию PowerShell в новом окне обозревателя. <br> ![Коллекция PowerShell](media/automation-runbook-gallery/powershell-gallery-button.png)
