...
# Обновление проверки подлинности учетных записей службы автоматизации с использованием учетных записей запуска от имени 
...
### Необходимые разрешения для обновления учетной записи службы автоматизации
...
## Создание учетной записи запуска от имени на портале
...
## Создание учетной записи запуска от имени с использованием скрипта PowerShell
