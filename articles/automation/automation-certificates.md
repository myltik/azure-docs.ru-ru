---
title: Ресурсы-контейнеры сертификатов в службе автоматизации Azure | Microsoft Docs
...
### Создание сертификата на портале классической версии Azure
...
5. Щелкните **Выбрать файл** в разделе **Передача файла сертификата** и перейдите к CER- или PFX-файлу. Если выбран PFX-файл, введите пароль и укажите, разрешен ли экспорт сертификата.
