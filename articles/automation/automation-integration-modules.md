...
2. Если модуль работает в удаленной системе, нужно выполнить следующие требования.
    ...
    а. Модуль должен содержать файл метаданных модуля интеграции, содержащий сведения, необходимые для подключения к этой удаленной системе, то есть тип соединения.  
