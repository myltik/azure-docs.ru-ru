...
4. Создайте два параметра со следующими свойствами, которые будут использоваться для действия **Get-AzureVM**:
    ...
    * **Параметр2:** "Имя" — VMNameServiceName, "Тип" — "Строковый", "Обязательный" — "Нет", "Значение по умолчанию" — "Пользовательское", "Пользовательское значение по умолчанию" — <имя службы по умолчанию, которая содержит виртуальные машины>.
