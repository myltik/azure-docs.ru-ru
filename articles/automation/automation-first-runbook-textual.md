<properties
	pageTitle="Мой первый текстовый модуль Runbook в службе автоматизации Azure"
...
4.  Щелкните правой кнопкой по своим учетным данным и щелкните **Добавить на холст**. При этом добавляется действие **Get-AutomationCredential** для ваших учетных данных.
5.  Перед **Get-AutomationCredential** введите *$Credential =*, чтобы назначить эти учетные данные переменной. 
