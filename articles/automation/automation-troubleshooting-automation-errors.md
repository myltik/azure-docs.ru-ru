...
**Причина ошибки.** Если в результате выражения, указанного рядом с ключевым словом **Node** в конфигурации DSC, получается $null, то ни один файл конфигурации узла создан не будет.    
