...
5. Введите **имя** и при желании **описание** нового расписания. Расписание может выполняться **один раз**, **ежечасно**, **ежедневно**, **еженедельно** или **ежемесячно**.
...
5. Если модуль Runbook сейчас не связан с расписанием, вам будут предложены варианты **Связать с новым расписанием** или **Связать с существующим расписанием**.  Если модуль в настоящее время связан с расписанием, щелкните **Ссылки** в нижней части окна для доступа к этим параметрам.
6. Если модуль Runbook имеет параметры, вам будет предложено указать их значения.  
