...
Чтобы запускать модуль Runbook в определенное время с помощью расписания в службе автоматизации Azure, его необходимо привязать к одному или нескольким расписаниям. Расписание можно настроить расписание ежедневной либо однократно, либо по повторения каждый час выполнения для модулей Runbook на портале Azure. Можно также запланировать их для еженедельно, ежемесячно, конкретные дни недели или дни месяца или определенный день месяца.  Один модуль Runbook может быть связан с несколькими расписаниями, и одно расписание может иметь несколько привязанных модулей Runbook.
...
Можно создать новое расписание для Runbook на портале Azure или с помощью Windows PowerShell. Также расписание можно создать при связывании Runbook с расписанием с помощью портала Azure или классического портала Azure.
