...
Расписания службы автоматизации используются для планирования автоматического выполнения модулей Runbook. Это может быть одна дата и время для однократного запуска модуля Runbook. Также это может быть повторяющееся ежечасное, ежедневное, еженедельное или ежемесячное расписание для повторного запуска этого модуля. Расписания обычно недоступны из модулей Runbook.
...
1. Завершите работу мастера и установите флаг, чтобы сохранить новое расписание.
