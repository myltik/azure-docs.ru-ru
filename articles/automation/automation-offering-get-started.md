...
# Приступая к работе со службой автоматизации Azure
...
## Общие сведения об архитектуре автоматизации
...
* Для создания учетной записи службы автоматизации необходимо добавить учетную запись пользователя AD к роли с разрешениями, аналогичными роли участника для ресурсов службы автоматизации Майкрософт, как описано в статье [Управление доступом на основе ролей в службе автоматизации Azure](automation-role-based-access-control.md#contributor-role-permissions).  
...
### Что такое учетная запись службы автоматизации 
...
### Создание учетной записи службы автоматизации, интегрированной с OMS
