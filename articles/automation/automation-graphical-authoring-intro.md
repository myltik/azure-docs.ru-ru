...
|Входной параметр Runbook <br>*(Ожидается в ближайшее время)*|Выберите входной параметр Runbook в качестве входных данных для параметра действия.|  
|Актив переменной службы автоматизации<br>*(Ожидается в ближайшее время)*|Выберите переменную службы автоматизации в качестве входных данных.|  
|Актив учетных данных службы автоматизации<br>*(Ожидается в ближайшее время)*|Выберите учетные данные службы автоматизации в качестве входных данных.|  
|Актив сертификата службы автоматизации<br>*(Ожидается в ближайшее время)*|Выберите сертификат службы автоматизации в качестве входных данных.|  
|Актив подключения службы автоматизации<br>*(Ожидается в ближайшее время)*|Выберите подключение службы автоматизации в качестве входных данных.| 
