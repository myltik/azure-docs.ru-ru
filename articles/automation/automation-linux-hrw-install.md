...
1.  Включите решение "Гибридная рабочая роль службы автоматизации" в Azure. Для этого нужно:
   ...
   1. Добавьте решение **Гибридная рабочая роль службы автоматизации** в свою подписку, используя процедуру, описанную в статье [Добавление решений для управления Azure Log Analytics в рабочую область](https://docs.microsoft.com/azure/log-analytics/log-analytics-add-solutions).
