...
* [Блог об управлении](https://azure.microsoft.com/ru-RU/blog/tag/azure-automation/) содержит последние сведения о службе автоматизации Azure и других технологиях управления корпорации Майкрософт. Подпишитесь на этот блог и следите за новостями от группы разработчиков службы автоматизации Azure. 
