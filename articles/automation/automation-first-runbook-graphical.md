...
16.  В элементе управления "Библиотека" введите в поле поиска текст **Get-AzureRmContext**.
...
2. Добавьте на холст командлет **Start-AzureRmVM**, а затем перетащите его под элемент **Подключение к Azure**.
