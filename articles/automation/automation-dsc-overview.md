...
- Если виртуальная машина Azure для управления через DSC автоматизации Azure адаптируется с помощью `Register-AzureAutomationDscNode`, `Set-AzureVMExtension` или расширения для виртуальных машин DSC службы автоматизации Azure на портале предварительной версии Azure, она появится в узле DSC службы автоматизации Azure в течение часа. Это связано с тем, что расширение DSC для виртуальных машин Azure устанавливает на виртуальную машину платформу Windows Management Framework 5.0, которая требуется для размещения этой виртуальной машины в DSC службы автоматизации Azure.
