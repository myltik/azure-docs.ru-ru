...
Создайте простую [конфигурацию DSC](https://msdn.microsoft.com/powershell/dsc/configurations), которая обеспечивает наличие или отсутствие компонента Windows **веб-сервера** (IIS) в зависимости от назначения узлов.
...
3. На странице **Учетная запись автоматизации** выберите **Конфигурации DSC** из раздела **Управление конфигурацией**.
4. На странице **Конфигурации DSC** щелкните **+ Add a configuration** (+ Добавить конфигурацию).
5. На странице **Импорт конфигурации** перейдите к файлу `TestConfig.ps1` на своем компьютере.
...
2. Слева щелкните **Все ресурсы**, а затем — имя учетной записи службы автоматизации.
3. На странице **Учетная запись автоматизации** выберите **Конфигурации DSC** из раздела **Управление конфигурацией**.
4. На странице **Конфигурации DSC** щелкните **TestConfig** (это имя конфигурации, импортированной при выполнении предыдущей процедуры).
5. На странице **Настройка TestConfig** щелкните **Просмотреть источник конфигурации**.
...
1. Войдите на [портале Azure](https://portal.azure.com).
2. Слева щелкните **Все ресурсы**, а затем — имя учетной записи службы автоматизации.
3. На странице **Учетная запись автоматизации** щелкните **Конфигурации DSC** в разделе **Управление конфигурацией**.
4. На странице **Конфигурации DSC** щелкните **TestConfig** (имя импортированной ранее конфигурации).
5. На странице **Настройка TestConfig** щелкните **Скомпилировать**, а затем нажмите кнопку **Да**. Запустится задание компиляции.
...
3. На странице **Учетная запись автоматизации** щелкните **Конфигурации DSC** в разделе **Управление конфигурацией**.
4. На странице **Конфигурации DSC** щелкните **TestConfig** (имя импортированной ранее конфигурации).
5. В разделе **Задания компиляции** выберите задание компиляции, которое нужно просмотреть. Откроется страница **Задание компиляции** с датой начала задания компиляции.
   
    ![Снимок экрана: страница "Задание компиляции"](./media/automation-dsc-getting-started/CompilationJob.png)
6. Чтобы просмотреть дополнительные сведения о задании, щелкните любую плитку на странице **Задание компиляции**.
...
1. Войдите на [портале Azure](https://portal.azure.com).
2. Слева щелкните **Все ресурсы**, а затем — имя учетной записи службы автоматизации.
3. На странице **Учетная запись автоматизации** щелкните **Узлы DSC** в разделе **Управление конфигурацией**.
4. На странице **Узлы DSC** щелкните **Добавить виртуальную машину Azure**.
...
5. На странице "Виртуальные машины" выберите свою виртуальную машину. На странице **Добавить виртуальные машины Azure** щелкните **Выберите виртуальную машину для присоединения**.
