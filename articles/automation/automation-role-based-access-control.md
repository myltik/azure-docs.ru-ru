...
1.	Выполните вход на [портале Azure](http://portal.azure.com/) и откройте свою учетную запись службы автоматизации в колонке "Учетные записи службы автоматизации".  
