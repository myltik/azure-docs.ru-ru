...
Модули Runbook Python — это текстовые модули Runbook, основанные на языке сценариев Python. Служба автоматизации Azure поддерживает модули Runbook Python 2 и Python 3.
Сведения о Python см. на сайте [https://www.python.org/](https://www.python.org/).
Пример использования модуля Runbook Python см. в статье [Мой первый модуль Runbook Python в службе автоматизации Azure](automation-first-runbook-textual-python2.md).

## <a name="bash-runbooks"></a>Модули Runbook Bash

Модули Runbook Bash — это текстовые модули Runbook, основанные на оболочке GNU Bash. Сведения о Bash см. на сайте [https://www.gnu.org/software/bash/](https://www.gnu.org/software/bash/).
