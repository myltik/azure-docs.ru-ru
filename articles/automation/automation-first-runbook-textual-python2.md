...
2. Если сейчас прокурить экран влево, чтобы просмотреть модуль runbook в области **Модули Runbook**, для параметра **Состояние создания** отобразится значение **Опубликовано**.
