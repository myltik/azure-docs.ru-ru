...
Чтобы выполнить задачи в сначала нужно настроить для виртуальной машины службу отслеживания изменений и инвентаризации. Если ранее для виртуальной машины было включено решение **Отслеживание изменений**, то этот шаг не является обязательным.
