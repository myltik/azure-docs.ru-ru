...
> [!div class="checklist"]
> * подключение виртуальной машины к решениям для отслеживания изменений и инвентаризации;
...
## <a name="view-installed-software"></a>Просмотр установленного программного обеспечения
