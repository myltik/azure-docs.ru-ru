<properties title="Использование службы очередей (PHP) - руководство по компонентам Azure" pageTitle="Использование службы очередей (PHP) | Microsoft Azure" metaKeywords="Сообщения службы очередей Azure PHP" description="Узнайте, как использовать службу очередей Azure для создания и удаления очередей, а также вставки, получения и удаления сообщений. Примеры кода написаны на PHP." documentationCenter="PHP" services="storage" authors="" />
...
* [Создание учетной записи хранилища Azure](#create-account)
...
<h2><a id="create-account"></a>Создание учетной записи хранилища Azure</h2>
...
В этом руководстве будут использоваться компоненты службы очередей, которые могут быть вызваны локально в приложении PHP или в коде, работающем в веб-роли, роли работника или на веб-сайте Azure.
