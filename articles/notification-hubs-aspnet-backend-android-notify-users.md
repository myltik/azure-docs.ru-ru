...
> [AZURE.NOTE] В этом учебнике подразумевается, что вы создали и настроили центр уведомлений в соответствии с описанием в руководстве [Приступая к работе с центрами уведомлений (Android)](notification-hubs-android-get-started.md). 
> Если вы используете мобильные службы в качестве серверной службы, см. раздел [Версии мобильных служб](mobile-services-javascript-backend-android-push-notifications-app-users.md) этого учебника.
...
1. Следуйте инструкциям учебника [Приступая к работе с центрами уведомлений (Android)](notification-hubs-android-get-started.md), чтобы создать приложение и настроить его на получение push-уведомлений для GCM.
