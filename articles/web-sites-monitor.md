...
> [AZURE.NOTE]Если команда **azure** не установлена, см. информацию об установке и настройке в статье [Как использовать средства командной строки Azure](virtual-machines-command-line-tools.md).
