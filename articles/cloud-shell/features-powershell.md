...
|**Категория**    |**Имя**                                 |
|----------------|-----------------------------------------|
|Инструменты Azure     |[Azure PowerShell (5.2.0)](https://docs.microsoft.com/powershell/azure/overview)<br> [Azure CLI (2.0.26)](https://docs.microsoft.com/cli/azure/overview)|
