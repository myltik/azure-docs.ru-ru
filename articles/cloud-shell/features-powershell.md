...
|**Категория**    |**Имя**                                 |
|----------------|-----------------------------------------|
|Инструменты Azure     |[Azure PowerShell 5.7.0](https://docs.microsoft.com/powershell/azure/overview)<br> [Azure CLI (2.0.31)](https://docs.microsoft.com/cli/azure)|
...
|.NET        |4.6        |
|Node.js     |8.9.4       |
|PowerShell  |5.1 и [6.1.0 (предварительная версия 1)](https://github.com/PowerShell/powershell/releases)       |
|Python      |2.7        |
