<properties title="Download the Azure SDK for PHP" pageTitle="Загрузка пакета Azure SDK для PHP" metaKeywords="" description="Learn how to download and install the Azure SDK for PHP." documentationCenter="PHP" services="" solutions="web" authors="tomfitz" manager="wpickett" />
