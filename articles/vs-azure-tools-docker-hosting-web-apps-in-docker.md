...
1. На вкладке **Подключение** в диалоговом окне **Публикация веб-сайта** установите флажок **Проверить подключение**, чтобы проверить готовность узла Docker. Если подключение надежное, нажмите кнопку **Опубликовать**, чтобы опубликовать веб-приложение.
...
1. Теперь вы можете выполнить приведенные ниже команды, чтобы проверить, что узел Docker развернут и работает.
    ...
    Чтобы получить полный список команд Docker, просто введите команду `docker` в командной строке. Дополнительные сведения см. в статье [Командная строка Docker](https://docs.docker.com/reference/commandline/cli/).
...
Сведения об использовании расширения виртуальных машин Docker для Linux в Azure см. в статье [Расширение виртуальных машин Docker для Linux в Azure](virtual-machines-docker-vm-extension.md).
