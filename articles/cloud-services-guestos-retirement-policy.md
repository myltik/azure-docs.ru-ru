...
Сведения на этой странице относятся к гостевой операционной системе Azure ([гостевой ОС](https://msdn.microsoft.com/library/azure/ff729422.aspx)) для веб-ролей и рабочих ролей облачных служб (PaaS). Они не относятся к виртуальным машинам (IaaS). 
...
В некоторых случаях могут поддерживаться более двух семейств версий или выпусков. Официальные сведения о поддержке гостевой ОС появятся в [матрице совместимости выпусков и пакетов SDK гостевой ОС Azure](cloud-services-guestos-update-matrix.md).
