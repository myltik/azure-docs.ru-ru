...
> [!TIP]
> Инструкции по созданию сервера, созданию брандмауэра на основе сервера, просмотру свойств сервера, созданию базы данных, подключению и отправке запросов с помощью Workbench и mysql.exe см. в статье [Design your first Azure Database for MySQL database](tutorial-design-database-using-portal.md) (Создание первой базы данных для службы баз данных Azure для MySQL).
...
База данных Azure MySQL управляет ресурсами, доступными для сервера, используя два различных механизма: 
