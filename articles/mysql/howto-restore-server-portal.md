...
1. Щелкните **Создать** (+) в левом верхнем углу портала. Выберите **Базы данных** > **База данных Azure для MySQL**.

   ![Пункт "База данных Azure для MySQL"](./media/howto-restore-server-portal/1-create-database.png)
