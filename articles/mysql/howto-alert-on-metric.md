---
title: "Настройка оповещений на основе метрик в базе данных Azure для MySQL на портале Azure | Документация Майкрософт"
...
4. Откроется страница **Add rule** (Добавление правила), как показано ниже.  Заполните необходимые сведения:
   ...
   | Подписки | В этом поле предварительно указывается подписка, в которой размещена база данных Azure для MySQL. |
