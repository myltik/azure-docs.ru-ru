...
Чтобы подключиться, найдите сведения о подключении на панели **Свойства** в базе данных Azure для MySQL.
...
- При перемещении объектов, отличных от таблиц, явно создайте их. Включите ограничения (первичный ключ, внешний ключ, индексы), представления, функции, процедуры, триггеры и другие объекты базы данных, которые требуется перенести.
