...
4. Под папкой **Контейнеры больших двоичных объектов** отобразится текстовое поле. Введите имя контейнера больших двоичных объектов. В разделе [Правила именования контейнеров](storage/blobs/storage-dotnet-how-to-use-blobs.md#create-a-container) представлен список правил и ограничений, действующих при именовании контейнеров больших двоичных объектов.
...
7. Следуйте приведенным ниже инструкциям в зависимости от задачи, которую необходимо выполнить.
   ...
   * **Отправка файлов в контейнер больших двоичных объектов**
     ...
     3. Укажите тип в поле **Тип BLOB-объекта**. В статье [Приступая к работе с хранилищем BLOB-объектов Azure с помощью .NET](storage/blobs/storage-dotnet-how-to-use-blobs.md#blob-service-concepts) описаны различия между типами больших двоичных объектов.
