<properties title="How to use the SendGrid email service (PHP) - Azure" pageTitle="Как использовать службу электронной почты SendGrid (PHP) - Azure" metaKeywords="Azure SendGrid, электронной почты Azure, Azure SendGrid PHP, служба электронной почты Azure PHP" description="Learn how send email with the SendGrid email service on Azure. Code samples written in PHP." documentationCenter="PHP" services="" manager="wpickett" editor="mollybos" authors="robmcm" scriptId="" videoId="" />
