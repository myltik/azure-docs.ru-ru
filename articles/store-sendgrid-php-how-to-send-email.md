...
В этом руководстве показано, как выполнять типовые задачи программирования для службы электронной почты SendGrid в Azure. Образцы написаны на языке PHP.
 В число рассматриваемых сценариев входит **создание сообщений электронной почты**, **отправка сообщений электронной почты** и **добавление вложений**. Дополнительные сведения о SendGrid и отправке эл. почты см. в разделе [Дальнейшие действия][Дальнейшие действия].
...
-   [Использование SendGrid в своем приложении PHP][Использование SendGrid в своем приложении PHP]
...
SendGrid — это [облачная служба электронной почты][облачная служба электронной почты], обеспечивающая надежные возможности
[доставки электронной почты][доставки электронной почты], масштабируемости и аналитики в режиме реального времени наряду с гибкими интерфейсами API
