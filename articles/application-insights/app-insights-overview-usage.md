---
title: "Анализ использования с помощью Application Insights"
...
Чтобы приступить к работе, получите бесплатную учетную запись [Microsoft Azure](https://azure.com). (После завершения бесплатного пробного периода вы можете использовать уровень обслуживания "Бесплатный").
...
Вы можете также добавить Application Insights в свой серверный код [ASP.NET](app-insights-asp-net.md) или [J2EE](app-insights-java-get-started.md), чтобы объединить телеметрию клиента и сервера.

### <a name="run-your-project-and-see-first-results"></a>Запустите ваш проект и ознакомьтесь с первыми результатами
Запустите проект в режиме отладки на несколько минут, после чего перейдите на [портал Azure](https://portal.azure.com) и найдите ресурс своего проекта в Application Insights.
...
## <a name="analytics-out-of-the-box"></a>Готовая к использованию служба аналитики
