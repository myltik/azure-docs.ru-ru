...
Добавьте [Application Insights][start] в проект и без дополнительных усилий получите диаграммы, показывающие количество имеющихся пользователей и многое другое.

![В Azure выберите "Обзор" > "Application Insights", затем выберите свой проект и прокрутите вниз](./media/app-insights-overview-usage/01-overview.png)

Наведите указатель мыши на пустую область над диаграммой для просмотра счетчиков в определенной точке. В иных случаях числа отображают значение, агрегированное за период, например среднее, итого или число уникальных пользователей за период.
