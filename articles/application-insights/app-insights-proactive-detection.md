...
Мы будем очень рады получить ваш отзыв. Сообщите нам, как упреждающее обнаружение помогает вам, как мы можем улучшить его и какие дополнительные возможности вы хотели бы увидеть. Можно предоставить отзыв с помощью значка "Отправить смайлик или неодобрение" на портале или отправить его по электронной почте на адрес AppInsightsML@microsoft.com.
