...
Для других типов приложений, например веб-приложения Java или приложения для устройств, можно самостоятельно написать монитор, используя TrackDependency API.
