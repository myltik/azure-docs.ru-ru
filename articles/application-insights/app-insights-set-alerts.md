...
![В колонке правил оповещений нажмите кнопку «Добавить оповещение». Установите приложение в качестве ресурса для измерения, введите имя оповещения и выберите метрику.](./media/app-insights-set-alerts/01-set-metric.png)
...
![В нижней части колонки «Обзор» щелкните «События за прошлую неделю»](./media/app-insights-set-alerts/09-alerts.png)
