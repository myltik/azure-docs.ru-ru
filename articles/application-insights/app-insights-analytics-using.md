...
См. [обзор языка аналитики](app-insights-analytics-tour.md) и [справочные материалы по аналитике](app-insights-analytics-reference.md).
...
Вы можете закрепить диаграмму или таблицу на одной из [общих панелей мониторинга](app-insights-dashboards.md). Для этого просто щелкнув значок булавки. (Для включения этой функции может потребоваться [обновить ценовой пакет приложения](app-insights-pricing.md).)
