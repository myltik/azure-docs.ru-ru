...
1. [Создайте новый ресурс Application Insights](https://docs.microsoft.com/en-us/azure/application-insights/app-insights-create-new-resource) или выберите имеющийся. 
