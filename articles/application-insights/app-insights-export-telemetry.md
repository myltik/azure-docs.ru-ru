---
title: Непрерывный экспорт данных телеметрии из Application Insights
...
Функция непрерывного экспорта доступна в бесплатной пробной версии и в [тарифных планах Standard и Premium](https://azure.microsoft.com/pricing/details/application-insights/).
...
* Если вы собираетесь [исследовать данные в Power BI](http://blogs.msdn.com/b/powerbi/archive/2015/11/04/explore-your-application-insights-data-with-power-bi.aspx), это можно сделать без использования непрерывного экспорта.
