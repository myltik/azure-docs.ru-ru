...
Чтобы просмотреть хранилище Azure в Visual Studio, выберите меню **Представление** и щелкните **Обозреватель облака**. (Если этой команды нет в меню, установите пакет SDK Azure: откройте диалоговое окно **Создание проекта**, разверните узел "Visual C#/облако" и выберите **Получить Microsoft Azure SDK для .NET**.)
