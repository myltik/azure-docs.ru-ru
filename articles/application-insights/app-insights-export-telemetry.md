...
>[AZURE.NOTE] Если вы собираетесь [исследовать данные в Power BI](http://blogs.msdn.com/b/powerbi/archive/2015/11/04/explore-your-application-insights-data-with-power-bi.aspx), это можно сделать без использования непрерывного экспорта.
>
>И если требуется сделать [одноразовый экспорт](app-insights-metrics-explorer.md#export-to-excel) отображаемых в метрике или в поисковой колонке, щелкните "Экспорт" в верхней части колонки.
