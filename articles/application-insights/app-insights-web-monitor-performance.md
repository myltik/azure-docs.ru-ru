...
На стороне клиента Application Insights может извлекать данные телеметрии с веб-страниц и разнообразных устройств, включая приложения для iOS, Android и Магазина Windows.
