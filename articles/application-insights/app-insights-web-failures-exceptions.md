...
[Visual Studio Application Insights][start] представляет собой мощный инструмент для обнаружения и диагностики ошибок в приложениях. В этой статье мы сосредоточим внимание на веб-приложениях (Application Insights можно использовать также на [различных других платформах][platforms]).
