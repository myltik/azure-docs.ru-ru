...
Прием не работает, если пакет SDK осуществляет фиксированную или адаптивную выборку. Несмотря на то что частота выборки в пакете SDK меньше 100 %, параметр выборки приема не учитывается.
