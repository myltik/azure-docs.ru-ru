...
Если указать числовое или временное выражение, не используя функцию `bin()`, аналитика AI автоматически применит его с интервалом час (`1h`) для временных значений и интервалом `1.0` для числовых.
