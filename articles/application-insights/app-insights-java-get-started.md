...
[Веб-тесты Application Insights][availability] отслеживают доступность приложения.
 ...
 * Скачайте последнюю версию [пакета SDK Application Insights для Java](http://dl.windowsazure.com/lib/applicationinsights/javabin/sdk.zip) и установите ее вместо более старых версий.
...
* Для получения разнообразных системных и сетевых данных нужно [установить collectd с подключаемым модулем Application Insights](app-insights-java-collectd.md).
