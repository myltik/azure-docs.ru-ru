...
---
<a id="system-performance-counters-in-application-insights" class="xliff"></a>
...
<a id="view-counters" class="xliff"></a>
...
<a id="add-counters" class="xliff"></a>
...
<a id="collecting-performance-counters-in-code" class="xliff"></a>
...
<a id="performance-counters-in-analytics" class="xliff"></a>

## Счетчики производительности в службе аналитики
...
<a id="aspnet-and-application-insights-counts" class="xliff"></a>
