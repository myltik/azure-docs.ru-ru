...
Если ваше приложение отправляет большие объемы данных, а вы используете пакет SDK службы Application Insights для ASP.NET версии 2.0.0-beta3 или более поздней версии, функция [адаптивной выборки](app-insights-sampling.md) может сработать и отправить только часть данных телеметрии.
