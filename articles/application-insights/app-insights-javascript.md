...
**Чтобы быстро проанализировать вызовы AJAX, завершившиеся сбоем**, выберите вместо диаграммы сбоев таблицу и щелкните строку, чтобы просмотреть конкретные экземпляры.
