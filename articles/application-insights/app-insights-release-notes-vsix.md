...
Мы улучшили внешний вид окна для поиска данных, чтобы пользователям было удобнее искать данные в рабочей среде. ![Окно поиска](./media/app-insights-release-notes-vsix/SearchWindow.png)
