...
# Заметки о выпуске средств Application Insights для Visual Studio версии 4.2
##Версия 4.2
...
Установив адаптер для ведения журналов, запустите приложение и убедитесь в том, что данные на вкладке средств диагностики выглядят следующим образом: ![Трассировки](./media/app-insights-release-notes-vsix/Traces.png)
