...
* [**Экспорт аналитических запросов**](#export-analytics-queries). Напишите необходимый запрос с помощью средства аналитики или экспортируйте его из воронок данных использования в Power BI. Его можно разместить на панели мониторинга вместе с другими данными.
...
Этот способ предполагает написание любого аналитического запроса или его экспорт из воронок данных использования, а затем его экспорт на панель мониторинга Power BI. (Его можно добавить на панель мониторинга, созданную при помощи адаптера.)
...
1. [Создание воронки](usage-funnels.md)
2. Нажмите кнопку Power BI 

   ![Кнопка Power BI](./media/app-insights-export-power-bi/button.png)
   
3. В Power BI Desktop выберите меню **Get Data, Blank Query** (Получить данные, пустой запрос), а затем в редакторе запросов на вкладке **Представление** выберите **расширенный редактор запросов**.

   ![Пустое поле запроса](./media/app-insights-export-power-bi/blankquery.png)

   Вставьте скрипт на языке M в расширенный редактор запросов. 

   ![Расширенный редактор запросов](./media/app-insights-export-power-bi/advancedquery.png)

4. Выберите элементы запроса, а затем — визуализацию "Воронка".

   ![Выбор последовательности и воронки](./media/app-insights-export-power-bi/selectsequence.png)

5. Замените заголовок на информативный и опубликуйте отчет в рабочей области Power BI в облаке. 

   ![Изменение заголовка](./media/app-insights-export-power-bi/changetitle.png)

## <a name="troubleshooting"></a>Устранение неполадок

### <a name="401-or-403-unauthorized"></a>401 или 403 — недостаточно прав 
Такая ошибка может произойти, если токен обновления не обновлен. Попробуйте выполнить следующие действия, чтобы убедиться, что у вас по-прежнему есть доступ. Если у вас есть доступ, но обновление учетных данных не выполняется, обратитесь в службу поддержки.
