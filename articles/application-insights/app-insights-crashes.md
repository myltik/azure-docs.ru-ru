...
Если этого еще не сделано, добавьте [Application Insights в свой проект приложения][platforms] и повторно опубликуйте его.
...
![В диаграмме сбоев щелкните сначала "Правила оповещения", а затем "Добавить оповещение"](./media/app-insights-crashes/appinsights-d023-alert.png)
