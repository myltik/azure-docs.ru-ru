...
* **[Анализ данных использования мобильного приложения](app-insights-mobile-center-quickstart.md)** при помощи интеграции с Visual Studio Mobile Center.
