 ...
 * [Универсальные приложения для Windows Phone, Магазина Windows, Windows 10 и прямая интеграция с порталом разработчика Windows 10][windows]
...
2. Войдите на [портал предварительной версии Azure](http://portal.azure.com).
