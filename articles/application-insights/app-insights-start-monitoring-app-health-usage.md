...
Вам потребуется [Visual Studio 2013](http://go.microsoft.com/fwlink/?linkid=397827&clcid=0x409) (обновление 3 или более поздняя версия) и учетная запись в [Microsoft Azure](http://azure.com).
