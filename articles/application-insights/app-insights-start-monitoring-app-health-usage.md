...
* Подождите несколько секунд и нажмите кнопку **Обновить**. Диаграмма периодически обновляется, однако ее можно обновить и вручную, если вы ждете появления каких-либо данных.
...
## 5\. Добавление отслеживания зависимостей
...
![В веб-приложении последовательно выберите «Сервис», «Мониторинг производительности», «Добавить», Application Insights](./media/app-insights-start-monitoring-app-health-usage/05-extend.png)
