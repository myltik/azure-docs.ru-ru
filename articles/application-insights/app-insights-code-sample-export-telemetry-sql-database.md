...
Этот код автоматически извлекает любые свойства, имеющиеся в JSON. Описание свойств см. в разделе [Экспорт модели данных](app-insights-export-data-model.md).
