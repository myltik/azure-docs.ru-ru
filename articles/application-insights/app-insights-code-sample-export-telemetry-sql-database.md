...
4. Проверьте экспортированные данные. В Visual Studio выберите пункты **Вид и Cloud Explorer**, а затем — Azure и "Хранилище". (Если этой команды нет в меню, установите пакет SDK Azure: откройте диалоговое окно «Создание проекта», разверните узел «Visual C#/облако» и выберите «Получить Microsoft Azure SDK для .NET».)
