...
При настройке профилировщика в параметры веб-приложения вносятся следующие обновления. Если требуется, их можно внести вручную, например, если приложение выполняется в частной сети с использованием внутренней подсистемы балансировки нагрузки.
...
Приложения ASP.NET Core 1.1.2, нацеленные на пакет SDK для Application Insights 2.0 или более поздней версии, будут работать с профилировщиком. 
