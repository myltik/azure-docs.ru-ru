...
*Эта функция Azure Application Insights общедоступна для компонента "Веб-приложения" службы приложений Azure и предоставляется в предварительной версии для вычислительных ресурсов Azure.*
