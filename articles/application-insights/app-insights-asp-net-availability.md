<properties
	pageTitle="Отслеживание доступности и скорости реагирования веб-сайта | Microsoft Azure"
	description="Получение оповещений, когда веб-сайт становится недоступным или медленно реагирует на запросы."
...
# Настройка Application Insights: веб-тесты на доступность
