...
[Выборка](app-insights-sampling.md) позволяет уменьшить скорость отправки данных телеметрии в ваше приложение, сохранив при этом возможность поиска связанных событий во время поиска по журналу диагностики, сохранив правильные количества событий. Выборка помогает соблюдать месячную квоту.
...
Если приложение превышает эти пределы, рекомендуем разделить данные между разными ключами инструментирования, т. е. [создать новые ресурсы Application Insights](app-insights-create-new-resource.md) и отправлять часть данных в новые ключи инструментирования. В этом случае результаты, возможно, будут более структурированными. Просматривать различные показатели на одном экране можно с помощью [панелей мониторинга](app-insights-dashboards.md#dashboards), поэтому такой подход не ограничивает возможности сравнения различных показателей.
