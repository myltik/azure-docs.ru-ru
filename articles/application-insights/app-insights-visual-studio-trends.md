---
title: Анализ трендов в Visual Studio | Microsoft Docs
...
4. Повторите этот процесс, чтобы найти тренды в определенных подмножествах телеметрии. Например, можно найти запросы к серверу GET Home/Index, *инициированные* в Германии *и* получившие код ответа 500.
