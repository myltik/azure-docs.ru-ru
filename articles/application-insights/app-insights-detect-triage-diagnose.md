...
Давайте посмотрим, как обычная команда веб-разработчиков использует Application Insights для отслеживания производительности. Мы будем наблюдать за действиями команды, разрабатывающей систему интернет-банкинга в банке Fabrikam.
...
* Производительность. Им нужна информация о том, как время отклика зависит от количества запросов; какой объем ресурсов ЦП, сети, диска и т. д. используется; и где возникают узкие места.
...
Анастасия Лебедева — старший разработчик в команде интернет-банкинга. Она также отвечает за мониторинг производительности сети. Анастасия настраивает несколько [веб-тестов][availability]\:
...
Поэтому она задает [оповещения][metrics] о времени отклика, превышающем обычное пороговое значение. Это гарантирует, что она узнает, если ответы будут выполняться медленно.
...
## Оповещения превентивной диагностики
