<properties 
	pageTitle="Использование поиска по журналу диагностики | Microsoft Azure" 
...
"Поиск по журналу диагностики" — это функция [Application Insights][start], которая позволяет искать и изучать отдельные данные телеметрии, например просмотры страниц, исключения и веб-запросы. Также можно просматривать журнал трассировки и события, которые были закодированы.

## Где находится колонка поиска по журналу диагностики?
...
database|Находит database01, databaseAB,...<br/>Подстановочный знак "?" нельзя использовать в начале поискового запроса.
