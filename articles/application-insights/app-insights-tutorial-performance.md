...
- [Включите Application Insights Profiler](app-insights-profiler.md#enable-the-profiler) для вашего приложения. 
...
6.  Выберите **Показать критический путь**, чтобы выделить конкретный путь событий, которые больше всего влияют на итоговою длительность операции.  В этом примере видно, что произошло исключение, которое ожидало ресурс более двух секунд.
