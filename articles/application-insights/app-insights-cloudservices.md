...
1. Задайте для файла ApplicationInsights.config незамедлительное копирование в выходной каталог.
...
2. Выберите тот же ресурс Application Insights, что и для других данных телеметрии.
