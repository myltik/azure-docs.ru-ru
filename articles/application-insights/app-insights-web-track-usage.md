...
Поместите код на главной странице, например в \_Layout.cshtml (в .NET), или во включаемом файле, чтобы убедиться, что он добавлен во все страницы.
...
По умолчанию пользователь идентифицируется посредством размещения файла cookie. Пользователь, использующий несколько браузеров или устройств, будет учтен несколько раз. (См. исключения в разделе [Прошедшие проверку пользователи](#authenticated-users).)
