...
* **Пользователи** — количество отдельных активных пользователей за диапазон времени на диаграмме. 
