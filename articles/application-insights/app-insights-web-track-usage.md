---
title: "Анализ использования для веб-приложений с помощью Application Insights"
...
Azure Application Insights обеспечивает два уровня отслеживания использования:
...
## <a name="how-popular-is-my-web-application"></a>Насколько популярно мое веб-приложение?
...
При [диагностировании проблем][diagnostic] можно найти все данные телеметрии, связанные с сеансом, в рамках которого возникла проблема, в том числе все запросы и все зарегистрированные события, исключения или трассировки.
...
#### <a name="whats-a-session"></a>Что такое сеанс?
...
**Длительность сеанса** — [метрика][metrics], представляющая собой промежуток времени между первым и последним элементами телеметрии сеанса. (Она не включает время ожидания.)
...
## <a name="users-and-user-counts"></a>Пользователи и число пользователей
...
**новые пользователи** показывает количество пользователей, которые начали свой первый сеанс работы в приложении в данный интервал времени. При учете пользователей с помощью файлов cookie (этот метод используется по умолчанию) пользователи, удалившие файлы cookie или использующие новое устройство или браузер для доступа к приложению, будут учитываться как новые.
![В колонке использования щелкните диаграмму пользователей, чтобы изучить новых пользователей.](./media/app-insights-web-track-usage/031-dual.png)
...
## <a name="synthetic-traffic"></a>Синтезированный трафик
...
## <a name="page-usage"></a>Использование страницы
...
## <a name="custom-events"></a>Настраиваемые события
...
## <a name="view-counts-of-custom-events"></a>Просмотр числа пользовательских событий
