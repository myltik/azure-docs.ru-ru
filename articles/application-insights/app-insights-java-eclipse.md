---
title: "Приступая к работе с Application Insights на Java в Eclipse"
...
В настоящее время подключаемый модуль работает для проектов Maven и динамических веб-проектов в Eclipse. ([Приступая к работе с Application Insights в веб-проекте Java][java].)
...
2. Пакет SDK находится по адресу http://dl.windowsazure.com/eclipse, в разделе Azure Toolkit ("Набор инструментов Azure"). 
...
[Узнайте больше о настройке телеметрии на стороне клиента][usage]
...
Application Insights может тестировать ваш веб-сайт через равные промежутки времени для проверки, работает ли он и правильно ли отвечает на запросы. [Чтобы настроить ][availability], прокрутите вниз и щелкните "Доступность".
...
[См. дополнительные сведения о журналах диагностики][javalogs]
...
[Узнайте больше о пользовательской телеметрии][track].
...
* [Выполните поиск событий и журналов][diagnostic] для диагностики неполадок.
* [Используйте трассировку Log4J или Logback][javalogs]

#### <a name="track-usage"></a>Отслеживание использования
* [Добавьте сбор данных телеметрии веб-клиента][usage] для мониторинга просмотров страниц и основных метрик пользователей.
