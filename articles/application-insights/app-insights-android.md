<properties
    pageTitle="Application Insights для приложений Android | Microsoft Azure"
...
1.  Выберите пункты **Инструменты** -> **Интегрировать пакет SDK для Application Insights**.
...
4.  Синхронизируйте Gradle, чтобы скачать пакет SDK и интегрировать его с проектом.
    ...
    (Дополнительную информацию см. на [странице использования](http://go.microsoft.com/fwlink/?LinkID=533220).)
