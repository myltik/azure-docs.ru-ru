...
Размер зерна можно настроить в колонке временного диапазона:

![Заголовок колонки.](./media/app-insights-metrics-explorer/grain.png)

Доступные размеры зерна зависят от выбранного интервала времени. Вместо автоматических размеров зерна для интервала времени можно выбрать прямые значения.
