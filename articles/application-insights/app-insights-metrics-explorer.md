...
* Данные о производительности \(ЦП, скорость ввода-вывода и т. д\) доступны для веб-служб Java, классических приложений, [веб-приложений и служб IIS, если установлен монитор состояния](app-insights-monitor-performance-live-website-now.md), и [облачных служб Azure](app-insights-azure.md). Такие данные для веб-сайтов Azure недоступны.
