...
После настройки [Application Insights для вашего проекта](app-insights-get-started.md) при условии, что ваше приложение создает некоторое минимальное количество данных телеметрии, системе превентивной диагностики в близком к реальному масштабе времени необходимо 24 часа, чтобы изучить нормальное поведение приложения. По истечении этого времени систему можно будет включить, и она начнет отправлять оповещения.
...
Ниже приведен пример подробного оповещения.

![Конфигурация](./media/app-insights-nrt-proactive-diagnostics/060.png)
