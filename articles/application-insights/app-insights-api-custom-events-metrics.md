...
Стандартный модуль отслеживания зависимостей использует данный API для регистрации вызовов внешних зависимостей, таких как базы данных или API REST. Модуль обнаруживает некоторые внешние зависимости автоматически, но аналогичная обработка может потребоваться и для других компонентов.
