...
1. В Visual Studio измените пакеты NuGet вашего проекта веб-приложения.
    ...
    ![Щелкните проект правой кнопкой мыши и выберите пункт "Управление пакетами Nuget"](./media/app-insights-asp-net-manual/03-nuget.png)

2. Установите пакет SDK Application Insights для веб-приложений.

    ![Поиск Application Insights](./media/app-insights-asp-net-manual/04-ai-nuget.png)
...
![Опубликуйте свое веб-приложение с помощью Visual Studio](./media/app-insights-asp-net-manual/15-publish.png)
...
## Добавление функции отслеживания зависимостей (и счетчиков производительности IIS)
...
Если вы используете собственный сервер IIS, с помощью этого действия можно отобразить системные счетчики производительности в [обозревателе метрик](app-insights-metrics-explorer.md).
...
![В веб-приложении последовательно выберите пункты "Настройки", "Расширения", "Добавить" и "Application Insights".](./media/app-insights-asp-net-manual/05-extend.png)
...
![В веб-приложении откройте быстрый запуск и щелкните ссылку "Получить код для мониторинга веб-страниц".](./media/app-insights-asp-net-manual/02-monitor-web-page.png)
...
![Создание проекта ASP.NET](./media/app-insights-asp-net-manual/appinsights-01-vsnewp1.png)
...
![Выберите пункт Add Application Insights](./media/app-insights-asp-net-manual/appinsights-03-addExisting.png)
...
![Щелкните проект правой кнопкой мыши и откройте портал Azure](./media/app-insights-asp-net-manual/appinsights-04-openPortal.png)
