...
Через 1–2 минуты щелкните «Обновить» в колонке «Доступность». (Она не обновляется автоматически.)
...
В колонке «Веб-тесты» прокрутите вниз и щелкните тест, в котором появились ошибки.
