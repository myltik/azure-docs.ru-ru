...
(Не вставляйте циклы в веб-тест.)
...
* *Можно ли вызывать код из моего веб-теста?*
    ...
    Нет. Действия теста должны находиться в WEBTEST-файле. Существует несколько подключаемых модулей, которые могут оказаться полезными для вас.
