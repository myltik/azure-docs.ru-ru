<properties 
	pageTitle="Наблюдение за доступностью и скоростью реагирования веб-сайта" 
...
Через 1–2 минуты щелкните «Обновить» в колонке доступности/веб-тестов. (Она не обновляется автоматически.)
...
* Я получаю сообщение об ошибке «Недопустимые символы» при... 

* **Есть ли разница между понятиями «веб-тесты» и «доступность»?
