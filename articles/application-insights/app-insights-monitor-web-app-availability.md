...
Пропустите этот шаг, если вы уже [настроили ресурс Application Insights][start] для этого приложения и хотите, чтобы отчеты о доступности отображались здесь же.
...
## <a name="multistep-web-tests"></a>Многошаговые веб-тесты
...
### <a name="plugging-time-and-random-numbers-into-your-multistep-test"></a>Вставка времени и случайных чисел в многошаговый тест
...
## <a name="dealing-with-signin"></a>Работа с входом
