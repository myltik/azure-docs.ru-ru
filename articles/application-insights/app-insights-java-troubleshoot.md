...
*При добавлении пакета SDK для Application Insights посредством Maven или Gradle в Eclipse возникают ошибки сборки или проверки контрольной суммы.*
...
* Проверьте [блог состояниях](http://blogs.msdn.com/b/applicationinsights-status/).
* Возможно, вы достигли месячной квоты точек данных. Откройте «Параметры», выберите «Квота» и «Расценки», чтобы узнать. Если это так, можно обновить план или оплатить дополнительную емкость. См. [схему ценообразования](http://azure.microsoft.com/pricing/details/application-insights/).
