...
Пакет SDK Application Insights отправляет данные телеметрии из живого веб-приложения на портал Azure, на который вы можете войти и просмотреть диаграммы производительности и использования приложения.
