...
* Убедитесь, что вы смотрите именно туда, куда необходимо. Войдите на [портал Azure](https://portal.azure.com), нажмите «Обзор», Application Insights и выберите приложение.
...
Мониторинг браузера позволяет получать данные о пользователях, сеансах, просмотрах страниц, а также обо всех возникших в браузере исключениях и сбоях.
...
(Также можно добавить расширение к готовому приложению, даже если вы не установили для него пакет SDK.)
