...
Для основного приложения на этапах отладки, тестирования и эксплуатации данные телеметрии рекомендуется отправлять в [отдельные ресурсы](app-insights-separate-resources.md).
...
Существует [ручная процедура добавления монитора состояния](app-insights-cloudservices.md).
