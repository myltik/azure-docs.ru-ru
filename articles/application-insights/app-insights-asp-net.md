...
Это особенно полезно, когда у вас есть [пользовательская телеметрия](app-insights-api-custom-events-metrics.md), которую необходимо отладить перед отправкой на портал.
