...
* [Динамический поток метрик](app-insights-metrics-explorer.md#live-metrics-stream) — ключевые метрики, отображаемые с задержкой примерно в 1 секунду, для мониторинга нового выпуска.
...
* [Серверы](app-insights-web-monitor-performance.md) — счетчики производительности. Доступно, если [установить монитор состояния](app-insights-monitor-performance-live-website-now.md).
* **Браузер** — производительность просмотра страниц и вызовов AJAX. Доступно, если выполнить [инструментирование веб-страниц](app-insights-javascript.md).
* **Использование**: число просмотров страниц, пользователей и сеансов. Доступно, если выполнить [инструментирование веб-страниц](app-insights-javascript.md).
...
* [Непрерывный экспорт](app-insights-export-telemetry.md) — настройка экспорта телеметрии в хранилище Azure.
...
* **Доступ к API** — в настоящее время используется для создания [заметок к выпуску](app-insights-annotations.md) и для API доступа к данным.
...
|[Аналитика](app-insights-analytics.md)<br/>Мощный язык запросов| ![Пример поиска](./media/app-insights-dashboards/63.png)
