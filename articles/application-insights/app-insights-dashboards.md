...
Вы можете настроить любую другую диаграмму и закрепить ее на панели мониторинга. Таким образом, вы получаете возможность объединить ключевые диаграммы из различных приложений.
...
* [**Упреждающая диагностика**](app-insights-proactive-diagnostics.md) предназначена для просмотра последних оповещений о производительности.
* [**Динамический поток**](app-insights-metrics-explorer.md#live-metrics-stream) представляет собой фиксированный набор почти мгновенных метрик, полезных при отладке или развертывании новой сборки.
