...
Интеллектуальная диагностика использует расширенный алгоритм машинного обучения без учителя на основе операции [DiffPatterns](app-insights-analytics-reference.md#evaluate-diffpatterns_v2). Она ищет шаблоны-кандидаты, которые могут объяснить изменение данных. Она анализирует влияние каждого кандидата на метрику и показывает шаблон, который наиболее точно соответствует изменению.
