...
Представления страниц и имена пользовательских событий используются через инструменты аналитики потребления. Оптимальное именование событий имеет решающее значение при получении выгоды от этих инструментов. Целью является баланс между немногочисленными и слишком универсальными именами ("Щелчок кнопки") и многочисленными и очень специфичными ("На сайте http://www.contoso.com/index щелкнули кнопку").
