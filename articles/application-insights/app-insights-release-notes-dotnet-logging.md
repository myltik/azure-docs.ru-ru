...
Если вы уже используете платформу ведения журналов, например log4net, NLog или System.Diagnostics.Trace, вы можете получать эти журналы и отправлять их в [Application Insights](http://azure.microsoft.com/services/application-insights/), а там сопоставить трассировку журналов с действиями пользователя, исключениями и другими событиями.
