...
Если у вас уже есть запущенное на сервере J2EE веб-приложение, вы можете начать отслеживать его с помощью [Application Insights](app-insights-overview.md). Для этого вам не нужно вносить изменения в код или повторно компилировать проект. Таким образом вы сможете получать информацию об HTTP-запросах, отправляемых на сервер, необработанных исключениях и счетчиках производительности.
...
## 5\. Проверка исключений брандмауэра
