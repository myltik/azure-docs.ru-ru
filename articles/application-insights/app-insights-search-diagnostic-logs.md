---
title: "Журналы, исключения и пользовательские средства диагностики для ASP.NET в Application Insights"
...
Пользовательские события отображаются в колонке [Diagnostic Search][diagnostic] (Поиск по журналу диагностики) и в [обозревателе метрик][metrics]. Их можно отправлять с устройств, веб-страниц и серверных приложений. Они могут использоваться для диагностики, а также для [понимания закономерностей использования][track].
