---
title: "Создание ресурса Application Insights | Документация Майкрософт"
...
В Azure Application Insights данные о приложении отображаются в *ресурсе* Microsoft Azure. Таким образом, создание ресурса является частью [настройки Application Insights для мониторинга нового приложения][start]. Во многих случаях это можно сделать автоматически в IDE. Мы советуем по возможности использовать этот способ. Однако в некоторых случаях создавать ресурс необходимо вручную.
...
Вы также можете создать новую подписку. Бесплатная учетная запись позволяет опробовать все возможности Azure. По истечении пробного периода можно найти соответствующую подписку с оплатой по мере использования, при этом плата за бесплатные службы взиматься не будет. 
...
Щелкните плитку "Поиск", чтобы открыть [Diagnostic Search][diagnostic] (Поиск по журналу диагностики), где отобразятся первые события. 
