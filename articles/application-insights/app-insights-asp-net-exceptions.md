---
title: Диагностика ошибок и исключений в приложениях ASP.NET с помощью Application Insights
...
Для мониторинга приложения ASP.NET необходимо [добавить пакет SDK Application Insights][greenbrown] в свое приложение или [установить монитор состояния на сервере IIS][redfield], или, если приложение является веб-приложением Azure, добавить [расширение Application Insights](app-insights-azure-web-apps.md).
...
![Щелкните исключение.](./media/app-insights-asp-net-exceptions/35.png)

Щелкните ссылку на строку в трассировке стека, чтобы открыть соответствующий файл.
...
Для получения данных о зависимости необходимо [установить монитор состояния][redfield] на сервере IIS или, если приложение является веб-приложением Azure, используйте [расширение Application Insights](app-insights-azure-web-apps.md).
...
Если на сервере [установлен монитор состояний][redfield], можно получить диаграмму частоты исключений, вычисленной платформой .NET. Она включает как обработанные, так и необработанные исключения .NET.
