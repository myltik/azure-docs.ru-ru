...
## Просмотр запроса POST и других данных журналов
...
Если уже используется платформа ведения журналов, такая как Log4Net или NLog, можно [записать эти журналы][netlogs] и просматривать их вместе со встроенными журналами.

[Пользовательские события][api] обычно нужны для отслеживания использования, но их также можно найти в разделе «Вся телеметрия для данного запроса».
