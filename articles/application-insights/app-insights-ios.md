...
В отобразившейся колонке будут содержаться данные о производительности и использовании приложения. Чтобы вернуться к нему после следующего входа в Azure, найдите соответствующую плитку на начальном экране. Или щелкните «Обзор», чтобы найти ее.
...
Как только приложение будет использоваться, данные будут отображаться в колонке обзора.

![Колонка «Обзор»](./media/app-insights-ios/22-oview.png)

Щелкните любую диаграмму, чтобы получить более подробные сведения. Например, в случае сбоя:
