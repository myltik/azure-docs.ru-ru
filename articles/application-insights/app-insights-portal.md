...
При входе в [портал Azure](https://portal.azure.com) вы попадаете на панель мониторинга. Ее можно настроить или перевести в полноэкранный режим. Этот пример был настроен таким образом, чтобы отображать ключевые диаграммы, интересующие его владельцев.


![Настроенная панель мониторинга.](./media/app-insights-portal/30.png)

1. Для возврата к панели мониторинга в любое время щелкните левый верхний угол окна.
2. При нажатии кнопки **+ Создать** создается новый ресурс. [Ресурс Application Insights](app-insights-create-new-resource.md) — место для хранения и анализа данных телеметрии из приложения.
3. На панели навигации можно открыть существующие ресурсы.
4. С помощью панели инструментов панели мониторинга можно изменять и создавать панели мониторинга.
...
![Откройте колонку обзора приложения на портале Azure](./media/app-insights-portal/03-range.png)
...
![Перетащите часть диаграммы.](./media/app-insights-portal/12-drag.png)
...
![Наведите указатель мыши на диаграмму](./media/app-insights-portal/02-focus.png)
...
![Заголовок колонки.](./media/app-insights-portal/11-grain.png)

Степень детализации можно настроить в колонке временного диапазона:

![Заголовок колонки.](./media/app-insights-portal/grain.png)
...
* **Диагностику**, чтобы получить стандартные страницы других метрик.
...
![Основные маршруты для просмотра телеметрии](./media/app-insights-portal/010-oview.png)
...
![Нажмите кнопку «Изменить». Перетащите элементы и диаграммы. Добавление элементы из коллекции. Затем нажмите кнопку "Готово".](./media/app-insights-portal/020-customize.png)

## Панели мониторинга

Панель мониторинга Azure — это домашняя страница, отображаемая при первом входе в [портал](https://portal.azure.com). Здесь можно собрать вместе диаграммы элементы (группы диаграмм) из нескольких ресурсов.

![Нажмите кнопку «Изменить». Перетащите элементы и диаграммы. Добавление элементы из коллекции. Затем нажмите кнопку "Готово".](./media/app-insights-portal/30.png)
...
![Чтобы закрепить диаграмму, наведите на нее курсор мыши и нажмите кнопку "..." в заголовке.](./media/app-insights-portal/33.png)
...
![Для переключения между панелями мониторинга щелкните "Панель мониторинга" и выберите сохраненную панель мониторинга. Чтобы создать и сохранить новую панель мониторинга, нажмите кнопку "Создать". Чтобы изменить расположение панелей, нажмите кнопку "Изменить".](./media/app-insights-portal/32.png)
...
![В колонке обзора щелкните "Метрики".](./media/app-insights-portal/16-metrics.png)

### Изменение диаграмм и сеток

Добавление новой диаграммы в колонку:

![В обозревателе метрик выберите "Добавить диаграмму"](./media/app-insights-portal/04-add.png)

Выберите существующую или новую диаграмму для редактирования отображаемых данных:

![Выберите одну или несколько метрик](./media/app-insights-portal/08-select.png)
...
![Выберите "Объекты группировки", затем выберите свойство в списке "Группировать по"](./media/app-insights-portal/15-segment.png)
...
![Отрегулируйте положение ползунка](./media/app-insights-portal/18-height.png)

### Фильтрация данных

Просмотр метрик только для выбранного набора значений свойства

![Щелкните "Фильтр", разверните свойство и проверьте некоторые значения](./media/app-insights-portal/19-filter.png)
...
![Выберите "Избранное"](./media/app-insights-portal/21-favorite-save.png)

Чтобы снова увидеть эту колонку, **перейдите в колонку "Обзор"** и откройте "Избранное":

![В колонке "Обзор" выберите "Избранное"](./media/app-insights-portal/22-favorite-get.png)
...
![В кнопках верхней части обозревателя метрик](./media/app-insights-portal/17-reset.png)
...
![Откройте поиск по журналу диагностики](./media/app-insights-portal/01-open-Diagnostic.png)
...
![Щелкните "Фильтр" и укажите типы элементов телеметрии](./media/app-insights-portal/02-filter-req.png)
...
![Разверните свойство и выберите значение](./media/app-insights-portal/03-response500.png)
...
![Разверните свойство и выберите значение](./media/app-insights-portal/04-failingReq.png)
...
![Щелкните "Избранное", задайте имя и нажмите кнопку "Сохранить"](./media/app-insights-portal/08-favorite-save.png)


Чтобы восстановить параметры поиска, **перейдите в колонку обзора ** и откройте избранное:

![Плитка "Избранное"](./media/app-insights-portal/22-favorite-get.png)
