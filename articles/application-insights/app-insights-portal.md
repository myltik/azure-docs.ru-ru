...
### Настройка панели мониторинга Azure


Панель мониторинга Azure — это домашняя страница, отображаемая при первом входе в портал. Здесь можно собрать вместе элементы (группы графиков) из нескольких ресурсов.

Чтобы закрепить элемент из колонки обзора Application Insights на панели мониторинга портала, выберите заголовок элемента, а затем "...".

Чтобы панели мониторинга стали более подробными, отобразите телеметрию с помощью [Power BI](https://azure.microsoft.com/blog/application-insights-content-pack-for-power-bi/).
