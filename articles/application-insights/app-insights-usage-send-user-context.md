---
title: "Отправка контекста пользователей для обеспечения оптимального использования в Azure Application Insights | Документация Майкрософт"
...
---
#  <a name="sending-user-context-to-enable-usage-experiences-in-azure-application-insights"></a>Отправка контекста пользователей для обеспечения оптимального использования в Azure Application Insights
...
Для отслеживания действий пользователя за определенный период Application Insights требуется идентификатор для каждого пользователя или сеанса. Включите эти идентификаторы в каждое представление пользовательского события или страницы.
