<properties 
	pageTitle="Application Insights для приложений C++" 
	description="Анализ данных использования и производительности приложения C++ с помощью Application Insights." 
...
2. Установите пакет SDK для Application Insights для приложений C++.
    ...
    ![Выберите узел **Online** (В сети), укажите **Include prerelease** (Включить предварительный выпуск) и выполните поиск «Application Insights»](./media/app-insights-windows-cpp/04-ai-nuget.png)
