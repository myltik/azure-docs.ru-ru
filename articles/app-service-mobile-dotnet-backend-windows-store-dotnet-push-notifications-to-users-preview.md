...
1. Вместо этого будет выполнена **InitNotificationAsync** в **MainPage.cs** для работы с проверкой подлинности пользователя. Удалите определение метода **InitNotificationAsync** и вызов в **App.xmal.cs**, добавьте следующее в **MainPage.cs** в классе **MainPage**:
...
[Начало работы с push-уведомлениями]: app-service-mobile-dotnet-backend-windows-store-dotnet-get-started-push-preview.md
