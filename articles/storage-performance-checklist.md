...
-	Текущие целевые показатели масштабируемости можно посмотреть на странице [Целевые показатели по масштабируемости и производительности службы хранилища Azure в MSDN](http://msdn.microsoft.com/library/azure/dn249410.aspx).
...
-	Текущую информацию о ценах на использование служб Azure см. в разделе [Краткий обзор цен Azure](http://azure.microsoft.com/pricing/overview/).  
...
#####Полезные ресурсы
Дополнительную информацию о размерах виртуальных машин и выделенной полосы пропускания см. раздел [Рекомендации по проектированию крупномасштабных служб на основе облачных служб Azure](http://msdn.microsoft.com/library/dn197896.aspx) в сети MSDN.  
...
Дополнительную информацию о сети Azure CDN см. в статье [Сеть Azure CDN](http://azure.microsoft.com/services/cdn/).  
...
####Полезные ресурсы
Для получения дополнительной информации о технологии SAS см. раздел [Подписи совместного доступа. Часть 1. Общие сведения о модели SAS](http://azure.microsoft.com/documentation/articles/storage-dotnet-shared-access-signature-part-1/).  
...
Пример того, как получить свойства большого двоичного объекта, необходимые для определения даты последнего изменения с помощью .NET, см. в разделе [Задание и получение свойств и метаданных](http://msdn.microsoft.com/library/hh225342.aspx) в MSDN. Дополнительную информацию об условных скачиваниях см. в разделе [Условное обновление локальной копии большого двоичного объекта](http://msdn.microsoft.com/library/azure/dd179371.aspx) в MSDN.  
...
Дополнительную информацию см. в разделе [Метод ThreadPool.SetMinThreads](http://msdn.microsoft.com/library/system.threading.threadpool.setminthreads(v=vs.110).aspx) в MSDN.  
...
Дополнительную информацию см. в статье [Обзор новых способов повышения производительности в .NET 4.5](http://msdn.microsoft.com/magazine/hh882452.aspx) в MSDN.  
...
####Полезные ресурсы
Дополнительную информацию о кодах ошибок хранилища см. в разделе [Коды ошибок и состояний](http://msdn.microsoft.com/library/azure/dd179382.aspx) на веб-сайте Microsoft Azure.  
...
Дополнительную информацию о целевой пропускной способности для больших двоичных объектов см. в разделе [Целевые показатели по масштабируемости и производительности хранилища Azure](http://msdn.microsoft.com/library/azure/dn249410.aspx) в MSDN.  
...
Пример того, как получить метаданные большого двоичного объекта с помощью .NET, см. в разделе [Задание и получение свойств и метаданных](http://msdn.microsoft.com/library/hh225342.aspx) в MSDN.  
...
Дополнительную информацию см. в разделе [Что такое блочные и страничные BLOB-объекты](http://msdn.microsoft.com/library/azure/ee691964.aspx) в MSDN.  
...
Текущие целевые показатели масштабируемости можно посмотреть на странице [Целевые показатели по масштабируемости и производительности службы хранилища Azure](http://msdn.microsoft.com/library/azure/dn249410.aspx) в MSDN.  
...
Актуальную информацию о стоимости см. в разделе [Информация о ценах на хранилища](http://azure.microsoft.com/pricing/details/storage/).  
...
Для получения дополнительной информации см. статью [Что нужно сделать, чтобы Изменение содержимого сообщения в очереди](http://azure.microsoft.com/documentation/articles/storage-dotnet-how-to-use-queues/#change-contents).  
