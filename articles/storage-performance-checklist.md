...
||Все службы|	Работа в сети|	[Отличаются ли клиентские устройства достаточно высокой пропускной способностью и низким уровнем задержки для достижения необходимой производительности?](#subheading2)
||Все службы|	Работа в сети|	[Обеспечивают ли клиентские устройства достаточно высокое качество связи?](#subheading3)
||Все службы|	Работа в сети|	[Расположено ли клиентское приложение "вблизи" учетной записи хранения?](#subheading4)
||Все службы|	Распространение содержимого|	[Используете ли вы CDN для распределения содержимого?](#subheadin5)
...
||Все службы|	Конфигурация .NET|	[Используете ли вы .NET версии 4.5 или более позднее версии, в которой улучшена функция сборки мусора?](#subheading11)
||Все службы|	Параллелизм|	[Вы уверены в том, что параллелизм ограничен таким образом, чтобы не перегружать ни возможности клиента, ни целевые показатели масштабируемости?](#subheading12)
||Все службы|	Инструменты|	[Вы используете последние версии клиентских библиотек и инструментов, предоставленных корпорацией Майкрософт?](#subheading13)
...
||Большие двоичные объекты|	Целевые показатели масштабируемости|	[Ваше приложение придерживается уровня пропускной способности или рабочего целевого показателя масштабируемости для одинарного большого двоичного объекта?](#subheading16)
||Большие двоичные объекты|	Копирование больших двоичных объектов|	[Вы копируете большие двоичные объекты эффективным способом?](#subheading17)
||Большие двоичные объекты|	Копирование больших двоичных объектов|	[Используете ли вы AzCopy для массового копирования больших двоичных объектов?](#subheading18)
||Большие двоичные объекты|	Копирование больших двоичных объектов|	[Используете ли вы операции импорта и экспорта Azure для перемещения очень больших объемов данных?](#subheading19)
||Большие двоичные объекты|	Использование метаданных|	[Вы храните часто используемые метаданные, касающиеся больших двоичных объектов, в метаданных этих объектов?](#subheading20)
||Большие двоичные объекты|	Быстрая отправка|	[При попытке быстро отправить один большой двоичный объект вы осуществляете параллельную отправку блоков?](#subheading21)
||Большие двоичные объекты|	Быстрая отправка|	[При попытке быстро отправить множество больших двоичных объектов вы отправляете большие двоичные объекты параллельно?](#subheading22)
||Большие двоичные объекты|	Правильный тип большого двоичного объекта|	[Используете ли вы при необходимости страничные или блочные BLOB-объекты?](#subheading23)
...
||Таблицы|	Конфигурация|	[Вы отключили алгоритм Нейгла для повышения производительность небольших запросов?](#subheading26)
...
||Очереди|	Конфигурация|	[Вы отключили алгоритм Нейгла для повышения производительность небольших запросов?](#subheading40)
||Очереди|	Размер сообщения|	[Ваши сообщения сжаты для повышения производительности очереди?](#subheading41)
||Очереди|	Массовое получение|	[Вы получаете множество сообщений при выполнении одной операции Get?](#subheading41)
||Очереди|	Частота опроса|	[Частота опроса достаточна для уменьшения наблюдаемой задержки приложения?](#subheading42)
||Очереди|	UpdateMessage|	[Используете ли вы UpdateMessage для хранения хода выполнения обработки сообщений, избегая повторной обработки всего сообщения при возникновении ошибки?](#subheading43)
||Очереди|	Архитектура|	[Используете ли вы очереди, чтобы сделать все приложение более масштабируемым, не допуская длительных рабочих нагрузок на критическом пути и масштабируя их самостоятельно?](#subheading44)
...
-	Текущие целевые показатели масштабируемости можно посмотреть на странице [Целевые показатели по масштабируемости и производительности службы хранилища Azure в MSDN](http://msdn.microsoft.com/ru-ru/library/azure/dn249410.aspx).
-	Подробнее о параметрах избыточности хранилищ можно узнать в записи блога [Параметры избыточности в службе хранилища Microsoft Azure и геоизбыточное хранилище с доступом на чтение](http://blogs.msdn.com/b/windowsazurestorage/archive/2013/12/11/introducing-read-access-geo-replicated-storage-ra-grs-for-windows-azure-storage.aspx). Подробнее см. в следующем разделе.
-	Текущую информацию о ценах на использование служб Azure см. в разделе [Краткий обзор цен Azure](http://azure.microsoft.com/ru-ru/pricing/overview/).  
...
#####Полезные ресурсы
Дополнительную информацию о размерах виртуальных машин и выделенной полосы пропускания см. раздел [Рекомендации по проектированию крупномасштабных служб на основе облачных служб Azure](http://msdn.microsoft.com/ru-ru/library/dn197896.aspx) в сети MSDN.  
...
Дополнительную информацию о сети Azure CDN см. в статье [Сеть Azure CDN](http://azure.microsoft.com/ru-ru/services/cdn/).  
...
####Полезные ресурсы
Для получения дополнительной информации о технологии SAS см. раздел [Подписи совместного доступа. Часть 1. Общие сведения о модели SAS](http://azure.microsoft.com/ru-ru/documentation/articles/storage-dotnet-shared-access-signature-part-1/).  

Дополнительную информацию о технологии CORS см. в разделе [Поддержка общего доступа к ресурсам независимо от источника (CORS) для службы хранилища Azure в сети MSDN](http://msdn.microsoft.com/library/azure/dn535601.aspx).  
...
Пример того, как получить свойства большого двоичного объекта, необходимые для определения даты последнего изменения с помощью .NET, см. в разделе [Задание и получение свойств и метаданных](http://msdn.microsoft.com/ru-ru/library/hh225342.aspx) в MSDN. Дополнительную информацию об условных скачиваниях см. в разделе [Условное обновление локальной копии большого двоичного объекта](http://msdn.microsoft.com/ru-ru/library/azure/dd179371.aspx) в MSDN.  
...
Для получения дополнительной информации см. публикацию [Веб-службы. Одновременные подключения](http://blogs.msdn.com/b/darrenj/archive/2005/03/07/386655.aspx) в MSDN.  
...
Данный код позволяет увеличить минимальное количество потоков в пуле потоков:  
	...
	ThreadPool.SetMinThreads(100,100); //(Determine the right number для приложения)  

Дополнительную информацию см. в разделе [Метод ThreadPool.SetMinThreads](http://msdn.microsoft.com/ru-ru/library/system.threading.threadpool.setminthreads(v=vs.110).aspx) в MSDN.  
...
Дополнительную информацию см. в статье [Обзор новых способов повышения производительности в .NET 4.5](http://msdn.microsoft.com/ru-ru/magazine/hh882452.aspx) в MSDN.  
...
####Полезные ресурсы
Дополнительную информацию о кодах ошибок хранилища см. в разделе [Коды ошибок и состояний](http://msdn.microsoft.com/ru-ru/library/azure/dd179382.aspx) на веб-сайте Microsoft Azure.  
...
####<a name="subheading16"></a>Пропускная способность и операции с большим двоичным объектом
...
Дополнительную информацию о целевой пропускной способности для больших двоичных объектов см. в разделе [Целевые показатели по масштабируемости и производительности хранилища Azure](http://msdn.microsoft.com/ru-ru/library/azure/dn249410.aspx) в MSDN.  
...
Пример того, как получить метаданные большого двоичного объекта с помощью .NET, см. в разделе [Задание и получение свойств и метаданных](http://msdn.microsoft.com/ru-ru/library/hh225342.aspx) в MSDN.  
...
####<a name="subheading21"></a>Быстрая отправка одного большого двоичного объекта
...
Для получения дополнительной информации см. публикацию [Таблицы Windows Azure. Знакомство с JSON](http://blogs.msdn.com/b/windowsazurestorage/archive/2013/12/05/windows-azure-tables-introducing-json.aspx) и [Формат полезной нагрузки для операций службы таблиц](http://msdn.microsoft.com/ru-ru/library/azure/dn535600.aspx) в MSDN. 
...
#####<a name="subheading38"></a>Хранение структурированных данных в больших двоичных объектах
...
Текущие целевые показатели масштабируемости можно посмотреть на странице [Целевые показатели по масштабируемости и производительности службы хранилища Azure](http://msdn.microsoft.com/ru-ru/library/azure/dn249410.aspx) в MSDN.  
