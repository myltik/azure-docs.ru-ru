...
- **Технические данные.** Вы можете выбирать целевую аудиторию, используя те же технические сведения, которые можно увидеть в разделах аналитики и мониторинга. **См. также:** [Анализ данных о приложении за прошлые периоды][Link 15] и [Мониторинг данных о приложении в реальном времени][Link 16] .
