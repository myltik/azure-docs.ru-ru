...
## <a name="getting-started-with-the-azure-toolkit-for-eclipse"></a>Приступая к работе с набором средств Azure для Eclipse
...
[Отладка приложения Azure в Eclipse]: ./azure-toolkit-for-eclipse-debugging-azure-applications.md
