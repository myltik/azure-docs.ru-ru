<properties 
	pageTitle="Веб-сайты на основе Django (Python) - учебник по Azure" 
	description="В учебнике описывается, как запустить веб-сайт на языке Python в службах Azure." 
...
# Создание веб-приложений на основе Django

В этом учебнике описывается, как работать с языком Python в веб-приложениях Azure.  Служба веб-приложений Azure предоставляет ограниченное бесплатное размещение приложений, а также возможности их быстрого развертывания и использования языка Python.  По мере роста приложения его можно перевести на платное размещение и интегрировать во все другие службы Azure.

Вы создадите приложение на веб-платформе Django (сведения об использовании платформ [Flask](web-sites-python-create-deploy-flask-app.md) и [Bottle](web-sites-python-create-deploy-bottle-app.md) см. в других версиях учебника).  Затем вы создадите веб-сайт из коллекции Azure, настроите развертывание через Git и локально клонируете репозиторий.  После этого вы запустите приложение локально, внесете в него изменения, зафиксируете их и отправите в Azure.  В этом учебнике показано, как выполнить вышеуказанные действия в Windows, Mac или Linux.
...
Первым делом нужно создать веб-приложение на портале управления Azure.  Для этого понадобится войти на портал и нажать кнопку **СОЗДАТЬ** в нижнем левом углу. Откроется окно. Последовательно выберите **СРЕДА ВЫПОЛНЕНИЯ ПРИЛОЖЕНИЙ**, **ВЕБ-САЙТ** и **ИЗ КОЛЛЕКЦИИ**.
...
## Устранение неполадок - параметры
...
- [Django и MySQL на платформе Azure со средствами Python 2.1 для Visual Studio][]


<!--Link references-->
[Django и MySQL на платформе Azure со средствами Python 2.1 для Visual Studio]: web-sites-python-ptvs-django-mysql.md
[Использование Django и базы данных SQL в Azure с помощью инструментов Python 2.1 для Visual Studio]: web-sites-python-ptvs-django-sql.md
[База данных SQL]: web-sites-python-ptvs-django-sql.md
[MySQL]: web-sites-python-ptvs-django-mysql.md


<!--External Link references-->
[Azure SDK для Python 2.7]: http://go.microsoft.com/fwlink/?linkid=254281
[Azure SDK для Python 3.4]: http://go.microsoft.com/fwlink/?linkid=516990
