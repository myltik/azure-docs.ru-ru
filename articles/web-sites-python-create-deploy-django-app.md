<properties urlDisplayName="Websites with Django" pageTitle="Веб-сайты Python на Django - учебник Azure" metaKeywords="Azure django, django website" description="Учебник, в котором вы ознакомитесь с запуском веб-сайта Python в Azure." metaCanonical="" services="web-sites" documentationCenter="Python" title="Creating Websites with Django" authors="huvalo" solutions="" manager="wpickett" editor="" />
