...
## <a name="20-summary-azure-security-capabilities"></a>2.0 Сводка возможностей системы безопасности Azure
...
### <a name="21-security-features-implemented-to-secure-the-azure-platform"></a>2.1 Функции безопасности, реализованные для защиты платформы Azure
...
| [Современный центр обработки данных](https://www.microsoft.com/en-us/cloud-platform/global-datacenters), физическая безопасность, [безопасная сеть](https://docs.microsoft.com/en-us/azure/security/security-network-overview) | [Реагирование на запросы правоохранительных органов](https://www.microsoft.com/en-us/trustcenter/Privacy/Responding-to-govt-agency-requests-for-customer-data) |  [Соответствие служб, расположений и отрасли](https://www.microsoft.com/en-us/trustcenter/Compliance/default.aspx) |[Как корпорация Майкрософт защищает данные клиентов в службах Azure](https://www.microsoft.com/en-us/trustcenter/Transparency/default.aspx)|
...
### <a name="22-security-features-offered-by-azure-to-secure-data-and-application"></a>2.2 Функции безопасности, предлагаемые Azure для защиты данных и приложений
...
## <a name="30-operations"></a>3.0 Операции
...
### <a name="31-operations-management-suite-security-and-audit-dashboard"></a>3.1 Панель мониторинга "Безопасность и аудит" в Operations Management Suite
...
### <a name="36-azure-advisor"></a>3.6 Помощник по Azure
...
### <a name="37-azure-security-center"></a>3.7 Центр безопасности Azure
...
## <a name="40-applications"></a>4.0 Приложения
...
### <a name="43-web-application-firewall"></a>4.3 Брандмауэр веб-приложения
...
### <a name="44-authentication-and-authorization-in-azure-app-service"></a>4.4 Аутентификация и авторизация в службе приложений Azure
...
### <a name="45-layered-security-architecture"></a>4.5 Многоуровневая архитектура безопасности
...
### <a name="46-web-server-diagnostics-and-application-diagnostics"></a>4.6 Диагностика веб-сервера и приложений
...
#### <a name="461-web-server-diagnostics"></a>4.6.1 Диагностика веб-сервера
...
## <a name="50-storage"></a>5.0 Хранилище
...
### <a name="53-encryption-in-transit"></a>5.3 Шифрование при передаче
...
### <a name="54-encryption-at-rest"></a>5.4 Шифрование неактивных данных
...
### <a name="56-enabling-browser-based-clients-using-cors"></a>5.6 Поддержка браузерных клиентов с помощью CORS
...
## <a name="60-networking"></a>6.0 Сеть
...
### <a name="61-network-layer-controls"></a>6.1 Контроль сетевого уровня
...
#### <a name="611-network-security-groups"></a>6.1.1 Группы безопасности сети
...
#### <a name="612-route-control-and-forced-tunneling"></a>6.1.2 Управление маршрутами и принудительное туннелирование
...
#### <a name="613-virtual-network-security-appliances"></a>6.1.3 Виртуальные устройства сетевой безопасности
...
### <a name="62-azure-virtual-network"></a>6.2 Виртуальная сеть Azure
...
### <a name="63-vpn-gateway"></a>6.3 VPN-шлюз
...
### <a name="65-application-gateway"></a>6.5 Шлюз приложений
...
### <a name="66-web-application-firewall"></a>6.6 Брандмауэр веб-приложения
...
### <a name="67-traffic-manager"></a>6.7 Диспетчер трафика
...
### <a name="611-log-analytics-nsgs"></a>6.11 Группы безопасности сети Log Analytics
...
### <a name="612-azure-security-center"></a>6.12 Центр безопасности Azure
...
## <a name="70-compute"></a>7.0 Вычисления
...
### <a name="71-antimalware--antivirus"></a>7.1 Антивредоносная программа и антивирусная программа
...
### <a name="72-hardware-security-module"></a>7.2 Аппаратный модуль безопасности
...
### <a name="73-virtual-machine-backup"></a>7.3 Архивация виртуальных машин
...
### <a name="75-sql-vm-tde"></a>7.5 Прозрачное шифрование данных виртуальных машин SQL
...
### <a name="76-vm-disk-encryption"></a>7.6 Шифрование дисков виртуальных машин
...
### <a name="77-virtual-networking"></a>7.7 Виртуальные сети
...
### <a name="78-patch-updates"></a>7.8 Обновление исправлений
...
### <a name="79-security-policy-management-and-reporting"></a>7.9 Управление политиками безопасности и отчеты
...
### <a name="710-azure-security-center"></a>7.10 Центр безопасности Azure
...
## <a name="80-identify-and-access-management"></a>8.0 Управление удостоверениями и доступом
...
### <a name="81-secure-identity"></a>8.1 Безопасные удостоверения
...
### <a name="82-secure-apps-and-data"></a>8.2 Защита приложений и данных
