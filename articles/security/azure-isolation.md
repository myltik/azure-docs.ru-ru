...
## <a name="20-tenant-level-isolation"></a>2.0 Уровень изоляции клиентов
...
### <a name="21-azure-tenancy"></a>2.1 Аренда Azure
...
### <a name="22-azure-role-based-access-control-rbac"></a>2.2 Управление доступом на основе ролей в Azure (RBAC)
...
### <a name="23-isolation-from-microsoft-administrators--data-deletion"></a>2.3 Изоляция от администраторов корпорации Майкрософт и удаление данных
...
## <a name="30-compute-isolation"></a>3.0 Изоляция вычислений
...
### <a name="31-hyper-v--root-os-isolation-between-root-vm--guest-vms"></a>3.1 Hyper-V и корневая ОС: изоляция корневой виртуальной машины и гостевых виртуальных машин
...
### <a name="32-advanced-vm-placement-algorithm--protection-from-side-channel-attacks"></a>3.2 Расширенный алгоритм размещения виртуальных машин и защита от атак по сторонним каналам
...
### <a name="33-the-azure-fabric-controller"></a>3.3 Контроллер структуры Azure
...
### <a name="34-additional-rules-configured-by-fabric-controller-agent-to-isolate-vm"></a>3.4 Дополнительные правила, настраиваемые агентом контроллера структуры для изоляции виртуальных машин
...
### <a name="35-vlan-isolation"></a>3.5 Изоляция виртуальных локальных сетей
...
## <a name="40-storage-isolation"></a>4.0 Изоляция хранилища
### <a name="41-logical-isolation-between-compute-and-storage"></a>4.1 Логическая изоляция вычислений и хранилища
...
### <a name="42-isolation-using-storage-access-control"></a>4.2 Изоляция с помощью управления доступом к хранилищу
...
### <a name="43-ip-level-storage-isolation"></a>4.3 Изоляция хранилища на уровне IP-адреса
...
### <a name="44-encryption"></a>4.4 Шифрование
Azure предлагает следующие типы шифрования для защиты данных.
-    Шифрование при передаче

-    Шифрование при хранении

#### <a name="441-encryption-in-transit"></a>4.4.1 Шифрование при передаче
...
-    [шифрование подключения](https://docs.microsoft.com/azure/storage/storage-security-guide#using-encryption-during-transit-with-azure-file-shares), например шифрование SMB 3.0 для файловых ресурсов Azure;
...
#### <a name="442-encryption-at-rest"></a>4.4.2 Шифрование неактивных данных
...
#### <a name="443-azure-disk-encryption"></a>4.4.3 Шифрование дисков Azure
...
## <a name="50-sql-azure-database-isolation"></a>5.0 Изоляция Базы данных SQL Azure
...
### <a name="51-sql-azure-application-model"></a>5.1 Преимущества модели приложения SQL Azure
...
### <a name="52-isolation-through-network-topology"></a>5.2 Изоляции с помощью топологии сети
...
### <a name="53-isolation-by-machine-function-and-access"></a>5.3 Изоляция с помощью функций и доступа компьютеров
...
## <a name="60-networking-isolation"></a>6.0 Изоляция сетей
