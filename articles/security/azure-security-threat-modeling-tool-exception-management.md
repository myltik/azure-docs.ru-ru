...
## <a name="a-idservicedebugawcf--do-not-include-servicedebug-node-in-configuration-file"></a><a id="servicedebug"></a>WCF — не добавляйте узел serviceDebug в файл конфигурации
...
## <a name="a-idservicemetadataawcf--do-not-include-servicemetadata-node-in-configuration-file"></a><a id="servicemetadata"></a>WCF — не добавляйте узел serviceMetadata в файл конфигурации
...
## <a name="a-idexceptionaensure-that-proper-exception-handling-is-done-in-aspnet-web-api"></a><a id="exception"></a>Обеспечьте правильную обработку исключений в веб-API ASP.NET
...
| Атрибуты              | Недоступно  |
| Ссылки              | [Обработка исключений в веб-API ASP.NET](http://www.asp.net/web-api/overview/error-handling/exception-handling), [проверка модели в веб-API ASP.NET](http://www.asp.net/web-api/overview/formats-and-model-binding/model-validation-in-aspnet-web-api) |
...
# <a name="by-action"></a>Для действия
# <a name="by-controller"></a>Для контроллера
...
## <a name="a-idmessagesado-not-expose-security-details-in-error-messages"></a><a id="messages"></a>Не раскрывайте сведения о безопасности в сообщениях об ошибках
...
## <a name="a-iddefaultaimplement-default-error-handling-page"></a><a id="default"></a>Реализуйте страницу обработки ошибок по умолчанию
...
## <a name="a-iddeploymentaset-deployment-method-to-retail-in-iis"></a><a id="deployment"></a>Настройте метод развертывания retail в IIS
...
## <a name="a-idfailaexceptions-should-fail-safely"></a><a id="fail"></a>Обеспечьте безопасную обработку исключений
