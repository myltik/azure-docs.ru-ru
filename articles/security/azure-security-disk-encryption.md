...
- Чтобы создать приложение Azure AD, создать хранилище ключей или настроить существующее хранилище ключей, а также включить шифрование, шифрованию дисков Azure требуется сценарий PowerShell, который находится [здесь](https://github.com/Azure/azure-powershell/blob/dev/src/ResourceManager/Compute/Commands.Compute/Extension/AzureDiskEncryption/Scripts/AzureDiskEncryptionPreRequisiteSetup.ps1).
