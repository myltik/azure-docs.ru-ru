...
1. Откройте консоль PowerShell от имени администратора и с помощью команды **cd** перейдите в каталог **c:\Program Files\Microsoft Azure Log Integration**.
...
## <a name="integrate-azure-activity-logs-and-security-center-alerts"></a>Интеграция оповещений центра безопасности и журналов действий Azure
