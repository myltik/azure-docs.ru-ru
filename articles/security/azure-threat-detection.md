...
## <a name="20-azure-active-directory-identity-protection"></a>2.0 Защита идентификации Azure Active Directory
...
### <a name="21-identity-protections-capabilities"></a>2.1 Возможности защиты идентификации
...
### <a name="22-azure-ad-privileged-identity-management-pim"></a>2.2 Azure AD Privileged Identity Management
...
### <a name="31-holistic-security-and-compliance-posture"></a>3.1 Комплексное состояние безопасности и соответствия
...
### <a name="32-insight-and-analytics"></a>3.2 Анализ и аналитика
...
### <a name="33-automation--control-alert-on-security-configuration-drifts"></a>3.3 Автоматизация и контроль: оповещения об отклонениях конфигурации безопасности
...
## <a name="40-azure-security-center"></a>4.0 Центр безопасности Azure
...
### <a name="41-threat-intelligence"></a>4.1 Аналитика угроз
...
### <a name="42-behavioral-analytics"></a>4.2 Поведенческая аналитика
...
### <a name="43-anomaly-detection"></a>4.3 Обнаружение аномалий
...
### <a name="44-continuous-threat-intelligence-monitoring"></a>4.4 Непрерывный мониторинг аналитики угроз
...
## <a name="50-advanced-threat-detection-features---other-azure-services"></a>5.0 Функции расширенного обнаружения угроз: другие службы Azure

### <a name="51-virtual-machine-microsoft-antimalware"></a>5.1 Виртуальная машина: антивредоносная программа (Майкрософт)
...
#### <a name="511-microsoft-antimalware-core-features"></a>5.1.1 Основные возможности антивредоносной программы (Майкрософт)
...
### <a name="52-azure-sql-database-threat-detection"></a>5.2 Обнаружение угроз базы данных SQL Azure
...
### <a name="53-application-gateway-web-application-firewall"></a>5.3 Брандмауэр веб-приложения шлюза приложений
...
### <a name="54-anomaly-detection--an-api-built-with-azure-machine-learning"></a>5.4 API обнаружения аномалий, встроенный в Машинное обучение Azure
...
## <a name="60-third-party-atd-capabilities-through-azure-marketplace"></a>6.0 Возможности сторонних ATD, доступные в Azure Marketplace
