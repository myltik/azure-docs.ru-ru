...
### <a name="21-oms-services"></a>2.1 Службы OMS
...
| служба  | Описание|
| :------------- | :-------------|
| Служба Log Analytics | Отслеживает и анализирует доступность и производительность различных ресурсов, включая физические компьютеры и виртуальные машины. |
...
### <a name="23-azure-backup"></a>2.3 Служба архивации Azure
...
### <a name="24-management-solutions"></a>2.4 Решения для управления
...
## <a name="30-azure-security-center"></a>3.0 Центр безопасности Azure
...
### <a name="31-security-policies-and-recommendations"></a>3.1 Политики безопасности и рекомендации по их обеспечению
...
### <a name="32-data-collection"></a>3.2 Сбор данных
...
### <a name="33-data-sources"></a>3.3 Источники данных
...
### <a name="34-data-protection"></a>3.4 Защита данных
...
### <a name="35-data-location"></a>3.5 Расположение данных
...
### <a name="41-azure-activity-log"></a>4.1 Журнал действий Azure
...
### <a name="42-azure-diagnostic-logs"></a>4.2 Журналы диагностики Azure
...
### <a name="43-metrics"></a>4.3 Метрики
...
### <a name="44-azure-diagnostics"></a>4.4 Система диагностики Azure
...
## <a name="50-azure-network-watcher"></a>5.0 Наблюдатель за сетями Azure
...
## <a name="80-summary"></a>8.0 Сводка
