...
Прежде чем углубляться в обсуждение рекомендаций для среды Azure [IaaS](https://azure.microsoft.com/overview/what-is-iaas/), давайте разберемся с ситуациями, в которых вы можете управлять обновлениями программного обеспечения. В этом вам поможет следующая схема.
