---
title: "Рекомендации по обновлению программного обеспечения в IaaS Azure | Документация Майкрософт"
description: "Эта статья содержит рекомендации по обновлениям программного обеспечения в среде IaaS Microsoft Azure.  Она предназначена для ИТ-специалистов и аналитиков по вопросам безопасности, ежедневно сталкивающихся с управлением изменениями, обновлением ПО и управлением ресурсами, в том числе для сотрудников, отвечающих за меры безопасности и соответствие требованиям в организации."
services: security
