...
Для многих организаций [шифрование хранимых данных](https://blogs.microsoft.com/cybertrust/2015/09/10/cloud-security-controls-series-encrypting-data-at-rest/) является обязательным шагом при обеспечении защиты и конфиденциальности данных, а также при соблюдении стандартов. В Azure есть три функции, обеспечивающие шифрование неактивных данных.
...
При шифровании дисков Azure используется [хранилище ключей Azure](https://azure.microsoft.com/services/key-vault/). Благодаря этому вы можете управлять ключами и секретами дискового шифрования в рамках подписки на хранилище ключей. Шифрование выполняется для всех хранимых данных на дисках виртуальных машин в хранилище Azure. Хранилище ключей следует использовать для аудита ключей и применения политик.
