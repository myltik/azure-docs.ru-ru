<properties
   pageTitle="Службы и технологии безопасности Azure | Microsoft Azure"
...
# Службы и технологии безопасности Azure
...
## Безопасность в Azure — общие вопросы
...
## Безопасность службы хранилища Azure
- [Шифрование службы хранилища Azure](../storage/storage-service-encryption.md)
...
## Безопасность базы данных Azure
...
- [Доменные службы Azure Active Directory](https://azure.microsoft.com/documentation/services/active-directory-ds/)
