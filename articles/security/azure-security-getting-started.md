...
-   [Антивредоносное ПО Azure](../security/azure-security-antimalware.md) включено по умолчанию на всех серверах инфраструктуры. При желании его можно включить в виртуальных машинах.
