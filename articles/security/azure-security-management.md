---
title: "Управление безопасностью в Azure | Документация Майкрософт"
...
Все это можно реализовать принудительно с помощью [объектов групповой политики](https://www.microsoft.com/download/details.aspx?id=2612) в доменных службах Active Directory, применив эти объекты ко всем учетным записям управления в (локальном) домене управления.
...
### <a name="standalone-hardened-workstation-for-management"></a>Изолированная рабочая станция управления с усиленной защитой
