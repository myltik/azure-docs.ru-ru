...
Начиная с 15 июня 2017 г., Microsoft больше не требует предварительного утверждения для проведения проникновения тестов для ресурсов Azure. Пользователи, желающие формально документа предстоящем преодоление вовлечения от Microsoft Azure, рекомендуется заполнить [уведомления Тестирование проникновения Azure службы](https://portal.msrc.microsoft.com/engage/pentest). Этот процесс связана только с Microsoft Azure и неприменимо к остальным облачной службы Майкрософт. 

>[!IMPORTANT] 
>Во время уведомления Майкрософт пера при выполнении тестов больше не требуется клиентам по-прежнему должны соответствовать требованиям [Microsoft облака единой проникновения тестирование правила использования](https://technet.microsoft.com/en-us/mt784683). 
