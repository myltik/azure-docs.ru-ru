...
description: Сведения о применении шифрования Azure для защиты персональных данных, которые могут оказаться полезными для соблюдения Общего регламента по защите данных (GDPR).
services: security
...
Эта статья поможет понять, как защитить данные при передаче на основе технологий шифрования Azure. Защита конфиденциальности персональных данных во время их передачи по сети — это важная часть многоуровневой эшелонированной стратегии защиты. Шифрование при передаче не позволяет злоумышленнику, перехватывающему передачи, просматривать или использовать данные. Сведения в этой статье можно использовать в организации для соблюдения требований Общего регламента по защите данных (GDPR).
