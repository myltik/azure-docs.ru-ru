...
| **Применимые технологии** | Универсальный |
| **Атрибуты**              | Н/Д  |
| **Справочные материалы**              | [Объявляет о параметризации SQL в Azure Cosmos DB](https://azure.microsoft.com/blog/announcing-sql-parameterization-in-documentdb/) |
| **Действия** | Несмотря на то, что Azure Cosmos DB поддерживает только запросы только для чтения, внедрение кода SQL — по-прежнему возможно, если запросы создаются путем объединения с вводимыми пользователем данными. Пользователи могут получить доступ к данным, к которым они не должны обращаться, в одной коллекции, составляя вредоносные SQL-запросы. Используйте параметризованные SQL-запросы, если запросы создаются на основе входных данных пользователя. |
