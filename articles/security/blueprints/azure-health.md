...
-   **[Таблица ответственности клиента.](https://aka.ms/healthcrmblueprint)** В книге Microsoft Excel приведены соответствующие требования HITRUST и обязанности корпорации Майкрософт и ее клиентов друг перед другом.

-   **[Проверка системами здравоохранения. Решение проверено с помощью Coalfire Systems, Inc. В статье о проверке соответствия требованиям системы здравоохранения (HIPAA и HITRUST) описывается проверка аудитором решения и рекомендации для преобразования проекта в развертывание, готовое к рабочей среде.
