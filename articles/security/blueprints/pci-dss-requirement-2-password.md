...
|---|---|
| **Поставщик<br />(Microsoft&nbsp;Azure)** | Не применяется |
| **Клиент<br />(план PCI-DSS&nbsp;)** | Список компонентов для демонстрационного решения PaaS Contoso Webstore можно просмотреть в предоставленный документации. Дополнительные сведения см. в разделе [OMS solutions](payment-processing-blueprint.md#oms-solutions) (Решения OMS) руководства PCI.|
