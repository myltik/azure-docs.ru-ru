...
[Operations Management Suite (OMS)](/azure/operations-management-suite/) может предоставить для интернет-магазина Contoso подробные журналы всех действий системы и пользователя, включая финансовые данные. Здесь можно просмотреть все изменения и проверить их правильность. 
