...
| **Клиент<br />(проект PCI‑DSS&nbsp;)** | Интернет-магазин Contoso записывает идентификатор пользователя, тип события, отметку даты и времени, сведения о результате выполнения события (успешное или неудачное), источник события и название ресурса в соответствии с требованием 10.3.|
