...
Большая круизная компания, расположенная в США, расширяет масштабы своей деятельности и предлагает маршруты в Средиземноморье, Адриатическом и Балтийском морях, а также на Британских островах. Для реализации этой программы компания приобрела несколько небольших круизных фирм, расположенных в Италии, Германии, Дании и Великобритании.

Компания использует Microsoft Azure для обработки и хранения корпоративных данных. Сюда входят персональные данные, позволяющие установить личность, например имена, адреса, номера телефонов и сведения о кредитной карте в глобальной клиентской базе. Эти корпоративные данные также включают стандартные сведения о кадрах, например адреса, номера телефонов, идентификационные номера налогоплательщиков и другие сведения о сотрудниках компании во всех расположениях. Круизная компания также содержит большую базу данных участников бонусных программ и программ скидок, которые, в свою очередь, включают личные данные для отслеживания связей с текущими и бывшими клиентами.

Корпоративным служащим, у которых есть доступ к сети из отдаленных филиалов и туристических агентств, расположенных по всему миру, предоставлен доступ к некоторым ресурсам компании.
