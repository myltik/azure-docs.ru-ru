...
Наблюдатель за сетями Azure включает в себя множество возможностей мониторинга, которые будет полезны при устранении неполадок, а также предоставляет абсолютно новый набор инструментов, помогающих выявлять проблемы безопасности.
