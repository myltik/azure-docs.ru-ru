            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Я рассматриваю возможность использования Azure для своей компании. Что мне может предложить Azure?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-isolation">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Как Azure изолирует мои ресурсы от других клиентов Azure?</p>
                        </div>
                    </div>
                </div>
            </div>
