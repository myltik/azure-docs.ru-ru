---
title: "Управление ролями в проектах облачных служб Azure с помощью Visual Studio | Документация Майкрософт"
...
---
# <a name="managing-roles-in-the-azure-cloud-services-projects-with-visual-studio"></a>Управление ролями в проектах облачных служб Azure с помощью Visual Studio
...
## <a name="adding-or-removing-roles"></a>Добавление и удаление ролей
**Чтобы добавить роль:**
...
## <a name="removing-and-adding-roles-in-your-cloud-service"></a>Удаление и добавление ролей в облачной службе
...
Сведения о настройке ролей в Visual Studio см. в статье [Настройка ролей для облачной службы Azure в среде Visual Studio](vs-azure-tools-configure-roles-for-cloud-service.md).
