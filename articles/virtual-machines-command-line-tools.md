...
**vm create-from &lt;имя_DNS> &lt;файл_ролей>**
...
##<a name="Commands_to_manage_your_Azure_virtual_machine_data_disks"></a>Команды для управления дисками с данными виртуальных машин Azure
...
Эта команда отключает диск с данными, подключенный к виртуальной машине Azure. Параметр &lt;LUN> указывает диск, который необходимо отключить. Чтобы перед отключением диска получить список сопоставленных с ним дисков, запустите команду vm disk-list &lt;имя_виртуальной_машины>.
...
##<a name="Commands_to_manage_your_web_sites"></a>Команды для управления веб-приложениями
...
**site domain delete [параметры] &lt;доменное_имя> [имя]**
...
+ **--job-type** &lt;тип_задания>: необязательный параметр. Тип веб-задания. Допустимым является значение triggered или continuous. По умолчанию команда возвращает веб-задания всех типов.
+ **--slot** &lt;слот>: имя слота, который необходимо перезапустить.
...
Описанные в этом разделе команды используются для управления серверными сценариями, которые относятся к мобильной службе. Дополнительную информацию см. в разделе [Работа с серверными сценариями в мобильных службах](mobile-services-how-to-use-server-scripts.md).
...
##<a name ="Commands_to_manage_service_bus"></a>Команды для управления служебной шиной
...
##<a name="Commands_to_manage_your_Storage_objects"></a>Команды для управления объектами хранилища
...
+ **-k** или **--account-key** &lt;ключ_учетной_записи>: ключ учетной записи хранения.
...
+ **--container** &lt;контейнер>: имя контейнера службы хранилища, который необходимо создать.
+ **-b** или **--blob** &lt;имя_большого_двоичного_объекта>: имя большого двоичного объекта службы хранилища, который необходимо отправить.
+ **-t** или **--blobtype** &lt;тип_большого_двоичного_объекта>: тип большого двоичного объекта службы хранилища: страница или блок.
...
**sql server create &lt;имя_пользователя_администратора> &lt;пароль_администратора> &lt;расположение>**
