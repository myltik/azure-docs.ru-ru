...
IoT Edge агент отправляет ответ среды выполнения к центру IOT. Ниже приведен список возможных ответов:
  * 200 – OK
  * 400 - конфигурацию развертывания имеет неправильный формат или является недопустимым.
  * 417 — устройство не имеет набора конфигурации развертывания.
  * 412 - Недопустимая версия схемы в конфигурации развертывания.
  * 406 - устройство, край, отчеты о состоянии вне сети или не отправку.
  * 500 - произошла ошибка во время выполнения edge.
