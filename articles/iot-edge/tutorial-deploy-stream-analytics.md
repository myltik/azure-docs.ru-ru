...
2. В области **Новое задание Stream Analytics** выполните следующие действия.
    ...
    а. В поле **Job name** (Имя задания) введите имя задания.
    
    b. В разделе **Среда размещения**выберите **Edge**.
...
5. В области **Новые входные данные** выполните следующие действия.
    ...
    а. В поле **Входной псевдоним** введите **температуру**.
    
    b. В поле **Source Type** (Тип источника) выберите **Поток данных**.
...
8. В области **Новое выходное значение** выполните следующие действия.
    ...
    а. В поле **Выходной псевдоним** введите **предупреждение**.
    
    b. В остальных полях используйте значения по умолчанию. 
...
2. Щелкните **Set modules** (Настроить модули).  
   ...
   а. Выберите **Add IoT Edge Modulе** (Добавить модуль IoT Edge).

   b. В качестве имени введите **tempSensor**.
...
6. Скопируйте имя, автоматически созданное для модуля Azure Stream Analytics. 
