...
1. Создайте контейнер для модуля ASA для хранения данных. Установите для уровня доступа значение _Контейнер_. Нажмите кнопку **ОК**.

    ![параметры хранилища][10]

1. На портале Azure перейдите к **Создать ресурс** > **Интернет вещей** и выберите **Задание Stream Analytics**.

1. Введите имя, **выберите "Edge" в качестве среды размещения** и используйте остальные значения по умолчанию.  Щелкните **Создать**.
