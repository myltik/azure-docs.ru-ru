---
title: "Сведения об использовании устройства Azure IoT Edge в качестве шлюза для других устройств | Документация Майкрософт"
...
При использовании шаблона непрозрачный шлюза (преобразование протоколов), всех устройств, подключающихся через шлюз, совместное использование одной очереди облака на устройство, которое может содержать не более 50 сообщений. Из этого следует, что шаблон непрозрачного шлюза должен использоваться только в том случае, если через шлюз каждого поля подключается небольшое число устройств и их трафик из облака на устройство низкий.
