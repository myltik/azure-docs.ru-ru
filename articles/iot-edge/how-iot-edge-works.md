...
>[!NOTE]
>Служба Azure IoT Edge доступна только на стандартном уровне Центра Интернета вещей. Дополнительные сведения о базовом и стандартном уровнях см. в статье о [выборе нужного уровня Центра Интернета вещей](../iot-hub/iot-hub-scaling.md).
