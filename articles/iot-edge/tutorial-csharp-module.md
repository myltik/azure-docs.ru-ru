...
3. Отправьте образ в репозиторий Docker. Выберите **Вид** > **Палитра команд** и найдите пункт меню **Edge: Push IoT Edge module Docker image** (Edge: отправка образа Docker модуля IoT Edge). В верхней части окна VS Code введите имя образа в текстовом поле всплывающего элемента. Укажите имя образа, выбранное на шаге 4.
