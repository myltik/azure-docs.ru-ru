...
В этом руководстве вы создали модуль IoT Edge и развернули его на устройстве IoT Edge в VS Code. Чтобы узнать о других сценариях при разработке Azure IoT Edge в VS Code, ознакомьтесь со следующим руководством:
