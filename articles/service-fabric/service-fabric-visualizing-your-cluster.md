...
| Узел | Перезагрузить | Моделирование сбоя узла путем перезапуска узла. Дополнительные сведения см. [здесь](https://docs.microsoft.com/en-us/powershell/servicefabric/vlatest/Restart-ServiceFabricNode). ||
