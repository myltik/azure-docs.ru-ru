...
>[AZURE.TIP] Те же действия можно выполнить из представления дерева, щелкнув символ многоточия рядом с каждым элементом.
