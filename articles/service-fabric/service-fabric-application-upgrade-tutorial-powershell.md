...
Теперь создайте проект, выбрав проект **ActorService**, щелкнув его правой кнопкой мыши и выбрав пункт "Построить" в Visual Studio (при выборе пункта "Перестроить все" может потребоваться обновление версий проектов **VisualObjects.WebService** и VisualObjects.Common, а также изменение соответствующих файлов *ServiceManifest.xml* и *ApplicationManifest.xml*, поскольку код тоже изменится). Теперь давайте создадим пакет обновленного приложения, щелкнув правой кнопкой проект *VisualObjectsApplication*, выбрав в меню Service Fabric пункт "Создать пакет". При этом должен создаться пакет приложения, пригодный для развертывания. Теперь обновленное приложение готово к развертыванию.
