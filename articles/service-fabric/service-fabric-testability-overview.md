...
Возможности тестирования представлены в сборке System.Fabric.dll. Эта библиотека DLL расположена в пакете NuGet Microsoft.ServiceFabric.nupack. Чтобы использовать возможности тестирования, включите пакет NuGet в качестве ссылки в свой проект.

### Использование компонента Testability в оболочке PowerShell

Чтобы использовать модуль тестирования PowerShell, необходимо установить MSI среды выполнения. После установки MSI автоматически загрузится модуль для PowerShell Service Fabric, который смогут использовать разработчики.
