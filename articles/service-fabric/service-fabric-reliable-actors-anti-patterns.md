<properties
   pageTitle="Антишаблоны надежных субъектов"
   description="Некоторые проблемы, с которыми могут столкнуться пользователи, изучающие надежные субъекты Service Fabric."
