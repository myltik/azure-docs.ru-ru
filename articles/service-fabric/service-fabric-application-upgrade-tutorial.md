<properties
   pageTitle="Руководство по обновлению приложений | Microsoft Azure"
   description="В этой статье рассматривается процесс развертывания приложения Service Fabric, изменения кода и развертывания обновления."
...
# Руководство по обновлению приложений
