...
## Изолированный пакет Service Fabric

Изолированный пакет для развертывания Service Fabric для Windows Server 2012 R2 называется *Microsoft.Azure.ServiceFabric.WindowsServer.&lt;версия&gt;.zip*. Скачать его можно [здесь](http://go.microsoft.com/fwlink/?LinkId=730690).
...
- Распространяемый пакет Visual C++ 2012 (VC++ 11.0).
