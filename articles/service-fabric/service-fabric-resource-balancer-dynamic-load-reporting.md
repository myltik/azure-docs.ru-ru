<properties
   pageTitle="Передача данных о динамической нагрузке | Microsoft Azure"
   description="Общие сведения о передаче данных о динамической нагрузке в балансировщик"
...
Когда служба сообщает о своей нагрузке, эти данные перезаписывают значения нагрузки первичных и вторичных ролей (значения по умолчанию, которые определяются во время создания службы). Эти данные становятся новыми значениями нагрузки, которые балансировщик ресурсов Service Fabric должен будет использовать, принимая решения о необходимости балансировки или перемещения служб.
