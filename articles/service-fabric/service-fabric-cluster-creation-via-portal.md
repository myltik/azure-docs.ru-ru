...
## Вход по протоколу RDP в экземпляр из набора масштабирования виртуальной машины (VMSS) или на узел кластера 

Каждый из типов NodeType, задаваемый в кластере, отражается на конфигурации VMSS. Подробнее об этом см. в разделе [How to RDP into your VMSS instance](service-fabric-cluster-nodetypes.md).
