<properties
   ...
   description="Эта статья содержит вводные сведения об обновлении приложения Service Fabric, включая выбор режимов обновления и выполняемых проверок работоспособности."
