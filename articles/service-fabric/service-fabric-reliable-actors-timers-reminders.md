...
# Таймеры субъектов
Таймеры субъектов обеспечивают простую оболочку вокруг таймера .NET, чтобы методы обратного вызова учитывали пошаговые гарантии параллелизма, предоставляемые средой выполнения Actors.
