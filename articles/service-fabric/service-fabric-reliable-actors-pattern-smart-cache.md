<properties
   pageTitle="Шаблон проектирования субъектов Azure Service Fabric смарт-кэш"
   description="Шаблон проектирования, показывающий, как использовать субъекты Service Fabric в качестве инфраструктуры кэширования в веб-приложениях"
...
# Шаблон проектирования субъектов Service Fabric: смарт-кэш
