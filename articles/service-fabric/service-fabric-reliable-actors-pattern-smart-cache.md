<properties
   pageTitle="Шаблон проектирования надежных субъектов: смарт-кэш"
   description="Шаблон проектирования, показывающий, как использовать надежные субъекты в качестве инфраструктуры кэширования в веб-приложениях"
