...
Наконец, мы реализуем интерфейс IJobQueue в субъекте. Обратите внимание, что мы здесь для ясности опустили детали реализации очереди приоритета. Пример реализации можно найти в соответствующих образцах.
