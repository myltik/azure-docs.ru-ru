---
title: Общие сведения о микрослужбах | Microsoft Docs
...
Независимо от языка программирования микрослужбы код и при необходимости состояние следует развертывать, обновлять и масштабировать отдельно. На самом деле эту проблему сложно решить, так как все сводится к выбору технологий. А для масштабирования все сводится к пониманию того, как секционировать (или сегментировать) код и состояние. Если в коде и состоянии используются разные технологии (а на сегодняшний день именно так и происходит), в сценариях развертывания микрослужбы должна быть предусмотрена возможность масштабирования и кода, и состояния. Кроме того, следует обеспечить гибкость и динамичность использования, позволяющие обновлять отдельные микрослужбы, а не все одновременно.
