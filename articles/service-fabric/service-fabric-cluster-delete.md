<properties
   pageTitle="Удаление кластера и его ресурсов | Microsoft Azure"
...
# Удаление кластера Service Fabric и используемых им ресурсов
...
4. Откроется страница **Основные компоненты группы ресурсов**.
...
Если кластер развернут с помощью портала или с помощью одного из шаблонов ARM Service Fabric из коллекции шаблонов, все ресурсы, используемые кластером, помечены следующими двумя тегами. С их помощью можно определить, какие ресурсы требуется удалить.
