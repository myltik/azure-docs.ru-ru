...
После экспорта файлов необходимо внести определенные изменения. В файле **parameters.json** удалите элемент **adminPassword**. Таким образом, при запуске скрипта развертывания будет запрашиваться пароль. Обновление конфигурации с помощью скачанного шаблона
