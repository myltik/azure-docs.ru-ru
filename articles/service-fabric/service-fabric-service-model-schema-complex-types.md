...
#### <a name="version"></a>Version (версия)
Определенная пользователем строка версии для документа манифеста кластера.
|Атрибут|Значение|
|---|---|
|name|Version (версия)|
|use|обязательно|
...
#### <a name="os"></a>Os
Версия сборки операционной системы. Например, 1809 для RS1.
|Атрибут|Значение|
|---|---|
|Тип|xs:string|
|name|Os|
...
Ограничение общего объема памяти (память и замена) в МБ.
|Атрибут|Значение|
|---|---|
|Тип|xs:string|
|name|MemorySwapInMB|
...
Нестрогие ограничения памяти (в МБ). Принимаются только положительные целые числа.
|Атрибут|Значение|
|---|---|
|Тип|xs:string|
...
Используемое процентное значение доступной ЦП (только для Windows). Принимаются только положительные целые числа.
|Атрибут|Значение|
|---|---|
|Тип|xs:string|
|name|CpuPercent|
...
Максимальная скорость ввода-вывода на основе числа операций ввода-вывода в секунду. Принимаются только положительные целые числа.
|Атрибут|Значение|
|---|---|
|Тип|xs:string|
|name|MaximumIOps|
...
Максимальная пропускная способность операций ввода-вывода. Принимаются только положительные целые числа.
|Атрибут|Значение|
|---|---|
|Тип|xs:string|
...
Относительное число операций ввода-вывода в блоке. Принимается только целочисленное значение в диапазоне от 10 до 1000.
|Атрибут|Значение|
|---|---|
|Тип|xs:string|
|name|BlockIOWeight|
...
Определенный пользователем идентификатор типа для группы служб. Например, ActorQueueSGType. Это значение используется в файле ApplicationManifest.xml для идентификации группы служб.
|Атрибут|Значение|
|---|---|
...
#### <a name="servicetypename"></a>ServiceTypeName
Определенный пользователем идентификатор типа для службы. Например, QueueType или CalculatorType. Это значение используется в файле ApplicationManifest.xml для идентификации службы.
|Атрибут|Значение|
|---|---|
|name|ServiceTypeName|
|use|обязательно|
