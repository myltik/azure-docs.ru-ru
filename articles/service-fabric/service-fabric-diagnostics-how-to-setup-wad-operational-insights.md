<properties
   ...
   description="В этой статье описывается, как можно настроить систему диагностики Windows Azure и оперативную аналитику для сбора журналов из кластера Service Fabric, запущенного в Azure."
...
# Сбор журналов из кластера Service Fabric в Azure с помощью системы диагностики Windows Azure (WAD) и оперативная аналитика
...
## Развертывание WAD (системы диагностики Windows Azure) в кластере Service Fabric для сбора и передачи журналов
