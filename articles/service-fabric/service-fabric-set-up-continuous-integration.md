...
4. Выберите следующие значения:
    ...
    |Продолжить при ошибке|Этот шаг завершится ошибкой, если группа ресурсов не существует. Чтобы этого избежать, включить параметр **Продолжить при ошибке** в разделе **Параметры управления**.|
...
1. Выполните инструкции, указанные для [добавления этапа "Удаление группы ресурсов кластера"](#RemoveClusterResourceGroup). Это приведет к удалению всех подготовленных ресурсов Azure, созданных во время сборки.
