...
description: "Узнайте, как настроить мониторинг и диагностику приложения ASP.NET Core в Azure Service Fabric."
...
4. Справа установите флажки рядом с двумя службами в приложении, **VotingWeb** и **VotingData**, и нажмите кнопку **Установить**.
    ![Регистрация Application Insights завершена](./media/service-fabric-tutorial-monitoring-aspnet/aisdk-sf-nuget.png)
...
Перейдите к ресурсу Application Insights на портале Azure. На левой панели навигации ресурса в разделе *Настройка* щелкните **Предварительные версии**. **Включите** параметр *Карта приложения с несколькими ролями* в списке доступных предварительных версий.

![Включение карты приложений в Application Insights](./media/service-fabric-tutorial-monitoring-aspnet/ai-appmap-enable.png)
...
Кроме того, так как мы включили карту приложений, на странице *Обзор* можно щелкнуть значок **Карта приложений**, чтобы просмотреть обе ваши подключенные службы.

![Сведения о трассировке в Application Insights](./media/service-fabric-tutorial-monitoring-aspnet/app-map.png)
