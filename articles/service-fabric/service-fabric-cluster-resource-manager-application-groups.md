...
Существует ряд ограничений на параметры емкости приложений, которые необходимо соблюдать. Если при проверке параметров обнаружатся ошибки, создание или обновление приложения будет отклонено.
Все числовые параметры должны иметь неотрицательные значения.
Также есть следующие ограничения для отдельных параметров.
