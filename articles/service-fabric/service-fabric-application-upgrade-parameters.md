...
| UpgradeHealthCheckInterval | Частота проверки состояния работоспособности. Этот параметр указан в разделе ClusterManager _манифеста_ _кластера_. Он не указывается в командлете обновления. Значение по умолчанию составляет 60 секунд. |
