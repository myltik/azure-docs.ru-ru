...
### <a name="steps"></a>Действия
  1. Получите образ контейнера Jenkins для Service Fabric: ``docker pull sayantancs/jenkins:v9``.
  2. Запустите образ контейнера: ``docker run -itd -p 8080:8080 sayantancs/jenkins:v9``
