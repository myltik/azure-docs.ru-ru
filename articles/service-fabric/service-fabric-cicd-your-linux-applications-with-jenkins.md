...
### <a name="steps"></a>Действия
  1. Образ контейнера Jenkins структуры службы по запросу: ``docker pull rapatchi/jenkins:v10``. Этот образ поставляется с предварительно установленной подключаемого модуля Jenkins структуры службы.
