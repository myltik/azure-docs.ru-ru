...
3. Создайте каталог для хранения приложения, которое вы загрузите и развернете, например c:\\ServiceFabric.
...
4. Загрузите приложение WordCount в созданную папку [отсюда](http://aka.ms/servicefabric-wordcountapp).
...
3. Наконец, просмотрите список разделов для WordCountService:
    ...
    Чтобы отобразить взаимодействие с кластером, используйте веб-обозреватель Service Fabric. Для этого в браузере перейдите по адресу [http://localhost:19080/Explorer](http://localhost:19080/Explorer).
