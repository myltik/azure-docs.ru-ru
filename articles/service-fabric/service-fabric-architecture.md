---
title: Архитектура Service Fabric | Microsoft Docs
...
Подсистема надежности предусматривает механизм, обеспечивающий высокую доступность службы Service Fabric за счет использования *репликатора*, *диспетчера отработки отказов* и *балансировщика нагрузки*.
