...
* Канал данных и обмена сообщениями: критически важные журналы и события, создаваемые в нашей системе обмена сообщениями (сейчас только ReverseProxy) и пути к данным (модели Reliable Services).
