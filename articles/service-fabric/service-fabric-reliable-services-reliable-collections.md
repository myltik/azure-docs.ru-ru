---
title: Надежные коллекции | Microsoft Docs
...
> [!NOTE]
> Еще одно преимущество создания контрольных точек состоит в том, что в общем случае они повышают производительность восстановления. Это обусловлено тем, что контрольные точки содержат только последние версии.
> 
> 
