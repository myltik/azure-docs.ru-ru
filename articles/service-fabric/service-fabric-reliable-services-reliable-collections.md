---
title: "Сохранение состояния приложения в микрослужбах Azure | Документация Майкрософт"
...
* Рассмотрите возможность обеспечения размера элементов (например, TKey + TValue для надежного словаря) ниже 80 КБ: чем меньше, тем лучше. Это позволит снизить объем использования кучи больших объектов, а также уменьшить требования к дискам и вводу-выводу сетевых операций. Во многих случаях это также уменьшит репликацию повторяющихся данных при обновлении только небольшой части значения. Распространенный способ добиться этого в надежном словаре — разбить строки на несколько строк. 
