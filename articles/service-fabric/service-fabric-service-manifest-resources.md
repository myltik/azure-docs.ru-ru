---
title: Настройка конечных точек службы Service Fabric | Microsoft Docs
...
> [!NOTE]
> Протокол службы невозможно изменить при обновлении приложения, не внося изменений, нарушающих работу.
> 
> 
