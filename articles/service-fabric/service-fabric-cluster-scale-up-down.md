...
## <a name="choose-the-node-typevm-scale-set-to-scale"></a>Выбор типа узла или масштабирования набора виртуальных машин для масштабирования
...
## <a name="set-auto-scale-rules-for-the-node-typevm-scale-set"></a>Настройка правил автомасштабирования для типа узлов или набора масштабирования виртуальных машин
...
## <a name="manually-add-vms-to-a-node-typevm-scale-set"></a>Добавление виртуальных машин в тип узла или набор масштабирования виртуальных машин
...
## <a name="manually-remove-vms-from-the-primary-node-typevm-scale-set"></a>Удаление виртуальных машин из типа первичного узла или набора масштабирования виртуальных машин
> [!NOTE]
...
## <a name="manually-remove-vms-from-the-non-primary-node-typevm-scale-set"></a>Удаление виртуальных машин из типа вторичного узла или набора масштабирования виртуальных машин
> [!NOTE]
