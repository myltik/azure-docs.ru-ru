<properties
   pageTitle="Различия между облачными службами и Service Fabric | Microsoft Azure"
...
Microsoft Azure Service Fabric — это платформа облачных приложений следующего поколения для построения масштабируемых и высоконадежных распределенных приложений. Она содержит множество новых функций для упаковки, развертывания, обновления и управления распределенными облачными приложениями.
