...
1.  Убедитесь, что установлена версия Eclipse Neon (или более поздняя) и последняя версия Buildship (1.0.17 или более поздняя версия):
    -   Чтобы проверить версии установленных компонентов, в Eclipse выберите **Help** > **Installation Details** (Справка > Сведения об установке).
...
2.  Для установки подключаемого модуля Service Fabric в Eclipse щелкните **Help** > **Install New Software** (Справка > Установка нового программного обеспечения).
