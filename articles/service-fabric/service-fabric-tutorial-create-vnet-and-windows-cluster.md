...
description: "Из этого руководства вы узнаете, как развернуть кластер Service Fabric на платформе Windows в имеющейся виртуальной сети с помощью PowerShell."
