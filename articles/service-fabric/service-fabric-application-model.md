...
В этой статье приведен обзор модели приложений структуры службы и описание того, как определить приложение и службу через файлы манифеста, выполнить создание пакета приложения и подготовку к развертыванию.
...
![Разделы и реплики в службе][Image2]
