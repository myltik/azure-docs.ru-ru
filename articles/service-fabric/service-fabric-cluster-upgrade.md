...
>[AZURE.NOTE] Перед идентификацией сертификата, который вы хотите использовать для ресурсов кластера, необходимо выполнить описанные ниже действия, иначе новый сертификат не будет использоваться. 1. Отправьте новый сертификат в хранилище ключей Azure. Инструкции см. в статье [Защита кластера Service Fabric](service-fabric-cluster-security.md). Начните с шага 2 в этом документе. 2. Обновите все виртуальные машины в составе кластера, чтобы развернуть на них сертификат. Для этого обратитесь к [Блогу команды разработчиков хранилища ключей Azure](http://blogs.technet.com/b/kv/archive/2015/07/14/vm_2d00_certificates.aspx).
