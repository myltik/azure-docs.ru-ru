---
title: Добавление настраиваемых отчетов о работоспособности Service Fabric | Microsoft Docs
...
Для разработки и реализации системы отчетов о работоспособности нужно, чтобы устройства наблюдения и компоненты системы могли выполнить следующее.
