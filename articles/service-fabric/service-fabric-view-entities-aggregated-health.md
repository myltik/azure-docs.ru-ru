---
title: Обзор сводного состояния работоспособности сущностей Azure Service Fabric | Microsoft Docs
...
Следующий командлет возвращает сведения о работоспособности пакета службы **WordCountServicePkg** приложения **fabric:/WordCount**, развернутого на узле ***Node2***. Эта сущность составляет отчеты **System.Hosting** при успешной активации пакета службы и точки входа, а также при успешной регистрации типа службы.
