...
description: "В этом руководстве вы узнаете, как развертывать приложение в кластере Service Fabric."
...
Это руководство является вторым из серии руководств. В нем показано, как развернуть приложение Azure Service Fabric в кластере, выполняющемся в Azure.
