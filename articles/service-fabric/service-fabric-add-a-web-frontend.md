---
title: Создание внешнего веб-интерфейса для приложения с помощью ASP.NET Core | Microsoft Docs
...
> [!NOTE]
> Для работы с этим учебником необходимо [установить .NET Core 1.0][dotnetcore-install].
> 
> 
