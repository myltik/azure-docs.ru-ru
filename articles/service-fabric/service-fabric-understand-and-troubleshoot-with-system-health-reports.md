...
* **SourceId**: System.Hosting.
* **Свойство**: **Download:***версия_развертывания*.
...
* **SourceId**: System.Hosting.
* **Свойство**: использует префикс **CodePackageActivation** и содержит имя пакета кода и точку входа вида **CodePackageActivation:***имя_пакета_кода*:*SetupEntryPoint/EntryPoint*. Например, **CodePackageActivation:Code:SetupEntryPoint**.
