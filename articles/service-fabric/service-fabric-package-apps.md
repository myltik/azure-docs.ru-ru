...
Если вы скопировали несжатую версию пакета приложения и после этого решили применить для этого пакета сжатие, необходимо изменить версию манифеста приложения, чтобы избежать несовпадения контрольных сумм.
Аналогичным образом, если вы ранее передали сжатую версию пакета, для использования несжатого пакета следует обновить версию манифеста приложения.
