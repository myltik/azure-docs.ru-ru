...
>[AZURE.NOTE] Для создания пакета приложения в составе проекта приложения можно также использовать Visual Studio. Если связать источник с проектом Visual Studio, при построении решения Visual Studio следует убедиться, что в пакете приложения отображаются последние изменения в источнике. [Упаковка имеющегося приложения с использованием Visual Studio](service-fabric-deploy-existing-app.md#using-visual-studio-to-package-an-existing-application)
...
>[AZURE.NOTE] С помощью Visual Studio можно опубликовать приложение локально, нажав клавишу F5 для отладки или используя мастер публикации.
