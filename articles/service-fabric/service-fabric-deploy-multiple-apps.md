...
>[AZURE.NOTE] Для создания пакета приложения в составе проекта приложения можно также использовать Visual Studio. Если связать источник с проектом Visual Studio, при построении решения Visual Studio следует убедиться, что в пакете приложения отображаются последние изменения в источнике.
