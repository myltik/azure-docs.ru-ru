...
Разделенный запятыми список команд для контейнера.
...
|Атрибут|Значение|
|---|---|
|Тип|[ContainerHealthConfigType](#containerhealthconfigtype-type)|
|Содержимое|0 элементов, 0 атрибутов|
|name|HealthConfig|
|minOccurs|0|
|maxOccurs|1|
...
|Атрибут|Значение|
|---|---|
|Тип|[ImageOverridesType](#imageoverridestype-type)|
|Содержимое|0 элементов, 0 атрибутов|
|name|ImageOverrides|
|minOccurs|0|
|maxOccurs|1|
