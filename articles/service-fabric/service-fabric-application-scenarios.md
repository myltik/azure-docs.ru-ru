...
Несколько примеров, показывающих, как Service Fabric используется для проектирования приложений, опубликовано на [сайте решений микрослужб](https://azure.microsoft.com/solutions/microservice-applications/).
