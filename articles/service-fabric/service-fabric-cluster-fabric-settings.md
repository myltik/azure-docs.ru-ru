...
| **Параметр** | **Допустимые значения** | **Рекомендация или краткое описание** |
| --- | --- | --- |
| Уровень |Целое число, по умолчанию — 4 |Уровень трассировки событий Windows. |
...
| **Параметр** | **Допустимые значения** | **Рекомендация или краткое описание** |
| --- | --- | --- |
| FabricDataRoot |Строка |Корневой каталог данных Windows Fabric. |
| FabricLogRoot |Строка |Корневой каталог журналов Windows Fabric. |
...
| SkipFirewallConfiguration |Логическое значение, по умолчанию — false |Указывает, следует ли пропустить настройку брандмауэра. |
...
| ReplicatorAddress |Строка символов в кодировке Юникод, по умолчанию — "localhost:0" | Конечная точка в формате "IP-адрес:порт", используемая репликатором Windows Fabric для установки подключений к другим репликам, чтобы отправлять и получать операции. |
...
| **Параметр** | **Допустимые значения** | **Рекомендация или краткое описание** |
| --- | --- | --- |
| UpgradeDomainId |Строка символов в кодировке Юникод, по умолчанию — L"" |Описывает домен обновления, к которому принадлежит узел. |
...
| ClusterX509StoreName |Строка символов в кодировке Юникод, по умолчанию — L"My" |Имя хранилища сертификатов X.509, в котором содержится сертификат кластера, используемый для защиты передачи данных внутри кластера. |
| ClusterX509FindType |Строка символов в кодировке Юникод, по умолчанию — L"FindByThumbprint" |Указывает, как найти сертификат кластера в хранилище с использованием поддерживаемых значений параметра ClusterX509StoreName (FindByThumbprint, FindBySubjectName, FindBySubjectName). При наличии нескольких совпадений используется сертификат с самым поздним временем окончания срока действия. |
| ClusterX509FindValue |Строка символов в кодировке Юникод, по умолчанию — L"" |Значение фильтра поиска, используемое для поиска сертификата кластера. |
| ClusterX509FindValueSecondary |Строка символов в кодировке Юникод, по умолчанию — L"" |Значение фильтра поиска, используемое для поиска сертификата кластера. |
| ServerAuthX509StoreName |Строка символов в кодировке Юникод, по умолчанию — L"My" |Имя хранилища сертификатов X.509, в котором содержится сертификат сервера для входа в службу. |
| ServerAuthX509FindType |Строка символов в кодировке Юникод, по умолчанию — L"FindByThumbprint" |Указывает, как найти сертификат сервера в хранилище с использованием поддерживаемых значений параметра ServerAuthX509StoreName (FindByThumbprint, FindBySubjectName). |
| ServerAuthX509FindValue |Строка символов в кодировке Юникод, по умолчанию — L"" |Значение фильтра поиска, используемое для поиска сертификата сервера. |
| ServerAuthX509FindValueSecondary |Строка символов в кодировке Юникод, по умолчанию — L"" |Значение фильтра поиска, используемое для поиска сертификата сервера. |
| ClientAuthX509StoreName |Строка символов в кодировке Юникод, по умолчанию — L"My" |Имя хранилища сертификатов X.509, в котором содержится сертификат для роли администратора FabricClient по умолчанию. |
| ClientAuthX509FindType |Строка символов в кодировке Юникод, по умолчанию — L"FindByThumbprint" |Указывает, как найти сертификат в хранилище с использованием поддерживаемых значений параметра ClientAuthX509StoreName (FindByThumbprint, FindBySubjectName). |
| ClientAuthX509FindValue |Строка символов в кодировке Юникод, по умолчанию — L"" | Значение фильтра поиска, используемое для поиска сертификата роли администратора FabricClient по умолчанию. |
| ClientAuthX509FindValueSecondary |Строка символов в кодировке Юникод, по умолчанию — L"" |Значение фильтра поиска, используемое для поиска сертификата роли администратора FabricClient по умолчанию. |
| UserRoleClientX509StoreName |Строка символов в кодировке Юникод, по умолчанию — L"My" |Имя хранилища сертификатов X.509, в котором содержится сертификат роли пользователя FabricClient по умолчанию. |
| UserRoleClientX509FindType |Строка символов в кодировке Юникод, по умолчанию — L"FindByThumbprint" |Указывает, как найти сертификат в хранилище с использованием поддерживаемых значений параметра UserRoleClientX509StoreName (FindByThumbprint, FindBySubjectName). |
| UserRoleClientX509FindValue |Строка символов в кодировке Юникод, по умолчанию — L"" |Значение фильтра поиска, используемое для поиска сертификата роли пользователя FabricClient по умолчанию. |
| UserRoleClientX509FindValueSecondary |Строка символов в кодировке Юникод, по умолчанию — L"" |Значение фильтра поиска, используемое для поиска сертификата роли пользователя FabricClient по умолчанию. |

### <a name="section-name-paas"></a>Имя раздела: Paas
| **Параметр** | **Допустимые значения** | **Рекомендация или краткое описание** |
| --- | --- | --- |
| ClusterId |Строка символов в кодировке Юникод, по умолчанию — L"" |Хранилище сертификатов X509, используемое Fabric для защиты конфигурации. |
...
### <a name="section-name-votes"></a>Имя раздела: Votes
| **Параметр** | **Допустимые значения** | **Рекомендация или краткое описание** |
| --- | --- | --- |
| PropertyGroup |VoteConfig |Голос — это единица голосования в кворуме кластера. Голос назначается владельцу голосования (узлу) в центре голосования. Как правило, центры голосования — это узлы (начальные узлы) в кластере. Наличие кворума голосов означает, что кластер работоспособен,  а его отсутствие может стать причиной сбоя кластера. Альтернативой голосования начальных узлов являются голосования SQL, где в качестве центра голосования используется не узел в кластере, а экземпляр SQL Server. В этом случае в качестве прокси-сервера выступает узел, идентификатор которого наиболее совпадает с идентификатором голосования SQL. Голоса, выбранные в конфигурации, должны совпадать на всех узлах. Идентификатор — это строка, преобразованная в длинное целое число, представляющее идентификатор голоса в кластере. Доступно два типа голосований: SeedNode и SqlServer. Их использование зависит от центра голосования, используемого кластером. Формат строки подключения зависит от выбранного типа. Строка подключения к голосованию типа SeedNode — это конечная точка узла с тем же идентификатором узла. Для типа SqlServer — это строка подключения к SQL Server 2008 или более поздней версии. Пример строки подключения к SeedNode: '0 = SeedNode;10.0.0.1:10000'. Пример строки подключения к SQL: 'sqlvote1 = SqlServer;Provider=SQLNCLI10;Server=.\SQLEXPRESS;Database=master;Integrated Security=SSPI'. |
...
| UserStandByReplicaKeepDuration |Время в секундах, по умолчанию — 3600.0 * 24 * 7 |Временной диапазон в секундах. Если реплика не восстанавливает работоспособность за определенное время, она уже заменена. Этот таймер определяет, как долго диспетчер отработки отказов сохраняет реплику, находящуюся в режиме ожидания, до ее удаления. |
...
|MinReplicaSetSize | Целое число, по умолчанию — 3. | Минимальное количество реплик службы именования, необходимых для записи данных, чтобы завершить обновление. При наличии меньшего количества реплик система надежности отклоняет обновления в хранилище службы именования до восстановления реплик. Это значение никогда не должно быть больше значения TargetReplicaSetSize. | | ReplicaRestartWaitDuration | Время в секундах, по умолчанию — (60.0 * 30). | Временной диапазон в секундах. Этот таймер запускается после сбоя реплики службы именования.  По истечении этого времени диспетчер отработки отказов начинает заменять отключенные реплики (он еще не рассматривает их как потерянные). | |QuorumLossWaitDuration | Время в секундах, по умолчанию — MaxValue. | Временной диапазон в секундах. Этот таймер запускается после потери кворума в службе именования.  По истечении этого времени диспетчер отработки отказов рассматривает отключенные реплики как потерянные и пытается восстановить кворум. Обратите внимание, что это может привести к потере данных. | | StandByReplicaKeepDuration | Время в секундах, по умолчанию — 3600.0 * 2. | Временной диапазон в секундах. Если реплики службы именования не восстанавливают работоспособность за определенное время, происходит их замена.  Этот таймер определяет, как долго диспетчер отработки отказов сохраняет реплику, находящуюся в режиме ожидания, до ее удаления. | |PlacementConstraints | Строка символов в кодировке Юникод, по умолчанию — L"". | Ограничение на размещение в службе именования. | | ServiceDescriptionCacheLimit | Целое число, по умолчанию — 0. | Максимальное количество записей, хранящихся в кэше для описания службы, которая дольше других не использовалась, в службе хранилища службы именования (чтобы снять ограничения, задайте значение 0). | | RepairInterval | Время в секундах, по умолчанию — 5. | Временной диапазон в секундах. Интервал времени, в течение которого запускается устранение несоответствия именования между владельцем имени и владельцем центра. | | MaxNamingServiceHealthReports | Целое число, по умолчанию — 10. | Максимальное количество медленных операций, одновременно рассматриваемых службой хранилища службы именования в качестве неработоспособных. Если значение равно 0, отправляются все медленные операции. | | MaxMessageSize |Целое число, по умолчанию — 4 * 1024 * 1024. | Максимальный размер сообщения для обмена с узлом клиента при использовании именования. Снижает количество атак типа "отказ в обслуживании". По умолчанию — 4MB. | | MaxFileOperationTimeout | Время в секундах, по умолчанию — 30. | Временной диапазон в секундах. Максимально допустимое время ожидания для операции службы хранилища файлов. Запросы с более долгим временем ожидания отклоняются. | | MaxOperationTimeout | Время в секундах, по умолчанию — 600 | Временной диапазон в секундах. Максимально допустимое время ожидания для операций клиента. Запросы с более долгим временем ожидания отклоняются. | | MaxClientConnections | Целое число, по умолчанию — 1000. | Максимально допустимое количество клиентских подключений на шлюз. | | ServiceNotificationTimeout | Время в секундах, по умолчанию — 30. | Временной диапазон в секундах. Время ожидания, используемое при доставке уведомлений службы клиенту. | | MaxOutstandingNotificationsPerClient |Целое число, по умолчанию — 1000. | Максимальное количество необработанных уведомлений до принудительного закрытия регистрации клиента шлюзом. | | MaxIndexedEmptyPartitions | Целое число, по умолчанию — 1000. | Максимальное количество пустых разделов, остающихся индексированными в кэше уведомления для синхронизации повторного подключения клиентов. При превышении этого значения пустые разделы удаляются из индекса в порядке возрастания версии поиска. Подключенные повторно клиенты по-прежнему могут синхронизировать и получать обновления недостающих пустых разделов, но протокол синхронизации становится более затратным. | | GatewayServiceDescriptionCacheLimit | Целое число, по умолчанию — 0. | Максимальное количество записей, хранящихся в кэше для описания службы, которая дольше других не использовалась, в шлюзе службы именования (чтобы снять ограничения, задайте значение 0). | | PartitionCount | Целое число, по умолчанию — 3. | Количество разделов хранилища службы именования, которые нужно создать. Каждому разделу принадлежит один ключ раздела, соответствующий его индексу. Поэтому ключи разделов [0; PartitionCount) существуют. При увеличении количества разделов службы именования увеличивается конфигурация масштабирования этой службы. Это связано с уменьшением среднего размера данных, занятого любым набор реплик резервного копирования. Однако это приводит к повышению стоимости использования ресурсов, так как необходимо обслуживать реплики службы (их количество равно числу разделов, умноженному на размер набора реплик).|

### <a name="section-name-runas"></a>Имя раздела: RunAs
| **Параметр** | **Допустимые значения** | **Рекомендация или краткое описание** |
| --- | --- | --- |
| RunAsAccountName |Строка символов в кодировке Юникод, по умолчанию — L"" |Указывает имя учетной записи запуска от имени. Требуется только для учетной записи типа DomainUser или ManagedServiceAccount. Допустимые значения: "domain\user" или "user@domain". |
|RunAsAccountType|Строка символов в кодировке Юникод, по умолчанию — L"" |Указывает тип учетной записи запуска от имени. Требуется для любого допустимого значения раздела RunAs (DomainUser, NetworkService, ManagedServiceAccount, LocalSystem).|
|RunAsPassword|Строка символов в кодировке Юникод, по умолчанию — L"" |Указывает пароль учетной записи запуска от имени. Требуется только для учетной записи типа DomainUser. |

### <a name="section-name-runasfabric"></a>Имя раздела: RunAs_Fabric
| **Параметр** | **Допустимые значения** | **Рекомендация или краткое описание** |
| --- | --- | --- |
| RunAsAccountName |Строка символов в кодировке Юникод, по умолчанию — L"" |Указывает имя учетной записи запуска от имени. Требуется только для учетной записи типа DomainUser или ManagedServiceAccount. Допустимые значения: "domain\user" или "user@domain". |
|RunAsAccountType|Строка символов в кодировке Юникод, по умолчанию — L"" |Указывает тип учетной записи запуска от имени. Требуется для любого допустимого значения раздела RunAs (LocalUser, DomainUser, NetworkService, ManagedServiceAccount, LocalSystem). |
|RunAsPassword|Строка символов в кодировке Юникод, по умолчанию — L"" |Указывает пароль учетной записи запуска от имени. Требуется только для учетной записи типа DomainUser. |
...
|SharedLogPath |Строка символов в кодировке Юникод, по умолчанию — L"" | Имя файла и путь к расположению, где требуется разместить контейнер общего журнала. Укажите значение L"", чтобы использовать расположение по умолчанию в корневой папке данных Fabric. |
|SharedLogId |Строка символов в кодировке Юникод, по умолчанию — L"" |Глобальный уникальный идентификатор контейнера общего журнала. Укажите значение L"" при использовании расположения по умолчанию в корневой папке данных Fabric. |
...
|GatewayAuthCredentialType |Строка символов в кодировке Юникод, по умолчанию — L"None" | Указывает тип учетных данных, используемых для безопасного доступа к конечной точке HTTP-шлюза приложения. Допустимое значение: None/X509. |
|GatewayX509CertificateStoreName |Строка символов в кодировке Юникод, по умолчанию — L"My" | Имя хранилища сертификатов X.509, в котором содержится сертификат HTTP-шлюза приложения. |
|GatewayX509CertificateFindType |Строка символов в кодировке Юникод, по умолчанию — L"FindByThumbprint" | Указывает, как найти сертификат в хранилище с использованием поддерживаемых значений параметра GatewayX509CertificateStoreName (FindByThumbprint, FindBySubjectName). |
|GatewayX509CertificateFindValue | Строка символов в кодировке Юникод, по умолчанию — L"" | Значение фильтра поиска, используемое для поиска сертификата HTTP-шлюза приложения. Этот сертификат настроен в конечной точке HTTPS, и при необходимости может также использоваться для проверки удостоверения приложения в службах. Сначала выполняется поиск параметра FindValue, а если он отсутствует, — FindValueSecondary. |
|GatewayX509CertificateFindValueSecondary | Строка символов в кодировке Юникод, по умолчанию — L"" |Значение фильтра поиска, используемое для поиска сертификата HTTP-шлюза приложения. Этот сертификат настроен в конечной точке HTTPS, и при необходимости может также использоваться для проверки удостоверения приложения в службах. Сначала выполняется поиск параметра FindValue, а если он отсутствует, — FindValueSecondary.|
...
| PlacementConstraints | Строка символов в кодировке Юникод, по умолчанию — L""| Ограничения на размещения для службы анализа сбоев. |
...
| PrimaryAccountType | Строка символов в кодировке Юникод, по умолчанию — L"" |Тип основной учетной записи субъекта, используемой для внесения общих папок службы хранилища файлов в список управления доступом. |
| PrimaryAccountUserName | Строка символов в кодировке Юникод, по умолчанию — L"" |Имя пользователя основной учетной записи субъекта, используемой для внесения общих папок службы хранилища файлов в список управления доступом. |
| PrimaryAccountUserPassword | Защищенная строка, по умолчанию — пусто |Пароль основной учетной записи субъекта, используемой для внесения общих папок службы хранилища файлов в список управления доступом. |
...
| PrimaryAccountNTLMX509StoreLocation | Строка символов в кодировке Юникод, по умолчанию — L"LocalMachine"| Расположение хранилища сертификатов X509, используемых для создания HMAC в секрете пароля основной учетной записи при использовании проверки подлинности NTLM. |
| PrimaryAccountNTLMX509StoreName | Строка символов в кодировке Юникод, по умолчанию — L"MY"| Имя хранилища сертификатов X509, используемых для создания HMAC в секрете пароля основной учетной записи при использовании проверки подлинности NTLM. |
| PrimaryAccountNTLMX509Thumbprint | Строка символов в кодировке Юникод, по умолчанию — L""|Отпечаток хранилища сертификатов X509, используемых для создания HMAC в секрете пароля основной учетной записи при использовании проверки подлинности NTLM. |
| SecondaryAccountType | Строка символов в кодировке Юникод, по умолчанию — L""| Тип дополнительной учетной записи субъекта, используемой для внесения общих папок службы хранилища файлов в список управления доступом. |
| SecondaryAccountUserName | Строка символов в кодировке Юникод, по умолчанию — L""| Имя пользователя дополнительной учетной записи субъекта, используемой для внесения общих папок службы хранилища файлов в список управления доступом. |
| SecondaryAccountUserPassword | Защищенная строка, по умолчанию — пусто |Пароль дополнительной учетной записи субъекта, используемой для внесения общих папок службы хранилища файлов в список управления доступом.  |
...
| SecondaryAccountNTLMX509StoreLocation | Строка символов в кодировке Юникод, по умолчанию — L"LocalMachine" |Расположение хранилища сертификатов X509, используемых для создания HMAC в секрете пароля дополнительной учетной записи при использовании проверки подлинности NTLM. |
| SecondaryAccountNTLMX509StoreName | Строка символов в кодировке Юникод, по умолчанию — L"MY" |Имя хранилища сертификатов X509, используемых для создания HMAC в секрете пароля дополнительной учетной записи при использовании проверки подлинности NTLM. |
| SecondaryAccountNTLMX509Thumbprint | Строка символов в кодировке Юникод, по умолчанию — L""| Отпечаток хранилища сертификатов X509, используемых для создания HMAC в секрете пароля дополнительной учетной записи при использовании проверки подлинности NTLM. |
...
| PlacementConstraints | Строка символов в кодировке Юникод, по умолчанию — L"" | Ограничения на размещения для службы хранилища образов. |
...
| **Параметр** | **Допустимые значения** | **Рекомендация или краткое описание** |
| --- | --- | --- |
| Поставщики |Строка символов в кодировке Юникод, по умолчанию — L"DSTS" |Разделенный запятыми список поставщиков проверки токенов, которых можно включить (допустимые поставщики: DSTS, AAD). Сейчас в любое время может быть включен только один поставщик. |

### <a name="section-name-dststokenvalidationservice"></a>Имя раздела: DSTSTokenValidationService
| **Параметр** | **Допустимые значения** | **Рекомендация или краткое описание** |
| DSTSDnsName | Строка символов в кодировке Юникод, по умолчанию — L"". | DNS-имя сервера DSTS. | | DSTSRealm | Строка символов в кодировке Юникод, по умолчанию — L"". | Имя области сервера DSTS. | | CloudServiceDnsName | Строка символов в кодировке Юникод, по умолчанию — L"". | DNS-имя облачной службы, для которой запрашивается маркер безопасности DSTS. | | CloudServiceName | Строка символов в кодировке Юникод, по умолчанию — L"". | Имя облачной службы, для которой запрашивается маркер безопасности DSTS. | | PublicCertificateFindValue | Строка символов в кодировке Юникод, по умолчанию — L"". | Значения поиска сертификата X509 для общего сертификата DSTS. | | PublicCertificateFindType | Строка символов в кодировке Юникод, по умолчанию — L"". | Тип поиска сертификата X509 для общего сертификата DSTS, например FindByThumbprint. | | PublicCertificateStoreName | Строка символов в кодировке Юникод, по умолчанию — L"My". | Имя хранилища, в котором хранится общий сертификат серверов DSTS. |
...
| PlacementConstraints | Строка символов в кодировке Юникод, по умолчанию — L"" | Ограничения на размещения для службы управления обновлениями. |
...
| **Параметр** | **Допустимые значения** | **Рекомендация или краткое описание** |
| --- | --- | --- |
| PlacementConstraints |Строка символов в кодировке Юникод, по умолчанию — L"" |Ограничения на размещения для службы обновления. |
...
| CoordinatorType | Строка символов в кодировке Юникод, по умолчанию — L"WUTest"| Тип координатора службы обновления. |
| BaseUrl | Строка символов в кодировке Юникод, по умолчанию — L"" |Базовый URL-адрес службы обновления. |
| ClusterId | Строка символов в кодировке Юникод, по умолчанию — L"" | Идентификатор кластера службы обновления. |
| X509StoreName | Строка символов в кодировке Юникод, по умолчанию — L"My"| Имя хранилища X509 службы обновления. |
| X509StoreLocation | Строка символов в кодировке Юникод, по умолчанию — L"" | Расположение хранилища X509 службы обновления. |
| X509FindType | Строка символов в кодировке Юникод, по умолчанию — L""| Тип поиска сертификата X509 службы обновления. |
| X509FindValue | Строка символов в кодировке Юникод, по умолчанию — L"" | Значение поиска сертификата X509 службы обновления. |
| X509SecondaryFindValue | Строка символов в кодировке Юникод, по умолчанию — L"" | Дополнительное значение поиска сертификата X509 службы обновления. |
| OnlyBaseUpgrade | Логическое значение, по умолчанию — false | Только базовое обновление службы обновления. |
| TestCabFolder | Строка символов в кодировке Юникод, по умолчанию — L"" | Папка с CAB-файлом теста для службы обновления. |

### <a name="section-name-securityclientaccess"></a>Имя раздела: Security/ClientAccess
| **Параметр** | **Допустимые значения** | **Рекомендация или краткое описание** |
| --- | --- | --- |
| CreateName |Строка символов в кодировке Юникод, по умолчанию — L"Admin" |Настройка безопасности для создания универсального кода ресурса (URI) именования. |
| DeleteName |Строка символов в кодировке Юникод, по умолчанию — L"Admin" |Настройка безопасности для удаления универсального кода ресурса (URI) именования. |
| PropertyWriteBatch |Строка символов в кодировке Юникод, по умолчанию — L"Admin" |Настройка безопасности для операций записи свойств именования. |
| CreateService |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для создания службы. |
| CreateServiceFromTemplate |Строка символов в кодировке Юникод, по умолчанию — L"Admin" |Настройка безопасности для создания службы на основе шаблона. |
| UpdateService |Строка символов в кодировке Юникод, по умолчанию — L"Admin" |Настройка безопасности для обновлений службы. |
| DeleteService  |Строка символов в кодировке Юникод, по умолчанию — L"Admin" |Настройка безопасности для удаления службы. |
| ProvisionApplicationType |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для подготовки типа приложения. |
| CreateApplication |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для создания приложения. |
| DeleteApplication |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для удаления приложения. |
| UpgradeApplication |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для запуска или прерывания обновлений приложения. |
| RollbackApplicationUpgrade |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для отката обновлений приложения. |
| UnprovisionApplicationType |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для отмены подготовки типа приложения. |
| MoveNextUpgradeDomain |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для возобновления обновлений приложения с помощью явного домена обновления. |
| ReportUpgradeHealth |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для возобновления обновлений приложения с помощью текущего процесса обновления. |
| ReportHealth |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для отправки сведений о работоспособности. |
| ProvisionFabric |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для подготовки MSI и (или) манифеста кластера. |
| UpgradeFabric |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для запуска обновлений кластера. |
| RollbackFabricUpgrade |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для отката обновлений кластера. |
| UnprovisionFabric |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для отмены подготовки MSI и (или) манифеста кластера. |
| MoveNextFabricUpgradeDomain |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для возобновления обновлений кластера с помощью явного домена обновления. |
| ReportFabricUpgradeHealth |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для возобновления обновлений кластера с помощью текущего процесса обновления. |
| StartInfrastructureTask |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для запуска задач инфраструктуры. |
| FinishInfrastructureTask |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для завершения задач инфраструктуры. |
| ActivateNode |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для активации узла. |
| DeactivateNode |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для деактивации узла. |
| DeactivateNodesBatch |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для деактивации нескольких узлов. |
| RemoveNodeDeactivations |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для отмены деактивации нескольких узлов. |
| GetNodeDeactivationStatus |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для проверки состояния деактивации. |
| NodeStateRemoved |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для отправки сообщения об удалении узла. |
| RecoverPartition |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для восстановления раздела. |
| RecoverPartitions |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для восстановления разделов. |
| RecoverServicePartitions |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для восстановления разделов службы. |
| RecoverSystemPartitions |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для восстановления разделов системной службы. |
| ReportFault |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для отправки сообщения об ошибке. |
| InvokeInfrastructureCommand |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для команд управления задачами инфраструктуры. |
| FileContent |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для передачи клиентского файла хранилища образов (вне кластера). |
| FileDownload |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для инициации скачивания клиентского файла хранилища образов (вне кластера). |
| InternalList |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для операции вывода списка клиентских файлов хранилища образов (внутренняя). |
| Delete |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для операции удаления клиента хранилища образов. |
| Отправить |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для операции передачи клиента хранилища образов. |
| GetStagingLocation |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для получения промежуточного расположения клиента хранилища образов. |
| GetStoreLocation |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для получения расположения хранилища клиента хранилища образов. |
| NodeControl |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для запуска, остановки и перезапуска узлов. |
| CodePackageControl |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для перезапуска пакетов кода. |
| UnreliableTransportControl |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Ненадежный транспорт для добавления и удаления поведения. |
| MoveReplicaControl |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Перемещение реплики. |
| PredeployPackageToNode |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | API предварительного развертывания. |
| StartPartitionDataLoss |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Приводит к потере данных в разделе. |
| StartPartitionQuorumLoss |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Приводит к потере кворума в разделе. |
| StartPartitionRestart |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Одновременно перезапускает некоторые или все реплики раздела. |
| CancelTestCommand |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Отменяет определенную тестовую команду, если она выполняется. |
| StartChaos |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Запускает Chaos, если он еще не запущен. |
| StopChaos |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Останавливает Chaos, если он уже запущен. |
| StartNodeTransition |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Настройка безопасности для запуска перехода узла. |
| StartClusterConfigurationUpgrade |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Вызывает обновление конфигурации запуска кластера в разделе. |
| GetUpgradesPendingApproval |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Приводит к ожиданию утверждения получения обновлений в разделе. |
| StartApprovedUpgrades |Строка символов в кодировке Юникод, по умолчанию — L"Admin" | Приводит к запуску утвержденных обновлений в разделе. |
| Проверка связи |Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Настройка безопасности для проверок связи клиента. |
| Запрос |Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Настройка безопасности для запросов. |
| NameExists |Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Настройка безопасности для проверок существования универсального кода ресурса (URI) именования. |
| EnumerateSubnames |Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Настройка безопасности для перечисления универсального кода ресурса (URI) именования. |
| EnumerateProperties |Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Настройка безопасности для перечисления свойств именования. |
| PropertyReadBatch |Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Настройка безопасности для операции чтения свойств именования. |
| GetServiceDescription |Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Настройка безопасности для уведомлений служб с длительным временем опроса и чтение описаний служб. |
| ResolveService |Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Настройка безопасности для разрешения служб на основе жалоб. |
| ResolveNameOwner |Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Настройка безопасности для разрешения владельца универсального кода ресурса (URI) именования. |
| ResolvePartition |Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Настройка безопасности для разрешения системных служб. |
| ServiceNotifications |Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Настройка безопасности для уведомлений служб на основе событий. |
| PrefixResolveService |Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Настройка безопасности для разрешения префикса служб на основе жалоб. |
| GetUpgradeStatus |Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Настройка безопасности для опроса состояния обновления приложения. |
| GetFabricUpgradeStatus |Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Настройка безопасности для опроса состояния обновления кластера. |
| InvokeInfrastructureQuery |Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Настройка безопасности для запроса задач инфраструктуры. |
| список |Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Настройка безопасности для операции вывода списка клиентских файлов хранилища образов. |
| ResetPartitionLoad |Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Настройка безопасности для сброса нагрузки на единицу отработки отказа. |
| ToggleVerboseServicePlacementHealthReporting | Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Настройка безопасности для включения и выключения подробных отчетов о работоспособности размещения службы. |
| GetPartitionDataLossProgress | Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Получает сведения о ходе выполнения вызова API потери данных. |
| GetPartitionQuorumLossProgress | Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Получает сведения о ходе выполнения вызова API потери кворума. |
| GetPartitionRestartProgress | Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Получает сведения о ходе выполнения вызова API перезапуска раздела. |
| GetChaosReport | Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Получает сведения о состоянии Chaos в определенный диапазон времени. |
| GetNodeTransitionProgress | Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Настройка безопасности для получения сведений о ходе выполнения команды перехода узла. |
| GetClusterConfigurationUpgradeStatus | Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Вызывает получение сведений о состоянии обновления конфигурации кластера в разделе. |
| GetClusterConfiguration | Строка символов в кодировке Юникод, по умолчанию — L"Admin\|\|User" | Вызывает получение конфигурации кластера в разделе. |
...
|InBuildThrottlingAssociatedMetric | Строка символов в кодировке Юникод, по умолчанию — L"" | Имя метрики, связанной с этим регулированием. |
...
|SwapPrimaryThrottlingAssociatedMetric | Строка символов в кодировке Юникод, по умолчанию — L""| Имя метрики, связанной с этим регулированием. |
...
|PlacementConstraints | Строка символов в кодировке Юникод, по умолчанию — L"" |Ограничения на размещения для диспетчера кластеров. |
...
|InfrastructureTaskHealthCheckStableDuration | Время в секундах, по умолчанию — 0| Временной диапазон в секундах. Промежуток времени для отслеживания последовательно переданных проверок работоспособности перед завершением постобработки задачи инфраструктуры. При обнаружении неудачной проверки работоспособности таймер сбрасывается. |
