...
| **Параметр** | **Допустимые значения** | **Рекомендация или краткое описание** |
| --- | --- | --- |
| UpgradeDomainId |Wstring, значение по умолчанию — "". |Описывает домен обновления, к которому принадлежит узел. |
...
| ClusterX509StoreName |Wstring, значение по умолчанию — "My". |Имя хранилища сертификатов X.509, в котором содержится сертификат кластера, используемый для защиты передачи данных внутри кластера. |
| ClusterX509FindType |Wstring, значение по умолчанию — "FindByThumbprint". |Указывает, как найти сертификат кластера в хранилище с использованием поддерживаемых значений параметра ClusterX509StoreName (FindByThumbprint, FindBySubjectName, FindBySubjectName). При наличии нескольких совпадений используется сертификат с самым поздним временем окончания срока действия. |
| ClusterX509FindValue |Wstring, значение по умолчанию — "". |Значение фильтра поиска, используемое для поиска сертификата кластера. |
| ClusterX509FindValueSecondary |Wstring, значение по умолчанию — "". |Значение фильтра поиска, используемое для поиска сертификата кластера. |
| ServerAuthX509StoreName |Wstring, значение по умолчанию — "My". |Имя хранилища сертификатов X.509, в котором содержится сертификат сервера для входа в службу. |
| ServerAuthX509FindType |Wstring, значение по умолчанию — "FindByThumbprint". |Указывает, как найти сертификат сервера в хранилище с использованием поддерживаемых значений параметра ServerAuthX509StoreName (FindByThumbprint, FindBySubjectName). |
| ServerAuthX509FindValue |Wstring, значение по умолчанию — "". |Значение фильтра поиска, используемое для поиска сертификата сервера. |
| ServerAuthX509FindValueSecondary |Wstring, значение по умолчанию — "". |Значение фильтра поиска, используемое для поиска сертификата сервера. |
| ClientAuthX509StoreName |Wstring, значение по умолчанию — "My". |Имя хранилища сертификатов X.509, в котором содержится сертификат для роли администратора FabricClient по умолчанию. |
| ClientAuthX509FindType |Wstring, значение по умолчанию — "FindByThumbprint". |Указывает, как найти сертификат в хранилище с использованием поддерживаемых значений параметра ClientAuthX509StoreName (FindByThumbprint, FindBySubjectName). |
| ClientAuthX509FindValue |Wstring, значение по умолчанию — "". | Значение фильтра поиска, используемое для поиска сертификата роли администратора FabricClient по умолчанию. |
| ClientAuthX509FindValueSecondary |Wstring, значение по умолчанию — "". |Значение фильтра поиска, используемое для поиска сертификата роли администратора FabricClient по умолчанию. |
| UserRoleClientX509StoreName |Wstring, значение по умолчанию — "My". |Имя хранилища сертификатов X.509, в котором содержится сертификат роли пользователя FabricClient по умолчанию. |
| UserRoleClientX509FindType |Wstring, значение по умолчанию — "FindByThumbprint". |Указывает, как найти сертификат в хранилище с использованием поддерживаемых значений параметра UserRoleClientX509StoreName (FindByThumbprint, FindBySubjectName). |
| UserRoleClientX509FindValue |Wstring, значение по умолчанию — "". |Значение фильтра поиска, используемое для поиска сертификата роли пользователя FabricClient по умолчанию. |
| UserRoleClientX509FindValueSecondary |Wstring, значение по умолчанию — "". |Значение фильтра поиска, используемое для поиска сертификата роли пользователя FabricClient по умолчанию. |

### <a name="section-name-paas"></a>Имя раздела: Paas
| **Параметр** | **Допустимые значения** | **Рекомендация или краткое описание** |
| --- | --- | --- |
| ClusterId |Wstring, значение по умолчанию — "". |Хранилище сертификатов X509, используемое Fabric для защиты конфигурации. |
...
|PlacementConstraints | Wstring, значение по умолчанию — "". | Ограничение размещения для службы именования. |
...
| **Параметр** | **Допустимые значения** | **Рекомендация или краткое описание** |
| --- | --- | --- |
| RunAsAccountName |Wstring, значение по умолчанию — "". |Указывает имя учетной записи запуска от имени. Требуется только для учетной записи типа DomainUser или ManagedServiceAccount. Допустимые значения: "domain\user" или "user@domain". |
|RunAsAccountType|Wstring, значение по умолчанию — "". |Указывает тип учетной записи запуска от имени. Требуется для любого допустимого значения раздела RunAs (DomainUser, NetworkService, ManagedServiceAccount, LocalSystem).|
|RunAsPassword|Wstring, значение по умолчанию — "". |Указывает пароль учетной записи запуска от имени. Требуется только для учетной записи типа DomainUser. |

### <a name="section-name-runasfabric"></a>Имя раздела: RunAs_Fabric
| **Параметр** | **Допустимые значения** | **Рекомендация или краткое описание** |
| --- | --- | --- |
| RunAsAccountName |Wstring, значение по умолчанию — "". |Указывает имя учетной записи запуска от имени. Требуется только для учетной записи типа DomainUser или ManagedServiceAccount. Допустимые значения: "domain\user" или "user@domain". |
|RunAsAccountType|Wstring, значение по умолчанию — "". |Указывает тип учетной записи запуска от имени. Требуется для любого допустимого значения раздела RunAs (LocalUser, DomainUser, NetworkService, ManagedServiceAccount, LocalSystem). |
|RunAsPassword|Wstring, значение по умолчанию — "". |Указывает пароль учетной записи запуска от имени. Требуется только для учетной записи типа DomainUser. |
...
|SharedLogPath |Wstring, значение по умолчанию — "". | Имя файла и путь к расположению, где требуется разместить контейнер общего журнала. Укажите значение "", чтобы использовать расположение по умолчанию в корневой папке данных Service Fabric. |
|SharedLogId |Wstring, значение по умолчанию — "". |Глобальный уникальный идентификатор контейнера общего журнала. Укажите значение "", если используется расположение по умолчанию в корневой папке данных Service Fabric. |
...
|GatewayAuthCredentialType |Wstring, значение по умолчанию — "None". | Указывает тип учетных данных, используемых для безопасного доступа к конечной точке HTTP-шлюза приложения. Допустимое значение: None/X509. |
|GatewayX509CertificateStoreName |Wstring, значение по умолчанию — "My". | Имя хранилища сертификатов X.509, в котором содержится сертификат HTTP-шлюза приложения. |
|GatewayX509CertificateFindType |Wstring, значение по умолчанию — "FindByThumbprint". | Указывает, как найти сертификат в хранилище с использованием поддерживаемых значений параметра GatewayX509CertificateStoreName (FindByThumbprint, FindBySubjectName). |
|GatewayX509CertificateFindValue | Wstring, значение по умолчанию — "". | Значение фильтра поиска, используемое для поиска сертификата HTTP-шлюза приложения. Этот сертификат настроен в конечной точке HTTPS, и при необходимости может также использоваться для проверки удостоверения приложения в службах. Сначала выполняется поиск параметра FindValue, а если он отсутствует, — FindValueSecondary. |
|GatewayX509CertificateFindValueSecondary | Wstring, значение по умолчанию — "". |Значение фильтра поиска, используемое для поиска сертификата HTTP-шлюза приложения. Этот сертификат настроен в конечной точке HTTPS, и при необходимости может также использоваться для проверки удостоверения приложения в службах. Сначала выполняется поиск параметра FindValue, а если он отсутствует, — FindValueSecondary.|
...
| PlacementConstraints | Wstring, значение по умолчанию — "".| Ограничения на размещения для службы анализа сбоев. |
...
| PrimaryAccountType | Wstring, значение по умолчанию — "". |Тип основной учетной записи субъекта, используемой для внесения общих папок службы хранилища файлов в список управления доступом. |
| PrimaryAccountUserName | Wstring, значение по умолчанию — "". |Имя пользователя основной учетной записи субъекта, используемой для внесения общих папок службы хранилища файлов в список управления доступом. |
...
| PrimaryAccountNTLMX509StoreLocation | Wstring, значение по умолчанию — "LocalMachine".| Расположение хранилища сертификатов X509, используемых для создания HMAC в секрете пароля основной учетной записи при использовании проверки подлинности NTLM. |
| PrimaryAccountNTLMX509StoreName | Wstring, значение по умолчанию — "MY".| Имя хранилища сертификатов X509, используемых для создания HMAC в секрете пароля основной учетной записи при использовании проверки подлинности NTLM. |
| PrimaryAccountNTLMX509Thumbprint | Wstring, значение по умолчанию — "".|Отпечаток хранилища сертификатов X509, используемых для создания HMAC в секрете пароля основной учетной записи при использовании проверки подлинности NTLM. |
| SecondaryAccountType | Wstring, значение по умолчанию — "".| Тип дополнительной учетной записи субъекта, используемой для внесения общих папок службы хранилища файлов в список управления доступом. |
| SecondaryAccountUserName | Wstring, значение по умолчанию — "".| Имя пользователя дополнительной учетной записи субъекта, используемой для внесения общих папок службы хранилища файлов в список управления доступом. |
...
| SecondaryAccountNTLMX509StoreLocation | Wstring, значение по умолчанию — "LocalMachine". |Расположение хранилища сертификатов X509, используемых для создания HMAC в секрете пароля дополнительной учетной записи при использовании проверки подлинности NTLM. |
| SecondaryAccountNTLMX509StoreName | Wstring, значение по умолчанию — "MY". |Имя хранилища сертификатов X509, используемых для создания HMAC в секрете пароля дополнительной учетной записи при использовании проверки подлинности NTLM. |
| SecondaryAccountNTLMX509Thumbprint | Wstring, значение по умолчанию — "".| Отпечаток хранилища сертификатов X509, используемых для создания HMAC в секрете пароля дополнительной учетной записи при использовании проверки подлинности NTLM. |
...
| PlacementConstraints | Wstring, значение по умолчанию — "". | Ограничения на размещения для службы хранилища образов. |
...
| **Параметр** | **Допустимые значения** | **Рекомендация или краткое описание** |
| --- | --- | --- |
| Поставщики |Wstring, значение по умолчанию — "DSTS". |Разделенный запятыми список поставщиков проверки токенов, которых можно включить (допустимые поставщики: DSTS, AAD). Сейчас в любое время может быть включен только один поставщик. |
...
| PlacementConstraints | Wstring, значение по умолчанию — "". | Ограничения на размещения для службы управления обновлениями. |
...
| **Параметр** | **Допустимые значения** | **Рекомендация или краткое описание** |
| --- | --- | --- |
| PlacementConstraints |Wstring, значение по умолчанию — "". |Ограничения на размещения для службы обновления. |
...
| CoordinatorType | Wstring, значение по умолчанию — "WUTest".| Тип координатора службы обновления. |
| BaseUrl | Wstring, значение по умолчанию — "". |Базовый URL-адрес службы обновления. |
| ClusterId | Wstring, значение по умолчанию — "". | Идентификатор кластера службы обновления. |
| X509StoreName | Wstring, значение по умолчанию — "My".| Имя хранилища X509 службы обновления. |
| X509StoreLocation | Wstring, значение по умолчанию — "". | Расположение хранилища X509 службы обновления. |
| X509FindType | Wstring, значение по умолчанию — "".| Тип поиска сертификата X509 службы обновления. |
| X509FindValue | Wstring, значение по умолчанию — "". | Значение поиска сертификата X509 службы обновления. |
| X509SecondaryFindValue | Wstring, значение по умолчанию — "". | Дополнительное значение поиска сертификата X509 службы обновления. |
| OnlyBaseUpgrade | Логическое значение, по умолчанию — false | Только базовое обновление службы обновления. |
| TestCabFolder | Wstring, значение по умолчанию — "". | Папка с CAB-файлом теста для службы обновления. |

### <a name="section-name-securityclientaccess"></a>Имя раздела: Security/ClientAccess
| **Параметр** | **Допустимые значения** | **Рекомендация или краткое описание** |
| --- | --- | --- |
| CreateName |Wstring, значение по умолчанию — "Admin". |Настройка безопасности для создания универсального кода ресурса (URI) именования. |
| DeleteName |Wstring, значение по умолчанию — "Admin". |Настройка безопасности для удаления универсального кода ресурса (URI) именования. |
| PropertyWriteBatch |Wstring, значение по умолчанию — "Admin". |Настройка безопасности для операций записи свойств именования. |
| CreateService |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для создания службы. |
| CreateServiceFromTemplate |Wstring, значение по умолчанию — "Admin". |Настройка безопасности для создания службы на основе шаблона. |
| UpdateService |Wstring, значение по умолчанию — "Admin". |Настройка безопасности для обновлений службы. |
| DeleteService  |Wstring, значение по умолчанию — "Admin". |Настройка безопасности для удаления службы. |
| ProvisionApplicationType |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для подготовки типа приложения. |
| CreateApplication |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для создания приложения. |
| DeleteApplication |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для удаления приложения. |
| UpgradeApplication |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для запуска или прерывания обновлений приложения. |
| RollbackApplicationUpgrade |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для отката обновлений приложения. |
| UnprovisionApplicationType |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для отмены подготовки типа приложения. |
| MoveNextUpgradeDomain |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для возобновления обновлений приложения с помощью явного домена обновления. |
| ReportUpgradeHealth |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для возобновления обновлений приложения с помощью текущего процесса обновления. |
| ReportHealth |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для отправки сведений о работоспособности. |
| ProvisionFabric |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для подготовки MSI и (или) манифеста кластера. |
| UpgradeFabric |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для запуска обновлений кластера. |
| RollbackFabricUpgrade |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для отката обновлений кластера. |
| UnprovisionFabric |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для отмены подготовки MSI и (или) манифеста кластера. |
| MoveNextFabricUpgradeDomain |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для возобновления обновлений кластера с помощью явного домена обновления. |
| ReportFabricUpgradeHealth |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для возобновления обновлений кластера с помощью текущего процесса обновления. |
| StartInfrastructureTask |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для запуска задач инфраструктуры. |
| FinishInfrastructureTask |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для завершения задач инфраструктуры. |
| ActivateNode |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для активации узла. |
| DeactivateNode |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для деактивации узла. |
| DeactivateNodesBatch |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для деактивации нескольких узлов. |
| RemoveNodeDeactivations |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для отмены деактивации нескольких узлов. |
| GetNodeDeactivationStatus |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для проверки состояния деактивации. |
| NodeStateRemoved |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для отправки сообщения об удалении узла. |
| RecoverPartition |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для восстановления раздела. |
| RecoverPartitions |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для восстановления разделов. |
| RecoverServicePartitions |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для восстановления разделов службы. |
| RecoverSystemPartitions |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для восстановления разделов системной службы. |
| ReportFault |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для отправки сообщения об ошибке. |
| InvokeInfrastructureCommand |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для команд управления задачами инфраструктуры. |
| FileContent |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для передачи клиентского файла хранилища образов (вне кластера). |
| FileDownload |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для инициации скачивания клиентского файла хранилища образов (вне кластера). |
| InternalList |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для операции вывода списка клиентских файлов хранилища образов (внутренняя). |
| Удалить |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для операции удаления клиента хранилища образов. |
| Отправить |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для операции передачи клиента хранилища образов. |
| GetStagingLocation |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для получения промежуточного расположения клиента хранилища образов. |
| GetStoreLocation |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для получения расположения хранилища клиента хранилища образов. |
| NodeControl |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для запуска, остановки и перезапуска узлов. |
| CodePackageControl |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для перезапуска пакетов кода. |
| UnreliableTransportControl |Wstring, значение по умолчанию — "Admin". | Ненадежный транспорт для добавления и удаления поведения. |
| MoveReplicaControl |Wstring, значение по умолчанию — "Admin". | Перемещение реплики. |
| PredeployPackageToNode |Wstring, значение по умолчанию — "Admin". | API предварительного развертывания. |
| StartPartitionDataLoss |Wstring, значение по умолчанию — "Admin". | Приводит к потере данных в разделе. |
| StartPartitionQuorumLoss |Wstring, значение по умолчанию — "Admin". | Приводит к потере кворума в разделе. |
| StartPartitionRestart |Wstring, значение по умолчанию — "Admin". | Одновременно перезапускает некоторые или все реплики раздела. |
| CancelTestCommand |Wstring, значение по умолчанию — "Admin". | Отменяет определенную тестовую команду, если она выполняется. |
| StartChaos |Wstring, значение по умолчанию — "Admin". | Запускает Chaos, если он еще не запущен. |
| StopChaos |Wstring, значение по умолчанию — "Admin". | Останавливает Chaos, если он уже запущен. |
| StartNodeTransition |Wstring, значение по умолчанию — "Admin". | Настройка безопасности для запуска перехода узла. |
| StartClusterConfigurationUpgrade |Wstring, значение по умолчанию — "Admin". | Вызывает обновление конфигурации запуска кластера в разделе. |
| GetUpgradesPendingApproval |Wstring, значение по умолчанию — "Admin". | Приводит к ожиданию утверждения получения обновлений в разделе. |
| StartApprovedUpgrades |Wstring, значение по умолчанию — "Admin". | Приводит к запуску утвержденных обновлений в разделе. |
| Проверка связи |Wstring, значение по умолчанию — "Admin\".|\|User" | Настройка безопасности для проверок связи клиента. |
| Запрос |Wstring, значение по умолчанию — "Admin\".|\|User" | Настройка безопасности для запросов. |
| NameExists |Wstring, значение по умолчанию — "Admin\".|\|User" | Настройка безопасности для проверок существования универсального кода ресурса (URI) именования. |
| EnumerateSubnames |Wstring, значение по умолчанию — "Admin\".|\|User" | Настройка безопасности для перечисления универсального кода ресурса (URI) именования. |
| EnumerateProperties |Wstring, значение по умолчанию — "Admin\".|\|User" | Настройка безопасности для перечисления свойств именования. |
| PropertyReadBatch |Wstring, значение по умолчанию — "Admin\".|\|User" | Настройка безопасности для операции чтения свойств именования. |
| GetServiceDescription |Wstring, значение по умолчанию — "Admin\".|\|User" | Настройка безопасности для уведомлений служб с длительным временем опроса и чтение описаний служб. |
| ResolveService |Wstring, значение по умолчанию — "Admin\".|\|User" | Настройка безопасности для разрешения служб на основе жалоб. |
| ResolveNameOwner |Wstring, значение по умолчанию — "Admin\".|\|User" | Настройка безопасности для разрешения владельца универсального кода ресурса (URI) именования. |
| ResolvePartition |Wstring, значение по умолчанию — "Admin\".|\|User" | Настройка безопасности для разрешения системных служб. |
| ServiceNotifications |Wstring, значение по умолчанию — "Admin\".|\|User" | Настройка безопасности для уведомлений служб на основе событий. |
| PrefixResolveService |Wstring, значение по умолчанию — "Admin\".|\|User" | Настройка безопасности для разрешения префикса служб на основе жалоб. |
| GetUpgradeStatus |Wstring, значение по умолчанию — "Admin\".|\|User" | Настройка безопасности для опроса состояния обновления приложения. |
| GetFabricUpgradeStatus |Wstring, значение по умолчанию — "Admin\".|\|User" | Настройка безопасности для опроса состояния обновления кластера. |
| InvokeInfrastructureQuery |Wstring, значение по умолчанию — "Admin\".|\|User" | Настройка безопасности для запроса задач инфраструктуры. |
| список |Wstring, значение по умолчанию — "Admin\".|\|User" | Настройка безопасности для операции вывода списка клиентских файлов хранилища образов. |
| ResetPartitionLoad |Wstring, значение по умолчанию — "Admin\".|\|User" | Настройка безопасности для сброса нагрузки на единицу отработки отказа. |
| ToggleVerboseServicePlacementHealthReporting | Wstring, значение по умолчанию — "Admin\".|\|User" | Настройка безопасности для включения и выключения подробных отчетов о работоспособности размещения службы. |
| GetPartitionDataLossProgress | Wstring, значение по умолчанию — "Admin\".|\|User" | Получает сведения о ходе выполнения вызова API потери данных. |
| GetPartitionQuorumLossProgress | Wstring, значение по умолчанию — "Admin\".|\|User" | Получает сведения о ходе выполнения вызова API потери кворума. |
| GetPartitionRestartProgress | Wstring, значение по умолчанию — "Admin\".|\|User" | Получает сведения о ходе выполнения вызова API перезапуска раздела. |
| GetChaosReport | Wstring, значение по умолчанию — "Admin\".|\|User" | Получает сведения о состоянии Chaos в определенный диапазон времени. |
| GetNodeTransitionProgress | Wstring, значение по умолчанию — "Admin\".|\|User" | Настройка безопасности для получения сведений о ходе выполнения команды перехода узла. |
| GetClusterConfigurationUpgradeStatus | Wstring, значение по умолчанию — "Admin\".|\|User" | Вызывает получение сведений о состоянии обновления конфигурации кластера в разделе. |
| GetClusterConfiguration | Wstring, значение по умолчанию — "Admin\".|\|User" | Вызывает получение конфигурации кластера в разделе. |
...
|InBuildThrottlingAssociatedMetric | Wstring, значение по умолчанию — "". | Имя метрики, связанной с этим регулированием. |
...
|SwapPrimaryThrottlingAssociatedMetric | Wstring, значение по умолчанию — "".| Имя метрики, связанной с этим регулированием. |
...
|PlacementConstraints | Wstring, значение по умолчанию — "". |Ограничения на размещения для диспетчера кластеров. |
