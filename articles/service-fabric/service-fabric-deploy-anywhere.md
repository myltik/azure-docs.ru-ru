...
# Создание кластеров Service Fabric в Windows Server или Linux
...
##Создание кластеров Service Fabric в Azure
...
## Поддерживаемые операционные системы для кластеров в Azure
...
##Создание автономных кластеров Service Fabric локально или у другого поставщика облачных служб
