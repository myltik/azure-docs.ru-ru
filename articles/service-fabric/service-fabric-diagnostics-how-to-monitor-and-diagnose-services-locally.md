...
3. Создайте (или откройте) проект службы или субъекта с отслеживанием или без отслеживания состояния.

  ![Создание приложения Service Fabric](./media/service-fabric-diagnostics-how-to-monitor-and-diagnose-services-locally/CreateServiceFabricProject.png)

  ![Создание службы Service Fabric](./media/service-fabric-diagnostics-how-to-monitor-and-diagnose-services-locally/CreateServiceFabricProject-2.png)

4. Нажмите клавишу F5 для запуска отладки приложения. События Service Fabric должны отобразиться в окне «События диагностики». Стандартные метаданные события включают сведения об исходных узле, приложении и службе. События в списке событий можно фильтровать (например, по имени узла или службы), используя поле фильтра в верхней части окна.
