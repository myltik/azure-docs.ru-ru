...
## <a name="the-benefits-of-event-tracing-for-windows"></a>Преимущества трассировки событий Windows
[трассировки событий Windows](https://msdn.microsoft.com/library/windows/desktop/bb968803.aspx) (ETW). На это есть несколько причин:
