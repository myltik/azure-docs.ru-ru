...
## <a name="install-the-necessary-java-artifacts-on-vagrant-optional-if-you-want-to-use-the-java-programming-models"></a>Установка необходимых артефактов Java в Vagrant (необязательно, если вы планируете использовать модели программирования Java)
