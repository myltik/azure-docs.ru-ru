...
---
<a id="configure-stateful-reliable-services" class="xliff"></a>
...
В Azure ARM или в локальном шаблоне JSON выполните приведенный ниже пример, позволяющий изменить общий журнал транзакций, который создается для хранения резервных копий надежных коллекций для служб с отслеживанием состояния.
...
<a id="sample-local-developer-cluster-manifest-section" class="xliff"></a>
...
<a id="service-specific-configuration" class="xliff"></a>
...
<a id="default-section-name" class="xliff"></a>
...
<a id="sample-configuration-via-code" class="xliff"></a>
