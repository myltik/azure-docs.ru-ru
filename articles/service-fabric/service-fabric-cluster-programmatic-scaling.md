...
Имейте в виду, что в случае с *начальными* узлами не всегда выполняется правило, в соответствии с которым первыми удаляются экземпляры с большим значением идентификатора.
