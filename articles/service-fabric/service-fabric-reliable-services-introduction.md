...
Надежные службы являются одной из моделей программирования, доступных в Service Fabric. Дополнительные сведения о модели программирования надежных субъектов см. во [введении](../service-fabric/service-fabric-reliable-actors-introduction.md).
...
3. После создания CommunicationListener открывается
  + Объекты CommunicationListener содержат метод Open(), который вызывается на этом этапе и возвращает адрес прослушивания для службы. Если в вашей надежной службе используется один из встроенных интерфейсов ICommunicationListener, эта обработка выполняется автоматически.
