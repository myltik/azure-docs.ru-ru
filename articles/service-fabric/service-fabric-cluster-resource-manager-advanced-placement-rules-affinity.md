...
* Большинство задач, для которых используется сходство, например работа служб на небольшом количестве компьютеров или сбор информации о нагрузке в коллекции служб, зачастую проще решить с помощью групп приложений. См. статью [Введение в группы приложений](service-fabric-cluster-resource-manager-application-groups.md).
