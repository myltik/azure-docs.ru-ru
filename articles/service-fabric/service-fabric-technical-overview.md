...
**Служба диспетчера отработки отказов (FM)** — на каждом кластере Service Fabric имеется служба диспетчера отработки отказов, которая отвечает за выполнение функций, связанных с обеспечением высокой доступности и согласованности служб, а также за обновление приложений и кластера и взаимодействие с другими компонентами системы.
