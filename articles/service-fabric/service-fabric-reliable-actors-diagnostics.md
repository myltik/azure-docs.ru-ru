...
Среда выполнения надежных субъектов генерирует следующие события, связанные с [методами субъектов](service-fabric-reliable-actors-introduction.md#actors).
...
Среда выполнения надежных субъектов генерирует следующие события, связанные с [параллелизмом](service-fabric-reliable-actors-introduction.md#concurrency).
...
Среда выполнения надежных субъектов генерирует следующие события, связанные с [управлением состояниями субъектов](service-fabric-reliable-actors-introduction.md#actor-state-management).
...
Среда выполнения надежных субъектов генерирует следующие события, связанные с [экземплярами субъектов без отслеживания состояния](service-fabric-reliable-actors-platform.md#service-fabric-partition-concepts-for-stateless-actors).
...
Среда выполнения надежных субъектов генерирует следующие события, связанные с [репликами субъектов с отслеживанием состояния](service-fabric-reliable-actors-platform.md#service-fabric-partition-concepts-for-stateful-actors).
...
Среда выполнения надежных субъектов генерирует следующие события, связанные с [активацией и деактивацией субъектов](service-fabric-reliable-actors-lifecycle.md).
