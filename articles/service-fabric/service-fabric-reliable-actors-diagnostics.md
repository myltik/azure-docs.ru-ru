...
|0x4|Набор событий, связанных с состоянием субъекта. Дополнительные сведения см. в разделах, посвященных [субъектам с отслеживанием состояния](service-fabric-reliable-actors-introduction.md#stateful-actors).|
...
Среда выполнения Reliable Actors генерирует следующие события, связанные с [управлением состояниями субъектов](service-fabric-reliable-actors-introduction.md#actor-state-management).
...
Среда выполнения Reliable Actors генерирует следующие события, связанные с [экземплярами субъектов без отслеживания состояния](service-fabric-reliable-actors-platform.md#service-fabric-partition-concepts-for-stateless-actors).
...
Среда выполнения Reliable Actors генерирует следующие события, связанные с [репликами субъектов с отслеживанием состояния](service-fabric-reliable-actors-platform.md#service-fabric-partition-concepts-for-stateful-actors).
