...
- Диспетчер кластерных ресурсов работает с функциями управления Service Fabric. Чтобы узнать больше об этой интеграции, читайте [эту статью](service-fabric-cluster-resource-manager-management-integration.md).
