...
В будущем мы реализуем поддержку политики обновления ОС, скоординированной между доменами обновления, которая гарантирует, что доступность сохранится несмотря на перезагрузки и другие непредвиденные сбои.

В настоящее время есть только одна безопасная возможность — выполнить обновление ОС вручную, по одному узлу за раз.
