...
- Нельзя сравнивать секционированные службы. У каждой службы должна быть схема секционирования FABRIC_PARTITION_SCHEME_SINGLETON.
...
```
В этом примере кода показаны определения служб по умолчанию (DefaultServices) в манифесте приложения. ``` xml
<DefaultServices>
