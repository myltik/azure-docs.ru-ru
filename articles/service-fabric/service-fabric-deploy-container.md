<properties
   pageTitle="Service Fabric и развертывание контейнеров | Microsoft Azure"
...
# Предварительная версия: развертывание контейнера в Service Fabric
...
>[AZURE.NOTE] В будущих версиях может быть добавлена поддержка ограничений на определенные параметры блочного ввода-вывода, например на количество операций ввода-вывода, скорость чтения/записи и т. п.
...
## Полные примеры манифестов для приложения и службы
