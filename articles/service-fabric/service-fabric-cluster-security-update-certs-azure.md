...
![Снимок экрана: раздел отпечатков сертификатов на портале][SecurityConfigurations\_02]
...
! [Снимок экрана выполняемого развертывания сертификата] [SecurityConfigurations\_03]

Ниже приведен снимок экрана колонки безопасности после завершения развертывания.

![Снимок экрана отпечатков сертификата после развертывания][SecurityConfigurations\_08]
