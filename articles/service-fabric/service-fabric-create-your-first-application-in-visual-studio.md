...
## Очистка.
  ...
  Прежде чем завершить работу, важно помнить, что локальный кластер работает по-настоящему. Если остановить работу отладчика, экземпляр приложения будет удален, а регистрация типа приложения — отменена. Но кластер будет продолжать работать в фоновом режиме. Вы можете выбрать один из вариантов управления этими приложениями.
