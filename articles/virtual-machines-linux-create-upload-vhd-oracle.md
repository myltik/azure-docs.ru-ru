<properties urlDisplayName="Upload an Oracle Linux VHD" pageTitle="Создание и передача виртуального жесткого диска с ОС Oracle Linux в Azure" metaKeywords="Azure VHD, uploading Linux VHD, Oracle Linux" description="Узнайте, как создать и передать виртуальный жесткий диск (VHD-файл) Azure, содержащий операционную систему Oracle Linux." metaCanonical="" services="virtual-machines" documentationCenter="" title="Создание и передача виртуального жесткого диска с операционной системой Oracle Linux" authors="kathydav" solutions="" manager="timlt" editor="tysonn" />
...
-   [Подготовка виртуальной машины Oracle Linux 6.4+ для Azure][Подготовка виртуальной машины Oracle Linux 6.4+ для Azure]
-   [Подготовка виртуальной машины Oracle Linux 7.0+ для Azure][Подготовка виртуальной машины Oracle Linux 7.0+ для Azure]

## Предварительные требования

В этой статье предполагается, что вы уже установили операционную систему Oracle Linux на виртуальный жесткий диск. Для создания VHD-файлов существует несколько средств, например решение виртуализации, такое как Hyper-V. Инструкции см. в разделе [Установка роли Hyper-V и настройка виртуальной машины][Установка роли Hyper-V и настройка виртуальной машины].
...
15. В диспетчере Hyper-V выберите **Действие -\> Завершение работы**. Виртуальный жесткий диск Linux готов к передаче в Azure.
  ...
  [Подготовка виртуальной машины Oracle Linux 6.4+ для Azure]: #oracle6
  [Подготовка виртуальной машины Oracle Linux 7.0+ для Azure]: #oracle7
