...
Управление доступом на основе ролей (RBAC) Azure обеспечивает точное управление доступом для планировщика Azure. Чтобы узнать, как использовать вкладку "Пользователи", см. статью [Управление доступом на основе ролей в Azure](../active-directory/role-based-access-control-configure.md).
