...
Планировщик Azure позволяет описывать действия, которые выполняются в облаке.  Затем он планирует и выполняет эти действия автоматически.  Планировщик хранит журнал результатов выполнения задания, который можно просмотреть.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>PowerShell</h3>
                        <p>Командлеты PowerShell планировщика Azure</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>.NET</h3>
                        <p>Управляемый справочник по планировщику</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p>Справочник по REST API планировщика</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="downloadHolder">
    <a href="https://opbuildstorageprod.blob.core.windows.net/output-pdf-files/en-us/Azure.azure-documents/live/scheduler.pdf">
        <div class="img"></div>
        <div class="text">
Скачать документацию по планировщику </div>
    </a>
</div>
