...
Пользоваться планировщиком Azure можно через пользовательский интерфейс практически в любом географическом регионе, который входит в систему Azure на сегодняшний день. Список регионов, в которых доступен планировщик Azure, см. [здесь](http://azure.microsoft.com/regions/#services). Если центр обработки данных в регионе размещения отображается как недоступный, услуги планировщика Azure может предоставить другой центр обработки данных.
...
Например, если задание создано в Южно-Центральной части США, планировщик Azure обеспечивает его автоматическую репликацию в Северо-Центральной части США. В случае сбоя в Южно-Центральной части США планировщик Azure гарантирует выполнение задания из Северо-Центральной части США. [Список связанных регионов Azure см. по этой ссылке](https://msdn.microsoft.com/library/azure/dn758204.aspx).
