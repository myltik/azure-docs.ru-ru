...
|**P10 Премиум**|50 заданий в коллекции|Один раз в минуту. Не позволяет выполнять задания чаще одного раза в минуту.|Подписка может включать до 10 000 коллекций заданий "P10 Премиум". <a href="mailto:wapteams@microsoft.com">Свяжитесь с нами</a> для получения дополнительных сведений.|Доступен весь набор функций планировщика.|
|**P20 Премиум**|1000 заданий в коллекции|Один раз в минуту. Не позволяет выполнять задания чаще одного раза в минуту.|Подписка может включать в себя до 10 000 коллекций заданий P20 уровня "Премиум". <a href="mailto:wapteams@microsoft.com">Свяжитесь с нами</a> для получения дополнительных сведений.|Доступен весь набор функций планировщика.|
...
Оплачиваемая единица уровня P10 "Премиум" может включать в себя до 10 000 коллекций заданий уровня P10 "Премиум". Так как коллекция заданий уровня P10 "Премиум" может содержать до 50 заданий, то одна оплачиваемая единица уровня "Премиум" позволяет включить в подписку до 500 000 заданий, что означает почти 22 миллиарда выполненных заданий в месяц.
...
Оплачиваемая единица уровня P20 "Премиум" может включать в себя до 5 000 коллекций заданий уровня P20 "Премиум". Так как коллекция заданий уровня P20 "Премиум" может содержать до 1000 заданий, то одна оплачиваемая единица уровня "Премиум" позволяет включить в подписку до 5 000 000 заданий, что означает почти 220 миллиардов выполненных заданий в месяц.
