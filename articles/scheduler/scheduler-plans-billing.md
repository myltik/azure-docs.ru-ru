...
|**Премиальный**|50 заданий в коллекции|Один раз в минуту. Не позволяет выполнять задания чаще одного раза в минуту.|Нет ограничений на количество премиальных коллекций заданий в подписке.|Доступен весь набор функций планировщика.|
