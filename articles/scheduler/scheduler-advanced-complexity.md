...
| **weekDays** |Дни недели, в которые будет выполняться задание. Указываются только при выборе еженедельной частоты. |<ul><li>Массив любого значения ниже (максимальное число элементов в массиве — 7)<ul><li>Понедельник</li><li>Вторник</li><li>Среда</li><li>Четверг</li><li>Пятница</li><li>Суббота</li><li>Воскресенье</li></ul></li></ul>*Без учета* регистра |
...
| **monthDays** |День месяца, в который будет выполняться задание. Указываются только при выборе ежемесячной частоты. |<ul><li>Массив значений ниже</li><ul><li>Любое значение < = –1 и > = –31</li><li>Любое значение > = 1 и < = 31</li></ul></ul> |
