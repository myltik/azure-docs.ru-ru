...
-   Настройте дополнительные таблицы. См. статью [Включение растяжения базы данных для таблицы](sql-server-stretch-database-enable-table.md).

-   Отслеживайте состояние переноса данных. См. статью [Мониторинг и устранение неполадок переноса данных (база данных Stretch)](sql-server-stretch-database-monitor.md).
