...
### <a name="provides-costeffective-availability-for-cold-data"></a>Экономия средств при доступе к редко используемым данным
...
### <a name="streamlines-onpremises-data-maintenance"></a>Оптимизация локального обслуживания данных
