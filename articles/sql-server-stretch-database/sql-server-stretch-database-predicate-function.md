<properties
	pageTitle="Написание встроенной функции табличных значений для выбора строк (растяжение базы данных) | Microsoft Azure"
	description="Узнайте, как создать предикат фильтра для выбора строк для переноса."
...
# Написание встроенной функции табличных значений для выбора строк (растяжение базы данных)
...
В CTP версии 3.1 до RC0 включительно возможность указания предиката в мастере "Включение базы данных для растяжения" отсутствует. В этом случае необходимо использовать инструкцию ALTER TABLE для настройки растяжения базы данных. Подробнее см. в разделе [Инструкция ALTER TABLE (Transact-SQL)](https://msdn.microsoft.com/library/ms190273.aspx).
