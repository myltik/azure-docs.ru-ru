...
В версии-кандидате 3 при запуске мастера "Включение режима Stretch для базы данных" можно перенести всю таблицу или указать простой предикат фильтра на основе даты. Если вы хотите использовать другой предикат фильтра, чтобы выбрать строки для переноса, выполните одну из следующих процедур.
...
Ниже приведен пример, который переносит строки, где столбец **date** содержит значение, предшествующее 1 января 2016 г.
...
Начните с предиката фильтра, аналогичного приведенному в примере, переносящего строки, в которых столбец **systemEndTime** содержит значение, более раннее, чем 1 января 2016 г.
