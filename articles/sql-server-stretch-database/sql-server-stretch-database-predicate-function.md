...
При запуске мастера "Включение режима Stretch для базы данных" можно перенести всю таблицу или указать простой предикат фильтра на основе даты. Если вы хотите использовать другой предикат фильтра, чтобы выбрать строки для переноса, выполните одну из следующих процедур.
