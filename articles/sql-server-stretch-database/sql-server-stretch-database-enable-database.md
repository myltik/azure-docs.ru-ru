...
5.  Для настройки растяжения базы данных для базы данных выполните инструкцию ALTER DATABASE.
    ...
    2.  Укажите существующие учетные данные администратора в аргументе CREDENTIAL или FEDERATED\_SERVICE\_ACCOUNT \\ = ON. В примере ниже приведены существующие учетные данные.
