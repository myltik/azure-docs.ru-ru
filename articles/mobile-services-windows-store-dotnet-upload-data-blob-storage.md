<properties pageTitle="Использование мобильных служб для отправки данных в хранилище больших двоичных объектов (Магазин Windows) | Мобильные службы" metaKeywords="" description="Узнайте, как использовать мобильные службы для передачи изображений в хранилище больших двоичных объектов Azure и получения доступа к изображениям из приложения магазина Windows." metaCanonical="" services="mobile-services,storage" documentationCenter="Mobile" title="Upload images to Azure Storage by using Mobile Services" authors="glenga" solutions="mobile" manager="dwrede" editor="" />
...
2. В левой области выберите категорию **Интернет**, найдите "WindowsAzure.Storage", щелкните пункт **Установить** в пакете **Azure Storage**, а затем примите условия лицензионных соглашений. 
