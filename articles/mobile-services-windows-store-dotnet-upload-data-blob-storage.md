<properties pageTitle="Отправка изображений в хранилище BLOB-объектов с помощью мобильных служб (Магазин Windows) | Мобильные службы" metaKeywords="" description="Узнайте, как использовать мобильные службы для передачи изображений в хранилище больших двоичных объектов Azure и получения доступа к изображениям из приложения магазина Windows." metaCanonical="" services="mobile-services,storage" documentationCenter="Mobile" title="Upload images to Azure Storage by using Mobile Services" authors="glenga" solutions="mobile" manager="dwrede" editor="" />
...
2. В левой области выберите категорию **В сети**, выполните поиск по запросу WindowsAzure.Storage, щелкните пункт **Установить** для пакета **хранилища Azure** и примите условия лицензионного соглашения. 
