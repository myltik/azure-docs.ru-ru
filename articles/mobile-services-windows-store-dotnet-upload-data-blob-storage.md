<properties pageTitle="Использование мобильных служб для передачи изображений в хранилище BLOB-объектов (Магазин Windows) | Мобильные службы" metaKeywords="" description="Узнайте, как использовать мобильные службы для передачи изображений в хранилище BLOB-объектов Azure и получения доступа к изображениям из приложения Магазина Windows." metaCanonical="" services="" documentationCenter="Mobile" title="Передача изображений в хранилище Azure с помощью мобильных служб" authors="glenga" solutions="mobile" manager="" editor="" />

# Передача изображений в хранилище Azure с помощью мобильных служб

<div class="dev-center-tutorial-selector sublanding"> 
	<a href="/ru-ru/documentation/articles/mobile-services-windows-store-dotnet-upload-data-blob-storage" title="Магазин Windows C#" class="current">Магазин Windows C#</a><a href="/ru-ru/documentation/articles/mobile-services-windows-phone-upload-data-blob-storage" title="Windows Phone">Windows Phone</a>
</div>
...
+  Камера или другое устройство захвата, подключенное к компьютеру.
...
2. В левой области выберите категорию **Интернет**, выполните поиск `json.net`, щелкните пункт **Установить** в пакете **WindowsAzure.Storage**, а затем примите условия лицензионных соглашений. 
...
[Отправка push-уведомлений в приложения Windows Store с использованием Service Bus на серверной стороне .NET]: http://go.microsoft.com/fwlink/?LinkId=277073&clcid=0x409
