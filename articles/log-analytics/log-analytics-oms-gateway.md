...
6. На странице "Конечная папка" оставьте папку по умолчанию (**%ProgramFiles%\OMS Gateway**) или укажите расположение, куда необходимо установить шлюз, и нажмите кнопку **Далее**.
