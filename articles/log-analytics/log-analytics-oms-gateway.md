...
---
# <a name="connect-computers-and-devices-without-internet-access-to-oms-using-the-oms-gateway"></a>Подключения компьютеров и устройств к OMS с помощью шлюза OMS без доступа к Интернету
