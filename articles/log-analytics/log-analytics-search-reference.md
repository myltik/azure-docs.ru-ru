...
Позволяет создавать поля на время выполнения запросов. Обратите внимание, что если вы хотите выполнить агрегирование, поля на время выполнения запросов нельзя использовать с командой measure.
