...
> [!NOTE]
> Решения для анализа шлюзов приложений Azure и для анализа групп безопасности сети Azure доступны в [предварительных версиях](log-analytics-add-solutions.md#preview-management-solutions-and-features).
> 
> 
