...
* **Протокол TCP.** Если вы выбрали TCP как протокол мониторинга, откройте порт брандмауэра для агентов, используемых для мониторинга производительности сети и мониторинга ExpressRoute, чтобы обеспечить подключение между агентами. Чтобы отрыть порт, запустите сценарий PowerShell EnableRules.ps1, не задавая каких-либо параметров, в окне PowerShell с правами администратора.
