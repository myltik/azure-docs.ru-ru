...
Период удержания собранных данных, хранящихся в базе данных, зависит от плана, выбранного при создании рабочей области.  В платных уровнях собранные данные будут доступны по умолчанию в течение 31 дня, а срок доступности может быть продлен до 365 дней.  Функция шифрования неактивных данных еще не реализована и планируется на середину 2018 года. 
