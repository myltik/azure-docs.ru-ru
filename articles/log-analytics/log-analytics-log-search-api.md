---
title: "REST API поиска по журналам в Azure Log Analytics | Документация Майкрософт"
description: "Это руководство дает базовые знания о том, как использовать REST API поиска Azure Log Analytics, и содержит примеры использования команд."
...
| query |Поисковый запрос, используемый для сбора и отображения результатов. |
