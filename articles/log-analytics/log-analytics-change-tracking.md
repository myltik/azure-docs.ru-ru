...
# Решение "Отслеживание изменений" в Log Analytics


Решение для отслеживания изменений конфигурации в службе Log Analytics позволяет легко определять изменения программного обеспечения и служб Windows, возникающие в среде, а выявление таких изменений, в свою очередь, помогает определить проблемы в работе.
...
## Сведения о сборе данных отслеживания изменений.
...
После установки решения можно просмотреть сводку изменений для отслеживаемых серверов с помощью элемента **Отслеживание изменений** на странице **Обзор** в OMS.
