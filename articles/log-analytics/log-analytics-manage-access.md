...
Управление доступом к Log Analytics осуществляется с использованием разных задач администрирования, связанных с рабочими областями. Эта статья содержит рекомендации и инструкции, применяемые для управления рабочими областями с использованием различных типов учетных записей. Рабочая область — это контейнер, который содержит сведения об учетной записи и ее конфигурации. Вы или другие члены организации могут использовать несколько рабочих областей для управления различными наборами данных, собранными из всех частей ИТ-инфраструктуры.
...
Чтобы разрешить всем пользователям видеть данные в этих решениях, предоставьте им по меньшей мере доступ **для чтения** к хранилищу службы архивации и хранилищу Site Recovery, связанным с рабочей областью.   
...
> [!NOTE]
> Если рабочая область, которую необходимо связать, не отображается, у подписки Azure нет прав доступа к рабочей области, созданной на веб-сайте OMS.  Вам потребуется предоставить доступ к этой учетной записи из портала OMS. Подробнее об этом см. в разделе [Добавление пользователя в существующую рабочую область](#add-a-user-to-an-existing-workspace).
>
>
...
5. В разделе **Ценовая категория** щелкните тарифный план и нажмите кнопку **Выбрать**.  
