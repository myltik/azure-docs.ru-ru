---
title: Справочник по плиткам конструктора представлений Log Analytics | Microsoft Docs
...
|:--- |:--- |
| Имя |Текст, отображаемый в верхней строке плитки. |
| Description (Описание) |Текст, отображаемый под именем плитки. |
| **Кольцо** | |
...
| Описание |Текст, отображаемый под именем плитки. |
| **График** | |
| Запрос |Запрос на выполнение для графика.  Первое свойство должно быть текстовым значением, а второе — числовым.  Обычно это запрос, использующий ключевое слово **measure** для суммирования результатов.  Если запрос использует ключевое слово **interval**, тогда для оси Х графика будет использоваться этот временной интервал.  Если запрос не содержит ключевое слово **interval**, тогда для оси Х будут использоваться интервалы в 1 час. |
| **График** |**> Ось Y** |
...
| Описание |Текст, отображаемый под именем плитки. |
| Первая диаграмма | |
| Условные обозначения |Текст для отображения под выноской для первого ряда. |
