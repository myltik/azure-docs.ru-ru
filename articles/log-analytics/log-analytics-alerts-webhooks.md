...
# Действия webhook в оповещениях Log Analytics
...
## Шаг 1. Включение действий webhook в Slack
2.	Войдите в службу Slack по адресу [slack.com](http://slack.com).
3.	Выберите канал в разделе **Channels** (Каналы) в левой области. Это канал, в который будет отправлено сообщение. Можно выбрать один из каналов по умолчанию, например **general** (Общий) или **random** (Случайный). В рабочих сценариях чаще всего создается специальный канал, например **criticalservicealerts**. <br>
...
## Шаг 2. Создание правила генерации оповещений в Log Analytics
...
### Расширенные полезные данные webhook для Slack
