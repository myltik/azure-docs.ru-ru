...
> [AZURE.NOTE] Запрос поиска по журналу, возвращающий необработанные данные, более предпочтителен, чем консолидация с использованием таких команд, как [Measure](log-analytics-search-reference.md#measure).  На основе необработанных данных в Power BI можно выполнять любые операции агрегирования и расчеты.
