---
title: "Настраиваемые журналы в Log Analytics | Документация Майкрософт"
...
> [!NOTE]
> В настоящее время Log Analytics обрабатывает дату и время, собранные из журнала, используя в качестве разделителя метку времени в формате UTC.  Вскоре в агенте для этого будет использоваться часовой пояс. 
> 
> 
