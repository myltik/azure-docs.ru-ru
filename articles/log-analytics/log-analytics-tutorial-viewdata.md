...
Процесс занимает несколько минут. В это время вы можете отслеживать ход его выполнения в меню в разделе **Уведомления**. Дополнительные сведения о преимуществах нового языка запросов см. в [этом разделе](log-analytics-log-search-upgrade.md#why-the-new-language).
