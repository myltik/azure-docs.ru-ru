---
title: Оптимизация среды с помощью решения оценки SQL в Log Analytics | Microsoft Docs
...
### <a name="to-create-and-use-an-ignorerecommendations.txt-text-file"></a>Создание и использование текстового файла IgnoreRecommendations.txt
