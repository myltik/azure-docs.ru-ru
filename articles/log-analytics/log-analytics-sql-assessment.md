...
>[AZURE.NOTE] Если используется прямой агент OMS, а не агент SCOM, то пакет управления всегда выполняется в контексте безопасности учетной записи Local System. Пропустите шаги 1-5, описанные ниже, и выполните пример T-SQL или Powershell, указав в качестве имени пользователя NT AUTHORITY\SYSTEM.
