...
>[AZURE.NOTE] Если конфигурация портала OMS включена, при редактировании файлы конфигурации счетчиков производительности и системных журналов переопределяются. Конфигурацию можно отключить для всех узлов (полностью) на портале OMS или для одного узла с помощью следующей команды.
