...
Вам будет предложено выбрать подписку и группу ресурсов для публикации панели мониторинга. Для удобства при публикации на портале панели мониторинга помещаются в группу ресурсов с названием **dashboards**.  Проверьте выбранные подписки и выберите **Опубликовать**.  Доступ к информации, отображаемой на панели мониторинга, контролируется с помощью [службы контроля доступа на основе ресурсов Azure](../active-directory/role-based-access-control-configure.md).   
