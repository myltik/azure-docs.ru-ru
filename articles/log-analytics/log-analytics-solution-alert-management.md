<properties
   pageTitle="Решение управления оповещениями в Operations Management Suite (OMS) | Microsoft Azure"
...
| [Агенты Linux](log-analytics-linux-agents.md) | Нет | Прямые агенты Linux не создают оповещения SCOM. |
...
## <a name="scope-and-time-range"></a>Область действия и диапазон времени
