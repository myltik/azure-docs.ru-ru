<properties linkid="manage-services-storage-net-shared-access-signature-part-2" urlDisplayName="" pageTitle="Создание и использование подписи общего доступа с помощью службы BLOB-объектов | Microsoft Azure" metaKeywords="BLOB-объект Azure, подписи общего доступа, хранимая политика доступа" description="Узнайте о создании и использовании подписей общего доступа с помощью службы BLOB-объектов" metaCanonical="" services="storage" documentationCenter="" title="Часть 2. Создание и использование подписи общего доступа с помощью службы BLOB-объектов" authors="tamram" solutions="" manager="mbaldwin" editor="cgronlun" />
