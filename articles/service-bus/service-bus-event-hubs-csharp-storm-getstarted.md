...
Для получения более подробной информации см [Общие сведения о концентраторах событий].
...
6. Выберите расположенную вверху страницы вкладку **Настройка**, добавьте правило **SendRule**, задав для него права *Отправка*, и правило **ReceiveRule**, задав для него права  *Прослушиваниеn*, затем нажмите кнопку **Сохранить**.
