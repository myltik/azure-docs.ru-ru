...
2. Нажмите кнопку **Настроить**, чтобы просмотреть стандартные политики общего доступа для пространства имен.
