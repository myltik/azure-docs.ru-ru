<properties
    pageTitle="Создание пространства имен служебной шины с помощью шаблона ARM | Microsoft Azure"
...
# Создание пространства имен служебной шины с помощью шаблона ARM

В этой статье показывается, как использовать шаблон Azure Resource Manager (ARM), создающий пространство имен "Messaging" служебной шины с SKU уровня "Стандартный" или "Базовый". В этой статье также определяются параметры, которые задаются во время развертывания. Этот шаблон можно использовать для собственных развертываний или настроить его в соответствии с вашими требованиями.
...
С помощью этого шаблона вы развернете пространство имен служебной шины с SKU уровня ["Стандартный" или "Базовый"](https://azure.microsoft.com/pricing/details/service-bus/).

Чтобы выполнить развертывание автоматически, нажмите следующую кнопку.

[![Развертывание в Azure](./media/service-bus-arm-namespace/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2F101-servicebus-create-namespace%2Fazuredeploy.json)
...
В шаблоне определены значения, допустимые для этого параметра ("Стандартный" или "Базовый"). Если значение не указано, параметру назначается значение по умолчанию ("Стандартный").

Для уровня "Стандартный" также предусмотрен базовый сбор в размере 10 долларов в месяц, который позволяет выполнять до 12,5 миллиона операций в месяц без дополнительных затрат. Стоимость для уровня "Базовый" составляет 0,05 доллара за миллион операций.

Дополнительные сведения о ценах на использование служебной шины см. в разделе [Служебная шина: цены и выставление счетов][].
...
- [Управление ресурсами служебной шины с помощью обозревателя служебной шины](https://code.msdn.microsoft.com/Service-Bus-Explorer-f2abca5a)
  ...
  [Служебная шина: цены и выставление счетов]: https://azure.microsoft.com/documentation/articles/service-bus-pricing-billing/
