...
1. В разделе **Генератор общего ключа доступа** запишите **Первичный ключ**, связанный с политикой **RootManageSharedAccessKey**, или скопируйте его в буфер обмена. Этот ключ потребуется позже в этом руководстве.
...
- Использует пространство имен службы и ключ [подписанного URL-адреса](service-bus-sas-overview.md) (SAS) для получения доступа к ресурсам пространства имен служебной шины.
...
- [Базовая информация о служебной шине Azure](service-bus-fundamentals-hybrid-solutions.md)
