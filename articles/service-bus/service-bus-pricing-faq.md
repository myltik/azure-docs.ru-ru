...
# Часто задаваемые вопросы о ценах на служебную шину
...
- **Квоты на размер сообщения**
	...
	- **Ретрансляторы NetOneway и NetEvent**. Каждое сообщение ограничено суммарным размером 64 КБ, включая заголовки сообщения.
