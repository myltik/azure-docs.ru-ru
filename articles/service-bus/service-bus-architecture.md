...
С единицей масштабирования сопоставляется пространство имен служебной шины. Единица масштабирования обрабатывает все типы сущностей служебной шины: ретрансляторы и обмен сообщениями через брокер (очереди, разделы, подписки). Единица масштабирования служебной шины состоит из следующих компонентов.
