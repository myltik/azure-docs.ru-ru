...
> [AZURE.NOTE] Этот пример хорошо работает в сценариях IaaS, когда локальный диск или диск для MSMQ сопоставлен учетной записью хранения и сообщения надежно хранятся в MSMQ. Это не подходит для сценариев PaaS, например облачных служб и веб-приложений.
