---
title: Рекомендации по изолированию приложений служебной шины от простоев и аварий | Microsoft Docs
...
Для защиты от простоев ACS используйте маркеры подписи общего доступа (SAS). В этом случае клиент проходит проверку подлинности непосредственно у служебной шины, подписывая самостоятельно созданный маркер секретным ключом. Вызовы к ACS больше не требуются. Дополнительные сведения о маркерах SAS см. в статье [Проверка подлинности служебной шины][Проверка подлинности служебной шины].
