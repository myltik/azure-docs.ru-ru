...
Можно управлять пространствами имен и сущностями обмена сообщениями Service Bus с помощью [портала Azure][] или обозревателя серверов Visual Studio, но новые пространства имен можно создавать только с портала.
...
Созданное пространство имен появится на портале Azure, хотя его активация может занять некоторое время. Прежде чем продолжать, подождите, пока состояние не изменится на **Активное**.
...
1.  Войдите на [портал Azure], щелкните пункт **Облачные службы**, а затем щелкните имя своей службы.
...
* [Использование очередей служебной шины][sbwacomqhowto]  
  ...
  [портала Azure]: http://manage.windowsazure.com
