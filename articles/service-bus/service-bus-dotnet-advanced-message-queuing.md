...
Значение **Microsoft.ServiceBus.ConnectionString** представляет собой строку подключения сервисной шины, используемую для настройки подключения к сервисной шине. Используется следующий формат:

	Endpoint=sb://[namespace].servicebus.windows.net;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=[SAS key];TransportType=Amqp

где [пространство имен] и [ключ SAS] принимаются с портала управления Azure. Дополнительные сведения см. в статье [Использование очередей служебной шины][].
...
Дополнительные сведения о межплатформенном обмене сообщениями с помощью Service Bus и AMQP 1.0 см. в статье [Руководство разработчика AMQP 1.0 для Service Bus](http://msdn.microsoft.com/library/azure/jj841071.aspx).
...
Дополнительные сведения см. в [руководстве разработчика AMQP 1.0 для Service Bus](http://msdn.microsoft.com/library/azure/jj841071.aspx). В данном разделе приводится подробный список неподдерживаемых интерфейсов API.
...
* [Протокол AMQP 1.0 для Service Bus. Руководство разработчика](http://msdn.microsoft.com/library/azure/jj841071.aspx)
