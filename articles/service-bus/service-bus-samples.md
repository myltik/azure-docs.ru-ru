...
В примерах служебной шины демонстрируются ключевые возможности служебной шины (облачной службы) и служебной шины для Windows Server. В этой статье приведены категории примеров с описаниями и ссылками.

>[AZURE.NOTE]Примеры служебной шины не устанавливаются вместе с пакетом SDK. Примеры доступны на [странице примеров пакета SDK для Azure](https://code.msdn.microsoft.com).
