<properties
    pageTitle="Обзор подписанных URL-адресов | Microsoft Azure"
...
> [AZURE.NOTE] Важно, чтобы подключение было создано с применением **механизма аутентификации SASL EXTERNAL** (а не механизма по умолчанию PLAIN, при котором имя пользователя и пароль используются, когда не нужно отправлять маркер SAS).
