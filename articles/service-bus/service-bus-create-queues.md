...
После получения подписки можно создать новое пространство имен. Присвойте пространству имен имя, которое будет уникальным среди всех учетных записей служебной шины. Каждое пространство имен выступает в качестве определяющего область действия контейнера для набора сущностей служебной шины.
...
Теперь когда вы ознакомились с основами использования очередей, обратитесь к разделу [Создание приложений, использующих разделы и подписки служебной шины](service-bus-create-topics-subscriptions.md). В этом разделе описаны возможности публикаций и подписок служебной шины.
