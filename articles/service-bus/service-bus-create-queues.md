...
Теперь, когда вы ознакомились с основами использования очередей, перейдите к разделу [Создание приложений, использующих разделы и подписки служебной шины](service-bus-create-topics-subscriptions.md). В этом разделе описаны возможности разделов и подписок служебной шины, позволяющие публиковать их или подписываться на них.
