...
- [Основные сведения о служебной шине Microsoft Azure](fundamentals-service-bus-hybrid-solutions.md)
...
- [Рекомендации по изолированию приложений служебной шины в целях предотвращения сбоев и аварий](http://msdn.microsoft.com/library/azure/jj554355.aspx)
- [Управляемый обмен сообщениями: образец ответа на запрос](http://code.msdn.microsoft.com/windowsazure/Brokered-Messaging-Request-2b4ff5d8) 
- [Многоуровневое приложение со служебной шиной Azure](cloud-services-dotnet-multi-tier-app-using-service-bus-queues.md)
