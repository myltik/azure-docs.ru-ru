...
В этом руководстве предполагается, что вы уже создали пространство имен служебной шины, содержащее очередь с именем queue1. Если это не так, можно создать пространство имен и в очередь, используя [портал Azure](http://manage.windowsazure.com). Дополнительную информацию о создании пространства имен и очередей служебной шины см. в статье [Очереди служебной шины](service-bus-dotnet-how-to-use-queues.md).
...
* [Протокол AMQP 1.0 для Service Bus. Руководство разработчика](service-bus-amqp-dotnet.md)
