...
Дополнительную информацию о получении и использовании этих библиотек с шиной Service Bus см. в [руководстве разработчика AMQP для служебной шины][]. Ссылки на дополнительную информацию см. в разделе [Дальнейшие действия](service-bus-java-amqp-overview.md#next-steps).
...
[руководстве разработчика AMQP для служебной шины]: service-bus-amqp-dotnet.md
