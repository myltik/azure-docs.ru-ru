...
* Дополнительные сведения о защите ресурсов Azure см. в статье [Вопросы безопасности при работе с диспетчером ресурсов Azure](../best-practices-resource-manager-security.md).
