...
В нижней части колонки "Зона DNS" отображаются записи для зоны DNS. Должны отобразиться записи типа NS и SOA по умолчанию, которые создаются в каждой зоне, а также все новые записи, созданные вами.
