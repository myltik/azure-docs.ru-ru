---
title: Делегирование домена в Azure DNS | Microsoft Docs
...
> [!NOTE]
> Подробные сведения об определении владельца доменного имени и о том, как приобрести домен, см. в разделе [Управление доменами Интернета в Azure AD](https://msdn.microsoft.com/library/azure/hh969248.aspx).
> 
> 
