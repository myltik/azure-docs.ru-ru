---
title: "Создание зоны DNS с помощью Azure CLI 1.0 | Документация Майкрософт"
description: "Сведения о создании зон DNS в Azure DNS. Это пошаговое руководство описывает создание первой зоны DNS и управление ею с помощью интерфейса командной строки Azure CLI 1.0."
services: dns
...
# <a name="create-an-azure-dns-zone-using-azure-cli-10"></a>Создание зоны Azure DNS с помощью Azure CLI 1.0
