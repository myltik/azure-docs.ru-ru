...
Невозможно удалить наборы записей типа SOA и NS на вершине зоны (имя = "@")), которые создаются автоматически вместе с зоной. Они удаляются автоматически при удалении зоны.
