...
Для своей учетной записи хранения вы можете настроить имя домена. Для получения дополнительной информации см. раздел [Настройка пользовательского имени домена для данных больших двоичных объектов в учетной записи хранения](http://azure.microsoft.com/documentation/articles/storage-custom-domain-name/).
