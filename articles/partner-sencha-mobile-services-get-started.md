<properties linkid="develop-mobile-tutorials-get-started-sencha" urlDisplayName="Приступая к работе" pageTitle="Приступая к работе с мобильными службами Azure и Sencha" metaKeywords="" description="Изучите данный урок, чтобы приступить к разработке с использованием мобильных служб и платформы мобильных приложений HTML5 Sencha. " metaCanonical="" disqusComments="1" umbracoNaviHide="1" services="" documentationCenter="Mobile" title="Приступая к работе с мобильными службами и Sencha Touch" authors="sencha" solutions="" manager="" editor="" />
...
<div class="dev-center-tutorial-selector sublanding">
	...
	<a href="/ru-ru/documentation/articles/partner-sencha-mobile-services-get-started/" title="Sencha" class="current">Sencha</a>
...
<!--<div class="dev-center-tutorial-subselector">
	<a href="/ru-ru/documentation/articles/partner-sencha-mobile-services-dotnet-backend-get-started/" title="Серверная часть .NET">Серверная часть .NET</a> | 
	<a href="/ru-ru/documentation/articles/partner-sencha-mobile-services-get-started/"  title="Серверная часть JavaScript" class="current">Серверная часть JavaScript</a>
</div>-->
...
3. Чтобы создать таблицу для хранения данных приложения, щелкните элемент **Создание таблицы TodoItems**.
...
###Настройка прокси-сервер данных Azure
...
###Просмотр и редактирование элементов дел
