...
3. Для создания базы данных, в которой будут храниться записи блога, используйте следующую команду:
	...
	Эта команда использует поставщик базы данных по умолчанию для Rails, т. е. [Базу данных][sqlite3]. Вы можете использовать другую базу данных для рабочего приложения, однако для этого руководства SQLite вполне достаточно.
