...
- Включите систему диагностики Azure для ролей облачной службы. <br /><br />Дополнительные сведения см. в разделе [Включение диагностики в облачных службах и виртуальных машинах Azure](cloud-services-dotnet-diagnostics.md).
...
1. Скопируйте ключ доступа к хранилищу для учетной записи, в которой будут размещаться данные подробного мониторинга. Для этого войдите на [Портал управления Azure](https://manage.windowsazure.com/) и выберите **Управление ключами** на странице **Учетные записи хранения**. Дополнительные сведения см. в разделе [Управление облачными службами](cloud-services-how-to-manage.md) или в справке для страницы **Учетные записи хранения**. 
