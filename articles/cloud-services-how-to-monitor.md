<properties urlDisplayName="How to monitor" pageTitle="Мониторинг облачной службы &mdash; Azure" metaKeywords="Azure monitoring cloud services, Azure Management Portal cloud services" description="Узнайте, как осуществлять мониторинг облачных служб с помощью портала управления Azure." metaCanonical="" services="cloud-services" documentationCenter="" title="Мониторинг облачных служб" authors="ryanwi" solutions="" manager="timlt" editor="" />
...
-   Включите систему диагностики Azure для ролей облачной службы.
    Подробнее см. раздел [Включение системы диагностики для облачных служб и виртуальных машин Azure][Включение системы диагностики для облачных служб и виртуальных машин Azure].
...
2.  Добавление метрик в таблицу метрик:
    ...
    а). Щелкните **Добавить метрику**, при этом откроется окно **Выбор метрики**, изображенное ниже.
    Первая метрика развернута для демонстрации доступных настроек. Верхний параметр для каждой метрики позволяет отобразить сводные данные мониторинга по всем ролям. Также вы можете выбрать отдельные роли, для которых требуется отображать данные.
...
Например, в следующих таблицах размещаются сводные данные подробного мониторинга, собираемые с интервалом в 1 час:
  ...
  [Включение диагностики в облачных службах и виртуальных машинах Azure]: http://azure.microsoft.com/ru-ru/documentation/articles/cloud-services-dotnet-diagnostics/
  [Создание учетной записи хранения]: /ru-ru/manage/services/storage/how-to-create-a-storage-account/
  [Включение системы диагностики для облачных служб и виртуальных машин Azure]: /ru-ru/documentation/articles/cloud-services-dotnet-diagnostics/
  [Портал управления Azure]: https://manage.windowsazure.com/
  [Управление облачными службами]: /ru-ru/documentation/articles/cloud-services-how-to-manage/
