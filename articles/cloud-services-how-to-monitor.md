<properties linkid="manage-services-how-to-monitor-a-cloud-service" urlDisplayName="Способы мониторинга" pageTitle="Мониторинг облачной службы — Azure" metaKeywords="Azure, мониторинг облачной службы, портал управления Azure, портал управления" description="Узнайте, как осуществлять мониторинг облачных служб с помощью портала управления Azure." metaCanonical="" services="cloud-services" documentationCenter="" title="Мониторинг облачных служб" authors=""  solutions="" writer="ryanwi" manager="" editor=""  />
...
> [WACOM.NOTE]
> Для подробного мониторинга вы можете добавить дополнительные счетчики производительности при запуске экземпляра роли с помощью файла конфигурации диагностики, а также удаленно через API диагностики Azure. Чтобы отслеживать эти метрики на портале управления, перед настройкой подробного мониторинга необходимо добавить соответствующие счетчики производительности. Дополнительные сведения см. в разделе <a href="http://msdn.microsoft.com/ru-ru/library/gg433048.aspx">Сбор данных журнала с помощью диагностики Azure</a> и <a href="http://msdn.microsoft.com/ru-ru/library/hh411542.aspx">Создание и использование счетчиков производительности в приложении Azure</a>.
...
Чтобы настроить минимальный или подробный уровень мониторинга на портале управления, выполните следующие действия. Прежде чем настраивать подробный мониторинг, необходимо включить диагностику Azure и настроить строки подключения диагностики, чтобы обеспечить доступ к учетным записям хранения, где будут размещаться данные мониторинга.
...
- Включите диагностику Azure для ролей облачной службы. <br /><br />При этом необходимо обновить файлы определения (CSDEF) и конфигурации (CSCFG) службы. Дополнительные сведения см. в разделе [Настройка диагностики в Azure](http://msdn.microsoft.com/ru-ru/library/windowsazure/dn186185.aspx).
...
Вы можете настроить получение оповещений на основе метрик мониторинга облачной службы. На странице **Службы управления** портала управления Azure можно создать правило, которое вызывает оповещение при достижении заданного значения выбранной метрики. Кроме того, вы можете настроить отправку сообщения электронной почты с оповещением. Дополнительные сведения см. в разделе [Практическое руководство. Получение уведомлений об оповещениях и управление правилами оповещения в Azure](http://go.microsoft.com/fwlink/?LinkId=309356).
