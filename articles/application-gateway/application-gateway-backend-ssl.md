...
# Включение политики SSL и сквозного режима связи SSL в шлюзе приложений
...
## Сквозной режим связи SSL и список разрешенных сертификатов
...
2. Определение политики SSL дает возможность отключить любой из трех следующих протоколов: TLSv1_0, TLSv1_1, TLSv1\_2.
3. Если политика SSL не определена, то будут включены все три протокола (TLSv1_0, TLSv1_1 и TLSv1\_2).
