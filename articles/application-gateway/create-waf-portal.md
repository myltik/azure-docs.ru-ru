...
![Пример брандмауэра веб-приложений](./media/create-waf-portal/scenario-waf.png)
...
3. Введите следующие значения для шлюза приложений:
    ...
    ![Создание шлюза приложений](./media/create-waf-portal/application-gateway-create.png)
...
5. Щелкните **Выбрать виртуальную сеть**, выберите **Создать**, а затем введите следующие значения для виртуальной сети:
    ...
    ![Создание виртуальной сети](./media/create-waf-portal/application-gateway-vnet.png)
...
2. Щелкните **Подсети**, а затем — **Подсеть**.
    ...
    ![Создание подсети](./media/create-waf-portal/application-gateway-subnet.png)
...
1. Откройте интерактивную оболочку и убедитесь, что для нее задано значение **PowerShell**.
    ...
    ![Установка пользовательского расширения](./media/create-waf-portal/application-gateway-extension.png)
...
3. Нажмите кнопку **Добавить целевой объект**, чтобы добавить в серверный пул каждую созданную виртуальную машину.
    ...
    ![Добавление внутренних серверов](./media/create-waf-portal/application-gateway-backend.png)
...
7. Выберите команду **Сохранить**.
    ...
    ![Настройка диагностики](./media/create-waf-portal/application-gateway-diagnostics.png)
...
1. Найдите общедоступный IP-адрес для шлюза приложений на экране обзора. Выберите **Все ресурсы**, а затем щелкните **myAGPublicIPAddress**.
    ...
    ![Запись общедоступного IP-адреса шлюза приложений](./media/create-waf-portal/application-gateway-record-ag-address.png)

2. Скопируйте общедоступный IP-адрес и вставьте его в адресную строку браузера.

    ![Тестирование шлюза приложений](./media/create-waf-portal/application-gateway-iistest.png)
