...
* [Журналы.](#diagnostic-logs) Можно сохранять или использовать данные производительности, доступа и другие данные, относящиеся к ресурсу, чтобы отслеживать его состояние.

* [Метрики.](#metrics) Сейчас в шлюзе приложений используется одна метрика. Она позволяет измерить пропускную способность шлюза приложений в байтах в секунду.
