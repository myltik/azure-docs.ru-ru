<properties 
   pageTitle="Наблюдение за журналами доступа и производительности и метриками для шлюза приложений | Microsoft Azure"
...
# Журналы диагностики и метрики для шлюза приложений

Azure предоставляет возможность наблюдать за ресурсом с помощью журналов и метрик.

[**Ведение журнала**](#enable-logging-with-powershell). Можно сохранять или использовать журналы производительности, доступа и другие журналы, относящиеся к ресурсу, в целях наблюдения за ним.
...
- **Журналы брандмауэра**. Этот журнал можно использовать для просмотра запросов, которые были зарегистрированы в режиме обнаружения или предотвращения на шлюзе приложений, на котором настроен брандмауэр веб-приложения.
...
Список текущих поддерживаемых метрик доступен на странице [Метрики, поддерживаемые Azure Monitor](../azure-portal/monitoring-supported-metrics.md).
...
Чтобы лучше понять, как действуют веб-перехватчики webhook и как их использовать с оповещениями, ознакомьтесь с [настройкой webhook для оповещений метрик Azure](../azure-portal/insights-webhooks-alerts.md).
