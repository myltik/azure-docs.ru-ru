<properties
   pageTitle="Создание шлюза приложений с брандмауэром веб-приложения с помощью портала | Microsoft Azure"
...
# Создание шлюза приложений с брандмауэром веб-приложения с помощью портала
...
Далее следует настроить конфигурацию прослушивателей. Если используется протокол **HTTP**, настраивать больше нечего и можно нажать кнопку **ОК**. Чтобы использовать протокол **HTTPS**, нужно настроить дополнительные параметры.
...
- **Состояние брандмауэра**. Этот параметр включает или отключает WAF.
