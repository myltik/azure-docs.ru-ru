...
Изучив принципы создания шлюза приложений, вы можете [создать шлюз приложения](application-gateway-create-gateway.md) или [создать разгрузку SSL шлюза приложений](application-gateway-ssl.md) для балансировки нагрузки HTTPS-подключений.
