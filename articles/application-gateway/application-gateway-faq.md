...
Правила обрабатываются в том порядке, в котором они были настроены. Рекомендуется настроить правила для нескольких сайтов прежде, чем базовые правила. Если сначала настроить прослушиватели для нескольких сайтов, это снизит вероятность направления трафика к несоответствующей серверной части. Эта проблема маршрутизации может возникнуть, так как базовое правило будет сопоставлять трафик по порту прежде, чем будет применено правило для нескольких сайтов.
