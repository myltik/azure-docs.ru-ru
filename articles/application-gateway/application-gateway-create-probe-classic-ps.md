<properties 
   ...
   description="Научитесь создавать пользовательские проверки для шлюза приложений с помощью PowerShell в классической модели развертывания"
...
# Создание пользовательской проверки для шлюза приложений (классического) с помощью PowerShell
...
В приведенном ниже примере показано, как использовать файл конфигурации для настройки шлюза приложений, чтобы сбалансировать нагрузку HTTP-трафика на общем порте 80 и направить сетевой трафик на внутренний порт 80 между двумя IP-адресами с помощью пользовательской проверки.
...
## Добавление конфигурации пользовательской проверки для существующего шлюза приложений
...
Обновите конфигурацию шлюза приложения для нового XML-файла с помощью `Set-AzureApplicationGatewayConfig`. Эта команда обновит шлюз приложений с новой конфигурацией.
