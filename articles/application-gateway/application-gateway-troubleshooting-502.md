...
После настройки шлюза приложений Azure может появиться сообщение об ошибке "Ошибка сервера 502: веб-сервер, выполняющий роль шлюза или прокси-сервера, получил недопустимый ответ". Такая ошибка происходит по следующим причинам:
