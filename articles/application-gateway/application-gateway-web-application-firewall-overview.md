...
|---|---|
|**[REQUEST-910-IP-REPUTATION](application-gateway-crs-rulegroups-rules.md#crs910)**|Содержит правила, обеспечивающие защиту от рассылки известной нежелательной почты и вредоносных действий.|
...
|**[REQUEST-912-DOS-PROTECTION](application-gateway-crs-rulegroups-rules.md#crs912)**| Содержит правила, обеспечивающие защиту от атак типа "отказ в обслуживании".|
...
Выставление счетов за WAF начинается с 5.05.2017 г. До этой даты номера SKU шлюзов WAF тарифицируются по стандартным расценкам.
