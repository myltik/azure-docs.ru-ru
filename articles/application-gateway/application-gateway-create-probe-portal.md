---
title: Создание пользовательской пробы для шлюза приложений с помощью портала | Microsoft Docs
...
> [!IMPORTANT]
> Имя узла не является именем сервера. Это имя виртуального узла, запущенного на сервере приложений. Проба отправляется по адресу http://(имя\_узла):(порт\_из\_параметров\_HTTP)/urlPath.
> 
> 
