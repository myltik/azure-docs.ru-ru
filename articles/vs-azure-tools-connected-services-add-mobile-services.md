---
title: Добавление мобильных служб с помощью подключенных служб Visual Studio | Microsoft Docs
description: 'Добавление мобильных служб с помощью диалогового окна '
;добавление: ''
подключенных: ''
служб";: ''
в: ''
