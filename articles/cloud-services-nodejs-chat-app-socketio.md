...
2.  Перейдите по структуре каталогов локального репозитория
    ...
    **C:\\node\\chatapp\\WorkerRole1**.
    ...
    ![Обозреватель с извлеченным из архива содержимым каталога exampleschat][chat-example-view]
