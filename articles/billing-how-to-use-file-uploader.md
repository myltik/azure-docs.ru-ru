...
При [создании нового запроса на техническую поддержку](https://ms.portal.azure.com/#create/Microsoft.Support) утилита загрузки файлов помогает легко загружать файлы диагностики и любые другие файлы, которые могут быть связаны с инцидентом.
...
## Таблица расширений имен файлов
