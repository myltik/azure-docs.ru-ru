...
* **insert\_or\_merge\_entity():** обновление имеющейся сущности путем ее замены. Если сущность не существует, будет вставлена новая:
* **insert\_or\_replace\_entity():** обновление сущности посредством объединения новых значений свойств с имеющейся сущностью. Если сущность не существует, будет вставлена новая.
