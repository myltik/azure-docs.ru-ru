...
В этом руководстве показано, как реализовать типичные сценарии с использованием службы таблиц Windows Azure. Примеры написаны с помощью Ruby API. Здесь описаны такие сценарии, как **создание и удаление таблицы, вставка и запрос сущностей в таблице**. Дополнительные сведения о таблицах см. в разделе [Дальнейшие действия][].
...
[Создание приложений Ruby в Azure][].
...
1.  Выполните вход в [Портал управления Azure][].
...
-   Посетите репозиторий [Azure SDK для Ruby][] на веб-сайте GitHub
  ...
  [Создание приложений Ruby в Azure]: /en-us/develop/ruby/tutorials/web-app-with-linux-vm/
