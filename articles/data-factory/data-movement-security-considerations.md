...
### <a name="secure-data-store-credentials"></a>Защита учетных данных хранилища данных
...
### <a name="firewall-configurations-and-whitelisting-ip-addresses"></a>Параметры конфигурации брандмауэра и добавление IP-адресов в список разрешенных
