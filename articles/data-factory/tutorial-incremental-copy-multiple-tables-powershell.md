...
> * установите среду выполнения интеграции; 
...
>[Добавочная загрузка данных из базы данных SQL Azure в хранилище BLOB-объектов Azure с использованием технологии "Отслеживание изменений"](tutorial-incremental-copy-multiple-tables-powershell.md)
