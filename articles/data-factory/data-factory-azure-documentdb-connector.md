...
---
<a id="move-data-to-and-from-azure-cosmos-db-using-azure-data-factory" class="xliff"></a>

# Перемещение данных в Azure Cosmos DB и из нее с помощью фабрики данных Azure
...
```
<a id="schema-by-data-factory" class="xliff"></a>
...
<a id="importexport-json-documents" class="xliff"></a>

## Документы JSON для импорта и экспорта
...
<a id="json-examples" class="xliff"></a>

## Примеры определений JSON
...
<a id="example-copy-data-from-azure-cosmos-db-to-azure-blob" class="xliff"></a>

## Пример. Копирование данных из Azure Cosmos DB в большой двоичный объект Azure
...
```
<a id="example-copy-data-from-azure-blob-to-azure-cosmos-db" class="xliff"></a>

## Пример. Копирование данных из большого двоичного объекта в Azure Cosmos DB 
В примере ниже показано следующее.
...
1. **Вопрос.**
    ...
    **Ответ.**
    Нет.
2. **Вопрос.**
    Как при повторной попытке копирования в Azure Cosmos DB обрабатываются уже скопированные записи?
...
3. **Вопрос.**
    Поддерживает ли фабрика данных [секционирование данных по диапазонам или хэш-секционирование](../documentdb/documentdb-partition-data.md)?

    **Ответ.**
    Нет.
4. **Вопрос.**
    Можно ли указать больше одной коллекции Azure Cosmos DB для таблицы?
