...
Этот соединитель DocumentDB поддерживает копирование данных в односекционные и секционированные коллекции DocumentDB и из них. [DocDB для MongoDB](../documentdb/documentdb-protocol-mongodb.md) не поддерживается. Сведения о копировании данных в виде "как есть" в JSON-файлы или другую коллекцию DocumentDB либо из них см. в статье [Документы JSON для импорта и экспорта](#importexport-json-documents).
...
* При использовании мастера копирования установите флажок **Export as-is to JSON files or DocumentDB collection** (Экспортировать как есть в JSON-файлы или коллекцию DocumentDB).
* При редактировании не указывайте раздел "structure" в наборах данных DocumentDB или свойство "nestingSeparator" для источника или приемника DocumentDB в действии копирования. Чтобы импортировать данные в JSON-файлы или экспортировать их оттуда, в наборе хранилища файлов укажите тип формата "JsonFormat", конфигурацию "filePattern" и пропустите остальные параметры формата. Дополнительные сведения см. в разделе [Формат JSON](data-factory-supported-file-and-compression-formats.md#json-format).
