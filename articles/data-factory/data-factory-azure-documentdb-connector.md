<properties 
	pageTitle="Соединитель DocumentDB: перемещение данных в базу данных DocumentDB и из нее" 
	description="Сведения о соединителе Azure DocumentDB для службы фабрики данных, с помощью которого можно перемещать данные в коллекцию Azure DocumentDB и из нее." 
...
# Соединитель DocumentDB: перемещение данных в базу данных DocumentDB и из нее
...
3. Входной набор данных типа DocumentDbCollection. 
4. Выходной набор данных типа AzureBlob.
4. Конвейер с действием копирования, в котором используются DocumentDbCollectionSource и BlobSink.
...
4. Конвейер с действием копирования, в котором используются BlobSource и DocumentDbCollectionSink.
...
| -------- | ----------- | --------- |
| type | Для свойства нужно указать тип **DocumentDb**. | Да |
