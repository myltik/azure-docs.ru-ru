<properties 
	pageTitle="Соединитель Teradata: перемещение данных из Teradata" 
...
# Соединитель Teradata: перемещение данных из Teradata
...
1.	Связанная служба типа OnPremisesTeradata.
