...
6. [Мониторинг конвейеров и срезов данных](#monitor-pipelines). На этом шаге вы выполните мониторинг конвейеров, таблиц и срезов данных с помощью классического портала Azure.
...
Классический портал Azure пока не поддерживает создание наборов данных и таблиц, поэтому вам необходимо воспользоваться Azure PowerShell для создания таблиц в этом выпуске.
