...
index | Индекс таблицы в ресурсе. Действия для получения индекса таблицы на HTML-странице представлены в разделе [Получение индекса таблицы на HTML-странице](#get-index-of-a-table-in-an-html-page). | Да
...
4.  В диалоговом окне **Доступ к веб-содержимому** выберите соответствующий **URL-адрес** и **тип проверки подлинности**, затем нажмите кнопку **Подключить**. 
