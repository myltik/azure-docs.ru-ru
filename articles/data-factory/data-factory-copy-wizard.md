...
# Удобное копирование и перемещение данных с помощью мастера копирования в фабрике данных Azure
...
## Интуитивно понятный мастер для копирования данных
...
## Поддержка разнообразных данных и типов объектов
