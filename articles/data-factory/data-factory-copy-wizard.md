---
title: "Мастер копирования фабрики данных | Документация Майкрософт"
...
---
# <a name="data-factory-copy-wizard"></a>Мастер копирования фабрики данных
...
## <a name="schema-capture-and-mapping"></a>Запись и сопоставление схем
...
Вы можете использовать переменные в пути к папке, чтобы источник копирования данных определялся во время выполнения на основе [системных переменных](data-factory-functions-variables.md#data-factory-system-variables). Поддерживаемые переменные: **{year}**, **{month}**, **{day}**, **{hour}**, **{minute}** и **{custom}**. Пример: inputfolder/{year}/{month}/{day}.
...
Краткое описание создания конвейера с действием копирования с помощью мастера копирования фабрики данных приведено в [этой статье](data-factory-copy-data-wizard-tutorial.md).
