...
> [AZURE.NOTE] Если окна действий не отображаются в нижней части, на панели инструментов нажмите кнопку **Обновить**, чтобы обновить список. Кроме того, установите правильные значения для фильтров **Время начала** и **Время окончания**.
