...
---
# <a name="monitor-and-manage-azure-data-factory-pipelines-using-new-monitoring-and-management-app"></a>Мониторинг конвейеров фабрики данных Azure и управление ими с помощью нового приложения по мониторингу и управлению
...
## <a name="launching-the-monitoring-and-management-app-a"></a>Запуск приложения по мониторингу и управлению
Чтобы запустить приложение по мониторингу и управлению, щелкните элемент **Monitoring & Manage** (Мониторинг и управление) в колонке **Фабрика данных** для фабрики данных.
...
![приложения по мониторингу и управлению](./media/data-factory-monitor-manage-app/AppLaunched.png)
...
## <a name="understanding-the-monitoring-and-management-app"></a>Общие сведения о приложении по мониторингу и управлению
...
* **окон действий** на нижней панели в центре страницы;
* **Свойства**/**Activity Window Explorer** (Обозреватель окон действий) в правой области. 
...
### <a name="activity-windows-list"></a>Список "Окна действий"
...
## <a name="using-system-views"></a>Использование системных представлений
...
## <a name="sorting-and-filtering-activity-windows"></a>Сортировка и фильтрация окон действий
...
## <a name="performing-batch-actions"></a>Выполнение пакетных действий
...
## <a name="creating-alerts"></a>Создание оповещений
...
### <a name="to-editdeletedisable-an-alert"></a>Изменение, удаление или отключение оповещения
