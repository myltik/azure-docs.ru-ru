<properties 
	pageTitle="Пошаговое руководство. Копирование выходных данных в базу данных SQL Server (портал Azure)" 
...
# Пошаговое руководство. Копирование выходных данных в локальную базу данных SQL Server (портал Azure) 
