---
title: "Копирование данных из Couchbase с помощью фабрики данных Azure (бета-версия) | Документация Майкрософт"
