...
Если источник и приемник (целевое хранилище) данных находятся в облаке, действие копирования включает описанные ниже этапы копирования и переноса данных. Служба, на основе которой реализовано действие копирования, выполняет следующее:
...
Для безопасного переноса данных между локальным хранилищем, защищенным корпоративным брандмауэром, и облачным хранилищем данных, необходимо установить на локальный компьютер шлюз управления данными. Шлюз управления данными — это агент, обеспечивающий гибридное перемещение и обработку данных. Его можно установить на тот же компьютер, где находится хранилище данных, или на отдельную машину с доступом к этому хранилищу.
...
## Дальнейшие действия
- Чтобы получить общие сведения о перемещении данных из исходного хранилища данных в приемник данных с помощью действия копирования, ознакомьтесь со статьей [Копирование данных из хранилища BLOB-объектов Azure в базу данных SQL с помощью фабрики данных](data-factory-copy-data-from-azure-blob-storage-to-sql-database.md).
