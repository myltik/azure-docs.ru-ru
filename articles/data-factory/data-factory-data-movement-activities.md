...
| Источники| Приемники |
|:------- | :---- |
| <ul><li>[Большой двоичный объект Azure](data-factory-azure-blob-connector.md)</li><li>[Таблица Azure](data-factory-azure-table-connector.md)</li><li>[База данных SQL Azure](data-factory-azure-sql-connector.md)</li><li>[Хранилище данных SQL Azure](data-factory-azure-sql-data-warehouse-connector.md)</li><li>[Azure DocumentDB](data-factory-azure-documentdb-connector.md)</li><li>[Azure Data Lake Store](data-factory-azure-datalake-connector.md)</li><li>[Источники OData](data-factory-odata-connector.md)</li><li>[Веб-таблица (в формате HTML)](data-factory-web-table-connector.md)</li><li>[GE Historian в локальной среде или IaaS Azure](data-factory-odbc-connector.md#ge-historian-store)</li><li>[Salesforce](data-factory-salesforce-connector.md)</li><li>[SQL Server в локальной среде или IaaS Azure](data-factory-sqlserver-connector.md)</li><li>[Файловая система в локальной среде или IaaS Azure](data-factory-onprem-file-system-connector.md)</li><li>[База данных Oracle в локальной среде или IaaS Azure](data-factory-onprem-oracle-connector.md)</li><li>[База данных MySQL в локальной среде или IaaS Azure](data-factory-onprem-mysql-connector.md)</li><li>[База данных DB2 в локальной среде или IaaS Azure](data-factory-onprem-db2-connector.md)</li><li>[База данных Teradata в локальной среде или IaaS Azure](data-factory-onprem-teradata-connector.md)</li><li>[База данных Sybase в локальной среде или IaaS Azure](data-factory-onprem-sybase-connector.md)</li><li>[База данных PostgreSQL в локальной среде или IaaS Azure](data-factory-onprem-postgresql-connector.md)</li><li>[Источники данных ODBC в локальной среде или IaaS Azure](data-factory-odbc-connector.md)</li><li>[Распределенная файловая система Hadoop (HDFS) в локальной среде или IaaS Azure](data-factory-hdfs-connector.md)</li><li>[База данных Cassandra в локальной среде или IaaS Azure](data-factory-onprem-cassandra-connector.md)</li></ul> | <ul><li>[Большой двоичный объект Azure](data-factory-azure-blob-connector.md)</li><li>[Таблица Azure](data-factory-azure-table-connector.md)</li><li>[База данных SQL Azure](data-factory-azure-sql-connector.md)</li><li>[Хранилище данных SQL Azure](data-factory-azure-sql-data-warehouse-connector.md)</li><li>[Azure DocumentDB](data-factory-azure-documentdb-connector.md)</li><li>[Azure Data Lake Store](data-factory-azure-datalake-connector.md)</li><li>[База данных SQL Server в локальной среде или IaaS Azure](data-factory-sqlserver-connector.md)</li><li>[Файловая система в локальной среде или IaaS Azure](data-factory-onprem-file-system-connector.md)</li><li>[База данных Oracle в локальной среде или IaaS Azure](data-factory-onprem-oracle-connector.md)</li></ul> |

Если необходимо переместить данные в хранилище или из хранилища данных, которое не поддерживается **действием копирования**, вы можете использовать в фабрике данных **настраиваемое действие** с собственной логикой для копирования и перемещения данных. Сведения о создании и использовании настраиваемого действия см. в статье [Использование настраиваемых действий в конвейере фабрики данных Azure](data-factory-use-custom-activities.md).
...
Действие копирования копирует данные из одного входного набора данных (**источник**) в один выходной набор данных (**приемник**). Данные копируются в пакетном режиме в соответствии с заданным для действия расписанием. Общие сведения об определении действий см. в статье [Конвейеры и действия в фабрике данных Azure: создание конвейеров, цепочки действий и расписаний для них](data-factory-create-pipelines.md).
...
Действие копирования поддерживает разнообразные форматы файлов для файловых хранилищ, включая двоичный (изображения, документы, музыка и др.), текстовый, Avro, ORC и JSON. Однако оно может только считывать внутреннее содержимое структурированных файлов текстового формата, Avro, ORC и JSON. Действие копирования можно использовать для преобразования из одного формата в другой. Пример: преобразование текста (CSV) в Avro. Если данные не структурированы, свойство **Structure** в JSON-файле определения объекта [dataset](data-factory-create-datasets.md) можно опустить.
...
**Предварительный просмотр данных, сопоставление схем и простые преобразования** ![Параметры формата файла](./media/data-factory-data-movement-activities/file-format-settings.png) ![Сопоставление схем](./media/data-factory-data-movement-activities/schema-mapping.png) ![Проверка выражений](./media/data-factory-data-movement-activities/validate-expressions.png)
