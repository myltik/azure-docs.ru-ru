...
Если необходимо переместить данные в хранилище или из хранилища данных, которое не поддерживается **действием копирования**, вы можете использовать в фабрике данных **настраиваемое действие** с собственной логикой для копирования и перемещения данных. Сведения о создании и использовании настраиваемого действия см. в разделе [Использование настраиваемых действий в конвейере фабрики данных Azure](data-factory-use-custom-activities.md).
...
**Шлюз управления данными** или **фабрика данных Azure** выполняет перемещение данных в зависимости от расположения исходного и целевого хранилищ данных во время операции копирования. Дополнительные сведения см. в таблице ниже.
...
### Попробуйте сейчас 
Краткое описание создания конвейера с действием копирования при помощи **мастера копирования фабрики данных** см. в разделе [Руководство. Создание конвейера с действием копирования с помощью мастера копирования фабрики данных](data-factory-copy-data-wizard-tutorial.md).
...
Нажмите кнопку **Обзор** в разделе **Файл или папка**, перейдите к одной из этих папок, скажем, 2016->03->01->02, и щелкните **Выбрать**. В текстовом поле должно появиться: **2016/03/01/02**. Теперь замените **2016** на **{year}**, **03** на **{month}**, **01** на **{day}**, **02** на **{hour}** и нажмите клавишу **TAB**. Вы должны увидеть раскрывающиеся списки, в которых можно выбрать **формат** для этих четырех переменных, как показано ниже.
...
Также можно использовать переменную **custom**, как показано ниже, и любые [поддерживаемые строки формата](https://msdn.microsoft.com/library/8kb3ddd4.aspx). Сначала выберите папку в этой структуре с помощью кнопки "Обзор", затем замените значение переменной на **{custom}** и нажмите клавишу **TAB** для отображения текстового поля, в которое можно ввести строку формата.
