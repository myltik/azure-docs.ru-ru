...
| authenticationType | Тип проверки подлинности, используемый для подключения к источнику OData. <br/><br/> Для облачной службы OData возможны значения "Анонимная" и "Обычная". Для локальной службы OData возможны значения "Анонимная", "Обычная" и "Windows". | Да | 
...
### Использование проверки подлинности Windows при получении доступа к локальному источнику OData
