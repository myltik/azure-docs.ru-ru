---
title: Перемещение данных из источников OData | Microsoft Docs
...
> [!NOTE]
> Этот соединитель OData поддерживает копирование данных и из облачных, и из локальных источников OData. Для копирования из локальных источников необходимо установить шлюз управления данными. Сведения о шлюзе управления данными см. в статье [Перемещение данных между локальными источниками и облаком](data-factory-move-data-between-onprem-and-cloud.md).
> 
> 
