<properties 
	pageTitle="Связанные службы вычислений | Фабрика данных Azure" 
...
- Статья о командлете [New-AzureBatchAccount](https://msdn.microsoft.com/library/mt125880.aspx) поможет вам создать учетную запись пакетной службы Azure или [портал управления Azure](../batch/batch-technical-overview.md), с помощью которого можно создать учетную запись пакетной службы Azure. Подробные инструкции по использованию этого командлета см. в статье [Использование Azure PowerShell для управления учетной записью пакетной службы Azure](http://blogs.technet.com/b/windowshpc/archive/2014/10/28/using-azure-powershell-to-manage-azure-batch-account.aspx).
