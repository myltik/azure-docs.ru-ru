...
* **Версия в связанных службах HDInsight по запросу не указана:**
  ...
  * После **15.07.2017** убедитесь, что вы явно указали значения osType и версии, если вы хотите переопределить параметры по умолчанию. 
