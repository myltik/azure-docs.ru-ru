...
Действие копирования поддерживает копирование данных как в учетные записи хранения Azure общего назначения и в хранилище горячих и холодных BLOB-объектов, так и из них. Это действие поддерживает чтение данных из блочных, добавочных или страничных BLOB-объектов, однако запись поддерживается только в блочные BLOB-объекты. Обратите внимание, что хранилище Azure класса Premium не поддерживается в качестве приемника из-за используемых страничных BLOB-объектов.
