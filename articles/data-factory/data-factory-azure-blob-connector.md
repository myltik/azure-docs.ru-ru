...
---
# <a name="move-data-to-or-from-azure-blob-storage-using-azure-data-factory"></a>Перемещение данных в хранилище BLOB-объектов Azure и обратно с помощью фабрики данных Azure
