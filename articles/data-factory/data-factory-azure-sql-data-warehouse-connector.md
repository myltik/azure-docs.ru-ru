...
> [AZURE.IMPORTANT] При копировании данных из локального хранилища данных в хранилище данных SQL Azure с помощью PolyBase и промежуточного хранения необходимо установить JRE (среда выполнения Java) на компьютере шлюза, который будет использоваться для преобразования исходных данных в правильный формат. Обратите внимание, что для 64-разрядного шлюза требуется 64-разрядная версия JRE, а для 32-разрядного шлюза — 32-разрядная версия JRE. Выберите подходящую для своего шлюза версию [здесь](http://go.microsoft.com/fwlink/?LinkId=808605).
