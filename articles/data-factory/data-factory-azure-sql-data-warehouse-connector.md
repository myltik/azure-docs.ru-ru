...
> 
> В этой статье приведены примеры JSON, но в ней не содержится пошаговых инструкций по созданию фабрики данных. Краткое пошаговое руководство с инструкциями по использованию действия копирования в фабрике данных Azure см. в статье [Copy data from Blob Storage to SQL Database using Data Factory](data-factory-copy-data-from-azure-blob-storage-to-sql-database.md) (Копирование данных из хранилища больших двоичных объектов в базу данных SQL с помощью фабрики данных Azure).
...
2. Тип **входного набора данных** — **BLOB-объект Azure**, тип формата в свойствах типа — **OrcFormat** или **TextFormat** с приведенными ниже конфигурациями:
