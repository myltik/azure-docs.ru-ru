...
> [AZURE.NOTE] Шлюз используется для подключения к источнику MySQL, даже если он размещен на виртуальных машинах IaaS Azure. Если вы подключаетесь к экземпляру MySQL, размещенному в облаке, экземпляр шлюза можно тоже установить на виртуальную машину IaaS.
