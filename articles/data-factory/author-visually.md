...
> [!NOTE]
> У конвейера фабрики данных нет доступа к файлам, которые хранятся в репозитории Git VSTS. В результате вы не сможете сохранить файлы, которые используются действиями конвейера фабрики данных (например, файлы данных и файлы скриптов), в репозитории Git VSTS.
