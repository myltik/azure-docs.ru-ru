...
| fileName | Имя файла в хранилище озера данных Azure. Свойство fileName является необязательным и в нем учитывается регистр знаков. <br/><br/>Если вы укажете имя файла, то любое действие (включая копирование) будет выполняться с конкретным файлом.<br/><br/>Если свойство fileName не указано, будут скопированы все файлы из папки folderPath входного набора данных.<br/><br/>Если свойство fileName не указано для выходного набора данных, то имя созданного файла будет иметь следующий формат: Data.<GUID>.txt (например, Data.0a405f8a-93ff-4c6f-b3be-f69616f1df7a.txt). | Нет |
