...
| Пользователь AAD и источник на основе OAuth находятся не на клиенте фабрики данных, а на другом [клиенте](https://msdn.microsoft.com/library/azure/jj573650.aspx#BKMK_WhatIsAnAzureADTenant). | 12 часов |
