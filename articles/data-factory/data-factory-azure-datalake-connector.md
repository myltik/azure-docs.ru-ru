...
> [!IMPORTANT]
> Если вы используете мастер копирования, для успешного перехода между папками обязательно предоставьте службе-объекту как минимум права на чтение корневого хранилища ADLS ("/") или назначьте роль "Читатель" учетной записи ADLS. Иначе может появиться ошибка "указанные учетные данные недействительны".
>
