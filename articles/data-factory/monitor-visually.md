...
2. Перейдите к колонке созданной фабрики данных и щелкните плитку "Мониторинг и управление". Откроется визуальный интерфейс мониторинга для ADF версии 2.
...
| Состояние | Сбой (Failed), Успешно (Succeeded), Выполняется (In Progress) |
...
Дополнительные сведения о мониторинге и управлении конвейерами см. в статье [Отслеживание фабрики данных Azure с помощью программных средств](https://docs.microsoft.com/en-us/azure/data-factory/monitor-programmatically).
