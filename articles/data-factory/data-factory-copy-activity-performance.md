...
> [!NOTE]
> Если вам требуется больше облачных единиц перемещения данных, чтобы повысить пропускную способность, обратитесь в [службу поддержки Azure](https://azure.microsoft.com/support/). В настоящее время 8 и более облачных единиц перемещения данных поддерживаются только при **копировании нескольких файлов размером не меньше 16 МБ каждый из хранилища BLOB-объектов, Data Lake Store, Amazon S3 или облака FTP в хранилище BLOB-объектов, Data Lake Store или базу данных SQL Azure**.
>
>
...
Рекомендации по настройке шлюза см. в разделе [Особенности использования шлюза управления данными](data-factory-data-management-gateway.md#considerations-for-using-gateway).
