...
В **случае гибридного копирования**, когда источник является локальным, а приемник размещен в облаке, данные из источника переносятся в промежуточное хранилище при помощи **шлюза управления данными**, а оттуда загружаются в приемник **службой фабрики данных Azure**.
...
При копировании данных из облака в локальное хранилище или между двумя локальными хранилищами функция промежуточного хранилища пока не поддерживается. Но вскоре эта возможность будет реализована.
