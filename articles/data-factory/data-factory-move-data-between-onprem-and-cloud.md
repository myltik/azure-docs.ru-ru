...
6. Подождите, пока не будут выполнены следующие условия:
	...
	На вкладке **Главная** можно также выполнить следующие операции: **зарегистрировать** шлюз, используя ключ с портала Azure, с помощью кнопки "Зарегистрировать"; **остановить** службу узла шлюза управления данными на компьютере шлюза; **запланировать установку обновлений** на определенное время суток; просмотреть, когда шлюз был **обновлен последний раз**.
