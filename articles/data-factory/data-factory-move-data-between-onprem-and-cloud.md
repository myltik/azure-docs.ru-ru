...
8.	В диалоговом окне **Настройка учетных данных** выполните следующие действия.
	...
	2. В поле **ИМЯ ПОЛЬЗОВАТЕЛЯ** укажите имя пользователя, у которого есть доступ к базе данных. 
...
6. В колонке "Связанные службы" служба **SqlServerLinkedService** должна иметь состояние "В сети". 
