...
- В корпоративном брандмауэре и брандмауэре Windows следует включить правило исходящих подключений для портов TCP 80, 443 и 9350–9354. Эти порты используются служебной шиной Microsoft Azure для установления соединения между облачными службами и шлюзом управления данными.
