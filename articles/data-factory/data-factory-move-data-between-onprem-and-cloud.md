...
5. Нажмите кнопку **Зашифровать** на панели команд. Откроется диалоговое окно **Настройка учетных данных**. ![Диалоговое окно "Настройка учетных данных"](./media/data-factory-move-data-between-onprem-and-cloud/setting-credentials-dialog.png)
6. В диалоговом окне **Настройка учетных данных** выполните следующие действия.  
	...
	4.	Щелкните **ОК**, чтобы зашифровать учетные данные и закрыть диалоговое окно. 
...
Вы можете установить учетные данные для локального источника данных с помощью приложения **Настройка учетных данных**, запустив его на портале Azure. При этом портал зашифрует учетные данные с помощью сертификата, который указан на вкладке **Сертификат** в **диспетчере конфигурации шлюза управления данными** на компьютере шлюза.
