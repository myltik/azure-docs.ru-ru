...
## Поддерживаемые версии и установка
...
## Пример JSON для копирования данных из Sybase в хранилище BLOB-объектов Azure
...
## Повторяющиеся операции чтения из реляционных источников
