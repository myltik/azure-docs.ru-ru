<properties 
	pageTitle="Соединитель Sybase: перемещение данных из Sybase" 
	description="Cведения о соединителе Sybase для службы фабрики данных, с помощью которого можно перемещать данные из базы данных Sybase." 
...
# Соединитель Sybase: перемещение данных из Sybase 
...
1.	Связанная служба типа OnPremisesSybase.
