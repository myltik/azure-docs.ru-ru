...
19. На **панели инструментов фабрики данных** щелкните **раскрывающийся список** для просмотра всех фабрик данных в вашей подписке Azure. Если вы увидите диалоговое окно **Вход в Visual Studio**, выполните вход следующим образом: 
	20. Введите **адрес электронной почты**, связанный с подпиской Azure, для которой вы создаете фабрику данных, введите **пароль** и нажмите кнопку **Вход**.
