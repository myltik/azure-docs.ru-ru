...
- Visual Studio 2013.
- Скачайте пакет SDK Azure для Visual Studio 2013. Перейдите к [Странице загрузки Azure](http://azure.microsoft.com/downloads/) и нажмите **Установить VS 2013** в разделе **.NET**.
