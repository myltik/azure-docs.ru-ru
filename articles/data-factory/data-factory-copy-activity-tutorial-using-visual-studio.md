...
3. Чтобы создать проект Visual Studio на основе имеющейся фабрики данных, в обозревателе серверов щелкните фабрику данных правой кнопкой мыши и выберите пункт Export Data Factory to New Project (Экспорт фабрики данных в новый проект).
