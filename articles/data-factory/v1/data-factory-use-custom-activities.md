...
Можно настроить пользовательские действия для выполнения на **пакетной службы Azure** пула виртуальных машин. При использовании пакетной службы Azure можно использовать только имеющийся пул пакетной службы Azure.
