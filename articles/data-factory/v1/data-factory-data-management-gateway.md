...
Эта функция будет включена в будущем. В будущих обновлениях (v3.4 или более поздней версии) мы можно включить или отключить все возможности удаленного подключения, происходящее сегодня с помощью приложения PowerShell или диспетчер учетных данных для шифрования учетных данных с помощью порта 8050 (см. выше). 
