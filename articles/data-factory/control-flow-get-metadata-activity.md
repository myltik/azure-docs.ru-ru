...
dataset | Эталонный набор данных, действие которого требуется получить с помощью действия GetMetadata. <br/><br/>В настоящее время в качестве типа набора данных поддерживается большой двоичный объект Azure. Существуют два следующих подсвойства: <ul><li><b>referenceName</b>: ссылка на существующий набор данных большого двоичного объекта Azure.</li><li><b>type</b>: так как существует ссылка на набор данных, используется тип DatasetReference.</li></ul> |    <ul><li>Строка</li><li>DatasetReference</li></ul> | Yes
