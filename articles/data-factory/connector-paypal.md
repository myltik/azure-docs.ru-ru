---
title: "Копирование данных из PayPal с помощью фабрики данных Azure (бета-версия) | Документация Майкрософт"
