...
Обратите внимание, что хотя фабрика данных Azure доступна только в регионах **Западная часть США** и **Северная Европа**, служба, которая обеспечивает перемещение данных, доступна [глобально](data-factory-data-movement-activities.md#global) в нескольких регионах. Если хранилище данных находится за брандмауэром, тогда [шлюз управления данными](data-factory-move-data-between-onprem-and-cloud.md), установленный в локальной среде, перемещает данные вместо этой службы.
