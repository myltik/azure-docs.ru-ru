...
1. Создайте в папке C:\ADFGetStarted JSON-файл MyFirstPipelinePSH.json со следующим содержимым.
   ...
   > [ACOM.NOTE] Дополнительные сведения о свойствах JSON, используемых в приведенном выше примере, см. в статье о [принципе работы конвейера](data-factory-create-pipelines.md#anatomy-of-a-pipeline). 
   > 
   > 
