...
Если срез не находится в состоянии **Ready** (Готов), в списке **Неготовые вышестоящие срезы** вы увидите неготовые вышестоящие срезы, которые блокируют выполнение текущего среза. Когда срез находится в состоянии **Waiting** (Ожидание), это позволяет просмотреть вышестоящие зависимости, влияющие на состояние текущего неготового среза.
...
6. 	В командлете **Save-AzureDataFactoryLog** укажите параметр **-DownloadLogs** и идентификатор, который возвращен командлетом выше, и загрузите файлы журналов.
