...
Фабрика данных Azure предоставляет полное и достоверное представление о службах хранения, обработки и перемещения данных. Она содержит панель мониторинга, с помощью которой можно:
...
В этом разделе также содержатся сведения о переходе среза из одного состояния в другое.   
...
Например, на следующем снимке экрана показано, что в фабрике данных **productrecgamalbox1dev** в конвейере **PartitionProductsUsagePipeline** обнаружена проблема и конвейер нужно приостановить.
