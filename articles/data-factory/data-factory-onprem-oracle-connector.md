...
2. Если сообщение об ошибке появляется даже после установки поставщика, выполните следующие действия. 
	...
	2. Найдите **поставщик данных Oracle для .NET** и найдите запись, аналогичную приведенной ниже, в разделе **system.data** -> **DbProviderFactories**: "<add name="Oracle Data Provider for .NET" invariant="Oracle.DataAccess.Client" description="Oracle Data Provider for .NET" type="Oracle.DataAccess.Client.OracleClientFactory, Oracle.DataAccess, Version=2.112.3.0, Culture=neutral, PublicKeyToken=89b483f429c47342" />"
...
3.	Установите "<ODP.NET Installed Path>\\11.2.0\\client\_1\\odp.net\\bin\\4\\Oracle.DataAccess.dll" в глобальный кэш сборок (GAC), выполнив команду "gacutil /i [путь\_к\_поставщику]".
