...
- **Драйвер Майкрософт для Oracle** включен в комплект шлюза управления данными, начиная с версии 2.7. **Рекомендуется** использовать именно этот драйвер. Для подключения к Oracle не нужно устанавливать ничего, кроме шлюза, а производительность копирования будет выше. Поддерживаются базы данных Oracle версии 10g Release 2 или более поздних версий.
