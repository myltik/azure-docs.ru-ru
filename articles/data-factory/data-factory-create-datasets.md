...
В разделе availability набора данных определяется окно обработки или модель среза для создания наборов данных. Дополнительные сведения о создании срезов данных и модели зависимостей см. в разделе "Срез данных".
