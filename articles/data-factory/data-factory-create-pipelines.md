...
linkedServiceName | Имя связанной службы, используемой действием. <br/><br/> В ряде случаев для действий требуется указать связанную службу, через которую осуществляется подключение к вычислительной среде.| Да — для действия HDInsight и действия пакетной оценки показателей машинного обучения Azure <br/><br/> Нет — для всех остальных действий typeProperties | Свойства в разделе 
typeProperties зависят от типа действия. Дополнительные сведения см. в статьях, посвященных конкретным действиям. | Нет 
