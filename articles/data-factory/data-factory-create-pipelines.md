...
Можно создать и развернуть конвейер, используя шаблон Azure Resource Manager (ARM). Чтобы больше узнать об этом, см. раздел [Начало работы с фабрикой данных Azure с помощью диспетчера ресурсов Azure](data-factory-build-your-first-pipeline-using-arm.md).
