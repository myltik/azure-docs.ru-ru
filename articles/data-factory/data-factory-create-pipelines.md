...
После развертывания конвейера можно управлять им, срезами и циклами выполнения и наблюдать за их состояниями. Дополнительные сведения см. в разделе [Мониторинг конвейеров и управление ими](data-factory-monior-manage-pipelines.md).
