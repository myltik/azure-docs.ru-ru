...
Задайте значение **concurrency** в определения JSON действия больше 1, чтобы во время выполнения несколько срезов обрабатывались параллельно несколькими экземплярами действия. Это весьма полезно при обработке срезов, заполненных в прошлом.
