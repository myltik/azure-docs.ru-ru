...
script path | Путь к файлу сценария Hive в хранилище BLOB-объектов Azure. Можно использовать либо свойство script, либо свойство scriptPath, но не оба сразу. Обратите внимание, что в имени файла учитывается регистр знаков. | Нет 
