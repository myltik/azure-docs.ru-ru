...
| sqlWriterCleanupScript | Запрос на выполнение, который выполняется действием копирования. Позволяет очищать данные конкретного среза. | Инструкция запроса. | Нет | 
...
Как упоминалось в статье о [действиях перемещения данных](data-factory-data-movement-activities.md), во время копирования типы источников автоматически преобразуются в типы приемников. Такое преобразование выполняется в два следующих этапа.
