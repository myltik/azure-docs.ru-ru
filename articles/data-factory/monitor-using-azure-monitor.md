...
| Включено| Логический | Указывает, включена ли коллекция этой метрики или категории журнала для выбранного ресурса.|
...
Чтобы открыть окно метрики, следуйте инструкциям в статье https://docs.microsoft.com/en-us/azure/monitoring-and-diagnostics/monitoring-overview-metrics 
