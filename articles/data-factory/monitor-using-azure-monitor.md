...
* Анализ в **Log Analytics в Operations Management Suite (OMS)**.
...
| ActiviySucceededRuns | Метрики успешных выполнений действий. | Количество    | Итого                | Общее количество успешных выполнений действий в минутном окне.  |
...
Для доступа к метрики, следуйте инструкциям в статье - https://docs.microsoft.com/azure/monitoring-and-diagnostics/monitoring-overview-metrics 
