...
В этом пошаговом руководстве на примере ошибки, которая будет умышленно сделана при выполнении инструкций статьи "Приступая к работе с фабрикой данных", вы узнаете, как можно использовать классический портал Azure для устранения ошибок.
