...
Сейчас фабрика данных Azure поддерживает перемещение данных только в Поиск Azure из [поддерживаемых локальных исходных хранилищ данных](data-factory-data-movement-activities.md#supported-data-stores-and-formats). Она не поддерживает перемещение данных из Поиска Azure в другие хранилища данных.
