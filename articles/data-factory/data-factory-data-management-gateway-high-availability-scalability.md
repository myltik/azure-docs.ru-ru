...
Вы можете обновить имеющийся шлюз, чтобы использовать функцию обеспечения высокого уровня доступности и масштабируемости. Она работает только с узлами, на которых установлен шлюз управления данными версии 2.9.xxxx и более поздней. Версию шлюза управления данными, установленного на компьютере, можно просмотреть на вкладке **Справка** Configuration Manager шлюза управления данными. 
