...
| connectionString |Укажите сведения о параметре connectionString, необходимые для подключения к базе данных SQL Server с помощью проверки подлинности SQL или Windows. Пометьте это поле в качестве SecureString. |Да |
...
| tableName |Имя таблицы или представления экземпляра базы данных SQL Server, на который ссылается связанная служба. | Да |
