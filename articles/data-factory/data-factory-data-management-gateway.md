...
Шлюз использует прокси-сервер для подключения к облачной службе. Во время начальной настройки щелкните ссылку **Изменить**, чтобы открыть диалоговое окно настройки прокси-сервера.
...
1.	В проводнике создайте резервную копию исходного файла в пути C:\\Program Files\\Microsoft Data Management Gateway\\1.0\\Shared\\diahost.exe.config.
...
Если вы не хотите открывать порт 8050 на компьютере шлюза, то настроить учетные данные для хранилища данных с помощью приложения **настройки учетных данных** будет невозможно. Используйте другие механизмы настройки локальной связанной службы. Например, можно использовать командлет PowerShell [New-AzureRmDataFactoryEncryptValue](https://msdn.microsoft.com/library/mt603802.aspx). Дополнительные сведения о настройке учетных данных хранилища данных см. в разделе [Настройка учетных данных и безопасность](#set-credentials-and-securityy).
