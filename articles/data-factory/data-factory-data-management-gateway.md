---
title: Шлюз управления данными для фабрики данных | Microsoft Docs
...
3. В колонке **Шлюз данных** щелкните **Скачивание и установка шлюза данных**.
   
    ![Ссылка для скачивания на портале](media/data-factory-data-management-gateway/download-and-install-link-on-portal.png)   
4. В колонке **Настройка** щелкните **Повторное создание ключа**. Нажмите кнопку "Да" в окне предупреждающего сообщения, внимательно его прочитав.
...
2. Выберите нужный шлюз в разделе **Шлюзы данных** в колонке **Связанные службы**.
...
4. В колонке **Настройка** щелкните **Скачивание и установка шлюза данных**, а затем следуйте инструкциям по установке шлюза данных на компьютере. 
...
6. В колонке **Настройка** на портале щелкните **Повторное создание ключа** на панели команд и щелкните **Да** в окне с предупреждением. Скопируйте ключ в буфер обмена с помощью **кнопки копирования** рядом с текстом ключа. Шлюз на старом компьютере прекращает работу сразу же, как только будет повторно создан ключ.  
