...
### <a name="configure-proxy-server-settings-in-diahostexeconfig"></a>Настройка параметров прокси-сервера в файле diahost.exe.config
...
Сведения и советы по устранению неполадок с помощью шлюза управления данными см. в статье [Troubleshoot issues with using Data Management Gateway](data-factory-troubleshoot-gateway-issues.md) (Устранение неполадок в работе шлюза управления данными).  
