...
> [!TIP]
> Если отобразилось сообщение об ошибке "Пакет, соответствующий запросу на выполнение инструкции SQL, не найден. SQLSTATE=51002 SQLCODE=-805", это указывает на то, что в данной операционной системе не создан требуемый пакет для обычного пользователя. Выполните приведенные ниже инструкции в соответствии с типом сервера DB2.
