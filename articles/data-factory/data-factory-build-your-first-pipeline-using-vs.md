...
21. На странице «Настройка фабрики данных» выполните следующие действия.
	...
	6. Нажмите кнопку **Далее** для перехода на страницу **Публикация элементов**. (Нажмите клавишу **TAB** для выхода из поля «Имя», если кнопка **Далее** недоступна.) 
