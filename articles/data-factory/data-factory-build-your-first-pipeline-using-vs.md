...
- Загрузите пакет SDK Azure для Visual Studio 2013 или Visual Studio 2015. Перейдите на [страницу загрузки Azure](http://azure.microsoft.com/downloads/) и щелкните **VS 2013** или **VS 2015** в разделе **.NET**.
...
2. В диалоговом окне **Новый проект** выберите шаблон **Фабрика данных** и щелкните **Пустой проект фабрики данных**.   
...
21. На странице «Настройка фабрики данных» выполните следующие действия.
	...
	6. Нажмите кнопку **Далее**, чтобы перейти на страницу **Публикация элементов**. (Чтобы выйти из поля «Имя», нажмите клавишу **TAB**, если кнопка **Далее** недоступна.) 
...
6. Войдите на [портал Azure](http://portal.azure.com/) и выполните следующие действия:
...
1. В меню программы **Visual Studio** выберите элемент **Вид** и щелкните **Обозреватель сервера**.
...
2. На панели слева выберите пункт **Обновления**, а затем — **Галерея Visual Studio**.
