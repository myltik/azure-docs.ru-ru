...
2. Выберите существующую фабрику данных или укажите значения для создания новой фабрики данных на странице **Настройка фабрики данных** и нажмите кнопку **Далее**.   
...
6. После завершения операции развертывания нажмите кнопку **Готово**. 
