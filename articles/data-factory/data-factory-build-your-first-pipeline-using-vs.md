...
2. В левой части окна в списке установленных шаблонов выберите пункт **Конфигурация**, затем выберите **Файл конфигурации**, введите **имя** файла конфигурации и нажмите кнопку **Добавить**.
...
3. На странице **Публикация элементов** будет раскрывающийся список **Выбор конфигурации развертывания** с доступными конфигурациями.
