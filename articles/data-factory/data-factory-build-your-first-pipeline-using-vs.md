...
На вашем компьютере должны быть установлены следующие компоненты: Visual Studio 2013. Скачайте пакет SDK Azure для Visual Studio 2013. Перейдите к [странице загрузки Azure](http://azure.microsoft.com/downloads/) и нажмите кнопку **Установить Visual Studio 2013** в разделе **.NET**. — Обновите «Средства Visual Studio для фабрики данных Azure» до последней версии, открыв Visual Studio 2013, выбрав «Средства --> Обновления --> Коллекция Visual Studio» и нажав кнопку «Обновить» подключаемого модуля «Средства Visual Studio для фабрики данных Azure».
...
1. В меню выберите **Средства** и затем **Расширения и обновления**.
2. Выберите **Обновления** в левой панели и затем выберите **Коллекции Visual Studio**.
3. Выберите **Средства фабрики данных Azure для Visual Studio** и щелкните **Обновить**. Если эта запись отсутствует, у вас уже установлена последняя версия средства. 
...
## Отправить отзыв
Мы будем очень благодарны за ваш отзыв об этой статье. Отправьте его [по электронной почте](mailto:adfdocfeedback@microsoft.com?subject=data-factory-build-your-first-pipeline-using-vs.md).
