...
2. Чтобы опубликовать сущности фабрики данных в фабрике данных Azure, необходимо **обладать правами администратора подписки Azure**. Сейчас действует такое ограничение.
...
21. На странице "Настройка фабрики данных" выполните следующие действия.
	...
	2. В поле **Имя** введите **FirstDataFactoryUsingVS**.
		...
		> [AZURE.IMPORTANT] Имя фабрики данных Azure должно быть глобально уникальным. Если при публикации появится сообщение об ошибке **Имя FirstDataFactoryUsingVS фабрики данных недоступно**, измените имя (например, на ваше\_имя\_FirstDataFactoryUsingVS). Ознакомьтесь со статьей [Фабрика данных Azure — правила именования](data-factory-naming-rules.md), чтобы узнать о правилах именования артефактов фабрики данных.
