...
На вашем компьютере должны быть установлены следующие компоненты: Visual Studio 2013. Скачайте пакет SDK Azure для Visual Studio 2013. Перейдите на [страницу загрузок Azure](http://azure.microsoft.com/downloads/) и нажмите кнопку **установки VS 2013** в разделе **.NET**.
