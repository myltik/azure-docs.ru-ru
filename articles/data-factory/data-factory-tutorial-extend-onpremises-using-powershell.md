...
10.	Это действие устанавливает приложение, запускаемое одним щелчком при первом входе, и открывает **диалоговое окно **Установка учетных данных.11.	В диалоговом окне **Установка учетных данных** введите **Имя пользователя** и **Пароль**, затем нажмите **ОК**. Подождите, пока закроется диалоговое окно. 
