...
См. раздел **Ограничения фабрики данных Azure** в статье [Подписка Azure и ограничения служб, квоты и ограничения](azure-subscription-service-limits.md/#data-factory-limits)
...
Действие копирования поддерживает копирование данных в следующих регионах: восточный регион США, восточный регион США 2, западный регион США, центральный регион США, северо-центральный регион США, юго-центральный регион США, Северная Европа, Западная Европа, Юго-Восточная Азия, восточная часть Японии и южная часть Бразилии.
