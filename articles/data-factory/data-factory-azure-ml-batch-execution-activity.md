...
1. В веб-службу оценки добавьте конечную точку, которая не будет являться точкой по умолчанию. Конечная точка веб-службы по умолчанию не допускает изменений, поэтому вам нужно будет создать новую точку с помощью портала управления Azure. Основные сведения и инструкции см. в статье [Создание конечных точек](../machine-learning/machine-learning-create-endpoint.md).
...
#### Связанная служба для обновляемой конечной точки машинного обучения Azure
