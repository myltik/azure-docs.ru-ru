...
Если для свойства format задано значение **TextFormat**, в подразделе **Format** раздела **typeProperties** вы можете указать приведенные ниже **необязательные** свойства.
