...
> 
> Советы по устранению неполадок, связанных со шлюзом или подключением, см. в разделе [Устранение неполадок со шлюзом](data-factory-move-data-between-onprem-and-cloud.md#gateway-troubleshooting).
