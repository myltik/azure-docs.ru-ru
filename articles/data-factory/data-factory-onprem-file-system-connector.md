<properties
    pageTitle="Перемещение данных в файловую систему и из нее | Microsoft Azure"
...
> [AZURE.NOTE] Мы рекомендуем вам [обновить свой шлюз управления данными до версии 2.0 и выше](data-factory-data-management-gateway.md#update-data-management-gateway), чтобы получить преимущества последних функций и исправлений.
...
> [AZURE.NOTE] Свойства filename и fileFilter невозможно использовать одновременно.
