...
1. На портале управления Azure создайте учетную запись Пакетной службы Azure. Инструкции см. в статье [Создание учетной записи пакетной службы Azure и управление ею][batch-create-account]. Запишите ключ и имя учетной записи Пакетной службы Azure.
