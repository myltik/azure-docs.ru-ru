.<properties 
	pageTitle="Руководство. Создание конвейера с действием копирования с помощью редактора фабрики данных | Microsoft Azure" 
