...
## <a name="current-version-2762192"></a>Текущая версия (2.7.6219.2)

### <a name="whats-new"></a>Новые возможности
- Аутентификацию в Azure Data Lake Store можно выполнить с помощью субъект-службы. Раньше эта функция поддерживалась только в OAuth.
- Мы также добавили драйвер для считывания данных из локального хранилища данных Oracle в шлюзе.

### <a name="enhancements-"></a>Улучшения
- Улучшенная производительность чтения данных из источника данных Oracle.
- Исправлено. Проблема с истечением срока действия маркера OAuth в источнике OData.
- Исправлено. Проблема с невозможностью чтения десятичных чисел, длина которых превышает 28 бит, в Oracle.
