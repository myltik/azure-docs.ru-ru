...
Среда выполнения интеграции должен быть связан с хранилищем данных каждого источника и приемника. Дополнительные сведения о том, как действие копирования определяет, какую IR использовать, см. в [этом разделе](concepts-integration-runtime.md#determining-which-ir-to-use).
