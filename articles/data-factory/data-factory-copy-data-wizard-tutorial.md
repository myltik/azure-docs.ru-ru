<properties 
    pageTitle="Руководство. Создание конвейера с действием копирования с помощью мастера копирования фабрики данных | Microsoft Azure" 
...
10. На странице **Сопоставление схемы** нажмите кнопку **Далее**.
...
12. На странице **развертывания** щелкните ссылку: `Click here to monitor copy pipeline`.
...
13. Чтобы получить сведения о способах отслеживания созданного вами конвейера, изучите инструкции в статье [Мониторинг конвейеров фабрики данных Azure и управление ими с помощью нового приложения по мониторингу и управлению](data-factory-monitor-manage-app.md) . Щелкните значок **обновления** в списке **Окна действий**, чтобы просмотреть срез. 
