...
# Учебник. Перемещение и обработка файлов журнала с помощью фабрики данных Azure (на портале Azure)  
...
6. [Мониторинг конвейеров](#monitor-pipelines). На этом шаге вы выполните мониторинг конвейеров, таблиц и срезов данных с помощью классического портала Azure.
