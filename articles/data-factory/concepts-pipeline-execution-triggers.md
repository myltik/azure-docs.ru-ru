...
Триггер "переворачивающегося" окна — это тип триггера, который активируется с определенным интервалом начиная с указанного времени запуска, сохраняя состояние. "Переворачивающиеся" окна — это ряд неперекрывающихся и несоприкасающихся интервалов времени фиксированного размера. Дополнительные сведения об этом типе триггеров и примеры см. в статье, посвященной [созданию триггера "переворачивающегося" окна](how-to-create-tumbling-window-trigger.md).
