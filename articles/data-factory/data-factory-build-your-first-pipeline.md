...
1.	**Подписка Azure**. Если ее нет, можно за пару минут создать бесплатную пробную учетную запись. Сведения о том, как получить такую учетную запись, см. на странице [Бесплатный ознакомительный период](http://azure.microsoft.com/pricing/free-trial/).
...
Для выполнения этой задачи можно использовать любое средство на свой выбор (например, обозреватель хранилищ Azure или CloudXPlorer от ClumsyLeaf Software). В этом разделе приводятся инструкции по использованию средства AzCopy.
