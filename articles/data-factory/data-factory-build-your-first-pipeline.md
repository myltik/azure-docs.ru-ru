...
В этой статье содержится **обзор** учебника и пошаговые инструкции, помогающие выполнить **предварительные требования** для работы с данным учебником. После выполнения предварительных требований для прохождения этого учебника воспользуйтесь одним из следующих инструментов: редактор фабрики данных на портале Azure, Visual Studio, Azure PowerShell или шаблон Azure Resource Manager.
