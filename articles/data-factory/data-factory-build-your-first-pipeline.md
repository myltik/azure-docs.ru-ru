...
Если вы хотите быстро ознакомиться с различными возможностями фабрики данных, не создавая ее с нуля, используйте готовые образцы, представленные на портале Azure. Инструкции по развертыванию образца, предназначенного для определенного сценария, с помощью портала Azure, см. в статье [Обновление фабрики данных Azure: упрощенное развертывание образца](http://azure.microsoft.com/blog/2015/04/24/azure-data-factory-update-simplified-sample-deployment/).
...
- Щелкните ссылку [Использование редактора фабрики данных](data-factory-build-your-first-pipeline-using-editor.md) вверху, чтобы пройти руководство, используя редактор фабрики данных, который является компонентом классического портала Azure.
