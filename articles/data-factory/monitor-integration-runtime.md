...
| Состояние | Состояние локальной среды выполнения интеграции и каждого узла. например, "В сети", "Автономно", "Ограничено" и т. д. Дополнительные сведения об этих состояниях указаны в следующем разделе. | 
...
| Состояние | Описание |
| ------ | ----------- | 
| Starting | Этот узел будет подготовлен. |
...
| Starting | Узлы среды выполнения интеграции SSIS Azure выделяются или подготавливаются, выставления счетов запущено. |
