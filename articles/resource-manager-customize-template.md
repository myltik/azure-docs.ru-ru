---
title: Настройка экспортированного шаблона Resource Manager | Microsoft Docs
...
1. Чтобы использовать для развертывания свой скрипт, сделайте следующее.
...
2. Если вы скачали экспортированный шаблон и скрипты, найдите файл **deploy.ps1** (для PowerShell) или файл **deploy.sh** (для интерфейса командной строки Azure).
