...
>[AZURE.NOTE]Если используется поставщик идентификаторов, отличный от Google, измените значение, переданное в метод **authorizeClient**, на одно из следующих: *microsoftaccount*, *facebook*, *twitter* или *windowsazureactivedirectory*.
