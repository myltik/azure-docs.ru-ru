...
Используйте следующий командлет, чтобы включить перенаправление USB на уровне коллекции:
