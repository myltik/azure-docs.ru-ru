...
Дополнительную информацию о создании виртуальных машин Linux в Azure см. в разделе [Создание виртуальной машины с ОС Linux](../virtual-machines-linux-tutorial/).
...
На виртуальной машине *script-vm* должен быть установлен интерфейс xplat-cli и она должна быть подключена к Azure. Дополнительную информацию см. в разделе [Установка и настройка кроссплатформенного интерфейса командной строки Azure](../xplat-cli/).
