...
6. Измените заполнители **your_service_bus_namespace**, **your_service_bus_owner** и **your_service_bus_key** на значения **Пространство имен**, **Издатель по умолчанию** и **Ключ по умолчанию** для служебной шины соответственно.
...
5. Измените заполнители **your_service_bus_namespace**, **your_service_bus_owner** и **your_service_bus_key** на значения **Пространство имен**, **Издатель по умолчанию** и **Ключ по умолчанию** для служебной шины соответственно.
