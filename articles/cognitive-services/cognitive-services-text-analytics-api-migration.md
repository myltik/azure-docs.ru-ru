...
1. Перейдите к службе анализа текста с помощью [Коллекции Cortana Analytics](//gallery.cortanaanalytics.com/MachineLearningAPI/Text-Analytics-2). Здесь вы также найдете ссылки на документацию и примеры кода.
...
1. Выберите план. Вы можете выбрать **уровень "Бесплатный" на 5 000 транзакций в месяц**. Так как это бесплатный план, плата за его использование взиматься не будет. Вам понадобится войти в подписку Azure.
