...
В настоящее время поддерживаются два типа сборки: *рекомендации* и *FBT*. Для создания каждой сборки используются разные алгоритмы. Кроме того, у каждой из них есть свои преимущества.
