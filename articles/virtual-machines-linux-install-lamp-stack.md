...
1. Настройка **Apache**
	...
	- Apache по умолчанию прослушивает порт 80. Возможно, для удаленного доступа к серверу Apache вам необходимо будет открыть конечную точку.  Подробные указания см. в документации по [настройке конечных точек](http://azure.microsoft.com/ru-ru/documentation/articles/virtual-machines-set-up-endpoints/) .
...
2. Настройка **MySQL**
	...
	- Обратите внимание, что этот шаг необязателен в Ubuntu, где при установке пакета mysql-server запрашивается корневой пароль MySQL.
