...
После выполнения приведенной выше команды вам будет предложено установить эти пакеты и некоторые другие зависимости.  Нажмите 'y' and then 'Enter' для продолжения и выполните другие указания, чтобы задать административный пароль для MySQL.
...
После выполнения приведенной выше команды вам будет предложено установить эти пакеты и некоторые другие зависимости.  Нажмите 'y' and then 'Enter' для продолжения.
...
1. Настройка **Apache**
	...
	- Apache по умолчанию прослушивает порт 80. Возможно, для удаленного доступа к серверу Apache вам необходимо будет открыть конечную точку.  Подробные указания см. в документации по [настройке конечных точек](http://azure.microsoft.com/documentation/articles/virtual-machines-set-up-endpoints/).
