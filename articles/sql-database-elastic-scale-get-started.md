...
С перечнем всех разделов на тему эластичного масштабирования можно ознакомиться на странице [Карта документации по эластичному масштабированию][Карта документации по эластичному масштабированию]
...
-   [Страница по изучению технологии эластичного масштабирования][Карта документации по эластичному масштабированию]
...
<!--Anchors--> <!--Image references-->
  ...
  [Карта документации по эластичному масштабированию]: ./sql-database-elastic-scale-documentation-map.md
