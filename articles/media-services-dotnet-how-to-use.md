...
Ниже приводится список доступных клиентских пакетов SDK и платформ проигрывателя.  Дополнительные сведения об этих и других запланированных пакетах SDK и платформах проигрывателя, а также поддерживаемых ими функциональных возможностях см. в разделе [Разработка клиента для служб мультимедиа][] форумов по службам мультимедиа. 
...
##Дальнейшие действия
Теперь, когда вы ознакомились с обзором служб мультимедиа, перейдите к раздел [Настройка компьютера для служб мультимедиа](http://go.microsoft.com/fwlink/?LinkId=301751).
  ...
  [Подключение к службам мультимедиа программными средствами]: #connect
  [Практическое руководство. Создание шифрованного актива и его передача в хранилище]: #create-asset
  [Получение экземпляра процессора мультимедиа]: #get-mediaproc
  [Практическое руководство. Проверка хода выполнения задания]: #check-job-progress
  [Практическое руководство. Шифрование актива]: #encode-asset
  [Практическое руководство. Защита актива с помощью PlayReady Protection]: #playready
  [Практическое руководство. Управление активами в хранилище]: #manage-asset
  [Доставка актива путем загрузки]: #download-asset
  [Практическое руководство. Доставка потокового контента]: #stream-asset
  [Практическое руководство. Доставка контента потоковой передачи Apple HLS]: #stream-HLS
  [Практическое руководство. Включение Azure CDN]: #enable-cdn
  ...
  [Предварительный просмотр служб мультимедиа: поддерживаемые возможности]: http://social.msdn.microsoft.com/Forums/ru-ru/MediaServices/thread/eb946433-16f2-4eac-834d-4057335233e0
  [Предстоящие выпуски служб мультимедиа: поддержка запланированных возможностей]: http://social.msdn.microsoft.com/Forums/ru-ru/MediaServices/thread/431ef036-0939-4784-a939-0ecb31151ded
  ...
  [Начало работы с Azure CDN]: http://msdn.microsoft.com/ru-ru/library/windowsazure/ff919705.aspx
