...
Самая последняя документация по пакету SDK для служб мультимедиа находится [здесь][].
...
Теперь, когда вы ознакомились с обзором служб мультимедиа, перейдите к раздел [Настройка компьютера для служб мультимедиа][].
  ...
  [здесь]: http://msdn.microsoft.com/en-us/library/hh973613.aspx
  [Архитектура служб мультимедиа]: ./media/media-services-dotnet-how-to-use/wams-01.png
  [Поддерживаемые типы файлов для служб мультимедиа]: http://msdn.microsoft.com/en-us/library/hh973634
  ...
  [Клиент бесперебойной потоковой передачи для Silverlight]: http://www.microsoft.com/en-us/download/details.aspx?id=29940
  ...
  [Пошаговое руководство: Создание первого проигрывателя с потоковой передачей Smooth Streaming на HTML5]: http://msdn.microsoft.com/en-us/library/jj573656(v=vs.90).aspx
