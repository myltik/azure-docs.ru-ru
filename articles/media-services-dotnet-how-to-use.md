<properties pageTitle="Использование служб мультимедиа" description="" services="media-services" documentationCenter="" authors="juliako" manager="dwrede" editor=""/>
...
-	[Клиент Smooth Streaming для Silverlight](http://www.microsoft.com/ru-ru/download/details.aspx?id=29940)
-	[Платформа Microsoft Media: платформа проигрывателя для Silverlight](http://smf.codeplex.com/documentation)
-	[Подключаемый модуль Smooth Streaming для OSMF 2.0](http://go.microsoft.com/fwlink/?LinkId=275022). Сведения об этом подключаемом модуле см. в разделе [Использование подключаемого модуля Smooth Streaming для Adobe Open Source Media Framework](../media-services-use-osmf-smooth-streaming-client-plugin/).
...
-	[Пакет для портирования клиента Smooth Streaming](http://www.microsoft.com/ru-ru/mediaplatform/sspk.aspx)
...
## Дальнейшие действия
Теперь, когда вы ознакомились с обзором служб мультимедиа, перейдите в раздел [Настройка компьютера для служб мультимедиа](../media-services-set-up-computer/) topic.
  ...
  [Практическое руководство. Создание зашифрованного актива и его отправка в хранилище]: #create-asset
  ...
  [Практическое руководство. Кодировка актива]: #encode-asset
  ...
  [Практическое руководство. Доставка актива путем скачивания]: #download-asset
  ...
  [Практическое руководство. Включение сети Azure CDN]: #enable-cdn
  ...
  [Протокол Open Data]: http://odata.org/
  [Службы данных WCF 5.0 для OData v3]: http://www.microsoft.com/download/en/details.aspx?id=29306
  ...
  [Предварительная версия служб мультимедиа:  поддерживаемые функции]: http://social.msdn.microsoft.com/Forums/ru-ru/MediaServices/thread/eb946433-16f2-4eac-834d-4057335233e0
  [Предстоящие выпуски служб мультимедиа:  планируемые поддерживаемые функции]: http://social.msdn.microsoft.com/Forums/ru-ru/MediaServices/thread/431ef036-0939-4784-a939-0ecb31151ded
  ...
  [Начало работы с пакетом SDK служб мультимедиа для .NET]: http://go.microsoft.com/fwlink/?linkid=252966
