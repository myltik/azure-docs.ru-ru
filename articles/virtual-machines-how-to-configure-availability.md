<properties title="How to Configure An Availability Set for Virtual Machines" pageTitle="Настройка группы доступности для виртуальных машин" description="Gives the steps to configure an availability set for a VM in Azure" metaKeywords="" services="virtual-machines" solutions="" documentationCenter="" authors="kathydav" manager="timlt" videoId="" scriptId="" />
...
3. Щелкните **Виртуальная машина**, а затем выберите **Из коллекции**.
...
2.	Получите имя образа, который вы хотите использовать для создания виртуальной машины, и сохраните его в переменной. Следующий пример команды использует номер индекса для получения свойства ImageName объекта образа. В нем предполагается, что вы знаете текущий номер индекса необходимого вам образа, и что вы замените этот номер на index_number. <br>

	`C:\PS> $image = (Get-AzureVMImage)[<index_number>].ImageName`

	>[WACOM.NOTE] Для получения списка всех образов, доступных для вашей подписки, выполните команду Get-AzureVMImage без параметров. В результате вы можете получить большой список. Чтобы сократить его, используйте свойства, такие как имя семейства образов. Подсказки и примеры, демонстрирующие как найти определенный образ, см. в разделе [Управление образами с помощью Windows PowerShell](http://msdn.microsoft.com/ru-ru/library/azure/dn790330.aspx).
...
[Информация о параметрах конфигурации виртуальной машины Azure]
...
[Общие сведения о виртуальных сетях]: http://go.microsoft.com/fwlink/p/?linkid=294063
