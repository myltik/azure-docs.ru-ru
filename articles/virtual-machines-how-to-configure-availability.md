...
5. На третьем экране можно настроить ресурсы сети, хранилища и доступности. Выполните следующие действия.
...
5. В разделе "Параметры" найдите элемент **Группа доступности**. Выполните одно из следующих действий.
...
Чтобы использовать команды Azure PowerShell, откройте сеанс Azure PowerShell уровня администратора и выполните следующую команду. Для заполнителей (таких как &lt;VmCloudServiceName&gt;) замените все содержимое внутри кавычек, включая символы < и >, на правильные имена.
...
=======
[Подключение виртуальных машин в облачной службе]: ../cloud-services-connect-virtual-machine
[О параметрах конфигурации виртуальной машины Azure]: http://msdn.microsoft.com/library/azure/dn763935.aspx
>>>>>>> 1dc830a16302e6b943a5d55ebacef659451b22d6
