...
2.  В меню **Файл** выберите **Новый проект**.
    ...
    ![Меню нового проекта][Меню нового проекта]
...
5.  В диалоговом окне **Новая облачная служба Azure** выберите **Веб-роль ASP.NET** и щелкните стрелку вправо.
    ...
    ![Диалоговое окно нового облачного проекта Azure][Диалоговое окно нового облачного проекта Azure]
...
7.  Введите MvcWebRole в качестве нового имени и нажмите клавишу ВВОД.
    ...
    ![Диалоговое окно нового облачного проекта Azure — переименование веб-роли][Диалоговое окно нового облачного проекта Azure — переименование веб-роли]

8.  Выполните ту же процедуру для добавления элемента **Рабочая роль**, присвойте ему имя WorkerRoleA и нажмите кнопку **ОК**.

    ![Диалоговое окно нового облачного проекта Azure — добавление рабочей роли][Диалоговое окно нового облачного проекта Azure — добавление рабочей роли]
...
10. В диалоговом окне **Изменить аутентификацию** щелкните **Без аутентификации** и нажмите кнопку **ОК**.
    ...
    ![Нет проверки подлинности][Нет проверки подлинности]
...
1.  Если [завершенное решение][завершенное решение] еще не загружено, сделайте это, прежде чем перейти к следующему шагу.
...
1.  Для запуска приложения нажмите сочетание клавиш CTRL+F5.
    ...
    ![Эмулятор вычислений на панели задач][Эмулятор вычислений на панели задач]
...
1.  В меню **Сервис** Visual Studio наведите указатель на элемент **Диспетчер пакетов библиотеки** и затем выберите **Управление пакетами NuGet для решения**.
    ...
    ![Управление пакетами NuGet для решения в меню][Управление пакетами NuGet для решения в меню]
...
2.  В левой части диалогового окна **Управление пакетами NuGet** выберите **Обновления**, затем выполните прокрутку вниз до пакета **Хранилище Azure** и щелкните элемент **Обновить**.
    ...
    ![Пакет хранилища Azure в диалоговом окне "Управление пакетами NuGet"][Пакет хранилища Azure в диалоговом окне "Управление пакетами NuGet"]

3.  Убедитесь, что в диалоговом окне **Выбор проектов** выбраны оба проекта, и нажмите кнопку **ОК**.

    ![Выбор обоих проектов в диалоговом окне "Выбор проектов"][Выбор обоих проектов в диалоговом окне "Выбор проектов"]
...
1.  В **обозревателе решений** щелкните правой кнопкой мыши элемент **MvcWebRole** в области **Роли** облачного проекта **AzureEmailService**, а затем выберите пункт **Свойства**.
    ...
    ![Свойства веб-роли][Свойства веб-роли]
...
1.  Запустите проект, нажав сочетание клавиш CTRL+F5.
    ...
    ![Пустая страница индексов MailingList][Пустая страница индексов MailingList]
...
2.  Используйте функцию **Создать**, чтобы добавить списки рассылки, и попробуйте использовать функции **Изменить** и **Удалить**, чтобы убедиться, что они работают.
    ...
    ![Страница индексов MailingList со строками][Страница индексов MailingList со строками]
...
1.  Запустите проект, нажав сочетание клавиш CTRL+F5, а затем щелкните элемент **Подписчики**.
    ...
    ![Пустая страница индексов подписчиков][Пустая страница индексов подписчиков]

2.  Используйте функцию **Создать**, чтобы добавить списки рассылки, и попробуйте использовать функции **Изменить** и **Удалить**, чтобы убедиться, что они работают.

    ![Страница индексов подписчиков со строками][Страница индексов подписчиков со строками]
...
1.  Запустите проект, нажав сочетание клавиш CTRL+F5, а затем щелкните элемент **Сообщения**.
    ...
    ![Пустая страница индексов сообщений][Пустая страница индексов сообщений]
