...
![Совместное использование шаблона](media/share-template-portal1a.png) <br />
 ...
 Теперь можно выбрать роль и пользователя или группу для предоставления доступа к конкретному **шаблону**. Доступные роли: "Владелец", "Читатель" и "Участник". Дополнительную информацию см. в разделе о [контроле доступа](#access-control-for-a-tenant-resource-provider) ниже.
