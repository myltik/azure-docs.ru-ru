...
3. Во всплывающем окне введите следующую информацию:
	...
	- **Платформа**. Выберите целевую платформу для этого приложения (**iOS**) (если приложение предназначено для нескольких платформ, изучите этот учебник для каждой платформы). 
...
В этом учебнике описаны действия по базовой интеграции, т. е. минимум, требуемый для сбора данных и отправки push-уведомлений. Полную документацию по интеграции можно найти в [документации по Mobile Engagement iOS SDK].
...
3. Заполните поля **Название продукта**, **Название организации** и **Идентификатор организации**. Убедитесь, что в качестве языка выбран **Objective C**.
...
6. Вернитесь на страницу портала Azure *Информация о подключении* для вашего приложения и скопируйте строку подключения.
