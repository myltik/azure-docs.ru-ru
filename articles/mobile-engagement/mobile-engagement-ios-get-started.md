...
В этом руководстве описаны действия по базовой интеграции, т. е. минимум, необходимый для сбора данных и отправки push-уведомлений. Полную документацию по интеграции см. в статье [Интеграция пакета Mobile Engagement iOS SDK](../mobile-engagement-ios-sdk-overview/)
...
7. На странице **Информация о подключении** вашего приложения вернитесь на портал Azure и скопируйте строку подключения.
