...
-   Можно переопределить метод `OnActivated` для включения Engagement Reach при активации вашего приложения с помощью команды, пользовательской схемы или другим приложением:
