...
Настройка решения Azure Mobile Engagement очень проста. Вся документация, связанная с пользовательским интерфейсом, доступна на веб-сайте Azure Mobile Engagement [Навигация по пользовательскому интерфейсу](mobile-engagement-user-interface.md).
