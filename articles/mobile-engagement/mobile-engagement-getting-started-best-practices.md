...
Настройка решения Azure Mobile Engagement очень проста. Вся документация, связанная с пользовательским интерфейсом, доступна на веб-сайте Azure Mobile Engagement [Навигация по пользовательскому интерфейсу](mobile-engagement-user-interface-navigation.md).
...
Дальнейшие действия. Зарегистрируйте идентификатор устройства для тестирования на собственном устройстве. Откройте параметры учетной записи и настройте часовой пояс для доставки диаграмм и уведомлений в соответствии с вашим временем. Откройте параметры приложения и зарегистрируйте «информацию приложения», необходимую для охвата конечных пользователей.
