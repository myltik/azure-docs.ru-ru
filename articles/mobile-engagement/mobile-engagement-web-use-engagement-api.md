---
title: "Интерфейсы API веб-пакета SDK для Azure Mobile Engagement | Документация Майкрософт"
...
## <a name="mobile-engagement-concepts"></a>Основные понятия Mobile Engagement
