...
> [!IMPORTANT]
> Перед продолжением прочтите предупреждение об атрибуте android:process \<android-sdk-engagement-process\> в разделе "Интеграция Engagement на платформе Android".
> 
> 
