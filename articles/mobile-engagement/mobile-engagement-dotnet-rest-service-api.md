...
1. Добавьте в класс `Program` следующие два метода. Они будут использоваться для выполнения интерфейсов API REST и отображения ответов в консоли.
...
4. Постройте и запустите свое приложение. Вывод приложения должен быть аналогичен приведенному ниже:
