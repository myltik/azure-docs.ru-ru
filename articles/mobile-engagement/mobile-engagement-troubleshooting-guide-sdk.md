...
- Адаптирующееся расположение или GPS-расположение неправильно интегрировано в пакет SDK (отслеживание по GPS-расположению). [Документация по пакету SDK — руководства по интеграции][Link 5], [Руководство по устранению неполадок — push-уведомления][Link 23]
...
- использованием API связана с неправильным использованием ключа пакета SDK и ключа API. [Основные понятия — глоссарий][Link 6]
...
### Дополнительные материалы
 ...
 - [Руководство по устранению неполадок — push-уведомления][Link 23], [Документация по пакету SDK — примечания к выпуску][Link 5], [Документация по пакету SDK — руководства по обновлению][Link 5], [Документация по пакету SDK — Android — обзор технической документации Azure Mobile Engagement][Link 5], [Документация по пакету SDK — iOS — обзор технической документации Azure Mobile Engagement][Link 5], [Документация по пакету SDK — iOS — как подготовить приложение для push-уведомлений Apple][Link 5], [Разработчик Android](https://developer.android.com/), [Разработчик iOS](https://developer.apple.com/), [Разработчик Windows](https://developer.windows.com/) 
...
- [Принципы — вопросы и ответы][Link 6], [Принципы — глоссарий][Link 6], [Документация по API — аналитические API — сбои][Link 4], [Документация по пользовательскому интерфейсу — аналитика — сбои][Link 15], [Документация по пользовательскому интерфейсу — параметры][Link 20], [Документация по пакету SDK — примечания к выпуску][Link 5], [Документация по пакету SDK — руководства по обновлению][Link 5]
...
- [Документация по пакету SDK — примечания к выпуску][Link 5], [Документация по пакету SDK — руководства по обновлению][Link 5] 
