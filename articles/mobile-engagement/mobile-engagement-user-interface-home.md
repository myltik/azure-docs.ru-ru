---
title: Пользовательский интерфейс Azure Mobile Engagement — домашняя страница
...
В этой статье описывается **Главная** страница портала **Mobile Engagement**. Портал **Mobile Engagement** используется для отслеживания мобильных приложений и управления ими. Обратите внимание, что для того, чтобы начать пользоваться порталом, сначала необходимо создать учетную запись **Azure Mobile Engagement**.
