---
title: "Пользовательский интерфейс Azure Mobile Engagement — Содержимое рекламных кампаний"
...
* [Рекламная кампания — практические руководства — объявления][Link 3] 
...
* **Действия только для iOS**
  ...
  * http://itunes.apple.com/[страна]/app/[имя приложения]/id[идентификатор приложения]?mt=8; 
...
### <a name="see-also"></a>Дополнительные материалы
* [Документация по пользовательскому интерфейсу — рекламная кампания — создание нового условия для push-уведомлений][Link 28]
