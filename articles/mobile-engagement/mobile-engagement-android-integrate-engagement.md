...
Загрузите пакет Android SDK [отсюда](https://aka.ms/vq9mfn). Поместите `mobile-engagement-VERSION.jar` в папку `libs` вашего проекта Android (создайте папку libs, если она еще не создана).
