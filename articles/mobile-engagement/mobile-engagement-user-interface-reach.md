...
>[AZURE.NOTE] Многие части интерфейса портала **Mobile Engagement** оснащены кнопкой **ПОКАЗАТЬ СПРАВКУ**. Нажмите ее, чтобы получить больше контекстной информации по соответствующему разделу.
