...
2.	**Доставленные** — это число сообщений, успешно доставленных службой push-уведомлений на устройство и признанных полученными пакетом SDK Mobile Engagement.
...
4.	**Взаимодействие с пользователем** — число уведомлений, с которыми пользователь приложения взаимодействовал, включая активацию и выход.
