---
title: Начало работы с Azure Mobile Engagement для Cordova (Phonegap)
...
> [!NOTE]
> Исходный код и файл сведений о подключаемом модуле Cordova можно найти на сайте [Github](https://github.com/Azure/azure-mobile-engagement-cordova)
> 
> 
