---
title: "Пользовательский интерфейс Azure Mobile Engagement — Рекламная кампания"
...
* [Документация по пользовательскому интерфейсу — рекламная кампания — содержимое рush-уведомления][Link 29]
...
### <a name="see-also"></a>Дополнительные материалы
* [Рекламная кампания — практические руководства — планирование][Link 3] 
