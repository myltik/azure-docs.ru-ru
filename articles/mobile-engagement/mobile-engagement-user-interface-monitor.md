...
>[AZURE.NOTE] Многие части пользовательского интерфейса портала **Mobile Engagement** содержат кнопку **ПОКАЗАТЬ СПРАВКУ**. Нажмите ее, чтобы получить больше контекстной информации по соответствующему разделу.
