...
### <a name="usecases-to-get-started"></a>Случаи использования для начала работы
...
### <a name="usecases-and-best-practices"></a>Случаи использования и рекомендации
...
#### <a name="mcommerce"></a>Мобильная коммерция
...
[Учебные материалы]: http://azure.microsoft.com/documentation/articles/mobile-engagement-ios-get-started/
