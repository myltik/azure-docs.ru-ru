...
4. На портале Azure Mobile Engagement перейдите на вкладку **Охват**. Выберите тип push-уведомления (объявление, опрос и т. д.). В данном примере мы выберем объявление.
