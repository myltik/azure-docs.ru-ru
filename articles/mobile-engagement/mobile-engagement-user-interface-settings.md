...
>[AZURE.NOTE] Многие части интерфейса портала **Mobile Engagement** содержат кнопку **ПОКАЗАТЬ СПРАВКУ**. Нажмите ее, чтобы получить больше контекстной информации по соответствующему разделу.
