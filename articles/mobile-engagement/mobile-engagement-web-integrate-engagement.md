---
title: "Интеграция веб-пакета SDK для Azure Mobile Engagement | Документация Майкрософт"
...
---
# <a name="integrate-azure-mobile-engagement-in-a-web-application"></a>Интегрирование Azure Mobile Engagement в веб-приложение
...
[Скачайте веб-пакет SDK для Azure Mobile Engagement](http://aka.ms/P7b453).
Веб-пакет SDK для Mobile Engagement поставляется как отдельный файл JavaScript с именем azure-engagement.js, который необходимо включить в каждую страницу сайта или веб-приложения.

> [!IMPORTANT]
> Этот сценарий необходимо выполнить после выполнения фрагмента сценария или кода, который вы создаете, чтобы настроить Mobile Engagement для приложения.
> 
> 
...
## <a name="configure-mobile-engagement"></a>Настройка Mobile Engagement
...
## <a name="include-mobile-engagement-scripts-in-your-pages"></a>Добавление сценариев Mobile Engagement в страницы
...
API Mobile Engagement позволяет использовать все расширенные возможности этой службы. Дополнительные сведения об API см. в статье [Использование API Azure Mobile Engagement в веб-приложении](mobile-engagement-web-use-engagement-api.md).
