...
* ** Technicals: ** можно выбрать целевую основании же технические сведения, которые можно увидеть в разделах аналитика и монитора. **Ознакомьтесь со статьями:** [Анализ журналов данных о приложении][Link 15], [Наблюдение за работой приложения в режиме реального времени][Link 16]
