---
title: "Пользовательский интерфейс Azure Mobile Engagement — условия охвата"
...
* [Документация по пользовательскому интерфейсу — рекламная кампания — создание новой кампании push-уведомлений][Link 27]
...
* Сегменты. Выбирать целевую аудиторию можно также, исходя из сегментов, которые вы создали на основе определенного поведения пользователей. Такое поведение обычно определяется несколькими условиями. В этом списке отображаются все сегменты, которые вы определили для своего приложения. **См. также:** [Документация по пользовательскому интерфейсу — сегменты][Link 18].
* **Сведения о приложении.** В разделе "Параметры" можно создать теги со сведениями о настраиваемом приложении, которые помогут отслеживать поведение пользователей. **См. также:** [Документация по пользовательскому интерфейсу — параметры][Link 20].
