---
title: Пользовательский интерфейс Azure Mobile Engagement - Моя учетная запись
...
В этой статье описывается **Главная** страница портала **Mobile Engagement**. Портал **Mobile Engagement** используется для отслеживания мобильных приложений и управления ими.
