---
title: "Заметки о выпуске пакета SDK для платформы Azure Mobile Engagement (iOS) | Документация Майкрософт"
...
---
# <a name="azure-mobile-engagement-ios-sdk-release-notes"></a>Заметки о выпуске пакета SDK для платформы Azure Mobile Engagement (iOS)
