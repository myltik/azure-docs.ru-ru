...
Начните с этой статьи, чтобы получить подробную информацию об интеграции Azure Mobile Engagement в веб-приложение. Если вы хотите потренироваться, обязательно пройдите наш [15-минутный учебник](mobile-engagement-web-app-get-started.md).

## Процедуры по интеграции
1. Начните с этого раздела: [How to integrate Mobile Engagement in your Web app](mobile-engagement-web-integrate-engagement.md) (Как интегрировать Mobile Engagement в веб-приложение).

2. Реализация плана добавления тегов: [Как использовать API Engagement в веб-приложении](mobile-engagement-web-use-engagement-api.md).

## Заметки о выпуске

### 2\.0.1 (10.06.2016)

-   Пакет SDK отключен в IE8 и IE9.
...
Если вы уже интегрировали более старую версию нашего пакета SDK в свое приложение, обратитесь к разделу [Процедуры обновления](mobile-engagement-web-upgrade-procedure.md).
