---
title: Пользовательский интерфейс Azure Mobile Engagement — сегменты
...
> [!NOTE]
> Многие части интерфейса портала **Mobile Engagement** оснащены кнопкой **ПОКАЗАТЬ СПРАВКУ**. Нажмите эту кнопку, чтобы получить больше контекстной информации по соответствующему разделу.
> 
> 
...
6. Нажмите кнопку «Далее». В этом примере заданы пользователи, которые провели по крайней мере 50 сеансов на прошлой неделе.
