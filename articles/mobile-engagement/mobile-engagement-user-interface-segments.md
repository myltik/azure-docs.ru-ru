...
### <a name="segments-you-can-create-based-on-the-major-azure-mobile-engagement-elements"></a>На базе основных элементов Azure Mobile Engagement можно создавать следующие сегменты:
