...
В этой статье описывается вкладка **СЕГМЕНТЫ** портала **Mobile Engagement**. Портал **Mobile Engagement** используется для отслеживания мобильных приложений и управления ими.
