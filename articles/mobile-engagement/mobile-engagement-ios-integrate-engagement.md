...
> [AZURE.IMPORTANT] Пакет SDK для Engagement требует использования версии iOS 6 или выше (целевое устройство для развертывания приложения должно быть с версией не ниже iOS 6).
