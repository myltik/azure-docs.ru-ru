...
5. Теперь вернемся к файлу **ViewController.m** и добавим в него следующий код:
...
6. Обратите внимание на следующие моменты, касающиеся файла **ViewController.m**:
...
7. Создайте файл с именем **LocalPage.html**, содержащий следующий код:
...
9. Запустите приложение и вы увидите следующее. Теперь укажите какое-нибудь имя для тестового события (например такое, как указано ниже) и щелкните **Отправить** рядом с ним.
