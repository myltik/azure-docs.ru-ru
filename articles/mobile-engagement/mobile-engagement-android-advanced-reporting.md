...
В этой статье описаны дополнительные сценарии создания отчетов в приложении Android. Это параметры, которые можно применить для приложения, созданного в руководстве [Приступая к работе с Azure Mobile Engagement для приложений Android](mobile-engagement-android-get-started.md).
...
В руководстве [Приступая к работе с Azure Mobile Engagement для приложений Android](mobile-engagement-android-get-started.md) достаточно было обеспечить наследование подклассов `*Activity` из соответствующих классов `Engagement*Activity` (например, если устаревшее действие расширяло `ListActivity`, нужно было обеспечить, чтобы оно расширяло и `EngagementListActivity`).
