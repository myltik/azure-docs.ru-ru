<properties
	pageTitle="Расширенная конфигурация с пакетом SDK для Android Mobile Engagement"
	description="Параметры расширенной конфигурации для Android с использованием пакета SDK для Azure Mobile Engagement"
...
# Расширенная конфигурация с пакетом SDK для Android Mobile Engagement

> [AZURE.SELECTOR]
- [Android](mobile-engagement-android-logging.md)

В этой статье описано, как настроить параметры расширенной конфигурации для приложений Engagement Android.
...
| ---------- | --------- |
| ИНТЕРНЕТ | Упрощенные отчеты |
| ACCESS\_NETWORK\_STATE | Упрощенные отчеты |
| WRITE\_EXTERNAL\_STORAGE | Упрощенные отчеты |
| RECEIVE\_BOOT\_COMPLETED | Упрощенные отчеты |
| VIBRATE | Упрощенные отчеты |
| DOWNLOAD\_WITHOUT\_NOTIFICATION | Общие уведомления |
| WAKE\_LOCK | Сбор статистики при использовании Wi-Fi или при выключенном экране |
| RECEIVE\_BOOT\_COMPLETED | Создание отчетов в фоновом режиме |
| ACCESS\_COARSE\_LOCATION | Создание отчетов о расположении в режиме реального времени |
| ACCESS\_FINE\_LOCATION | Создание отчетов на основе данных GPS |
...
## Варианты настройки файла Manifest
