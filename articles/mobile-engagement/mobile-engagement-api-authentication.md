...
8. Вот как выглядит набор командлетов PS. 
    ...
    ![][3]
9. На портале управления Azure убедитесь, что в разделе **Приложения, которыми владеет моя компания** отображается новое приложение AD с именем, переданным в скрипт **principalName**.
