---
title: Пользовательский интерфейс Azure Mobile Engagement - «Аналитика»
...
В этой статье описывается вкладка **АНАЛИТИКА** портала **Mobile Engagement**. Портал **Mobile Engagement** используется для отслеживания мобильных приложений и управления ими. Обратите внимание, что для того, чтобы начать пользоваться порталом, сначала необходимо создать учетную запись **Azure Mobile Engagement**.
...
> [!NOTE]
> Многие части интерфейса портала **Mobile Engagement** оснащены кнопкой **ПОКАЗАТЬ СПРАВКУ**. Нажмите ее, чтобы получить больше контекстной информации по соответствующему разделу.
> 
> 
