<properties 
   ...
   description="Научитесь анализировать журналы данных о приложении с помощью Azure Mobile Engagement" 
...
> Примечание. Период времени основан на дате, заданной в параметрах устройства пользователя. Если на телефоне пользователя установлена неправильная дата, он может зайти в систему в неправильный период времени.
...
## Доступ к обзору периода удержания
![Analytics3][12]
