...
4. В разделе рush-уведомлений щелкните ссылку на **сайт служб Live** .

    ![][12]

5. Вы перейдете в раздел учетных данных для отправки push-уведомлений. В разделе **Параметры приложения** скопируйте **SID пакета** и **cекрет клиента**.

    ![][13]

6. Перейдите в область **Параметры** портала Служб мобильного взаимодействия и щелкните раздел **Системные push-уведомления** слева. Нажмите кнопку **Изменить**, чтобы ввести данные в поля **Идентификатор безопасности пакета (SID)** и **Секретный ключ**, как показано ниже.
