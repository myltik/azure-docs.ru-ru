<properties urlDisplayName="Analyze flight delay data with Hadoop in HDInsight" pageTitle="Анализ данных о задержке рейсов с помощью Hadoop в HDInsight | Azure" metaKeywords="" description="Узнайте, как использовать один сценарий PowerShell, чтобы подготовить кластер HDInsight, выполнить задание Hive, выполнить задание Sqool и удалить кластер." metaCanonical="" services="hdinsight" documentationCenter="" title="Analyze flight delay data using Hadoop in HDInsight " authors="jgao" solutions="" manager="paulettm" editor="cgronlun" />
