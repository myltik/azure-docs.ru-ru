...
---
# <a name="resource-classes-for-workload-management"></a>Классы ресурсов для управления рабочими нагрузками
Руководство по использованию классов ресурсов для управления определенным количеством параллельных запросов и вычислительными ресурсами для запросов в хранилище данных SQL Azure.
...
Хранилище данных SQL предоставляет возможности управления рабочими нагрузками многопользовательских сред. Хранилище данных не предназначено для мультитенантных рабочих нагрузок.

## <a name="what-are-resource-classes"></a>Что такое классы ресурсов?
Классы ресурсов представляют собой предопределенные ограничения ресурсов, регулирующие выполнение запроса. Хранилище данных SQL ограничивает вычислительные ресурсы для каждого запроса в соответствии с классом ресурсов. 

Классы ресурсов помогают управлять общей производительностью рабочей нагрузки хранилища данных. Использование классов ресурсов значительно упрощает управление рабочей нагрузкой с помощью задания ограничений на количество параллельно выполняющихся запросов, а также вычислительных ресурсов, назначенных для каждого запроса. 

- Небольшие классы ресурсов используют меньше вычислительных ресурсов, но обеспечивают больший параллелизм запросов.
- Большие классы ресурсов используют больше вычислительных ресурсов, но обеспечивают меньший параллелизм запросов.

Классы ресурсов предназначены для управления данными и других действий по управлению. Их также можно использовать для некоторых очень сложных запросов при наличии множественных объединений и сортировки, когда система выполняет запрос в памяти, а не на диске.
...
## <a name="static-and-dynamic-resource-classes"></a>Статические и динамические классы ресурсов

Существует два типа классов ресурсов: динамический и статический.

- **Статические классы ресурсов** выделяют один объем памяти независимо от текущего уровня обслуживания, измеряемого в [единицах использования хранилища данных](what-is-a-data-warehouse-unit-dwu-cdwu.md). Это статическое выделение означает, что на расширенных уровнях обслуживания вы можете выполнить больше запросов в каждом классе ресурсов.  Статические классы ресурсов называются staticrc10, staticrc20, staticrc30, staticrc40, staticrc50, staticrc60, staticrc70 и staticrc80. Они больше подходят для решений, повышающих класс ресурса для получения дополнительных вычислительных ресурсов.

- **Динамические классы ресурсов** выделяют переменный объем памяти в зависимости от текущего уровня обслуживания. При увеличении масштаба уровня обслуживания запросы автоматически получают больший объем памяти. Динамические классы ресурсов называются smallrc, mediumrc, largerc и xlargerc. Они больше подходят для решений, увеличивающих масштаб вычислительных ресурсов для получения дополнительных ресурсов. 

Для [уровней производительности](performance-tiers.md) используются одинаковые имена классов ресурсов, но разные [спецификации параллелизма и памяти](performance-tiers.md). 


## <a name="assigning-resource-classes"></a>Назначение классов ресурсов
...
### <a name="queries-exempt-from-resource-classes"></a>Запросы, исключенные из классов ресурсов
