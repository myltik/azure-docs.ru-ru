<properties
   pageTitle="Элементы языка Transact-SQL хранилища данных SQL | Microsoft Azure"
...
## Пакеты, управление потоком и переменные
...
## Подстановочные знаки для сопоставления
...
- [!= (Не равно)](https://msdn.microsoft.com/library/vstudio/bb399278.aspx)
