---
title: Проектные решения и методики программирования для разработки для хранилища данных SQL | Microsoft Docs
...
## Дальнейшие действия
После ознакомления со статьями о разработке перейдите в [Справочник по Transact-SQL][Справочник по Transact-SQL], чтобы получить дополнительные сведения о поддерживаемом синтаксисе для хранилища данных SQL.
