<properties
   pageTitle="Восстановление базы данных в хранилище данных SQL Azure (портал) | Microsoft Azure"
   description="Задачи портала Azure для восстановления работающей или удаленной базы данных в хранилище данных SQL Azure."
...
# Восстановление базы данных в хранилище данных SQL Azure (портал)
...
Задачи PowerShell для восстановления работающей или удаленной базы данных в хранилище данных SQL Azure.
