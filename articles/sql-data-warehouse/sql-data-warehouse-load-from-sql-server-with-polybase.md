...
См. также статью [Приступая к работе со служебной программой командной строки AzCopy][последняя версия AzCopy].
...
* [Create Master Key (Transact-SQL)][Create Master Key (Transact-SQL)] — шифрование секрета учетных данных для базы данных.
