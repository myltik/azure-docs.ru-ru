<properties
   pageTitle="Приступая к работе с системой обнаружения угроз хранилища данных SQL"
   description="Приступая к работе с системой обнаружения угроз хранилища данных SQL"
...
# Приступая к работе с системой обнаружения угроз хранилища данных SQL
...
## Анализ подозрительной активности в хранилище данных при обнаружении подозрительного события
