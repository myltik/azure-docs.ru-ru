<properties
   pageTitle="Резервное копирование и восстановление базы данных в хранилище данных SQL Azure (PowerShell) | Microsoft Azure"
...
Создание резервной копии и восстановление базы данных в хранилище данных SQL с помощью PowerShell.
