...
- Внешняя таблица и внутренняя кэшируемая таблица существуют как разные объекты с экземпляром базы данных SQL. Рассмотрите возможность создания представления кэшированной части таблицы и внешней таблицы, которое позволит объединить обе таблицы и применить фильтры к граничной точке каждой из них.
