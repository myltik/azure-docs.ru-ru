...
description: "Задачи PowerShell, которые приостанавливают вычисления для хранилища данных SQL Azure для снижения расходов. Возобновите вычисления, когда вы готовы к использованию хранилища данных."
...
5. Если вашим сервером является foo.database.windows.net, то в командлетах PowerShell в качестве -ServerName используйте только первую часть имени сервера. На предыдущем рисунке полное имя сервера — newserver-20171113.database.windows.net. Мы будем использовать **newserver-20171113** в качестве имени сервера в командлете PowerShell.
