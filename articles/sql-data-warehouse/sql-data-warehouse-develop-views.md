...
> [AZURE.NOTE] Синтаксис `CREATE VIEW` в этой статье не рассматривается. Эти справочные материалы доступны в статье [CREATE VIEW][] на сайте MSDN.
...
Поэтому недоступны следующие возможности:
...
## Дальнейшие действия
Дополнительные советы по разработке см. в разделе [Общие сведения о разработке для хранилища данных SQL][]. Сведения о синтаксисе `CREATE VIEW` см. в разделе [CREATE VIEW][].
