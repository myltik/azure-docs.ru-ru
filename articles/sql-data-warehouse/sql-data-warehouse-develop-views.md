---
title: Представления в хранилище данных SQL | Microsoft Docs
...
## Дальнейшие действия
Дополнительные советы по разработке см. в разделе [Общие сведения о разработке для хранилища данных SQL][Общие сведения о разработке для хранилища данных SQL]. Сведения о синтаксисе `CREATE VIEW` см. в статье [CREATE VIEW][CREATE VIEW].
