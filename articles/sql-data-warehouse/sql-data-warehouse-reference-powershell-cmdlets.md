...
Этот командлет выводит точки восстановления с резервных копий для базы данных Azure SQL. Точки восстановления используются для восстановления базы данных. Далее перечислены свойства для возвращенного объекта. <table> <tr> <td>Свойство</td> <td>Описание</td> </tr> <tr> <td>RestorePointType</td> <td>ДИСКРЕТНЫЕ и НЕПРЕРЫВНЫЕ. Дискретные точки восстановления — это возможные точки во времени, до которых можно восстановить базу данных Azure SQL. Непрерывные точки восстановления — это самые ранние возможные точки во времени, до которых можно восстановить базу данных Azure SQL. Базу данных можно восстановить до любой точки во времени после самой ранней точки.</td> </tr> <tr> <td>EarliestRestoreDate</td> <td>Самое ранее время восстановления (задается, если restorePointType = CONTINUOUS)</td> </tr> <tr> <td>RestorePointCreationDate </td> <td>Время моментального снимка резервной копии (задается, если restorePointType = DISCRETE)</td> </tr> </table>
