...
* [Создание хранилища данных SQL с помощью Powershell][Создание хранилища данных SQL с помощью Powershell]
* [Восстановление базы данных][Восстановление базы данных]

Список всех задач, которые можно автоматизировать с помощью PowerShell, см. в разделе [Azure SQL Database Cmdlets][Azure SQL Database Cmdlets] \(Командлеты базы данных SQL Azure). Список задач, которые можно автоматизировать с помощью REST, см. в статье [Операции для баз данных SQL Azure][Операции для баз данных SQL Azure].
