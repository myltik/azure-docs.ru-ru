---
title: Создание хранилища данных SQL на портале Azure | Microsoft Docs
...
* **Учетная запись Azure**. Чтобы создать учетную запись, перейдите на страницу [бесплатной пробной версии Azure][бесплатной пробной версии Azure] или [кредитов Azure MSDN][кредитов Azure MSDN].
* **Сервер SQL Azure**. Дополнительные сведения см. в статье [Руководство по базам данных SQL: создание базы данных SQL за несколько минут с помощью портала Azure][Руководство по базам данных SQL: создание базы данных SQL за несколько минут с помощью портала Azure].

> [!NOTE]
> Создание хранилища данных SQL может привести к дополнительным расходам. Дополнительные сведения см. на странице [с ценами на хранилище данных SQL][с ценами на хранилище данных SQL].
> 
> 
...
> [!NOTE]
> Параметры сортировки по умолчанию для хранилища данных SQL: SQL\_Latin1\_General\_CP1\_CI\_AS. Если требуются другие параметры сортировки, можно использовать [T-SQL][T-SQL] для создания базы данных с другими параметрами сортировки.
> 
> 
...
[!INCLUDE [Создание сервера базы данных SQL](../../includes/sql-database-create-new-server-firewall-portal.md)]
...
Можно также настроить правила брандмауэра с помощью Transact-SQL. Дополнительные сведения см. в статьях [sp\_set\_firewall\_rule (база данных SQL Azure)][sp\_set\_firewall\_rule (база данных SQL Azure)] и [sp\_set\_database\_firewall\_rule (база данных SQL Azure)][sp\_set\_database\_firewall\_rule (база данных SQL Azure)].

Рекомендуем также ознакомиться со статьей [Рекомендации по использованию хранилища данных SQL Azure][Рекомендации по использованию хранилища данных SQL Azure].
