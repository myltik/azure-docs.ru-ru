...
Для выполнения следующих задач вам необходима подписка Azure и утверждения в предварительной версии хранилища данных SQL. Если у вас еще нет подписки Azure, то самый первый шаг — это получение подписки.
...
В верхнем левом углу портала Azure находится кнопка "Создать". Она позволяет создавать любые новые службы в Azure.

- Теперь нажмите кнопку "Создать".

### Данные + хранилище

При нажатии кнопки "Создать" открываются все категории служб Azure. Хранилище данных SQL находится в категории "Данные + хранилище".
...
##Допуском к предварительной версии
Перед началом установки вам необходимо получить допуск к программе предварительной версии. Щелкните "Зарегистрироваться для получения предварительной версии" и нажмите "Отправить". После утверждения вы получите уведомление по почте.

После этого можно перейти к дальнейшим действиям. Примечание. Для утверждения может потребоваться несколько дней.
