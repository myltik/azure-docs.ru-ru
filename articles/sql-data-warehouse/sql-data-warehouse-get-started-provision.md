...
* **Сервер SQL Azure.** Дополнительные сведения см. в статье [Создание базы данных SQL Azure и отправка к ней запросов с помощью портала Azure][Create an Azure SQL database in the Azure portal].
