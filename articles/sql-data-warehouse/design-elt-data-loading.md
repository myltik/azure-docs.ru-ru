...
- [PolyBase с фабрикой данных Azure (ADF)](sql-data-warehouse-load-with-data-factory.md) представляет собой другое средство оркестрации.  Оно определяет конвейер и планирует расписания заданий. Проанализировать данные JSON и загрузить их в хранилище данных SQL можно с помощью ADF.
- [PolyBase с использованием Azure DataBricks](../azure-databricks/databricks-extract-load-sql-data-warehouse.md) передает данные из Azure Data Lake Store в хранилище данных SQL. Azure DataBricks можно использовать для анализа данных JSON и загрузки данных в хранилище данных SQL. 
