<properties
   pageTitle="Резервные копии хранилища данных SQL | Microsoft Azure"
   description="Ознакомьтесь с дополнительными сведениями о встроенной функции резервного копирования баз данных хранилища данных SQL, которая позволяет восстановить хранилище данных SQL Azure до точки восстановления или в другом географическом регионе."
...
Эта функция включена по умолчанию. От использования георепликации можно отказаться, отключив эту функцию. 
...
> [AZURE.IMPORTANT] Когда вы удаляете экземпляр логического сервера SQL Server, все относящиеся к этому экземпляру базы данных также удаляются без возможности восстановления. Удаленный сервер восстановить невозможно.
