...
Выполнение геоархивации задано по умолчанию. Если хранилище данных оптимизировано для эластичности, при необходимости вы можете [отказаться от геоархивации](https://docs.microsoft.com/powershell/resourcemanager/Azurerm.sql/v2.1.0/Set-AzureRmSqlDatabaseGeoBackupPolicyredirectedfrom=msdn). Если же уровень производительности оптимизирован для вычислений, вы не можете отказаться от геоархивации.
