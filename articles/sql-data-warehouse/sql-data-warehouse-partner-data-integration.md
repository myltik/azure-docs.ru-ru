.<properties
   pageTitle="Партнеры по интеграции данных хранилища данных SQL | Microsoft Azure"
...
| ![SnapLogic][6] | **SnapLogic**<br>Платформа SnapLogic позволяет выполнять быстрый перенос данных в хранилище данных SQL Microsoft Azure и из него. SnapLogic обеспечивает возможность интеграции в одном решении сотен разных приложений, служб и сценариев IoT. Воспользуйтесь SnapLogic и делайте более точный и эффективный анализ в облаке, локально или в гибридной модели! | [Marketplace][snaplogic_marketplace]<br>[Веб-сайт][snaplogic_website]<br>[Информационный лист][snaplogic_datasheet]<br>[Twitter][snaplogic_twitter]<br>[YouTube][snaplogic_youtube] | [![Видео о SnapLogic](./media/sql-data-warehouse-partner-data-integration/snaplogic_video.jpg)](https://www.youtube.com/watch?v=YiJCwObOh5Y) |

## Дальнейшие действия

Дополнительные сведения о некоторых других партнерах см. в статьях [Партнеры по бизнес-аналитике хранилища данных SQL][bi_partners] и [Партнеры по управлению данными хранилища данных SQL][dm_partners].
