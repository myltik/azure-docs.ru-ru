...
Наши цели относительно хранилища данных SQL:
...
- **Частота опроса**. Число записей, которые можно последовательно получить из хранилища данных в секунду. Эта метрика специально измеряет количество записей, возвращаемых запросом из таблицы с кластеризованным индексом хранилища столбцов.
