<properties
   pageTitle="Поиск долго выполняющихся запросов пользователей в хранилище данных SQL Azure | Microsoft Azure"
   description="Вы можете узнать, как отслеживать рабочую нагрузку и искать долго выполняющиеся запросы в хранилище данных SQL Azure с помощью динамических административных представлений (DMV)."
