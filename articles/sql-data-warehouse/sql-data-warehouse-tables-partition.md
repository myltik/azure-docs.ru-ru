...
* удалить [схему секционирования][схему секционирования] SQL Server;
* добавить определение [функции секционирования][функции секционирования] в инструкцию CREATE TABLE.
...
Хранилище данных SQL поддерживает разбиение, слияние и переключение секций. Для каждой из этих функций используется инструкция [Инструкция ALTER TABLE][Инструкция ALTER TABLE].
...
> [!NOTE]
> Создавая объект статистики, мы обеспечиваем более точные метаданные таблицы. Если пропустить создание объекта статистики, хранилище данных SQL будет использовать значения по умолчанию. Сведения об управлении статистикой таблиц в хранилище данных SQL см. в [этой статье][управление статистикой].
> 
> 
...
Дополнительные сведения см. в статьях, посвященных [общим сведениям о таблицах][Обзор], [типам данных таблиц][Типы данных], [распределению][Распределение], [индексированию][Индекс], [управлению статистикой таблиц][Статистика] и [временным таблицам][Временные таблицы].  Рекомендации по использованию хранилища данных SQL Azure см. в [этой статье][Рекомендации по использованию хранилища данных SQL Azure].
...
[Инструкция ALTER TABLE]: https://msdn.microsoft.com/en-us/library/ms190273.aspx
