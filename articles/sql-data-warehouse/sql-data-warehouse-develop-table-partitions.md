...
Примечание. Чтобы больше узнать о секциях в SQL Server, см. раздел [Секционированные таблицы и индексы](https://msdn.microsoft.com/library/ms190787.aspx).
...
Выполните `SPLIT` таблицы в процессе развертывания:
