...
- Вместо **uniqueidentifier** используйте varbinary(16) или varchar(36) в зависимости от формата входного значения (двоичное значение или символ). Если входной формат основан на символах, то возможна оптимизация. Если преобразовать символьный формат в двоичный, то память, используемая столбцом, уменьшится на 50 %. В больших таблицах подобная оптимизация может быть очень полезной.
