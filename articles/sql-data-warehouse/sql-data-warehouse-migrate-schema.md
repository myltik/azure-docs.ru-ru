---
title: Перенос схемы в хранилище данных SQL | Microsoft Docs
...
## Перенос таблиц
При переносе таблиц следует ознакомиться с возможностями таблиц хранилища данных SQL. Вы можете начать с [обзора таблиц][обзора таблиц]. В этой статье рассмотрены наиболее важные вопросы, касающиеся создания таблицы, например статистика таблиц, распределения, секционирование и индексирование. В ней также рассматриваются некоторые [неподдерживаемые функции таблиц][неподдерживаемые функции таблиц] и способы их обойти.

Хранилище данных SQL поддерживает распространенные типы бизнес-данных. Список поддерживаемых и [неподдерживаемых типов данных][неподдерживаемых типов данных] см. в разделе [Типы данных][Типы данных]. Статья [Типы данных][Типы данных] также содержит запрос для выявления [неподдерживаемых типов данных][неподдерживаемых типов данных]. При преобразовании типов данных обязательно ознакомьтесь с [рекомендациями по типам данных][рекомендациями по типам данных].
