...
> [AZURE.IMPORTANT]Типы учетных записей службы хранилища Azure, поддерживаемые PolyBase: локально избыточное хранилище Standard (Standard-LRS), геоизбыточное хранилище Standard (Standard-GRS), геоизбыточное хранилище Standard с доступом на чтение (Standard-RAGRS). Учетные записи хранилища Standard, избыточного в пределах зоны (Standard-ZRS), и локально избыточного хранилища Premium (Premium-LRS) НЕ поддерживаются PolyBase. При создании новой учетной записи службы хранилища Azure обязательно выберите в ценовой категории тип учетной записи, поддерживаемой PolyBase.
