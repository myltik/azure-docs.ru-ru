...
Чтобы уточнить наличие учетных данных для конкретной базы, используйте представление sys.database_credentials, а не sys.credentials, возвращающее только учетные данные сервера.
