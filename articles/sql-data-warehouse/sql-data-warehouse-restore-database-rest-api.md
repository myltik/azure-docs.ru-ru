---
title: Восстановление хранилища данных SQL Azure (REST API) | Microsoft Docs
...
2. Получите подробную информацию об удаленной базе данных, которую необходимо восстановить, с помощью операции [Get Restorable Dropped Database][Get Restorable Dropped Database] .
