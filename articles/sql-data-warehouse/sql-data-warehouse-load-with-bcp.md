...
Чтобы узнать, как создать процесс загрузки, см. статью [Designing Extract, Load, and Transform (ELT) for Azure SQL Data Warehouse] (Разработка процесса извлечения, загрузки и преобразования (ELT) для хранилища данных SQL Azure) (sql-data-warehouse-design-elt-data-loading].  
