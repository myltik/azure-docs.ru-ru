...
1.	Чтобы начать работу, перейдите в экземпляр хранилища данных SQL на классическом портале Azure.
...
Полное имя сервера и имя базы данных можно посмотреть на классическом портале Azure. Обратите внимание, что в настоящее время хранилище данных SQL можно найти только на портале Azure.
