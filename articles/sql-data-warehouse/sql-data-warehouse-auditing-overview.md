---
title: Аудит в хранилище данных SQL Azure | Microsoft Docs
...
> [!NOTE]
> Модуль [Azure Resource Manager](https://msdn.microsoft.com/library/dn654592.aspx) в настоящее время находится на стадии предварительной версии. Он может не обеспечивать те же возможности управления, что и модуль Azure.
> 
> 
