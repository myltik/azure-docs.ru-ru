...
Сведения об оптимизации и минимизации объема данных, записываемых в журнал, см. в статье [рекомендациями по транзакциям][рекомендациями по транзакциям].
...
Дополнительные сведения об оптимизации транзакций см. в статье [рекомендациями по транзакциям][рекомендациями по транзакциям].  Дополнительные сведения о других рекомендациях по использованию хранилища данных SQL Azure см. в [этой статье][рекомендациями по использованию хранилища данных SQL Azure].
