...
## Дальнейшие действия
См. дополнительные сведения об [оптимизации транзакций для хранилища данных SQL][]. См. [рекомендации по использованию хранилища данных SQL Azure][].
...
[оптимизации транзакций для хранилища данных SQL]: ./sql-data-warehouse-develop-best-practices-transactions.md
