...
Если вы столкнулись с крупномасштабными изменениями в рамках [секции таблицы][], то имеет смысл воспользоваться схемой переключения секций. Если изменения данных существенные и охватывают несколько секций, то простая итерация по секциям приводит к тому же результату.
...
Чтобы узнать об уровнях изоляции и лимитах транзакций, ознакомьтесь с разделом [Транзакции в хранилище данных SQL][]. Обзор рекомендаций см. в разделе [Рекомендации по использованию хранилища данных SQL][].
