...
- Масштабирование вычислительных ресурсов путем корректировки единиц использования хранилища данных (DWU)
...
Чтобы добиться гибкого увеличения или уменьшения вычислительной мощности, просто измените параметр единиц хранилища данных (DWU) для своей базы данных. В то же время за кадром хранилище данных SQL изменяет распределение ресурсов ЦП и памяти, используя функции быстрого и простого развертывания базы данных SQL.
