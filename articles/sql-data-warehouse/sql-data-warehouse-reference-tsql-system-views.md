---
title: Системные представления хранилища данных SQL | Microsoft Docs
...
> [!NOTE]
> Чтобы использовать эти представления, вставьте в имя текст ’pdw\_nodes\_’, как показано в приведенной ниже таблице.
> 
> 
...
| sys.dm\_pdw\_nodes\_exec\_sessions |[sys.dm\_exec\_sessions](https://msdn.microsoft.com/ru-RU/library/ms176013.aspx) |
...
## Дальнейшие действия
Дополнительные справочные сведения см. в обзоре [Общие справочные сведения о хранилище данных SQL][Общие справочные сведения о хранилище данных SQL].
