...
## Представления каталога хранилища данных SQL
...
## Представления каталога базы данных SQL

- [dbo.server\_quotas (база данных SQL Azure)](http://msdn.microsoft.com/library/dn308512.aspx)
- [sys.bandwidth\_usage (база данных SQL Azure)](http://msdn.microsoft.com/library/dn269985.aspx)
- [sys.database\_connection\_stats (база данных SQL Azure)](http://msdn.microsoft.com/library/dn269986.aspx)
- [sys.database\_firewall\_rules (база данных SQL Azure)](http://msdn.microsoft.com/library/dn269982.aspx)
- [sys.database\_usage (база данных SQL Azure)](https://msdn.microsoft.com/library/dn270020.aspx)
- [sys.event\_log (база данных SQL Azure)](http://msdn.microsoft.com/library/dn270018.aspx)
- [sys.database\_firewall\_rules (база данных SQL Azure)](http://msdn.microsoft.com/library/dn269982.aspx)
- [sys.firewall\_rules (база данных SQL Azure)](https://msdn.microsoft.com/library/dn269980.aspx)
- [sys.resource\_stats (база данных SQL Azure)](http://msdn.microsoft.com/library/dn269979.aspx)
- [sys.resource\_usage (база данных SQL Azure)](https://msdn.microsoft.com/library/dn270016.aspx)


## Динамические административные представления (DMV) хранилища данных SQL
...
## Список динамических административных представлений SQL Server, доступных в хранилище данных SQL
...
Именно поэтому каждое динамическое административное представление включает отдельный столбец с именем pdw\_node\_id. Это идентификатор вычислительного узла. В PDW вычислительный узел является активным участником архитектуры. В хранилище данных SQL архитектура в основном строится на распределениях.

>[AZURE.NOTE] Чтобы использовать эти представления, вставьте в имя текст ’pdw\_nodes\_’, как показано в приведенной ниже таблице.
...
| sys.dm\_pdw\_nodes\_exec\_sessions | [sys.dm\_exec\_sessions (Transact-SQL)](https://msdn.microsoft.com/ru-RU/library/ms176013.aspx) |
...
| sys.dm\_pdw\_nodes\_os\_dispatchers | Документация по Transact-SQL недоступна. |
...
| sys.dm\_pdw\_nodes\_os\_memory\_node\_access\_stats | Документация по Transact-SQL недоступна. |
...
| sys.dm\_pdw\_nodes\_os\_spinlock\_stats | Документация по Transact-SQL недоступна. |
...
| sys.dm\_pdw\_nodes\_tran\_commit\_table | Документация по Transact-SQL недоступна. |
...
## Динамические административные представления базы данных SQL, доступные в хранилище данных SQL
...
## Представления information\_schema SQL Server

Ниже приводятся ссылки на представления информационной схемы SQL Server, доступные в PDW SQL Server. Все представления INFORMATION\_SCHEMA, которые можно увидеть в SQL Server, доступны в PDW SQL Server.
...
- [CONSTRAINT\_COLUMN\_USAGE (Transact-SQL)](http://msdn.microsoft.com/library/ms174431.aspx)
