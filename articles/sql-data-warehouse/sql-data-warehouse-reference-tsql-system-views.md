...
- [dbo.server_quotas (база данных SQL Azure)](http://msdn.microsoft.com/library/dn308512.aspx)
- [sys.bandwidth_usage (база данных SQL Azure)](http://msdn.microsoft.com/library/dn269985.aspx)
- [sys.database_connection_stats (база данных SQL Azure)](http://msdn.microsoft.com/library/dn269986.aspx)
- [sys.database_firewall_rules (база данных SQL Azure)](http://msdn.microsoft.com/library/dn269982.aspx)
- [sys.database_usage (база данных SQL Azure)](http://msdn.microsoft.com/library/azure/ff951626.aspx)
- [sys.event_log (база данных SQL Azure)](http://msdn.microsoft.com/library/dn270018.aspx)
- [sys.database_firewall_rules (база данных SQL Azure)](http://msdn.microsoft.com/library/dn269982.aspx)
- [sys.firewall_rules (база данных SQL Azure)](http://msdn.microsoft.com/library/azure/ff951627.aspx)
- [sys.resource_stats (база данных SQL Azure)](http://msdn.microsoft.com/library/dn269979.aspx)
- sys.resource_usage (база данных SQL Azure)
...
>[AZURE.NOTE]Чтобы использовать эти представления, вставьте в имя текст ’pdw_nodes_’, как показано в приведенной ниже таблице.
...
| sys.dm_pdw_nodes_tran_commit_table | Документация по Transact-SQL недоступна. |
...
## Представления information_schema SQL Server

Ниже приводятся ссылки на представления информационной схемы SQL Server, доступные в PDW SQL Server. Все представления INFORMATION_SCHEMA, которые можно увидеть в SQL Server, доступны в PDW SQL Server.
...
- [CONSTRAINT_COLUMN_USAGE (Transact-SQL)](http://msdn.microsoft.com/library/ms174431.aspx)
