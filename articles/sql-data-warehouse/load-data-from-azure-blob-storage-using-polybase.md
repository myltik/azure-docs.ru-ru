---
title: "Загрузка данных из Azure Storage Blob в хранилище данных SQL Azure с помощью Polybase | Документация Майкрософт"
...
---
# <a name="use-polybase-to-load-data-from-azure-blob-storage-to-azure-sql-data-warehouse"></a>Загрузка данных из хранилища BLOB-объектов Azure в хранилище данных SQL Azure с помощью PolyBase
...
2. В диалоговом окне **Подключение к серверу** введите следующие значения.
    ...
    | имя сервера; | Полное имя сервера | Имя должно быть в таком формате: **mynewserver-20171113.database.windows.net**. |
...
2. Введите полное имя сервера, но в этот раз в качестве имени для входа укажите **LoaderRC20**.  Введите пароль для LoaderRC20.
...
1. Выполните эти команды для создания статистики по столбцам, которые с большой вероятностью будут использоваться в соединениях.
...
4. Чтобы удалить созданный вами сервер SQL, щелкните **mynewserver-20171113.database.windows.net** на предыдущем изображении, а затем нажмите кнопку **Удалить**.  Будьте внимательны, так как удаление сервера приведет к удалению всех баз данных, назначенных этому серверу.
