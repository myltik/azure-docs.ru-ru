...
Вычислительные ресурсы можно масштабировать с помощью параметра [единиц использования хранилища данных](what-is-a-data-warehouse-unit-dwu-cdwu.md), настроенного для хранилища данных. Добавление единиц использования хранилища данных позволяет линейно повышать производительность загрузки и запросов. Хранилище данных SQL предлагает [уровни обслуживания](performance-tiers.md#service-levels) для единиц использования хранилища данных, обеспечивающие значительное изменение производительности при масштабировании. 
...
Дополнительные сведения см. в разделах [Транзакции в хранилище данных SQL](sql-data-warehouse-develop-transactions.md) и [Оптимизация транзакций для хранилища данных SQL](sql-data-warehouse-develop-best-practices-transactions.md).
...
Для масштабирования хранилища данных требуются разрешения, описанные в статье [ALTER DATABASE](/sql/t-sql/statements/alter-database-azure-sql-data-warehouse.md).  Чтобы приостановить и возобновить работу, нужны разрешения [Участник баз данных SQL](../active-directory/role-based-access-built-in-roles.md#sql-db-contributor), в частности Microsoft.Sql/servers/databases/action.
