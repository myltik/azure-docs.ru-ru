...
Если возникнут проблемы с хранилищем данных, [создайте запрос в службу поддержки][] и укажите "Миграция в хранилище класса Premium" в качестве возможной причины.
...
[ выполнить переименование во время миграции]: #optional-steps-to-rename-during-migration
