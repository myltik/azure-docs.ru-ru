...
## Восстановление активной базы данных
В случае ошибки пользователя, которая привела к непреднамеренному изменению данных, базу данных можно восстановить в любой точке восстановления, срок хранения которой еще не истек. Моментальные снимки активной базы данных создаются через каждые 8 часов и хранятся в течение 7 дней.
