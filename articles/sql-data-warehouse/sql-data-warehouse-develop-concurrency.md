...
> [AZURE.NOTE]  Запросы SELECT, выполняемые исключительно с динамическими административными представлениями или представлениями каталогов, *не* регулируются пороговыми значениями параллелизма. Вы можете следить за системой независимо от количества выполняемых в ней запросов.
