...
### <a name="memory-allocations-per-distribution-mb"></a>Выделение памяти на распределение (МБ)
...
## <a name="change-a-user-resource-class-example"></a>Пример изменения класса ресурсов пользователя
