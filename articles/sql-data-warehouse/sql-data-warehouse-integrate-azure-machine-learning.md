---
title: Использование машинного обучения Azure с хранилищем данных SQL | Microsoft Docs
...
Машинное обучение Azure — это полностью управляемая служба прогнозной аналитики, которая позволяет создавать прогнозные модели с данными из хранилища данных SQL и публиковать их в виде готовых веб-служб. Познакомиться с основами прогнозной аналитики и машинного обучения можно в разделе [Основные сведения о машинном обучении Azure][Основные сведения о машинном обучении Azure]. Сведения о создании, обучении, оценке и тестировании модели машинного обучения см. в учебнике [Создание эксперимента][Создание эксперимента].

В этой статье вы узнаете, как выполнить следующие задачи с помощью [Студии машинного обучения Microsoft Azure][Студии машинного обучения Microsoft Azure].
...
2. Имя сервера баз данных: введите имя сервера. Эти сведения можно узнать на [портале Azure][портале Azure].
...
Сведения о создании, обучении, оценке и тестировании модели машинного обучения см. в учебнике [Создание эксперимента][Создание эксперимента].
