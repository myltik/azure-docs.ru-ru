...
|:--- |:--- |:--- |
| [Единицы использования хранилища данных (DWU)](what-is-a-data-warehouse-unit-dwu-cdwu.md) |Максимальное число DWU на одно хранилище данных SQL | [Уровень производительности](memory-and-concurrency-limits.md#performance-tiers), оптимизированный для эластичности: 6000 DWU<br></br>[Уровень производительности](memory-and-concurrency-limits.md#performance-tiers), оптимизированный для вычислений: 30 000 cDWU |
