<properties 
	pageTitle="Хранение серверных сценариев в системе управления версиями - Мобильные службы Azure" 
...
1. На [портале управления][портале управления Azure] выберите мобильную службу и откройте вкладку **Настройка**.
...
+ Дополнительную информацию об использовании New Relic см. в разделе [Обзор приложений] документации New Relic. 
