<properties urlDisplayName="Web w/ WebMatrix" pageTitle="Веб-сайт на PHP с использованием MySQL и WebMatrix - учебник Azure" metaKeywords="" description="В этом учебнике показано, как использовать бесплатную интегрированную среду разработки WebMatrix для создания и развертывания веб-сайта на PHP, который хранит данные в MySQL." metaCanonical="" services="web-sites" documentationCenter="PHP" title="Create and deploy a PHP-MySQL Azure Website using WebMatrix" authors="tomfitz" solutions="" manager="wpickett" editor="mollybos" />
