...
> [AZURE.SELECTOR]
- [Географическое восстановление - портал](http://azure.microsoft.com/documentation/articles/sql-database-geo-restore-tutorial-management-portal/)
...
В этом учебнике показано, как восстановить базу данных SQL Azure с помощью географического восстановления в [Azure PowerShell](http://azure.microsoft.com/documentation/articles/install-configure-powershell/). Географическое восстановление - это основной механизм защиты для аварийного восстановления баз данных SQL Azure на всех уровнях обслуживания - Basic, Standard и Premium.

## Ограничения и безопасность

См. [Восстановление базы данных SQL Azure с использованием географического восстановления на портале Azure](http://azure.microsoft.com/documentation/articles/sql-database-geo-restore-tutorial-management-portal/).
