<properties title="Operating System Functionality Available to Applications on Azure Websites" pageTitle="Функциональные возможности операционной системы, доступные приложениям на веб-сайтах Azure" description="Узнайте функциональных возможностях операционной системы, доступных веб-приложениям на веб-сайтах Azure" metaKeywords="Azure,Web Sites,web applications,operating system functionality" services="web-sites" solutions="web" documentationCenter="" authors="cephalin" manager="wpickett" editor="mollybos" videoId="" scriptId="" />
