<properties linkid="manage-services-storage-net-shared-access-signature-part-2" urlDisplayName="Подпись общего доступа. Часть 2" pageTitle="Подписи общего доступа. Часть 2: создание и использование подписи общего доступа с помощью службы BLOB-объектов" metaKeywords="" description="Узнайте, как создать и использовать подписи общего доступа с помощью службы BLOB-объектов Azure. Примеры написаны на языке C# и используют клиентскую библиотеку хранилища Azure для .NET." metaCanonical="" services="storage" documentationCenter=".NET" title="Функциональные возможности операционной системы, доступные приложениям на веб-сайтах Azure" authors="timamm"  solutions="" writer="timamm" manager="" editor=""  />
...
Одним из уникальных аспектов веб-сайтов Azure, который упрощает обслуживание и развертывание веб-приложений, является хранение всего пользовательского содержимого на наборе общих UNC-ресурсов. Эта модель очень хорошо согласуется с распространенным шаблоном хранилища содержимого, который используется локальными средами размещения веб-сайтов, имеющими несколько серверов с балансировкой нагрузки. 
