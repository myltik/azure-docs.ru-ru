<properties 
	pageTitle="Функциональные возможности операционной системы, доступные приложениям на веб-сайтах Azure" 
	description="Узнайте функциональных возможностях операционной системы, доступных веб-приложениям на веб-сайтах Azure" 
	services="web-sites" 
	documentationCenter="" 
	authors="cephalin" 
	manager="wpickett" 
