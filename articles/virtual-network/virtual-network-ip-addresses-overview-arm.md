...
# IP-адреса в диспетчере ресурсов Azure
...
- имеет место разрешение DNS-имени, в рамках которого изменение IP-адреса влечет за собой необходимость обновить записи A;
- ваши ресурсы Azure взаимодействуют с другими веб-службами, которые используют модель безопасности, основанную на IP-адресах;
...
## Сравнение развертываний диспетчера ресурсов и классических развертываний
Ниже приведено сравнение классической модели развертывания с моделью, в рамках которой в диспетчере ресурсов используется IP-адрес.

||Ресурс|Классический|Диспетчер ресурсов| |---|---|---|---| |**Общедоступные IP-адреса**|VM|Называется ILPIP-адресом (только динамический)|Называется общедоступным IP-адресом (динамический и статический)| |||Назначается виртуальной машине IaaS или экземпляру роли PaaS|Связывается с сетевым адаптером виртуальной машины| ||Доступный в Интернете балансировщик нагрузки|Называется виртуальным IP-адресом (динамический) или зарезервированный IP-адрес (статический)|Называется общедоступным IP-адресом (динамический и статический)| |||Назначается облачной службе|Назначается конфигурации внешнего интерфейса балансировщика нагрузки| |||| |**Частные IP-адреса**|VM|Называется выделенным IP-адресом|Называется частным IP-адресом| |||Назначается виртуальной машине IaaS или экземпляру роли PaaS|Назначается сетевому адаптеру виртуальной машины| ||Внутренний балансировщик нагрузки|Назначается внутреннему балансировщику нагрузки (динамический и статический)|Назначается конфигурации внешнего интерфейса внутреннего балансировщика нагрузки (динамический и статический)|
