...
Чтобы связать общедоступный IP-адрес с виртуальной машиной [Windows](../virtual-machines/virtual-machines-windows-about.md) или [Linux](../virtual-machines/virtual-machines-linux-about.md), назначьте этот адрес ее **сетевому интерфейсу**. Если используется виртуальная машина с несколькими сетевыми интерфейсами, можно назначить его только *основному* сетевому интерфейсу. Виртуальной машине можно назначить динамический или статический общедоступный IP-адрес.
