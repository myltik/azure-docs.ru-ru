...
### Виртуальные машины
Чтобы связать общедоступный IP-адрес с [виртуальной машиной](../virtual-machines/virtual-machines-linux-about.md), назначьте этот адрес ее **сетевому адаптеру**. Если в виртуальной машине несколько сетевых адаптеров, IP-адрес достаточно назначить *основному* адаптеру. Виртуальной машине можно назначить динамический или статический общедоступный IP-адрес.
...
### Шлюзы приложений
Чтобы связать общедоступный IP-адрес со [шлюзом приложений](application-gateway-introduction.md) Azure, назначьте этот адрес конфигурации **внешнего интерфейса** шлюза. Этот общедоступный IP-адрес будет выполнять функцию виртуального IP-адреса с балансировкой нагрузки. Сейчас конфигурации, заданной для внешнего интерфейса шлюза приложений, можно назначить только *динамический* общедоступный IP-адрес.
...
|---|---|---|---|
|Виртуальная машина.|Сетевой адаптер|Да|Да|
...
### Виртуальные машины
Частный IP-адрес назначается **сетевому адаптеру** [виртуальной машины](../virtual-machines/virtual-machines-linux-about.md). В виртуальной машине с несколькими сетевыми адаптерами IP-адрес назначается каждому сетевому адаптеру. Способ выделения адаптера может быть динамическим или статическим.
...
Ограничения IP-адресации указаны в полном списке [сетевых ограничений](azure-subscription-service-limits.md#networking-limits) в Azure. Ограничения указаны на регион и на подписку. Для увеличения ограничений по умолчанию до максимальных ограничений в зависимости от потребностей вашего бизнеса вы можете [обратиться в службу поддержки](https://portal.azure.com/#blade/Microsoft_Azure_Support/HelpAndSupportBlade).
