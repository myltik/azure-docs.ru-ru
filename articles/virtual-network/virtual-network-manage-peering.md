...
- Диапазоны адресов нельзя добавить в виртуальную сеть или удалить из нее после создания пиринговой связи с другой виртуальной сетью. Чтобы добавить или удалить диапазоны адресов, удалите пиринг, добавьте или удалите диапазоны, затем повторно создайте пиринг. Дополнительные сведения см. в разделе [Создание, изменение или удаление виртуальной сети](virtual-network-manage-network.md).
