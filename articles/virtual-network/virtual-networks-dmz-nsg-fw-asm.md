...
>[AZURE.NOTE] Хотя в этом примере используется брандмауэр Barracuda NextGen Firewall, вместо него может быть использовано множество других виртуальных сетевых устройств.
