...
Вы можете удалить ненужную группу ресурсов и все содержащиеся в ней ресурсы, выполнив команду [Remove-AzureRmResourceGroup](/powershell/module/azurerm.resources/remove-azurermresourcegroup).
...
> [Создание настраиваемой виртуальной сети](virtual-networks-create-vnet-arm-pportal.md#powershell)
