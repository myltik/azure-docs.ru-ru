...
- [Виртуальные машины.](#vms) К виртуальной машине подключается по крайней мере одна сетевая карта. В зависимости от размера к виртуальной машине можно подключить несколько сетевых карт. Дополнительные сведения об определении числа сетевых карт, поддерживаемых каждым из размеров виртуальной машины, см. в статьях [Размеры виртуальных машин Windows в Azure](../virtual-machines/virtual-machines-windows-sizes.md?toc=%2fazure%2fvirtual-network%2ftoc.json#size-tables) и [Размеры виртуальных машин Linux в Azure](../virtual-machines/virtual-machines-linux-sizes.md?toc=%2fazure%2fvirtual-network%2ftoc.json#size-tables). В этом разделе содержатся инструкции по созданию виртуальной машины с одной или несколькими сетевыми картами, а также по подключению сетевых карт к существующим виртуальным машинам и по их отключению.
...
- Размер виртуальной машины должен поддерживать использование нескольких сетевых интерфейсов. Дополнительные сведения об определении числа сетевых карт, поддерживаемых каждым из размеров виртуальной машины, см. в статьях [Размеры виртуальных машин Windows в Azure](../virtual-machines/virtual-machines-windows-sizes.md?toc=%2fazure%2fvirtual-network%2ftoc.json#size-tables) и [Размеры виртуальных машин Linux в Azure](../virtual-machines/virtual-machines-linux-sizes.md?toc=%2fazure%2fvirtual-network%2ftoc.json#size-tables).
