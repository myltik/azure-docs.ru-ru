...
Существует два типа IP-адресов, назначаемых компонентам в Azure: общедоступные и частные. Каждой сетевой карте виртуальных машин IaaS и экземпляров роли PaaS, развернутых в подсети Azure, автоматически назначается частный IP-адрес в соответствии с блоками адресов CIDR, назначенными подсетям. Виртуальным машинам IaaS и экземплярам роли PaaS можно также назначать общедоступные IP-адреса.
