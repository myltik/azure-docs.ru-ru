...
---
# <a name="virtual-network-overview"></a>Обзор виртуальной сети
...
## <a name="virtual-network-benefits"></a>Преимущества виртуальных сетей
...
## <a name="network-security-group-nsg"></a>Группа безопасности сети (NSG)
