...
- [Создание виртуальной машины в виртуальной сети](../virtual-machines/virtual-machines-windows-tutorial.md).
- Дополнительные сведения о [группах безопасности сети](virtual-networks-nsg.md).
- Дополнительные сведения о [подсистемах балансировки нагрузки](../load-balancer/load-balancer-overview.md).
