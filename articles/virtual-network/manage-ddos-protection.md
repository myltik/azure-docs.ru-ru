...
Перед выполнением каких-либо инструкций в этом руководстве войдите на портал Azure по адресу https://portal.azure.com. Если у вас еще нет подписки Azure, [создайте бесплатную учетную запись Azure](https://azure.microsoft.com/free/?WT.mc_id=A261C142F), прежде чем начинать работу.
