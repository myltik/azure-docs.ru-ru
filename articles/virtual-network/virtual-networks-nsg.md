...
|Портал Azure|![Да][green]|[](virtual-networks-create-nsg-arm-pportal.md)![Да][green]|
|PowerShell|[](virtual-networks-create-nsg-classic-ps.md)![Да][green]|[](virtual-networks-create-nsg-arm-ps.md)![Да][green]|
|Инфраструктура CLI Azure|[](virtual-networks-create-nsg-classic-cli.md)![Да][green]|[](virtual-networks-create-nsg-arm-cli.md)![Да][green]|
|Шаблон ARM|![Нет][red]|[](virtual-networks-create-nsg-arm-template.md)![Да][green]|
