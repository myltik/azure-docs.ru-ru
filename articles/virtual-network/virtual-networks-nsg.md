...
- **Балансировщик нагрузки.** Разрешает Azure Load Balancer инициировать проверку работоспособности виртуальных машин и экземпляров роли. Если переопределить это правило, проверки работоспособности Azure Load Balancer будут завершаться ошибкой, что может повлиять на службу.
