...
| Имя | Приоритет | Исходный IP-адрес | Исходный порт | Конечный IP-адрес | Конечный порт | Протокол | Access |
|------|----------|-----------|-------------|----------------|------------------|----------|--------|
|БЕЗ ДОСТУПА К ИНТЕРНЕТУ|100| VIRTUAL_NETWORK|&\#42;|ИНТЕРНЕТ|&\#42;|TCP|ЗАПРЕТИТЬ| 
...
| Имя | Приоритет | Исходный IP-адрес | Исходный порт | Конечный IP-адрес | Конечный порт | Протокол | Access |
|------|----------|-----------|-------------|----------------|------------------|----------|--------|
|К ИНТЕРНЕТУ|100| VIRTUAL_NETWORK|&\#42;|ИНТЕРНЕТ|&\#42;|TCP|РАЗРЕШИТЬ|
|ИЗ ИНТЕРНЕТА|110| ИНТЕРНЕТ|&\#42;|VIRTUAL_NETWORK|&\#42;|TCP|ЗАПРЕТИТЬ| 
