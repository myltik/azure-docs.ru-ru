...
|Портал Azure|![Нет][red]|<a href="https://azure.microsoft.com/documentation/articles/virtual-networks-create-nsg-arm-pportal">![Да][green]</a>|
...
Дополнительные сведения о планировании обеспечения сетевой безопасности в Azure см. в статье [Облачные службы (Майкрософт) и сетевая безопасность](../best-practices-network-security.md).
