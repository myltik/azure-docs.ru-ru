...
-  Для виртуальных сетей под управлением ARM суффикс можно определить с помощью ресурса [сетевой карты](https://msdn.microsoft.com/library/azure/mt163668.aspx) или командлета [Get-AzureRmNetworkInterface](https://msdn.microsoft.com/library/mt619434.aspx).    
-  Для классического развертывания суффикс можно определить с помощью вызова [API получения развертывания](https://msdn.microsoft.com/library/azure/ee460804.aspx) или командлета [Get-AzureVM -Debug](https://msdn.microsoft.com/library/azure/dn495236.aspx).
