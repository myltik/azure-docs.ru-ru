...
По умолчанию DNS-клиент Windows имеет встроенный кэш DNS. В некоторых дистрибутивах Linux возможность кэширования не включена по умолчанию. Поэтому рекомендуется включать ее на каждой виртуальной машине под управлением ОС Linux. Существует несколько разных доступных пакетов кэширования DNS, включая dnsmasq. Ниже описаны шаги по установке пакета dnsmasq на наиболее распространенные версии ОС.
