<properties
   pageTitle="Создание виртуальной сети с помощью шаблона ARM | Microsoft Azure"
...
В этом документе описывается создание виртуальной сети с помощью модели развертывания диспетчера ресурсов. Вы также можете [создать виртуальную сеть на основе классической модели развертывания](virtual-networks-create-vnet-classic-pportal.md).
