...
Пример рабочего бизнес-приложения, размещенного в Azure, см. в схеме архитектурного проекта **Бизнес-приложения** в разделе [Архитектурные схемы и проекты программного обеспечения Майкрософт](http://msdn.microsoft.com/dn630664).
