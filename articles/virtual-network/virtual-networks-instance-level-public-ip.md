---
title: Общедоступный IP-адрес уровня экземпляра | Microsoft Docs
...
Узнайте, как [выполнить эти действия с помощью модели Resource Manager](virtual-network-ip-addresses-overview-arm.md).
