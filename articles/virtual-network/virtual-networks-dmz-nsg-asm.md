...
Для исходящего трафика стандартное правило разрешает любой трафик в Интернет. В этом примере мы разрешаем исходящий трафик и не меняем никаких исходящих правил. Чтобы заблокировать трафик в обоих направлениях, требуется определенная пользователем маршрутизация. Этот аспект рассмотрен в примере 3 в статье [о сетевой безопасности в облачных службах][HOME].
