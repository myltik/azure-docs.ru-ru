...
Ниже приведены пояснения по каждому правилу. (**Примечание**. Все объекты, в начале имени которых стоит знак доллара (например, $NSGName), являются пользовательскими переменными из сценария, который приведен в разделе справочной информации ниже.)
