...
4.	На странице "Приступая к работе с FastTrack" в разделе **Сначала зарегистрируйтесь для получения пробной версии Office 365** щелкните ссылку **Для предприятий зарегистрироваться здесь**.
...
1.	На компьютере CLIENT1 на странице **Центр администрирования Office 365** на левой панели щелкните **Пользователи**, а затем — **Активные пользователи**.
