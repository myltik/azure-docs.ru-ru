...
Далее необходимо зарегистрировать новую учетную запись Майрософт. Перейдите на веб-сайт **http://outlook.com** и создайте учетную запись с адресом электронной почты, подобным этому: user123@outlook.com. Вам предстоит зарегистрироваться для получения пробной версии Office 365 с использованием этой учетной записи.
...
2.	Откройте Internet Explorer и перейдите на веб-сайт **http://fasttrack.office.com**.
3.	Щелкните **Приступая к работе с FastTrack**.
...
5.	На странице Шаг 1 заполните страницу, указав новую учетную запись Майкрософт в поле **Рабочий адрес электронной почты**, и затем щелкните **Далее**.
6.	На странице шаг 2 введите имя начальной учетной записи Office 365 в первое поле, название вымышленной компании и пароль. Запишите полученный адрес электронной почты (например, user123@contoso123.onmicrosoft.com) и пароль в надежном месте. Эта информация понадобится для завершения мастера настройки средства синхронизации Active Directory на этапе 3. Нажмите кнопку **Далее**.
7.	На странице Шаг 3 введите номер мобильного телефона или смартфона для приема текстовых сообщений, а затем нажмите кнопку **Text me** (Отправить мне текст).
8.	После получения текстового сообщения на телефоне введите код проверки и нажмите кнопку **Создать учетную запись**. 
9.	После того, как Office 365 завершит создание учетной записи щелкните **You're ready to go** (Вы готовы к работе).
...
1.	На странице виртуальной машины в портале управления Azure щелкните **Работает** в столбце СОСТОЯНИЕ для виртуальной машины DS1.
...
1.	Запустите Internet Explorer, введите **http://go.microsoft.com/fwlink/?LinkID=278924** в адресной строке и нажмите клавишу ВВОД. Когда будет предложено запустить dirsync.exe, щелкните стрелку рядом с кнопкой **Сохранить**, щелкните **Сохранить как** и затем нажмите кнопку **Сохранить**, чтобы сохранить файл в папке Загрузки. Подробнее об установке средства см. раздел [Установка или обновление средства синхронизации каталогов](http://technet.microsoft.com/library/jj151800).
2.	Откройте папку **Загрузки**, щелкните правой кнопкой мыши файл **dirsync**, а затем нажмите кнопку **Запуск от имени администратора**.
...
1.	На компьютере CLIENT1 на странице **Центр администрирования Office 365** в левой панели щелкните **Пользователи**, а затем щелкните **Активные пользователи**.
2.	Для **синхронизации Active Directory** щелкните **Настройка**.
3.	На странице "Настройка и управление синхронизацией Active Directory" на шаге 3 щелкните **Активировать**.
...
На компьютере CLIENT1 на странице **Настройка и управление синхронизацией Active Directory** перейдите по ссылке **пользователи** на шаге 6 этой страницы. Если синхронизация службы каталогов завершилась успешно, на экране должно отображаться следующее.

![](./media/virtual-networks-setup-dirsync-hybrid-cloud-testing/CreateDirSyncHybridCloud_4.png)

Столбец **Состояние** указывает, что синхронизация выполнена в результате синхронизации с доменом Active Directory.
...
2.	В свойствах учетной записи Lynda Meyer в разделе **Назначенные лицензии** щелкните **Изменить**.
3.	На вкладке **Назначить лицензию** выберите расположение в поле **Задать местонахождение пользователя** (например, США).
4.	Выберите **Microsoft Office 365 план E3** и щелкните **Сохранить**.
5.	Закройте Internet Explorer.
6.	Запустите Internet Explorer и перейдите на веб-сайт **http://portal.microsoftonline.com**. 
...
8.	После успешного входа можно увидеть главную страницу портала Office 365 с надписью **Let's make a difference today** (Изменим мир сегодня).
