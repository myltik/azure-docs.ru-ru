...
Далее необходимо зарегистрировать новую учетную запись Майрософт. Перейдите на страницу ****http://outlook.com** и создайте учетную запись с электронным адресом, например user123@outlook.com. Вам предстоит зарегистрироваться для получения пробной версии Office 365 с использованием этой учетной записи.
...
2.	Откройте Internet Explorer и перейдите на страницу ****http://fasttrack.office.com**.
...
6.	На странице шаг 2 введите имя начальной учетной записи Office 365 в первое поле, название вымышленной компании и пароль. Запишите полученный электронный адрес (например, user123@contoso123.onmicrosoft.com) и пароль в надежном месте. Эта информация понадобится для завершения мастера настройки средства синхронизации Active Directory на этапе 3. Нажмите кнопку **Далее**.
