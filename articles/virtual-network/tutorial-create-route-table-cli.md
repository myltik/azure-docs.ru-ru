...
С помощью следующей команды установите средство traceroute на виртуальную машину *myVmPrivate*:
...
С помощью следующей команды установите средство traceroute на виртуальную машину *myVmPublic*:
...
> [Настройка конечных точек служб виртуальной сети](virtual-network-service-endpoints-configure.md#azure-cli)
