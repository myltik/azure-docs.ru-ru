...
### <a name="view-effective-security-rules-for-a-virtual-machine"></a>Просмотр действующих правил безопасности виртуальной машины
...
### <a name="view-effective-security-rules-for-a-network-interface"></a>Просмотр действующих правил безопасности сетевого интерфейса
...
1. Откройте портал Azure по адресу https://portal.azure.com.
2. Выберите **Другие службы**, а затем в появившемся списке выберите пункт **Сетевые интерфейсы**.
...
## <a name="view-effective-security-rules-for-a-network-security-group-(nsg)"></a>Просмотр действующих правил безопасности NSG
...
1. Откройте портал Azure по адресу https://portal.azure.com.
2. Щелкните **Другие службы**, а затем в появившемся списке выберите пункт **Группы безопасности сети**.
