...
4. В колонке **Таблица маршрутов** выберите **Effective Routes** (Эффективные маршруты). Для значения параметра **Область действия** будет задана выбранная таблица маршрутов.
