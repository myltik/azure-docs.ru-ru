...
- Группы безопасности сети с конечными точками служб:
  - По-прежнему разрешают исходящий интернет-трафик, передаваемый в Интернет, и, таким образом, разрешают и трафик, передаваемый из виртуальной сети на общедоступные IP-адреса служб Azure.
  - Позволяют запретить трафик, передаваемый на общедоступные IP-адреса, за исключением адресов служб Azure, с помощью [тегов служб](security-overview.md#service-tags) в группах безопасности сети. в качестве назначения в правилах группы безопасности сети можно указать поддерживаемые службы Azure. За обслуживание базовых адресов для этих тегов отвечает платформа Azure.
