---
title: "Пример приложения, которое можно использовать в средах с периметром безопасности | Документация Майкрософт"
...
---
# <a name="sample-application-for-use-with-security-boundary-environments"></a>Пример приложения, которое можно использовать в средах с периметром безопасности
...
## <a name="appvm01---file-server-installation-script"></a>AppVM01: сценарий установки файлового сервера
