---
title: Пример приложения, которое можно использовать в средах с периметром безопасности | Microsoft Docs
...
> [!IMPORTANT]
> **Рекомендация**. Никогда не отключайте усиленную безопасность IE на рабочем сервере. Кроме того, работать в Интернете на рабочем сервере считается плохой идеей. Мы также не рекомендуем предоставлять анонимный доступ к файловым ресурсам. В нашем случае это сделано для простоты.
> 
> 
