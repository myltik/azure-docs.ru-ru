...
## <a name="a-namecreateacreate-the-vm"></a><a name="create"></a>Создание виртуальной машины
...
## <a name="a-name--validateavalidate-vm-creation-and-nics"></a><a name = "validate"></a>Проверка создания виртуальной машины и сетевых карт
...
Если вы создали группу ресурсов, только чтобы выполнить процедуры из этой статьи, можно удалить все ресурсы, удалив группу ресурсов, используя команду `az group delete --name Multi-NIC-VM`.

>[!WARNING]
>Прежде чем удалять группу ресурсов, убедитесь, что в ней содержатся только ресурсы, созданные с помощью скрипта в этой статье. Выполните команду `az resource list --resource-group Multi-NIC-VM` для просмотра ресурсов в группе ресурсов.
