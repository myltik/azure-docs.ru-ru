...
Затем установите Azure PowerShell на локальном компьютере с помощью инструкций из статьи [Установка и настройка Azure PowerShell](../powershell-install-configure.md).
