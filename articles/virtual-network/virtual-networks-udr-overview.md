...
2. маршрут системы с типом прыжка *Виртуальная сеть*, *Пиринг VNet* или *VirtualNetworkServiceEndpoint*;
2. маршрут BGP;
3. маршрут системы с типом прыжка, отличным от типов *Виртуальная сеть*, *Пиринг VNet* или *VirtualNetworkServiceEndpoint*.
