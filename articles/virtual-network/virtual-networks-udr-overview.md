...
- [Просмотр всех маршрутов для подсети](virtual-network-routes-troubleshoot-portal.md) Таблица определяемых пользователем маршрутов отображает только определяемые пользователем маршруты. В ней не отображаются маршруты по умолчанию и маршруты BGP для подсети. Вы можете просмотреть все маршруты по умолчанию, маршруты BGP и определяемые пользователем маршруты для подсети, в которой находится сетевой интерфейс.
