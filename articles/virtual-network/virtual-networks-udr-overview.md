...
Распространение маршрутов BGP можно отключить для подсети с помощью свойства в таблице маршрутов. При обмене маршрутами с Azure с использованием протокола BGP маршруты не добавляются в таблицу маршрутов всех подсетей при отключенном распространении BGP. Активировать VPN-подключения можно с помощью пользовательских маршрутов](#custom-routes) и VPN с типом следующего прыжка. См. дополнительные сведения об [отключении распространения маршрутов BGP](/manage-route-table#create-a-route-table.md).
