...
> [!NOTE]
> Системные маршруты для трафика, связанного с виртуальной сетью, пиринговыми подключениями виртуальной сети или конечными точками службы виртуальной сети, являются предпочтительными, даже если маршруты BGP более четко определены.
