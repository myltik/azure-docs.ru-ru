...
> [!IMPORTANT]
> Защита от атак DDoS Azure уровня "Стандартный" сейчас находится в предварительной версии. Защита обеспечивается для любого ресурса Azure, с которым связан общедоступный IP-адрес Azure. Это может быть виртуальная машина, подсистема балансировки нагрузки или шлюз приложения. Чтобы включить защиту от атак DDoS Azure уровня "Стандартный" для своей подписки, сначала необходимо [зарегистрироваться для использования службы](http://aka.ms/ddosprotection). После регистрации, команда Azure DDoS обращается к вам и проведет вас через процесс включения. Защита от атак DDoS Azure уровня "Стандартный" доступна только в следующих регионах: восточная часть США, восточная часть США 2, западная часть США, центральная часть США, Северная Европа, Западная Европа, западная Япония, восточная Япония, Восточная Азия, Юго-Восточная Азия. При использовании предварительной версии плата за использование службы не взимается.
