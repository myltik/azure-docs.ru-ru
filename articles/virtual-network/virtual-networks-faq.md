...
Да. Дополнительные сведения о диапазонах общедоступных IP-адресов см. в разделе [Create a virtual network](virtual-network-manage-network.md#create-a-virtual-network) (Создание виртуальной сети). Общедоступные IP-адреса не доступны непосредственно из Интернета.
...
Здесь возможны варианты в зависимости от обстоятельств. Нет, если виртуальная машина была развернута с помощью Resource Manager, независимо от того, как был присвоен IP-адрес: с помощью статического или же динамического метода распределения. Если виртуальная машина была развернута с помощью классической модели развертывания, динамические IP-адреса могут изменяться при перезапуске виртуальной машины после того, как она была остановлена (освобождена). В случае удаления виртуальной машины, развернутой с помощью любой модели развертывания, назначенный ей адрес освобождается.
