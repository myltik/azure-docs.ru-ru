...
* **Частные:** назначаются каждому сетевому адаптеру на каждой виртуальной машине. Для назначения адресов может применяться статический или динамический метод распределения. Частные IP-адреса назначаются из диапазона, указанного в параметрах подсети виртуальной сети. Ресурсы, развернутые по классической модели развертывания, получают частные IP-адреса, даже если они не подключены к виртуальной сети. Динамический частный IP-адрес остается назначенным для ресурса, пока этот ресурс не будет освобожден (для виртуальной машины) или удален (для виртуальной машины или слота развертывания облачной службы). Статический частный IP-адрес остается назначенным для ресурса, пока ресурс не будет удален.
