...
>[AZURE.WARNING]Зарезервированный IP-адрес можно назначить только виртуальному IP-адресу.
...
1. Сколько зарезервированных IP-адресов можно назначить облачной службе? 
  - На одну конечную точку в облачной службе разрешен только один IP-адрес, независимо от того, зарезервирован ли он. Резервирование IP-адреса не позволяет добавлять дополнительные IP-адреса для облачной службы.
...
[Зарезервированный частный IP-адрес](../virtual-networks-reserved-private-ip)
