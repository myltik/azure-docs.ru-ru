...
1. Сколько зарезервированных IP-адресов можно установить?
  - На данный момент все подписки Azure авторизованы на использование 20 зарезервированных IP-адресов. Однако вы можете запросить дополнительные зарезервированные IP-адреса. Дополнительные сведения см. на странице [Ограничения подписки и обслуживания](../azure-subscription-service-limits.md).
