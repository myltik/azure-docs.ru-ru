...
- См. статью [IP-адреса в Azure (классическая модель развертывания)](virtual-network-ip-addresses-overview-classic.md), чтобы узнать, как IP-адреса работают в классической модели развертывания.
