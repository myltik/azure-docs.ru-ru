...
1. Как зарезервировать IP-адрес?
  - Для резервирования IP-адреса из определенного региона можно использовать PowerShell или интерфейс [REST API управления Azure](https://msdn.microsoft.com/library/azure/dn722420.aspx). Этот зарезервированный IP-адрес связывается с вашей подпиской. Зарезервировать IP-адрес с помощью портала управления нельзя.
