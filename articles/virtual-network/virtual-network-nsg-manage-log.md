...
1.  Войдите на [портал предварительной версии Azure](http://portal.azure.com). Если группа безопасности сети еще не создана, [создайте ее](virtual-networks-create-nsg-arm-ps.md). 
