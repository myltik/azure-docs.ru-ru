...
#### [Портал](virtual-networks-create-nsg-arm-portal.md)
...
#### [Несколько IP-адресов](virtual-network-multiple-ip-addresses-powershell.md)
...
## [Командлеты PowerShell (Resource Manager)](https://msdn.microsoft.com/library/mt163510(v=azure.300))
## [Командлеты PowerShell (классическая модель)](https://msdn.microsoft.com/library/mt270335(v=azure.300))
## [Интерфейсы API (Resource Manager)](https://msdn.microsoft.com/library/mt163658.aspx)
## [Интерфейсы API (классическая модель)](https://msdn.microsoft.com/library/jj157182.aspx)
