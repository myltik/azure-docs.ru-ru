...
4. В колонке **Выбор размера** щелкните *DS1_V2 Standard*, а затем нажмите кнопку **Выбрать**. Список размеров виртуальных машин Windows, поддерживаемых в Azure, см. в [этой статье](../virtual-machines/virtual-machines-windows-sizes.md?toc=%2fazure%2fvirtual-network%2ftoc.json).
5. В колонке **Параметры** введите или выберите приведенные ниже значения и нажмите кнопку **ОК**.
    ...
    |**Все остальные значения**|Примите значения по умолчанию.|Дополнительные сведения об остальных параметрах см. в статье [Обзор виртуальных машин Windows в Azure](../virtual-machines/virtual-machines-windows-overview.md?toc=%2fazure%2fvirtual-network%2ftoc.json).|
