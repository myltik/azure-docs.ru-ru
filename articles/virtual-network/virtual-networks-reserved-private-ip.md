...
>[AZURE.NOTE] Если требуется протестировать указанную выше команду в защищенной среде, следуйте инструкциям из раздела [Создание виртуальной сети](virtual-networks-create-vnet-classic-portal.md), чтобы создать виртуальную сеть с именем *TestVnet* и убедиться в том, что она использует адресное пространство *10.0.0.0/8*.
