---
title: "IP-адреса (классическая модель) | Документация Майкрософт"
...
---
# <a name="ip-addresses-classic-in-azure"></a>IP-адреса в Azure (классическая модель развертывания)
...
* [Сведения о развертывании виртуальной машины со статическим частным IP-адресом](virtual-networks-static-private-ip-classic-pportal.md) на классическом портале.
