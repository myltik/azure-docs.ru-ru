---
title: Общедоступные и частные IP-адреса в Azure (классическая модель развертывания) | Microsoft Docs
...
Узнайте, как [выполнить эти действия для модели развертывания с помощью Resource Manager](virtual-network-ip-addresses-overview-arm.md).
