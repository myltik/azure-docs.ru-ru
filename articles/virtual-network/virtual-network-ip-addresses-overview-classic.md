...
В следующей таблице показаны ограничения, накладываемые на IP-адресацию в Azure в зависимости от подписки. Для увеличения ограничений по умолчанию до максимальных ограничений в зависимости от потребностей вашего бизнеса вы можете [обратиться в службу поддержки](https://ms.portal.azure.com/#blade/Microsoft_Azure_Support/HelpAndSupportBlade).

||Ограничение по умолчанию|Максимальное ограничение| |---|---|---| |Общедоступные IP-адреса (динамические)|5|связаться со службой поддержки| |Зарезервированные общедоступные IP-адреса|20|связаться со службой поддержки| |Общедоступный виртуальный IP-адрес (ILB) на развертывание (облачная служба)|5|связаться со службой поддержки| |Частный виртуальный IP-адрес (ILB) на развертывание (облачная служба)|1|1|
