...
|Общедоступный виртуальный IP-адрес (ILB) на развертывание (облачная служба)|5|связаться со службой поддержки|
|Частный виртуальный IP-адрес (ILB) на развертывание (облачная служба)|1|1|
