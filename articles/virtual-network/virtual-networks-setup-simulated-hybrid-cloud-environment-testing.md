...
Используйте указания в статье [Тестовая среда с базовой конфигурацией](../virtual-machines/virtual-machines-windows-classic-test-config-env.md), чтобы настроить в виртуальной сети Azure с именем TestLab компьютеры DC1, APP1 и CLIENT1.
