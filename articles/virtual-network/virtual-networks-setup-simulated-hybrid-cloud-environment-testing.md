...
Затем установите Azure PowerShell на локальном компьютере с помощью указаний в статье [Установка и настройка Azure PowerShell](../powershell-install-configure.md).
