...
Затем установите Azure PowerShell на локальном компьютере с помощью указаний в статье [Установка и настройка Azure PowerShell](../install-configure-powershell.md).
...
4.	В столбце **CIDR (число адресов)** выберите **/24 (256)**, а затем щелкните флажок.
...
8.	В столбце **CIDR (число адресов)** выберите **/24 (256)**, а затем щелкните флажок.
...
1.	На портале управления Azure на локальном компьютере щелкните **Сети** в левой области, а затем убедитесь, что в столбце **Состояние** для **TestLab** указано значение **Создана**.
...
5.	Щелкните **Сети** в левой области и убедитесь, что в столбце **Состояние** для TestVNET указано значение **Создана**.
...
1.	На портале управления Azure на локальном компьютере щелкните **Сети** в левой области, щелкните **TestLab**, а затем нажмите кнопку **Панель мониторинга**.
...
3.	Щелкните **Сети** в левой области, щелкните **TestVNET**, а затем нажмите кнопку **Панель мониторинга**.
...
1.	На портале управления Azure на локальном компьютере щелкните **Сети** в левой области, а затем щелкните **TestLab**. На странице панели мониторинга должно отображаться состояние **Шлюз не был создан**.
2.	На панели задач щелкните **Создать шлюз**, а затем щелкните **Динамическая маршрутизация**. Щелкните **Да** при появлении запроса. Подождите, пока шлюз не будет создан и его состояние не изменится на **Подключение**. Это может занять несколько минут.
