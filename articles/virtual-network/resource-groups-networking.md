...
### <a name="arm-template-language"></a>Язык шаблонов ARM
...
Дополнительные сведения о языке шаблонов ARM см. в статье [Authoring Azure Resource Manager templates](../resource-group-authoring-templates.md) (Создание шаблонов Azure Resource Manager).
...
[Azure Resource Manager и классическое развертывание](../resource-manager-deployment-model.md)
