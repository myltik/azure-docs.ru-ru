...
* Подключить виртуальные сети к локальной сети можно с помощью одного из [вариантов подключения](../vpn-gateway/vpn-gateway-about-vpngateways.md#site-to-site-and-multi-site), доступных в Azure.
...
* Узнайте больше о [возможностях подключений к виртуальной сети и распределенных подключений](../vpn-gateway/vpn-gateway-about-vpngateways.md#site-to-site-and-multi-site).
