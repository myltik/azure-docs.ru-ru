...
* Загруженная и установленная последняя версия Azure PowerShell. См. статью [Установка и настройка Azure PowerShell](../powershell-install-configure.md).
