...
1. Установите и настройте Azure CLI 1.0, следуя инструкциям из [этой статьи](../xplat-cli-install.md), а затем войдите в учетную запись Azure, выполнив команду `azure-login`.

2. Зарегистрируйтесь для получения предварительной версии, выполнив следующие команды в PowerShell (невозможно зарегистрироваться с помощью интерфейса командной строки) после входа, и выберите соответствующую подписку:
