---
title: Создание групп безопасности сети в режиме ARM с помощью портала Azure | Microsoft Docs
...
6. Повторите действия до шага 6, чтобы создать правило *rdp-rule* с приоритетом *250*, которое разрешает доступ через *TCP*-порт *3389* к любой виртуальной машине из любого источника.
