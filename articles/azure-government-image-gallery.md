...
Издатель|Имя образа|Описание|Размер диска
---|---|---|---
Barracuda Networks, Inc.|Barracuda Web Application Firewall (WAF) 7.8 PatchLevel 4|Примечание. Это устройство управляется через пользовательский веб-интерфейс, и для этого необходимо переслать TCP/8000. См. файл README https://cloudvm.cudasvc.com/azure/deployment-readme-waf.html о развертывании для получения дополнительных...|Linux|50 ГБ
Barracuda Networks, Inc.|Barracuda NG Firewall 5.4.3-182 PatchLevel 4|Примечание. Это устройство управляется через клиентское приложение, и для этого необходимо переслать TCP/807. См. файл README https://cloudvm.cudasvc.com/azure/deployment-readme-ng.html о развертывании для...|Linux|80 ГБ
...
Группа серверов Microsoft SQL Server|SQL Server 2012 SP2 Standard на базе Windows Server 2012|Некоторые компоненты SQL Server требуют дополнительной установки и настройки перед использованием. Рекомендуется использовать виртуальную машину размера A2 или больше. Этот образ предварительно настроен для использования с Azure...|Windows|127 ГБ
Группа серверов Microsoft SQL Server|SQL Server 2014 RTM Standard на Windows Server 2012 R2|Этот образ содержит полную версию SQL Server. Рекомендуется использовать виртуальную машину размера A2 или больше. Этот образ предварительно настроен для использования с Azure. В нем, помимо прочего, включена поддержка CEIP, что...|Windows|127 ГБ
Группа серверов Microsoft Windows Server|Windows Server 2012 R2 Datacenter, июнь 2104 г.|В основе концепции Microsoft Cloud OS находится ОС Windows Server 2012 R2, которая позволяет вам использовать в своей инфраструктуре глобальные облачные службы Майкрософт. Эта операционная система предлагает производительность корпоративного класса...|Windows|128 ГБ
Группа серверов Microsoft Windows Server|Windows Server 2012 Datacenter, июнь 2014 г.|В ОС Windows Server 2012 собран опыт корпорации Майкрософт по созданию и эксплуатации общедоступных облаков, что позволяет получить динамичную и высокодоступную серверную платформу. Они предлагает масщтабируемую, динамичную и мультитенантную...|Windows|128 ГБ
Группа серверов Microsoft Windows Server|Windows Server 2008 R2 SP1, июнь 2014 г.|Windows Server 2008 R2 — это многоцелевой сервер, разработанный для повышения надежности и гибкости ваших серверов или инфраструктуры частных облаков в целях экономии времени и снижения затрат. Он обеспечивает...|Windows|128 ГБ
Группа серверов Microsoft Windows Server|Windows Server 2008 R2 SP1, сентябрь 2014 г.|Windows Server 2008 R2 — это многоцелевой сервер, разработанный для повышения надежности и гибкости ваших серверов или инфраструктуры частных облаков в целях экономии времени и снижения затрат. Он обеспечивает...|Windows|128 ГБ
Группа серверов Microsoft Windows Server|Windows Server 2008 R2 SP1, октябрь 2014 г.|Windows Server 2008 R2 — это многоцелевой сервер, разработанный для повышения надежности и гибкости ваших серверов или инфраструктуры частных облаков в целях экономии времени и снижения затрат. Он обеспечивает...|Windows|128 ГБ
Группа серверов Microsoft Windows Server|Windows Server 2008 R2 SP1, ноябрь 2014 г.|Windows Server 2008 R2 — это многоцелевой сервер, разработанный для повышения надежности и гибкости ваших серверов или инфраструктуры частных облаков в целях экономии времени и снижения затрат. Он обеспечивает...|Windows|128 ГБ
Группа серверов Microsoft Windows Server|Windows Server 2008 R2 SP1, апрель 2015 г.|Windows Server 2008 R2 — это многоцелевой сервер, разработанный для повышения надежности и гибкости ваших серверов или инфраструктуры частных облаков в целях экономии времени и снижения затрат. Он обеспечивает...|Windows|128 ГБ
Группа серверов Microsoft Windows Server|Windows Server 2012 Datacenter, сентябрь 2014 г.|В ОС Windows Server 2012 собран опыт корпорации Майкрософт по созданию и эксплуатации общедоступных облаков, что позволяет получить динамичную и высокодоступную серверную платформу. Они предлагает масщтабируемую, динамичную и мультитенантную...|Windows|128 ГБ
Группа серверов Microsoft Windows Server|Windows Server 2012 Datacenter, ноябрь 2014 г.|В ОС Windows Server 2012 собран опыт корпорации Майкрософт по созданию и эксплуатации общедоступных облаков, что позволяет получить динамичную и высокодоступную серверную платформу. Они предлагает масщтабируемую, динамичную и мультитенантную...|Windows|128 ГБ
Группа серверов Microsoft Windows Server|Windows Server 2012 Datacenter, октябрь 2014 г.|В ОС Windows Server 2012 собран опыт корпорации Майкрософт по созданию и эксплуатации общедоступных облаков, что позволяет получить динамичную и высокодоступную серверную платформу. Они предлагает масщтабируемую, динамичную и мультитенантную...|Windows|128 ГБ
Группа серверов Microsoft Windows Server|Windows Server 2012 R2 Datacenter, сентябрь 2014 г.|В основе концепции Microsoft Cloud OS находится ОС Windows Server 2012 R2, которая позволяет вам использовать в своей инфраструктуре глобальные облачные службы Майкрософт. Эта операционная система предлагает производительность корпоративного класса...|Windows|128 ГБ
Группа серверов Microsoft Windows Server|Windows Server 2012 R2 Datacenter, октябрь 2014 г.|В основе концепции Microsoft Cloud OS находится ОС Windows Server 2012 R2, которая позволяет вам использовать в своей инфраструктуре глобальные облачные службы Майкрософт. Эта операционная система предлагает производительность корпоративного класса...|Windows|128 ГБ
Группа серверов Microsoft Windows Server|Windows Server 2012 R2 Datacenter, ноябрь 2014 г.|В основе концепции Microsoft Cloud OS находится ОС Windows Server 2012 R2, которая позволяет вам использовать в своей инфраструктуре глобальные облачные службы Майкрософт. Эта операционная система предлагает производительность корпоративного класса...|Windows|128 ГБ
Группа серверов Microsoft Windows Server|Windows Server 2012 R2 Datacenter, апрель 2015 г.|В основе концепции Microsoft Cloud OS находится ОС Windows Server 2012 R2, которая позволяет вам использовать в своей инфраструктуре глобальные облачные службы Майкрософт. Эта операционная система предлагает производительность корпоративного класса...|Windows|128 ГБ
Группа серверов Microsoft Windows Server|Windows Server Technical Preview|В основе концепции облачной платформы Майкрософт находится ОС Windows Server, которая позволяет вам использовать в инфраструктуре своего центра обработки данных глобальные облачные службы Майкрософт. Windows S...|Windows|128 ГБ
Группа серверов Microsoft Windows Server|Windows Server 2012 Datacenter, апрель 2015 г.|В ОС Windows Server 2012 собран опыт корпорации Майкрософт по созданию и эксплуатации общедоступных облаков, что позволяет получить динамичную и высокодоступную серверную платформу. Они предлагает масщтабируемую, динамичную и мультитенантную...|Windows|128 ГБ
...
SUSE|SUSE Linux Enterprise Server 11 SP3|Уверенно запускайте вашу рабочую нагрузку на SUSE Linux Enterprise Server в Microsoft Azure, зная, что ваши уровни обслуживания гарантированы и что помощь от инженеров SUSE и Майкрософт, если вы ...|Linux|30 ГБ
SUSE|SUSE Linux Enterprise Server 11 SP3 (образ Premium)|Уверенно запускайте вашу рабочую нагрузку на SUSE Linux Enterprise Server в Microsoft Azure, зная, что ваши уровни обслуживания гарантированы и что помощь от инженеров SUSE и Майкрософт, если вы ...|Linux|30 ГБ
...
- [Развертывание виртуальной машиныWindows](../virtual-machines/virtual-machines-windows-tutorial.md)

- [Развертывание виртуальной машины Linux](../virtual-machines/virtual-machines-linux-tutorial.md)

- [Вопросы и ответы по виртуальным машинам](http://msdn.microsoft.com/library/azure/dn683781.aspx)

- [Создание и отправка собственного виртуального жесткого диска](../virtual-machines-create-upload-vhd-windows-server/)

- [Запись образа виртуальной машины Linux](../virtual-machines/virtual-machines-linux-capture-image.md)
