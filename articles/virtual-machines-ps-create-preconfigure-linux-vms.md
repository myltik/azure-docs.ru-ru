...
Дополнительные сведения о настройке виртуальных машин под управлением Windows см. в разделе [Использование Azure PowerShell для создания и предварительной настройки виртуальных машин под управлением Windows](../virtual-machines-ps-create-preconfigure-windows-vms/).
...
Дополнительные сведения см. в разделе [Использование SSH с Linux в Azure](../virtual-machines-linux-use-ssh-key/).
...
После создания виртуальной машины см. раздел [Как войти в виртуальную машину под управлением Linux](../virtual-machines-linux-how-to-log-on/). 
