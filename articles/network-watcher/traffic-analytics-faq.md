---
title: Часто задаваемые вопросы по Аналитике трафика Azure | Документация Майкрософт
description: Получите ответы на некоторые часто задаваемые вопросы об Аналитике трафика Azure.
...
1.  Что необходимо, чтобы использовать Аналитику трафика?
...
12.  Как устранить проблему, если появились сообщение о том, что: 1) журналы потоков NSG анализируются впервые, это может занять от 20 до 30 минут и следует подождать некоторое время; 2) если способ выше не сработал, а у рабочей области бесплатный номер SKU, следует проверить используемый объем рабочей области, чтобы убедиться, что не превышена квота, или просмотреть раздел часто задаваемых вопросов, чтобы узнать дополнительные сведения.
        ...
        - Если решение "Аналитика трафика" включено недавно, оно должно выполнить достаточно статистических вычислений для того, чтобы произвести важные аналитические сведения и можно было создать отчет. В таком случае повторите попытку через 30 минут.
...
14.  Как образуются цены на Аналитику трафика?

        Аналитика трафика в общедоступной предварительной версии бесплатна. Создание журналов потоков NSG и хранение данных в рабочей области OMS оплачиваются согласно заявленным тарифам.

15.  Как перемещаться в представлении географической карты с помощью клавиатуры?
