...
Дополнительные сведения об этом подключаемого модуля см. в документации, доступной [здесь](https://github.com/Azure/azure-diagnostics-tools/tree/master/Logstash/logstash-input-azureblob).
