...
![Выберите экземпляр, а затем выберите «...»](./media/appinsights/appinsights-23-customevents-4.png)


Используйте поле поиска для просмотра вхождений события с определенным значением свойства.


![Введите слово в поле поиска](./media/appinsights/appinsights-23-customevents-5.png)
...
![Область «Использование» в колонке «Обзор»](./media/appinsights/appinsights-47usage-2.png)
