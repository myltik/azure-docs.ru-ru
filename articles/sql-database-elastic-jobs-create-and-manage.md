...
* Установка компонентов службы заданий эластичной базы данных. См. статью [Установка компонентов службы заданий эластичной базы данных](vsql-database-elastic-jobs-service-installation.md).

## Создание заданий

1. В колонке пула заданий эластичной базы данных выберите **Создать задание**.
2. Введите имя и пароль администратора базы данных (создается во время установки).
2. В колонке **Создание задания** введите имя задания.
3. Вставьте или введите сценарий T-SQL.
4. Нажмите **Сохранить**, затем нажмите кнопку **Запустить**.
