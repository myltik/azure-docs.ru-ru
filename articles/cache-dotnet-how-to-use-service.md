...
-   Кэширование любых сериализуемых объектов, например объектов среды CLR, строк, XML, двоичных данных.
...
После вызова командлета PowerShell cоздание кэша может занять несколько минут. После создания новый кэш имеет состояние `Running` и готов для использования со значениями по умолчанию, его можно просмотреть и настроить на [портале управления Azure][]. Сведения о настройке конфигурации кэша см. в следующем разделе [Настройка кэша][].
...
Чтобы работать с кэшем программными средствами, требуется ссылка на кэш. Добавьте следующий код в начало любого файла, из которого вы хотите использовать
Кэш Azure:
...
[Планирование мощности]: http://go.microsoft.com/fwlink/?LinkId=320167
