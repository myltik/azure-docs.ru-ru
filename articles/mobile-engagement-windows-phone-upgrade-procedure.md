<properties 
	...
	description="Процедуры обновления пакета SDK для Windows Phone для Azure Mobile Engagement" 					
...
[Веб-сайт NuGet]:http://www.nuget.org/packages/Capptain.WindowsPhone
