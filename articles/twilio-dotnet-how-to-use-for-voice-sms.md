---
title: Использование Twilio для поддержки голосовых вызовов и SMS (.NET) | Microsoft Docs
...
> [!NOTE]
> Хотя TwiML предназначается для использования веб-службами, TwiML можно также просмотреть в браузере. Например, перейдите по ссылке [http://twimlets.com/message](twimlet_message_url.md) для просмотра пустого элемента &lt;Response&gt;. Другой пример: перейдите по ссылке [http://twimlets.com/message?Message%5B0%5D=Hello%20World](twimlet_message_url_hello_world.md), чтобы отобразить элемент &lt;Response&gt;, содержащий еще один элемент &lt;Say&gt;.
> 
> 
