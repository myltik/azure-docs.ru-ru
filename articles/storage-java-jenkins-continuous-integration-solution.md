...
-   [Общие сведения о Jenkins][Общие сведения о Jenkins]
-   [Преимущества использования службы BLOB-объектов][Преимущества использования службы BLOB-объектов]
-   [Предварительные требования][Предварительные требования]
-   [Использование службы BLOB-объектов с решением непрерывной интеграции Jenkins][Использование службы BLOB-объектов с решением непрерывной интеграции Jenkins]
...
Дополнительные сведения о Jenkins см. в разделе [Знакомство с Jenkins][Знакомство с Jenkins].
