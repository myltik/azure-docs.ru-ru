...
*Автор [сотрудник Microsoft Open Technologies Inc.][]*
...
-   [Создание шага построения для загрузки blob-объектов из хранилища Azure][]
-   [Компоненты, используемые службой BLOB-объектов][]

## <a name="overview"></a><span class="short header">Обзор</span>Общие сведения о Jenkins
...
## <a name="benefits"></a><span class="short header">Преимущества</span>Преимущества использования службы BLOB-объектов
...
## <a name="prerequisites"></a><span class="short header">Предварительные требования</span>Предварительные требования
...
-   Решение непрерывной интеграции Jenkins.
    ...
    3.  В браузере откройте `http://localhost:8080/`. Открывается панель мониторинга Jenkins, которую вы будете использовать для установки и настройки подключаемого модуля хранилища Azure.
...
-   Учетная запись хранилища Azure. Если у вас еще нет учетной записи хранения, ее можно создать с помощью процедуры [Создание учетной записи хранения][].
...
## <a name="howtouse"></a><span class="short header">Использование службы BLOB-объектов</span>Использование службы BLOB-объектов с решением непрерывной интеграции Jenkins
...
## <a name="howtoinstall"></a><span class="short header">Установка</span>Установка подключаемого модуля хранилища Azure
...
## <a name="howtoconfigure"></a><span class="short header">Настройка</span>Настройка подключаемого модуля хранилища Azure для использования вашей учетной записи хранения
...
## <a name="howtocreatepostbuild"></a><span class="short header">Создание действия, выполняемого после построения</span>Создание действия, выполняемого после построения и отправляющего артефакты построения в вашу учетную запись хранения
...
## <a name="components"></a><span class="short header">Компоненты службы BLOB-объектов</span>Компоненты, используемые службой BLOB-объектов
...
-   **Форматы URL-адреса**: Для адресации BLOB-объектов используется следующий формат URL-адресов:
  ...
  [Что такое BLOB-блоки и BLOB-страницы]: http://msdn.microsoft.com/en-us/library/windowsazure/ee691964.aspx
