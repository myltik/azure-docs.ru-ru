...
Компонент восстановления, представленный на [портале Azure](http://go.microsoft.com/fwlink/?LinkId=529715) в колонке **Резервные копии**, доступен только в режимах Standard и Premium. Дополнительные сведения о масштабировании приложений с помощью режимов Standard и Premium см. в разделе [Масштабирование веб-приложения в службе приложений Azure](web-sites-scale.md). 
Обратите внимание, что режим Premium позволяет ежедневно создавать больше резервных копий, чем режим Standard.
...
3. Чтобы восстановить существующее веб-приложение, проверьте в колонке **Восстановить** все сведения, после чего щелкните **OK**. 
...
5. Выбранный файл можно скачать** **или** **. Обратите внимание, что существует два основных типа файлов: ZIP и XML. 

<a name="OperationLogs"></a>
## Просмотр журналов аудита
	
1. Чтобы просмотреть подробные сведения о результате восстановления, в главной колонке **Обзор** выберите элемент **Журнал аудита**. 
