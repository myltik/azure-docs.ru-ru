...
2. Добавьте следующий метод, чтобы получить сохраненный языковой стандарт:
...
3. В MainPage.xaml.cs обновите обработчик нажатия кнопки с помощью получения текущего значения поля языкового стандарта и предоставления его для вызова класса уведомлений, как показано:
...
Дополнительные сведения об использовании шаблонов см. в учебниках [Уведомление пользователей с помощью концентраторов уведомлений: ASP.NET], [Уведомление пользователей с помощью концентраторов уведомлений: мобильные службы] и см. также [Руководства по использованию концентраторов уведомлений]. Справочник по языку выражений шаблона см. в учебнике [Инструкциях по использованию концентраторов уведомлений для Магазина Windows].
...
[Push-уведомления для пользователей приложений]: /ru-ru/develop/mobile/tutorials/push-notifications-to-app-users-dotnet
