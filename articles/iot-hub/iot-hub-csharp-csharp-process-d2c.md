<properties
    pageTitle="Обработка сообщений, отправляемых с устройства центра IoT в облако (.Net) | Microsoft Azure"
...
> [AZURE.NOTE] Для центра IoT существуют пакеты SDK для многих платформ устройств и языков (включая C, Java и JavaScript). Чтобы узнать, как заменить имитацию устройства в этом руководстве физическим устройством, а также подключить устройства к Центру Интернета вещей Azure, см. [Центр разработчиков для Azure IoT].
