...
- Модуль **SensorTag** отправляет сообщения в модуль **сопоставления** и модуль **принтера BLE**.
...
- Модуль **сопоставления** отправляет сообщения обратно в модуль **SensorTag**.
