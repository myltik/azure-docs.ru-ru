...
6. Подключитесь к устройству SensorTag с помощью его MAC-адреса, введя команду **connect <MAC-адрес>**. Обратите внимание, что приведенный ниже пример выходных данных является сокращенным:
