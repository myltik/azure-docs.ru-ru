...
Интеграция службы "Сетка событий" теперь находится в общедоступной предварительной версии и доступна не во всех регионах. Интеграция работает для Центров Интернета вещей, которые расположены в следующих регионах:
...
Подписки событий Центра Интернета вещей могут фильтровать события по типу событий и имени устройства. Фильтры темы в службе "Сетка событий" работают на основе совпадений **префиксов** и **суффиксов**, что позволяет доставлять подписчику события с соответствующей темой. 
