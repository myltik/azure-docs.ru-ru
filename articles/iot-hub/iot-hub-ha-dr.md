...
В модели с отработкой отказа между регионами серверная часть решения работает преимущественно в одном центре обработки данных, но в другом ЦОД в другом регионе развертываются дополнительный Центр Интернета вещей и дополнительная серверная часть. Если в Центре Интернета вещей в основном центре обработки данных произойдет сбой или подключение устройства к основному ЦОД по какой-то причине будет нарушено, устройства используют дополнительную конечную точку службы всякий раз, когда основной шлюз недоступен. Использование дополнительного региона при отработках отказов позволяет еще больше повысить уровень доступности решения.
