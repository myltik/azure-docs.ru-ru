---
title: "Высокий уровень доступности и аварийное восстановление Центра Интернета вещей | Документация Майкрософт"
...
В модели с отработкой отказа между регионами серверная часть решения работает преимущественно в одном центре обработки данных, но в другом ЦОД в другом регионе развертываются дополнительный Центр Интернета вещей и дополнительная серверная часть. Если в основном ЦОД произойдет сбой или подключение устройства к основному ЦОД по какой-то причине будет нарушено, то устройства подключатся к дополнительному центру обработки данных. Использование дополнительного региона при отработках отказов позволяет еще больше повысить уровень доступности решения.
