---
title: Высокий уровень доступности и аварийное восстановление центра IoT | Microsoft Docs
...
* [Что такое центр IoT в Azure?][Что такое центр IoT в Azure?]
