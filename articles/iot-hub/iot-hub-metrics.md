---
title: "Метрики диагностики центра IoT"
description: "Обзор метрик Центра Интернета вещей Azure, позволяющих пользователям оценивать общую работоспособность их ресурсов."
services: iot-hub
documentationcenter: 
author: nberdy
manager: timlt
...
## <a name="metrics-and-how-to-use-them"></a>Метрики и их использование
...
Вы ознакомились с общими сведениями о метриках диагностики. Чтобы узнать больше об управлении Центром Интернета вещей Azure, перейдите по этой ссылке:
