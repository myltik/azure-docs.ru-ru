...
Центр Интернета вещей поддерживает только запись данных в контейнеры службы хранилища Azure в виде больших двоичных объектов формата [Apache Avro](http://avro.apache.org/). Центр Интернета вещей собирает сообщения и записывает данные в большой двоичный объект при достижении любого определенного размера или после истечения отведенного времени, в зависимости от того, какое событие произойдет раньше. Центр Интернета вещей не записывает данные в пустой большой двоичный объект, если нет данных для записи.
