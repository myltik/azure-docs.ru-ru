...
В пакет SDK входит [файл сведений](https://github.com/Azure/azure-iot-sdks/tree/master/c) , который содержит инструкции по подготовке среды разработки и получению учетных данных устройства.
