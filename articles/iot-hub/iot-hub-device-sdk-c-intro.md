...
Перед запуском примеров из пакета SDL для устройств Azure IoT для C вам нужно выполнить две задачи: подготовить среду разработки и получить учетные данные устройства. Инструкции по выполнению этих задач включены в [файл сведений](https://github.com/Azure/azure-iot-sdks/tree/master/c), входящий в состав пакета SDK. В следующих разделах приведены дополнительные комментарии к этим инструкциям.
