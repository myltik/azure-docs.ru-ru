---
title: Использование пакета SDK для устройств Azure IoT для C | Microsoft Docs
...
> > [!NOTE]
> > В этой статье нет сведений об использовании возможностей *управления устройствами* библиотек C из пакета SDK. Чтобы узнать, как использовать возможности управления устройствами, см. раздел [Знакомство с клиентской библиотекой управления устройствами для центра Azure IoT](iot-hub-device-management-library.md).
> > 
> > 
> 
> 
