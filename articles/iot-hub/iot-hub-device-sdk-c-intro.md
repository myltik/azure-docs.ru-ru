---
title: "Использование пакета SDK для устройств Azure IoT для C | Документация Майкрософт"
...
---
# <a name="introducing-the-azure-iot-device-sdk-for-c"></a>Знакомство с пакетом SDK для устройств Azure IoT для C
