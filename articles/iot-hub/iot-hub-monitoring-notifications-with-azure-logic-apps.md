...
description: "Azure Logic Apps можно использовать для мониторинга температуры в Центре Интернета вещей и автоматической отправки уведомлений по электронной почте в почтовый ящик для обнаруженных аномалий."
services: iot-hub
documentationcenter: 
author: shizn
manager: timtl
...
1. На [портале Azure](https://portal.azure.com/) последовательно выберите **Создать** > **Enterprise Integration** (Корпоративная интеграция) > **Service Bus** (Служебная шина).
...
1. На [портале Azure](https://portal.azure.com/) последовательно выберите **Создать** > **Enterprise Integration** (Корпоративная интеграция) > **Приложение логики**.
1. Введите следующие сведения:
