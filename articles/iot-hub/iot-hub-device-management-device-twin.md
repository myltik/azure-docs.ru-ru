...
---
# Учебник. Как использовать "двойник" устройства с помощью C# (предварительная версия)
...
3. Полная запись: запись свойства **Timezone** в физическое устройство.
4. Полное чтение: чтение свойства **Timezone** из физического устройства, чтобы проверить, не изменилось ли оно.
