---
title: Сравнение центра IoT Azure и концентраторов событий Azure | Microsoft Docs
...
Одним из основных способов использования центра IoT Azure (IoT — «Интернет вещей») является сбор телеметрических данных с устройств. По этой причине центр IoT часто сравнивается с [концентраторами событий Azure][концентраторами событий Azure]. Как и центры IoT, концентраторы событий — это служба обработки событий, используемая для крупномасштабной передачи событий и данных телеметрии в облако при низкой задержке и с высокой надежностью.
