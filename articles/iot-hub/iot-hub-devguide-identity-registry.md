...
Дополнительные сведения об интерфейсах API импорта и экспорта см. в статье [IoT Hub resource provider REST APIs][lnk-resource-provider-apis] (Интерфейсы REST API поставщика ресурсов Центра Интернета вещей). Дополнительные сведения о выполнении заданий импорта и экспорта см. в статье [Массовое управление удостоверениями устройств Центра Интернета вещей][lnk-bulk-identity].
