...
В идентификаторе устройства, хранящемся в реестре идентификаторов, учитывается регистр.
...
Этот раздел имеет формат JSON и предоставляет двойник созданного удостоверения устройства. Например,
``` 
{
