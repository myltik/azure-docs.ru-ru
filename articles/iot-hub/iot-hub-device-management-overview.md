...
Теперь, когда мы рассмотрели основные понятия на стороне службы, рассмотрим создание управляемого физического устройства. Клиентская библиотека управления устройствами для центра Azure IoT позволяет управлять устройствами IoT с помощью центра Azure IoT. Под управлением понимаются такие действия, как перезагрузка, сброс настроек фабрики и обновление встроенного ПО. Сейчас доступна независимая от платформы библиотека на C, но скоро мы добавим поддержку других языков.
...
Дополнительные сведения об этих обязанностях и реализации на физическом устройстве см. в статье [Знакомство с клиентской библиотекой управления устройствами для центра Azure IoT][lnk-library-c].
...
Чтобы продолжить ознакомление с управлением устройствами центра IoT Azure, см. руководство [Приступая к работе с функцией управления устройствами центра IoT Azure с использованием C# (предварительная версия)][lnk-get-started].
