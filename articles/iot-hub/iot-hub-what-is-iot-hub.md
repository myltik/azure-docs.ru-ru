<properties
 ...
 description="Обзор службы центра IoT Azure, архитектуры Интернета вещей, подключения устройств и моделей связи, в частности модели связи через службу."
 services="iot-hub"
 documentationCenter=""
