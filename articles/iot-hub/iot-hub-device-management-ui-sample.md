...
> [AZURE.NOTE] Если дочерние задания вернут состояние "failed" (Сбой), проверьте, выполняются ли ваши имитации устройств в тестовой системе. Если это не так, еще раз выполните файл simulate.bat или сценарий simulate.sh и повторите процесс перезагрузки устройств с помощью задания, описанный в предыдущем разделе.
