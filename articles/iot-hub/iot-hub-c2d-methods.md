---
title: Использование прямых методов | Microsoft Docs
...
> [!NOTE]
> На данный момент доступ к прямым методам можно получить только на устройствах, подключающихся к Центру Интернета вещей по протоколу MQTT. Указания по преобразованию существующего приложения устройства для использования MQTT см. в статье [Поддержка MQTT][lnk-devguide-mqtt].
> 
> 
