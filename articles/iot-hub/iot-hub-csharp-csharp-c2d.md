...
* 
            **SimulatedDevice**, измененную версию приложения, созданного в руководстве [Подключение устройства к Центру Интернета вещей с помощью .NET]. Это приложение подключается к Центрe Интернета вещей и получает сообщения с облака на устройство.
...
[документации по Azure IoT Suite]: https://docs.microsoft.com/azure/iot-suite/
