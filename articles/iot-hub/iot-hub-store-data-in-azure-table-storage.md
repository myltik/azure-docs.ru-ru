...
1. На [портале Azure](https://portal.azure.com/) щелкните **Создать** > **Хранилище** > **Учетная запись хранения**.
...
1. Создайте новую функцию приложения-функции.
   ...
   1. Щелкните **Создайте эту функцию**, а затем — нажмите **Новая функция**.
   1. Выберите **JavaScript** в качестве языка и **Обработка данных** в качестве сценария.
