---
title: "Подключение Intel Edison (Node) к Интернету вещей Azure. Приступая к работе | Документация Майкрософт"
...
---
# <a name="connect-your-intel-edison-device-to-your-iot-hub-using-nodejs"></a>Подключение устройства Intel Edison к Центру Интернета вещей с помощью Node.js
...
Ознакомьтесь со статьей [Создание Центра Интернета вещей и регистрация Intel Edison](iot-hub-intel-edison-kit-node-lesson2-prepare-azure-iot-hub.md).
