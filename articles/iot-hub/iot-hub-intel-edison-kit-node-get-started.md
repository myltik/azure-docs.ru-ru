---
title: "Приступая к работе с начальным набором Интернета вещей Azure для Intel Edison | Документация Майкрософт"
...
---
# <a name="get-started-with-intel-edison-nodejs"></a>Начало работы с Intel Edison (Node.js)
