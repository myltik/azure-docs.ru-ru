...
Центр Интернета вещей ограничивает размер итоговых значений `tags`, `properties/desired` и `properties/reported` до 8 КБ. Это ограничение не относится к элементам только для чтения.
