---
title: Руководство разработчика. Язык запросов | Microsoft Docs
...
> [!NOTE]
> [Пакеты SDK Центра Интернета вещей][lnk-hub-sdks] поддерживают разбивку на страницы объемных результатов.
> 
> 
