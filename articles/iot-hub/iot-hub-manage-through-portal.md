...
**Учетная запись хранения**. На портале выберите учетную запись хранения в своей текущей подписке для связывания с центром IoT. Центр IoT будет создавать универсальные коды ресурса (URI) SAS на основе этой учетной записи хранения, которые будут использоваться устройствами при передаче файлов.
