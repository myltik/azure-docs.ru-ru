---
title: Использование портала Azure для управления центром IoT | Microsoft Docs
...
> [!NOTE]
> Служба центров IoT позволяет подключить только один центр уровня "Бесплатный" для каждой подписки.
> 
> 
