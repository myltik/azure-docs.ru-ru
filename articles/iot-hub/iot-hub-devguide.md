...
| Операции отправки файлов | 100 уведомлений об отправке файлов в минуту на единицу. <br/> Для учетной записи хранения одновременно может быть выдано 10 000 кодов URI SAS. <br/> Для одного устройства одновременно может быть выдано 10 кодов URI SAS. | 
