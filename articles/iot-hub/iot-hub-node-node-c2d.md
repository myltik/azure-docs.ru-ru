...
# <a name="tutorial:-how-to-send-cloud-to-device-messages-with-iot-hub-and-node.js"></a>Учебник. Как отправлять сообщения из облака на устройства с помощью центра IoT и Node.js
...
Дополнительные сведения о сообщениях, отправляемых с облака на устройство, можно найти в [руководстве разработчика по Центру Интернета вещей][IoT Hub Developer Guide - C2D].
