...
[Начало работы с центром IoT]: iot-hub-node-node-getstarted.md
[Приступая к работе с центром Azure IoT с использованием Java]: iot-hub-node-node-getstarted.md
[Приступая к работе с центром Azure IoT с использованием Node.js]: iot-hub-node-node-getstarted.md
