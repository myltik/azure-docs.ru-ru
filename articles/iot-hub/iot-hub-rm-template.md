...
4. Замените содержимое файла **parameters.json** следующим параметром, который задает имя нового центра IoT — **mynewiothub** \(обратите внимание, что это должно быть глобально уникальное имя\).
