...
# <a name="tutorial:-how-to-process-iot-hub-device-to-cloud-messages-using-java"></a>Учебник: как обрабатывать сообщения, отправляемые с устройства центра IoT в облако, с помощью Java
