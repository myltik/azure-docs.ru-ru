---
title: 'Управление устройствами в центре IoT: '
;двойники";: ''
'|': ''
microsoft: ''
azure": ''
description: 'В учебнике по использованию Azure IoT Hub для управления устройствами описывается, как использовать '
устройств.": ''
services: iot-hub
...
3. Запустите `node jobClient_devicePropertyReadWrite.js`.
