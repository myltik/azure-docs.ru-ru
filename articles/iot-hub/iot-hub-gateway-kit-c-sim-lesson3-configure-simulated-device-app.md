...
# Настройка и запуск примера приложения для имитации устройства
...
## Настройка имитации устройства и NUC
...
## Получение строки подключения логического устройства Центра Интернета вещей
...
## Настройка примера приложения отправки в облако для имитации устройства
