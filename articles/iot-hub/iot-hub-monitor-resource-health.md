...
Параметры диагностики Azure Monitor заменяют операции мониторинга Центра Интернета вещей. Если вы выполняете мониторинг пользовательских операций, необходимо перенести рабочие процессы. Дополнительную информацию см. в статье [Перенос Центра Интернета вещей для перехода с операций мониторинга к параметрам диагностики][lnk-migrate].
