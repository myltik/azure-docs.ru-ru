...
Когда устройство уведомляет Центр Интернета вещей о завершении передачи, Центр Интернета вещей может при необходимости создать сообщение уведомления, которое содержит имя и расположение файла.
