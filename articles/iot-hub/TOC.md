...
## [Приступая к работе с двойниками устройств (Node)](iot-hub-node-node-twin-getstarted.md)
## [Приступая к работе с двойниками устройств (.NET или Node)](iot-hub-csharp-node-twin-getstarted.md)
## [Использование прямых методов для Node.js](iot-hub-node-node-direct-methods.md)
## [Использование прямых методов для .NET или Node](iot-hub-csharp-node-direct-methods.md)
## [Приступая к управлению устройствами для Node.js](iot-hub-node-node-device-management-get-started.md)
## [Приступая к управлению устройствами для .NET или Node](iot-hub-csharp-node-device-management-get-started.md)
## [Как использовать свойства двойников (Node)](iot-hub-node-node-twin-how-to-configure.md)
## [Как использовать свойства двойников (.NET или Node)](iot-hub-csharp-node-twin-how-to-configure.md)
## [Использование заданий устройства для обновления встроенного ПО устройства для Node.js](iot-hub-node-node-firmware-update.md)
## [Использование заданий устройства для обновления встроенного ПО устройства для .NET или Node](iot-hub-csharp-node-firmware-update.md)
## [Планирование и трансляция заданий для Node.js](iot-hub-node-node-schedule-jobs.md)
## [Планирование и трансляция заданий для .NET или Node](iot-hub-csharp-node-schedule-jobs.md)
...
## Управление службой
### [Создание Центра Интернета вещей с помощью портала](iot-hub-create-through-portal.md)
### [Создание Центра Интернета вещей с помощью интерфейса командной строки](iot-hub-create-using-cli.md)
### [Создание Центра Интернета вещей с помощью REST](iot-hub-rm-rest.md)
### [Создание Центра Интернета вещей с помощью PowerShell](iot-hub-rm-template-powershell.md)
### [Создание Центра Интернета вещей с помощью шаблона](iot-hub-rm-template.md)
...
## [Пакеты SDK для Azure IoT](http://azure.github.io/azure-iot-sdks/)
## [API пакета SDK для шлюза](http://azure.github.io/azure-iot-gateway-sdk)
## [REST API поставщика ресурсов](https://docs.microsoft.com/rest/api/iothub/resourceprovider/iot-hub-resource-provider-rest)
## [REST API удостоверений устройств](https://docs.microsoft.com/rest/api/iothub/device-identities-rest)
## [REST API обмена сообщениями между устройствами](https://docs.microsoft.com/rest/api/iothub/device-messaging-rest-apis)
