...
В следующих разделах каждая из этих возможностей управления устройствами рассматривается более подробно, а также описывается высокоуровневая модель для их реализации с помощью центра IoT Azure.
