<properties
 pageTitle="Руководство разработчика. Обмен сообщениями | Microsoft Azure"
...
>[AZURE.IMPORTANT] Одна очередь устройства содержит не более 50 сообщений, отправляемых из облака на устройство. Попытка отправить на устройство большее количество сообщений приведет к ошибке.
