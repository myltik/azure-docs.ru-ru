...
Этот тот же пример устройства, который вы создали в руководстве по [отправке данных телеметрии с устройства в Центр Интернета вещей (Swift)]. Если он у вас уже есть, можете пропустить этот раздел.
...
<!-- Links -->
[отправке данных телеметрии с устройства в Центр Интернета вещей (Swift)]: quickstart-send-telemetry-ios.md (Отправка данных телеметрии с устройства в Центр Интернета вещей (Swift))
