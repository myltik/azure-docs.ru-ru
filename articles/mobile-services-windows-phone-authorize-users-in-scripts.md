...
2.  Щелкните вкладку **Данные** и выберите таблицу **TodoItem**.
...
1.  Откройте в Visual Studio 2012 Express для Windows Phone проект, измененный во время работы с учебником [Приступая к работе с аутентификацией][Приступая к работе с аутентификацией].
...
<!-- Anchors.  Images.  URLs. -->
  ...
  [Просмотр учебника]: http://go.microsoft.com/fwlink/?LinkId=298630
