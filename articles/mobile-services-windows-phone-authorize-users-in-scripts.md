<properties pageTitle="Авторизация пользователей на стороне службы (Windows Phone) | Центр мобильных разработок" metaKeywords="" description="Узнайте, как осуществить авторизацию пользователей в серверной части JavaScript мобильных служб Azure." metaCanonical="" services="" documentationCenter="Mobile" title="Service-side authorization of Mobile Services users" authors="glenga" solutions="" manager="dwrede" editor="" />
...
<p>Этот учебник основан на кратком руководстве по мобильным службам и развивает материалы предыдущего учебника  <a href="/ru-ru/develop/mobile/tutorials/get-started-with-users-wp8">Приступая к работе с аутентификацией</a>. Перед началом работы с данным учебником необходимо изучить материал учебника <a href="/ru-ru/develop/mobile/tutorials/get-started-with-users-wp8">Приступая к работе с аутентификацией</a>.</p>
</div>
