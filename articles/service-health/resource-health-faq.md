...
## <a name="how-is-resource-health-different-from-the-service-health-dashboard-or-the-azure-portal-service-notifications"></a>Чем служба "Работоспособность ресурсов" отличается от панели мониторинга работоспособности служб и от уведомлений службы на портале Azure?
Служба "Работоспособность ресурсов" предоставляет более детальные сведения, чем панель мониторинга работоспособности службы Azure.

[Состояние Azure](https://status.azure.com) и служебные уведомления портала информируют о проблемах в работе служб, которые влияют на большое число клиентов (например, регион Azure), а служба "Работоспособность ресурсов" предоставляет подробные события, относящиеся только к определенному ресурсу. Например, если узел неожиданно перезагружается, служба оповещает только тех клиентов, чьи виртуальные машины выполнялись на этом узле.

Важно отметить, что служба должна предоставлять как можно больше информации о событиях, влияющих на ресурсы. Для этого она информирует вас о событиях, опубликованных в уведомлениях службы и на панели мониторинга работоспособности службы.
