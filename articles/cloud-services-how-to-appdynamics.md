...
1.  Щелкните **Пробная версия** или **Регистрация** для AppDynamics в магазине Azure по адресу <https://datamarket.azure.com/browse/Applications>.
...
Последние обновления этого документа можно найти в вики-версии по адресу<http://docs.appdynamics.com/display/ADAZ/How+To+Use+AppDynamics+for+Windows+Azure>.
