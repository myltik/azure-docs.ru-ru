...
<table border="1">
<tr bgcolor="FAF9F9">
        <td><strong>Что нужно</strong></td>
        <td><strong>Зачем это нужно</strong></td>
</tr>
<tr>
...
<tr> <td>База данных SQL Azure</td>
<td>Здесь хранятся таблицы, представления и хранимые процедуры, используемые службой BizTalk, в том числе данные отслеживания.
<br/><br/>
...
<br/>
<ul>
<li> При создании нового сервера SQL Server и базы данных SQL Azure, службы Azure включаются автоматически. Для работы службы BizTalk необходимо, чтобы службы Azure были включены.</li>
...
<tr>
<td>Пространство имен контроля доступа</td>
<td> Осуществляет аутентификацию при использовании служб BizTalk Azure. Это пространство имен Access Control вводится при развертывании проекта службы BizTalk из Visual Studio. Пространство имен контроля доступа создается автоматически при создании службы BizTalk.</td>
</tr>
