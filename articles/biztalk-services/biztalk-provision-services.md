...
<br/><br/>
Дополнительную информацию см. в статье <a HREF="http://go.microsoft.com/fwlink/p/?LinkID=267577">Использование назначений ролей для управления доступом к ресурсам в подписке Azure</a>.
</td>
</tr>
<tr>
