...
Установите флажок для завершения работы мастера. Появится значок хода выполнения: <br/> ![Значок хода выполнения, отображаемый при завершении процесса][ProgressComplete]
...
2. Перейдите к своему закрытому SSL-сертификату (*имя\_сертификата*.pfx), который содержит имя службы BizTalk, введите пароль и щелкните флажок.
