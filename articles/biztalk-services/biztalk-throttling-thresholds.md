---
title: Дополнительная информация о регулировании в службах BizTalk | Microsoft Docs
...
|  | Description (Описание) | Нижнее пороговое значение | Верхнее пороговое значение |
| --- | --- | --- | --- |
