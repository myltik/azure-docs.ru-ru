...
> [AZURE.NOTE] Вне зависимости от выпуска создавать резервные копии гибридных подключений невозможно. Гибридные подключения необходимо создать повторно.
...
1. На классическом портале Azure выберите **Создать** > **Службы приложений** > **Служба BizTalk** > **Восстановить**.
