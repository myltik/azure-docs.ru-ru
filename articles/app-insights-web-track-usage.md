...
Вставляйте скрипт перед тегом &lt;/head&gt; на каждой странице, где необходимо отслеживание. Если на вашем веб-сайте есть главная страница, можно разместить скрипт на ней. Например, в проекте ASP.NET MVC скрипт следует разместить на странице View\Shared\_Layout.cshtml
