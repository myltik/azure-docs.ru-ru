...
Если у вас нет доступа к Visual Studio, можно перейти к следующему разделу и отправлять уведомления из самого приложения. Можно также отправлять уведомления правильный шаблон [портал Azure] используя вкладку «Отладка» для центра уведомлений. 
