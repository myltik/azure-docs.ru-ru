...
Можно проверить, поступают ли в приложение уведомления, с помощью параметра *Тестовая отправка* на [портала Azure]. Этот параметр отправит тестовое push-уведомление на устройство.
