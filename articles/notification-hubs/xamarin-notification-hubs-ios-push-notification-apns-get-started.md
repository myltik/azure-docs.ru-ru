...
<p>Нажмите кнопку <b>Notification Services</b> и выберите <b>Apple (APNS)</b>. Выберите вкладку <b>Сертификат</b>, щелкните значок файла и выберите файл <b>P12</b>, экспортированный ранее. Кроме того, необходимо указать правильный пароль.</p>
