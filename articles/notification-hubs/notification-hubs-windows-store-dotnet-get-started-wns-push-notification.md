...
5. В обозревателе решений щелкните правой кнопкой мыши проект приложения для Магазина Windows, щелкните **Магазин**, а затем — **Связать приложение с Магазином...**.
...
1. В окне мастера щелкните **Вход** и затем войдите в систему, используя свою учетную запись Майкрософт.
2. Выберите приложение, зарегистрированное на шаге 2, щелкните **Далее**, а затем — **Связать**.
   
       ![](./media/notification-hubs-windows-store-dotnet-get-started/notification-hub-associate-app-name.png)
   
       This adds the required Windows Store registration information to the application manifest.
3. Вернитесь на страницу нового приложения в [Центре разработки для Windows](http://go.microsoft.com/fwlink/p/?LinkID=266582), щелкните **Службы**, **Push notifications** (Push-уведомления), а затем в разделе **Windows Push Notification Services (WNS) and Microsoft Azure Mobile Apps** (Службы push-уведомлений Windows (WNS) и мобильные приложения Microsoft Azure) щелкните **Live Services site** (Сайт служб Live).
   
       ![](./media/notification-hubs-windows-store-dotnet-get-started/notification-hubs-uwp-app-live-services.png)
4. На странице регистрации приложения найдите и запишите значение пароля в разделе **секретов приложения** и значение **идентификатора безопасности пакета (SID)**, указанное в параметрах платформы **Магазина Windows**.
