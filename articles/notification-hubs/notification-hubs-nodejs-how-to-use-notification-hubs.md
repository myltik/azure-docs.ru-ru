...
2. Выберите **Центры уведомлений**, затем щелкните центр, который хотите использовать. Если вам нужна помощь в создании центра уведомлений, обратитесь к учебнику [Приступая к работе с Центрами уведомлений для приложений Магазина Windows](notification-hubs-windows-store-dotnet-get-started.md).
