...
10. Добавьте в класс следующий код:
	...
	Присвойте параметру **API\_KEY** значение, которое вы получили ранее из облачного проекта Baidu, параметру **NotificationHubName** — имя вашего центра уведомлений на портале Azure, а параметру **NotificationHubConnectionString** — значение DefaultListenSharedAccessSignature на портале Azure.
