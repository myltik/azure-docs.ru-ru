...
Вы изменили серверную часть приложения для отправки только *идентификатора* push-уведомления. Теперь вам нужно изменить приложение Android для обработки этого уведомления и выполнения обратного вызова к серверной части. Это необходимо для извлечения защищенного сообщения, которое будет показано пользователю. Чтобы выполнить эту задачу, убедитесь, что ваше приложение Android умеет идентифицировать себя с серверной частью, когда получает push-уведомления.
