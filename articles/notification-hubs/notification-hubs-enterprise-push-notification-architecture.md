...
2. **ReceiveAndSendNotification**
    ...
    Б. Это еще одно консольное приложение на C#, которое мы будем запускать в качестве [веб-задания Azure] , так как оно должно выполняться непрерывно для прослушивания сообщений из бизнес-систем и серверных систем. Оно будет входить в состав серверной части мобильной службы.
    ...
    ж. Настроить задание, чтобы быть «Запустите постоянно», чтобы при входе [портал Azure] вы увидите примерно следующее:
   
    ![][4]
3. **EnterprisePushMobileApp**
   
    a. Это приложение Магазина Windows, которое будет получать всплывающие уведомления из задания WebJob, выполняющегося в составе серверной части мобильной службы, и отображать это уведомление. Оно основано на материале [учебника по центрам уведомлений для Windows Universal].  
