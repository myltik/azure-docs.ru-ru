...
> [!NOTE]
> Если вы используете в качестве серверной службы мобильные приложения, перейдите к [версии этого руководства для мобильных приложений](../app-service-mobile/app-service-mobile-windows-store-dotnet-get-started-push.md).
> 
> 
