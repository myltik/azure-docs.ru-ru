---
title: Отправка push-уведомлений с определением геозон с помощью Центров уведомлений Azure и Bing Spatial Data | Microsoft Docs
...
> [!NOTE]
> Система может предложить указать **главный ключ**, отличный от **ключа запроса**. Просто создайте ключ на панели мониторинга и обновите страницу отправки источника данных.
> 
> 
...
> [!NOTE]
> Переключите `POST_URL` в расположение развернутого веб-приложения, созданного при работе с предыдущим разделом. Сейчас его можно запустить локально. Однако если планируется развернуть общедоступную версию, его необходимо разместить у внешнего поставщика.
> 
> 
