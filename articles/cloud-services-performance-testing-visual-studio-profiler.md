<properties linkid="dev-net-common-tasks-profiling-in-compute-emulator" urldisplayname="Team Foundation Service" headerexpose="" pageTitle="Локальное профилирование облачной службы в эмуляторе вычислений" metakeywords="" footerexpose="" description="" umbraconavihide="0" disquscomments="1" title="Локальное тестирование производительности облачной службы в эмуляторе вычислений Azure с помощью профилировщика Visual Studio" authors="" />
...
При публикации облачной службы в Azure имеется возможность собрать в Visual Studio данные профилирования и затем проанализировать их локально, как описано в разделе [Профилирование приложения Azure][1]
Также при помощи средств диагностики можно отслеживать различные счетчики производительности, как описано в разделе [Использование счетчиков производительности в Azure][2].
...
-   [Шаг 1. Настройка Visual Studio для профилирования][]

-   [Шаг 2. Присоединение к процессу][]

-   [Шаг 3. Просмотр отчетов профилирования][]

-   [Шаг 4. Внесение изменений и сравнение производительности][]
...
Выполните сборку и запуск облачной службы с установленным в конфигурации решения параметром **Выпуск**. Это гарантирует, что все файлы и папки будут созданы для локального запуска приложения, а также гарантирует, что запущены все эмуляторы.
...
На этом этапе профилировщик останавливает работу, сохраняет данные в VSP-файле и выводит отчет, показывающий анализ этих данных.
...
[1]: http://msdn.microsoft.com/ru-ru/library/windowsazure/hh369930.aspx
[2]: http://www.windowsazure.com/ru-ru/develop/net/common-tasks/performance-profiling
