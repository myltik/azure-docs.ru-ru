<properties urldisplayname="Team Foundation Service" headerexpose="" pageTitle="Локальное профилирование облачной службы в эмуляторе вычислений " metakeywords="" footerexpose="" description="" umbraconavihide="0" disquscomments="1" title="Testing the Performance of a Cloud Service Locally in the Azure Compute Emulator Using the Visual Studio Profiler" authors="kempb" manager="douge" />
...
Эти инструкции можно использовать как для нового, так и для существующего проекта.  При создании нового проекта для методов, описанных ниже, выберите проект **Облачная служба Azure** на C# и выберите **Веб-роль** и **Рабочая роль**.
