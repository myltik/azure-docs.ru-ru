...
Соединители могут создаваться с помощью портала Azure или с помощью REST API. 
...
1. На начальной панели (домашней странице) портала Azure выберите **Marketplace**. **В статье "Приложения API"** перечисляются все существующие соединители. Вы также можете выполнить **поиск** определенного соединителя.
2. Выберите соединитель. В новой колонке нажмите кнопку **Создать**. 
3. Задайте следующие свойства. 

	Свойство | Описание
--- | ---
Имя | Введите имя для вашего соединителя. Например, вы можете назначить ему имя *SAPConnector*, *SalesForceGetAccounts* или *QuickBooksGetItems*.
Параметры пакета | Введите параметры корпоративной системы, например *SAP User Name* или *SugarCRM Server URL*. См. раздел [Свойства, относящиеся к корпоративной системе](#AddProperties) в этой статье. 
...
> [AZURE.IMPORTANT] Каждый соединитель имеет свойства, относящиеся к конкретной корпоративной системе. При подключении к SAP вы указываете свойства, относящиеся к SAP. При подключении к Salesforce вы указываете свойства, относящиеся к Salesforce, и так далее.	В следующей таблице приведены необходимые свойства корпоративной системы. 
	...
	Корпоративная система | Необходимые свойства
--- | ---
Marketo | <ul><li>Конечная точка</li><li>Имя поставщика</li></ul>
MongoDB| <ul><li>Строка подключения</li><li>Узел</li><li>Порт</li><li>Имя пользователя</li><li>Пароль</li><li>База данных</li><li>Использовать SSL-шифрование</li><li>Локально: для облачной системы укажите False; если система MongoDb локальная, то укажите True, а также задайте следующие свойства:<ul><li>Имя общего ключа доступа</li><li>Пространство имен служебной шины</li><li>Путь ретрансляции</li><li>Ключ отправки</li></ul></li></ul>
QuickBooks | <ul><li>Идентификатор компании</li><li>Имя поставщика</li></ul>
SAP | <ul><li>Имя компьютера</li><li>Язык</li><li>Имя пользователя</li><li>Пароль</li><li>Номер системы</li><li>Строка подключения к служебной шине</li><li>Имена RFC</li><li>Имена TRFC</li><li>Имена BAPI</li><li>Имя IDOC</li></ul>
...
[Интеграция с локальным сервером SAP](app-service-logic-integrate-with-an-on-premise-SAP-server.md)<br/>
