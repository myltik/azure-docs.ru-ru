...
>[AZURE.NOTE]Начиная с пакета SDK для Azure версии 2.6, кэш роли использует пакет SDK для службы хранилища Microsoft Azure версии 4.3. В предыдущих версиях пакета SDK для Azure для кэша роли использовался пакет SDK для службы хранилища Azure версии 1.7. Приложения, использующие кэш роли с пакетами SDK для Azure до версии 2.6, следует перенести в пакет SDK для Azure версии 2.6 до того, как служба хранилища Azure версии 2011-08-18 будет выведена из эксплуатации (9 декабря 2015 г). Дополнительную информацию см. в статье [Заметки о выпуске пакета SDK 2.6 для Azure. Кэш роли](../azure-sdk-dotnet-release-notes-2_6.md#in-role-cache-updates) и статье [Прекращение использования версий службы хранилища Azure Microsoft](http://azure.microsoft.com/blog/2014/08/04/microsoft-azure-storage-service-version-removal/).
