...
-   [Создание продукта][]
-   [Добавление API к продукту][]
-   [Задание ограничений скорости вызова и политик квот][]
-   [Публикация продукта][]
-   [Подписка учетной записи разработчика на продукт][]
-   [Вызов операции и тестирование ограничения скорости][]
-   [Дальнейшие действия][]
...
![Добавление группы разработчиков][]
