...
# Приступая к работе с Hadoop 1.2 в HDInsight

<div class="dev-center-tutorial-selector sublanding">
<a href="../hdinsight-get-started" title="Начало работы с Hadoop 2.2 в HDInsight">Hadoop 2.2</a>
<a href="../hdinsight-get-started-31" title="Начало работы с Hadoop 2.4 в HDInsight">Hadoop 2.4</a>
<a href="../hdinsight-get-started-21" title="Приступая к работе с Hadoop 1.2 в HDInsight" class="current">Hadoop 2.2</a>
</div>
...
В этом учебнике вы будете заниматься подготовкой кластера Hadoop в HDInsight с помощью портала управления Azure, отправкой задания Hive для запроса простой таблицы Hive с использованием панели мониторинга кластера и импортом выходных данных задания Hive в Excel для анализа.

> [WACOM.NOTE] В этом учебнике описывается использование кластеров Hadoop 1.2 в HDInsight. Для доступа к другим поддерживаемым версиям щелкните средство выбора в верхней части страницы. Для получения информации о версиях см. раздел [Новые возможности версий кластеров, предоставляемых HDInsight.][Новые возможности версий кластеров, предоставляемых HDInsight.]
...
4.  На вкладке "Сведения о кластере" введите или выберите следующие значения:
    ...
    | **Версия HDInsight** | Выберите **2.1**, чтобы создать кластер Hadoop 1.2 в HDInsight.                                                                                                                                                                                                                                       |
...
1.  В верхней части панели мониторинга щелкните **Редактор Hive**.
...
-   [Разработка программ MapReduce на Java для HDInsight][Разработка программ MapReduce на Java для HDInsight]
  ...
  [1]: ../hdinsight-get-started-21 "Приступая к работе с Hadoop 1.2 в HDInsight"
