<properties title="How to use end user analytics in Azure" pageTitle="Использование аналитики конечных пользователей" description="End user analytics for Microsoft Azure websites." authors="awills" manager="kamrani" />
...
*Вы можете выполнить эти действия и для других сайтов (не Azure): [Отслеживание использования веб-приложений с помощью Application Insights](../app-insights-web-track-usage/).*
