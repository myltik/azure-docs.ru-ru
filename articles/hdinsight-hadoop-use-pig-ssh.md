...
Дополнительную информацию об использовании Putty см. в подразделе **Использование Putty для подключения к компьютеру под управлением Linux** раздела <a href="http://azure.microsoft.com/documentation/articles/virtual-machines-linux-use-ssh-key/" target="_blank">Использование SSH для Linux в Azure</a>.

> [AZURE.NOTE] Если сертификат использовался для проверки подлинности по SSH в кластере HDInsight, вам также потребуется ознакомиться с подразделом **Создание PPK для Putty** раздела <a href="http://azure.microsoft.com/documentation/articles/virtual-machines-linux-use-ssh-key/" target="_blank">Использование SSH для Linux в Azure</a>.
