...
1. Вам следует настроить инфраструктуру восстановления размещения, включая следующее:
    ...
    * **Отдельный главный целевой сервер**. По умолчанию главный целевой сервер, установленный вместе с сервером конфигурации на локальной виртуальной машине VMware, обрабатывает восстановление размещения. При необходимости восстановить размещение больших объемов трафика настройте отдельный локальный главный целевой сервер для этой цели.
