...
5. На странице **Параметры Интернета** укажите параметры, с которыми установленный на сервере поставщик будет подключаться к Azure Site Recovery через Интернет.
...
2. На странице **Перед началом работы** выберите параметр **Служба мобильности**.
...
Кроме того, состояние защиты можно отслеживать, последовательно выбрав **Защищенные элементы** > <имя группы защиты> > **Виртуальные машины**. После завершения начальной репликации и синхронизации данных состояние компьютера изменится на **Защищенный**.
