...
5. На странице **Параметры Интернета** укажите параметры Интернета для подключения к Azure Site Recovery поставщика, который будет установлен на сервере.
...
>[AZURE.WARNING] Если при проверке предварительных требований для **глобальной синхронизации времени** появится предупреждение, убедитесь, что время на системных часах и время часового пояса совпадают.
...
2. На вкладке **Глобальные параметры** можно изменить IP-адрес сервера управления.
