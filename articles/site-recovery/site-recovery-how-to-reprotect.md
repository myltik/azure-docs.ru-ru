...
Сейчас ASR поддерживает восстановление размещения только в хранилище данных VMFS. Хранилища данных vSAN и NFS не поддерживаются. Обратите внимание, что можно защитить виртуальные машины, работающие в хранилище данных vSAN или NFS. Из-за этого ограничения информация о выбранном хранилище данных на экране повторного включения защиты не будет отображаться для хранилища данных NFS или будет отображено хранилище данных vSAN, но во время задания произойдет сбой. Если вы планируете выполнить восстановление размещения, можно создать локальное хранилище данных VMFS и выполнить в нем восстановление размещения. Это восстановление размещения приведет к полному скачиванию VMDK. В будущих выпусках будет добавлена поддержка для хранилища данных NFS и vSAN.
