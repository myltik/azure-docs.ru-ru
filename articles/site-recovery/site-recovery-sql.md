...
## <a name="integrate-protection-with-sql-server-always-on-in-classic-azure-portal-on-premises-to-azure"></a>Интеграция защиты с использованием SQL Server AlwaysOn на классическом портале Azure (из локальной среды в Azure)
...
### <a name="protect-machines-in-new-azure-portal-or-without-a-vmm-server-or-a-configuration-server-in-classic-azure-portal"></a>Защита компьютеров на новом портале Azure или компьютеров без сервера VMM или сервера конфигурации на классическом портале Azure
