...
3. Выберите виртуальную сеть Azure, в которой будут созданы тестовые виртуальные машины.
    ...
    - Если тот же IP-адрес недоступен в подсети, виртуальная машина получает другой доступный IP-адрес в подсети. [Подробнее](#creating-a-network-for-test-failover).
