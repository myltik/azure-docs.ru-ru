...
1. На странице быстрого запуска щелкните <b>Загрузить агент служб восстановления Azure и установить на узлах</b>, чтобы получить последнюю версию установочного файла агента.
...
3. На странице **Проверка готовности** нажмите кнопку <b>Далее</b>. Все отсутствующие предварительные требования будут установлены автоматически.
...
7. В поле <b>Сохранение точек восстановления</b> оставьте значение по умолчанию. При использовании нулевого значения по умолчанию на сервере узла реплики хранится только последняя точка восстановления для основной виртуальной машины.
...
9. В поле <b>Время начала репликации</b> укажите, когда должна запускаться начальная репликация данных в Azure. Используется часовой пояс сервера узла Hyper-V. Рекомендуется запланировать начальную репликацию на часы наименьшей нагрузки.
...
1. Для включения защиты на вкладке <b>Виртуальные машины</b> в облаке, в котором находится виртуальная машина, щелкните <b>Включить защиту</b> и выберите <b>Добавить виртуальные машины</b>.
...
1. На вкладке **Планы восстановления** добавьте новый план. Укажите имя, **VMM** в поле **Тип исходного сервера** и исходный сервер VMM в поле **Исходный сервер**, в качестве цели укажите Azure.
...
После создания плана восстановления он отображается на вкладке **Планы восстановления**. Также к плану восстановления можно добавить [модули Runbook службы автоматизации Azure](site-recovery-runbook-automation.md) для автоматизации обработки отказа.
...
1. Если для облака включено шифрование данных, то при установке флажка для включения шифрования данных для облака в поле **Ключ шифрования** выберите сертификат, который был выдан в ходе установки поставщика на сервере VMM.
...
## <a id="runtest" name="runtest" href="#runtest"></a>Мониторинг активности
...
<UL>
<LI>Сведения о планировании и развертывании Azure Site Recovery в полноценной рабочей среде см. в разделах <a href="http://go.microsoft.com/fwlink/?LinkId=321294">Руководство по планированию для Azure Site Recovery</a> и <a href="http://go.microsoft.com/fwlink/?LinkId=321295">Руководство по развертыванию для Azure Site Recovery</a>.</LI>
