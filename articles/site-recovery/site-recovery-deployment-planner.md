...
* Оценочная общая стоимость аварийного восстановления в Azure: затраты на вычисления, хранение, сеть и лицензии Azure Site Recovery.
