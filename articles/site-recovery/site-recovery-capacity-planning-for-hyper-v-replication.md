<properties
	pageTitle="Планирование ресурсов для репликации виртуальных машин Hyper-V"
...
# Планирование ресурсов для репликации виртуальных машин Hyper-V

Azure Site Recovery использует реплику Hyper-V для репликации виртуальных машин Hyper-V из локального сайта в Azure или в дополнительный центр обработки данных. Перед репликацией виртуальной машины Hyper-V планировщик ресурсов помогает службе Site Recovery определить требования к пропускной способности и репликации.
...
- [Ознакомьтесь с результатами](http://blogs.technet.com/b/keithmayer/archive/2014/02/27/guided-hands-on-lab-capacity-planner-for-windows-server-2012-hyper-v-replica.aspx) нашей проверки производительности при репликации Hyper-V между локальными средами.
