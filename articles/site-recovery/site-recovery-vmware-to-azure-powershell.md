...
description: "Репликация и отработка отказа виртуальных машин VMware в Azure с помощью Azure Site Recovery и PowerShell."
...
---
# <a name="replicate-and-failover-vmware-virtual-machines-to-azure-using-azure-site-recovery-powershell"></a>Репликация и отработка отказа виртуальных машин VMware в Azure с помощью Azure Site Recovery и PowerShell
...
* [Выбор целевых объектов для защиты](site-recovery-set-up-vmware-to-azure.md#choose-your-protection-goals)
...
## <a name="add-a-vcenter-server-and-discover-vmware-virtual-machines"></a>Добавление сервера vCenter Server и обнаружение виртуальных машин VMware
