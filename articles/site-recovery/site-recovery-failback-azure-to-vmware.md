...
7.  Щелкните**Удалить**, чтобы удалить запись.
...
14.  Для этого необходимо выбрать **Datastore** (Хранилище данных) на стороне восстановления. Это хранилище данных, в которое будут восстановлены виртуальные машины.
