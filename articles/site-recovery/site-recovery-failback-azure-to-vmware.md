...
* При отработке отказа физических серверов восстановление размещения всегда выполняется на новой виртуальной машине VMware.
  * Перед восстановлением размещения на физический компьютер обратите внимание, что
    * защищаемый физический компьютер будет восстановлен как виртуальная машина при восстановлении размещения из Azure в VMware. Если защищенный компьютер под управлением Windows Server 2008 R2 SP1 выполнил отработку отказа в Azure, он не будет восстановлен в исходном расположении;
...
7. Компьютер под управлением Windows Server 2008 R2 SP1, защищенный как физический или виртуальный локальный компьютер, не может быть восстановлен из Azure в локальную среду.
