---
title: "Hyper-V, чтобы архитектура Azure репликации в Azure Site Recovery | Документы Microsoft"
...
Выполните [этого учебника](tutorial-prepare-azure.md) для начала работы с Hyper-V для репликации в Azure.
