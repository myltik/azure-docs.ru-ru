---
title: "Обзор архитектуры для репликации Hyper-V в Azure с использованием Azure Site Recovery | Документы Майкрософт"
...
**Hyper-V** | Во время развертывания Site Recovery вы собираете узлы и кластеры Hyper-V в сайты Hyper-V. Вы устанавливаете поставщик Azure Site Recovery и агент служб восстановления на каждом компьютере Hyper-V. | Поставщик оркестрирует репликацию через Интернет с помощью службы Site Recovery. Агент служб восстановления обрабатывает репликацию данных.<br/><br/> Обмен данными между поставщиком и агентом осуществляется по защищенным и зашифрованным каналам. Реплицированные данные в службе хранилища Azure также шифруются.
...
![Архитектура](./media/concepts-hyper-v-to-azure-architecture/arch-onprem-azure-hypervsite.png)
...
![Компоненты](./media/concepts-hyper-v-to-azure-architecture/arch-onprem-onprem-azure-vmm.png)



## <a name="replication-process"></a>Процесс репликации

![Репликация из Hyper-V в Azure](./media/concepts-hyper-v-to-azure-architecture/arch-hyperv-azure-workflow.png)
...
4. На вкладке **Задания** можно отслеживать ход выполнения задания.      ![Список заданий](media/concepts-hyper-v-to-azure-architecture/image1.png)![Подробные сведения о включении защиты](media/concepts-hyper-v-to-azure-architecture/image2.png)
...
3. Если вы не хотите ждать времени повторной синхронизации по умолчанию, то можете повторно синхронизировать виртуальную машину вручную. Например, такая потребность может возникнуть в случае сбоя. Для этого на портале Azure выберите виртуальную машину и щелкните **Повторно синхронизир.**
    ...
    ![Повторная синхронизация вручную](./media/concepts-hyper-v-to-azure-architecture/image4-site.png)
...
Ознакомьтесь с таблицей поддержки. Следуйте указаниям руководства, чтобы включить репликацию из Hyper-V в Azure.
