...
**Конфигурация** | **VMware или физический сервер** | **Hyper-V (с и без Virtual Machine Manager)**
--- | --- | --- | ---
NFS | Да для VMware<br/><br/> Нет для физических серверов | Н/Д
SMB 3.0 | Н/Д | Yes
...
VMDK | Yes | Н/Д
VHD (VHDX) | Н/Д | Yes
Виртуальная машина 2-го поколения | Н/Д | Yes
UEFI (EFI)| Нет  | Yes
Общий диск кластера | Нет  | Нет 
Зашифрованный диск | Нет  | Нет 
NFS | Нет  | Н/Д
SMB 3.0 | Нет  | Нет 
RDM | Yes<br/><br/> Недоступно для физических серверов. | Н/Д
