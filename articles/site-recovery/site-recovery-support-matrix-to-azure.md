...
Диск с физическими и логическими секторами с размером в 4 КБ. | Да | Не поддерживается для виртуальных машин поколения 1.<br/><br/>Да, поддерживается для виртуальных машин поколения 2
