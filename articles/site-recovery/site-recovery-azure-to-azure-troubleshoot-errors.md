...
Виртуальные машины Azure для выбора могут не отображаться на шаге [включения репликации](./site-recovery-azure-to-azure.md#step-2-select-virtual-machines). Эта проблема может возникать из-за устаревшей конфигурации Site Recovery, остававшейся на виртуальной машине Azure. Устаревшая конфигурация может остаться на виртуальной машине Azure в следующих случаях:
