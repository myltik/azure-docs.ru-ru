---
title: "Запуск тестовой отработки отказа для репликации Hyper-V (с System Center VMM) в Azure | Документация Майкрософт"
description: "В этой статье кратко описаны шаги для запуска тестовой отработки отказа при репликации виртуальных машин из Hyper-V в облаках VMM в Azure с помощью службы Azure Site Recovery."
