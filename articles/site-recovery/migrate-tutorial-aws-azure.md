...
- Вам потребуется отдельный экземпляр EC2, который можно использовать в качестве сервера конфигурации Site Recovery. Он должен работать под управлением Windows Server 2012 R2.
...
1. В области навигации слева на [портале Azure](https://portal.azure.com) щелкните **Все службы**, а затем найдите и выберите **хранилища служб восстановления**.
