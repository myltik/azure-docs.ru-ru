...
Следить за включением защиты, включая первоначальную репликацию, можно на вкладке **Задания**. После запуска задачи финализации защиты виртуальная машина готова к отработке отказа.
