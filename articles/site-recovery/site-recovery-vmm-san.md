<properties
	pageTitle="Настройка защиты между локальными сайтами VMM с помощью сети SAN и Azure Site Recovery | Microsoft Azure"
...
# Настройка защиты между локальными сайтами VMM с помощью сети SAN и Azure Site Recovery
