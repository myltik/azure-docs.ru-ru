<properties
	pageTitle="Репликация виртуальных машин Hyper-V в облаке VMM в дополнительный ЦОД с помощью службы Azure Site Recovery и сети SAN | Microsoft Azure"
...
1. После интеграции хранилища SAN в VMM создайте (подготовьте) логические устройства (LUN):
	...
	>[AZURE.NOTE] После включения репликации для виртуальной машины не следует добавлять виртуальные жесткие диски для него в LUN, которые не находятся в группе репликации Site Recovery. Если это сделать, то они не будут определяться Site Recovery.
