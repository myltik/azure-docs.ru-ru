...
4. Запустите файл установки **Microsoft-ASR\_CX\_TP\_8.4.0.0\_Windows**\* и выполните инструкции. При этом будут установлены сторонние компоненты, необходимые для развертывания.
...
1. Откройте вкладку **Защищенные элементы** > **Группа защиты** и щелкните ссылку на добавление группы защиты.
...
4. Параметры
	...
	- **Хранение точки восстановления**. Определяет окно сохранения. Защищенные компьютеры будут восстанавливаться до любой точки в пределах этого периода.
