...
Для настройки репликации и переноса локальных Hyper-V, VMware и физических рабочих нагрузок в Azure выполните действия, описанные в статье [Перенос в Azure с помощью Site Recovery](site-recovery-migrate-to-azure.md). 
