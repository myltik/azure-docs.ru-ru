...
# Начало работы
## [Репликация виртуальных машин Azure (предварительная версия)](azure-to-azure-walkthrough-overview.md)
### [Шаг 1. Общие сведения об архитектуре](azure-to-azure-walkthrough-architecture.md)
### [Шаг 2. Перед началом работы](azure-to-azure-walkthrough-prerequisites.md)
### [Шаг 3. Планирование сетей](azure-to-azure-walkthrough-network.md)
### [Шаг 4. Создание хранилища](azure-to-azure-walkthrough-vault.md)
### [Шаг 5. Включение репликации](azure-to-azure-walkthrough-enable-replication.md)
### [Шаг 6. Запуск тестовой отработки отказа](azure-to-azure-walkthrough-test-failover.md)
...
## [Репликация виртуальных машин Hyper-V на дополнительный сайт с помощью VMM](vmm-to-vmm-walkthrough-overview.md)
### [Шаг 1. Общие сведения об архитектуре](vmm-to-vmm-walkthrough-architecture.md)
### [Шаг 2. Просмотр предварительных условий и ограничений](vmm-to-vmm-walkthrough-prerequisites.md)
### [Шаг 3. Планирование сетей](vmm-to-vmm-walkthrough-network.md)
### [Шаг 4. Подготовка VMM и Hyper-V](vmm-to-vmm-walkthrough-vmm-hyper-v.md)
### [Шаг 5. Создание хранилища](vmm-to-vmm-walkthrough-create-vault.md)
### [Шаг 6. Настройка исходной и целевой среды](vmm-to-vmm-walkthrough-source-target.md)
### [Шаг 7. Настройка сетевого сопоставления](vmm-to-vmm-walkthrough-network-mapping.md)
### [Шаг 8. Создание политики репликации](vmm-to-vmm-walkthrough-replication.md)
### [Шаг 9. Включение репликации](vmm-to-vmm-walkthrough-enable-replication.md)
### [Шаг 10. Запуск тестовой отработки отказа](vmm-to-vmm-walkthrough-test-failover.md)
