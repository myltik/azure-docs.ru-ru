<properties
	pageTitle="Что такое Site Recovery?" 
...
Site Recovery — это служба Azure, которая помогает реализовать стратегию непрерывности бизнес-процессов и аварийного восстановления (BCDR).Она управляет процессами репликации локальных серверов и виртуальных машин в дополнительный центр обработки данных или Azure. Site Recovery управляет репликацией, позволяя быстро и просто запускать операции отработки отказа или восстановления. Дополнительные сведения в форме часто задаваемых вопросов см. в статье [Вопросы и ответы](site-recovery-faq.md).
...
---|---|---|---
Виртуальные машины VMware | Локальный сервер VMware | Хранилище Azure | [Развертывание](site-recovery-vmware-to-azure.md)
Физический сервер Windows или Linux | Локальный физический сервер | Хранилище Azure | [Развертывание](site-recovery-vmware-to-azure.md)
...
Локальные виртуальные машины Hyper-V| Локальный сервер Hyper-V в облаке VMM | Локальный сервер Hyper-V в облаке VMM, размещенный в дополнительном центре обработки данных | [Развертывание](site-recovery-vmm-to-vmm)
...
Виртуальные машины VMware | Локальный сервер VMware | Дополнительный центр обработки данных под управлением VMware | [Развертывание](https://microsoft.sharepoint.com/sites/academy/media/AEVD-3-85237) 
Физический сервер Windows или Linux | Локальный физический сервер | Второстепенный центр обработки данных | [Развертывание](https://microsoft.sharepoint.com/sites/academy/media/AEVD-3-85237) 
...
Дополнительные сведения см. в статье [Какие рабочие нагрузки можно защитить с помощью Site Recovery?](site-recovery-workload.md)
