...
## <a name="deploy-the-site-recovery-mobility-service-by-using-automation-dsc"></a>Развертывание службы Mobility Service Site Recovery с помощью Automation DSC
...
## <a name="step-2-create-the-dsc-configuration"></a>Шаг 2. Создание конфигурации DSC
...
Войдите в учетную запись службы автоматизации и щелкните **Ресурсы-контейнеры** > **Модули**, а затем выберите **Просмотреть коллекцию**.
...
### <a name="check-for-any-pending-file-rename-operations-in-the-registry"></a>Проверка всех ожидающих операций переименования файлов в реестре
