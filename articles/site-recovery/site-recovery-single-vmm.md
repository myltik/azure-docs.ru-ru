...
3. Настройте параметры защиты для облаков. Укажите имя обособленного сервера VMM в полях исходного расположения и целевого расположения. Для настройки сетевого сопоставления сопоставьте сеть виртуальных машин для облака и защищаемые виртуальные машины с сетью виртуальных машин для облака репликации.
4. Включите начальную репликацию для защищаемых по сети виртуальных машин, так как оба облака расположены на одном сервере.
