...
1. Загрузите ZIP-файл [обновления](http://aka.ms/scoutupdates). Этот ZIP-файл содержит следующие файлы:
...
2. **Серверы конфигурации и процессов**: скопируйте файл **CX\_Windows\_8.0.2.0\_GA\_Update\_2\_4306954\_21Aug15.exe** на сервер конфигурации и сервер процессов. Дважды щелкните, чтобы запустить его.
...
### Обновление 1 для ASR Scout 8.0.1 от 03.12.2015 г.

Обновление от 03.12.2015 г. включает следующие исправления:
...
>[AZURE.NOTE]
>
>-	Все обновления ASR являются накопительными.
