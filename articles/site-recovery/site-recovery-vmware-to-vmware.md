---
title: Репликация локальных виртуальных машин VMware и физических серверов в Azure в дополнительное местонахождение | Microsoft Docs
...
6. исходный сервер (только для Windows Server).
