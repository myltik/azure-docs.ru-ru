...
9. В разделе **Настройка целевых параметров** укажите, хотите ли вы использовать те же параметры для всех машин, а затем выберите сервер обработки и учетную запись хранения Azure. Если необходимо настроить один сервер управления, то сервер обработки будет IP-адресом этого сервера управления.

	![Добавление учетной записи](./media/site-recovery-vmware-to-azure-classic-legacy/legacy-migration3.png)

10. В разделе **Указание учетных записей** выберите учетную запись, созданную для автоматической передачи новой версии службы Mobility Service на защищенные машины.
