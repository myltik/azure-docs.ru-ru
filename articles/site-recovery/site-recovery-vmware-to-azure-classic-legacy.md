...
**Служба хранилища Azure** | <p>Для хранения реплицируемых данных потребуется учетная запись хранения Azure</p><p> Учетная запись должна быть либо [учетной записью геоизбыточного хранилища Standard](../storage/storage-redundancy.md#geo-redundant-storage), либо [учетной записью хранения Premium](../storage/storage-premium-storage.md).</p><p>Она должна находиться в том же регионе, что и служба Azure Site Recovery, и быть связанной с той же подпиской.</p><p>Дополнительную информацию см. в разделе [Знакомство со службой Microsoft Azure](../storage/storage-introduction.md)</p>
