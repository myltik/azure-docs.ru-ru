<properties
	pageTitle="Репликация виртуальных машин и физических серверов VMware в Azure с помощью Azure Site Recovery (устарело) | Microsoft Azure" 
	description="Описывает устаревшее развертывание для настройки Azure Site Recovery и оркестрации репликации, отказоустойчивости и восстановления локальных виртуальных машин VMware и физических серверов Windows/Linux в Azure."
