---
title: "Репликация Hyper-V на архитектуру вторичного сайта в Azure Site Recovery | Документы Microsoft"
...
Выполните [этого учебника](tutorial-vmm-to-vmm.md) для включения репликации Hyper-V между облака VMM.
