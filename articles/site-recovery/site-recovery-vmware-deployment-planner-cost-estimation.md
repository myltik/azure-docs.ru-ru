...
Сводка поможет вам составить представление о затратах на хранилище, вычислительные ресурсы, сеть и лицензию при защите всех совместимых виртуальных машин в Azure с помощью Azure Site Recovery. Затраты рассчитываются только для совместимых, а не для всех профилируемых виртуальных машин.  
...
В этом разделе показаны идентификаторы подписки и предложения, которые вы использовали при создании отчета.  Если эти данные не указаны, раздел будет пустым.
...
Ознакомьтесь с дополнительными сведениями о защите [виртуальных машин VMware в Azure с помощью Azure Site Recovery](https://docs.microsoft.com/en-us/azure/site-recovery/tutorial-vmware-to-azure).