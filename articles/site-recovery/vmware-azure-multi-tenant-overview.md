...
Необходимо настроить сервер конфигурации с учетной записью, которой назначена специальная роль. 
...
См. дополнительные сведения о [настройке аварийного восстановления виртуальных машин VMware в Azure](vmware-azure-tutorial.md)
[Set up disaster recovery for VMWare VMs with multi-tenancy with CSP](vmware-azure-multi-tenant-csp-disaster-recovery.md) (Настройка аварийного восстановления виртуальных машин VMWare с несколькими клиентами с помощью CSP)
