...
* **Используйте службу синхронизации файлов Azure для репликации файлов**. Если вы планируете использовать облако или уже используете виртуальную машину Azure, можно использовать эту службу. Служба синхронизации файлов обеспечивает синхронизацию полностью управляемых общих файловых ресурсов в облаке, доступ к которым можно получить с помощью стандартного отраслевого протокола [Server Message Block](https://msdn.microsoft.com/library/windows/desktop/aa365233.aspx). Затем общие ресурсы службы файлов Azure можно одновременно подключить к облачным или локальным развертываниям Windows, Linux и macOS. 
