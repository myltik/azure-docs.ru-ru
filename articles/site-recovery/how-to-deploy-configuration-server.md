...
3. После завершения установки войдите на виртуальную машину от имени администратора.
...
Настройка аварийного восстановления [виртуальных машин VMware](tutorial-vmware-to-azure.md) в Azure.
