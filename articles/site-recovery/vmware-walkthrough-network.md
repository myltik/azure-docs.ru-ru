---
title: "Планирование сетей для репликации из VMware в Azure | Документация Майкрософт"
description: "В этой статье рассматривается планирование сетей, необходимое при репликации виртуальных машин VMware в Azure."
...
## <a name="connect-to-replica-vms"></a>Подключение виртуальных машин реплик
