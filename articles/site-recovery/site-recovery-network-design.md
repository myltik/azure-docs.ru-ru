...
На этом рисунке показаны параметры отработки отказа TCP/IP для реплики виртуальной машины (на консоли Hyper-V). Эти параметры будут заполняться непосредственно перед запуском виртуальной машины после отработки отказа.
