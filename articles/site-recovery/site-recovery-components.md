...
- При наличии правил файрволла для IP-адресов убедитесь, что они разрешают выполнение соединений от сервера конфигурации на IP-адреса, описанные в статье [Диапазоны IP-адресов датацентра Azure](https://www.microsoft.com/download/details.aspx?id=41653), и на порт HTTPS (443). Необходимо добавить в белый список диапазоны адресов того региона Azure, который вы планируете использовать, и IP-адреса Azure Запада США.
...
--- | --- 
<p>**Поставщик Azure Site Recovery для VMM**</p><p>**Агент служб восстановления Azure**</p> | <p></p>**Первоначальная установка**: загрузите последнюю версию на странице быстрого запуска<p></p>**Последующие установки**: загрузите последнюю (или предыдущие) версии на панели управления Site Recovery. Также, если были выбраны обновления Microsoft, на сервер будут автоматически установлены последние версии поставщика и агента.
...
**Служба Mobility Service** | <p>Убедитесь в наличии последних обновлений на каждом компьютере, который необходимо защитить.<p><p>Последние обновления можно загрузить по ссылкам:</p><p>[Windows](http://download.microsoft.com/download/7/C/7/7C70CA53-2D8E-4FE0-BD85-8F7A7A8FA163/Microsoft-ASR_UA_8.3.0.0_Windows_GA_03Jul2015_release.exe)</p><p>[RHELP6 64](http://download.microsoft.com/download/B/4/5/B45D1C8A-C287-4339-B60A-70F2C7EB6CFE/Microsoft-ASR_UA_8.3.0.0_RHEL6-64_GA_03Jul2015_release.tar.gz)</p><p>[OL6 64](http://download.microsoft.com/download/9/4/8/948A2D75-FC47-4DED-B2D7-DA4E28B9E339/Microsoft-ASR_UA_8.3.0.0_OL6-64_GA_03Jul2015_release.tar.gz)</p><p>[SLES11-SP3-64](http://download.microsoft.com/download/6/A/2/6A22BFCD-E978-41C5-957E-DACEBD43B353/Microsoft-ASR_UA_8.3.0.0_SLES11-SP3-64_GA_03Jul2015_release.tar.gz)</p><p>. Альтернативный вариант: убедившись в том, что используется последняя версия сервера обработки, можно загрузить последнюю версию службы Mobility Service из каталога C:\\pushinstallsvc\\repository на сервере обработки</p>  
