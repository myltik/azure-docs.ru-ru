...
Прочтите эту статью, чтобы ознакомиться с базовой архитектурой службы [Azure Site Recovery](site-recovery-overview.md) и ее компонентами.
...
## <a name="replication-to-azure"></a>Репликация в Azure
...
## <a name="vmware-replication-to-azure"></a>Репликация VMware в Azure
...
## <a name="physical-server-replication-to-azure"></a>Репликация физического сервера в Azure

В этом сценарии репликации используются те же компоненты и процессы, что и в сценарии [VMware в Azure](#vmware-replication-to-azure), но обратите внимание на следующие отличия:
...
## <a name="hyper-v-replication-to-azure"></a>Репликация Hyper-V в Azure
...
## <a name="replication-to-a-secondary-site"></a>Репликация на дополнительный сайт
...
## <a name="vmware-vmphysical-server-replication-to-a-secondary-site"></a>Репликация виртуальных машин или физических серверов VMware на дополнительный сайт
...
## <a name="hyper-v-vm-replication-to-a-secondary-site"></a>Репликация виртуальной машины Hyper-V на дополнительный сайт
