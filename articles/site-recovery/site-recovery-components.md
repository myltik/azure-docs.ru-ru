...
Эта статья содержит сведения о базовой архитектуре службы [Azure Site Recovery](site-recovery-overview.md) и ее компонентах, с помощью которых можно реплицировать рабочие нагрузки из локальной среды в Azure.
...
Следующие локальные инфраструктуры можно защитить и реплицировать в Azure:
...
**Серверы VMware** | Виртуальные машины VMware размещаются на серверах vSphere ESXi. Мы рекомендуем управлять узлами с помощью сервера vCenter. | Добавьте серверы VMware в хранилище служб восстановления.<br/><br/>
