...
Конечные точки служб виртуальной сети<br/><br/> (Брандмауэры и виртуальные сети службы хранилища Azure) | Нет  | Нет 
...
Конечные точки службы виртуальной сети Azure (виртуальные сети и брандмауэры службы хранилища Azure), настроенные в целевой системе для кэширования учетной записи хранения, используемой для данных репликации | Нет  | Нет 
