---
title: "Связь с виртуальными машинами после отработки отказа на дополнительный сайт с помощью Azure Site Recovery | Документы Майкрософт"
...
---
# <a name="vm-connectivity-after-failover-to-a-secondary-site"></a>Подключение виртуальной машины после отработки отказа на дополнительный сайт
