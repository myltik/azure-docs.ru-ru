---
title: "Подключение к виртуальным машинам после отработки отказа на дополнительный сайт с помощью Azure Site Recovery | Документация Майкрософт"
description: "Указания по настройке сети для подключения к виртуальным машинам после отработки отказа на дополнительный сайт с помощью Azure Site Recovery."
...
---
# <a name="connecting-to-vms-after-failover-to-a-secondary-site"></a>Подключение виртуальной машины после отработки отказа на дополнительный сайт
