...
1. Откройте на узле Hyper-V оснастку MMC в службе Microsoft Azure Backup. По умолчанию ярлык для службы Microsoft Azure Backup расположен на рабочем столе или в папке C:\Program Files\Microsoft Azure Recovery Services Agent\bin\wabadmin.
...
3. В раскрывающемся списке **Частота копирования**выберите периодичность репликации изменений данных после начальной репликации (каждые 30 секунд, 5 или 15 минут).
    ...
    > [!NOTE]
    >  Частота 30 секунд не поддерживается при репликации в хранилище класса Premium. Это ограничение связано с ограничением в 100 моментальных снимков на большой двоичный объект, которые можно сохранить в хранилище класса Premium. [Подробнее](../virtual-machines/windows/premium-storage.md#snapshots-and-copy-blob).
