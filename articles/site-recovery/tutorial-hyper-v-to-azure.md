...
6. В разделе **Are you using System Center VMM** (Используете ли вы System Center VMM?) выберите **No** (Нет). Нажмите кнопку **ОК**.

    ![Цель репликации](./media/tutorial-hyper-v-to-azure/replication-goal.png)
...
5. Скачайте ключ регистрации хранилища. Он понадобится при запуске программы установки поставщика. Ключ действителен в течение пяти дней после создания.
    ...
    ![Скачивание поставщика](./media/tutorial-hyper-v-to-azure/download.png)
