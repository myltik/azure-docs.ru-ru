...
Чтобы перенести локальные виртуальные машины Hyper-V, виртуальные машины VMware и физические серверы, выполняются практически те же действия, что и при обычной репликации. Сначала настройте хранилище служб восстановления. Затем настройте необходимые серверы управления (в зависимости от того, что вы хотите перенести), добавьте их в хранилище и укажите параметры репликации. Включите репликацию для машин, которые нужно перенести, и выполните быструю тестовую отработку отказа, чтобы проверить работоспособность всех компонентов.
