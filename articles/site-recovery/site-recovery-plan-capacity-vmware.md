...
Соберите сведения о среде репликации с помощью [планировщика ресурсов Azure Site Recovery](https://aka.ms/asr-deployment-planner-doc). Они включают в себя данные о количестве виртуальных машин (совместимых и несовместимых), дисков на виртуальную машину, обновлениях данных на диск, требованиях к пропускной способности сети и инфраструктуре Azure для успешной репликации и тестовой отработки отказа.
...
С помощью [планировщика ресурсов](https://aka.ms/asr-deployment-planner-doc) вы можете рассчитать пропускную способность, необходимую для репликации (начальной и разностной). Объемом пропускной способности, используемой для репликации, можно управлять несколькими способами.
