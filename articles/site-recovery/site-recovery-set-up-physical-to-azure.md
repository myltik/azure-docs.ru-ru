---
title: "Настройка исходной среды (из физических серверов в Azure) | Документация Майкрософт"
...
# <a name="set-up-the-source-environment-physical-server-to-azure"></a>Настройка исходной среды (из физического сервера в Azure)
...
1. Если у вас нет сервера конфигурации, в окне **Подготовка источника** щелкните **Добавить сервер конфигурации**.
