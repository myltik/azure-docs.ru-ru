...
# Восстановление размещения в Site Recovery для виртуальных машин Hyper-V
...
## Почему нет кнопки, которая называется "Восстановить размещение"?
...
## Почему существует только плановая команда для восстановления размещения?
