...
---
# <a name="failback-in-site-recovery"></a>Восстановление размещения в Site Recovery
...
6. Если вы выбрали параметр, при котором синхронизация данных выполняется до отработки отказа, то после завершения начальной синхронизация данных и когда вы будете готовы завершить работу виртуальных машин в Azure, последовательно выберите пункты **Задания** > <planned failover job name> и **Полная отработка отказа**. Эта команда завершит работу машины Azure, передаст последние изменения на локальную виртуальную машину и запустит ее.
