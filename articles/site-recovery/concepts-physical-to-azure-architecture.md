---
title: "Физический сервер, чтобы архитектура Azure репликации в Azure Site Recovery | Документы Microsoft"
...
- Размещение следует восстанавливать на локальную виртуальную машину VMware. Это означает, что даже в том случае, если репликация локальных физических серверов в Azure необходимо VMware локальной инфраструктуры.
...
Выполните [этого учебника](tutorial-physical-to-azure.md) для включения физического сервера Azure репликации.
