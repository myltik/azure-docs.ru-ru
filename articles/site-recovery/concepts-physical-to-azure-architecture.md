---
title: "Обзор архитектуры для репликации физического сервера в Azure | Документы Майкрософт"
...
![Компоненты](./media/concepts-physical-to-azure-architecture/arch-enhanced.png)
...
![Процесс репликации](./media/concepts-physical-to-azure-architecture/v2a-architecture-henry.png)
...
1. Выполните отработку отказа одного компьютера или создайте планы восстановления, чтобы выполнить отработку отказа нескольких компьютеров.
...
![Восстановление размещения](./media/concepts-physical-to-azure-architecture/enhanced-failback.png)
