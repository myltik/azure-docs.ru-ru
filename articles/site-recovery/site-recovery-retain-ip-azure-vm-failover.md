...
Дополнительные сведения см. в разделе [Регистрация для предварительной версии пиринга между виртуальными сетями в разных регионах](../virtual-network/virtual-network-create-peering.md#register) и на [странице цен на виртуальные сети](https://azure.microsoft.com/en-us/pricing/details/virtual-network/).
