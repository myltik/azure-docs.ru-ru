...
В этой статье описываются компоненты и процессы, задействованные при репликации виртуальных машин Hyper-V из локальной среды в Azure с помощью службы [Azure Site Recovery](site-recovery-overview.md).
...
В репликации виртуальных машин Hyper-V в Azure задействовано несколько компонентов.
...
**Рис. 2. Репликация Hyper-V из облаков VMM в Azure**
...
**Рис. 3. Репликация и восстановление в ходе репликации Hyper-V в Azure**
