...
Том с чередующимся диском размером более 1 ТБ для клиента или сервера<br/><br/> Управление логическими томами; клиент или сервер — дисковые пространства | Нет: клиент или сервер — горячее добавление или удаление диска | Нет: клиент или сервер — исключение диска | Да: клиент или сервер — многопутевая обработка (MPIO) | Н/Д

> [!NOTE]
> ** Виртуальные машины с VMware с загрузкой UEFI и физические серверы под управлением Windows Server 2012 или более поздней версии могут быть перенесены в Azure. Применяются следующие ограничения.
