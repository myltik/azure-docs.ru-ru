...
-   [Как сохранить букву диска для защищенных виртуальных машин
    > которые выполняют отработку отказа или переносятся в Azure](http://support.microsoft.com/kb/3031135)
