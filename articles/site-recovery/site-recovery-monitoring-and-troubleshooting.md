...
-   <span style="color:green;">Новая информация.</span> Время ожидания отработки отказа заканчивается (появляется сообщение PreFailoverWorkflow task WaitForScriptExecutionTaskTimeout (Завершилось время ожидания задачи PreFailoverWorkflow) из-за настроек конфигурации в группе безопасности сети, связанной с виртуальной машиной или подсетью, которой принадлежит виртуальная машина. Подробности см. в статье [Failover operation timed out due to "PreFailoverWorkflow task WaitForScriptExecutionTaskTimeout"](https://aka.ms/troubleshoot-nsg-issue-azure-site-recovery) (Завершилось время ожидания отработки отказа из-за ошибки PreFailoverWorkflow task WaitForScriptExecutionTaskTimeout (Завершилось время ожидания задачи PreFailoverWorkflow)).
