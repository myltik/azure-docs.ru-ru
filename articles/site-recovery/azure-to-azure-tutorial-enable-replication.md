...
- Ознакомьтесь с [требованиями поддержки ](site-recovery-support-matrix-azure-to-azure.md) для всех компонентов.
...
3. В поле **Имя**укажите понятное имя для идентификации хранилища. Если у вас имеется несколько подписок, выберите соответствующую.
...
- **Целевые группы доступности**. По умолчанию Site Recovery создает группу доступности в целевом регионе с суффиксом asr.
