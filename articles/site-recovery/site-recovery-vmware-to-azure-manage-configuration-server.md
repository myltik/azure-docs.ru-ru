...
Шаблон в формате OVF развертывает виртуальную машину сервера конфигурации с одним сетевым адаптером. Вы можете [добавить дополнительный сетевой адаптер в эту виртуальную машину](how-to-deploy-configuration-server.md#add-an-additional-adapter), но добавление нужно сделать до регистрации сервера конфигурации в хранилище.
...
Ознакомьтесь с руководствами по настройке аварийного восстановления [виртуальных машин VMware](tutorial-vmware-to-azure.md) в Azure.
