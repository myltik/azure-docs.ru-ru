---
title: Защита Active Directory и DNS с Azure Site Recovery | Microsoft Docs
...
2. Запустите тестовую отработку отказа для плана восстановления приложения.
3. По завершении теста отметьте задачи отработки отказа виртуальной машины контроллера домена и плана восстановления на вкладке **Задания** в Site Recovery как выполненные.
...
## Дальнейшие действия
Для получения дополнительных сведений о защите корпоративных приложений с Azure Site Recovery прочтите статью [Какие рабочие нагрузки можно защитить?](site-recovery-workload.md).
