...
- Все предварительные требования к портам и URL-адресам, которые нужно добавить в список разрешений, приведены [здесь](vmware-azure-deploy-configuration-server.md#prerequisites).
