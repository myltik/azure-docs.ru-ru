...
- **Репликация из локального ЦД в локальный с использованием SAN**. Сопоставление хранилищ настраивается посредством сопоставления пулов массивов хранения на исходном и целевом серверах VMM.
