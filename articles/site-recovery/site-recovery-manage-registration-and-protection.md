...
При репликации виртуальных машин VMware или физических серверов Windows или Linux в Azure можно отменить регистрацию сервера конфигурации в хранилище, используя следующие действия:
...
7. Удалите все дополнительные серверы обработки.
...
Инструкции не отличаются, независимо от того, подключен сервер конфигурации к Azure или нет.
