...
Виртуальные машины и физические серверы, защищенные с помощью Site Recovery, также поддерживают **плановую отработку отказа**. В этом варианте потеря данных исключается. Когда выполняется плановая отработка отказа, сначала завершается работа исходных виртуальных машин, затем синхронизируются данные, которые еще не синхронизированы, и лишь затем запускается отработка отказа.
