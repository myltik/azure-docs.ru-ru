...
3.	При наличии существующих устройств появится предупреждающее сообщение. Щелкните **Форматировать**, чтобы отформатировать диск с заданными параметрами раздела. Щелкните **Записать изменения на диск**, чтобы применить изменения к разделу.
...
1.	На странице **Планы восстановления** выберите план восстановления, содержащий группу восстановления размещения, и последовательно выделите **Отработка отказа** \> **Внеплановая отработка отказа**.
