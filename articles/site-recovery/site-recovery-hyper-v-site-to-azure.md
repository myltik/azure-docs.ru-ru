...
Эта статья описывает следующие шаги развертывания.
...
### <a name="before-you-start"></a>Перед началом работы
 ...
 - Чтобы полностью проверить систему, скопируйте Active Directory и DNS в вашу тестовую среду. [Подробнее](site-recovery-active-directory.md#test-failover-considerations).
...
Когда начальная репликация завершится и вы проверите работу развертывания, отработку отказа можно будет использовать в любой момент по мере необходимости. [Узнайте больше](site-recovery-failover.md) о разных типах отработки отказа и способах их выполнения.
