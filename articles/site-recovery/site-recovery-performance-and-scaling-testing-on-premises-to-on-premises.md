---
title: "Результаты масштабирования и теста производительности для репликации Hyper-V между локальными сайтами с помощью Site Recovery | Документация Майкрософт"
description: "В этой статье содержатся сведения о тестировании производительности для репликации между локальными сайтами с помощью Azure Site Recovery."
...
---
# <a name="performance-test-and-scale-results-for-on-premises-to-on-premises-hyper-v-replication-with-site-recovery"></a>Результаты масштабирования и теста производительности для репликации Hyper-V между локальными сайтами с помощью Site Recovery
...
## <a name="test-deployment-results"></a>Результаты тестового развертывания
...
### <a name="effect-of-replication-on-network-utilization"></a>Влияние репликации на использование сети
...
### <a name="effect-of-replication-on-virtual-machine-performance"></a>Влияние репликации на производительность виртуальной машины
...
| Рабочая нагрузка | # Виртуальные машины | Минимальный объем ОЗУ (ГБ) | Максимальный объем ОЗУ (ГБ) | Размер логического диска (ГБ) на виртуальную машину | Максимальное значение IOPS |
| --- | --- | --- | --- | --- | --- |
...
### <a name="azure-site-recovery-settings"></a>Настройки Azure Site Recovery
