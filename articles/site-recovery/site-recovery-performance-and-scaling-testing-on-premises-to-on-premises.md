<properties
	pageTitle="Azure Site Recovery: тест производительности и результаты масштабирования для репликации Hyper-V между локальными сайтами"
...
# Azure Site Recovery: тест производительности и результаты масштабирования для репликации Hyper-V между локальными сайтами
