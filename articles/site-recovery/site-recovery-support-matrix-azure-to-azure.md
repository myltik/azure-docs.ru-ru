...
**Конфигурация** | **Поддержка** | **Примечания**
--- | --- | ---
Максимальный размер диска ОС | 1023 ГБ | Дополнительные сведения см.в разделе [Диски, используемые виртуальными машинами](../storage/storage-about-disks-and-vhds-windows.md#disks-used-by-vms).
Максимальный размер данных на диске | 1023 ГБ | Дополнительные сведения см.в разделе [Диски, используемые виртуальными машинами](../storage/storage-about-disks-and-vhds-windows.md#disks-used-by-vms).
