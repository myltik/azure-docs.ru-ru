<properties
	pageTitle="Планирование производительности для защиты виртуальных машин и физических серверов в Azure Site Recovery | Microsoft Azure"
...
# Планирование производительности для защиты виртуальных машин и физических серверов в Azure Site Recovery

Планировщик ресурсов Azure Site Recovery позволяет определить требования к производительности для защиты виртуальных машин Hyper-V, виртуальных машин VMware и физических серверов под управлением Windows и Linux с помощью Azure Site Recovery.


## Обзор

С помощью планировщика ресурсов Site Recovery можно проанализировать исходную среду и рабочие нагрузки и выяснить требования к пропускной способности, а также определить объем ресурсов сервера, которые следует выделить в исходном расположении, и ресурсов (виртуальных машин, хранилищ и т. д.), требуемых для целевого расположения.
