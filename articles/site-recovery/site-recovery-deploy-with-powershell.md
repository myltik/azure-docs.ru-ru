<properties
	pageTitle="Автоматизируйте защиту между локальным сайтом VMM и Azure с помощью PowerShell"
	description="Автоматизируйте развертывание Azure Site Recovery с помощью PowerShell."
...
Windows PowerShell® — оболочка командной строки на основе задач и языка сценариев, разработанная специально для администрирования системы. Использование командлетов PowerShell для Azure Site Recovery поддерживается между узлом Hyper-V, которым управляет VMM, и Azure.

## Обзор

Служба Azure Site Recovery помогает реализовать стратегии непрерывности бизнеса и восстановления после сбоев (BCDR), управляя процессами репликации, отработки отказа и восстановления виртуальных машин в ряде сценариев развертывания. Полный список сценариев развертывания приведен в статье [Обзор Azure Site Recovery](site-recovery-overview.md).

В этой статье показано, как использовать PowerShell для автоматизации типичных задач развертывания Azure Site Recovery, включая управление и автоматизацию защиты рабочих нагрузок, работающих на виртуальных машинах на серверах узлов Hyper-V, расположенных в частных облаках VMM. В этом сценарии виртуальные машины реплицируются с первичного сайта VMM в Azure с помощью реплики Hyper-V.
...
При возникновении проблем свои вопросы можно задать на [форуме по Azure Recovery Services](http://go.microsoft.com/fwlink/?LinkId=313628).
...
- Вам потребуется учетная запись [Microsoft Azure](http://azure.microsoft.com/). Если у вас ее нет, начните с получения [бесплатной пробной версии](http://aka.ms/try-azure). Также вы можете ознакомиться с [расценками на использование менеджера Azure Site Recovery](http://go.microsoft.com/fwlink/?LinkId=378268).
...
Дополнительные сведения об использовании командлетов, например о типичной обработке значений параметров, входных и выходных параметров в Azure PowerShell, приведены в статье [Приступая к работе с командлетами Azure](https://msdn.microsoft.com/library/azure/jj554332.aspx).
...
Для проверки выполнения операции выполните действия, описанные в статье [Мониторинг активности](#monitor).
...
<LI>Дополнительные сведения о командлетах Azure Site Recovery PowerShell приведены в <a href="https://msdn.microsoft.com/library/dn850420.aspx">этой</a> статье.
