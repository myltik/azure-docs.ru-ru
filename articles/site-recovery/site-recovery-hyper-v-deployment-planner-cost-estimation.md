...
Если вы используете для DR контроллер домена, виртуальную машину DNS или виртуальную машину SQL Server с группами доступности AlwaysOn в Azure, вы можете указать число и размер виртуальных машин, чтобы расходы на вычислительные ресурсы для них включались в общие затраты на DR. 
...
Как добавить данные виртуальных машин вручную 
...
* Операций тестирования DR в год 
...
Ознакомьтесь с дополнительными сведениями о защите [виртуальных машин Hyper-V в Azure с помощью Azure Site Recovery](https://docs.microsoft.com/en-us/azure/site-recovery/tutorial-hyper-v-to-azure).
