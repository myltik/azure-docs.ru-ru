...
>[!NOTE]
>
> - Репликация виртуальных машин Azure между подписками в рамках сценариев аварийного восстановления не поддерживается.
> - Перенос виртуальных машин Azure между подписками не поддерживается.
> - Перенос виртуальных машин Azure в пределах одного региона не поддерживается.
> - Перенос виртуальных машин Azure из классической модели развертывания в модель Resource Manager не поддерживается.
