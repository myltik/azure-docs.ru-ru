...
-   Visual Studio 2012 или более поздней версии с ASP.NET MVC 4 и SQL Server. Вы можете скачать Visual Studio 2013 Express через Интернет из [Центра загрузки](http://www.microsoft.com/ru-ru/download/details.aspx?id=40747).
-   Служба "Поиск Azure". Вам понадобятся имя службы поиска и ключ администратора. Дополнительные сведения см. в разделе [Настройка поиска на портале предварительной версии Azure](../search-configure/) .
