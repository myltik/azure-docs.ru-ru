...
![Последовательно выберите «Создать», «Службы для разработчиков», «Application Insights»](./media/app-insights-asp-net/01-new-asp.png)
...
![Нажмите «Свойства», выберите ключ и нажмите сочетание клавиш CTRL + C](./media/app-insights-asp-net/02-props-asp.png)
...
Если у вас есть файл _Layout.cshtml, вставьте в него следующий код. В противном случае, вставьте код на любую страницу, которую необходимо отслеживать.
