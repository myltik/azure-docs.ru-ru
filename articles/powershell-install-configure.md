...
> [AZURE.NOTE]**Предварительная версия Azure PowerShell 1.0** теперь доступна в [коллекции PowerShell](http://www.powershellgallery.com/). В эту предварительную версию добавлено много изменений, и мы хотели бы использовать ее для сбора отзывов и предложений, которые мы внедрим в Azure PowerShell 1.0. **Эта предварительная версия не предназначен для критически важных приложений**. Если у вас запущены такие приложения, продолжайте использовать Azure PowerShell 0.9.8. Если вы хотите использовать предварительную версию 1.0, в любой момент ее можно удалить и вернуться к версии 0.9.8. Полные указания по установке см. в этой [записи блога](https://azure.microsoft.com/ru-RU/blog/azps-1-0-pre/).
