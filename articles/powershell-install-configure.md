...
Установка Azure PowerShell 1.0 и более поздних версий с использованием WebPI выполняется также, как и для версий 0.9.x. Скачайте [Azure PowerShell](http://aka.ms/webpi-azps) и начните установку. Если вы установили Azure PowerShell 0.9.x, появится запрос для удаления версии 0.9.x. Если вы установили модули Azure PowerShell из коллекции PowerShell, установщик потребует удалить эти модули перед установкой, чтобы обеспечить целостность среды Azure PowerShell.
...
Если вы установили Azure PowerShell с помощью коллекции PowerShell, но вместо нее хотите использовать установщик веб-платформы, то установка с его помощью автоматически удалит установленные командлеты из коллекции.
