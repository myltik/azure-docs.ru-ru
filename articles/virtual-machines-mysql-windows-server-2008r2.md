<properties pageTitle="Создание виртуальной машины с MySQL в Azure" description="Создание виртуальной машины Azure под управлением Windows Server 2008 R2 и последующая установка и настройка базы данных MySQL на виртуальной машине." services="virtual-machines" documentationCenter="" authors="KBDAzure" manager="timlt" editor="tysonn"/>
...
После создания виртуальной машины присоедините диск данных. Он будет выполнять роль хранилища данных, необходимого при установке MySQL. Подключите пустой диск, следуя указаниям в статье [Как присоединить диск данных к виртуальной машине](http://azure.microsoft.com/ru-ru/documentation/articles/storage-windows-attach-disk/).
