<properties      
    ...
    description="Узнайте, как секционировать данные в DocumentDB и когда использовать секционирование по хэшу, диапазону и подстановке."          services="documentdb"      
    authors="arramac"      
    manager="johnmac"      
    editor="monicar"      
    documentationCenter=""/> 
...
Наиболее распространенными методиками секционирования данных с помощью Azure DocumentDB являются *секционирование по диапазону*, *секционирование по подстановке* и *секционирование по хэшу*. Обычно вы обозначаете имя отдельного свойства JSON в документе в качестве ключа раздела, такого как "timestamp" или "userID". В некоторых случаях может использоваться внутреннее свойство JSON или новое имя свойства для каждого отличного типа документа.
