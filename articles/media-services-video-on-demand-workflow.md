...
См. раздел [Кодирование с помощью служб мультимедиа Azure](../media-services-encode-asset).
...
[Этот](../media-services-how-to-scale) раздел содержит ссылки на соответствующие разделы.


##Воспроизведение содержимого

Дополнительные сведения см. в разделе [Воспроизведение содержимого с помощью существующих проигрывателей](../media-services-playback-content).
