...
Чтобы исправить это, вы можете изменить размер виртуальной машины с помощью консоли диспетчера Hyper-V или командлета Powershell [Resize-VHD](http://technet.microsoft.com/ru-ru/library/hh848535.aspx).
