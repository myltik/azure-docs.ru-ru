<properties linkid="develop-java-tutorials-web-site-get-started" urlDisplayName="Приступая к работе с Azure" pageTitle="Приступая к работе с веб-сайтами Microsoft Azure с помощью Java" metaKeywords="" description="В этом учебнике показано, как развернуть веб-сайт Java в среде Microsoft Azure." metaCanonical="" services="web-sites" documentationCenter="Java" title="Приступая к работе с Azure и Java" videoId="" scriptId="" authors="waltpo" solutions="" manager="keboyd" editor="mollybos" />

# Приступая к работе с веб-сайтами Azure и Java
...
2. Щелкните **Создать**, **Среда выполнения приложений**, **Веб-сайт**, а затем **Из коллекции**.
...
Через несколько секунд веб-сайт будет создан. Для просмотра веб-сайта дождитесь, когда в представлении **Веб-сайты** на портале управления Azure отобразится состояние **Выполняется**, а затем щелкните URL-адрес веб-сайта.
...
5. Щелкните **Завершить**. Через несколько секунд веб-сайт будет создан. Для просмотра веб-сайта дождитесь, когда в представлении **Веб-сайты** на портале управления Azure отобразится состояние **Выполняется**, а затем щелкните URL-адрес веб-сайта.
6. В представлении **Веб-сайты** на портале управления Azure щелкните имя своего веб-сайта, чтобы открыть панель мониторинга.
...
Веб-сайт на базе Java станет доступен через несколько секунд. Чтобы убедиться, что сайт создан на основе Java, дождитесь, когда в представлении **Веб-сайты** на портале управления Azure отобразится состояние **Выполняется**, а затем щелкните URL-адрес веб-сайта. Обратите внимание, что на странице будет присутствовать текст о том, что новый веб-сайт создан на основе Java.
