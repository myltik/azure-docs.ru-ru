---
title: Руководство по безопасности службы хранилища Azure | Microsoft Docs
...
* [виртуальные машины IaaS серий A, D и G](https://azure.microsoft.com/pricing/details/virtual-machines/)
* шифрование для виртуальных машин IaaS, созданных с помощью модели [диспетчера ресурсов Azure](../resource-group-overview.md) ;
* все общедоступные [регионы](https://azure.microsoft.com/regions/)
