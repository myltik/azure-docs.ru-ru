...
1.  **Как можно проверять целостность BLOB-объектов, передаваемых в службу хранилища Azure или из нее, если протокол HTTPS использовать невозможно?**
	...
	Дополнительные сведения см. в статье [Azure Blob MD5 Overview](http://blogs.msdn.com/b/windowsazurestorage/archive/2011/02/18/windows-azure-blob-md5-overview.aspx) (Общие сведения о проверке MD5 BLOB-объектов Azure).
