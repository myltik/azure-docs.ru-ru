...
* шифрование для виртуальных машин IaaS, созданных с помощью модели [диспетчера ресурсов Azure](../azure-resource-manager/resource-group-overview.md) ;
