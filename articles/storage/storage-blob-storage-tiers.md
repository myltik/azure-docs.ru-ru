---
title: Холодный уровень хранилища Azure для больших двоичных объектов | Microsoft Docs
description: 'Уровни хранилища BLOB-объектов Azure обеспечивают экономичное хранение данных объектов в зависимости от схемы доступа. '
;холодный";: ''
уровень: ''
хранилища: ''
оптимизирован: ''
...
> [!NOTE]
> Сейчас учетные записи хранения BLOB-объектов поддерживаются в большинстве регионов Azure, и планируется расширить поддержку. Обновленный список регионов доступности см. на странице [Службы Azure по региону](https://azure.microsoft.com/regions/#services).
> 
> 
