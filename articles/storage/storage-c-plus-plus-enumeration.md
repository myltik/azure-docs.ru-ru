...
>[AZURE.NOTE]Это руководство предназначено для клиентской библиотеки хранилища Azure для С++ версии 1.x, которая доступна в [NuGet](http://www.nuget.org/packages/wastorage) или [GitHub](https://github.com/Azure/azure-storage-cpp).
...
Так как клиентская библиотека хранилища для C++ основана на [библиотеке C++ REST (проект Casablanca)](http://casablanca.codeplex.com/), мы поддерживаем асинхронные операции с использованием [pplx::task](http://microsoft.github.io/cpprestsdk/classpplx_1_1task.html). Например:
...
API-интерфейсы отложенного перечисления включены в клиентскую библиотеку хранилища C++ версии 1.0.0.
