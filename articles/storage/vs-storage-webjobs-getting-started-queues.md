<properties 
	pageTitle="Приступая к работе с подключенными службами хранилища очередей Azure и Visual Studio (проекты веб-заданий)" 
	description="Начало работы с хранилищем очередей в учетной записи хранения Azure, которая была создана с помощью диалогового окна Visual Studio «Добавление подключенных службы» в проекте веб-задания."
	services="storage"
	documentationCenter=""
	authors="patshea123"
	manager="douge"
