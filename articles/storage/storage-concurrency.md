...
Delete Container| Нет| Да|
Lease Container| Да| Да|
List Blobs| Нет| Нет 
...
Lease Blob (*)| Да| Да|
Snapshot Blob| Да| Да|
Copy Blob| Да| Да (для исходного и конечного большого двоичного объекта)|
Abort Copy Blob| Нет| Нет|
Delete Blob| Нет| Да|
Put Block| Нет| Нет|
Put Block List| Да| Да|
Get Block List| Да| Нет|
Put Page| Да| Да|
Get Page Ranges| Да| Да
