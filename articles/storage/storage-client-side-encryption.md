<properties 
	pageTitle="Шифрование на стороне клиента с помощью .NET для службы хранилища Microsoft Azure | Microsoft Azure" 
...
В статье с [примерами шифрования](https://github.com/Azure/azure-storage-net/tree/master/Samples/GettingStarted/EncryptionSamples) показан подробный сквозной сценарий для больших двоичных объектов, очередей, таблиц и интеграции хранилища ключей.
...
Скачать [клиентскую библиотеку службы хранилища Azure для пакета .NET NuGet](http://www.nuget.org/packages/WindowsAzure.Storage/5.0.0)
Скачать [клиентскую библиотеку службы хранилища Azure для исходного кода .NET](https://github.com/Azure/azure-storage-net) из GitHub
Скачать пакеты NuGet для хранилища ключей Azure [Core](http://www.nuget.org/packages/Microsoft.Azure.KeyVault.Core/), [Client](http://www.nuget.org/packages/Microsoft.Azure.KeyVault/) и [Extensions](http://www.nuget.org/packages/Microsoft.Azure.KeyVault.Extensions/)   
Просмотреть [документацию по хранилищу ключей Azure](../articles/key-vault-whatis.md)
