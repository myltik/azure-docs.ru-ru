...
### [Личные домены](storage-custom-domain-name.md)
...
### [Служба импорта и экспорта для хранилища BLOB-объектов](storage-import-export-service.md)
...
## .NET
### [Большой двоичный объект, очередь, таблица и файл](https://msdn.microsoft.com/library/azure/mt347887.aspx)
### [Поставщик ресурсов](/dotnet/api/)
### [Перемещение данных](/dotnet/api/)

## REST
### [Большой двоичный объект, очередь, таблица и файл](/rest/api/storageservices/fileservices/azure-storage-services-rest-api-reference)
