...
- При копировании большого двоичного объекта в другой большой двоичный объект, который относится к другой учетной записи, необходимо использовать SAS для проверки подлинности исходного большого двоичного объекта. При необходимости можно использовать SAS для проверки подлинности конечного большого двоичного объекта при условии, что вы используете службы хранилища версии 2013-08-15 или более поздней.
- При копировании файла в другой файл, который относится к другой учетной записи, необходимо использовать SAS для проверки подлинности исходного файла. При необходимости можно использовать SAS для проверки подлинности конечного файла.
...
- **Ресурс хранилища.** Ресурсы хранилища, для которых можно делегировать доступ, включают в себя следующее.
...
Версия служб хранилища|sv=2012-02-12|Для служб хранилища версии 2012-02-12 и более поздней этот параметр указывает используемую версию.
Время начала|st=2013-04-29T22%3A18%3A26Z|Указывается в формате ISO 8061. Чтобы подпись общего доступа вступала в силу сразу же, не указывайте время начала действия.
Время окончания срока действия|se=2013-04-30T02%3A23%3A26Z|Указывается в формате ISO 8061.
...
- [Использование хранилища файлов Azure с помощью PowerShell и .NET](storage-dotnet-how-to-use-files.md)
