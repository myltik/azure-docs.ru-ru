<properties 
	pageTitle="Подписи общего доступа: общие сведения о модели SAS | Microsoft Azure" 
	description="Узнайте о том, как делегировать доступ к ресурсам больших двоичных объектов, очереди и таблиц с помощью подписанных URL-адресов" 
	services="storage" 
	documentationCenter="" 
	authors="tamram" 
	manager="adinah" 
