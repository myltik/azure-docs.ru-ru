...
## <a name="a-nameallservicesaall-services"></a><a name="allservices"></a>Все службы
...
### <a name="a-namesubheading1ascalability-targets"></a><a name="subheading1"></a>Целевые показатели масштабируемости
...
#### <a name="a-namesub1bandwidthabandwidth-scalability-target-for-all-services"></a><a name="sub1bandwidth"></a>Целевой показатель масштабируемости пропускной способности для всех служб
...
### <a name="a-namesubheading47apartition-naming-convention"></a><a name="subheading47"></a>Соглашение об именовании секций
...
##### <a name="a-namesubheading2athroughput"></a><a name="subheading2"></a>Пропускная способность
...
##### <a name="a-namesubheading3alink-quality"></a><a name="subheading3"></a>Качество связи
...
##### <a name="useful-resources"></a>Полезные ресурсы
Дополнительные сведения о размерах виртуальной машины и выделенной пропускной способности см. в статье [Размеры виртуальных машин в Azure](../virtual-machines/virtual-machines-windows-sizes.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) (Windows) или [Размеры виртуальных машин в Azure](../virtual-machines/virtual-machines-linux-sizes.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) (Linux).  

#### <a name="a-namesubheading4alocation"></a><a name="subheading4"></a>Расположение
...
### <a name="a-namesubheading5acontent-distribution"></a><a name="subheading5"></a>Распространение содержимого
...
### <a name="a-namesubheading6ausing-sas-and-cors"></a><a name="subheading6"></a>Использование SAS и CORS
...
#### <a name="a-namesubheading7agetting-data"></a><a name="subheading7"></a>Получение данных
...
#### <a name="a-namesubheading8auploading-data-in-batches"></a><a name="subheading8"></a>Передача данных в пакетах
...
#### <a name="a-namesubheading9aincrease-default-connection-limit"></a><a name="subheading9"></a>Увеличение ограничения числа подключений по умолчанию
...
#### <a name="a-namesubheading10aincrease-threadpool-min-threads-if-using-synchronous-code-with-async-tasks"></a><a name="subheading10"></a>
...
#### <a name="a-namesubheading11atake-advantage-of-net-45-garbage-collection"></a><a name="subheading11"></a>
...
### <a name="a-namesubheading12aunbounded-parallelism"></a><a name="subheading12"></a>Неограниченный параллелизм
...
### <a name="a-namesubheading13astorage-client-libraries-and-tools"></a><a name="subheading13"></a>Клиентские библиотеки и средства хранилища
...
#### <a name="a-namesubheading14athrottlingserverbusy"></a><a name="subheading14"></a>Регулирование количества запросов и состояние "Сервер занят"
...
#### <a name="a-namesubheading15anon-retryable-errors"></a><a name="subheading15"></a>Ошибки без повторов
...
#### <a name="a-namesubheading46amultiple-clients-accessing-a-single-object-concurrently"></a><a name="subheading46"></a>Несколько клиентов, одновременно обращающихся к одному объекту
...
#### <a name="a-namesubheading16abandwidth-and-operations-per-blob"></a><a name="subheading16"></a>Пропускная способность и операции с BLOB-объектом
...
#### <a name="a-namesubheading17acopy-blob"></a><a name="subheading17"></a>Копирование BLOB-объекта
...
#### <a name="a-namesubheading18ause-azcopy"></a><a name="subheading18"></a>Использование программы AzCopy
...
#### <a name="a-namesubheading19aazure-importexport-service"></a><a name="subheading19"></a>Служба импорта и экспорта Azure
...
### <a name="a-namesubheading20ause-metadata"></a><a name="subheading20"></a>Использование метаданных
...
#### <a name="a-namesubheading21auploading-one-large-blob-quickly"></a><a name="subheading21"></a>Быстрая отправка одного BLOB-объекта
...
#### <a name="a-namesubheading22auploading-many-blobs-quickly"></a><a name="subheading22"></a>Быстрая отправка множества BLOB-объектов
...
### <a name="a-namesubheading23achoosing-the-correct-type-of-blob"></a><a name="subheading23"></a>Выбор правильного типа BLOB-объекта
...
### <a name="a-namesubheading24atable-specific-scalability-targets"></a><a name="subheading24"></a>Целевые показатели масштабирования для таблицы
...
#### <a name="a-namesubheading25ause-json"></a><a name="subheading25"></a>Использование JSON
...
#### <a name="a-namesubheading26anagle-off"></a><a name="subheading26"></a>Отключение алгоритма Nagle
...
#### <a name="a-namesubheading27atables-and-partitions"></a><a name="subheading27"></a>Таблицы и секции
...
##### <a name="a-namesubheading28aappend-only-and-prepend-only-patterns"></a><a name="subheading28"></a>Инкрементируемые и декрементируемые шаблоны
...
##### <a name="a-namesubheading29ahigh-traffic-data"></a><a name="subheading29"></a>Данные с интенсивным трафиком
...
##### <a name="a-namesubheading30aquery-scope"></a><a name="subheading30"></a>Область запроса
...
##### <a name="a-namesubheading31aquery-density"></a><a name="subheading31"></a>Плотность запроса
...
###### <a name="a-namesubheading32afiltering"></a><a name="subheading32"></a>Фильтрация
...
###### <a name="a-namesubheading33aprojection"></a><a name="subheading33"></a>Проекция
...
##### <a name="a-namesubheading34adenormalization"></a><a name="subheading34"></a>Денормализация
...
##### <a name="a-namesubheading35abatching"></a><a name="subheading35"></a>Пакетная обработка
...
##### <a name="a-namesubheading36aupsert"></a><a name="subheading36"></a>Операция Upsert
...
##### <a name="a-namesubheading37astoring-data-series-in-a-single-entity"></a><a name="subheading37"></a>Хранение ряда данных в одной сущности
...
##### <a name="a-namesubheading38astoring-structured-data-in-blobs"></a><a name="subheading38"></a>Хранение структурированных данных в BLOB-объектах
...
### <a name="a-namesubheading39ascalability-limits"></a><a name="subheading39"></a>Ограничения масштабируемости
...
### <a name="a-namesubheading40anagle-off"></a><a name="subheading40"></a>Отключение алгоритма Nagle
...
### <a name="a-namesubheading41amessage-size"></a><a name="subheading41"></a>Размер сообщения
...
### <a name="a-namesubheading42abatch-retrieval"></a><a name="subheading42"></a>Пакетное извлечение
...
### <a name="a-namesubheading43aqueue-polling-interval"></a><a name="subheading43"></a>Интервал опроса очереди
...
### <a name="a-namesubheading45aapplication-architecture"></a><a name="subheading45"></a>Архитектура приложения
