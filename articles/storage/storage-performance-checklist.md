...
####Полезные ресурсы
Приведенные ниже ссылки ведут на ресурсы с дополнительными сведениями о целевых показателях масштабируемости: информация о целевых показателях масштабируемости ([Цели масштабируемости и производительности хранилища Azure в MSDN](storage-scalability-targets.md)); информация о вариантах обеспечения избыточности хранилища (статья [Репликация хранилища Azure](storage-redundancy.md) и запись в блоге [Варианты избыточности хранилища Azure и геоизбыточное хранилище с доступом для чтения](http://blogs.msdn.com/b/windowsazurestorage/archive/2013/12/11/introducing-read-access-geo-replicated-storage-ra-grs-for-windows-azure-storage.aspx)); информация о формировании цен на службы Azure ([Обзор цен на Azure](http://azure.microsoft.com/pricing/overview/)).
...
Дополнительные сведения см. в статье [Обзор усовершенствований, направленных на повышение производительности, в .NET 4.5](http://msdn.microsoft.com/magazine/hh882452.aspx).
