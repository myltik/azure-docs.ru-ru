...
####Полезные ресурсы
Следующие ссылки предоставляют дополнительные сведения о целевых показателях масштабирования. — Дополнительные сведения о целевых показателях масштабируемости см. в статье [Целевые показатели масштабируемости и производительности хранилища Azure в MSDN](storage-scalability-targets.md). — Дополнительные сведения о вариантах избыточности хранилища см. в статье [Репликация хранилища Azure](storage-redundancy.md) и в записи блога [Варианты избыточности хранилища Azure и геоизбыточное хранилище с доступом для чтения](http://blogs.msdn.com/b/windowsazurestorage/archive/2013/12/11/introducing-read-access-geo-replicated-storage-ra-grs-for-windows-azure-storage.aspx). — Дополнительные сведения о формировании цен на службы Azure см. в статье [Обзор цен на Azure](http://azure.microsoft.com/pricing/overview/).
...
#####Полезные ресурсы
Дополнительные сведения о размерах виртуальной машины и выделенной пропускной способности см. в статье [Размеры виртуальных машин](../virtual-machines/virtual-machines-size-specs.md).
...
Дополнительные сведения см. в статье [Метод ThreadPool.SetMinThreads](http://msdn.microsoft.com/library/system.threading.threadpool.setminthreads(v=vs.110).aspx)).
...
Дополнительные сведения о целевой пропускной способности для большого двоичного объекта см. в статье [Целевые показатели по масштабируемости и производительности хранилища Azure](storage-scalability-targets.md).
...
Дополнительную информацию см. в статье [Копирование большого двоичного объекта в MSDN](http://msdn.microsoft.com/library/azure/dd894037.aspx).
...
Пример того, как получить метаданные большого двоичного объекта с помощью .NET, см. в разделе [Задание и получение свойств и метаданных](storage-properties-metadata.md).
...
Подробнее см. в статье [Основные сведения о блочных больших двоичных объектах и страничных больших двоичных объектах](http://msdn.microsoft.com/library/azure/ee691964.aspx).
...
Дополнительные сведения см. в записях [Таблицы Microsoft Azure — введение в JSON](http://blogs.msdn.com/b/windowsazurestorage/archive/2013/12/05/windows-azure-tables-introducing-json.aspx) и [Формат полезных данных для операций службы таблиц](http://msdn.microsoft.com/library/azure/dn535600.aspx).
...
Текущие целевые показатели масштабируемости можно посмотреть на странице [Целевые показатели по масштабируемости и производительности хранилища Azure](storage-scalability-targets.md).
