---
title: "Репликация службы хранилища Azure | Документация Майкрософт"
...
* Реплика будет недоступна, пока корпорация Майкрософт не инициирует отработку отказа в дополнительном регионе.
* Если приложению требуется выполнить считывание из дополнительного региона, пользователю необходимо включить RA-GRS.
