...
- [Локально избыточное хранилище](#locally-redundant-storage)
- [Хранилище, избыточное в пределах зоны](#zone-redundant-storage)
- [Геоизбыточное хранилище](#geo-redundant-storage)
- [Геоизбыточное хранилище с доступом для чтения](#read-access-geo-redundant-storage)
