...
Кроме того, на сайте GitHub в репозитории Node.js для службы хранилища Azure есть пример использования маркеров продолжения (см. `examples/samples/continuationsample.js`).
