...
|**/bk:<ключ_BitLocker\>**|необязательный параметр. Укажите ключ BitLocker, чтобы разблокировать зашифрованное размещение, в котором хранятся экспортированные файлы.|  
