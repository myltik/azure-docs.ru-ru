...
| Н/Д | Диск, не входящий ни в одно задание, прибывает в центр обработки данных в рамках другого задания. | Диск будет помечен как лишний и будет возвращен клиенту по завершении задания, связанного с исходным пакетом. |
