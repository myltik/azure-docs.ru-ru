...
1.  Определите данные, которые нужно импортировать в службу хранилища Azure. Это могут быть папки или отдельные файлы на локальном сервере или в общей сетевой папке.
...
* Создайте задание экспорта, если необходимо передать данные, которые в настоящее время хранятся в вашей учетной записи хранения, на отправленные нам жесткие диски. При создании задания вы уведомляете службу импорта и экспорта о том, что отправите один или несколько жестких дисков в центр обработки данных Azure.
...
При импорте данных в службу хранилища Azure плата за транзакции не взимается. При экспорте данных из хранилища BLOB-объектов взимается стандартная плата за исходящие данные. Дополнительные сведения о стоимости транзакций см. на странице [Сведения о ценах — передача данных](https://azure.microsoft.com/pricing/details/data-transfers/).
