...
2.  Чтобы включить шифрование на компьютере Windows, включите шифрование BitLocker на томе NTFS. Воспользуйтесь инструкциями на странице https://technet.microsoft.com/en-us/library/cc731549(v=ws.10).aspx.
