...
Вы можете обновить свою учетную запись GPv1 до учетной записи GPv2 с помощью портала Azure, PowerShell или Azure CLI. 
...
* [настройка учетной записи хранения GPv2](#change-the-storage-tier-of-a-gpv2-storage-account-using-the-azure-portal);
* [настройка уровня большого двоичного объекта в хранилище BLOB-объектов или учетной записи хранения GPv2](#change-the-storage-tier-of-a-blob-using-the-azure-portal).
