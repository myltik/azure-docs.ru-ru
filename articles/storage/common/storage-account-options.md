...
С помощью портала, CLI или PowerShell пользователи могут в любое время обновить учетные записи GPv1 или хранилища BLOB-объектов до учетной записи GPv2. Это изменение невозможно отменить, а другие изменения не разрешены.
...
### <a name="convert-a-gpv1-or-blob-storage-account-to-a-gpv2-storage-account-using-the-azure-portal"></a>Преобразование учетной записи GPv1 или хранилища BLOB-объектов в учетную запись хранения GPv2 с помощью портала Azure
...
Учетную запись GPv1 или хранилища BLOB-объектов можно легко обновить до GPv2 без простоя или изменений API и без необходимости перемещения данных. Это одно из основных преимуществ GPv2 в сравнении с учетными записями хранилища BLOB-объектов.
...
Да. Учетные записи GPv1 или хранилища BLOB-объектов можно легко обновить до GPv2 на портале.
...
**Можно ли изменить уровень хранилища в учетной записи хранения GPv2?**
