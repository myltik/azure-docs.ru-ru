...
Учетные записи ZRS можно вручную перевести на учетную запись LRS, GRS или RAGRS и наоборот в этом регионе. Ручную миграцию можно выполнить с помощью AzCopy, Обозревателя службы хранилища Azure, Azure PowerShell, Azure CLI или одной из клиентских библиотек службы хранилища Azure.
