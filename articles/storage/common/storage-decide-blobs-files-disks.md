...
Дополнительные сведения о дисках см. в разделах [Сведения о дисках и виртуальных жестких дисках для виртуальных машин Azure под управлением Linux](../../virtual-machines/windows/about-disks-and-vhds.md) и [Подключение диска данных к виртуальной машине Windows, созданной с использованием классической модели развертывания](../../virtual-machines/windows/classic/attach-disk.md).
