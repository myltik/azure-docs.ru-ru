---
title: "Настройка брандмауэров службы хранилища Azure и виртуальных сетей (предварительная версия) | Документация Майкрософт"
...
## <a name="preview-availability-and-support"></a>Предварительная версия решений для обеспечения доступности и предоставления поддержки
Брандмауэры службы хранилища и виртуальные сети находятся на этапе предварительной версии.  Сейчас эти компоненты доступны для новых или имеющихся учетных записей хранения во всех регионах Azure для общедоступного облака.

> [!NOTE]
> В предварительной версии не поддерживаются производственные рабочие нагрузки.
>
...
> [!NOTE]
> Убедитесь, что ваша учетная запись хранения находится в одном из поддерживаемых регионов для общедоступной предварительной версии.
>
