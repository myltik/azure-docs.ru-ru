...
Брандмауэры службы хранилища и виртуальные сети находятся на этапе предварительной версии.  Сейчас эти компоненты доступны для новых или имеющихся учетных записей хранения в следующих регионах:
- Восток США
- Запад США
