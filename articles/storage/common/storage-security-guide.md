...
Эта функция доступна для учетных записей хранения категорий "Стандартный" и "Премиум", созданных с использованием модели развертывания с помощью Resource Manager. SSE применяется к данным любого типа: к блочным, страничным и добавочным BLOB-объектам, таблицам, очередям и файлам.
...
SSE позволяет выполнять шифрование любых данных в учетной записи хранения (блочных, страничных и добавочных BLOB-объектов, данных таблиц, очередей и файлов).
