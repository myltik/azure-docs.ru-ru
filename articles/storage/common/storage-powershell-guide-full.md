...
Дополнительные сведения о службе файлов Azure см. в статьях [Знакомство с хранилищем файлов Azure](../files/storage-files-introduction.md) и [File Service REST API](http://msdn.microsoft.com/library/azure/dn167006.aspx) (REST API службы файлов).
