...
Можно включить шифрование службы хранилища (SSE) для хранилища больших двоичных объектов или файлов Azure (предварительная версия). При этом все данные, записываемые в конкретной службе, шифруются перед записью. Перед чтением эти данные расшифровываются.
