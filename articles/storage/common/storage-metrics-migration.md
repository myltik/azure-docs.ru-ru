...
О. Нет. Если необходимо архивировать данные метрик в учетную запись хранения, можно [настроить параметр диагностики в Azure Monitor](https://azure.microsoft.com/blog/azure-monitor-multiple-diagnostic-settings/).
