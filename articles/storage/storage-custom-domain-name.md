...
>[AZURE.IMPORTANT] Служба хранилища Azure пока не поддерживает протокол HTTPS для личных доменов. Мы понимаем, что такая возможность нужна пользователям, поэтому добавим ее в будущих выпусках.
...
## Отмена регистрации пользовательского домена для учетной записи хранения
...
5. На ленте щелкните **Управление доменом**.

6. В диалоговом окне **Управление пользовательским доменом** щелкните **Отменить регистрацию**.
