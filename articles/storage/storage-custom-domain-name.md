...
1.  На [классическом портале Azure](manage.windowsazure.com) откройте вкладку **Хранилище**.
...
Например, для доступа к веб-форме через пользовательский поддомен **photos.contoso.com**, который выполняет сопоставление с большим двоичным объектом в вашем контейнере **myforms**, можно использовать следующий URI:
