...
4. Укажите модель развертывания: **диспетчер ресурсов** или **классическая**. Мы рекомендуем использовать **диспетчер ресурсов**. Подробнее об этих моделях можно узнать в статье [Общие сведения о развертывании диспетчера ресурсов и классическом развертывании](../resource-manager-deployment-model.md).

5. Укажите уровень производительности для учетной записи хранилища — **Premium**.

6. Единственным доступным вариантом репликации для хранилища класса Premium является **Локально избыточное хранилище (LRS)**. Дополнительные сведения о репликации службы хранилища Azure см. в статье [Репликация службы хранилища Azure](storage-redundancy.md).

7. Выберите подписку, в которой вы создаете учетную запись хранения.

8. Выберите существующую группу ресурсов или создайте новую. Дополнительные сведения о группах ресурсов Azure см. в статье [Управление ресурсами Azure с помощью портала Azure](../azure-portal/resource-group-portal.md).

9. Выберите географический регион для учетной записи хранения. Убедитесь, что хранилище класса Premium доступно в выбранном расположении, обратившись к статье [Службы Azure по региону](https://azure.microsoft.com/regions/#services).
