...
2. Затем установите удаленное подключение к виртуальной машине, следуя инструкциям в статье [Log on to a Windows virtual machine using the Azure portal](../virtual-machines/virtual-machines-windows-log-on.md) (Вход на виртуальную машину Windows с помощью портала Azure).
