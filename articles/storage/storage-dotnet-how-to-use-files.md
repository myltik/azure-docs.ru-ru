...
Дополнительные сведения об использовании хранилища файлов Azure в ОС Linux см. в статье [Использование хранилища файлов Azure в Linux](storage-how-to-use-files-linux.md).
...
[Портал предварительной версии Azure](https://ms.portal.azure.com/) дает клиентам возможность управлять хранилищем файлов с помощью пользовательского интерфейса. На портале предварительной версии вы можете выполнять следующие действия:
...
- получать команду `net use`, которая позволяет подключить общую папку с клиентского компьютера Windows. 
