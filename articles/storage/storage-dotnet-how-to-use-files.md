...
AzCopy можно использовать для копирования одного файла в другой, а также копирования большого двоичного объекта в файл или наоборот. См. раздел [Копирование файлов в хранилище файлов Azure с помощью AzCopy](storage-use-azcopy.md#copy-files-in-azure-file-storage-with-azcopy).
