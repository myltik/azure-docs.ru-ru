...
- [Azure Files Storage: a frictionless cloud SMB file system for Windows and Linux (Хранилище файлов Azure: удобная облачная файловая система SMB для Windows и Linux)
