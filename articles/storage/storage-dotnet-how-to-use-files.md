<properties
            ...
            description="Информация о том, как использовать хранилище файлов Azure для создания общих ресурсов файлов и управления содержанием файла. Хранилище файлов позволяет предприятиям переместить приложения, использующие общую папку с файлами SMB, в Azure. Примеры написаны на PowerShell и C#."
            services="storage"
...
В данном руководстве по началу работы продемонстрированы основы использования хранилища файлов Microsoft Azure. В этом учебнике мы выполним следующее:
