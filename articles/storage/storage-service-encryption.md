...
Чтобы использовать предварительную версию SSE для файлов, свяжитесь с нами по адресу ssdiscussions@microsoft.com.

Дополнительные сведения см. в разделе вопросов и ответов.
Шифрование службы хранения для хранилища файлов сейчас поддерживается в Восточной Азии.
