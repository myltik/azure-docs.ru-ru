---
title: Использование хранилища больших двоичных объектов из Node.js | Microsoft Docs
...
> [!NOTE]
> Чтобы исключить ненужные вызовы сервера, API-интерфейсы appendFromXXX будут выполнять проверку на стороне клиента по принципу fail fast. appendBlockFromXXX не будут делать этого.
> 
> 
...
* Репозиторий [Пакет SDK службы хранилища Azure для Node][Пакет SDK службы хранилища Azure для Node] на веб-сайте GitHub
