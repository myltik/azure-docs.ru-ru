...
Пример настройки переменных среды для веб-приложения Azure на [портале Azure](portal.azure.com) см. в статье [Веб-приложение Node.js с хранилищем].

## Создание контейнера

Объект **BlobService** позволяет работать с контейнерами и BLOB-объектами. Указанный ниже код создает объект **BlobService**. Добавьте в начало **server.js** следующий код.
...
* **createWriteStreamToExistingPageBlob** —предоставляет поток записи в существующий страничный BLOB-объект.
