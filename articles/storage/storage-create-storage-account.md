...
После создания учетной записи хранения вы можете изменить ее конфигурацию. Например, можно изменить вариант репликации учетной записи или уровень доступа для учетной записи хранилища BLOB-объектов. На [портале Azure](https://portal.azure.com) перейдите к учетной записи хранения, откройте раздел **Все параметры**, затем выберите элемент **Конфигурация**, чтобы просмотреть и/или изменить конфигурацию учетной записи.
...
Для учетных записей хранилища BLOB-объектов за изменение уровня доступа может взиматься отдельная плата в дополнение к изменению цены. Дополнительные сведения см. в разделе [о ценах и выставлении счетов в учетной записи хранилища BLOB-объектов](storage-blob-storage-tiers.md#pricing-and-billing).
...
**Обозреватели хранилищ**. Если вы используете какие-либо [приложения обозревателей хранилищ](storage-explorers.md), возможно, будет необходимо обновить ключ хранилища, используемый этими приложениями.
