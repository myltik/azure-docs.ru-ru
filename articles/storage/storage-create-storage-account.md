...
Для своей учетной записи хранения вы можете настроить имя домена. Чтобы получить дополнительную информацию, см. раздел [Настройка пользовательского имени домена для данных больших двоичных объектов в учетной записи хранения](storage-custom-domain-name.md).
...
- Чтобы больше узнать о службе хранилища Azure, см. документацию по ней на следующих ресурсах: [azure.com](http://azure.microsoft.com/documentation/services/storage/) и [MSDN)]http://msdn.microsoft.com/library/gg433040.aspx). 
