...
5. Укажите тип создаваемой учетной записи хранения. Тип учетной записи хранения определяет параметры репликации, а также класс этой учетной записи ("Стандартный" или "Премиум").
	...
	Дополнительные сведения о репликации службы хранилища Azure см. в статье [Репликация службы хранилища Azure](storage-redundancy.md). Дополнительные сведения об учетных записях хранения в стандартном хранилище и хранилище класса Premium см. в статьях [Знакомство со службой хранилища Microsoft Azure](storage-introduction.md) и [Хранилище Premium: высокопроизводительное хранилище для рабочих нагрузок виртуальных машин Azure](storage-premium-storage.md).
...
Если учетная запись хранения использует классическую модель развертывания, можно удалить диск виртуальной машины, выполнив следующие действия на [классическом портале Azure](https://manage.windowsazure.com):
