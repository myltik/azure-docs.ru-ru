...
1. Перейдите на панель мониторинга для учетной записи на [классическом портале Azure](manage.windowsazure.com), а затем выберите **Монитор**, чтобы просмотреть страницу мониторинга.
