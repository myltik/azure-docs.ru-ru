...
Дополнительные сведения о добавлении метрик на странице "Мониторинг" см. в разделе [Практическое руководство. Добавление метрик в таблицу метрик](storage-monitor-storage-account.md#add-metrics-charts-to-the-portal-dashboard).
