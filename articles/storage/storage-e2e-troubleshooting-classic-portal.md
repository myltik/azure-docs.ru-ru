...
## Просмотр данных метрик на классическом портале Azure
...
![Выбор метрики](./media/storage-e2e-troubleshooting-classic-portal/choose-metrics-portal-1.png)
...
![Начальная страница анализатора сообщений](./media/storage-e2e-troubleshooting-classic-portal/mma-start-page-1.png)
