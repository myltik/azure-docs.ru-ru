...
3. В меню **Tools** (Инструменты) выберите пункт **Asset Manager** (Диспетчер ресурсов). В окне **Asset Manager** (Диспетчер ресурсов) выберите **Downloads** (Загрузки) и отфильтруйте данные для **хранилища Azure**. Вы увидите ресурсы хранилища Azure, как показано на рисунке ниже.
