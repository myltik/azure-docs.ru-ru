...
7.  **Поддерживаемые операционные системы**: клиент может использовать одну из следующих 64-разрядных операционных систем для подготовки жесткого диска с помощью средства импорта и экспорта Azure перед отправкой в Azure: Windows 7 Корпоративная, Windows 7 Максимальная, Windows 8 Профессиональная, Windows 8 Корпоративная, Windows 8.1 Профессиональная, Windows 8.1 Enterprise, Windows 10*, Windows Server 2008 R2, Windows Server 2012, Windows Server 2012 R2. Все эти операционные системы поддерживают шифрование диска BitLocker.  
...
- На востоке Азиатско-Тихоокеанского региона, юго-востоке Азиатско-Тихоокеанского региона, в восточной Австралии, юго-восточной Австралии, западной Японии, восточной Японии и центральной Индии поддерживается только [DHL](http://www.dhl.com/). Все посылки будут возвращаться через DHL Express Worldwide.
...
- Майкрософт будет использовать учетную запись транспортного агента, которую вы указали во время создания задания для отправки дисков на ваш обратный адрес из центра обработки данных. Не забудьте указать учетную запись транспортного агента для для региона ЦОД, который его поддерживает Вы можете создать учетную запись транспортного агента для [FedEx](http://www.fedex.com/us/oadr/) (США и Европа) или [DHL](http://www.dhl.com/) (Азия и Австралия), если ее у вас еще нет.
