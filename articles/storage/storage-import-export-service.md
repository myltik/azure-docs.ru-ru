...
**Как подготовить жесткий диск в Windows 10?**
  
Для подготовки вашего жесткого диска в Windows 10 следуйте инструкциям ниже:
 
- Вручную включите шифрование BitLocker на диске, который подготавливается для службы импорта и экспорта Azure. Щелкните правой кнопкой мыши на букве диска в проводнике, выберите "Включить BitLocker" и следуйте указаниям мастера.  
- Обязательно запишите ключ восстановления.  
