---
title: "Использование службы экспорта и импорта для передачи данных в хранилище BLOB-объектов | Документация Майкрософт"
description: "Сведения о создании заданий импорта и экспорта на портале Azure для передачи данных в хранилище BLOB-объектов."
author: muralikk
manager: syadav
editor: tysonn
services: storage
...
---
# <a name="use-the-microsoft-azure-importexport-service-to-transfer-data-to-blob-storage"></a>Использование службы импорта и экспорта Azure для передачи данных в хранилище BLOB-объектов
...
Скачайте [последнюю версию средства WAImportExport](http://download.microsoft.com/download/3/6/B/36BFF22A-91C3-4DFC-8717-7567D37D64C5/WAImportExport.zip). Дополнительные сведения об использовании средства WAImportExport см. в [этой статье](storage-import-export-tool-how-to.md).
...
Служба импорта и экспорта поддерживает только 2,5-дюймовые твердотельные накопители и 2,5- или 3,5-дюймовые внутренние жесткие диски SATA II или III. Можно использовать жесткие диски емкостью до 10 ТБ.
...
Жесткий диск для копирования данных можно подключить напрямую через 2,5-дюймовый разъем твердотельного накопителя или 2,5- и 3,5-дюймовый разъем SATA II и III. Кроме того, для подключения можно использовать внешний USB-адаптер SATA II или III (2,5 или 3,5 дюйма), а также внешний USB-адаптер твердотельного накопителя (2,5 дюйма).
...
* Центральная Индия
* Канада
* Штат в США (для обслуживания государственных организаций США)
* Китай
...
## <a name="how-to-create-an-import-job"></a>Как создать задание импорта?
...
5.  Создайте CSV-файл для набора данных и набора дисков.
    ...
    **CSV-файл набора дисков**
    ...
    Значение флага набора дисков — это CSV-файл, содержащий список дисков, с которыми сопоставлены буквы дисков, в результате чего средство может правильно выбрать список дисков для подготовки. 
...
Пошаговые инструкции см. в статье [Пример рабочего процесса для подготовки жестких дисков для задания импорта](storage-import-export-tool-sample-preparing-hard-drives-import-job-workflow.md).  
...
## <a name="how-to-create-an-export-job"></a>Как создать задание экспорта?
