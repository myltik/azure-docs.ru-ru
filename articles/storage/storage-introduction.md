...
Здесь вы можете найти общие сведения о хранилище, а информация о конкретном продукте изложена в разделах, посвященных BLOB-объектам Azure, таблицам Azure, очередям Azure и файлам Azure.
