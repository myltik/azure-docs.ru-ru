...
Служба импорта и экспорта Azure позволяет импортировать и экспортировать данные BLOB-объектов из вашей учетной записи хранения путем отправки вашего жесткого диска по почте в центр обработки данных Azure. Дополнительные сведения о службе импорта и экспорта см. в разделе [Использование службы импорта и экспорта Azure для передачи данных в хранилище BLOB-объектов](storage-import-export-service.md).
