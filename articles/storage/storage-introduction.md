...
Чтобы быстро приступить к работе с хранилищем Azure, см. статью [Начните работать с хранилищем Azure за пять минут](storage-getting-started-guide.md).
...
При использовании очень больших наборов данных, когда данные просто нереально отправить или загрузить в хранилище BLOB-объектов по сети, можно передать жесткий диск в Майкрософт для импорта или экспорта данных непосредственно в центре обработки данных. Подробнее см. в статье [Использование службы импорта и экспорта Azure для передачи данных в хранилище BLOB-объектов](storage-import-export-service.md). Можно также копировать данные BLOB-объекта внутри вашей учетной записи хранения или между разными учетными записями хранения.
...
- [Справочник по клиентской библиотеке Java](http://azure.github.io/azure-storage-java/)
- [Использование хранилища BLOB-объектов из Java/Android](storage-java-how-to-use-blob-storage.md)
- [Использование табличного хранилища из Java/Android](storage-java-how-to-use-table-storage.md)
- [Использование хранилища очередей из Java/Android](storage-java-how-to-use-queue-storage.md)
- [Использование табличного хранилища из Java](storage-java-how-to-use-file-storage.md) 
