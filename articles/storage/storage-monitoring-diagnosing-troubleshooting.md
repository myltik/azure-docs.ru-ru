...
Подробнее см. в статье <a href="http://msdn.microsoft.com/library/azure/gg433132.aspx" target="_blank">Инициализация эмулятора хранилища с помощью командной строки</a> в библиотеке MSDN (эмулятор хранения можно инициализировать и в Visual Studio, но для этого также потребуются права администратора).
