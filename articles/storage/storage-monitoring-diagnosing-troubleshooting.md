---
title: Мониторинг, диагностика и устранение неисправностей службы хранилища | Microsoft Docs
...
> [!NOTE]
> Дополнительные сведения об использовании Wireshark см. в [руководстве пользователя Wireshark](http://www.wireshark.org/docs/wsug_html_chunked).
> 
> 
