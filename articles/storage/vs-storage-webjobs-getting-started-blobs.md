<properties 
	...
	description="Начало работы с хранилищем BLOB-объектов в учетной записи хранения Azure, которая была создана с помощью диалогового окна Visual Studio «Добавление подключенных службы» в проекте веб-задания."
	services="storage"
	documentationCenter=""
	authors="patshea123"
	manager="douge"
