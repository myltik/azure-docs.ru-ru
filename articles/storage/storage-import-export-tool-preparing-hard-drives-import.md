...
- **Файлы журнала копирования**, созданные во время копирования службой импорта и экспорта Azure данных между учетной записью хранения и диском. Он находится в целевой учетной записи хранения.
...
Скачайте [последнюю версию WAImportExport.exe](https://www.microsoft.com/download/details.aspx?id=42659). Распакуйте содержимое в каталог на своем компьютере.
...
### <a name="sample-journal-file-jrn-for-session-which-records-the-trail-of-sessions"></a>Пример файла журнала для сеанса (JRN-файл) со сведениями о состоянии сеансов
