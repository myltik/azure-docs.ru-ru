...
-	Это решение не поддерживает изоляцию транзакций. Например, клиент мог считывать таблицы **Current** и **Archive**, когда рабочая роль находилась между **4** и **5** шагами, и заметить несогласованное представление данных. Обратите внимание, что в конечном счете данные будут согласованы.  
...
-	Добавьте тип сущности в начало свойства **RowKey** (или, возможно, свойства **PartitionKey**). Например, **EMPLOYEE\_000123** или **DEPARTMENT\_SALES** в качестве значений **RowKey**.  
