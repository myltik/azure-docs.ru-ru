...
Эта проблема может возникнуть, если изменить имя по умолчанию веб-сайта IIS. Чтобы обойти эту проблему, переименуйте на веб-сайт IIS по умолчанию в "Default Web Site" и повторите попытку установки. Эта проблема будет исправлена в будущем обновлении агента. 
