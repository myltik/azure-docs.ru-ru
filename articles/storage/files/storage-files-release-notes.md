...
|----|----------------------|--------------|------------------|
| Накопительный пакет обновления за март | 2.2.0.0 | 12 марта 2018 г. | Поддерживается (рекомендуемая версия) |
...
| Накопительный пакет обновления за январь | 1.4.0.0 | 8 января 2018 г. | Поддерживается до 8 марта 2018 г.<sup>1</sup> |
| Накопительный пакет обновления за ноябрь | 1.3.0.0 | 30 ноября 2017 г. | Поддерживается до 8 марта 2018 г.<sup>1</sup> |
| Накопительный пакет обновления за октябрь | 1.2.0.0 | 31 октября 2017 г. | Поддерживается до 8 марта 2018 г.<sup>1</sup> |
| Первоначальный выпуск предварительной версии | 1.1.0.0 | 26 сентября 2017 г. | Поддерживается до 8 марта 2018 г.<sup>1</sup> |

\[1\]: выпуски агента службы "Синхронизация файлов Azure" на этапе предварительной версии намеренно не соответствуют политике обновления. Политика обновления будет применяться начиная с первого выпуска агента после выхода общедоступной версии службы "Синхронизация файлов Azure".
