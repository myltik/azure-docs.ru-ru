...
* <a id="why-files-useful"></a>**Чем полезна служба файлов Azure?**  
...
* <a id="tier-options"></a>**Какие уровни хранилища поддерживаются службой файлов Azure?**  
...
* <a id="give-us-feedback"></a>**Очень хотелось бы, чтобы в службу файлов Azure была включена отдельная функция. Это возможно?**  
...
* <a id="afs-region-availability"></a>**В каких регионах поддерживается предварительная версия синхронизации файлов Azure?**  
    На сегодняшний день синхронизация файлов Azure доступна в следующих регионах: западная часть США, Западная Европа, восточная Австралия и Юго-Восточная Азия. Будет также добавлена поддержка других регионов, так как мы заинтересованы в разработке общедоступной версии. Дополнительные сведения см. в разделе [Регионы доступности](storage-sync-files-planning.md#region-availability).
...
* <a id="afs-change-detection"></a>**Если файл был создан непосредственно в файловом ресурсе Azure через SMB или портал, сколько времени займет его синхронизация с серверами в группе синхронизации?**  
...
* <a id="afs-storage-redundancy"></a>**Поддерживает ли служба синхронизации файлов Azure геоизбыточное хранилище?**  
...
* <a id="afs-effective-vfs"></a>**Как определяется *свободное место в томе*, если в нем используется несколько конечных точек сервера?**  
...
* <a id="afs-os-support"></a>**Могу ли я использовать службу синхронизации файлов Azure с Windows Server 2008 R2, Linux или своим запоминающим устройством, подключаемым к сети (NAS)?**  
...
* <a id="data-compliance-policies"></a>**Какие политики соответствия данных поддерживаются службой файлов Azure?**  
...
* <a id="what-are-snaphots"></a>**Что представляют собой моментальные снимки общих файловых ресурсов?**  
...
* <a id="snapshot-perf-impact"></a>**Предусмотрены ли ограничения производительности в отношении использования моментальных снимков общих ресурсов?**  
...
* <a id="encypted-snapshots"></a>**Можно ли создать моментальный снимок общего ресурса зашифрованного общего файлового ресурса?**  
...
* <a id="need-larger-share"></a>**Мне нужен более крупный файловый ресурс, чем сейчас предлагается в службе файлов Azure. Можно ли увеличить размер файлового ресурса Azure?**  
...
* <a id="zip-slow-performance"></a>**При попытке распаковать файлы в службе файлов Azure падает производительность Что делать?**  
...
* <a id="slow-perf-windows-81-2012r2"></a>**Почему после подключения общего файлового ресурса Azure в Windows Server 2012 R2 или Windows 8.1 падает производительность?**  
...
* <a id="nested-shares"></a>**Могу ли я настроить вложенные файловые ресурсы? Другими словами — файловый ресурс в файловом ресурсе?**  
    Нет. Общая папка *является* виртуальным драйвером для подключения, поэтому вложенные общие папки не поддерживаются.

* <a id="ibm-mq"></a>**Как использовать службу файлов Azure с IBM MQ?**  
