...
**Каковы разные способы доступа к файлам в файлы Azure?**  
...
* <a id="what-is-afs"></a>
**Что такое синхронизация файлов Azure?**  
...
**Зачем использовать Azure файловый ресурс и хранилище больших двоичных объектов Azure для данных?**  
...
* <a id="get-started"></a>
**Как начать работу с помощью файлов Azure?**  
...
**Действительно требуется просмотреть определенные компонент, добавленный к файлам Azure. Это возможно?**  
...
**Какие регионы поддерживаются для синхронизации файлов Azure (Предварительная версия)?**  
    В настоящее время синхронизации файлов служб Azure доступен в Восток США, Запад США, Западная Европа, Восточная Австралия и Юго-Восточная Азия. Будет также добавлена поддержка других регионов, так как мы заинтересованы в разработке общедоступной версии. Дополнительные сведения см. в разделе [Регионы доступности](storage-sync-files-planning.md#region-availability).

* <a id="cross-domain-sync"></a>
**Может иметь присоединенных к домену и не присоединенных к домену серверы в группу синхронизации?**  
...
**Я создал файл непосредственно в моем Azure общей папки с помощью SMB или на портале. сколько времени займет его синхронизация с серверами в группе синхронизации?**  
...
**Географически избыточное хранилище поддерживается для синхронизации файлов Azure?**  
...
**Почему не *размер на диске* свойство для сопоставления файла *размер* свойство после использования синхронизации файлов Azure?**  
...
**Как определить, был ли файл многоуровневое хранилище?**  
...
**Как заставить файл или каталог для заноситься в многоуровневое хранилище?**  
...
**Как будет *свободное место на томе* интерпретируется при работе с несколькими конечными точками сервера на томе?**  
...
**Какие файлы или папки, автоматически исключаются синхронизации файлов Azure?**  
...
**Можно использовать файл синхронизации Azure с Windows Server 2008 R2, Linux или устройство хранилище, подключенном к сети (NAS)**  
...
* <a id="ad-support"></a>
**— Проверка подлинности на основе Active Directory и управления доступом, поддерживаемые файлами Azure?**  
...
**Как обеспечить шифрование при хранении my Azure общей папки?**  
...
**Как позволяют осуществлять доступ к определенному файлу с помощью веб-браузера**  
...
**Это можно указать только для чтения или только для записи разрешения для папки общего ресурса?**  
...
**Можно реализовать ограничения IP-адресов для Azure общей папки**  
...
**Какие политики соответствия требованиям данных поддерживает файлы Azure?**  
...
**Нужно ли использовать Azure ExpressRoute для подключения к файлам Azure или для использования синхронизации файлов Azure локально?**  
...
**Как подключить Azure файловый ресурс на локальный компьютер?**  
...
* <a id="backup-share"></a>
**Резервное копирование Azure файл совместное использование?**  
...
**Что такое снимки файлов общей папки**  
...
**Где хранятся Мои папки моментальных снимков**  
...
**Существуют ли производительность с использованием общей папки моментальных снимков?**  
    Моментальные снимки общего ресурса не снижают производительность.

* <a id="snapshot-consistency"></a>
**Папки моментальных снимков, согласованных на уровне приложения?**  
...
**Существуют ограничения на число общей папки моментальных снимков, которые я могу использовать?**  
...
**Можно создать общую папку моментальных снимков отдельных файлов**  
...
**Можно создать общую папку моментальных снимков зашифрованные общей папки**  
...
**Представляют собой снимки Мои папки географически избыточная?**  
...
**Можно просмотреть Мой общей папки моментальных снимков Linux?**  
...
**Можно скопировать папку моментальных снимков другую учетную запись хранения?**  
...
**Можно повысить общую папку моментального снимка к базовой папке**  
...
**Можно ли восстановить данные из моей общей папки моментальных снимков другую учетную запись хранения?**  
...
**Можно ли удалить папку my но удаляет Мои папки моментальных снимков**  
...
**Что происходит с моей общей папки моментальных снимков, при удалении учетной записи хранилища?**  
...
**Сети трафик между Виртуальной машине Azure и счетчиком общую папку файлов Azure как внешнюю полосу пропускания, которая зачисляется подписки?**  
...
**Сколько следует использовать общую стоимость моментальные снимки?**  
...
**Каковы ограничения масштабирования файлов Azure?**  
...
**Требуется увеличить общую папку, чем файлы Azure сейчас предоставляет. Можно ли увеличить размер файлового ресурса Azure?**  
...
**Сколько клиентов могут одновременно доступ к тому же файлу?**   
...
**Мои производительности выполняется медленно, если я распаковки файлов Azure. Что делать?**  
...
**Почему необходимо снижение производительности после ли смонтировать my Azure общей папки на Windows Server 2012 R2 или Windows 8.1?**  
...
**Можно ли использовать мой Azure файловом ресурсе как *файлового ресурса-свидетеля* Мой отказоустойчивый кластер Windows Server?**  
...
* <a id="containers"></a>
**Можно подключить Azure файловый ресурс на экземпляр контейнера Azure**  
...
**Можно настроить общие вложенной папки? Другими словами — файловый ресурс в файловом ресурсе?**  
    Нет. Общая папка *является* виртуальным драйвером для подключения, поэтому вложенные общие папки не поддерживаются.

* <a id="ibm-mq"></a>
**Как использовать файлы Azure с IBM MQ?**  
