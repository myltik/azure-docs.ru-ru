...
> [AZURE.NOTE] Клиентская библиотека хранилища Azure для Xamarin в настоящее время поддерживает следующие типы проектов: "общий собственный", "общий Xamarin.Forms", "Xamarin.Android" и "Xamarin.iOS".
