...
- Учетная запись Azure. Зарегистрироваться для получения учетной записи Azure можно по адресу <http://www.azure.com>.
...
2. На странице **Manage Hudson** нажмите **Управление подключаемыми модулями**.
...
1. На панели мониторинга Hudson щелкните элемент **Manage Hudson** (Управление Hudson).
2. На странице **Manage Hudson** нажмите **Настройка системы**.
