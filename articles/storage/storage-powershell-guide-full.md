...
Дополнительные сведения см. в разделах [Подписанные URL-адреса: общие сведения о модели SAS](storage-dotnet-shared-access-signature-part-1.md) и [Управление анонимным доступом на чтение к контейнерам и большим двоичным объектам](storage-manage-access-to-resources.md).
