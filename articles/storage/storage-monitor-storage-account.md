...
После установки уровней мониторинга и политик хранения можно выбрать, какие из доступных метрик будут отслеживаться на [портале Azure](https://portal.azure.com) и какие будут выводиться на диаграммах метрик. На каждом уровне мониторинга отображается набор метрик по умолчанию. Для добавления метрики или удаления ее из списка метрик можно использовать кнопку **Добавить метрики**.
