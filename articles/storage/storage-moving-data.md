...
Кроме того, мы также предлагаем [библиотеку перемещения данных для службы хранилища Azure](https://www.nuget.org/packages/Microsoft.Azure.Storage.DataMovement). Это библиотека, предназначенная для высокопроизводительного копирования данных в среду Azure и из нее. Чтобы узнать больше, ознакомьтесь с [документацией](https://github.com/Azure/azure-storage-net-data-movement) по нашей библиотеке перемещения данных.
