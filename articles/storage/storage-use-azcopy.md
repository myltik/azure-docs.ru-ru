...
1. Загрузите [последнюю версию AzCopy](http://aka.ms/downloadazcopy).
2. Запустите установку. По умолчанию AzCopy устанавливается в `%ProgramFiles(x86)%\Microsoft SDKs\Azure\AzCopy\AzCopy.exe` (на компьютере под управлением 64-разрядной версии Windows) или `%ProgramFiles%\Microsoft SDKs\Azure\AzCopy\AzCopy.exe` (на компьютере под управлением 32-разрядной версии Windows). Однако путь установки можно изменить в мастере установки.
...
Простой способ опробовать AzCopy — загрузить файл из локальной файловой системы в хранилище BLOB-объектов. В окне консоли выполните следующую команду, заменив имена ресурсов на ваши собственные имена допустимых ресурсов:
	
	AzCopy /Source:C:\myfolder /Dest:https://myaccount.blob.core.windows.net/mycontainer /DestKey:key /Pattern:abc.txt

Обратите внимание, что при копировании одного файла необходимо указать параметр `/Pattern` с именем этого файла. Другие примеры см. в указанных ниже разделах.
...
<table>
  <tr>
    ...
    <th>Применяется к хранилищу файлов (да/нет)</th>
    <th>Применяется к хранилищу таблиц (да/нет)</th>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="auto-style1">Задает подпись общего доступа (SAS) с правами ЧТЕНИЯ и ЗАПИСИ для контейнера назначения (если применяется). Поместите SAS в двойные кавычки, так как подпись может содержать специальные символы командной строки.<br /><br />
        Если ресурс места назначения&#160;представляет собой контейнер BLOB-объекта, общую папку или таблицу, можно либо указать эту опцию перед маркером SAS, либо указать SAS как часть пути контейнера BLOB-объекта места назначения, общей папки или URI таблицы, не указывая этой опции.<br /><br />
  ...
  <tr>
    ...
    <td>Определяет, является ли BLOB-объект места назначения блочным, страничным или расширенным. <br /><br />
	Этот параметр применяется только в случае передачи BLOB-объекта. В противном случае создается сообщение об ошибке. Если в качестве места назначения выступает BLOB-объект и этот параметр не задается, то по умолчанию AzCopy создает блочный BLOB-объект.</td>
    <td>Да</td>
    <td>Нет</td>
    <td>Нет</td>
  </tr>
  ...
  <tr>
    ...
    <td>Выводит сообщения с подробным состоянием в файл журнала.
	<br /><br />По умолчанию файл подробного журнала называется <code>AzCopyVerbose.log</code> в папке <code>%LocalAppData%\Microsoft\Azure\AzCopy</code>. При задании существующего местоположения файла для этого параметра журнал с подробными данными будет добавляться к этому файлу.</td>
    <td>Да</td>
    <td>Да<br /></td>
    <td>Да<br /></td>
  </tr>
  ...
  <tr>
    <td><b>/XN</b></td>
    <td>Исключает более новый исходный ресурс. Ресурс не будет копироваться, если исходный файл был изменен в то же время, что и конечный файл, или позднее.</td>
    <td>Да</td>
    <td>Да<br /></td>
    <td>Нет</td>
  </tr>
  <tr>
    <td><b>/XO</b></td>
    <td>Исключает более старый исходный ресурс. Ресурс не будет копироваться, если исходный файл был изменен в то же время, что и конечный файл, или ранее.</td>
    <td>Да</td>
    <td>Да<br /></td>
    <td>Нет</td>
  </tr>
  ...
  <tr>
    ...
    <td>Передает файлы, содержащие любой из следующих заданных атрибутов.<br /><br />
        Доступные атрибуты:  
        <br /><br />
  ...
  <tr>
    ...
    <td>Исключает файлы с любым из следующих установленных атрибутов.<br /><br />
        Доступные атрибуты:  
        <br /><br />
        R&#160;&#160;&#160;файлы только для чтения  
        <br />
  ...
  <tr>
    ...
    <td>Указывает разделитель, используемый для разделения виртуальных каталогов в имени большого двоичного объекта.<br /><br />
  ...
  <tr>
    ...
    <td>Задает файл описания для операций экспорта и импорта таблицы.
	<br /><br />
  ...
  <tr>
    <td><b>/SyncCopy</b></td>
    <td>Указывает, копируются ли большие двоичные объекты или файлы синхронно между двумя конечными точками службы хранилища Azure. <br /><br />
		...
		<br /><br />
		Вы можете использовать этот параметр для копирования файлов в хранилище больших двоичных объектов и хранилище файлов или из хранилища больших двоичных объектов в хранилище файлов и наоборот.</td>
    <td>Да</td>
    <td>Да<br /></td>
    <td>Нет</td>
  </tr>
  <tr>
    ...
    <td>Задает тип содержимого MIME для целевых больших двоичных объектов или файлов. <br /><br />
		AzCopy по умолчанию задает тип содержимого для BLOB-объекта или файла <code>application/octet-stream</code>. Вы можете задать тип содержимого для всех больших двоичных объектов или файлов, указав значение для этого параметра. 
		<br /><br />
		Если вы задали этот параметр, не указав значение, AzCopy установит тип содержимого для каждого большого двоичного объекта или файла в соответствии с расширением файла.</td>
    <td>Да</td>
    <td>Да<br /></td>
    <td>Нет</td>
  </tr>
    ...
    <td>Указывает формат файла экспортируемых данных таблицы.<br /><br />
...
Обратите внимание, что если указанный виртуальный каталог не существует, AzCopy передает файл, чтобы включить его в виртуальный каталог от своего имени (*например*, `vd/abc.txt` в указанном выше примере).
...
**Исключите большие двоичные объекты, изменен в то же время, что и конечный файл, или позднее.**

	AzCopy /Source:https://myaccount.blob.core.windows.net/mycontainer /Dest:C:\myfolder /SourceKey:key /MT /XN

**Исключите большие двоичные объекты, изменен в то же время, что и конечный файл, или ранее.**
...
## Копирование файлов в хранилище файлов Azure с помощью AzCopy
...
Помимо асинхронного копирования пользователь также может указать параметр `/SyncCopy` для синхронного копирования данных из хранилища файлов в хранилище файлов, из хранилища файлов в хранилище BLOB-объектов и из хранилища BLOB-объектов в хранилище файлов. AzCopy сделает это, скачивая данные источника в локальную память и передавая их в место назначения.
...
## Копирование сущностей в таблицу Azure с помощью AzCopy
...
AzCopy по умолчанию экспортирует сущности таблицы в файлы JSON. С помощью параметра `/PayloadFormat:JSON|CSV` пользователь может указать тип файла экспортируемых данных.
...
|---------|-----------------------------------------------------------------------------------------------------------------|--------|----------|
| [**Версия 5.0.0**](http://xdmrelease.blob.core.windows.net/azcopy-5-0-0/MicrosoftAzureStorageTools.msi) | **Текущая версия выпуска. Включает в себя все функциональные возможности версии 4.2.0. Теперь все функции хранения файлов и таблиц являются общедоступными.** | **Версия 6.0.0** | **05.04.2015**
| [Версия 4.2.0](http://xdmrelease.blob.core.windows.net/azcopy-4-2-0-preview/MicrosoftAzureStorageTools.msi) | Включает в себя весь набор функциональных возможностей версии 3.2.0. Также поддерживает SAS общей папки хранилища файлов, асинхронное копирование хранилища файлов, экспорт сущностей таблицы в файл формата CSV и указание имени файла манифеста при экспорте сущностей таблицы. | ВЕРСИЯ 0.0 | 2015-02-21
| [Версия 3.2.0](http://xdmrelease.blob.core.windows.net/azcopy-3-2-0/MicrosoftAzureStorageTools.msi) | Поддерживает добавление больших двоичных объектов и выбор FIPS-совместимого MD5. | ВЕРСИЯ 0.0 | 2015-02-21
| [V4.1.0](http://xdmrelease.blob.core.windows.net/azcopy-4-1-0-preview/MicrosoftAzureStorageTools.msi) | Включает в себя весь набор функциональных возможностей версии 3.1.0. Она поддерживает синхронное копирование больших двоичных объектов и файлов и позволяет указывать тип содержимого для целевых больших двоичных объектов и файлов | Версия 4.3.0 | 2014-02-14
| [V3.1.0](http://xdmrelease.blob.core.windows.net/azcopy-3-1-0/MicrosoftAzureStorageTools.msi) | Она поддерживает синхронное копирование больших двоичных объектов и позволяет указывать тип содержимого для целевых больших двоичных объектов.| Версия 4.3.0 | 2014-02-14
| [ВЕРСИЯ 4.0.0](http://xdmrelease.blob.core.windows.net/azcopy-4-0-0-preview/MicrosoftAzureStorageTools.msi) | Включает в себя весь набор функциональных возможностей версии 3.0.0. Версия поддерживает возможность копирования файлов в хранилище файлов Azure и импорт файлов из него, а также копирование данных в хранилище таблиц Azure и извлечение данных из него.| Версия 4.2.1 | 2014-02-14
| [ВЕРСИЯ 3.0.0](http://xdmrelease.blob.core.windows.net/azcopy-3-0-0/MicrosoftAzureStorageTools.msi) | Изменен синтаксис командной строки AzCopy: теперь необходимо указывать имя параметра. Изменен внешний вид справки по командной строке. Данная версия поддерживает только копирование данных в BLOB-объекты и копирование данных из них.| Версия 4.2.1 | 2014-02-14
| Версия 2.5.1 | Повышена производительность при использовании /xo и /xn. Исправлены ошибки, возникающие при наличии в имени исходного файла специальных символов, а также появление ошибок в файле журнала из-за неправильного введения команд пользователем в командной строке.| V4.1.0 | 2014-02-14
| V2.5.0 | Улучшена производительность при крупномасштабных сценариях копирования, а также реализовано несколько важных улучшений для повышения удобства использования.| V4.1.0 | 2014-02-14
| V2.4.1 | Поддерживает указание папки назначения в мастере установки.| Версия 4.0.0 | 2014-02-14
| V2.4.0 | Поддерживает отправку и загрузку файлов для хранилища файлов Azure.| Версия 4.0.0 | 2014-02-14
| V2.3.0 | Поддерживает геоизбыточные учетные записи хранения для доступа с правом чтения.| Версия 3.0.3 | 2013-08-15
| V2.2.2 | Обновлена для использования библиотеки клиента хранилища Azure версии 3.0.3.| Версия 3.0.3 | 2013-08-15
| V2.2.1 | Устранение проблем с производительностью при копировании большого количества файлов в пределах одной учетной записи хранения.| Версия 2.1.0 |
| V2.2 | Поддерживает задание разделителя виртуального каталога для имен BLOB-объектов. Поддерживает задание пути файла журнала.| Версия 2.1.0 |
| V2.1 | Предоставляет более 20 параметров для выполнения эффективных операций отправки, загрузки и копирования BLOB-объектов.| Версия 2.0.5 |
