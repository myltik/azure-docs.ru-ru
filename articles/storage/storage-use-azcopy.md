...
Передаваемые моментальные снимки большого двоичного объекта переименовываются в следующем формате: [имя\_большого\_двоичного объекта](snapshot-time)[расширение].
...
Определяет, что ресурс `source` представляет собой большой двоичный объект, доступный в локальной среде разработки, которая запущена в эмуляторе хранилища.

**Применимо к** большим двоичным объектам и таблицам.

### /DestType:"Blob" | "Table"

Определяет, что ресурс `destination` представляет собой большой двоичный объект, доступный в локальной среде разработки, которая запущена в эмуляторе хранилища.
