...
- С [портала управления Azure](https://manage.windowsazure.com/).
...
Чтобы задать разрешения контейнера с помощью портала Azure, выполните следующие действия.
...
4. В диалоговом окне **Изменить метаданные контейнера** выберите нужный уровень разрешений в поле **Доступ**, как показано на следующем снимке.
