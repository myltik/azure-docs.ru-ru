...
Указания о том, как создать приложение Ruby см. в разделе [Создание приложения Ruby в Azure](/develop/ruby/tutorials/web-app-with-linux-vm/).
...
4. Скопируйте нужное значение клавиши доступа.
...
- Репозиторий [пакетов SDK Azure для Ruby](http://github.com/WindowsAzure/azure-sdk-for-ruby) на веб-сайте GitHub
