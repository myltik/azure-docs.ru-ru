...
Эти сведения можно найти в профиле подписки. Если у вас нет копии вашего профиля подписки, его можно загрузить с [сайта подписки](https://manage.windowsazure.com/publishsettings/Index?SchemaVersion=2.0). Ниже приведен пример профиля подписки.
