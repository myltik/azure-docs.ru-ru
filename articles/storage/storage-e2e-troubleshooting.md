...
Чтобы настроить ведение журнала и метрики для вашей учетной записи хранения с помощью [портала Azure](https://portal.azure.com), следуйте инструкциям в разделе [Мониторинг учетной записи хранения](storage-monitor-storage-account.md).
