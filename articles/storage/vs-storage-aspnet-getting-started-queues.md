<properties
	pageTitle="Начало работы с хранилищем очередей Azure и подключенными службами Visual Studio | Microsoft Azure"
	description="Как приступить к работе с хранилищем очередей Azure в проекте ASP.NET в Visual Studio"
	services="storage"
	documentationCenter=""
	authors="patshea123"
	manager="douge"
