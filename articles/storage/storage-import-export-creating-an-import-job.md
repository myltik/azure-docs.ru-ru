---
title: "Создание задания импорта для службы импорта и экспорта Azure | Документация Майкрософт"
description: "Сведения о создании задания импорта для службы импорта и экспорта Microsoft Azure"
author: muralikk
manager: syadav
editor: syadav
services: storage
...
---
# <a name="creating-an-import-job"></a>Создание задания импорта
...
-   подготовка дисков с помощью средства импорта и экспорта Azure;
...
Ниже вкратце описана процедура подготовки диска. Подробные инструкции см. в [справочном руководстве по средству импорта и экспорта Azure](storage-import-export-tool-how-to-v1.md). Средство импорта и экспорта Azure можно скачать [отсюда](http://go.microsoft.com/fwlink/?LinkID=301900).
...
-   копирование данных на один или несколько жестких дисков с помощью средства импорта и экспорта Azure.

 Кроме того, средство импорта и экспорта Azure при подготовке дисков создает файл манифеста для каждого диска. Этот файл манифеста содержит:
...
## <a name="obtaining-your-shipping-location"></a>Получение адреса для отправки
