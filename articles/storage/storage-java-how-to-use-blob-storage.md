---
title: Использование хранилища BLOB-объектов Azure (хранилища объектов) из Java | Microsoft Docs
...
> [!NOTE]
> Пакет SDK доступен разработчикам, использующим хранилище Azure на устройствах Android. Дополнительные сведения см. в разделе [Пакет SDK хранилища Azure для Android][Пакет SDK хранилища Azure для Android].
> 
> 
...
> [!NOTE]
> Существуют также другие способы создания объектов **CloudStorageAccount**. Дополнительную информацию см. в разделе **CloudStorageAccount** [справочника по пакету SDK для клиента службы хранилища Azure].
> 
> 
