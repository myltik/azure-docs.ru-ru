<properties 
	pageTitle="Использование хранилища BLOB-объектов из Java | Microsoft Azure" 
...
Объект CloudQueueClient позволяет ссылаться на объекты контейнеров и BLOB-объектов. Следующий код создает объект **CloudBlobClient**. (Примечание. Есть другие способы создания объектов **CloudStorageAccount**. Дополнительные сведения см. в разделе **CloudStorageAccount** в [справочнике по пакету SDK для клиента хранилища Azure].)
...
## Практическое руководство. Загрузка BLOB-объекта
