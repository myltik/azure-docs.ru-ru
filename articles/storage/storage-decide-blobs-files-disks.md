...
Дополнительные сведения о дисках данных см. в разделах [Сведения о дисках и виртуальных жестких дисках для виртуальных машин Azure под управлением Linux](storage-about-disks-and-vhds-linux.md) и [Подключение диска данных к виртуальной машине Windows, созданной с использованием классической модели развертывания](../virtual-machines/windows/classic/attach-disk.md).
