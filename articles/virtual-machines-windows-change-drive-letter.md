...
Прежде чем начать, потребуется подключить диск данных к виртуальной машине, чтобы хранить файл подкачки Windows (pagefile.sys) во время этой процедуры. См. раздел [Как присоединить диск данных к виртуальной машине], если у вас его нет. Указания о том, как определить, какие диски подключены, см. в подразделе "Управление дисками" раздела [О дисках виртуальных машин в Azure].
