<properties 
   ...
   description="Обзор пользовательского интерфейса Azure Mobile Engagement" 
...
После интеграции пакета [SDK] для Azure Mobile Engagement[Link 5] в приложение и знакомства с основными [понятиями] Azure Mobile Engagement[Link 6]вы можете воспользоваться одним из следующих способов взаимодействия между Azure Mobile Engagement и приложением: через [пользовательский интерфейс] (для обычных пользователей)[Link 1] или с помощью интерфейсов [API] на основе HTTP REST (для разработчиков)[Link 4]. Сведения о пошаговом выполнении стандартных действий см. в [практических руководствах][Link 3]. В случае возникновения проблем обратитесь к [руководствам по поиску и устранению неполадок] Azure Mobile Engagement[Link 2].
