...
8.  Замените метод **refreshTodoItems** следующим кодом:
   ...
   Если требуется перезапустить веб-сервера, повторите действия, описанные в первом разделе.
...
3. На <a href="https://manage.windowsazure.com/">Портале управления</a> щелкните **Мобильные службы**, затем щелкните свою мобильную службу.
...
6. Найдите в файле проекта app.js метод**RefreshTodoItems** и замените строку кода, которая определяет `query`, следующим:
7. 
...
* <a href="/ru-ru/develop/mobile/tutorials/validate-modify-and-augment-data-html">Проверка и изменение данных с помощью скриптов</a>
...
* <a href="/ru-ru/develop/mobile/tutorials/add-paging-to-data-html">Уточнение запросов посредством разбиения по страницам</a>
...
После ознакомления с работой с данными, узнайте, как проверять подлинность пользователей приложения, изучив один из следующих учебников и статью <a href="/ru-ru/develop/mobile/tutorials/get-started-with-users-html">Приступая к работе с проверкой подлинности</a>.
...
[99]: ./media/mobile-services-html-get-started-data/mobile-todoitem-data-browse.png
