<properties pageTitle="Tomcat на виртуальной машине - учебник по Azure" description="Узнайте, как создать виртуальную машину под управлением Windows и настроить ее для работы сервера приложений Apache Tomcat." services="virtual-machines" documentationCenter="java" authors="rmcmurray" manager="wpickett" editor="mollybos"/>
...
## Дальнейшие действия
* Узнайте о других службах, таких как служба хранилища Azure, Service Bus, база данных SQL и т. д., которые можно включить в приложения Java, изучив информацию на странице <http://www.windowsazure.com/ru-ru/develop/java/>.
