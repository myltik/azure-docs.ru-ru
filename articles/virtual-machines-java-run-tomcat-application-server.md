...
2. Дважды щелкните ссылку **Установщик службы Windows 32-разрядной и 64-разрядной версии**. С использованием этого метода Tomcat будет установлен как служба Windows.
...
5. Щелкните **Добавить**.
6. В диалоговом окне **Добавить конечную точку** установите флажок **Добавить автономную конечную точку** и затем нажмите **Далее**.
