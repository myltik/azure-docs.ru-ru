<properties linkid="dev-java-vm-application-server" urlDisplayName="Tomcat на виртуальной машине" pageTitle="Tomcat на виртуальной машине - учебник по Azure" metaKeywords="ВМ Azure, создание ВМ Tomcat, настройка ВМ Tomcat" description="Как создать виртуальную машину Windows и настроить машину для использования сервера приложений Apache Tomcat." metaCanonical="" services="virtual-machines" documentationCenter="Java" title="Как использовать сервер приложений Java на виртуальной машине" authors="waltpo" solutions="" manager="" editor="" />
...
6. В следующем диалоговом окне <strong>Конфигурация виртуальной машины</strong>:
    1. В разделе **Облачная служба** используйте значение по умолчанию **Создать новую облачную службу**.
...
## Дальнейшие действия
* Узнайте о других службах, таких как хранилища Azure, Service Bus, база данных SQL и т. д., которые можно включить в приложения Java, изучив информацию в <http://www.windowsazure.com/ru-ru/develop/java/>.
