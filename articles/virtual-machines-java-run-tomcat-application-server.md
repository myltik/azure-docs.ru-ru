...
На этом этапе ваш веб-сайт Tomcat должен быть видимым из внешнего браузера с помощью URL-адреса формы **http://*ваше\_имя\_DNS*.cloudapp.net**, где ***ваше\_имя\_DNS*** — это имя DNS, которое вы указали при создании виртуальной машины.
