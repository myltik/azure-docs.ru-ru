...
## Дальнейшие действия
* Узнайте о других службах, таких как служба хранилища Azure, Service Bus, база данных SQL и т. д., которые можно включить в приложения Java, изучив информацию в <http://azure.microsoft.com/develop/java/>.
