<properties 
	pageTitle="Практическое руководство. Использование нескольких клиентов на одном внутреннем сервере мобильной службы | Azure Mobile" 
...
Если вместо собственной регистрации клиента используется регистрация шаблона, такое же уведомление можно отправить одним вызовом функции **send** глобального [объекта push](http://msdn.microsoft.com/library/windowsazure/jj554217.aspx), указав в качестве аргумента содержательную часть сообщения шаблона: 
...
>[AZURE.NOTE]Чтобы использовать аутентификацию клиента при едином входе через учетную запись Майкрософт в приложения среды выполнения Windows и Windows Phone Silverlight, необходимо сначала зарегистрировать приложение среды выполнения Windows на панели мониторинга Магазина Windows. Это связано с тем, что после создания регистрации Live Connect для Windows Phone невозможно создать регистрацию для Магазина Windows. Дополнительные сведения о том, как это сделать, см. раздел **Проверка подлинности приложения Магазина Windows с помощью единого входа Live Connect** ([Магазин Windows][Единый вход для Магазина Windows]/[Windows Phone][Единый вход для Windows Phone]).


<!-- URLs -->
[Портал управления Azure]: https://manage.windowsazure.com
[Концентраторы уведомлений Azure]: /develop/net/how-to-guides/service-bus-notification-hubs/
[Единый вход для Магазина Windows]: /develop/mobile/tutorials/single-sign-on-windows-8-dotnet/
[Единый вход для Windows Phone]: /develop/mobile/tutorials/single-sign-on-wp8/
[Учебники и ресурсы]: /develop/mobile/resources/
...
[Приступая к работе с push-уведомлениями Windows dotnet]: /develop/mobile/tutorials/get-started-with-push-dotnet-vs2012/
[Приступая к работе с push-уведомлениями Windows js]: /develop/mobile/tutorials/get-started-with-push-js-vs2012/
[Приступая к работе с push-уведомлениями Windows Phone]: /develop/mobile/tutorials/get-started-with-push-wp8/
[Приступая к работе с push-уведомлениями iOS]: /develop/mobile/tutorials/get-started-with-push-ios/
[Приступая к работе с push-уведомлениями Android]: /develop/mobile/tutorials/get-started-with-push-android/
[Динамическая схема]: http://msdn.microsoft.com/library/windowsazure/jj193175.aspx
[Как использовать клиент .NET для мобильных служб Azure]: documentation/articles/mobile-services-windows-dotnet-how-to-use-client-library/
...
[Новинки для разработчиков приложений для Windows Phone 8]: http://msdn.microsoft.com/library/windows/apps/dn655121(v=vs.105).aspx
