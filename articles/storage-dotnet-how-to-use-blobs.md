...
-   [Практическое руководство. Асинхронное перечисление BLOB-объектов в страницах][Практическое руководство. Асинхронное перечисление BLOB-объектов в страницах]
...
## <a name="list-blobs-async"> </a><span class="short-header">Практическое руководство. Асинхронное перечисление BLOB-объектов в страницах</span>
...
-   Просмотрите дополнительные руководства, чтобы изучить дополнительные возможности хранения данных в Azure.
  ...
  [Практическое руководство. Асинхронное перечисление BLOB-объектов в страницах]: #list-blobs-async
