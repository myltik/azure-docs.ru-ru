...
После создания в облачной службе двух и более экземпляров виртуальных машин с WAF можно использовать [классический портал Azure](https://portal.azure.com), чтобы добавить конечные точки HTTP и HTTPS, которые будут использоваться вашим приложением, как показано на рисунке ниже.
...
Если приложение доступно в нескольких регионах, необходимо сбалансировать нагрузку с помощью [диспетчера трафика Azure](traffic-manager.md). Для этого можно добавить конечную точку на [классическом портале Azure](https://manage.azure.com) с помощью имени облачной службы для вашего WAF в профиле диспетчера трафика, как показано на рисунке ниже.
