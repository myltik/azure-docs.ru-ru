...
6. Нажмите кнопку **ОК**.
	...
	Вы можете увидеть созданное веб-приложение в **обозревателе серверов**.
...
10. На вкладке **Параметры** нажмите кнопку **Далее**.
	...
	В раскрывающемся списке **Конфигурация** можно развертывать отладочное построение для удаленной отладки. В разделе [Дальнейшие действия](#next-steps) содержатся ссылки на руководство, в котором описан удаленный запуск Visual Studio в режиме отладки.
...
* [Как выбрать или создать группу ресурсов](../azure-portal/resource-group-portal.md)
