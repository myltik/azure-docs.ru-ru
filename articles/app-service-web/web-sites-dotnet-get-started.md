...
2. В меню **Файл** выберите пункты **Создать и Проект**.

3. В диалоговом окне **Создание проекта** последовательно выберите пункты **C#, Интернет и Веб-приложение ASP.NET**. При желании вы можете выбрать **Visual Basic**.
...
7. В окне **Действие службы приложений Azure** щелкните **Опубликовать MyExample в этом веб-приложении**.
	...
	Через несколько секунд откроется окно мастера **публикации веб-сайта**.
...
Этот раздел руководства является необязательным. В нем вы измените заголовок **h1** домашней страницы, локально запустите проект на компьютере разработчика, чтобы проверить изменения, а затем развернете его в Azure.
...
2. Щелкните **Просмотреть все и Веб-приложения**, а затем выберите имя вашего веб-приложения.
