...
2. Значение по умолчанию для параметра **Версия Java** — **Отключено**. Выберите целевую версию Java для своего приложения, например 1.7.0_51. После этого убедитесь, что для **Веб-контейнер** установлена версия «Сервер Tomcat».
