---
title: "Развертывание веб-приложения на HTML в Azure за пять минут | Документация Майкрософт"
...
---
# <a name="deploy-your-first-html-web-app-to-azure-in-five-minutes"></a>Развертывание первого веб-приложения на HTML в Azure за пять минут
...
4. Перейдите в рабочий каталог (`CD`) и клонируйте образец HTML-сайта следующим образом:
