...
| [Подключение веб-приложения DocumentDB](./scripts/app-service-cli-app-service-documentdb.md?toc=%2fcli%2fazure%2ftoc.json) | Создает веб-приложение Azure и DocumentDB, а затем добавляет сведения о подключении DocumentDB в параметры приложения. |
