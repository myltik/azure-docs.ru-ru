...
9. В раскрывающемся списке [План службы приложений](../app-service/azure-web-sites-web-hosting-plans-in-depth-overview.md) выберите пункт **Создать новый план службы приложений**.

11. Введите имя для плана службы приложений, например ContosoAdsPlan.

9. В раскрывающемся списке [Группа ресурсов](../resource-group-overview.md) выберите пункт **Создать новую группу ресурсов**.

11. Введите имя для группы ресурсов, например ContosoAdsGroup.
...
1. Введите имя сервера базы данных, например ContosoAdsServer.
...
> **Примечание.** Код, характерный для SDK веб-заданий, см. в разделе [Program.cs и Functions.cs](#programcs).
