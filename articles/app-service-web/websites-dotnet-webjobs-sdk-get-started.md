---
title: Создание веб-задания .NET в службе приложений Azure | Microsoft Docs
...
3. В меню **Файл** выберите **Открыть > Проект/решение**, перейдите к скачанному решению и откройте файл решения.
...
8. В раскрывающемся списке [Группа ресурсов](../resource-group-overview.md) выберите пункт **Создать группу ресурсов**.
...
15. В шаге **Подключение** мастера **веб-публикации** нажмите кнопку **Далее**.
    
    ![Шаге "Подключение"](./media/websites-dotnet-webjobs-sdk-get-started/connstep.png)
16. В шаге **Параметры** снимите флажок **Использовать эту строку подключения в среде выполнения** и нажмите кнопку **Далее**.
...
17. В шаге **Предварительный просмотр** нажмите кнопку **Начать предварительный просмотр**.
    ...
    В окне предварительного просмотра отобразится, что двоичные файлы и файлы конфигурации проекта веб-задания будут скопированы в каталог *app\_data\\jobs\\continuous* веб-приложения.
...
1. В **обозревателе сервера** щелкните правой кнопкой мыши свое веб-приложение в узле **Azure > Служба приложений > {ваша группа ресурсов}**, а затем щелкните **Просмотр параметров**.
...
> [!NOTE]
> Код, связанный с пакетом SDK для веб-заданий, см. в разделах [Program.cs и Functions.cs](#programcs).
> 
> 
...
Дополнительную информацию см. в статье [Масштабирование веб-заданий](websites-webjobs-resources.md#scale).

### Предотвращение завершения работы веб-приложений из-за превышения времени ожидания
