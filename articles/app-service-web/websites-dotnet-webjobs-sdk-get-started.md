...
> **Примечание.** Код, характерный для пакета SDK веб-заданий, см. в разделе [Program.cs и Functions.cs](#programcs).
