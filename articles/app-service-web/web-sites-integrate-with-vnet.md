...
Использовать эту функцию могут только те приложения, которые входят в план службы приложений класса «Стандартный» или «Премиум».  Дополнительные сведения о ценах на планы см. на странице [цен на службы приложений][ASPricing]. 
