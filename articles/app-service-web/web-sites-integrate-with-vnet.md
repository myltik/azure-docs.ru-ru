...
1.	К виртуальной сети можно подключить только те веб-приложения, которые обслуживаются в плане из ценовой категории Standard. Веб-приложения с планами обслуживания Free, Shared и Basic невозможно подключить к виртуальной сети.
