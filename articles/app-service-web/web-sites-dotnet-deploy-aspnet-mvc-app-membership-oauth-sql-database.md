...
> [!NOTE]
> Это обширное руководство. Если вас интересует краткое введение в службу приложений Azure и веб-проекты Visual Studio, см. статью [Развертывание веб-приложения ASP.NET в службе приложений Azure с помощью Visual Studio](app-service-web-get-started-dotnet.md). Сведения об устранении неполадок см. в разделе [Устранение неполадок](#troubleshooting).
> 
...
* Ошибки при развертывании. Ознакомьтесь со статьей, описывающей [базовое развертывание ASP.NET](app-service-web-get-started-dotnet.md). Так как этот сценарий развертывания является более простым, при возникновении такой же проблемы вам будет проще ее изолировать. Например, в некоторых корпоративных средах корпоративный брандмауэр может помешать создавать при веб-развертывании разные типы необходимых подключений к Azure.
