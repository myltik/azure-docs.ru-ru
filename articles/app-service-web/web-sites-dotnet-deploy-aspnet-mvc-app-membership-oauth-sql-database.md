...
>[AZURE.NOTE]Чтобы создать кнопки входа в социальную сеть, как показано на снимке экрана выше, см. запись блога [Кнопки входа в социальные сети для ASP.NET MVC 5](http://www.jerriepelser.com/blog/pretty-social-login-buttons-for-asp-net-mvc-5)
