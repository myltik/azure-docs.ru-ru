...
1. В диалоговом окне **Новый проект ASP.NET** выберите шаблон **MVC**. Убедитесь, что параметру **Проверка подлинности** задано значение **Индивидуальные учетные записи пользователей**. Также должен быть установлен флажок **Размещать в облаке** и выбран пункт **Веб-служба**.
