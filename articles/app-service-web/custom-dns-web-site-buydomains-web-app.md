...
- Возможно, вы удалили пользовательский домен. Проверьте журналы аудита, щелкнув **Параметры** > **Журналы аудита** в главной колонке вашего приложения. 
- Колонка **Пользовательские домены и SSL**, в которой вы пытаетесь найти домен, может принадлежать приложению, созданному в другой подписке Azure. Перейдите в другое приложение в другой подписке и проверьте его колонку **Пользовательские домены и SSL**. В рамках портала вы не можете просматривать пользовательские домены, созданные в другой подписке Azure, и управлять ими. Тем не менее, если щелкнуть элемент **Расширенное управление** в колонке **Управление доменом** нужного домена, вы сможете перейти на веб-сайт поставщика домена, где можно будет [вручную настроить этот пользовательский домен как любой внешний пользовательский домен](web-sites-custom-domain-name.md) для приложений, созданных в другой подписке Azure. 
