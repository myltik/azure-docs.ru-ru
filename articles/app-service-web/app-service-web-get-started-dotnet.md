---
title: "Развертывание первого веб-приложения .NET в Azure за пять минут | Документация Майкрософт"
...
---
# <a name="deploy-your-first-net-web-app-to-azure-in-five-minutes"></a>Развертывание первого веб-приложения .NET в Azure за пять минут
Это руководство поможет вам развернуть простое веб-приложение .NET в [службе приложений Azure](../app-service/app-service-value-prop-what-is.md).
...
## <a name="deploy-an-net-web-app"></a>Развертывание веб-приложения .NET
...
4. Перейдите в рабочий каталог (`CD`) и клонируйте пример приложения.
