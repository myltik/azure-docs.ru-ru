...
![Создание нового плана службы приложений](./media/app-service-web-get-started-dotnet/configure-app-service-plan.png)
...
Повторно развернуть обновление в Azure очень просто. Давайте обновим домашнюю страницу.
