...
Если ваш веб-сайт размещен в среде службы приложений для PowerApps, узнайте, как получить исходящий IP-адрес в разделе [Исходящие сетевые адреса](app-service-app-service-environment-network-architecture-overview.md#outbound-network-addresses).
...
Дополнительные сведения см. в статье [Создание среды службы приложения](app-service-web-how-to-create-an-app-service-environment.md).
...
Подробную документацию по проверке подлинности и авторизации в службе приложений см. в статье [Безопасность службы приложений Azure](../app-service/app-service-security-readme.md). Эта документация также содержит сведения о настройке службы приложений для использования различных процедур входа в систему для идентификации поставщика:
