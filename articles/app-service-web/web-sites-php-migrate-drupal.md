...
Если вы используете FTP, вы найдете имя узла FTP и имя пользователя в колонке веб-приложения на [портале предварительной версии Azure](https://portal.azure.com). Затем воспользуйтесь любым FTP-клиентом для передачи файлов Drupal в папку **/site/wwwroot** удаленного сайта.
