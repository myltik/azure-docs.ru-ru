...
## <a name="a-idoverviewaoverview"></a><a id="overview"></a>Обзор
...
## <a name="a-idscenariosascenarios"></a><a id="scenarios"></a>Сценарии
...
## <a name="a-idcodea-code-samples"></a><a id="code"></a> Примеры кода
...
## <a name="a-idschedulea-scheduling"></a><a id="schedule"></a> Планирование
...
## <a name="a-idworkerroleausing-the-webjobs-sdk-outside-of-webjobs"></a><a id="workerrole"></a>Использование пакета SDK для веб-заданий вне сферы применения веб-заданий
...
## <a name="a-idnostorageadashboard-features"></a><a id="nostorage"></a>Функции панели мониторинга
