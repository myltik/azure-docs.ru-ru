...
4. В результатах поиска выберите **Django**, затем нажмите кнопку **Создать**.
...
<!--Link references-->
[Использование Django и MySQL в Azure с помощью инструментов Python 2.1 для Visual Studio]: web-sites-python-ptvs-django-mysql.md
