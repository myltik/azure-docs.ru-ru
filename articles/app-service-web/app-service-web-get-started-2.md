...
Выполнив инструкции из статьи [Начало работы с веб-приложениями в службе приложений Azure](app-service-web-get-started.md), вы развернули веб-приложение в службу приложений Azure. Эта статья поможет быстро добавить в развернутое приложение некоторые важные функции. Служба приложений обеспечивает возможности корпоративного уровня, с которыми ваши приложения будут соответствовать всем существующим требованиям к безопасности, масштабируемости, производительности, управляемости и т. п.
...
- [Увеличение масштаба](https://en.wikipedia.org/wiki/Scalability#Horizontal_and_vertical_scaling). При масштабировании приложения в службе приложений вы изменяете ценовую категорию плана службы приложений, к которой принадлежит приложение. Масштабирование дает больше ресурсов ЦП, памяти и места на диске. Также вы получите множество дополнительных возможностей, например выделенные виртуальные машины, автоматическое масштабирование, уровень доступности 99,95 %, пользовательские домены и сертификаты, слоты развертывания, резервное копирование и т. д. Чем выше уровень, тем больше функций доступно для приложения.  
