...
Кроме того, служба веб-приложений может полностью задействовать локальные средства, обеспечивая подключение к вашим внутренним ресурсам, например к хранилищу данных или среде SharePoint. Как уже сказано в разделе [Решение высшего уровня], можно также использовать гибридные подключения и подключения к виртуальным сетям, чтобы подключаться к локальным службам и инфраструктуре.
