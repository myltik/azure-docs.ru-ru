...
Настраивая диспетчер трафика при создании нового веб-приложения путем клонирования, вы можете подключить оба веб-приложения к новому или к уже существующему профилю диспетчера трафика, учитывая, что поддерживается только ARM-версия диспетчера трафика.
