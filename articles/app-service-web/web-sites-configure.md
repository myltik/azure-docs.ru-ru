...
**Веб-сокеты**. Установите значение **Включено**, чтобы разрешить использование протокола WebSocket. Например, если ваш веб-сайт использует [ASP.NET SignalR] или [socket.io].
...
- Настройка непрерывного развертывания. См. статью [Использование Git для развертывания веб-приложений в службе приложений Azure].
- Слоты развертывания. См. статью [Развертывание в промежуточную среду для веб-приложений в службе приложений Azure].
...
Дополнительные сведения см. в статье [Мониторинг состояния конечных точек Интернета].
...
[Развертывание в промежуточную среду для веб-приложений в службе приложений Azure]: ./web-sites-staged-publishing.md
[Включение протокола HTTPS для приложения в службе приложений Azure]: ./web-sites-configure-ssl-certificate.md
[Мониторинг состояния конечных точек Интернета]: http://go.microsoft.com/fwLink/?LinkID=279906
...
[Использование Git для развертывания веб-приложений в службе приложений Azure]: ./web-sites-publish-source-control.md
