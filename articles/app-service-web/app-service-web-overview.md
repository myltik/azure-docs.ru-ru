...
- **Гибридные подключения** — доступ к локальным данным с помощью [гибридных подключений](../integration-hybrid-connection-overview.md) и [виртуальной сети](../app-service-web/web-sites-integrate-with-vnet.md).
