...
6. В диалоговом окне **Новый проект ASP.NET** убедитесь, что флажок **Host in the Cloud** (Разместить в облаке) установлен, и нажмите кнопку **ОК**.
...
2. Замените содержимое файла *Views\\Shared\_Layout.cshtml* кодом, приведенным ниже:
...
6. Щелкните **Опубликовать**. После завершения развертывания в браузере открывается главная страница приложения.
