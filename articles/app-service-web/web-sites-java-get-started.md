...
4. В поле поиска введите имя сервера приложений Java, например **Apache Tomcat** или **Jetty**, и затем нажмите клавишу ВВОД.
...
12. Выберите нужный **веб-контейнер**.
