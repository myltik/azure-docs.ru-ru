...
4. Выберите **группу ресурсов** или создайте новую.
    ...
    Дополнительные сведения о группах ресурсов Azure см. в статье [Управление ресурсами Azure через портал].
...
[Управление ресурсами Azure через портал Azure]: ../azure-portal/resource-group-portal.md
