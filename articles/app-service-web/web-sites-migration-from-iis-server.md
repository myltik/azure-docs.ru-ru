...
10. В следующем окне можно изменить настройки по умолчанию:
    ...
    * настроить глобальные параметры и параметров на уровне веб-сайта.
    ...
    > [!NOTE]
    > Флаг **Включить Azure Active Directory** в пользовательских настройках позволяет выполнить интеграцию веб-сайта Azure в [Azure Active Directory](../active-directory/active-directory-whatis.md) (**каталог по умолчанию**). Дополнительные сведения о синхронизации Azure Active Directory с локальным каталогом Active Directory см. в разделе [Интеграция каталогов](http://msdn.microsoft.com/library/jj573653).
    > 
    > 
