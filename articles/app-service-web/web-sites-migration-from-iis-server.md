...
>[AZURE.IMPORTANT] Срок поддержки Windows Server 2003 истекает 14 июля 2015 года. Если веб-сайты на IIS-сервере хранятся в Windows Server 2003, можно поддерживать их работу на основе веб-приложений Azure, безопасного, экономичного и эффективного решения, при этом помощник по миграции веб-приложений позволит автоматизировать процесс переноса необходимых данных.
...
13.	Выберите учетную запись клиента, подписку Azure и регион для использования веб-приложений и баз данных, перенесенных на Azure, а затем нажмите кнопку **Начать миграцию**. Выбрать веб-сайты для переноса можно позже.
