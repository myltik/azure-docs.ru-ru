...
5. В колонке **Слоты развертывания** щелкните слот развертывания, чтобы открыть колонку для этого слота с набором метрик и конфигурацией как у любого другого веб-приложения. <strong><i>имя_вашего_веб приложения</i>-<i>имя_слота_развертывания</i></strong> будет отображаться в верхней части колонки, напоминая о том, что отображается слот развертывания.
...
- Указания по установке, настройке и использованию интерфейса командной строки Azure, включая сведения о подключении Azure CLI к подписке Azure, см. в статье [Установка и настройка интерфейса командной строки Azure](../xplat-cli.md).

-  Чтобы получить список команд, доступных для службы приложений Azure в Azure CLI, вызовите `azure site -h`.
