...
Сведения о планах служб приложений см. в разделах [Что такое план размещения службы приложений?](../app-service/web-sites-web-hosting-plan-overview.md) и [Подробный обзор планов размещения службы приложений Azure](../app-service/azure-web-sites-web-hosting-plans-in-depth-overview.md). Сведения о ценах и функциях отдельных планов службы приложений см. в разделе [Сведения о ценах службы приложений](/pricing/details/web-sites/).
