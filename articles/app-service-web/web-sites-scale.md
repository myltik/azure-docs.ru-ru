...
5. В параметрах щелкните **Увеличить масштаб**, выберите в раскрывающемся списке пункт *число экземпляров, выбранное вручную*, передвиньте вправо ползунок **Экземпляры**, чтобы увеличить число экземпляров, и нажмите кнопку **Сохранить** в командной строке. Параметр размера экземпляра недоступен в режиме **Shared**. Дополнительные сведения о размерах экземпляров см. в разделе [цен на службу приложений][vmsizes].
