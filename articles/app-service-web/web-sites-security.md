...
Кроме того, импортированные учетные данные также необходимо защитить. Например, как **Azure PowerShell**, так и **интерфейс командной строки Azure (Azure CLI)** сохраняют импортированные данные в вашем **домашнем каталоге** (*~* в системах Linux или OS X и */users/yourusername* в системах Windows). Для дополнительной защиты можно **зашифровать** эти расположения с помощью средств шифрования, имеющихся в используемой операционной системе.
...
**Параметры приложений** и **строки подключения** можно настраивать с помощью [портала Azure](http://go.microsoft.com/fwlink/?LinkId=529715) или служебных программ, например PowerShell или интерфейса командной строки Azure.
