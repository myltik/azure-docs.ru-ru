...
**Параметры приложений** и **строки подключения** можно настраивать с помощью [портала предварительной версии Azure](http://portal.azure.com) или служебных программ, например PowerShell или интерфейса командной строки Azure.
...
3. Из колонки **Обзор** выберите **Веб-приложения**.
4. Из колонки **Веб-приложения** выберите нужное веб-приложение.
5. В колонке веб-приложений выберите **Все параметры**.
6. Из колонки **Параметры** выберите **Свойства**.
