...
2. В нижней части панели навигации щелкните **СОЗДАТЬ** и выберите **Данные + Хранение** > **База данных SQL**.
...
6. В колонке **Параметры брандмауэра** добавьте правило брандмауэра, указав для параметров **НАЧАЛЬНЫЙ IP-АДРЕС** и **КОНЕЧНЫЙ IP-АДРЕС** открытый IP-адрес компьютера разработки. Щелкните **Сохранить**.
   
   Это позволит вам подключаться к серверу базы данных со своего компьютера разработчика.
7. В колонке базы данных щелкните **Свойства**, затем щелкните **Показать строки подключения базы данных**.
