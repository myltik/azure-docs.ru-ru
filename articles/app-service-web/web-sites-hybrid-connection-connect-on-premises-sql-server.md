...
> [AZURE.NOTE]Если вы уже создали веб-приложение на портале Azure, которое хотите использовать при прохождении этого учебника, можно пропустить этот шаг и продолжить с раздела [Создание гибридного подключения и службы BizTalk](#CreateHC).
