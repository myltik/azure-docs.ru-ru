...
# Настройка взаимной проверки подлинности TLS для веб-приложения
...
## Настройка веб-приложения для проверки подлинности сертификата клиента ##
...
## Доступ к сертификату клиента из веб-приложения ##
После настройки веб-приложения для использования проверки подлинности сертификата клиента в приложении будет доступен сертификат клиента через значение заголовка запроса X-ARR-ClientCert, закодированное в base64. Приложение может создать сертификат из этого значения и использовать его для проверки подлинности и авторизации.

## Дополнительные рекомендации для проверки сертификата ##
