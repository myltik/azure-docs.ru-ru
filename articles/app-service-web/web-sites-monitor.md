...
1. Откройте страницу управления **Панель мониторинга** веб-приложения на [портале Azure](https://manage.windowsazure.com).
...
Диагностика включается на вкладке **Настройка** веб-приложения на [портале Azure](https://manage.windowsazure.com). Существует два типа диагностики: **диагностика приложений** и **диагностика сайтов**.
