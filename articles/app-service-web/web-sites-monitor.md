...
> [AZURE.NOTE] Если команда **azure** не установлена, информацию об установке и настройке см. в статье об [использовании интерфейса командной строки Azure](../virtual-machines/virtual-machines-command-line-tools.md).
