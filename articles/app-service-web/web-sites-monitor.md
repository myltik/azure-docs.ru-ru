...
1. На страницах управления веб-приложений на [портале Azure](http://go.microsoft.com/fwlink/?LinkId=529715) выберите вкладку **Монитор**, чтобы просмотреть страницу управления **Монитор**. По умолчанию на диаграмме на странице **Монитор** отображаются те же показатели, что и на диаграмме на странице **Панель мониторинга**.
...
>
> Если оболочка Azure PowerShell не установлена или не настроена для использования подписки Azure, см. раздел [Как использовать Azure PowerShell](/develop/nodejs/how-to-guides/powershell-cmdlets/).
...
> - **Node.js**: [Как выполнять отладку приложения Node.js для веб-сайтов Azure](/develop/nodejs/how-to-guides/Debug-Website/)
>
...
Файлы журнала можно загрузить с помощью FTP, Azure PowerShell или интерфейса командной строки Azure.
...
> [AZURE.NOTE]Если команда **azure** не установлена, сведения об установке и настройке см. в статье [Использование интерфейса командной строки Azure](../virtual-machines-command-line-tools.md).
