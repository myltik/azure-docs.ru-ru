...
## <a name="a-idingressa-how-to-add-entities-to-a-table"></a><a id="ingress"></a> Как добавить сущность в таблицу
...
## <a name="a-idmonitora-real-time-monitoring"></a><a id="monitor"></a> Мониторинг в реальном времени
...
## <a name="a-idmultiplea-how-to-read-multiple-entities-from-a-table"></a><a id="multiple"></a> Как выполнять чтение нескольких сущностей из таблицы
...
### <a name="a-idreadonea-how-to-read-a-single-entity-from-a-table"></a><a id="readone"></a> Как выполнять чтение одной сущности из таблицы
...
## <a name="a-idstorageapia-how-to-use-the-net-storage-api-directly-to-work-with-a-table"></a><a id="storageapi"></a> Как использовать API хранилища .NET непосредственно для работы с таблицей
...
## <a name="a-idqueuesarelated-topics-covered-by-the-queues-how-to-article"></a><a id="queues"></a>Связанные разделы, которые описаны в практическом руководстве по работе с очередями
