<properties
	...
	description="Узнайте, как создать новое веб-приложение Azure для блога WordPress с помощью портала предварительной версии Azure."
...
В этом учебнике показано, как найти приложение в магазине Azure и установить его в веб-приложение службы приложений. В качестве примера в этом учебнике используется сайт блога WordPress, но для многих других приложений магазина применяется такой же процесс.
...
3. Выполните поиск по запросу **WordPress**, а затем щелкните приложение **WordPress**.
...
7. После завершения создания веб-приложения перейдите на портале к группе ресурсов, в которой было создано приложение, и вы увидите веб-приложение и базу данных.
...
* Информацию об изменениях, связанных с заменой старого портала новым, см. в статье [Справочник по навигации на предварительной версии портала](http://go.microsoft.com/fwlink/?LinkId=529715).
