...
Если у вас нет веб-приложения, его можно создать на [портале Azure](https://portal.azure.com). В левом нижнем углу нажмите кнопку «СОЗДАТЬ», а затем щелкните **Интернет + мобильные устройства** > **Веб-приложение**.
