...
Замените `<vm-dns-name>` на DNS-имя виртуальной машины, где выполняется база данных MongoDB, созданная на шаге [Создание виртуальной машины и установка MongoDB][Создание виртуальной машины и установка MongoDB] в данном учебнике. Чтобы найти DNS-имя своей виртуальной машины, перейдите на портал Azure, выберите **Виртуальные машины** и **DNS-имя**.
