...
* Компоненту резервного копирования и восстановления требуется учетная запись хранения Azure и контейнер, принадлежащие к той же подписке, что и веб-приложение, резервную копию которого вы собираетесь создать. Если у вас еще нет учетной записи хранения, вы можете создать ее, щелкнув элемент **Учетная запись хранения** в колонке **Резервные копии** на [портале Azure](https://portal.azure.com/) и выбрав **учетную запись хранения** и **контейнер** из колонки **Место назначения**. Дополнительные сведения об учетных записях хранения Azure см. в [ссылках](#moreaboutstorage) в конце этой статьи.
