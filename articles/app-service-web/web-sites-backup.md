...
5. В разделе **Включенные базы данных** выберите базы данных, подключенные к веб-приложению (SQL Server или MySQL), резервную копию которого вы хотите создать. Чтобы база данных появилась в списке, ее строка подключения должна присутствовать в разделе **Строки подключения** колонки **Параметры веб-приложения** на этом портале.
