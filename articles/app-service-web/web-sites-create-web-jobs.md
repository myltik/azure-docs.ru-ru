...
Этот метод можно использовать для веб-приложений, работающих в режиме Стандартный или Премиум. При его использовании в приложении необходимо включить параметр **Всегда включено**.
...
- Каждый час (т. е. когда количество минут — 0): `* 0 * * * *` 
- Каждый час с 9:00 до 17:00: `* 0 9-17 * * *` 
- Каждый день в 09:30: `* 30 9 * * *`
- Каждый рабочий день в 09:30: `* 30 9 * * 1-5`
