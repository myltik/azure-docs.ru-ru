...
В данной статье показано, как развернуть веб-задания с помощью [портала Azure](https://portal.azure.com). Информацию о развертывании с помощью Visual Studio или процесса непрерывной доставки см. в разделе [Развертывание веб-заданий Azure в веб-приложениях](websites-dotnet-deploy-webjobs.md).
...
Этот метод можно использовать для веб-приложений, работающих в режиме "Базовый", "Стандартный" или "Премиум". При его использовании в приложении необходимо включить параметр **Всегда включено**.
