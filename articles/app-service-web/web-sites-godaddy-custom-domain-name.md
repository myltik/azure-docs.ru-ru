...
6. Выберите **CNAME** в качестве типа записи, укажите для параметра **Host** значение **awverify**, а для параметра **Points to** значение **awverify.&lt;имя\_вашего\_веб\_приложения&gt;.azurewebsites.net**.

	> [AZURE.NOTE]Запись CNAME позволяет Azure проверить, что именно вы являетесь владельцем домена, описанного в записи A или первой записи CNAME. После сопоставления домена с веб-приложением на портале Azurepreview можно удалить запись **awverify**.
