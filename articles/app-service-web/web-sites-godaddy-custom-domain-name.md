...
1. Выполните вход на GoDaddy.com с использованием своей учетной записи и выберите **Моя учетная запись**, а затем — **Управление доменами**. Выберите в раскрывающемся меню доменное имя, которое вы хотите использовать для своего веб-приложения Azure, и откройте **Управление DNS**.
