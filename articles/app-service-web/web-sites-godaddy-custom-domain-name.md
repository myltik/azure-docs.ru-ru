...
6. Выберите **TXT** в качестве типа записи, укажите для параметра **Узел** значение **@**, а для параметра **Указывает на** значение **&lt;имя_вашего_веб_приложения&gt;.azurewebsites.net**.
