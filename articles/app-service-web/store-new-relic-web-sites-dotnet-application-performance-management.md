 ...
 * [Установка агента .NET в веб-приложениях Azure](https://docs.newrelic.com/docs/agents/net-agent/azure-installation/azure-preview-portal#install-new-relic-azure-webapps): процедуры установки агента .NET New Relic. 
