...
5. При появлении запроса введите желаемое имя пользователя и пароль для доступа к базе данных.
   ...
   > [!TIP]
   > Узнайте, как сценарий *&lt;repository\_root>*\\ARMTemplates\\Deploy.ps1 создает ресурсы с уникальными идентификаторами. Тот же подход можно использовать для создания клонов одного и того же развертывания, не беспокоясь о конфликтующих именах ресурсов.
   > 
   > 
