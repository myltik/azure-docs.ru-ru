...
---
# <a name="create-a-web-app-in-an-app-service-environment"></a>Создание веб-приложения в среде служб приложений
...
> [!NOTE]
> Если вы хотите научиться создавать веб-приложения, но не хотите делать это в среде службы приложений, ознакомьтесь со статьей [Создание веб-приложения .NET](web-sites-dotnet-get-started.md) или одним из связанных учебников, описывающих другие языки и платформы.
> 
> 
...
3. Выберите или создайте группу ресурсов.
    ...
    *Группы ресурсов* позволяют управлять ресурсами Azure как единым целым. Кроме того, они могут быть полезны при настройке правил *контроля доступа на основе ролей* (RBAC) для приложений. Дополнительные сведения см. в статье [Общие сведения о диспетчере ресурсов Azure][ResourceGroups]. 
...
## <a name="a-namecreateplana-create-an-app-service-plan"></a><a name="createplan"></a> Создание плана службы приложений
