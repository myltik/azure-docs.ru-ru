---
title: Создание веб-приложения в среде служб приложений
...
> [!NOTE]
> Если хотите научиться создавать веб-приложения, но не хотите делать это в среде службы приложений, см. статью [Создание веб-приложения .NET](web-sites-dotnet-get-started.md) или один из связанных учебников, описывающих другие языки и платформы.
> 
> 
...
5. Присвойте веб-приложению имя и нажмите кнопку **Создать**.
    ...
    Если ваша среда ASE использует внешний виртуальный IP-адрес, то URL-адресом приложения в ASE является [*имя\_сайта*].[*имя\_среды\_службы\_приложений*].p.azurewebsites.net, а не [*имя\_сайта*].azurewebsites.net.
   
    Если ваша среда ASE использует внутренний виртуальный IP-адрес, то URL-адресом приложения в ASE является [*имя\_сайта*].[*указанный\_при\_создании\_ASE\_поддомен*]. После выбора плана службы приложений во время создания ASE вы увидите, что поддомен в разделе **Имя** изменился.
