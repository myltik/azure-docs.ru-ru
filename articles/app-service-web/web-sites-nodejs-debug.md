...
* [Метод развертывания](web-sites-deploy). При использовании Git как метода развертывания будет создан одноименный каталог. Он будет содержать сведения, связанные с развертываниями.
...
* LogFiles
	...
	* [Метод развертывания](web-sites-deploy). При использовании метода развертывания, например Git, будет создан одноименный каталог со сведениями, связанными с развертываниями.
...
Сведения по работе с модулями Azure см. в разделе [Использование модулей Node.js с приложениями Azure](../nodejs-use-node-modules-azure-apps).
