...
* LogFiles
	...
	* [Метод развертывания]. При использовании метода развертывания, например Git, будет создан одноименный каталог со сведениями, связанными с развертываниями.
...
[Использование средств командной строки Azure]: ../xplat-cli.md
