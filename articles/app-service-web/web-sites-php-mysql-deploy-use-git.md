...
> [AZURE.NOTE]Для этого на портале Azure следует выполнить действия, которые описаны выше в конце раздела "Создание веб-приложения и настройка публикации через Git".
