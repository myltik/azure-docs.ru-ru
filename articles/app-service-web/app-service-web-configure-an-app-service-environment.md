...
- Сейчас поддерживаются только виртуальные сети с адресным пространством RFC1918 (т. е. частными адресами).
...
Существует три способа управления количеством серверов в пулах ресурсов.
- Операция масштабирования в главной колонке ASE, которая расположена вверху.
