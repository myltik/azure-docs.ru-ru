---
title: "Настройка среды службы приложений | Документация Майкрософт"
...
---
# <a name="configuring-an-app-service-environment"></a>Настройка среды службы приложений
...
При настройке правил автомасштабирования необходимо учитывать требуемое время на подготовку. Дополнительные сведения об автомасштабировании в средах ASE см. в [этой статье][ASEAutoscale].
