<properties
	...
	description="Узнайте, как прогнозируемым образом с помощью шаблонов групп ресурсов JSON и скриптов PowerShell развернуть сложное приложение в Azure как единое целое."
...
В этом учебнике показано, как прогнозируемым образом с помощью шаблонов групп ресурсов JSON и скриптов PowerShell развернуть сложное приложение в Azure как единое целое.
...
В DevOps повторяемость и предсказуемость являются ключевыми факторами для любого успешного развертывания крупномасштабных сложных приложений. В этом учебнике рассматривалось развертывание приложения в Azure как отдельной группы ресурсов с помощью шаблона диспетчера ресурсов Azure. Надеемся, что вы смогли узнать все, что необходимо для преобразования сложного приложения в Azure в шаблон, и сможете предсказуемо развертывать его в Azure.
