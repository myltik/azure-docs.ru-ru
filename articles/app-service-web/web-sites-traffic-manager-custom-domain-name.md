...
> [AZURE.NOTE] Кроме того, если запись уже используется и вам нужно заблаговременно привязать к ней свое приложение, создайте запись типа TXT для **awverify.contoso.com** с **contoso.trafficmanager.net**.
