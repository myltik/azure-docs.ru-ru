...
<p><li>Легко [перейти с мобильных служб на мобильные приложения](../app-service-mobile/app-service-mobile-migrating-from-mobile-services.md). Поскольку мобильные приложения находятся на стадии предварительной версии, пока не рекомендуется использовать их для выполнения рабочих приложений.</p>
