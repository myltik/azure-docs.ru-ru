...
Несмотря на то что приведенные в этой статье действия дают возможность использовать портал Azure для создания веб-приложения, можно также применять [интерфейс командной строки Azure](../xplat-cli.md), позволяющий выполнять те же самые операции.
