...
> [AZURE.NOTE]Для работы с этим учебником необходимо использовать учетную запись Microsoft Azure. Если у вас нет учетной записи, можно [активировать преимущества для подписчиков MSDN](/ja-jp/pricing/member-offers/msdn-benefits-details/?WT.mc_id=A261C142F) или [подписаться на бесплатную пробную версию](/ja-jp/pricing/free-trial/?WT.mc_id=A261C142F).
>
...
5. Выберите или создайте **план службы приложений/расположение**.
...
7. Щелкните **Веб-приложения > {ваше новое веб-приложение}**.

	![](./media/web-sites-nodejs-develop-deploy-mac/gotowebapp.png)

8. В колонке **Веб-приложение** щелкните элемент **Развертывание**.

	![][deployment-part]

9. В колонке **Непрерывное развертывание** щелкните **Выбрать источник**

14. Щелкните **Локальный репозиторий Git**, а затем нажмите кнопку **ОК**.

	![][setup-git-publishing]

11. Настройте учетные данные развертывания, если это еще не сделано.
...
11. В колонке веб-приложения щелкните **Параметры**, а затем **Свойства**.
...
2. С помощью текстового редактора создайте новый файл с именем **server.js** в каталоге *helloworld*.
...
1. В командной строке переключитесь на каталог **helloworld** и введите следующую команду для инициализации локального репозитория Git.
...
2. В командной строке переключитесь на каталог **helloworld** и выполните следующие команды:
...
В колонке **Веб-приложение** можно щелкнуть элементы **Параметры > Непрерывное развертывание**, чтобы просмотреть историю развертывания в колонке **Развертывания**. Если необходимо выполнить откат к более раннему развертыванию, можно выбрать его, а затем щелкнуть элемент **Развернуть повторно** в колонке **Сведения о развертывании**.

## Дальнейшие действия

Вы развернули приложение Node.js в веб-приложение в службе приложений Azure. Дополнительные сведения о том, как веб-приложения службы приложений запускают приложения Node.js, см. в разделе [Веб-приложения службы приложений Azure: Node.js](http://blogs.msdn.com/b/silverlining/archive/2012/06/14/windows-azure-websites-node-js.aspx) и [Указание версии Node.js в приложении Azure](../nodejs-specify-node-version-azure-apps.md).
...
В этой статье используется портал Azure для создания веб-приложения. Для выполнения тех же операций можно также использовать [интерфейс командной строки Azure](../xplat-cli-install.md) или [Azure PowerShell](../install-configure-powershell.md).
