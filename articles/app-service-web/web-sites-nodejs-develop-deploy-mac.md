...
В этом учебнике показано, как создать приложение [Node][nodejs.org] и развернуть его в [веб-приложениях службы приложений Azure](http://go.microsoft.com/fwlink/?LinkId=529714) с помощью [Git]. Инструкции, приведенные в этом учебнике, применимы к любой операционной системе, на которой может работать Node.
...
3. Щелкните **Интернет + мобильные устройства**, а затем — **Веб-приложение**.
...
7. После изменения состояния параметра **Выполняется** портал будет автоматически открыт в колонке вашего веб-приложения. Можно также получить доступ к этой колонке, нажав **Обзор**.
...
9. Щелкните **Выбор источника**, а затем выберите **Локальный репозиторий Git** и нажмите кнопку **OK**.
...
5. Чтобы просмотреть приложение, нажмите кнопку **Обзор** в разделе **Веб-приложение** на портале Azure.
...
При возникновении проблем с приложением после его развертывания в Azure информацию о диагностике проблемы можно найти в статье [Отладка приложения Node.js в службе приложений Azure](web-sites-nodejs-debug.md).
