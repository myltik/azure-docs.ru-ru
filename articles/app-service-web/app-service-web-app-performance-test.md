...
*	Вам потребуется учетная запись [Visual Studio Online (VSO)][WhatIsVSO] для хранения журнала тестирования производительности. Создайте новую учетную запись после настройки теста производительности или воспользуйтесь существующей при наличии. [Что еще можно сделать с учетной записью Visual Studio Online?](#VSOAccount)
...
0.	Выполните вход на [портал предварительной версии Azure][AzurePortal]. Чтобы воспользоваться своей учетной записью Visual Studio Online, войдите как владелец учетной записи.
...
0.	Теперь необходимо привязать учетную запись [Visual Studio Online (VSO)][WhatIsVSO], в которой будет храниться журнал тестирования производительности.

	Если у вас уже есть учетная запись VSO, выберите ее. Если учетной записи нет, создайте ее.

	![Выберите существующую учетную запись VSO или создайте новую][ExistingNewVSOAccount]
...
Ответ. После выхода общедоступной предварительной версии каждая учетная запись Visual Studio Online ежемесячно будет получать 20 000 бесплатных человекоминут, которые можно расходовать на виртуальных пользователей (единицы VUM). Единицы VUM — это количество виртуальных пользователей, умноженное на количество минут в тесте. Если вам нужно больше времени, вы можете купить больше минут и платить только за их фактическое использование.
