...
> [!NOTE]
> При внесении изменений в приложение можно выполнить повторную публикацию непосредственно в VSCode с помощью встроенных функций Git. Для этого выберите элемент **Фиксировать все**, а затем — **Отправить**. Команда **Отправить** находится в раскрывающемся меню рядом с кнопками **Фиксировать все** и **Обновить**.
> 
> 
