...
- **Расширение IntelliSense**: предложение удаленных метаданных
	...
	Теперь средства HDInsight для Visual Studio поддерживают получение удаленных метаданных при редактировании сценария Hive. Например, вы можете ввести текст *ВЫБРАТЬ* ИЗ**, чтобы отобразились все имена таблиц. Кроме того, после указания таблицы будут показаны имена столбцов.
