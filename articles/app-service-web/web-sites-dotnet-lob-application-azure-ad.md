...
public class WorkItemsController : Controller
{
    ...
    ...
}</pre>Поскольку нас интересует сопоставление ролей в интерфейсе портала Azure, достаточно просто убедиться, что каждое действие авторизует соответствующую роль.
