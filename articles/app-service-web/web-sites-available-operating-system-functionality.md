...
В данной статье описаны общие базовые функции операционной системы, доступные для всех приложений, работающих на базе веб-приложений [службы приложений Azure](http://go.microsoft.com/fwlink/?LinkId=529714). Данные функциональные возможности включают в себя доступ к файлам, сети и реестру, а также диагностику и журналы событий.

<a id="tiers"></a>
## Уровни обслуживания плана службы приложений
Веб-приложения запускают приложения клиента в мультитенантной среде размещения. Веб-приложения, развернутые на уровнях обслуживания **Free** и **Shared** , выполняются в рабочих процессах на общих виртуальных машинах, а веб-приложения, развернутые на уровнях **Standard** и **Premium**, выполняются на виртуальных машинах, которые выделены специально для веб-приложений, связанных с отдельным заказчиком.
