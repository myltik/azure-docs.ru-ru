...
> [!NOTE]
> Для работы с этим учебником необходимо использовать учетную запись Microsoft Azure. Если у вас нет учетной записи, можно [активировать преимущества для подписчиков Visual Studio][активация] или [подписаться на бесплатную пробную версию][бесплатная пробная версия].
> 
...
[активация]: https://azure.microsoft.com/pricing/member-offers/msdn-benefits-details/
