---
title: Создание веб-приложения из Azure Marketplace | Microsoft Docs
...
6. Щелкните элемент **База данных** и укажите в колонке **Новая база данных MySQL** необходимые значения для настройки базы данных MySQL.
...
5. На странице **приветствия** WordPress введите сведения о конфигурации, которые требуются WordPress, после чего нажмите кнопку **Установить WordPress**.
