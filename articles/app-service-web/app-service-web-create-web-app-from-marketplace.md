...
* найти шаблон приложения в Azure Marketplace;
* создать веб-приложение в службе приложений Azure на основе шаблона;
* настроить параметры службы приложений Azure для нового веб-приложения и базы данных.
...
![Пример панели мониторинга веб-приложения WordPress][WordPressDashboard]
...
1. Отобразится колонка параметров WordPress, в которой необходимо выполнить следующие шаги:
...
1. Откроется страница панели мониторинга сайта, в которой отображаются предоставленные сведения.
	...
	![Просмотрите панель мониторинга WordPress][WordPressDashboard]
