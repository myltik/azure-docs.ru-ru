...
> [AZURE.NOTE]В этой статье рассматривается использование [предварительной версии портала Azure](http://go.microsoft.com/fwlink/?LinkId=529715), Azure PowerShell и интерфейса командной строки Azure (Azure CLI) для работы с журналами диагностики. Дополнительные сведения о работе с журналами диагностики с использованием Visual Studio см. в статье [Устранение неполадок Azure в Visual Studio](web-sites-dotnet-troubleshoot-visual-studio.md).
