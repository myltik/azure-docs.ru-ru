...
> [AZURE.NOTE]В этой статье рассматривается использование [предварительной версии портала Azure](http://go.microsoft.com/fwlink/?LinkId=529715), Azure PowerShell и интерфейса командной строки Azure (Azure CLI) для работы с журналами диагностики. Дополнительные сведения о работе с журналами диагностики с использованием Visual Studio см. в статье [Устранение неполадок Azure в Visual Studio](troubleshoot-web-sites-in-visual-studio.md).
...
Во время выполнения эти журналы доступны для устранения неполадок. Дополнительную информацию см. в разделе [Устранение неполадок веб-приложений Azure в Visual Studio](../troubleshoot-web-sites-in-visual-studio.md).
...
Чтобы включить диагностику на [портале предварительной версии Azure](https://portal.azure.com), в колонке своего веб-приложения щелкните **Параметры > Журналы диагностики**.

<!-- todo:cleanup dogfood addresses in screenshot -->
![Часть журналов](./media/web-sites-enable-diagnostic-log/logspart.png)

После включения **диагностики приложений** выберите параметр **Уровень**. Этот параметр отвечает за фильтрацию данных, собираемых в виде **информации**, **предупреждений** или **сведений об ошибке**. Можно выбрать вариант **подробно**, чтобы записать в журнал все сведения, созданные приложением.
