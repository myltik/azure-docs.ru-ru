...
4. На [портале Azure](http://portal.azure.com/) перейдите к новому ресурсу Application Insights и откройте **Поиск**. Вы увидите данные журнала, а также запросы, сведения об использовании и другую телеметрию. Получение некоторых данных телеметрии может занять несколько минут: щелкните "Обновить". [Подробнее](../application-insights/app-insights-diagnostic-search.md)
