...
## <a name="a-namewhatisdiagaweb-server-diagnostics-and-application-diagnostics"></a><a name="whatisdiag"></a>Диагностика веб-сервера и приложений
...
## <a name="a-nameenablediagahow-to-enable-diagnostics"></a><a name="enablediag"></a>Практическое руководство. Включение диагностики
...
## <a name="a-namedownloada-how-to-download-logs"></a><a name="download"></a> Практическое руководство. Загрузка журналов
...
> [!NOTE]
> Если интерфейс командной строки Azure (Azure CLI) не установлен или не настроен для использования подписки Azure, ознакомьтесь с разделом [Установка Azure CLI](../xplat-cli-install.md).
>
>
...
## <a name="a-namestreamlogsa-how-to-stream-logs"></a><a name="streamlogs"></a> Практическое руководство. Потоковая передача журналов
...
> [!NOTE]
> Если интерфейс командной строки Azure не установлен или не настроен для использования подписки Azure, ознакомьтесь с разделом [Установка Azure CLI](../xplat-cli-install.md).
>
>

## <a name="a-nameunderstandlogsa-how-to-understand-diagnostics-logs"></a><a name="understandlogs"></a> Практическое руководство. Интерпретация журналов диагностики
