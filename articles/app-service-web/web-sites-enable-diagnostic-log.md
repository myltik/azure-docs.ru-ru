...
> [AZURE.NOTE] Вы также можете включить диагностику из PowerShell Azure с помощью командлета **Set-AzureWebsite**. Если Azure PowerShell не установлена или не настроена для использования подписки Azure, см. раздел [Использование Azure PowerShell](/develop/nodejs/how-to-guides/powershell-cmdlets/).
...
> [AZURE.NOTE] Если Azure PowerShell не установлена или не настроена для использования подписки Azure, см. раздел [Использование Azure PowerShell](/develop/nodejs/how-to-guides/powershell-cmdlets/).
...
> [AZURE.NOTE] Если интерфейс командной строки Azure (Azure CLI) не установлен или не настроен для использования подписки Azure, см. статью [Установка Azure CLI](../xplat-cli-install.md).
...
> [AZURE.NOTE] Если интерфейс командной строки Azure не установлен или не настроен для использования подписки Azure, см. статью [Установка Azure CLI](../xplat-cli-install.md).
