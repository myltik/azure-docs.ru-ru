<properties 
	pageTitle="Использование службы электронной почты SendGrid (.NET) — Azure" 
...
<h2><a name="whatis"></a><span  class="short-header">Что такое служба электронной почты SendGrid?</span></h2>
...
<h2><a name="usefilters"></a><span  class="short-header">Практическое руководство. Использование приложений для включения нижних колонтитулов, отслеживания и аналитики</span></h2>
