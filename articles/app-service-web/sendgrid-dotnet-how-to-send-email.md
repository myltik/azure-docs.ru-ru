...
и поддерживают .NET Standard 1.3. Здесь описываются сценарии создания электронного сообщения, его отправки, добавления вложений и включения различных параметров электронной почты и отслеживания. Дополнительные сведения о SendGrid и отправке электронной почты см. в разделе [Дальнейшие действия][Next steps].
...
1. Создайте **новый проект** и выберите **Шаблон**.
