...
## Предварительные требования
 ...
 - [Образцы VSIX инструментов Python 2.2 для Visual Studio]
...
[Образцы VSIX инструментов Python 2.2 для Visual Studio]: http://go.microsoft.com/fwlink/?LinkId=624025
