<properties
	pageTitle="Развертывание веб-приложения с использованием MSDeploy, имени узла и SSL-сертификата"
