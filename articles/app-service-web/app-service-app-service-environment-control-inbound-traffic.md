...
## <a name="network-ports-used-in-an-app-service-environment"></a>Сетевые порты, используемые в среде службы приложений
...
Подробные сведения о принципах работы групп безопасности сети см. [здесь][NetworkSecurityGroups].  Ниже приведены основные сведения о группах сетевой безопасности. Особое внимание уделено настройке и применению группы сетевой безопасности к подсети, которая содержит среду службы приложений.
