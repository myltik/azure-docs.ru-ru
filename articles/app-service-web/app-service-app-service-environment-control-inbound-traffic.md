...
- 990: канал управления для FTP. Этот порт можно благополучно заблокировать, если не используется FTPS. В ASE с внутренним балансировщиком нагрузки этот порт может быть привязан к адресу балансировщика нагрузки ASE.
