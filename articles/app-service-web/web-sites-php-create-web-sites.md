...
## Обзор
В этой статье будет показано, как создать веб-приложение PHP в [службе приложений Azure] с использованием [портала предварительной версии Azure](https://portal.azure.com), [интерфейса командной строки Azure][Azure CLI] или [командлетов Azure PowerShell][powershell-cmdlets].

В целом, создание веб-приложения на PHP ничем не отличается от создания *любого* веб-приложения в службе приложений Azure. По умолчанию поддержка PHP включена для всех веб-приложений. Сведения о настройке PHP (или подключении собственной настраиваемой среды выполнения PHP) см. в статье [Настройка PHP в веб-приложениях службы приложений Azure].
...
- **Быстрое создание** — см. статью [Практическое руководство. Создание веб-приложения с помощью портала предварительной версии Azure](../web-sites-create-deploy.md#createawebsiteportal)
...
1. Установите интерфейс командной строки Azure согласно инструкциям в статье [Установка интерфейса командной строки Azure](../xplat-cli.md#install).

1. Загрузите и импортируйте свой файл настроек публикации, следуя инструкциям в статье [Загрузка и импорт параметров публикации](../xplat-cli.md#configure).
...
1. Установите командлеты Azure PowerShell, следуя инструкциям в статье [Приступая к работе с Azure PowerShell](/develop/php/how-to-guides/powershell-cmdlets/#GetStarted).

1. Загрузите и импортируйте свой файл настроек публикации, следуя инструкциям в статье [Практическое руководство. Импорт параметров публикации](/develop/php/how-to-guides/powershell-cmdlets/#ImportPubSettings).
