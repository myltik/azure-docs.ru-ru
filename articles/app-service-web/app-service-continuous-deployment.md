...
## <a name="a-nameoverviewaenable-continuous-deployment"></a><a name="overview"></a>Включение непрерывного развертывания
...
## <a name="a-namevssolutionacontinuous-deployment-of-a-visual-studio-solution"></a><a name="VSsolution"></a>Непрерывное развертывание решения Visual Studio
...
## <a name="a-namedisablecdadisable-continuous-deployment"></a><a name="disableCD"></a>Отключение непрерывного развертывания
...
[Средства командной строки Azure для Mac и Linux]: ../xplat-cli-install.md
...
[началу работы с VSTS]: https://www.visualstudio.com/get-started/overview-of-get-started-tasks-vs (Приступая к работе с VSTS)
