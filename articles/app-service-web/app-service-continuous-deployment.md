---
title: Непрерывное развертывание в службе приложений Azure | Microsoft Docs
...
2. В колонке приложения на [портале Azure] выберите **Параметры > Источник развертывания**. Щелкните **Выбор источника** и выберите, например, источник **GitHub**.
   ...
   > [!NOTE]
   > Чтобы настроить учетную запись VSTS для развертывания службы приложений, см. этот [учебник](https://github.com/projectkudu/kudu/wiki/Setting-up-a-VSTS-account-so-it-can-deploy-to-a-Web-App).
   > 
   > 
