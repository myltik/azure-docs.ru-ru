...
- **Кэш роли** был обновлен для использования **Пакета SDK хранилища Microsoft Azure ** версии 4.3. До этого момента для **кэша роли** использовался пакет SDK хранилища Azure версии 1.7.
	...
	Клиентам, использующим пакет SDK Azure версии 2.5 (или ниже), следует выполнить обновление до версии 2.6 и перейти на новую версию пакета SDK хранилища Azure. Обратите внимание, что версия 2011-08-18 хранилища Azure будет удалена 9 декабря 2015 г. Для получения дополнительных сведений см. [это объявление](http://azure.microsoft.com/blog/2014/08/04/microsoft-azure-storage-service-version-removal/).

	Дополнительные сведения см. в разделе [Кэш роли для кэша Azure](https://msdn.microsoft.com/library/azure/dn386103.aspx).
