...
## <a name="a-nameftpadeploy-via-ftp-by-copying-files-to-azure-manually"></a><a name="ftp"></a>Развертывание через FTP путем копирования файлов в Azure вручную
...
### <a name="a-namehowtoftpahow-to-deploy-by-copying-files-to-azure-manually"></a><a name="howtoftp"></a>Пошаговая инструкция по развертыванию путем копирования файлов в Azure вручную
