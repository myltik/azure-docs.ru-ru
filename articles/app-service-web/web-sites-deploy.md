...
* [Непрерывная доставка с помощью Visual Studio Online](#vso)
...
##<a name="vso"></a>Непрерывная доставка с помощью Visual Studio Online
...
##<a name="dropbox"></a>Автоматизация развертывания из общего банка данных
...
##<a name="ftp"></a>Копирование файлов с помощью средств и сценариев FTP
