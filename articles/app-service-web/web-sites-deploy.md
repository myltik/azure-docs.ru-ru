...
[Octopus Deploy](http://en.wikipedia.org/wiki/Octopus_Deploy) можно использовать с веб-приложениями службы приложений. Дополнительные сведения см. в статье [Развертывание веб-приложений ASP.NET на веб-сайтах Azure](https://octopusdeploy.com/blog/deploy-aspnet-applications-to-azure-websites).
...
С помощью командной строки на машинах Windows, Mac или Linux можно выполнить развертывание с помощью FTP. В этом случае можно также вызвать API-интерфейс управления Azure REST, используя интерфейс командной строки Azure.

Для получения дополнительных сведений см. следующий ресурс:

* [Средства командной строки Azure](/downloads/#cmd-line-tools). Страница портала на сайте Azure.com с информацией о программе командной строки.
