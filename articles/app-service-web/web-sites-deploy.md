...
В этой статье представлен краткий обзор вариантов развертывания собственного контента в [веб-приложениях службы приложений](http://go.microsoft.com/fwlink/?LinkId=529714).
...
Сведения о развертывании из облачных систем управления источниками см. в последующих разделах этой статьи.
...
Сведения о развертывании из локальных систем управления источниками см. в последующих разделах этой статьи.

* [Team Foundation Server (TFS)](#tfs)
* [Локальные репозитории Git или Mercurial](#onpremises)

Вы также можете автоматизирование с помощью инструментов командной строки. Сведения о развертывании с помощью инструментов командной строки см. в последующих разделах этой статьи.

* [MSBuild](#msbuild)
* [Инструменты и сценарии FTP](#ftp)
...
Иногда удобнее выполнять развертывание из интегрированной среды разработки (IDE). Сведения о развертывании с помощью IDE см. в последующих разделах этой статьи.
...
##<a name="ftp"></a>Инструменты и сценарии FTP
