...
Установка любых MSI-файлов по выбору пользователя||X|X|X|Service Fabric позволяет разместить любой исполняемый файл как [гостевой исполняемый файл](../service-fabric/service-fabric-deploy-existing-app.md). Также любое приложение можно установить на виртуальных машинах.
