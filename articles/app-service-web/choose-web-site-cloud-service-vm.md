...
## <a name="a-namefeaturesafeature-comparison"></a><a name="features"></a>Сравнение возможностей
...
## <a name="a-namescenariosascenarios-and-recommendations"></a><a name="scenarios"></a>Сценарии и рекомендации
...
### <a name="a-idcorpa-i-need-a-reliable-way-to-host-my-corporate-website-that-scales-well-and-offers-global-reach"></a><a id="corp"></a> Требуется надежный способ размещения корпоративного веб-сайта с возможностями масштабирования и с широким всемирным охватом.
...
### <a name="a-idiis6a-i-have-an-iis6-application-running-on-windows-server-2003"></a><a id="iis6"></a> Имеется приложение IIS6, работающее в Windows Server 2003.
...
### <a name="a-idsmallbusinessaim-a-small-business-owner-and-i-need-an-inexpensive-way-to-host-my-site-but-with-future-growth-in-mind"></a><a id="smallbusiness"></a>Владельцу малого бизнеса требуется недорогое размещение сайта с возможностями расширения.
...
### <a name="a-iddesignera-im-a-web-or-graphic-designer-and-i-want-to-design-and-build-websites-for-my-customers"></a><a id="designer"></a> Веб-дизайнер или графический дизайнер планирует создавать веб-сайты для клиентов.
...
### <a name="a-idmultitieraim-migrating-my-multi-tier-application-with-a-web-front-end-to-the-cloud"></a><a id="multitier"></a>Выполняется миграция многоуровневого приложения с веб-интерфейсом в облако.
...
### <a name="a-idcustomamy-application-depends-on-highly-customized-windows-or-linux-environments-and-i-want-to-move-it-to-the-cloud"></a><a id="custom"></a>Приложение зависит от гибко настраиваемой среды Windows или Linux, и требуется перенести его в облако.
...
### <a name="a-idossamy-site-uses-open-source-software-and-i-want-to-host-it-in-azure"></a><a id="oss"></a>Веб-сайт использует программное обеспечение с открытым исходным кодом, и его требуется разместить в Azure.
...
### <a name="a-idlobai-have-a-line-of-business-application-that-needs-to-connect-to-the-corporate-network"></a><a id="lob"></a>Имеется бизнес-приложение, которому необходимо подключение к корпоративной сети.
...
### <a name="a-idmobileai-want-to-host-a-rest-api-or-web-service-for-mobile-clients"></a><a id="mobile"></a>Требуется разместить REST API или веб-службу для мобильных клиентов.
