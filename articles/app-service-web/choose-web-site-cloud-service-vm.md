---
title: Сравнение службы приложений Azure, виртуальных машин, Service Fabric и облачных служб | Microsoft Docs
...
| Сетевая изоляция с помощью [виртуальной сети Azure](/services/virtual-network/) |X |X |X |X |См. также раздел [Интеграция виртуальной сети веб-сайтов Azure](/blog/2014/09/15/azure-websites-virtual-network-integration/). |
...
| Установка любых MSI-файлов по выбору пользователя | |X |X |X |Service Fabric позволяет разместить любой исполняемый файл как [гостевой исполняемый файл](../service-fabric/service-fabric-deploy-existing-app.md). Также на виртуальных машинах можно установить любое приложение. |
...
* Осуществлять интеграцию с другими службами Azure, такими как [база данных SQL][sqldatabase], [Service Bus][servicebus] и [служба хранилища][служба хранилища], или партнерскими предложениями от [Магазина Azure][azurestore], такими как MySQL и MongoDB.
...
[веб-заданий]: http://go.microsoft.com/fwlink/?linkid=390226&clcid=0x409
