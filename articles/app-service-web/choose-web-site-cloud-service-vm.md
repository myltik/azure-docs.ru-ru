<properties
	pageTitle="Сравнение службы приложений Azure, виртуальных машин, Service Fabric и облачных служб | Microsoft Azure"
...
Azure предоставляет несколько способов размещения веб-сайтов: [служба приложений Azure][], [виртуальные машины][], [Service Fabric][] и [облачные службы][]. Данная статья поможет вам понять имеющиеся возможности и сделать правильный выбор веб-приложения.
