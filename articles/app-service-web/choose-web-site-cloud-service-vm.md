<properties
	pageTitle="Сравнение службы приложений, облачных служб, виртуальных машин Azure и Service Fabric"
	description="Узнайте, когда для размещения веб-приложений следует использовать службу приложений Azure, облачные службы, виртуальные машины и Service Fabric."
...
# Сравнение службы приложений, облачных служб, виртуальных машин Azure и Service Fabric

## Обзор

Azure предоставляет несколько способов размещения веб-сайтов: [служба приложений Azure][], [облачные службы][], [виртуальные машины][] и [Service Fabric][]. Данная статья поможет вам понять имеющиеся возможности и сделать правильный выбор веб-приложения.
...
Поддержка ASP.NET, классической ASP, Node.js, PHP, Python|X|X|X|X|Service Fabric поддерживает создание веб-интерфейса на основе [ASP.NET 5](../service-fabric/service-fabric-add-a-web-frontend.md). Также можно развернуть приложение любого типа (Node.js, Java, и т. д.) в качестве [гостевого исполняемого файла](../service-fabric/service-fabric-deploy-existing-app.md).
