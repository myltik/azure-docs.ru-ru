---
title: Отладка в Eclipse веб-приложения Java, размещенного в Azure | Microsoft Docs
...
2. Настройте время ожидания для удаленной отладки.
   ...
   3. Задайте для параметров **Debugger timeout (ms)** (Время ожидания отладчика (мс)) и **Launch timeout (ms)** (Время ожидания запуска (мс)) значение `120000`.
       ...
       ![][02]
   4. Нажмите кнопку **OK**, чтобы закрыть диалоговое окно **Параметры**.
3. В представлении обозревателя проектов Eclipse щелкните правой кнопкой мыши динамический веб-проект, который вы развернули в Azure. В контекстном меню выберите **Azure**, затем щелкните **Веб-приложение Azure**.
