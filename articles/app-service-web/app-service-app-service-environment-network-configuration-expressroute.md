...
**Примечание.** Среду службы приложений невозможно создать в виртуальной сети v2. В настоящее время среды службы приложений поддерживаются только в классических виртуальных сетях версии 1, которые используют адресное пространство RFC1918 (т. е. частные адреса).
