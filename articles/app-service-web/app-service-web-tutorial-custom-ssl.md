...
Управлением привязками SSL для веб-приложения можно автоматизировать с помощью сценариев, воспользовавшись [Azure CLI](/cli/azure/install-azure-cli) или [Azure PowerShell](/powershell/azureps-cmdlets-docs/).
