...
1. В **обозревателе серверов** разверните узлы **Azure**, **Служба приложений**, группу ресурсов, в которой расположено ваше веб-приложение, а затем разверните узел веб-приложения.
...
* Вы можете вручную присоединить отладчик к любому процессу, а не только к процессу веб-приложения (w3wp.exe). Дополнительные сведения о том, как использовать режим отладки в Visual Studio, см. в разделе [Отладка в Visual Studio](http://msdn.microsoft.com/ru-ru/library/vstudio/sc65sadd.aspx).
...
Если вас интересует отладка облачной службы Azure, а не веб-приложения, ознакомьтесь с разделом [Отладка облачных служб](http://msdn.microsoft.com/ru-ru/library/windowsazure/ee405479.aspx).
