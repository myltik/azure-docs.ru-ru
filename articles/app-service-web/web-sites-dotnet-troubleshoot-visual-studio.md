...
1. В **обозревателе серверов** разверните узлы **Azure**, **Служба приложений**, затем группу ресурсов, в которой расположено ваше веб-приложение, а затем разверните узел веб-приложения.
