...
5. В **Обозревателе серверов** щелкните правой кнопкой мыши веб-приложение и выберите пункт **Подключить отладчик**.
...
3. В колонке [Портал Azure](https://portal.azure.com) **Параметры** вашего веб-приложения щелкните **Учетные данные развертывания**, а затем введите новые имя пользователя и пароль.
