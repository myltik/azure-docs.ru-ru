...
Для дополнительной записи TXT применяется соглашение, в соответствии с которым &lt;*поддомен*>.&lt;*корневой\_домен*> сопоставляется с адресом &lt;*поддомен*>.azurewebsites.net. Настройте запись TXT следующим образом.
