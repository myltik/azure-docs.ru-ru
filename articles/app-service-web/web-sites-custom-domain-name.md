...
7.  Когда Azure завершит настройку нового имени личного домена, перейдите по нему в браузере. Теперь ваше приложение должно быть запущено, а имя личного домена
