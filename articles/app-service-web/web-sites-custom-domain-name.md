...
> [!NOTE] 
> Вы всегда можете просто [купить имя личного домена непосредственно в Azure](custom-dns-web-site-buydomains-web-app.md).
>
>

Существуют три основных этапа сопоставления личного домена с приложением.
...
## <a name="migrate-an-active-domain-name"></a>Перенос активного доменного имени

Если доменное имя, которое необходимо сопоставить, уже используется существующим веб-сайтом, и вы хотите избежать простоя, изучите раздел [Перенос активного личного домена в службу приложений Azure](app-service-custom-domain-name-migrate.md).
