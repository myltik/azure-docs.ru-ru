...
Чтобы приступить к использованию шаблона приложения логики, перейдите в Marketplace и выберите "Приложения логики".  Выберите один из шаблонов приложения логики из проверенного списка.
...
После выбора одного из шаблонов выполните развертывание, как при создании собственного приложения логики.  См. раздел [Создание приложения логики](app-service-logic-create-a-logic-app.md.md).
