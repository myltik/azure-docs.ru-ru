...
- Перенесите базу данных, использовав [экспорт и импорт](./howto-migrate-using-export-and-import.md) или [дамп и восстановление](./howto-migrate-using-dump-and-restore.md).
- Технический обзор см. в статье [What is Azure Database for PostgreSQL?](overview.md) (Обзор базы данных Azure для PostgreSQL)
