...
## <a name="postgresql-version-956"></a>PostgreSQL версии 9.5.6
Сведения об улучшениях и исправлениях в PostgreSQL 9.5.6 см. в [документации по PostgreSQL](https://www.postgresql.org/docs/9.6/static/release-9-5-6.html).
