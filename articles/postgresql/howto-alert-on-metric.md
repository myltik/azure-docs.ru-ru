---
title: "Настройка оповещений на основе метрик в базе данных Azure для PostgreSQL на портале Azure | Документация Майкрософт"
...
4. Откроется страница **Add rule** (Добавление правила), как показано ниже.  Заполните необходимые сведения:
   ...
   | Подписки | В этом поле предварительно указывается подписка, в которой размещена база данных Azure для PostgreSQL. |
   ...
   | Пороговое значение | Пороговое значение для метрики, например 85 (в процентах). |
