...
* Если вы не знакомы с Apache Storm, вам следует сначала ознакомиться со статьей [Обзор Storm HDInsight](hdinsight-storm-overview.md).
