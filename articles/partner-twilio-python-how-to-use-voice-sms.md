...
Twilio представляет собой службу с повременной оплатой. Стартовые платежи отсутствуют, а учетную запись можно закрыть в любое время. Дополнительные сведения см. на [странице с ценами на Twilio][twilio_pricing].
...
## <a name="a-idcreateappacreate-a-php-application"></a><a id="create_app"></a>Создание приложения PHP
...
1. Скачайте библиотеку Twilio для PHP из Github ([https://github.com/twilio/twilio-php][twilio_php]) и добавьте каталог **Services** для приложения.
...
* **Примечание.** Чтобы устранить ошибки проверки SSL-сертификатов, см. страницу [http://readthedocs.org/docs/twilio-php/en/latest/usage/rest.html][ssl_validation]
...
Дополнительные сведения об использовании Twilio в Azure с PHP см. на [этой странице][howto_phonecall_php].
