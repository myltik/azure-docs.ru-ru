<properties urlDisplayName="Validate and Modify Data" pageTitle="Пользовательские серверные скрипты для проверки и изменения данных (Магазин Windows) | Центр мобильных разработок" metaKeywords="" description="Узнайте, как использовать серверные сценарии для проверки, изменения и улучшения данных для приложения магазина Windows с помощью мобильных служб Azure." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="Validate and modify data in Mobile Services by using server scripts" authors="glenga" solutions="" manager="dwrede" editor="" />
