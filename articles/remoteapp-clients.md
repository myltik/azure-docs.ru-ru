...
<properties
    ...
    description="Узнайте, какие клиенты поддерживаются службой RemoteApp, а также как получить доступ к своим приложениям."
    services="remoteapp"
...
Одним из преимуществ службы RemoteApp является возможность доступа к опубликованным приложениям с любого устройства. Более того, вы можете начать работу на одном устройстве, а затем без проблем продолжить ее на другом. Чтобы приступить к работе, необходимо загрузить на устройство соответствующий клиент и войти в службу.
