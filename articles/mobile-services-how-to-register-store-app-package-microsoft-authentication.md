...
>[AZURE.NOTE]Visual Studio 2013 позволяет легко регистрировать пакет приложения для Магазина Windows в мобильных службах. Дополнительные сведения см. в статье <a href="http://go.microsoft.com/fwlink/p/?LinkId=309101">Быстрое начало: добавление push-уведомлений в мобильную службу</a> в Центре разработчиков Windows.
