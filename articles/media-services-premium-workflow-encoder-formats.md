...
[Входные форматы и кодеки рабочего процесса Premium обработчика мультимедиа](#input_formats)

[Выходные форматы и кодеки рабочего процесса Premium обработчика мультимедиа](#output_formats)

**Рабочий процесс Premium обработчика мультимедиа** поддерживает скрытые субтитры, описанные [здесь](#closed_captioning) . 


##<a id="input_formats"></a>Входные форматы и кодеки рабочего процесса Premium обработчика мультимедиа
...
##<a id="output_format"></a>Выходные форматы и кодеки рабочего процесса Premium обработчика мультимедиа
...
При приеме **рабочий процесс Premium обработчика мультимедиа** поддерживает:
