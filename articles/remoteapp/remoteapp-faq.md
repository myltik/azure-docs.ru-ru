...
- **Каковы ограничения службы?** Подробные сведения о параметрах по умолчанию и ограничениях службы Azure RemoteApp см. в разделе [Подписка Azure, границы, квоты и ограничения службы](azure-subscription-service-limits.md). Сообщите нам, если у вас есть дополнительные вопросы.
...
- **Для гибридной коллекции необходима виртуальная сеть. Можно ли использовать имеющуюся виртуальную сеть?** Можно, если это виртуальная сеть Azure. Дополнительные сведения см. в разделе "Шаг 1. Настройка виртуальной сети", описанном в [инструкциях по гибридной коллекции](remoteapp-create-hybrid-deployment.md).
