...
- **Каковы ограничения службы?** Мы недавно добавили новый раздел, описывающий все [ограничения службы и значения умолчанию](remoteapp-servicelimits.md). Сообщите нам, если у вас есть дополнительные вопросы.
- **Сколько должно быть пользователей?** Минимум 20 пользователей. Еще раз для ясности: МИНИМУМ 20. Счет будет выставляться за 20 пользователей. Ознакомьтесь с другими [ограничениями пользователей и значениями по умолчанию](remoteapp-servicelimits.md) здесь.
...
- **Для гибридной коллекции необходима виртуальная сеть. Можно ли использовать имеющуюся виртуальную сеть?** Можно, если это виртуальная сеть Azure. Дополнительные сведения см. в пункте «Шаг 1. Настройка виртуальной сети», описанном в [инструкциях по гибридной коллекции](remoteapp-create-hybrid-deployment.md).
