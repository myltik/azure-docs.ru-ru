<properties 
	pageTitle="Создание настраиваемого образа шаблона для службы RemoteApp" 
...
- создать учетную запись пользователя в Active Directory для использования в качестве учетной записи службы RemoteApp. ограничить разрешения для этой учетной записи, чтобы она могла только присоединять машины к домену. Дополнительные сведения см. в [статье о настройке Azure Active Directory для RemoteApp](remoteapp-ad.md).
...
1. Установите Windows Server 2012 R2.
	1. Создайте новую виртуальную машину. Используйте Мастер новой виртуальной машины в диспетчере Hyper-V или клиент Hyper-V. 
		...
		2. На странице «Параметры установки» выберите **Install an operating system from a boot CD/DVD_ROM** (Установить операционную систему с загрузочного CD/DVD_ROM), а затем выберите местоположение установочного носителя Windows Server 2012 R2.
