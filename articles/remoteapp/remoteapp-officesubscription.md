...
# Как использовать подписку Office 365 с удаленным приложением Azure RemoteApp
...
## Могу ли я использовать подписку Office 365 для запуска приложений Office в удаленном приложении Azure RemoteApp?
...
Вы можете использовать подписку Office 365 профессиональный плюс для совместного использования Office 2013 и Office 2016 (после выпуска). Azure RemoteApp не поддерживает более ранние версии Office.
...
Чтобы развернуть Office 365 профессиональный плюс в коллекции, проще всего [воспользоваться одним из образов из коллекции Azure](remoteapp-image-on-azurevm.md), включенных в подписку Azure RemoteApp. Выберите образ **узла сеансов удаленных рабочих столов Windows Server с предустановленным предложением Office 365 профессиональный плюс**. Затем установите на этот образ все приложения, которые вам нужны. Все готово.
