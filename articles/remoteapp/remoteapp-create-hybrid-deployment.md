...
Сначала создайте [виртуальную сеть](../virtual-network/virtual-networks-create-vnet-arm-pportal.md). Это можно сделать на вкладке **Сеть** на портале управления Azure. Виртуальную сеть необходимо подключить к развернутой системе Active Directory, синхронизированной с вашим клиентом Azure Active Directory.
