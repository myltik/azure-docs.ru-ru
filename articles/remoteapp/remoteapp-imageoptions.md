<properties 
    pageTitle="Создание образа RemoteApp"
    description="Способы и варианты создания образов для среды RemoteApp" 
    services="remoteapp" 
    solutions="" 
	documentationCenter="" 
    authors="lizap" 
