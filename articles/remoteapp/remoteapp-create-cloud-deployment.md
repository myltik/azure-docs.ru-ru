...
**Примечание** *Данный раздел находится в процессе переработки. Я обновил шаги для пользовательского интерфейса, но еще не смог повторно опубликовать весь раздел. Я работаю над несколькими новыми статьями, которые позволят гораздо проще определить доступные вам варианты проверки подлинности и варианты коллекций. Таким образом, если вы запутались, знайте, что в скором времени будут доступны более подробные сведения. Спасибо.*
...
- Определите, нужно ли вам подключаться к виртуальной сети. Если вы будете подключаться к виртуальной сети, убедитесь, что она удовлетворяет [требованиям к размеру](remoteapp-vnetsizing.md) и [может подключиться к RemoteApp](remoteapp-vnet.md). Изучите сведения о [планировании виртуальных сетей](remoteapp-planvpn.md).
...
1. На портале управления перейдите на страницу RemoteApp.
2. Щелкните **Создать** > **Создать с VPN**.
