...
<properties 
    pageTitle="Отправка пользовательского образа"
    description="Сведения о процессе отправки пользовательского образа для RemoteApp" 
    services="remoteapp" 
...
# Отправка пользовательского образа
...
1.      Убедитесь, что пользовательский образ соответствует [требованиям к образу](..\remoteapp-imagereqs) и [требованиям к приложению](..\remoteapp-appreqs).
2.      Установите [модуль Azure PowerShell](../install-configure-powershell.md).
...
**Предупреждение.** Никогда не изменяйте скрипт отправки. Соответствие требованиям к образу и приложению обеспечивается с помощью специальных проверок.
