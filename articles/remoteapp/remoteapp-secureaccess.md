...
5.	Проверьте конфигурацию, запустив клиент Azure RemoteApp с IP-адреса, который находится за пределами указанного диапазона. После входа в систему с помощью своих учетных данных Azure AD вы увидите примерно следующее сообщение: ![Отказ в доступе к Azure RemoteApp](./media/remoteapp-secureaccess/ra-accessdenied.png)
