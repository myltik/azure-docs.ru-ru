...
# Как перенести данные в службу Azure RemoteApp и из нее

Для передачи [данных пользователя](remoteapp-upd.md) в службу Azure RemoteApp и из нее можно использовать множество различных инструментов и способов. Ниже приведено несколько таких способов.
...
>[AZURE.NOTE] 
Вы не сможете включить агенты синхронизации OneDrive для бизнеса или OneDrive for Consumer — они [не поддерживаются](remoteapp-onedrive.md) в Azure RemoteApp.

## Копирование и вставка в проводнике
...
1. [Опубликуйте проводник как приложения](remoteapp-publish.md) в коллекции RemoteApp. (Обратите внимание, что это задача администрирования.)
...
## Передача файлов и данных на файловый сервер с помощью стандартного сетевого копирования файлов
...
## Копирование файлов в OneDrive для бизнеса
...
## Копирование файлов с помощью перенаправления дисков
