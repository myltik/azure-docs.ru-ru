...
---
title: Как Azure RemoteApp сохраняет данные и параметры пользователя? | Microsoft Docs
...
> [!NOTE]
> Отключение UPD Узнайте, как это сделать, из сообщения [Отключение дисков профилей пользователей (UPD) в Azure RemoteApp](https://blogs.technet.microsoft.com/enterprisemobility/2015/11/11/disable-user-profile-disks-upds-in-azure-remoteapp/) в блоге Pavithra.
> 
> 
