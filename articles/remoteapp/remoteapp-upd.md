...
>[AZURE.NOTE] Отключение UPD Узнайте, как это сделать, из сообщения [Отключение дисков профилей пользователей (UPD) в Azure RemoteApp](http://blogs.msdn.com/b/rds/archive/2015/11/11/disable-user-profile-disks-upds-in-azure-remoteapp.aspx) в блоге Pavithra.
...
Дополнительные сведения см. в разделе [Отключение дисков профилей пользователей (UPD) в Azure RemoteApp](http://blogs.msdn.com/b/rds/archive/2015/11/11/disable-user-profile-disks-upds-in-azure-remoteapp.aspx).
