...
1. Распределение данных на основании хэширования значений из одного столбца.
2. Распределение данных равномерно, но случайным образом.  

Распределение данных определяется на уровне таблицы. Все таблицы распределяются, поэтому можно принять это решение для каждой таблицы в базе данных хранилища данных SQL.
