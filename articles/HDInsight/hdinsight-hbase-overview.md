<properties 
	...
	description="Введение в Apache HBase в HDInsight — базу данных NoSQL на основе Hadoop. Узнайте об этой технологии данных большого размера, вариантах использования и сравнении с другими кластерами Hadoop." 
