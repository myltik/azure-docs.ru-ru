...
С помощью портала Azure можно подготовить кластеры Hadoop в HDInsight, изменить пароль пользователя Hadoop и включить протокол удаленного рабочего стола (RDP), чтобы получить доступ к командной консоли Hadoop в кластере.
...
- Дополнительные сведения об администрировании HDInsight с помощью кроссплатформенных средств командной строки см. в разделе [Администрирование HDInsight с помощью кроссплатформенного интерфейса командной строки](hdinsight-administer-use-command-line.md).

##Предварительные требования

Перед началом работы с этой статьей необходимо иметь следующее:

- **Подписка Azure**. Azure — это платформа на основе подписок. Сведения о получении подписки см. в разделе [Варианты приобретения](http://azure.microsoft.com/pricing/purchase-options/), [Предложения для участников](http://azure.microsoft.com/pricing/member-offers/) или [Бесплатное пробное использование](http://azure.microsoft.com/pricing/free-trial/).
...
Вы можете подготавливать кластеры HDInsight на портале Azure, используя вариант быстрого создания или настраиваемого создания. Инструкции см. по следующим ссылкам.
...
3. Выполните импорт сертификата на портал Azure. На портале щелкните **ПАРАМЕТРЫ** в нижней левой части страницы, а затем нажмите **СЕРТИФИКАТЫ УПРАВЛЕНИЯ**. В нижней части страницы нажмите **ОТПРАВИТЬ** и следуйте инструкциям по отправке CER-файла, созданного на предыдущем шаге.
...
* [Администрирование HDInsight с помощью кроссплатформенного интерфейса командной строки](hdinsight-administer-use-command-line.md)
