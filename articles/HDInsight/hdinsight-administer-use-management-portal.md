...
С помощью [портала Azure](https://manage.windowsazure.com) можно подготовить кластеры Hadoop в HDInsight, изменить пароль пользователя Hadoop и включить протокол удаленного рабочего стола (RDP), чтобы получить доступ к командной консоли Hadoop в кластере.
