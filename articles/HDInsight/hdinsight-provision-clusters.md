...
##<a id="cli"></a> С помощью Azure CLI

> [AZURE.NOTE]Начиная с 8.29.2014 Azure CLI не может использоваться для связывания кластера с виртуальной сетью Azure.

Другим вариантом подготовки кластера HDInsight является использование интерфейса командной строки Azure CLI. Интерфейс командной строки Azure CLI реализован в Node.js. Его можно использовать на любой платформе, которая поддерживает Node.js, включая Windows, Mac и Linux. CLI можно установить из следующих расположений:
...
Выполните следующие процедуры, чтобы настроить компьютер под управлением Windows для использования Azure CLI:
...
Интерфейс командной строки Azure CLI можно установить с помощью NPM или установщика Windows. Корпорация Майкрософт рекомендует установку с использованием только одного из двух параметров.
