<properties
 pageTitle="Примеры топологий Storm для платформы Apache Storm в HDInsight"
 description="Список примеров топологий Storm, созданных и протестированных на платформе Apache Storm в HDInsight."
 services="hdinsight"
 documentationCenter=""
 authors="Blackmist"
 manager="paulettm"
...
# Примеры топологий Storm для Apache Storm в HDInsight
...
| [Обработка данных с датчиков автомобиля из концентраторов событий с использованием Storm в HDInsight][246ee964] | Концентраторы событий, DocumentDb, хранилище Blob-объектов Azure (WASB) | C#, Java |
