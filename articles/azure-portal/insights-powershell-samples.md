...
В нашем примере после успешного запуска веб-сайта вы отправите сообщение для подписки в группе ресурсов *abhingrgtest123*.
