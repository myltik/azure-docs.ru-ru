---
title: Настройка объектов webhook для оповещений на основе метрик Azure | Microsoft Docs
...
> [!NOTE]
> Поле свойств можно задать с помощью [REST API Insights](https://msdn.microsoft.com/library/azure/dn933805.aspx).
> 
> 
