...
На [портале Azure](https://portal.azure.com) можно настроить мониторинг для сбора статистических данных и информации о зависимостях приложений в [веб-приложениях Azure](../app-service-web/app-service-web-overview.md) или [виртуальных машинах](../virtual-machines/virtual-machines-about.md).
