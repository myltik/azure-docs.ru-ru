...
На [портале Azure](https://portal.azure.com) можно настроить мониторинг производительности [веб-приложений](../app-service-web/app-service-web-overview.md) или [виртуальных машин Azure](../virtual-machines/virtual-machines-linux-about.md). Средства мониторинга производительности инструментируют ваше приложение для отправки телеметрии о его работе. Полученные метрики и данные телеметрии используются для диагностики неисправностей, улучшения производительности и анализа использования приложения.
...
* Используйте [расширение Application Insights для приложений JavaScript и веб-страниц](../application-insights/app-insights-web-track-usage.md), чтобы получать данные телеметрии клиентов из браузеров, которые используются для открытия веб-страницы.
* [Настройте веб-тесты доступности](../application-insights/app-insights-monitor-web-app-availability.md), чтобы получать уведомления о сбоях в работе сайта.
