...
2. Щелкните строку, которая представляет приложение, чтобы перейти к этому поставщику:
![Щелкните "Обновить"](./media/insights-perf-analytics/06-overview.png)
...
В колонке Application Insights, например, вы можете:
- открыть элемент "Производительность".
