...
![Модель сетевых ресурсов](./media/resource-group-networking/Figure1.png)
...
![Модель сетевых ресурсов](./media/resource-group-networking/Figure2.png)
...
![Сетевая карта на одной виртуальной машине](./media/resource-group-networking/Figure3.png)
...
![Сетевая карта на одной виртуальной машине](./media/resource-group-networking/Figure4.png)
...
![Сетевая карта на одной виртуальной машине](./media/resource-group-networking/Figure5.png)
...
![Пример развертывания шаблона](./media/resource-group-networking/Figure6.png)
