<properties
	pageTitle="Обзор оповещений в Microsoft Azure | Microsoft Azure"
...
- **Azure Monitor** позволяет использовать оповещения на основе значений метрик и событий журнала действий. Azure Monitor включает в себя [REST API Azure Insights](https://msdn.microsoft.com/library/dn931943.aspx). Ознакомьтесь с разделом [Создание оповещений для служб Azure с помощью портала Azure](insights-alerts-portal.md).
