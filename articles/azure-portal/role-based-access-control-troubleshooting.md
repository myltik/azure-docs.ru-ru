...
Из этого документа вы узнаете, к чему нужно быть готовым при использовании некоторых новых ролей на портале Azure. В этот выпуск включены три встроенные роли: владелец, участник и читатель.
