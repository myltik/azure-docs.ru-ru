...
---
# Создание оповещения метрики с помощью шаблона Resource Manager
...
## Шаблон Resource Manager для оповещения метрики
...
## Шаблон Resource Manager для ресурса с оповещением
...
* [Добавьте параметры диагностики](../monitoring-and-diagnostics/monitoring-enable-diagnostic-logs-using-template.md) в шаблон Resource Manager.
