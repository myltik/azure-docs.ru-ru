---
title: "Панели мониторинга на портале Azure | Документация Майкрософт"
...
---
# <a name="creating-and-sharing-dashboards-in-the-azure-portal"></a>Создание панелей мониторинга и предоставление общего доступа к ним на портале Azure
...
## <a name="customizing-dashboards-versus-blades"></a>Настройка панелей мониторинга и колонок
