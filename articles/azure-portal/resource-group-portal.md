<properties 
	pageTitle="Управление ресурсами Azure с помощью портала предварительной версии Azure | Microsoft Azure" 
...
В этом разделе приведен краткий обзор использования групп ресурсов на портале предварительной версии Azure. В настоящее время не все службы поддерживают предварительную версию портала или диспетчер ресурсов. Для этих служб необходимо использовать [портал](https://manage.windowsazure.com). Сведения о состоянии отдельных служб см. в разделе [Поддержка диспетчера ресурсов для служб, регионов и версий API](resource-manager-supported-services.md).
...
К ресурсам и их группам можно добавлять теги. Это позволяет логически их упорядочивать. Сведения о работе с тегами на портале предварительной версии см. в статье [Использование тегов для организации ресурсов в Azure](../resource-group-using-tags.md).
...
Чтобы развернуть настроенный шаблон с помощью портала предварительной версии, последовательно щелкните **Создать**, **Marketplace** и **Все**.
