<properties
	pageTitle="Использование кроссплатформенного интерфейса командной строки (CLI) для создания оповещений для служб Azure | Microsoft Azure"
...
1. Выполнение необходимые условия и войдите в Azure. Ознакомьтесь с [примерами использования интерфейса командной строки в Azure Insights](insights-cli-samples.md). Если коротко, установите интерфейс командной строки и выполните следующие команды. Вы выполните вход, увидите, какая подписка используется, и подготовитесь к выполнению команд Insights.
...
2.  Чтобы получить список существующих правил для группы ресурсов, используйте следующую команду: **azure insights alerts rule list** *[параметры] &lt;группа\_ресурсов&gt;*.
...
3. Чтобы создать правило, необходимо сначала получить определенные важные сведения.
	...
	_PT1M_ представляет собой детализацию доступного измерения (интервалы в 1 минуту). Выбор различных уровней детализации позволяет использовать разные параметры метрик.
...
6. Чтобы создать оповещение, которое срабатывает при возникновении определенных условий в журнале действий, используйте следующую команду.
...
7. Можно проверить, правильно ли созданы оповещения, просмотрев отдельное правило.

	```console
    azure insights alerts rule list myresourcegroup --ruleName myrule
	```

8. Для удаления правил используйте следующую команду.
