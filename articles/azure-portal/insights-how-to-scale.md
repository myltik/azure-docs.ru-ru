---
title: Масштабирование числа экземпляров вручную или автоматически | Microsoft Docs
...
1. Можно вручную настроить число **экземпляров** с помощью ползунка.
2. Нажмите кнопку **Сохранить**, после чего практически мгновенно количество экземпляров будет увеличено.
...
1. Нажмите кнопку **ОК**.
2. Теперь необходимо добавить правила, которые необходимо применить для второго профиля. Нажмите **Добавить правило**, после чего вы сможете создать то же правило для профиля по умолчанию. ![Добавить правило для нерабочего времени](./media/insights-how-to-scale/Insights_RuleOffWork.png)
3. Создайте правила для увеличения и уменьшения масштаба, иначе во время профиля число экземпляров будет только увеличено (или уменьшено).
4. Наконец, нажмите кнопку **Сохранить**.
