...
**Универсальный код ресурса (URI) запроса**: https://management.azure.com/subscriptions/*{subscription-id}*/resourceGroups/*{resource-group-name}*/providers/*{resource-provider-namespace}*/*{resource-type}*/*{resource-name}*/providers/microsoft.insights/metrics?$filter=*{filter}*&api-version=*{apiVersion}*
...
3. Введите *armclient GET [ваш\_ИД\_ресурса]/providers/microsoft.insights/metricdefinitions?api-version=2016-03-01*
4. Введите *armclient GET [ваш\_ИД\_ресурса]/providers/microsoft.insights/metrics?api-version=2016-06-01*
...
* **Центр Интернета вещей**: /subscriptions/*{ИД\_подписки}*/resourceGroups/*{имя\_группы\_ресурсов}*/providers/Microsoft.Devices/IotHubs/*{имя\_Центра\_Интернета\_вещей}*
* **Пул эластичных баз данных SQL**: /subscriptions/*{ИД\_подписки}*/resourceGroups/*{имя\_группы\_ресурсов}*/providers/Microsoft.Sql/servers/*{БД\_пула}*/elasticpools/*{имя\_пула\_SQL}*
* **База данных SQL (версии 12)**: /subscriptions/*{ИД\_подписки}*/resourceGroups/*{имя\_группы\_ресурсов}*/providers/Microsoft.Sql/servers/*{имя\_сервера}*/databases/*{имя\_базы\_данных}*
* **Служебная шина**: /subscriptions/*{ИД\_подписки}*/resourceGroups/*{имя\_группы\_ресурсов}*/providers/Microsoft.ServiceBus/*{пространство\_имен}*/*{имя\_служебной\_шины}*
* **Наборы масштабирования виртуальных машин**: /subscriptions/*{ИД\_подписки}*/resourceGroups/*{имя\_группы\_ресурсов}*/providers/Microsoft.Compute/virtualMachineScaleSets/*{имя\_ВМ}*
* **Виртуальные машины**: /subscriptions/*{ИД\_подписки}*/resourceGroups/*{имя\_группы\_ресурсов}*/providers/Microsoft.Compute/virtualMachines/*{имя\_ВМ}*
* **Концентраторы событий**: /subscriptions/*{ИД\_подписки}*/resourceGroups/*{имя\_группы\_ресурсов}*/providers/Microsoft.EventHub/namespaces/*{пространство\_имен\_концентратора\_событий}*
...
## Дальнейшие действия
* Прочитайте [общие сведения о мониторинге](../monitoring-and-diagnostics/monitoring-overview.md).
* Ознакомьтесь с разделом [Метрики, поддерживаемые Azure Monitor](../monitoring-and-diagnostics/monitoring-supported-metrics.md).
