---
title: "Доступ к панели мониторинга на портале Azure | Документация Майкрософт"
...
---
# <a name="sharing-azure-dashboards"></a>Совместное использование панелей мониторинга Azure
