---
title: Отслеживание работоспособности служб с помощью Azure Insights | Microsoft Docs
...
1. Нажмите кнопку **Обзор** и выберите **Журналы аудита**. ![Обзор концентратора](./media/insights-service-health/Insights_Browse.png)
2. При этом откроется колонка со всеми событиями, которые повлияли на любую из ваших подписок за последние 7 дней. Записи работоспособности службы будут отображаться в этом списке, но их может быть трудно найти, так как список может быть большим.
3. Щелкните **Фильтр** команды.
4. Выберите **Категорию событий** и выберите **Работоспособность службы**: ![Все события](./media/insights-service-health/Insights_Filter.png)
5. Щелкните **Обновить**.
6. Теперь вы увидите все события работоспособности службы, которые касаются вашей подписки: ![Группы ресурсов](./media/insights-service-health/Insights_HealthEvent.png)
7. Отсюда можно перейти к колонке сведения для просмотра описания события.
