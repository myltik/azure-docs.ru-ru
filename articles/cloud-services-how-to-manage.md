<properties urlDisplayName="How to manage" pageTitle="Управление облачной службой &mdash; Azure" metaKeywords="Azure manage cloud services, Azure Management Portal cloud services" description="Узнайте, как управлять облачными службами с помощью портала управления Azure." metaCanonical="" services="cloud-services" documentationCenter="" title="Управление облачными службами" authors="ryanwi" solutions="" manager="timlt" editor="" />
