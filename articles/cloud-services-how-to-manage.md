<properties linkid="manage-services-how-to-manage-a-cloud-service" urlDisplayName="Управление" pageTitle="Управление облачной службой — Azure" metaKeywords="Azure, управление облачными службами, портал управления Azure, облачный службы" description="Узнайте, как управлять облачными службами с помощью портала управления Azure." metaCanonical="" services="cloud-services" documentationCenter="" title="Управление облачными службами" authors=""  solutions="" writer="ryanwi" manager="" editor=""  />
...
В области **Облачные службы** портала управления Azure можно обновить роль службы или развертывание, перенести промежуточное развертывание в рабочую среду, привязать ресурсы к облачной службе для просмотра их зависимостей и масштабирования, а также удалить службу или развертывание.
...
1. Войдите на [портал управления Azure](https://manage.windowsazure.com/), откройте панель мониторинга, перейдите на страницу **Облачные службы** или **Экземпляры** и щелкните **Обновить**.
...
6. Выполните настройку базы данных в соответствии с инструкциями в справке для области **Базы данных SQL** портала управления.
	...
	По завершении этого процесса вы можете проконтролировать состояние связанных ресурсов на панели мониторинга облачной службы. Дополнительные сведения о масштабировании связанной базы данных SQL см. в разделе [Масштабирование облачной службы и связанных ресурсов](../how-to-scale-a-cloud-service/).
...
> [WACOM.NOTE]
> Если для удаляемой облачной службы был настроен подробный мониторинг, платформа Azure не удаляет данные мониторинга из учетной записи хранения. В этом случае требуется удалить такие данные вручную. Сведения о расположении таблицы показателей см. в подразделе "Практическое руководство. Доступ к данным подробного мониторинга вне портала управления" раздела <a href="https://www.windowsazure.com/ru-ru/manage/services/cloud-services/how-to-monitor-a-cloud-service/">Мониторинг облачных служб</a>.
