<properties
   pageTitle="Общие задачи виртуальных машин с использованием режима управления службами в Azure PowerShell"
   description="Описывает команды для выполнения общих задач виртуальных машин с использованием режима управления службами в Azure PowerShell."
...
# Общие задачи виртуальных машин с использованием Azure PowerShell в режиме управления службами
...
Многие повседневные задачи управления виртуальными машинами можно автоматизировать с помощью командлетов Azure PowerShell в режиме управления службами. В этой статье приводятся примеры команд для простых задач, а также ссылки на статьи о командах для более сложных задач.
