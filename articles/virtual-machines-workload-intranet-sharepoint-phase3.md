...
На этом этапе развертывания фермы SharePoint 2013 в интрасети с группами доступности AlwaysOn для SQL Server на базе служб инфраструктуры Azure настраиваются два компьютера SQL Server и компьютер узла большинства кластера, после чего они объединяются в кластер Windows Server.
...
3. Выполните в консоли Windows PowerShell следующие команды:
...
Для обоих компьютеров с сервером SQL Server и узла большинства кластера выполните в консоли Windows PowerShell следующую команду с правами администратора:
...
7.	На странице «Точка доступа для администрирования кластера» в поле **Имя кластера** введите название кластера и нажмите кнопку **Далее**.
