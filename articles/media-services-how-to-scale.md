...
Сведения о масштабировании единиц кодирования см. в следующих статьях о **портале** и **.NET**.
...
Дополнительные сведения см. в разделах [Управление ресурсами служб мультимедиа в нескольких учетных записях хранения](https://msdn.microsoft.com/library/azure/dn271889.aspx) и [Работа с хранилищем Azure](https://msdn.microsoft.com/library/azure/dn767951.aspx).
