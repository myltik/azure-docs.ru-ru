<properties 
   pageTitle="Отладка опубликованной облачной службы с помощью IntelliTrace и Visual Studio"
...
1. Откройте контекстное меню для проекта Azure в обозревателе решений и выберите **Опубликовать**. Откроется мастер публикации приложения Azure.

1. Чтобы собирать журналы IntelliTrace для приложения при его публикации в облаке, установите флажок **Включить IntelliTrace**.
