...
[Виртуальные машины](https://msdn.microsoft.com/library/azure/)

[Доступ к виртуальным машинам Azure из обозревателя сервера](https://msdn.microsoft.com/library/azure/jj131259.aspx)
