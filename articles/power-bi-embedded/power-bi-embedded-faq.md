...
12.	**Существуют ли какие-то инструменты или рекомендации, которые помогут оценить предполагаемое количество отрисовок? Как я узнаю о том, сколько отрисовок выполнено?**
...
19.	**Где можно получить дополнительную информацию?**
    ...
    Вы можете посетить [страницу документации по Power BI Embedded](http://go.microsoft.com/fwlink/?LinkId=760526). Последние новости об этой службе можно получить в [блоге разработчиков Power BI](http://blogs.msdn.com/powerbidev) или посетив Центр разработчиков для Power BI на сайте dev.powerbi.com. Вы также можете задать свои вопросы на сайте [Stackoverflow](http://stackoverflow.com/questions/tagged/powerbi).
