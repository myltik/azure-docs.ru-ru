---
title: "Средства непрерывной интеграции и доставки со Службой контейнеров Azure и Swarm | Документация Майкрософт"
...
4. Настроив действия сборки и принудительной отправки для каждого из пяти образов, добавьте еще два действия в рабочий процесс сборки.
    ...
    а. Задача командной строки, в которой для замены вхождения *BuildNumber* в файле docker-compose.yml текущим идентификатором сборки используется bash-скрипт. Подробнее показано на следующем снимке экрана.
