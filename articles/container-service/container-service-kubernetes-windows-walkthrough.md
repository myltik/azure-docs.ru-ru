...
3. Чтобы запустить приложение, ведите приведенную ниже команду.
...
4. Чтобы проверить развертывание службы (которое занимает около 30 секунд), введите приведенную ниже команду.

  ```
  kubectl get pods
  ```

5. Чтобы после запуска службы просмотреть ее внутренний и внешний IP-адреса, введите приведенную команду.
...
6. После того, как внешний IP-адрес станет доступен, вы сможете получить доступ к службе через веб-браузер.
