---
title: "Кластеры контейнеров Docker в Azure | Документация Майкрософт"
...
Чтобы начать работу со службой контейнеров Azure, разверните кластер этой службы на портале (выполните поиск по словам "Служба контейнеров Azure"). Для этого воспользуйтесь шаблоном Azure Resource Manager ([Docker Swarm](https://github.com/Azure/azure-quickstart-templates/tree/master/101-acs-swarm), [DC/OS](https://github.com/Azure/azure-quickstart-templates/tree/master/101-acs-dcos) или [Kubernetes](https://github.com/Azure/azure-quickstart-templates/tree/master/101-acs-kubernetes)) или [интерфейсом командной строки](/articles/xplat-cli-install.md). Предоставляемые шаблоны быстрого запуска можно изменять, включив дополнительную или расширенную конфигурацию Azure. Дополнительные сведения о развертывании кластера службы контейнеров Azure см. в статье [Развертывание кластера службы контейнеров Azure](container-service-deployment.md).
