---
title: "Управление контейнером службы контейнеров Azure через REST API | Документация Майкрософт"
...
---
# <a name="container-management-through-the-rest-api"></a>Управление контейнерами через REST API
