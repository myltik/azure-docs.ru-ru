...
* **Секрет и идентификатор клиента субъекта-службы (только для Kubernetes).** Дополнительные сведения и рекомендации по созданию субъекта-службы Azure Active Directory см. в разделе [Сведения о субъекте-службе Azure Active Directory для кластера Kubernetes в службе контейнеров Azure](../kubernetes/container-service-kubernetes-service-principal.md).
