...
Хотя платформы доступны для многих популярных рабочих нагрузок, в этом документе мы рассмотрим создание и масштабирование развертываний контейнеров с помощью Marathon. 
...
Чтобы открыть пользовательский интерфейс Marathon, перейдите по адресу http://localhost/marathon. На этом экране можно запустить новый контейнер или другие приложения в кластере DC/OS службы контейнеров Azure. Здесь вы также можете просмотреть информацию о работе контейнеров и приложений.  
...
![Пользовательский интерфейс "Новое приложение", вкладка "Проверки работоспособности"](./media/dcos/dcos_healthcheck.png)
...
С помощью пользовательского интерфейса Marathon можно изменять количество экземпляров контейнера. Для этого перейдите на страницу **Marathon**, выберите контейнер, который требуется масштабировать, и нажмите кнопку **Scale Application** (Масштабировать приложение). В диалоговом окне **Scale Application** (Масштабирование приложения) введите нужное количество экземпляров контейнера, а затем щелкните **Scale Application** (Масштабировать приложение).
