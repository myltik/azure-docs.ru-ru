---
title: "Управление контейнером службы контейнеров Azure через веб-интерфейс | Документация Майкрософт"
...
---
# <a name="container-management-through-the-web-ui"></a>Управление контейнерами через веб-интерфейс
