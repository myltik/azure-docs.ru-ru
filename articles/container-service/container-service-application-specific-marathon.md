---
title: Создание службы Marathon с настройками для приложения или пользователя | Microsoft Docs
...
[!INCLUDE [Установите интерфейс командной строки DC/OS.](../../includes/container-service-install-dcos-cli-include.md)]
