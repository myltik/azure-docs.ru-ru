...
В этой статье мы настроим внешний веб-интерфейс для управляемой службы контейнеров Azure DC/OS. Мы также настроим балансировщик нагрузки Marathon, чтобы вы могли масштабировать приложение.

## Предварительные требования

[Разверните экземпляр службы контейнеров Azure](container-service-deployment.md) с типом оркестратора DC/OS и [убедитесь, что клиент может подключиться к кластеру](container-service-connect.md).
...
Подробные сведения об этом см. в документации по [виртуальным узлам](https://mesosphere.com/blog/2015/12/04/dcos-marathon-lb/), которые позволяют связать домены с конкретными путями marathon-lb.
