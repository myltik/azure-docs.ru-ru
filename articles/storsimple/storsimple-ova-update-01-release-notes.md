...
- **Устойчивость к сбоям в облаке**: этот выпуск содержит несколько исправлений, касающихся аварийного восстановления, резервного копирования, восстановления и распределения по уровням в случае сбоя подключения облака. 
...
- **Новые образы VHD, VHDX и VMDK**: новые образы VHD, VHDX и VMDK теперь доступны с помощью классического портала Azure. Эти образы можно скачать для подготовки новых устройств с Обновлением 0.1.
...
- **Исправления ошибок, связанных с присоединением к домену и переименованием** устройства.
