...
* Вы изучили сетевые требования к развертыванию виртуального устройства StorSimple и настроили сеть центра обработки данных в соответствии с требованиями. Дополнительные сведения см. в статье [Системные требования для виртуального массива StorSimplе](storsimple-virtual-array-system-requirements.md).
...
21. На странице **Memory** (Память) укажите 8 ГБ (или больше) ОЗУ. Нажмите кнопку **Next**(Далее).
