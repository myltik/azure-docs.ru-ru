---
title: "Панель мониторинга службы диспетчера StorSimple — виртуальный массив | Документация Майкрософт"
...
---
# <a name="use-the-storsimple-manager-service-dashboard-for-the-storsimple-virtual-array"></a>Использование панели мониторинга в службе диспетчера StorSimple при работе с виртуальным массивом StorSimple
...
Дополнительные сведения о получении регистрационного ключа службы см. в разделе [Получение регистрационного ключа службы](storsimple-ova-manage-service.md#get-the-service-registration-key).
