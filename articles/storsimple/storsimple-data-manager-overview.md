...
![Регионы, доступные для данных](./media/storsimple-data-manager-overview/data-manager-job-definition-different-regions.png)

Этот набор больше, так как при развертывании ресурсов в любом из регионов, указанных выше, может начаться преобразование в следующих регионах. При условии, что данные хранятся в одном из 26 регионов, их можно преобразовать с помощью этой службы.
