<properties 
    pageTitle="Заметки о выпуске StorSimple — июль 2014 г."
...
# Заметки о выпуске StorSimple — июль 2014 г. 

## Обзор

В следующих заметках о выпуске перечислены важные открытые вопросы, связанные с общедоступным выпуском Microsoft Azure StorSimple за июль 2014 г. Этот выпуск соответствует версии программного обеспечения 6.3.9600.17215.
