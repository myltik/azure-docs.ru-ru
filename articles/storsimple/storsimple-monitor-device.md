...
Установив обновления 2 или более поздней версии, вы сможете детализировать данные об использовании ресурсов основного хранилища по отдельным томам, всем томам, всем многоуровневым томам и всем локальным томам, как показано ниже. Детализация по всем локальным томам позволяет быстро оценить, какой объем локального уровня уже задействован.

![Уровень использования основного хранилища по всем локальным томам](./media/storsimple-monitor-device/localvolumes.png)
