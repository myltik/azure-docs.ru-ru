...
# Общие сведения о виртуальном массиве StorSimple (предварительная версия)
...
Сведения об использовании пользовательского веб-интерфейса см. в статье [Use the web-based UI to administer your StorSimple Virtual Array](storsimple-ova-web-ui-admin.md) (Использование пользовательского веб-интерфейса для администрирования виртуального массива StorSimple).
