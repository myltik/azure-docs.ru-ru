...
1.  Просмотрите информацию на странице **Сводка**. Для создания виртуальной машины нажмите кнопку **Готово**.
...
1.  На странице **Выбор формата диска** примите выбор формата **VHDX** по умолчанию. Нажмите кнопку **Далее**. Если используется Windows Server 2008 R2, то этот экран больше отображаться не будет.
