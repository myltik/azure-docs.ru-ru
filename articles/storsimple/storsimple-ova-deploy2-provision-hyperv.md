...
# Развертывание виртуального массива StorSimple — подготовка виртуального массива в Hyper-V (предварительная версия)

![](./media/storsimple-ova-deploy2-provision-hyperv/hyperv4.png)

## Обзор 

Это руководство по подготовке применяется только к виртуальным массивам Microsoft Azure StorSimple (также известным как локальные виртуальные устройства StorSimple или виртуальные устройства StorSimple) версии 1.1.1.0 (общедоступная предварительная версия). В руководстве описана подготовка виртуального устройства StorSimple в главной системе под управлением Hyper-V 2008 R2, Hyper-V 2012 или Hyper-V 2012 R2.
...
Здесь указаны все предварительные требования для подготовки виртуального устройства в главной системе под управлением Hyper-V 2008 R2, Hyper-V 2012 и 2012 R2.
...
-   Вы скачали с портала Azure образ виртуального устройства для Hyper-V. Дополнительные сведения см. в разделе [Шаг 3. Загрузка образа виртуального устройства](storsimple-ova-deploy1-portal-prep.md#step-3-download-the-virtual-device-image).
...
-   Вы изучили сетевые требования к развертыванию виртуального устройства StorSimple и настроили сеть центра обработки данных в соответствии с требованиями. Дополнительные сведения см. в разделе [Сетевые требования к виртуальному массиву StorSimple ](storsimple-ova-system-requirements.md#networking-requirements).
...
1.  В главной системе Windows Server скопируйте образ виртуального устройства на локальный диск. Это образ, который вы скачали с портала Azure. Запишите расположение, в которое был скопирован образ. Эти сведения потребуются вам позднее.

2.  Откройте **диспетчер серверов**. В верхнем углу справа выберите пункт **Средства**, а затем — пункт **Диспетчер Hyper-V**.

	![](./media/storsimple-ova-deploy2-provision-hyperv/image1.png)

	Если вы используете Hyper-V 2008 R2, откройте диспетчер Hyper-V. В диспетчере серверов последовательно выберите пункты **Роли > Hyper-V > Диспетчер Hyper-V**.
...
1.  На странице **Указание поколения** выберите пункт **Поколение 1**. Нажмите кнопку **Далее**.
...
1.  Вы вернетесь к странице **Параметры**. Нажмите кнопку **ОК**, чтобы закрыть страницу **Параметры** и вернуться к окну диспетчера Hyper-V.
