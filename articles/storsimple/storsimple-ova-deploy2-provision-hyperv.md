...
3. В **диспетчере Hyper-V** на панели областей щелкните правой кнопкой мыши узел системы, чтобы открыть контекстное меню, затем щелкните **Создать** > **Виртуальная машина**.
...
7. На странице **Выделить память** для параметра **Память при запуске** укажите по крайней мере **8192 МБ**. Не включайте динамическую память. Нажмите кнопку **Далее**.
...
12. В левой области страницы **Параметры** щелкните **Процессор**. В области справа установите для параметра **Количество виртуальных процессоров** значение 4 (или больше). Нажмите кнопку **Применить**.
...
14. На странице **Жесткий диск** выберите **Виртуальный жесткий диск** и нажмите кнопку **Создать**. Запустится **мастер создания виртуального жесткого диска**.
...
18. На странице **Указание имени и расположения** введите **имя** и **расположение** (к нему можно перейти) диска данных. Нажмите кнопку **Далее**.
    
    ![](./media/storsimple-ova-deploy2-provision-hyperv/image17.png)
19. На странице **Настройка диска** выберите параметр **Создать пустой виртуальный жесткий диск** и укажите размер **500 ГБ** (или больше). Нажмите кнопку **Далее**.
    
    ![](./media/storsimple-ova-deploy2-provision-hyperv/image18.png)
20. На странице **Сводка** просмотрите подробные сведения о данных виртуального диска и, если они соответствуют требованиям, нажмите кнопку **Готово** для создания диска. Мастер закроется, и виртуальный жесткий диск будет добавлен на компьютер.
