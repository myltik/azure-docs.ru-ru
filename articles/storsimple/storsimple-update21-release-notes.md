<properties 
   pageTitle="Заметки о выпуске, посвященные обновлению 2.1 для устройств серии StorSimple 8000 | Microsoft Azure"
   description="В статье описываются новые возможности, проблемы и способы их решения для обновления 2.1, предназначенного для устройств серии StorSimple 8000."
   services="storsimple"
...
# Заметки о выпуске, посвященные обновлению 2.1 для устройств серии StorSimple 8000  

## Обзор

В приведенных ниже заметках о выпуске описаны новые функции и критические открытые проблемы в обновлении 2.1 для устройств серии StorSimple 8000. Здесь также содержится список обновлений программного обеспечения StorSimple для этого выпуска.

Обновление 2.1 можно применить к любому устройству StorSimple под управлением ПО общедоступной версии или версии с обновлениями версий 0.1–2. Версия устройства, связанная с обновлением 2.1 — 6.3.9600.17705.

Перед развертыванием обновления в решении StorSimple, просмотрите сведения, содержащиеся в заметках о выпуске.

>[AZURE.IMPORTANT]
> 
> - В обновлении 2.1 содержатся обновления только программного обеспечения. Установка этого обновления занимает примерно 1,5–2 часа. 
...
## Новые возможности в обновлении 2.1

В обновление 2.1 внесены следующие основные улучшения:
...
- **Улучшения производительности моментальных снимков**. В обновлении 2.1 требуется меньше времени на обработку облачных моментальных снимков в определенных сценариях, где используются большие тома с минимальным обновлением данных или без него. Это улучшение целесообразно использовать для архивных томов.
...
## Проблемы, устраненные в обновлении 2.1

В приведенной ниже таблице в общих чертах описаны проблемы, устраненные в обновлении 2.1.
...
## Известные проблемы в обновлении 2.1
...
## Обновления контроллера и встроенного ПО в обновлении 2.1
...
Дополнительные сведения о том, как установить обновления драйвера, Storport, Spaceport и встроенного ПО диска, см. в статье [Установка обновления 2.1 на устройство StorSimple](storsimple-install-update-21.md).

 
## Обновления для виртуальных устройств в обновлении 2.1

Это обновление не может применяться к виртуальному устройству. Нужно будет создать новые виртуальные устройства.

## Дальнейшие действия

Узнайте, как [установить обновление 2.1](storsimple-install-update-21.md) на устройство StorSimple.
