<properties 
   pageTitle="Заметки о выпуске обновления 2.2 для устройств серии StorSimple 8000 | Microsoft Azure"
...
# Заметки о выпуске, посвященные обновлению 2.2 для устройств серии StorSimple 8000.  
...
## Новые возможности в обновлении 2.2
...
## Проблемы, устраненные в обновлении 2.2
...
| 7 | Инструментарий управления Windows (WMI) | В предыдущих версиях ПО наблюдались несколько случаев сбоя веб-прокси с исключением "Сбой загрузки поставщика <исключение\_управления>". Эта ошибка была связана с проблемой доступа к памяти WMI. В этом выпуске она исправлена. | Да | Нет |
...
## Известные проблемы в обновлении 2.2
...
## Обновления контроллера и встроенного ПО в обновлении 2.2
...
## Обновления для виртуальных устройств в обновлении 2.2
