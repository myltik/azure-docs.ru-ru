...
# Использование службы диспетчера StorSimple для управления учетной записью хранения (предварительная версия)
...
В этом учебнике объясняется, как с помощью страницы **Настройка** добавлять, изменять или удалять учетные записи хранения для виртуального массива StorSimple. Сведения в этом учебнике применимы только к виртуальному массиву StorSimple с общедоступной предварительной версией программного обеспечения.
...
3. В диалоговом окне **Добавление или изменение учетных записей хранения**:
  ...
  5. Чтобы сохранить обновленные параметры, в нижней части страницы нажмите кнопку **Сохранить**. 
