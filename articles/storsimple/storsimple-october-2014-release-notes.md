...
> [!IMPORTANT]
> * Для установки октябрьского обновления используйте службу StorSimple Manager, а не Windows PowerShell для StorSimple.  
...
* Убедитесь в том, что необходимые исходящие порты на устройстве StorSimple доступны для исходящего трафика. Дополнительные сведения см. в разделе [Требования к сети для устройства StorSimple](storsimple-system-requirements.md#networking-requirements-for-your-storsimple-device).  
...
## <a name="whats-new-in-the-october-release"></a>Новые возможности в октябрьском выпуске
Это обновление содержит следующие улучшения.

* Пользовательский интерфейс службы StorSimple Manager теперь можно использовать для управления контроллерами устройства. Доступны такие действия управления: перезапуск, завершение работы и включение контроллера. Дополнительные сведения см. в статье [Управление контроллерами устройства StorSimple](storsimple-manage-device-controller.md).  
* Вы можете запланировать распределение пропускной способности глобальной сети по дням недели и времени суток. Это позволяет лучше использовать пропускную способность глобальной сети в часы наименьшей нагрузки. Для разных контейнеров томов можно использовать разные шаблоны пропускной способности. Дополнительные сведения см. в статье [Использование службы диспетчера StorSimple для управления шаблонами пропускной способности StorSimple](storsimple-manage-bandwidth-templates.md).  
* Чтобы предупреждать администраторов и других пользователей о существующих или потенциально возможных проблемах, можно настроить уведомления по электронной почте. Дополнительные сведения см. в разделе [Настроить параметры оповещений](storsimple-manage-alerts.md#configure-alert-settings).  

## <a name="issues-fixed-in-the-october-release"></a>Исправления в октябрьском выпуске
...
## <a name="known-issues-in-the-october-release"></a>Известные проблемы в октябрьском выпуске
