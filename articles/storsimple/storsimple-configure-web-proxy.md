<properties 
   pageTitle="Настройка веб-прокси для устройства"
   description="Узнайте, как настроить веб-прокси для устройства StorSimple с помощью Windows PowerShell для StorSimple."
   services="storsimple"
   documentationCenter=""
   authors="alkohli"
   manager="carolz"
...
# Настройка веб-прокси для устройства
...
1. Затем с помощью командлетов Windows PowerShell для StorSimple заданные параметры веб-прокси активируются.
...
- просматривать параметры веб-прокси на портале управления;
...
#### Для настройки веб-прокси с помощью мастера установки выполните следующие действия.
...
1. При использовании проверки подлинности укажите **имя пользователя веб-прокси** и **пароль веб-прокси**. Также потребуется подтвердить пароль.
...
Веб-прокси также будет включен. Можно пропустить пункт [Включить веб-прокси](#Enable-web-proxy) и просмотреть параметры веб-прокси непосредственно на портале управления.


## Настройка веб-прокси с помощью Windows PowerShell для StorSimple

Альтернативный способ настройки параметров веб-прокси — с помощью командлетов Windows PowerShell для StorSimple. Для настройки веб-прокси выполните следующие действия.
...
## Просмотр параметров веб-прокси на портале управления
Параметры веб-прокси настраиваются через интерфейс Windows PowerShell и изменить их на портале управления нельзя. Однако на портале управления их можно просматривать. Для просмотра параметров веб-прокси выполните следующие действия.

#### Просмотр параметров веб-прокси
1. Выберите **Служба диспетчера StorSimple > Устройства**. Выберите и щелкните на устройстве, затем выберите **Настройка**.
...
> - Ошибки, связанные с параметрами веб-прокси, не будут отображаться в портале управления в службе диспетчера StorSimple. Если после завершения конфигурации есть проблема с веб-прокси, состояние устройства на портале управления изменится на**Вне сети**.|

## Дальнейшие действия
Если возникают проблемы при развертывании устройства или настройке параметров прокси-сервера, обратитесь к статье [Устранение неполадок устройства StorSimple](storsimple-troubleshoot-deployment.md).
