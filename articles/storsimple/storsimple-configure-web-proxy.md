<properties 
   pageTitle="Настройка веб-прокси для устройства | Microsoft Azure"
...
Веб-прокси также будет включен. Можно пропустить шаг [Включить веб-прокси](#enable-web-proxy) и перейти непосредственно к [просмотру параметров веб-прокси на портале управления](#view-web-proxy-settings-in-the-management-portal).
...
Параметры веб-прокси настраиваются через интерфейс Windows PowerShell и изменить их на портале управления нельзя. Однако на портале управления их можно просматривать. Чтобы просмотреть параметры веб-прокси, выполните следующие действия.
