...
Чтобы получить дополнительные сведения и настроить CHAP, перейдите к разделу [Настройка CHAP для устройства StorSimple](storsimple-configure-chap.md).
...
- Для реализации избыточности используйте несколько каналов ввода-вывода (MPIO), чтобы избежать ситуации с единой точкой сбоя в сети хранения данных iSCSI. Подробные инструкции см. в разделе [Настройка MPIO для устройства StorSimple](storsimple-configure-mpio-windows-server.md).
