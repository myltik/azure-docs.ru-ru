...
| **Регионы доступности** |Все регионы Azure |Регионы Azure, которые поддерживают хранилища класса Premium.<br></br>Список поддерживаемых регионов для 8020 см. в [соответствующем разделе](#supported-regions-for-8020) |
| **Тип хранилища** |Использует хранилище Azure класса Standard для локальных дисков<br></br> Узнайте, как [создать учетную запись хранения класса Standard](../storage/storage-create-storage-account.md) |Использует хранилище Azure класса Premium для локальных дисков<sup>2</sup> <br></br>Узнайте, как [создать учетную запись хранения класса Premium](../storage/storage-premium-storage.md#quick-start-create-and-use-a-premium-storage-account-for-a-virtual-machine-data-disk) |
...
#### <a name="supported-regions-for-8020"></a>Регионы с поддержкой модели 8020
...
| S. номер | Регионы, в которых сейчас реализована поддержка |
| --- | --- |
