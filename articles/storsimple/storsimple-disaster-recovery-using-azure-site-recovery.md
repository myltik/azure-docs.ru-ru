---
title: Автоматизация аварийного восстановления файловых ресурсов StorSimple с помощью Azure Site Recovery| Microsoft Docs
...
1. На классическом портале Azure выберите свое хранилище Site Recovery.
2. Щелкните план восстановления, созданный для виртуальной машины файлового сервера.
3. Щелкните **Восстановление размещения**, а затем выберите **Плановая отработка отказа** или **Внеплановая отработка отказа**.
