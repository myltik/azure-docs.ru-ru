---
title: "Замена контроллера на устройстве StorSimple | Документация Майкрософт"
...
> [!IMPORTANT]
> Перед снятием и заменой контроллера ознакомьтесь со сведениями о безопасности в статье [Замена компонентов оборудования StorSimple](storsimple-hardware-component-replacement.md).
> 
> 
...
### <a name="use-the-azure-classic-portal-to-identify-the-active-controller"></a>Определение активного контроллера с помощью классического портала Azure
