...
1. На портале управления в службе диспетчера StorSimple перейдите на вкладку **Устройства**, а затем щелкните имя устройства, которое требуется отслеживать.
...
8. После перезагрузки контроллера проверьте **Состояние контроллера** и **Состояние кластера** на портале управления и убедитесь, что контроллер вернулся в работоспособное состояние и находится в режиме ожидания.
...
5. Чтобы убедиться, что замена выполнена успешно, на портале управления выберите **Устройства** > **Обслуживание** > **Состояние оборудования** и убедитесь, что оба контроллера 0 и 1 работают (зеленый свет индикаторов).
