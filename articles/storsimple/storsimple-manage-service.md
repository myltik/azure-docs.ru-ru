---
title: "Развертывание службы StorSimple Manager | Документация Майкрософт"
description: "Сведения о создании и удалении службы StorSimple Manager на классическом портале Azure, а также об управлении ключом регистрации службы."
services: storsimple
documentationcenter: 
author: alkohli
manager: timlt
...
---
# <a name="deploy-the-storsimple-manager-service-in-the-azure-classic-portal"></a>Развертывание службы StorSimple Manager на классическом портале Azure
> [!NOTE]
> Классический портал StorSimple устарел. Диспетчеры устройств StorSimple автоматически перейдут на новый портал Azure в соответствии с графиком устаревания. Вы получите сообщение электронной почты и уведомление с портала, касающиеся этого перехода. Этот документ скоро также перестанет использоваться. Чтобы просмотреть версию этой статьи для нового портала Azure, перейдите к статье [Развертывание службы диспетчера устройств StorSimple для устройств StorSimple серии 8000](storsimple-8000-manage-service.md). Сведения, связанные с переходом, см. в [ответах на вопросы о перемещении на портал Azure](storsimple-8000-move-azure-portal-faq.md).


## <a name="overview"></a>Обзор
Служба StorSimple Manager выполняется в Microsoft Azure и подключается к нескольким устройствам StorSimple. После создания службы вы можете использовать ее для управления этими устройствами на классическом портале Microsoft Azure, запущенном в браузере. Это позволит отследить все устройства, которые подключены к службе StorSimple Manager из одного центрального расположения, таким образом, снизив административную нагрузку.

На главной странице StorSimple Manager перечислены все службы StorSimple Manager, которые можно использовать для управления запоминающими устройствами StorSimple. Для каждой службы StorSimple Manager на странице StorSimple Manager представлена следующая информация:

* 
            **Имя** — имя, назначенное вашей службе StorSimple Manager при ее создании. **Имя службы невозможно изменить после ее создания. Это также верно для других сущностей, таких как устройства, тома, контейнеры томов и политики резервного копирования, которые не могут быть переименованы на классическом портале Azure.**
...
Распространенные задачи, которые можно выполнить на странице StorSimple Manager:
...
Выберите параметр **Быстрое создание** , чтобы создать службу StorSimple Manager, если вы хотите развернуть свое устройство StorSimple. Для создания службы требуется следующее:
...
1. На странице **Служба StorSimple Manager** выберите службу, которую вы хотите удалить.
...
1. На странице **Службы StorSimple Manager** щелкните **Ключ регистрации**.
