<properties 
   ...
   description="Сведения о создании и удалении службы диспетчера StorSimple на портале Azure, а также об управлении ключом регистрации службы."
   services="storsimple"
   documentationCenter=""
   authors="SharS"
   manager="carolz"
