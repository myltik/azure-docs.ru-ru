...
| 5 |Архивация |В редких случаях в предыдущих версиях ПО, когда пользователь создавал резервную копию удаленного клона, происходила ошибка в облаке и операция завершалась сбоем. В данном выпуске эта ошибка устранена, и операция завершается успешно. |Yes |Yes |
