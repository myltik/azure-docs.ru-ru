<properties 
   pageTitle="Используйте Windows PowerShell для StorSimple для администрирования устройства StorSimple | Microsoft Azure"
...
## Дальнейшие действия
Если с устройством StorSimple возникнут неполадки при выполнении одного из указанных выше рабочих процессов, см. раздел [Средства устранения неисправностей в развертываемых средах StorSimple](storsimple-troubleshoot-deployment.md#tools-for-troubleshooting-storsimple-deployments).
