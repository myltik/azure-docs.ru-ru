...
С помощью страницы **Каталог архивов** можно восстановить том устройства StorSimple из определенной резервной копии. Однако следует помнить, что в результате восстановления том вернется к состоянию, в котором он находился на момент резервного копирования. Любые данные, добавленные после операции резервного копирования, будут утрачены.
