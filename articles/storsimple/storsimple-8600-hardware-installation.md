---
title: Установка устройства StorSimple 8600 | Microsoft Docs
...
2. Прикрепите левые и правые рельсовые направляющие к вертикальным элементам стойки шкафа. Кронштейны отмечены **LH** (левый), **RH** (правый) и **This side up** (этой стороной вверх) для определения положения установки.
