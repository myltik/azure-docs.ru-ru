...
Теперь вы можете [развернуть и настроить локальное устройство StorSimple](storsimple-deployment-walkthrough.md).
