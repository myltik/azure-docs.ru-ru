<properties 
   pageTitle="Использование диспетчера моментальных снимков StorSimple для администрирования решения StorSimple | Microsoft Azure"
   description="Ссылки на дополнительные сведения о задачах администрирования и рабочих процессах, которые можно выполнить с помощью диспетчера моментальных снимков StorSimple."
   services="storsimple"
