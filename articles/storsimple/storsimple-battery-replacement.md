...
4. После замены откройте классической портал Azure, выберите **Устройства** > **Обслуживание** > **Состояние оборудования** и проверьте состояние аккумулятора, чтобы убедиться в том, что установка прошла успешно. Если горит зеленый индикатор, аккумулятор исправен.
