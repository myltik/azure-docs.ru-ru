...
Выполните указанные ниже действия, чтобы подключить, инициализировать и отформатировать тома Azure StorSimple. В данной процедуре используется «Управление дисками» — это системная служебная программа для управления жесткими дисками и их томами или разделами. Дополнительные сведения о служебной программе «Управление дисками» см. в статье [Управление дисками](https://technet.microsoft.com/library/cc770943.aspx) на веб-сайте Microsoft TechNet.
