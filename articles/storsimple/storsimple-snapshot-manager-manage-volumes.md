...
2. На панели **Область** щелкните правой кнопкой мыши узел **Тома** и выберите **Повторно сканировать тома**. По завершении сканирования на панели **Результаты** должен появиться список томов. Динамический зеркальный том будет указан как один том.
...
6. Щелкните правой кнопкой мыши имя группы томов.
    ...
    - Чтобы запланировать автоматическую архивацию, щелкните **Создать политику архивации**. На странице **Общие** выберите в списке группу томов. На странице **Расписание** введите подробные данные о расписании. Закончив, нажмите кнопку **ОК**.

7. Вы можете отслеживать ход выполнения задания архивации. На панели **Область** разверните узел **Задания**, а затем щелкните **Выполняются**. Информация о задании отобразится на панели **Результаты**. После завершения задания архивации информация о нем вносится в список заданий **За последние 24 часа**.
...
- Узнайте о [создании групп томов и управлении ими с помощью диспетчера моментальных снимков StorSimple](storsimple-snapshot-manager-manage-volume-groups.md).
