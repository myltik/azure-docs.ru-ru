...
> [!NOTE]
> Невозможно удалить том, который входит в какую-либо группу томов. (Параметр удаления недоступен для таких томов.) Чтобы удалить том, потребуется удалить всю группу томов.
> 
> 
