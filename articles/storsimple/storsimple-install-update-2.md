---
title: "Установка обновления 2 на устройство StorSimple | Документация Майкрософт"
...
## <a name="install-update-2-via-the-azure-classic-portal"></a>Установка обновления 2 с помощью классического портала Azure
...
1. Убедитесь, что на устройстве установлено **обновление 2 для StorSimple серии 8000 (6.3.9600.17673)**. Также должна измениться **Дата последнего обновления** . Вы также увидите, что доступны обновления режима обслуживания (это сообщение может отображаться до 24 часов после установки обновлений).
