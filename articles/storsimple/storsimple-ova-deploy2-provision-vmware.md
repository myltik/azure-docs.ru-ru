---
title: Развертывание виртуального массива StorSimple — подготовка в VMware
...
4. Сначала необходимо отправить файл VMDK на сервер ESXi. Перейдите на вкладку **Конфигурация** на панели справа. В списке **Hardware** \(Оборудование\) выберите пункт **Storage** \(Хранилище\).
...
8. На панели инструментов щелкните значок ![](./media/storsimple-ova-deploy2-provision-vmware/image7.png), чтобы создать новую папку. Укажите имя папки и запишите его. Это имя будет использоваться позднее при создании виртуальной машины \(рекомендуется\). Нажмите кнопку **ОК**.
...
10. Щелкните значок отправки ![](./media/storsimple-ova-deploy2-provision-vmware/image10.png) и выберите команду **Upload File** \(Отправить файл\).
    
    ![](./media/storsimple-ova-deploy2-provision-vmware/image11.png)
11. Теперь необходимо найти скачанные VMDK-файлы и указать их. Будет два файла. Выберите файл для передачи.
    
    ![](./media/storsimple-ova-deploy2-provision-vmware/image12m.png)
12. Щелкните **Открыть**. Начнется отправка файла VMDK в указанное хранилище данных. Отправка файла может занять несколько минут.
...
15. Отобразится окно **Create New Virtual Machine** \(Создание виртуальной машины\). На странице **Configuration** \(Конфигурация\) выберите параметр **Custom** \(Настраиваемая\). Нажмите кнопку **Next** \(Далее\).
...
34. Снова откроется страница свойств виртуальной машины. На виртуальную машину будет добавлен новый жесткий диск. Нажмите кнопку **Готово**
