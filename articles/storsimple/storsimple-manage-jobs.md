<properties 
   ...
   description="Описание страницы ";Задания"; службы диспетчера StorSimple и способов ее использования."
   services="storsimple"
...
- **Сущность** — задания могут быть связаны с томом, политикой резервного копирования или устройством. Задание клонирования связано с томом, тогда как запланированное задание резервного копирования связано с политикой резервного копирования. Задание устройства создается в результате аварийного восстановления (DR) или операции восстановления.
...
4. В диалоговом окне **Сведения о задании резервного копирования** можно просмотреть состояние, сведения, временную статистику и статистику по данным.
...
1. На странице **Задания** отобразите задания, которые нужно отменить, выполнив запрос с соответствующими фильтрами.
