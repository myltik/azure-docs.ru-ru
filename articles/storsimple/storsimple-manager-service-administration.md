...
||Устройства →|Мониторинг| ||Каталог резервных копий|Контейнеры томов→|Тома| ||Настройка (служба)|Политики резервного копирования|| ||Задания|Настройка (устройство)| ||Оповещения|Обслуживание|
