...
|Создать диаграммы мониторинга.|Служба диспетчера StorSimple → Устройства → Мониторинг|[Мониторинг устройства StorSimple](https://msdn.microsoft.com/library/azure/dn757759.aspx)|
...
-  [Обращение в службу поддержки Майкрософт](https://msdn.microsoft.com/library/azure/dn757750.aspx).
