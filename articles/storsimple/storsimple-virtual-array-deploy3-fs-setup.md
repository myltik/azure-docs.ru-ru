---
title: "Развертывание виртуального массива Microsoft Azure StorSimple — настройка в качестве файлового сервера | Документация Майкрософт"
...
3. На панели команд щелкните **Настроить**. Откроется колонка **Настройка**. В колонке **Настройка** выполните следующие действия.
    ...
    4. Щелкните **Настроить обязательные параметры**, чтобы указать данные учетной записи хранения, которую следует использовать с устройством. Щелкните **Добавить**, если учетная запись хранения не настроена.
