...
| Изменение ключа шифрования данных службы</br>Просмотреть журнал операций |[Использование панели мониторинга службы диспетчера устройств StorSimple](storsimple-8000-service-dashboard.md) |
