...
На классическом портале Azure выполните следующее.
...
Чтобы завершить минимальную настройку устройства, на классическом портале Azure выполните следующее.
...
Чтобы создать контейнер томов, на классическом портале Azure выполните следующее.

[AZURE.INCLUDE [storsimple-create-volume-container](../../includes/storsimple-create-volume-container.md)]

## Шаг 6. Создание тома

После того как вы создадите контейнер томов, вы сможете выделить на устройстве StorSimple том хранения для своих серверов. Чтобы создать том, на классическом портале Azure выполните следующее.
...
Чтобы создать запланированное резервное копирование, на классическом портале Azure выполните следующее.
...
Чтобы вручную запустить резервное копирование отдельного тома на устройстве StorSimple, на классическом портале Azure выполните следующее.
