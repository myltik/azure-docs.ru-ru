...
1. Перейдите в раздел **Состояние оборудования** и убедитесь, что состояние контроллеров на вашем устройстве — **Исправно**.
...
> [AZURE.IMPORTANT] Если требуется восстановить заводские настройки устройства по умолчанию, обратитесь в службу технической поддержки Майкрософт. Описанная ниже процедура должна применяться только при согласовании со службой технической поддержки Майкрософт.
...
1. В командной строке введите следующую команду, чтобы сбросить настройки всего кластера с удалением всех данных, метаданных и параметров контроллера:
