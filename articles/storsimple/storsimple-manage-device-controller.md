...
Эта процедура описывает, как восстановить заводские настройки по умолчанию на устройстве Microsoft Azure StorSimple с помощью Windows PowerShell для StorSimple. При сбросе настроек устройства будут удалены все данные и параметры из всего кластера по умолчанию.
...
1. В командной строке введите следующую команду, чтобы сбросить настройки всего кластера с удалением всех данных, метаданных и параметров контроллера:
    ...
    Сбросить один контроллер можно с помощью командлета [Reset-HcsFactoryDefault](http://technet.microsoft.com/library/dn688132.aspx) с параметром `-scope`.
