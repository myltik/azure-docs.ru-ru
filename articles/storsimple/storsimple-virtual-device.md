<properties 
   ...
   description="Создание, настройка, развертывание виртуального устройства StorSimple и управление им."
   services="storsimple"
   documentationCenter=""
   authors="alkohli"
   manager="adinah"
...
- Убедитесь, что ваша [учетная запись хранения](https://msdn.microsoft.com/library/1747f56e-858a-4cfe-a020-949d7db23b8b#sec01) находится в том же регионе, что и виртуальное устройство. Если учетные записи хранения находятся в разных регионах, это может привести к сильному понижению производительности.
...
Перед выполнением этих процедур убедитесь, что соблюдены [предварительные условия для виртуального устройства](https://msdn.microsoft.com/library/dn772572.aspx).

После завершения этих процедур вы сможете [работать с виртуальным устройством](https://msdn.microsoft.com/library/dn772527.aspx).
...
- Установите флажок, чтобы указать, что вы понимаете, что данные, сохраненные на виртуальном устройстве, будут размещены в центре обработки данных Майкрософт. При использовании только физического устройства ваш ключ шифрования сохраняется на устройстве, следовательно, Майкрософт не может расшифровать его. При использовании виртуального устройства ключ шифрования и ключ расшифровки хранятся в Microsoft Azure. Дополнительные сведения см. в статье [Рекомендации по безопасности при использовании виртуального устройства](https://msdn.microsoft.com/library/dn772561.aspx).
...
- Установите флажок, чтобы завершить первоначальную настройку и регистрацию виртуального устройства. Пароль диспетчера моментальных снимков и пароль администратора устройства предварительно заданы с использованием значений по умолчанию, и их следует изменить после регистрации устройства.
...
- [Контейнеры томов](https://msdn.microsoft.com/library/dn757817.aspx)

- [Тома](https://msdn.microsoft.com/library/dn772417.aspx)

- [Политики резервного копирования](https://msdn.microsoft.com/library/dn772382.aspx)
...
- **Автоматические обновления** — вы можете включать и отключать автоматическое обновление. Если автоматическое обновление включено, виртуальное устройство автоматически завершит работу и будет перезагружено (при необходимости) для применения выпущенных обновлений. Так как на виртуальном устройстве есть только один интерфейс, это означает, что при применении обновлений произойдет краткое прерывание в работе служб.
...
- Щелкните **Удалить** и удалите все диски виртуальной машины. <!--HONumber=52-->
