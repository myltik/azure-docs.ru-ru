...
1.  Скачайте соответствующий виртуальный жесткий диск (VHD- или VHDX-файл) в сетевую папку в центре обработки данных. Доступны отдельные образы:

	-   для Hyper-V 2012 и более поздней версии;
...
1.  Если вы используете Hyper-V, скачайте VHDX-файл для Hyper-V 2012 или Hyper-V 2008 R2 и более поздних версий. Если вы используете VMware, скачайте VMDK. VHDX-файл — это сжатый ZIP-файл, который имеет размер 4,77 ГБ. VHD-файл имеет размер 4,77 ГБ, а VMDK-файл — 4,75 ГБ. Скорость скачивания файла зависит от вашего подключения к Интернету.
