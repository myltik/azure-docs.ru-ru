...
Если вам нужно создать учетную запись хранения Azure в другом регионе, см. пошаговые инструкции в статье [Создание учетных записей хранения](storage-create-storage-account.md#create-a-storage-account).
