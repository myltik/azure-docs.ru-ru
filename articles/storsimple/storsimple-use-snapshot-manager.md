...
| Переключение отображения импорта |Щелкните правой кнопкой мыши верхний узел на панели **Область** (узел **StorSimple Snapshot Manager** в примерах). |Щелкните **Переключение отображения импорта** , чтобы показать или скрыть группы томов и связанные резервные копии, импортированные из панели мониторинга службы диспетчера StorSimple. |
