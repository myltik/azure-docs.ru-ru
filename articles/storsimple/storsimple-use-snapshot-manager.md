...
**Рисунок 1. Пользовательский интерфейс диспетчера моментальных снимков StorSimple**
...
**Рисунок 2. Строка меню диспетчера моментальных снимков StorSimple с выбранным меню "Вид"**
...
В следующей таблице описаны элементы меню "Файл".
...
Чтобы просмотреть меню **Действие**, выполните одно из следующих действий.
...
Например, если выбрать верхний узел на панели **Область** и щелкнуть правой кнопкой мыши или просто щелкнуть **Действие** в строке меню, появится следующее меню.
...
- В столбце **Навигации** описано, как отобразить соответствующее меню **Действие**, в котором вы можете выбрать действие. Некоторые действия отображаются в нескольких меню **Действие**. Для этих действий необходимо выбрать один параметр **Навигация** в маркированном списке.
...
|:--------|:------------|:-------------|
| Проверка подлинности | Выберите узел **Устройства** и щелкните правой кнопкой мыши устройство на панели **Результаты**. | Щелкните **Проверка подлинности**, чтобы ввести пароль, который вы настроили для устройства. |
...
| Создать политику архивации | Выполните одно из следующих действий.<ul><li>Щелкните правой кнопкой мыши **Политики архивации**.</li><li>Щелкните или разверните узел **Группы томов**, а затем щелкните правой кнопкой мыши группу томов.</li><li>Щелкните или разверните узел **Каталог архивов**, а затем щелкните правой кнопкой мыши группу томов.</li></ul> | Щелкните **Создать политику архивации**, чтобы настроить архивацию по расписанию для группы томов. |
| Создать группу томов | Выполните одно из следующих действий.<ul><li>Щелкните узел **Тома**, а затем щелкните правой кнопкой мыши том на панели **Результаты**.</li><li>Щелкните правой кнопкой мыши узел **Группы томов**.</li></ul> | Щелкните **Создать группу томов**, чтобы назначить тома группе томов. |
...
| Редактирование | Щелкните**Политики архивации**, а затем щелкните правой кнопкой мыши политику на панели **Результаты**. | Щелкните **Изменить**, чтобы изменить расписание архивации для группы томов. |
...
Меню **Вид** позволяет создать пользовательское представление содержимого панели **Результаты**. Меню **Вид** содержит параметры **Добавить или удалить столбцы** и **Настроить**.
...
В следующей таблице описаны элементы меню **Вид**.
...
Меню **Избранное** используется для добавления, удаления и упорядочивания представлений страниц и задач, которые часто используются.
...
В следующей таблице описаны элементы меню **Избранное**.
...
Меню **Окно** используется для добавления и переупорядочивания окон консоли диспетчера моментальных снимков StorSimple.
...
| ![Значок "Вверх"](./media/storsimple-use-snapshot-manager/HCS_SSM_Up.png) | Щелкните значок "Вверх", чтобы перейти на один уровень вверх в дереве консоли (на панели **Область**). |
| ![Показать/скрыть дерево консоли](./media/storsimple-use-snapshot-manager/HCS_SSM_ShowConsoleTree.png) | Щелкните значок "Показать/скрыть дерево консоли", чтобы отобразить или скрытия панель **Область**. |
...
| ![Показать/скрыть панель "Действия"](./media/storsimple-use-snapshot-manager/HCS_SSM_ShowAction.png) | Щелкните значок отображения или сокрытия панели **Действия**, чтобы показать или скрыть панель **Действия**. 
...
Панель **Область** включает ряд объектов (узлов), упорядоченных в виде древовидной структуры, которые можно щелкать.

![Панель "Область"](./media/storsimple-use-snapshot-manager/HCS_SSM_Scope_pane.png)

**Рисунок 10. Панель "Область" диспетчера моментальных снимков StorSimple**
...
Узел **Задания** содержит сведения о запланированных, запущенных и недавно завершенных заданий архивации.
...
Чтобы просмотреть следующий пример, щелкните узел **Группы томов** на панели **Область**. На панели **Результаты** отобразится список групп томов с подробными сведениями о каждой группе.
...
**Рисунок 12. Панель "Действия" (запланированные задания) в диспетчере моментальных снимков StorSimple**
...
В следующих таблицах приведены сочетания клавиш для каждого узла на панели **Область**.
