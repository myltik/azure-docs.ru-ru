---
title: "Восстановление из резервной копии виртуального массива StorSimple (предварительная версия)"
...
## <a name="restore-shares-from-a-backup-set"></a>Восстановление общих папок из набора архивации
...
#### <a name="to-restore-a-share"></a>Восстановление общей папки
...
2. В отображенном списке наборов архивации щелкните и выберите определенную резервную копию. Разверните резервную копию, чтобы увидеть общие папки, которые она содержит. Щелкните и выберите общую папку, которую нужно восстановить.
3. В нижней части страницы щелкните **Восстановить в качестве новой**.
4. Запустится мастер **Восстановление как нового общего файлового ресурса** . На странице **Указание имени и расположения** выполните следующее.
...
5. По завершении задания начнется восстановление и появится другое уведомление. Чтобы проконтролировать ход восстановления, щелкните **Просмотреть задание**. После этого вы перейдете на страницу **Задания** .
6. Здесь вы можете проследить за выполнением задания восстановления. Когда восстановление будет завершено на 100 %, перейдите на страницу **Общие файловые ресурсы** устройства.
7. Теперь вы можете просмотреть восстановленную общую папку в списке общих папок на устройстве. Обратите внимание, что после восстановления у общей папки будет тот же тип. Многоуровневая общая папка будет восстановлена в качестве многоуровневой общей папки, а локально закрепленная общая папка — в качестве локально закрепленной.

Настройка устройства завершена. Теперь вы знаете, как создать резервную копию общей папки и восстановить ее. 

## <a name="restore-volumes-from-a-backup-set"></a>Восстановление томов из набора архивации
...
3. В нижней части страницы щелкните **Восстановить в качестве новой**. Запустится мастер **Восстановление как нового тома** .
4. На странице **Указание имени и расположения** выполните следующее.
...
5. На странице **Указание узлов, которые могут использовать этот том** из раскрывающегося списка выберите соответствующие ACR.
   
   ![](./media/storsimple-ova-restore/image13.png)
6. Щелкните значок галочки ![](./media/storsimple-ova-restore/image1.png). Это запустит задание восстановления, и вы увидите уведомление о том, что задание выполняется.
7. По завершении задания начнется восстановление и появится другое уведомление. Чтобы проконтролировать ход восстановления, щелкните **Просмотреть задание**. После этого вы перейдете на страницу **Задания** .
8. Здесь вы можете проследить за выполнением задания восстановления. Вернитесь на страницу **Тома** устройства.
9. Теперь вы можете просмотреть восстановленный том в списке томов на устройстве. Обратите внимание, что после восстановления у тома будет тот же тип. Многоуровневый том будет восстановлен в качестве многоуровневого тома, а локально закрепленный том — в качестве локально закрепленного.
10. Как только том появится в списке томов в сети, он будет доступен для использования.  На узле инициатора iSCSI обновите список целей в окне свойств инициатора iSCSI.  Новая цель, которая содержит имя восстановленного тома, должна иметь значение "Неактивна" в столбце состояния.
11. Выберите цель и щелкните **Подключиться**.   После подключения инициатора к цели состояние должно измениться на **Подключено**. 
12. В окне **Управление дисками** подключенные тома отображаются так, как показано на следующем рисунке. Щелкните правой кнопкой мыши обнаруженные тома (щелкните имя диска) и выберите пункт **Подключить**.
...
![video_icon](./media/storsimple-ova-restore/video_icon.png) **Доступно видео**
