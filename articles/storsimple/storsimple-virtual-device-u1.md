...
- Вы можете создать [виртуальные машины Azure](https://msdn.microsoft.com/library/azure/jj156003.aspx) (серверы узла) в виртуальной сети, которые могут использовать тома, предоставляемые виртуальным устройством. Эти серверы должны соответствовать следующим требованиям. 							
...
- В диалоговом окне **Создание виртуального устройства** укажите следующее:
	...
	b. **Версия** — выберите версию виртуального устройства. Этот параметр будет отсутствовать, если вы зарегистрировали в службе только физические устройства с обновлением 1 (или более поздней версией). Он будет отображаться, только если вы зарегистрировали в службе физические устройства как с предварительным обновлением 1, так и с обновлением 1. При наличии версии виртуального устройства вы сможете определить, с какого физического устройства можно выполнить отработку отказа или клонирование. Важно создать соответствующую версию виртуального устройства. Выбор:
	...
	- Обновление до версии 1 при отработке отказа или клонировании с физического устройства с обновлением 1 (или более поздней версией). 
...
1. Выберите **Виртуальное устройство StorSimple**, созданную на странице "Устройства". 
...
- Введите пароли диспетчера моментальных снимков и администратора устройства, соответствующие заданным параметрам и длине.

- Установите флажок, чтобы завершить первоначальную настройку и регистрацию виртуального устройства.
