...
В учебниках о замене компонентов оборудования описаны компоненты оборудования устройства Microsoft Azure StorSimple и шаги, необходимые для их снятия и замены. В этой статье описываются значки безопасности, содержатся ссылки на подробные учебники и перечислены компоненты, которые можно заменить.
