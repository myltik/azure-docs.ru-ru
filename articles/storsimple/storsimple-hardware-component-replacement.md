...
В учебниках о замене компонентов оборудования описаны компоненты оборудования устройства Microsoft Azure StorSimple и шаги, необходимые для снятия и замены компонентов. В этих учебниках вы узнаете, какие компоненты можно заменить и как их заменить.

Перед снятием или заменой любого компонента StorSimple обязательно ознакомьтесь с [условными обозначениями сведений о безопасности](#safety-icon-conventions) и другими [мерами безопасности](storsimple-safety.md).
 
### Условные обозначения сведений о безопасности

В следующей таблице описаны условные обозначения сведений о безопасности, используемые в данном руководстве. Обращайте пристальное внимание на эти условные обозначения при выполнении действий по снятию и замене компонентов устройства.
...
Ознакомьтесь со сведениями безопасности для вашего устройства и условными обозначениями сведений о безопасности, используемыми в данном руководстве. Для получения подробной информации обратитесь к статье [Безопасность устройства](storsimple-safety.md). Перед обращением с устройством StorSimple ознакомьтесь с [Мерами безопасности](storsimple-safety.md#handling-precautions).
...
## Компоненты оборудования устройства

Устройство Microsoft Azure StorSimple состоит из нескольких подключаемых модулей в основном корпусе и/или в корпусе EBOD. В модели 8100 используется только один основной корпус, тогда как в модели 8600 два корпуса: основной и корпус EBOD.
...
**Рис. 2**. Задняя поверхность основного корпуса
...
**Рис. 3**. Задняя поверхность корпуса EBOD
...
Пожалуйста, [обратитесь в службу поддержки Microsoft](storsimple-contact-microsoft-support.md) для заказа любых из этих запасных частей.

## Дальнейшие действия

Перед заменой компонентов оборудования StorSimple ознакомьтесь со всей [информацией по безопасности](storsimple-safety.md).
