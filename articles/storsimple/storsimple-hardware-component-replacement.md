...
# <a name="storsimple-hardware-component-replacement"></a>Замена компонентов оборудования StorSimple
...
>[AZURE.IMPORTANT] Перед снятием или заменой любого компонента StorSimple обязательно ознакомьтесь с [условными обозначениями сведений о безопасности](#safety-icon-conventions) и другими [мерами предосторожности](storsimple-safety.md).
...
|Компоненты|# Присутствует|Подключаемый модуль?|Процедура замены
|:---------|:--------|:--------------|:---------------------|
