---
title: Замена контроллера EBOD на устройстве StorSimple | Microsoft Docs
...
> [!IMPORTANT]
> Перед снятием или заменой любого компонента StorSimple обязательно ознакомьтесь с [условными обозначениями сведений о безопасности](storsimple-safety.md#safety-icon-conventions) и другими [мерами безопасности](storsimple-safety.md).
> 
> 
