<properties 
   pageTitle="Развертывание локального устройства StorSimple (с обновлением 2) | Microsoft Azure"
...
| [Шаг 4. Завершение минимальной настройки устройства](#step-4-complete-minimum-device-setupd).</br>[Необязательно: обновление устройства StorSimple](#scan-for-and-apply-updates). | С помощью службы управления завершите настройку устройства и включите на нем возможность хранения данных. |
...
> [AZURE.IMPORTANT]StorSimple Manager может создавать тома с тонкой и полной подготовкой. Однако тома с частичной подготовкой создать нельзя.
