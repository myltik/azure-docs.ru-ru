<properties 
   ...
   description="Описание устройства StorSimple, виртуального устройства, служб и технологий управления и определения основных терминов, используемых в решении." 
   services="storsimple" 
...
# Что представляют собой компоненты StorSimple и как они работают? 
...
- В настоящее время установка обновлений к виртуальному устройству отключена. Если вам необходимо виртуальное устройство с последней версией, вы можете создать новое и перенести контейнеры томов на новое виртуальное устройство.
...
Узнайте подробнее об [обеспечении безопасности StorSimple](storsimple-security.md).
