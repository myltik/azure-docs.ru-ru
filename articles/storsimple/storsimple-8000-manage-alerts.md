...
4. Вы видите уведомление об отправке тестового сообщения электронной почты. 
   ...
   > [!NOTE]
   > Если не удается отправить тестовое уведомление, служба диспетчера устройств StorSimple отобразит соответствующее сообщение об ошибке. Подождите несколько минут и повторите попытку отправки тестового сообщения уведомления. 
