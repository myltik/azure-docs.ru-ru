...
5. Убедитесь, что замена выполнена успешно, и диск работоспособен. Перейдите на портал Azure и выберите **Параметры** > **Работоспособность оборудования**. В разделах **Общие компоненты** или **Общие компоненты EBOD** состояние диска должно быть обозначено зеленым. Это указывает на работоспособность диска.
