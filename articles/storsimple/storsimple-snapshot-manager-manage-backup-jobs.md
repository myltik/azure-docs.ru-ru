---
title: Задания архивации диспетчера моментальных снимков StorSimple | Microsoft Docs
...
2. На панели **Область** разверните узел **Задания** и щелкните **Запланированные**. На панели **Результаты** отобразятся следующие сведения.
   ...
   * **Последнее выполнение**: дата и время последнего запланированного моментального снимка
     ...
     > [!NOTE]
     > Если моментальный снимок создается только один раз, значения параметров **Следующее выполнение** и **Последнее выполнение** будут совпадать.
     > 
     > 
