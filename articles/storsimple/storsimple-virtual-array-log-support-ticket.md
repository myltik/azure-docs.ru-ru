---
title: "Диспетчер устройств StorSimple — регистрация запроса в службу поддержки для виртуального массива Microsoft Azure StorSimple | Документация Майкрософт"
