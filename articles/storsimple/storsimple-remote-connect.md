...
Дополнительные сведения об использовании удаленного взаимодействия Windows PowerShell для управления устройством см. в статье [Администрирование устройства с помощью Windows PowerShell для StorSimple](storsimple-windows-powershell-administration.md).
...
Для настройки удаленного управления можно использовать портал управления или последовательную консоль. Выберите одну из следующих процедур:

- [Включение удаленного управления по протоколу HTTP с помощью портала управления](#use-the-management-portal-to-enable-remote-management-over-http)
...
### Включение удаленного управления по протоколу HTTP с помощью портала управления 

Для включения удаленного управления по протоколу HTTP выполните следующие действия в портале управления.

#### Включение удаленного управления с помощью портала управления
...
- [Включение удаленного управления по протоколу HTTPS с помощью портала управления](#use-the-management-portal-to-enable-remote-management-over-https)
...
### Включение удаленного управления по протоколу HTTPS с помощью портала управления

Для включения удаленного управления по протоколу HTTPS выполните следующие действия в портале управления.
