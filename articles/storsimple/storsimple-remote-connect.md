...
- [Включение удаленного управления по протоколу HTTP с помощью портала Azure](#use-the-azure-portal-to-enable-remote-management-over-http)
...
Для включения удаленного управления по протоколу HTTP выполните следующие действия на портале Azure.

#### Включение удаленного управления с помощью портала Azure
...
- [Включение удаленного управления по протоколу HTTPS с помощью портала Azure](#use-the-azure-portal-to-enable-remote-management-over-https)
...
Для включения удаленного управления по протоколу HTTPS выполните следующие действия на портале Azure.

#### Включение удаленного управления по протоколу HTTPS на портале Azure
