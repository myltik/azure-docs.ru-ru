...
В устройствах StorSimple, как 8100, так и 8600, используются как жесткие диски, так и твердотельные накопители. Общая доступная емкость для 8100 и 8600 составляет примерно 15 ТБ и 40 ТБ соответственно. В следующей таблице приведены сведения о емкости твердотельных накопителей, жестких дисков и облачного хранилища в контексте емкости решения StorSimple.
...
| Общая доступная емкость* | ~ 15 ТБ | ~ 40 ТБ |
