...
1. Запрос на техническую поддержку можно создать с помощью [портала управления](http://manage.windowsazure.com/). На [портале управления](http://manage.windowsazure.com/) щелкните **имя своей учетной записи** и затем элемент **Обратитесь в службу технической поддержки Майкрософт**.
