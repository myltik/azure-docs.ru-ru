...
1. Запрос на техническую поддержку можно создать с помощью [классического портала Azure](https://manage.windowsazure.com/). На [классическом портале](https://manage.windowsazure.com/) щелкните **имя своей учетной записи**, а затем — элемент **Обратитесь в службу технической поддержки Майкрософт**.
