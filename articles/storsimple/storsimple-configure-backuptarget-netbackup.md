...
4.  Введите имя целевого объекта архивации, а затем дважды нажмите кнопку **Далее**,  > ****чтобы завершить работу мастера.
...
1.  [Установите Azure PowerShell](https://docs.microsoft.com/en-us/powershell/azureps-cmdlets-docs/#install-and-configure).
