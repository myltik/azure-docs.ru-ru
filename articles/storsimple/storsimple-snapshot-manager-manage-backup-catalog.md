...
Основная функция диспетчера моментальных снимков StorSimple — создание согласованных с приложением резервных копий томов Azure StorSimple в форме моментальных снимков. Затем моментальные снимки перечисляются в XML-файле, который называется *каталогом резервных копий*. Моментальные снимки в каталоге резервных копий упорядочиваются по группе томов, а затем — по локальному или облачному моментальному снимку.
