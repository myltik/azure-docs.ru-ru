...
description: "Описание условий срабатывания оповещений StorSimple и уровней их серьезности, описание порядка настройки отправки уведомлений об оповещениях, а также того, как использовать службу StorSimple Manager для управления оповещениями."
services: storsimple
...
> [!NOTE]
> Классический портал StorSimple устарел. Диспетчеры устройств StorSimple автоматически перейдут на новый портал Azure в соответствии с графиком устаревания. Вы получите сообщение электронной почты и уведомление с портала, касающиеся этого перехода. Этот документ скоро также перестанет использоваться. Чтобы просмотреть версию этой статьи для нового портала Azure, перейдите к статье [Использование службы диспетчера устройств StorSimple для просмотра оповещений StorSimple и управления ими](storsimple-8000-manage-alerts.md). Сведения, связанные с переходом, см. в [ответах на вопросы о перемещении на портал Azure](storsimple-8000-move-azure-portal-faq.md).

## <a name="overview"></a>Обзор
Вкладка **Оповещения** в службе StorSimple Manager предоставляет способ для просмотра и удаления оповещений, связанных с устройством StorSimple, на основе данных в режиме реального времени. На этой вкладке можно централизованно отслеживать проблемы работоспособности устройств StorSimple и всего решения Microsoft Azure StorSimple.
...
3. Чтобы отправить тестовое уведомление по электронной почте, щелкните значок стрелки рядом с полем **Отправить тестовое электронное сообщение**. Служба StorSimple Manager отобразит сообщения о состоянии по мере отправки тестового уведомления. 
4. Когда появится следующее сообщение, нажмите кнопку **ОК**. 
   ...
   > [!NOTE]
   > Если не удается отправить тестовое сообщение уведомления, служба StorSimple Manager отобразит соответствующее сообщение. Щелкните **ОК**, подождите несколько минут и повторите попытку отправки тестового сообщения уведомления. 
   > 
   > 

## <a name="view-and-track-alerts"></a>Просмотр и отслеживание оповещений
Панель мониторинга службы StorSimple Manager предоставляет быстрый обзор количества оповещений на устройствах, упорядоченных по степени серьезности.
...
| Обнаружен приближающийся сбой диска. | Обнаружен приближающийся сбой диска. |Система обнаружила приближение сбоя у диска аппаратного компонента "Диск в слоте *идентификатор_слота* в корпусе *идентификатор_корпуса*". Попробуйте заменить диск. <br> Перед заменой диска ознакомьтесь со следующей информацией.<br><br>Если на устройстве несколько неисправных дисков, не извлекайте сразу несколько дисков SSD или жестких дисков. Это может привести к потере данных.<br><br>Убедитесь, что новый SSD устанавливается в слот, в котором ранее находился SSD. То же самое касается и жестких дисков.<br><br>Слоты пронумерованы от 0 до 11. Неисправный диск в слоте 2 сопоставлен с неисправным диском в слоте 3 устройства (начиная с левого верхнего угла).<br><br>Дополнительные сведения о замене дисков: https://go.microsoft.com/fwlink/?linkid=838653. Если проблему не удается устранить, обратитесь в службу поддержки Майкрософт: https://go.microsoft.com/fwlink/?linkid=838654. |
