<properties 
   pageTitle="Просмотр оповещений StorSimple и управление ими"
...
1. Выполните для устройства команду **Устройства** > **Настроить**.

2. В разделе **Параметры оповещений** задайте следующее.

    1. В поле **ОТПРАВКА УВЕДОМЛЕНИЙ ПО ЭЛЕКТРОННОЙ ПОЧТЕ** выберите **ДА**.

    2. В поле **АДМИНИСТРАТОРЫ СЛУЖБЫ ЭЛЕКТРОННОЙ ПОЧТЫ** выберите **Да**, если вы хотите, чтобы администратор службы и все дополнительные администраторы получали уведомления об оповещениях.
...
Можно скопировать сведения об оповещении в текстовый файл, если вы хотите отслеживать разрешения оповещения в отдельном файле или если необходимо отправить их в службу технической поддержки Майкрософт. После разрешения условия оповещения следует удалить оповещения с устройства, выбрав оповещение в разделе **Оповещение** и нажав кнопку **Очистить**. Чтобы удалить несколько оповещений, удерживайте нажатой клавишу Ctrl, выберите оповещения и нажмите кнопку**Очистить**. Обратите внимание, что некоторые оповещения автоматически удаляются при устранении проблемы или когда система обновляет оповещения новыми данными.
...
|Не удается автоматически проверять наличие новых обновлений.|Сбой автоматической проверки.|Можно вручную проверить наличие новых обновлений на странице **Обслуживание**.|
...
|Версия компонента встроенного ПО <\*идентификатор компонента\*> не совпадает с оборудованием.|Обновления встроенного ПО не были успешно установлены.|Обратитесь в службу поддержки Майкрософт.|

## Дальнейшие действия

[Узнайте о больше об ошибках StorSimple](storsimple-troubleshoot-operational-device.md).
