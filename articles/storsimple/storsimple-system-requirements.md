...
> [AZURE.IMPORTANT]Убедитесь, что брандмауэр не изменяет и не дешифрует SSL-трафик между устройством StorSimple и Azure.
...
- Изолируйте iSCSI и облачный трафик, получив выделенные сетевые интерфейсы на устройстве для доступа к iSCSI и облаку. Дополнительные сведения см. в разделе об [изменении сетевых интерфейсов](storsimple-modify-device-config.md#modify-network-interfaces) на устройстве StorSimple.

- Не используйте конфигурацию протокола LACP для сетевых интерфейсов. Эта конфигурация не поддерживается.

## Дальнейшие действия

- [Узнайте больше о системных ограничениях StorSimple](storsimple-limits.md).
- [Узнайте больше о развертывании решения StorSimple](storsimple-deployment-walkthrough.md).
