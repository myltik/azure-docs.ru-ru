...
> - Если дополнительно выполняется StorSimple Snapshot Manager, то перед обновлением устройства убедитесь, что для версии Snapshot Manager установлено обновление 3.
