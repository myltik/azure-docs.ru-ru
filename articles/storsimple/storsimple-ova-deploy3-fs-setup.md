...
6. На странице **Параметры устройства** :
   ...
   2. Чтобы выбрать **тип** создаваемого устройства, щелкните значок ![](./media/storsimple-ova-deploy3-fs-setup/image6.png), обозначающий **файловый сервер**. На файловом сервере можно создавать общие папки.
