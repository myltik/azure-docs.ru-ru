...
В этом учебнике описывается настройка CHAP для устройства StorSimple. CHAP — сокращение от Challenge Handshake Authentication Protocol (протокол проверки подлинности на основе вызова). Это схема проверки подлинности, используемая серверами для проверки удаленных клиентов. Проверка выполняется на основе общего пароля или секрета.
...
2. В окне **Свойства инициатора iSCSI** выполните указанные ниже действия.
	...
	2. Щелкните **Обнаружение портала**.
...
2. Прокрутите страницу вниз и в разделе **Конечный объект CHAP**
