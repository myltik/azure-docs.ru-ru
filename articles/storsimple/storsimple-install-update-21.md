...
**Если на устройстве установлено обновление 2.1**, то необходимо скачать только обновление ПО устройства KB3179904. Установите только двоичный файл, имя которого начинается с all-hcsmdssoftwareudpate. Не устанавливайте обновление агента Cis и MDS, имя которого начинается с `all-cismdsagentupdatebundle`. В противном случае произойдет сбой.
...
|--------|-----------|-------------------------|------------- |-------------|
| 1\. | KB3179904 | Обновление программного обеспечения &#42; | Обычный | ~ 45 мин |
