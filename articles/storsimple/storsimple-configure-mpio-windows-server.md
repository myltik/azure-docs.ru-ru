<properties 
   pageTitle="Настройка MPIO для устройства StorSimple"
   description="Настройка MPIO для устройства StorSimple, подключенного к узлу, работающему под управлением Windows Server 2012 R2"
   services="storsimple"
   documentationCenter=""
   authors="alkohli"
   manager="adinah"
...
4. Повторите шаги 2–3 для установки второго сетевого интерфейса (например, DATA 1) на устройстве. Помните, что эти интерфейсы должны поддерживать iSCSI. Дополнительные сведения об этом см. в разделе [Настройка сетевых интерфейсов](https://msdn.microsoft.com/library/02f1412f-e196-4a88-8eda-2113247ea47c#sec05).
