...
> [!NOTE]
> Классический портал StorSimple устарел. Диспетчеры устройств StorSimple автоматически перейдут на новый портал Azure в соответствии с графиком устаревания. Вы получите сообщение электронной почты и уведомление с портала, касающиеся этого перехода. Этот документ скоро также перестанет использоваться. Чтобы просмотреть версию этой статьи для нового портала Azure, перейдите к статье [Настройка функции Multipath I/O для устройства StorSimple](storsimple-8000-configure-mpio-windows-server.md). Сведения, связанные с переходом, см. в [ответах на вопросы о перемещении на портал Azure](storsimple-8000-move-azure-portal-faq.md).
...
6. В диалоговом окне **Добавление поддержки многопутевого ввода-вывода** в разделе **Код оборудования** введите серийный номер устройства. Серийный номер устройства можно узнать с помощью службы StorSimple Manager и на вкладке **Устройства > Панель мониторинга**. Серийный номер устройства отображается в правой области **Краткий обзор** панели мониторинга устройства.
...
15. В диалоговом окне модели StorSimple #### **Multi-Path Disk Device Properties** (Свойства устройства многопутевого диска) перейдите на вкладку **MPIO**. ![Свойства многопутевого диска StorSimple 8100.](./media/storsimple-configure-mpio-windows-server/IC741009.png)
...
Дополнительные сведения см. в статье [Использование службы StorSimple Manager для изменения конфигурации устройства StorSimple](storsimple-modify-device-config.md).
