...
Общие сведения о всей системе Microsoft Azure StorSimple, включая устройство StorSimple, службу диспетчера StorSimple, диспетчер моментальных снимков StorSimple и адаптер StorSimple для SharePoint, см. в статье [Что такое StorSimple?](storsimple-overview.md) и [Каковы компоненты StorSimple?](storsimple-components.md).
...
Диспетчер моментальных снимков StorSimple позволяет монтировать тома, а затем объединять их в группы, как правило,, по приложениям. Диспетчер моментальных снимков StorSimple использует эти группы томов для создания резервных копий, согласованных между приложениями (согласованность приложений имеет место, когда все связанные файлы и базы данных синхронизированы и представляют фактическое состояние приложения в определенный момент времени).
...
**Рисунок 1. Архитектура диспетчера моментальных снимков StorSimple**
...
**Рисунок 2. Процесс службы теневого копирования томов Windows**
...
[Дополнительные сведения о задачах и рабочих процессах диспетчера моментальных снимков StorSimple](storsimple-snapshot-manager-admin.md)
