<properties 
   pageTitle="Как выполнить отработку отказа для устройства StorSimple"
...
1. После завершения отработки отказа, перейдите на страницу **Устройства**.
	...
	b. Перейдите на страницу **Контейнеры томов**. Здесь должны отобразиться все контейнеры томов, а также тома со старого устройства.


## Дополнительные материалы
После отработки отказа может потребоваться:

- [деактивировать устройство StorSimple](https://msdn.microsoft.com/library/azure/dn772379.aspx#deactivate);
- [удалить устройство StorSimple](https://msdn.microsoft.com/library/azure/dn772379.aspx#delete);
