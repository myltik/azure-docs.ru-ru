...
- Задания удаления для каждого контейнера томов (отработка отказа) отображаются на странице **Задания**. Время выполнения операции удаления контейнеров томов зависит от объема данных в этих контейнерах. Если вы планируете выполнить тестовую отработку отказа или тестовое восстановление размещения, то рекомендуем использовать для тестирования контейнеры томов с меньшим объемом данных (ГБ).

- По завершении всех заданий удаления можно выполнить восстановление размещения.
