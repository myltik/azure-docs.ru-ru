...
- При выполнении отработки отказа между устройствами после аварийного восстановления моментальные снимки, используемые для восстановления данных, выбираются следующим образом.
	1.  	Определите политику архивации с наибольшим числом томов.
	2.  	Выберите последний удачный облачный моментальный снимок для этой политики архивации и используйте его для восстановления данных на устройство восстановления.
...
1. В открывшемся окне мастера в разделе **Выберите контейнер томов для отработки отказа**:
	...
	1. В списке контейнеров томов выберите контейнеры томов, для которых следует выполнить отработку отказа.
		...
		>[AZURE.NOTE] **Отображаться будут только контейнеры томов со связанными облачными моментальными снимками и тома в автономном режиме.** <br></br>
