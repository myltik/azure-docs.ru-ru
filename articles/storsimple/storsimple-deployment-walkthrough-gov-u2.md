---
title: Развертывание устройства StorSimple на портале государственных организаций | Microsoft Docs
...
| [Шаг 3. Настройка и регистрация устройства средствами Windows PowerShell для StorSimple.](step 3-configure-and-register-the-device-through-windows-powershell-for-storsimple.md) |Подключите устройство к сети и зарегистрируйте его в Azure, чтобы завершить установку с помощью службы управления. |
...
> [!IMPORTANT]
> Azure StorSimple может создать только тома с тонкой подготовкой. Вы не можете создавать полностью или частично подготовленные тома в системе Azure StorSimple.
> 
> 
...
[!INCLUDE [Подключение к последовательной консоли устройства с помощью PuTTY](../../includes/storsimple-use-putty.md)]
...
[!INCLUDE [Создание резервной копии вручную](../../includes/storsimple-get-iqn.md)]
...
[!INCLUDE [Создание резервной копии вручную](../../includes/storsimple-create-manual-backup-gov.md)]
