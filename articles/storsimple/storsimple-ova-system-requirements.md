...
| Минимальная пропускная способность Интернета<sup>2</sup> | 5 Мбит/с |
...
| UDP 123 (NTP) | Исходящий | WAN | В некоторых случаях. См. примечания. | Этот порт требуется, только если вы используете веб-NTP-сервер.<br></br> **Примечание**. При развертывании файлового сервера советуем синхронизировать время с контроллерами домена Active Directory. |
