...
5. На вкладке **Расписание** введите указанные ниже данные.
   ...
   1. Установите флажок **Включить**, чтобы запланировать следующую операцию архивации.
...
После создания политики архивации на панели **Результаты** отобразятся указанные ниже сведения.

- **Имя**: имя политики архивации.

- **Тип**: тип моментального снимка (локальный или облачный).

- **Группы томов**: группа томов, связанная с политикой.
...
3. Щелкните правой кнопкой мыши политику, в которую нужно внести изменения, и выберите пункт **Изменить**.
...
3. Щелкните правой кнопкой мыши политику архивации, которую нужно удалить, и выберите пункт **Удалить**.
