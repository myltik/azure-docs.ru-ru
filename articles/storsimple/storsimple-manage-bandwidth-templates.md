...
1. Откройте службу диспетчера StorSimple и на странице **Настройка** щелкните **add/edit bandwidth template** (Добавить или изменить шаблон пропускной способности).
