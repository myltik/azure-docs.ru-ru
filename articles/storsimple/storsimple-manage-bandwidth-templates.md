---
title: Управление шаблонами пропускной способности StorSimple | Microsoft Docs
...
3. Задайте **расписание пропускной способности**. Чтобы создать расписание, выполните следующие действия.
   ...
   4. В раскрывающемся списке выберите **Время окончания**. Это время завершения расписания.
      ...
      > [!NOTE]
      > Пересечения временных интервалов не допускаются. Если начальное и конечное время таковы, что в расписании появляются пересекающиеся временные интервалы, будет выдано соответствующее сообщение об ошибке.
      > 
      > 
