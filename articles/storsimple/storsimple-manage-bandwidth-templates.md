...
1. В табличном списке шаблонов пропускной способности для службы выберите шаблон, который вы хотите удалить. Значок удаления (**x**) будет отображаться справа от выбранного шаблона. Щелкните значок **x**, чтобы удалить шаблон.
