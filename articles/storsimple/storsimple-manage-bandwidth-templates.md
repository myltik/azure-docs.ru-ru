---
title: "Управление шаблонами пропускной способности StorSimple | Документация Майкрософт"
...
---
# <a name="use-the-storsimple-manager-service-to-manage-storsimple-bandwidth-templates"></a>Использование службы StorSimple Manager для управления шаблонами пропускной способности StorSimple
> [!NOTE]
> Классический портал StorSimple устарел. Диспетчеры устройств StorSimple автоматически перейдут на новый портал Azure в соответствии с графиком устаревания. Вы получите сообщение электронной почты и уведомление с портала, касающиеся этого перехода. Этот документ скоро также перестанет использоваться. Чтобы просмотреть версию этой статьи для нового портала Azure, перейдите к статье [Использование службы диспетчера устройств StorSimple для управления шаблонами пропускной способности StorSimple](storsimple-8000-manage-bandwidth-templates.md). Сведения, связанные с переходом, см. в [ответах на вопросы о перемещении на портал Azure](storsimple-8000-move-azure-portal-faq.md).
...
Для управления шаблонами пропускной способности можно использовать страницу **Настройка** службы StorSimple Manager на классическом портале Azure.
...
1. Откройте службу StorSimple Manager и на странице **Настройка** щелкните **add/edit bandwidth template** (Добавить или изменить шаблон пропускной способности).
...
3. Задайте **расписание пропускной способности**. Чтобы создать расписание, выполните следующие действия.
   ...
   2. Выберите параметр **Весь день** , если расписание применимо ко всему дню. Если он задан, то вам больше не нужно указывать **Время начала** и **Время окончания**. Расписание будет выполняться с 00:00 до 23:59.
...
3. Чтобы сохранить изменения, в нижней части страницы щелкните **Сохранить** . Щелкните **Да** при запросе на подтверждение.

> [!NOTE]
> Вы не сможете сохранить свои изменения, если отредактированное расписание перекрывает существующее в изменяемом шаблоне пропускной способности.
> 
> 
