...
Для управления шаблонами пропускной способности можно использовать страницу **Настройка** службы диспетчера StorSimple на классическом портале Azure. Самые распространенные задачи, связанные с шаблонами пропускной способности, которые можно выполнить на этой странице:
