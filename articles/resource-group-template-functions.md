...
Сведения о получении значений параметров, переменных или текущего развертывания см. в статье [Функции для параметров развертывания](#deployment-value-functions).
