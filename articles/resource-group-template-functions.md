...
Сведения о получении значений из ресурсов, групп ресурсов или подписки см. в статье [Выражения ресурсов](#resource-expressions).
...
Сведения о получении значений из параметров, переменных или текущего развертывания см. в статье [Выражения значений развертывания](#deployment-value-expressions).
...
Если не требуется непосредственно указывать версию API в шаблоне, вы можете использовать выражение **providers** и получить одно значение, например последнюю версию, как показано ниже.
