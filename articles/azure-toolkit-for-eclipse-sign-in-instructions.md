---
title: "Инструкции по входу для набора средств Azure для Eclipse | Документы Майкрософт"
...
* [Набор средств Azure для Eclipse]
  ...
  * *Инструкции по входу для набора средств Azure для Eclipse (эта статья)*
