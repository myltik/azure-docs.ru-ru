...
-   [Пакет инструментов SDK Azure для VS 2013][Пакет инструментов SDK Azure для VS 2013] или [Пакет инструментов SDK Azure для VS 2012][Пакет инструментов SDK Azure для VS 2012]
-   [Python 2.7 (32-разрядный)][Python 2.7 (32-разрядный)] или [Python 3.4 (32-разрядный)][Python 3.4 (32-разрядный)]
