<properties linkid="dev-nodejs-how-to-twilio-voice-sms-service" urlDisplayName="Служба Twilio Voice и SMS" pageTitle="Использование Twilio для голосовой связи, VoIP и SMS сообщений в Azure" metaKeywords="" description="" metaCanonical="" services="" documentationCenter="Node.js" title=" VoIP" authors="" solutions="" manager="" editor="" />
...
Выберите веб-сайт node.js и щелкните ссылку "НАСТРОИТЬ".  Если немного прокрутить экран, появится область, где можно задать свойства конфигурации для приложения.  Введите учетные данные учетной записи Twilio ([их можно найти на панели мониторинга Twilio][twilio_dashboard]), как показано; - убедитесь, что используется имя "TWILIO_ACCOUNT_SID" и "TWILIO_AUTH_TOKEN" соответственно:
