<properties title="Scale Azure Stream Analytics jobs" pageTitle="Задания по масштабированию в Stream Analytics | Azure" description="Learn how to scale Stream Analytics jobs" metaKeywords="" services="stream-analytics" solutions="" documentationCenter="" authors="jgao" videoId="" scriptId="" manager="paulettm" editor="cgronlun"/>
