<properties urlDisplayName="Xamarin" pageTitle="Как использовать клиентский компонент Xamarin - руководство по функциям мобильных служб Azure" metaKeywords = "мобильные службы Azure, Xamarin, iOS, Android, клиент .NET" description="Learn how to use the Xamarin Component client for Azure Mobile Services." metaCanonical="" disqusComments="1" umbracoNaviHide="0" title="How to use the Xamarin Component client for Azure Mobile Services" authors="donnam" manager="dwrede" />
