<properties title="О Puppet и виртуальных машинах Azure" pageTitle="О Puppet и виртуальных машинах Azure" description="Описывается установка и настройка Puppet на виртуальной машине в Azure" metaKeywords="" services="virtual machines" solutions="" documentationCenter="" authors="kathydav" manager="timlt" videoId="" scriptId="" />
