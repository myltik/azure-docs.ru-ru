...
Дополнительные сведения о создании пулов эластичных баз данных с помощью PowerShell см. в статье [Создание эластичного пула с помощью PowerShell](sql-database-elastic-pool-create-powershell.md).
