...
В этом документе описано, как разработать [клиентскую библиотеку эластичной базы данных](sql-database-elastic-database-client-library.md), чтобы помочь вам запустить пример приложения. Используя пример приложения, мы создадим простое сегментированное приложение и изучим основные возможности инструментов эластичной базы данных. В этом документе описано, как [управлять сопоставлениями сегментов](sql-database-elastic-scale-shard-map-management.md), [настроить маршрутизацию, зависящую от данных](sql-database-elastic-scale-data-dependent-routing.md), и [создавать многосегментные запросы](sql-database-elastic-scale-multishard-querying.md). Клиентская библиотека доступна для .NET и Java. 

## <a name="elastic-database-tools-for-java"></a>Инструменты эластичных баз данных для Java
### <a name="prerequisites"></a>Предварительные требования
* Java Developer Kit (JDK) версии 1.8 и выше
* [Maven](http://maven.apache.org/download.cgi)
* Логический сервер в Azure или локальный сервер SQL Server
...
2. Измените файл _./sample/src/main/resources/resource.properties_, чтобы указать следующее:
    * TEST_CONN_USER;
    * TEST_CONN_PASSWORD;
    * TEST_CONN_SERVER_NAME.
3. В каталоге _./sample_ выполните следующую команду, чтобы создать пример проекта.<br>

    ```
    mvn install
    ```
    
4. В каталоге _./sample_ выполните следующую команду, чтобы запустить пример проекта. 
