...
Дополнительную информацию об инструментах эластичных баз данных см. в статье [Обзор инструментов эластичной базы данных](sql-database-elastic-scale-introduction.md).

Перечень всех разделов об инструментах эластичных баз данных см. на странице [учебного плана](sql-database-elastic-scale-documentation-map.md).

## Пример приложения эластичных баз данных

В данном примере выполняется создание простого сегментированного приложения и исследуются основные возможности инструментов эластичной базы данных. Для загрузки и запуска приложения выполните действия, описанные далее или в видеоролике [Эластичное масштабирование — начало работы](http://channel9.msdn.com/Blogs/Windows-Azure/Elastic-Scale-with-Azure-SQL-Database-Getting-Started).
...
Пример приложения из раздела **Эластичные базы данных SQL Azure — приступая к работе** позволяет познакомиться с наиболее важными аспектами процесса разработки сегментированных приложений с использованием инструментов эластичных баз данных SQL Azure. В нем описаны основные случаи использования для [управления сопоставлением сегментов](sql-database-elastic-scale-shard-map-management.md), [маршрутизации, управляемой данными](sql-database-elastic-scale-data-dependent-routing.md), и [многосегментного формирования запросов](sql-database-elastic-scale-multishard-querying.md). Чтобы загрузить и запустить демонстрационное приложение, выполните следующие действия.
...
4. **Добавление пустых сегментов**. Итеративное добавление новых пустых сегментов выполняется программным кодом, который приводится в файле **AddNewShardsSample.cs**. С подробностями по данной теме можно ознакомиться здесь: [Управление картой сегментов](http://go.microsoft.com/?linkid=9862595).
