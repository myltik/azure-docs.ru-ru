<properties
	...
	description="Создание и экспорт BACPAC-файла базы данных SQL Azure в хранилище Azure"
...
# Создание и экспорт BACPAC-файла базы данных SQL
...
В этой статье показано, как вручную экспортировать BACPAC-файл базы данных SQL с помощью [портала предварительной версии Azure](https://portal.azure.com).
