...
> [AZURE.IMPORTANT]Для получения транзакционного согласованного BACPAC-файла сначала [создайте копию базы данных](sql-database-copy.md) а затем экспортируйте эту копию.
