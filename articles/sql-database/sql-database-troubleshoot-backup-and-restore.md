...
4.	Внесите изменения, необходимые для ссылки на новую базу данных. См. раздел [Восстановление базы данных после ошибки пользователя](sql-database-user-error-recovery.md).
...
5.	Внесите изменения, необходимые для ссылки на новую базу данных. См. раздел [Восстановление базы данных после ошибки пользователя](sql-database-user-error-recovery.md).

##Восстановление после сбоя регионального центра обработки данных
При настройке вторичных баз данных с георепликацией их можно использовать для восстановления баз данных уровня Standard и Premium. Это уменьшает вероятность потери данных при восстановлении базы данных. Дополнительные сведения см. в разделе [Восстановление базы данных SQL Azure после сбоя](sql-database-disaster-recovery.md).
