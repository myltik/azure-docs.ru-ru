...
1. Выполните следующие запросы для просмотра глобальных представлений:
...
1. В скрипте прокрутите вниз до скрипта SQL, содержащего схему для базы данных.  Изучите скрипт и обратите внимание на следующее:
