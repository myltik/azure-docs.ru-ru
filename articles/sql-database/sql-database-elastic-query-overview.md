---
title: "Обзор функции запросов к эластичной базе данных SQL Azure | Документация Майкрософт"
description: "Обзор функции эластичных запросов\L"
...
---
# <a name="azure-sql-database-elastic-database-query-overview-preview"></a>Обзор функции запросов к эластичной базе данных SQL Azure (предварительная версия)
...
**Доступно на стандартном уровне.** Сейчас эластичные запросы поддерживаются на уровнях производительности "Стандартный" и "Премиум". Сведения об ограничениях производительности для нижних уровней производительности см. в разделе "Ограничения предварительной версии" ниже.
...
## <a name="elastic-database-query-scenarios"></a>Сценарии эластичных запросов к базам данных
...
## <a name="elastic-database-query-topologies"></a>Топология запросов к эластичной базе данных
### <a name="topology-1-vertical-partitioning---cross-database-queries"></a>Топология 1: вертикальное секционирование — межбазовые запросы
...
### <a name="topology-2-horizontal-partitioning---sharding"></a>Топология 2: горизонтальное секционирование (сегментирование)
...
## <a name="implementing-elastic-database-queries"></a>Реализация запросов к эластичной базе данных
...
Дополнительные сведения о действиях, требуемых при вертикальном секционировании, см. в статье [Запрос к нескольким облачным базам данных с разными схемами (предварительная версия)](sql-database-elastic-query-vertical-partitioning.md).  
