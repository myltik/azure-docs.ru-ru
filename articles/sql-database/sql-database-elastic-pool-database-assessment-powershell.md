...
> [AZURE.IMPORTANT] Во время работы сценария окно PowerShell должно быть открыто. Не закрывайте окно PowerShell, пока сценарий не завершит выполнение в течение необходимого времени. 
