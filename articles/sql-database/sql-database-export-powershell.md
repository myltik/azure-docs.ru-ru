...
В статье содержатся инструкции по архивации базы данных SQL Azure в [BACPAC](https://msdn.microsoft.com/library/ee210546.aspx#Anchor_4)-файл, хранимый в хранилище BLOB-объектов Azure. В данной статье показано, как это можно сделать с помощью PowerShell.
