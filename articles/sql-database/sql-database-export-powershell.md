...
# Создание и экспорт BACPAC-файла базы данных SQL с помощью PowerShell
...
В этой статье показано, как вручную экспортировать BACPAC-файл базы данных SQL с помощью PowerShell.
...
Чтобы получить эти значения, перейдите к учетной записи хранения в [портале предварительной версии Azure](https://portal.azure.com). Чтобы найти первичный ключ доступа, последовательно выберите пункты **Все параметры** и **Ключи** в колонке учетной записи хранения.
