...
- [Учетная запись хранения Azure](../storage/storage-create-storage-account.md) с контейнером больших двоичных объектов для хранения BACPAC-файла. В данный момент для учетной записи хранения необходимо использовать классическую модель развертывания, поэтому выберите **Классическая** при создании учетной записи хранения.
