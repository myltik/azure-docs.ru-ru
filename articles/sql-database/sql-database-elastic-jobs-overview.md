...
Инструкции по установке см. в статье [Обзор установки заданий обработки эластичных баз данных](sql-database-elastic-jobs-service-installation.md).
...
3.	Создайте зашифрованные учетные данные для выполнения заданий и [добавьте пользователя (или роль) в каждую базу данных в группе](sql-database-elastic-jobs-add-logins-to-dbs.md).
...
2.	Служба **заданий обработки эластичных баз данных** обращается к управляющей базе данных для запуска и отслеживания заданий.
