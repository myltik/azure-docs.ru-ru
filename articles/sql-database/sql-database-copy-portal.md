---
title: Копирование базы данных SQL Azure с помощью портала Azure | Microsoft Docs
...
6. После выбора параметра **Целевой сервер** станут доступны параметры **Пул эластичной базы данных** и **Ценовая категория**. Если на сервере организован пул, то базу данных можно скопировать в него.
