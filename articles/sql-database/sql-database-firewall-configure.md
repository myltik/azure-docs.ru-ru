...
- На [портале Microsoft Azure](https://portal.azure.com/) установите флажок **Разрешить службам Microsoft Azure доступ к серверу** при создании нового сервера.

- На [классическом портале](http://go.microsoft.com/fwlink/p/?LinkID=161793) на вкладке **Настройка** сервера, в разделе **Разрешенные службы** щелкните **Да** для пункта **Службы Microsoft Azure**.

## Создание первого правила брандмауэра уровня сервера

Первый параметр брандмауэра на уровне сервера можно создать с помощью [портала Azure](https://portal.azure.com/) или программным путем с помощью REST API или Azure PowerShell. Последующие правила брандмауэра уровня сервера можно создавать и контролировать с помощью этих методов, а также посредством Transact-SQL. Дополнительные сведения о правилах брандмауэра уровня сервера см. в разделе [Краткое руководство: настройка параметров брандмауэра (база данных SQL Azure)](sql-database-configure-firewall-settings.md).
