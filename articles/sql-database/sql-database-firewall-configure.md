...
### <a name="faq-when-should-you-use-a-server-level-firewall-rule-and-when-should-you-use-a-database-level-firewall-rule"></a>Часто задаваемый вопрос. Когда следует использовать правило брандмауэра уровня сервера, а когда — уровня базы данных?   
...
Комплексное руководство по созданию процедур входа в систему, пользователей и брандмауэров см. в статье [Аутентификация, доступ и правила брандмауэра уровня базы данных в SQL Server](sql-database-control-access-sql-authentication-get-started.md).
