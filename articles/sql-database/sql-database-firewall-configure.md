...
Подключения из Azure можно включить на [классическом портале](http://go.microsoft.com/fwlink/p/?LinkID=161793) двумя способами.
...
Первый параметр брандмауэра на уровне сервера можно создать с помощью [классического портала](http://go.microsoft.com/fwlink/p/?LinkID=161793) или программным путем с помощью REST API или Azure PowerShell. Последующие правила брандмауэра уровня сервера можно создавать и контролировать с помощью этих методов, а также посредством Transact-SQL. Дополнительные сведения о правилах брандмауэра уровня сервера см. в разделе [Краткое руководство: настройка параметров брандмауэра (база данных SQL Azure)](sql-database-configure-firewall-settings.md).
...
Помимо классического портала Azure правилами брандмауэра можно управлять программно с помощью Transact-SQL, API REST и Azure PowerShell. В приведенных ниже таблицах описан набор команд, доступных для каждого метода.
