---
title: Установка заданий обработки эластичных баз данных | Microsoft Docs
...
6. Нажмите кнопку «ОК». Компоненты будут созданы через несколько минут в новой [группе ресурсов](../resource-group-overview.md). Новая группа ресурсов закрепляется на начальной доске, как показано на рисунке ниже. После создания компонентов в группе будут созданы задания обработки эластичных баз данных (облачная служба, база данных SQL, служебная шина и хранилище).
