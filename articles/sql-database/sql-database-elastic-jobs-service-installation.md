...
6. Нажмите кнопку «ОК». Компоненты будут созданы через несколько минут в новой [группе ресурсов](../azure-portal/resource-group-portal.md). Новая группа ресурсов закрепляется на начальной доске, как показано на рисунке ниже. После создания компонентов в группе будут созданы задания обработки эластичных баз данных (облачная служба, база данных SQL, служебная шина и хранилище).
