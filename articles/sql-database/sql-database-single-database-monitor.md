---
title: Мониторинг производительности базы данных в базе данных SQL Azure | Microsoft Docs
...
> [!NOTE]
> **sys.dm\_db\_resource\_stats** возвращает пустой результирующий набор при использовании в базах данных устаревших выпусков Web Edition и Business Edition.
> 
> 
