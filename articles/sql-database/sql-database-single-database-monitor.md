<properties pageTitle="Мониторинг производительности баз данных в базе данных SQL Azure" | Microsoft Azure" description="Узнайте, как выполнять мониторинг производительности базы данных с помощью средств Azure и динамических административных представлений." keywords="мониторинг базы данных, производительность облачной базы данных" services="sql-database" documentationCenter="" authors="jeffgoll" manager="jeffreyg" editor="jeffreyg"/>
