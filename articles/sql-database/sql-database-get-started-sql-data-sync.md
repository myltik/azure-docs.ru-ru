...
Выполните инструкции в разделе [Установка агента клиента (синхронизация данных SQL)](http://msdn.microsoft.com/library/jj823137.aspx) для установки агента.
...
После установки клиентского агента зарегистрируйте каждую локальную базу данных SQL Server, которую следует включить в группу синхронизации агента. Чтобы зарегистрировать базу данных в агенте, выполните указания, приведенные в разделе [Регистрация базы данных SQL Server в клиентском агенте](http://msdn.microsoft.com/library/jj823138.aspx).
...
Всегда можно синхронизировать группу синхронизации, щелкнув СИНХРОНИЗАЦИЯ в нижней части главной страницы синхронизации данных. Если необходимо, чтобы группа синхронизации синхронизировалась по расписанию, необходимо настроить группу синхронизации.
