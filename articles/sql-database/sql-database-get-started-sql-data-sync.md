...
В этом учебнике описываются основы синхронизации данных SQL Azure с использованием портала управления Azure.
...
> [AZURE.NOTE]Полную техническую документацию по синхронизации данных SQL Azure, которая ранее располагалась на сайте MSDN, можно скачать в виде одного PDF-файла по следующей [ссылке](http://download.microsoft.com/download/4/E/3/4E394315-A4CB-4C59-9696-B25215A19CEF/SQL_Data_Sync_Preview.pdf).
