...
# Разработка базы данных на C&\#x23;: создание и настройка пула эластичных баз данных для базы данных SQL
...
2. Наведите указатель мыши на имя в правом верхнем углу и запомните домен, который отобразится во всплывающем окне. Замените **domain.onmicrosoft.com** в приведенном ниже фрагменте кода на значение, соответствующее вашей учетной записи.
