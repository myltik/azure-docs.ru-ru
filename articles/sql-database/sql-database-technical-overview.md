...
В этой статье рассматриваются основные понятия и функции базы данных SQL, относящиеся к производительности, масштабируемости и управляемости. Также приведены ссылки для более подробного изучения. Для начала попробуйте [создать первую базу данных SQL](sql-database-get-started.md) или [пул эластичных баз данных](sql-database-elastic-pool-create-portal.md). На это вам потребуется несколько минут. Если вам необходимы более подробные сведения, просмотрите этот 30-минутный видеоролик.
