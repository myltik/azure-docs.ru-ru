...
- **[Базы данных, избыточные в пределах зоны](sql-database-high-availability.md)**: база данных SQL позволяет подготовить базы данных или эластичные пулы уровня "Премиум" в нескольких зонах доступности. Так как базы данных или эластичные пулы уровня "Премиум" имеют несколько избыточных реплик для обеспечения высокой доступности, размещение этих реплик в нескольких зонах доступности гарантирует более высокую устойчивость, включая возможность автоматического восстановления после масштабных ошибок центра обработки данных без потери данных. Эта функция в настоящее время находится на стадии предварительной версии. 
