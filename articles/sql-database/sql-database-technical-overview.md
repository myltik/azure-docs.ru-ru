...
Вы можете приступить к работе за считанные минуты, но если вас интересуют более подробные сведения, посмотрите это 30-минутное видео.


> [AZURE.VIDEO azurecon-2015-get-started-with-azure-sql-database]


В этой статье рассматриваются основные понятия и функции Базы данных SQL, относящиеся к производительности, масштабируемости и управляемости. Также приведены ссылки для более подробного изучения. Если вы готовы начать, можно [создать свою первую базу данных SQL](sql-database-get-started.md) или [создать пул эластичных баз данных](sql-database-elastic-pool-portal.md) за несколько минут.
...
Подробные сведения о различных возможностях по обеспечению непрерывности бизнес-процессов для различных уровней службы приведены в статье [Непрерывность бизнес-процессов](sql-database-business-continuity.md).

## Защита данных
SQL Server обладает традициями надежной защиты данные, которые в базах данных SQL поддерживаются с помощью функций ограничения доступа, защиты данных и отслеживания ваших действий. Краткое описание параметров безопасности Базы данных SQL см. в статье [Защита базы данных SQL](sql-database-security.md). Более подробное представление функций безопасности см. в статье [Центр обеспечения безопасности для SQL Server Database Engine и Базы данных SQL](https://msdn.microsoft.com/library/bb510589). Кроме того, посетите [центр управления безопасностью Azure](http://azure.microsoft.com/support/trust-center/security/) для получения сведений о безопасности платформы Azure.
