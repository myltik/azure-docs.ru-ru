...
В этой статье рассматриваются основные понятия и функции базы данных SQL, относящиеся к производительности, масштабируемости и управляемости. Также приведены ссылки для более подробного изучения. Если вы готовы к работе с практическими руководствами, попробуйте [создать первую базу данных SQL](sql-database-get-started.md) или [эластичный пул](sql-database-elastic-pool-manage-portal.md). Краткий обзор представлен в этом небольшом видеоролике.
