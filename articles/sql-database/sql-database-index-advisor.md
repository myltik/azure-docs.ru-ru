...
Помощник по индексу предоставляет список рекомендаций по индексу в колонке базы данных на [портале предварительной версии Azure](https://portal.azure.com/). Наилучшие рекомендации показаны для каждой таблицы из выбранной базы данных, где создание нового индекса может обеспечить рост производительности.
