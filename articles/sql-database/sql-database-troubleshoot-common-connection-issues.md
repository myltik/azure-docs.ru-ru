...
- В процессе разработки приложения не были соблюдены [рекомендации и указания по разработке](sql-database-connect-central-recommendations.md).
...
| 8 | [Общие сведения о разработке базы данных SQL](sql-database-connect-central-recommendations.md) | Содержит ссылки на примеры кода для различных технологий, которые можно использовать для подключения к базе данных SQL Azure и взаимодействия с ней. |
...
- [Общие сведения о разработке базы данных SQL](sql-database-connect-central-recommendations.md).
