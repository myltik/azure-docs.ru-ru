...
Каждый Управляемый экземпляр содержит 35 ТБ зарезервированного дискового пространства, а каждый файл базы данных первоначально помещается на единицу выделения памяти 128 ГБ. Базы данных со множеством небольших файлов могут быть помещены в единицы 128 ГБ, которые в сумме превышают ограничение в 35 ТБ. В этом случае невозможно создать новые базы данных или восстановить имеющиеся, даже если общий размер всех баз данных не достигает предельного размера экземпляра. Ошибка, возвращаемая в этом случае, может быть непонятной.
