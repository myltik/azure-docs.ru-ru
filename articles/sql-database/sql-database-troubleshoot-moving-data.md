...
- Определите совместимость баз данных и выберите подходящий способ переноса. Выполните инструкции и примените параметры мастера переноса базы данных SQL Server.
