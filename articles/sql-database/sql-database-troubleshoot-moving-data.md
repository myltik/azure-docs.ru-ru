...
- Определите совместимость баз данных и выберите подходящий способ переноса. Выполните инструкции и примените параметры [мастера переноса базы данных SQL Server](../virtual-machines/virtual-machines-windows-classic-migrate-sql.md).
