...
> [AZURE.IMPORTANT] Чтобы обеспечить синхронизацию с обновлениями Microsoft Azure и базой данных SQL, необходимо всегда использовать последнюю версию Management Studio. Более старая версия SSMS не будет успешно работать с базой данных SQL. Чтобы получить SSMS, см. статью [Скачивание SQL Server Management Studio](https://msdn.microsoft.com/library/mt238290.aspx).
