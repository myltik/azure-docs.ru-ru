...
## <a name="troubleshooting-sync"></a>Устранение неполадок с синхронизацией
...
## <a name="troubleshooting-the-client-agent"></a>Устранение неполадок агента клиента
...
-   Создайте агент в том же центре обработки данных, что и группа синхронизации. Затем зарегистрируйте базу данных в агенте.
...
## <a name="troubleshooting-setup-and-maintenance"></a>Устранение неполадок с установкой и обслуживанием
...
3. Добавьте учетную запись пользователя в диалоговое окно **Свойства**  **Вход в качестве службы**.
...
Если вы восстанавливаете потерянную или поврежденную базу данных из резервной копии, в группах синхронизации, к которым принадлежит база данных может отсутствовать конвергенция данных.
