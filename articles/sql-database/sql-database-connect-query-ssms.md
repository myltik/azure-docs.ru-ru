---
title: Подключение к базе данных SQL с помощью SQL Server Management Studio | Microsoft Docs
...
[!INCLUDE [Установка SSMS](../../includes/sql-server-management-studio-install.md)]

[!INCLUDE [Подключение SSMS](../../includes/sql-database-sql-server-management-studio-connect-server-principal.md)]
