...
- Примеры кодов см. в статье [Библиотеки подключений для Базы данных SQL и SQL Server](sql-database-libraries.md)
...
Примеры кода приведены для клиентов, работающих на платформах Windows, Linux и Mac.


**Общие примеры.** Существует несколько примеров кода для различных языков программирования, включая PHP, Python, Java, Node.js и .NET CSharp. Ссылки на примеры кода вы найдете в следующих статьях:
