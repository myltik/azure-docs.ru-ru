...
- ADO.NET 4.5 внутренним образом использует ODBC 11.
 - Приведенная здесь информация, относящаяся к ADO.NET 4.5, также касается ODBC 11.
...
#### *Внутренняя программа.* Клиент работает на виртуальной машине Azure
...
Примеры кода, демонстрирующие логику повторных попыток, см. в разделе [Краткие образцы клиентского кода для базы данных SQL](sql-database-develop-quick-start-client-code-samples.md).
