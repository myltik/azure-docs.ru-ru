...
Отдельные шаги, необходимые для каждого сценария, включают операции с большим количеством баз данных. Мы рекомендуем использовать задания обработки эластичных БД SQL для управления этими операциями в масштабе. Дополнительные сведения см. в статье [Управление масштабируемыми облачными базами данных](./sql-database-elastic-jobs-overview.md). Ниже приведены ссылки на ресурсы с дополнительными сведениями, необходимыми для реализации описанных здесь сценариев.
