...
* Группа отработки отказа инициирует автоматическую отработку отказа базы данных управления в регион аварийного восстановления. Приложение будет автоматически повторно подключено к новой базе данных-источнику. В регионе аварийного восстановления будут созданы новые учетные записи и базы данных клиента. Для существующих клиентов данные будут временно недоступными.
