...
1. Выберите **API управления службами Microsoft Azure**, а затем завершите работу мастера.
2. В разделе **Разрешения для других приложений** найдите раздел **API управления службами Microsoft Azure** и щелкните **Делегированные разрешения**.
...
1. Прокрутите вниз и щелкните **Добавить приложение**.
1. Выберите **Приложения Майкрософт**.
1. Найдите и выберите **API управления службами Microsoft Azure**, а затем завершите работу мастера.
2. В разделе **Разрешения для других приложений** найдите раздел **API управления службами Microsoft Azure** и щелкните **Делегированные разрешения**.
3. Выберите **Доступ к управлению службами Azure**.
