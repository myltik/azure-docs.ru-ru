...
> [!IMPORTANT]
> Обзор функций защиты в базе данных SQL см. в [этой статье](sql-database-security-overview.md). Сведения об использовании проверки подлинности SQL Server см. в статье [Руководство по базе данных SQL: проверка подлинности SQL Server, имена для входа и учетные записи пользователей, роли базы данных, разрешения, правила брандмауэра на уровне сервера и на уровне базы данных](sql-database-control-access-sql-authentication-get-started.md). Сведения об использовании проверки подлинности Azure Active Directory см. в статье [Руководство по базе данных SQL: проверка подлинности AAD, имена для входа и учетные записи пользователей, роли базы данных, разрешения, правила брандмауэра на уровне сервера и правила брандмауэра на уровне базы данных](sql-database-control-access-aad-authentication-get-started.md).
...
Кроме того, вы можете использовать следующие функции, чтобы ограничить или расширить права.
...
- Описание упреждающего мониторинга см. во вводных статьях об [аудите базы данных SQL](sql-database-auditing-get-started.md) и [системе обнаружения угроз базы данных SQL](sql-database-threat-detection-get-started.md).
- Сведения об использовании проверки подлинности SQL Server см. в статье [Руководство по базе данных SQL: проверка подлинности SQL Server, имена для входа и учетные записи пользователей, роли базы данных, разрешения, правила брандмауэра на уровне сервера и на уровне базы данных](sql-database-control-access-sql-authentication-get-started.md).
