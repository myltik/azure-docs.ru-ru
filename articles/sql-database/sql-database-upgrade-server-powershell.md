...
Чтобы обновить сервер до версии 12 с помощью PowerShell, сначала установите и запустите последнюю версию Azure PowerShell. Дополнительные сведения можно узнать в статье [Установка и настройка Azure PowerShell](/powershell/azureps-cmdlets-docs).
...
Дополнительные сведения см. в статьях [Создание эластичного пула на портале Azure](sql-database-elastic-pool-create-portal.md) и [SQL Database pricing tier recommendations](sql-database-service-tier-advisor.md) (Рекомендации по выбору ценовой категории для базы данных SQL Azure).
...
Если эти рекомендации не подходят для вашего сервера и организации, вы можете выбрать способ обновления своих баз данных и сопоставить их с изолированными базами данных или пулами эластичных баз данных.
