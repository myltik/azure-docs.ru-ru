...
В этой статье приведены указания по созданию новой базы данных SQL Azure из BACPAC-файла с помощью [портала предварительной версии Azure](https://portal.azure.com).
