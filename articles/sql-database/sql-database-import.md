<properties
	pageTitle="Импорт BACPAC-файла в базу данных SQL Azure"
	description="Импорт BACPAC-файла в базу данных SQL Azure"
...
# Импорт BACPAC-файла в базу данных SQL
...
В этой статье показано, как создать базу данных SQL путем импорта BACPAC-файла с помощью [портала предварительной версии Azure](https://portal.azure.com).
