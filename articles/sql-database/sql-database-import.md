...
- командлет [New-AzureRmSqlDatabaseImport](https://docs.microsoft.com/powershell/module/azurerm.sql/new-azurermsqldatabaseimport?view=azurermps-3.7.0).
...
Чтобы импортировать базу данных с помощью портала Azure, откройте страницу для базы данных и щелкните **Импорт** на панели инструментов. Введите имя BACPAC-файла, укажите учетную запись хранения Azure и контейнер для BACPAC-файла, а также учетные данные для подключения к базе данных-источнику.  
...
> [!IMPORTANT]
> Логический сервер базы данных SQL Azure ожидает передачи данных через порт 1433. Чтобы подключиться к логическому серверу базы данных SQL Azure из среды, ограничиваемой корпоративным брандмауэром, этот порт должен быть открыт в брандмауэре.
>

## <a name="powershell"></a>PowerShell

Используйте командлет [New-AzureRmSqlDatabaseImport](https://docs.microsoft.com/powershell/module/azurerm.sql/new-azurermsqldatabaseimport?view=azurermps-3.7.0), чтобы отправить запрос на импорт базы данных к службе Базы данных SQL Azure. Операция импорта может занять некоторое время в зависимости от размера базы данных.
