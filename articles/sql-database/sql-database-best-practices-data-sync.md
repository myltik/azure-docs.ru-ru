...
Не все таблицы в базе данных должны находиться в группе синхронизации. Выбор таблиц, которые нужно включить в группу синхронизации и исключить из нее (или включить в другую группу синхронизации), может повлиять на эффективность и затраты. Включите только те таблицы в группу синхронизации, которые требуются для бизнеса, а также те, от которых они зависят.
