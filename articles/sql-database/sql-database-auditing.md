...
* **Аудит больших двоичных объектов**: журналы записываются в хранилище BLOB-объектов Azure. Это более новый метод аудита, который обеспечивает **более высокую производительность**, поддерживает **более высокую детализацию аудита на уровне объекта** и **является более экономически эффективным**.
...
### <a id="subheading-2-2">Аудит таблиц</a>
...
### <a id="subheading-3-2">Аудит таблиц</a>
