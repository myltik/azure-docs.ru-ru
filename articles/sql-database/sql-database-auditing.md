...
* **Аудит больших двоичных объектов**: журналы записываются в хранилище BLOB-объектов Azure. Это более новый метод аудита, который обеспечивает **более высокую производительность**, поддерживает **более высокую детализацию аудита на уровне объекта** и **является более экономически эффективным**. Аудит больших двоичных объектов заменит аудит таблиц.
* **Аудит таблиц (не рекомендуется)**: журналы записываются в Хранилище таблиц Azure.
...
### <a id="subheading-2-1">Аудит больших двоичных объектов</a>
1. Запустите [портал Azure](https://portal.azure.com) по адресу https://portal.azure.com.
...
## <a id="subheading-8"></a>Различия между большими двоичными объектами и таблицами при наследовании политики аудита сервера
...
###<a name="atable-auditinga-deprecated"></a><a>Аудит таблиц</a> (не рекомендуется)
...
### <a id="subheading-3-1">Аудит больших двоичных объектов</a>
...
### <a id="subheading-3-2">Аудит таблиц</a> (не рекомендуется)
...
## <a id="subheading-5"></a>Рекомендации по использованию в рабочей среде
...
2. **REST API — аудит больших двоичных объектов**
...
3. **REST API — аудит таблиц (не рекомендуется)**

   * [Создание или обновление политики аудита базы данных](https://msdn.microsoft.com/library/azure/mt604471.aspx)
   * [Создание или обновление политики аудита сервера](https://msdn.microsoft.com/library/azure/mt604383.aspx)
   * [Получение политики аудита базы данных](https://msdn.microsoft.com/library/azure/mt604381.aspx)
   * [Получение политики аудита сервера](https://msdn.microsoft.com/library/azure/mt604382.aspx)
