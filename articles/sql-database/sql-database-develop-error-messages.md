...
В этой статье перечислены коды ошибок SQL для клиентского приложения базы данных SQL, включая ошибки подключения к базе данных, временные сбои, ошибки управления ресурсами, проблемы при копировании баз данных и другие ошибки. Большинство категорий относятся к базам данных SQL Azure и не применяются к Microsoft SQL Server.
...
## Ошибки подключения к базе данных, временные сбои и другие временные ошибки
...
### Наиболее распространенные ошибки подключения к базе данных и временные сбои
