...
Настройка политики динамического маскирования данных на портале предварительной версии Azure осуществляется посредством выбора операции «Динамическое маскирование данных» в колонке конфигурации или параметров Базы данных SQL.
