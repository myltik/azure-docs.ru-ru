...
> [!TIP]
> Пример создания приложения .NET с помощью базы данных SQL Azure приведен в разделе [Создание приложения ASP.NET в Azure с подключением к базе данных SQL](/app-service-web/app-service-web-tutorial-dotnet-sqldatabase.md).
>
