...
Узнайте, как создавать [пулы эластичных баз данных](sql-database-elastic-pool.md) с помощью языка C#.
...
В этом примере создается группа ресурсов Azure, экземпляр Azure SQL Server и пул эластичных БД.
