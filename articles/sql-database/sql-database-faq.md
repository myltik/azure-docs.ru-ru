...
## Как часто можно менять уровень службы или уровень производительности для отдельной базы данных? 
Уровень службы («Базовый», «Стандартный» или «Премиум») или уровень производительности в пределах уровня службы (например, S1 и S2) можно изменять до четырех раз в течение 24 часов.
