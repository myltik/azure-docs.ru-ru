...
## <a name="whatis-the-new-vcore-based-purchasing-model-preview-for-azure-sql-database"></a>Что представляет собой новая модель приобретения на основе виртуальных ядер (предварительная версия) для базы данных SQL Azure?
