---
title: 'Руководство по базам данных SQL: создание базы данных SQL | Microsoft Docs'
...
[!INCLUDE [Создание правила брандмауэра для сервера](../../includes/sql-database-create-new-server-firewall-portal.md)]
