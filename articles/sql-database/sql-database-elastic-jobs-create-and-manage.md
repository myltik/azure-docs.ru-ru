---
title: "Создание развернутых баз данных SQL Azure и управление ими с помощью заданий обработки эластичных БД | Документация Майкрософт"
...
* Эластичный пул баз данных. См. статью [Что такое пул эластичных БД Azure?](sql-database-elastic-pool.md)
