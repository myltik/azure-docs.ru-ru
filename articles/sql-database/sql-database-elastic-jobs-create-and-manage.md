---
title: Создание развернутых баз данных SQL Azure и управление ими с помощью заданий обработки эластичных БД | Microsoft Docs
...
6. Нажмите **Сохранить**, затем нажмите кнопку **Запустить**.
