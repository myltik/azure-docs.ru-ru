...
> [!NOTE]
> При использовании избыточных в пределах зоны пулов и баз данных уровня "Премиум" процесс восстановления автоматизирован. Поэтому описанные в этой статье действия выполнять не нужно. 
