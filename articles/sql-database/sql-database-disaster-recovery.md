...
## <a name="failover-to-geo-replicated-secondary-database"></a>Отработка отказа с помощью геореплицируемой базы данных-получателя
...
* [Настройка георепликации базы данных SQL Azure с помощью PowerShell.](scripts/sql-database-setup-geodr-and-failover-database-powershell.md)
