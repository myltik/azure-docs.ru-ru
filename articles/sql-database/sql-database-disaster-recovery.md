...
Подробнее об изменении строк подключения см. в статье [Подключение к базе данных SQL: рекомендации и советы по разработке](sql-database-connect-central-recommendations.md).
