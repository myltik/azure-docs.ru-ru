...
###PowerShell
PowerShell позволяет прекратить связь непрерывной копии с базой данных-получателем, восстановленной с помощью георепликации, используя командлет [Stop-AzureSqlDatabaseCopy](https://msdn.microsoft.com/library/dn720223).
...
###Интерфейс REST API 
REST позволяет программными средствами прекратить связь непрерывной копии с базой данных-получателем, восстановленной с помощью георепликации.
...
###Портал Azure
Чтобы восстановить Базу данных SQL с помощью функции геовосстановления на портале Azure, выполните указанные ниже действия или [посмотрите эту видеоинструкцию](https://azure.microsoft.com/documentation/videos/restore-a-sql-database-using-geo-restore/).
...
###PowerShell 
Чтобы восстановить Базу данных SQL с помощью функции геовосстановления в PowerShell, отправьте соответствующий запрос с помощью командлета [start-AzureSqlDatabaseRecovery](https://msdn.microsoft.com/library/azure/dn720224.aspx). Для получения подробной информации по решению этой задачи [посмотрите эту видеоинструкцию](http://azure.microsoft.com/documentation/videos/restore-a-sql-database-using-geo-restore-with-microsoft-azure-powershell/).
