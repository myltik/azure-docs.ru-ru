...
---
# <a name="design-patterns-for-multitenant-saas-applications-and-azure-sql-database"></a>Шаблоны разработки для мультитенантных приложений SaaS и Базы данных SQL Azure
...
## <a name="multitenant-applications"></a>Мультитенантные приложения
...
## <a name="multitenant-application-design-trade-offs"></a>Компромиссы при разработке мультитенантного приложения
...
## <a name="multitenant-data-models"></a>Модели данных мультитенантного приложения
...
![Модели данных мультитенантных приложений](./media/sql-database-design-patterns-multi-tenancy-saas-applications/sql-database-multi-tenant-data-models.png)
...
## <a name="popular-multitenant-data-models"></a>Популярные модели данных мультитенантного приложения
...
## <a name="multitenancy-support-in-azure-sql-database"></a>Поддержка мультитенантности в Базе данных SQL Azure
...
Рис. 3. Шаблоны мультитенантных приложений в базе данных SQL Azure
