---
title: 'База данных SQL Azure: пример использования Azure — Daxko/CSI | Microsoft Docs'
...
---
# <a name="daxko/csi-used-azure-to-accelerate-its-development-cycle-and-to-enhance-its-customer-services-and-performance"></a>Компания Daxko/CSI использовала Azure для ускорения своего цикла разработки, расширения набора пользовательских услуг и повышения производительности
...
## <a name="azure-elastic-database-pools-free-up-it-resources"></a>Пулы эластичных баз данных Azure освобождают ресурсы ИТ
