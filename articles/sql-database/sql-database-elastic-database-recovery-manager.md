...
3. Сегмент или база данных ShardMapManager восстанавливается до более ранней версии. Дополнительные сведения о восстановлении базы данных SQL Azure до точки во времени см. в [этой статье](sql-database-point-in-time-restore-portal.md).
