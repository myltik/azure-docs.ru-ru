...
3. Рассчитайте цену за пул следующим образом:
    ...
    Информацию о ценах см. в разделе [База данных SQL. Цены](http://azure.microsoft.com/pricing/details/sql-database/).
