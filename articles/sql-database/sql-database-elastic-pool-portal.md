...
На [портале Azure](https://portal.azure.com/) откройте раздел **Серверы SQL Server**, выберите сервер с базами данных, которые нужно добавить в пул, а затем щелкните **Добавить пул**.
