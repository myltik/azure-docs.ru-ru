...
В этой статье показано, как создать пул эластичных баз данных, упрощающий процесс создания, обслуживания, а также контроля производительности и себестоимости сразу нескольких баз данных. Для работы с данным руководством нужна хотя бы одна база данных на сервере Базы данных SQL версии 12. При необходимости такую базу данных можно создать за пять минут (см. статью [Создание своей первой базы данных SQL Azure](sql-database-get-started.md)).
...
В колонке **Пул эластичных баз данных** приводятся параметры для выбора ценовой категории, добавления баз данных и настройки производительности пула.

> [AZURE.NOTE]При первом выборе команды **Добавить пул** необходимо принять условия предоставления предварительной версии, выбрав пункт **Условия предварительной версии**, и заполнить содержимое колонки **Условия предварительной версии**. Это нужно сделать только один раз для каждой подписки.
