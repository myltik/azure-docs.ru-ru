...
- Сервер базы данных SQL Azure версии 12. Если у вас отсутствует сервер версии 12, создайте его, следуя указаниям из статьи [Создание первой базы данных SQL Azure](sql-database-get-started.md), или [обновите имеющийся сервер до версии 12](sql-database-v12-upgrade.md).
...
2.	Создайте пул, нажав в верхней части колонки **SQL Server** кнопку **Добавить пул**.
    ...
    Если появится сообщение о том, что для этого сервера есть рекомендуемый пул, щелкните его, чтобы с легкостью просмотреть и создать пул, оптимизированный для баз данных вашего сервера. Дополнительные сведения см. в статье [Рекомендуемые пулы эластичных баз данных](sql-database-elastic-pool-portal.md#recommended-elastic-database-pools).
...
## Добавление баз данных в пул и удаление эластичных баз данных из него
