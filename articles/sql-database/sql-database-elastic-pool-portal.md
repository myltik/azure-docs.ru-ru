<properties 
	pageTitle="Создание пула эластичных баз данных для Базы данных SQL и управление им" 
...
# Создание пула эластичных баз данных для Базы данных SQL и управление им
...
В этой статье описано, как создать пул эластичных баз данных с помощью [портала предварительной версии](https://portal.azure.com).
...
- **Настроить пул**. Позволяет изменять количество eDTU для пула и одной базы данных.
