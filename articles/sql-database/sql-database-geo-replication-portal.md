...
В этой статье объясняется, как настроить георепликацию для базы данных SQL Azure с помощью [портала Azure](https://portal.azure.com).
...
1. На [портале Azure](https://portal.azure.com) перейдите к базе данных-источнику в связи георепликации.
2. В колонке «База данных SQL» выберите **Все параметры** > **Георепликация**.
