...
||[Создание приложений по схеме "программное обеспечение как услуга" (SaaS)](sql-database-design-patterns-multi-tenancy-saas-applications.md).| Создание гибридных приложений.|
|||||
