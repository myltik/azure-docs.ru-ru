...
## <a name="get-the-wingtip-tickets-saas-multi-tenant-database-application-scripts"></a>Получение скриптов для SaaS-приложения Wingtip Tickets c мультитенантной базой данных
...
1. В среде SSMS перейдите к базе данных клиента на сервере *tenants1-mt-&lt;пользователь&gt;* и запросите таблицу *VenueTypes*, чтобы убедиться, что *Motorcycle Racing* и *Swimming Club* **добавлены* в таблицу.
...
[Ad-hoc analytics tutorial](saas-multitenantdb-adhoc-reporting.md) (Руководство по аналитике Ad-hoc)
