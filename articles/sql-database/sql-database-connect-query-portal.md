...
2. На странице базы данных SQL нажмите кнопку **Средства** на панели инструментов. Откроется страница "Средства".

    ![меню средств](./media/sql-database-connect-query-portal/tools-menu.png)

3. Щелкните **Редактор запросов (предварительная версия)**, а затем установите флажок напротив пункта **Условия предварительной версии** и нажмите кнопку **ОК**. Откроется страница редактора запросов.

4. Щелкните **Вход** и при появлении запроса выберите **Проверка подлинности SQL Server**, а затем укажите учетные данные и пароль администратора сервера, указанные при создании базы данных.

    ![вход](./media/sql-database-connect-query-portal/login-menu.png) 

5. Нажмите кнопку **ОК**, чтобы выполнить вход.
...
Перейдите в базу данных SQL, к которой вы хотите выполнить запрос, нажмите кнопку **Средства** на панели инструментов, а затем выберите параметр **Редактор запросов (предварительная версия)**. Откроется страница редактора запросов, и будет автоматически установлено подключение к базе данных.
