...
3.	Для получения параметров производительности в режиме реального времени используйте динамические административные представления (DMV), расширенные события (Xevent) и хранилище запросов в SSMS. Дополнительные сведения о мониторинге и рекомендации по настройке см. в руководстве по производительности.

## Повышение производительности базы данных с использованием дополнительных ресурсов
1.	Для повышения производительности одиночных баз данных можно [изменять уровни обслуживания](sql-database-scale-up.md) по мере необходимости.
