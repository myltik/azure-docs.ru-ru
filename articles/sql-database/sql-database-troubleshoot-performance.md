...
2.	Используйте [анализ производительности процессов](sql-database-query-performance.md) для оценки запросов с помощью DTU, а затем используйте [помощник по работе с базами данных SQL](sql-database-index-advisor.md), чтобы просмотреть рекомендации по созданию и удалению индексов, параметризации запросов и устранению ошибок схемы.
