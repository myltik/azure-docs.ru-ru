---
title: Начало работы с динамическим маскированием данных в базе данных SQL (классический портал Azure)
...
> [!NOTE]
> Сведения о настройке динамической маскировки данных на портале Azure см. в статье [Начало работы с динамической маскировкой данных в базе данных SQL (портал Azure)](sql-database-dynamic-data-masking-get-started.md).
> 
> 
...
См. раздел, посвященный [динамической маскировке данных](https://msdn.microsoft.com/library/mt130841.aspx).
