...
Чтобы инициировать отработку отказа, обратитесь к статье [Запуск плановой или незапланированной отработки отказа для базы данных SQL Azure](sql-database-geo-replication-failover-powershell.md).
