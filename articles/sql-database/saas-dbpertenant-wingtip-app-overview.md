...
| Учебник | Описание |
|:--|:--|
| [Рекомендации и советы по использованию примера мультитенантного приложения SaaS для базы данных SQL Azure](saas-dbpertenant-wingtip-app-guidance-tips.md) | **НАЧНИТЕ ЗДЕСЬ!** Скачайте и выполните скрипты PowerShell для подготовки частей приложения. |
...
- [Рекомендации и советы по использованию примера мультитенантного приложения SaaS для базы данных SQL Azure](saas-dbpertenant-wingtip-app-guidance-tips.md)
