...
# База данных SQL — поддержка клиентов прежних версий для аудита и динамической маскировки данных 
...
- .NET 4.0 и ниже
- ODBC 10.0 и ниже
- JDBC 4.0 и ниже (хотя JDBC 4.0 поддерживает TDS 7.4, но функция перенаправления TDS поддерживается не полностью)
- Tedious (для Node.JS)
