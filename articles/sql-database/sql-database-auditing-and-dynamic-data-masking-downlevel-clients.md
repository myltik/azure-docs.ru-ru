---
title: "База данных SQL: поддержка клиентов прежних версий и изменения конечных точек с IP-адресами для аудита | Документация Майкрософт"
description: "Дополнительные сведения о поддержке клиентов прежних версий базы данных SQL и изменениях конечных точек с IP-адресами для аудита"
...
[аудита](sql-database-auditing-get-started.md) автоматически выполняются в клиентах SQL, которые поддерживают перенаправление TDS.

## <a name="a-idsubheading-1adownlevel-clients-support"></a><a id="subheading-1"></a>Поддержка клиентов нижнего уровня
...
## <a name="a-idsubheading-2aip-endpoint-changes-when-enabling-auditing"></a><a id="subheading-2"></a>Изменения IP-адресов конечных точек при включении аудита
Обратите внимание, что при включении аудита IP-адрес конечной точки базы данных изменится. Если в брандмауэре используются строгие параметры, обновите их соответственно.
