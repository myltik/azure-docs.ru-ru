...
[Аудит таблиц в базе данных SQL](sql-database-auditing-get-started.md) автоматически выполняется в клиентах SQL, которые поддерживают перенаправление TDS. Обратите внимание, что перенаправление не применяется при использовании метода аудита больших двоичных объектов.
