<properties 
	pageTitle="База данных SQL — поддержка клиентов прежних версий для аудита и динамического маскирования данных |Microsoft Azure" 
	description="Дополнительные сведения о поддержке клиентов прежних версий Базы данных SQL для аудита и динамического маскирования данных." 
...
# База данных SQL — поддержка клиентов прежних версий для аудита и динамического маскирования данных 


Функции [аудита](sql-database-auditing-get-started.md) и [динамической маскировки данных](sql-database-dynamic-data-masking-get-started.md) работают в клиентах SQL, которые поддерживают перенаправление TDS.
