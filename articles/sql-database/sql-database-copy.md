...
Ниже показано, как скопировать Базу данных SQL с помощью [портала предварительной версии Azure](https://portal.azure.com). Операция копирования базы данных создает новую Базу данных SQL. Такая копия представляет собой моментальный снимок базы данных, созданный на том же или на другом сервере.
