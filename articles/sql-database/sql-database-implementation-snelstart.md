<properties
   pageTitle="База данных SQL Azure: пример использования Azure — Snelstart | Microsoft Azure"
...
# С помощью Azure компания SnelStart быстро расширила свои бизнес-службы со скоростью 1000 новых баз данных SQL Azure в месяц

![Логотип](./media/sql-database-case-study-snelstart/snelstartlogo.png)
...
##Почему SnelStart решила перенести свои службы с настольных компьютеров в облако
...
##Современная компания, соблюдающая традиции
...
##Оптимизация производительности и расходов с помощью пулов эластичных БД
...
##Базы данных SQL Azure помогают помещать данные в контейнеры для изоляции и безопасности 
...
##Azure устраняет непроизводительные издержки, позволяя разработчикам эффективней использовать свое время 
...
##Как службы Azure реализуют SaaS для SnelStart?
...
![На рисунке 1](./media/sql-database-case-study-snelstart/figure1.png)
...
##Простота, достигаемая с помощью облака
...
Компания SnelStart также признательна команде Базы данных SQL Microsoft Azure за надежное партнерство и поддержку. Г-н Куйп говорит: "У нас были споры о разных функциях и о применении технологий. Думаю, они были полезны для обеих сторон". Ближайшая цель для SnelStart — дальнейшее увеличение базы довольных клиентов. Г-н Беен утверждает: "Если отбросить технические и ресурсные ограничения, которые у нас были как у независимого поставщика программного обеспечения, то нет той вершины, которую мы не можем покорить".
...
- Дополнительные сведения о хранилище данных SQL Azure см. в [этой статье](https://azure.microsoft.com/documentation/services/sql-data-warehouse/).

- Дополнительные сведения о SnelStart см. на сайте [SnelStart](http://www.snelstart.nl).
