...
Несегментированные базы данных рассматриваются в статье [Запросы между сегментированными облачными базами данных (вертикальное секционирование)](sql-database-elastic-query-vertical-partitioning.md).
