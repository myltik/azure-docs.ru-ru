...
1. На [портале Azure](https://portal.azure.com) перейдите к списку баз данных на сервере *tenants1*. 
...
2. Проверьте экран **Наблюдение за эластичными базами данных**.Там показаны наиболее активные базы данных за последний час. База данных *contosoconcerthall* также должна появиться в этом списке.
