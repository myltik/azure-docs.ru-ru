---
title: "Мониторинг производительности приложения WTP (пример приложения SaaS, использующего базу данных SQL Azure) | Документация Майкрософт"
description: "Сведения о мониторинге производительности примера приложения SaaS, которое использует базу данных SQL Azure."
