...
description: "Мониторинг и контроль производительности для примера приложения SaaS базы данных SQL Azure Wingtip."
