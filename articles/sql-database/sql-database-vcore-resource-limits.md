...
|Уровень производительности|GP_Gen4_1|GP_Gen4_2|GP_Gen4_4|GP_Gen4_8|GP_Gen4_16|
|:--- | --: |--: |--: |--: |--: |
|Создание аппаратной части|4.|4.|4.|4.|4.|
|Виртуальные ядра|1|2|4.|8|16|
|Память (ГБ)|7|14|28|56|112|
...
|Тип хранилища|Хранилище уровня "Премиум" (удаленное)|Хранилище уровня "Премиум" (удаленное)|Хранилище уровня "Премиум" (удаленное)|Хранилище уровня "Премиум" (удаленное)|Хранилище уровня "Премиум" (удаленное)|
...
|Максимальный размер журнала|307|307|461|922|1229|
|Размер tempdb (ГБ)|32|64|128|256|384|
|Целевая скорость операций ввода-вывода в секунду|320|640|1280|2560|5120|
|Задержка ввода-вывода (приблизительно)|5–7 мс (запись)
|Максимальное количество одновременных рабочих ролей (запросов)|200|400|800|1600|3200|
|Максимальное количество одновременных входов|200|400|800|1600|3200|
|Максимальное число одновременных сеансов|3000|3000|3000|3000|3000|
...
|Память (ГБ)|7|14|28|56|112|
|Поддержка columnstore|Yes|Yes|Yes|Yes|Yes|
|Хранилище выполняющейся в памяти OLTP (ГБ)|1|2|4.|8|20|
|Тип хранилища|Подключенный диск SSD|Подключенный диск SSD|Подключенный диск SSD|Подключенный диск SSD|Подключенный диск SSD|
|Максимальный размер данных (ГБ)|1024|1024|1024|1024|1024|
|Максимальный размер журнала|307|307|307|307|307|
|Размер tempdb (ГБ)|32|64|128|256|384|
|Целевая скорость операций ввода-вывода в секунду|5000|10 000|20 000|40 000|80 000|
...
|Хранилище выполняющейся в памяти OLTP (ГБ)|Недоступно|Недоступно|Недоступно|Недоступно|Недоступно|
|Тип хранилища|Хранилище уровня "Премиум" (удаленное)|Хранилище уровня "Премиум" (удаленное)|Хранилище уровня "Премиум" (удаленное)|Хранилище уровня "Премиум" (удаленное)|Хранилище уровня "Премиум" (удаленное)|
|Максимальный размер данных (ГБ)|512|756|1536|2048|3584|
|Максимальный размер журнала|154|227|461|614|1075|
|Размер tempdb (ГБ)|32|64|128|256|384|
|Целевая скорость операций ввода-вывода в секунду|320|640|1280|2560|5120|
|Задержка ввода-вывода (приблизительно)|5–7 мс (запись)<br>5–10 мс (чтение)|5–7 мс (запись)<br>5–10 мс (чтение)|5–7 мс (запись)<br>5–10 мс (чтение)|5–7 мс (запись)<br>5–10 мс (чтение)|5–7 мс (запись)<br>5–10 мс (чтение)|
|Максимальное количество одновременных рабочих ролей (запросов)|210|420|840|1680|3360|
|Максимальное количество одновременных входов|210|420|840|1680|3360|
|Максимальное число одновременных сеансов|3000|3000|3000|3000|3000|
|Максимальная плотность пула|100|200|500|500|500|
|Минимальное и максимальное количество раз остановки эластичного пула|0, 0,25, 0,5, 1|0, 0,25, 0,5, 1, 2|0, 0,25, 0,5, 1, 2, 4|0, 0,25, 0,5, 1, 2, 4, 8|0, 0,25, 0,5, 1, 2, 4, 8, 16|
|Количество реплик|1|1|1|1|1|
|Возможность развертывания Multi-AZ|Недоступно|Недоступно|Недоступно|Недоступно|Недоступно|
|Горизонтальное масштабирование для чтения|Недоступно|Недоступно|Недоступно|Недоступно|Недоступно|
|Включенное хранилище резервных копий|1 x размер базы данных|1 x размер базы данных|1 x размер базы данных|1 x размер базы данных|1 x размер базы данных|
...
|Тип хранилища|Подключенный диск SSD|Подключенный диск SSD|Подключенный диск SSD|Подключенный диск SSD|Подключенный диск SSD|
|Максимальный размер данных (ГБ)|1024|1024|1024|1024|1024|
|Максимальный размер журнала|307|307|307|461|614|
|Размер tempdb (ГБ)|32|64|128|256|384|
|Целевая скорость операций ввода-вывода в секунду|320|640|1280|2560|5120|
|Задержка ввода-вывода (приблизительно)|1–2 мс (запись)<br>1–2 мс (чтение)|1–2 мс (запись)<br>1–2 мс (чтение)|1–2 мс (запись)<br>1–2 мс (чтение)|1–2 мс (запись)<br>1–2 мс (чтение)|1–2 мс (запись)<br>1–2 мс (чтение)|
|Максимальное количество одновременных рабочих ролей (запросов)|210|420|840|1680|3360|
|Максимальное количество одновременных входов|210|420|840|1680|3360|
|Максимальное число одновременных сеансов|3000|3000|3000|3000|3000|
|Максимальная плотность пула|Недоступно|50|100|100|100|
|Минимальное и максимальное количество раз остановки эластичного пула|0, 0,25, 0,5, 1|0, 0,25, 0,5, 1, 2|0, 0,25, 0,5, 1, 2, 4|0, 0,25, 0,5, 1, 2, 4, 8|0, 0,25, 0,5, 1, 2, 4, 8, 16|
|Возможность развертывания Multi-AZ|Yes|Yes|Yes|Yes|Yes|
|Горизонтальное масштабирование для чтения|Yes|Yes|Yes|Yes|Yes|
|Включенное хранилище резервных копий|1 x размер базы данных|1 x размер базы данных|1 x размер базы данных|1 x размер базы данных|1 x размер базы данных|
