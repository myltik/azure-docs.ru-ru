...
- Сведения об использовании геовосстановления для аварийного восстановления см. в разделе [Обзор. Геовосстановление базы данных SQL Azure](sql-database-recovery-using-backups.md#geo-restore).
