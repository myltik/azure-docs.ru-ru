...
> [AZURE.NOTE] В случае необратимого сбоя службы в регионе необходимо вручную активировать отработку отказа базы данных и принять потери данных. Приложение будет работать в дополнительном регионе с доступом к базе данных для чтения и записи.
