...
2. Вызов соответствующей базы данных-получателя для [запуска отработки отказа базы данных](https://msdn.microsoft.com/
