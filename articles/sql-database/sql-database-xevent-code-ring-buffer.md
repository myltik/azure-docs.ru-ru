---
title: Код кольцевого буфера XEvent для Базы данных SQL | Microsoft Docs
description: 'Содержит пример кода Transact-SQL, обеспечивающего простоту и удобство использования целевого объекта '
;кольцевой: ''
буфер";: ''
в: ''
базе: ''
