...
Логика повторных попыток при временных ошибках — это пример области, в которой библиотека EntLib60 может быть полезной. См. статью [4 — Perseverance, Secret of All Triumphs: Using the Transient Fault Handling Application Block](http://msdn.microsoft.com/library/dn440719%28v=pandp.60%29.aspx) (4. Настойчивость, секрет всех побед: использование решения Transient Fault Handling Application Block).
