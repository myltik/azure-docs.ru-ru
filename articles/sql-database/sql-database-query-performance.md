...
- Откройте [Помощник по производительности](sql-database-index-advisor.md) и проверьте наличие каких-либо рекомендаций.
...
Для получения дополнительных рекомендаций по повышению производительности базы данных SQL щелкните [Помощник по производительности](sql-database-index-advisor.md) в колонке **Анализ производительности запросов**.
