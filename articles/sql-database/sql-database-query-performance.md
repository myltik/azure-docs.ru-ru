...
> [AZURE.NOTE]Сейчас существует только предварительная версия функции анализа производительности запросов, доступная только на [портале предварительной версии Azure](https://portal.azure.com/).
...
На [портале предварительной версии](https://portal.azure.com) выполните следующие действия.
