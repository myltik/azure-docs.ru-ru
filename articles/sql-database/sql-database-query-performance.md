...
Для получения дополнительных рекомендаций по повышению производительности базы данных SQL щелкните [Помощник по базам данных SQL](sql-database-advisor.md) в колонке **Анализ производительности запросов**.
