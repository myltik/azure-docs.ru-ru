<properties
   pageTitle="База данных SQL помогает обеспечить безопасность и защиту"
...
# База данных SQL помогает обеспечить безопасность и защиту
...
Вы можете только надеяться, что вам никогда не потребуется вчерашняя резервная копия или восстановление после аварии. Но если это случится, база данных SQL всегда выручит вас. Вам гарантированы: доступность на уровне 99,99 %, автоматическое резервное копирование, восстановление до точки во времени, встроенная географическая репликация и возможности отработки отказа. Благодаря этому вы можете не беспокоиться о надежности своего приложения.

[Ознакомьтесь с документацией](sql-database-business-continuity.md).

## Крупнейшее портфолио соответствия требованиям

База данных SQL располагает крупнейшим портфолио соответствия промышленным стандартам. Если вас интересует регламент HIPPA или FERPA, или даже Сингапурский стандарт MTCS уровня 3 — не беспокойтесь, мы все это поддерживаем.
