...
Откройте терминал и перейдите в каталог, в котором вы планируете создать сценарий Python. Введите следующие команды для установки **brew**, **FreeTDS** и **pyodbc**. pyodbc использует FreeTDS MacOS для подключения к базам данных SQL.
