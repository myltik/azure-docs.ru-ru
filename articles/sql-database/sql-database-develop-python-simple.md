...
[Предварительные требования для использования драйвера pymssql Python для SQL Server](https://msdn.microsoft.com/library/mt694094.aspx)
...
[Эксперимент по подключению к SQL с использованием Python](http://msdn.microsoft.com/library/mt715796.aspx)
