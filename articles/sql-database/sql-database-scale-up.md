---
title: Изменение уровня обслуживания и уровня производительности базы данных SQL Azure
...
4. Щелкните базу данных, которую хотите изменить.
5. В колонке "База данных SQL" выберите **Все настройки**, а затем **Ценовая категория (масштабировать DTU)**.
   
   ![ценовая категория][1]
6. Выберите новый уровень обслуживания и нажмите кнопку **Выбрать**.
...
7. На ленте слева щелкните **Уведомления**:
...
1. Нажмите **ПРОСМОТРЕТЬ ВСЕ**.
2. Нажмите **Базы данных SQL**.
3. Щелкните базу данных, которую вы обновили.
4. Щелкните **Ценовая категория** и убедитесь, что вы выбрали правильную категорию.
