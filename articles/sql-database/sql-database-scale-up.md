...
3.	Затем в колонке "База данных SQL" щелкните плитку **Ценовая категория**.

    ![плитка "Ценовой уровень"][1]
...
3.	Щелкните плитку **Ценовая категория** и убедитесь, что выбран правильный уровень.
