...
3.	В колонке "База данных SQL" выберите **Все параметры**, а затем щелкните пункт **Ценовая категория (масштабировать DTU)**.
...
1.  Выберите новый уровень обслуживания и нажмите кнопку **Выбрать**.
    ...
    > [AZURE.NOTE] Изменение ценовой категории базы данных не приводит к изменению максимального размера баз данных. Чтобы изменить максимальный размер базы данных, используйте [Transact-SQL (T-SQL)](https://msdn.microsoft.com/library/mt574871.aspx) или [PowerShell](https://msdn.microsoft.com/library/mt619433.aspx).
...
3.	Щелкните пункт **Ценовая категория** и убедитесь, что вы выбрали правильную категорию.
