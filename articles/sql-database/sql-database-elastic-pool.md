...
## <a name="edtu-and-storage-limits-for-elastic-pools-and-elastic-databases"></a>eDTU и размеры хранилища для эластичных баз данных и пулов эластичных баз данных
...
В следующих таблицах описаны ограничения для пулов эластичных БД и эластичных баз данных.
...
Дополнительные сведения о других средствах работы с эластичными базами данных см. в статье [Развертывание с помощью базы данных SQL Azure](sql-database-elastic-scale-introduction.md).
