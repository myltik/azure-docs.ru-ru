...
Вы можете увеличить или уменьшить количество ресурсов, доступных для эластичного пула, в зависимости от потребностей.
...
## <a name="what-are-the-resource-limits-for-elastic-pools"></a>Каковы ограничения на ресурсы для эластичных пулов?
...
## <a name="manage-sql-database-elastic-pools-using-the-azure-portal"></a>Управление эластичными пулами базы данных SQL с помощью портала Azure
...
Чтобы создать эластичный пул и переместить в него существующие базы данных, проще всего использовать колонку существующего **сервера** на портале. Также можно создать эластичный пул, выполнив поиск по строке **пул эластичных баз данных SQL** в **Marketplace** или нажав кнопку **+Добавить** в колонке обзора **Пулы эластичных БД SQL**. В процессе подготовки пула вы можете создать новый сервер или указать существующий.

> [!NOTE]
> На сервере можно создать несколько пулов, но в один пул нельзя добавлять базы данных с разных серверов.
>  

Ценовая категория пула определяет функции, которые будут доступны для эластичных баз данных в пуле, максимальное количество единиц eDTU (eDTU MAX) и объем хранилища (в гигабайтах) для каждой базы данных. Дополнительные сведения см. в статье [Уровни служб](#edtu-and-storage-limits-for-elastic-pools).
...
## <a name="manage-sql-database-elastic-pools-using-the-azure-cli"></a>Управление эластичными пулами базы данных SQL с помощью Azure CLI
...
## <a name="manage-sql-database-elastic-pools-using-the-rest-api"></a>Управление эластичными пулами базы данных SQL с помощью REST API

Создание эластичных пулов баз данных SQL с помощью REST API описано в разделе [Azure SQL Database REST API](/rest/api/sql/) (REST API базы данных SQL Azure).
