...
Разработчикам SaaS приходится создавать десятки, сотни или даже тысячи баз данных SQL для управления. Пулы эластичных баз данных позволяют упростить создание и обслуживание всех этих баз, а также управление их производительностью в рамках контролируемого бюджета. При необходимости базы данных можно добавлять в пул или удалять их из пула. См. статью, посвященную [созданию масштабируемого пула эластичных баз данных SQL с использованием портала Azure](sql-database-elastic-pool-create-portal.md), [PowerShell](sql-database-elastic-pool-powershell.md) или [C#](sql-database-elastic-pool-csharp.md).
