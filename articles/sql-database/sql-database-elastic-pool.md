...
Для приложений c более высокими требованиями к восстановлению, чем те, что предложены для геовосстановления, настройте активную георепликацию. Это можно сделать на [портале Azure](sql-database-geo-replication-portal.md) либо с помощью [PowerShell](sql-database-geo-replication-powershell.md) или [Transact-SQL](sql-database-geo-replication-transact-sql.md).
