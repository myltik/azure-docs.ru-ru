...
В настоящее время эластичные базы данных доступны в виде предварительной версии и поддерживают большинство [функций обеспечения непрерывности бизнеса](sql-database-business-continuity.md), доступных для отдельных баз данных на серверах V12.
