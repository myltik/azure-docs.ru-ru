...
В рамках распространенной модели SaaS каждому клиенту предоставляется своя база данных. И каждый такой клиент (база данных) характеризуется непредсказуемым потреблением ресурсов памяти, ввода-вывода и ЦП. Так как же распределить ресурсы, зная о колебаниях потребности в них? Обычно имеется два варианта: либо подготовить чрезмерное число ресурсов, соответствующее пиковой нагрузке, что ведет к повышению затрат, либо подготовить недостаточно ресурсов в целях экономии в ущерб производительности и удовлетворенности клиентов во время пиков нагрузки. Эту проблему можно устранить благодаря пулам эластичных баз данных, в которых базы данных получают нужные ресурсы в нужное время. Кроме того, это решение предоставляет простой механизм выделения ресурсов с предсказуемыми расходами.
...
* **Пул категории "Базовый"**: возможность восстановления до любой точки, созданной за последние 7 дней. 
* **Пул категории "Стандартный"**: возможность восстановления до любой точки, созданной за последние 14 дней.
* **Пул категории "Премиум"**: возможность восстановления до любой точки, созданной за последние 35 дней. 
