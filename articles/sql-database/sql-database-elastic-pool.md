.<properties
	pageTitle="Что такое пул эластичных БД Azure? | Microsoft Azure"
...
# Что такое пул эластичных БД Azure?
...
## Ограничения eDTU и хранилища для пулов эластичных БД и эластичных баз данных
...
## Свойства пула эластичных БД и эластичной базы данных
