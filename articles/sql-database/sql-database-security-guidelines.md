...
- Всегда используйте последние обновления. При подключении к Базе данных SQL Azure всегда используйте самую последнюю версию средств и библиотек для предотвращения возникновения уязвимостей в системе безопасности.
