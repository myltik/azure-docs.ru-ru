...
## <a name="a-idazuresqlaazure-sql-database-and-sql-server-on-virtual-machines"></a><a id="AzureSQL"></a>База данных SQL Azure и SQL Server на виртуальных машинах
...
## <a name="a-idwindowsastep-4-connecting-from-a-windows-cc-application"></a><a id="Windows"></a>Шаг 4. Подключение из приложения Windows C/C++
...
## <a name="a-idlinuxastep-5-connecting-from-a-linux-cc-application"></a><a id="Linux"></a>Шаг 5. Подключение из приложения Linux C/C++
...
Запустите Visual Studio 2015. В разделе "Средства" -> "Параметры" -> "Кроссплатформенный" -> C++ -> "Диспетчер соединений" добавьте подключение к компьютеру под управлением Linux: 
...
## <a name="a-idgetsolutionaget-the-complete-cc-tutorial-solution"></a><a id="GetSolution"></a>Получение полного решения C/C++ для этого руководства
