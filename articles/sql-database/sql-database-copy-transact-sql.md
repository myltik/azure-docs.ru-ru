...
> [!NOTE]
> Кроме того, это можно сделать с помощью [портала Azure](sql-database-copy-portal.md) или [PowerShell](scripts/sql-database-copy-database-to-new-server-powershell.md).
>
