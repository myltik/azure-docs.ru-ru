...
| Количество баз данных для каждого сервера | До 5000 | На каждом сервере версии 12 может размещаться не более 5000 баз данных. В зависимости от действий входа во всех базах данных на сервере и использовании запросов в системных представлениях в базе данных master на практике могут применяться более низкие ограничения. При значительном увеличении количества баз данных на сервере клиентам рекомендуется отслеживать подключения к базе данных на возникновение возможных проблем. |  
