...
| **Ограничение** | Зависит от [уровня службы и уровня производительности](https://msdn.microsoft.com/library/azure/dn741336.aspx). |
| **Рекомендации** | Проверьте представление dm\_exec\_connections, чтобы просмотреть активные подключения пользователей.<br><br>Подождите 10 секунд и повторите попытку входа. |
...
| **Рекомендации** | Проверьте представление dm\_exec\_requests, что увидеть выполняемые в данный момент пользовательские запросы. <br><br>Подождите 10 секунд и повторите запрос. |
