...
description: "Сведения о базе данных SQL — базе данных как услуге в облаке. В руководствах, видеороликах и другой документации показано, как настроить и подключить реляционную базу данных и управлять ею."
...
Узнайте, как использовать базу данных SQL — реляционную базу данных как услугу в облаке на базе ядра Microsoft SQL Server. В руководствах, видеороликах и другой документации описывается настройка и подключение базы данных SQL и управление ею.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Подробнее о базе данных SQL Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Библиотека видеозаписей о базе данных SQL Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Начало работы с базой данных SQL Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Начало работы с инструментами эластичных баз данных</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Знакомство с управлением доступом и разрешениями</h3>
                    </div>
                </div>
            </div>
        </div>
