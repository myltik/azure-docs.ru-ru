...
4. **Настройка главного ключа**
    ...
    На странице **Настройка главного ключа** можно настроить главный ключ столбца и выбрать поставщик хранилища ключей, в котором будет находиться этот ключ. В настоящее время главные ключи столбцов можно хранить в хранилище сертификатов Windows, хранилище ключей Azure или аппаратном модуле безопасности. В этом руководстве показано, как сохранить ключи в хранилище сертификатов Windows.
...
- [Deploy Always Encrypted certificates to other client machines](https://msdn.microsoft.com/library/mt723359.aspx#Anchor_1) (Развертывание сертификатов Always Encrypted на других клиентских компьютерах) (ознакомьтесь с разделом *Making Certificates Available to Applications and Users* (Предоставление сертификатов приложениям и пользователям)).
