...
- Visual Studio 2013 с обновлением 4 или более поздняя версия. Корпорация Майкрософт предлагает *бесплатную* версию Visual Studio Community.
 ...
 - Кроме того, [далее](#InstallVSForFree) в этом разделе описывается установка Visual Studio с помощью [портала Azure](http://portal.azure.com/).
...
- С помощью [портала Azure](http://portal.azure.com/) перейдите на страницу загрузки, как описано ниже.
...
На [портале Azure](http://portal.azure.com/) скопируйте строку подключения для подключения к базе данных SQL.
...
IP-адрес можно добавить на [портале Azure](http://portal.azure.com/).
