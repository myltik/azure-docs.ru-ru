---
title: "PowerShell: восстановление базы данных SQL из геоизбыточной резервной копии | Документация Майкрософт"
description: "Восстановление базы данных SQL Azure на новый сервер из геоизбыточной резервной копии с помощью PowerShell."
...
---
# <a name="restore-an-azure-sql-database-from-a-geo-redundant-backup-with-powershell"></a>Восстановление базы данных SQL Azure из геоизбыточной резервной копии с помощью PowerShell

В этой статье показано, как восстановить базу данных на новый сервер с помощью геовосстановления и PowerShell. Эту задачу можно также выполнить на [портале Azure](sql-database-geo-restore-portal.md).
