---
title: "Выполнение запросов аналитики к нескольким клиентам (пример приложения SaaS, использующий базу данных SQL Azure) | Документация Майкрософт"
description: "Выполнение запросов аналитики к нескольким клиентам"
...
---
# <a name="run-analytics-queries-against-multiple-tenants"></a>Выполнение запросов аналитики к нескольким клиентам
