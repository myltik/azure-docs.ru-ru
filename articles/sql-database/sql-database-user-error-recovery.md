...
# Восстановление базы данных SQL Azure после ошибки
...
При восстановлении базы данных SQL Azure до точки во времени данные всегда восстанавливаются в новую базу данных, однако удаленную базу данных можно восстановить с прежним именем. Эти способы восстановления доступны для всех баз данных уровней Basic, Standard и Premium.
...
Срок хранения баз данных уровня "Базовый" составляет 7 дней, а уровней "Стандартный" и "Премиум" — 35 дней. Чтобы узнать больше о хранении резервных копий баз данных, ознакомьтесь с [создаваемыми автоматически резервными копиями](sql-database-automated-backups.md).
...
- Чтобы узнать об использовании активной георепликации, ознакомьтесь с разделом [Обзор: активная георепликация для базы данных SQL](sql-database-geo-replication-overview.md).
