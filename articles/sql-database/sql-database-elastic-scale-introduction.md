...
Для получения сведения об особенностях пула эластичных баз данных см. статью [Вопросы цены и производительности для пула эластичных баз данных](sql-database-elastic-pool-guidance.md) или воспользуйтесь [учебником](sql-database-elastic-pool-portal.md) для создания нового пула.
