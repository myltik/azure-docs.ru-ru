...
3. Подмножество баз данных помещается в **пул эластичных баз данных**. (См. статью [Что такое пул эластичных БД Azure?](sql-database-elastic-pool.md))
...
Сведения об особенностях пула эластичных баз данных см. в статье [Когда следует использовать пул эластичных баз данных?](sql-database-elastic-pool-guidance.md) или воспользуйтесь [руководством](sql-database-elastic-pool-create-portal.md) по созданию пула.  
