...
# Добавление пользователей в эластичный пул баз данных.

Задания эластичной базы данных позволяют выполнять один сценарий для всех баз данных в [эластичном пуле баз данных](sql-database-elastic-pool.md). Чтобы запустить сценарий, во все базы данных пула нужно добавить пользователя с соответствующими разрешениями. Этот пользователь может быть субъектом серверного уровня, созданным во время установки **заданий эластичной базы данных**. Ему предоставляются **учетные данные задания** для управления метаданными в **контрольной** базе данных. Дополнительные сведения см. в статье [Управление базами данных и учетными данными в базе данных SQL Azure](https://msdn.microsoft.com/library/azure/ee336235.aspx?f=255&MSPPError=-2147217396) или [Добавление пользователей в базу данных SQL Azure](http://azure.microsoft.com/blog/2010/06/21/adding-users-to-your-sql-azure-database/)
...
Выполните это задание для пула базы данных. См. статью [Создание заданий эластичной базы данных и управление ими](sql-database-elastic-jobs-create-and-manage.md).
