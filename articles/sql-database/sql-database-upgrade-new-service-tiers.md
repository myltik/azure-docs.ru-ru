...
Чтобы просмотреть рекомендуемые уровни служб для устаревших баз данных, можно воспользоваться [порталом предварительной версии Azure](https://portal.azure.com) или PowerShell. Пошаговые инструкции см. в следующих статьях:

- [Обновление до версии 12 Базы данных SQL (портал предварительной версии Azure)](sql-database-v12-upgrade.md)
...
| Статья | Описание |
|:--|:--|
|[Уровни служб и уровни производительности в базе данных SQL Azure](sql-database-service-tiers.md)| Общие сведения, метрики и возможности для каждого уровня служб (а также информация о том, как отслеживать использование баз данных с помощью портала управления и динамических административных представлений). |
...
Просмотрите общий обзор процентных показателей использования единиц передачи данных (DTU) на портале предварительной версии Azure, а затем перейдите к системным представлениям, чтобы просмотреть подробную информацию.

Кроме того, на портале предварительной версии Azure можно просмотреть уровень служб для базы данных Web или Business, рекомендуемый при обновлении сервера до версии 12 Базы данных SQL Azure.

### Как просмотреть рекомендуемый уровень служб на портале предварительной версии Azure
...
1. Войдите на [портал предварительной версии Azure](https://portal.azure.com) и перейдите к серверу, содержащему базу данных уровня Web или Business.
