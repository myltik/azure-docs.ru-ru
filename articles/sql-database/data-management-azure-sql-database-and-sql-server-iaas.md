...
**SQL Server на виртуальной машине Azure** относится к отраслевой категории *инфраструктура как услуга (IaaS)* и позволяет запускать SQL Server на виртуальной машине в облаке. Подобно базе данных Azure SQL, он создан на основе стандартного аппаратного и программного обеспечения, которое принадлежит корпорации Майкрософт, размещается и обслуживается ею. При использовании SQL Server на виртуальной машине вы можете использовать собственную лицензию SQL Server для Azure или один из предварительно настроенных образов SQL Server на классическом портале Azure.
