...
<tr>
   ...
   <td valign="middle">
      ...
      <li type=round>Аварийное восстановление для локальных приложений SQL Server с помощью [резервного копирования в службу хранилища Azure] (http://msdn.microsoft.com/library/jj919148.aspx) или [реплик AlwaysOn с виртуальными машинами Azure] (../virtual-machines/virtual-machines-windows-classic-sql-dr.md).
...
Для начала рекомендуем ознакомиться со статьей [Подготовка виртуальной машины с SQL Server в Azure](virtual-machines-windows-classic-portal-sql.md).
