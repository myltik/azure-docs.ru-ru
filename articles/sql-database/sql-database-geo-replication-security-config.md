---
title: Как управлять безопасностью после восстановления базы данных на новый сервер или отработки отказа базы данных в копию базы данных-получателя | Microsoft Docs
...
> [!NOTE]
> Раздел [Active Geo-Replication](sql-database-geo-replication-overview.md) теперь доступен для всех баз данных и всех уровней обслуживания.
> 
> 
...
> [!NOTE]
> Пользователи **INFORMATION\_SCHEMA** и **sys** имеют ИД безопасности *NULL*, а ИД безопасности пользователя **guest** – **0x00**. ИД безопасности **Dbo** может начинаться с *0x01060000000001648000000000048454*, если создателем базы данных является администратор сервера, а не участник **DbManager**.
> 
> 
