---
title: "Начало работы с резервным копированием и восстановлением баз данных SQL Azure для защиты и восстановления данных с помощью Azure PowerShell | Документация Майкрософт"
...
# <a name="get-started-with-backup-and-restore-for-data-protection-and-recovery-using-powershell"></a>Начало работы с резервным копированием и восстановлением для защиты и восстановления данных с помощью PowerShell

Из этого руководства вы узнаете, как с помощью Azure PowerShell выполнять следующие задачи:
