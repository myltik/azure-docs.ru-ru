...
|Пропускная способность ввода-вывода|Низкий  | Средний | Порядок величины больше, чем для уровня "Стандартный".|
|Задержка ввода-вывода|Выше, чем для уровня "Премиум".|Выше, чем для уровня "Премиум".|Ниже, чем для уровней "Базовый" и "Стандартный".|
