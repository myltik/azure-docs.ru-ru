---
title: 'Уровни служб: производительность и возможности базы данных SQL | Microsoft Docs'
...
---
# <a name="sql-database-options-and-performance:-understand-what's-available-in-each-service-tier"></a>Параметры базы данных SQL и производительность: возможности разных уровней служб
