...
> [!IMPORTANT]
> Отдельные базы данных размером до 4 ТБ предоставляются в режиме общедоступной предварительной версии для клиентов, использующих уровни производительности P11 и P15, без дополнительной платы. Сейчас также доступны пулы уровня "Премиум" с более 750 ГБ хранилища. Сейчас эта возможность предоставляется в режиме общедоступной предварительной версии только в следующих регионах: восточная часть США 2, западная часть США, Западная Европа, Юго-Восточная Азия, восточная Япония, восточная Австралия, Центральная Канада и Восточная Канада. См. [текущие ограничения в 4 ТБ](sql-database-service-tiers.md#current-limitations-of-p11-and-p15-databases-with-4-tb-maxsize).
>
