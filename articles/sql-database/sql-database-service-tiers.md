...
>[AZURE.NOTE] Выпуски Web и Business станут недоступны. Узнайте, как [обновить выпуски Web и Business](sql-database-upgrade-new-service-tiers.md). Если вы собираетесь продолжать использовать выпуски Web и Business, ознакомьтесь с разделом [Вопросы и ответы по остановке версий Web и Business](https://azure.microsoft.com/pricing/details/sql-database/web-business/).
