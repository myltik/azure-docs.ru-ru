...
Приведенные здесь характеристики производительности относятся к базам данных, созданным с помощью [Базы данных SQL версии 12](sql-database-v12-whats-new.md).
