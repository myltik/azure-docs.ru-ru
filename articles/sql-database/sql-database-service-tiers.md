...
# Доступные параметры производительности базы данных SQL Azure
...
## Увеличение или уменьшение масштаба отдельной базы данных
...
* Если вы обновляете базу данных с включенной [георепликацией](sql-database-geo-replication-portal.md), перед обновлением базы данных-источника обновите базы данных-получатели до требуемого уровня производительности (общая рекомендация).
* При переходе от уровня служб **Премиум** к более низкому уровню необходимо сначала завершить все активные отношения георепликации. Чтобы остановить процесс репликации между базой данных-источником и базами данных-получателями, выполните действия, описанные в разделе [Восстановление после сбоя](sql-database-disaster-recovery.md).
...
## Текущие ограничения баз данных P11 и P15 с максимальным размером 4 ТБ
...
## Управление уровнями служб и производительности для отдельной базы данных с помощью портала Azure
...
## Управление уровнями служб и производительности для отдельной базы данных с помощью PowerShell
...
|[az sql db list-usages](/cli/azure/sql/db#list-usages)|Возвращает данные об использовании базы данных.|
...
## Управление уровнями служб и производительности для отдельной базы данных с помощью Transact-SQL
...
## Управление отдельными базами данных с помощью API REST
