---
title: "Помощник по работе с базами данных SQL Azure"
...
Для серверов версии 12 (для серверов версии 11 рекомендации недоступны) доступны следующие рекомендации. Сейчас можно настроить автоматическое применение рекомендаций по созданию и удалению индексов. Дополнительные сведения см. в разделе [Включение автоматического управления индексами](sql-database-advisor-portal.md#enable-automatic-index-management).
