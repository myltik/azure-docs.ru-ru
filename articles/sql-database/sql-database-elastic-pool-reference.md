...
- Создание пулов эластичных баз данных и управление ими возможно только с помощью [портала Microsoft Azure](https://portal.azure.com), PowerShell и REST API только в диспетчере ресурсов Azure (ARM). [Классический портал](https://manage.windowsazure.com/) и команды управления службами (RDFE) не поддерживаются. 


## Ограничения текущей предварительной версии

- Пул эластичных баз данных текущей предварительной версии имеет ценовую категорию Standard.  
- Импорт базы данных непосредственно в пул не поддерживается. Вы можете выполнить импорт в автономную базу данных, а затем переместить эту базу данных в пул. Поддерживается экспорт базы данных из пула.
- Каждый пул может содержать не более 100 баз данных.
...
| Статья | Описание |
| :-- | :-- |
| [Пулы эластичных баз данных для Базы данных SQL](sql-database-elastic-pool.md) | Обзор эластичных пулов |
| [Создание пула эластичных баз данных для Базы данных SQL и управление им с помощью портала Azure](sql-database-elastic-pool-portal.md) | Как создать эластичный пул и управлять им с помощью портала Azure |
| [Создание пула эластичных баз данных для Базы данных SQL и управление им с помощью PowerShell](sql-database-elastic-pool-powershell.md) | Как создать эластичный пул и управлять им с помощью командлетов PowerShell |
