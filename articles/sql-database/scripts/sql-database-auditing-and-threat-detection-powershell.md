...
Этот пример сценария Azure PowerShell позволяет настроить аудит и обнаружение угроз для базы данных SQL. Чтобы запустить этот пример, установите последнюю версию [Azure PowerShell](/powershell/azure/overview).
