---
title: Мониторинг базы данных SQL Azure с помощью динамических представлений управления | Microsoft Docs
...
> [!NOTE]
> Если при выполнении представлений **sys.dm\_exec\_requests** и **sys.dm\_exec\_sessions** у вас есть разрешение **VIEW DATABASE STATE** для базы данных, то вы увидите все выполняющиеся сеансы в базе данных. В противном случае вы увидите только текущий сеанс.
> 
> 
