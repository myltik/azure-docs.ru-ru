...
> [AZURE.NOTE]Если при выполнении представлений **sys.dm\_exec\_requests** и **представления sys.dm\_exec\_sessions** у пользователя есть разрешения **VIEW DATABASE STATE** для базы данных, он увидит все выполняющиеся сеансы в базе данных. В противном случае он увидит только текущий сеанс.
