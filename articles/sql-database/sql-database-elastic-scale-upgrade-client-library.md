 ...
 * На левой панели выберите пункт **Обновления** и нажмите кнопку **Обновить** возле отобразившегося в окне пакета **База данных SQL — клиентская библиотека эластичного масштабирования**.![Обновление пакетов Nuget][1]
