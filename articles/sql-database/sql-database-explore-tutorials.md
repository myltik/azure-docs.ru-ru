---
title: Изучение учебников по базе данных SQL Azure | Microsoft Docs
...
| [Копирование базы данных SQL Azure с помощью PowerShell](sql-database-copy-powershell.md#copy-your-sql-database) |В этом руководстве вы можете узнать, как скопировать базу данных SQL Azure с помощью PowerShell. |
