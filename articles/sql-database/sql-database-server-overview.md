...
- Обеспечивает область для квоты базы данных и квоты DTU для ресурсов, содержащихся на нем (например, 45000 единиц DTU).
