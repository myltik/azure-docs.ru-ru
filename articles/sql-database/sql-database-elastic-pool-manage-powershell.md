...
Переместить базу данных в эластичный пул или из него можно с помощью командлета [Set-AzureRmSqlDatabase](https://docs.microsoft.com/powershell/module/azurerm.sql/set-azurermsqlelasticpool).
