...
Используйте [последнюю версию средств для работы с данными SQL Server для Visual Studio](https://msdn.microsoft.com/library/mt204009.aspx) вместе с Visual Studio 2013 с обновлением 4 или более поздней версии.
