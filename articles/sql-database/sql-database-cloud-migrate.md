...
В дополнение к поиску в Интернете и этим ресурсам вы можете получить помощь в устранении проблемы несовместимости на [форумах MSDN сообщества SQL Server](https://social.msdn.microsoft.com/Forums/sqlserver/home?category=sqlserver) и сайте [StackOverflow](http://stackoverflow.com/).
