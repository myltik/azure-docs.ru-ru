---
title: "Управление схемой для нескольких клиентов (пример приложения SaaS, использующего базу данных SQL Azure) | Документация Майкрософт"
description: "Управление схемой для нескольких клиентов в приложении SaaS, использующем Azure SQL"
