...
1. Измените \<пользователь\> на имя пользователя, которое вы использовали при развертывании приложения Wingtip, во всех трех местах скрипта.
