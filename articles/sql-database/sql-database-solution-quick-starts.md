...
Демонстрация [WingTipTickets базы данных SQL Azure](https://github.com/microsoft/wingtiptickets) и практическая работа. Эти файлы представляют собой практическую работу. В ней демонстрируется пример приложения, которое работает на основании базы данных SQL Azure и Поиска Azure и которое служит для продажи билетов на концерты.
