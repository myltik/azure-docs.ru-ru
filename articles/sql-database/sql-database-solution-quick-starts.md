...
[Пользовательская панель мониторинга пула эластичных БД для SaaS](https://github.com/Microsoft/sql-server-samples/tree/master/samples/manage/azure-sql-db-elastic-pools-custom-dashboard) в репозитории примеров SQL Server на сайте GitHub предоставляет генератор нагрузки и веб-приложение мониторинга, а также документацию, в которой описывается их назначение и способ использования.
...
## Демонстрационное приложение Contoso Clinic

В этом примере демонстрируются функции безопасности базы данных SQL Azure (вер. 12). Для выполнения этого примера ознакомьтесь с разделом [Демонстрационное приложение Contoso Clinic](https://github.com/Microsoft/azure-sql-security-sample).
