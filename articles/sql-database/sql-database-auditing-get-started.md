...
Если вы пользуетесь [клиентом прежних версий](sql-database-auditing-and-dynamic-data-masking-downlevel-clients.md), перед настройкой аудита проверьте контроль аудирования. Кроме того, если брандмауэр имеет строгие параметры, при включении аудита [IP-адрес конечной точки базы данных изменится](sql-database-auditing-and-dynamic-data-masking-downlevel-clients.md).
