...
Средства аудита позволяют и способствуют соблюдению стандартов, но не гарантируют соответствия им. Дополнительные сведения о программах Azure, поддерживающих проверку соблюдения стандартов, см. [Центр управления безопасностью Azure](http://azure.microsoft.com/support/trust-center/compliance).
...
Дополнительные сведения об аудируемых действиях и событиях см. в разделе [Справочник по формату журнала аудита (DOC)](http://go.microsoft.com/fwlink/?LinkId=506733).
...
1. Запустите [портал предварительной версии Azure](https://portal.azure.com) на https://portal.azure.com либо [классический портал Azure](https://manage.windowsazure.com/) на https://manage.windowsazure.com/. См. подробности ниже.
...
7. После настройки параметров аудита можно **включить** обнаружение угроз и указать адреса электронной почты для получения предупреждений системы безопасности. Дополнительные сведения см. на странице [Начало работы с функцией обнаружения угроз](sql-database-threat-detection-get-started.md).
...
Для скачивания доступен предварительно настроенный шаблон отчета в виде [загружаемой таблицы Excel](http://go.microsoft.com/fwlink/?LinkId=403540), что позволит быстро проанализировать данные журнала. Для того, чтобы использовать шаблон с вашими журналами аудита, вам потребуется Excel 2013 и выше и Power Query, который можно загрузите по [этой ссылке](http://www.microsoft.com/download/details.aspx?id=39379).
...
1. Запустите [классический портал Azure](https://manage.windowsazure.com/) на https://manage.windowsazure.com/.
...
Описания в этом разделе относятся к снимкам экрана выше. Можно использовать [портал предварительной версии Azure](https://portal.azure.com) или [классический портал Azure](https://manage.windowsazure.com/).


##<a id="subheading-6"></a>Повторное создание ключа хранилища

Обычно, в рабочей среде приходится периодически обновлять ключи хранилища. При обновлении ключей необходимо сохранять политику аудирования повторно. Вот как это можно сделать:
