---
title: Настройка георепликации базы данных SQL Azure с помощью Transact-SQL | Microsoft Docs
...
## Обновление недоступной для чтения базы данных-получателя до доступной для чтения
