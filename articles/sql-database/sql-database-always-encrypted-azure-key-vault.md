...
12. Оставьте параметр **ПОКАЗАТЬ** в значении **Приложения Microsoft**, затем найдите и выделите **Управление службами Microsoft Azure** и щелкните флажок, чтобы продолжить.
