...
|Команда|Описание|
|-------|-----------|
|[ALTER DATABASE (база данных SQL Azure)]https://msdn.microsoft.com/ru-RU/library/mt574871.aspx)|Используйте аргумент ADD SECONDARY ON SERVER, чтобы создать базу данных-получатель для существующей базы данных и начать репликацию данных.|
|[ALTER DATABASE (база данных SQL Azure)]https://msdn.microsoft.com/ru-RU/library/mt574871.aspx)|Используйте аргумент FAILOVER или FORCE\_FAILOVER\_ALLOW\_DATA\_LOSS, чтобы задать базу данных-получатель в качестве базы данных-источник для запуска отработки отказа.
|[ALTER DATABASE (база данных SQL Azure)]https://msdn.microsoft.com/ru-RU/library/mt574871.aspx)|Используйте аргумент REMOVE SECONDARY ON SERVER, чтобы завершить репликацию данных между базой данных SQL и указанной базой данных-получателем.|
...
|API|Описание|
|---|-----------|
|[REST (createMode=Restore)](https://msdn.microsoft.com/library/azure/mt163685.aspx)|Создает, обновляет или восстанавливает базу данных-источник или базу данных-получатель.|
