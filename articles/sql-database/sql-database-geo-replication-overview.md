...
>[AZURE.NOTE] Задержка вследствие вызова процедуры **sp_wait_for_database_copy_sync** может оказаться значительной. Задержка зависит от объема журнала транзакций в данный момент. Возврата результата вызова не происходит до полной репликации всего журнала. Вызывайте эту процедуру только в случае крайней необходимости.
