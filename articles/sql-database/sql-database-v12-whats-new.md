...
До версии 12 Базы данных SQL Azure включали шлюз, который действовал как прокси для буферизации всех взаимодействий между базой данных и клиентской программой. Шлюз предоставлял автоматическую *логику повторных попыток* для некоторых *временных ошибок*.

 В версии 12 этот шлюз отсутствует. Теперь ваша программа должна обеспечивать более полную обработку временных ошибок. Дополнительные сведения см. в разделе


- [Подключение к базе данных SQL: ссылки, рекомендации и советы по разработке](sql-database-connect-central-recommendations.md#gatewaynoretry)
...
| Регион Azure | Текущее состояние<br/>выпуска версии 12 | Дата перехода в<br/>состояние общей доступности, приблизительная |
| :--- | :--- | :--- |
| Восточная часть Австралии | **Предварительная версия** | Третий квартал календарного 2015 г. (приблизительно) |
| Юго-Восточная часть Австралии | **Предварительная версия** | Третий квартал календарного 2015 г. (приблизительно) |
