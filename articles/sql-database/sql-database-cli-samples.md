---
title: "Примеры Azure CLI для базы данных SQL | Документация Майкрософт"
...
В следующей таблице содержатся ссылки на примеры скриптов Azure CLI для базы данных SQL Azure.
