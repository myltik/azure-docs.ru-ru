...
# Удаление компонентов службы заданий обработки эластичных баз данных

Если во время установки службы заданий обработки эластичных баз данных произойдет ошибка, удалите группу ресурсов службы.
...
Общие сведения о службе можно найти в статье [Обзор службы заданий обработки эластичных баз данных](sql-database-elastic-jobs-overview.md).
