---
title: "Мониторинг пула эластичных баз данных и управление им на портале Azure | Документация Майкрософт"
...
2. В колонке **Изменение диаграммы** выберите новый диапазон времени (последний час, текущий день или прошлую неделю) или нажмите кнопку **Пользовательский**, чтобы выбрать любой диапазон времени в пределах прошедших двух недель. Выберите тип диаграммы (линейчатая или график), а затем выберите ресурсы для мониторинга.

   > [!Note]
   > Диаграмма может одновременно показывать несколько метрик с одинаковыми единицами измерения. Например, если вы выберете "Процент eDTU", дополнительно можно будет выбрать только те метрики, которые измеряются в процентах.
   >
