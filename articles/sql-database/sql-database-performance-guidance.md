...
- [Помощник по работе с базами данных SQL](sql-database-index-advisor.md)
...
>[AZURE.NOTE] Перед использованием динамических административных представлений для поиска отсутствующих индексов сначала ознакомьтесь с разделом об [анализе производительности запросов и помощнике по работе с базами данных SQL](#query-performance-insight-and-index-advisor).
