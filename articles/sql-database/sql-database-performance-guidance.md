...
>[AZURE.NOTE]Можно также использовать портал управления Azure для просмотра использования ресурсов. Например, см. раздел [Уровни служб. Мониторинг производительности](sql-database-service-tiers.md#monitoring-performance).
