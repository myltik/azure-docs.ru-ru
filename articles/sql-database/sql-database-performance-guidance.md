...
Уровень Стандартный и активная георепликация предоставляют аналогичные функции аварийного восстановления, но с более низкой целевой точкой восстановления \(RPO\). Например, с геовосстановлением целевая точка восстановления — менее одного часа \(другими словами, резервная копия сделана не позже часа назад\). Но в случае георепликации целевая точка восстановления — менее 5 секунд.
...
### Анализ производительности запросов и помощник по индексу
База данных SQL предоставляет на классическом портале Azure два средства для анализа и устранения проблем производительности базы данных.

- [Анализ производительности запросов](sql-database-query-performance.md)
- [Помощник по индексу](sql-database-index-advisor.md)
...
>[AZURE.NOTE] Перед использованием динамических административных представлений для поиска отсутствующих индексов сначала ознакомьтесь с разделом об [анализе производительности запросов и помощнике по индексу](#query-performance-insight-and-index-advisor).
