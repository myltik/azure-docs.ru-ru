...
* **Premium RS**. Уровень Premium RS предназначен для рабочих нагрузок, интенсивно использующих ввод-вывод, но не требующих гарантий максимальной доступности. К примерам относятся тестовые высокопроизводительные рабочие нагрузки или рабочие нагрузки анализа, для которых база данных не является системой учета.
