...
Нет запроса или динамического административного представления, которые могли бы показать количество одновременных входов или журнал. Чтобы получить представление о частоте входа, можно проанализировать шаблоны работы пользователей и приложений. Можно также запустить реальные нагрузки в тестовой среде, чтобы убедиться в том, что вы не приближаетесь к этим или другим ограничениям, описанным в этом разделе.
...
>[AZURE.NOTE] Некоторые столбцы **sys.resource\_stats** были изменены в текущей версии 12 баз данных, поэтому образцы запросов в следующих примерах могут вызывать ошибки. Будущие обновления этого раздела предоставят новые версии запросов, которые решают эту проблему.
