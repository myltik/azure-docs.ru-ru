...
- **Начало работы с Базой данных SQL Azure**. Для приложений на первых этапах разработки часто не требуется высокого уровня производительности. Базы данных Basic предоставляют идеальную среду для разработки по низкой цене.
...
>[AZURE.NOTE]Перед использованием динамических административных представлений для поиска отсутствующих индексов сначала ознакомьтесь с разделом об [анализе производительности запросов и помощнике по индексу](query-performance-insight-and-index-advisor.md).
