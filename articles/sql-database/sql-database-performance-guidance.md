...
### Хранилище XTP In-Memory
**Хранилище Max XTP In-Memory** — это максимальный объем дискового пространства, доступный в [предварительной версии In-Memory OLTP](sql-database-in-memory.md) для баз данных уровня Премиум. Можно использовать портал Azure или представление **sys.dm\_db\_resource\_stats**, чтобы отслеживать использование хранилища In-Memory. Дополнительные сведения об отслеживании см. в разделе [Мониторинг хранилища XTP In-Memory](sql-database-in-memory-oltp-monitoring.md).
...
>[AZURE.NOTE]Можно также использовать портал управления Azure для просмотра использования ресурсов. Например, см. раздел [Уровни служб. Наблюдение за производительностью](sql-database-service-tiers.md#monitoring-performance).
...
Следующий пример демонстрирует различные способы понять сведения об использовании ресурсов Базы данных SQL с помощью представления каталога **sys.resource\_stats**.
