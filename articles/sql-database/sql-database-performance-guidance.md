---
title: "База данных SQL Azure и производительность отдельных баз данных | Документация Майкрософт"
...
> [!NOTE]
> В статье приведены рекомендации по производительности отдельных баз данных в Базе данных SQL Azure. Сведения о производительности пулов эластичных баз данных см. в статье [Когда следует использовать пул эластичных баз данных](sql-database-elastic-pool-guidance.md). Обратите внимание, что многие из рекомендаций по настройке в этой статье можно применить к базам данных в пуле эластичных баз данных, чтобы получить аналогичные преимущества в отношении производительности.
> 
> 
...
> [!NOTE]
> Сейчас предварительная версия оперативной обработки транзакций Azure в памяти поддерживается только для отдельных баз данных. Ее нельзя использовать для баз данных в пулах эластичных баз данных.
> 
> 
