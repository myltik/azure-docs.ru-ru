...
**Восстановление состояния системы в определенной временной точке** — возможность восстановления состояния базы данных на более ранний момент времени. Уровень службы определяет, состояние какой давности вы можете использовать. Подробнее см. в разделе [Восстановление Базы данных SQL Azure после ошибки пользователя](sql-database-user-error-recovery.md).
