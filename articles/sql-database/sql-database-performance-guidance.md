...
Для анализа Базы данных SQL можно получить журнал статистики использования сеансов. Для этого выполните запрос **sys.resource_stats** и воспользуйтесь столбцом **active_session_count**. Дополнительные сведения об использовании этого представления см. в следующем разделе.
...
>[AZURE.NOTE] Вы должны быть подключены к базе данных **master** логического сервера базы данных SQL, чтобы отправить запрос **sys.resource_stats** в следующих примерах.
...
- Дополнительные сведения о пулах эластичных баз данных см. в статье [Что такое пул эластичных баз данных Azure?](sql-database-elastic-pool.md).
