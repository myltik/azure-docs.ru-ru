...
Чтобы создать правила автомасштабирования, вам понадобится имеющийся масштабируемый набор виртуальных машин. Вы можете создать его с помощью [портала Azure](virtual-machine-scale-sets-portal-create.md), [Azure CLI 2.0](virtual-machine-scale-sets-create.md#create-from-azure-cli) или [Azure PowerShell](virtual-machine-scale-sets-create.md#create-from-powershell).
