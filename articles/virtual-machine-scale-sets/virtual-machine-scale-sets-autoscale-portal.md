...
Чтобы увидеть, как применяются правила автомасштабирования, выберите **Журнал выполнения** в верхней части окна **Масштабирование**. График и список событий соответствуют активации правил автомасштабирования и количеству экземпляров виртуальных машин при изменении масштаба.
