...
```
> [!NOTE]
> Виртуальные машины разных размеров имеют различные ограничения на количество подключенных дисков, которые они поддерживают. Прежде чем добавлять новый диск, просмотрите [характеристики размеров виртуальных машин](../virtual-machines/virtual-machines-windows-sizes.md).
