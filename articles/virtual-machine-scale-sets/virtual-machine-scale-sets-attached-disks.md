...
* Создайте управляемый образ диска ОС и диска данных (с необходимыми данными), а затем создайте масштабируемый набор с этим образом. Таким образом, каждая новая виртуальная машина будет создаваться с диском данных, указанном в определении масштабируемого набора. Так как это определение ссылается на образ диска данных с необходимыми данными, каждая виртуальная машина в масштабируемом наборе автоматически создается с этими изменениями.
