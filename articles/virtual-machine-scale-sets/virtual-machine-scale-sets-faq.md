...
### <a name="what-is-the-resourceguid-property-on-a-nic-for-its-not-documented-here"></a>Для чего предназначено свойство resourceGuid в сетевом адаптере? Здесь это не описано.
