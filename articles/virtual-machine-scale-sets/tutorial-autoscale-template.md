...
После входа в систему установите служебную программу **stress**. Запустите *10* **нагрузочных** рабочих процессов, которые создают нагрузку на ЦП. Эти рабочие процессы выполняются на протяжении *420* секунд, чего достаточно, чтобы активировать правила автомасштабирования для реализации нужного действия.
...
Когда в служебной программе **stress** отобразятся примерно такие выходные данные *stress: info: [2688] dispatching hogs: 10 cpu, 0 io, 0 vm, 0 hdd*, нажмите клавишу *ВВОД*, чтобы вернуться к командной строке.
...
Опять-таки, когда в служебной программе **stress** отобразятся примерно такие выходные данные *stress: info: [2713] dispatching hogs: 10 cpu, 0 io, 0 vm, 0 hdd*, нажмите клавишу *ВВОД*, чтобы вернуться к командной строке.
...
Выйдите из программы *watch* с помощью команды `Ctrl-c`. Каждые 5 минут будет происходить свертывание масштабируемого набора с удалением одного экземпляра виртуальной машины, пока не будет достигнуто минимальное число экземпляров (2 экземпляра).
...
> [Azure CLI 2.0 samples for virtual machine scale sets](cli-samples.md) (Примеры Azure CLI 2.0 для масштабируемых наборов виртуальных машин)