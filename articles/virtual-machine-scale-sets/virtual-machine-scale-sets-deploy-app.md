...
Примените конфигурацию расширения настраиваемых сценариев к экземплярам виртуальных машин в своем масштабируемом наборе командой [az vmss extension set](/cli/azure/vmss/extension#az_vmss_extension_set). Следующий пример применяет конфигурацию *customConfig.json* к экземплярам виртуальных машин набора *myScaleSet* в группе ресурсов *myResourceGroup*. Введите свои имена следующим образом.
