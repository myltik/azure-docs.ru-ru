...
Для основных правил автоматического масштабирования можно использовать метрики производительности на основе узла, такие как загрузка ЦП или дисковые операции ввода-вывода. Эти метрики на основе узла доступны сразу. Вам не нужно устанавливать дополнительные агенты или расширения. Правила автоматического масштабирования, использующие метрики на основе узла, можно создавать с помощью одного из следующих средств:
