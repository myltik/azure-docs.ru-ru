---
title: Обзор масштабируемых наборов виртуальных машин | Microsoft Docs
...
* Планируйте не более 20 виртуальных машин на учетную запись хранения (если только для свойства *overprovision* не задано значение false — в этом случае можно создать до 40 виртуальных машин).
...
**Ответ.** 100, если использовать образы платформы, которые можно распределить между несколькими учетными записями хранения. При использовании настраиваемых образов — до 40 (если для свойства *overprovision* задано значение false; по умолчанию — 20), так как в настоящее время они ограничены одной учетной записью хранения.
