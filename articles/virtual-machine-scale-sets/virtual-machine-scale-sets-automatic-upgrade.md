...
- Автоматические обновления ОС поддерживают только [три номера SKU ОС](#supported-os-images). Отсутствует соглашение об уровне обслуживания и гарантии. Мы не рекомендуем использовать автоматические обновления для критически важных рабочих нагрузок на этапе предварительной версии.
...
- Возможность работы с порталом будет предоставлена в ближайшее время.
...
|-------------------------|---------------|--------------------|----------|
| MicrosoftWindowsServer  | WindowsServer | 2012-R2-Datacenter | последних   |
| MicrosoftWindowsServer  | WindowsServer | 2016-Datacenter    | последних   |
| Canonical               | UbuntuServer  | 16.04-LTS          | последних   |
