...
В этой статье рассматриваются вопросы проектирования для набора масштабирования виртуальной машины. Сведения о том, что такое масштабируемые наборы виртуальных машин, см. в статье [Обзор масштабируемых наборов виртуальных машин](virtual-machine-scale-sets-overview.md).
...
Как правило, масштабируемые наборы полезны при развертывании инфраструктуры высокой доступности с набором виртуальных машин одинаковой конфигурации. Тем не менее некоторые возможности доступны только в масштабируемых наборах, а другие — только в виртуальных машинах. Чтобы принять обоснованное решение о необходимости использования каждой из технологий, вы должны сначала взгляните на некоторые часто используемые функции, доступные в наборы масштабирования, но не виртуальных машин:

### <a name="scale-set-specific-features"></a>Возможности масштабируемого набора

- После указания шкалы набора конфигурации, можно обновить свойство «объем» для развертывания нескольких виртуальных машин в параллельном режиме. Это гораздо проще, чем написание скрипта для оркестрации развертывания множества отдельных виртуальных машин в параллельном режиме.
...
Некоторые возможности доступны в настоящее время только в виртуальных машинах:
...
- Сетевым адаптерам отдельных виртуальных машин можно присвоить общедоступные IP-адреса IPv6, но этого нельзя сделать для виртуальных машин в масштабируемом наборе. Можно назначить общих IP-адресов IPv6 балансировки перед либо отдельных виртуальных машин или набора масштабирования виртуальных машин.
