...
Для набора масштабирования, созданного на основе образа платформы, действует ограничение в 100 виртуальных машин, и мы рекомендуем 5 учетных записей хранения для такого масштаба.
