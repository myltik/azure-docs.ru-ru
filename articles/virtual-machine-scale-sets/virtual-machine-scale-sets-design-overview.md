...
## Ограничения (платформа и пользовательские образы)
В отношении набора масштабирования, созданного на основе образа платформы, действует ограничение в 100 виртуальных машин, и мы рекомендуем 5 учетных записей хранения для такого масштаба. Набор масштабирования на основе пользовательского образа (созданного вами) должен создавать все виртуальные жесткие диски с ОС в одной учетной записи хранения. Поэтому максимальное число виртуальных машин в наборе масштабирования, созданном на основе пользовательского образа, равно 20. Если отключить избыточную подготовку, этот предел можно повысить до 40.


## Большой масштаб

Набор масштабирования ограничен 100 виртуальными машинами для образов платформы и 20 — для пользовательских образов (40 без избыточной подготовки). Если вам нужно больше виртуальных машин, разверните несколько наборов масштабирования. Пример см. в следующем шаблоне: https://github.com/Azure/azure-quickstart-templates/tree/master/301-custom-images-at-scale.
