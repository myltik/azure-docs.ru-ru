<properties
   pageTitle="Разрешение внешнего доступа к виртуальной машине с помощью портала | Microsoft Azure"
   description="Узнайте, как открыть порт или создать конечную точку, которая обеспечивает доступ к виртуальной машине, используя модель развертывания с помощью Resource Manager и портал Azure."
...
# Разрешение внешнего доступа к виртуальной машине с помощью портала Azure
...
Введите имя для нового правила. Обратите внимание, что по умолчанию уже указан порт 80. В приведенном ниже окне можно изменить источник, протокол и назначение при добавлении дополнительных правил группы безопасности сети.
