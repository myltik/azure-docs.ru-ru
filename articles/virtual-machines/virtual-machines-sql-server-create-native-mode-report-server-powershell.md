...
1. Запустите Центр обновления Windows и установите обновления для виртуальной машины. Если требуется перезагрузка виртуальной машины, перезапустите ее и повторно подключитесь к ней с портала Azure.
