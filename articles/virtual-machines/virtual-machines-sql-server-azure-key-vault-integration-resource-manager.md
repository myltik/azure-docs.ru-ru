...
|**$rgName**|**Имя группы ресурсов**: имя группы ресурсов, связанное с виртуальной машиной SQL.|"myrgname"|
