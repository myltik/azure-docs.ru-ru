...
При создании образов SQL Server рассмотрите возможность использования портала предварительной версии Azure, чтобы воспользоваться такими преимуществами, как использование хранилища класса Premium по умолчанию, и другими возможностями, такими как автоматическое исправление, автоматическое резервное копирование и конфигурации AlwaysOn.
