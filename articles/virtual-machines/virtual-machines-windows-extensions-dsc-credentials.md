...
Важно включить *узел localhost* в конфигурацию. Если этот оператор отсутствует, то приведенный ниже код не будет работать, так как обработчик расширений специально ищет оператор node localhost. Важно также добавить приведение типа *[PsCredential]*, так как этот конкретный тип активирует в расширении шифрование учетных данных.
