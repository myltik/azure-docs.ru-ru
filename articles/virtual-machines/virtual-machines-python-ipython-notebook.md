...
После развертывания виртуальной машины необходимо открыть правило безопасности для группы безопасности сети. На портале откройте раздел **Сетевые группы безопасности** и перейдите на вкладку группы безопасности, соответствующей вашей виртуальной машине. Вам нужно добавить правило безопасности для входящего трафика со следующими параметрами: **TCP** в качестве протокола, ***** в качестве исходного (открытого) порта и **9999** в качестве конечного (закрытого) порта.
