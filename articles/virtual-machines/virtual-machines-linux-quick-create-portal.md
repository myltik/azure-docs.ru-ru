...
[AZURE.NOTE] Если для защиты доступа к виртуальной машине вы решили использовать пароль, он должен содержать более 12 символов, включая по крайней мере одну прописную букву, одну строчную букву, один специальный знак и одну цифру.
