<properties 
	pageTitle="Пятый этап развертывания бизнес-приложений: создание группы доступности и добавление баз данных приложений" 
	description="На последнем этапе развертывания бизнес-приложений высокого уровня доступности вы создадите группу доступности и добавите к ней базы данных приложения." 
	documentationCenter=""
...
1.	Войдите на основной сервер базы данных, указав учетную запись **[домен]\\sqladmin**. 
...
Выполните перечисленные выше действия на резервном сервере базы данных. На шаге 5 предоставьте учетной записи sqlservice разрешения на **чтение** для папки F:\\Backup.
...
1.	На начальном экране основного сервера базы данных введите **SQL Studio** и выберите **SQL Server Management Studio**.
...
7.	В поле **Расположение файла резервной копии** введите **\\[имя\_компьютера]\\backup**, нажмите клавишу **ВВОД**, выберите **[имя\_базы\_данных].bak** и дважды нажмите кнопку **ОК**. В разделе **Восстанавливаемые резервные наборы данных** должны появиться полная резервная копия и резервная копия журнала.
...
4.	На странице **Указание имени группы доступности** введите название группы доступности (например, AG1) в поле **Имя группы доступности** и нажмите кнопку **Далее**.
