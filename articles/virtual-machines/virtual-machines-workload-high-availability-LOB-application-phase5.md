...
7.	В поле **Соединение с сервером** введите имя сервера-получателя базы данных и нажмите кнопку **Подключиться**. 
8.	На странице **Указание реплик** в списке **Реплики доступности** будет указан сервер-получатель базы данных. Для обоих экземпляров сервера задайте указанные ниже значения параметров. 
