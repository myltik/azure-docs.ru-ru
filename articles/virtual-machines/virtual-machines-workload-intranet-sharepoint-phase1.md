...
После создания виртуальной сети Azure портал Azure определяет:

- общедоступный IPv4-адрес VPN-шлюза Azure для виртуальной сети;
- общий ключ IPsec для VPN-подключения типа «сеть-сеть».

Чтобы найти эти параметры на портале Azure после создания виртуальной сети, щелкните **Сети**, выберите имя виртуальной сети, а затем пункт меню **Панель мониторинга**.

После этого необходимо настроить шлюз виртуальной сети для создания VPN-подключения типа «сеть-сеть». Соответствующие инструкции см. в статье [Настройка шлюза виртуальной сети на портале Azure](../vpn-gateway/vpn-gateway-configure-vpn-gateway-mp.md).

После этого создайте VPN-подключение типа «сеть-сеть» между новой виртуальной сетью и локальным VPN-устройством. Соответствующие инструкции см. в статье [Настройка шлюза виртуальной сети на портале Azure](../vpn-gateway/vpn-gateway-configure-vpn-gateway-mp.md).
