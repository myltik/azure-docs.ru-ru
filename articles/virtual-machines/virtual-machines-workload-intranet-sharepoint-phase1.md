...
После этого необходимо настроить шлюз виртуальной сети для создания VPN-подключения типа «сеть-сеть». Соответствующие инструкции см. в статье [Настройка шлюза виртуальной сети на портале управления](../vpn-gateway/vpn-gateway-configure-vpn-gateway-mp.md).

После этого создайте VPN-подключение типа «сеть-сеть» между новой виртуальной сетью и локальным VPN-устройством. Соответствующие инструкции см. в статье [Настройка шлюза виртуальной сети на портале управления](../vpn-gateway/vpn-gateway-configure-vpn-gateway-mp.md).
