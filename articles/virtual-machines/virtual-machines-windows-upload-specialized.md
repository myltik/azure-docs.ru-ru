...
Если вы планируете использовать специализированный диск VHD "как есть" для создания виртуальной машины, то необходимо выполнить следующие действия: 
  * Если вы собираетесь использовать Управляемые диски, ознакомьтесь с разделом [Планирование миграции на Управляемые диски](virtual-machines-windows-on-prem-to-azure.md#plan-for-the-migration-to-managed-disks).
