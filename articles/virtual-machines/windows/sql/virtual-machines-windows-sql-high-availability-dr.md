...
У вас может быть решение высокого уровня доступности для баз данных SQL Server в Azure, использующее возможности AlwaysOn, включая группы доступности или экземпляры отказоустойчивого кластера.
...
### <a name="wsfc-cluster-behavior-in-azure-networking"></a>Поведение кластера WSFC в сети Azure
...
* [Настройка внешнего прослушивателя для групп доступности Always On в Azure](../sqlclassic/virtual-machines-windows-classic-ps-sql-ext-listener.md).
