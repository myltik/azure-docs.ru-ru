---
title: "Расширение агента SQL Server для виртуальных машин SQL Server (Resource Manager) | Документация Майкрософт"
...
---
# <a name="sql-server-agent-extension-for-sql-server-vms-resource-manager"></a>Расширение агента SQL Server для виртуальных машин SQL Server (Resource Manager)
