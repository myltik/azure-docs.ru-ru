...
Существующей виртуальной Машины, созданные с помощью портала Azure, Azure CLI или PowerShell могут не иметь агент виртуальной Машины. На существующей виртуальной машине без агента виртуальной машины необходимо сначала скачать и установить этот агент. В данной статье рассматриваются обе ситуации.
