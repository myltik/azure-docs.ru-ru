...
На виртуальной машине, созданной с помощью классического портала, Azure CLI или PowerShell, может не быть агента виртуальной машины. На существующей виртуальной машине без агента виртуальной машины необходимо сначала скачать и установить этот агент. В данной статье рассматриваются обе ситуации.
