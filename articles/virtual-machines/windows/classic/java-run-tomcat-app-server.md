...
2. Щелкните **Создать**, выберите **Вычисления**, а затем щелкните **Смотреть все** в разделе **Рекомендуемые приложения**.
...
С этого момента ваш веб-сайт Tomcat должен быть доступен для просмотра во внешнем браузере. В строке адреса браузера введите URL-адрес в формате **http:://*your\_DNS\_name*.cloudapp.net**, где ***your\_DNS\_name*** соответствует DNS-имени, указанному при создании виртуальной машины.
