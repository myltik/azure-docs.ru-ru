...
####[Настройка Oracle Data Guard для Azure](configure-oracle-data-guard.md)

####[Настройка Oracle GoldenGate для Azure](configure-oracle-goldengate.md)

####[Рекомендации по работе с образами](oracle-considerations.md)
