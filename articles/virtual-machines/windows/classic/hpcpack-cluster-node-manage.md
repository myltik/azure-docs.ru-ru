...
* **ImageName**: имя образа ВМ Azure, который можно получить через портал Azure или командлета Azure PowerShell **Get-AzureVMImage**. Этот образ должен соответствовать следующим требованиям.
