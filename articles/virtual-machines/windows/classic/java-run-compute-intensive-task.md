...
1. Войдите на [портал Azure](https://portal.azure.com).
2. В области навигации слева портала Azure щелкните **шина обслуживания, управление доступом и кэширование**.
3. В области верхнего левого портала Azure щелкните **Service Bus** , а затем щелкните **New** кнопки.  
...
5. Убедившись в доступности имени пространства имен, выберите страну или регион, где должно размещаться это пространство имен, и нажмите кнопку **Создать пространство имен** .  
   ...
   Пространство имен, которое вы создали будут отображаться на портале Azure и занимает некоторое время для активации. Прежде чем продолжить, дождитесь отображения состояния **Активно** .
