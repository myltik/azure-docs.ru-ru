...
Образ готов к использованию для создания виртуальных машин. Для этого создайте виртуальную машину, выбрав в нижней части меню служб **Больше служб**, а затем в группе **Вычисления** щелкнув **Образы VM (классика)**. Инструкции см. в статье [Создание виртуальной машины из образа](createportal.md).
