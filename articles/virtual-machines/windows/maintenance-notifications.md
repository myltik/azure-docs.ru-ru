...
Дополнительные сведения о регионах Azure см. в разделе "Регионы и доступность виртуальных машин в Azure".  Вы можете просмотреть полный список пар регионов здесь.
