...
В этом руководстве рассматриваются различные типы дисков виртуальной машины и описывается, как выбрать конфигурацию дисков, а затем создать и подключить диски к виртуальным машинам Azure. Кроме того, в нем рассматривается создание моментальных снимков дисков.  
...
**Диск операционной системы**. Размер дисков операционной системы может составлять до 1 ТБ. Это диски, содержащие операционную систему виртуальной машины.  Для диска операционной системы по умолчанию назначается буква `c:`. Конфигурация кэширования диска ОС оптимизирована для производительности операционной системы. На диске ОС **не должны** размещаться приложения или данные. Для приложений и данных используйте диск данных, который описан далее в этой статье.
