...
![Баннер конфигурации развертывания службы управления обновлениями](./media/tutorial-monitoring/manageupdates-onboard-solution-banner.png)
...
Включение решения может занять до 15 минут. В течение этого времени закрывать окно браузера не следует. После включения решения сведения об отсутствующих обновлениях на виртуальной машине передаются в Log Analytics.
