---
title: "Создание нескольких виртуальных машин Azure | Документация Майкрософт"
...
Один из способов создания нескольких схожих виртуальных машин — использовать Azure Resource Manager из *цикла ресурсов*.
...
И наконец, при использовании цикла ресурсов в основную структуру отправляется множество вызовов для создания ресурсов. Когда многочисленные вызовы создают одинаковые ресурсы, Azure получает косвенную возможность усовершенствования этой инфраструктуры и выполнения оптимизации для повышения надежности и эффективности развертывания. В этом случае подходят *наборы для масштабирования виртуальных машин* .
...
Общие сведения о масштабируемых наборах виртуальных машин см. на странице [Наборы для масштабирования виртуальных машин](https://azure.microsoft.com/services/virtual-machine-scale-sets/). на [документации](https://azure.microsoft.com/documentation/services/virtual-machine-scale-sets/).
