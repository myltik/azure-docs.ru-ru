...
6. Щелкните **Сохранить**. Когда сохранение завершится, на странице приложения щелкните **Манифест**. Измените манифест. Для этого найдите параметр `appRoles`, добавьте приведенную ниже роль приложения и нажмите кнопку **Сохранить**.
...
8. Щелкните **Свойства** и измените значение параметра **Требуется назначение пользователей** на **Да**. Щелкните **Сохранить**.
