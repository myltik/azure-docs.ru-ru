    ...
    <div class="calloutHolder">
        <div class="callout">
            <a href="https://azure.microsoft.com/community/training/courses/managing-infrastructure-microsoft-azure-getting-started/">
                <img src="media/index/pluralsight.svg" />Бесплатные видеоуроки PluralSight. Управление инфраструктурой с помощью Microsoft Azure</a>
        </div>
    </div>
</div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>См. дополнительные сведения о виртуальных машинах Windows</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Начало работы с виртуальными машинами Windows с помощью портала Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Начало работы с виртуальными машинами Windows с помощью PowerShell</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Начало работы с виртуальными машинами Windows с помощью шаблона Resource Manager</h3>
                    </div>
                </div>
            </div>
        </div>
