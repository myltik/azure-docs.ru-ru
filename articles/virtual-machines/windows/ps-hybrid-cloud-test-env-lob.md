...
Создайте [имитацию тестовой гибридной облачной среды](ps-hybrid-cloud-test-env-sim.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json). Для этой тестовой среды не нужен сервер APP1 в корпоративной подсети, поэтому его можно выключить на время.
