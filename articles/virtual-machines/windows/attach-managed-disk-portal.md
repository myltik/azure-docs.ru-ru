...
3. На странице виртуальной машины нажмите кнопку **дисков**.
4. На **дисков** щелкните **+ добавить диск данных**.
5. Выберите в раскрывающемся списке для нового диска, **создать диск**.
6. В **Создание управляемого диска** введите в поле имя диска и настроить другие параметры, при необходимости. Закончив, щелкните **Создать**.
7. В **дисков** щелкните **Сохранить** сохранить новую конфигурацию диска для виртуальной Машины.
6. Azure создает диск и прикрепляет его к виртуальной машине, новый диск указан в параметры диска виртуальной машины в группе **диски с данными**.


## <a name="initialize-a-new-data-disk"></a>Инициализация нового диска данных

1. Подключитесь к виртуальной машине.
1. Щелкните меню "Пуск" на виртуальной машине, введите **diskmgmt.msc** и нажмите клавишу **ВВОД**. Оснастку управления дисками открывается.
2. Управление дисками распознает наличие новых, отмена инициализации диска и **инициализация диска** всплывает окно.
3. Убедитесь, что выбран новый диск, и нажмите кнопку **ОК**, чтобы его инициализировать.
4. Новый диск появится **нераспределенного**. Щелкните правой кнопкой мыши в любой части диска и выберите **Создать простой том**. **Мастер создания простых томов** открывается.
