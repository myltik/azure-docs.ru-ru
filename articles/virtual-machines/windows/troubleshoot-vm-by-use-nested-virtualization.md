...
В этой статье описывается, как создать среду вложенной виртуализации в Microsoft Azure, чтобы можно было подключить диск виртуальной машины с неполадками на узле Hyper-V (виртуальная машина восстановления) для устранения неполадок.

## <a name="prerequisite"></a>Предварительные требования

Чтобы подключить виртуальную машину, на которой имеются неполадки, виртуальная машина восстановления должна отвечать следующим требованиям:

-   виртуальная машина восстановления должна находиться в том же расположении, что и виртуальная машина, на которой нужно устранить проблемы;

-   виртуальная машина восстановления должна находиться в той же группе ресурсов, что и виртуальная машина, на которой нужно устранить проблемы;

-   для виртуальной машины восстановления должен использоваться тот же тип учетной записи хранения (класса Standard или Premium), что и для виртуальной машины, на которой нужно устранить проблемы.

## <a name="step-1-create-a-recovery-vm-and-install-hyper-v-role"></a>Шаг 1. Создание виртуальной машины восстановления и настройка роли Hyper-V

1.  Создайте виртуальную машину восстановления:
...
2.  После создания виртуальной машины восстановления установите к ней подключение удаленного рабочего стола.
...
5.  В разделе **Выбор целевого сервера** выберите виртуальную машину восстановления.
...
## <a name="step-2-create-the-problem-vm-on-the-recovery-vms-hyper-v-server"></a>Шаг 2. Создание виртуальной машины, на которой имеются проблемы, на сервере Hyper-V виртуальной машины восстановления

1.  Запишите имя диска на проблемной виртуальной машине, а затем удалите ее. Проверьте наличие всех подключенных дисков. 

2.  Подключите диск операционной системы проблемной виртуальной машины как диск данных виртуальной машины восстановления.

    1.  После удаления проблемной виртуальной машины перейдите к виртуальной машине восстановления.
...
3.  После успешного подключения диска установите подключение удаленного рабочего стола к виртуальной машине восстановления.
...
6.  В диспетчере Hyper-V щелкните правой кнопкой мыши виртуальную машину восстановления, а затем выберите **Создать** > **Виртуальная машина** > **Далее**.
...
2.  Перейдите на [портал Azure](https://portal.azure.com), выберите виртуальную машину восстановления, щелкните "Диски", а затем скопируйте имя диска. Вы используете его на следующем шаге. Отсоедините диск фиксированного размера на виртуальной машине восстановления.
