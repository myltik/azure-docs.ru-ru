...
> [!NOTE] 
> Если ввести имя, отличное от текущей учетной записи локального администратора на виртуальной Машине, расширение VMAccess добавить учетную запись локального администратора с таким именем и назначить указанный пароль этой учетной записи. Если учетной записи локального администратора на виртуальной Машине существует, он будет сбросить пароль, и если учетная запись отключена, расширение VMAccess позволяет ему.
