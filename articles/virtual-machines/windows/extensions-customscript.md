...
> [!NOTE]  
> Не используйте настраиваемое расширение скриптов для выполнения обновления AzureRmVM с одной виртуальной Машины в качестве параметра, так как время ожидания на себя.  
>   
> 
