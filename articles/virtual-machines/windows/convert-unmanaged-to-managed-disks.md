...
Прежде чем начать, внимательно изучите [планирование миграции на управляемые диски](on-prem-to-azure.md#plan-for-the-migration-to-managed-disks).
Отработайте процесс миграции на тестовой виртуальной машине, прежде чем переходить к миграции в рабочей среде, так как процесс миграции необратим. Управление виртуальной машины во время миграции заблокировано, поэтому вы не можете запустить, остановить или удалить виртуальную машину до завершения этой операции.
...
В этом разделе показано, как можно перевести существующие виртуальные машины Azure с неуправляемых дисков класса "Стандартный" на управляемые диски класса "Премуим". Чтобы использовать управляемые диски класса "Премиум", необходимо использовать [размер виртуальной машины](sizes.md), поддерживающий хранилище класса Premium.


1.  Сначала задайте общие параметры. Убедитесь, что выбранный [размер виртуальной машины](sizes.md) поддерживает хранилище класса Premium.
