---
title: Устранение ошибок при удалении ресурсов хранилища в развертывании Azure Resource Manager на виртуальных машинах Windows | Документация Майкрософт
...
Виртуальные жесткие диски, используемые на виртуальных машинах Azure, — это VHD-файлы, хранящиеся как страничные BLOB-объекты в учетной записи хранения Azure (цен. категория "Стандартный" или "Премиум"). Дополнительные сведения о дисках Azure см. в разделе [Основные сведения о дисковых хранилищах для виртуальных машин Windows в Azure](about-disks-and-vhds.md). 
