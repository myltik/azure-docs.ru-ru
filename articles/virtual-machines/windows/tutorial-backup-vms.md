---
title: "Архивация виртуальных машин Windows в Azure | Документы Майкрософт"
...
5. На локальном компьютере откройте новую вкладку и перейдите в [портал Azure](https://portal.azure.com).
...
14. Перейдите на рабочий стол виртуальной машины и дважды щелкните EXE-файл. Откроется командная строка. После этого подключите точку восстановления как общую папку. После создания общей папки введите **q**, чтобы закрыть командную строку.
