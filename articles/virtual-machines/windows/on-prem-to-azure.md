...
|----------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------|
| У вас есть экземпляры AWS EC2, которые вы хотели бы перенести на управляемые диски Azure.                                     | [Перенос виртуальной машины из Amazon Web Services (AWS) в Azure](aws-to-azure.md)                           |
