...
После завершения трассировки или операции в папке D:\\log\_collection (или на временном диске) появится новый файл. Имя файла **CollectedData\_гггг-ММ-дд\_чч\_мм\_сс.zip.** Вы можете отправить этот файл агенту поддержки для анализа или открыть отчет внутри ZIP-файла, чтобы просмотреть результаты и рекомендации.
