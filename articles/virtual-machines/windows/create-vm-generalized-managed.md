...
Из универсальной виртуальной машины удалены все данные вашей личной учетной записи с помощью [Sysprep](generalize-vhd.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json). Чтобы создать универсальную виртуальную машину, запустите Sysprep на локальной виртуальной машине, а затем [передайте виртуальный жесткий диск в Azure](upload-image.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json). Можно также запустить Sysprep на существующей виртуальной машине Azure, а затем [записать образ виртуальной машины](capture-image-resource.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
