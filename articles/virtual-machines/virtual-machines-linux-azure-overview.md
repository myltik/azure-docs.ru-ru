...
* [См. наш обновляемый список с примерами скриптов для выполнения стандартных задач с помощью Azure CLI](virtual-machines-linux-cli-samples.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
