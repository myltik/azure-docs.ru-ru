...
- Для устранения каких-либо проблем с размещением измените размер виртуальной машины.<br> Последовательно выберите **Обзор** > **Виртуальные машины** > ваша виртуальная машина Windows > **Параметры** > **Размер**.
