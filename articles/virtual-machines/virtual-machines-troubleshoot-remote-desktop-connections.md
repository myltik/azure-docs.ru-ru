<properties
	pageTitle="Устранение неполадок подключения к удаленному рабочему столу на виртуальной машине под управлением Windows | Microsoft Azure"
...
[AZURE.INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-include.md)]В этой статье рассматривается устранение неполадок виртуальных машин, созданных на основе классической модели развертывания или модели развертывания диспетчера ресурсов.
...
Кроме того, можно зарегистрировать обращение в службу поддержки Azure. Перейдите на [сайт службы поддержки Azure](http://azure.microsoft.com/support/options/) и нажмите **Поддержка**. Дополнительные сведения об использовании службы поддержки Azure см. в статье [Часто задаваемые вопросы о поддержке Azure](http://azure.microsoft.com/support/faq/).
...
- Выполните сброс конфигурации службы удаленных рабочих столов с помощью [портала Azure](https://portal.azure.com). Последовательно выберите пункты **Просмотреть все** > **Виртуальные машины (классические)** > Виртуальные машины Windows > **Сброс удаленного доступа**.
...
1.	Выберите **Пакет диагностики Microsoft Azure IaaS (Windows)** на [странице поддержки диагностики](https://home.diagnostics.support.microsoft.com/SelfHelp?knowledgebaseArticleFilter=2976864). Нажмите **Создать**, чтобы создать сеанс диагностики. Вы можете **поделиться** сеансом с другого конечного компьютера или **скачать** его на локальный компьютер.
