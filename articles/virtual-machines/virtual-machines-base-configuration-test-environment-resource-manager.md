...
- Используйте это как основу для создания [имитации гибридной облачной тестовой среды](../virtual-network/virtual-networks-setup-simulated-hybrid-cloud-environment-testing.md).
