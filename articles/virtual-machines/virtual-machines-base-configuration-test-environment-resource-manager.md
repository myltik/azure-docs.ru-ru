...
Для начала откройте командную строку Azure PowerShell.
...
1.	В левой области портала Azure щелкните **Просмотреть все**, выберите пункт **Виртуальные машины** в списке **Обзор**, а затем щелкните виртуальную машину **DC1**.  
