...
Если виртуальная машина находится в виртуальной сети Azure, вместо этого необходимо использовать группы безопасности сети. Дополнительную информацию см. в разделе [О группах безопасности сети](https://msdn.microsoft.com/library/azure/dn848316.aspx).
...
Дополнительную информацию о настройке с помощью командлета Azure PowerShell см. в разделе [Управление списками управления доступом (ACL) для конечных точек с помощью PowerShell](https://msdn.microsoft.com/library/azure/dn376543.aspx).
...
[О группах безопасности сети](https://msdn.microsoft.com/library/azure/dn848316.aspx)
