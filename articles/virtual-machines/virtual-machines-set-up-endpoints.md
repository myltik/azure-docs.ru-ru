...
У каждой конечной точки есть *общедоступный* и *частный* порты.
...
[Приступая к созданию балансировщика нагрузки для Интернета в диспетчере ресурсов с помощью PowerShell](load-balancer-get-started-internet-arm-ps.md)
