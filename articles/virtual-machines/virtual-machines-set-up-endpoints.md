...
Обратите внимание на то, что группы безопасности сети управляют доступом к виртуальной машине, но не предоставляют возможности перенаправления портов. Чтобы реализовать перенаправление портов, обратитесь к следующей статье:

- [Приступая к настройке подсистемы балансировки нагрузки для Интернета с помощью диспетчера ресурсов Azure](../load-balancer/load-balancer-arm-powershell.md)
