<properties
   pageTitle="Доступность и масштабирование в шаблонах Azure Resource Manager | Microsoft Azure"
...
# Доступность и масштабирование в шаблонах Azure Resource Manager
...
![Группа доступности](./media/virtual-machines-linux-dotnet-core/aset.png)

Дополнительные сведения о группах доступности см. в статье [Управление доступностью виртуальных машин](./virtual-machines-linux-manage-availability.md).
...
![Балансировщик сетевой нагрузки](./media/virtual-machines-linux-dotnet-core/nlb.png)
...
![Правило балансировщика сетевой нагрузки](./media/virtual-machines-linux-dotnet-core/lbrule.png)

## Проба балансировщика нагрузки
...
![Проба балансировщика сетевой нагрузки](./media/virtual-machines-linux-dotnet-core/lbprobe.png)
...
![Правило NAT для входящего трафика](./media/virtual-machines-linux-dotnet-core/natrule.png)

Дополнительные сведения о балансировщике сетевой нагрузки Azure см. в статье [Балансировка нагрузки для служб инфраструктуры Azure](./virtual-machines-linux-load-balance.md).
