...
> [!IMPORTANT]
> Прежде чем начать миграцию на [Управляемые диски](../storage/storage-managed-disks-overview.md), внимательно изучите [этот раздел](virtual-machines-windows-on-prem-to-azure.md#plan-for-the-migration-to-managed-disks).
>
> Прежде чем передавать в Azure диск VHD любого типа, следует выполнить инструкции из статьи [Подготовка диска VHD или VHDX для Windows к отправке в Azure](virtual-machines-windows-prepare-for-upload-vhd-image.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
>
>
