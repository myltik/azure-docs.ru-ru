...
Расширение CustomScript можно развернуть с помощью классического портала Azure, Windows PowerShell или интерфейса командной строки Azure (Azure CLI).
...
Дополнительную информацию о создании виртуальных машин Linux в Azure см. в статье [Создание виртуальной машины с ОС Linux](virtual-machines-linux-cli-create.md).
