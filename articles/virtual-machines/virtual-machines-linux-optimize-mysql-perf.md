...
Ниже объясняется, как создать RAID в Azure с помощью портала управления Azure. RAID также можно настроить с помощью сценариев Windows PowerShell. В этом примере мы настроим RAID 0 с 4 дисками.
