...
Если экземпляр SQL Server работает на виртуальной машине Azure, файлы базы данных уже содержатся на дисках данных в Azure. Эти диски находятся в хранилище BLOB-объектов. Поэтому причины для резервного копирования базы данных и применяемый подход будут немного отличаться. Давайте рассмотрим следующее.
...
## Версия-кандидат SQL Server 2016

Версия-кандидат Microsoft SQL Server 2016 (RC3) поддерживает функции [резервного копирования и восстановления с использованием больших двоичных объектов Azure](https://msdn.microsoft.com/library/jj919148.aspx), реализованные в SQL Server 2014. Однако эта версия включает также следующие усовершенствования:
...
Инструкции по использованию функций SQL Server 2016 при работе с хранилищем больших двоичных объектов Azure см. в учебнике [Использование службы хранилища больших двоичных объектов Microsoft Azure с базами данных SQL Server 2016](https://msdn.microsoft.com/library/dn466438.aspx).
