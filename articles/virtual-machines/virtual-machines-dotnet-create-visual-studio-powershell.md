...
5. В поле DNS-имени введите имя виртуальной машины. Имя DNS должно быть уникальным в рамках Azure. Если указанное имя недоступно, появится красный восклицательный знак.
6. В списке **Образ** выберите образ, из которого нужно создать виртуальную машину. Выбрать можно любой стандартный образ виртуальной машины Azure либо же свой собственный образ, который вы предварительно передали в Azure.
