---
title: Автоматическое масштабирование узлов кластера пакета HPC | Microsoft Docs
...
Кроме того, в настоящее время можно автоматически увеличивать и уменьшать только вычислительные узлы пакета HPC под управлением ОС Windows Server.
