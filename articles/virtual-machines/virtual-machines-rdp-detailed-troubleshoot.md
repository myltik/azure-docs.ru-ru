...
- Если для управления своими подключениями к удаленным рабочим столам вы ранее использовали классический портал Azure или портал Azure, а теперь перешли на приложение, убедитесь в том, что в его конфигурации задан случайным образом определяемый TCP-порт для трафика удаленного рабочего стола.
...
- Проверьте состояние виртуальной машины на классическом портале Azure или портале Azure.
