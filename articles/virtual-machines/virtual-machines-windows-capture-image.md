---
title: Создание образа виртуальной машины на основе виртуальной машины Azure | Microsoft Docs
...
> [!WARNING]
> После обобщения виртуальной машины вы не сможете войти в нее через протокол RDP, так как этот процесс удаляет все учетные записи пользователей. Эти изменения необратимы.
> 
> 
...
> [!NOTE]
> Виртуальная машина должна находиться в той же учетной записи хранения, что и исходный виртуальный жесткий диск.
> 
> 
