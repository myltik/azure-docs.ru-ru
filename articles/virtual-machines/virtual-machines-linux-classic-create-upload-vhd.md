...
- **Интерфейс командной строки Azure**. Установите и используйте [интерфейс командной строки Azure](../virtual-machines-command-line-tools.md) для отправки VHD-файлов.
