...
|---|---|---|---|
|**Перенос приложений из локальной среды**|Существующие приложения «как есть».|Приложениям необходимы веб-роли и рабочие роли.|Существующие приложения «как есть», подходящие для автономных веб-приложений и веб-служб, которым требуется быстрая масштабируемость.|
