...
В этой статье мы развернем простое приложение LAMP в Ubuntu, используя для этого интерфейс командной строки Azure.

## Предварительные требования

Для следующего примера создайте две виртуальные машины Azure под управлением Ubuntu 14.04. Присвойте им имена *script-vm* и *lamp-vm*. При создании виртуальных машин используйте уникальные имена. Одна из этих машин будет использоваться для выполнения команд интерфейса командной строки, а другая — для развертывания приложения LAMP.
...
Сценарий в приведенном ниже примере устанавливает стек LAMP в Ubuntu (включая настройку автоматической установки сервера MySQL), создает простой PHP-файл и запускает сервер Apache:
