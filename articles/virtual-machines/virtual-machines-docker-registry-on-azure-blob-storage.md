...
2. У вас есть сервер, на котором установлено ядро Docker. (Если это не так, [нужный сервер можно быстро создать в Azure.](http://azure.microsoft.com/documentation/templates/docker-simple-on-ubuntu/))
...
Экземпляр Docker Registry: * хранит образы в вашей учетной записи хранения Azure; * прослушивает порт 5000 виртуальной машины; * не использует проверку подлинности (не рекомендуется, см. примечание ниже).
