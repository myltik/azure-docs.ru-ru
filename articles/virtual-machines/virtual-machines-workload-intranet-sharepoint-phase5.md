<properties
	...
	description="На последнем этапе развертывания фермы SharePoint 2013 в интрасети создается группа доступности и в нее добавляются базы данных SharePoint."
	documentationCenter=""
