...
Инструкции по устранению распространенных проблем см. в статье "Общие действия по устранению неполадок". Шаги по устранению ошибок на основе соответствующих сообщений см. в статье "Подробное описание устранения неполадок". Прежде чем начать, ознакомьтесь со следующей справочной информацией, чтобы понять, как работает распределение и почему возникают связанные с ним ошибки. Вы также можете [устранить ошибки выделения ресурсов при создании, перезапуске или изменении размера виртуальных машин Linux в Azure](virtual-machines-linux-allocation-failure.md).
