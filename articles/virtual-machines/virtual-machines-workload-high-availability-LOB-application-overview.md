...
- [Этап 3. Настройка инфраструктуры SQL Server](virtual-machines-workload-high-availability-LOB-application-phase3.md). Создание и настройка виртуальных машин с SQL Server, создание кластера и включение групп доступности AlwaysOn для SQL Server.
