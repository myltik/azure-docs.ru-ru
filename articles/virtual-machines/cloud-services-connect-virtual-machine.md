...
1.	Создайте виртуальную сеть на [портале Azure](http://manage.windowsazure.com). Дополнительные сведения см. в разделе [Создание (классической) виртуальной сети с помощью портала Azure](../virtual-network/virtual-networks-create-vnet-classic-portal.md).
