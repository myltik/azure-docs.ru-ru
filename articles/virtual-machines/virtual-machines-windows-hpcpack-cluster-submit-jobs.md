...
>[AZURE.TIP] Некоторые шаблоны быстрого запуска Azure устанавливают и настраивают веб-компоненты автоматически. При создании кластера с помощью [скрипта развертывания пакета HPC по модели IaaS](virtual-machines-windows-classic-hpcpack-cluster-powershell-script.md) можно установить и настроить веб-компоненты в рамках развертывания.
...
Скачайте файлы установки пакета HPC (полная установка) из [Центра загрузки Майкрософт](http://go.microsoft.com/fwlink/?LinkId=328024) на клиентский компьютер (если это еще не сделано). При запуске инсталляции выберите вариант установки "Клиентские служебные программы для пакета HPC".
