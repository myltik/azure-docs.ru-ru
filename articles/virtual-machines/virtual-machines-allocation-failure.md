<properties
	pageTitle="Устранение ошибок выделения ресурсов для виртуальных машин | Microsoft Azure"
...
# Устранение ошибок выделения ресурсов при создании, перезагрузке или изменении размера виртуальных машин в Azure
...
- Удалите из облачной службы все виртуальные машины и создайте их заново.<br> Последовательно выберите **Просмотреть все** > **Виртуальные машины (классические)** > имя своей виртуальной машины > **Удалить**. Затем щелкните **Создать** > **Среда выполнения приложений** > [образ виртуальной машины].
