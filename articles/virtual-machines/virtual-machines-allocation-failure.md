...
Если эта статья не помогла устранить проблему с Azure, см. форумы по Azure на сайтах [MSDN и Stack Overflow](http://azure.microsoft.com/support/forums/). Кроме того, можно зарегистрировать обращение с проблемой в службу поддержки Azure. Перейдите на [веб-сайт службы поддержки Azure](http://azure.microsoft.com/support/options/) и щелкните «Поддержка». Дополнительные сведения об использовании службы поддержки Azure см. в статье [Часто задаваемые вопросы о поддержке Azure](http://azure.microsoft.com/support/faq/).
