...
1. В окне Azure PowerShell, использованном при выполнении предыдущего шага, введите команду такого типа:
	...
	Где **BlobStorageURL** — URL-адрес учетной записи хранения; **YourImagesFolder** — контейнер в хранилище больших двоичных объектов, в котором следует сохранить образы; **VHDName** — имя для идентификации виртуального жесткого диска, которое будет отображаться на классическом портале Azure; **PathToVHDFile** — полный путь и имя VHD-файла.
