<properties
	pageTitle="Рекомендации по виртуальным машинам Windows| Microsoft Azure"
...
- Определите рабочие нагрузки своего приложения и ресурсы, необходимые виртуальной машине.
...
Одним из основных компонентов в среде Azure можно считать виртуальные машины. Именно на них будут выполняться приложения, базы данных, службы аутентификации и т. д.
