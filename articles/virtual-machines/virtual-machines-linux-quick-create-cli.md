...
Чтобы развернуть виртуальную машину RedHat Enterprise Linux 7.2, мы используем `RHEL` для параметра **ImageURN** (`-Q`). (Эти 7 псевдонимов представляют малую долю ОС, доступных в Azure. Дополнительные образы можно найти в Marketplace, используя [поиск образа](virtual-machines-linux-cli-ps-findimage.md). Можно также [загрузить собственный настраиваемый образ](virtual-machines-linux-create-upload-generic.md).)
