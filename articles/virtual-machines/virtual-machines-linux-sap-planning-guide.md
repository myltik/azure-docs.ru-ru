...
[комментарий]: <> (MShermannd TODO. Не удается найти статью, в которой есть раздел про OpenLDAP и ARM;) 
[комментарий]: <> (MSSedusch <https://channel9.msdn.com/Blogs/Open/Load-balancing-highly-available-Linux-services-on-Windows-Azure-OpenLDAP-and-MySQL>)
...
[комментарий]: <> (MSSedusch — Дополнительные сведения см. здесь.) 
[комментарий]: <> (MShermannd TODO ссылка уже не действительна. Но ARM все равно не поддерживается — см. ссылку ниже.) 
[комментарий]: <> (MSSedusch-- <http://msdn.microsoft.com/library/azure/dn133798.aspx>.) 
[комментарий]: <> (MShermannd TODO "точка — сеть" для ARM пока не поддерживается.) 
[комментарий]: <> (MSSedusch — <https://azure.microsoft.com/documentation/articles/vpn-gateway-point-to-site-create/>.)
...
[комментарий]: <> (MSSedusch * <https://azure.microsoft.com/documentation/articles/virtual-networks-create-vnet-arm-pportal/>) 
[комментарий]: <> (MSSedusch * <https://azure.microsoft.com/documentation/articles/virtual-machines-windows-tutorial/>)
...
[комментарий]: <> (MShermannd TODO как насчет службы автоматизации для ВМ SAP?)
[комментарий]: <> (MSSedusch развертывание нескольких виртуальных машин ОС сейчас возможно) [комментарий]: <> (MSSedusch также с помощью портала Azure невозможно настроить для развертывания автоматизацию любого типа. Такие задачи, как развертывание нескольких виртуальных машин по сценарию, на портале Azure не поддерживаются.)
