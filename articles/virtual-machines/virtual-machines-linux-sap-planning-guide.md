...
[комментарий]: <> (MShermannd TODO. Не удается найти статью, в которой есть раздел про OpenLDAP и ARM;) [комментарий]: <> (MSSedusch <https://channel9.msdn.com/Blogs/Open/Load-balancing-highly-available-Linux-services-on-Windows-Azure-OpenLDAP-and-MySQL>)
...
Прочитайте также раздел [Интерфейс командной строки Azure для виртуальных машин Linux][deployment-guide-4.5.2] [руководства по развертыванию][planning-guide], где описано использование интерфейса командной строки Azure для развертывания расширения мониторинга Azure для SAP.
