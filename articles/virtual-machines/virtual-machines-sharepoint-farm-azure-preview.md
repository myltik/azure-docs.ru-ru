...
10. Чтобы определить расположение Azure, щелкните стрелку.
...
- Для администрирования этих серверов можно использовать подключения к удаленному рабочему столу. Дополнительные сведения см. в статье [Вход на виртуальную машину](virtual-machines-windows-tutorial.md#log-on-to-the-virtual-machine).
