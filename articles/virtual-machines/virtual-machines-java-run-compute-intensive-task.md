...
1.  Войдите на [портал Azure](https://manage.windowsazure.com).
2.  В нижней левой области навигации портала Azure щелкните **Служебная шина, контроль доступа и кэширование**.
3.  В верхней левой области портала Azure выберите узел **Служебная шина**, а затем нажмите кнопку **Создать**. ![Снимок экрана узла служебной шины][svc_bus_node]
