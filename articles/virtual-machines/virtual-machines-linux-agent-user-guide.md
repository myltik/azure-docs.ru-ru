...
> [AZURE.NOTE] Для получения дополнительных сведений см. файл [README](https://github.com/Azure/WALinuxAgent/blob/master/README.md) агента Linux для Azure.
...
> [AZURE.NOTE] Этот список может отличаться от официального списка систем, поддерживаемых платформой Microsoft Azure, который доступен на странице: [http://support.microsoft.com/kb/2805216](http://support.microsoft.com/kb/2805216).
...
> [AZURE.WARNING] Отмена подготовки не гарантирует, что из образа будет удалена вся конфиденциальная информация и что он будет готов к повторному распространению.
...
> [AZURE.NOTE] В образах облаков Ubuntu, использующих для подготовки пакет cloud-init, для параметра `Provisioning.Enabled` по умолчанию устанавливается значение n.
