...
Когда подготовленная виртуальная машина запустится, присоедините и подключите диск с данными. Инструкции см. [здесь](virtual-machines-linux-cli-create.md#attach-and-mount-a-disk).

Чтобы выполнить другие настройки, подключитесь к виртуальной машине с помощью любого SSH-клиента. Дополнительные сведения см. в разделе [Подключение к виртуальной машине Linux в Azure c помощью протокола SSH](virtual-machines-linux-portal-create.md#connect-to-your-azure-linux-vm-using-strongsshstrong).
