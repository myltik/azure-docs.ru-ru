...
> [AZURE.NOTE] \(Значение *unique\_domain\_name* можно определить на [классическом портале Azure](https://ms.portal.azure.com/), щелкнув **Виртуальные машины** и выбрав виртуальную машину, которая используется для запуска базы данных Oracle.)
