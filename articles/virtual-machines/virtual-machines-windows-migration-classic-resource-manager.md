...
| Сеть |Шлюзы ExpressRoute, шлюз приложений (поддерживаются VPN-шлюзы). |
...
> [!NOTE]
> Невозможно выбрать имя группы ресурсов, созданной для перенесенных ресурсов (т. е. -Migrated), но после завершения миграции можно использовать функцию перемещения Azure Resource Manager, чтобы переместить ресурсы в любую группу ресурсов на ваш выбор. Дополнительные сведения об этом см. в статье [Перемещение ресурсов в новую группу ресурсов или подписку](../resource-group-move-resources.md).
...
![Снимок экрана классический облачной службы на портале](./media/virtual-machines-windows-migration-classic-resource-manager/portal-classic.png)

![Снимок экрана подготовки ресурсов ARM на портале](./media/virtual-machines-windows-migration-classic-resource-manager/portal-arm.png)
