...
3. Откроется диалоговое окно **Программа подготовки системы** .
   ...
   ![Запуск Sysprep](./media/virtual-machines-windows-classic-createupload-vhd/sysprepgeneral.png)
...
Теперь вы можете [создать пользовательскую виртуальную машину](virtual-machines-windows-classic-createportal.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json) с помощью переданного образа.
