<properties
	pageTitle="Установка и настройка Trend Micro Deep Security как услуги на виртуальной машине Azure | Microsoft Azure"
	description="В этой статье описывается порядок установки и настройки защиты Trend Micro на виртуальной машине в Azure."
...
Параметр **Из коллекции** открывает мастер, помогающий установить виртуальную машину. Последняя страница мастера используется для установки агента ВМ и модуля безопасности Trend Micro. Общие инструкции см. в статье [Создание виртуальной машины под управлением Windows на портале Azure](virtual-machines-windows-tutorial-classic-portal.md). Дойдя до последней страницы мастера, выполните следующие действия.

1.	В разделе **Агент VM** установите флажок **Установить агент VM**.
