---
title: Варианты кластеров пакета HPC на основе Linux в облаке | Microsoft Docs
...
---
# Варианты создания кластера HPC в Azure для рабочих нагрузок Linux и управления им с помощью пакета HPC
