...
При создании новой виртуальной машины SQL Server 2014 с классической моделью развертывания настройте автоматизированную архивацию с помощью портала Azure.
