...
- Настройка мониторинга виртуальной машины с помощью расширения ВМ Microsoft Monitoring Agent. Дополнительные сведения см. в статье [Включение и отключение мониторинга виртуальной машины Azure](virtual-machines-linux-vm-monitoring.md).
...
Расширения ВМ Azure можно запускать на существующих виртуальных машинах с помощью команды `azure vm extension set`. В этом примере на виртуальной машине выполняется расширение пользовательского сценария.
...
Дополнительные сведения см. в статье [Разработка шаблонов Azure Resource Manager с расширениями виртуальной машины Linux](virtual-machines-linux-extensions-authoring-templates.md).
...
| --- | --- | --- |
| Расширение пользовательских сценариев для Linux |Выполняет сценарии на виртуальных машинах Azure. |[Расширение пользовательских сценариев для Linux](virtual-machines-linux-extensions-customscript.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) |
| Расширение Docker |Устанавливает управляющую программу Docker для поддержки удаленных команд Docker. |[Расширение виртуальной машины Docker](virtual-machines-linux-dockerextension.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) |
