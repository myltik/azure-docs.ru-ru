...
> [AZURE.IMPORTANT]Эти метрики обеспечивают данными диаграммы мониторинга и оповещения на портале Azure. Узел **Metrics** с *resourceID* и **MetricAggregation** должен быть включен в конфигурацию диагностики виртуальной машины, если вы хотите видеть на портале Azure данные мониторинга этой виртуальной машины.
...
- Разверните шаблон диспетчера ресурсов с использованием [Azure PowerShell](virtual-machines-deploy-rmtemplates-powershell.md) или [командной строки Azure](virtual-machines-deploy-rmtemplates-powershell.md).
