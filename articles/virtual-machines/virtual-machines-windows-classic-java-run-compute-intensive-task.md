---
title: "Выполнение на виртуальной машине приложения Java для ресурсоемких вычислений | Документация Майкрософт"
...
3. В верхней левой области классического портала Azure выберите узел **Служебная шина**, а затем нажмите кнопку **Создать**.  
