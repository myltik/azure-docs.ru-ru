...
> [AZURE.NOTE] Для операций с существующими развернутыми службами сначала ознакомьтесь с разделом [Необходимые условия для использования хранилища Premium Storage](#prerequisites-for-premium-storage) этой статьи.
...
1. Для нового ресурса IP-адреса измените возможного владельца на перенесенный сервер-получатель SQL Server (в примере ниже — dansqlams5):
