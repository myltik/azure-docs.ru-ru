...
Более детальная дополнительная информация о сервере SQL Server в виртуальных машинах Azure содержится в разделе [SQL Server в виртуальных машинах Azure](virtual-machines-windows-classic-sql-overview.md).
...
- [SQL Server в виртуальных машинах Azure](virtual-machines-windows-classic-sql-overview.md)
