...
## Дальнейшие действия
Перейдите к [руководству пользователя Docker](https://docs.docker.com/userguide/) и узнайте, как создавать некоторые приложения в Microsoft Azure. Вы также можете воспользоваться [Docker и Swarm в Azure] и узнать, как использовать [Swarm](https://github.com/docker/swarm) с помощью Docker и Azure.
...
[Docker и Swarm в Azure]: virtual-machines-linux-docker-swarm.md
