<properties
   pageTitle="Использование SAP на виртуальных машинах Azure | Microsoft Azure"
   description="Использование SAP на виртуальных машинах Azure"
...
# Использование SAP на виртуальных машинах Azure
...
[Эту статью можно найти здесь](virtual-machines-sap-on-linux-suse-quickstart.md)
