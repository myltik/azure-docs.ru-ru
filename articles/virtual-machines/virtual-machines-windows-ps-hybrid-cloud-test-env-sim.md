---
title: "Имитация гибридной облачной тестовой среды | Документация Майкрософт"
...
## <a name="phase-2-create-the-testvnet-virtual-network"></a>Этап 2. Создание виртуальной сети TestVNET
...
## <a name="phase-3-create-the-vnet-to-vnet-connection"></a>Этап 3. Создание подключения между виртуальными сетями
...
* Настройте в этой среде [специализированное веб-приложение](virtual-machines-windows-ps-hybrid-cloud-test-env-lob.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
