...
5.	Откроется страница **Указание параметров базы данных конфигурации**.
 ...
 - В поле **Имя пользователя** введите [домен]**\sp_farm_db** (эта учетная запись была создана на [этапе 2: настройка контроллеров домена](virtual-machines-workload-intranet-sharepoint-phase2.md)). Обратите внимание, что у учетной записи sp_farm_db есть привилегии sysadmin на сервере базы данных.
