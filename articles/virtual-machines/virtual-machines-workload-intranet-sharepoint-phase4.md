...
8.	На странице **Настройка веб-приложения центра администрирования SharePoint** нажмите кнопку **Далее**.
...
Дальнейшие действия по настройке этой среды см. в статье [Этап 5: создание группы доступности и добавление баз данных SharePoint](virtual-machines-workload-intranet-sharepoint-phase5.md).
