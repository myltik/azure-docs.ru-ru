<properties
	pageTitle="Выполнение ресурсоемкой задачи в .NET на виртуальной машине Azure"
...
10. Щелкните **Создать виртуальную машину**. Следить за состоянием можно в разделе **Виртуальные машины** портала управления. Когда отображается состояние **Активная**, можно выполнить вход в виртуальную машину.
