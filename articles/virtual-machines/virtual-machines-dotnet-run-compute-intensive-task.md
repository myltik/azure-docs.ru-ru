...
10. Щелкните **Создать виртуальную машину**. Следить за текущим состоянием можно в разделе **Виртуальные машины** на классическом портале Azure. Когда отображается состояние **Активная**, можно выполнить вход в виртуальную машину.
...
1.  Войдите на [классический портал Azure](https://manage.windowsazure.com).
2.  В левой области навигации классического портала Azure нажмите кнопку **Служебная шина**.
3.  В нижней части классического портала Azure нажмите кнопку **Создать**.
...
Созданное пространство имен появится на классическом портале Azure; его активация займет некоторое время. Прежде чем продолжить, дождитесь отображения состояния **Активно**.
...
1. На компьютере для разработки (который не обязательно должен быть созданной вами виртуальной машиной) скачайте [пакет Azure SDK для .NET](https://azure.microsoft.com/develop/net/).
...
Для создания или удаления очереди вместо TSPSolver можно использовать [классический портал Azure](https://manage.windowsazure.com). В разделе служебной шины классического портала Azure доступны пользовательские интерфейсы для создания или удаления очереди, а также получения строки подключения, издателя и ключа доступа. Можно также использовать панель мониторинга очередей служебной шины, что позволяет просматривать метрики для входящих и исходящих сообщений.
