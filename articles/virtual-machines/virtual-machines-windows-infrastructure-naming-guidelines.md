...
Соглашения об именовании следует установить заранее. Ниже приведено несколько рекомендаций по соглашениям об именовании, которые составляют данный набор правил.
