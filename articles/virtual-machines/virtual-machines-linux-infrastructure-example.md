...
![Схема разных уровней для инфраструктуры приложений](windows/media/infrastructure-example/example-tiers.png)
...
![Окончательная инфраструктура приложений, развернутая в Azure](windows/media/infrastructure-example/example-config.png)
