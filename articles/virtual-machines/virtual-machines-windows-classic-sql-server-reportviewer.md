---
title: Использование ReportViewer для веб-сайта | Microsoft Docs
...
### <a name="to-add-a-reference-to-microsoft.reportviewer.common"></a>Добавление ссылки на сборку Microsoft.ReportViewer.Common
...
### <a name="to-make-the-assemblies-locally-accessible-by-your-asp.net-application"></a>Включение локальной доступности сборок для приложения ASP.NET
...
## <a name="publish-the-asp.net-web-application-to-azure"></a>Публикация веб-приложения ASP.NET в Azure
