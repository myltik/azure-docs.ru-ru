---
title: Расширения и компоненты виртуальной машины | Microsoft Docs
...
Сведения о поддерживаемых операционных системах и инструкции по установке см. в статье [Руководство пользователя агента Linux для Azure](virtual-machines-windows-classic-agents-and-extensions.md).
...
| --- | --- | --- |
| Расширение Custom Script в ОС Windows |Выполняет скрипты на виртуальной машине Azure |[Расширение Custom Script в ОС Windows](virtual-machines-windows-extensions-customscript.md) |
| Расширение DSC в ОС Windows |Расширение PowerShell DSC (настройка требуемого состояния). |[Расширение виртуальной машины Docker](virtual-machines-windows-extensions-dsc-overview.md) |
