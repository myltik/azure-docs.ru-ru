...
---
# <a name="sap-netweaver-on-azure-linux-virtual-machines-vms--dbms-deployment-guide"></a>SAP NetWeaver на виртуальных машинах Linux в Azure. Руководство по развертыванию СУБД
