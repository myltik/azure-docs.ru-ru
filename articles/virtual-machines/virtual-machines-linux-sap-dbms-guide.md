...
#### Высокая доступность
[comment]: <> (link refers to ASM) Для обеспечения высокой доступности и аварийного восстановления можно использовать Oracle Data Guard. Подробные сведения см. в [этой документации][virtual-machines-configuring-oracle-data-guard].
