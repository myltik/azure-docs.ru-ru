...
Только для конфигураций виртуальных машин с одним и несколькими экземплярами Azure отправляет предварительное электронное сообщение, чтобы оповестить вас о предстоящем плановом обслуживании (за 1 неделю). Это сообщение будет отправляться на адреса электронной почты администратора и соадминистратора, указанные в подписке. Ниже приведен пример такого электронного письма.
