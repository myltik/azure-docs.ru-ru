...
##Oracle Linux 6.4+
Необходимо выполнить определенные действия настройки операционной системы, чтобы виртуальная машина запускалась в среде Azure.
...
Подготовка виртуальной машины Oracle Linux 7 для Azure в значительной степени аналогична подготовке Oracle Linux 6, однако есть несколько важных отличий.
