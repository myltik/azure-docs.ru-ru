...
# Использование расширения Custom Script с шаблонами Azure Resource Manager
...
Для развертывания с помощью шаблонов используйте ту же версию расширения Custom Script, которая доступна для интерфейсов API управления службами Azure. Это расширение поддерживает такие же параметры и сценарии, например добавление файлов в учетную запись хранения Azure или в расположение Github. Основное отличие при использовании с шаблонами — это необходимость указывать версию расширения в ее непосредственном виде, а не в формате основной\_номер\_версии.*.
...
Развернуть созданный шаблон можно с помощью Azure CLI или Azure PowerShell.
