...
Если нужно повторно использовать диск данных, можно просто [подключить его к другой виртуальной машине](virtual-machines-linux-add-disk.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
