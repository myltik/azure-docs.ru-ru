...
1.	На левой панели портала предварительной версии Azure щелкните **Просмотреть все > Виртуальные сети** и выберите имя своей виртуальной сети (таблица V, элемент 1, столбец значений).
