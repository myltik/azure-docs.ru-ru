...
1.	На [портале предварительной версии Azure](https://portal.azure.com/) на левой панели щелкните **Просмотреть все > Виртуальные сети** и выберите имя своей виртуальной сети (таблица V, элемент 1, столбец значений).
...
5.	На левой панели портала предварительной версии Azure последовательно щелкните **Просмотреть все > Виртуальные машины**.
6.	На панели **Виртуальные машины** щелкните имя первого контроллера домена (в таблице M в столбце имен виртуальных машин см. элемент 1).
7.	На панели виртуальной машины щелкните **Перезапустить**.
8.	После запуска первого контроллера домена на панели **Виртуальные машины** щелкните имя второго контроллера домена (в таблице M в столбце имен виртуальных машин см. элемент 2).
...
Дальнейшие действия по настройке этой рабочей нагрузки описаны в статье [Третий этап: настройка инфраструктуры SQL Server](virtual-machines-workload-high-availability-LOB-application-phase3.md).
