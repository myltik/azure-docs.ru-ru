...
1.	На левой панели портала Azure щелкните **Просмотреть все > Виртуальные сети** и выберите имя своей виртуальной сети (таблица V, элемент 1, столбец значений).
...
5.	На левой панели портала Azure последовательно щелкните **Просмотреть все > Виртуальные машины**.
