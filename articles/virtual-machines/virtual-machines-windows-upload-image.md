---
title: Отправка Windows VHD для диспетчера ресурсов | Microsoft Docs
...
> [!NOTE]
> Виртуальная машина должна находиться в той же учетной записи хранения, что и переданный VHD-файл.
> 
> 
