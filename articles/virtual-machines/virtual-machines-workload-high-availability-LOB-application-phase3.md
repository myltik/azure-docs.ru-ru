...
9.	В поле **Имя для входа** введите *домен*\\sqladmin, заменив *домен* именем домена, в котором на [втором этапе](virtual-machines-workload-high-availability-LOB-application-phase2.md) была создана учетная запись sqladmin. 
...
1.	Войдите на основную виртуальную машину с SQL Server с помощью учетной записи sqladmin, созданной на [втором этапе](virtual-machines-workload-high-availability-LOB-application-phase2.md).
...
7.	На странице **Точка доступа для администрирования кластера** в поле **Имя кластера** введите его имя и нажмите кнопку **Далее**.
...
Дальнейшие действия по настройке рабочей нагрузки см. в статье [Четвертый этап: настройка веб-серверов](virtual-machines-workload-high-availability-LOB-application-phase4.md).
