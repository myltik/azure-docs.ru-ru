...
Дополнительную информацию о группах ресурсов Azure и их возможностях см. [здесь](../resource-group-overview.md). Если вас интересует разработка шаблонов, см. раздел [Создание шаблонов диспетчера ресурсов Azure](../resource-group-authoring-templates.md).
...
## <a id="create-a-custom-vm-image"></a>ЗАДАЧА: создание пользовательского образа виртуальной машины
...
## <a id="deploy-a-multi-vm-application-that-uses-a-virtual-network-and-an-external-load-balancer"></a>ЗАДАЧА: развертывание приложения для нескольких виртуальных машин, использующего виртуальную сеть и внешний балансировщик нагрузки
...
## <a id="remove-a-resource-group"></a>ЗАДАНИЕ: удаление группы ресурсов
...
## <a id="show-the-log-for-a-resource-group-deployment"></a>ЗАДАНИЕ: показ журнала для развертывания группы ресурсов
...
## <a id="display-information-about-a-virtual-machine"></a>ЗАДАНИЕ: отображение информации о виртуальной машине
...
## <a id="stop-a-virtual-machine"></a>ЗАДАНИЕ: остановка виртуальной машины
