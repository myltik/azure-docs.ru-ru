...
В этой статье рассказывается, как c помощью шаблонов диспетчера ресурсов Azure и интерфейса командной строки Azure выполнять указанные ниже стандартные задачи по развертыванию виртуальных машин Azure и управлению ими. Дополнительные шаблоны см. на странице [Шаблоны быстрого запуска Azure](https://azure.microsoft.com/documentation/templates/) и в статье [Создание платформ приложений с помощью шаблонов](virtual-machines-app-frameworks.md).
...
Вы можете просмотреть сведения о какой-либо виртуальной машине, входящей в группу ресурсов, выполнив команду `azure vm show <groupname> <vmname> command`. Если в вашей группе несколько виртуальных машин, вам может потребоваться сначала перечислить их с помощью команды `azure vm list <groupname>`.
...
Дополнительные шаблоны см. на странице [Шаблоны быстрого запуска Azure](https://azure.microsoft.com/documentation/templates/) и в статье [Создание платформ приложений с помощью шаблонов](virtual-machines-app-frameworks.md).
