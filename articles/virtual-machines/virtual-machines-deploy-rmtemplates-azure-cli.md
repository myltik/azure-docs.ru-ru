...
Теперь [войдите в систему с помощью учетной записи Azure](../xplat-cli-connect.md#use-the-log-in-method): введите `azure login` и следуйте подсказкам по интерактивному входу в учетную запись Azure.

> [AZURE.NOTE]Если у вас есть рабочий или учебный идентификатор и известно, что двухфакторная проверка подлинности не включена, можно **также** использовать `azure login -u` совместно с рабочим или учебным идентификатором для входа *без* интерактивного сеанса. Если у вас нет рабочего или учебного идентификатора, его можно [создать из личной учетной записи Майкрософт](resource-group-create-work-id-from-personal.md) для выполнения входа описанным образом.
