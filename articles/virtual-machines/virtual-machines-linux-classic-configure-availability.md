...
Дополнительные ресурсы, посвященные классическому развертыванию, перечислены в статье [Linux и вычисления с открытым кодом в Azure](virtual-machines-linux-opensource-links.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
