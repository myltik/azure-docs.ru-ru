...
6. **Создание новой облачной службы и учетной записи хранения**.
    ...
    С помощью портала Azure создайте облачную службу и учетную запись хранения для развертывания в регионе, в котором доступны экземпляры с ресурсоемкими вычислениями. (Не связывайте облачную службу и учетную запись хранения с существующей группой сходства, используемой для других развертываний).
