...
[AZURE.INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-include.md)]Эта статья ссылается на вызовы развертывания, предназначенные для классической модели развертывания.
