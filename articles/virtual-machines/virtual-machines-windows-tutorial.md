...
В этом руководстве показано, как всего за несколько минут на портале предварительной версии Azure можно создать виртуальную машину Azure. В качестве примера мы создадим виртуальную машину с помощью образа Windows Server 2012 R2 Datacenter, но это лишь один из многих образов, предлагаемых в Azure. Доступность образов зависит от подписки. Например, подписчикам MSDN могут быть доступны образы рабочих столов.
...
6. Щелкните **Сводка**, чтобы просмотреть выбранные значения параметров. Просмотрев или обновив параметры, нажмите кнопку **Создать**.
...
2. Щелкните виртуальную машину на начальной панели. Если вам нужно найти ее, щелкните элементы **Просмотреть все** > **Последние** или **Просмотреть все** > **Виртуальные машины**. Затем выберите виртуальную машину в списке.
...
* Автоматизация развертывания виртуальных машин и рабочей нагрузки, а также управления ими с помощью [диспетчера ресурсов Azure](virtual-machines-how-to-automate-azure-resource-manager.md) и [шаблонов диспетчера ресурсов Azure](http://azure.microsoft.com/documentation/templates/).
