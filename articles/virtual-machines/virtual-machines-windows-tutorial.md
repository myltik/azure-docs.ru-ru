...
2. Введите **имя** для виртуальной машины. Это имя не должно содержать специальных символов.
...
8. Ход создания виртуальной машины в Azure можно отслеживать в разделе **Виртуальные машины** в главном меню.
...
* Автоматизация развертывания виртуальных машин и рабочих нагрузок и управления ими с помощью [шаблонов диспетчера ресурсов Azure](http://azure.microsoft.com/documentation/templates/).
