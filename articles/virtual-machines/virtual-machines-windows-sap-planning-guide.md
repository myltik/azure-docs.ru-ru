...
[комментарий]: <> (MSSedusch развертывание нескольких виртуальных машин ОС сейчас возможно) 
[комментарий]: <> (MSSedusch также с помощью портала Azure невозможно настроить для развертывания автоматизацию любого типа. Такие задачи, как развертывание нескольких виртуальных машин по сценарию, на портале Azure не поддерживаются.)
