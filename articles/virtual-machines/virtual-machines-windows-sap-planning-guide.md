---
title: SAP NetWeaver на виртуальных машинах Windows. Руководство по планированию и внедрению | Microsoft Docs
...
> [!NOTE]
> Именно такой сценарий развертывания поддерживается для работы производственных систем SAP.
> 
> 
...
> [!NOTE]
> Ресурсы ЦП и памяти для типов виртуальных машин, поддерживаемых SAP, предварительно выделяются на главных узлах. Это означает, что доступность определенных ресурсов для развернутой виртуальной машины будет зависеть от ее типа.
> 
> 
...
* В конфигурации новой виртуальной машины укажите этот виртуальный жесткий диск в качестве диска операционной системы с помощью командлета *Set-AzureRmVMOSDisk*. Дополнительные сведения см. по адресу <https://msdn.microsoft.com/library/mt603746.aspx>.
* Создайте новую виртуальную машину из конфигурации виртуальной машины с помощью командлета *New-AzureRmVM*. Дополнительные сведения см. по адресу: <https://msdn.microsoft.com/library/mt603754.aspx>
* Добавьте диск данных к новой виртуальной машине с помощью командлета *Add-AzureRmVMDataDisk*. Дополнительные сведения см. по адресу <https://msdn.microsoft.com/library/mt603673.aspx>.
...
* Укажите подписку контекста с помощью командлета *Set-AzureRmContext* с параметром SubscriptionId или SubscriptionName. Дополнительные сведения см. по адресу: <https://msdn.microsoft.com/library/mt619263.aspx>
* Загрузите виртуальный жесткий диск с помощью командлета *Add-AzureRmVhd* в учетную запись хранения. Дополнительные сведения см. по адресу: <https://msdn.microsoft.com/library/mt603554.aspx>
* В конфигурации новой виртуальной машины укажите этот виртуальный жесткий диск в качестве диска операционной системы с помощью командлета *Set-AzureRmVMOSDisk -SourceImageUri -CreateOption fromImage*. Дополнительные сведения см. по адресу <https://msdn.microsoft.com/library/mt603746.aspx>.
* Создайте новую виртуальную машину из конфигурации виртуальной машины с помощью командлета *New-AzureRmVM*. Дополнительные сведения см. по адресу: <https://msdn.microsoft.com/library/mt603754.aspx>
...
* Создайте контекст учетной записи хранения для исходной учетной записи хранения с помощью командлета *New-AzureStorageContext*. Дополнительный сведения см. по адресу: <https://msdn.microsoft.com/library/dn806380.aspx>.
* Создайте контекст учетной записи хранения для целевой учетной записи хранения с помощью командлета *New-AzureStorageContext*. Дополнительный сведения см. по адресу: <https://msdn.microsoft.com/library/dn806380.aspx>.
