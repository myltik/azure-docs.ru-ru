...
* [Подключение к порталу Azure и подготовка виртуальной машины из коллекции](#Provision)
...
1. Войдите на [портал Azure](http://manage.windowsazure.com), используя свою учетную запись. Если у вас нет учетной записи Azure, используйте [бесплатную пробную версию Azure](http://azure.microsoft.com/pricing/free-trial/).

2. На портале Azure в нижней левой части веб-страницы щелкните **+СОЗДАТЬ**, **СРЕДА ВЫПОЛНЕНИЯ ПРИЛОЖЕНИЙ**, затем **ВИРТУАЛЬНАЯ МАШИНА** и **ИЗ КОЛЛЕКЦИИ**.
