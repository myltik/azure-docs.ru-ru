...
Эта статья написана на основе записи блога [Рекомендации по реализации Azure](http://blogs.msdn.com/b/thecolorofazure/archive/2014/05/13/azure-implementation-guidelines.aspx). Благодарим Сантьяго Канепу (Santiago Cánepa) (руководителя отдела разработки приложений корпорации Майкрософт), Хьюго Сальседо (Hugo Salcedo) (руководителя отдела разработки приложений корпорации Майкрософт) и Грега Хинкела (Greg Hinkel) (бывшего руководителя отдела разработки корпорации Майкрософт) за предоставленные оригинальные материалы.
...
Когда администратор создает виртуальную машину, Microsoft Azure требует указать ее имя. Microsoft Azure будет использовать имя виртуальной машины в качестве имени ресурса виртуальной машины Azure. То же имя виртуальной машины Azure будет использовать в качестве имени компьютера, заданного в операционной системе виртуальной машины. Однако эти имена могут и не совпадать.
