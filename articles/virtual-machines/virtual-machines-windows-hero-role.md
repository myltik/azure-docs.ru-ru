---
title: Установка IIS на вашу первую виртуальную машину Windows | Microsoft Docs
...
4. В окне "Безопасность Windows" введите имя пользователя и пароль локальной учетной записи, созданной при создании виртуальной машины. Введите имя пользователя в формате *имя виртуальной машины*&#92;*имя пользователя*, а затем нажмите кнопку **ОК**.
...
3. Откройте браузер, введите в адресную строку общедоступный IP-адрес в формате http://<общедоступный\_IP-адрес> и нажмите клавишу **ВВОД**, чтобы перейти к этому адресу.
