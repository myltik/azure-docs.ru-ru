<properties
	...
	description="Эта статья описывает действия по настройке в Azure группы доступности для новой или существующей виртуальной машины с помощью портала Azure и команд Azure PowerShell."
