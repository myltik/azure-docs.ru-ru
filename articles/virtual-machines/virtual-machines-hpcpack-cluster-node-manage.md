...
* Если вам требуется способ автоматического увеличения или сжатия узлов кластера в соответствии с текущей рабочей нагрузкой заданий и задач в кластере, см. статью [Автоматическое увеличение и сжатие вычислительных ресурсов Azure в кластере пакета HPC](virtual-machines-hpcpack-cluster-node-autogrowshrink.md).
