...
Чтобы досконально изучить технические возможности облачной платформы, ознакомьтесь с [техническим руководством по обеспечению непрерывности бизнес-процессов Azure](http://aka.ms/bctechguide).
