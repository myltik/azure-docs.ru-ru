<properties
	pageTitle="Установка и настройка PostgreSQL на виртуальной машине Microsoft Azure под управлением Linux"
	description="Узнайте, как установить и настроить PostgreSQL на виртуальных машинах Azure под управлением Ubuntu или CentOS."
...
#Установка и настройка PostgreSQL в Microsoft Azure
...
> [Azure.NOTE]Для выполнения инструкций учебника у вас уже должна быть виртуальная машина Microsoft Azure под управлением Linux. Прежде чем продолжить, создайте и настройте виртуальную машину под управлением Linux, используя сведения, приведенные в [учебнике по виртуальным машинам Azure под управлением Linux](virtual-machines-linux-tutorial.md).

(В качестве порта PostgreSQL используйте порт 1999).

## Установка PostgreSQL

Подключитесь к виртуальной машине под управлением Linux, используя утилиту PuTTY. Если вы выполняете такое подключение впервые, ознакомьтесь с информацией о подключении с помощью утилиты PuTTY [здесь](virtual-machines-linux-use-ssh-key.md).
...
3. Загрузите PostgreSQL в корневой каталог и распакуйте пакет:
	...
	Выше приведен лишь пример. Подробный список адресов для загрузки можно найти [здесь](https://ftp.postgresql.org/pub/source/).
...
6. Проверьте установку, используя эту команду:
...
![изображение](./media/virtual-machines-linux-postgresql/no1.png)
...
![изображение](./media/virtual-machines-linux-postgresql/no2.png)
...
![изображение](./media/virtual-machines-linux-postgresql/no3.png)
...
![изображение](./media/virtual-machines-linux-postgresql/no4.png)

Вы также можете проверить структуру таблицы, используя следующую команду:

![изображение](./media/virtual-machines-linux-postgresql/no5.png)
...
![изображение](./media/virtual-machines-linux-postgresql/no6.png)
...
![изображение](./media/virtual-machines-linux-postgresql/no7.png)
...
В результате выполнения этой команды будут удалены все сведения в строке «John». Результаты:

![изображение](./media/virtual-machines-linux-postgresql/no8.png)
...
##Дополнительная информация о PostgreSQL
Вы завершили установку PostgreSQL на виртуальной машине Microsoft Azure под управлением Linux и можете приступить к работе с ней. Дополнительные сведения о PostgreSQL см. [здесь](http://www.postgresql.org/).
