<properties
	pageTitle="Установка и настройка PostgreSQL на виртуальной машине Microsoft Azure под управлением Linux | Microsoft Azure"
...
Подключитесь к виртуальной машине под управлением Linux, используя утилиту PuTTY. Если виртуальная машина Linux Azure используется впервые, изучите статью [Использование SSH с Linux в Azure](virtual-machines-linux-use-ssh-key.md), чтобы узнать, как использовать PuTTY для подключения к виртуальной машине Linux.
...
3. Загрузите PostgreSQL в корневой каталог и распакуйте пакет:
	...
	Выше приведен лишь пример. Более точный адрес загрузки см. в [индексе каталога /pub/source/](https://ftp.postgresql.org/pub/source/).
