...
В этом документе предпринята попытка собрать в одном месте список всех разделов, написанных сотрудниками и партнерами корпорации Майкрософт о запуске виртуальных машин под управлением Linux, а также других открытых вычислительных сред и приложений на платформе Microsoft Azure. Особо отмечены статьи, описывающие только классическую модель развертывания, как и те, в которых описывается модель развертывания диспетчера ресурсов. В статьях, для которых не указана особая отметка, описываются обе модели развертывания.
...
- [Классическое развертывание] [Практическое руководство. Передача собственного образа дистрибутива](virtual-machines-linux-classic-create-upload-vhd.md) (а также инструкции по использованию [рекомендованных дистрибутивов Azure](virtual-machines-linux-endorsed-distros.md))
- [Примечания. Общие требования к Linux для выполнения в Azure](virtual-machines-linux-create-upload-generic.md)
- [Классическое развертывание] [Примечания. Введение в Linux в Azure](virtual-machines-linux-intro-on-azure.md)
...
1. [Практическое руководство. Передача собственного образа Ubuntu](virtual-machines-linux-create-upload-ubuntu.md)
2. [Практическое руководство. Стек LAMP Ubuntu](virtual-machines-linux-install-lamp-stack.md)
3. [Классическое развертывание] [Практическое руководство. Кластеры MySQL](virtual-machines-linux-classic-mysql-cluster.md)
4. [Классическое развертывание] [Практическое руководство. Node.js и Cassandra](virtual-machines-linux-classic-cassandra-nodejs.md)
5. [Развертывание диспетчера ресурсов] [Практическое руководство. IPython Notebook](virtual-machines-linux-jupyter-notebook.md)
6. [Классическое развертывание] [Углубленные знания. Запуск ASP.NET 5 в Linux с помощью контейнеров Docker](http://blogs.msdn.com/b/webdev/archive/2015/01/14/running-asp-net-5-applications-in-linux-containers-with-docker.aspx)
...
2. [Коллекция образов](https://azure.microsoft.com/marketplace/partners/OpenLogic/)
3. [Практическое руководство. Подготовка пользовательской виртуальной машины на основе CentOS для Azure](virtual-machines-linux-create-upload-centos.md)
4. [Классическое развертывание] [Блог. Развертывание образа виртуальной машины CentOS из OpenLogic](https://azure.microsoft.com/blog/2013/01/11/deploying-openlogic-centos-images-on-windows-azure-virtual-machines/)
6. [Классическое развертывание] [Практическое руководство. Установка Apache Qpid Proton-C для AMQP и служебной шины](../service-bus/service-bus-amqp-apache.md/)
...
11. [Классическое развертывание] [Практическое руководство. Установка и запуск MySQL](virtual-machines-linux-classic-mysql-on-opensuse.md)
12. [Практическое руководство. Подготовка пользовательской виртуальной машины SLES или openSUSE](virtual-machines-linux-suse-create-upload-vhd.md)  
...
11. [Классическое развертывание] [Практическое руководство. Использование CoreOS в Azure](virtual-machines-linux-classic-coreos-howto.md)
12. [Классическое развертывание] [Практическое руководство. Начало работы с fleet и Docker на CoreOS в Azure](virtual-machines-linux-classic-coreos-fleet-get-started.md)


#### [Oracle Linux](https://azure.microsoft.com/marketplace/?term=Oracle+Linux)
  2. [Подготовка виртуальной машины Oracle Linux для Azure](virtual-machines-linux-oracle-create-upload-vhd.md)

### FreeBSD

12. [MSOpenTech VM Depot](https://vmdepot.msopentech.com/List/Index?sort=Date&search=FreeBSD)
13. [Классическое развертывание] [Блог. Запуск FreeBSD в Azure](https://azure.microsoft.com/blog/2014/05/22/running-freebsd-in-azure/)
14. [Классическое развертывание] [Блог. Простое развертывание FreeBSD](http://msopentech.com/blog/2014/10/24/easy-deploy-freebsd-microsoft-azure-vm-depot/)
...
6. [Классическое развертывание] [Основные сведения. Вход в виртуальную машину Linux через классический портал Azure](virtual-machines-linux-classic-log-on.md)
7. [Основные сведения. SSH](virtual-machines-linux-ssh-from-linux.md)
8. [Классическое развертывание] [Основные сведения. Сброс пароля или свойств SSH для Linux](virtual-machines-linux-classic-reset-access.md)
9. [Основные сведения. Использование прав корневой учетной записи](virtual-machines-linux-use-root-privileges.md)
10. [Классическое развертывание] [Основные сведения. Подключение диска данных к виртуальной машине Linux](virtual-machines-linux-classic-attach-disk.md)
11. [Классическое развертывание] [Основные сведения. Отключение диска данных от виртуальной машины Linux](virtual-machines-linux-classic-detach-disk.md)
...
14. [Классическое развертывание] [Основные сведения. Запись виртуальной машины Linux для создания шаблона](virtual-machines-linux-classic-capture-image.md)
...
17. [Классическое развертывание] [Основные сведения. Включение пользовательских данных в виртуальную машину для использования с пакетом Cloud-init](virtual-machines-windows-classic-inject-custom-data.md)
18. [Классическое развертывание] [Блог основных сведений. Сборка высокодоступной системы Linux в Azure за 12 шагов](http://blogs.technet.com/b/keithmayer/archive/2014/10/03/quick-start-guide-building-highly-available-linux-servers-in-the-cloud-on-microsoft-azure.aspx)
19. [Классическое развертывание] [Блог основных сведений. Автоматизация подготовки Linux в Azure с помощью Azure CLI, node.js, jhawk](http://blogs.technet.com/b/keithmayer/archive/2014/11/24/step-by-step-automated-provisioning-for-linux-in-the-cloud-with-microsoft-azure-xplat-cli-json-and-node-js-part-1.aspx)
20. [Основные сведения. Расширение виртуальной машины Docker для Azure](virtual-machines-linux-dockerextension.md)
23. [Классическое развертывание] [Справочник по REST API управления службами Azure](https://msdn.microsoft.com/library/azure/ee460799.aspx)
24. [Классическое развертывание] [Файловая система Gluster в Azure](http://dastouri.azurewebsites.net/gluster-on-azure-part-1/)
...
## Языки и платформы
### [Центр разработки на Java для Azure](https://azure.microsoft.com/develop/java/)
...
3. [Практическое руководство. Настройка Tomcat7 в Linux с использованием классического портала Azure](virtual-machines-linux-classic-setup-tomcat.md)
...
5. [Блог. Приступая к работе с библиотеками управления Azure для Java](https://azure.microsoft.com/blog/2014/09/15/getting-started-with-the-azure-java-management-libraries/)
...
8. [Образы. WebSphere](https://azure.microsoft.com/marketplace/partners/msopentech/was-8-5-was-8-5-5-3/)
9. [Образы. WebLogic](https://azure.microsoft.com/marketplace/?term=weblogic)
...
5. [Пакет SDK для управления службами Azure: Ruby](https://github.com/MSOpenTech/azure-sdk-for-ruby)
    - [Практическое руководство. Установка Ruby on Rails](virtual-machines-linux-classic-ruby-rails-web-app.md)
6. [Пакет SDK для управления службами Azure: Python](https://github.com/Azure/azure-sdk-for-python)
    - [Практическое руководство. Веб-приложение Hello World на Django (Mac и Linux)](virtual-machines-linux-python-django-web-app.md)
...
3. MongoDB
    - [Практическое руководство. Создание приложения Node.js в Azure с MongoDB с помощью надстройки MongoLab](../app-service-web/web-sites-dotnet-store-data-mongodb-vm.md)
4. Cassandra
...
2. MySQL
    ...
    - [Практическое руководство. Django и MySQL на базе веб-сайтов Azure с использованием Python и Visual Studio](../app-service-web/web-sites-python-ptvs-django-mysql.md)
...
1. Docker
	...
	- [Как использовать Docker со Swarm в Azure](virtual-machines-linux-docker-swarm.md)
	- [Начало работы с решениями Docker и Compose в Azure](virtual-machines-linux-docker-compose-quickstart.md)
...
10. Chef
	- [Chef и виртуальные машины](virtual-machines-windows-chef-automation.md)
