<properties
	pageTitle="Настройка Apache Tomcat на виртуальной машине Linux | Microsoft Azure"
...
На [портале Azure](https://portal.azure.com/) на панели задач щелкните **Создать**, чтобы создать образ, и выберите образ Linux в соответствии с вашими потребностями. В этом примере используется образ Ubuntu 14.04.![][3]
...
1.	На портале Azure щелкните **Обзор** -> **Виртуальная машина** и выберите созданную виртуальную машину. ![][5]
...
Сначала получите DNS-имя вашей виртуальной машины на портале Azure. **Щелкните Обзор** -> **Виртуальные машины** -> имя своей виртуальной машины -> **Свойства**, а затем просмотрите значение в поле **Доменное имя** плитки **Свойства**.
...
Откройте браузер и введите URL-адрес **http://<DNS-имя\_сервера\_Tomcat>/manager/html**. В качестве примера в этой статье используется такой URL-адрес http://tomcatexample.cloudapp.net/manager/html.
