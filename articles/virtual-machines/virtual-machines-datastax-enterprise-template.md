...
На следующей схеме представлены связи между всеми файлами, скачанными из репозитория GitHub для этого развертывания.
...
-	**opscenter-install-resources.json**: развертывает расширение виртуальной машины OpsCenter (настраиваемый скрипт для Linux), которое будет вызывать определенный файл скрипта Bash (opscenter.sh), необходимый для настройки службы OpsCenter на этой виртуальной машине.
