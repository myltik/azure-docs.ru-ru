<properties
	...
	description="Узнайте, как войти в виртуальную машину Windows Server с помощью портала предварительной версии Azure и модели развертывания на основе диспетчера ресурсов."
