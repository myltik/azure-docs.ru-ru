...
- Разверните [ферму в интрасети SharePoint 2013](virtual-machines-windows-sp-intranet-overview.md) как рабочую нагрузку для рабочей среды в службах инфраструктуры Azure.
