...
Сначала установите подключение удаленного рабочего стола для сайта А и сайта B на портале Azure. Откройте командную строку Windows и создайте домашний каталог для файлов установки Oracle GoldenGate:
...
Необходимо создать процессы Extract и Data Pump на сайтах A и B. Установите подключение удаленного рабочего стола к сайтам А и B на портале Azure. Откройте окно интерпретатора команд GGSCI. Выполните следующие команды на сайте A:
