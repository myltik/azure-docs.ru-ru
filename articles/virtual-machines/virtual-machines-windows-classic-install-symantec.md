---
title: "Установка Symantec Endpoint Protection на виртуальную машину | Документация Майкрософт"
...
Если команда **write-host** отображает значение **True**, агент ВМ установлен. Если она отображает значение **False**, см. инструкции и ссылку для скачивания [во второй части записи блога Azure, посвященной агенту и расширениям виртуальных машин][Агент].
...
1. Войдите в виртуальную машину. Указания см. в статье [Как войти в виртуальную машину под управлением Windows Server][Вход в систему].
...
[Как войти в виртуальную машину под управлением Windows Server][Вход в систему]
...
[Создание]: virtual-machines-windows-classic-tutorial.md

[PS]: ../powershell-install-configure.md

[Агент]: http://go.microsoft.com/fwlink/p/?LinkId=403947
