...
### Графический пользовательский интерфейс ― портал предварительной версии Azure

Графический пользовательский интерфейс портала Azure — это простой способ опробовать виртуальную машину, особенно если вы только начали работать с Azure. Использование портала предварительной версии Azure для создания виртуальной машины
