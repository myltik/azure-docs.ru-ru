...
Перед выполнением этого скрипта убедитесь, что установлено подключение к Azure, выполнив команду `az login`. Кроме того, потребуется имеющаяся виртуальная машина. Обновите имя и группу ресурсов имеющейся виртуальной машины в примере скрипта.
