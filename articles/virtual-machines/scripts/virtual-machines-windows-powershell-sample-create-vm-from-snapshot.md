...
[!code-powershell[main](../../../powershell_scripts/virtual-machine/create-vm-from-snapshot/create-vm-from-snapshot.ps1 "Создание виртуальной машины с помощью управляемого диска ОС")]
