...
Этот сценарий создает виртуальную машину Azure с операционной системой Windows, а также связанные сетевые ресурсы. После успешного выполнения скрипта можно получить доступ к виртуальной машине по протоколу SSH. 
