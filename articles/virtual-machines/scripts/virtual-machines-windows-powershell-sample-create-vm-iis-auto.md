---
title: "Использование командлета New-AzVM для создания виртуальной машины IIS в Azure | Документация Майкрософт"
description: "Создание виртуальной машины с выполняющимися службами IIS с помощью командлета New-AzVM."
...
---
# <a name="create-an-iis-vm-using-the-new-azvm-powershell-cmdlet-preview"></a>Создание виртуальной машины IIS с помощью командлета PowerShell New-AzVM (предварительная версия)
