...
- Сохраните этот набор команд как модуль Runbook службы автоматизации Azure в разделе **Автоматизация** классического портала Azure.
...
Если требуется диск ОС больше 127 ГБ, [диск ОС можно расширить](virtual-machines-windows-expand-os-disk.md).
