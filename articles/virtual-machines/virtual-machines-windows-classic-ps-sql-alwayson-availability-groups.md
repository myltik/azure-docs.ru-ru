...
> [AZURE.SELECTOR]
- [Портал — Resource Manager](virtual-machines-windows-portal-sql-alwayson-availability-groups.md)
- [Портал — классическая модель](virtual-machines-windows-classic-portal-sql-alwayson-availability-groups.md)
- [PowerShell — классическая модель](virtual-machines-windows-classic-ps-sql-alwayson-availability-groups.md)
