<properties 
	pageTitle="Настройка внешнего прослушивателя для групп доступности AlwaysOn в Azure"
...
Обратите внимание на следующие ограничения, действующие при развертывании прослушивателя группы доступности в Azure при помощи общедоступного виртуального IP-адреса облачной службы:
