...
3. На портале Azure или портале предварительной версии Azure создайте классическую виртуальную машину, выбрав образ пакета HPC 2012 R2 в Azure Marketplace. (Шаги для портала Azure см. [здесь](virtual-machines-windows-tutorial-classic-portal.md).)
