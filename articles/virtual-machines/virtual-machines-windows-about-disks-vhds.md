...
>[AZURE.NOTE] Дополнительные сведения о емкости виртуальных машин см. в статье о [размерах виртуальных машин Windows](virtual-machines-windows-sizes.md).
