...
Размер временного диска зависит от размера виртуальной машины. Чтобы узнать больше, ознакомьтесь с [размерами виртуальных машин Windows](virtual-machines-windows-sizes.md).

>[AZURE.WARNING] Мы советуем не хранить данные на временном диске. Он обеспечивает временное хранилище для приложений и процессов и предназначен только для хранения данных, таких как файлы подкачки. Сведения о переназначении буквы этого диска см. в статье [Изменение буквы диска для временного диска Windows](virtual-machines-windows-classic-change-drive-letter.md).
...
>[AZURE.NOTE] Дополнительные сведения о емкости виртуальных машин см. в статье [Размеры виртуальных машин Windows](virtual-machines-windows-sizes.md).
...
-  [Подключите диск](virtual-machines-windows-attach-disk-portal.md) , чтобы увеличить емкость хранилища для виртуальной машины.
