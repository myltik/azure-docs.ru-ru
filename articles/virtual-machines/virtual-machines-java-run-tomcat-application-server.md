...
7. В диалоговом окне **В диалоговом окне** выполните указанные ниже действия.
    ...
    5. Чтобы закрыть диалоговое окно, нажмите кнопку **Завершить**. Теперь конечная точка создана.
