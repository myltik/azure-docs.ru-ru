...
Благодаря Azure CLI команду **azure vm extension set** можно использовать прямо в интерфейсе командной строки (Bash, Terminal, командная строка) для доступа к командам. Выполните команду **azure help vm extension set** для получения подробных сведений об использовании расширения.
...
- Вам потребуется [установить интерфейс Azure CLI](../xplat-cli-install.md) и [подключиться к подписке](../xplat-cli-connect.md), чтобы использовать ресурсы Azure, связанные с вашей учетной записью.
