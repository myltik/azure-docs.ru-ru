...
8.	При необходимости задайте дополнительную конфигурацию с учетом таких рекомендаций:
	1. Не изменяйте **учетную запись хранения**, чтобы при создании она имела имя виртуальной машины.
...
11.	Разрешите в брандмауэре входящие подключения через порт 7001:
	...
	5.	В разделе **Протокол и порты** выберите **Протокол TCP**, **Определенные локальные порты** и введите номер порта **7001**, а затем нажмите кнопку **Далее**.
