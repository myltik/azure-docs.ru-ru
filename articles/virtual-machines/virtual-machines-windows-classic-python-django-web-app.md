---
title: Веб-приложение Python на Django | Microsoft Docs
...
3. Создайте новый файл с именем **views.py** в папке *C:\\inetpub\\wwwroot\\helloworld\\helloworld*. Он будет содержать представление, которое осуществляет отрисовку страницы "hello world". Запустите редактор и введите следующую команду:
