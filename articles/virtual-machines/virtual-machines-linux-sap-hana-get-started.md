...
В [примечании SAP 2205917](https://launchpad.support.sap.com/#/notes/2205917) к базе данных SAP Hana приведены рекомендуемые параметры ОС для SLES 12 и приложений SLES для SAP 12.
