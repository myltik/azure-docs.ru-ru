...
- [Третий этап: настройка инфраструктуры SQL Server](virtual-machines-windows-ps-lob-ph3.md). Создание и настройка виртуальных машин под управлением SQL Server, создание кластера и включение групп доступности AlwaysOn для SQL Server.
