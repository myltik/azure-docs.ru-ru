...
В следующей таблице перечислены дистрибутивы и версии Linux, поддерживаемые в Azure. Дополнительные сведения см. в статье [Support for Linux and open source technology in Azure](https://support.microsoft.com/ru-RU/kb/2941892) (Поддержка Linux и технологии открытого кода в Azure).
...
---|---|---|---
CentOS через OpenLogic | CentOS 6.3+, 7.0+ | CentOS 6.3: [скачиваемый пакет LIS](http://go.microsoft.com/fwlink/?LinkID=403033&clcid=0x409)<p>CentOS 6.4 и более поздних версий: в ядре | Пакет: в [репозитории OpenLogic](http://olcentgbl.trafficmanager.net/openlogic/6/openlogic/x86_64/RPMS/) в разделе WALinuxAgent <br/>Исходный код: [GitHub](https://github.com/Azure/WALinuxAgent)
...
SUSE Linux Enterprise | SLES 11 с пакетом обновления 4, SLES 12 или более поздней версии и <p> SLES для SAP 11.3 или более поздней версии | В ядре | Пакет: в репозитории [Cloud:Tools](https://build.opensuse.org/project/show/Cloud:Tools) в разделе WALinuxAgent <br/>Исходный код: [GitHub](http://go.microsoft.com/fwlink/p/?LinkID=250998)
openSUSE | openSUSE 13.2 или более поздней версии. | В ядре | Пакет: в репозитории [Cloud:Tools](https://build.opensuse.org/project/show/Cloud:Tools) в разделе WALinuxAgent <br/>Исходный код: [GitHub](https://github.com/Azure/WALinuxAgent)
Ubuntu|Ubuntu 12.04, 14.04 и 16.04 | В ядре | Пакет: в репозитории в разделе WALinuxAgent <br/>Исходный код: [GitHub](https://github.com/Azure/WALinuxAgent)
