...
---
# <a name="azure-virtual-machine-cli-samples"></a>Примеры CLI виртуальной машины Azure
...
| [Создание виртуальной машины с помощью Docker](./scripts/virtual-machines-linux-cli-sample-create-docker-host.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) | Создает виртуальную машину, настраивает ее в качестве узла Docker и запускает контейнер NGINX. |
