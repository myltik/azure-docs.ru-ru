...
Щелкните **+ Добавить** для добавления еще одной конечной точки и, в случае по умолчанию, введите имя конечной точки (в этом примере **docker**) и значение 2376 для частного и общедоступного портов. Не изменяйте значение протокола **TCP** и щелкните **OK** для создания конечной точки.
