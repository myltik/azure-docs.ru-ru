...
Чтобы создать виртуальную машину под управлением Windows в Azure, используйте указания в разделе [Использование Azure PowerShell для создания и предварительной настройки виртуальных машин под управлением Windows](virtual-machines-windows-classic-create-powershell.md). В этом разделе последовательно описаны шаги создания набора команд Azure PowerShell, создающего виртуальную машину под управлением Windows, для которой можно предварительно настроить:
...
Чтобы создать новую предварительно настроенную виртуальную машину Linux в Azure, используйте указания в разделе [Создание и предварительная настройка виртуальной машины под управлением Linux с помощью Azure PowerShell](virtual-machines-linux-classic-createpowershell.md).
