...
В дополнительных разделах нужно ссылаться на группу ресурсов, используя шаблон *${azurerm_resource_group.myterraform.name}*.
