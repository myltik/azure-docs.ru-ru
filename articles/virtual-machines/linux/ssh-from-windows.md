...
# Использование ключей SSH с Windows в Azure
...
## Создание закрытого ключа для PuTTY
...
## Использование PuTTY для подключения к компьютеру Linux по протоколу SSH
