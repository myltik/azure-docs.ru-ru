...
Виртуальные машины создаются в масштабируемом наборе по мере необходимости. Можно определить правила автомасштабирования, чтобы управлять добавлением и удалением виртуальных машин в масштабируемом наборе. Эти правила могут выполняться в зависимости от метрики, такие как загрузки ЦП, использование памяти и сетевой трафик.
...
После этого можно вручную увеличить или уменьшить число виртуальных машин в масштабируемом наборе, выполнив команду [az vmss scale](/cli/azure/vmss#scale). В следующем примере задается количество виртуальных машин в ваш набор масштабирования *3*:
