...
> * создать масштабируемый набор виртуальных машин;
> * увеличить или уменьшить количество экземпляров в масштабируемом наборе;
> * просмотреть сведения о подключении для экземпляров масштабируемого набора;
