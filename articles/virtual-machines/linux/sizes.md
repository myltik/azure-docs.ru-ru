...
| [Оптимизированные для памяти](sizes-memory.md)         | M, GS, G, DSv2, DS, Dv2, D   | Высокое соотношение ресурсов памяти и ядер. Отлично подходят для серверов реляционной базы данных, кэша среднего и большого объема, а также выполняющейся в памяти аналитики.                 |
