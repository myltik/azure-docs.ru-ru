...
- Выполните поиск *GitHub* в текстовом поле в верхней части окна, выберите *GitHub plugin* (Подключаемый модуль GitHub), а затем нажмите кнопку **Install** (Установить).
...
- По завершении щелкните **Start using Jenkins** (Начать работу с Jenkins).
