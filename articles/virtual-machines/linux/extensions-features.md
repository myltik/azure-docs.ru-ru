...
Следуя инструкциям из статьи [Automating application deployments to Azure virtual machines](../windows/dotnet-core-1-landing.md) (Автоматизация развертывания приложений в виртуальных машинах Azure), вы можете выполнить пример комплексного развертывания приложения, используя расширения виртуальной машины.
...
Дополнительные сведения см. в статье [Разработка шаблонов Azure Resource Manager с расширениями виртуальной машины Linux](../windows/extensions-authoring-templates.md).
