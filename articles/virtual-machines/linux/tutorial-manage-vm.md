...
![Сайт NGINX по умолчанию](./media/tutorial-manage-vm/nginx.png)  
...
В этом руководстве описывается создание одной виртуальной машины с помощью отдельных ресурсов Azure. Приведенные принципы используются в следующем руководстве для создания высокодоступного приложения с балансировкой нагрузки, которое устойчиво к событиям обслуживания. Перейдите к следующему руководству, [Создание в Azure высокодоступного приложения с балансировкой нагрузки, выполняемого на виртуальных машинах Linux](tutorial-load-balance-nodejs.md).

Примеры: [Примеры Azure CLI для виртуальных машин Linux](../windows/cli-samples.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
