...
Создание территориальной группы для решения вход на портал Azure, при выборе **параметры**и создать группу сходства. Этой территориальной группе будут назначаться выделенные ресурсы, созданные позднее.
