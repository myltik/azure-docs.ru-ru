...
Выполните действия, описанные в статье [Создание настраиваемой виртуальной машины под управлением Linux][vm-instructions].
...
Дополнительную информацию о Ruby on Rails см. в [руководстве по Ruby on Rails][rails-guides].

Об использовании служб Azure из приложения Ruby можно узнать из следующих материалов:

* [Использование хранилища BLOB-объектов из Ruby][blobs]
* [Использование хранилища BLOB-объектов из Ruby][tables]
