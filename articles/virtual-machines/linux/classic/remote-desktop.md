...
![изображение](./media/remote-desktop/no1.png)

Если вы не знаете, как настроить конечную точку для виртуальной машины, воспользуйтесь [руководством](setup-endpoints.md).
