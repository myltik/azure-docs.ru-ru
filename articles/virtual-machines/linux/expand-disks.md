...
## <a name="expand-azure-managed-disk"></a>Разверните узел Azure управляемого диска
...
## <a name="expand-disk-partition-and-filesystem"></a>Разверните раздел диска и файловой системы
Чтобы использовать развернутый диск, необходимо развернуть основной раздел и файловую систему.

1. Подключитесь к виртуальной машине по протоколу SSH, используя соответствующие учетные данные. Вы можете получить общедоступный IP-адрес виртуальной машины с помощью команды [az vm show](/cli/azure/vm#show).
