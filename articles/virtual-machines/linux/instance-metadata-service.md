...
scheduledevents | Ознакомьтесь со статьей о [запланированных событиях](scheduled-events.md) | 2017-03-01
...
- Дополнительные сведения о [запланированных событиях](scheduled-events.md).
