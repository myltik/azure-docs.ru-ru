...
Обновите метод выделения, используя команду [az network public-ip update](/azure/network/public-ip#update). В этом случае для параметра `--allocaion-metod` необходимо задать значение *static*.
