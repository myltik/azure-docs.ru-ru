...
Виртуальные машины Linux серии N поддерживают следующие дистрибутивы из Azure Marketplace и перечисленные драйверы NVIDIA.


| Серия виртуальной машины | Поддерживаемые дистрибутивы | Поддерживаемые драйверы |
| --- | --- | --- |
| **NC** (карта Tesla K80) | Ubuntu 16.04 LTS<br/><br/> Red Hat Enterprise Linux 7.3<br/><br/> Версия 7.3 на основе CentOS | NVIDIA CUDA 8.0, драйвер серии R375<br/>[Действия по установке](#install-cuda-drivers-for-nc-vms) |
| **NV** (карта Tesla K60)| Ubuntu 16.04 LTS<br/><br/>Red Hat Enterprise Linux 7.3<br/><br/>Версия 7.3 на основе CentOS | NVIDIA GRID 4.2, драйверы серии R367<br/>[Действия по установке](#install-grid-drivers-for-nv-vms) |
...
7. После завершения установки добавьте следующий код в `/etc/nvidia/gridd.conf.template`:
 
  ```
  IgnoreSP=TRUE
  ```
8. Перезапустите виртуальную машину и приступите к проверке установки.
