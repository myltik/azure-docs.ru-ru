...
> [!NOTE]
> При развертывании расширения с помощью шаблона развертывания Azure, учетная запись хранения и маркер SAS должно быть создан заранее и затем передается в шаблон. Невозможно развертывание виртуальной Машины, учетной записи хранилища и настройка расширения в одном шаблоне. Создание маркера SAS внутри шаблона в настоящее время не поддерживается.
