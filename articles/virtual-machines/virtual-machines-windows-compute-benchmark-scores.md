...
------- | ------ | ---- | -------| ---- | ---- | -----
Standard_A8 | 8 | 1 | Intel Xeon E5-2670 0 с тактовой частотой 2,6 ГГц | 10 | 236,1 | 1,1
Standard_A9 | 16 | 2 | Intel Xeon E5-2670 0 с тактовой частотой 2,6 ГГц | 10 | 450,3 | 7.0
Standard_A10 | 8 | 1 | Intel Xeon E5-2670 0 с тактовой частотой 2,6 ГГц | 5 | 235,6 | 0.9
Standard_A11 | 16 | 2 | Intel Xeon E5-2670 0 с тактовой частотой 2,6 ГГц |7 | 454,7 | 4.8
...
* Сведения о емкости хранилища, подробности о дисках и дополнительные рекомендации по выбору размера виртуальной машины см. в статье [Размеры виртуальных машин в Azure](virtual-machines-windows-sizes.md).
