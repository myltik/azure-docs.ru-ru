...
В руководстве [Реализация Oracle Data Guard на виртуальной машине Azure под управлением Linux](configuring-oracle-dataguard.md) описывается процедура базовой установки пробной версии в Azure.  
