---
title: "Использование перезапуска виртуальной машины в инфраструктуре Azure для повышения доступности системы SAP | Документация Майкрософт"
description: "Использование перезапуска виртуальной машины в инфраструктуре Azure для повышения доступности приложений SAP"
...
---
# <a name="utilizing-azure-infrastructure-vm-restart-to-achieve-higher-availability-of-sap-system"></a>Использование перезапуска виртуальной машины в инфраструктуре Azure для повышения доступности системы SAP
...
> Инструкции в этой главе применимы к:
>
...
Для полной реализации высокого уровня доступности для приложений SAP NetWeaver см. статью о [высоком уровне доступности приложений SAP в Azure IaaS][sap-high-availability-architecture-scenarios-sap-app-ha].
