...
---
# <a name="sap-netweaver-on-azure-virtual-machines--dbms-deployment-guide"></a>SAP NetWeaver на виртуальных машинах Windows. Руководство по развертыванию СУБД
...
* Инструменты сторонних производителей, которые также можно рассмотреть для реализации архивации и SAP в Azure, более подробно описаны в [руководстве по архивации SAP](sap-hana-backup-guide.md).
