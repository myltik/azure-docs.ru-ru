...
1. Создание виртуальной машины 1.  
   Используйте по крайней мере SLES4SAP 12 с пакетом обновления 1. В этом примере мы будем использовать образ SLES4SAP 12 SP1 BYOS (https://portal.azure.com/#create/suse-byos.sles-for-sap-byos12-sp1).  
