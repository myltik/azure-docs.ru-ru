...
Служба хранилища Azure обеспечивает доступность и надежность по умолчанию. (Дополнительные сведения см. в статье [Введение в хранилище Microsoft Azure](../../../storage/storage-introduction.md).)
...
- создание полной резервной копии данных с использованием файла или архива (раз в неделю);
