...
- [Обзор и архитектура](hana-overview-architecture.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
- [Инфраструктура и подключение](hana-overview-infrastructure-connectivity.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
- [Установка SAP HANA](hana-installation.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
- [Высокий уровень доступности и аварийное восстановление](hana-overview-high-availability-disaster-recovery.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
- [Устранение неполадок и мониторинг](troubleshooting-monitoring.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
![Диапазоны IP-адресов, необходимые для минимального развертывания SAP HANA в Azure (крупные экземпляры)](./media/hana-overview-architecture/image5-ip-address-range-a.png)

  -  При настройке нескольких подсетей клиентов в виртуальной сети Azure: ![Диапазоны IP-адресов с непрерывным адресным пространством для виртуальной сети Azure](./media/hana-overview-architecture/image6-ip-address-range-b.png)
...
![Минимальное развертывание с диапазонами IP-адресов](./media/hana-overview-architecture/image7-minimal-deployment.png)
