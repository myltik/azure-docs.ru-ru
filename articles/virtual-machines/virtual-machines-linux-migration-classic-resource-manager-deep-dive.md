...
## <a name="detailed-guidance-on-migration-at-a-resource-and-feature-level"></a>Подробное руководство по миграции на уровне ресурсов и компонентов
...
![Снимок экрана, на котором показано классическое представление после подготовки](./media/virtual-machines-windows-migration-classic-resource-manager/classic-migration-prepare-portal.png)
![Снимок экрана, на котором показано представление Resource Manager после подготовки](./media/virtual-machines-windows-migration-classic-resource-manager/resourcemanager-migration-prepare-portal.png)
