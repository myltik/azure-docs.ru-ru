...
- [Подготовка виртуальной машины CentOS 6.x для Azure](#centos-6.x)
- [Подготовка виртуальной машины CentOS 7.0+ для Azure](#centos-7.0+)
...
14. **Только CentOS 6.3**. Обновите ядро с помощью следующей команды:
