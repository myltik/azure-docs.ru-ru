...
> [AZURE.NOTE] Инфраструктура Azure RHUI недавно была обновлена (сентябрь 2016 г.) и требует изменения конфигурации существующих экземпляров RHEL для обеспечения непрерывного доступа к Azure RHUI. Подробные сведения см. в разделе, посвященному обновлению инфраструктуры Azure RHUI.
