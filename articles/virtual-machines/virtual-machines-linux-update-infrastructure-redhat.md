...
RHUI доступна во всех общедоступных регионах, указанных на [панели мониторинга состояния Azure](https://azure.microsoft.com/status/). Это означает, что в этих регионах службу обновления yum можно получить без дополнительной платы. В дальнейшем эта информация будет обновляться.

## Получение обновлений из другого репозитория обновлений (например, Red Hat Network Satellite)

Для получения обновлений из другого репозитория обновлений необходима лицензия Red Hat Cloud Access и действующая подписка Red Hat для Azure.

Затем необходимо отменить регистрацию RHUI и повторно зарегистрироваться в инфраструктуре обновления. Ниже приведены подробные инструкции.
