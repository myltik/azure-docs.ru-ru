...
Если после выполнения шагов, указанных выше в этой статье, необходима дополнительная помощь для решения этой проблемы, воспользуйтесь одним из следующих вариантов.

- Получите помощь специалистов по Azure со всего мира. Сообщите о своей проблеме на форуме MSDN Azure или форуме Stack Overflow. Дополнительные сведения см. в статье [Форумы Microsoft Azure](https://azure.microsoft.com/support/forums/).
