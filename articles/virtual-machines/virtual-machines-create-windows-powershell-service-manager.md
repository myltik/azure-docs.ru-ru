<properties 
	pageTitle="Создание виртуальной машины Windows и управление ею с помощью PowerShell и управления службами Azure" 
...
# Создание виртуальной машины Windows и управление ею с помощью PowerShell и управления службами Azure

В этой статье описывается способ создания виртуальной машины Windows и управления ею с помощью управления службами Azure и PowerShell.
