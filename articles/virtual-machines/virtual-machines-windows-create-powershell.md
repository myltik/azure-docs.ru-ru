...
Если вашего образа виртуальной машины нет в списке, определите издателя, предложение и номер SKU, следуя приведенным [здесь](virtual-machines-linux-cli-ps-findimage.md#powershell) инструкциям.
