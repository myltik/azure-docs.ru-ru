...
Если вы не можете подключиться к виртуальной машине Windows, так как забыли пароль или у вас возникла проблема с конфигурацией службы удаленных рабочих столов, воспользуйтесь порталом Azure или расширением VMAccess, чтобы сбросить пароль локального администратора или конфигурацию службы удаленных рабочих столов.

## Портал Azure

Чтобы выполнить сброс службы удаленных рабочих столов на [портале Azure](https://portal.azure.com), щелкните **Просмотреть все** > **Виртуальные машины (классические)** > *ваша виртуальная машина Windows* > **Сброс удаленного доступа**. Откроется следующая страница.
