...
> [AZURE.NOTE]Эта статья не касается виртуальных машин, созданных в диспетчере ресурсов Azure.
...
- Модуль Azure PowerShell версии не ниже 0.8.5. Номер установленной версии Azure PowerShell можно уточнить с помощью команды **Get-Module azure | format-table version** Инструкции и ссылку на последнюю версию см. в статье [Установка и настройка Azure PowerShell](http://go.microsoft.com/fwlink/p/?linkid=320552&clcid=0x409).
