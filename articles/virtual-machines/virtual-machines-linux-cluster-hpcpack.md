...
Отправка заданий в кластер в Azure с помощью пользовательского интерфейса пакета HPC и веб-портала HPC аналогична отправке заданий для вычислительных узлов Windows. См. статьи [Диспетчер заданий пакета HPC](https://technet.microsoft.com/library/ff919691.aspx) и [Отправка заданий из локального клиента](virtual-machines-hpcpack-cluster-submit-jobs.md).
