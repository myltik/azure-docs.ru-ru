---
title: Tomcat на виртуальной машине | Microsoft Docs
...
С этого момента ваш веб-сайт Tomcat должен быть доступен для просмотра во внешнем браузере по URL-адресу следующего вида: **http://*your\_DNS\_name*.cloudapp.net**, где ***your\_DNS\_name*** — это DNS-имя, указанное при создании виртуальной машины.
