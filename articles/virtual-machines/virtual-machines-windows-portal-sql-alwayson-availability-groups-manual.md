...
1. Создайте вторую подсеть. Щелкните **+Подсеть**. 
...
| Настройка | Поле |
| --- | ---|
| Имя **пула серверной части** | sqlLBBE 
