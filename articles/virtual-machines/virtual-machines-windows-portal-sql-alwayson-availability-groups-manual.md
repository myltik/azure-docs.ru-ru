...
1. Войдите в систему, используя настроенную учетную запись (**\\DomainAdmin**) и пароль (**Contoso!000**) администратора.
