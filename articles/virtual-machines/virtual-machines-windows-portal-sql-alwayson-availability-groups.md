...
> [AZURE.SELECTOR]
- [Портал — диспетчер ресурсов](virtual-machines-windows-portal-sql-alwayson-availability-groups.md)
...
Дополнительные рекомендации по настройке см. в статье [Performance best practices for SQL Server in Azure virtual machines](virtual-machines-windows-sql-performance.md).
