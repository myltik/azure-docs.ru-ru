...
- **Availablity group name** (Имя группы доступности) — это имя кластеризованного ресурса для группы доступности. Мы будем использовать префикс **Contoso-ag**.
...
-  **Порт прослушивателя группы доступности** — это TCP-порт, который будет использоваться прослушивателем SQL Server. В этом учебнике используется порт по умолчанию **1433**.
