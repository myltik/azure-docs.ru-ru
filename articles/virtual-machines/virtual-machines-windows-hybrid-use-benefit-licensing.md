...
Чтобы воспользоваться льготой на гибридное использование Azure для виртуальных машин Windows Server, требуется выполнить некоторые предварительные требования:
