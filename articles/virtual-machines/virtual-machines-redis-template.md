...
[AZURE.INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-include.md)]В этой статье описывается процесс создания кластера Redis с помощью модели развертывания на основе диспетчера ресурсов.
...
### Шаг 3-а. Развертывание кластера Redis на основе шаблона с помощью Azure PowerShell
