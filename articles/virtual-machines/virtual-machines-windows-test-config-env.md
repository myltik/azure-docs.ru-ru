...
Если у вас еще нет учетной записи Azure, вы можете зарегистрироваться на странице [Пробная версия Azure](https://azure.microsoft.com/pricing/free-trial/), чтобы получить бесплатную пробную версию. Если у вас есть подписка MSDN или Visual Studio, см. раздел [Ежемесячная сумма денег на счете в Azure для подписчиков Visual Studio](https://azure.microsoft.com/pricing/member-offers/msdn-benefits-details/).
...
- Добавление новой виртуальной машины с помощью [портала Azure](virtual-machines-windows-hero-tutorial.md) или создание [смоделированной гибридной облачной среды для тестирования](virtual-machines-windows-ps-hybrid-cloud-test-env-sim.md).
