...
Затем необходимо создать виртуальную сеть Azure TestLab, в которой будет размещена подсеть базовой конфигурации Corpnet, и защитить ее с помощью группы безопасности сети.
