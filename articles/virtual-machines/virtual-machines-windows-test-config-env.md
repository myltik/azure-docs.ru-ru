...
- [Добавьте новую виртуальную машину](virtual-machines-windows-create-powershell.md) к подсети Corpnet, например к той подсети, в которой работает Microsoft SQL Server.
