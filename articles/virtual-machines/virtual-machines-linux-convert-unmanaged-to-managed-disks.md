...
description: "Преобразование виртуальной машины с неуправляемыми дисками для использования Управляемых дисков Azure с помощью Azure CLI 2.0 (предварительная версия)."
...
- С помощью команды [az storage blob copy start](/cli/azure/storage/blob/copy#start) [скопируйте виртуальный жесткий диск (VHD-файл)](virtual-machines-linux-copy-vm.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json#unmanaged-disks) в учетную запись хранения, для которой никогда не использовалось шифрование службы хранилища Azure.
