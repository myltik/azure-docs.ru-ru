---
title: Группы доступности для классических виртуальных машин Windows | Microsoft Docs
...
. [Группы доступности](virtual-machines-windows-create-availability-set.md) можно также настраивать в развертываниях Resource Manager.
