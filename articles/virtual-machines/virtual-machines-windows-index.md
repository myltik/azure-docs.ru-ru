...
[About Azure virtual machines (Сведения о виртуальных машинах Azure)](windows/overview.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)
...
[Справочная документация по командлетам PowerShell для управления службами Azure](/powershell/azure/overview?view=azuresmps-3.7.0)
