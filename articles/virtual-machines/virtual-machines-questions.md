...
При возникновении проблем с удаленным рабочим столом или SSH, чтобы устранить их, попробуйте установить и использовать расширение [VMAccess](virtual-machines-extensions-features.md).
...
Если вы забыли имя пользователя или пароль, то, если установлен агент виртуальных машин, для устранения проблемы можно установить расширение [VMAccess](virtual-machines-extensions-features.md) и воспользоваться им.
