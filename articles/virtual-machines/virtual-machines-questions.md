...
- [Вход в виртуальную машину под управлением Windows Server](virtual-machines-log-on-windows-server.md). Если сервер не настроен как узел сеансов служб удаленных рабочих столов, поддерживается не более 2 параллельных подключений.  
- [Вход в виртуальную машину под управлением ОС Linux](virtual-machines-linux-how-to-log-on.md) По умолчанию SSH поддерживает не более 10 параллельных подключений. Число доступных параллельных подключений можно увеличить, изменив файл конфигурации.

При возникновении проблем с удаленным рабочим столом или SSH для их устранения попробуйте установить и использовать расширение [VMAccess](http://go.microsoft.com/fwlink/p/?LinkId=396856).
...
Если вы забыли имя пользователя или пароль, то для устранения проблемы при наличии установленного агента виртуальных машин можно установить расширение [VMAccess](http://go.microsoft.com/fwlink/p/?LinkId=396856) и воспользоваться им.
...
Для просмотра журналов перезагрузки при перезагрузке из-за планового обслуживания можно использовать классический портал Azure или Azure PowerShell. Дополнительную информацию см. в статье [Просмотр журналов перезагрузки виртуальной машины](http://azure.microsoft.com/blog/2015/04/01/viewing-vm-reboot-logs/).
