...
Для виртуальных машин, созданных на основе управления службами, для расширения имеющейся инфраструктуры можно использовать виртуальную сеть Azure. Этот подход аналогичен настройке филиала. В Azure можно подготавливать виртуальные частные сети (VPN) и управлять ими, а также безопасно подключать их к локальной ИТ-инфраструктуре. Дополнительную информацию см. в статье [Общие сведения о виртуальных сетях](../virtual-network/virtual-networks-overview.md).
