---
title: Часто задаваемые вопросы по виртуальным машинам Windows | Microsoft Docs
...
Да. Указания см. в статье [Отправка образа виртуальной машины Windows в Azure](virtual-machines-windows-upload-image.md).
...
Да. Указания см. в статье [Как создать копию виртуальной машины Windows в модели развертывания диспетчера ресурсов](virtual-machines-windows-vhd-copy.md).
...
## <a name="can-i-add-a-nic-to-my-vm-after-it's-created?"></a>Создав виртуальную машину, могу я добавить к ней сетевой адаптер?
