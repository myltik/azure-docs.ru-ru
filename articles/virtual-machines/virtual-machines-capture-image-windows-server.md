<properties
	pageTitle="Запись образа виртуальной машины Windows | Microsoft Azure"
	description="Запись образа виртуальной машины Windows, созданной с использованием классической модели развертывания."
...
#Запись образа виртуальной машины Windows, созданной с использованием классической модели развертывания
...
##Дальнейшие действия##
Образ готов к использованию для создания виртуальных машин. Для этого с помощью пункта меню **Из коллекции** создайте виртуальную машину и выберите только что созданный образ. Необходимые указания см. в разделе [Создание настраиваемой виртуальной машины под управлением Windows][].
