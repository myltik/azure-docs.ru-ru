...
11.	Прежде чем добавить образ Windows Server в набор настраиваемых образов, его необходимо обобщить, запустив программу Sysprep, как описано в предыдущих шагах. Щелкните **Sysprep запущен на виртуальной машине**, чтобы указать, что соответствующее действие выполнено.
