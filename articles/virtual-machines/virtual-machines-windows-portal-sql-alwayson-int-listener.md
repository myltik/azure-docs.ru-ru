---
title: Создание прослушивателя для группы доступности AlwaysOn для SQL Server в виртуальных машинах Azure
...
2. Настроить серверный пул.
3. Создать пробу.
4. Настроить правила балансировки нагрузки.

> [!NOTE]
> Если серверы SQL Server расположены в разных группах ресурсов и регионах, необходимо выполнить все эти действия дважды, по одному разу в каждой группе ресурсов.
> 
> 
