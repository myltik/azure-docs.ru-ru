...
Эти среды вы можете создать, используя свою [подписку Visual Studio](https://azure.microsoft.com/pricing/member-offers/msdn-benefits/) или подписку Azure.
