...
## Преимущества интеграции вычислительных ресурсов, сетевых ресурсов и ресурсов хранения в диспетчере ресурсов Azure
...
## Усовершенствования для API вычислительных ресурсов, API сетевых ресурсов и API ресурсов хранения в диспетчере ресурсов Azure
...
Портал Azure будет по-прежнему поддерживать возможность одновременного развертывания виртуальных машин и предварительных версий виртуальных машин. На портале Azure можно будет также выполнять развертывания на основе настраиваемого шаблона.
