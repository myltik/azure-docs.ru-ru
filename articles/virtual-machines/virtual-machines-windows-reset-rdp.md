...
### Портал Azure
Выберите свою виртуальную машину, щелкнув **Обзор** > **Виртуальные машины** > *ваша виртуальная машина Windows* > **Все параметры** > **Сбросить пароль**. Отобразится колонка сброса пароля следующего вида.
