...
Прежде чем начать эту процедуру, внимательно изучите [планирование миграции на управляемые диски](virtual-machines-windows-on-prem-to-azure.md#plan-for-the-migration-to-managed-disks).

Прежде чем передавать в Azure какой-либо виртуальный жесткий диск, следует выполнить инструкции из статьи [Подготовка диска VHD или VHDX для Windows к отправке в Azure](virtual-machines-windows-prepare-for-upload-vhd-image.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
...
Если вы еще не установили PowerShell, ознакомьтесь со статьей [How to install and configure Azure PowerShell](/powershell/azureps-cmdlets-docs) (Установка и настройка Azure PowerShell).
