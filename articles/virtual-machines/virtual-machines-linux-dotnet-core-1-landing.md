...
|---|---|
|SSHKEYDATA   | Данные ключа SSH для защиты доступа к виртуальной машине. Дополнительные сведения о создании пар ключей SSH см. в статье [Создание ключей SSH для виртуальных машин Linux в Azure](virtual-machines-linux-mac-create-ssh-keys.md).  |
