...
Расширения виртуальных машин Azure (полный список расширений с поддерживаемыми ими функциями см. в статье [Обзор расширений и компонентов виртуальной машины](virtual-machines-extensions-features.md)). Вы можете найти расширения и дополнительную информацию, используя:
