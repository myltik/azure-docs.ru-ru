...
Например, в следующем примере кода показано, как с помощью Azure CLI команды **azure vm extension list** отобразить сведения о расширении **IaaSDiagnostics**, и приводится пример использования параметра **—-json** для получения полной информации.
