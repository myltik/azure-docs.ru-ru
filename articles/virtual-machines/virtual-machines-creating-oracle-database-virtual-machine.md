...
6.	Создайте переменную среды **ORACLE_HOSTNAME** со значением, соответствующим имени компьютера виртуальной машины. Создать переменную среды можно, выполнив следующие действия:
