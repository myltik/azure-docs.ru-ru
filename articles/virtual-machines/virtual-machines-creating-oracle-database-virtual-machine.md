...
8.	В мастере **Database Configuration Assistant** введите значения, необходимые для каждого шага в диалоговом окне.
	...
	b. **Шаг 2.** Введите значение **Имя глобальной базы данных**. Введите и подтвердите значение **Пароль администратора**. Этот пароль будет использован для пользователя **SYSTEM** базы данных Oracle. Снимите флажок **Создать как базу данных контейнера**. Нажмите кнопку **Далее**.
