...
> [AZURE.NOTE] В Docker имеются инструменты для Windows, [Docker Machine](https://docs.docker.com/installation/windows/), позволяющие также автоматизировать создание клиента Docker, который можно использовать для работы с виртуальными машинами Azure в качестве узлов Docker.
...
в интерфейсе командной строки Azure для поиска последнего образа Ubuntu в коллекции виртуальных машин, выберите одно из имен образов, например `b39f27a8b8c64d52b05eac6a62ebad85__Ubuntu-14_04_4-LTS-amd64-server-20160516-ru-RU-30GB`, и используйте указанную ниже команду для создания виртуальной машины с помощью этого образа.

```
azure vm docker create -e 22 -l "West US" <vm-cloudservice name> "b39f27a8b8c64d52b05eac6a62ebad85__Ubuntu-14_04_4-LTS-amd64-server-20160516-ru-RU-30GB" <username> <password>
```
