...
>[AZURE.IMPORTANT] В базе данных Oracle Database 12c имеется новый пользователь **SYSDG**, которого можно использовать для администрирования Oracle Data Guard. Дополнительные сведения см. в статье [Изменения в выпуске Oracle Database 12c](http://docs.oracle.com/database/121/UNXAR/release_changes.htm#UNXAR404).
