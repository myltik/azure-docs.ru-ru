<properties
   pageTitle="Устранение сбоев в расширениях виртуальных машин Azure"
   description="Дополнительные сведения об устранении сбоев в расширениях виртуальных машин Azure"
...
Пройдите по ссылке [Создание шаблонов расширений](virtual-machines-extensions-authoring-templates.md), чтобы получить дополнительную информацию о создании шаблонов для использования расширений.
