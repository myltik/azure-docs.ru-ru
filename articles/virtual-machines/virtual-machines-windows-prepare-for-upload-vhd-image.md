...
16.	Удалите все стороннее программное обеспечение и драйверы.
17. Убедитесь в том, что никакое стороннее приложение не использует порт 3389. Этот порт используется для службы RDP в Azure.
...
23. Если вы хотите создать образ для развертывания нескольких машин на его основе, то необходимо подготовить этот образ к использованию, выполнив команду `sysprep`, прежде чем передать VHD в Azure. Дополнительные сведения о создании подготовленного к использованию образа см. в следующих статьях:
