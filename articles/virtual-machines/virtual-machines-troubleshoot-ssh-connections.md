...
1. Щелкните **Обзор** > **Виртуальные машины** > *Имя виртуальной машины*. Для виртуальной машины, созданной в диспетчере ресурсов, щелкните **Обзор** > **Виртуальные машины (вер. 2)** > *Имя виртуальной машины*. Панель состояния виртуальной машины должна отображать состояние **Работает**. Прокрутите страницу вниз для просмотра последних действий в ресурсах вычислений, хранения и сетевых ресурсах.
...
> [AZURE.NOTE]Для виртуальных машин, созданных в диспетчере ресурсов, см. раздел [Источник 4: группы безопасности сети](#nsg).
