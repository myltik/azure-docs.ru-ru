<properties
	pageTitle="Устранение неполадок SSH-подключений к виртуальной машине Linux | Microsoft Azure"
	description="Если вам не удается подключиться к виртуальной машине Azure под управлением Linux, выполните следующие действия, чтобы выявить источник проблемы."
...
При необходимости перезапустите виртуальную машину или [измените ее размер](virtual-machines-size-specs.md).
...
Чтобы устранить конечную точку облачной службы и ACL как источник проблем или неправильной конфигурации для виртуальных машин, созданных с помощью API управления службами, убедитесь, что другая виртуальная машина Azure, которая находится в той же виртуальной сети, может устанавливать SSH-подключения к вашей виртуальной машине Azure.
...
Для этого зайдите на [сайт службы поддержки Azure](http://azure.microsoft.com/support/options/), а затем щелкните **Поддержка**.
