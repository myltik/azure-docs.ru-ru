...
1. **Выполните сброс удаленного доступа** на [портале Azure](https://portal.azure.com). Последовательно выберите пункты **Просмотреть все** > **Виртуальные машины (классические)** > Виртуальные машины Windows > **Сброс удаленного доступа**.
...
2. **Перезапустите** виртуальную машину. На [портале Azure](https://portal.azure.com) последовательно выберите **Просмотреть все** > **Виртуальные машины (классика)** > имя вашей виртуальной машины Windows > **Перезагрузить**. На [классическом портале Azure](https://manage.windowsazure.com) откройте **Виртуальные машины** > **Экземпляры** и выберите **Перезагрузить**.
