...
Дополнительные сведения о виртуальных машинах под управлением Windows см. в разделе [Использование Azure PowerShell для создания виртуальных машин Windows](virtual-machines-windows-classic-create-powershell.md).
...
Дополнительную информацию см. в разделе [Использование SSH с Linux в Azure](virtual-machines-linux-ssh-from-linux.md).
...
Короткое имя облачной службы — это то имя, которое отображается в списке облачных служб Azure на классическом портале Azure или в списке групп ресурсов на портале Azure.
...
После создания виртуальной машины ознакомьтесь с разделом [Как войти в виртуальную машину под управлением Linux](virtual-machines-linux-classic-log-on.md).
