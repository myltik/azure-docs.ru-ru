...
1.	Создайте kickstart-файл, содержащий приведенный ниже код, и сохраните файл. Дополнительные сведения об установке kickstart-файла см. в [Руководстве по установке Kickstart](https://access.redhat.com/documentation/ru-RU/Red_Hat_Enterprise_Linux/7/html/Installation_Guide/chap-kickstart-installations.html).
