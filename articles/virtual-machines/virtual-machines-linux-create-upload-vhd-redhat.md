...
## Автоматическая подготовка ISO-образа с помощью файла kickstart
...
Проблема может возникать при частых операциях ввода-вывода, связанных с диском RHEL 7.1 в Hyper-V и Azure.
