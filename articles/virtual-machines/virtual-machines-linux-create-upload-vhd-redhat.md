...
В этой статье вы узнаете, как подготовить виртуальную машину Red Hat Enterprise Linux (RHEL) для использования в Azure. Статья охватывает RHEL версий 6.7 и 7.1, а также низкоуровневые оболочки для подготовки виртуальных машин Hyper-V, KVM и VMWare.
...
1.	Загрузите KVM-образ RHEL 7.1 с веб-сайта Red Hat.
