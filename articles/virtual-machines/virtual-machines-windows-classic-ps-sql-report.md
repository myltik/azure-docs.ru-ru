...
1. Сценарий настроен для служб Reporting Services. Если вы хотите выполнить сценарий для служб Reporting Services, измените версию в пути пространства имен на значение v11 в операторе Get-WmiObject.
...
1. В **интегрированной среде сценариев Windows PowerShell** откройте меню **Вид** и выберите пункт **Показать область сценариев**.
...
1. Щелкните элемент **База данных**на левой панели.
    ...
    1. Щелкните элемент **Далее** on the **Далее** .
