...
[AZURE.INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-include.md)]В этой статье описываются ресурсы, созданные с помощью модели развертывания диспетчера ресурсов (например, Service Management), а также классической модели развертывания.
...
* Дополнительные сведения об использовании интерфейса командной строки Azure для работы с ресурсами диспетчера ресурсов см. в статьях [Использование интерфейса командной строки Azure с диспетчером ресурсов](xplat-cli-azure-resource-manager.md) и [Контроль доступа на основе ролей с помощью интерфейса командной строки Azure](../role-based-access-control-xplat-cli-install.md).
