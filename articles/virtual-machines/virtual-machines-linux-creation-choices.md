...
Воспользуйтесь интерфейсом командной строки Azure (Azure CLI). Ознакомьтесь с дополнительными сведениями об [установке интерфейса командной строки Azure](../xplat-cli-install.md) с помощью npm, контейнера Docker или скрипта установки. В следующих руководствах содержатся примеры использования интерфейса командной строки Azure:
...
* [Создание виртуальной машины, работающей под управлением ОС Linux, на портале Azure](virtual-machines-linux-quick-create-portal.md) 
...
* Попробуйте выполнить инструкции, приведенные в руководствах по созданию виртуальной машины Linux с помощью [портала](virtual-machines-linux-quick-create-portal.md), [интерфейса командной строки](virtual-machines-linux-quick-create-cli.md) или [шаблона](virtual-machines-linux-cli-deploy-templates.md) Azure Resource Manager.
