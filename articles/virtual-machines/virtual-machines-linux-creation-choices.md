...
* Попробуйте выполнить инструкции, приведенные в руководствах по созданию виртуальной машины Linux с помощью [портала](virtual-machines-linux-portal-create.md), [интерфейса командной строки](virtual-machines-linux-quick-create-cli.md) или [шаблона](virtual-machines-linux-cli-deploy-templates.md) Azure Resource Manager.
