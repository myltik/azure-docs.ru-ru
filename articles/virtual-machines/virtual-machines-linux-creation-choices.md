...
Ознакомьтесь с дополнительными сведениями об [установке интерфейса командной строки Azure](../xplat-cli-install.md) с помощью npm, контейнера Docker или скрипта установки. В следующих руководствах содержатся примеры использования интерфейса командной строки Azure:
