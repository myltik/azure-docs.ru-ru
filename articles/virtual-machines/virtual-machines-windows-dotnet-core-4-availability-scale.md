...
![Группа доступности](./media/virtual-machines-windows-dotnet-core/ase-win.png)

Дополнительные сведения о группах доступности см. в статье [Управление доступностью виртуальных машин](virtual-machines-windows-manage-availability.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json). 
...
![Балансировщик сетевой нагрузки](./media/virtual-machines-windows-dotnet-core/nlb-win.png)
...
![Правило балансировщика сетевой нагрузки](./media/virtual-machines-windows-dotnet-core/lbrule-win.png)
...
![Проба балансировщика сетевой нагрузки](./media/virtual-machines-windows-dotnet-core/lbprobe-win.png)
...
![Правило NAT для входящего трафика](./media/virtual-machines-windows-dotnet-core/natrule-win.png)

Дополнительные сведения о балансировщике сетевой нагрузки Azure см. в статье [Балансировка нагрузки для служб инфраструктуры Azure](virtual-machines-windows-load-balance.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
...
Дополнительные сведения о функции копирования см. в статье [Создание нескольких экземпляров ресурсов в Azure Resource Manager](../azure-resource-manager/resource-group-create-multiple.md).
