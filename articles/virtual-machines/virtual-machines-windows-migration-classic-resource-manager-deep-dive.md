...
| Внутренние DNS-имена в виртуальной машине | Внутренние DNS-имена в сетевой карте | Во время миграции внутренние DNS-суффиксы обновляются в соответствии с суффиксами модели развертывания с помощью Resource Manager. Обратите внимание, что разрешение имен продолжает работать после миграции. Тем не менее суффиксы, связанные с виртуальными машинами, меняются. | | |
