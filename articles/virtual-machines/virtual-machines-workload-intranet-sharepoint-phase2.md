...
5.	На странице **Выбор сервера и диска** щелкните **Диск 2**, а затем нажмите кнопку **Далее**. При появлении запроса нажмите кнопку **OK**.
...
1.	В левой области портала Azure щелкните **Сети** и выберите имя своей виртуальной сети (таблица V, элемент 1, столбец «Значение»).
2.	Нажмите **Настроить**.
...
6.	В левой области портала Azure щелкните **Виртуальные машины**, а затем щелкните столбец **Состояние** рядом с именем первого контроллера домена.
...
Дальнейшие действия по настройке этой рабочей нагрузки описаны в статье [Этап 3. Настройка инфраструктуры сервера SQL Server](virtual-machines-workload-intranet-sharepoint-phase3.md).
