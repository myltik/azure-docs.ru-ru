...
1. Выберите пункт **IP версии 4 (TCP/IPv4)** и нажмите кнопку "Свойства".
...
1. После завершения установки компонента **Отказоустойчивость кластеров** нажмите кнопку **Закрыть**.
...
1. В левой панели выберите **Правила для входящих подключений**. На правой панели нажмите кнопку **Создать правило**.
