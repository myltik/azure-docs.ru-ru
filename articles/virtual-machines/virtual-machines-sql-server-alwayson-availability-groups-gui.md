...
1. После входа вы должны увидеть панель мониторинга **Диспетчер серверов**. Нажмите **Локальный сервер** на левой панели.
...
1. Нажмите кнопку O**K**, а затем **Закрыть**, чтобы сохранить изменения. Теперь вы можете присоединить виртуальную машину к домену **corp.contoso.com**.
