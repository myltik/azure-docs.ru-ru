...
Группа сходства для решения создается путем входа на портал Azure, перехода к разделу настроек и создания в нем новой группы сходства. Этой территориальной группе будут назначаться выделенные ресурсы, созданные позднее.
