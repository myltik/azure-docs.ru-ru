...
1. Установите SSH-подключение к виртуальной машине. Дополнительные сведения см. в статье [Как войти в виртуальную машину под управлением Linux][Logon].
...
4. При появлении запроса введите **n** для создания нового раздела.
	...
	![Создание нового устройства](./media/virtual-machines-linux-classic-attach-disk/fdisknewpartition.png)
