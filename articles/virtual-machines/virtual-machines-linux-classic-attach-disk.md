...
8. Создайте файловую систему на новом разделе. Добавьте номер секции (1) к идентификатору устройства. Например, введите следующую команду, а затем введите пароль данной учетной записи:
