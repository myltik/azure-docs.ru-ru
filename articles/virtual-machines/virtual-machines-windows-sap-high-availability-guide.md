---
title: SAP NetWeaver на виртуальных машинах Windows. Руководство по обеспечению высокого уровня доступности | Microsoft Docs
...
***Рис. 21**. Использование окна **Свойства** для изменения IP-адреса*
