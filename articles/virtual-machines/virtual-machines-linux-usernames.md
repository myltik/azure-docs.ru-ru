...
При подготовке виртуальной машины Linux в Azure необходимо указать имя непривилегированного пользователя, которое позже можно будет использовать для входа в виртуальную машину. Можно выбрать имя нового пользователя или принять имя по умолчанию azureuser при подготовке с помощью портала Azure.
