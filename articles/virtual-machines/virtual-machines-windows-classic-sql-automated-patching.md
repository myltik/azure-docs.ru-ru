...
При создании новой виртуальной машины SQL Server с классической моделью развертывания настройте автоматизированную установку исправлений с помощью портала Azure.
