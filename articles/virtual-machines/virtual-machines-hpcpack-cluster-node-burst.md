...
Действия по добавлению и запуску узлов Azure в этом сценарии аналогичны действиям для локального головного узла. Дополнительные сведения см. в следующих подразделах раздела [Steps to Deploy Azure Nodes with Microsoft HPC Pack]((https://technet.microsoft.com/library/gg481758(v=ws.10).aspx):
...
Если при развертывании узлов Azure возникли проблемы, см. раздел [Troubleshoot Deployments of Azure Nodes with Microsoft HPC Pack] (http://technet.microsoft.com/library/jj159097(v=ws.10).aspx).
