...
>[AZURE.TIP] Если используется [сценарий развертывания IaaS пакета HPC](virtual-machines-hpcpack-cluster-powershell-script.md) для создания кластера в Azure, можно включить расширительные узлы Azure в свое автоматическое развертывание. См. примеры в этой статье.
