...
На [портале предварительной версии Azure](https://portal.azure.com/) нажмите кнопку **Создать** на панели задач и создайте образ, придерживаясь следующих указаний и выбрав образ Linux согласно своим потребностям. В этом примере используется образ Ubuntu 14.04.
...
Сначала получите DNS-имя виртуальной машины на портале предварительной версии Azure. Щелкните **Обзор -> Виртуальные машины ->** имя своей виртуальной машины **-> Свойства**, а затем просмотрите значение в поле **Доменное имя** элемента **Свойства**.
