...
Сначала получите DNS-имя виртуальной машины на портале Azure. Щелкните **Обзор -> Виртуальные машины ->** имя своей виртуальной машины **-> Свойства**, а затем просмотрите значение в поле **Доменное имя** элемента **Свойства**.
