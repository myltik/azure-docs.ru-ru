...
Чтобы создать виртуальную машину, можно использовать портал управления Azure или интерфейс командной строки Azure (CLI).
...
1. Перейдите на [портал управления Azure][management-portal] и выберите виртуальную машину.
