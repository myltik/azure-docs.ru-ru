...
- Командлеты Azure PowerShell 0.8.0 или более поздней версии. Дополнительные сведения см. на странице [загрузок Azure](http://azure.microsoft.com/downloads/).
...
## Добавление AzureLogCollector в качестве расширения службы
...
## Добавление AzureLogCollector в качестве расширения виртуальной машины
