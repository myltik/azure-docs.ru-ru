...
## Дальнейшие действия
Теперь вы готовы с помощью VHD-файла системы SUSE Linux создавать в Azure виртуальные машины Azure. Если вы используете Azure и отправляете VHD-файл в Azure в первый раз, следуйте инструкциям, описанным в шагах 2 и 3 [этого руководства](virtual-machines-linux-create-upload-vhd.md).
