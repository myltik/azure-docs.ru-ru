...
# Архитектура приложений с использованием шаблонов Azure Resource Manager
...
![Учетная запись хранения](./media/virtual-machines-linux-dotnet-core/storacct.png)

Щелкните контейнер больших двоичных объектов учетной записи хранилища, чтобы просмотреть файл виртуального жесткого диска для каждой виртуальной машины, развернутой с использованием этого шаблона.

![Виртуальные жесткие диски](./media/virtual-machines-linux-dotnet-core/vhd.png)
...
![Сетевой интерфейс](./media/virtual-machines-linux-dotnet-core/nic.png)
...
Щелкните эту ссылку, чтобы увидеть пример JSON в шаблоне Resource Manager с настройками [базы данных Azure SQL](https://github.com/Microsoft/dotnet-core-sample-templates/blob/master/dotnet-core-music-linux/azuredeploy.json#L401.
