...
- Контекстные примеры реализации принципов проектирования, описанные в этом разделе, см. в статье [Контекстные примеры рекомендаций по реализации шаблонов](best-practices-resource-manager-examples.md).
- Рекомендации по обеспечению безопасности при использовании диспетчера ресурсов Azure см. в статье [Вопросы безопасности при работе с диспетчером ресурсов Azure](best-practices-resource-manager-security.md)
