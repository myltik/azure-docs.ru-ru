<properties linkid="hdinsight-use-oozie-with-hdinsight" urlDisplayName="Использование Oozie с HDInsight" pageTitle="Использование Oozie с HDInsight | Azure" metaKeywords="" description="Использование Oozie с HDInsight, решения для обработки больших объемов данных. Узнайте, как определить рабочий процесс Oozie и отправить задание Oozie." metaCanonical="" services="hdinsight" documentationCenter="" title="Использование Oozie с HDInsight" authors="jgao" solutions="" manager="paulettm" editor="cgronlun" />
...
> [WACOM.NOTE] Этот учебник работает в кластере HDInsight версии 2.1 и 3.0. Использование эмулятора HDInsight для этой статьи протестировано не было.
...
1. Создайте текстовый файл со следующим содержимым:
	...
	<tr><td>${nameNode}</td><td>Укажите URL-адрес узла имени заданий Hadoop. Используйте адрес WASB файловой системы по умолчанию. Например, <i>wasb://&lt;имя_контейнера&gt;@&lt;имя_учетной-записи_хранения&gt;.blob.core.windows.net</i>.</td></tr>
	...
	<tr><td>${hiveOutputFolder}</td><td>Папка выходных данных для инструкции INSERT OVERWRITE Hive. Это та же папка, что и каталог для экспорта Sqoop export-dir.</td></tr>
	</table>
...
8. Нажмите кнопку **Запустить скрипт** или нажмите клавишу **F5** для выполнения скрипта. Результат должен быть аналогичен приведенному ниже:
