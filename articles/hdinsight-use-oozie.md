...
Узнайте, как определить рабочий процесс и выполнить его в HDInsight. Для получения сведений о координаторе Oozie см. раздел [Использование временного координатора Oozie с HDInsight][].
...
*C:\\apps\\dist\\oozie-3.3.2.1.3.2.0-05\\oozie-win-distro\\logs\\Oozie.log* или *C:\\apps\\dist\\oozie-4.0.0.2.0.7.0-1528\\oozie-win-distro\\logs\\Oozie.log* из головного узла кластера. Сведения о RDP см. в разделе [Администрирование кластеров HDInsight с использованием портала управления][].
