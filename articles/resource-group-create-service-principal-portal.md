...
1. Перейдите на уровень области действия, которому вы хотите назначить приложение. Для назначения роли в области действия подписки выберите **Подписки**.
     ...
     Щелкните значок **Доступ** в правом верхнем углу.
