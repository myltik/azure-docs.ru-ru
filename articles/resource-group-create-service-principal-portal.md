...
- Дополнительные сведения о настройке политик безопасности см. в разделе [Управление доступом к ресурсам и его аудит](azure-portal/resource-group-rbac.md).  
- Указания по предоставлению доступа к ресурсам субъекту-службе см. в статье [Проверка подлинности субъекта-службы в диспетчере ресурсов Azure](./resource-group-authenticate-service-principal.md).  
