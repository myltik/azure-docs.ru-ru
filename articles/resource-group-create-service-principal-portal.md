...
## Обзор
При наличии автоматизированного процесса или приложения, требующего доступа к ресурсу или изменения ресурса в подписке, вы можете воспользоваться классическим порталом для создания приложения Active Directory и назначить его роли, имеющей необходимые разрешения. При создании приложения Active Directory на портале происходит фактическое создание приложения и субъекта-службы. Субъект-службы используется при установке разрешений.
