...
4. В **PowerApps** выберите **Управление интерфейсами API**:    
...
![настройка параметров API Office 365 Outlook][4]
...
8. Задайте **URL-адрес ответа** в разделе _OAuth 2_, чтобы перенаправить URL-адрес, полученный при добавлении нового API Office 365 Outlook на портале Azure (в этой статье). Затем нажмите кнопку **Добавить приложение**:  
