...
# Создание нового API Google Drive в среде службы приложений организации
...
10. На странице создания идентификатора клиента:
	...
	а) в разделе **Тип приложения** выберите **Веб-приложение**; б) введите имя для клиента; в) присвойте URL-адресу перенаправления значение, полученное при добавлении нового API Google Drive на портале Azure (в этой статье); г) нажмите кнопку **Создать**.
