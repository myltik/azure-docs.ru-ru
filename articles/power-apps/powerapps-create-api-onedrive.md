...
# Создание нового API OneDrive в среде службы приложений организации
...
3. На странице «Параметры»:
	...
	а) Выберите **Параметры API**. б) В качестве URL-адреса перенаправления укажите URL-адрес перенаправления, полученный при добавлении нового API OneDrive на портале Azure (в этой статье). в) Щелкните **Сохранить**.
