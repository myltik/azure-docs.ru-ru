...
- Добавлять пользователей из вашей компании и назначать им роли администраторов PowerApps с помощью [контроля доступа на основе ролей](../role-based-access-control-configure.md), чтобы они могли получать доступ к порталу PowerApps Enterprise.
...
Обычная среда службы приложений Azure имеет другие функции. Дополнительные сведения см. в статье [Введение в среду службы приложений](../app-service-app-service-environment-intro.md).
...
1. Войдите на [портал Azure](https://portal.azure.com/) с помощью рабочей учетной записи. Например, войдите, используя учетную запись *имя\_пользователя*@*имя\_компании*.com. Таким образом вы автоматически войдете в подписку вашей компании.
 
2. На панели задач выберите **Обзор**: ![Обзор PowerApps][1]
  
3. Можно прокрутить список и найти PowerApps или ввести *powerapps*: ![Поиск PowerApps][2]

4. В колонке **PowerApps** щелкните **Создать среду службы приложений и приступить к работе** или выберите **Среда службы приложений** в пункте *Параметры*: ![][5]
...
5. Затем введите имя, выберите подписку, которую необходимо использовать, выберите или создайте группу ресурсов и выберите виртуальную сеть. **Обратите внимание**, что после того, как вы выбрали виртуальную сеть, ее нельзя изменить: ![][6] Дополнительные сведения о работе виртуальных сетей в среде службы приложений см. в статье [Создание среды службы приложений](../app-service-web-how-to-create-an-app-service-environment.md).
