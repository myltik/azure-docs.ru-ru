...
5. Затем введите имя, выберите подписку, которую необходимо использовать, выберите или создайте группу ресурсов и выберите виртуальную сеть. **Обратите внимание**, что после того, как вы выбрали виртуальную сеть, ее нельзя изменить: ![][6] Дополнительные сведения о работе виртуальных сетей в среде службы приложений см. в статье [Создание среды службы приложений](../app-service-web/app-service-web-how-to-create-an-app-service-environment.md).
