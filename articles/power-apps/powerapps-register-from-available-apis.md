...
2. Выберите **Обзор**, **PowerApps**, а затем выберите **Управление API**: ![][17]
3. В разделе "Управление API" щелкните **Добавить**: ![][18]  
...
5. Выберите **API**, а затем API, который нужно зарегистрировать: ![][20]
