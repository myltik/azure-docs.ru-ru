...
>[AZURE.IMPORTANT] Этот раздел был перемещен на сайт [powerapps.microsoft.com](https://powerapps.microsoft.com/tutorials/customapi-how-to-swagger/). См. последнюю версию на сайте PowerApps. Эта статья Azure архивируется.
