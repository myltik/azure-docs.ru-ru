...
# Создание нового API Microsoft Translator в среде службы приложений организации
...
2. На панели задач выберите **Обзор**: ![][7]

3. Вы можете прокрутить список и найти PowerApps или набрать *powerapps* на клавиатуре: ![][8]
...
7. В поле **Источник** укажите **Доступные API**, чтобы выбрать встроенные API, а затем выберите **Microsoft Translator**: ![выбор AIP Microsoft Translator][3]

8. Выберите **Настройки — Настроить обязательные параметры**: ![настройка параметров API Microsoft Translator][4]
...
3. В окне **Регистрация приложения**:
	...
	а) укажите **Идентификатор клиента**; б) укажите **Имя** приложения; в) введите фиктивное значение **URL-адреса перенаправления**. Например, введите **https://contosoredirecturl*; г) укажите **Описание**; д) нажмите кнопку **Создать**.
