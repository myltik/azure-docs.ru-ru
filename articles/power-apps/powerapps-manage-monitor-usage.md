...
> [AZURE.IMPORTANT]Администраторы PowerApps не могут вносить изменения в среду службы приложений, пока не получат роль владельца в группе ресурсов среды службы приложений. Инструкции см. [в этой статье](powerapps-get-started-azure-portal.md).
