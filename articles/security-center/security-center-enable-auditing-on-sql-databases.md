...
1. В колонке **Рекомендации** выберите **Включить аудит для баз данных SQL**. Откроется колонка **Включить аудит для баз данных SQL**. ![][1]

2. Выберите базу данных SQL для включения аудита. Откроется колонка **Аудит и обнаружение и угроз**. ![][2]
3. В колонке **Аудит и обнаружение и угроз** в разделе **Аудит** щелкните **ВКЛ**. ![][3]
