...
| [Исправлять конфигурации безопасности](security-center-remediate-os-vulnerabilities.md) |Корпорация Майкрософт рекомендует выравнивания настройки операционной системы с помощью правила конфигурации безопасности, например не разрешать сохранение паролей. |
