...
Для выполнения инструкций этого руководства требуется центр безопасности с ценовой категорией "Стандартный". Вы можете использовать центр безопасности категории "Стандартный" бесплатно в течение первых 60 дней. Следуйте инструкциям [краткого руководства по центру безопасности Azure](security-center-get-started.md), чтобы обновить ценовую категорию до уровня "Стандартный".
...
1. В соответствии с политиками безопасности, которые были включены, центр безопасности предоставит набор рекомендаций при необходимости. Необходимо начать с просмотра рекомендаций для виртуальной машины и компьютеров. Откройте панель мониторинга центра безопасности. Выберите вкладку **Обзор**, затем выберите **Вычисления**.
  ...
  ![Среда выполнения приложений](./media/tutorial-security-policy/tutorial-security-policy-fig2.png)
...
Другие руководства в этой коллекции созданы на основе этого документа. Если вы планируете продолжить работу со следующими руководствами, продолжайте использовать уровень "Стандартный" и оставьте включенной автоматическую подготовку. Если вы не планируете продолжать или хотите вернуться на уровень "Бесплатный", выполните следующие действия.

1. Вернитесь в основное меню центра безопасности и выберите **Политика безопасности**.
2. Выберите подписку или политику, которую вы хотите вернуть на уровень "Бесплатный". Откроется окно **Политика безопасности**.
...
3. В колонке **Политика безопасности — сбор данных** в разделе **Подключение** выберите **Откл.**, чтобы отключить автоматическую подготовку.
