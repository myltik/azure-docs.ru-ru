...
|[Включение групп безопасности сети в подсетях и сетевых интерфейсах](security-center-enable-network-security-groups.md)|Рекомендует включить группы безопасности сети (NSG) в подсетях и сетевых интерфейсах.|
...
1. В колонке **Рекомендации** выберите **Включение защиты от вредоносных программ**. ![Включение защиты от вредоносных программ][5]
...
5. В колонке **Добавление расширения** введите необходимые параметры конфигурации и нажмите кнопку **ОК**. ![Установка защиты от вредоносных программ][6]
