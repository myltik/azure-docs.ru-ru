...
| [Включение аудита SQL для сервера](security-center-enable-auditing-on-sql-servers.md) |Рекомендует включить аудит для серверов SQL Azure. (Только служба SQL Azure. Не затрагивает SQL на ваших виртуальных машинах.) |
| [Включение аудита SQL для базы данных](security-center-enable-auditing-on-sql-databases.md) |Рекомендует включить аудит для баз данных SQL Azure. (Только служба SQL Azure. Не затрагивает SQL на ваших виртуальных машинах.) |
