...
| [Исправлять конфигурации безопасности](security-center-remediate-os-vulnerabilities.md) |Корпорация Майкрософт рекомендует выровнять настройки операционной системы с помощью правила конфигурации безопасности, например, запретить сохранение паролей. |
