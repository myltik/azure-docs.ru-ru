---
title: 'Центр безопасности Azure: часто задаваемые вопросы | Microsoft Docs'
...
### Какие ресурсы Azure отслеживаются центром безопасности Azure?
...
### Почему центр безопасности Azure не распознает решение для защиты от вредоносных программ, работающее на моей виртуальной машине Azure?
...
### Почему я получаю сообщение "Агент виртуальной машины отсутствует"?
