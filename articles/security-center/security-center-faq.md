...
В соответствии с рекомендацией центра безопасности по [применению обновлений системы](security-center-recommendations.md) следует развертывать отсутствующие обновления системы безопасности и критических обновлений на виртуальных машинах. Для виртуальных машин в облачных службах в соответствии с рекомендацией по **обновлению версии ОС** следует обновлять ОС до последней версии.
