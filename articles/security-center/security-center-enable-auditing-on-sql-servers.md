...
1. В колонке **Рекомендации** выберите **Включить аудит для серверов SQL**. Откроется колонка **Включить аудит для серверов SQL**. ![][1]

2. Выберите сервер SQL для включения аудита. Откроется колонка **Параметры аудита**. ![][2]
3. В колонке **Параметры аудита** в разделе **Аудит** щелкните **ВКЛ**. ![][3]
