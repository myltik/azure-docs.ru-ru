...
1.  Откройте панель мониторинга **Центр безопасности** и щелкните **Адаптивное управление приложениями** в разделе **Расширенная защита облака** на панели навигации слева.

    ![Защита](./media/security-center-adaptive-application/security-center-adaptive-application-fig1-new.png)

2. Откроется страница **Адаптивное управление приложениями**.
...
Выберите группу ресурсов, чтобы открыть окно **Create application control rules** (Создание правил управления приложениями):
