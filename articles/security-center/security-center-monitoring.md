...
В этом разделе указывается общее число виртуальных машин и компьютеров, на которых инициализирована автоматическая подготовка, а также их текущее состояние. Если щелкнуть эту запись, появится сообщение **Агент ВМ отсутствует или не отвечает**. 
