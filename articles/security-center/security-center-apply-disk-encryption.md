...
[Шифрования виртуальной машины Azure](security-center-disk-encryption.md) .  В этом разделе предполагается, что в качестве клиентского компьютера, на котором будет настраиваться шифрование дисков, используется компьютер под управлением Windows 10.
