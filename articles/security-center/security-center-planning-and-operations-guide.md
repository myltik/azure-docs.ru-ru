...
- Может использовать систему отправки запросов, чтобы отслеживать изменения (указывает рекомендации с помощью [API](https://msdn.microsoft.com/library/mt704034.aspx)).
...
- Может использовать имеющуюся панель мониторинга (указывает оповещения с помощью [API](https://msdn.microsoft.com/library/mt704034.aspx)).
...
> [AZURE.NOTE] Чтобы устранить неполадки, связанные с агентом мониторинга центра безопасности Azure, см. статью [Руководство по устранению неполадок в центре безопасности Azure](security-center-troubleshooting-guide.md).
