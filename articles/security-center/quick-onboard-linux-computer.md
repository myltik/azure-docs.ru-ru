...
Для начала работы с этим руководством требуется центр безопасности с ценовой категорией "Стандартный". Инструкции по повышению категории см. в статье [Краткое руководство по центру безопасности Azure](security-center-get-started.md). Вы можете использовать центр безопасности категории "Стандартный" бесплатно в течение первых 60 дней.
...
Теперь можно осуществлять мониторинг виртуальных машин Azure и компьютеров, не относящихся к Azure, в одном и том же месте. В разделе **Среда выполнения приложений** предоставляется обзор всех виртуальных машин и компьютеров с рекомендациями. В каждом столбце представлен один набор рекомендаций. Цвет соответствует текущему состоянию безопасности виртуальной машины или компьютера для соответствующей рекомендации. Центр безопасности также предоставляет доступ к обнаруженным угрозам для этих компьютеров в оповещениях системы безопасности.
