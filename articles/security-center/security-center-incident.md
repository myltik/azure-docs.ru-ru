---
title: "Обработка инцидентов в центре безопасности Azure | Документация Майкрософт"
...
---
# <a name="handling-security-incident-in-azure-security-center"></a>Обработка инцидентов в центре безопасности Azure
