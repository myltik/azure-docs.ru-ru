...
При создании приложения в службе приложений можно выбрать один из следующих типов:
...
- [Мобильные приложения](../../app-service-mobile/app-service-mobile-value-prop.md). Расширяют возможности веб-приложений за счет поддержки доступа с мобильных устройств. Это позволяет использовать аутентификацию с помощью поставщиков социальных сетей и Azure Active Directory (Azure AD), а также обеспечивает серверное хранилище и интеграцию с [центрами уведомлений Azure](../../notification-hubs/notification-hubs-push-notification-overview.md) для использования push-уведомлений.

- [Приложения API](../../app-service-api/app-service-api-apps-why-best-platform.md). Позволяют более безопасно предоставлять собственные интерфейсы API в облаке с помощью метаданных Swagger, что упрощает их использование клиентами.

Так как все три типа приложения используют общую среду выполнения службы приложений, вы можете разместить веб-сайт, включить поддержку мобильных клиентов и предоставить собственные интерфейсы API в Azure из одного проекта или решения. Чтобы узнать больше, ознакомьтесь с разделом [Принцип работы службы приложений](../../app-service/app-service-how-works-readme.md).
...
>**Приступая к работе**. Служба приложений позволяет легко создать и развернуть свое первое [веб-приложение](../../app-service-web/web-sites-dotnet-get-started.md), [мобильное приложение](../../app-service-mobile/app-service-mobile-ios-get-started.md) или [приложение API](../../app-service-api/app-service-api-dotnet-get-started.md).
...
-   **Служба контейнеров Azure**. Позволяет создать и настроить кластер виртуальных машин, предварительно настроенных для запуска контейнерных приложений, а также управлять этим кластером. Дополнительные сведения о службе контейнеров см. в разделе [Introduction to Azure Container Service for Kubernetes](../../container-service/container-service-intro.md) (Введение в службу контейнеров Azure для Kubernetes).
    ...
    >**Приступая к работе**. [Разверните кластер службы контейнеров](../../container-service/container-service-deployment.md).
...
>**Приступая к работе**. Чтобы просмотреть варианты использования DevOps для приложения службы приложений, ознакомьтесь с разделом [Непрерывное развертывание в службе приложений Azure](../../app-service-web/app-service-continuous-deployment.md).
