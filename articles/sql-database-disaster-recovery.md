...
После восстановления базы данных вы можете настроить ее для использования. Для этого следуйте инструкциям руководства [Завершение восстановленной базы данных](articles/sql-database-recovered-finalize.md).
###PowerShell 
Используйте PowerShell для программного восстановления базы данных.
