<properties pageTitle="Создание и передача виртуального жесткого диска с ОС Linux на основе CentOS в Azure" description="Узнайте, как создать и передать виртуальный жесткий диск (VHD-файл) Azure, содержащий операционную систему Linux на основе CentOS" services="virtual-machines" documentationCenter="" authors="szarkos" manager="timlt" editor="tysonn"/>
...
8. **Только для CentOS 6.3**: Установите драйверы для служб интеграции Linux
	...
	**Важно! Это действие действительно только для CentOS версии 6.3 и более ранних версий.**  В CentOS 6.4+ службы интеграции Linux  *уже доступны в ядре*.
