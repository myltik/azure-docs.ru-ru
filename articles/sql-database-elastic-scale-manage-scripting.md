...
1. Загрузите файл **ShardElasticity.zip** и извлеките его содержание.
...
1. Перейдите на страницу [Предварительная версия Azure](http://azure.microsoft.com/ru-ru/services/preview/).
