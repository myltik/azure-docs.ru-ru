...
В следующей таблице перечислены данные об энергопотреблении для различных моделей устройства StorSimple.
 
| Условия | 240 В переменного тока | 110 В переменного тока |
| ---------- | -------- | -------- |
| Вентиляторы работают медленно, диски в режиме простоя | 1,45 А, 0,31 кВт | 3,19 А, 0,34 кВт |
| Вентиляторы работают медленно, диски в режиме доступа | 1,54 А, 0,33 кВт | 3,27 А, 0,36 кВт |
| Вентиляторы работают быстро, диски в режиме простоя, включены два блока питания | 2,14 А, 0,49 кВт | 4,99 А, 0,54 кВт |
| Вентиляторы работают быстро, диски в режиме простоя, один блок питания включен, другой в режиме простоя | 2,05 А, 0,48 кВт | 4,58 А, 0,5 кВт |
| Вентиляторы работают быстро, диски в режиме доступа, включены два блока питания | 2,26 А, 0,51 кВт | 4,95 А, 0,54 кВт |
| Вентиляторы работают быстро, диски в режиме доступа, один блок питания включен, другой в режиме простоя | 2,14 А, 0,49 кВт | 4,81 А, 0,53 кВт |
...
Для сетевых интерфейсов 10 GbE, DATA 2 и DATA 3 список поддерживаемых сетевых кабелей и модулей можно найти по ссылке [http://www.mellanox.com/page/cables?mtag=cable\_overview](http://www.mellanox.com/page/cables?mtag=cable_overview).
