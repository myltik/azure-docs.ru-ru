...
Поделитесь своими примерами на GitHub: [Примеры и документация Microsoft Azure Active Directory](https://github.com/AzureADSamples) 
...
| Язык или платформа | Пример | Описание
| ----------------- | ------ | -----------
...
| C#/.NET | [WebApp-MultiTenant-OpenIdConnect-DotNet](https://github.com/AzureADSamples/WebApp-MultiTenant-OpenIdConnect-DotNet) | Многопользовательское веб-приложение .NET MVC, которое использует OpenID Connect (ПО промежуточного слоя ASP.Net OpenID Connect OWIN) для проверки подлинности пользователей нескольких клиентов Azure AD.
...
| C#/.NET | [NativeClient-WebAPI-MultiTenant-WindowsStore](https://github.com/AzureADSamples/NativeClient-WebAPI-MultiTenant-WindowsStore) | Приложение Магазина Windows, которое вызывает многопользовательский веб-интерфейс API, защищенный с помощью Azure AD.
...
| Язык или платформа | Пример | Описание
| ----------------- | ------ | -----------
| C#/.NET | [WebApp-WebAPI-OpenIDConnect-DotNet](http://github.com/AzureADSamples/WebApp-WebAPI-OpenIDConnect-DotNet) | Вызов веб-интерфейса API с разрешениями выполнившего вход пользователя.
| C#/.NET | [WebApp-WebAPI-OAuth2-AppIdentity-DotNet](http://github.com/AzureADSamples/WebApp-WebAPI-OAuth2-AppIdentity-DotNet) | Вызов веб-интерфейса API с разрешениями приложения.
...
| C#/.NET | [WebApp-WebAPI-MultiTenant-OpenIdConnect-DotNet](https://github.com/AzureADSamples/WebApp-WebAPI-MultiTenant-OpenIdConnect-DotNet) | Многопользовательское веб-приложение MVC, которое использует OpenID Connect (ПО промежуточного слоя ASP.Net OpenID Connect OWIN) для проверки подлинности пользователей клиентов Azure AD. Использует код авторизации для вызова Graph API.
...
| Язык или платформа | Пример | Описание
| ----------------- | ------ | -----------
| C#/.NET | [Проверка подлинности на основе ролей и проверка подлинности на основе ACL в приложении Windows Azure AD](http://go.microsoft.com/fwlink/?LinkId=331694) | Выполнение проверки подлинности на основе ролей (RBAC) и проверки подлинности на основе ACL в приложении, интегрированном с Windows Azure AD.
| C#/.NET | [AAL (приложение в Магазине Windows к службе REST) - проверка подлинности](http://go.microsoft.com/fwlink/?LinkId=330605) | Использование [библиотеки проверки подлинности Azure AD (ADAL)](http://go.microsoft.com/fwlink/?LinkID=258232) (ранее AAL) для бета-версии Магазина Windows, чтобы добавить возможности проверки подлинности пользователя в приложение Магазина Windows.
| C#/.NET | [ADAL (собственное приложение к службе REST) - проверка подлинности с помощью AAD через диалог в браузере](http://go.microsoft.com/fwlink/?LinkId=259814) | Использование [библиотеки проверки подлинности Azure AD (ADAL)](http://go.microsoft.com/fwlink/?LinkID=258232), чтобы добавить возможности проверки подлинности пользователя в клиент WPF.
| C#/.NET | [ADAL (собственное приложение к службе REST) - проверка подлинности с помощью ACS через диалог в браузере](http://code.msdn.microsoft.com/AAL-Native-App-to-REST-de57f2cc) | Использование [библиотеки проверки подлинности Azure AD (ADAL)](http://go.microsoft.com/fwlink/?LinkID=258232) и [службы управления доступом Access Control Service 2.0 (ACS)](http://msdn.microsoft.com/library/azure/hh147631.aspx), чтобы добавить возможности проверки подлинности пользователя в клиент WPF.
...
| C#/.NET | [Добавление единого входа в веб-приложение с помощью Azure AD](https://msdn.microsoft.com/library/azure/dn151790.aspx) | Настройка приложения .NET в каталоге организации Windows Azure AD для выполнения единого входа через Интернет.
| C#/.NET | [Разработка многопользовательских веб-приложений с помощью Azure AD](https://msdn.microsoft.com/library/azure/dn151789.aspx) | Использование Azure AD для добавления единого входа и возможности доступа к каталогу одного приложения .NET для работы в нескольких организациях.
JAVA | [Пример приложения Java для интерфейса API Azure AD Graph](http://go.microsoft.com/fwlink/?LinkId=263969) | Использование интерфейса Graph API для доступа к данным каталога из Azure AD.
PHP | [Пример приложения PHP для интерфейса API Azure AD Graph](http://code.msdn.microsoft.com/PHP-Sample-App-For-Windows-228c6ddb) | Использование интерфейса Graph API для доступа к данным каталога из Azure AD.
| C#/.NET | [Пример приложения для интерфейса API Azure AD Graph](http://go.microsoft.com/fwlink/?LinkID=262648) | Использование интерфейса Graph API для доступа к данным каталога из Azure AD.
| C#/.NET | [Пример приложения для дифференциального запроса в Azure AD Graph](http://go.microsoft.com/fwlink/?LinkId=275398) | Использование дифференциального запроса в Graph API для получения периодических изменений объектов пользователей в клиенте Azure AD.
| C#/.NET | [Пример приложения для интеграции многопользовательского облачного приложения с Windows Azure AD](http://go.microsoft.com/fwlink/?LinkId=275397) | Интеграция многопользовательского приложения в Azure AD.
...
| C#/.NET| [Использование Graph API для запросов к Azure AD](https://msdn.microsoft.com/library/azure/dn151791.aspx) | Настройка приложения .NET для использования Graph API Azure AD для доступа к данным из каталога клиента Azure AD.
