---
title: Проекты группы ресурсов Azure в Visual Studio | Microsoft Docs
...
3. Разверните узлы в проекте развертывания, чтобы увидеть, какие ресурсы созданы.
...
3. Выберите **MVC** и снимите флажок **Разместить в облаке** — эту задачу выполнит проект группы ресурсов.
