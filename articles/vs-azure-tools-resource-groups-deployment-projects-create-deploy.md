...
1. После создания веб-приложения добавьте ссылку на проект веб-приложения в проект группы ресурсов.
    ...
    - Свойство **Additional Properties** (Дополнительные свойства) содержит данные о промежуточном расположении пакета веб-развертывания, который будет отправлен в хранилище Azure. 
