---
title: Использование службы электронной почты SendGrid (Node.js) | Microsoft Docs
...
SendGrid — это [облачная служба электронной почты](https://sendgrid.com/email-solutions), которая обеспечивает надежную [доставку электронной почты](https://sendgrid.com/transactional-email), масштабируемость и аналитику в реальном времени, а также предоставляет гибкие интерфейсы API для пользовательской интеграции. Ниже перечислены наиболее распространенные сценарии использования SendGrid.
...
Дополнительную информацию обо всех свойствах, поддерживаемых функцией Email, см. в разделе [sendgrid-nodejs](https://github.com/sendgrid/sendgrid-nodejs).
...
Дополнительные сведения см. в разделе [sendgrid-nodejs](https://github.com/sendgrid/sendgrid-nodejs).

## Практическое руководство. Использование дополнительных служб SendGrid
SendGrid поддерживает различные веб-интерфейсы API, с помощью которых вы можете использовать дополнительные функции SendGrid, доступные в приложении Azure. Дополнительные сведения см. в [документации по интерфейсу API SendGrid](https://sendgrid.com/docs).
...
* Репозиторий модуля Node.js SendGrid: [sendgrid-nodejs](https://github.com/sendgrid/sendgrid-nodejs)
