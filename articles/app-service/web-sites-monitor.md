...
Метрику **Процент использования ЦП** рекомендуется использовать для приложений в рамках плана **Базовый**, **Стандартный** и **Премиум**, так как эти приложения можно масштабировать. Кроме того, эта метрика позволяет оценить общее потребление ресурсов ЦП всеми экземплярами.
