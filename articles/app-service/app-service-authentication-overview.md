...
* [Добавление функциональных возможностей в первое веб-приложение][web-getstarted]
...
## <a name="a-nameauthorizationahow-authorization-works-in-app-service"></a><a name="authorization"></a>Принцип действия авторизации в службе приложений
...
* [Практическое руководство. Проверка подлинности пользователей с помощью библиотеки проверки подлинности Active Directory][ADAL-iOS]
* [Практическое руководство. Проверка подлинности пользователей с помощью библиотеки проверки подлинности Active Directory][ADAL-Android]
* [Аутентификация пользователей с помощью библиотеки аутентификации Active Directory][ADAL-dotnet]
