...
5. Выберите используемую операционную систему. 
    ...
    * Если вы хотите создать приложение Linux с помощью настраиваемого контейнера Docker, можно просто использовать собственный контейнер, следуя приведенным здесь инструкциям. 
