...
* Добавить собственные IP-адреса в брандмауэр ASE Azure SQL.
...
2. Включите конечные точки службы Azure SQL и службы хранилища Azure в подсеть ASE.
...
Если вы настраиваете принудительное туннелирование с помощью сетевого фильтра, обратите внимание на то, что ASE имеет ряд зависимостей в дополнение к Azure SQL и службе хранилища Azure. Этот трафик или трафик ASE будет работать неправильно.
