...
В этом разделе показано, как удаленно выполнить отладку при помощи проекта, созданного при изучении раздела [Создание веб-приложения ASP.NET в Azure][app-service-web-get-started-dotnet.md].

1. Откройте веб-проект, созданный при изучении раздела [Создание веб-приложения ASP.NET в Azure][app-service-web-get-started-dotnet.md].
...
6. Из раскрывающегося списка **Профиль** выберите профиль, который использовался при изучении раздела [Создание веб-приложения ASP.NET в Azure][app-service-web-get-started-dotnet.md]. Затем щелкните "Параметры".
