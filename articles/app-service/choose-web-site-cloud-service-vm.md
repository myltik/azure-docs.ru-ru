...
| Поддержка ASP.NET, классической ASP, Node.js, PHP, Python |X |X |X |X |Service Fabric поддерживает создание веб-интерфейса на основе [ASP.NET 5](../service-fabric/service-fabric-reliable-services-communication-aspnetcore.md). Также вы можете развернуть приложение любого типа (Node.js, Java и т. д.) в качестве [гостевого исполняемого файла](../service-fabric/service-fabric-deploy-existing-app.md). |
