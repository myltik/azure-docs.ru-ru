...
* работает с Web, мобильные приложения для API и функции
...
Службы приложений можно интегрировать с виртуальной сетью Azure с помощью PowerShell. Все готово к запуску скрипта см. в разделе [подключение к виртуальной сети Azure приложения в службе приложений Azure](https://gallery.technet.microsoft.com/scriptcenter/Connect-an-app-in-Azure-ab7527e3).
