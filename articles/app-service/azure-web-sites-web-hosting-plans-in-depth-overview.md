...
- Измените **число экземпляров** плана. Например, план уровня **Стандартный**, развернутый до 3 экземпляров, можно масштабировать до 10 экземпляров, а план уровня **Премиум** можно масштабировать до 20 экземпляров. Все приложения, связанные с этим планом, смогут использовать дополнительные ресурсы ЦП и памяти, предоставляемые увеличенным числом экземпляров.
