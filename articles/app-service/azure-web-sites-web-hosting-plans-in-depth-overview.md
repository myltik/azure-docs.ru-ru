...
Можно создать пустой **план служб приложений** после просмотра **плана служб приложений** или при создании приложения.
...
С клонированием связаны определенные ограничения. Подробнее об этом см. [здесь](../app-service-web/app-service-web-app-cloning-portal.md).
...
Можно изменить ценовую категорию и размер экземпляров, щелкнув элемент **Увеличить масштаб** в разделе параметров приложения или плана служб приложений. Изменения будут применены к **плану служб приложений** и повлияют на все приложения, размещенные в нем.
