...
> [!NOTE]
> Сертификаты службы приложений поддерживают три типа проверки домена: проверка через домен, по почте и вручную. Типы проверки подробно описаны в разделе [Дополнительно](#advanced).
