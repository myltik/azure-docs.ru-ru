...
Количество увеличения для правил увеличения масштаба должно быть задано в размере как минимум 1X от **скорости роста плана службы приложений** для увеличения масштаба.
