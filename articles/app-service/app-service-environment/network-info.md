...
Помимо системы мониторинга, входящий трафик обеспечивает контроль и управление ASE. Исходные IP-адреса для этого трафика не являются постоянными. В конфигурации безопасности сети необходимо разрешить доступ со всех IP-адресов через порты 454 и 455.
...
При использовании среды ASE с ILB сайт диспетчера служб недоступен через Интернет вне виртуальной сети. Если приложение размещено в ASE с ILB, то возможности, не имеющие доступа к сайту диспетчера служб, отключены на портале Azure.
