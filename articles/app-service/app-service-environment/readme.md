...
description: "Статья с документацией по среде службы приложений Azure"
...
* [Создание и использование внутренней подсистемы балансировки нагрузки со средой службы приложений][MakeILBASE]
* [Использование среды службы приложений][UsingASE]
* [Networking considerations for an App Service Environment][ASENetwork] (Рекомендации по работе с сетями в среде службы приложений)
