...
При работе с Node.js и большим числом исходящих HTTP-запросов очень важна поддержка открытых соединений HTTP. Чтобы упростить код, вы можете использовать пакет `npm` [agentkeepalive](https://www.npmjs.com/package/agentkeepalive).
