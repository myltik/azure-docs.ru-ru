...
Выполните указанные ниже действия, чтобы настроить **высокую плотность размещения** для ваших приложений.
...
1. Создайте один **план службы приложений** и настройте его на использование всей доступной емкости в **рабочем пуле**.
