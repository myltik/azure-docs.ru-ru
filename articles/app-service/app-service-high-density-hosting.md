...
При использовании службы приложений Azure приложение рассматривается отдельно от емкости, выделяемой для него, в соответствии с двумя основными понятиями:
