...
* Поддержка функций в предварительной версии

### <a name="preview-supported-java-runtimes"></a>Предварительная версия: поддерживаемые среды выполнения Java

Ниже перечислены среды выполнения Java, доступные в службе приложений на платформе Linux:
...
* При создании веб-приложений для контейнеров в группе ресурсов, которая содержит веб-приложения под управлением платформ, отличных от Linux, необходимо создать план службы приложений в другой группе ресурсов, отличной от группы с существующим планом службы приложений.
