...
Этот скрипт создает базу данных Azure SQL и Azure веб-приложение. База данных SQL связывает веб-приложения с помощью параметров приложения.
...
Этот скрипт использует следующие команды для создания группы ресурсов, веб-приложения, базы данных SQL и все связанные ресурсы. Для каждой команды в таблице приведены ссылки на соответствующую документацию.
...
| [`az sql db show-connection-string`](/cli/azure/sql/db?view=azure-cli-latest#az_sql_db_show_connection_string) | Создает строку подключения к базе данных. |
