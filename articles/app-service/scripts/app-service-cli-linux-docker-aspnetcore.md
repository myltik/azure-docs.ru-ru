...
Этот образец скрипта создает группу ресурсов, план служб приложений Linux и веб-приложения. Развертывается с помощью контейнера Docker приложения ASP.NET Core.
