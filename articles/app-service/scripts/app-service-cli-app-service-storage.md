...
| [az storage account create](https://docs.microsoft.com/cli/azure/storage/account#az_storage_account_create) | Создание учетной записи хранения. Здесь будут храниться статичные ресурсы. |
