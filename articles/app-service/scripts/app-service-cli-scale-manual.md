...
Этот образец скрипта создает группу ресурсов, план служб приложений и веб-приложения. Затем он масштабирует план служб приложений из одного экземпляра на нескольких экземплярах.
