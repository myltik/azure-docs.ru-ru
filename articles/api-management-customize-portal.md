...
Давайте изменим цвет текста заголовка. Выберите эту запись в поле **@headings-color** и введите \#000000. Это шестнадцатеричный код черного цвета. После этого в конце текстового блока появится цветной квадратный индикатор. При щелчке по нему элемент выбора цвета позволит выбрать цвет.
