...
2. Щелкните правой кнопкой мыши узел **Azure**, а затем нажмите **Подключиться к Microsoft Azure**.
...
8. Замените строку подключения к хранилищу в файле *Web.config* на скопированную строку подключения. Перед вставкой убедитесь, что выбраны все элементы внутри кавычек, но не сами кавычки.
...
2. Введите тестовые данные, выберите изображение и нажмите кнопку **Create**.
...
2. В шаге **Подключение** мастера **веб-публикации** нажмите кнопку **Далее**.
...
В следующих разделах объясняется код, связанный с работой с пакетом SDK веб-заданий и большими двоичными объектами и очередями Azure. Код, связанный в пакетом SDK веб-заданий, см. в разделе [Раздел Program.cs](#programcs).
...
* [Использование хранилища больших двоичных объектов Azure с пакетом SDK для веб-заданий](websites-dotnet-webjobs-sdk-storage-blobs-how-to.md)
