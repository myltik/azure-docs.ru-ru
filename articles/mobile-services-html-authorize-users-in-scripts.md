<properties pageTitle="Авторизация на стороне службы (HTML) | Центр разработчиков для мобильных устройств" metaKeywords="" description="Узнайте, как осуществить авторизацию пользователей в серверной части JavaScript мобильных служб Azure." metaCanonical="" services="" documentationCenter="Mobile" title="Авторизация пользователей мобильных служб на стороне службы" authors="glenga" solutions="" manager="" editor="" />
...
1. В веб-браузере перейдите на страницу index.html для приложения, а затем войдите с выбранного поставщика удостоверений. 
