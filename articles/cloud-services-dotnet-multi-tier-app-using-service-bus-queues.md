...
7.  В левой части диалогового окна выберите **Интернет**. Выполните поиск «** Service Bus **» и выберите элемент **Microsoft Azure Service Bus**. Выполните установку и закройте это диалоговое окно.
