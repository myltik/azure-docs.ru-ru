...
- [Почему я не могу изменить или добавить данные своей подписки?](#why-cannot-i-edit-or-add-details-to-my-subscription)
...
- [Я не вижу счет за последний расчетный период. Почему?](#i-do-not-see-an-invoice-for-the-last-billing-period-why)
...
- [Что такое пробная подписка и как долго она действует?](#what-is-a-trial-subscription-and-how-long-does-it-last)
- [Какие ресурсы доступны при использовании пробной учетной записи?](#what-resources-are-available-whru-RUing-a-trial-account)
...
Чтобы обратиться за помощью, отправьте запрос в службу поддержки. В статье [Обращение в службу поддержки при возникновении проблем с оплатой или подпиской на Azure](billing-how-to-create-billing-support-ticket.md) описано, как создать запрос в службу поддержки о состоянии платежа по кредитной карте.
...
Чтобы обратиться за помощью, отправьте запрос в службу поддержки. Создание запроса в службу поддержки об удалении кредитной карты описывается в статье [Обращение в службу поддержки при возникновении проблем с оплатой или подпиской на Azure](billing-how-to-create-billing-support-ticket.md).

### Как обновить или изменить данные кредитной карты?

Если существующая кредитная карта обновлена, а ее номер остается прежним, можно просто обновить сведения о такой карте, например дату окончания срока действия. Если номер вашей карты меняется, или вы хотите использовать другую карту, необходимо добавить новую карту. Инструкции по обновлению или добавлению кредитной карты можно найти в статье [Изменение кредитной карты, используемой для оплаты подписки Azure](billing-how-to-change-credit-card.md).
...
**ПРИМЕЧАНИЕ**. Дополнительные сведения, относящиеся к виртуальным машинам, см. в статье [о плановом обслуживании виртуальных машин в Azure](virtual-machines/virtual-machines-linux-planned-maintenance.md).

**Внеплановое техническое обслуживание**: если работа службы на платформе Azure будет прервана незапланированным образом, информация о состоянии будет отражена на [панели мониторинга службы](http://status.azure.com/). Также клиенты получат уведомление на [классическом портале Azure](https://manage.windowsazure.com/).

### Что такое соглашение Azure об уровне обслуживания, бесперебойной работе и подключении?

В Azure предусмотрены отдельные соглашения об уровне обслуживания для общедоступных рабочих версий каждой службы. В соглашении об уровне обслуживания (SLA) приводится описание обязательств корпорации Майкрософт в отношении доступности и подключения. Самая свежая информация есть на [странице соглашения об уровне обслуживания](https://azure.microsoft.com/support/legal/sla/).
...
**Примечание**. Убедитесь, что используете для входа правильную учетную запись администратора. Администратор учетной записи имеет доступ только к [центру учетных записей](https://account.windowsazure.com/), а администраторы служб и соадминистраторы — только к [порталу Azure](https://portal.azure.com/) и [классическому порталу Azure](https://manage.windowsazure.com/).

### Как приобрести поддержку Azure?
Планы поддержки Azure можно приобрести либо через Интернет, либо в составе соглашения Enterprise. Планы поддержки Developer, Standard и Professional Direct можно приобрести через Интернет на странице [Планы поддержки Azure](https://azure.microsoft.com/support/plans/). Для приобретения плана поддержки необходимо быть владельцем учетной записи Microsoft Azure.
...
За дополнительной информацией обратитесь в [службу поддержки Azure](https://azure.microsoft.com/support/options/). Создание запроса в службу поддержки о переносе данных и служб из одной подписки Azure в другую описывается в статье [Обращение в службу поддержки при возникновении проблем с оплатой или подпиской на Azure](billing-how-to-create-billing-support-ticket.md).
...
В исходной версии этой функции величина предельной суммы расходов установлена равной $0, и это значение изменить нельзя. Эта функция реализована таким образом, чтобы пользователи бесплатной пробной версии, предложений MSDN, MPN и BizSpark были полностью уверены в том, что плата за использование платформы Azure взиматься не будет. Дополнительные сведения см. в статье "Предельная сумма расходов в Azure" (https://azure.microsoft.com/pricing/spending-limits/).
...
### Что такое пробная подписка и как долго она действует?

Пробная подписка Azure предоставляет вам кредит в денежном выражении на оплату служб Microsoft в объеме, соответствующем вашему потреблению за период 30 дней. Чтобы увидеть, на какие службы распространяется или не распространяется кредит бесплатной пробной версии, изучите страницу [Бесплатное пробное использование Azure](https://azure.microsoft.com/offers/ms-azr-0044p/).

Зарегистрироваться для получения пробной подписки вы можете [здесь](http://azure.microsoft.com/pricing/free-trial/).

### Какие ресурсы доступны при использовании пробной учетной записи?

При получении бесплатной пробной версии вам предоставляется кредит Azure в на сумму 200 долларов США. Вы сами можете выбрать, как использовать этот кредит Azure. Подробные сведения есть на странице [Бесплатное пробное использование Azure](https://azure.microsoft.com/offers/ms-azr-0044p/).
