...
**ПРИМЕЧАНИЕ.** Дополнительные сведения, относящиеся к виртуальным машинам, см. в статье [Плановое обслуживание виртуальных машин Azure](./virtual-machines/virtual-machines-planned-maintenance.md).

[Внеплановое техническое обслуживание](https://manage.windowsazure.com/): в случае незапланированного прерывания работы службы на платформе Azure информация о состоянии обновится на нашей странице **панели мониторинга службы** и клиенты получат уведомление на [классическом портале Azure](http://status.azure.com/).

### Что такое соглашение Azure об уровне обслуживания, бесперебойной работе и подключении?

В Azure предусмотрены отдельные соглашения об уровне обслуживания для общедоступных рабочих версий каждой службы. В соглашении об уровне обслуживания (SLA) приводится описание обязательств корпорации Майкрософт в отношении доступности и подключения. Подробнее см. на [странице соглашения об уровне обслуживания](https://azure.microsoft.com/support/legal/sla/).
...
За дополнительной информацией обращайтесь в [службу поддержки Azure](https://azure.microsoft.com/support/options/). Создание запроса в службу поддержки о переносе данных и служб из одной подписки Azure в другую описывается в статье [Как создать запрос в службу поддержки по вопросам подписки и выставления счетов в Azure](billing-how-to-create-billing-support-ticket.md).
...
2.	Щелкните **Изменить сведения** и обновите адрес электронной почты для получения уведомлений.
...
1.	Откройте [центр учетных записей Azure](https://account.windowsazure.com/Subscriptions).
...
**ПРИМЕЧАНИЕ.** В центр учетных записей можно также войти через классический портал Microsoft Azure. В этом случае щелкните имя вашей учетной записи и выберите "Просмотреть мой счет". 4. На странице **Выбор метода оплаты** щелкните раскрывающийся список и выберите метод оплаты, который требуется обновить, затем нажмите **Изменить**. 5. На странице подробных сведений убедитесь в выборе надлежащего типа и номера кредитной карты. 6. Внесите необходимые изменения в сведения о кредитной карте и нажмите **Далее**.

Дополнительные сведения см. в статье [Описание процедуры изменения кредитной карты, используемой для оплаты подписки Azure](billing-how-to-change-credit-card.md).
