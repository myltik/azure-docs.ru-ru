...
4.	На странице **Выбор метода оплаты** щелкните раскрывающийся список и выберите метод оплаты, который требуется обновить, затем нажмите **Изменить**.
5.	На странице подробных сведений убедитесь в выборе надлежащего типа и номера кредитной карты.
6.	Внесите необходимые изменения в сведения о кредитной карте и нажмите **Далее**.
