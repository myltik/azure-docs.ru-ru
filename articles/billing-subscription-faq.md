...
>[AZURE.NOTE] Дополнительные сведения, относящиеся к виртуальным машинам, см. в статье [о плановом обслуживании виртуальных машин в Azure](virtual-machines/virtual-machines-linux-planned-maintenance.md).
...
См. сведения в разделе [Не удается выполнить вход для управления подпиской Azure](billing-cannot-login-subscription.md).
...
В исходной версии этой функции величина предельной суммы расходов установлена равной $0, и это значение изменить нельзя. Эта функция реализована таким образом, чтобы пользователи бесплатной пробной версии, предложений MSDN, MPN и BizSpark были полностью уверены в том, что плата за использование платформы Azure взиматься не будет. Дополнительные сведения см. в разделе [Предельная сумма расходов Azure](https://azure.microsoft.com/pricing/spending-limits/).
...
Зарегистрироваться для получения пробной подписки вы можете [здесь](http://azure.microsoft.com/pricing/free-trial/). [В этом руководстве](billing-buy-sign-up-azure-subscription.md#sign-up-for-an-azure-free-trial-subscription) приведены пошаговые инструкции.
...
Также см. статью [Часто задаваемые вопросы о бесплатном пробном использовании Azure](https://azure.microsoft.com/pricing/free-trial-faq/).
