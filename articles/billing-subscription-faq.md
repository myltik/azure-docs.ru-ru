...
> [!NOTE]
> Дополнительные сведения, относящиеся к виртуальным машинам, см. в статье [Плановое обслуживание виртуальных машин Linux в Azure](virtual-machines/virtual-machines-linux-planned-maintenance.md).
> 
> 
...
> [!NOTE]
> Для подписки DreamSpark также недоступна возможность увеличения квоты.
> 
> 
