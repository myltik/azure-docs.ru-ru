...
Чтобы обратиться за помощью, отправьте запрос в службу поддержки. Создание запроса в службу поддержки о проверке состояния подписки Azure описывается в статье [Как обратиться в службу поддержки при возникновении проблем с оплатой или подпиской на Azure](billing-how-to-create-billing-support-ticket.md).

### Как получить копию счета?

Администратор учетной записи Azure может просматривать выставленные счета в центре учетных записей Azure, а также скачивать выписки за шесть предыдущих расчетных периодов. Дополнительные сведения см. в статье [Как скачать счет на оплату и данные о ежедневном использовании в Azure](billing-download-azure-invoice-daily-usage-date.md).

### Как удалить кредитную карту, которая больше не будет использоваться для оплаты Azure?

Чтобы обратиться за помощью, отправьте запрос в службу поддержки. Создание запроса в службу поддержки об удалении кредитной карты описывается в статье [Как обратиться в службу поддержки при возникновении проблем с оплатой или подпиской на Azure](billing-how-to-create-billing-support-ticket.md).

### Как обновить или изменить данные кредитной карты?

Инструкции по изменению или добавлению кредитной карты для оплаты Azure см. в статье [Как изменить кредитную карту, используемую для оплаты подписки Azure](billing-how-to-change-credit-card.md).
...
**Внеплановое техническое обслуживание**: в случае незапланированного прерывания работы службы на платформе Azure информация о состоянии изменится на [панели мониторинга службы](http://status.azure.com/) и клиенты получат уведомление на [классическом портале Azure](https://manage.windowsazure.com/).
...
Имейте в виду, что срок плана поддержки Azure — 6 месяцев, а корпорация Майкрософт требует непрерывного соблюдения финансовых обязательств на его протяжении. При досрочной отмене оставшееся обязательство не аннулируется, а предоплаченные суммы не возмещаются. Дополнительные сведения см. в статье [Как отменить подписку Azure](billing-how-to-cancel-azure-subscription.md).

### Как перенести данные и службы из подписки Azure в новую подписку?

За дополнительной информацией обращайтесь в [службу поддержки Azure](https://azure.microsoft.com/support/options/). Создание запроса в службу поддержки о переносе данных и служб из одной подписки Azure в другую описывается в статье [Как обратиться в службу поддержки при возникновении проблем с оплатой или подпиской на Azure](billing-how-to-create-billing-support-ticket.md).
...
2.	Щелкните **Изменить сведения** и измените адрес электронной почты для получения уведомлений.
...
3.	На странице общих сведений о **подписке** щелкните "Изменить метод оплаты". В отдельном окне откроется средство **Изменение метода оплаты**.
