...
- Также вам нужна учетная запись Azure, в которую необходимо войти для просмотра ресурсов Azure в Cloud Explorer. Дополнительные сведения см. в статье [Создание учетной записи Azure и включение предварительных версий компонентов](../php-create-account/).
...
- Вкладка **Действия** отображает действия, которые можно выполнить в обозревателе облака для выбранного ресурса. Также вы можете увидеть доступные действия в контекстном меню ресурса.

- Вкладка **Свойства** отображает свойства ресурса, например его тип, языковой стандарт и группу ресурсов, с которой связан ресурс.
