...
1. Создайте сведения о группе регистрации:

    1. Выполните **шаг 1** и **шаг 2**, чтобы создать _корневой_ и _промежуточный_ сертификаты.
    ...
    1. Войдите на портал Azure, нажмите кнопку **Все ресурсы** в меню слева и откройте службу подготовки.
        ...
        1. Выберите только что созданный сертификат.
            ...
            - Выполните **шаг 3**. Введите _код проверки_ или щелкните правой кнопкой мыши в открытом окне PowerShell, чтобы вставить код.  Нажмите клавишу **ВВОД**.
...
1. Чтобы создать сертификаты устройств и очистить ресурсы, выполните **шаг 4** и **шаг 5**.
