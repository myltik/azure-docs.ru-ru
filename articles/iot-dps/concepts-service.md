...
Это группа устройств, совместно использующих определенный механизм аттестации. Все устройства в группе регистраций представляют сертификаты X.509, подписанные одним корневым ЦС. Группы регистраций могут использовать только механизм аттестации X.509.
