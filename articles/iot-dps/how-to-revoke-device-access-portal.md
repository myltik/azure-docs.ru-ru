...
## <a name="blacklist-devices-by-using-an-individual-enrollment-entry"></a>Черный список устройств при использовании записей индивидуальной регистрации
...
4. Выберите запись регистрации устройства, которое вы хотите внести в черный список. 
...
2. Выберите из списка ресурсов службу подготовки, от которой нужно отключить устройство.
3. В службе подготовки выберите **Управление регистрациями**, а затем — вкладку **Отдельные регистрации**.
4. Установите флажок рядом с записью регистрации устройства, которое вы хотите внести в черный список. 
...
4. Выберите группу регистраций, которую вы хотите внести в черный список.
