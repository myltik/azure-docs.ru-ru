---
title: "Практическое руководство Azure. Использование разных аппаратных модулей безопасности с клиентским пакетом SDK для службы подготовки устройств в Azure | Документация Майкрософт"
