...
2. *Выполните в Marketplace поиск* по запросу **Device provisioning service**. Выберите **IoT Device Provisioning Service (preview)** и нажмите кнопку **Создать**. 
...
3. На портале в колонке **Добавление ссылки на Центр Интернета вещей или пул** выберите текущую подписку или введите имя и строку подключения для другой подписки. Выберите *Центр Интернета вещей* в качестве **типа ресурса** и выберите имя центра из раскрывающегося списка. Затем нажмите кнопку **Сохранить**. 
...
3. Теперь вы выбранный центр будет отображается в колонке **Связанные Центры Интернета вещей**. 
...
2. В меню слева на портале Azure нажмите кнопку **Все ресурсы** и выберите свой Центр Интернета вещей. В верхней части колонки **Все ресурсы** нажмите кнопку **Удалить**.  
