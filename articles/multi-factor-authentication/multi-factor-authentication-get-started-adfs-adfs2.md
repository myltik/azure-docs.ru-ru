---
title: Защита облачных и локальных ресурсов с помощью сервера Azure Multi-Factor Authentication и AD FS 2.0
...
4. Укажите IP-адрес, диапазон IP-адресов или подсеть, которые следует внести в список разрешений. При указании подсети выберите соответствующую маску сети и нажмите кнопку «ОК». Надежный IP-адрес добавлен.
