---
title: Интеграция локальных удостоверений с Azure Active Directory.
...
> [!NOTE]
> При реализации службы Multi-Factor Authentication используйте такие дополнительные факторы, как вторичную и третичную проверку в дополнение к основному способу проверки подлинности. Эти методы не предназначены для использования в качестве основных способов проверки подлинности.
> 
> 
