...
Существует два разных способа загрузки сервера Azure Multi-Factor Authentication: первый — с портала Azure, второй — непосредственно со страницы [https://pfweb.phonefactor.net](https://pfweb.phonefactor.net). Для загрузки пакета SDK требуется подписка Azure.
...
2. Слева внизу нажмите SDK.
3. Выберите необходимый язык и щелкните одну из связанных ссылок для загрузки.
