...
## <a name="download-the-azure-multi-factor-authentication-sdk"></a>Загрузка пакета SDK для Azure Multi-Factor Authentication
...
### <a name="to-download-the-azure-multi-factor-authentication-sdk-from-the-azure-classic-portal"></a>Скачивание пакета SDK для многофакторной идентификации Azure с классического портала Azure
...
### <a name="to-download-the-azure-multi-factor-authentication-sdk-via-the-service-settings"></a>Загрузка пакета SDK для Azure Multi-Factor Authentication через параметры службы
1. Войдите на [классический портал Azure](https://manage.windowsazure.com) с учетной записью администратора.
2. Выберите **Active Directory**слева.
...
## <a name="contents-of-the-azure-multi-factor-authentication-sdk"></a>Содержимое пакета SDK для Azure Multi-Factor Authentication
...
## <a name="code-sample-standard-mode-phone-verification"></a>Пример кода: проверка телефона в стандартном режиме
