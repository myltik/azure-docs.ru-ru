...
description: "Выберите подходящее решение многофакторной идентификации, выяснив, что является объектом защиты и где находятся пользователи.  После этого выберите облако, сервер Multi-Factor Authentication или службы AD FS."
