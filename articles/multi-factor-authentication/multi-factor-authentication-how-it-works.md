...
Настраиваемые приветствия для звонков| | | * 
Настройка идентификатора звонящего для звонков| | | * 
Подтверждение событий| | | * 
Список надежных IP-адресов| | | * 
Приостановка MFA для запомненных устройств (общедоступная предварительная версия)| | | * 
Пакет SDK для MFA| | | * 
MFA для локальных приложений с использованием сервера MFA| | | *
