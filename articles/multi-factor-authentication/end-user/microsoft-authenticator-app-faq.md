...
Если вы воспользовались этими рекомендациями по устранению неполадок, но проблема осталась, отправьте нам свои журналы для диагностики. Перейдите к параметрам приложения и выберите **Справка и отзывы** и **Отправка журналов**. Затем перейдите на [форум приложения Microsoft Authenticator](https://social.technet.microsoft.com/Forums/en-US/home?forum=MicrosoftAuthenticatorApp) и сообщите нам, какая проблема у вас возникла и какие действия вы уже предприняли.
