...
- Вы получаете уведомления для одних учетных записей в приложении, но не получаете для других? Если это так, то необходимо удалить проблемную учетную запись из приложения и добавить ее повторно, чтобы заново активировать push-уведомления. 

Если вы воспользовались этими рекомендациями по устранению неполадок, но проблема осталась, отправьте нам свои журналы для диагностики (перейдите к параметрам приложения и выберите **Справка и отзывы** > **Отправить журналы**). Затем перейдите на [форум приложения Microsoft Authenticator](https://social.technet.microsoft.com/Forums/en-US/home?forum=MicrosoftAuthenticatorApp) и сообщите нам, какая проблема у вас возникла и какие действия вы уже предприняли. 
