...
Когда отделу ИТ потребуется запустить двухфакторную проверку, вы увидите экран с надписью **Администратор просит вас настроить для своей учетной записи дополнительную проверку безопасности**.
