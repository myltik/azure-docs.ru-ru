...
Ниже описано, как использовать приложение Microsoft Authenticator для двухфакторной проверки подлинности. Приложение можно использовать двумя способами. Вы можете получить push-уведомление на устройство или открыть приложение, чтобы получить код проверки.
