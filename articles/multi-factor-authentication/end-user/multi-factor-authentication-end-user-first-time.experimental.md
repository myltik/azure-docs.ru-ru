...
Когда ИТ-отделу потребуется запустить двухфакторную проверку, появится экран с надписью **Администратор потребовал настроить дополнительную проверку безопасности для этой учетной записи**:
