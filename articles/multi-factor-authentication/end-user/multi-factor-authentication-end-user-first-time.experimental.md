...
Когда службе поддержки компаний потребуется запустить двухфакторную проверку подлинности, появится экран с надписью **Администратор потребовал настроить дополнительную проверку безопасности для этой учетной записи**:
