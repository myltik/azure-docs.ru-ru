...
Корпорация Майкрософт предлагает двухфакторную проверку, но ваша организация решает, использовать ли эту функцию. От этого нельзя отказаться, если этого требует служба поддержки вашей компании, также как нельзя отказаться от использования пароля для защиты учетной записи. 
