...
3. Выберите способ проверки, который нужно использовать. 
  - Если у вас также нет доступа к альтернативным методам, обратитесь в ИТ-отдел за помощью по входу в учетную запись.
...
Если ваш телефон был утерян или украден, мы также рекомендуем сообщить об этом в ИТ-отдел, так как специалистам понадобится сбросить пароли приложения и удалить все сохраненные устройства. 
