...
> [!ВИДЕО https://channel9.msdn.com/Blogs/Azure/WA-MFA-Overview/player]
>
>
...
> [!ВИДЕО https://channel9.msdn.com/Blogs/Azure/Windows-Azure-Multi-Factor-Authentication/player]
>
>
...
| Версия | Описание |
| --- | --- |
| Многофакторная проверка подлинности для Office 365 |Эта версия работает исключительно с приложениями Office 365, и ей можно управлять с портала Office 365. Поэтому теперь администраторы могут защитить свои ресурсы Office 365 с помощью двухшаговой проверки. Эта версия является частью подписки Office 365. |
...
| --- |:---:|:---:|:---:|
| Защита учетных записей администраторов с помощью MFA |● |● (Доступно только для учетных записей администраторов Azure) |● |
