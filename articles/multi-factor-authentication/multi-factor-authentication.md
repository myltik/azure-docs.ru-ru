<properties
    pageTitle="Обзор Azure MFA | Microsoft Azure"
...
>[AZURE.NOTE] В этой сравнительной таблице рассматриваются функции, которые являются частью каждой подписки. При наличии Azure AD Premium или Enterprise Mobility Suite некоторые возможности могут быть недоступны в зависимости от того, используется ли [MFA в облаке или MFA в локальной системе](multi-factor-authentication-get-started.md).
