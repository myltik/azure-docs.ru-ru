---
title: "Развертывание пользовательского портала для сервера Azure Multi-Factor Authentication"
...
4. Если компьютер присоединен к домену, но в Active Directory не закончена настройка защиты подключений между пользовательским порталом и службой Azure Multi-Factor Authentication, появится окно настройки Active Directory. Чтобы выполнить настройку автоматически, нажмите кнопку «Далее».
...
### <a name="install-the-user-portal"></a>Установить пользовательский портал.
...
## <a name="passed-sessions"></a>Передаваемые сеансы
## <a name="saml"></a>SAML
...
> [!NOTE]
> Для использования приложения Azure Multi-Factor Authentication пользователь должен включить push-уведомления для своего устройства.
> 
> 
