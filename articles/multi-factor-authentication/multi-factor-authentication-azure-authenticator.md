...
- Введите имя учетной записи и секретный ключ, указанные на той же странице, что и штрихкод. Данные необходимо ввести в поля кода и URL-адреса для мобильного приложения. После этого начнется активация.
