...
- Запустите установленное на телефоне приложение Azure Authenticator и нажмите кнопку Scan barcode (Считать штрихкод). Инструкции по добавлению учетной записи, для которой уже настроена Azure MFA или сторонняя учетная запись, см. в статье [Добавление учетной записи вручную](#Добавление учетной-записи-вручную).
