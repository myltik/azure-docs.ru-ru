...
description: "Из этой статьи вы узнаете, как назначать лицензии для службы Многофакторной идентификации Microsoft Azure."
...
- Дополнительные сведения см. в статье [Что такое лицензирование Microsoft Azure Active?](../active-directory/active-directory-licensing-whatis-azure-portal.md)
