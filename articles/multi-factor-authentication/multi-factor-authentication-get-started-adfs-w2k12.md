...
- Сведения об установке SDK веб-службы с помощью портала пользователей см. в статье [Развертывание пользовательского портала для сервера Azure Multi-Factor Authentication.](multi-factor-authentication-get-started-portal.md)
