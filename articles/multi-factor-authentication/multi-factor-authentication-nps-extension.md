...
- См. дополнительные сведения об интеграции [шлюза удаленных рабочих столов](nps-extension-remote-desktop-gateway.md) и [VPN-серверов](nps-extension-vpn.md) с помощью расширения NPS.
