...
1. Алгоритм шифрования пароля для обмена данными между клиентом RADIUS (VPN, сервером Netscaler или другим) и серверами NPS.
   - **PAP** поддерживает все методы проверки подлинности Azure MFA в облаке: телефонный звонок, текстовое сообщение, уведомление мобильного приложения и код проверки мобильного приложения.
   - **CHAPV2** поддерживает телефонный звонок или уведомление мобильного приложения.
...
- Не все протоколы шифрования поддерживают все методы проверки.
   - **PAP** поддерживает телефонный звонок, текстовое сообщение, уведомление мобильного приложения и код проверки мобильного приложения.
   - **CHAPV2** поддерживает телефонный звонок или уведомление мобильного приложения.
   - **EAP** не поддерживается.
