...
[Выбор методов проверки (общедоступная предварительная версия)](#selectable-verification-methods-public-preview)|Позволяет выбирать доступные пользователям методы проверки подлинности.|Сведения о включении и отключении определенных методов проверки подлинности, например вызов или текстовое сообщение.
...
1. Когда на телефон придет подтверждение, щелкните его, чтобы запустить приложение Azure Authenticator.
...
1. Войдите на классический портал Azure.
2. В левой части щелкните Active Directory.
3. В пункте Active Directory щелкните каталог, в отношении которого вы хотите задать приостановку Multi-Factor Authentication для занесенных в память устройств.
4. На выбранном каталоге щелкните "Настроить".
5. В разделе многофакторной проверки подлинности щелкните "Управление параметрами службы".
6. На странице "Параметры службы" в разделе управления параметрами пользовательского устройства установите или снимите флажок **Разрешить пользователям приостанавливать многофакторную проверку подлинности путем запоминания их устройств**. ![Приостановка устройств](./media/multi-factor-authentication-manage-users-and-devices/suspend.png)
...
## Выбор методов проверки (общедоступная предварительная версия)
...
[Уведомление в мобильном приложении](multi-factor-authentication-end-user-first-time-mobile-app.md)|В этом режиме приложение Azure Authenticator предотвращает несанкционированный доступ к учетным записям и блокирует мошеннические транзакции. Это осуществляется с помощью push-уведомлений на телефон или зарегистрированное устройство. Просто просмотрите уведомление и, если оно подлинное, выберите "Подтвердить". В противном случае вы можете просто выбрать "Отказать" или можете, отказав, еще и отправить сообщение о мошенническом уведомлении. Сведения о том, как сообщить о мошенничестве, см. в статье об использовании функции запрета и уведомления о мошенничестве для Multi-Factor Authentication.</br></br>Приложение Azure Authenticator доступно для устройств [Windows Phone](http://www.windowsphone.com/ru-RU/store/app/azure-authenticator/03a5b2bf-6066-418f-b569-e8aecbc06e50), [Android](https://play.google.com/store/apps/details?id=com.azure.authenticator) и [iOS](https://itunes.apple.com/us/app/azure-authenticator/id983156458).|
[Код проверки от мобильного приложения](multi-factor-authentication-end-user-first-time-mobile-app.md)|В этом режиме приложение Azure Authenticator можно использовать в качестве программного токена для создания кода проверки OATH. Затем вы можете ввести этот код вместе с именем пользователя и паролем в качестве второго способа проверки подлинности.</li><br><p> Приложение Azure Authenticator доступно для [Windows Phone](http://www.windowsphone.com/ru-RU/store/app/azure-authenticator/03a5b2bf-6066-418f-b569-e8aecbc06e50), [Android](https://play.google.com/store/apps/details?id=com.azure.authenticator) и [iOS](https://itunes.apple.com/us/app/azure-authenticator/id983156458).
...
4. На выбранном каталоге щелкните "Настроить".
5. В разделе многофакторной проверки подлинности щелкните "Управление параметрами службы".
6. На странице "Параметры службы" в разделе параметров проверки установите или снимите флажки рядом с нужными методами.</br></br> ![Приостановка устройств](./media/multi-factor-authentication-whats-next/authmethods.png)
9. Щелкните "Сохранить".
10. Нажмите кнопку Close (Закрыть).
