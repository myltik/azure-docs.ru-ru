...
2. Перейдите к **Azure Active Directory** > **MFA Server** (Сервер MFA) > **Предупреждение о мошенничестве**.
   ...
   ![Включение предупреждения о мошенничестве](./media/multi-factor-authentication-whats-next/fraudalert.png)
...
2. Перейдите к **Azure Active Directory** > **MFA Server** (Сервер MFA) > **Одноразовый обход проверки**.
   ...
   ![Создание разового обхода проверки](./media/multi-factor-authentication-whats-next/onetimebypass.png)
...
2. Перейдите к **Azure Active Directory** > **MFA Server** (Сервер MFA) > **Параметры телефонного звонка**.
   ...
   ![Запись пользовательских телефонных сообщений](./media/multi-factor-authentication-whats-next/phonecallsettings.png)
...
2. Последовательно выберите **Azure Active Directory** > **MFA Server** (Сервер MFA) > **Правила кэширования**.
   ...
   ![Настройка правил кэширования](./media/multi-factor-authentication-whats-next/cachingrules.png)
...
* Некоторые современные архитектуры при использовании двухфакторной проверки подлинности могут запрашивать разные учетные данные: имя пользователя и пароли рабочей или учебной учетной записи и пароли приложения. Требования зависят от того, как выполняется проверка подлинности. Что касается клиентов, выполняющих проверку подлинности в локальной инфраструктуре, использование имени пользователя и пароля рабочей или учебной учетной записи обязательно. Что касается клиентов, выполняющих проверку подлинности в Azure AD, требуется использовать пароль приложения.
  ...
  * вы используете службу Многофакторной идентификации Azure;
  ...
  ![Использование паролей в федеративной организации](./media/multi-factor-authentication-whats-next/federated.png)
...
5. На странице **Параметры службы** выберите вариант **Разрешить пользователям создавать пароли приложений для входа в приложения, не относящиеся к браузеру**.
   ...
   ![Предоставление пользователям разрешения создавать пароли приложений](./media/multi-factor-authentication-whats-next/trustedips3.png)
...
5. На странице **Параметры службы** в разделе **Запомнить многофакторную проверку подлинности** выберите **Разрешить пользователям сохранять данные многофакторной проверки подлинности на доверенных устройствах**.
   ...
   ![Сохранение данных многофакторной проверки подлинности для доверенных устройств](./media/multi-factor-authentication-whats-next/remember.png)
...
5. На странице **Параметры службы** в разделе **Параметры проверки** выберите или отмените выбор методов, предоставляемых пользователям.
   ...
   ![Выбор методов проверки](./media/multi-factor-authentication-whats-next/authmethods.png)
