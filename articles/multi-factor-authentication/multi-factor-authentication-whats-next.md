...
- В действительности пароль создается автоматически, а не задается пользователем. Это делается потому, что автоматически созданный пароль сложнее подобрать, и поэтому он более безопасен.
...
3. В пункте "Каталог" щелкните каталог того пользователя, которому вы хотите включить функцию.
...
1. Зайдите на портал Office 365
2. В правом верхнем углу выберите мини-приложение с параметрами
