...
:------------- | :------------- | 
[Я использую ее в службе Office 365](#Создание и удаление паролей приложений с помощью Office 365)| Это означает, что создавать пароли приложений вы будете на портале Office 365.
...
[Я использую ее в службе Microsoft Azure](#Создание паролей приложений на портале Azure)| Это означает, что создавать пароли приложений вы будете на портале Azure.
