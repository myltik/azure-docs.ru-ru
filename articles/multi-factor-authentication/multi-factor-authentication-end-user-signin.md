...
[Вход с помощью уведомлений мобильного приложения](#signing-in-with-the-mobile-app-using-notification) | Таким будет вход с мобильного приложения с использованием уведомлений.
[Вход с мобильного приложения с помощью кода подтверждения](#signing-in-with-the-mobile-app-using-verification-code)|Таким будет вход с мобильного приложения с использованием кода подтверждения.
...
## Вход с помощью уведомлений мобильного приложения
...
- Ответьте на него и нажмите кнопку подтверждения.
...
## Вход с мобильного приложения с помощью кода подтверждения
...
- Откройте приложение Azure Authenticatior на телефоне и введите код в поле для входа.
