...
* Необходимо установить пакет SDK веб-службы "Многофакторная идентификация Azure" в IIS 7.x или более поздней версии на том же **компьютере, на котором установлен сервер Многофакторной идентификации Azure**.
