...
- Необходимо установить веб-службу мобильного приложения на веб-сервере с выходом в Интернет под управлением Microsoft® Internet Information Services (IIS) 6.x или IIS 7.x. См. дополнительные сведения об [IIS.NET](http://www.iis.net/).
