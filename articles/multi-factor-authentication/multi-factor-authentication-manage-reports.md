...
Служба Многофакторной идентификации Azure предоставляет несколько типов отчетов, которые могут быть полезны для вас и вашей организации. Доступ к этим отчетам можно получить через портал управления Многофакторной идентификации. В следующей таблице перечислены доступные отчеты:
...
| Состояние серверов |В этом отчете отображается состояние серверов Многофакторной идентификации, с которыми связана ваша учетная запись. |
...
| Журнал обойденных пользователей |Отображается журнал запросов об обходе службы Многофакторной идентификации Azure в случае использования того или иного номера телефона. |
...
* [Многофакторная идентификация Azure в MSDN](https://msdn.microsoft.com/library/azure/dn249471.aspx)
