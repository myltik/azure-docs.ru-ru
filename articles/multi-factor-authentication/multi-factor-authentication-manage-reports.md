...
3. Вверху выберите пункт «Поставщики многофакторной проверки подлинности». Отобразится список поставщиков многофакторной проверки подлинности.
4. Если у вас несколько поставщиков, выберите того, чей отчет с оповещением о мошенничестве необходимо просмотреть, и щелкните «Управление» в нижней части страницы. Если поставщик один, просто щелкните «Управление». В результате откроется портал управления Azure Multi-Factor Authentication.
