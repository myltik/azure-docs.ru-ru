...
5. Откроется новая страница. Выберите элемент **Загрузки** 
	![Загрузить](./media/multi-factor-authentication-sdk/download.png)
...
4. В верхней части экрана щелкните ссылку **Настроить** 
	![Загрузить](./media/multi-factor-authentication-sdk/download2.png)
