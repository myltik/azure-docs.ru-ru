...
Прежде чем скачать сервер многофакторной идентификации Azure, определите требования к нагрузке и высокому уровню доступности. Используйте эти сведения, чтобы выбрать способ и расположение развертывания. 
...
3. На странице Active Directory щелкните **Поставщики многофакторной проверки подлинности** ![Multi-Factor Auth Providers](./media/multi-factor-authentication-get-started-server/authproviders.png).
4. В нижней части страницы щелкните **Управление**. Откроется новая страница.
5. Щелкните **Загрузки**.
6. Щелкните ссылку **Скачать**.
