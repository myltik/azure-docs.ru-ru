...
| Многофакторная проверка подлинности для администраторов Azure | Администраторы Azure могут включить двухшаговую проверку подлинности для своих учетных записей без дополнительных затрат.|
