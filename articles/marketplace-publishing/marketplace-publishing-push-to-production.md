...
3. На странице, показанной ниже, щелкните **Запросить утверждение для перемещения в рабочую среду**. После выполнения запроса команда утверждения выполнит окончательную проверку, и затем ваше предложение станет общедоступно в Azure Marketplace. Состояние предложения будет изменено на **В списке**.
