...
> [AZURE.IMPORTANT] Пользователи, которые достигли максимального числа транзакций за месяц, блокируются и не смогут работать со службой до окончания месячного цикла подписки.
