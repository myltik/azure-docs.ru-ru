...
Чтобы создать URI подписанного URL-адреса, можно использовать инструкции из статей [Использование подписанных URL-адресов (SAS)][link-azure-1] и [Подписанные URL-адреса. Часть 2: создание и использование подписанного URL-адреса в службе BLOB-объектов][link-azure-2].
