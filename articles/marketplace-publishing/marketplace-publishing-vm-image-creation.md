...
7. Выберите до шести рекомендуемых размеров виртуальных машин. Эти рекомендации будут отображаться для конечных пользователей в колонке «Ценовая категория» на портале Azure, когда они примут решение приобрести и развернуть ваш образ.
