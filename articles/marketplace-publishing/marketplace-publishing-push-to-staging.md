...
>[AZURE.NOTE] Ваш номер SKU будет недоступен в странах, для которых не заданы цены на [портале публикации](https://publish.windowsazure.com). Ниже приведены инструкции по настройке цен для номеров SKU с почасовой оплатой или оплатой по модели BYOL.
...
1.	Войдите на [портал публикации](https://publish.windowsazure.com).
2.	Перейдите на вкладку **VIRTUAL MACHINES** (Виртуальные машины) и выберите свое предложение.
3.	В боковом меню слева щелкните вкладку **SKUs** (Номера SKU).
