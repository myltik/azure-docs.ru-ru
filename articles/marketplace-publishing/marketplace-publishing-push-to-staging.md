...
Ниже приводится подробное представление использования предложения маркетинговой информации на [веб-сайте Azure Marketplace](https://azure.microsoft.com/marketplace/) и [предварительной версии портала Azure](https://ms.portal.azure.com).
