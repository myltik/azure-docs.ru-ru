...
Вместе с VHD вы указываете размер новой виртуальной машины.  Полная статистика для каждого размера приведена [в библиотеке Azure](http://msdn.microsoft.com/library/windowsazure/dn197896.aspx).  
