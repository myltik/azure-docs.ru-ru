...
4. При перемещении приложения службы приложений необходимо ознакомиться с подразделом [Ограничения службы приложений](#app-service-limitations).
5. При перемещении ресурсов, развернутых с помощью классической модели, необходимо ознакомиться с подразделом [Ограничения классического развертывания](#classic-deployment-limitations).
...
- Управление API
- Приложения службы приложений — см. подраздел [Ограничения службы приложений](#app-service-limitations)
- Автоматизация
- Пакетная служба
- CDN
- Облачные службы — см. подраздел [Ограничения классического развертывания](#classic-deployment-limitations)
- Фабрика данных
- DNS
- DocumentDB
- Кластеры HDInsight
...
- Планировщик
- Поиск
- Служба хранилища (классическая) — см. подраздел [Ограничения классического развертывания](#classic-deployment-limitations)
...
- Виртуальные машины (классические) — см. подраздел [Ограничения классического развертывания](#classic-deployment-limitations)
...
- Хранилище
- Виртуальные машины
- Виртуальные сети (классические) — см. подраздел [Ограничения классического развертывания](#classic-deployment-limitations)
...
- переместить **web-a**, **plan-a**, **web-b** и **plan-b**
- переместить **web-a** и **web-b**
- переместить **web-a**
- переместить **web-b**
...
- Необходимо, чтобы **web-a** и **plan-a** находились в объединенной группе **combined-group**
...
Если параметр доступен для этого типа ресурса, выберите **Изменить группу ресурсов**.
...
Выберите перемещаемые ресурсы, учитывая [ограничения классического развертывания](#classic-deployment-limitations). Чтобы начать перемещение, нажмите кнопку **ОК**.
...
- Сведения о командах интерфейса командной строки Azure для управления подпиской см. в разделе [Использование интерфейса командной строки Azure с диспетчером ресурсов](xplat-cli-azure-resource-manager.md).
...
- Дополнительные сведения о логической организации ресурсов см. в разделе [Использование тегов для организации ресурсов](resource-group-using-tags.md).
