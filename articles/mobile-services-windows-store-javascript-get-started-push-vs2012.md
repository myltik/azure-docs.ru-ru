<properties linkid="develop-mobile-tutorials-get-started-with-push-js" urlDisplayName="Приступая к работе с push-уведомлениями (JS)" pageTitle="Приступая к работе с push-уведомлениями (JavaScript)" metaKeywords="" description="Узнайте, как использовать push-уведомления в приложении Магазина Windows с мобильными службами Azure." metaCanonical="http://www.windowsazure.com/ru-ru/develop/mobile/tutorials/get-started-with-push-dotnet/" disqusComments="1" umbracoNaviHide="1" title="Приступая к работе с push-уведомлениями в мобильных службах с использованием Visual Studio 2012" documentationCenter="Mobile" authors="" />
...
<div class="dev-callout"><b>Примечание.</b>
	<p>В этом учебнике push-уведомления добавляются в приложение Магазина Windows, созданное в Visual Studio 2012. Visual Studio 2013 включает новые возможности, которые упрощают настройку push-уведомлений в приложении Магазина Windows с помощью мобильных служб. Для версии Visual Studio 2013 см. <a href="/ru-ru/develop/mobile/tutorials/get-started-with-push-js">Приступая к работе с push-уведомлениями</a>.</p>
</div>
...
Это учебник основан на учебнике [Приступая к работе с данными]. Перед началом работы с этим учебником необходимо изучить [этот учебник][Приступая к работе с данными].
...
4. Вставьте следующий код после кода, который создает экземпляра **MobileServiceClient**:
...
<h2><a name="update-scripts"></a><span class="short-header">Обновление скрипта вставки</span>Обновление зарегистрированного скрипта вставки на портале управления</h2>
...
[JavaScript и HTML]: /ru-ru/develop/mobile/tutorials/get-started-with-push-js-vs2012
