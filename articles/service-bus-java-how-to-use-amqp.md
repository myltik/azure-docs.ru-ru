...
Затем, чтобы определить **ConnectionFactory** с именем "SBCF", строка конфигурации выглядит следующим образом:
