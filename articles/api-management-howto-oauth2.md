...
>Дополнительные сведения о протоколе OAuth 2.0 см. в спецификации на сайте [http://oauth.net/2/][].

## Содержание раздела

- [Предварительные требования][]
- [Настройка сервера авторизации OAuth 2.0 в службе API Management][]
- [Настройка API для авторизации пользователей по протоколу OAuth 2.0][]
- [Тестирование авторизации пользователей по протоколу OAuth 2.0 на портале разработчика][]
...
> Дополнительные сведения о настройке OAuth 2.0 с использованием Azure Active Directory см. в примере [WebApp-GraphAPI-DotNet][].
