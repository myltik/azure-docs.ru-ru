---
title: Добавление Azure Active Directory с помощью подключенных служб в Visual Studio | Microsoft Docs
description: 'Добавление Azure Active Directory с помощью диалогового окна '
;добавление: ''
подключенных: ''
служб";: ''
в: ''
...
3. Выберите **проверку подлинности Azure AD** и нажмите кнопку **Настроить**.
...
4. На первой странице мастера **Настройка проверки подлинности Azure AD** установите флажок **Настроить единый вход с помощью Azure AD**.
