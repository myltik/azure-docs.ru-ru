<properties
   pageTitle="Управление кластерами HDInsight с помощью Ambari | Aure"
...
Веб-интерфейс Ambari доступен в каждом кластере HDInsight на платформе Linux, создаваемом по адресу **https://&lt;имя_кластера>.azurehdinsight.net**. На эту страницу можно также перейти с помощью кнопки **Веб-интерфейс Ambari** в нижней части панели мониторинга кластера на портале Azure.
