<properties title="How to create web test" pageTitle="Создание веб-теста" description="Learn how to create web tests in Azure." authors="awills" manager="kamrani" />
