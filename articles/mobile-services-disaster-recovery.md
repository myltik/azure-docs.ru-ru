<properties linkid="mobile-services-recovery-disaster" urlDisplayName="Восстановление мобильной службы в случае аварии" pageTitle="Восстановление мобильной службы в случае аварии – мобильные службы Azure" metaKeywords="" description="Узнайте, как восстановить мобильую службу в случае аварии." metaCanonical="" services="" documentationCenter="Mobile" title="Восстановление мобильной службы в случае аварии" authors="yavorg" solutions="" manager="" editor="" />
...
<h2><a name="prepare"></a><span class="short-header">Подготовка</span>Подготовки к возможным авариям</h2>
...
+ **Создайте резервную копию данных в базе данных SQL мобильных служб Azure**
	<br/>Данные приложения мобильной службы хранятся в базе данных SQL Azure. Корпорация Майкрософт рекомендует создавать их резервную копию, как это описано в [руководстве по обеспечению непрерывности бизнеса на основе базы данных SQL].
+ **Создайте резервную копию скриптов мобильной службы**
...
<h2><a name="watch"></a><span class="short-header">Наблюдение</span>Следите за признаками неполадок</h2>

Эти обстоятельства указывают на наличие проблемы, которая может потребовать использования операции восстановления:

+ Приложения, подключенные к вашей мобильной службе не могут взаимодействовать с ней в течение продолжительного времени.
+ Состояние мобильной службы отображается как **Неработоспособная** на [портале Azure].
+ Отметка **Неработоспособная** отображается в верхней части каждой вкладки мобильные службы на портале Azure, и операции управления создают сообщения об ошибках.
+ [Панель мониторинга служб Azure] указывает на наличие проблемы.

<h2><a name="recover"></a><span class="short-header">Восстановление</span>Восстановление после аварии</h2>
...
4. Теперь вы можете использовать дополнительную службу для восстановления вашей основной службы.
...
[служба Team Foundation]: http://tfs.visualstudio.com/
...
[Автоматизация мобильных служб с помощью средства командной строки]: http://www.windowsazure.com/ru-ru/develop/mobile/tutorials/command-line-administration/
