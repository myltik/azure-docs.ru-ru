...
Рекомендуем хранить сценарии мобильной службы в системе управления версиями, например [Team Foundation Service] или [[GitHub]], а не полагаться только на копии в самой мобильной службе. Можно загрузить скрипты через портал Azure с помощью [функции управления версиями] мобильных служб, или [с помощью средства командной строки Azure]. Обратите внимание на возможности, которые помечены как "preview" на портале, поскольку восстановление для этих скриптов не гарантируется, и может потребоваться восстанавливать их с помощью вашей собственной системы управления версиями.
...
3. Настройте программы командной строки Azure для работы с подпиской, как описано в разделе [Автоматизация мобильных служб с помощью средств командной строки].
