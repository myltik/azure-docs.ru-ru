...
+ **Создание резервной копии скриптов мобильных служб**
	<br/>Корпорация Майкрософт рекомендует сохранять скрипты мобильных служб в системе управления версиями, такой как [Team Foundation Service] или [GitHub], и не полагаться только на копии в самой мобильной службе. Можно загрузить скрипты через портал Azure с помощью [функции управления версиями] мобильных служб, или [с помощью средства командной строки Azure]. Обратите внимание на возможности, которые помечены как "preview" на портале, поскольку восстановление для этих скриптов не гарантируется, и может потребоваться восстанавливать их с помощью вашей собственной системы управления версиями.
