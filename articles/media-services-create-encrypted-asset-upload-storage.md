<properties linkid="develop-media-services-how-to-guides-create-assets" urlDisplayName="Создание зашифрованного актива и его загрузка в хранилище" pageTitle="Создание зашифрованного актива и его загрузка в хранилище Azure" metaKeywords="" description="Узнайте, как загрузить мультимедиа-контент в службы мультимедиа, создав и отправив зашифрованный актив." metaCanonical="" services="media-services" documentationCenter="" title="Создание зашифрованного актива и его загрузка в хранилище" authors="migree" solutions="" manager="" editor="" />





<h1><a name="create-asset"> </a><span class="short header">Создание зашифрованного актива и его загрузка в хранилище</span></h1>

Данная статья является частью серии вводных статей о программировании служб мультимедиа Azure. Предыдущая статья: [Настройка компьютера для служб мультимедиа](http://go.microsoft.com/fwlink/?LinkID=301751&clcid=0x409).
...
**Примечание.** Обратите внимание, что службы мультимедиа обеспечивают шифрование на диске, а не по сети, как технология управления цифровыми правами (DRM).
