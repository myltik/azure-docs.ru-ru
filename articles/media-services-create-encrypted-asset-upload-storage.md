<properties 
	pageTitle="Создание зашифрованного ресурса и его отправка в хранилище Azure" 
	description="Узнайте, как включить контент мультимедиа в службы мультимедиа, создав и отправив зашифрованный актив." 
