...
Политики доступа к данным предоставляют разрешения для отправки запросов данных, обработки ссылочных данных в среде и сохраняют общие запросы и представления, связанные со средой.
