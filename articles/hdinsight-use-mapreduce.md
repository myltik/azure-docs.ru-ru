...
-   Кластер HDInsight. Сведения по различным способам создания таких кластеров см. в разделе [Подготовка кластеров HDInsight][]
...
1.  [Ознакомление со сценарием][]
2.  [Выполнение примера с использованием Azure PowerShell][]
3.  [Код Java для программы счетчика слов MapReduce][]
...
-   Входной файл. В качестве входного файла будет использоваться */example/data/gutenberg/davinci.txt*. Сведения об отправке файлов см. в разделе [Отправка данных в HDInsight][].
