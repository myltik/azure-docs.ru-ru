<properties linkid="manage-services-hdinsight-howto-mapreduce" urlDisplayName="MapReduce с HDInsight " pageTitle="Использование MapReduce с HDInsight | Azure" metaKeywords="" description="Узнайте, как использовать HDInsight для выполнения простого задания Hadoop MapReduce." metaCanonical="" services="hdinsight" documentationCenter="" title="Использование MapReduce с HDInsight" authors="jgao" solutions="" manager="paulettm" editor="cgronlun" />
...
- Кластер HDInsight. Сведения о различных способах создания таких кластеров см. в разделе [Подготовка кластеров HDInsight](/ru-ru/manage/services/hdinsight/provision-hdinsight-clusters/)
...
8. Выполните следующую команду для проверки наличия ошибок при выполнении задания MapReduce:	
...
* [Разработка программ MapReduce на C# для потоковой передачи Hadoop в HDInsight][hdinsight-develop-streaming]
...
[hdinsight-samples]: /ru-ru/documentation/articles/hdinsight-run-samples/
