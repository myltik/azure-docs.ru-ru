...
- Дополнительные примеры Политики Azure для виртуальных машин см. в статье о [применении политик к виртуальным машинам Windows](/azure/virtual-machines/windows/policy)
