---
title: "Пример политики Azure в формате JSON: создание виртуальной машины с помощью управляемого диска | Документация Майкрософт"
...
---
# <a name="create-vm-using-managed-disk"></a>Создание виртуальной машины с помощью управляемого диска
