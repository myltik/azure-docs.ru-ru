...
- [У меня есть приложение IIS6, работающее на базе ОС Windows Server 2003.](#iis6)
...
### <a id="onprem"></a> Требуется веб-интерфейс с возможностями фоновой обработки и с поддержкой базы данных для выполнения бизнес-приложений, интегрированных с локальными ресурсами.
...
Служба Веб-сайтов Azure позволяет избежать расходов на инфраструктуру, связанных с миграцией приложений, созданных на устаревшей платформе IIS6. Майкрософт разработала [удобные в использовании инструменты для переноса данных и подробное руководство по выполнению переноса,](https://www.movemetowebsites.net/) что позволит вам проверить совместимость и определить все изменения, которые требуется внести. Интеграция с Visual Studio, TFS и с широко распространенными инструментами CMS позволяет развертывать приложения IIS6 непосредственно в облачной среде. После развертывания на портале управления Azure клиентам предоставляются многофункциональные инструменты для управления, позволяющие оптимизировать масштабирование в соответствии с расходами и необходимыми потребностями. С помощью инструмента для миграции можно:
...
### <a id="custom"></a>Мое приложение зависит от гибко настраиваемой среды Windows или Linux, и его необходимо перенести в облако.
...
### <a id="oss"></a>Мой веб-сайт использует программное обеспечение с открытым исходным кодом, и его необходимо размещать в Azure
...
### <a id="lob"></a>У меня есть бизнес-приложение, которому необходимо подключиться к корпоративной сети

Если вы хотите создать бизнес-приложение, для веб-сайта может потребоваться прямой доступ к службам или данным в корпоративной сети. Это возможно реализовать на веб-сайтах, в облачных службах и на виртуальных машинах при использовании [службы виртуальной сети Azure](/ru-ru/services/virtual-network/). На веб-сайтах вы можете воспользоваться новой [функцией интеграции VNET](http://azure.microsoft.com/blog/2014/09/15/azure-websites-virtual-network-integration/), которая позволяет запускать приложения Azure, как если бы они были в вашей корпоративной сети.
...
В следующей таблице сравниваются возможности веб-сайтов, облачных служб и виртуальных машин, что поможет вам сделать лучший выбор. Ознакомиться с текущей информацией, касающейся Соглашений об уровнях обслуживания (SLA) для каждого из вариантов, можно в разделе [Соглашения об уровнях обслуживания для Azure](/ru-ru/support/legal/sla/).
...
<tr>
   ...
   <td valign="middle">X</td>
   <td valign="middle">X</td>
   <td valign="middle">На веб-сайтах можно с легкостью размещать средний уровень REST API, а функция веб-сайтов <a href="http://go.microsoft.com/fwlink/?linkid=390226">WebJobs</a> (Веб-задания) может размещать фоновые задания обработки. Веб-задания можно выполнять на выделенном веб-сайте, что позволит обеспечить независимое масштабирование для этого уровня.</td>
</tr>
<tr>
...
<tr>
   ...
   <td valign="middle">X</td>
   <td valign="middle">X</td>
   <td valign="middle">Для веб-сайтов в режиме Basic и Standard протокол SSL поддерживается только для имен пользовательских доменов. Для получения дополнительной информации об использовании SSL с веб-сайтами см. раздел <a href="../web-sites-configure-ssl-certificate/">Настройка сертификата SSL для веб-сайта Azure</a>.</td>
</tr>
<tr>
...
<tr>
   <td valign="middle"><p>Сетевая изоляция с помощью <a href="/ru-ru/services/virtual-network/">виртуальной сети Azure</a></p></td>
   <td valign="middle">X</td>
   <td valign="middle">X</td>
   <td valign="middle">X</td>
...
<tr>
   <td valign="middle"><p>Поддержка для <a href="/ru-ru/services/traffic-manager/">Azure Traffic Manager</a></p></td>
   <td valign="middle">X</td>
   <td valign="middle">X</td>
   <td valign="middle">X</td>
   <td valign="middle"></td>
