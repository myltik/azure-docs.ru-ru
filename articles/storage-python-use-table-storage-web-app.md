...
В этом учебнике вы узнаете, как создать приложение, которое использует хранилище таблиц с помощью клиентских библиотек Azure для Python. Если это ваше первое приложение Python Azure, вы можете сначала рассмотреть [веб-приложение Hello World на Django][веб-приложение Hello World на Django].
...
API-интерфейсы REST. Дополнительные сведения см. в разделе [Хранение данных и доступ к ним в Azure][Хранение данных и доступ к ним в Azure].
