...
11. В меню **Запуск веб-приложения PHP** нажмите кнопку **OK**.
...
2. В меню **Пуск** запустите **модуль Azure Active Directory для консоли Windows PowerShell**. Эта консоль предоставляет среду командной строки для настройки атрибутов клиента Office 365, например для создания и изменения субъектов-служб.
...
[Пакет Windows Identity Foundation 3.5 SDK]: http://www.microsoft.com/download/details.aspx?id=4451
[Среда выполнения Windows Identity Foundation 1.0]: http://www.microsoft.com/download/details.aspx?id=17331
