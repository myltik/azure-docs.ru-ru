...
## <a name="from-on-premise-to-the-cloud"></a>Из локальной среды в облако
...
Тот факт, что службы OMS работают в облаке, не означает, что ними нельзя эффективно управлять в локальной среде.  Поместите агент на любой компьютер Windows или Linux в центре обработки данных, и он будет отправлять данные службе Log Analytics, где их можно проанализировать вместе с другими данными, собранными в облаке или в локальных службах.  Используйте службу архивации Azure и Azure Site Recovery, чтобы обеспечить эффективную архивацию и высокий уровень доступности локальных ресурсов за счет использования облака.  
