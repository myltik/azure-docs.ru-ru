---
title: Монитор зависимости приложений (ADM) в Operations Management Suite (OMS) | Microsoft Docs
...
* Узнайте подробнее о [поиске по журналу](../log-analytics/log-analytics-log-searches.md\] in Log Analytics to retrieve data collected by Application Dependency Monitor..md).
