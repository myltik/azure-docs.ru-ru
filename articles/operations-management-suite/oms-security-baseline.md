---
title: 'Оценка базовых показателей с помощью решения '
безопасность: ''
и: ''
аудит": ''
operations: ''
...
microsoft: ''
azure": ''
description: 'В этом документе объясняется, как выполнить оценку базовых показателей всех отслеживаемых компьютеров с помощью решения '
в: ''
целях: ''
обеспечения: ''
безопасности: ''
