...
Как правило, [решения по управлению](operations-management-suite-solutions.md) включают одно или несколько представлений для визуализации данных.  В этой статье описывается, как экспортировать представление, созданное в [конструкторе представлений](../log-analytics/log-analytics-view-designer.md), и добавить его в решение для управления.  
