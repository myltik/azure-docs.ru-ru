---
title: "Нацеливание решений в OMS | Документация Майкрософт"
description: "Нацеливание решений — это функция в Operations Management Suite (OMS), которая позволяет ограничить решения по управлению определенным набором агентов.  В этой статье описывается, как создать конфигурацию области и применить ее к решению."
...
В следующих разделах описаны три шага, которые необходимо выполнить для нацеливания решения.  Обратите внимание, что для выполнения различных шагов вам потребуется как портал OMS, так и портал Azure.
...
- Нацеливание решений применимо только к решениям, предоставляемым корпорацией Майкрософт.  Оно не может применяться к решениям, [созданным вами или партнерами](operations-management-suite-solutions-creating.md).
