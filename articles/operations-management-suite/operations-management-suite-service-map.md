...
- Память\\% использования выделенной памяти (в байтах).
...
Чтобы получить данные по производительности сети, необходимо также включить решение Wire Data 2.0 в Operations Management Suite.
