...
В этой статье подробно описано использование схемы услуги. Сведения о настройке решения "Сопоставление служб" и соответствующих агентов подключения см. в статье [Настройка схемы услуги в Operations Management Suite](operations-management-suite-service-map-configure.md).
