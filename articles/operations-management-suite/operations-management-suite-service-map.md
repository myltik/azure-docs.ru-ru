...
Если выбрать пункт "Показать ссылки на себя", будет обновлен узел сервера, включая все циклические ссылки, которые являются TCP-подключениями, начинающимися и заканчивающимися на процессах в пределах сервера.  При отображении циклических ссылок название меню изменится на "Скрыть ссылки на себя", что даст пользователям возможность переключить отображение циклических ссылок.
...
Схема услуги интегрируется с оповещениями OMS для отображения активированных оповещений для выбранного сервера за указанный диапазон времени.  При наличии предупреждений на сервере отображается соответствующий значок, и эти предупреждения отображаются на панели оповещений виртуальной машины.
...
## <a name="oms-service-desk-integration"></a>Интеграция службы поддержки OMS
Если сопоставление служб и соединитель управления ИТ-службами включены и настроены в рабочей области OMS, они интегрируются друг с другом автоматически.  Интеграция сопоставления служб обозначена как "Служба поддержки".  [Дополнительные сведения о включении и настройке соединителя ITSM.](https://docs.microsoft.com/azure/log-analytics/log-analytics-itsmc-overview)

На панели службы поддержки отображается список всех событий управления ИТ-службами для выбранного сервера за выбранный диапазон времени.  При наличии текущих элементов на сервере они отображаются на панели службы поддержки.
![Панель службы поддержки](media/oms-service-map/service-desk.png)

Щелкните "Просмотреть рабочий элемент", чтобы открыть элемент в подключенном решении ITSM.

Щелкните "Показать в поиске по журналам", чтобы просмотреть сведения об элементе "Поиск по журналам".
...
Панель безопасности виртуальной машины отображает данные из решения для защиты и аудита OMS для выбранного сервера.  Панель отображает сводку необработанных проблем безопасности для сервера за выбранный диапазон времени.  Если щелкнуть проблему безопасности, будет выполнен поиск дополнительных сведений о ней в журналах.
...
Панель обновлений виртуальной машины отображает данные из решения для управления обновлениями OMS для выбранного сервера.  Панель отображает сводку отсутствующих обновлений для сервера за выбранный диапазон времени.
...
Данные инвентаризации виртуальных машин и процессов из схемы услуги можно получить, выполнив [поиск](../log-analytics/log-analytics-log-searches.md) в Log Analytics.  Эти данные используются в разных сценариях, таких как планирование миграции, выполнение анализа емкости, обнаружение и устранение проблем с производительностью по требованию.
...
| Bitness_s | Разрядность компьютера: 32-разрядная или 64-разрядная версия |
