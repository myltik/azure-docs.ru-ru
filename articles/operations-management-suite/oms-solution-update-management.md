...
* Решение поддерживает оценку обновлений для Windows Server 2008 и более поздних версий и развертывание обновлений для Windows Server 2008 R2 и более поздних версий.  Параметры установки Server Core и Nano Server не поддерживаются.

    > [!NOTE]
    > Для поддержки развертывания обновлений для Windows Server 2008 R2 требуется .NET Framework 4.5 и WMF 5.0 или более поздней версии.
    >  
