...
После входа в клиент на базе блокчейна пользователь сначала должен извлечь все приложения Blockchain Workbench на базе блокчейна. В этом сценарии пользователь имеет доступ к двум приложениям:
